...
main(int argc, char **argv)
{
  ...
  struct gkyl_gyrokinetic_species elc = {
    ...
    .collisions =  {
      ...
      .normNu = true,
      .norm_nu_facs = {ctx.nuElc*pow((2*ctx.vtElc*ctx.vtElc), 3.0/2.0)/ctx.n0, ctx.nuIon*pow(ctx.vtIon*ctx.vtIon + ctx.vtElc*ctx.vtElc , 3.0/2.0)/ctx.n0},
      .bmag_mid = 2.51,
      .ctx = &ctx,
      .self_nu = evalNuElc,
  ...
  struct gkyl_gyrokinetic_species ion = {
    ...
    .collisions =  {
      ...
      .ctx = &ctx,
      .normNu = true,
      .norm_nu_facs = {ctx.nuIon*pow((2*ctx.vtIon*ctx.vtIon), 3.0/2.0)/ctx.n0, ctx.nuElc*pow(ctx.vtIon*ctx.vtIon + ctx.vtElc*ctx.vtElc , 3.0/2.0)/ctx.n0},
      .bmag_mid = 2.51,
      .self_nu = evalNuIon,
      .num_cross_collisions = 1,
      .collide_with = { "elc" },
