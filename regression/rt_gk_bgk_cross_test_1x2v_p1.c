...
struct cross_test_ctx
{
  ...
  double uPar; // Electron and Ion drift velocity.
...
create_ctx(void)
{
  ...
  double Ti = 20.0 * GKYL_ELEMENTARY_CHARGE; // Ion temperature.
...
main(int argc, char **argv)
{
  ...
  struct cross_test_ctx ctx = create_ctx(); // Context for initialization functions.
  ...
  struct gkyl_gk app_inp = {
    .name = "gk_bgk_cross_test_1x2v_p1",
