...
//    .cfl_frac_omegaH = 1e10,
  ...
  double fe_tm = stat.species_rhs_tm + stat.species_coll_tm + stat.field_rhs_tm + stat.species_coll_mom_tm +stat.species_alpha_tm + stat.species_omega_cfl_tm + stat.fe_accumulate_tm;
  double sum_tm = stat.fe_tm + stat.species_bc_tm + stat.accumulate_tm;
