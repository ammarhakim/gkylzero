...
struct gem_ctx
{
  ...
  double coll_fac; // Ratio of collision time, tau_ei, to inverse ion plasma frequency. 
...
create_ctx(void)
{
  ...
  double coll_fac = 1.0e6; // Ratio of collision time, tau_ei, to inverse ion plasma frequency.   
