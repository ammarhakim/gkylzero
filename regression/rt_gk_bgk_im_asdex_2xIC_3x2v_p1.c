...
create_ctx(void)
{
  ...
  int Ny = 16; // Number of cells in y.
...
main(int argc, char **argv)
{
  ...
  struct gkyl_gyrokinetic_species elc = {
    ...
    .init_from_file = {
      ...
      .file_name = "gk_bgk_im_asdex_2x2v_p1-elc_100.gkyl", // This file comes from the last frame of a test with t_end=1.0e-3 and num_frames=100.
    },
  ...
  struct gkyl_gyrokinetic_species ion = {
    ...
    .init_from_file = {
      .type = GKYL_IC_IMPORT_F,
      .file_name = "gk_bgk_im_asdex_2x2v_p1-ion_100.gkyl", // This file comes from the last frame of a test with t_end=1.0e-3 and num_frames=100.
    },
  ...
  // GK app
  struct gkyl_gk gk = {
    .name = "gk_bgk_im_asdex_2xIC_3x2v_p1",

    .cdim = ctx.cdim, .vdim = ctx.vdim,
    .lower = { 0.15, -ctx.Ly/2.0, -ctx.Lz/2.0 },
    .upper = { 0.172, ctx.Ly/2.0, ctx.Lz/2.0 },
