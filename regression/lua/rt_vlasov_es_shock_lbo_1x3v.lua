    ...
    projections = {
      {
        ...
        init = function (t, xn)
          ...
          local n = 0.0
          if x < 0.0 then
            n = (1.0 / math.pow(math.sqrt(2.0 * pi * vte * vte), 3.0)) * (math.exp(-v_sq_m / (2.0 * vte * vte))) -- Distribution function (left).
          else
            n = (1.0 / math.pow(math.sqrt(2.0 * pi * vte * vte), 3.0)) * (math.exp(-v_sq_p / (2.0 * vte * vte))) -- Distribution function (right).
          end
    ...
    projections = {
      {
        ...
        init = function (t, xn)
          ...
          local n = 0.0
          if x < 0.0 then
            n = (1.0 / math.pow(math.sqrt(2.0 * pi * vti * vti), 3.0)) * (math.exp(-v_sq_m / (2.0 * vti * vti))) -- Distribution function (left).
          else
            n = (1.0 / math.pow(math.sqrt(2.0 * pi * vti * vti), 3.0)) * (math.exp(-v_sq_p / (2.0 * vti * vti))) -- Distribution function (right).
          end
