...
rhob = 0.01 -- Background fluid mass density.
ub = 0.0 -- Background fluid velocity.
pb = 0.01 -- Background fluid pressure.

rhol = 1.0 -- Left ring fluid mass density.
ul = 0.0 -- Left ring fluid velocity.
pl = 0.1 -- Left ring fluid pressure.

rhor = 2.0 -- Right ring fluid mass density.
ur = 0.0 -- Right ring fluid velocity.
pr = 0.1 -- Right ring fluid pressure.

-- Spacetime parameters (using geometric units).
mass = 0.3 -- Mass of the black hole.
spin = -0.99 -- Spin of the black hole.
