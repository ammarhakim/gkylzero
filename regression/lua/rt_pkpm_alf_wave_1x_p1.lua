...
train_nn_file = "rt_pkpm_alf_wave_1x_p1_moms_nn_1" -- File path of neural network to train.
...
test_nn_file = "rt_pkpm_alf_wave_1x_p1_moms_nn_1" -- File path of neural network to test.
