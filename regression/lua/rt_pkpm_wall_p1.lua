...
train_nn_file = "rt_pkpm_wall_p1_moms_nn_1" -- File path of neural network to train.
...
test_nn_file = "rt_pkpm_wall_p1_moms_nn_1" -- File path of neural network to test.
