...
main(int argc, char **argv)
{
  ...
  int NVX_NEUT = APP_ARGS_CHOOSE(app_args.vcells[0], ctx.Nvx_neut);
  int NVY_NEUT = APP_ARGS_CHOOSE(app_args.vcells[0], ctx.Nvy_neut);
  int NVZ_NEUT = APP_ARGS_CHOOSE(app_args.vcells[0], ctx.Nvz_neut);
