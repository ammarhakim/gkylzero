...
create_ctx(void)
{
  ...
  double psi_avg = (ctx.psi_max + ctx.psi_min) / 2;
  double diff_z_max = z_xi(ctx.z_m + dxi / 2, psi_avg, &ctx) - z_xi(ctx.z_m - dxi / 2, psi_avg, &ctx);
  double diff_z_p75 = z_xi(ctx.z_m * .75 + dxi / 2, psi_avg, &ctx) - z_xi(ctx.z_m * .75 - dxi / 2, psi_avg, &ctx);
  double diff_z_p50 = z_xi(ctx.z_m * .5 + dxi / 2, psi_avg, &ctx) - z_xi(ctx.z_m * .5 - dxi / 2, psi_avg, &ctx);
  double diff_z_p25 = z_xi(ctx.z_m * .25 + dxi / 2, psi_avg, &ctx) - z_xi(ctx.z_m * .25 - dxi / 2, psi_avg, &ctx);
  double diff_z_min = z_xi(dxi / 2, psi_avg, &ctx) - z_xi(-dxi / 2, psi_avg, &ctx);
