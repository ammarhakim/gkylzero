...
evalEulerInit(double t, const double* GKYL_RESTRICT xn, double* GKYL_RESTRICT fout, void *ctx)
{
  ...
  // See
  // https://ammar-hakim.org/sj/je/je2/je2-euler-shock.html#problem-3
  double rhol = 1.0, ul = 1.0, pl = 1e-6;
  double rhor = 1.0, ur = -1.0, pr = 1e-6;
...
euler_ctx(void)
{
  return (struct euler_ctx) { .gas_gamma = 5.0/3.0 };
}
