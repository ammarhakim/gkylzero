...
// Sod shock with small jump in state vars to compare to DG isothermal sodshock
...
iso_euler_ctx(void)
{
  return (struct iso_euler_ctx) { .cs = 100.0 };
}
...
main(int argc, char **argv)
{
  ...
  struct gkyl_moment app_inp = {
    .name = "iso_euler_sodshocksmalljump",
