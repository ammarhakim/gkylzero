...
GKYL_CU_D
static const gkyl_gk_nf_prim_vars_udrift_set_prob_kern_list ser_gk_nf_prim_vars_set_prob_kernels[] = {
...
GKYL_CU_D
static const gkyl_gk_nf_prim_vars_udrift_get_sol_kern_list ser_gk_nf_prim_vars_get_sol_kernels[] = {
...
choose_udrift_set_prob_ker(enum gkyl_basis_type b_type, int cdim, int poly_order)
{
  switch (b_type) {
    case GKYL_BASIS_MODAL_SERENDIPITY:
      return ser_gk_nf_prim_vars_set_prob_kernels[cdim-1].kernels[poly_order-1];
      break;
    default:
      assert(false);
      break;
...
choose_udrift_get_sol_ker(enum gkyl_basis_type b_type, int cdim, int poly_order)
{
  switch (b_type) {
    case GKYL_BASIS_MODAL_SERENDIPITY:
      return ser_gk_nf_prim_vars_get_sol_kernels[cdim-1].kernels[poly_order-1];
      break;
    default:
      assert(false);
      break;
