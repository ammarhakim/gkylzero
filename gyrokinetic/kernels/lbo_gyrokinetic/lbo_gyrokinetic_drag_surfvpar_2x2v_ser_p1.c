...
{ 
  ...
  alphaDrSurf_l[4] = (-1.414213562373095*nuUSum[3])-1.732050807568877*vmap[1]*nuSum[3]+vmap[0]*nuSum[3]; 
  ...
  alphaDrSurf_r[4] = (-1.414213562373095*nuUSum[3])+1.732050807568877*vmap[1]*nuSum[3]+vmap[0]*nuSum[3]; 
