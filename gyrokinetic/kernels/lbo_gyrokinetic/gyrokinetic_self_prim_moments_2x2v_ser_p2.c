...
{ 
  ...
  if (notCellAvg && (-0.5*(3.872983346207417*(moms[23]+moms[22])-2.23606797749979*(moms[21]+moms[20])-3.0*moms[19]+1.732050807568877*(moms[18]+moms[17])-1.0*moms[16]) < 0)) notCellAvg = false; 
  if (notCellAvg && (0.5*(3.872983346207417*moms[23]-3.872983346207417*moms[22]+2.23606797749979*(moms[21]+moms[20])-3.0*moms[19]-1.732050807568877*moms[18]+1.732050807568877*moms[17]+moms[16]) < 0)) notCellAvg = false; 
  if (notCellAvg && (-0.5*(3.872983346207417*moms[23]-3.872983346207417*moms[22]-2.23606797749979*(moms[21]+moms[20])+3.0*moms[19]-1.732050807568877*moms[18]+1.732050807568877*moms[17]-1.0*moms[16]) < 0)) notCellAvg = false; 
  if (notCellAvg && (0.5*(3.872983346207417*(moms[23]+moms[22])+2.23606797749979*(moms[21]+moms[20])+3.0*moms[19]+1.732050807568877*(moms[18]+moms[17])+moms[16]) < 0)) notCellAvg = false; 
