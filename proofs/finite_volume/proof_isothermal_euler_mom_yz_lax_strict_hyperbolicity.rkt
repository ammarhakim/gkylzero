...
(require "../prover_vector.rkt")
 ...
 (prove-lax-friedrichs-vector2-1d-strict-hyperbolicity '#hash((cons-exprs . (mom_y mom_z)) (flux-exprs . ((* mom_y u) (* mom_z u))) (max-speed-exprs . ((abs u) (abs u))) (name . "isothermal-euler-mom-yz") (parameters . ((define u 0.0)))) #:cfl 0.95 #:init-funcs '(0.0 0.0) #:nx 200 #:t-final 0.1 #:x0 0.0 #:x1 1.0)
  ...
  (is-real 0.0 '(mom_y mom_z) '((define u 0.0)))
  #t
  (is-real 'u '(mom_y mom_z) '((define u 0.0)))
  #t
  (is-real 'u '(mom_y mom_z) '((define u 0.0)))
  #t
  (are-distinct '(u u) '((define u 0.0)))
  #f
 #f
