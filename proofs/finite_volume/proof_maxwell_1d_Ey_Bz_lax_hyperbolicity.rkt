...
(require "../prover_vector.rkt")
 ...
 (prove-lax-friedrichs-vector2-1d-hyperbolicity '#hash((cons-exprs . (Ey Bz)) (flux-exprs . ((* (* c c) Bz) Ey)) (max-speed-exprs . ((abs c) (abs c))) (name . "maxwell_EyBz") (parameters . ((define c 1.0) (define e_fact 1.0) (define b_fact 1.0)))) #:cfl 0.95 #:init-funcs '(0.0 (cond ((< x 0.0) 0.5) (else -0.5))) #:nx 200 #:t-final 1.0 #:x0 -1.5 #:x1 1.5)
