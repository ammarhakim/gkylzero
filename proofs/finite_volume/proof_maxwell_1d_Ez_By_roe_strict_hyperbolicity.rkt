...
(require "../prover_vector.rkt")
 ...
 (prove-roe-vector2-1d-strict-hyperbolicity '#hash((cons-exprs . (Ez By)) (flux-exprs . ((* -1.0 (* (* c c) By)) (* -1.0 Ez))) (max-speed-exprs . ((abs c) (abs c))) (name . "maxwell_EzBy") (parameters . ((define c 1.0) (define e_fact 1.0) (define b_fact 1.0)))) #:cfl 0.95 #:init-funcs '(0.0 (cond ((< x 0.0) 0.5) (else -0.5))) #:nx 200 #:t-final 1.0 #:x0 -1.5 #:x1 1.5)
  ...
  (is-real 'c '(EzL EzR ByL ByR) '((define c 1.0) (define e_fact 1.0) (define b_fact 1.0)))
  #t
  (are-distinct '(c (* -1.0 c)) '((define c 1.0) (define e_fact 1.0) (define b_fact 1.0)))
