...
{ 
  ...
  out[1] += (1.732050807568877*f[13]*hamil[15]*rdvx2+1.732050807568877*f[12]*hamil[14]*rdvx2+3.872983346207417*f[7]*hamil[11]*rdvx2+3.872983346207417*f[6]*hamil[10]*rdvx2+3.872983346207417*f[4]*hamil[9]*rdvx2+3.872983346207417*f[2]*hamil[8]*rdvx2+1.732050807568877*f[5]*hamil[7]*rdvx2+1.732050807568877*f[3]*hamil[6]*rdvx2+1.732050807568877*f[1]*hamil[4]*rdvx2+1.732050807568877*f[0]*hamil[2]*rdvx2)*volFact; 
  out[2] += (3.872983346207417*f[7]*hamil[15]*rdvy2+3.872983346207417*f[6]*hamil[14]*rdvy2+3.872983346207417*f[5]*hamil[13]*rdvy2+3.872983346207417*f[3]*hamil[12]*rdvy2+1.732050807568877*f[9]*hamil[11]*rdvy2+1.732050807568877*f[8]*hamil[10]*rdvy2+1.732050807568877*f[4]*hamil[7]*rdvy2+1.732050807568877*f[2]*hamil[6]*rdvy2+1.732050807568877*f[1]*hamil[5]*rdvy2+1.732050807568877*f[0]*hamil[3]*rdvy2)*volFact; 
