...
{ 
  ...
  fUpR[2] = 1.58113883008419*fskin[8]+1.224744871391589*fskin[6]+0.7071067811865475*fskin[4]; 
    } else { 
  ...
  fUpR[2] = 1.58113883008419*fedge[8]-1.224744871391589*fedge[6]+0.7071067811865475*fedge[4]; 
    } 
  } else { 
  double f_cr[3] = {0.};
  double f_rl[3] = {0.};
  ...
  f_cr[2] = 1.58113883008419*fskin[8]+1.224744871391589*fskin[6]+0.7071067811865475*fskin[4]; 
  ...
  f_rl[2] = 1.58113883008419*fedge[8]-1.224744871391589*fedge[6]+0.7071067811865475*fedge[4]; 
  ...
  out[8] += -1.58113883008419*GhatR[2]*rdvx2; 
  ...
  fUpL[2] = 1.58113883008419*fedge[8]+1.224744871391589*fedge[6]+0.7071067811865475*fedge[4]; 
    } else { 
  ...
  fUpL[2] = 1.58113883008419*fskin[8]-1.224744871391589*fskin[6]+0.7071067811865475*fskin[4]; 
    } 
  } else { 
  double f_lr[3] = {0.};
  double f_cl[3] = {0.};
  ...
  f_lr[2] = 1.58113883008419*fedge[8]+1.224744871391589*fedge[6]+0.7071067811865475*fedge[4]; 
  ...
  f_cl[2] = 1.58113883008419*fskin[8]-1.224744871391589*fskin[6]+0.7071067811865475*fskin[4]; 
  ...
  out[8] += 1.58113883008419*GhatL[2]*rdvx2; 
