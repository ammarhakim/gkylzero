...
{ 
  ...
  const double *alphaL = &alpha_surf_skin[14];
  const double *alphaR = &alpha_surf_edge[14];
  const double *sgn_alpha_surfL = &sgn_alpha_surf_skin[15];
  const double *sgn_alpha_surfR = &sgn_alpha_surf_edge[15];
  ...
  fUpR[0] = 1.58113883008419*fskin[12]+1.224744871391589*fskin[3]+0.7071067811865475*fskin[0]; 
  fUpR[1] = 1.58113883008419*fskin[13]+1.224744871391589*fskin[5]+0.7071067811865475*fskin[1]; 
  fUpR[2] = 1.58113883008419*fskin[14]+1.224744871391589*fskin[6]+0.7071067811865475*fskin[2]; 
  fUpR[3] = 1.58113883008419*fskin[15]+1.224744871391589*fskin[7]+0.7071067811865475*fskin[4]; 
  fUpR[4] = 1.224744871391589*fskin[10]+0.7071067811865475*fskin[8]; 
  fUpR[5] = 1.224744871391589*fskin[11]+0.7071067811865475*fskin[9]; 
    } else { 
  fUpR[0] = 1.58113883008419*fedge[12]-1.224744871391589*fedge[3]+0.7071067811865475*fedge[0]; 
  fUpR[1] = 1.58113883008419*fedge[13]-1.224744871391589*fedge[5]+0.7071067811865475*fedge[1]; 
  fUpR[2] = 1.58113883008419*fedge[14]-1.224744871391589*fedge[6]+0.7071067811865475*fedge[2]; 
  fUpR[3] = 1.58113883008419*fedge[15]-1.224744871391589*fedge[7]+0.7071067811865475*fedge[4]; 
  fUpR[4] = 0.7071067811865475*fedge[8]-1.224744871391589*fedge[10]; 
  fUpR[5] = 0.7071067811865475*fedge[9]-1.224744871391589*fedge[11]; 
    } 
  } else { 
  double f_cr[6] = {0.};
  double f_rl[6] = {0.};
  ...
  f_cr[0] = 1.58113883008419*fskin[12]+1.224744871391589*fskin[3]+0.7071067811865475*fskin[0]; 
  f_cr[1] = 1.58113883008419*fskin[13]+1.224744871391589*fskin[5]+0.7071067811865475*fskin[1]; 
  f_cr[2] = 1.58113883008419*fskin[14]+1.224744871391589*fskin[6]+0.7071067811865475*fskin[2]; 
  f_cr[3] = 1.58113883008419*fskin[15]+1.224744871391589*fskin[7]+0.7071067811865475*fskin[4]; 
  f_cr[4] = 1.224744871391589*fskin[10]+0.7071067811865475*fskin[8]; 
  f_cr[5] = 1.224744871391589*fskin[11]+0.7071067811865475*fskin[9]; 

  f_rl[0] = 1.58113883008419*fedge[12]-1.224744871391589*fedge[3]+0.7071067811865475*fedge[0]; 
  f_rl[1] = 1.58113883008419*fedge[13]-1.224744871391589*fedge[5]+0.7071067811865475*fedge[1]; 
  f_rl[2] = 1.58113883008419*fedge[14]-1.224744871391589*fedge[6]+0.7071067811865475*fedge[2]; 
  f_rl[3] = 1.58113883008419*fedge[15]-1.224744871391589*fedge[7]+0.7071067811865475*fedge[4]; 
  f_rl[4] = 0.7071067811865475*fedge[8]-1.224744871391589*fedge[10]; 
  f_rl[5] = 0.7071067811865475*fedge[9]-1.224744871391589*fedge[11]; 
  ...
  out[8] += -0.7071067811865475*GhatR[4]*rdvy2; 
  out[9] += -0.7071067811865475*GhatR[5]*rdvy2; 
  out[10] += -1.224744871391589*GhatR[4]*rdvy2; 
  out[11] += -1.224744871391589*GhatR[5]*rdvy2; 
  out[12] += -1.58113883008419*GhatR[0]*rdvy2; 
  out[13] += -1.58113883008419*GhatR[1]*rdvy2; 
  out[14] += -1.58113883008419*GhatR[2]*rdvy2; 
  out[15] += -1.58113883008419*GhatR[3]*rdvy2; 
  ...
  fUpL[0] = 1.58113883008419*fedge[12]+1.224744871391589*fedge[3]+0.7071067811865475*fedge[0]; 
  fUpL[1] = 1.58113883008419*fedge[13]+1.224744871391589*fedge[5]+0.7071067811865475*fedge[1]; 
  fUpL[2] = 1.58113883008419*fedge[14]+1.224744871391589*fedge[6]+0.7071067811865475*fedge[2]; 
  fUpL[3] = 1.58113883008419*fedge[15]+1.224744871391589*fedge[7]+0.7071067811865475*fedge[4]; 
  fUpL[4] = 1.224744871391589*fedge[10]+0.7071067811865475*fedge[8]; 
  fUpL[5] = 1.224744871391589*fedge[11]+0.7071067811865475*fedge[9]; 
    } else { 
  fUpL[0] = 1.58113883008419*fskin[12]-1.224744871391589*fskin[3]+0.7071067811865475*fskin[0]; 
  fUpL[1] = 1.58113883008419*fskin[13]-1.224744871391589*fskin[5]+0.7071067811865475*fskin[1]; 
  fUpL[2] = 1.58113883008419*fskin[14]-1.224744871391589*fskin[6]+0.7071067811865475*fskin[2]; 
  fUpL[3] = 1.58113883008419*fskin[15]-1.224744871391589*fskin[7]+0.7071067811865475*fskin[4]; 
  fUpL[4] = 0.7071067811865475*fskin[8]-1.224744871391589*fskin[10]; 
  fUpL[5] = 0.7071067811865475*fskin[9]-1.224744871391589*fskin[11]; 
    } 
  } else { 
  double f_lr[6] = {0.};
  double f_cl[6] = {0.};
  ...
  f_lr[0] = 1.58113883008419*fedge[12]+1.224744871391589*fedge[3]+0.7071067811865475*fedge[0]; 
  f_lr[1] = 1.58113883008419*fedge[13]+1.224744871391589*fedge[5]+0.7071067811865475*fedge[1]; 
  f_lr[2] = 1.58113883008419*fedge[14]+1.224744871391589*fedge[6]+0.7071067811865475*fedge[2]; 
  f_lr[3] = 1.58113883008419*fedge[15]+1.224744871391589*fedge[7]+0.7071067811865475*fedge[4]; 
  f_lr[4] = 1.224744871391589*fedge[10]+0.7071067811865475*fedge[8]; 
  f_lr[5] = 1.224744871391589*fedge[11]+0.7071067811865475*fedge[9]; 

  f_cl[0] = 1.58113883008419*fskin[12]-1.224744871391589*fskin[3]+0.7071067811865475*fskin[0]; 
  f_cl[1] = 1.58113883008419*fskin[13]-1.224744871391589*fskin[5]+0.7071067811865475*fskin[1]; 
  f_cl[2] = 1.58113883008419*fskin[14]-1.224744871391589*fskin[6]+0.7071067811865475*fskin[2]; 
  f_cl[3] = 1.58113883008419*fskin[15]-1.224744871391589*fskin[7]+0.7071067811865475*fskin[4]; 
  f_cl[4] = 0.7071067811865475*fskin[8]-1.224744871391589*fskin[10]; 
  f_cl[5] = 0.7071067811865475*fskin[9]-1.224744871391589*fskin[11]; 
  ...
  out[8] += 0.7071067811865475*GhatL[4]*rdvy2; 
  out[9] += 0.7071067811865475*GhatL[5]*rdvy2; 
  out[10] += -1.224744871391589*GhatL[4]*rdvy2; 
  out[11] += -1.224744871391589*GhatL[5]*rdvy2; 
  out[12] += 1.58113883008419*GhatL[0]*rdvy2; 
  out[13] += 1.58113883008419*GhatL[1]*rdvy2; 
  out[14] += 1.58113883008419*GhatL[2]*rdvy2; 
  out[15] += 1.58113883008419*GhatL[3]*rdvy2; 
