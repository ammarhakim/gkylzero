...
GKYL_CU_DH double vlasov_poisson_ext_EB_boundary_surfvx_2x2v_ser_p2(const double *w, const double *dxv, const double *pots, const double *EBext, const int edge, const double *fEdge, const double *fSkin, double* GKYL_RESTRICT out) 
{ 
  ...
  alpha[1] = 1.4142135623730951*Bz[1]*wv2-5.477225575051662*phi[4]*dx10+1.4142135623730951*Ex[1]; 
  ...
  alpha[4] = 1.4142135623730951*Bz[3]*wv2-5.477225575051662*phi[6]*dx10+1.4142135623730951*Ex[3]; 
  alpha[5] = 0.408248290463863*Bz[1]*dv2; 
  alpha[6] = 0.408248290463863*Bz[2]*dv2; 
  alpha[7] = 1.4142135623730951*Bz[4]*wv2+1.4142135623730951*Ex[4]; 
  alpha[8] = 1.4142135623730951*Bz[5]*wv2-2.4494897427831783*phi[7]*dx10+1.4142135623730951*Ex[5]; 
  alpha[10] = 0.408248290463863*Bz[3]*dv2; 
  alpha[11] = 1.4142135623730951*Bz[6]*wv2+1.4142135623730951*Ex[6]; 
  alpha[12] = 1.4142135623730951*Bz[7]*wv2+1.4142135623730951*Ex[7]; 
  alpha[13] = 0.40824829046386296*Bz[4]*dv2; 
  alpha[14] = 0.40824829046386296*Bz[5]*dv2; 
  alpha[17] = 0.40824829046386296*Bz[6]*dv2; 
  alpha[18] = 0.40824829046386296*Bz[7]*dv2; 
