...
{ 
  ...
  alpha_vdim[1] = 1.4142135623730951*Ex[1]*dv10; 
  ...
  out[4] += 1.9364916731037085*(alpha_vdim[1]*f[3]+alpha_vdim[0]*f[2]); 
  out[5] += 0.8660254037844386*alpha_cdim[0]*f[4]+1.9364916731037085*alpha_vdim[0]*f[3]+(0.7745966692414833*alpha_cdim[2]+1.9364916731037085*alpha_vdim[1])*f[2]; 
