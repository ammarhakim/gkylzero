...
{ 
  ...
  int_fluid_vars[4] += 0.25*(rhouz[3]*uz[3]+rhouy[3]*uy[3]+rhoux[3]*ux[3]+rhouz[2]*uz[2]+rhouy[2]*uy[2]+rhoux[2]*ux[2]+rhouz[1]*uz[1]+rhouy[1]*uy[1]+rhoux[1]*ux[1]+rhouz[0]*uz[0]+rhouy[0]*uy[0]+rhoux[0]*ux[0]); 
