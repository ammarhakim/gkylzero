...
GKYL_CU_DH int canonical_pb_alpha_edge_surfx_2x_ser_p1(const double *w, const double *dxv, const double *phi,
...
{ 
  ...
  alphaR[0] = 2.1213203435596424*phi[3]*rdy2+1.224744871391589*phi[2]*rdy2; 
