...
{ 
  ...
  alphaL[0] = 2.738612787525831*hamil[6]*rdvx2-2.121320343559642*hamil[3]*rdvx2+1.224744871391589*hamil[2]*rdvx2; 
  alphaL[1] = 6.123724356957944*hamil[8]*rdvx2-4.743416490252569*hamil[7]*rdvx2+2.738612787525831*hamil[5]*rdvx2; 
