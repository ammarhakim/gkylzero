...
GKYL_CU_DH int canonical_pb_alpha_surfy_2x_ser_p1(const double *w, const double *dxv, const double *phi,
...
{ 
  ...
  alphaL[0] = 2.1213203435596424*phi[3]*rdx2-1.224744871391589*phi[1]*rdx2; 
