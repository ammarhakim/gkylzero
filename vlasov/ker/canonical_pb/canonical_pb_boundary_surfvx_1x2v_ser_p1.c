...
{ 
  ...
  fUpR[1] = 1.58113883008419*fskin[9]+1.224744871391589*fskin[4]+0.7071067811865475*fskin[1]; 
  fUpR[2] = 1.58113883008419*fskin[10]+1.224744871391589*fskin[6]+0.7071067811865475*fskin[3]; 
  fUpR[3] = 1.58113883008419*fskin[11]+1.224744871391589*fskin[7]+0.7071067811865475*fskin[5]; 
  fUpR[4] = 1.224744871391589*fskin[14]+0.7071067811865475*fskin[12]; 
  fUpR[5] = 1.224744871391589*fskin[15]+0.7071067811865475*fskin[13]; 
    } else { 
  fUpR[0] = 1.58113883008419*fedge[8]-1.224744871391589*fedge[2]+0.7071067811865475*fedge[0]; 
  fUpR[1] = 1.58113883008419*fedge[9]-1.224744871391589*fedge[4]+0.7071067811865475*fedge[1]; 
  fUpR[2] = 1.58113883008419*fedge[10]-1.224744871391589*fedge[6]+0.7071067811865475*fedge[3]; 
  fUpR[3] = 1.58113883008419*fedge[11]-1.224744871391589*fedge[7]+0.7071067811865475*fedge[5]; 
  fUpR[4] = 0.7071067811865475*fedge[12]-1.224744871391589*fedge[14]; 
  fUpR[5] = 0.7071067811865475*fedge[13]-1.224744871391589*fedge[15]; 
    } 
  } else { 
  double f_cr[6] = {0.};
  double f_rl[6] = {0.};
  ...
  f_cr[1] = 1.58113883008419*fskin[9]+1.224744871391589*fskin[4]+0.7071067811865475*fskin[1]; 
  f_cr[2] = 1.58113883008419*fskin[10]+1.224744871391589*fskin[6]+0.7071067811865475*fskin[3]; 
  f_cr[3] = 1.58113883008419*fskin[11]+1.224744871391589*fskin[7]+0.7071067811865475*fskin[5]; 
  f_cr[4] = 1.224744871391589*fskin[14]+0.7071067811865475*fskin[12]; 
  f_cr[5] = 1.224744871391589*fskin[15]+0.7071067811865475*fskin[13]; 

  f_rl[0] = 1.58113883008419*fedge[8]-1.224744871391589*fedge[2]+0.7071067811865475*fedge[0]; 
  f_rl[1] = 1.58113883008419*fedge[9]-1.224744871391589*fedge[4]+0.7071067811865475*fedge[1]; 
  f_rl[2] = 1.58113883008419*fedge[10]-1.224744871391589*fedge[6]+0.7071067811865475*fedge[3]; 
  f_rl[3] = 1.58113883008419*fedge[11]-1.224744871391589*fedge[7]+0.7071067811865475*fedge[5]; 
  f_rl[4] = 0.7071067811865475*fedge[12]-1.224744871391589*fedge[14]; 
  f_rl[5] = 0.7071067811865475*fedge[13]-1.224744871391589*fedge[15]; 
  ...
  out[7] += -1.224744871391589*GhatR[3]*rdvx2; 
  out[8] += -1.58113883008419*GhatR[0]*rdvx2; 
  out[9] += -1.58113883008419*GhatR[1]*rdvx2; 
  out[10] += -1.58113883008419*GhatR[2]*rdvx2; 
  out[11] += -1.58113883008419*GhatR[3]*rdvx2; 
  out[12] += -0.7071067811865475*GhatR[4]*rdvx2; 
  out[13] += -0.7071067811865475*GhatR[5]*rdvx2; 
  out[14] += -1.224744871391589*GhatR[4]*rdvx2; 
  out[15] += -1.224744871391589*GhatR[5]*rdvx2; 
  ...
  fUpL[1] = 1.58113883008419*fedge[9]+1.224744871391589*fedge[4]+0.7071067811865475*fedge[1]; 
  fUpL[2] = 1.58113883008419*fedge[10]+1.224744871391589*fedge[6]+0.7071067811865475*fedge[3]; 
  fUpL[3] = 1.58113883008419*fedge[11]+1.224744871391589*fedge[7]+0.7071067811865475*fedge[5]; 
  fUpL[4] = 1.224744871391589*fedge[14]+0.7071067811865475*fedge[12]; 
  fUpL[5] = 1.224744871391589*fedge[15]+0.7071067811865475*fedge[13]; 
    } else { 
  fUpL[0] = 1.58113883008419*fskin[8]-1.224744871391589*fskin[2]+0.7071067811865475*fskin[0]; 
  fUpL[1] = 1.58113883008419*fskin[9]-1.224744871391589*fskin[4]+0.7071067811865475*fskin[1]; 
  fUpL[2] = 1.58113883008419*fskin[10]-1.224744871391589*fskin[6]+0.7071067811865475*fskin[3]; 
  fUpL[3] = 1.58113883008419*fskin[11]-1.224744871391589*fskin[7]+0.7071067811865475*fskin[5]; 
  fUpL[4] = 0.7071067811865475*fskin[12]-1.224744871391589*fskin[14]; 
  fUpL[5] = 0.7071067811865475*fskin[13]-1.224744871391589*fskin[15]; 
    } 
  } else { 
  double f_lr[6] = {0.};
  double f_cl[6] = {0.};
  ...
  f_lr[1] = 1.58113883008419*fedge[9]+1.224744871391589*fedge[4]+0.7071067811865475*fedge[1]; 
  f_lr[2] = 1.58113883008419*fedge[10]+1.224744871391589*fedge[6]+0.7071067811865475*fedge[3]; 
  f_lr[3] = 1.58113883008419*fedge[11]+1.224744871391589*fedge[7]+0.7071067811865475*fedge[5]; 
  f_lr[4] = 1.224744871391589*fedge[14]+0.7071067811865475*fedge[12]; 
  f_lr[5] = 1.224744871391589*fedge[15]+0.7071067811865475*fedge[13]; 

  f_cl[0] = 1.58113883008419*fskin[8]-1.224744871391589*fskin[2]+0.7071067811865475*fskin[0]; 
  f_cl[1] = 1.58113883008419*fskin[9]-1.224744871391589*fskin[4]+0.7071067811865475*fskin[1]; 
  f_cl[2] = 1.58113883008419*fskin[10]-1.224744871391589*fskin[6]+0.7071067811865475*fskin[3]; 
  f_cl[3] = 1.58113883008419*fskin[11]-1.224744871391589*fskin[7]+0.7071067811865475*fskin[5]; 
  f_cl[4] = 0.7071067811865475*fskin[12]-1.224744871391589*fskin[14]; 
  f_cl[5] = 0.7071067811865475*fskin[13]-1.224744871391589*fskin[15]; 
  ...
  out[7] += -1.224744871391589*GhatL[3]*rdvx2; 
  out[8] += 1.58113883008419*GhatL[0]*rdvx2; 
  out[9] += 1.58113883008419*GhatL[1]*rdvx2; 
  out[10] += 1.58113883008419*GhatL[2]*rdvx2; 
  out[11] += 1.58113883008419*GhatL[3]*rdvx2; 
  out[12] += 0.7071067811865475*GhatL[4]*rdvx2; 
  out[13] += 0.7071067811865475*GhatL[5]*rdvx2; 
  out[14] += -1.224744871391589*GhatL[4]*rdvx2; 
  out[15] += -1.224744871391589*GhatL[5]*rdvx2; 
