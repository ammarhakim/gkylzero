...
{ 
  ...
  fUpL[4] = 1.58113883008419*fl[20]+1.224744871391589*fl[12]+0.7071067811865475*fl[8]; 
  fUpL[5] = 1.58113883008419*fl[21]+1.224744871391589*fl[15]+0.7071067811865475*fl[9]; 
  fUpL[6] = 1.58113883008419*fl[23]+1.224744871391589*fl[18]+0.7071067811865475*fl[14]; 
  fUpL[7] = 1.58113883008419*fl[24]+1.224744871391589*fl[19]+0.7071067811865475*fl[16]; 
  fUpL[8] = 1.58113883008419*fl[26]+1.224744871391589*fl[25]+0.7071067811865475*fl[22]; 
    } else { 
  ...
  fUpL[4] = 1.58113883008419*fc[20]-1.224744871391589*fc[12]+0.7071067811865475*fc[8]; 
  fUpL[5] = 1.58113883008419*fc[21]-1.224744871391589*fc[15]+0.7071067811865475*fc[9]; 
  fUpL[6] = 1.58113883008419*fc[23]-1.224744871391589*fc[18]+0.7071067811865475*fc[14]; 
  fUpL[7] = 1.58113883008419*fc[24]-1.224744871391589*fc[19]+0.7071067811865475*fc[16]; 
  fUpL[8] = 1.58113883008419*fc[26]-1.224744871391589*fc[25]+0.7071067811865475*fc[22]; 
    } 
  } else { 
  double f_lr[9] = {0.};
  double f_cl[9] = {0.};
  ...
  f_lr[4] = 1.58113883008419*fl[20]+1.224744871391589*fl[12]+0.7071067811865475*fl[8]; 
  f_lr[5] = 1.58113883008419*fl[21]+1.224744871391589*fl[15]+0.7071067811865475*fl[9]; 
  f_lr[6] = 1.58113883008419*fl[23]+1.224744871391589*fl[18]+0.7071067811865475*fl[14]; 
  f_lr[7] = 1.58113883008419*fl[24]+1.224744871391589*fl[19]+0.7071067811865475*fl[16]; 
  f_lr[8] = 1.58113883008419*fl[26]+1.224744871391589*fl[25]+0.7071067811865475*fl[22]; 
  ...
  f_cl[4] = 1.58113883008419*fc[20]-1.224744871391589*fc[12]+0.7071067811865475*fc[8]; 
  f_cl[5] = 1.58113883008419*fc[21]-1.224744871391589*fc[15]+0.7071067811865475*fc[9]; 
  f_cl[6] = 1.58113883008419*fc[23]-1.224744871391589*fc[18]+0.7071067811865475*fc[14]; 
  f_cl[7] = 1.58113883008419*fc[24]-1.224744871391589*fc[19]+0.7071067811865475*fc[16]; 
  f_cl[8] = 1.58113883008419*fc[26]-1.224744871391589*fc[25]+0.7071067811865475*fc[22]; 
  ...
  fUpR[4] = 1.58113883008419*fc[20]+1.224744871391589*fc[12]+0.7071067811865475*fc[8]; 
  fUpR[5] = 1.58113883008419*fc[21]+1.224744871391589*fc[15]+0.7071067811865475*fc[9]; 
  fUpR[6] = 1.58113883008419*fc[23]+1.224744871391589*fc[18]+0.7071067811865475*fc[14]; 
  fUpR[7] = 1.58113883008419*fc[24]+1.224744871391589*fc[19]+0.7071067811865475*fc[16]; 
  fUpR[8] = 1.58113883008419*fc[26]+1.224744871391589*fc[25]+0.7071067811865475*fc[22]; 
    } else { 
  ...
  fUpR[4] = 1.58113883008419*fr[20]-1.224744871391589*fr[12]+0.7071067811865475*fr[8]; 
  fUpR[5] = 1.58113883008419*fr[21]-1.224744871391589*fr[15]+0.7071067811865475*fr[9]; 
  fUpR[6] = 1.58113883008419*fr[23]-1.224744871391589*fr[18]+0.7071067811865475*fr[14]; 
  fUpR[7] = 1.58113883008419*fr[24]-1.224744871391589*fr[19]+0.7071067811865475*fr[16]; 
  fUpR[8] = 1.58113883008419*fr[26]-1.224744871391589*fr[25]+0.7071067811865475*fr[22]; 
    } 
  } else { 
  double f_cr[9] = {0.};
  double f_rl[9] = {0.};
  ...
  f_cr[4] = 1.58113883008419*fc[20]+1.224744871391589*fc[12]+0.7071067811865475*fc[8]; 
  f_cr[5] = 1.58113883008419*fc[21]+1.224744871391589*fc[15]+0.7071067811865475*fc[9]; 
  f_cr[6] = 1.58113883008419*fc[23]+1.224744871391589*fc[18]+0.7071067811865475*fc[14]; 
  f_cr[7] = 1.58113883008419*fc[24]+1.224744871391589*fc[19]+0.7071067811865475*fc[16]; 
  f_cr[8] = 1.58113883008419*fc[26]+1.224744871391589*fc[25]+0.7071067811865475*fc[22]; 
  ...
  f_rl[4] = 1.58113883008419*fr[20]-1.224744871391589*fr[12]+0.7071067811865475*fr[8]; 
  f_rl[5] = 1.58113883008419*fr[21]-1.224744871391589*fr[15]+0.7071067811865475*fr[9]; 
  f_rl[6] = 1.58113883008419*fr[23]-1.224744871391589*fr[18]+0.7071067811865475*fr[14]; 
  f_rl[7] = 1.58113883008419*fr[24]-1.224744871391589*fr[19]+0.7071067811865475*fr[16]; 
  f_rl[8] = 1.58113883008419*fr[26]-1.224744871391589*fr[25]+0.7071067811865475*fr[22]; 
