...
GKYL_CU_DH void canonical_pb_vars_pressure_2x3v_tensor_p1(const double *h_ij_inv, const double *MEnergy, const double *v_j, const double *nv_i, double* GKYL_RESTRICT d_Jv_P) 
{ 
  ...
  double Hxz_M1x[4] = {0.0}; 
  double Hxz_M1x_Vz[4] = {0.0}; 
  binop_mul_2d_ser_p1(Hxz, NVx, Hxz_M1x); 
  binop_mul_2d_ser_p1(Hxz_M1x, Vz, Hxz_M1x_Vz); 
 
  double Hyz_M1y[4] = {0.0}; 
  double Hyz_M1y_Vz[4] = {0.0}; 
  binop_mul_2d_ser_p1(Hyz, NVy, Hyz_M1y); 
  binop_mul_2d_ser_p1(Hyz_M1y, Vz, Hyz_M1y_Vz); 
 
  double Hzz_M1z[4] = {0.0}; 
  double Hzz_M1z_Vz[4] = {0.0}; 
  binop_mul_2d_ser_p1(Hzz, NVz, Hzz_M1z); 
  binop_mul_2d_ser_p1(Hzz_M1z, Vz, Hzz_M1z_Vz); 
