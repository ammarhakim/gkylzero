...
{ 
  ...
  const double *alphaL = &alpha_surf_l[4];
  const double *alphaR = &alpha_surf_r[4];
  const double *sgn_alpha_surfL = &sgn_alpha_surf_l[4];
  const double *sgn_alpha_surfR = &sgn_alpha_surf_r[4];
  ...
  fUpL[1] = 1.224744871391589*fl[4]+0.7071067811865475*fl[1]; 
  fUpL[2] = 1.224744871391589*fl[6]+0.7071067811865475*fl[3]; 
  fUpL[3] = 1.224744871391589*fl[7]+0.7071067811865475*fl[5]; 
    } else { 
  fUpL[0] = 0.7071067811865475*fc[0]-1.224744871391589*fc[2]; 
  fUpL[1] = 0.7071067811865475*fc[1]-1.224744871391589*fc[4]; 
  fUpL[2] = 0.7071067811865475*fc[3]-1.224744871391589*fc[6]; 
  fUpL[3] = 0.7071067811865475*fc[5]-1.224744871391589*fc[7]; 
    } 
  } else { 
  double f_lr[4] = {0.};
  double f_cl[4] = {0.};
  ...
  f_lr[1] = 1.224744871391589*fl[4]+0.7071067811865475*fl[1]; 
  f_lr[2] = 1.224744871391589*fl[6]+0.7071067811865475*fl[3]; 
  f_lr[3] = 1.224744871391589*fl[7]+0.7071067811865475*fl[5]; 

  f_cl[0] = 0.7071067811865475*fc[0]-1.224744871391589*fc[2]; 
  f_cl[1] = 0.7071067811865475*fc[1]-1.224744871391589*fc[4]; 
  f_cl[2] = 0.7071067811865475*fc[3]-1.224744871391589*fc[6]; 
  f_cl[3] = 0.7071067811865475*fc[5]-1.224744871391589*fc[7]; 
  ...
  fUpR[1] = 1.224744871391589*fc[4]+0.7071067811865475*fc[1]; 
  fUpR[2] = 1.224744871391589*fc[6]+0.7071067811865475*fc[3]; 
  fUpR[3] = 1.224744871391589*fc[7]+0.7071067811865475*fc[5]; 
    } else { 
  fUpR[0] = 0.7071067811865475*fr[0]-1.224744871391589*fr[2]; 
  fUpR[1] = 0.7071067811865475*fr[1]-1.224744871391589*fr[4]; 
  fUpR[2] = 0.7071067811865475*fr[3]-1.224744871391589*fr[6]; 
  fUpR[3] = 0.7071067811865475*fr[5]-1.224744871391589*fr[7]; 
    } 
  } else { 
  double f_cr[4] = {0.};
  double f_rl[4] = {0.};
  ...
  f_cr[1] = 1.224744871391589*fc[4]+0.7071067811865475*fc[1]; 
  f_cr[2] = 1.224744871391589*fc[6]+0.7071067811865475*fc[3]; 
  f_cr[3] = 1.224744871391589*fc[7]+0.7071067811865475*fc[5]; 

  f_rl[0] = 0.7071067811865475*fr[0]-1.224744871391589*fr[2]; 
  f_rl[1] = 0.7071067811865475*fr[1]-1.224744871391589*fr[4]; 
  f_rl[2] = 0.7071067811865475*fr[3]-1.224744871391589*fr[6]; 
  f_rl[3] = 0.7071067811865475*fr[5]-1.224744871391589*fr[7]; 
