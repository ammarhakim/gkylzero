...
{ 
  ...
  fUpR[4] = 1.58113883008419*fskin[20]+1.224744871391589*fskin[12]+0.7071067811865475*fskin[8]; 
  fUpR[5] = 1.58113883008419*fskin[21]+1.224744871391589*fskin[15]+0.7071067811865475*fskin[9]; 
  fUpR[6] = 1.58113883008419*fskin[23]+1.224744871391589*fskin[18]+0.7071067811865475*fskin[14]; 
  fUpR[7] = 1.58113883008419*fskin[24]+1.224744871391589*fskin[19]+0.7071067811865475*fskin[16]; 
  fUpR[8] = 1.58113883008419*fskin[26]+1.224744871391589*fskin[25]+0.7071067811865475*fskin[22]; 
    } else { 
  ...
  fUpR[4] = 1.58113883008419*fedge[20]-1.224744871391589*fedge[12]+0.7071067811865475*fedge[8]; 
  fUpR[5] = 1.58113883008419*fedge[21]-1.224744871391589*fedge[15]+0.7071067811865475*fedge[9]; 
  fUpR[6] = 1.58113883008419*fedge[23]-1.224744871391589*fedge[18]+0.7071067811865475*fedge[14]; 
  fUpR[7] = 1.58113883008419*fedge[24]-1.224744871391589*fedge[19]+0.7071067811865475*fedge[16]; 
  fUpR[8] = 1.58113883008419*fedge[26]-1.224744871391589*fedge[25]+0.7071067811865475*fedge[22]; 
    } 
  } else { 
  double f_cr[9] = {0.};
  double f_rl[9] = {0.};
  ...
  f_cr[4] = 1.58113883008419*fskin[20]+1.224744871391589*fskin[12]+0.7071067811865475*fskin[8]; 
  f_cr[5] = 1.58113883008419*fskin[21]+1.224744871391589*fskin[15]+0.7071067811865475*fskin[9]; 
  f_cr[6] = 1.58113883008419*fskin[23]+1.224744871391589*fskin[18]+0.7071067811865475*fskin[14]; 
  f_cr[7] = 1.58113883008419*fskin[24]+1.224744871391589*fskin[19]+0.7071067811865475*fskin[16]; 
  f_cr[8] = 1.58113883008419*fskin[26]+1.224744871391589*fskin[25]+0.7071067811865475*fskin[22]; 
  ...
  f_rl[4] = 1.58113883008419*fedge[20]-1.224744871391589*fedge[12]+0.7071067811865475*fedge[8]; 
  f_rl[5] = 1.58113883008419*fedge[21]-1.224744871391589*fedge[15]+0.7071067811865475*fedge[9]; 
  f_rl[6] = 1.58113883008419*fedge[23]-1.224744871391589*fedge[18]+0.7071067811865475*fedge[14]; 
  f_rl[7] = 1.58113883008419*fedge[24]-1.224744871391589*fedge[19]+0.7071067811865475*fedge[16]; 
  f_rl[8] = 1.58113883008419*fedge[26]-1.224744871391589*fedge[25]+0.7071067811865475*fedge[22]; 
  ...
  out[20] += -1.58113883008419*GhatR[4]*rdx2; 
  out[21] += -1.58113883008419*GhatR[5]*rdx2; 
  out[22] += -0.7071067811865475*GhatR[8]*rdx2; 
  out[23] += -1.58113883008419*GhatR[6]*rdx2; 
  out[24] += -1.58113883008419*GhatR[7]*rdx2; 
  out[25] += -1.224744871391589*GhatR[8]*rdx2; 
  out[26] += -1.58113883008419*GhatR[8]*rdx2; 
  ...
  fUpL[4] = 1.58113883008419*fedge[20]+1.224744871391589*fedge[12]+0.7071067811865475*fedge[8]; 
  fUpL[5] = 1.58113883008419*fedge[21]+1.224744871391589*fedge[15]+0.7071067811865475*fedge[9]; 
  fUpL[6] = 1.58113883008419*fedge[23]+1.224744871391589*fedge[18]+0.7071067811865475*fedge[14]; 
  fUpL[7] = 1.58113883008419*fedge[24]+1.224744871391589*fedge[19]+0.7071067811865475*fedge[16]; 
  fUpL[8] = 1.58113883008419*fedge[26]+1.224744871391589*fedge[25]+0.7071067811865475*fedge[22]; 
    } else { 
  ...
  fUpL[4] = 1.58113883008419*fskin[20]-1.224744871391589*fskin[12]+0.7071067811865475*fskin[8]; 
  fUpL[5] = 1.58113883008419*fskin[21]-1.224744871391589*fskin[15]+0.7071067811865475*fskin[9]; 
  fUpL[6] = 1.58113883008419*fskin[23]-1.224744871391589*fskin[18]+0.7071067811865475*fskin[14]; 
  fUpL[7] = 1.58113883008419*fskin[24]-1.224744871391589*fskin[19]+0.7071067811865475*fskin[16]; 
  fUpL[8] = 1.58113883008419*fskin[26]-1.224744871391589*fskin[25]+0.7071067811865475*fskin[22]; 
    } 
  } else { 
  double f_lr[9] = {0.};
  double f_cl[9] = {0.};
  ...
  f_lr[4] = 1.58113883008419*fedge[20]+1.224744871391589*fedge[12]+0.7071067811865475*fedge[8]; 
  f_lr[5] = 1.58113883008419*fedge[21]+1.224744871391589*fedge[15]+0.7071067811865475*fedge[9]; 
  f_lr[6] = 1.58113883008419*fedge[23]+1.224744871391589*fedge[18]+0.7071067811865475*fedge[14]; 
  f_lr[7] = 1.58113883008419*fedge[24]+1.224744871391589*fedge[19]+0.7071067811865475*fedge[16]; 
  f_lr[8] = 1.58113883008419*fedge[26]+1.224744871391589*fedge[25]+0.7071067811865475*fedge[22]; 
  ...
  f_cl[4] = 1.58113883008419*fskin[20]-1.224744871391589*fskin[12]+0.7071067811865475*fskin[8]; 
  f_cl[5] = 1.58113883008419*fskin[21]-1.224744871391589*fskin[15]+0.7071067811865475*fskin[9]; 
  f_cl[6] = 1.58113883008419*fskin[23]-1.224744871391589*fskin[18]+0.7071067811865475*fskin[14]; 
  f_cl[7] = 1.58113883008419*fskin[24]-1.224744871391589*fskin[19]+0.7071067811865475*fskin[16]; 
  f_cl[8] = 1.58113883008419*fskin[26]-1.224744871391589*fskin[25]+0.7071067811865475*fskin[22]; 
  ...
  out[20] += 1.58113883008419*GhatL[4]*rdx2; 
  out[21] += 1.58113883008419*GhatL[5]*rdx2; 
  out[22] += 0.7071067811865475*GhatL[8]*rdx2; 
  out[23] += 1.58113883008419*GhatL[6]*rdx2; 
  out[24] += 1.58113883008419*GhatL[7]*rdx2; 
  out[25] += -1.224744871391589*GhatL[8]*rdx2; 
  out[26] += 1.58113883008419*GhatL[8]*rdx2; 
