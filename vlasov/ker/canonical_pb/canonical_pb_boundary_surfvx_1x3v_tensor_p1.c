...
{ 
  ...
  out[5] += -1.224744871391589*GhatR[1]*rdvx2; 
  out[6] += -0.7071067811865475*GhatR[4]*rdvx2; 
  out[7] += -1.224744871391589*GhatR[2]*rdvx2; 
  out[8] += -0.7071067811865475*GhatR[5]*rdvx2; 
  out[9] += -1.224744871391589*GhatR[3]*rdvx2; 
  out[10] += -0.7071067811865475*GhatR[6]*rdvx2; 
  out[11] += -1.224744871391589*GhatR[4]*rdvx2; 
  out[12] += -1.224744871391589*GhatR[5]*rdvx2; 
  out[13] += -0.7071067811865475*GhatR[7]*rdvx2; 
  ...
  out[5] += -1.224744871391589*GhatL[1]*rdvx2; 
  out[6] += 0.7071067811865475*GhatL[4]*rdvx2; 
  out[7] += -1.224744871391589*GhatL[2]*rdvx2; 
  out[8] += 0.7071067811865475*GhatL[5]*rdvx2; 
  out[9] += -1.224744871391589*GhatL[3]*rdvx2; 
  out[10] += 0.7071067811865475*GhatL[6]*rdvx2; 
  out[11] += -1.224744871391589*GhatL[4]*rdvx2; 
  out[12] += -1.224744871391589*GhatL[5]*rdvx2; 
  out[13] += 0.7071067811865475*GhatL[7]*rdvx2; 
