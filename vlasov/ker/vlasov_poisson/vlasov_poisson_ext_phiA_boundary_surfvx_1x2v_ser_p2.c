...
GKYL_CU_DH double vlasov_poisson_ext_phiA_boundary_surfvx_1x2v_ser_p2(const double *w, const double *dxv, const double *pots, const double *EBext, const int edge, const double *fEdge, const double *fSkin, double* GKYL_RESTRICT out) 
{ 
  ...
  Ghat[1] = 0.44721359549995804*alpha[3]*fUpwind[6]+0.4472135954999579*alpha[1]*fUpwind[4]+0.5*alpha[2]*fUpwind[3]+0.5*fUpwind[2]*alpha[3]+0.5*alpha[0]*fUpwind[1]+0.5*fUpwind[0]*alpha[1]; 
  Ghat[2] = 0.44721359549995804*alpha[3]*fUpwind[7]+0.4472135954999579*alpha[2]*fUpwind[5]+0.5*alpha[1]*fUpwind[3]+0.5*fUpwind[1]*alpha[3]+0.5*alpha[0]*fUpwind[2]+0.5*fUpwind[0]*alpha[2]; 
  Ghat[3] = 0.44721359549995804*alpha[2]*fUpwind[7]+0.44721359549995804*alpha[1]*fUpwind[6]+0.4472135954999579*alpha[3]*fUpwind[5]+0.4472135954999579*alpha[3]*fUpwind[4]+0.5*alpha[0]*fUpwind[3]+0.5*fUpwind[0]*alpha[3]+0.5*alpha[1]*fUpwind[2]+0.5*fUpwind[1]*alpha[2]; 
  ...
  Ghat[6] = 0.4*alpha[3]*fUpwind[7]+0.5*alpha[0]*fUpwind[6]+0.5000000000000001*alpha[2]*fUpwind[4]+0.44721359549995804*alpha[1]*fUpwind[3]+0.44721359549995804*fUpwind[1]*alpha[3]; 
  Ghat[7] = 0.5*alpha[0]*fUpwind[7]+0.4*alpha[3]*fUpwind[6]+0.5000000000000001*alpha[1]*fUpwind[5]+0.44721359549995804*alpha[2]*fUpwind[3]+0.44721359549995804*fUpwind[2]*alpha[3]; 
