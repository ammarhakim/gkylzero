...
{ 
  ...
  alpha[0] = 3.4641016151377544*Az[1]*dx10*wv3+3.4641016151377544*Ay[1]*dx10*wv2-3.4641016151377544*phi[1]*dx10; 
  alpha[1] = 7.745966692414834*Az[2]*dx10*wv3+7.745966692414834*Ay[2]*dx10*wv2-7.745966692414834*phi[2]*dx10; 
  alpha[2] = Ay[1]*dv2*dx10; 
  alpha[3] = Az[1]*dv3*dx10; 
  alpha[4] = 2.23606797749979*Ay[2]*dv2*dx10; 
  alpha[5] = 2.23606797749979*Az[2]*dv3*dx10; 
  ...
  Ghat_l[1] = 0.31622776601683794*alpha[5]*fUpwind_l[13]+0.31622776601683794*alpha[4]*fUpwind_l[11]+0.3162277660168379*alpha[1]*fUpwind_l[7]+0.3535533905932737*alpha[3]*fUpwind_l[5]+0.3535533905932737*fUpwind_l[3]*alpha[5]+0.3535533905932737*alpha[2]*fUpwind_l[4]+0.3535533905932737*fUpwind_l[2]*alpha[4]+0.3535533905932737*alpha[0]*fUpwind_l[1]+0.3535533905932737*fUpwind_l[0]*alpha[1]; 
  Ghat_l[2] = 0.31622776601683794*alpha[4]*fUpwind_l[12]+0.3535533905932737*alpha[5]*fUpwind_l[10]+0.3162277660168379*alpha[2]*fUpwind_l[8]+0.3535533905932737*alpha[3]*fUpwind_l[6]+0.3535533905932737*alpha[1]*fUpwind_l[4]+0.3535533905932737*fUpwind_l[1]*alpha[4]+0.3535533905932737*alpha[0]*fUpwind_l[2]+0.3535533905932737*fUpwind_l[0]*alpha[2]; 
  Ghat_l[3] = 0.31622776601683794*alpha[5]*fUpwind_l[15]+0.3535533905932737*alpha[4]*fUpwind_l[10]+0.3162277660168379*alpha[3]*fUpwind_l[9]+0.3535533905932737*alpha[2]*fUpwind_l[6]+0.3535533905932737*alpha[1]*fUpwind_l[5]+0.3535533905932737*fUpwind_l[1]*alpha[5]+0.3535533905932737*alpha[0]*fUpwind_l[3]+0.3535533905932737*fUpwind_l[0]*alpha[3]; 
  Ghat_l[4] = 0.3162277660168379*alpha[5]*fUpwind_l[17]+0.31622776601683794*alpha[2]*fUpwind_l[12]+0.31622776601683794*alpha[1]*fUpwind_l[11]+0.3535533905932737*alpha[3]*fUpwind_l[10]+0.3162277660168379*alpha[4]*fUpwind_l[8]+0.3162277660168379*alpha[4]*fUpwind_l[7]+0.3535533905932737*alpha[5]*fUpwind_l[6]+0.3535533905932737*alpha[0]*fUpwind_l[4]+0.3535533905932737*fUpwind_l[0]*alpha[4]+0.3535533905932737*alpha[1]*fUpwind_l[2]+0.3535533905932737*fUpwind_l[1]*alpha[2]; 
  Ghat_l[5] = 0.3162277660168379*alpha[4]*fUpwind_l[17]+0.31622776601683794*alpha[3]*fUpwind_l[15]+0.31622776601683794*alpha[1]*fUpwind_l[13]+0.3535533905932737*alpha[2]*fUpwind_l[10]+0.3162277660168379*alpha[5]*fUpwind_l[9]+0.3162277660168379*alpha[5]*fUpwind_l[7]+0.3535533905932737*alpha[4]*fUpwind_l[6]+0.3535533905932737*alpha[0]*fUpwind_l[5]+0.3535533905932737*fUpwind_l[0]*alpha[5]+0.3535533905932737*alpha[1]*fUpwind_l[3]+0.3535533905932737*fUpwind_l[1]*alpha[3]; 
  Ghat_l[6] = 0.3162277660168379*alpha[5]*fUpwind_l[19]+0.3162277660168379*alpha[4]*fUpwind_l[18]+0.31622776601683794*alpha[3]*fUpwind_l[16]+0.31622776601683794*alpha[2]*fUpwind_l[14]+0.3535533905932737*alpha[1]*fUpwind_l[10]+0.3535533905932737*alpha[0]*fUpwind_l[6]+0.3535533905932737*alpha[4]*fUpwind_l[5]+0.3535533905932737*fUpwind_l[4]*alpha[5]+0.3535533905932737*alpha[2]*fUpwind_l[3]+0.3535533905932737*fUpwind_l[2]*alpha[3]; 
  ...
  Ghat_l[10] = 0.3162277660168379*alpha[3]*fUpwind_l[19]+0.3162277660168379*alpha[2]*fUpwind_l[18]+0.3162277660168379*alpha[1]*fUpwind_l[17]+0.31622776601683794*alpha[5]*fUpwind_l[16]+0.31622776601683794*alpha[4]*fUpwind_l[14]+0.31622776601683794*alpha[4]*fUpwind_l[13]+0.31622776601683794*alpha[5]*fUpwind_l[11]+0.3535533905932737*alpha[0]*fUpwind_l[10]+0.3535533905932737*alpha[1]*fUpwind_l[6]+0.3535533905932737*alpha[2]*fUpwind_l[5]+0.3535533905932737*fUpwind_l[2]*alpha[5]+0.3535533905932737*alpha[3]*fUpwind_l[4]+0.3535533905932737*fUpwind_l[3]*alpha[4]; 
  Ghat_l[11] = 0.3535533905932737*alpha[3]*fUpwind_l[17]+0.28284271247461906*alpha[4]*fUpwind_l[12]+0.3535533905932737*alpha[0]*fUpwind_l[11]+0.31622776601683794*alpha[5]*fUpwind_l[10]+0.3535533905932737*alpha[2]*fUpwind_l[7]+0.31622776601683794*alpha[1]*fUpwind_l[4]+0.31622776601683794*fUpwind_l[1]*alpha[4]; 
  Ghat_l[12] = 0.3535533905932737*alpha[3]*fUpwind_l[18]+0.3535533905932737*alpha[5]*fUpwind_l[14]+0.3535533905932737*alpha[0]*fUpwind_l[12]+0.28284271247461906*alpha[4]*fUpwind_l[11]+0.3535533905932737*alpha[1]*fUpwind_l[8]+0.31622776601683794*alpha[2]*fUpwind_l[4]+0.31622776601683794*fUpwind_l[2]*alpha[4]; 
  Ghat_l[13] = 0.3535533905932737*alpha[2]*fUpwind_l[17]+0.28284271247461906*alpha[5]*fUpwind_l[15]+0.3535533905932737*alpha[0]*fUpwind_l[13]+0.31622776601683794*alpha[4]*fUpwind_l[10]+0.3535533905932737*alpha[3]*fUpwind_l[7]+0.31622776601683794*alpha[1]*fUpwind_l[5]+0.31622776601683794*fUpwind_l[1]*alpha[5]; 
  Ghat_l[14] = 0.3535533905932737*alpha[1]*fUpwind_l[18]+0.3535533905932737*alpha[0]*fUpwind_l[14]+0.3535533905932737*alpha[5]*fUpwind_l[12]+0.31622776601683794*alpha[4]*fUpwind_l[10]+0.3535533905932737*alpha[3]*fUpwind_l[8]+0.31622776601683794*alpha[2]*fUpwind_l[6]; 
  Ghat_l[15] = 0.3535533905932737*alpha[2]*fUpwind_l[19]+0.3535533905932737*alpha[4]*fUpwind_l[16]+0.3535533905932737*alpha[0]*fUpwind_l[15]+0.28284271247461906*alpha[5]*fUpwind_l[13]+0.3535533905932737*alpha[1]*fUpwind_l[9]+0.31622776601683794*alpha[3]*fUpwind_l[5]+0.31622776601683794*fUpwind_l[3]*alpha[5]; 
  Ghat_l[16] = 0.3535533905932737*alpha[1]*fUpwind_l[19]+0.3535533905932737*alpha[0]*fUpwind_l[16]+0.3535533905932737*alpha[4]*fUpwind_l[15]+0.31622776601683794*alpha[5]*fUpwind_l[10]+0.3535533905932737*alpha[2]*fUpwind_l[9]+0.31622776601683794*alpha[3]*fUpwind_l[6]; 
  Ghat_l[17] = 0.28284271247461906*alpha[5]*fUpwind_l[19]+0.28284271247461906*alpha[4]*fUpwind_l[18]+0.3535533905932737*alpha[0]*fUpwind_l[17]+0.3535533905932737*alpha[2]*fUpwind_l[13]+0.3535533905932737*alpha[3]*fUpwind_l[11]+0.3162277660168379*alpha[1]*fUpwind_l[10]+0.3162277660168379*alpha[4]*fUpwind_l[5]+0.3162277660168379*fUpwind_l[4]*alpha[5]; 
  Ghat_l[18] = 0.3535533905932737*alpha[0]*fUpwind_l[18]+0.28284271247461906*alpha[4]*fUpwind_l[17]+0.3535533905932737*alpha[1]*fUpwind_l[14]+0.3535533905932737*alpha[3]*fUpwind_l[12]+0.3162277660168379*alpha[2]*fUpwind_l[10]+0.3535533905932737*alpha[5]*fUpwind_l[8]+0.3162277660168379*alpha[4]*fUpwind_l[6]; 
  Ghat_l[19] = 0.3535533905932737*alpha[0]*fUpwind_l[19]+0.28284271247461906*alpha[5]*fUpwind_l[17]+0.3535533905932737*alpha[1]*fUpwind_l[16]+0.3535533905932737*alpha[2]*fUpwind_l[15]+0.3162277660168379*alpha[3]*fUpwind_l[10]+0.3535533905932737*alpha[4]*fUpwind_l[9]+0.3162277660168379*alpha[5]*fUpwind_l[6]; 
  ...
  Ghat_r[10] = 0.3162277660168379*alpha[3]*fUpwind_r[19]+0.3162277660168379*alpha[2]*fUpwind_r[18]+0.3162277660168379*alpha[1]*fUpwind_r[17]+0.31622776601683794*alpha[5]*fUpwind_r[16]+0.31622776601683794*alpha[4]*fUpwind_r[14]+0.31622776601683794*alpha[4]*fUpwind_r[13]+0.31622776601683794*alpha[5]*fUpwind_r[11]+0.3535533905932737*alpha[0]*fUpwind_r[10]+0.3535533905932737*alpha[1]*fUpwind_r[6]+0.3535533905932737*alpha[2]*fUpwind_r[5]+0.3535533905932737*fUpwind_r[2]*alpha[5]+0.3535533905932737*alpha[3]*fUpwind_r[4]+0.3535533905932737*fUpwind_r[3]*alpha[4]; 
  Ghat_r[11] = 0.3535533905932737*alpha[3]*fUpwind_r[17]+0.28284271247461906*alpha[4]*fUpwind_r[12]+0.3535533905932737*alpha[0]*fUpwind_r[11]+0.31622776601683794*alpha[5]*fUpwind_r[10]+0.3535533905932737*alpha[2]*fUpwind_r[7]+0.31622776601683794*alpha[1]*fUpwind_r[4]+0.31622776601683794*fUpwind_r[1]*alpha[4]; 
  Ghat_r[12] = 0.3535533905932737*alpha[3]*fUpwind_r[18]+0.3535533905932737*alpha[5]*fUpwind_r[14]+0.3535533905932737*alpha[0]*fUpwind_r[12]+0.28284271247461906*alpha[4]*fUpwind_r[11]+0.3535533905932737*alpha[1]*fUpwind_r[8]+0.31622776601683794*alpha[2]*fUpwind_r[4]+0.31622776601683794*fUpwind_r[2]*alpha[4]; 
  Ghat_r[13] = 0.3535533905932737*alpha[2]*fUpwind_r[17]+0.28284271247461906*alpha[5]*fUpwind_r[15]+0.3535533905932737*alpha[0]*fUpwind_r[13]+0.31622776601683794*alpha[4]*fUpwind_r[10]+0.3535533905932737*alpha[3]*fUpwind_r[7]+0.31622776601683794*alpha[1]*fUpwind_r[5]+0.31622776601683794*fUpwind_r[1]*alpha[5]; 
  Ghat_r[14] = 0.3535533905932737*alpha[1]*fUpwind_r[18]+0.3535533905932737*alpha[0]*fUpwind_r[14]+0.3535533905932737*alpha[5]*fUpwind_r[12]+0.31622776601683794*alpha[4]*fUpwind_r[10]+0.3535533905932737*alpha[3]*fUpwind_r[8]+0.31622776601683794*alpha[2]*fUpwind_r[6]; 
  Ghat_r[15] = 0.3535533905932737*alpha[2]*fUpwind_r[19]+0.3535533905932737*alpha[4]*fUpwind_r[16]+0.3535533905932737*alpha[0]*fUpwind_r[15]+0.28284271247461906*alpha[5]*fUpwind_r[13]+0.3535533905932737*alpha[1]*fUpwind_r[9]+0.31622776601683794*alpha[3]*fUpwind_r[5]+0.31622776601683794*fUpwind_r[3]*alpha[5]; 
  Ghat_r[16] = 0.3535533905932737*alpha[1]*fUpwind_r[19]+0.3535533905932737*alpha[0]*fUpwind_r[16]+0.3535533905932737*alpha[4]*fUpwind_r[15]+0.31622776601683794*alpha[5]*fUpwind_r[10]+0.3535533905932737*alpha[2]*fUpwind_r[9]+0.31622776601683794*alpha[3]*fUpwind_r[6]; 
  Ghat_r[17] = 0.28284271247461906*alpha[5]*fUpwind_r[19]+0.28284271247461906*alpha[4]*fUpwind_r[18]+0.3535533905932737*alpha[0]*fUpwind_r[17]+0.3535533905932737*alpha[2]*fUpwind_r[13]+0.3535533905932737*alpha[3]*fUpwind_r[11]+0.3162277660168379*alpha[1]*fUpwind_r[10]+0.3162277660168379*alpha[4]*fUpwind_r[5]+0.3162277660168379*fUpwind_r[4]*alpha[5]; 
  Ghat_r[18] = 0.3535533905932737*alpha[0]*fUpwind_r[18]+0.28284271247461906*alpha[4]*fUpwind_r[17]+0.3535533905932737*alpha[1]*fUpwind_r[14]+0.3535533905932737*alpha[3]*fUpwind_r[12]+0.3162277660168379*alpha[2]*fUpwind_r[10]+0.3535533905932737*alpha[5]*fUpwind_r[8]+0.3162277660168379*alpha[4]*fUpwind_r[6]; 
  Ghat_r[19] = 0.3535533905932737*alpha[0]*fUpwind_r[19]+0.28284271247461906*alpha[5]*fUpwind_r[17]+0.3535533905932737*alpha[1]*fUpwind_r[16]+0.3535533905932737*alpha[2]*fUpwind_r[15]+0.3162277660168379*alpha[3]*fUpwind_r[10]+0.3535533905932737*alpha[4]*fUpwind_r[9]+0.3162277660168379*alpha[5]*fUpwind_r[6]; 
