...
{ 
  ...
  alpha[0] = 2.4494897427831783*Ay[1]*dx10*wv2-2.4494897427831783*phi[1]*dx10; 
  alpha[1] = 5.477225575051662*Ay[2]*dx10*wv2-5.477225575051662*phi[2]*dx10; 
  alpha[2] = 0.7071067811865475*Ay[1]*dv2*dx10; 
  alpha[3] = 1.5811388300841895*Ay[2]*dv2*dx10; 
  ...
  Ghat_l[1] = 0.44721359549995804*alpha[3]*fUpwind_l[6]+0.4472135954999579*alpha[1]*fUpwind_l[4]+0.5*alpha[2]*fUpwind_l[3]+0.5*fUpwind_l[2]*alpha[3]+0.5*alpha[0]*fUpwind_l[1]+0.5*fUpwind_l[0]*alpha[1]; 
  Ghat_l[2] = 0.44721359549995804*alpha[3]*fUpwind_l[7]+0.4472135954999579*alpha[2]*fUpwind_l[5]+0.5*alpha[1]*fUpwind_l[3]+0.5*fUpwind_l[1]*alpha[3]+0.5*alpha[0]*fUpwind_l[2]+0.5*fUpwind_l[0]*alpha[2]; 
  Ghat_l[3] = 0.44721359549995804*alpha[2]*fUpwind_l[7]+0.44721359549995804*alpha[1]*fUpwind_l[6]+0.4472135954999579*alpha[3]*fUpwind_l[5]+0.4472135954999579*alpha[3]*fUpwind_l[4]+0.5*alpha[0]*fUpwind_l[3]+0.5*fUpwind_l[0]*alpha[3]+0.5*alpha[1]*fUpwind_l[2]+0.5*fUpwind_l[1]*alpha[2]; 
  ...
  Ghat_l[6] = 0.4*alpha[3]*fUpwind_l[7]+0.5*alpha[0]*fUpwind_l[6]+0.5000000000000001*alpha[2]*fUpwind_l[4]+0.44721359549995804*alpha[1]*fUpwind_l[3]+0.44721359549995804*fUpwind_l[1]*alpha[3]; 
  Ghat_l[7] = 0.5*alpha[0]*fUpwind_l[7]+0.4*alpha[3]*fUpwind_l[6]+0.5000000000000001*alpha[1]*fUpwind_l[5]+0.44721359549995804*alpha[2]*fUpwind_l[3]+0.44721359549995804*fUpwind_l[2]*alpha[3]; 

  Ghat_r[0] = 0.5*alpha[3]*fUpwind_r[3]+0.5*alpha[2]*fUpwind_r[2]+0.5*alpha[1]*fUpwind_r[1]+0.5*alpha[0]*fUpwind_r[0]; 
  Ghat_r[1] = 0.44721359549995804*alpha[3]*fUpwind_r[6]+0.4472135954999579*alpha[1]*fUpwind_r[4]+0.5*alpha[2]*fUpwind_r[3]+0.5*fUpwind_r[2]*alpha[3]+0.5*alpha[0]*fUpwind_r[1]+0.5*fUpwind_r[0]*alpha[1]; 
  Ghat_r[2] = 0.44721359549995804*alpha[3]*fUpwind_r[7]+0.4472135954999579*alpha[2]*fUpwind_r[5]+0.5*alpha[1]*fUpwind_r[3]+0.5*fUpwind_r[1]*alpha[3]+0.5*alpha[0]*fUpwind_r[2]+0.5*fUpwind_r[0]*alpha[2]; 
  Ghat_r[3] = 0.44721359549995804*alpha[2]*fUpwind_r[7]+0.44721359549995804*alpha[1]*fUpwind_r[6]+0.4472135954999579*alpha[3]*fUpwind_r[5]+0.4472135954999579*alpha[3]*fUpwind_r[4]+0.5*alpha[0]*fUpwind_r[3]+0.5*fUpwind_r[0]*alpha[3]+0.5*alpha[1]*fUpwind_r[2]+0.5*fUpwind_r[1]*alpha[2]; 
  ...
  Ghat_r[6] = 0.4*alpha[3]*fUpwind_r[7]+0.5*alpha[0]*fUpwind_r[6]+0.5000000000000001*alpha[2]*fUpwind_r[4]+0.44721359549995804*alpha[1]*fUpwind_r[3]+0.44721359549995804*fUpwind_r[1]*alpha[3]; 
  Ghat_r[7] = 0.5*alpha[0]*fUpwind_r[7]+0.4*alpha[3]*fUpwind_r[6]+0.5000000000000001*alpha[1]*fUpwind_r[5]+0.44721359549995804*alpha[2]*fUpwind_r[3]+0.44721359549995804*fUpwind_r[2]*alpha[3]; 
