...
{ 
  ...
  alpha[7] = -(2.4494897427831783*phi[6]*dx11); 
  ...
  Ghat_l[1] = 0.31622776601683794*alpha[4]*fUpwind_l[11]+0.3162277660168379*alpha[1]*fUpwind_l[7]+0.3162277660168379*fUpwind_l[1]*alpha[7]+0.3535533905932737*alpha[2]*fUpwind_l[4]+0.3535533905932737*fUpwind_l[2]*alpha[4]+0.3535533905932737*alpha[0]*fUpwind_l[1]+0.3535533905932737*fUpwind_l[0]*alpha[1]; 
  Ghat_l[2] = 0.31622776601683794*alpha[4]*fUpwind_l[12]+0.3535533905932737*alpha[7]*fUpwind_l[11]+0.3162277660168379*alpha[2]*fUpwind_l[8]+0.3535533905932737*alpha[1]*fUpwind_l[4]+0.3535533905932737*fUpwind_l[1]*alpha[4]+0.3535533905932737*alpha[0]*fUpwind_l[2]+0.3535533905932737*fUpwind_l[0]*alpha[2]; 
  ...
  Ghat_l[5] = 0.3162277660168379*alpha[4]*fUpwind_l[17]+0.31622776601683794*alpha[1]*fUpwind_l[13]+0.3535533905932737*alpha[2]*fUpwind_l[10]+0.3162277660168379*fUpwind_l[5]*alpha[7]+0.3535533905932737*alpha[4]*fUpwind_l[6]+0.3535533905932737*alpha[0]*fUpwind_l[5]+0.3535533905932737*alpha[1]*fUpwind_l[3]; 
  Ghat_l[6] = 0.3162277660168379*alpha[4]*fUpwind_l[18]+0.3535533905932737*alpha[7]*fUpwind_l[17]+0.31622776601683794*alpha[2]*fUpwind_l[14]+0.3535533905932737*alpha[1]*fUpwind_l[10]+0.3535533905932737*alpha[0]*fUpwind_l[6]+0.3535533905932737*alpha[4]*fUpwind_l[5]+0.3535533905932737*alpha[2]*fUpwind_l[3]; 
  Ghat_l[7] = 0.3535533905932737*alpha[2]*fUpwind_l[11]+0.22587697572631277*alpha[7]*fUpwind_l[7]+0.3535533905932737*alpha[0]*fUpwind_l[7]+0.3535533905932737*fUpwind_l[0]*alpha[7]+0.3162277660168379*alpha[4]*fUpwind_l[4]+0.3162277660168379*alpha[1]*fUpwind_l[1]; 
  ...
  Ghat_l[10] = 0.3162277660168379*alpha[2]*fUpwind_l[18]+0.3162277660168379*alpha[1]*fUpwind_l[17]+0.31622776601683794*alpha[4]*fUpwind_l[14]+0.31622776601683794*alpha[4]*fUpwind_l[13]+0.3162277660168379*alpha[7]*fUpwind_l[10]+0.3535533905932737*alpha[0]*fUpwind_l[10]+0.3535533905932737*alpha[1]*fUpwind_l[6]+0.3535533905932737*alpha[2]*fUpwind_l[5]+0.3535533905932737*fUpwind_l[3]*alpha[4]; 
  Ghat_l[11] = 0.28284271247461906*alpha[4]*fUpwind_l[12]+0.22587697572631277*alpha[7]*fUpwind_l[11]+0.3535533905932737*alpha[0]*fUpwind_l[11]+0.3535533905932737*alpha[2]*fUpwind_l[7]+0.3535533905932737*fUpwind_l[2]*alpha[7]+0.31622776601683794*alpha[1]*fUpwind_l[4]+0.31622776601683794*fUpwind_l[1]*alpha[4]; 
  Ghat_l[12] = 0.3162277660168379*alpha[7]*fUpwind_l[12]+0.3535533905932737*alpha[0]*fUpwind_l[12]+0.28284271247461906*alpha[4]*fUpwind_l[11]+0.3535533905932737*alpha[1]*fUpwind_l[8]+0.31622776601683794*alpha[2]*fUpwind_l[4]+0.31622776601683794*fUpwind_l[2]*alpha[4]; 
  Ghat_l[13] = 0.3535533905932737*alpha[2]*fUpwind_l[17]+0.22587697572631277*alpha[7]*fUpwind_l[13]+0.3535533905932737*alpha[0]*fUpwind_l[13]+0.31622776601683794*alpha[4]*fUpwind_l[10]+0.3535533905932737*fUpwind_l[3]*alpha[7]+0.31622776601683794*alpha[1]*fUpwind_l[5]; 
  Ghat_l[14] = 0.3535533905932737*alpha[1]*fUpwind_l[18]+0.3535533905932737*alpha[0]*fUpwind_l[14]+0.31622776601683794*alpha[4]*fUpwind_l[10]+0.31622776601683794*alpha[2]*fUpwind_l[6]; 
  ...
  Ghat_l[17] = 0.28284271247461906*alpha[4]*fUpwind_l[18]+0.22587697572631277*alpha[7]*fUpwind_l[17]+0.3535533905932737*alpha[0]*fUpwind_l[17]+0.3535533905932737*alpha[2]*fUpwind_l[13]+0.3162277660168379*alpha[1]*fUpwind_l[10]+0.3535533905932737*fUpwind_l[6]*alpha[7]+0.3162277660168379*alpha[4]*fUpwind_l[5]; 
  Ghat_l[18] = 0.3162277660168379*alpha[7]*fUpwind_l[18]+0.3535533905932737*alpha[0]*fUpwind_l[18]+0.28284271247461906*alpha[4]*fUpwind_l[17]+0.3535533905932737*alpha[1]*fUpwind_l[14]+0.3162277660168379*alpha[2]*fUpwind_l[10]+0.3162277660168379*alpha[4]*fUpwind_l[6]; 
  ...
  Ghat_r[1] = 0.31622776601683794*alpha[4]*fUpwind_r[11]+0.3162277660168379*alpha[1]*fUpwind_r[7]+0.3162277660168379*fUpwind_r[1]*alpha[7]+0.3535533905932737*alpha[2]*fUpwind_r[4]+0.3535533905932737*fUpwind_r[2]*alpha[4]+0.3535533905932737*alpha[0]*fUpwind_r[1]+0.3535533905932737*fUpwind_r[0]*alpha[1]; 
  Ghat_r[2] = 0.31622776601683794*alpha[4]*fUpwind_r[12]+0.3535533905932737*alpha[7]*fUpwind_r[11]+0.3162277660168379*alpha[2]*fUpwind_r[8]+0.3535533905932737*alpha[1]*fUpwind_r[4]+0.3535533905932737*fUpwind_r[1]*alpha[4]+0.3535533905932737*alpha[0]*fUpwind_r[2]+0.3535533905932737*fUpwind_r[0]*alpha[2]; 
  ...
  Ghat_r[5] = 0.3162277660168379*alpha[4]*fUpwind_r[17]+0.31622776601683794*alpha[1]*fUpwind_r[13]+0.3535533905932737*alpha[2]*fUpwind_r[10]+0.3162277660168379*fUpwind_r[5]*alpha[7]+0.3535533905932737*alpha[4]*fUpwind_r[6]+0.3535533905932737*alpha[0]*fUpwind_r[5]+0.3535533905932737*alpha[1]*fUpwind_r[3]; 
  Ghat_r[6] = 0.3162277660168379*alpha[4]*fUpwind_r[18]+0.3535533905932737*alpha[7]*fUpwind_r[17]+0.31622776601683794*alpha[2]*fUpwind_r[14]+0.3535533905932737*alpha[1]*fUpwind_r[10]+0.3535533905932737*alpha[0]*fUpwind_r[6]+0.3535533905932737*alpha[4]*fUpwind_r[5]+0.3535533905932737*alpha[2]*fUpwind_r[3]; 
  Ghat_r[7] = 0.3535533905932737*alpha[2]*fUpwind_r[11]+0.22587697572631277*alpha[7]*fUpwind_r[7]+0.3535533905932737*alpha[0]*fUpwind_r[7]+0.3535533905932737*fUpwind_r[0]*alpha[7]+0.3162277660168379*alpha[4]*fUpwind_r[4]+0.3162277660168379*alpha[1]*fUpwind_r[1]; 
  ...
  Ghat_r[10] = 0.3162277660168379*alpha[2]*fUpwind_r[18]+0.3162277660168379*alpha[1]*fUpwind_r[17]+0.31622776601683794*alpha[4]*fUpwind_r[14]+0.31622776601683794*alpha[4]*fUpwind_r[13]+0.3162277660168379*alpha[7]*fUpwind_r[10]+0.3535533905932737*alpha[0]*fUpwind_r[10]+0.3535533905932737*alpha[1]*fUpwind_r[6]+0.3535533905932737*alpha[2]*fUpwind_r[5]+0.3535533905932737*fUpwind_r[3]*alpha[4]; 
  Ghat_r[11] = 0.28284271247461906*alpha[4]*fUpwind_r[12]+0.22587697572631277*alpha[7]*fUpwind_r[11]+0.3535533905932737*alpha[0]*fUpwind_r[11]+0.3535533905932737*alpha[2]*fUpwind_r[7]+0.3535533905932737*fUpwind_r[2]*alpha[7]+0.31622776601683794*alpha[1]*fUpwind_r[4]+0.31622776601683794*fUpwind_r[1]*alpha[4]; 
  Ghat_r[12] = 0.3162277660168379*alpha[7]*fUpwind_r[12]+0.3535533905932737*alpha[0]*fUpwind_r[12]+0.28284271247461906*alpha[4]*fUpwind_r[11]+0.3535533905932737*alpha[1]*fUpwind_r[8]+0.31622776601683794*alpha[2]*fUpwind_r[4]+0.31622776601683794*fUpwind_r[2]*alpha[4]; 
  Ghat_r[13] = 0.3535533905932737*alpha[2]*fUpwind_r[17]+0.22587697572631277*alpha[7]*fUpwind_r[13]+0.3535533905932737*alpha[0]*fUpwind_r[13]+0.31622776601683794*alpha[4]*fUpwind_r[10]+0.3535533905932737*fUpwind_r[3]*alpha[7]+0.31622776601683794*alpha[1]*fUpwind_r[5]; 
  Ghat_r[14] = 0.3535533905932737*alpha[1]*fUpwind_r[18]+0.3535533905932737*alpha[0]*fUpwind_r[14]+0.31622776601683794*alpha[4]*fUpwind_r[10]+0.31622776601683794*alpha[2]*fUpwind_r[6]; 
  ...
  Ghat_r[17] = 0.28284271247461906*alpha[4]*fUpwind_r[18]+0.22587697572631277*alpha[7]*fUpwind_r[17]+0.3535533905932737*alpha[0]*fUpwind_r[17]+0.3535533905932737*alpha[2]*fUpwind_r[13]+0.3162277660168379*alpha[1]*fUpwind_r[10]+0.3535533905932737*fUpwind_r[6]*alpha[7]+0.3162277660168379*alpha[4]*fUpwind_r[5]; 
  Ghat_r[18] = 0.3162277660168379*alpha[7]*fUpwind_r[18]+0.3535533905932737*alpha[0]*fUpwind_r[18]+0.28284271247461906*alpha[4]*fUpwind_r[17]+0.3535533905932737*alpha[1]*fUpwind_r[14]+0.3162277660168379*alpha[2]*fUpwind_r[10]+0.3162277660168379*alpha[4]*fUpwind_r[6]; 
