...
{ 
  ...
  Ghat_l[4] = 0.31622776601683794*alpha[1]*fUpwind_l[11]+0.3535533905932737*alpha[0]*fUpwind_l[4]+0.3535533905932737*alpha[1]*fUpwind_l[2]; 
  Ghat_l[5] = 0.31622776601683794*alpha[1]*fUpwind_l[13]+0.3535533905932737*alpha[0]*fUpwind_l[5]+0.3535533905932737*alpha[1]*fUpwind_l[3]; 
  ...
  Ghat_l[11] = 0.3535533905932737*alpha[0]*fUpwind_l[11]+0.31622776601683794*alpha[1]*fUpwind_l[4]; 
  Ghat_l[12] = 0.3535533905932737*alpha[0]*fUpwind_l[12]+0.3535533905932737*alpha[1]*fUpwind_l[8]; 
  Ghat_l[13] = 0.3535533905932737*alpha[0]*fUpwind_l[13]+0.31622776601683794*alpha[1]*fUpwind_l[5]; 
  ...
  Ghat_r[4] = 0.31622776601683794*alpha[1]*fUpwind_r[11]+0.3535533905932737*alpha[0]*fUpwind_r[4]+0.3535533905932737*alpha[1]*fUpwind_r[2]; 
  Ghat_r[5] = 0.31622776601683794*alpha[1]*fUpwind_r[13]+0.3535533905932737*alpha[0]*fUpwind_r[5]+0.3535533905932737*alpha[1]*fUpwind_r[3]; 
  ...
  Ghat_r[11] = 0.3535533905932737*alpha[0]*fUpwind_r[11]+0.31622776601683794*alpha[1]*fUpwind_r[4]; 
  Ghat_r[12] = 0.3535533905932737*alpha[0]*fUpwind_r[12]+0.3535533905932737*alpha[1]*fUpwind_r[8]; 
  Ghat_r[13] = 0.3535533905932737*alpha[0]*fUpwind_r[13]+0.31622776601683794*alpha[1]*fUpwind_r[5]; 
