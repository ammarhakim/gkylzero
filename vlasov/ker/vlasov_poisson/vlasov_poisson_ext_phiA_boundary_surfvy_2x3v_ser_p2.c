...
GKYL_CU_DH double vlasov_poisson_ext_phiA_boundary_surfvy_2x3v_ser_p2(const double *w, const double *dxv, const double *pots, const double *EBext, const int edge, const double *fEdge, const double *fSkin, double* GKYL_RESTRICT out) 
{ 
  ...
  Ghat[11] = 0.25*alpha[9]*fUpwind[35]+0.25*alpha[7]*fUpwind[32]+0.15971914124998499*alpha[25]*fUpwind[25]+0.25000000000000006*alpha[4]*fUpwind[25]+0.25000000000000006*fUpwind[4]*alpha[25]+0.15971914124998499*alpha[21]*fUpwind[21]+0.25000000000000006*alpha[3]*fUpwind[21]+0.25000000000000006*fUpwind[3]*alpha[21]+0.25000000000000006*alpha[2]*fUpwind[19]+0.22360679774997896*alpha[16]*fUpwind[16]+0.22360679774997896*alpha[15]*fUpwind[15]+0.15971914124998499*alpha[11]*fUpwind[11]+0.25*alpha[0]*fUpwind[11]+0.25*fUpwind[0]*alpha[11]+0.22360679774997896*alpha[8]*fUpwind[8]+0.22360679774997896*alpha[6]*fUpwind[6]+0.22360679774997896*alpha[5]*fUpwind[5]+0.22360679774997896*alpha[1]*fUpwind[1]; 
  ...
  Ghat[28] = 0.25*alpha[7]*fUpwind[47]+0.25000000000000006*alpha[15]*fUpwind[43]+0.22360679774997896*alpha[21]*fUpwind[42]+0.25000000000000006*alpha[3]*fUpwind[42]+0.25000000000000006*alpha[2]*fUpwind[41]+0.2*alpha[16]*fUpwind[35]+0.25*alpha[6]*fUpwind[30]+0.25*alpha[5]*fUpwind[29]+0.22360679774997896*alpha[11]*fUpwind[28]+0.25*alpha[0]*fUpwind[28]+0.2*alpha[8]*fUpwind[25]+0.2*fUpwind[8]*alpha[25]+0.22360679774997902*alpha[9]*fUpwind[16]+0.22360679774997902*fUpwind[9]*alpha[16]+0.25000000000000006*alpha[1]*fUpwind[14]+0.22360679774997902*alpha[4]*fUpwind[8]+0.22360679774997902*fUpwind[4]*alpha[8]; 
  ...
  Ghat[42] = 0.25000000000000006*alpha[2]*fUpwind[47]+0.2*alpha[16]*fUpwind[44]+0.25*alpha[5]*fUpwind[43]+0.22360679774997896*alpha[11]*fUpwind[42]+0.25*alpha[0]*fUpwind[42]+0.25*alpha[7]*fUpwind[41]+0.2*alpha[8]*fUpwind[37]+0.22360679774997896*alpha[9]*fUpwind[31]+0.25000000000000006*alpha[1]*fUpwind[30]+0.25000000000000006*alpha[15]*fUpwind[29]+0.22360679774997896*alpha[21]*fUpwind[28]+0.25000000000000006*alpha[3]*fUpwind[28]+0.2*fUpwind[17]*alpha[25]+0.22360679774997896*alpha[16]*fUpwind[18]+0.22360679774997896*alpha[4]*fUpwind[17]+0.25*alpha[6]*fUpwind[14]+0.22360679774997896*alpha[8]*fUpwind[10]; 
