...
GKYL_CU_DH double vlasov_poisson_ext_EB_boundary_surfvx_2x3v_ser_p1(const double *w, const double *dxv, const double *pots, const double *EBext, const int edge, const double *fEdge, const double *fSkin, double* GKYL_RESTRICT out) 
{ 
  ...
  alpha[5] = -(2.0*By[3]*wv3)+2.0*Bz[3]*wv2+2.0*Ex[3]; 
  ...
  alpha[11] = 0.5773502691896258*Bz[3]*dv2; 
  alpha[12] = -(0.5773502691896258*By[3]*dv3); 
