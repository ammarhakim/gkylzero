...
GKYL_CU_DH void fpo_diff_coeff_cross_1x3v_vzvy_ser_p1_upvz_lovy(const double *dxv, const double *gamma, const double* fpo_g_stencil[9], const double* fpo_g_surf_stencil[9], const double* fpo_dgdv_surf, double *diff_coeff) { 
  ...
  surft1_up[1] = 0.599071547271275*GCR[29]+0.599071547271275*GCC[29]-0.8617863895711042*GCR[13]+0.8617863895711042*GCC[13]+0.6123724356957944*GCR[8]+0.6123724356957944*GCC[8]; 
  surft1_up[2] = 0.599071547271275*GCR[30]+0.599071547271275*GCC[30]-0.8617863895711042*GCR[14]+0.8617863895711042*GCC[14]+0.6123724356957944*GCR[9]+0.6123724356957944*GCC[9]; 
  surft1_up[3] = -(1.9270129491651047*GCR[35])+1.9270129491651047*GCC[35]+1.369306393762915*GCR[32]+1.369306393762915*GCC[32]; 
  surft1_up[4] = 0.599071547271275*GCR[31]+0.599071547271275*GCC[31]-0.8617863895711042*GCR[15]+0.8617863895711042*GCC[15]+0.6123724356957944*GCR[12]+0.6123724356957944*GCC[12]; 
  surft1_up[5] = -(1.927012949165105*GCR[37])+1.927012949165105*GCC[37]+1.369306393762915*GCR[33]+1.369306393762915*GCC[33]; 
  surft1_up[6] = -(1.927012949165105*GCR[38])+1.927012949165105*GCC[38]+1.369306393762915*GCR[34]+1.369306393762915*GCC[34]; 
  surft1_up[7] = -(1.9270129491651047*GCR[39])+1.9270129491651047*GCC[39]+1.369306393762915*GCR[36]+1.369306393762915*GCC[36]; 
  surft1_up[8] = -(0.8617863895711042*GCR[22])+0.8617863895711042*GCC[22]+0.6123724356957944*GCR[19]+0.6123724356957944*GCC[19]; 
  surft1_up[9] = -(0.8617863895711042*GCR[23])+0.8617863895711042*GCC[23]+0.6123724356957944*GCR[21]+0.6123724356957944*GCC[21]; 
