...
{ 
  ...
  out[10] += tempM1i[6]; 
  out[11] += tempM1i[7]; 
  out[12] += tempM0[0]*((-1.0*wx2_sq)-1.0*wx1_sq)+2.0*tempM1i[4]*wx2+2.0*tempM1i[0]*wx1+(0.1666666666666667*f[0]*dv2_sq+0.1666666666666667*f[0]*dv1_sq)*volFact; 
  out[13] += tempM0[1]*((-1.0*wx2_sq)-1.0*wx1_sq)+2.0*tempM1i[5]*wx2+2.0*tempM1i[1]*wx1+(0.1666666666666667*f[1]*dv2_sq+0.1666666666666667*f[1]*dv1_sq)*volFact; 
  out[14] += tempM0[2]*((-1.0*wx2_sq)-1.0*wx1_sq)+2.0*tempM1i[6]*wx2+2.0*tempM1i[2]*wx1+(0.1666666666666667*f[2]*dv2_sq+0.1666666666666667*f[2]*dv1_sq)*volFact; 
  out[15] += tempM0[3]*((-1.0*wx2_sq)-1.0*wx1_sq)+2.0*tempM1i[7]*wx2+2.0*tempM1i[3]*wx1+(0.1666666666666667*f[5]*dv2_sq+0.1666666666666667*f[5]*dv1_sq)*volFact; 
} 
