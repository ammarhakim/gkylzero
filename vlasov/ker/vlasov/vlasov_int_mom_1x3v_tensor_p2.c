...
{ 
  ...
  out[4] += volFact*(4.0*f[0]*wx3_sq+2.3094010767585034*f[4]*dv3*wx3+4.0*f[0]*wx2_sq+2.3094010767585034*f[3]*dv2*wx2+4.0*f[0]*wx1_sq+2.3094010767585034*f[2]*dv1*wx1+0.2981423969999719*f[14]*dv3_sq+0.3333333333333333*f[0]*dv3_sq+0.2981423969999719*f[13]*dv2_sq+0.3333333333333333*f[0]*dv2_sq+0.2981423969999719*f[12]*dv1_sq+0.3333333333333333*f[0]*dv1_sq); 
} 
