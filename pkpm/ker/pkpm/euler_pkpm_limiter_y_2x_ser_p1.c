...
{ 
  ...
  delta_c[2] = rhouy_c[2]; 
  delta_c[3] = rhouz_c[2]; 
  delta_c[4] = 0.5*rhoux_c[1]*ux_c[3]+0.5*ux_c[1]*rhoux_c[3]+0.5*rhoux_c[0]*ux_c[2]+0.5*ux_c[0]*rhoux_c[2]+Pxx_c[2]; 
  delta_c[5] = 0.5*rhoux_c[1]*uy_c[3]+0.5*uy_c[1]*rhoux_c[3]+0.5*rhoux_c[0]*uy_c[2]+0.5*uy_c[0]*rhoux_c[2]+Pxy_c[2]; 
  delta_c[6] = 0.5*rhoux_c[1]*uz_c[3]+0.5*uz_c[1]*rhoux_c[3]+0.5*rhoux_c[0]*uz_c[2]+0.5*uz_c[0]*rhoux_c[2]+Pxz_c[2]; 
  delta_c[7] = 0.5*rhouy_c[1]*uy_c[3]+0.5*uy_c[1]*rhouy_c[3]+0.5*rhouy_c[0]*uy_c[2]+0.5*uy_c[0]*rhouy_c[2]+Pyy_c[2]; 
  delta_c[8] = 0.5*rhouy_c[1]*uz_c[3]+0.5*uz_c[1]*rhouy_c[3]+0.5*rhouy_c[0]*uz_c[2]+0.5*uz_c[0]*rhouy_c[2]+Pyz_c[2]; 
  delta_c[9] = 0.5*rhouz_c[1]*uz_c[3]+0.5*uz_c[1]*rhouz_c[3]+0.5*rhouz_c[0]*uz_c[2]+0.5*uz_c[0]*rhouz_c[2]+Pzz_c[2]; 
