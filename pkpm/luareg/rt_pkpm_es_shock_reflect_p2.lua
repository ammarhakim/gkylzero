...
Lx = 128.0 -- Domain size (configuration space: x-direction).
...
train_nn_file = "rt_pkpm_es_shock_reflect_p2_moms_nn_1" -- File path of neural network to train.
...
test_nn_file = "rt_pkpm_es_shock_reflect_p2_moms_nn_1" -- File path of neural network to test.
...
pkpmApp = PKPM.App.new {
  ...
  elc = PKPM.Species.new {
    ...
    bcx = { G0.SpeciesBc.bcWall, G0.SpeciesBc.bcCopy } -- Wall/copy boundary conditions (x-direction).
  },
  ...
  field = PKPM.Field.new {
    ...
    bcx = { G0.FieldBc.bcPECWall, G0.FieldBc.bcCopy }, -- PEC wall/copy boundary conditions (x-direction).
