...
GKYL_CU_DH double dg_diffusion_fluid_order4_boundary_surfy_3x_tensor_p2_constcoeff(const double *w, const double *dx, const double *coeff, int edge, const double *fSkin, const double *fEdge, double* GKYL_RESTRICT out) 
{
  ...
  edgeSurf_incr[1] = 6.708203932499369*coeff[1]*fSkin[12]-6.708203932499369*coeff[1]*fEdge[12]+8.11898816047911*coeff[1]*fSkin[4]+8.11898816047911*coeff[1]*fEdge[4]+4.6875*coeff[1]*fSkin[1]-4.6875*coeff[1]*fEdge[1]; 
  edgeSurf_incr[2] = 14.16059535957086*coeff[1]*fSkin[8]-9.077304717673634*coeff[1]*fEdge[8]+15.46875*coeff[1]*fSkin[2]+12.65625*coeff[1]*fEdge[2]+8.11898816047911*fSkin[0]*coeff[1]-8.11898816047911*fEdge[0]*coeff[1]; 
  edgeSurf_incr[3] = 6.708203932499369*coeff[1]*fSkin[14]-6.708203932499369*coeff[1]*fEdge[14]+8.11898816047911*coeff[1]*fSkin[6]+8.11898816047911*coeff[1]*fEdge[6]+4.6875*coeff[1]*fSkin[3]-4.6875*coeff[1]*fEdge[3]; 
  edgeSurf_incr[4] = 14.16059535957087*coeff[1]*fSkin[12]-9.077304717673634*coeff[1]*fEdge[12]+15.46875*coeff[1]*fSkin[4]+12.65625*coeff[1]*fEdge[4]+8.11898816047911*coeff[1]*fSkin[1]-8.11898816047911*coeff[1]*fEdge[1]; 
  ...
  edgeSurf_incr[6] = 14.16059535957087*coeff[1]*fSkin[14]-9.077304717673634*coeff[1]*fEdge[14]+15.46875*coeff[1]*fSkin[6]+12.65625*coeff[1]*fEdge[6]+8.11898816047911*coeff[1]*fSkin[3]-8.11898816047911*coeff[1]*fEdge[3]; 
  ...
  edgeSurf_incr[10] = 14.16059535957086*coeff[1]*fSkin[18]-9.077304717673634*coeff[1]*fEdge[18]+15.46875*coeff[1]*fSkin[10]+12.65625*coeff[1]*fEdge[10]+8.11898816047911*coeff[1]*fSkin[5]-8.11898816047911*coeff[1]*fEdge[5]; 
  edgeSurf_incr[11] = 14.16059535957087*coeff[1]*fSkin[20]-9.077304717673634*coeff[1]*fEdge[20]+15.46875*coeff[1]*fSkin[11]+12.65625*coeff[1]*fEdge[11]+8.118988160479114*coeff[1]*fSkin[7]-8.118988160479114*coeff[1]*fEdge[7]; 
  edgeSurf_incr[12] = 20.34375*coeff[1]*fSkin[12]-0.65625*coeff[1]*fEdge[12]+15.61296411439865*coeff[1]*fSkin[4]+4.72019845319029*coeff[1]*fEdge[4]+4.192627457812107*coeff[1]*fSkin[1]-4.192627457812107*coeff[1]*fEdge[1]; 
  edgeSurf_incr[13] = 6.708203932499369*coeff[1]*fSkin[23]-6.708203932499369*coeff[1]*fEdge[23]+8.118988160479114*coeff[1]*fSkin[17]+8.118988160479114*coeff[1]*fEdge[17]+4.6875*coeff[1]*fSkin[13]-4.6875*coeff[1]*fEdge[13]; 
  edgeSurf_incr[14] = 20.34375*coeff[1]*fSkin[14]-0.65625*coeff[1]*fEdge[14]+15.61296411439865*coeff[1]*fSkin[6]+4.72019845319029*coeff[1]*fEdge[6]+4.192627457812107*coeff[1]*fSkin[3]-4.192627457812107*coeff[1]*fEdge[3]; 
  edgeSurf_incr[15] = 6.708203932499369*coeff[1]*fSkin[25]-6.708203932499369*coeff[1]*fEdge[25]+8.118988160479114*coeff[1]*fSkin[19]+8.118988160479114*coeff[1]*fEdge[19]+4.6875*coeff[1]*fSkin[15]-4.6875*coeff[1]*fEdge[15]; 
  edgeSurf_incr[16] = 14.16059535957087*coeff[1]*fSkin[22]-9.077304717673634*coeff[1]*fEdge[22]+15.46875*coeff[1]*fSkin[16]+12.65625*coeff[1]*fEdge[16]+8.118988160479114*coeff[1]*fSkin[9]-8.118988160479114*coeff[1]*fEdge[9]; 
  edgeSurf_incr[17] = 14.16059535957086*coeff[1]*fSkin[23]-9.077304717673634*coeff[1]*fEdge[23]+15.46875*coeff[1]*fSkin[17]+12.65625*coeff[1]*fEdge[17]+8.118988160479114*coeff[1]*fSkin[13]-8.118988160479114*coeff[1]*fEdge[13]; 
  ...
  edgeSurf_incr[19] = 14.16059535957086*coeff[1]*fSkin[25]-9.077304717673634*coeff[1]*fEdge[25]+15.46875*coeff[1]*fSkin[19]+12.65625*coeff[1]*fEdge[19]+8.118988160479114*coeff[1]*fSkin[15]-8.118988160479114*coeff[1]*fEdge[15]; 
  edgeSurf_incr[20] = 20.34375*coeff[1]*fSkin[20]-0.65625*coeff[1]*fEdge[20]+15.61296411439865*coeff[1]*fSkin[11]+4.72019845319029*coeff[1]*fEdge[11]+4.192627457812107*coeff[1]*fSkin[7]-4.192627457812107*coeff[1]*fEdge[7]; 
  ...
  edgeSurf_incr[22] = 20.34375*coeff[1]*fSkin[22]-0.65625*coeff[1]*fEdge[22]+15.61296411439865*coeff[1]*fSkin[16]+4.72019845319029*coeff[1]*fEdge[16]+4.192627457812107*coeff[1]*fSkin[9]-4.192627457812107*coeff[1]*fEdge[9]; 
  ...
  edgeSurf_incr[24] = 14.16059535957086*coeff[1]*fSkin[26]-9.077304717673634*coeff[1]*fEdge[26]+15.46875*coeff[1]*fSkin[24]+12.65625*coeff[1]*fEdge[24]+8.11898816047911*coeff[1]*fSkin[21]-8.11898816047911*coeff[1]*fEdge[21]; 
  ...
  boundSurf_incr[8] = 19.6875*coeff[1]*fSkin[8]-10.89276566120836*coeff[1]*fSkin[2]; 
  ...
  boundSurf_incr[12] = 19.6875*coeff[1]*fSkin[12]-10.89276566120836*coeff[1]*fSkin[4]; 
  boundSurf_incr[14] = 19.6875*coeff[1]*fSkin[14]-10.89276566120836*coeff[1]*fSkin[6]; 
  ...
  boundSurf_incr[18] = 19.6875*coeff[1]*fSkin[18]-10.89276566120836*coeff[1]*fSkin[10]; 
  boundSurf_incr[19] = 2.8125*coeff[1]*fSkin[19]-5.083290641897234*coeff[1]*fSkin[25]; 
  boundSurf_incr[20] = 19.6875*coeff[1]*fSkin[20]-10.89276566120836*coeff[1]*fSkin[11]; 
  boundSurf_incr[22] = 19.6875*coeff[1]*fSkin[22]-10.89276566120836*coeff[1]*fSkin[16]; 
  boundSurf_incr[23] = 19.6875*coeff[1]*fSkin[23]-10.89276566120836*coeff[1]*fSkin[17]; 
  boundSurf_incr[24] = 2.8125*coeff[1]*fSkin[24]-5.083290641897234*coeff[1]*fSkin[26]; 
  boundSurf_incr[25] = 19.6875*coeff[1]*fSkin[25]-10.89276566120836*coeff[1]*fSkin[19]; 
  boundSurf_incr[26] = 19.6875*coeff[1]*fSkin[26]-10.89276566120836*coeff[1]*fSkin[24]; 
