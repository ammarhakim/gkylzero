...
GKYL_CU_DH double dg_diffusion_fluid_order6_surfy_2x_tensor_p2_constcoeff(const double *w, const double *dx, const double *coeff, const double *ql, const double *qc, const double *qr, double* GKYL_RESTRICT out) 
{
  ...
  out[4] += 0.0625*(563.489130329947*coeff[1]*qr[8]+563.489130329947*coeff[1]*ql[8]-1126.978260659894*coeff[1]*qc[8]-545.5960043841964*coeff[1]*qr[6]+545.5960043841964*coeff[1]*ql[6]+315.0*coeff[1]*qr[4]+315.0*coeff[1]*ql[4]-630.0*coeff[1]*qc[4])*Jfac; 
  ...
  out[6] += 0.0078125*(6587.944671898817*coeff[1]*qr[8]-6587.944671898817*coeff[1]*ql[8]-7245.0*coeff[1]*qr[6]-7245.0*coeff[1]*ql[6]-15750.0*coeff[1]*qc[6]+4364.768035073571*coeff[1]*qr[4]-4364.768035073571*coeff[1]*ql[4])*Jfac; 
  ...
  out[8] += -0.0078125*(405.0*coeff[1]*qr[8]+405.0*coeff[1]*ql[8]+18090.0*coeff[1]*qc[8]+1568.558255214004*coeff[1]*qr[6]-1568.558255214004*coeff[1]*ql[6]-1609.968943799849*coeff[1]*qr[4]-1609.968943799849*coeff[1]*ql[4]+3219.937887599698*coeff[1]*qc[4])*Jfac; 
