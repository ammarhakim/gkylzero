...
GKYL_CU_DH double dg_diffusion_fluid_order4_surfy_2x_tensor_p2_constcoeff(const double *w, const double *dx, const double *coeff, const double *ql, const double *qc, const double *qr, double* GKYL_RESTRICT out) 
{
  ...
  out[4] += 0.0625*(107.3312629199899*coeff[1]*qr[8]+107.3312629199899*coeff[1]*ql[8]-214.6625258399798*coeff[1]*qc[8]-129.9038105676658*coeff[1]*qr[6]+129.9038105676658*coeff[1]*ql[6]+75.0*coeff[1]*qr[4]+75.0*coeff[1]*ql[4]-150.0*coeff[1]*qc[4])*Jfac; 
  ...
  out[6] += 0.03125*(290.4737509655563*coeff[1]*qr[8]-290.4737509655563*coeff[1]*ql[8]-405.0*coeff[1]*qr[6]-405.0*coeff[1]*ql[6]-990.0*coeff[1]*qc[6]+259.8076211353317*coeff[1]*qr[4]-259.8076211353317*coeff[1]*ql[4])*Jfac; 
  ...
  out[8] += 0.03125*(21.0*coeff[1]*qr[8]+21.0*coeff[1]*ql[8]-1302.0*coeff[1]*qc[8]-151.0463505020893*coeff[1]*qr[6]+151.0463505020893*coeff[1]*ql[6]+134.1640786499874*coeff[1]*qr[4]+134.1640786499874*coeff[1]*ql[4]-268.3281572999748*coeff[1]*qc[4])*Jfac; 
