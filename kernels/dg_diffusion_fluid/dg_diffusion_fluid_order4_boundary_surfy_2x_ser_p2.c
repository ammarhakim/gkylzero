...
GKYL_CU_DH double dg_diffusion_fluid_order4_boundary_surfy_2x_ser_p2_constcoeff(const double *w, const double *dx, const double *coeff, int edge, const double *fSkin, const double *fEdge, double* GKYL_RESTRICT out) 
{
  ...
  edgeSurf_incr[4] = 8.118988160479114*coeff[1]*fSkin[6]+8.118988160479114*coeff[1]*fEdge[6]+4.6875*coeff[1]*fSkin[4]-4.6875*coeff[1]*fEdge[4]; 
  ...
  edgeSurf_incr[6] = 15.46875*coeff[1]*fSkin[6]+12.65625*coeff[1]*fEdge[6]+8.118988160479114*coeff[1]*fSkin[4]-8.118988160479114*coeff[1]*fEdge[4]; 
  ...
  boundSurf_incr[6] = 2.8125*coeff[1]*fSkin[6]; 
