...
GKYL_CU_DH double dg_diffusion_fluid_order4_boundary_surfx_2x_tensor_p2_constcoeff(const double *w, const double *dx, const double *coeff, int edge, const double *fSkin, const double *fEdge, double* GKYL_RESTRICT out) 
{
  ...
  edgeSurf_incr[7] = 14.16059535957087*coeff[0]*fSkin[8]-9.077304717673634*coeff[0]*fEdge[8]+15.46875*coeff[0]*fSkin[7]+12.65625*coeff[0]*fEdge[7]+8.118988160479114*coeff[0]*fSkin[5]-8.118988160479114*coeff[0]*fEdge[5]; 
  edgeSurf_incr[8] = 20.34375*coeff[0]*fSkin[8]-0.65625*coeff[0]*fEdge[8]+15.61296411439865*coeff[0]*fSkin[7]+4.72019845319029*coeff[0]*fEdge[7]+4.192627457812107*coeff[0]*fSkin[5]-4.192627457812107*coeff[0]*fEdge[5]; 
  ...
  boundSurf_incr[8] = 19.6875*coeff[0]*fSkin[8]-10.89276566120836*coeff[0]*fSkin[7]; 
