...
GKYL_CU_DH double dg_diffusion_fluid_order4_vol_3x_tensor_p2_varcoeff_diffx(const double *w, const double *dx, const double *coeff, const double *q, double* GKYL_RESTRICT out) 
{
  // w[NDIM]: Cell-center coordinates
  // dx[NDIM]: Cell spacing
  // coeff: Diffusion coefficient vector
...
GKYL_CU_DH double dg_diffusion_fluid_order4_vol_3x_tensor_p2_varcoeff_diffy(const double *w, const double *dx, const double *coeff, const double *q, double* GKYL_RESTRICT out) 
{
  // w[NDIM]: Cell-center coordinates
  // dx[NDIM]: Cell spacing
  // coeff: Diffusion coefficient vector
  ...
  const double rdx2 = 2.0/dx[1]; 
  return 28.63782463805517*coeff[27]*pow(rdx2, 4.0); 
}

GKYL_CU_DH double dg_diffusion_fluid_order4_vol_3x_tensor_p2_varcoeff_diffz(const double *w, const double *dx, const double *coeff, const double *q, double* GKYL_RESTRICT out) 
{
  // w[NDIM]: Cell-center coordinates
  // dx[NDIM]: Cell spacing
  // coeff: Diffusion coefficient vector
  ...
  const double rdx2 = 2.0/dx[2]; 
  return 28.63782463805517*coeff[54]*pow(rdx2, 4.0); 
}
...
{ 
  ...
  cflFreq += dg_diffusion_fluid_order4_vol_3x_tensor_p2_varcoeff_diffx(w, dx, coeff, q, out);
...
{ 
  ...
  cflFreq += dg_diffusion_fluid_order4_vol_3x_tensor_p2_varcoeff_diffx(w, dx, coeff, q, out);
  cflFreq += dg_diffusion_fluid_order4_vol_3x_tensor_p2_varcoeff_diffy(w, dx, coeff, q, out);
...
{ 
  ...
  cflFreq += dg_diffusion_fluid_order4_vol_3x_tensor_p2_varcoeff_diffx(w, dx, coeff, q, out);
  cflFreq += dg_diffusion_fluid_order4_vol_3x_tensor_p2_varcoeff_diffy(w, dx, coeff, q, out);
  cflFreq += dg_diffusion_fluid_order4_vol_3x_tensor_p2_varcoeff_diffz(w, dx, coeff, q, out);
