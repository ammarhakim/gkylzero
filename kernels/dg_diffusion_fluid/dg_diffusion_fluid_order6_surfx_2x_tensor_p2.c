...
GKYL_CU_DH double dg_diffusion_fluid_order6_surfx_2x_tensor_p2_constcoeff(const double *w, const double *dx, const double *coeff, const double *ql, const double *qc, const double *qr, double* GKYL_RESTRICT out) 
{
  ...
  out[5] += 0.0625*(563.489130329947*coeff[0]*qr[8]+563.489130329947*coeff[0]*ql[8]-1126.978260659894*coeff[0]*qc[8]-545.5960043841964*coeff[0]*qr[7]+545.5960043841964*coeff[0]*ql[7]+315.0*coeff[0]*qr[5]+315.0*coeff[0]*ql[5]-630.0*coeff[0]*qc[5])*Jfac; 
  ...
  out[7] += 0.0078125*(6587.944671898817*coeff[0]*qr[8]-6587.944671898817*coeff[0]*ql[8]-7245.0*coeff[0]*qr[7]-7245.0*coeff[0]*ql[7]-15750.0*coeff[0]*qc[7]+4364.768035073571*coeff[0]*qr[5]-4364.768035073571*coeff[0]*ql[5])*Jfac; 
  out[8] += -0.0078125*(405.0*coeff[0]*qr[8]+405.0*coeff[0]*ql[8]+18090.0*coeff[0]*qc[8]+1568.558255214004*coeff[0]*qr[7]-1568.558255214004*coeff[0]*ql[7]-1609.968943799849*coeff[0]*qr[5]-1609.968943799849*coeff[0]*ql[5]+3219.937887599698*coeff[0]*qc[5])*Jfac; 
