...
GKYL_CU_DH double dg_diffusion_fluid_order4_boundary_surfy_2x_tensor_p2_constcoeff(const double *w, const double *dx, const double *coeff, int edge, const double *fSkin, const double *fEdge, double* GKYL_RESTRICT out) 
{
  ...
  edgeSurf_incr[1] = 6.708203932499369*coeff[1]*fSkin[7]-6.708203932499369*coeff[1]*fEdge[7]+8.11898816047911*coeff[1]*fSkin[3]+8.11898816047911*coeff[1]*fEdge[3]+4.6875*coeff[1]*fSkin[1]-4.6875*coeff[1]*fEdge[1]; 
  edgeSurf_incr[2] = 14.16059535957086*coeff[1]*fSkin[5]-9.077304717673634*coeff[1]*fEdge[5]+15.46875*coeff[1]*fSkin[2]+12.65625*coeff[1]*fEdge[2]+8.11898816047911*fSkin[0]*coeff[1]-8.11898816047911*fEdge[0]*coeff[1]; 
  edgeSurf_incr[3] = 14.16059535957087*coeff[1]*fSkin[7]-9.077304717673634*coeff[1]*fEdge[7]+15.46875*coeff[1]*fSkin[3]+12.65625*coeff[1]*fEdge[3]+8.11898816047911*coeff[1]*fSkin[1]-8.11898816047911*coeff[1]*fEdge[1]; 
  ...
  edgeSurf_incr[6] = 14.16059535957087*coeff[1]*fSkin[8]-9.077304717673634*coeff[1]*fEdge[8]+15.46875*coeff[1]*fSkin[6]+12.65625*coeff[1]*fEdge[6]+8.118988160479114*coeff[1]*fSkin[4]-8.118988160479114*coeff[1]*fEdge[4]; 
  edgeSurf_incr[7] = 20.34375*coeff[1]*fSkin[7]-0.65625*coeff[1]*fEdge[7]+15.61296411439865*coeff[1]*fSkin[3]+4.72019845319029*coeff[1]*fEdge[3]+4.192627457812107*coeff[1]*fSkin[1]-4.192627457812107*coeff[1]*fEdge[1]; 
  edgeSurf_incr[8] = 20.34375*coeff[1]*fSkin[8]-0.65625*coeff[1]*fEdge[8]+15.61296411439865*coeff[1]*fSkin[6]+4.72019845319029*coeff[1]*fEdge[6]+4.192627457812107*coeff[1]*fSkin[4]-4.192627457812107*coeff[1]*fEdge[4]; 
  ...
  boundSurf_incr[5] = 19.6875*coeff[1]*fSkin[5]-10.89276566120836*coeff[1]*fSkin[2]; 
  boundSurf_incr[6] = 2.8125*coeff[1]*fSkin[6]-5.083290641897235*coeff[1]*fSkin[8]; 
  boundSurf_incr[7] = 19.6875*coeff[1]*fSkin[7]-10.89276566120836*coeff[1]*fSkin[3]; 
  boundSurf_incr[8] = 19.6875*coeff[1]*fSkin[8]-10.89276566120836*coeff[1]*fSkin[6]; 
