...
GKYL_CU_DH double dg_diffusion_fluid_order6_vol_2x_tensor_p2_constcoeff_diffx(const double *w, const double *dx, const double *coeff, const double *q, double* GKYL_RESTRICT out) 
{
...
GKYL_CU_DH double dg_diffusion_fluid_order6_vol_2x_tensor_p2_constcoeff_diffy(const double *w, const double *dx, const double *coeff, const double *q, double* GKYL_RESTRICT out) 
{
  // w[NDIM]: Cell-center coordinates
  // dx[NDIM]: Cell spacing
  // coeff: Diffusion coefficient vector
...
{ 
  ...
  cflFreq += dg_diffusion_fluid_order6_vol_2x_tensor_p2_constcoeff_diffx(w, dx, coeff, q, out);
...
{ 
  ...
  cflFreq += dg_diffusion_fluid_order6_vol_2x_tensor_p2_constcoeff_diffx(w, dx, coeff, q, out);
  cflFreq += dg_diffusion_fluid_order6_vol_2x_tensor_p2_constcoeff_diffy(w, dx, coeff, q, out);
...
GKYL_CU_DH double dg_diffusion_fluid_order6_vol_2x_tensor_p2_varcoeff_diffx(const double *w, const double *dx, const double *coeff, const double *q, double* GKYL_RESTRICT out) 
{
  // w[NDIM]: Cell-center coordinates
  // dx[NDIM]: Cell spacing
  // coeff: Diffusion coefficient vector
...
GKYL_CU_DH double dg_diffusion_fluid_order6_vol_2x_tensor_p2_varcoeff_diffy(const double *w, const double *dx, const double *coeff, const double *q, double* GKYL_RESTRICT out) 
{
  // w[NDIM]: Cell-center coordinates
  // dx[NDIM]: Cell spacing
  // coeff: Diffusion coefficient vector
  ...
  const double rdx2 = 2.0/dx[1]; 
  return 364.5*coeff[9]*pow(rdx2, 6.0); 
}
...
{ 
  ...
  cflFreq += dg_diffusion_fluid_order6_vol_2x_tensor_p2_varcoeff_diffx(w, dx, coeff, q, out);
...
{ 
  ...
  cflFreq += dg_diffusion_fluid_order6_vol_2x_tensor_p2_varcoeff_diffx(w, dx, coeff, q, out);
  cflFreq += dg_diffusion_fluid_order6_vol_2x_tensor_p2_varcoeff_diffy(w, dx, coeff, q, out);
