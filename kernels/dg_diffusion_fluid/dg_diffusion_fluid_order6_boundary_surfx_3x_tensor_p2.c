...
GKYL_CU_DH double dg_diffusion_fluid_order6_boundary_surfx_3x_tensor_p2_constcoeff(const double *w, const double *dx, const double *coeff, int edge, const double *fSkin, const double *fEdge, double* GKYL_RESTRICT out) 
{
  ...
  edgeSurf_incr[12] = (-70.53065765632414*coeff[0]*fSkin[20])+51.4683177492095*coeff[0]*fEdge[20]-61.5234375*coeff[0]*fSkin[12]-56.6015625*coeff[0]*fEdge[12]-34.09975027401227*coeff[0]*fSkin[8]+34.09975027401227*coeff[0]*fEdge[8]; 
  ...
  edgeSurf_incr[15] = (-70.53065765632414*coeff[0]*fSkin[21])+51.4683177492095*coeff[0]*fEdge[21]-61.5234375*coeff[0]*fSkin[15]-56.6015625*coeff[0]*fEdge[15]-34.09975027401227*coeff[0]*fSkin[9]+34.09975027401227*coeff[0]*fEdge[9]; 
  ...
  edgeSurf_incr[20] = (-70.6640625*coeff[0]*fSkin[20])-3.1640625*coeff[0]*fEdge[20]-31.31670127597403*coeff[0]*fSkin[12]-12.2543613688594*coeff[0]*fEdge[12]-12.57788237343632*coeff[0]*fSkin[8]+12.57788237343632*coeff[0]*fEdge[8]; 
  edgeSurf_incr[21] = (-70.6640625*coeff[0]*fSkin[21])-3.1640625*coeff[0]*fEdge[21]-31.31670127597403*coeff[0]*fSkin[15]-12.2543613688594*coeff[0]*fEdge[15]-12.57788237343632*coeff[0]*fSkin[9]+12.57788237343632*coeff[0]*fEdge[9]; 
  ...
  edgeSurf_incr[23] = (-70.6640625*coeff[0]*fSkin[23])-3.1640625*coeff[0]*fEdge[23]-31.316701275974*coeff[0]*fSkin[18]-12.2543613688594*coeff[0]*fEdge[18]-12.57788237343632*coeff[0]*fSkin[14]+12.57788237343632*coeff[0]*fEdge[14]; 
  edgeSurf_incr[24] = (-70.6640625*coeff[0]*fSkin[24])-3.1640625*coeff[0]*fEdge[24]-31.316701275974*coeff[0]*fSkin[19]-12.2543613688594*coeff[0]*fEdge[19]-12.57788237343632*coeff[0]*fSkin[16]+12.57788237343632*coeff[0]*fEdge[16]; 
  ...
  edgeSurf_incr[26] = (-70.6640625*coeff[0]*fSkin[26])-3.1640625*coeff[0]*fEdge[26]-31.316701275974*coeff[0]*fSkin[25]-12.2543613688594*coeff[0]*fEdge[25]-12.57788237343632*coeff[0]*fSkin[22]+12.57788237343632*coeff[0]*fEdge[22]; 
  ...
  boundSurf_incr[12] = 19.06233990711463*coeff[0]*fSkin[20]-4.921875*coeff[0]*fSkin[12]; 
  boundSurf_incr[13] = 19.06233990711463*coeff[0]*fSkin[5]-73.828125*coeff[0]*fSkin[13]; 
  boundSurf_incr[15] = 19.06233990711463*coeff[0]*fSkin[21]-4.921875*coeff[0]*fSkin[15]; 
  boundSurf_incr[17] = 19.06233990711463*coeff[0]*fSkin[10]-73.828125*coeff[0]*fSkin[17]; 
  boundSurf_incr[18] = 19.06233990711463*coeff[0]*fSkin[23]-4.921875*coeff[0]*fSkin[18]; 
  boundSurf_incr[19] = 19.06233990711463*coeff[0]*fSkin[24]-4.921875*coeff[0]*fSkin[19]; 
  boundSurf_incr[20] = 19.06233990711463*coeff[0]*fSkin[12]-73.828125*coeff[0]*fSkin[20]; 
  boundSurf_incr[21] = 19.06233990711463*coeff[0]*fSkin[15]-73.828125*coeff[0]*fSkin[21]; 
  boundSurf_incr[23] = 19.06233990711463*coeff[0]*fSkin[18]-73.828125*coeff[0]*fSkin[23]; 
  boundSurf_incr[24] = 19.06233990711463*coeff[0]*fSkin[19]-73.828125*coeff[0]*fSkin[24]; 
  boundSurf_incr[25] = 19.06233990711463*coeff[0]*fSkin[26]-4.921875*coeff[0]*fSkin[25]; 
  boundSurf_incr[26] = 19.06233990711463*coeff[0]*fSkin[25]-73.828125*coeff[0]*fSkin[26]; 
  ...
  boundSurf_incr[18] = (-19.06233990711463*coeff[0]*fSkin[23])-4.921875*coeff[0]*fSkin[18]; 
  boundSurf_incr[19] = (-19.06233990711463*coeff[0]*fSkin[24])-4.921875*coeff[0]*fSkin[19]; 
  boundSurf_incr[20] = (-73.828125*coeff[0]*fSkin[20])-19.06233990711463*coeff[0]*fSkin[12]; 
  boundSurf_incr[21] = (-73.828125*coeff[0]*fSkin[21])-19.06233990711463*coeff[0]*fSkin[15]; 
  boundSurf_incr[23] = (-73.828125*coeff[0]*fSkin[23])-19.06233990711463*coeff[0]*fSkin[18]; 
  boundSurf_incr[24] = (-73.828125*coeff[0]*fSkin[24])-19.06233990711463*coeff[0]*fSkin[19]; 
  boundSurf_incr[25] = (-19.06233990711463*coeff[0]*fSkin[26])-4.921875*coeff[0]*fSkin[25]; 
  boundSurf_incr[26] = (-73.828125*coeff[0]*fSkin[26])-19.06233990711463*coeff[0]*fSkin[25]; 
