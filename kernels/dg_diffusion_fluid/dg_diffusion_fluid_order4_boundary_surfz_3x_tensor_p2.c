...
GKYL_CU_DH double dg_diffusion_fluid_order4_boundary_surfz_3x_tensor_p2_constcoeff(const double *w, const double *dx, const double *coeff, int edge, const double *fSkin, const double *fEdge, double* GKYL_RESTRICT out) 
{
  ...
  edgeSurf_incr[1] = 6.708203932499369*coeff[2]*fSkin[15]-6.708203932499369*coeff[2]*fEdge[15]+8.11898816047911*coeff[2]*fSkin[5]+8.11898816047911*coeff[2]*fEdge[5]+4.6875*fSkin[1]*coeff[2]-4.6875*fEdge[1]*coeff[2]; 
  edgeSurf_incr[2] = 6.708203932499369*coeff[2]*fSkin[16]-6.708203932499369*coeff[2]*fEdge[16]+8.11898816047911*coeff[2]*fSkin[6]+8.11898816047911*coeff[2]*fEdge[6]+4.6875*coeff[2]*fSkin[2]-4.6875*coeff[2]*fEdge[2]; 
  edgeSurf_incr[3] = 14.16059535957086*coeff[2]*fSkin[9]-9.077304717673634*coeff[2]*fEdge[9]+15.46875*coeff[2]*fSkin[3]+12.65625*coeff[2]*fEdge[3]+8.11898816047911*fSkin[0]*coeff[2]-8.11898816047911*fEdge[0]*coeff[2]; 
  ...
  edgeSurf_incr[5] = 14.16059535957087*coeff[2]*fSkin[15]-9.077304717673634*coeff[2]*fEdge[15]+15.46875*coeff[2]*fSkin[5]+12.65625*coeff[2]*fEdge[5]+8.11898816047911*fSkin[1]*coeff[2]-8.11898816047911*fEdge[1]*coeff[2]; 
  edgeSurf_incr[6] = 14.16059535957087*coeff[2]*fSkin[16]-9.077304717673634*coeff[2]*fEdge[16]+15.46875*coeff[2]*fSkin[6]+12.65625*coeff[2]*fEdge[6]+8.11898816047911*coeff[2]*fSkin[2]-8.11898816047911*coeff[2]*fEdge[2]; 
  ...
  edgeSurf_incr[10] = 14.16059535957086*coeff[2]*fSkin[19]-9.077304717673634*coeff[2]*fEdge[19]+15.46875*coeff[2]*fSkin[10]+12.65625*coeff[2]*fEdge[10]+8.11898816047911*coeff[2]*fSkin[4]-8.11898816047911*coeff[2]*fEdge[4]; 
  edgeSurf_incr[11] = 6.708203932499369*coeff[2]*fSkin[24]-6.708203932499369*coeff[2]*fEdge[24]+8.118988160479114*coeff[2]*fSkin[17]+8.118988160479114*coeff[2]*fEdge[17]+4.6875*coeff[2]*fSkin[11]-4.6875*coeff[2]*fEdge[11]; 
  edgeSurf_incr[12] = 6.708203932499369*coeff[2]*fSkin[25]-6.708203932499369*coeff[2]*fEdge[25]+8.118988160479114*coeff[2]*fSkin[18]+8.118988160479114*coeff[2]*fEdge[18]+4.6875*coeff[2]*fSkin[12]-4.6875*coeff[2]*fEdge[12]; 
  edgeSurf_incr[13] = 14.16059535957087*coeff[2]*fSkin[21]-9.077304717673634*coeff[2]*fEdge[21]+15.46875*coeff[2]*fSkin[13]+12.65625*coeff[2]*fEdge[13]+8.118988160479114*coeff[2]*fSkin[7]-8.118988160479114*coeff[2]*fEdge[7]; 
  edgeSurf_incr[14] = 14.16059535957087*coeff[2]*fSkin[22]-9.077304717673634*coeff[2]*fEdge[22]+15.46875*coeff[2]*fSkin[14]+12.65625*coeff[2]*fEdge[14]+8.118988160479114*coeff[2]*fSkin[8]-8.118988160479114*coeff[2]*fEdge[8]; 
  edgeSurf_incr[15] = 20.34375*coeff[2]*fSkin[15]-0.65625*coeff[2]*fEdge[15]+15.61296411439865*coeff[2]*fSkin[5]+4.72019845319029*coeff[2]*fEdge[5]+4.192627457812107*fSkin[1]*coeff[2]-4.192627457812107*fEdge[1]*coeff[2]; 
  edgeSurf_incr[16] = 20.34375*coeff[2]*fSkin[16]-0.65625*coeff[2]*fEdge[16]+15.61296411439865*coeff[2]*fSkin[6]+4.72019845319029*coeff[2]*fEdge[6]+4.192627457812107*coeff[2]*fSkin[2]-4.192627457812107*coeff[2]*fEdge[2]; 
  edgeSurf_incr[17] = 14.16059535957086*coeff[2]*fSkin[24]-9.077304717673634*coeff[2]*fEdge[24]+15.46875*coeff[2]*fSkin[17]+12.65625*coeff[2]*fEdge[17]+8.118988160479114*coeff[2]*fSkin[11]-8.118988160479114*coeff[2]*fEdge[11]; 
  edgeSurf_incr[18] = 14.16059535957086*coeff[2]*fSkin[25]-9.077304717673634*coeff[2]*fEdge[25]+15.46875*coeff[2]*fSkin[18]+12.65625*coeff[2]*fEdge[18]+8.118988160479114*coeff[2]*fSkin[12]-8.118988160479114*coeff[2]*fEdge[12]; 
  ...
  edgeSurf_incr[21] = 20.34375*coeff[2]*fSkin[21]-0.65625*coeff[2]*fEdge[21]+15.61296411439865*coeff[2]*fSkin[13]+4.72019845319029*coeff[2]*fEdge[13]+4.192627457812107*coeff[2]*fSkin[7]-4.192627457812107*coeff[2]*fEdge[7]; 
  edgeSurf_incr[22] = 20.34375*coeff[2]*fSkin[22]-0.65625*coeff[2]*fEdge[22]+15.61296411439865*coeff[2]*fSkin[14]+4.72019845319029*coeff[2]*fEdge[14]+4.192627457812107*coeff[2]*fSkin[8]-4.192627457812107*coeff[2]*fEdge[8]; 
  edgeSurf_incr[23] = 14.16059535957086*coeff[2]*fSkin[26]-9.077304717673634*coeff[2]*fEdge[26]+15.46875*coeff[2]*fSkin[23]+12.65625*coeff[2]*fEdge[23]+8.11898816047911*coeff[2]*fSkin[20]-8.11898816047911*coeff[2]*fEdge[20]; 
  ...
  boundSurf_incr[9] = 19.6875*coeff[2]*fSkin[9]-10.89276566120836*coeff[2]*fSkin[3]; 
  ...
  boundSurf_incr[15] = 19.6875*coeff[2]*fSkin[15]-10.89276566120836*coeff[2]*fSkin[5]; 
  boundSurf_incr[16] = 19.6875*coeff[2]*fSkin[16]-10.89276566120836*coeff[2]*fSkin[6]; 
  ...
  boundSurf_incr[19] = 19.6875*coeff[2]*fSkin[19]-10.89276566120836*coeff[2]*fSkin[10]; 
  boundSurf_incr[21] = 19.6875*coeff[2]*fSkin[21]-10.89276566120836*coeff[2]*fSkin[13]; 
  boundSurf_incr[22] = 19.6875*coeff[2]*fSkin[22]-10.89276566120836*coeff[2]*fSkin[14]; 
  boundSurf_incr[23] = 2.8125*coeff[2]*fSkin[23]-5.083290641897234*coeff[2]*fSkin[26]; 
  boundSurf_incr[24] = 19.6875*coeff[2]*fSkin[24]-10.89276566120836*coeff[2]*fSkin[17]; 
  boundSurf_incr[25] = 19.6875*coeff[2]*fSkin[25]-10.89276566120836*coeff[2]*fSkin[18]; 
  boundSurf_incr[26] = 19.6875*coeff[2]*fSkin[26]-10.89276566120836*coeff[2]*fSkin[23]; 
