...
GKYL_CU_DH double dg_diffusion_fluid_order6_boundary_surfx_2x_tensor_p2_constcoeff(const double *w, const double *dx, const double *coeff, int edge, const double *fSkin, const double *fEdge, double* GKYL_RESTRICT out) 
{
  ...
  edgeSurf_incr[7] = (-70.53065765632414*coeff[0]*fSkin[8])+51.4683177492095*coeff[0]*fEdge[8]-61.5234375*coeff[0]*fSkin[7]-56.6015625*coeff[0]*fEdge[7]-34.09975027401227*coeff[0]*fSkin[5]+34.09975027401227*coeff[0]*fEdge[5]; 
  edgeSurf_incr[8] = (-70.6640625*coeff[0]*fSkin[8])-3.1640625*coeff[0]*fEdge[8]-31.31670127597403*coeff[0]*fSkin[7]-12.2543613688594*coeff[0]*fEdge[7]-12.57788237343632*coeff[0]*fSkin[5]+12.57788237343632*coeff[0]*fEdge[5]; 
  ...
  boundSurf_incr[7] = 19.06233990711463*coeff[0]*fSkin[8]-4.921875*coeff[0]*fSkin[7]; 
  boundSurf_incr[8] = 19.06233990711463*coeff[0]*fSkin[7]-73.828125*coeff[0]*fSkin[8]; 
  ...
  boundSurf_incr[7] = (-19.06233990711463*coeff[0]*fSkin[8])-4.921875*coeff[0]*fSkin[7]; 
  boundSurf_incr[8] = (-73.828125*coeff[0]*fSkin[8])-19.06233990711463*coeff[0]*fSkin[7]; 
