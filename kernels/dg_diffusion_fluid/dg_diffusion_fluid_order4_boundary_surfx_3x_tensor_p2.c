...
GKYL_CU_DH double dg_diffusion_fluid_order4_boundary_surfx_3x_tensor_p2_constcoeff(const double *w, const double *dx, const double *coeff, int edge, const double *fSkin, const double *fEdge, double* GKYL_RESTRICT out) 
{
  ...
  edgeSurf_incr[12] = 14.16059535957087*coeff[0]*fSkin[20]-9.077304717673634*coeff[0]*fEdge[20]+15.46875*coeff[0]*fSkin[12]+12.65625*coeff[0]*fEdge[12]+8.118988160479114*coeff[0]*fSkin[8]-8.118988160479114*coeff[0]*fEdge[8]; 
  ...
  edgeSurf_incr[14] = 6.708203932499369*coeff[0]*fSkin[23]-6.708203932499369*coeff[0]*fEdge[23]+8.118988160479114*coeff[0]*fSkin[18]+8.118988160479114*coeff[0]*fEdge[18]+4.6875*coeff[0]*fSkin[14]-4.6875*coeff[0]*fEdge[14]; 
  edgeSurf_incr[15] = 14.16059535957087*coeff[0]*fSkin[21]-9.077304717673634*coeff[0]*fEdge[21]+15.46875*coeff[0]*fSkin[15]+12.65625*coeff[0]*fEdge[15]+8.118988160479114*coeff[0]*fSkin[9]-8.118988160479114*coeff[0]*fEdge[9]; 
  edgeSurf_incr[16] = 6.708203932499369*coeff[0]*fSkin[24]-6.708203932499369*coeff[0]*fEdge[24]+8.118988160479114*coeff[0]*fSkin[19]+8.118988160479114*coeff[0]*fEdge[19]+4.6875*coeff[0]*fSkin[16]-4.6875*coeff[0]*fEdge[16]; 
  ...
  edgeSurf_incr[18] = 14.16059535957086*coeff[0]*fSkin[23]-9.077304717673634*coeff[0]*fEdge[23]+15.46875*coeff[0]*fSkin[18]+12.65625*coeff[0]*fEdge[18]+8.118988160479114*coeff[0]*fSkin[14]-8.118988160479114*coeff[0]*fEdge[14]; 
  edgeSurf_incr[19] = 14.16059535957086*coeff[0]*fSkin[24]-9.077304717673634*coeff[0]*fEdge[24]+15.46875*coeff[0]*fSkin[19]+12.65625*coeff[0]*fEdge[19]+8.118988160479114*coeff[0]*fSkin[16]-8.118988160479114*coeff[0]*fEdge[16]; 
  edgeSurf_incr[20] = 20.34375*coeff[0]*fSkin[20]-0.65625*coeff[0]*fEdge[20]+15.61296411439865*coeff[0]*fSkin[12]+4.72019845319029*coeff[0]*fEdge[12]+4.192627457812107*coeff[0]*fSkin[8]-4.192627457812107*coeff[0]*fEdge[8]; 
  edgeSurf_incr[21] = 20.34375*coeff[0]*fSkin[21]-0.65625*coeff[0]*fEdge[21]+15.61296411439865*coeff[0]*fSkin[15]+4.72019845319029*coeff[0]*fEdge[15]+4.192627457812107*coeff[0]*fSkin[9]-4.192627457812107*coeff[0]*fEdge[9]; 
  ...
  edgeSurf_incr[25] = 14.16059535957086*coeff[0]*fSkin[26]-9.077304717673634*coeff[0]*fEdge[26]+15.46875*coeff[0]*fSkin[25]+12.65625*coeff[0]*fEdge[25]+8.11898816047911*coeff[0]*fSkin[22]-8.11898816047911*coeff[0]*fEdge[22]; 
  ...
  boundSurf_incr[20] = 19.6875*coeff[0]*fSkin[20]-10.89276566120836*coeff[0]*fSkin[12]; 
  boundSurf_incr[21] = 19.6875*coeff[0]*fSkin[21]-10.89276566120836*coeff[0]*fSkin[15]; 
  boundSurf_incr[23] = 19.6875*coeff[0]*fSkin[23]-10.89276566120836*coeff[0]*fSkin[18]; 
  boundSurf_incr[24] = 19.6875*coeff[0]*fSkin[24]-10.89276566120836*coeff[0]*fSkin[19]; 
  boundSurf_incr[25] = 2.8125*coeff[0]*fSkin[25]-5.083290641897234*coeff[0]*fSkin[26]; 
  boundSurf_incr[26] = 19.6875*coeff[0]*fSkin[26]-10.89276566120836*coeff[0]*fSkin[25]; 
