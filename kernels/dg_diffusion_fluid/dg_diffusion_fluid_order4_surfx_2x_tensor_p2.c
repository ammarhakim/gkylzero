...
GKYL_CU_DH double dg_diffusion_fluid_order4_surfx_2x_tensor_p2_constcoeff(const double *w, const double *dx, const double *coeff, const double *ql, const double *qc, const double *qr, double* GKYL_RESTRICT out) 
{
  ...
  out[5] += 0.0625*(107.3312629199899*coeff[0]*qr[8]+107.3312629199899*coeff[0]*ql[8]-214.6625258399798*coeff[0]*qc[8]-129.9038105676658*coeff[0]*qr[7]+129.9038105676658*coeff[0]*ql[7]+75.0*coeff[0]*qr[5]+75.0*coeff[0]*ql[5]-150.0*coeff[0]*qc[5])*Jfac; 
  ...
  out[7] += 0.03125*(290.4737509655563*coeff[0]*qr[8]-290.4737509655563*coeff[0]*ql[8]-405.0*coeff[0]*qr[7]-405.0*coeff[0]*ql[7]-990.0*coeff[0]*qc[7]+259.8076211353317*coeff[0]*qr[5]-259.8076211353317*coeff[0]*ql[5])*Jfac; 
  out[8] += 0.03125*(21.0*coeff[0]*qr[8]+21.0*coeff[0]*ql[8]-1302.0*coeff[0]*qc[8]-151.0463505020893*coeff[0]*qr[7]+151.0463505020893*coeff[0]*ql[7]+134.1640786499874*coeff[0]*qr[5]+134.1640786499874*coeff[0]*ql[5]-268.3281572999748*coeff[0]*qc[5])*Jfac; 
