...
GKYL_CU_DH double dg_diffusion_vlasov_order4_surfx_1x3v_ser_p1_constcoeff(const double *w, const double *dx, const double *coeff, const double *ql, const double *qc, const double *qr, double* GKYL_RESTRICT out) 
{
  ...
  out[34] += -0.0625*(25.98076211353316*coeff[0]*qr[36]-25.98076211353316*coeff[0]*ql[36]-15.0*coeff[0]*qr[34]-15.0*coeff[0]*ql[34]+30.0*coeff[0]*qc[34])*Jfac; 
  out[35] += -0.0625*(25.98076211353316*coeff[0]*qr[37]-25.98076211353316*coeff[0]*ql[37]-15.0*coeff[0]*qr[35]-15.0*coeff[0]*ql[35]+30.0*coeff[0]*qc[35])*Jfac; 
  out[36] += -0.0625*(33.0*coeff[0]*qr[36]+33.0*coeff[0]*ql[36]+114.0*coeff[0]*qc[36]-25.98076211353316*coeff[0]*qr[34]+25.98076211353316*coeff[0]*ql[34])*Jfac; 
  out[37] += -0.0625*(33.0*coeff[0]*qr[37]+33.0*coeff[0]*ql[37]+114.0*coeff[0]*qc[37]-25.98076211353316*coeff[0]*qr[35]+25.98076211353316*coeff[0]*ql[35])*Jfac; 
  out[38] += -0.0625*(25.98076211353316*coeff[0]*qr[39]-25.98076211353316*coeff[0]*ql[39]-15.0*coeff[0]*qr[38]-15.0*coeff[0]*ql[38]+30.0*coeff[0]*qc[38])*Jfac; 
  out[39] += -0.0625*(33.0*coeff[0]*qr[39]+33.0*coeff[0]*ql[39]+114.0*coeff[0]*qc[39]-25.98076211353316*coeff[0]*qr[38]+25.98076211353316*coeff[0]*ql[38])*Jfac; 
