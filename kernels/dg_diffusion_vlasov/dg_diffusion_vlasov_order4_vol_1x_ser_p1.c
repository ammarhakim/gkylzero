...
GKYL_CU_DH double dg_diffusion_vlasov_order4_vol_1x_ser_p1_constcoeff_diffx(const double *w, const double *dx, const double *coeff, const double *q, double* GKYL_RESTRICT out) 
{
...
{ 
  ...
  cflFreq += dg_diffusion_vlasov_order4_vol_1x_ser_p1_constcoeff_diffx(w, dx, coeff, q, out);
