...
GKYL_CU_DH double dg_diffusion_vlasov_order4_boundary_surfx_1x3v_ser_p1_constcoeff(const double *w, const double *dx, const double *coeff, int edge, const double *fSkin, const double *fEdge, double* GKYL_RESTRICT out) 
{
  ...
  edgeSurf_incr[34] = 1.6237976320958225*coeff[0]*fSkin[36]+1.6237976320958225*coeff[0]*fEdge[36]+0.9375*coeff[0]*fSkin[34]-0.9375*coeff[0]*fEdge[34]; 
  edgeSurf_incr[35] = 1.6237976320958225*coeff[0]*fSkin[37]+1.6237976320958225*coeff[0]*fEdge[37]+0.9375*coeff[0]*fSkin[35]-0.9375*coeff[0]*fEdge[35]; 
  edgeSurf_incr[36] = 3.5625*coeff[0]*fSkin[36]+2.0625*coeff[0]*fEdge[36]+1.6237976320958225*coeff[0]*fSkin[34]-1.6237976320958225*coeff[0]*fEdge[34]; 
  edgeSurf_incr[37] = 3.5625*coeff[0]*fSkin[37]+2.0625*coeff[0]*fEdge[37]+1.6237976320958225*coeff[0]*fSkin[35]-1.6237976320958225*coeff[0]*fEdge[35]; 
  edgeSurf_incr[38] = 1.6237976320958225*coeff[0]*fSkin[39]+1.6237976320958225*coeff[0]*fEdge[39]+0.9375*coeff[0]*fSkin[38]-0.9375*coeff[0]*fEdge[38]; 
  edgeSurf_incr[39] = 3.5625*coeff[0]*fSkin[39]+2.0625*coeff[0]*fEdge[39]+1.6237976320958225*coeff[0]*fSkin[38]-1.6237976320958225*coeff[0]*fEdge[38]; 
