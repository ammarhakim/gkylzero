...
GKYL_CU_DH void euler_pkpm_explicit_source_1x_tensor_p1(const double *qmem, const double *vlasov_pkpm_moms, const double *euler_pkpm, double* out) 
{ 
  // qmem:             q/m*EM fields.
  ...
  outrhoux[1] += 0.6324555320336759*Ex[1]*rho[2]-0.7071067811865475*By[0]*rhouz[1]+0.7071067811865475*Bz[0]*rhouy[1]+0.7071067811865475*Ex[0]*rho[1]+0.7071067811865475*rho[0]*Ex[1]+0.7071067811865475*rhouy[0]*Bz[1]-0.7071067811865475*rhouz[0]*By[1]; 
  ...
  outrhouy[1] += 0.6324555320336759*Ey[1]*rho[2]+0.7071067811865475*Bx[0]*rhouz[1]-0.7071067811865475*Bz[0]*rhoux[1]+0.7071067811865475*Ey[0]*rho[1]+0.7071067811865475*rho[0]*Ey[1]-0.7071067811865475*rhoux[0]*Bz[1]+0.7071067811865475*rhouz[0]*Bx[1]; 
  ...
  outrhouz[1] += 0.6324555320336759*Ez[1]*rho[2]-0.7071067811865475*Bx[0]*rhouy[1]+0.7071067811865475*By[0]*rhoux[1]+0.7071067811865475*Ez[0]*rho[1]+0.7071067811865475*rho[0]*Ez[1]+0.7071067811865475*rhoux[0]*By[1]-0.7071067811865475*rhouy[0]*Bx[1]; 
