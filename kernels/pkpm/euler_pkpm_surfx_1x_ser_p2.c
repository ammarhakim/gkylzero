...
{ 
  ...
  Ghat_rhoux_l = 0.1976423537605236*rho_l[2]*uxl_r_sq+0.1976423537605236*rho_c[2]*uxl_r_sq+0.1530931089239486*rho_l[1]*uxl_r_sq-0.1530931089239486*rho_c[1]*uxl_r_sq+0.0883883476483184*rho_l[0]*uxl_r_sq+0.0883883476483184*rho_c[0]*uxl_r_sq+0.3952847075210473*rho_l[2]*uxc_l*uxl_r+0.3952847075210473*rho_c[2]*uxc_l*uxl_r+0.3061862178478971*rho_l[1]*uxc_l*uxl_r-0.3061862178478971*rho_c[1]*uxc_l*uxl_r+0.1767766952966368*rho_l[0]*uxc_l*uxl_r+0.1767766952966368*rho_c[0]*uxc_l*uxl_r+0.3952847075210473*rho_l[2]*max_speed_l*uxl_r-0.3952847075210473*rho_c[2]*max_speed_l*uxl_r+0.3061862178478971*rho_l[1]*max_speed_l*uxl_r+0.3061862178478971*rho_c[1]*max_speed_l*uxl_r+0.1767766952966368*rho_l[0]*max_speed_l*uxl_r-0.1767766952966368*rho_c[0]*max_speed_l*uxl_r+0.1976423537605236*rho_l[2]*uxc_l_sq+0.1976423537605236*rho_c[2]*uxc_l_sq+0.1530931089239486*rho_l[1]*uxc_l_sq-0.1530931089239486*rho_c[1]*uxc_l_sq+0.0883883476483184*rho_l[0]*uxc_l_sq+0.0883883476483184*rho_c[0]*uxc_l_sq+0.3952847075210473*rho_l[2]*max_speed_l*uxc_l-0.3952847075210473*rho_c[2]*max_speed_l*uxc_l+0.3061862178478971*rho_l[1]*max_speed_l*uxc_l+0.3061862178478971*rho_c[1]*max_speed_l*uxc_l+0.1767766952966368*rho_l[0]*max_speed_l*uxc_l-0.1767766952966368*rho_c[0]*max_speed_l*uxc_l+0.7905694150420947*Pxx_l[2]+0.7905694150420947*Pxx_c[2]+0.6123724356957944*Pxx_l[1]-0.6123724356957944*Pxx_c[1]+0.3535533905932737*Pxx_l[0]+0.3535533905932737*Pxx_c[0] - pkpm_penalization_rhoux_l[0]; 
  Ghat_rhouy_l = 0.1976423537605237*rho_l[2]*uxl_r*uyl_r+0.1976423537605237*rho_c[2]*uxl_r*uyl_r+0.1530931089239486*rho_l[1]*uxl_r*uyl_r-0.1530931089239486*rho_c[1]*uxl_r*uyl_r+0.08838834764831843*rho_l[0]*uxl_r*uyl_r+0.08838834764831843*rho_c[0]*uxl_r*uyl_r+0.1976423537605237*rho_l[2]*uxc_l*uyl_r+0.1976423537605237*rho_c[2]*uxc_l*uyl_r+0.1530931089239486*rho_l[1]*uxc_l*uyl_r-0.1530931089239486*rho_c[1]*uxc_l*uyl_r+0.08838834764831843*rho_l[0]*uxc_l*uyl_r+0.08838834764831843*rho_c[0]*uxc_l*uyl_r+0.3952847075210474*rho_l[2]*max_speed_l*uyl_r-0.3952847075210474*rho_c[2]*max_speed_l*uyl_r+0.3061862178478972*rho_l[1]*max_speed_l*uyl_r+0.3061862178478972*rho_c[1]*max_speed_l*uyl_r+0.1767766952966369*rho_l[0]*max_speed_l*uyl_r-0.1767766952966369*rho_c[0]*max_speed_l*uyl_r+0.1976423537605237*rho_l[2]*uxl_r*uyc_l+0.1976423537605237*rho_c[2]*uxl_r*uyc_l+0.1530931089239486*rho_l[1]*uxl_r*uyc_l-0.1530931089239486*rho_c[1]*uxl_r*uyc_l+0.08838834764831843*rho_l[0]*uxl_r*uyc_l+0.08838834764831843*rho_c[0]*uxl_r*uyc_l+0.1976423537605237*rho_l[2]*uxc_l*uyc_l+0.1976423537605237*rho_c[2]*uxc_l*uyc_l+0.1530931089239486*rho_l[1]*uxc_l*uyc_l-0.1530931089239486*rho_c[1]*uxc_l*uyc_l+0.08838834764831843*rho_l[0]*uxc_l*uyc_l+0.08838834764831843*rho_c[0]*uxc_l*uyc_l+0.3952847075210474*rho_l[2]*max_speed_l*uyc_l-0.3952847075210474*rho_c[2]*max_speed_l*uyc_l+0.3061862178478972*rho_l[1]*max_speed_l*uyc_l+0.3061862178478972*rho_c[1]*max_speed_l*uyc_l+0.1767766952966369*rho_l[0]*max_speed_l*uyc_l-0.1767766952966369*rho_c[0]*max_speed_l*uyc_l+0.7905694150420948*Pxy_l[2]+0.7905694150420948*Pxy_c[2]+0.6123724356957945*Pxy_l[1]-0.6123724356957945*Pxy_c[1]+0.3535533905932737*Pxy_l[0]+0.3535533905932737*Pxy_c[0] - pkpm_penalization_rhouy_l[0]; 
  Ghat_rhouz_l = 0.1976423537605237*rho_l[2]*uxl_r*uzl_r+0.1976423537605237*rho_c[2]*uxl_r*uzl_r+0.1530931089239486*rho_l[1]*uxl_r*uzl_r-0.1530931089239486*rho_c[1]*uxl_r*uzl_r+0.08838834764831843*rho_l[0]*uxl_r*uzl_r+0.08838834764831843*rho_c[0]*uxl_r*uzl_r+0.1976423537605237*rho_l[2]*uxc_l*uzl_r+0.1976423537605237*rho_c[2]*uxc_l*uzl_r+0.1530931089239486*rho_l[1]*uxc_l*uzl_r-0.1530931089239486*rho_c[1]*uxc_l*uzl_r+0.08838834764831843*rho_l[0]*uxc_l*uzl_r+0.08838834764831843*rho_c[0]*uxc_l*uzl_r+0.3952847075210474*rho_l[2]*max_speed_l*uzl_r-0.3952847075210474*rho_c[2]*max_speed_l*uzl_r+0.3061862178478972*rho_l[1]*max_speed_l*uzl_r+0.3061862178478972*rho_c[1]*max_speed_l*uzl_r+0.1767766952966369*rho_l[0]*max_speed_l*uzl_r-0.1767766952966369*rho_c[0]*max_speed_l*uzl_r+0.1976423537605237*rho_l[2]*uxl_r*uzc_l+0.1976423537605237*rho_c[2]*uxl_r*uzc_l+0.1530931089239486*rho_l[1]*uxl_r*uzc_l-0.1530931089239486*rho_c[1]*uxl_r*uzc_l+0.08838834764831843*rho_l[0]*uxl_r*uzc_l+0.08838834764831843*rho_c[0]*uxl_r*uzc_l+0.1976423537605237*rho_l[2]*uxc_l*uzc_l+0.1976423537605237*rho_c[2]*uxc_l*uzc_l+0.1530931089239486*rho_l[1]*uxc_l*uzc_l-0.1530931089239486*rho_c[1]*uxc_l*uzc_l+0.08838834764831843*rho_l[0]*uxc_l*uzc_l+0.08838834764831843*rho_c[0]*uxc_l*uzc_l+0.3952847075210474*rho_l[2]*max_speed_l*uzc_l-0.3952847075210474*rho_c[2]*max_speed_l*uzc_l+0.3061862178478972*rho_l[1]*max_speed_l*uzc_l+0.3061862178478972*rho_c[1]*max_speed_l*uzc_l+0.1767766952966369*rho_l[0]*max_speed_l*uzc_l-0.1767766952966369*rho_c[0]*max_speed_l*uzc_l+0.7905694150420948*Pxz_l[2]+0.7905694150420948*Pxz_c[2]+0.6123724356957945*Pxz_l[1]-0.6123724356957945*Pxz_c[1]+0.3535533905932737*Pxz_l[0]+0.3535533905932737*Pxz_c[0] - pkpm_penalization_rhouz_l[0]; 
  Ghat_rhoux_r = 0.1976423537605236*rho_r[2]*uxr_l_sq+0.1976423537605236*rho_c[2]*uxr_l_sq-0.1530931089239486*rho_r[1]*uxr_l_sq+0.1530931089239486*rho_c[1]*uxr_l_sq+0.0883883476483184*rho_r[0]*uxr_l_sq+0.0883883476483184*rho_c[0]*uxr_l_sq+0.3952847075210473*rho_r[2]*uxc_r*uxr_l+0.3952847075210473*rho_c[2]*uxc_r*uxr_l-0.3061862178478971*rho_r[1]*uxc_r*uxr_l+0.3061862178478971*rho_c[1]*uxc_r*uxr_l+0.1767766952966368*rho_r[0]*uxc_r*uxr_l+0.1767766952966368*rho_c[0]*uxc_r*uxr_l-0.3952847075210473*rho_r[2]*max_speed_r*uxr_l+0.3952847075210473*rho_c[2]*max_speed_r*uxr_l+0.3061862178478971*rho_r[1]*max_speed_r*uxr_l+0.3061862178478971*rho_c[1]*max_speed_r*uxr_l-0.1767766952966368*rho_r[0]*max_speed_r*uxr_l+0.1767766952966368*rho_c[0]*max_speed_r*uxr_l+0.1976423537605236*rho_r[2]*uxc_r_sq+0.1976423537605236*rho_c[2]*uxc_r_sq-0.1530931089239486*rho_r[1]*uxc_r_sq+0.1530931089239486*rho_c[1]*uxc_r_sq+0.0883883476483184*rho_r[0]*uxc_r_sq+0.0883883476483184*rho_c[0]*uxc_r_sq-0.3952847075210473*rho_r[2]*max_speed_r*uxc_r+0.3952847075210473*rho_c[2]*max_speed_r*uxc_r+0.3061862178478971*rho_r[1]*max_speed_r*uxc_r+0.3061862178478971*rho_c[1]*max_speed_r*uxc_r-0.1767766952966368*rho_r[0]*max_speed_r*uxc_r+0.1767766952966368*rho_c[0]*max_speed_r*uxc_r+0.7905694150420947*Pxx_r[2]+0.7905694150420947*Pxx_c[2]-0.6123724356957944*Pxx_r[1]+0.6123724356957944*Pxx_c[1]+0.3535533905932737*Pxx_r[0]+0.3535533905932737*Pxx_c[0] - pkpm_penalization_rhoux_r[0]; 
  Ghat_rhouy_r = 0.1976423537605237*rho_r[2]*uxr_l*uyr_l+0.1976423537605237*rho_c[2]*uxr_l*uyr_l-0.1530931089239486*rho_r[1]*uxr_l*uyr_l+0.1530931089239486*rho_c[1]*uxr_l*uyr_l+0.08838834764831843*rho_r[0]*uxr_l*uyr_l+0.08838834764831843*rho_c[0]*uxr_l*uyr_l+0.1976423537605237*rho_r[2]*uxc_r*uyr_l+0.1976423537605237*rho_c[2]*uxc_r*uyr_l-0.1530931089239486*rho_r[1]*uxc_r*uyr_l+0.1530931089239486*rho_c[1]*uxc_r*uyr_l+0.08838834764831843*rho_r[0]*uxc_r*uyr_l+0.08838834764831843*rho_c[0]*uxc_r*uyr_l-0.3952847075210474*rho_r[2]*max_speed_r*uyr_l+0.3952847075210474*rho_c[2]*max_speed_r*uyr_l+0.3061862178478972*rho_r[1]*max_speed_r*uyr_l+0.3061862178478972*rho_c[1]*max_speed_r*uyr_l-0.1767766952966369*rho_r[0]*max_speed_r*uyr_l+0.1767766952966369*rho_c[0]*max_speed_r*uyr_l+0.1976423537605237*rho_r[2]*uxr_l*uyc_r+0.1976423537605237*rho_c[2]*uxr_l*uyc_r-0.1530931089239486*rho_r[1]*uxr_l*uyc_r+0.1530931089239486*rho_c[1]*uxr_l*uyc_r+0.08838834764831843*rho_r[0]*uxr_l*uyc_r+0.08838834764831843*rho_c[0]*uxr_l*uyc_r+0.1976423537605237*rho_r[2]*uxc_r*uyc_r+0.1976423537605237*rho_c[2]*uxc_r*uyc_r-0.1530931089239486*rho_r[1]*uxc_r*uyc_r+0.1530931089239486*rho_c[1]*uxc_r*uyc_r+0.08838834764831843*rho_r[0]*uxc_r*uyc_r+0.08838834764831843*rho_c[0]*uxc_r*uyc_r-0.3952847075210474*rho_r[2]*max_speed_r*uyc_r+0.3952847075210474*rho_c[2]*max_speed_r*uyc_r+0.3061862178478972*rho_r[1]*max_speed_r*uyc_r+0.3061862178478972*rho_c[1]*max_speed_r*uyc_r-0.1767766952966369*rho_r[0]*max_speed_r*uyc_r+0.1767766952966369*rho_c[0]*max_speed_r*uyc_r+0.7905694150420948*Pxy_r[2]+0.7905694150420948*Pxy_c[2]-0.6123724356957945*Pxy_r[1]+0.6123724356957945*Pxy_c[1]+0.3535533905932737*Pxy_r[0]+0.3535533905932737*Pxy_c[0] - pkpm_penalization_rhouy_r[0]; 
  Ghat_rhouz_r = 0.1976423537605237*rho_r[2]*uxr_l*uzr_l+0.1976423537605237*rho_c[2]*uxr_l*uzr_l-0.1530931089239486*rho_r[1]*uxr_l*uzr_l+0.1530931089239486*rho_c[1]*uxr_l*uzr_l+0.08838834764831843*rho_r[0]*uxr_l*uzr_l+0.08838834764831843*rho_c[0]*uxr_l*uzr_l+0.1976423537605237*rho_r[2]*uxc_r*uzr_l+0.1976423537605237*rho_c[2]*uxc_r*uzr_l-0.1530931089239486*rho_r[1]*uxc_r*uzr_l+0.1530931089239486*rho_c[1]*uxc_r*uzr_l+0.08838834764831843*rho_r[0]*uxc_r*uzr_l+0.08838834764831843*rho_c[0]*uxc_r*uzr_l-0.3952847075210474*rho_r[2]*max_speed_r*uzr_l+0.3952847075210474*rho_c[2]*max_speed_r*uzr_l+0.3061862178478972*rho_r[1]*max_speed_r*uzr_l+0.3061862178478972*rho_c[1]*max_speed_r*uzr_l-0.1767766952966369*rho_r[0]*max_speed_r*uzr_l+0.1767766952966369*rho_c[0]*max_speed_r*uzr_l+0.1976423537605237*rho_r[2]*uxr_l*uzc_r+0.1976423537605237*rho_c[2]*uxr_l*uzc_r-0.1530931089239486*rho_r[1]*uxr_l*uzc_r+0.1530931089239486*rho_c[1]*uxr_l*uzc_r+0.08838834764831843*rho_r[0]*uxr_l*uzc_r+0.08838834764831843*rho_c[0]*uxr_l*uzc_r+0.1976423537605237*rho_r[2]*uxc_r*uzc_r+0.1976423537605237*rho_c[2]*uxc_r*uzc_r-0.1530931089239486*rho_r[1]*uxc_r*uzc_r+0.1530931089239486*rho_c[1]*uxc_r*uzc_r+0.08838834764831843*rho_r[0]*uxc_r*uzc_r+0.08838834764831843*rho_c[0]*uxc_r*uzc_r-0.3952847075210474*rho_r[2]*max_speed_r*uzc_r+0.3952847075210474*rho_c[2]*max_speed_r*uzc_r+0.3061862178478972*rho_r[1]*max_speed_r*uzc_r+0.3061862178478972*rho_c[1]*max_speed_r*uzc_r-0.1767766952966369*rho_r[0]*max_speed_r*uzc_r+0.1767766952966369*rho_c[0]*max_speed_r*uzc_r+0.7905694150420948*Pxz_r[2]+0.7905694150420948*Pxz_c[2]-0.6123724356957945*Pxz_r[1]+0.6123724356957945*Pxz_c[1]+0.3535533905932737*Pxz_r[0]+0.3535533905932737*Pxz_c[0] - pkpm_penalization_rhouz_r[0]; 
