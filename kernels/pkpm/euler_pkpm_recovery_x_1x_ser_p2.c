...
{ 
  ...
  grad_u_z[0] += ((-0.2445699350390395*(uy_l[2]+uy_c[2]))-0.3518228202874282*uy_l[1]+0.3518228202874282*uy_c[1]-0.25*(uy_l[0]+uy_c[0]))*dx1; 
  grad_u_z[1] += (0.4236075534914363*(uy_l[2]+uy_c[2])+0.609375*uy_l[1]-0.609375*uy_c[1]+0.4330127018922193*(uy_l[0]+uy_c[0]))*dx1; 
  grad_u_z[2] += ((-0.546875*(uy_l[2]+uy_c[2]))-0.7866997421983816*uy_l[1]+0.7866997421983816*uy_c[1]-0.5590169943749475*(uy_l[0]+uy_c[0]))*dx1; 
  ...
  grad_u_z[0] += (0.2445699350390395*(uy_r[2]+uy_c[2])-0.3518228202874282*uy_r[1]+0.3518228202874282*uy_c[1]+0.25*(uy_r[0]+uy_c[0]))*dx1; 
  grad_u_z[1] += (0.4236075534914363*(uy_r[2]+uy_c[2])-0.609375*uy_r[1]+0.609375*uy_c[1]+0.4330127018922193*(uy_r[0]+uy_c[0]))*dx1; 
  grad_u_z[2] += (0.546875*(uy_r[2]+uy_c[2])-0.7866997421983816*uy_r[1]+0.7866997421983816*uy_c[1]+0.5590169943749475*(uy_r[0]+uy_c[0]))*dx1; 
