...
{ 
  ...
  u_l[0] = ser_2x_p1_surfx2_eval_quad_node_0_r(ux_l); 
  u_l[1] = ser_2x_p1_surfx2_eval_quad_node_0_r(uy_l); 
  u_l[2] = ser_2x_p1_surfx2_eval_quad_node_0_r(uz_l); 
  q_l[1] = q_l[0]*u_l[0]; 
  q_l[2] = q_l[0]*u_l[1]; 
  q_l[3] = q_l[0]*u_l[2]; 
  ...
  u_r[0] = ser_2x_p1_surfx2_eval_quad_node_0_l(ux_r); 
  u_r[1] = ser_2x_p1_surfx2_eval_quad_node_0_l(uy_r); 
  u_r[2] = ser_2x_p1_surfx2_eval_quad_node_0_l(uz_r); 
  q_r[1] = q_r[0]*u_r[0]; 
  q_r[2] = q_r[0]*u_r[1]; 
  q_r[3] = q_r[0]*u_r[2]; 
  ...
  T_l = ser_2x_p1_surfx2_eval_quad_node_0_l(Tii_l); 
  ...
  u_l[0] = ser_2x_p1_surfx2_eval_quad_node_1_r(ux_l); 
  u_l[1] = ser_2x_p1_surfx2_eval_quad_node_1_r(uy_l); 
  u_l[2] = ser_2x_p1_surfx2_eval_quad_node_1_r(uz_l); 
  q_l[1] = q_l[0]*u_l[0]; 
  q_l[2] = q_l[0]*u_l[1]; 
  q_l[3] = q_l[0]*u_l[2]; 
  ...
  u_r[0] = ser_2x_p1_surfx2_eval_quad_node_1_l(ux_r); 
  u_r[1] = ser_2x_p1_surfx2_eval_quad_node_1_l(uy_r); 
  u_r[2] = ser_2x_p1_surfx2_eval_quad_node_1_l(uz_r); 
  q_r[1] = q_r[0]*u_r[0]; 
  q_r[2] = q_r[0]*u_r[1]; 
  q_r[3] = q_r[0]*u_r[2]; 
  ...
  T_l = ser_2x_p1_surfx2_eval_quad_node_1_l(Tii_l); 
