...
{ 
  ...
  const double *F_0_sourcel = &fl[9]; 
  const double *G_1_sourcel = &g_dist_sourcel[0]; 
  const double *F_0_sourcec = &fc[9]; 
  const double *G_1_sourcec = &g_dist_sourcec[0]; 
  const double *F_0_sourcer = &fr[9]; 
  ...
  if (0.6324555320336759*div_b_Surf[2]-0.9486832980505137*div_b_Surf[1]+0.7071067811865475*div_b_Surf[0] > 0) { 
    F_0_div_b_UpwindQuad_l[0] = tensor_2x_p2_surfx2_eval_quad_node_0_r(F_0_sourcel); 
    F_0_div_b_UpwindQuad_r[0] = tensor_2x_p2_surfx2_eval_quad_node_0_r(F_0_sourcec); 
    G_1_div_b_UpwindQuad_l[0] = tensor_2x_p2_surfx2_eval_quad_node_0_r(G_1_sourcel); 
    G_1_div_b_UpwindQuad_r[0] = tensor_2x_p2_surfx2_eval_quad_node_0_r(G_1_sourcec); 
  } else { 
    F_0_div_b_UpwindQuad_l[0] = tensor_2x_p2_surfx2_eval_quad_node_0_l(F_0_sourcec); 
    F_0_div_b_UpwindQuad_r[0] = tensor_2x_p2_surfx2_eval_quad_node_0_l(F_0_sourcer); 
    G_1_div_b_UpwindQuad_l[0] = tensor_2x_p2_surfx2_eval_quad_node_0_l(G_1_sourcec); 
    G_1_div_b_UpwindQuad_r[0] = tensor_2x_p2_surfx2_eval_quad_node_0_l(G_1_sourcer); 
  } 
  if (0.7071067811865475*div_b_Surf[0]-0.7905694150420947*div_b_Surf[2] > 0) { 
    F_0_div_b_UpwindQuad_l[1] = tensor_2x_p2_surfx2_eval_quad_node_1_r(F_0_sourcel); 
    F_0_div_b_UpwindQuad_r[1] = tensor_2x_p2_surfx2_eval_quad_node_1_r(F_0_sourcec); 
    G_1_div_b_UpwindQuad_l[1] = tensor_2x_p2_surfx2_eval_quad_node_1_r(G_1_sourcel); 
    G_1_div_b_UpwindQuad_r[1] = tensor_2x_p2_surfx2_eval_quad_node_1_r(G_1_sourcec); 
  } else { 
    F_0_div_b_UpwindQuad_l[1] = tensor_2x_p2_surfx2_eval_quad_node_1_l(F_0_sourcec); 
    F_0_div_b_UpwindQuad_r[1] = tensor_2x_p2_surfx2_eval_quad_node_1_l(F_0_sourcer); 
    G_1_div_b_UpwindQuad_l[1] = tensor_2x_p2_surfx2_eval_quad_node_1_l(G_1_sourcec); 
    G_1_div_b_UpwindQuad_r[1] = tensor_2x_p2_surfx2_eval_quad_node_1_l(G_1_sourcer); 
  } 
  if (0.6324555320336759*div_b_Surf[2]+0.9486832980505137*div_b_Surf[1]+0.7071067811865475*div_b_Surf[0] > 0) { 
    F_0_div_b_UpwindQuad_l[2] = tensor_2x_p2_surfx2_eval_quad_node_2_r(F_0_sourcel); 
    F_0_div_b_UpwindQuad_r[2] = tensor_2x_p2_surfx2_eval_quad_node_2_r(F_0_sourcec); 
    G_1_div_b_UpwindQuad_l[2] = tensor_2x_p2_surfx2_eval_quad_node_2_r(G_1_sourcel); 
    G_1_div_b_UpwindQuad_r[2] = tensor_2x_p2_surfx2_eval_quad_node_2_r(G_1_sourcec); 
  } else { 
    F_0_div_b_UpwindQuad_l[2] = tensor_2x_p2_surfx2_eval_quad_node_2_l(F_0_sourcec); 
    F_0_div_b_UpwindQuad_r[2] = tensor_2x_p2_surfx2_eval_quad_node_2_l(F_0_sourcer); 
    G_1_div_b_UpwindQuad_l[2] = tensor_2x_p2_surfx2_eval_quad_node_2_l(G_1_sourcec); 
    G_1_div_b_UpwindQuad_r[2] = tensor_2x_p2_surfx2_eval_quad_node_2_l(G_1_sourcer); 
  } 

  // Project tensor nodal quadrature basis back onto modal basis. 
  tensor_2x_p2_upwind_quad_to_modal(F_0_div_b_UpwindQuad_l, F_0_div_b_Upwind_l); 
  tensor_2x_p2_upwind_quad_to_modal(F_0_div_b_UpwindQuad_r, F_0_div_b_Upwind_r); 
  tensor_2x_p2_upwind_quad_to_modal(G_1_div_b_UpwindQuad_l, G_1_div_b_Upwind_l); 
  tensor_2x_p2_upwind_quad_to_modal(G_1_div_b_UpwindQuad_r, G_1_div_b_Upwind_r); 
  ...
  out_F_0[8] += ((-1.58113883008419*Ghat_F_0_r[2])+1.58113883008419*Ghat_F_0_l[2]-1.58113883008419*Ghat_F_0_div_b_r[2]+1.58113883008419*Ghat_F_0_div_b_l[2])*dv1par; 
  ...
  out_G_1[8] += ((-1.58113883008419*Ghat_G_1_r[2])+1.58113883008419*Ghat_G_1_l[2]-1.58113883008419*Ghat_G_1_div_b_r[2]+1.58113883008419*Ghat_G_1_div_b_l[2])*dv1par; 
