...
{ 
  ...
  grad_u_x[1] += dx1*((0.1443375672974064*ux_r[3]-0.1443375672974064*ux_c[3])*phi_x_r+(0.1443375672974064*ux_l[3]-0.1443375672974064*ux_c[3])*phi_x_l-0.4330127018922193*(ux_r[3]+ux_l[3])+0.8660254037844386*ux_c[3]+0.25*ux_r[1]-0.25*ux_l[1]); 
  ...
  grad_u_x[3] += dx1*((0.25*ux_r[3]-0.25*ux_c[3])*phi_x_r+(0.25*ux_c[3]-0.25*ux_l[3])*phi_x_l-0.75*ux_r[3]+0.75*ux_l[3]+0.4330127018922193*(ux_r[1]+ux_l[1])+0.8660254037844386*ux_c[1]); 
  ...
  div_p_x_comp[1] += dx1*((0.1443375672974064*Pxy_r[3]-0.1443375672974064*Pxy_c[3])*phi_x_r+(0.1443375672974064*Pxy_l[3]-0.1443375672974064*Pxy_c[3])*phi_x_l-0.4330127018922193*(Pxy_r[3]+Pxy_l[3])+0.8660254037844386*Pxy_c[3]+0.25*Pxy_r[1]-0.25*Pxy_l[1]); 
  ...
  div_p_x_comp[3] += dx1*((0.25*Pxy_r[3]-0.25*Pxy_c[3])*phi_x_r+(0.25*Pxy_c[3]-0.25*Pxy_l[3])*phi_x_l-0.75*Pxy_r[3]+0.75*Pxy_l[3]+0.4330127018922193*(Pxy_r[1]+Pxy_l[1])+0.8660254037844386*Pxy_c[1]); 
  ...
  grad_u_y[1] += dx1*((0.1443375672974064*uy_r[3]-0.1443375672974064*uy_c[3])*phi_y_r+(0.1443375672974064*uy_l[3]-0.1443375672974064*uy_c[3])*phi_y_l-0.4330127018922193*(uy_r[3]+uy_l[3])+0.8660254037844386*uy_c[3]+0.25*uy_r[1]-0.25*uy_l[1]); 
  ...
  grad_u_y[3] += dx1*((0.25*uy_r[3]-0.25*uy_c[3])*phi_y_r+(0.25*uy_c[3]-0.25*uy_l[3])*phi_y_l-0.75*uy_r[3]+0.75*uy_l[3]+0.4330127018922193*(uy_r[1]+uy_l[1])+0.8660254037844386*uy_c[1]); 
  ...
  div_p_y_comp[1] += dx1*((0.1443375672974064*Pyy_r[3]-0.1443375672974064*Pyy_c[3])*phi_y_r+(0.1443375672974064*Pyy_l[3]-0.1443375672974064*Pyy_c[3])*phi_y_l-0.4330127018922193*(Pyy_r[3]+Pyy_l[3])+0.8660254037844386*Pyy_c[3]+0.25*Pyy_r[1]-0.25*Pyy_l[1]); 
  ...
  div_p_y_comp[3] += dx1*((0.25*Pyy_r[3]-0.25*Pyy_c[3])*phi_y_r+(0.25*Pyy_c[3]-0.25*Pyy_l[3])*phi_y_l-0.75*Pyy_r[3]+0.75*Pyy_l[3]+0.4330127018922193*(Pyy_r[1]+Pyy_l[1])+0.8660254037844386*Pyy_c[1]); 
  ...
  grad_u_z[1] += dx1*((0.1443375672974064*uz_r[3]-0.1443375672974064*uz_c[3])*phi_z_r+(0.1443375672974064*uz_l[3]-0.1443375672974064*uz_c[3])*phi_z_l-0.4330127018922193*(uz_r[3]+uz_l[3])+0.8660254037844386*uz_c[3]+0.25*uz_r[1]-0.25*uz_l[1]); 
  ...
  grad_u_z[3] += dx1*((0.25*uz_r[3]-0.25*uz_c[3])*phi_z_r+(0.25*uz_c[3]-0.25*uz_l[3])*phi_z_l-0.75*uz_r[3]+0.75*uz_l[3]+0.4330127018922193*(uz_r[1]+uz_l[1])+0.8660254037844386*uz_c[1]); 
  ...
  div_p_z_comp[1] += dx1*((0.1443375672974064*Pyz_r[3]-0.1443375672974064*Pyz_c[3])*phi_z_r+(0.1443375672974064*Pyz_l[3]-0.1443375672974064*Pyz_c[3])*phi_z_l-0.4330127018922193*(Pyz_r[3]+Pyz_l[3])+0.8660254037844386*Pyz_c[3]+0.25*Pyz_r[1]-0.25*Pyz_l[1]); 
  ...
  div_p_z_comp[3] += dx1*((0.25*Pyz_r[3]-0.25*Pyz_c[3])*phi_z_r+(0.25*Pyz_c[3]-0.25*Pyz_l[3])*phi_z_l-0.75*Pyz_r[3]+0.75*Pyz_l[3]+0.4330127018922193*(Pyz_r[1]+Pyz_l[1])+0.8660254037844386*Pyz_c[1]); 
