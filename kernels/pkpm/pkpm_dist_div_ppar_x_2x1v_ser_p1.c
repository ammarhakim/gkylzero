...
{ 
  ...
  const double *pkpm_max_b_r = &pkpm_max_b[2]; 
  ...
  pkpm_div_ppar[1] += dx1*volFact*((1.732050807568877*(Ghat_F_0_vpar_r[0]+Ghat_F_0_vpar_l[0])-0.8660254037844386*(F_0c[7]*alpha_c[7]+F_0c[6]*alpha_c[6]+F_0c[5]*alpha_c[5]+F_0c[4]*alpha_c[4]+F_0c[3]*alpha_c[3]+F_0c[2]*alpha_c[2]+F_0c[1]*alpha_c[1]+F_0c[0]*alpha_c[0]))*wvpar+((-0.223606797749979*alpha_c[7]*F_0c[11])-0.223606797749979*(alpha_c[6]*F_0c[10]+alpha_c[5]*F_0c[9])-0.223606797749979*alpha_c[3]*F_0c[8]-0.25*(F_0c[4]*alpha_c[7]+alpha_c[4]*F_0c[7]+F_0c[2]*alpha_c[6]+alpha_c[2]*F_0c[6]+F_0c[1]*alpha_c[5]+alpha_c[1]*F_0c[5]+F_0c[0]*alpha_c[3]+alpha_c[0]*F_0c[3])+0.5*(Ghat_F_0_vpar_r[2]+Ghat_F_0_vpar_l[2]))*dvpar); 
  pkpm_div_ppar[2] += dx1*volFact*((Ghat_F_0_vpar_r[1]-1.0*Ghat_F_0_vpar_l[1])*wvpar+(0.2886751345948129*Ghat_F_0_vpar_r[3]-0.2886751345948129*Ghat_F_0_vpar_l[3])*dvpar); 
  pkpm_div_ppar[3] += dx1*volFact*((1.732050807568877*(Ghat_F_0_vpar_r[1]+Ghat_F_0_vpar_l[1])-0.8660254037844386*(F_0c[5]*alpha_c[7]+alpha_c[5]*F_0c[7]+F_0c[3]*alpha_c[6]+alpha_c[3]*F_0c[6]+F_0c[1]*alpha_c[4]+alpha_c[1]*F_0c[4]+F_0c[0]*alpha_c[2]+alpha_c[0]*F_0c[2]))*wvpar+((-0.223606797749979*alpha_c[5]*F_0c[11])-0.223606797749979*(alpha_c[3]*F_0c[10]+alpha_c[7]*F_0c[9])-0.223606797749979*alpha_c[6]*F_0c[8]-0.25*(F_0c[1]*alpha_c[7]+alpha_c[1]*F_0c[7]+F_0c[0]*alpha_c[6]+alpha_c[0]*F_0c[6]+F_0c[4]*alpha_c[5]+alpha_c[4]*F_0c[5]+F_0c[2]*alpha_c[3])+0.5*(Ghat_F_0_vpar_r[3]+Ghat_F_0_vpar_l[3])-0.25*alpha_c[2]*F_0c[3])*dvpar); 
