...
{ 
  ...
  F_0l_rx = 1.118033988749895*F_0l[4]+0.8660254037844386*F_0l[1]+0.5*F_0l[0]; 
  F_0c_lx = 1.118033988749895*F_0c[4]-0.8660254037844386*F_0c[1]+0.5*F_0c[0]; 
  F_0c_rx = 1.118033988749895*F_0c[4]+0.8660254037844386*F_0c[1]+0.5*F_0c[0]; 
  F_0r_lx = 1.118033988749895*F_0r[4]-0.8660254037844386*F_0r[1]+0.5*F_0r[0]; 
  G_1l_rx = 1.118033988749895*G_1l[4]+0.8660254037844386*G_1l[1]+0.5*G_1l[0]; 
  G_1c_lx = 1.118033988749895*G_1c[4]-0.8660254037844386*G_1c[1]+0.5*G_1c[0]; 
  G_1c_rx = 1.118033988749895*G_1c[4]+0.8660254037844386*G_1c[1]+0.5*G_1c[0]; 
  G_1r_lx = 1.118033988749895*G_1r[4]-0.8660254037844386*G_1r[1]+0.5*G_1r[0]; 
  ...
  F_0l_rx = (-1.936491673103709*F_0l[4])-1.5*F_0l[1]-0.8660254037844386*F_0l[0]; 
  F_0c_lx = (-1.936491673103709*F_0c[4])+1.5*F_0c[1]-0.8660254037844386*F_0c[0]; 
  F_0c_rx = 1.936491673103709*F_0c[4]+1.5*F_0c[1]+0.8660254037844386*F_0c[0]; 
  F_0r_lx = 1.936491673103709*F_0r[4]-1.5*F_0r[1]+0.8660254037844386*F_0r[0]; 
  G_1l_rx = (-1.936491673103709*G_1l[4])-1.5*G_1l[1]-0.8660254037844386*G_1l[0]; 
  G_1c_lx = (-1.936491673103709*G_1c[4])+1.5*G_1c[1]-0.8660254037844386*G_1c[0]; 
  G_1c_rx = 1.936491673103709*G_1c[4]+1.5*G_1c[1]+0.8660254037844386*G_1c[0]; 
  G_1r_lx = 1.936491673103709*G_1r[4]-1.5*G_1r[1]+0.8660254037844386*G_1r[0]; 
  ...
  F_0l_rx = 2.5*F_0l[4]+1.936491673103709*F_0l[1]+1.118033988749895*F_0l[0]; 
  F_0c_lx = 2.5*F_0c[4]-1.936491673103709*F_0c[1]+1.118033988749895*F_0c[0]; 
  F_0c_rx = 2.5*F_0c[4]+1.936491673103709*F_0c[1]+1.118033988749895*F_0c[0]; 
  F_0r_lx = 2.5*F_0r[4]-1.936491673103709*F_0r[1]+1.118033988749895*F_0r[0]; 
  G_1l_rx = 2.5*G_1l[4]+1.936491673103709*G_1l[1]+1.118033988749895*G_1l[0]; 
  G_1c_lx = 2.5*G_1c[4]-1.936491673103709*G_1c[1]+1.118033988749895*G_1c[0]; 
  G_1c_rx = 2.5*G_1c[4]+1.936491673103709*G_1c[1]+1.118033988749895*G_1c[0]; 
  G_1r_lx = 2.5*G_1r[4]-1.936491673103709*G_1r[1]+1.118033988749895*G_1r[0]; 
  ...
  F_0l_rx = 0.8660254037844387*F_0l[7]+0.5*F_0l[5]; 
  F_0c_lx = 0.5*F_0c[5]-0.8660254037844387*F_0c[7]; 
  F_0c_rx = 0.8660254037844387*F_0c[7]+0.5*F_0c[5]; 
  F_0r_lx = 0.5*F_0r[5]-0.8660254037844387*F_0r[7]; 
  G_1l_rx = 0.8660254037844387*G_1l[7]+0.5*G_1l[5]; 
  G_1c_lx = 0.5*G_1c[5]-0.8660254037844387*G_1c[7]; 
  G_1c_rx = 0.8660254037844387*G_1c[7]+0.5*G_1c[5]; 
  G_1r_lx = 0.5*G_1r[5]-0.8660254037844387*G_1r[7]; 
  ...
  F_0l_rx = (-1.5*F_0l[7])-0.8660254037844387*F_0l[5]; 
  F_0c_lx = 1.5*F_0c[7]-0.8660254037844387*F_0c[5]; 
  F_0c_rx = 1.5*F_0c[7]+0.8660254037844387*F_0c[5]; 
  F_0r_lx = 0.8660254037844387*F_0r[5]-1.5*F_0r[7]; 
  G_1l_rx = (-1.5*G_1l[7])-0.8660254037844387*G_1l[5]; 
  G_1c_lx = 1.5*G_1c[7]-0.8660254037844387*G_1c[5]; 
  G_1c_rx = 1.5*G_1c[7]+0.8660254037844387*G_1c[5]; 
  G_1r_lx = 0.8660254037844387*G_1r[5]-1.5*G_1r[7]; 
