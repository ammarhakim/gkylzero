...
{ 
  ...
  const double *bl = &bvar_l[4]; 
  const double *bc = &bvar_c[4]; 
  const double *br = &bvar_r[4]; 
  ...
  const double *u_surf_lr = &pkpm_prim_surf_l[22]; 
  const double *u_surf_cl = &pkpm_prim_surf_c[20]; 
  const double *u_surf_cr = &pkpm_prim_surf_c[22]; 
  const double *u_surf_rl = &pkpm_prim_surf_r[20]; 
  ...
  G_1_lr[1] = 1.224744871391589*G_1l[4]+0.7071067811865475*G_1l[1]; 
  G_1_lr[2] = 1.224744871391589*G_1l[6]+0.7071067811865475*G_1l[3]; 
  G_1_lr[3] = 1.224744871391589*G_1l[7]+0.7071067811865475*G_1l[5]; 
  G_1_lr[4] = 1.224744871391589*G_1l[10]+0.7071067811865475*G_1l[8]; 
  G_1_lr[5] = 1.224744871391589*G_1l[11]+0.7071067811865475*G_1l[9]; 

  G_1_cl[0] = 0.7071067811865475*G_1c[0]-1.224744871391589*G_1c[2]; 
  G_1_cl[1] = 0.7071067811865475*G_1c[1]-1.224744871391589*G_1c[4]; 
  G_1_cl[2] = 0.7071067811865475*G_1c[3]-1.224744871391589*G_1c[6]; 
  G_1_cl[3] = 0.7071067811865475*G_1c[5]-1.224744871391589*G_1c[7]; 
  G_1_cl[4] = 0.7071067811865475*G_1c[8]-1.224744871391589*G_1c[10]; 
  G_1_cl[5] = 0.7071067811865475*G_1c[9]-1.224744871391589*G_1c[11]; 

  G_1_cr[0] = 1.224744871391589*G_1c[2]+0.7071067811865475*G_1c[0]; 
  G_1_cr[1] = 1.224744871391589*G_1c[4]+0.7071067811865475*G_1c[1]; 
  G_1_cr[2] = 1.224744871391589*G_1c[6]+0.7071067811865475*G_1c[3]; 
  G_1_cr[3] = 1.224744871391589*G_1c[7]+0.7071067811865475*G_1c[5]; 
  G_1_cr[4] = 1.224744871391589*G_1c[10]+0.7071067811865475*G_1c[8]; 
  G_1_cr[5] = 1.224744871391589*G_1c[11]+0.7071067811865475*G_1c[9]; 

  G_1_rl[0] = 0.7071067811865475*G_1r[0]-1.224744871391589*G_1r[2]; 
  G_1_rl[1] = 0.7071067811865475*G_1r[1]-1.224744871391589*G_1r[4]; 
  G_1_rl[2] = 0.7071067811865475*G_1r[3]-1.224744871391589*G_1r[6]; 
  G_1_rl[3] = 0.7071067811865475*G_1r[5]-1.224744871391589*G_1r[7]; 
  G_1_rl[4] = 0.7071067811865475*G_1r[8]-1.224744871391589*G_1r[10]; 
  G_1_rl[5] = 0.7071067811865475*G_1r[9]-1.224744871391589*G_1r[11]; 
  ...
  out_F_0[10] += -1.224744871391589*(Ghat_F_0_u_r[4]+Ghat_F_0_u_l[4])*dx1; 
  ...
  out_G_1[10] += -1.224744871391589*(Ghat_G_1_u_r[4]+Ghat_G_1_u_l[4])*dx1; 
