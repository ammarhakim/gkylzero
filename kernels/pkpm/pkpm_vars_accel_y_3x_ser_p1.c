...
{ 
  ...
  const double *b_l = &bvar_l[8]; 
  const double *b_c = &bvar_c[8]; 
  const double *b_r = &bvar_r[8]; 
  ...
  const double *Tii_surf_lr = &prim_surf_l[60]; 
  const double *Tii_surf_cl = &prim_surf_c[56]; 
  const double *Tii_surf_cr = &prim_surf_c[60]; 
  const double *Tii_surf_rl = &prim_surf_r[56]; 

  const double *pkpm_div_ppar = &prim_c[24]; 
  const double *T_perp_over_m = &prim_c[32]; 

  double *pkpm_lax_l = &pkpm_lax[8]; 
  double *pkpm_lax_r = &pkpm_lax[12]; 
  ...
  ul_r = 0.5*uy_surf_lr[3]-0.5*uy_surf_lr[2]-0.5*uy_surf_lr[1]+0.5*uy_surf_lr[0]; 
  uc_l = 0.5*uy_surf_cl[3]-0.5*uy_surf_cl[2]-0.5*uy_surf_cl[1]+0.5*uy_surf_cl[0]; 
  uc_r = 0.5*uy_surf_cr[3]-0.5*uy_surf_cr[2]-0.5*uy_surf_cr[1]+0.5*uy_surf_cr[0]; 
  ur_l = 0.5*uy_surf_rl[3]-0.5*uy_surf_rl[2]-0.5*uy_surf_rl[1]+0.5*uy_surf_rl[0]; 
  ...
  div_b_comp[1] = ((-0.2886751345948129*(b_r[4]+b_l[4]))+0.5773502691896258*b_c[4]+0.25*b_r[1]-0.25*b_l[1])*dx1; 
  div_b_comp[2] = ((-0.5*b_r[2])+0.5*b_l[2]+0.4330127018922193*(b_r[0]+b_l[0])-0.8660254037844386*b_c[0])*dx1; 
  div_b_comp[3] = ((-0.2886751345948129*(b_r[6]+b_l[6]))+0.5773502691896258*b_c[6]+0.25*b_r[3]-0.25*b_l[3])*dx1; 
  div_b_comp[4] = ((-0.5*b_r[4])+0.5*b_l[4]+0.4330127018922193*(b_r[1]+b_l[1])-0.8660254037844386*b_c[1])*dx1; 
  div_b_comp[5] = ((-0.2886751345948129*(b_r[7]+b_l[7]))+0.5773502691896258*b_c[7]+0.25*b_r[5]-0.25*b_l[5])*dx1; 
  div_b_comp[6] = ((-0.5*b_r[6])+0.5*b_l[6]+0.4330127018922193*(b_r[3]+b_l[3])-0.8660254037844386*b_c[3])*dx1; 
  div_b_comp[7] = ((-0.5*b_r[7])+0.5*b_l[7]+0.4330127018922193*(b_r[5]+b_l[5])-0.8660254037844386*b_c[5])*dx1; 
