...
{ 
  ...
  for (int i = 0; i < num_species; ++i) { 
    ...
    rhouy[i][0] = inp_euler_pkpm[3]; 
    rhouz[i][0] = inp_euler_pkpm[6]; 
    ...
    rhouy[i][1] = inp_euler_pkpm[4]; 
    rhouz[i][1] = inp_euler_pkpm[7]; 
    ...
    rhouy[i][2] = inp_euler_pkpm[5]; 
    rhouz[i][2] = inp_euler_pkpm[8]; 
  ...
  for (int s = 0; s < num_species; ++s) { 
    ...
    gkyl_mat_set(&rhs, 0 + s*(9), 0, qbym[s]*rhoux[s][0] + 0.5*dt*qbym[s]*qbym[s]*(0.7071067811865475*(ext_Ex[2]*rho[s][2]+ext_Ex[1]*rho[s][1]+ext_Ex[0]*rho[s][0])) + 0.5*dt*qbym[s]*(0.7071067811865475*(app_accel_x[s][2]*rho[s][2]+app_accel_x[s][1]*rho[s][1]+app_accel_x[s][0]*rho[s][0]))); 
    gkyl_mat_set(&rhs, 3 + s*(9), 0, qbym[s]*rhouy[s][0] + 0.5*dt*qbym[s]*qbym[s]*(0.7071067811865475*(ext_Ey[2]*rho[s][2]+ext_Ey[1]*rho[s][1]+ext_Ey[0]*rho[s][0])) + 0.5*dt*qbym[s]*(0.7071067811865475*(app_accel_y[s][2]*rho[s][2]+app_accel_y[s][1]*rho[s][1]+app_accel_y[s][0]*rho[s][0]))); 
    gkyl_mat_set(&rhs, 6 + s*(9), 0, qbym[s]*rhouz[s][0] + 0.5*dt*qbym[s]*qbym[s]*(0.7071067811865475*(ext_Ez[2]*rho[s][2]+ext_Ez[1]*rho[s][1]+ext_Ez[0]*rho[s][0])) + 0.5*dt*qbym[s]*(0.7071067811865475*(app_accel_z[s][2]*rho[s][2]+app_accel_z[s][1]*rho[s][1]+app_accel_z[s][0]*rho[s][0]))); 

    gkyl_mat_set(&rhs, 1 + s*(9), 0, qbym[s]*rhoux[s][1] + 0.5*dt*qbym[s]*qbym[s]*(0.6324555320336759*(ext_Ex[1]*rho[s][2]+rho[s][1]*ext_Ex[2])+0.7071067811865475*(ext_Ex[0]*rho[s][1]+rho[s][0]*ext_Ex[1])) + 0.5*dt*qbym[s]*(0.6324555320336759*(app_accel_x[s][1]*rho[s][2]+rho[s][1]*app_accel_x[s][2])+0.7071067811865475*(app_accel_x[s][0]*rho[s][1]+rho[s][0]*app_accel_x[s][1]))); 
    gkyl_mat_set(&rhs, 4 + s*(9), 0, qbym[s]*rhouy[s][1] + 0.5*dt*qbym[s]*qbym[s]*(0.6324555320336759*(ext_Ey[1]*rho[s][2]+rho[s][1]*ext_Ey[2])+0.7071067811865475*(ext_Ey[0]*rho[s][1]+rho[s][0]*ext_Ey[1])) + 0.5*dt*qbym[s]*(0.6324555320336759*(app_accel_y[s][1]*rho[s][2]+rho[s][1]*app_accel_y[s][2])+0.7071067811865475*(app_accel_y[s][0]*rho[s][1]+rho[s][0]*app_accel_y[s][1]))); 
    gkyl_mat_set(&rhs, 7 + s*(9), 0, qbym[s]*rhouz[s][1] + 0.5*dt*qbym[s]*qbym[s]*(0.6324555320336759*(ext_Ez[1]*rho[s][2]+rho[s][1]*ext_Ez[2])+0.7071067811865475*(ext_Ez[0]*rho[s][1]+rho[s][0]*ext_Ez[1])) + 0.5*dt*qbym[s]*(0.6324555320336759*(app_accel_z[s][1]*rho[s][2]+rho[s][1]*app_accel_z[s][2])+0.7071067811865475*(app_accel_z[s][0]*rho[s][1]+rho[s][0]*app_accel_z[s][1]))); 

    gkyl_mat_set(&rhs, 2 + s*(9), 0, qbym[s]*rhoux[s][2] + 0.5*dt*qbym[s]*qbym[s]*(0.4517539514526256*ext_Ex[2]*rho[s][2]+0.7071067811865475*(ext_Ex[0]*rho[s][2]+rho[s][0]*ext_Ex[2])+0.6324555320336759*ext_Ex[1]*rho[s][1]) + 0.5*dt*qbym[s]*(0.4517539514526256*app_accel_x[s][2]*rho[s][2]+0.7071067811865475*(app_accel_x[s][0]*rho[s][2]+rho[s][0]*app_accel_x[s][2])+0.6324555320336759*app_accel_x[s][1]*rho[s][1])); 
    gkyl_mat_set(&rhs, 5 + s*(9), 0, qbym[s]*rhouy[s][2] + 0.5*dt*qbym[s]*qbym[s]*(0.4517539514526256*ext_Ey[2]*rho[s][2]+0.7071067811865475*(ext_Ey[0]*rho[s][2]+rho[s][0]*ext_Ey[2])+0.6324555320336759*ext_Ey[1]*rho[s][1]) + 0.5*dt*qbym[s]*(0.4517539514526256*app_accel_y[s][2]*rho[s][2]+0.7071067811865475*(app_accel_y[s][0]*rho[s][2]+rho[s][0]*app_accel_y[s][2])+0.6324555320336759*app_accel_y[s][1]*rho[s][1])); 
    gkyl_mat_set(&rhs, 8 + s*(9), 0, qbym[s]*rhouz[s][2] + 0.5*dt*qbym[s]*qbym[s]*(0.4517539514526256*ext_Ez[2]*rho[s][2]+0.7071067811865475*(ext_Ez[0]*rho[s][2]+rho[s][0]*ext_Ez[2])+0.6324555320336759*ext_Ez[1]*rho[s][1]) + 0.5*dt*qbym[s]*(0.4517539514526256*app_accel_z[s][2]*rho[s][2]+0.7071067811865475*(app_accel_z[s][0]*rho[s][2]+rho[s][0]*app_accel_z[s][2])+0.6324555320336759*app_accel_z[s][1]*rho[s][1])); 
