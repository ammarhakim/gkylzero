...
{ 
  ...
  double ux_nodal[GKYL_MAX_SPECIES][4]; 
  double uy_nodal[GKYL_MAX_SPECIES][4]; 
  double uz_nodal[GKYL_MAX_SPECIES][4]; 
  ...
  for (int s = 0; s < num_species; ++s) { 
    ...
    modal_to_quad_nodal_2d_ser_p1(ux[s], ux_nodal[s]);
    modal_to_quad_nodal_2d_ser_p1(uy[s], uy_nodal[s]);
    modal_to_quad_nodal_2d_ser_p1(uz[s], uz_nodal[s]);
