...
{ 
  ...
  flux_rho_l[0] = 0.2795084971874737*ux_surf_lr[2]*rho_l[8]+0.2795084971874737*ux_surf_cl[2]*rho_l[8]+0.5590169943749475*pkpm_lax_l[2]*rho_l[8]+0.2795084971874737*ux_surf_lr[2]*rho_c[8]+0.2795084971874737*ux_surf_cl[2]*rho_c[8]-0.5590169943749475*pkpm_lax_l[2]*rho_c[8]+0.2165063509461097*ux_surf_lr[2]*rho_l[7]+0.2165063509461097*ux_surf_cl[2]*rho_l[7]+0.4330127018922194*pkpm_lax_l[2]*rho_l[7]-0.2165063509461097*ux_surf_lr[2]*rho_c[7]-0.2165063509461097*ux_surf_cl[2]*rho_c[7]+0.4330127018922194*pkpm_lax_l[2]*rho_c[7]+0.2795084971874738*ux_surf_lr[1]*rho_l[6]+0.2795084971874738*ux_surf_cl[1]*rho_l[6]+0.5590169943749476*pkpm_lax_l[1]*rho_l[6]+0.2795084971874738*ux_surf_lr[1]*rho_c[6]+0.2795084971874738*ux_surf_cl[1]*rho_c[6]-0.5590169943749476*pkpm_lax_l[1]*rho_c[6]+0.125*ux_surf_lr[2]*rho_l[5]+0.125*ux_surf_cl[2]*rho_l[5]+0.25*pkpm_lax_l[2]*rho_l[5]+0.125*ux_surf_lr[2]*rho_c[5]+0.125*ux_surf_cl[2]*rho_c[5]-0.25*pkpm_lax_l[2]*rho_c[5]+0.2795084971874737*ux_surf_lr[0]*rho_l[4]+0.2795084971874737*ux_surf_cl[0]*rho_l[4]+0.5590169943749475*pkpm_lax_l[0]*rho_l[4]+0.2795084971874737*ux_surf_lr[0]*rho_c[4]+0.2795084971874737*ux_surf_cl[0]*rho_c[4]-0.5590169943749475*pkpm_lax_l[0]*rho_c[4]+0.2165063509461096*ux_surf_lr[1]*rho_l[3]+0.2165063509461096*ux_surf_cl[1]*rho_l[3]+0.4330127018922193*pkpm_lax_l[1]*rho_l[3]-0.2165063509461096*ux_surf_lr[1]*rho_c[3]-0.2165063509461096*ux_surf_cl[1]*rho_c[3]+0.4330127018922193*pkpm_lax_l[1]*rho_c[3]+0.125*ux_surf_lr[1]*rho_l[2]+0.125*ux_surf_cl[1]*rho_l[2]+0.25*pkpm_lax_l[1]*rho_l[2]+0.125*ux_surf_lr[1]*rho_c[2]+0.125*ux_surf_cl[1]*rho_c[2]-0.25*pkpm_lax_l[1]*rho_c[2]+0.2165063509461096*ux_surf_lr[0]*rho_l[1]+0.2165063509461096*ux_surf_cl[0]*rho_l[1]+0.4330127018922193*pkpm_lax_l[0]*rho_l[1]-0.2165063509461096*ux_surf_lr[0]*rho_c[1]-0.2165063509461096*ux_surf_cl[0]*rho_c[1]+0.4330127018922193*pkpm_lax_l[0]*rho_c[1]+0.125*rho_l[0]*ux_surf_lr[0]+0.125*rho_c[0]*ux_surf_lr[0]+0.125*rho_l[0]*ux_surf_cl[0]+0.125*rho_c[0]*ux_surf_cl[0]+0.25*pkpm_lax_l[0]*rho_l[0]-0.25*pkpm_lax_l[0]*rho_c[0]; 
  flux_rho_l[1] = 0.25*ux_surf_lr[1]*rho_l[8]+0.25*ux_surf_cl[1]*rho_l[8]+0.5*pkpm_lax_l[1]*rho_l[8]+0.25*ux_surf_lr[1]*rho_c[8]+0.25*ux_surf_cl[1]*rho_c[8]-0.5*pkpm_lax_l[1]*rho_c[8]+0.1936491673103709*ux_surf_lr[1]*rho_l[7]+0.1936491673103709*ux_surf_cl[1]*rho_l[7]+0.3872983346207417*pkpm_lax_l[1]*rho_l[7]-0.1936491673103709*ux_surf_lr[1]*rho_c[7]-0.1936491673103709*ux_surf_cl[1]*rho_c[7]+0.3872983346207417*pkpm_lax_l[1]*rho_c[7]+0.2500000000000001*ux_surf_lr[2]*rho_l[6]+0.2500000000000001*ux_surf_cl[2]*rho_l[6]+0.5000000000000001*pkpm_lax_l[2]*rho_l[6]+0.2795084971874738*ux_surf_lr[0]*rho_l[6]+0.2795084971874738*ux_surf_cl[0]*rho_l[6]+0.5590169943749476*pkpm_lax_l[0]*rho_l[6]+0.2500000000000001*ux_surf_lr[2]*rho_c[6]+0.2500000000000001*ux_surf_cl[2]*rho_c[6]-0.5000000000000001*pkpm_lax_l[2]*rho_c[6]+0.2795084971874738*ux_surf_lr[0]*rho_c[6]+0.2795084971874738*ux_surf_cl[0]*rho_c[6]-0.5590169943749476*pkpm_lax_l[0]*rho_c[6]+0.1118033988749895*ux_surf_lr[1]*rho_l[5]+0.1118033988749895*ux_surf_cl[1]*rho_l[5]+0.223606797749979*pkpm_lax_l[1]*rho_l[5]+0.1118033988749895*ux_surf_lr[1]*rho_c[5]+0.1118033988749895*ux_surf_cl[1]*rho_c[5]-0.223606797749979*pkpm_lax_l[1]*rho_c[5]+0.2795084971874737*ux_surf_lr[1]*rho_l[4]+0.2795084971874737*ux_surf_cl[1]*rho_l[4]+0.5590169943749475*pkpm_lax_l[1]*rho_l[4]+0.2795084971874737*ux_surf_lr[1]*rho_c[4]+0.2795084971874737*ux_surf_cl[1]*rho_c[4]-0.5590169943749475*pkpm_lax_l[1]*rho_c[4]+0.1936491673103708*ux_surf_lr[2]*rho_l[3]+0.1936491673103708*ux_surf_cl[2]*rho_l[3]+0.3872983346207416*pkpm_lax_l[2]*rho_l[3]+0.2165063509461096*ux_surf_lr[0]*rho_l[3]+0.2165063509461096*ux_surf_cl[0]*rho_l[3]+0.4330127018922193*pkpm_lax_l[0]*rho_l[3]-0.1936491673103708*ux_surf_lr[2]*rho_c[3]-0.1936491673103708*ux_surf_cl[2]*rho_c[3]+0.3872983346207416*pkpm_lax_l[2]*rho_c[3]-0.2165063509461096*ux_surf_lr[0]*rho_c[3]-0.2165063509461096*ux_surf_cl[0]*rho_c[3]+0.4330127018922193*pkpm_lax_l[0]*rho_c[3]+0.1118033988749895*rho_l[2]*ux_surf_lr[2]+0.1118033988749895*rho_c[2]*ux_surf_lr[2]+0.1118033988749895*rho_l[2]*ux_surf_cl[2]+0.1118033988749895*rho_c[2]*ux_surf_cl[2]+0.223606797749979*pkpm_lax_l[2]*rho_l[2]+0.125*ux_surf_lr[0]*rho_l[2]+0.125*ux_surf_cl[0]*rho_l[2]+0.25*pkpm_lax_l[0]*rho_l[2]-0.223606797749979*pkpm_lax_l[2]*rho_c[2]+0.125*ux_surf_lr[0]*rho_c[2]+0.125*ux_surf_cl[0]*rho_c[2]-0.25*pkpm_lax_l[0]*rho_c[2]+0.2165063509461096*rho_l[1]*ux_surf_lr[1]-0.2165063509461096*rho_c[1]*ux_surf_lr[1]+0.125*rho_l[0]*ux_surf_lr[1]+0.125*rho_c[0]*ux_surf_lr[1]+0.2165063509461096*rho_l[1]*ux_surf_cl[1]-0.2165063509461096*rho_c[1]*ux_surf_cl[1]+0.125*rho_l[0]*ux_surf_cl[1]+0.125*rho_c[0]*ux_surf_cl[1]+0.4330127018922193*pkpm_lax_l[1]*rho_l[1]+0.4330127018922193*pkpm_lax_l[1]*rho_c[1]+0.25*rho_l[0]*pkpm_lax_l[1]-0.25*rho_c[0]*pkpm_lax_l[1]; 
  flux_rho_l[2] = 0.1785714285714286*ux_surf_lr[2]*rho_l[8]+0.1785714285714286*ux_surf_cl[2]*rho_l[8]+0.3571428571428572*pkpm_lax_l[2]*rho_l[8]+0.2795084971874737*ux_surf_lr[0]*rho_l[8]+0.2795084971874737*ux_surf_cl[0]*rho_l[8]+0.5590169943749475*pkpm_lax_l[0]*rho_l[8]+0.1785714285714286*ux_surf_lr[2]*rho_c[8]+0.1785714285714286*ux_surf_cl[2]*rho_c[8]-0.3571428571428572*pkpm_lax_l[2]*rho_c[8]+0.2795084971874737*ux_surf_lr[0]*rho_c[8]+0.2795084971874737*ux_surf_cl[0]*rho_c[8]-0.5590169943749475*pkpm_lax_l[0]*rho_c[8]+0.138320833793122*ux_surf_lr[2]*rho_l[7]+0.138320833793122*ux_surf_cl[2]*rho_l[7]+0.276641667586244*pkpm_lax_l[2]*rho_l[7]+0.2165063509461097*ux_surf_lr[0]*rho_l[7]+0.2165063509461097*ux_surf_cl[0]*rho_l[7]+0.4330127018922194*pkpm_lax_l[0]*rho_l[7]-0.138320833793122*ux_surf_lr[2]*rho_c[7]-0.138320833793122*ux_surf_cl[2]*rho_c[7]+0.276641667586244*pkpm_lax_l[2]*rho_c[7]-0.2165063509461097*ux_surf_lr[0]*rho_c[7]-0.2165063509461097*ux_surf_cl[0]*rho_c[7]+0.4330127018922194*pkpm_lax_l[0]*rho_c[7]+0.2500000000000001*ux_surf_lr[1]*rho_l[6]+0.2500000000000001*ux_surf_cl[1]*rho_l[6]+0.5000000000000001*pkpm_lax_l[1]*rho_l[6]+0.2500000000000001*ux_surf_lr[1]*rho_c[6]+0.2500000000000001*ux_surf_cl[1]*rho_c[6]-0.5000000000000001*pkpm_lax_l[1]*rho_c[6]+0.07985957062499249*ux_surf_lr[2]*rho_l[5]+0.07985957062499249*ux_surf_cl[2]*rho_l[5]+0.159719141249985*pkpm_lax_l[2]*rho_l[5]+0.125*ux_surf_lr[0]*rho_l[5]+0.125*ux_surf_cl[0]*rho_l[5]+0.25*pkpm_lax_l[0]*rho_l[5]+0.07985957062499249*ux_surf_lr[2]*rho_c[5]+0.07985957062499249*ux_surf_cl[2]*rho_c[5]-0.159719141249985*pkpm_lax_l[2]*rho_c[5]+0.125*ux_surf_lr[0]*rho_c[5]+0.125*ux_surf_cl[0]*rho_c[5]-0.25*pkpm_lax_l[0]*rho_c[5]+0.2795084971874737*ux_surf_lr[2]*rho_l[4]+0.2795084971874737*ux_surf_cl[2]*rho_l[4]+0.5590169943749475*pkpm_lax_l[2]*rho_l[4]+0.2795084971874737*ux_surf_lr[2]*rho_c[4]+0.2795084971874737*ux_surf_cl[2]*rho_c[4]-0.5590169943749475*pkpm_lax_l[2]*rho_c[4]+0.1936491673103708*ux_surf_lr[1]*rho_l[3]+0.1936491673103708*ux_surf_cl[1]*rho_l[3]+0.3872983346207416*pkpm_lax_l[1]*rho_l[3]-0.1936491673103708*ux_surf_lr[1]*rho_c[3]-0.1936491673103708*ux_surf_cl[1]*rho_c[3]+0.3872983346207416*pkpm_lax_l[1]*rho_c[3]+0.2165063509461096*rho_l[1]*ux_surf_lr[2]-0.2165063509461096*rho_c[1]*ux_surf_lr[2]+0.125*rho_l[0]*ux_surf_lr[2]+0.125*rho_c[0]*ux_surf_lr[2]+0.2165063509461096*rho_l[1]*ux_surf_cl[2]-0.2165063509461096*rho_c[1]*ux_surf_cl[2]+0.125*rho_l[0]*ux_surf_cl[2]+0.125*rho_c[0]*ux_surf_cl[2]+0.1118033988749895*ux_surf_lr[1]*rho_l[2]+0.1118033988749895*ux_surf_cl[1]*rho_l[2]+0.223606797749979*pkpm_lax_l[1]*rho_l[2]+0.1118033988749895*ux_surf_lr[1]*rho_c[2]+0.1118033988749895*ux_surf_cl[1]*rho_c[2]-0.223606797749979*pkpm_lax_l[1]*rho_c[2]+0.4330127018922193*rho_l[1]*pkpm_lax_l[2]+0.4330127018922193*rho_c[1]*pkpm_lax_l[2]+0.25*rho_l[0]*pkpm_lax_l[2]-0.25*rho_c[0]*pkpm_lax_l[2]; 

  flux_rho_r[0] = 0.2795084971874737*ux_surf_rl[2]*rho_r[8]+0.2795084971874737*ux_surf_cr[2]*rho_r[8]-0.5590169943749475*pkpm_lax_r[2]*rho_r[8]+0.2795084971874737*ux_surf_rl[2]*rho_c[8]+0.2795084971874737*ux_surf_cr[2]*rho_c[8]+0.5590169943749475*pkpm_lax_r[2]*rho_c[8]-0.2165063509461097*ux_surf_rl[2]*rho_r[7]-0.2165063509461097*ux_surf_cr[2]*rho_r[7]+0.4330127018922194*pkpm_lax_r[2]*rho_r[7]+0.2165063509461097*ux_surf_rl[2]*rho_c[7]+0.2165063509461097*ux_surf_cr[2]*rho_c[7]+0.4330127018922194*pkpm_lax_r[2]*rho_c[7]+0.2795084971874738*ux_surf_rl[1]*rho_r[6]+0.2795084971874738*ux_surf_cr[1]*rho_r[6]-0.5590169943749476*pkpm_lax_r[1]*rho_r[6]+0.2795084971874738*ux_surf_rl[1]*rho_c[6]+0.2795084971874738*ux_surf_cr[1]*rho_c[6]+0.5590169943749476*pkpm_lax_r[1]*rho_c[6]+0.125*ux_surf_rl[2]*rho_r[5]+0.125*ux_surf_cr[2]*rho_r[5]-0.25*pkpm_lax_r[2]*rho_r[5]+0.125*ux_surf_rl[2]*rho_c[5]+0.125*ux_surf_cr[2]*rho_c[5]+0.25*pkpm_lax_r[2]*rho_c[5]+0.2795084971874737*ux_surf_rl[0]*rho_r[4]+0.2795084971874737*ux_surf_cr[0]*rho_r[4]-0.5590169943749475*pkpm_lax_r[0]*rho_r[4]+0.2795084971874737*ux_surf_rl[0]*rho_c[4]+0.2795084971874737*ux_surf_cr[0]*rho_c[4]+0.5590169943749475*pkpm_lax_r[0]*rho_c[4]-0.2165063509461096*ux_surf_rl[1]*rho_r[3]-0.2165063509461096*ux_surf_cr[1]*rho_r[3]+0.4330127018922193*pkpm_lax_r[1]*rho_r[3]+0.2165063509461096*ux_surf_rl[1]*rho_c[3]+0.2165063509461096*ux_surf_cr[1]*rho_c[3]+0.4330127018922193*pkpm_lax_r[1]*rho_c[3]+0.125*ux_surf_rl[1]*rho_r[2]+0.125*ux_surf_cr[1]*rho_r[2]-0.25*pkpm_lax_r[1]*rho_r[2]+0.125*ux_surf_rl[1]*rho_c[2]+0.125*ux_surf_cr[1]*rho_c[2]+0.25*pkpm_lax_r[1]*rho_c[2]-0.2165063509461096*ux_surf_rl[0]*rho_r[1]-0.2165063509461096*ux_surf_cr[0]*rho_r[1]+0.4330127018922193*pkpm_lax_r[0]*rho_r[1]+0.2165063509461096*ux_surf_rl[0]*rho_c[1]+0.2165063509461096*ux_surf_cr[0]*rho_c[1]+0.4330127018922193*pkpm_lax_r[0]*rho_c[1]+0.125*rho_r[0]*ux_surf_rl[0]+0.125*rho_c[0]*ux_surf_rl[0]+0.125*rho_r[0]*ux_surf_cr[0]+0.125*rho_c[0]*ux_surf_cr[0]-0.25*pkpm_lax_r[0]*rho_r[0]+0.25*pkpm_lax_r[0]*rho_c[0]; 
  flux_rho_r[1] = 0.25*ux_surf_rl[1]*rho_r[8]+0.25*ux_surf_cr[1]*rho_r[8]-0.5*pkpm_lax_r[1]*rho_r[8]+0.25*ux_surf_rl[1]*rho_c[8]+0.25*ux_surf_cr[1]*rho_c[8]+0.5*pkpm_lax_r[1]*rho_c[8]-0.1936491673103709*ux_surf_rl[1]*rho_r[7]-0.1936491673103709*ux_surf_cr[1]*rho_r[7]+0.3872983346207417*pkpm_lax_r[1]*rho_r[7]+0.1936491673103709*ux_surf_rl[1]*rho_c[7]+0.1936491673103709*ux_surf_cr[1]*rho_c[7]+0.3872983346207417*pkpm_lax_r[1]*rho_c[7]+0.2500000000000001*ux_surf_rl[2]*rho_r[6]+0.2500000000000001*ux_surf_cr[2]*rho_r[6]-0.5000000000000001*pkpm_lax_r[2]*rho_r[6]+0.2795084971874738*ux_surf_rl[0]*rho_r[6]+0.2795084971874738*ux_surf_cr[0]*rho_r[6]-0.5590169943749476*pkpm_lax_r[0]*rho_r[6]+0.2500000000000001*ux_surf_rl[2]*rho_c[6]+0.2500000000000001*ux_surf_cr[2]*rho_c[6]+0.5000000000000001*pkpm_lax_r[2]*rho_c[6]+0.2795084971874738*ux_surf_rl[0]*rho_c[6]+0.2795084971874738*ux_surf_cr[0]*rho_c[6]+0.5590169943749476*pkpm_lax_r[0]*rho_c[6]+0.1118033988749895*ux_surf_rl[1]*rho_r[5]+0.1118033988749895*ux_surf_cr[1]*rho_r[5]-0.223606797749979*pkpm_lax_r[1]*rho_r[5]+0.1118033988749895*ux_surf_rl[1]*rho_c[5]+0.1118033988749895*ux_surf_cr[1]*rho_c[5]+0.223606797749979*pkpm_lax_r[1]*rho_c[5]+0.2795084971874737*ux_surf_rl[1]*rho_r[4]+0.2795084971874737*ux_surf_cr[1]*rho_r[4]-0.5590169943749475*pkpm_lax_r[1]*rho_r[4]+0.2795084971874737*ux_surf_rl[1]*rho_c[4]+0.2795084971874737*ux_surf_cr[1]*rho_c[4]+0.5590169943749475*pkpm_lax_r[1]*rho_c[4]-0.1936491673103708*ux_surf_rl[2]*rho_r[3]-0.1936491673103708*ux_surf_cr[2]*rho_r[3]+0.3872983346207416*pkpm_lax_r[2]*rho_r[3]-0.2165063509461096*ux_surf_rl[0]*rho_r[3]-0.2165063509461096*ux_surf_cr[0]*rho_r[3]+0.4330127018922193*pkpm_lax_r[0]*rho_r[3]+0.1936491673103708*ux_surf_rl[2]*rho_c[3]+0.1936491673103708*ux_surf_cr[2]*rho_c[3]+0.3872983346207416*pkpm_lax_r[2]*rho_c[3]+0.2165063509461096*ux_surf_rl[0]*rho_c[3]+0.2165063509461096*ux_surf_cr[0]*rho_c[3]+0.4330127018922193*pkpm_lax_r[0]*rho_c[3]+0.1118033988749895*rho_r[2]*ux_surf_rl[2]+0.1118033988749895*rho_c[2]*ux_surf_rl[2]+0.1118033988749895*rho_r[2]*ux_surf_cr[2]+0.1118033988749895*rho_c[2]*ux_surf_cr[2]-0.223606797749979*pkpm_lax_r[2]*rho_r[2]+0.125*ux_surf_rl[0]*rho_r[2]+0.125*ux_surf_cr[0]*rho_r[2]-0.25*pkpm_lax_r[0]*rho_r[2]+0.223606797749979*pkpm_lax_r[2]*rho_c[2]+0.125*ux_surf_rl[0]*rho_c[2]+0.125*ux_surf_cr[0]*rho_c[2]+0.25*pkpm_lax_r[0]*rho_c[2]-0.2165063509461096*rho_r[1]*ux_surf_rl[1]+0.2165063509461096*rho_c[1]*ux_surf_rl[1]+0.125*rho_r[0]*ux_surf_rl[1]+0.125*rho_c[0]*ux_surf_rl[1]-0.2165063509461096*rho_r[1]*ux_surf_cr[1]+0.2165063509461096*rho_c[1]*ux_surf_cr[1]+0.125*rho_r[0]*ux_surf_cr[1]+0.125*rho_c[0]*ux_surf_cr[1]+0.4330127018922193*pkpm_lax_r[1]*rho_r[1]+0.4330127018922193*pkpm_lax_r[1]*rho_c[1]-0.25*rho_r[0]*pkpm_lax_r[1]+0.25*rho_c[0]*pkpm_lax_r[1]; 
  flux_rho_r[2] = 0.1785714285714286*ux_surf_rl[2]*rho_r[8]+0.1785714285714286*ux_surf_cr[2]*rho_r[8]-0.3571428571428572*pkpm_lax_r[2]*rho_r[8]+0.2795084971874737*ux_surf_rl[0]*rho_r[8]+0.2795084971874737*ux_surf_cr[0]*rho_r[8]-0.5590169943749475*pkpm_lax_r[0]*rho_r[8]+0.1785714285714286*ux_surf_rl[2]*rho_c[8]+0.1785714285714286*ux_surf_cr[2]*rho_c[8]+0.3571428571428572*pkpm_lax_r[2]*rho_c[8]+0.2795084971874737*ux_surf_rl[0]*rho_c[8]+0.2795084971874737*ux_surf_cr[0]*rho_c[8]+0.5590169943749475*pkpm_lax_r[0]*rho_c[8]-0.138320833793122*ux_surf_rl[2]*rho_r[7]-0.138320833793122*ux_surf_cr[2]*rho_r[7]+0.276641667586244*pkpm_lax_r[2]*rho_r[7]-0.2165063509461097*ux_surf_rl[0]*rho_r[7]-0.2165063509461097*ux_surf_cr[0]*rho_r[7]+0.4330127018922194*pkpm_lax_r[0]*rho_r[7]+0.138320833793122*ux_surf_rl[2]*rho_c[7]+0.138320833793122*ux_surf_cr[2]*rho_c[7]+0.276641667586244*pkpm_lax_r[2]*rho_c[7]+0.2165063509461097*ux_surf_rl[0]*rho_c[7]+0.2165063509461097*ux_surf_cr[0]*rho_c[7]+0.4330127018922194*pkpm_lax_r[0]*rho_c[7]+0.2500000000000001*ux_surf_rl[1]*rho_r[6]+0.2500000000000001*ux_surf_cr[1]*rho_r[6]-0.5000000000000001*pkpm_lax_r[1]*rho_r[6]+0.2500000000000001*ux_surf_rl[1]*rho_c[6]+0.2500000000000001*ux_surf_cr[1]*rho_c[6]+0.5000000000000001*pkpm_lax_r[1]*rho_c[6]+0.07985957062499249*ux_surf_rl[2]*rho_r[5]+0.07985957062499249*ux_surf_cr[2]*rho_r[5]-0.159719141249985*pkpm_lax_r[2]*rho_r[5]+0.125*ux_surf_rl[0]*rho_r[5]+0.125*ux_surf_cr[0]*rho_r[5]-0.25*pkpm_lax_r[0]*rho_r[5]+0.07985957062499249*ux_surf_rl[2]*rho_c[5]+0.07985957062499249*ux_surf_cr[2]*rho_c[5]+0.159719141249985*pkpm_lax_r[2]*rho_c[5]+0.125*ux_surf_rl[0]*rho_c[5]+0.125*ux_surf_cr[0]*rho_c[5]+0.25*pkpm_lax_r[0]*rho_c[5]+0.2795084971874737*ux_surf_rl[2]*rho_r[4]+0.2795084971874737*ux_surf_cr[2]*rho_r[4]-0.5590169943749475*pkpm_lax_r[2]*rho_r[4]+0.2795084971874737*ux_surf_rl[2]*rho_c[4]+0.2795084971874737*ux_surf_cr[2]*rho_c[4]+0.5590169943749475*pkpm_lax_r[2]*rho_c[4]-0.1936491673103708*ux_surf_rl[1]*rho_r[3]-0.1936491673103708*ux_surf_cr[1]*rho_r[3]+0.3872983346207416*pkpm_lax_r[1]*rho_r[3]+0.1936491673103708*ux_surf_rl[1]*rho_c[3]+0.1936491673103708*ux_surf_cr[1]*rho_c[3]+0.3872983346207416*pkpm_lax_r[1]*rho_c[3]-0.2165063509461096*rho_r[1]*ux_surf_rl[2]+0.2165063509461096*rho_c[1]*ux_surf_rl[2]+0.125*rho_r[0]*ux_surf_rl[2]+0.125*rho_c[0]*ux_surf_rl[2]-0.2165063509461096*rho_r[1]*ux_surf_cr[2]+0.2165063509461096*rho_c[1]*ux_surf_cr[2]+0.125*rho_r[0]*ux_surf_cr[2]+0.125*rho_c[0]*ux_surf_cr[2]+0.1118033988749895*ux_surf_rl[1]*rho_r[2]+0.1118033988749895*ux_surf_cr[1]*rho_r[2]-0.223606797749979*pkpm_lax_r[1]*rho_r[2]+0.1118033988749895*ux_surf_rl[1]*rho_c[2]+0.1118033988749895*ux_surf_cr[1]*rho_c[2]+0.223606797749979*pkpm_lax_r[1]*rho_c[2]+0.4330127018922193*rho_r[1]*pkpm_lax_r[2]+0.4330127018922193*rho_c[1]*pkpm_lax_r[2]-0.25*rho_r[0]*pkpm_lax_r[2]+0.25*rho_c[0]*pkpm_lax_r[2]; 
  ...
  outrhou1[2] += ((-0.223606797749979*flux_rho_r[1]*uy_surf_rl[2])+0.223606797749979*flux_rho_l[1]*uy_surf_lr[2]-0.223606797749979*flux_rho_r[1]*uy_surf_cr[2]+0.223606797749979*flux_rho_l[1]*uy_surf_cl[2]-0.223606797749979*(uy_surf_rl[1]+uy_surf_cr[1])*flux_rho_r[2]+0.223606797749979*(uy_surf_lr[1]+uy_surf_cl[1])*flux_rho_l[2]-0.25*flux_rho_r[0]*uy_surf_rl[1]+0.25*flux_rho_l[0]*uy_surf_lr[1]-0.25*flux_rho_r[0]*uy_surf_cr[1]+0.25*flux_rho_l[0]*uy_surf_cl[1]-0.25*(uy_surf_rl[0]+uy_surf_cr[0])*flux_rho_r[1]+0.25*(uy_surf_lr[0]+uy_surf_cl[0])*flux_rho_l[1]-0.7071067811865475*avg_p_ij_y_r[1]+0.7071067811865475*avg_p_ij_y_l[1]+0.3535533905932737*apdq_rhouy_r[1]-0.3535533905932737*(apdq_rhouy_l[1]+amdq_rhouy_r[1])+0.3535533905932737*amdq_rhouy_l[1])*dx1; 
  ...
  outrhou2[2] += ((-0.223606797749979*flux_rho_r[1]*uz_surf_rl[2])+0.223606797749979*flux_rho_l[1]*uz_surf_lr[2]-0.223606797749979*flux_rho_r[1]*uz_surf_cr[2]+0.223606797749979*flux_rho_l[1]*uz_surf_cl[2]-0.223606797749979*(uz_surf_rl[1]+uz_surf_cr[1])*flux_rho_r[2]+0.223606797749979*(uz_surf_lr[1]+uz_surf_cl[1])*flux_rho_l[2]-0.25*flux_rho_r[0]*uz_surf_rl[1]+0.25*flux_rho_l[0]*uz_surf_lr[1]-0.25*flux_rho_r[0]*uz_surf_cr[1]+0.25*flux_rho_l[0]*uz_surf_cl[1]-0.25*(uz_surf_rl[0]+uz_surf_cr[0])*flux_rho_r[1]+0.25*(uz_surf_lr[0]+uz_surf_cl[0])*flux_rho_l[1]-0.7071067811865475*avg_p_ij_z_r[1]+0.7071067811865475*avg_p_ij_z_l[1]+0.3535533905932737*apdq_rhouz_r[1]-0.3535533905932737*(apdq_rhouz_l[1]+amdq_rhouz_r[1])+0.3535533905932737*amdq_rhouz_l[1])*dx1; 
