...
{ 
  ...
  const double *u_l = &priml[4]; 
  const double *u_c = &primc[4]; 
  const double *u_r = &primr[4]; 
  ...
  const double *vth_sql = &priml[16]; 
  const double *vth_sqc = &primc[16]; 
  const double *vth_sqr = &primr[16]; 
