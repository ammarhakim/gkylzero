...
{ 
  ...
  const double *Tii_surf_lr = &prim_surf_l[28]; 
  const double *Tii_surf_cl = &prim_surf_c[24]; 
  const double *Tii_surf_cr = &prim_surf_c[28]; 
  const double *Tii_surf_rl = &prim_surf_r[24]; 
  ...
  div_b_comp[2] = ((-0.2886751345948129*(b_r[4]+b_l[4]))+0.5773502691896258*b_c[4]+0.25*b_r[2]-0.25*b_l[2])*dx1; 
  div_b_comp[3] = ((-0.2886751345948129*(b_r[5]+b_l[5]))+0.5773502691896258*b_c[5]+0.25*b_r[3]-0.25*b_l[3])*dx1; 
  div_b_comp[4] = ((-0.5*b_r[4])+0.5*b_l[4]+0.4330127018922193*(b_r[2]+b_l[2])-0.8660254037844386*b_c[2])*dx1; 
  div_b_comp[5] = ((-0.5*b_r[5])+0.5*b_l[5]+0.4330127018922193*(b_r[3]+b_l[3])-0.8660254037844386*b_c[3])*dx1; 
  div_b_comp[6] = ((-0.2886751345948129*(b_r[7]+b_l[7]))+0.5773502691896258*b_c[7]+0.25*b_r[6]-0.25*b_l[6])*dx1; 
  div_b_comp[7] = ((-0.5*b_r[7])+0.5*b_l[7]+0.4330127018922193*(b_r[6]+b_l[6])-0.8660254037844386*b_c[6])*dx1; 
  ...
  p_perp_source[7] += (-0.6666666666666666*nu_c[7])-1.0*grad_u_x[7]+bb_grad_u_comp[7]; 
