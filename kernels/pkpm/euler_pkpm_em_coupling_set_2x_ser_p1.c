...
{ 
  ...
  for (int s = 0; s < num_species; ++s) { 
    ...
    gkyl_mat_set(&rhs, 0 + s*(12), 0, qbym[s]*rhoux[s][0] + 0.5*dt*qbym[s]*qbym[s]*(0.5*(ext_Ex[3]*rho[s][3]+ext_Ex[2]*rho[s][2]+ext_Ex[1]*rho[s][1]+ext_Ex[0]*rho[s][0])) + 0.5*dt*qbym[s]*(0.5*(app_accel_x[s][3]*rho[s][3]+app_accel_x[s][2]*rho[s][2]+app_accel_x[s][1]*rho[s][1]+app_accel_x[s][0]*rho[s][0]))); 
    gkyl_mat_set(&rhs, 4 + s*(12), 0, qbym[s]*rhouy[s][0] + 0.5*dt*qbym[s]*qbym[s]*(0.5*(ext_Ey[3]*rho[s][3]+ext_Ey[2]*rho[s][2]+ext_Ey[1]*rho[s][1]+ext_Ey[0]*rho[s][0])) + 0.5*dt*qbym[s]*(0.5*(app_accel_y[s][3]*rho[s][3]+app_accel_y[s][2]*rho[s][2]+app_accel_y[s][1]*rho[s][1]+app_accel_y[s][0]*rho[s][0]))); 
    gkyl_mat_set(&rhs, 8 + s*(12), 0, qbym[s]*rhouz[s][0] + 0.5*dt*qbym[s]*qbym[s]*(0.5*(ext_Ez[3]*rho[s][3]+ext_Ez[2]*rho[s][2]+ext_Ez[1]*rho[s][1]+ext_Ez[0]*rho[s][0])) + 0.5*dt*qbym[s]*(0.5*(app_accel_z[s][3]*rho[s][3]+app_accel_z[s][2]*rho[s][2]+app_accel_z[s][1]*rho[s][1]+app_accel_z[s][0]*rho[s][0]))); 

    gkyl_mat_set(&rhs, 1 + s*(12), 0, qbym[s]*rhoux[s][1] + 0.5*dt*qbym[s]*qbym[s]*(0.5*(ext_Ex[2]*rho[s][3]+rho[s][2]*ext_Ex[3]+ext_Ex[0]*rho[s][1]+rho[s][0]*ext_Ex[1])) + 0.5*dt*qbym[s]*(0.5*(app_accel_x[s][2]*rho[s][3]+rho[s][2]*app_accel_x[s][3]+app_accel_x[s][0]*rho[s][1]+rho[s][0]*app_accel_x[s][1]))); 
    gkyl_mat_set(&rhs, 5 + s*(12), 0, qbym[s]*rhouy[s][1] + 0.5*dt*qbym[s]*qbym[s]*(0.5*(ext_Ey[2]*rho[s][3]+rho[s][2]*ext_Ey[3]+ext_Ey[0]*rho[s][1]+rho[s][0]*ext_Ey[1])) + 0.5*dt*qbym[s]*(0.5*(app_accel_y[s][2]*rho[s][3]+rho[s][2]*app_accel_y[s][3]+app_accel_y[s][0]*rho[s][1]+rho[s][0]*app_accel_y[s][1]))); 
    gkyl_mat_set(&rhs, 9 + s*(12), 0, qbym[s]*rhouz[s][1] + 0.5*dt*qbym[s]*qbym[s]*(0.5*(ext_Ez[2]*rho[s][3]+rho[s][2]*ext_Ez[3]+ext_Ez[0]*rho[s][1]+rho[s][0]*ext_Ez[1])) + 0.5*dt*qbym[s]*(0.5*(app_accel_z[s][2]*rho[s][3]+rho[s][2]*app_accel_z[s][3]+app_accel_z[s][0]*rho[s][1]+rho[s][0]*app_accel_z[s][1]))); 

    gkyl_mat_set(&rhs, 2 + s*(12), 0, qbym[s]*rhoux[s][2] + 0.5*dt*qbym[s]*qbym[s]*(0.5*(ext_Ex[1]*rho[s][3]+rho[s][1]*ext_Ex[3]+ext_Ex[0]*rho[s][2]+rho[s][0]*ext_Ex[2])) + 0.5*dt*qbym[s]*(0.5*(app_accel_x[s][1]*rho[s][3]+rho[s][1]*app_accel_x[s][3]+app_accel_x[s][0]*rho[s][2]+rho[s][0]*app_accel_x[s][2]))); 
    gkyl_mat_set(&rhs, 6 + s*(12), 0, qbym[s]*rhouy[s][2] + 0.5*dt*qbym[s]*qbym[s]*(0.5*(ext_Ey[1]*rho[s][3]+rho[s][1]*ext_Ey[3]+ext_Ey[0]*rho[s][2]+rho[s][0]*ext_Ey[2])) + 0.5*dt*qbym[s]*(0.5*(app_accel_y[s][1]*rho[s][3]+rho[s][1]*app_accel_y[s][3]+app_accel_y[s][0]*rho[s][2]+rho[s][0]*app_accel_y[s][2]))); 
    gkyl_mat_set(&rhs, 10 + s*(12), 0, qbym[s]*rhouz[s][2] + 0.5*dt*qbym[s]*qbym[s]*(0.5*(ext_Ez[1]*rho[s][3]+rho[s][1]*ext_Ez[3]+ext_Ez[0]*rho[s][2]+rho[s][0]*ext_Ez[2])) + 0.5*dt*qbym[s]*(0.5*(app_accel_z[s][1]*rho[s][3]+rho[s][1]*app_accel_z[s][3]+app_accel_z[s][0]*rho[s][2]+rho[s][0]*app_accel_z[s][2]))); 

    gkyl_mat_set(&rhs, 3 + s*(12), 0, qbym[s]*rhoux[s][3] + 0.5*dt*qbym[s]*qbym[s]*(0.5*(ext_Ex[0]*rho[s][3]+rho[s][0]*ext_Ex[3]+ext_Ex[1]*rho[s][2]+rho[s][1]*ext_Ex[2])) + 0.5*dt*qbym[s]*(0.5*(app_accel_x[s][0]*rho[s][3]+rho[s][0]*app_accel_x[s][3]+app_accel_x[s][1]*rho[s][2]+rho[s][1]*app_accel_x[s][2]))); 
    gkyl_mat_set(&rhs, 7 + s*(12), 0, qbym[s]*rhouy[s][3] + 0.5*dt*qbym[s]*qbym[s]*(0.5*(ext_Ey[0]*rho[s][3]+rho[s][0]*ext_Ey[3]+ext_Ey[1]*rho[s][2]+rho[s][1]*ext_Ey[2])) + 0.5*dt*qbym[s]*(0.5*(app_accel_y[s][0]*rho[s][3]+rho[s][0]*app_accel_y[s][3]+app_accel_y[s][1]*rho[s][2]+rho[s][1]*app_accel_y[s][2]))); 
    gkyl_mat_set(&rhs, 11 + s*(12), 0, qbym[s]*rhouz[s][3] + 0.5*dt*qbym[s]*qbym[s]*(0.5*(ext_Ez[0]*rho[s][3]+rho[s][0]*ext_Ez[3]+ext_Ez[1]*rho[s][2]+rho[s][1]*ext_Ez[2])) + 0.5*dt*qbym[s]*(0.5*(app_accel_z[s][0]*rho[s][3]+rho[s][0]*app_accel_z[s][3]+app_accel_z[s][1]*rho[s][2]+rho[s][1]*app_accel_z[s][2]))); 
