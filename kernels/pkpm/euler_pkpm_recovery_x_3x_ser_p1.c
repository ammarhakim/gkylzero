...
{ 
  ...
  div_p_x[0] += (4.871392896287466*rhoux_r[1]-4.871392896287466*rhoux_l[1]-2.8125*(rhoux_r[0]+rhoux_l[0])+5.625*rhoux_c[0])*dxHyp*nuHyp+((-0.2886751345948129*(Pxx_r[1]+Pxx_l[1]))+0.5773502691896258*Pxx_c[1]+0.25*Pxx_r[0]-0.25*Pxx_l[0])*dx1; 
  div_p_x[1] += (72.1875*(rhoux_r[1]+rhoux_l[1])+249.375*rhoux_c[1]-56.83291712335378*rhoux_r[0]+56.83291712335378*rhoux_l[0])*dxHyp*nuHyp+((-0.5*Pxx_r[1])+0.5*Pxx_l[1]+0.4330127018922193*(Pxx_r[0]+Pxx_l[0])-0.8660254037844386*Pxx_c[0])*dx1; 
  div_p_x[2] += (4.871392896287466*rhoux_r[4]-4.871392896287466*rhoux_l[4]-2.8125*(rhoux_r[2]+rhoux_l[2])+5.625*rhoux_c[2])*dxHyp*nuHyp+((-0.2886751345948129*(Pxx_r[4]+Pxx_l[4]))+0.5773502691896258*Pxx_c[4]+0.25*Pxx_r[2]-0.25*Pxx_l[2])*dx1; 
  div_p_x[3] += (4.871392896287466*rhoux_r[5]-4.871392896287466*rhoux_l[5]-2.8125*(rhoux_r[3]+rhoux_l[3])+5.625*rhoux_c[3])*dxHyp*nuHyp+((-0.2886751345948129*(Pxx_r[5]+Pxx_l[5]))+0.5773502691896258*Pxx_c[5]+0.25*Pxx_r[3]-0.25*Pxx_l[3])*dx1; 
  div_p_x[4] += (72.1875*(rhoux_r[4]+rhoux_l[4])+249.375*rhoux_c[4]-56.83291712335378*rhoux_r[2]+56.83291712335378*rhoux_l[2])*dxHyp*nuHyp+((-0.5*Pxx_r[4])+0.5*Pxx_l[4]+0.4330127018922193*(Pxx_r[2]+Pxx_l[2])-0.8660254037844386*Pxx_c[2])*dx1; 
  div_p_x[5] += (72.1875*(rhoux_r[5]+rhoux_l[5])+249.375*rhoux_c[5]-56.83291712335378*rhoux_r[3]+56.83291712335378*rhoux_l[3])*dxHyp*nuHyp+((-0.5*Pxx_r[5])+0.5*Pxx_l[5]+0.4330127018922193*(Pxx_r[3]+Pxx_l[3])-0.8660254037844386*Pxx_c[3])*dx1; 
  div_p_x[6] += (4.871392896287466*rhoux_r[7]-4.871392896287466*rhoux_l[7]-2.8125*(rhoux_r[6]+rhoux_l[6])+5.625*rhoux_c[6])*dxHyp*nuHyp+((-0.2886751345948129*(Pxx_r[7]+Pxx_l[7]))+0.5773502691896258*Pxx_c[7]+0.25*Pxx_r[6]-0.25*Pxx_l[6])*dx1; 
  div_p_x[7] += (72.1875*(rhoux_r[7]+rhoux_l[7])+249.375*rhoux_c[7]-56.83291712335378*rhoux_r[6]+56.83291712335378*rhoux_l[6])*dxHyp*nuHyp+((-0.5*Pxx_r[7])+0.5*Pxx_l[7]+0.4330127018922193*(Pxx_r[6]+Pxx_l[6])-0.8660254037844386*Pxx_c[6])*dx1; 

  div_p_y[0] += (4.871392896287466*rhouy_r[1]-4.871392896287466*rhouy_l[1]-2.8125*(rhouy_r[0]+rhouy_l[0])+5.625*rhouy_c[0])*dxHyp*nuHyp+((-0.2886751345948129*(Pxy_r[1]+Pxy_l[1]))+0.5773502691896258*Pxy_c[1]+0.25*Pxy_r[0]-0.25*Pxy_l[0])*dx1; 
  div_p_y[1] += (72.1875*(rhouy_r[1]+rhouy_l[1])+249.375*rhouy_c[1]-56.83291712335378*rhouy_r[0]+56.83291712335378*rhouy_l[0])*dxHyp*nuHyp+((-0.5*Pxy_r[1])+0.5*Pxy_l[1]+0.4330127018922193*(Pxy_r[0]+Pxy_l[0])-0.8660254037844386*Pxy_c[0])*dx1; 
  div_p_y[2] += (4.871392896287466*rhouy_r[4]-4.871392896287466*rhouy_l[4]-2.8125*(rhouy_r[2]+rhouy_l[2])+5.625*rhouy_c[2])*dxHyp*nuHyp+((-0.2886751345948129*(Pxy_r[4]+Pxy_l[4]))+0.5773502691896258*Pxy_c[4]+0.25*Pxy_r[2]-0.25*Pxy_l[2])*dx1; 
  div_p_y[3] += (4.871392896287466*rhouy_r[5]-4.871392896287466*rhouy_l[5]-2.8125*(rhouy_r[3]+rhouy_l[3])+5.625*rhouy_c[3])*dxHyp*nuHyp+((-0.2886751345948129*(Pxy_r[5]+Pxy_l[5]))+0.5773502691896258*Pxy_c[5]+0.25*Pxy_r[3]-0.25*Pxy_l[3])*dx1; 
  div_p_y[4] += (72.1875*(rhouy_r[4]+rhouy_l[4])+249.375*rhouy_c[4]-56.83291712335378*rhouy_r[2]+56.83291712335378*rhouy_l[2])*dxHyp*nuHyp+((-0.5*Pxy_r[4])+0.5*Pxy_l[4]+0.4330127018922193*(Pxy_r[2]+Pxy_l[2])-0.8660254037844386*Pxy_c[2])*dx1; 
  div_p_y[5] += (72.1875*(rhouy_r[5]+rhouy_l[5])+249.375*rhouy_c[5]-56.83291712335378*rhouy_r[3]+56.83291712335378*rhouy_l[3])*dxHyp*nuHyp+((-0.5*Pxy_r[5])+0.5*Pxy_l[5]+0.4330127018922193*(Pxy_r[3]+Pxy_l[3])-0.8660254037844386*Pxy_c[3])*dx1; 
  div_p_y[6] += (4.871392896287466*rhouy_r[7]-4.871392896287466*rhouy_l[7]-2.8125*(rhouy_r[6]+rhouy_l[6])+5.625*rhouy_c[6])*dxHyp*nuHyp+((-0.2886751345948129*(Pxy_r[7]+Pxy_l[7]))+0.5773502691896258*Pxy_c[7]+0.25*Pxy_r[6]-0.25*Pxy_l[6])*dx1; 
  div_p_y[7] += (72.1875*(rhouy_r[7]+rhouy_l[7])+249.375*rhouy_c[7]-56.83291712335378*rhouy_r[6]+56.83291712335378*rhouy_l[6])*dxHyp*nuHyp+((-0.5*Pxy_r[7])+0.5*Pxy_l[7]+0.4330127018922193*(Pxy_r[6]+Pxy_l[6])-0.8660254037844386*Pxy_c[6])*dx1; 

  div_p_z[0] += (4.871392896287466*rhouz_r[1]-4.871392896287466*rhouz_l[1]-2.8125*(rhouz_r[0]+rhouz_l[0])+5.625*rhouz_c[0])*dxHyp*nuHyp+((-0.2886751345948129*(Pxz_r[1]+Pxz_l[1]))+0.5773502691896258*Pxz_c[1]+0.25*Pxz_r[0]-0.25*Pxz_l[0])*dx1; 
  div_p_z[1] += (72.1875*(rhouz_r[1]+rhouz_l[1])+249.375*rhouz_c[1]-56.83291712335378*rhouz_r[0]+56.83291712335378*rhouz_l[0])*dxHyp*nuHyp+((-0.5*Pxz_r[1])+0.5*Pxz_l[1]+0.4330127018922193*(Pxz_r[0]+Pxz_l[0])-0.8660254037844386*Pxz_c[0])*dx1; 
  div_p_z[2] += (4.871392896287466*rhouz_r[4]-4.871392896287466*rhouz_l[4]-2.8125*(rhouz_r[2]+rhouz_l[2])+5.625*rhouz_c[2])*dxHyp*nuHyp+((-0.2886751345948129*(Pxz_r[4]+Pxz_l[4]))+0.5773502691896258*Pxz_c[4]+0.25*Pxz_r[2]-0.25*Pxz_l[2])*dx1; 
  div_p_z[3] += (4.871392896287466*rhouz_r[5]-4.871392896287466*rhouz_l[5]-2.8125*(rhouz_r[3]+rhouz_l[3])+5.625*rhouz_c[3])*dxHyp*nuHyp+((-0.2886751345948129*(Pxz_r[5]+Pxz_l[5]))+0.5773502691896258*Pxz_c[5]+0.25*Pxz_r[3]-0.25*Pxz_l[3])*dx1; 
  div_p_z[4] += (72.1875*(rhouz_r[4]+rhouz_l[4])+249.375*rhouz_c[4]-56.83291712335378*rhouz_r[2]+56.83291712335378*rhouz_l[2])*dxHyp*nuHyp+((-0.5*Pxz_r[4])+0.5*Pxz_l[4]+0.4330127018922193*(Pxz_r[2]+Pxz_l[2])-0.8660254037844386*Pxz_c[2])*dx1; 
  div_p_z[5] += (72.1875*(rhouz_r[5]+rhouz_l[5])+249.375*rhouz_c[5]-56.83291712335378*rhouz_r[3]+56.83291712335378*rhouz_l[3])*dxHyp*nuHyp+((-0.5*Pxz_r[5])+0.5*Pxz_l[5]+0.4330127018922193*(Pxz_r[3]+Pxz_l[3])-0.8660254037844386*Pxz_c[3])*dx1; 
  div_p_z[6] += (4.871392896287466*rhouz_r[7]-4.871392896287466*rhouz_l[7]-2.8125*(rhouz_r[6]+rhouz_l[6])+5.625*rhouz_c[6])*dxHyp*nuHyp+((-0.2886751345948129*(Pxz_r[7]+Pxz_l[7]))+0.5773502691896258*Pxz_c[7]+0.25*Pxz_r[6]-0.25*Pxz_l[6])*dx1; 
  div_p_z[7] += (72.1875*(rhouz_r[7]+rhouz_l[7])+249.375*rhouz_c[7]-56.83291712335378*rhouz_r[6]+56.83291712335378*rhouz_l[6])*dxHyp*nuHyp+((-0.5*Pxz_r[7])+0.5*Pxz_l[7]+0.4330127018922193*(Pxz_r[6]+Pxz_l[6])-0.8660254037844386*Pxz_c[6])*dx1; 
