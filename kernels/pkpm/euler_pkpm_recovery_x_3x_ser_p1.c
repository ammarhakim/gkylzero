...
{ 
  ...
  grad_u_x[4] += -1.732050807568877*ux_c[2]*dx1; 
  grad_u_x[5] += -1.732050807568877*ux_c[3]*dx1; 
  grad_u_x[7] += -1.732050807568877*ux_c[6]*dx1; 
  div_p_x_comp[1] += -1.732050807568877*Pxx_c[0]*dx1; 
  div_p_x_comp[4] += -1.732050807568877*Pxx_c[2]*dx1; 
  div_p_x_comp[5] += -1.732050807568877*Pxx_c[3]*dx1; 
  div_p_x_comp[7] += -1.732050807568877*Pxx_c[6]*dx1; 
  if (phi_x_l == 0.0) { 
  ...
  grad_u_x[2] += ((-0.4330127018922193*ux_l[4])+0.4330127018922193*ux_c[4]-0.25*(ux_l[2]+ux_c[2]))*dx1; 
  grad_u_x[3] += ((-0.4330127018922193*ux_l[5])+0.4330127018922193*ux_c[5]-0.25*(ux_l[3]+ux_c[3]))*dx1; 
  grad_u_x[4] += (0.75*ux_l[4]-0.75*ux_c[4]+0.4330127018922193*(ux_l[2]+ux_c[2]))*dx1; 
  grad_u_x[5] += (0.75*ux_l[5]-0.75*ux_c[5]+0.4330127018922193*(ux_l[3]+ux_c[3]))*dx1; 
  grad_u_x[6] += ((-0.4330127018922193*ux_l[7])+0.4330127018922193*ux_c[7]-0.25*(ux_l[6]+ux_c[6]))*dx1; 
  grad_u_x[7] += (0.75*ux_l[7]-0.75*ux_c[7]+0.4330127018922193*(ux_l[6]+ux_c[6]))*dx1; 
  ...
  div_p_x_comp[2] += ((-0.4330127018922193*Pxx_l[4])+0.4330127018922193*Pxx_c[4]-0.25*(Pxx_l[2]+Pxx_c[2]))*dx1; 
  div_p_x_comp[3] += ((-0.4330127018922193*Pxx_l[5])+0.4330127018922193*Pxx_c[5]-0.25*(Pxx_l[3]+Pxx_c[3]))*dx1; 
  div_p_x_comp[4] += (0.75*Pxx_l[4]-0.75*Pxx_c[4]+0.4330127018922193*(Pxx_l[2]+Pxx_c[2]))*dx1; 
  div_p_x_comp[5] += (0.75*Pxx_l[5]-0.75*Pxx_c[5]+0.4330127018922193*(Pxx_l[3]+Pxx_c[3]))*dx1; 
  div_p_x_comp[6] += ((-0.4330127018922193*Pxx_l[7])+0.4330127018922193*Pxx_c[7]-0.25*(Pxx_l[6]+Pxx_c[6]))*dx1; 
  div_p_x_comp[7] += (0.75*Pxx_l[7]-0.75*Pxx_c[7]+0.4330127018922193*(Pxx_l[6]+Pxx_c[6]))*dx1; 
  } else { 
  ...
  grad_u_x[2] += ((-0.2886751345948129*ux_l[4])+0.2886751345948129*ux_c[4]-0.25*(ux_l[2]+ux_c[2]))*dx1; 
  grad_u_x[3] += ((-0.2886751345948129*ux_l[5])+0.2886751345948129*ux_c[5]-0.25*(ux_l[3]+ux_c[3]))*dx1; 
  grad_u_x[4] += (0.5*ux_l[4]-0.5*ux_c[4]+0.4330127018922193*(ux_l[2]+ux_c[2]))*dx1; 
  grad_u_x[5] += (0.5*ux_l[5]-0.5*ux_c[5]+0.4330127018922193*(ux_l[3]+ux_c[3]))*dx1; 
  grad_u_x[6] += ((-0.2886751345948129*ux_l[7])+0.2886751345948129*ux_c[7]-0.25*(ux_l[6]+ux_c[6]))*dx1; 
  grad_u_x[7] += (0.5*ux_l[7]-0.5*ux_c[7]+0.4330127018922193*(ux_l[6]+ux_c[6]))*dx1; 
  ...
  div_p_x_comp[2] += ((-0.2886751345948129*Pxx_l[4])+0.2886751345948129*Pxx_c[4]-0.25*(Pxx_l[2]+Pxx_c[2]))*dx1; 
  div_p_x_comp[3] += ((-0.2886751345948129*Pxx_l[5])+0.2886751345948129*Pxx_c[5]-0.25*(Pxx_l[3]+Pxx_c[3]))*dx1; 
  div_p_x_comp[4] += (0.5*Pxx_l[4]-0.5*Pxx_c[4]+0.4330127018922193*(Pxx_l[2]+Pxx_c[2]))*dx1; 
  div_p_x_comp[5] += (0.5*Pxx_l[5]-0.5*Pxx_c[5]+0.4330127018922193*(Pxx_l[3]+Pxx_c[3]))*dx1; 
  div_p_x_comp[6] += ((-0.2886751345948129*Pxx_l[7])+0.2886751345948129*Pxx_c[7]-0.25*(Pxx_l[6]+Pxx_c[6]))*dx1; 
  div_p_x_comp[7] += (0.5*Pxx_l[7]-0.5*Pxx_c[7]+0.4330127018922193*(Pxx_l[6]+Pxx_c[6]))*dx1; 
  } 
  if (phi_x_r == 0.0) { 
  ...
  grad_u_x[2] += ((-0.4330127018922193*ux_r[4])+0.4330127018922193*ux_c[4]+0.25*(ux_r[2]+ux_c[2]))*dx1; 
  grad_u_x[3] += ((-0.4330127018922193*ux_r[5])+0.4330127018922193*ux_c[5]+0.25*(ux_r[3]+ux_c[3]))*dx1; 
  grad_u_x[4] += ((-0.75*ux_r[4])+0.75*ux_c[4]+0.4330127018922193*(ux_r[2]+ux_c[2]))*dx1; 
  grad_u_x[5] += ((-0.75*ux_r[5])+0.75*ux_c[5]+0.4330127018922193*(ux_r[3]+ux_c[3]))*dx1; 
  grad_u_x[6] += ((-0.4330127018922193*ux_r[7])+0.4330127018922193*ux_c[7]+0.25*(ux_r[6]+ux_c[6]))*dx1; 
  grad_u_x[7] += ((-0.75*ux_r[7])+0.75*ux_c[7]+0.4330127018922193*(ux_r[6]+ux_c[6]))*dx1; 
  ...
  div_p_x_comp[2] += ((-0.4330127018922193*Pxx_r[4])+0.4330127018922193*Pxx_c[4]+0.25*(Pxx_r[2]+Pxx_c[2]))*dx1; 
  div_p_x_comp[3] += ((-0.4330127018922193*Pxx_r[5])+0.4330127018922193*Pxx_c[5]+0.25*(Pxx_r[3]+Pxx_c[3]))*dx1; 
  div_p_x_comp[4] += ((-0.75*Pxx_r[4])+0.75*Pxx_c[4]+0.4330127018922193*(Pxx_r[2]+Pxx_c[2]))*dx1; 
  div_p_x_comp[5] += ((-0.75*Pxx_r[5])+0.75*Pxx_c[5]+0.4330127018922193*(Pxx_r[3]+Pxx_c[3]))*dx1; 
  div_p_x_comp[6] += ((-0.4330127018922193*Pxx_r[7])+0.4330127018922193*Pxx_c[7]+0.25*(Pxx_r[6]+Pxx_c[6]))*dx1; 
  div_p_x_comp[7] += ((-0.75*Pxx_r[7])+0.75*Pxx_c[7]+0.4330127018922193*(Pxx_r[6]+Pxx_c[6]))*dx1; 
  } else { 
  ...
  grad_u_x[2] += ((-0.2886751345948129*ux_r[4])+0.2886751345948129*ux_c[4]+0.25*(ux_r[2]+ux_c[2]))*dx1; 
  grad_u_x[3] += ((-0.2886751345948129*ux_r[5])+0.2886751345948129*ux_c[5]+0.25*(ux_r[3]+ux_c[3]))*dx1; 
  grad_u_x[4] += ((-0.5*ux_r[4])+0.5*ux_c[4]+0.4330127018922193*(ux_r[2]+ux_c[2]))*dx1; 
  grad_u_x[5] += ((-0.5*ux_r[5])+0.5*ux_c[5]+0.4330127018922193*(ux_r[3]+ux_c[3]))*dx1; 
  grad_u_x[6] += ((-0.2886751345948129*ux_r[7])+0.2886751345948129*ux_c[7]+0.25*(ux_r[6]+ux_c[6]))*dx1; 
  grad_u_x[7] += ((-0.5*ux_r[7])+0.5*ux_c[7]+0.4330127018922193*(ux_r[6]+ux_c[6]))*dx1; 
  ...
  div_p_x_comp[2] += ((-0.2886751345948129*Pxx_r[4])+0.2886751345948129*Pxx_c[4]+0.25*(Pxx_r[2]+Pxx_c[2]))*dx1; 
  div_p_x_comp[3] += ((-0.2886751345948129*Pxx_r[5])+0.2886751345948129*Pxx_c[5]+0.25*(Pxx_r[3]+Pxx_c[3]))*dx1; 
  div_p_x_comp[4] += ((-0.5*Pxx_r[4])+0.5*Pxx_c[4]+0.4330127018922193*(Pxx_r[2]+Pxx_c[2]))*dx1; 
  div_p_x_comp[5] += ((-0.5*Pxx_r[5])+0.5*Pxx_c[5]+0.4330127018922193*(Pxx_r[3]+Pxx_c[3]))*dx1; 
  div_p_x_comp[6] += ((-0.2886751345948129*Pxx_r[7])+0.2886751345948129*Pxx_c[7]+0.25*(Pxx_r[6]+Pxx_c[6]))*dx1; 
  div_p_x_comp[7] += ((-0.5*Pxx_r[7])+0.5*Pxx_c[7]+0.4330127018922193*(Pxx_r[6]+Pxx_c[6]))*dx1; 
  } 

  grad_u_y[1] += -1.732050807568877*uy_c[0]*dx1; 
  grad_u_y[4] += -1.732050807568877*uy_c[2]*dx1; 
  grad_u_y[5] += -1.732050807568877*uy_c[3]*dx1; 
  grad_u_y[7] += -1.732050807568877*uy_c[6]*dx1; 
  div_p_y_comp[1] += -1.732050807568877*Pxy_c[0]*dx1; 
  div_p_y_comp[4] += -1.732050807568877*Pxy_c[2]*dx1; 
  div_p_y_comp[5] += -1.732050807568877*Pxy_c[3]*dx1; 
  div_p_y_comp[7] += -1.732050807568877*Pxy_c[6]*dx1; 
  if (phi_y_l == 0.0) { 
  ...
  grad_u_y[2] += ((-0.4330127018922193*uy_l[4])+0.4330127018922193*uy_c[4]-0.25*(uy_l[2]+uy_c[2]))*dx1; 
  grad_u_y[3] += ((-0.4330127018922193*uy_l[5])+0.4330127018922193*uy_c[5]-0.25*(uy_l[3]+uy_c[3]))*dx1; 
  grad_u_y[4] += (0.75*uy_l[4]-0.75*uy_c[4]+0.4330127018922193*(uy_l[2]+uy_c[2]))*dx1; 
  grad_u_y[5] += (0.75*uy_l[5]-0.75*uy_c[5]+0.4330127018922193*(uy_l[3]+uy_c[3]))*dx1; 
  grad_u_y[6] += ((-0.4330127018922193*uy_l[7])+0.4330127018922193*uy_c[7]-0.25*(uy_l[6]+uy_c[6]))*dx1; 
  grad_u_y[7] += (0.75*uy_l[7]-0.75*uy_c[7]+0.4330127018922193*(uy_l[6]+uy_c[6]))*dx1; 
  ...
  div_p_y_comp[2] += ((-0.4330127018922193*Pxy_l[4])+0.4330127018922193*Pxy_c[4]-0.25*(Pxy_l[2]+Pxy_c[2]))*dx1; 
  div_p_y_comp[3] += ((-0.4330127018922193*Pxy_l[5])+0.4330127018922193*Pxy_c[5]-0.25*(Pxy_l[3]+Pxy_c[3]))*dx1; 
  div_p_y_comp[4] += (0.75*Pxy_l[4]-0.75*Pxy_c[4]+0.4330127018922193*(Pxy_l[2]+Pxy_c[2]))*dx1; 
  div_p_y_comp[5] += (0.75*Pxy_l[5]-0.75*Pxy_c[5]+0.4330127018922193*(Pxy_l[3]+Pxy_c[3]))*dx1; 
  div_p_y_comp[6] += ((-0.4330127018922193*Pxy_l[7])+0.4330127018922193*Pxy_c[7]-0.25*(Pxy_l[6]+Pxy_c[6]))*dx1; 
  div_p_y_comp[7] += (0.75*Pxy_l[7]-0.75*Pxy_c[7]+0.4330127018922193*(Pxy_l[6]+Pxy_c[6]))*dx1; 
  } else { 
  ...
  grad_u_y[2] += ((-0.2886751345948129*uy_l[4])+0.2886751345948129*uy_c[4]-0.25*(uy_l[2]+uy_c[2]))*dx1; 
  grad_u_y[3] += ((-0.2886751345948129*uy_l[5])+0.2886751345948129*uy_c[5]-0.25*(uy_l[3]+uy_c[3]))*dx1; 
  grad_u_y[4] += (0.5*uy_l[4]-0.5*uy_c[4]+0.4330127018922193*(uy_l[2]+uy_c[2]))*dx1; 
  grad_u_y[5] += (0.5*uy_l[5]-0.5*uy_c[5]+0.4330127018922193*(uy_l[3]+uy_c[3]))*dx1; 
  grad_u_y[6] += ((-0.2886751345948129*uy_l[7])+0.2886751345948129*uy_c[7]-0.25*(uy_l[6]+uy_c[6]))*dx1; 
  grad_u_y[7] += (0.5*uy_l[7]-0.5*uy_c[7]+0.4330127018922193*(uy_l[6]+uy_c[6]))*dx1; 
  ...
  div_p_y_comp[2] += ((-0.2886751345948129*Pxy_l[4])+0.2886751345948129*Pxy_c[4]-0.25*(Pxy_l[2]+Pxy_c[2]))*dx1; 
  div_p_y_comp[3] += ((-0.2886751345948129*Pxy_l[5])+0.2886751345948129*Pxy_c[5]-0.25*(Pxy_l[3]+Pxy_c[3]))*dx1; 
  div_p_y_comp[4] += (0.5*Pxy_l[4]-0.5*Pxy_c[4]+0.4330127018922193*(Pxy_l[2]+Pxy_c[2]))*dx1; 
  div_p_y_comp[5] += (0.5*Pxy_l[5]-0.5*Pxy_c[5]+0.4330127018922193*(Pxy_l[3]+Pxy_c[3]))*dx1; 
  div_p_y_comp[6] += ((-0.2886751345948129*Pxy_l[7])+0.2886751345948129*Pxy_c[7]-0.25*(Pxy_l[6]+Pxy_c[6]))*dx1; 
  div_p_y_comp[7] += (0.5*Pxy_l[7]-0.5*Pxy_c[7]+0.4330127018922193*(Pxy_l[6]+Pxy_c[6]))*dx1; 
  } 
  if (phi_y_r == 0.0) { 
  ...
  grad_u_y[2] += ((-0.4330127018922193*uy_r[4])+0.4330127018922193*uy_c[4]+0.25*(uy_r[2]+uy_c[2]))*dx1; 
  grad_u_y[3] += ((-0.4330127018922193*uy_r[5])+0.4330127018922193*uy_c[5]+0.25*(uy_r[3]+uy_c[3]))*dx1; 
  grad_u_y[4] += ((-0.75*uy_r[4])+0.75*uy_c[4]+0.4330127018922193*(uy_r[2]+uy_c[2]))*dx1; 
  grad_u_y[5] += ((-0.75*uy_r[5])+0.75*uy_c[5]+0.4330127018922193*(uy_r[3]+uy_c[3]))*dx1; 
  grad_u_y[6] += ((-0.4330127018922193*uy_r[7])+0.4330127018922193*uy_c[7]+0.25*(uy_r[6]+uy_c[6]))*dx1; 
  grad_u_y[7] += ((-0.75*uy_r[7])+0.75*uy_c[7]+0.4330127018922193*(uy_r[6]+uy_c[6]))*dx1; 
  ...
  div_p_y_comp[2] += ((-0.4330127018922193*Pxy_r[4])+0.4330127018922193*Pxy_c[4]+0.25*(Pxy_r[2]+Pxy_c[2]))*dx1; 
  div_p_y_comp[3] += ((-0.4330127018922193*Pxy_r[5])+0.4330127018922193*Pxy_c[5]+0.25*(Pxy_r[3]+Pxy_c[3]))*dx1; 
  div_p_y_comp[4] += ((-0.75*Pxy_r[4])+0.75*Pxy_c[4]+0.4330127018922193*(Pxy_r[2]+Pxy_c[2]))*dx1; 
  div_p_y_comp[5] += ((-0.75*Pxy_r[5])+0.75*Pxy_c[5]+0.4330127018922193*(Pxy_r[3]+Pxy_c[3]))*dx1; 
  div_p_y_comp[6] += ((-0.4330127018922193*Pxy_r[7])+0.4330127018922193*Pxy_c[7]+0.25*(Pxy_r[6]+Pxy_c[6]))*dx1; 
  div_p_y_comp[7] += ((-0.75*Pxy_r[7])+0.75*Pxy_c[7]+0.4330127018922193*(Pxy_r[6]+Pxy_c[6]))*dx1; 
  } else { 
  ...
  grad_u_y[2] += ((-0.2886751345948129*uy_r[4])+0.2886751345948129*uy_c[4]+0.25*(uy_r[2]+uy_c[2]))*dx1; 
  grad_u_y[3] += ((-0.2886751345948129*uy_r[5])+0.2886751345948129*uy_c[5]+0.25*(uy_r[3]+uy_c[3]))*dx1; 
  grad_u_y[4] += ((-0.5*uy_r[4])+0.5*uy_c[4]+0.4330127018922193*(uy_r[2]+uy_c[2]))*dx1; 
  grad_u_y[5] += ((-0.5*uy_r[5])+0.5*uy_c[5]+0.4330127018922193*(uy_r[3]+uy_c[3]))*dx1; 
  grad_u_y[6] += ((-0.2886751345948129*uy_r[7])+0.2886751345948129*uy_c[7]+0.25*(uy_r[6]+uy_c[6]))*dx1; 
  grad_u_y[7] += ((-0.5*uy_r[7])+0.5*uy_c[7]+0.4330127018922193*(uy_r[6]+uy_c[6]))*dx1; 
  ...
  div_p_y_comp[2] += ((-0.2886751345948129*Pxy_r[4])+0.2886751345948129*Pxy_c[4]+0.25*(Pxy_r[2]+Pxy_c[2]))*dx1; 
  div_p_y_comp[3] += ((-0.2886751345948129*Pxy_r[5])+0.2886751345948129*Pxy_c[5]+0.25*(Pxy_r[3]+Pxy_c[3]))*dx1; 
  div_p_y_comp[4] += ((-0.5*Pxy_r[4])+0.5*Pxy_c[4]+0.4330127018922193*(Pxy_r[2]+Pxy_c[2]))*dx1; 
  div_p_y_comp[5] += ((-0.5*Pxy_r[5])+0.5*Pxy_c[5]+0.4330127018922193*(Pxy_r[3]+Pxy_c[3]))*dx1; 
  div_p_y_comp[6] += ((-0.2886751345948129*Pxy_r[7])+0.2886751345948129*Pxy_c[7]+0.25*(Pxy_r[6]+Pxy_c[6]))*dx1; 
  div_p_y_comp[7] += ((-0.5*Pxy_r[7])+0.5*Pxy_c[7]+0.4330127018922193*(Pxy_r[6]+Pxy_c[6]))*dx1; 
  } 

  grad_u_z[1] += -1.732050807568877*uz_c[0]*dx1; 
  grad_u_z[4] += -1.732050807568877*uz_c[2]*dx1; 
  grad_u_z[5] += -1.732050807568877*uz_c[3]*dx1; 
  grad_u_z[7] += -1.732050807568877*uz_c[6]*dx1; 
  div_p_z_comp[1] += -1.732050807568877*Pxz_c[0]*dx1; 
  div_p_z_comp[4] += -1.732050807568877*Pxz_c[2]*dx1; 
  div_p_z_comp[5] += -1.732050807568877*Pxz_c[3]*dx1; 
  div_p_z_comp[7] += -1.732050807568877*Pxz_c[6]*dx1; 
  if (phi_z_l == 0.0) { 
  ...
  grad_u_z[2] += ((-0.4330127018922193*uz_l[4])+0.4330127018922193*uz_c[4]-0.25*(uz_l[2]+uz_c[2]))*dx1; 
  grad_u_z[3] += ((-0.4330127018922193*uz_l[5])+0.4330127018922193*uz_c[5]-0.25*(uz_l[3]+uz_c[3]))*dx1; 
  grad_u_z[4] += (0.75*uz_l[4]-0.75*uz_c[4]+0.4330127018922193*(uz_l[2]+uz_c[2]))*dx1; 
  grad_u_z[5] += (0.75*uz_l[5]-0.75*uz_c[5]+0.4330127018922193*(uz_l[3]+uz_c[3]))*dx1; 
  grad_u_z[6] += ((-0.4330127018922193*uz_l[7])+0.4330127018922193*uz_c[7]-0.25*(uz_l[6]+uz_c[6]))*dx1; 
  grad_u_z[7] += (0.75*uz_l[7]-0.75*uz_c[7]+0.4330127018922193*(uz_l[6]+uz_c[6]))*dx1; 
  ...
  div_p_z_comp[2] += ((-0.4330127018922193*Pxz_l[4])+0.4330127018922193*Pxz_c[4]-0.25*(Pxz_l[2]+Pxz_c[2]))*dx1; 
  div_p_z_comp[3] += ((-0.4330127018922193*Pxz_l[5])+0.4330127018922193*Pxz_c[5]-0.25*(Pxz_l[3]+Pxz_c[3]))*dx1; 
  div_p_z_comp[4] += (0.75*Pxz_l[4]-0.75*Pxz_c[4]+0.4330127018922193*(Pxz_l[2]+Pxz_c[2]))*dx1; 
  div_p_z_comp[5] += (0.75*Pxz_l[5]-0.75*Pxz_c[5]+0.4330127018922193*(Pxz_l[3]+Pxz_c[3]))*dx1; 
  div_p_z_comp[6] += ((-0.4330127018922193*Pxz_l[7])+0.4330127018922193*Pxz_c[7]-0.25*(Pxz_l[6]+Pxz_c[6]))*dx1; 
  div_p_z_comp[7] += (0.75*Pxz_l[7]-0.75*Pxz_c[7]+0.4330127018922193*(Pxz_l[6]+Pxz_c[6]))*dx1; 
  } else { 
  grad_u_z[0] += ((-0.2886751345948129*uy_l[1])+0.2886751345948129*uy_c[1]-0.25*(uy_l[0]+uy_c[0]))*dx1; 
  grad_u_z[1] += (0.5*uy_l[1]-0.5*uy_c[1]+0.4330127018922193*(uy_l[0]+uy_c[0]))*dx1; 
  grad_u_z[2] += ((-0.2886751345948129*uy_l[4])+0.2886751345948129*uy_c[4]-0.25*(uy_l[2]+uy_c[2]))*dx1; 
  grad_u_z[3] += ((-0.2886751345948129*uy_l[5])+0.2886751345948129*uy_c[5]-0.25*(uy_l[3]+uy_c[3]))*dx1; 
  grad_u_z[4] += (0.5*uy_l[4]-0.5*uy_c[4]+0.4330127018922193*(uy_l[2]+uy_c[2]))*dx1; 
  grad_u_z[5] += (0.5*uy_l[5]-0.5*uy_c[5]+0.4330127018922193*(uy_l[3]+uy_c[3]))*dx1; 
  grad_u_z[6] += ((-0.2886751345948129*uy_l[7])+0.2886751345948129*uy_c[7]-0.25*(uy_l[6]+uy_c[6]))*dx1; 
  grad_u_z[7] += (0.5*uy_l[7]-0.5*uy_c[7]+0.4330127018922193*(uy_l[6]+uy_c[6]))*dx1; 
  ...
  div_p_z_comp[2] += ((-0.2886751345948129*Pxz_l[4])+0.2886751345948129*Pxz_c[4]-0.25*(Pxz_l[2]+Pxz_c[2]))*dx1; 
  div_p_z_comp[3] += ((-0.2886751345948129*Pxz_l[5])+0.2886751345948129*Pxz_c[5]-0.25*(Pxz_l[3]+Pxz_c[3]))*dx1; 
  div_p_z_comp[4] += (0.5*Pxz_l[4]-0.5*Pxz_c[4]+0.4330127018922193*(Pxz_l[2]+Pxz_c[2]))*dx1; 
  div_p_z_comp[5] += (0.5*Pxz_l[5]-0.5*Pxz_c[5]+0.4330127018922193*(Pxz_l[3]+Pxz_c[3]))*dx1; 
  div_p_z_comp[6] += ((-0.2886751345948129*Pxz_l[7])+0.2886751345948129*Pxz_c[7]-0.25*(Pxz_l[6]+Pxz_c[6]))*dx1; 
  div_p_z_comp[7] += (0.5*Pxz_l[7]-0.5*Pxz_c[7]+0.4330127018922193*(Pxz_l[6]+Pxz_c[6]))*dx1; 
  } 
  if (phi_z_r == 0.0) { 
  ...
  grad_u_z[2] += ((-0.4330127018922193*uz_r[4])+0.4330127018922193*uz_c[4]+0.25*(uz_r[2]+uz_c[2]))*dx1; 
  grad_u_z[3] += ((-0.4330127018922193*uz_r[5])+0.4330127018922193*uz_c[5]+0.25*(uz_r[3]+uz_c[3]))*dx1; 
  grad_u_z[4] += ((-0.75*uz_r[4])+0.75*uz_c[4]+0.4330127018922193*(uz_r[2]+uz_c[2]))*dx1; 
  grad_u_z[5] += ((-0.75*uz_r[5])+0.75*uz_c[5]+0.4330127018922193*(uz_r[3]+uz_c[3]))*dx1; 
  grad_u_z[6] += ((-0.4330127018922193*uz_r[7])+0.4330127018922193*uz_c[7]+0.25*(uz_r[6]+uz_c[6]))*dx1; 
  grad_u_z[7] += ((-0.75*uz_r[7])+0.75*uz_c[7]+0.4330127018922193*(uz_r[6]+uz_c[6]))*dx1; 
  ...
  div_p_z_comp[2] += ((-0.4330127018922193*Pxz_r[4])+0.4330127018922193*Pxz_c[4]+0.25*(Pxz_r[2]+Pxz_c[2]))*dx1; 
  div_p_z_comp[3] += ((-0.4330127018922193*Pxz_r[5])+0.4330127018922193*Pxz_c[5]+0.25*(Pxz_r[3]+Pxz_c[3]))*dx1; 
  div_p_z_comp[4] += ((-0.75*Pxz_r[4])+0.75*Pxz_c[4]+0.4330127018922193*(Pxz_r[2]+Pxz_c[2]))*dx1; 
  div_p_z_comp[5] += ((-0.75*Pxz_r[5])+0.75*Pxz_c[5]+0.4330127018922193*(Pxz_r[3]+Pxz_c[3]))*dx1; 
  div_p_z_comp[6] += ((-0.4330127018922193*Pxz_r[7])+0.4330127018922193*Pxz_c[7]+0.25*(Pxz_r[6]+Pxz_c[6]))*dx1; 
  div_p_z_comp[7] += ((-0.75*Pxz_r[7])+0.75*Pxz_c[7]+0.4330127018922193*(Pxz_r[6]+Pxz_c[6]))*dx1; 
  } else { 
  grad_u_z[0] += ((-0.2886751345948129*uy_r[1])+0.2886751345948129*uy_c[1]+0.25*(uy_r[0]+uy_c[0]))*dx1; 
  grad_u_z[1] += ((-0.5*uy_r[1])+0.5*uy_c[1]+0.4330127018922193*(uy_r[0]+uy_c[0]))*dx1; 
  grad_u_z[2] += ((-0.2886751345948129*uy_r[4])+0.2886751345948129*uy_c[4]+0.25*(uy_r[2]+uy_c[2]))*dx1; 
  grad_u_z[3] += ((-0.2886751345948129*uy_r[5])+0.2886751345948129*uy_c[5]+0.25*(uy_r[3]+uy_c[3]))*dx1; 
  grad_u_z[4] += ((-0.5*uy_r[4])+0.5*uy_c[4]+0.4330127018922193*(uy_r[2]+uy_c[2]))*dx1; 
  grad_u_z[5] += ((-0.5*uy_r[5])+0.5*uy_c[5]+0.4330127018922193*(uy_r[3]+uy_c[3]))*dx1; 
  grad_u_z[6] += ((-0.2886751345948129*uy_r[7])+0.2886751345948129*uy_c[7]+0.25*(uy_r[6]+uy_c[6]))*dx1; 
  grad_u_z[7] += ((-0.5*uy_r[7])+0.5*uy_c[7]+0.4330127018922193*(uy_r[6]+uy_c[6]))*dx1; 
  ...
  div_p_z_comp[2] += ((-0.2886751345948129*Pxz_r[4])+0.2886751345948129*Pxz_c[4]+0.25*(Pxz_r[2]+Pxz_c[2]))*dx1; 
  div_p_z_comp[3] += ((-0.2886751345948129*Pxz_r[5])+0.2886751345948129*Pxz_c[5]+0.25*(Pxz_r[3]+Pxz_c[3]))*dx1; 
  div_p_z_comp[4] += ((-0.5*Pxz_r[4])+0.5*Pxz_c[4]+0.4330127018922193*(Pxz_r[2]+Pxz_c[2]))*dx1; 
  div_p_z_comp[5] += ((-0.5*Pxz_r[5])+0.5*Pxz_c[5]+0.4330127018922193*(Pxz_r[3]+Pxz_c[3]))*dx1; 
  div_p_z_comp[6] += ((-0.2886751345948129*Pxz_r[7])+0.2886751345948129*Pxz_c[7]+0.25*(Pxz_r[6]+Pxz_c[6]))*dx1; 
  div_p_z_comp[7] += ((-0.5*Pxz_r[7])+0.5*Pxz_c[7]+0.4330127018922193*(Pxz_r[6]+Pxz_c[6]))*dx1; 
  } 
