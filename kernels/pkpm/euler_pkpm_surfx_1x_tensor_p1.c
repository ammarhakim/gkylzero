...
#include <gkyl_basis_tensor_1x_p1_surfx1_eval_quad.h> 
...
{ 
  ...
  const double *ux_surf_lr = &pkpm_u_surf_l[1]; 
  const double *uy_surf_lr = &pkpm_u_surf_l[3]; 
  const double *uz_surf_lr = &pkpm_u_surf_l[5]; 

  const double *ux_surf_cl = &pkpm_u_surf_c[0]; 
  const double *uy_surf_cl = &pkpm_u_surf_c[2]; 
  const double *uz_surf_cl = &pkpm_u_surf_c[4]; 

  const double *ux_surf_cr = &pkpm_u_surf_c[1]; 
  const double *uy_surf_cr = &pkpm_u_surf_c[3]; 
  const double *uz_surf_cr = &pkpm_u_surf_c[5]; 

  const double *ux_surf_rl = &pkpm_u_surf_r[0]; 
  const double *uy_surf_rl = &pkpm_u_surf_r[2]; 
  const double *uz_surf_rl = &pkpm_u_surf_r[4]; 
