...
{ 
  ...
  for (int s = 0; s < num_species; ++s) { 
    ...
    quad_nodal_to_modal_2d_ser_p1(rhoux_nodal[s], out_rhoux);
    quad_nodal_to_modal_2d_ser_p1(rhouy_nodal[s], out_rhouy);
    quad_nodal_to_modal_2d_ser_p1(rhouz_nodal[s], out_rhouz);
  } 
  ...
  if (!pkpm_field_static) { 
    ...
    double *out_Ey = &em[4]; 
    double *out_Ez = &em[8]; 
    quad_nodal_to_modal_2d_ser_p1(Ex_nodal, out_Ex);
    quad_nodal_to_modal_2d_ser_p1(Ey_nodal, out_Ey);
    quad_nodal_to_modal_2d_ser_p1(Ez_nodal, out_Ez);
  } 
} 
