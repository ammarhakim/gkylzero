...
GKYL_CU_DH void pkpm_vars_p_force_1x_tensor_p2(const double *prim_c, const double *div_b, 
...
{ 
  ...
  const double *T_perp_over_m = &prim_c[3]; 

  double *p_perp_div_b = &pkpm_accel[0]; 
  double *p_force = &pkpm_accel[6]; 

  binop_mul_1d_tensor_p2(T_perp_over_m, div_b, p_perp_div_b); 
