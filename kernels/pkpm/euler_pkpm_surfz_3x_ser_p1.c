...
{ 
  ...
  const double *u_l = &priml[16]; 
  const double *u_c = &primc[16]; 
  const double *u_r = &primr[16]; 
  ...
  const double *vth_sql = &priml[40]; 
  const double *vth_sqc = &primc[40]; 
  const double *vth_sqr = &primr[40]; 
