...
{ 
  ...
  const double *pkpm_lax_l = &pkpm_lax[16]; 
  const double *pkpm_lax_r = &pkpm_lax[20]; 
  ...
  flux_rho_l[0] = 0.1530931089239486*uz_surf_lr[3]*rho_l[7]+0.1530931089239486*uz_surf_cl[3]*rho_l[7]+0.3061862178478971*pkpm_lax_l[3]*rho_l[7]-0.1530931089239486*uz_surf_lr[3]*rho_c[7]-0.1530931089239486*uz_surf_cl[3]*rho_c[7]+0.3061862178478971*pkpm_lax_l[3]*rho_c[7]+0.1530931089239486*uz_surf_lr[2]*rho_l[6]+0.1530931089239486*uz_surf_cl[2]*rho_l[6]+0.3061862178478971*pkpm_lax_l[2]*rho_l[6]-0.1530931089239486*uz_surf_lr[2]*rho_c[6]-0.1530931089239486*uz_surf_cl[2]*rho_c[6]+0.3061862178478971*pkpm_lax_l[2]*rho_c[6]+0.1530931089239486*uz_surf_lr[1]*rho_l[5]+0.1530931089239486*uz_surf_cl[1]*rho_l[5]+0.3061862178478971*pkpm_lax_l[1]*rho_l[5]-0.1530931089239486*uz_surf_lr[1]*rho_c[5]-0.1530931089239486*uz_surf_cl[1]*rho_c[5]+0.3061862178478971*pkpm_lax_l[1]*rho_c[5]+0.0883883476483184*uz_surf_lr[3]*rho_l[4]+0.0883883476483184*uz_surf_cl[3]*rho_l[4]+0.1767766952966368*pkpm_lax_l[3]*rho_l[4]+0.0883883476483184*uz_surf_lr[3]*rho_c[4]+0.0883883476483184*uz_surf_cl[3]*rho_c[4]-0.1767766952966368*pkpm_lax_l[3]*rho_c[4]+0.1530931089239486*uz_surf_lr[0]*rho_l[3]+0.1530931089239486*uz_surf_cl[0]*rho_l[3]+0.3061862178478971*pkpm_lax_l[0]*rho_l[3]-0.1530931089239486*uz_surf_lr[0]*rho_c[3]-0.1530931089239486*uz_surf_cl[0]*rho_c[3]+0.3061862178478971*pkpm_lax_l[0]*rho_c[3]+0.0883883476483184*rho_l[2]*uz_surf_lr[2]+0.0883883476483184*rho_c[2]*uz_surf_lr[2]+0.0883883476483184*rho_l[2]*uz_surf_cl[2]+0.0883883476483184*rho_c[2]*uz_surf_cl[2]+0.1767766952966368*pkpm_lax_l[2]*rho_l[2]-0.1767766952966368*pkpm_lax_l[2]*rho_c[2]+0.0883883476483184*rho_l[1]*uz_surf_lr[1]+0.0883883476483184*rho_c[1]*uz_surf_lr[1]+0.0883883476483184*rho_l[1]*uz_surf_cl[1]+0.0883883476483184*rho_c[1]*uz_surf_cl[1]+0.1767766952966368*pkpm_lax_l[1]*rho_l[1]-0.1767766952966368*pkpm_lax_l[1]*rho_c[1]+0.0883883476483184*rho_l[0]*uz_surf_lr[0]+0.0883883476483184*rho_c[0]*uz_surf_lr[0]+0.0883883476483184*rho_l[0]*uz_surf_cl[0]+0.0883883476483184*rho_c[0]*uz_surf_cl[0]+0.1767766952966368*pkpm_lax_l[0]*rho_l[0]-0.1767766952966368*pkpm_lax_l[0]*rho_c[0]; 
  flux_rho_l[1] = 0.1530931089239486*uz_surf_lr[2]*rho_l[7]+0.1530931089239486*uz_surf_cl[2]*rho_l[7]+0.3061862178478971*pkpm_lax_l[2]*rho_l[7]-0.1530931089239486*uz_surf_lr[2]*rho_c[7]-0.1530931089239486*uz_surf_cl[2]*rho_c[7]+0.3061862178478971*pkpm_lax_l[2]*rho_c[7]+0.1530931089239486*uz_surf_lr[3]*rho_l[6]+0.1530931089239486*uz_surf_cl[3]*rho_l[6]+0.3061862178478971*pkpm_lax_l[3]*rho_l[6]-0.1530931089239486*uz_surf_lr[3]*rho_c[6]-0.1530931089239486*uz_surf_cl[3]*rho_c[6]+0.3061862178478971*pkpm_lax_l[3]*rho_c[6]+0.1530931089239486*uz_surf_lr[0]*rho_l[5]+0.1530931089239486*uz_surf_cl[0]*rho_l[5]+0.3061862178478971*pkpm_lax_l[0]*rho_l[5]-0.1530931089239486*uz_surf_lr[0]*rho_c[5]-0.1530931089239486*uz_surf_cl[0]*rho_c[5]+0.3061862178478971*pkpm_lax_l[0]*rho_c[5]+0.0883883476483184*uz_surf_lr[2]*rho_l[4]+0.0883883476483184*uz_surf_cl[2]*rho_l[4]+0.1767766952966368*pkpm_lax_l[2]*rho_l[4]+0.0883883476483184*uz_surf_lr[2]*rho_c[4]+0.0883883476483184*uz_surf_cl[2]*rho_c[4]-0.1767766952966368*pkpm_lax_l[2]*rho_c[4]+0.0883883476483184*rho_l[2]*uz_surf_lr[3]+0.0883883476483184*rho_c[2]*uz_surf_lr[3]+0.0883883476483184*rho_l[2]*uz_surf_cl[3]+0.0883883476483184*rho_c[2]*uz_surf_cl[3]+0.1530931089239486*uz_surf_lr[1]*rho_l[3]+0.1530931089239486*uz_surf_cl[1]*rho_l[3]+0.3061862178478971*pkpm_lax_l[1]*rho_l[3]-0.1530931089239486*uz_surf_lr[1]*rho_c[3]-0.1530931089239486*uz_surf_cl[1]*rho_c[3]+0.3061862178478971*pkpm_lax_l[1]*rho_c[3]+0.1767766952966368*rho_l[2]*pkpm_lax_l[3]-0.1767766952966368*rho_c[2]*pkpm_lax_l[3]+0.0883883476483184*rho_l[0]*uz_surf_lr[1]+0.0883883476483184*rho_c[0]*uz_surf_lr[1]+0.0883883476483184*rho_l[0]*uz_surf_cl[1]+0.0883883476483184*rho_c[0]*uz_surf_cl[1]+0.0883883476483184*uz_surf_lr[0]*rho_l[1]+0.0883883476483184*uz_surf_cl[0]*rho_l[1]+0.1767766952966368*pkpm_lax_l[0]*rho_l[1]+0.0883883476483184*uz_surf_lr[0]*rho_c[1]+0.0883883476483184*uz_surf_cl[0]*rho_c[1]-0.1767766952966368*pkpm_lax_l[0]*rho_c[1]+0.1767766952966368*rho_l[0]*pkpm_lax_l[1]-0.1767766952966368*rho_c[0]*pkpm_lax_l[1]; 
  flux_rho_l[2] = 0.1530931089239486*uz_surf_lr[1]*rho_l[7]+0.1530931089239486*uz_surf_cl[1]*rho_l[7]+0.3061862178478971*pkpm_lax_l[1]*rho_l[7]-0.1530931089239486*uz_surf_lr[1]*rho_c[7]-0.1530931089239486*uz_surf_cl[1]*rho_c[7]+0.3061862178478971*pkpm_lax_l[1]*rho_c[7]+0.1530931089239486*uz_surf_lr[0]*rho_l[6]+0.1530931089239486*uz_surf_cl[0]*rho_l[6]+0.3061862178478971*pkpm_lax_l[0]*rho_l[6]-0.1530931089239486*uz_surf_lr[0]*rho_c[6]-0.1530931089239486*uz_surf_cl[0]*rho_c[6]+0.3061862178478971*pkpm_lax_l[0]*rho_c[6]+0.1530931089239486*uz_surf_lr[3]*rho_l[5]+0.1530931089239486*uz_surf_cl[3]*rho_l[5]+0.3061862178478971*pkpm_lax_l[3]*rho_l[5]-0.1530931089239486*uz_surf_lr[3]*rho_c[5]-0.1530931089239486*uz_surf_cl[3]*rho_c[5]+0.3061862178478971*pkpm_lax_l[3]*rho_c[5]+0.0883883476483184*uz_surf_lr[1]*rho_l[4]+0.0883883476483184*uz_surf_cl[1]*rho_l[4]+0.1767766952966368*pkpm_lax_l[1]*rho_l[4]+0.0883883476483184*uz_surf_lr[1]*rho_c[4]+0.0883883476483184*uz_surf_cl[1]*rho_c[4]-0.1767766952966368*pkpm_lax_l[1]*rho_c[4]+0.0883883476483184*rho_l[1]*uz_surf_lr[3]+0.0883883476483184*rho_c[1]*uz_surf_lr[3]+0.0883883476483184*rho_l[1]*uz_surf_cl[3]+0.0883883476483184*rho_c[1]*uz_surf_cl[3]+0.1530931089239486*uz_surf_lr[2]*rho_l[3]+0.1530931089239486*uz_surf_cl[2]*rho_l[3]+0.3061862178478971*pkpm_lax_l[2]*rho_l[3]-0.1530931089239486*uz_surf_lr[2]*rho_c[3]-0.1530931089239486*uz_surf_cl[2]*rho_c[3]+0.3061862178478971*pkpm_lax_l[2]*rho_c[3]+0.1767766952966368*rho_l[1]*pkpm_lax_l[3]-0.1767766952966368*rho_c[1]*pkpm_lax_l[3]+0.0883883476483184*rho_l[0]*uz_surf_lr[2]+0.0883883476483184*rho_c[0]*uz_surf_lr[2]+0.0883883476483184*rho_l[0]*uz_surf_cl[2]+0.0883883476483184*rho_c[0]*uz_surf_cl[2]+0.0883883476483184*uz_surf_lr[0]*rho_l[2]+0.0883883476483184*uz_surf_cl[0]*rho_l[2]+0.1767766952966368*pkpm_lax_l[0]*rho_l[2]+0.0883883476483184*uz_surf_lr[0]*rho_c[2]+0.0883883476483184*uz_surf_cl[0]*rho_c[2]-0.1767766952966368*pkpm_lax_l[0]*rho_c[2]+0.1767766952966368*rho_l[0]*pkpm_lax_l[2]-0.1767766952966368*rho_c[0]*pkpm_lax_l[2]; 
  flux_rho_l[3] = 0.1530931089239486*uz_surf_lr[0]*rho_l[7]+0.1530931089239486*uz_surf_cl[0]*rho_l[7]+0.3061862178478971*pkpm_lax_l[0]*rho_l[7]-0.1530931089239486*uz_surf_lr[0]*rho_c[7]-0.1530931089239486*uz_surf_cl[0]*rho_c[7]+0.3061862178478971*pkpm_lax_l[0]*rho_c[7]+0.1530931089239486*uz_surf_lr[1]*rho_l[6]+0.1530931089239486*uz_surf_cl[1]*rho_l[6]+0.3061862178478971*pkpm_lax_l[1]*rho_l[6]-0.1530931089239486*uz_surf_lr[1]*rho_c[6]-0.1530931089239486*uz_surf_cl[1]*rho_c[6]+0.3061862178478971*pkpm_lax_l[1]*rho_c[6]+0.1530931089239486*uz_surf_lr[2]*rho_l[5]+0.1530931089239486*uz_surf_cl[2]*rho_l[5]+0.3061862178478971*pkpm_lax_l[2]*rho_l[5]-0.1530931089239486*uz_surf_lr[2]*rho_c[5]-0.1530931089239486*uz_surf_cl[2]*rho_c[5]+0.3061862178478971*pkpm_lax_l[2]*rho_c[5]+0.0883883476483184*uz_surf_lr[0]*rho_l[4]+0.0883883476483184*uz_surf_cl[0]*rho_l[4]+0.1767766952966368*pkpm_lax_l[0]*rho_l[4]+0.0883883476483184*uz_surf_lr[0]*rho_c[4]+0.0883883476483184*uz_surf_cl[0]*rho_c[4]-0.1767766952966368*pkpm_lax_l[0]*rho_c[4]+0.1530931089239486*rho_l[3]*uz_surf_lr[3]-0.1530931089239486*rho_c[3]*uz_surf_lr[3]+0.0883883476483184*rho_l[0]*uz_surf_lr[3]+0.0883883476483184*rho_c[0]*uz_surf_lr[3]+0.1530931089239486*rho_l[3]*uz_surf_cl[3]-0.1530931089239486*rho_c[3]*uz_surf_cl[3]+0.0883883476483184*rho_l[0]*uz_surf_cl[3]+0.0883883476483184*rho_c[0]*uz_surf_cl[3]+0.3061862178478971*pkpm_lax_l[3]*rho_l[3]+0.3061862178478971*pkpm_lax_l[3]*rho_c[3]+0.1767766952966368*rho_l[0]*pkpm_lax_l[3]-0.1767766952966368*rho_c[0]*pkpm_lax_l[3]+0.0883883476483184*rho_l[1]*uz_surf_lr[2]+0.0883883476483184*rho_c[1]*uz_surf_lr[2]+0.0883883476483184*rho_l[1]*uz_surf_cl[2]+0.0883883476483184*rho_c[1]*uz_surf_cl[2]+0.0883883476483184*uz_surf_lr[1]*rho_l[2]+0.0883883476483184*uz_surf_cl[1]*rho_l[2]+0.1767766952966368*pkpm_lax_l[1]*rho_l[2]+0.0883883476483184*uz_surf_lr[1]*rho_c[2]+0.0883883476483184*uz_surf_cl[1]*rho_c[2]-0.1767766952966368*pkpm_lax_l[1]*rho_c[2]+0.1767766952966368*rho_l[1]*pkpm_lax_l[2]-0.1767766952966368*rho_c[1]*pkpm_lax_l[2]; 

  flux_rho_r[0] = (-0.1530931089239486*uz_surf_rl[3]*rho_r[7])-0.1530931089239486*uz_surf_cr[3]*rho_r[7]+0.3061862178478971*pkpm_lax_r[3]*rho_r[7]+0.1530931089239486*uz_surf_rl[3]*rho_c[7]+0.1530931089239486*uz_surf_cr[3]*rho_c[7]+0.3061862178478971*pkpm_lax_r[3]*rho_c[7]-0.1530931089239486*uz_surf_rl[2]*rho_r[6]-0.1530931089239486*uz_surf_cr[2]*rho_r[6]+0.3061862178478971*pkpm_lax_r[2]*rho_r[6]+0.1530931089239486*uz_surf_rl[2]*rho_c[6]+0.1530931089239486*uz_surf_cr[2]*rho_c[6]+0.3061862178478971*pkpm_lax_r[2]*rho_c[6]-0.1530931089239486*uz_surf_rl[1]*rho_r[5]-0.1530931089239486*uz_surf_cr[1]*rho_r[5]+0.3061862178478971*pkpm_lax_r[1]*rho_r[5]+0.1530931089239486*uz_surf_rl[1]*rho_c[5]+0.1530931089239486*uz_surf_cr[1]*rho_c[5]+0.3061862178478971*pkpm_lax_r[1]*rho_c[5]+0.0883883476483184*uz_surf_rl[3]*rho_r[4]+0.0883883476483184*uz_surf_cr[3]*rho_r[4]-0.1767766952966368*pkpm_lax_r[3]*rho_r[4]+0.0883883476483184*uz_surf_rl[3]*rho_c[4]+0.0883883476483184*uz_surf_cr[3]*rho_c[4]+0.1767766952966368*pkpm_lax_r[3]*rho_c[4]-0.1530931089239486*uz_surf_rl[0]*rho_r[3]-0.1530931089239486*uz_surf_cr[0]*rho_r[3]+0.3061862178478971*pkpm_lax_r[0]*rho_r[3]+0.1530931089239486*uz_surf_rl[0]*rho_c[3]+0.1530931089239486*uz_surf_cr[0]*rho_c[3]+0.3061862178478971*pkpm_lax_r[0]*rho_c[3]+0.0883883476483184*rho_r[2]*uz_surf_rl[2]+0.0883883476483184*rho_c[2]*uz_surf_rl[2]+0.0883883476483184*rho_r[2]*uz_surf_cr[2]+0.0883883476483184*rho_c[2]*uz_surf_cr[2]-0.1767766952966368*pkpm_lax_r[2]*rho_r[2]+0.1767766952966368*pkpm_lax_r[2]*rho_c[2]+0.0883883476483184*rho_r[1]*uz_surf_rl[1]+0.0883883476483184*rho_c[1]*uz_surf_rl[1]+0.0883883476483184*rho_r[1]*uz_surf_cr[1]+0.0883883476483184*rho_c[1]*uz_surf_cr[1]-0.1767766952966368*pkpm_lax_r[1]*rho_r[1]+0.1767766952966368*pkpm_lax_r[1]*rho_c[1]+0.0883883476483184*rho_r[0]*uz_surf_rl[0]+0.0883883476483184*rho_c[0]*uz_surf_rl[0]+0.0883883476483184*rho_r[0]*uz_surf_cr[0]+0.0883883476483184*rho_c[0]*uz_surf_cr[0]-0.1767766952966368*pkpm_lax_r[0]*rho_r[0]+0.1767766952966368*pkpm_lax_r[0]*rho_c[0]; 
  flux_rho_r[1] = (-0.1530931089239486*uz_surf_rl[2]*rho_r[7])-0.1530931089239486*uz_surf_cr[2]*rho_r[7]+0.3061862178478971*pkpm_lax_r[2]*rho_r[7]+0.1530931089239486*uz_surf_rl[2]*rho_c[7]+0.1530931089239486*uz_surf_cr[2]*rho_c[7]+0.3061862178478971*pkpm_lax_r[2]*rho_c[7]-0.1530931089239486*uz_surf_rl[3]*rho_r[6]-0.1530931089239486*uz_surf_cr[3]*rho_r[6]+0.3061862178478971*pkpm_lax_r[3]*rho_r[6]+0.1530931089239486*uz_surf_rl[3]*rho_c[6]+0.1530931089239486*uz_surf_cr[3]*rho_c[6]+0.3061862178478971*pkpm_lax_r[3]*rho_c[6]-0.1530931089239486*uz_surf_rl[0]*rho_r[5]-0.1530931089239486*uz_surf_cr[0]*rho_r[5]+0.3061862178478971*pkpm_lax_r[0]*rho_r[5]+0.1530931089239486*uz_surf_rl[0]*rho_c[5]+0.1530931089239486*uz_surf_cr[0]*rho_c[5]+0.3061862178478971*pkpm_lax_r[0]*rho_c[5]+0.0883883476483184*uz_surf_rl[2]*rho_r[4]+0.0883883476483184*uz_surf_cr[2]*rho_r[4]-0.1767766952966368*pkpm_lax_r[2]*rho_r[4]+0.0883883476483184*uz_surf_rl[2]*rho_c[4]+0.0883883476483184*uz_surf_cr[2]*rho_c[4]+0.1767766952966368*pkpm_lax_r[2]*rho_c[4]+0.0883883476483184*rho_r[2]*uz_surf_rl[3]+0.0883883476483184*rho_c[2]*uz_surf_rl[3]+0.0883883476483184*rho_r[2]*uz_surf_cr[3]+0.0883883476483184*rho_c[2]*uz_surf_cr[3]-0.1530931089239486*uz_surf_rl[1]*rho_r[3]-0.1530931089239486*uz_surf_cr[1]*rho_r[3]+0.3061862178478971*pkpm_lax_r[1]*rho_r[3]+0.1530931089239486*uz_surf_rl[1]*rho_c[3]+0.1530931089239486*uz_surf_cr[1]*rho_c[3]+0.3061862178478971*pkpm_lax_r[1]*rho_c[3]-0.1767766952966368*rho_r[2]*pkpm_lax_r[3]+0.1767766952966368*rho_c[2]*pkpm_lax_r[3]+0.0883883476483184*rho_r[0]*uz_surf_rl[1]+0.0883883476483184*rho_c[0]*uz_surf_rl[1]+0.0883883476483184*rho_r[0]*uz_surf_cr[1]+0.0883883476483184*rho_c[0]*uz_surf_cr[1]+0.0883883476483184*uz_surf_rl[0]*rho_r[1]+0.0883883476483184*uz_surf_cr[0]*rho_r[1]-0.1767766952966368*pkpm_lax_r[0]*rho_r[1]+0.0883883476483184*uz_surf_rl[0]*rho_c[1]+0.0883883476483184*uz_surf_cr[0]*rho_c[1]+0.1767766952966368*pkpm_lax_r[0]*rho_c[1]-0.1767766952966368*rho_r[0]*pkpm_lax_r[1]+0.1767766952966368*rho_c[0]*pkpm_lax_r[1]; 
  flux_rho_r[2] = (-0.1530931089239486*uz_surf_rl[1]*rho_r[7])-0.1530931089239486*uz_surf_cr[1]*rho_r[7]+0.3061862178478971*pkpm_lax_r[1]*rho_r[7]+0.1530931089239486*uz_surf_rl[1]*rho_c[7]+0.1530931089239486*uz_surf_cr[1]*rho_c[7]+0.3061862178478971*pkpm_lax_r[1]*rho_c[7]-0.1530931089239486*uz_surf_rl[0]*rho_r[6]-0.1530931089239486*uz_surf_cr[0]*rho_r[6]+0.3061862178478971*pkpm_lax_r[0]*rho_r[6]+0.1530931089239486*uz_surf_rl[0]*rho_c[6]+0.1530931089239486*uz_surf_cr[0]*rho_c[6]+0.3061862178478971*pkpm_lax_r[0]*rho_c[6]-0.1530931089239486*uz_surf_rl[3]*rho_r[5]-0.1530931089239486*uz_surf_cr[3]*rho_r[5]+0.3061862178478971*pkpm_lax_r[3]*rho_r[5]+0.1530931089239486*uz_surf_rl[3]*rho_c[5]+0.1530931089239486*uz_surf_cr[3]*rho_c[5]+0.3061862178478971*pkpm_lax_r[3]*rho_c[5]+0.0883883476483184*uz_surf_rl[1]*rho_r[4]+0.0883883476483184*uz_surf_cr[1]*rho_r[4]-0.1767766952966368*pkpm_lax_r[1]*rho_r[4]+0.0883883476483184*uz_surf_rl[1]*rho_c[4]+0.0883883476483184*uz_surf_cr[1]*rho_c[4]+0.1767766952966368*pkpm_lax_r[1]*rho_c[4]+0.0883883476483184*rho_r[1]*uz_surf_rl[3]+0.0883883476483184*rho_c[1]*uz_surf_rl[3]+0.0883883476483184*rho_r[1]*uz_surf_cr[3]+0.0883883476483184*rho_c[1]*uz_surf_cr[3]-0.1530931089239486*uz_surf_rl[2]*rho_r[3]-0.1530931089239486*uz_surf_cr[2]*rho_r[3]+0.3061862178478971*pkpm_lax_r[2]*rho_r[3]+0.1530931089239486*uz_surf_rl[2]*rho_c[3]+0.1530931089239486*uz_surf_cr[2]*rho_c[3]+0.3061862178478971*pkpm_lax_r[2]*rho_c[3]-0.1767766952966368*rho_r[1]*pkpm_lax_r[3]+0.1767766952966368*rho_c[1]*pkpm_lax_r[3]+0.0883883476483184*rho_r[0]*uz_surf_rl[2]+0.0883883476483184*rho_c[0]*uz_surf_rl[2]+0.0883883476483184*rho_r[0]*uz_surf_cr[2]+0.0883883476483184*rho_c[0]*uz_surf_cr[2]+0.0883883476483184*uz_surf_rl[0]*rho_r[2]+0.0883883476483184*uz_surf_cr[0]*rho_r[2]-0.1767766952966368*pkpm_lax_r[0]*rho_r[2]+0.0883883476483184*uz_surf_rl[0]*rho_c[2]+0.0883883476483184*uz_surf_cr[0]*rho_c[2]+0.1767766952966368*pkpm_lax_r[0]*rho_c[2]-0.1767766952966368*rho_r[0]*pkpm_lax_r[2]+0.1767766952966368*rho_c[0]*pkpm_lax_r[2]; 
  flux_rho_r[3] = (-0.1530931089239486*uz_surf_rl[0]*rho_r[7])-0.1530931089239486*uz_surf_cr[0]*rho_r[7]+0.3061862178478971*pkpm_lax_r[0]*rho_r[7]+0.1530931089239486*uz_surf_rl[0]*rho_c[7]+0.1530931089239486*uz_surf_cr[0]*rho_c[7]+0.3061862178478971*pkpm_lax_r[0]*rho_c[7]-0.1530931089239486*uz_surf_rl[1]*rho_r[6]-0.1530931089239486*uz_surf_cr[1]*rho_r[6]+0.3061862178478971*pkpm_lax_r[1]*rho_r[6]+0.1530931089239486*uz_surf_rl[1]*rho_c[6]+0.1530931089239486*uz_surf_cr[1]*rho_c[6]+0.3061862178478971*pkpm_lax_r[1]*rho_c[6]-0.1530931089239486*uz_surf_rl[2]*rho_r[5]-0.1530931089239486*uz_surf_cr[2]*rho_r[5]+0.3061862178478971*pkpm_lax_r[2]*rho_r[5]+0.1530931089239486*uz_surf_rl[2]*rho_c[5]+0.1530931089239486*uz_surf_cr[2]*rho_c[5]+0.3061862178478971*pkpm_lax_r[2]*rho_c[5]+0.0883883476483184*uz_surf_rl[0]*rho_r[4]+0.0883883476483184*uz_surf_cr[0]*rho_r[4]-0.1767766952966368*pkpm_lax_r[0]*rho_r[4]+0.0883883476483184*uz_surf_rl[0]*rho_c[4]+0.0883883476483184*uz_surf_cr[0]*rho_c[4]+0.1767766952966368*pkpm_lax_r[0]*rho_c[4]-0.1530931089239486*rho_r[3]*uz_surf_rl[3]+0.1530931089239486*rho_c[3]*uz_surf_rl[3]+0.0883883476483184*rho_r[0]*uz_surf_rl[3]+0.0883883476483184*rho_c[0]*uz_surf_rl[3]-0.1530931089239486*rho_r[3]*uz_surf_cr[3]+0.1530931089239486*rho_c[3]*uz_surf_cr[3]+0.0883883476483184*rho_r[0]*uz_surf_cr[3]+0.0883883476483184*rho_c[0]*uz_surf_cr[3]+0.3061862178478971*pkpm_lax_r[3]*rho_r[3]+0.3061862178478971*pkpm_lax_r[3]*rho_c[3]-0.1767766952966368*rho_r[0]*pkpm_lax_r[3]+0.1767766952966368*rho_c[0]*pkpm_lax_r[3]+0.0883883476483184*rho_r[1]*uz_surf_rl[2]+0.0883883476483184*rho_c[1]*uz_surf_rl[2]+0.0883883476483184*rho_r[1]*uz_surf_cr[2]+0.0883883476483184*rho_c[1]*uz_surf_cr[2]+0.0883883476483184*uz_surf_rl[1]*rho_r[2]+0.0883883476483184*uz_surf_cr[1]*rho_r[2]-0.1767766952966368*pkpm_lax_r[1]*rho_r[2]+0.0883883476483184*uz_surf_rl[1]*rho_c[2]+0.0883883476483184*uz_surf_cr[1]*rho_c[2]+0.1767766952966368*pkpm_lax_r[1]*rho_c[2]-0.1767766952966368*rho_r[1]*pkpm_lax_r[2]+0.1767766952966368*rho_c[1]*pkpm_lax_r[2]; 

  avg_p_ij_x_l[0] = 0.6123724356957944*Pxz_l[3]-0.6123724356957944*Pxz_c[3]+0.3535533905932737*Pxz_l[0]+0.3535533905932737*Pxz_c[0]; 
  avg_p_ij_x_l[1] = 0.6123724356957944*Pxz_l[5]-0.6123724356957944*Pxz_c[5]+0.3535533905932737*Pxz_l[1]+0.3535533905932737*Pxz_c[1]; 
  avg_p_ij_x_l[2] = 0.6123724356957944*Pxz_l[6]-0.6123724356957944*Pxz_c[6]+0.3535533905932737*Pxz_l[2]+0.3535533905932737*Pxz_c[2]; 
  avg_p_ij_x_l[3] = 0.6123724356957944*Pxz_l[7]-0.6123724356957944*Pxz_c[7]+0.3535533905932737*Pxz_l[4]+0.3535533905932737*Pxz_c[4]; 

  avg_p_ij_x_r[0] = (-0.6123724356957944*Pxz_r[3])+0.6123724356957944*Pxz_c[3]+0.3535533905932737*Pxz_r[0]+0.3535533905932737*Pxz_c[0]; 
  avg_p_ij_x_r[1] = (-0.6123724356957944*Pxz_r[5])+0.6123724356957944*Pxz_c[5]+0.3535533905932737*Pxz_r[1]+0.3535533905932737*Pxz_c[1]; 
  avg_p_ij_x_r[2] = (-0.6123724356957944*Pxz_r[6])+0.6123724356957944*Pxz_c[6]+0.3535533905932737*Pxz_r[2]+0.3535533905932737*Pxz_c[2]; 
  avg_p_ij_x_r[3] = (-0.6123724356957944*Pxz_r[7])+0.6123724356957944*Pxz_c[7]+0.3535533905932737*Pxz_r[4]+0.3535533905932737*Pxz_c[4]; 

  avg_p_ij_y_l[0] = 0.6123724356957944*Pyz_l[3]-0.6123724356957944*Pyz_c[3]+0.3535533905932737*Pyz_l[0]+0.3535533905932737*Pyz_c[0]; 
  avg_p_ij_y_l[1] = 0.6123724356957944*Pyz_l[5]-0.6123724356957944*Pyz_c[5]+0.3535533905932737*Pyz_l[1]+0.3535533905932737*Pyz_c[1]; 
  avg_p_ij_y_l[2] = 0.6123724356957944*Pyz_l[6]-0.6123724356957944*Pyz_c[6]+0.3535533905932737*Pyz_l[2]+0.3535533905932737*Pyz_c[2]; 
  avg_p_ij_y_l[3] = 0.6123724356957944*Pyz_l[7]-0.6123724356957944*Pyz_c[7]+0.3535533905932737*Pyz_l[4]+0.3535533905932737*Pyz_c[4]; 

  avg_p_ij_y_r[0] = (-0.6123724356957944*Pyz_r[3])+0.6123724356957944*Pyz_c[3]+0.3535533905932737*Pyz_r[0]+0.3535533905932737*Pyz_c[0]; 
  avg_p_ij_y_r[1] = (-0.6123724356957944*Pyz_r[5])+0.6123724356957944*Pyz_c[5]+0.3535533905932737*Pyz_r[1]+0.3535533905932737*Pyz_c[1]; 
  avg_p_ij_y_r[2] = (-0.6123724356957944*Pyz_r[6])+0.6123724356957944*Pyz_c[6]+0.3535533905932737*Pyz_r[2]+0.3535533905932737*Pyz_c[2]; 
  avg_p_ij_y_r[3] = (-0.6123724356957944*Pyz_r[7])+0.6123724356957944*Pyz_c[7]+0.3535533905932737*Pyz_r[4]+0.3535533905932737*Pyz_c[4]; 

  avg_p_ij_z_l[0] = 0.6123724356957944*Pzz_l[3]-0.6123724356957944*Pzz_c[3]+0.3535533905932737*Pzz_l[0]+0.3535533905932737*Pzz_c[0]; 
  avg_p_ij_z_l[1] = 0.6123724356957944*Pzz_l[5]-0.6123724356957944*Pzz_c[5]+0.3535533905932737*Pzz_l[1]+0.3535533905932737*Pzz_c[1]; 
  avg_p_ij_z_l[2] = 0.6123724356957944*Pzz_l[6]-0.6123724356957944*Pzz_c[6]+0.3535533905932737*Pzz_l[2]+0.3535533905932737*Pzz_c[2]; 
  avg_p_ij_z_l[3] = 0.6123724356957944*Pzz_l[7]-0.6123724356957944*Pzz_c[7]+0.3535533905932737*Pzz_l[4]+0.3535533905932737*Pzz_c[4]; 

  avg_p_ij_z_r[0] = (-0.6123724356957944*Pzz_r[3])+0.6123724356957944*Pzz_c[3]+0.3535533905932737*Pzz_r[0]+0.3535533905932737*Pzz_c[0]; 
  avg_p_ij_z_r[1] = (-0.6123724356957944*Pzz_r[5])+0.6123724356957944*Pzz_c[5]+0.3535533905932737*Pzz_r[1]+0.3535533905932737*Pzz_c[1]; 
  avg_p_ij_z_r[2] = (-0.6123724356957944*Pzz_r[6])+0.6123724356957944*Pzz_c[6]+0.3535533905932737*Pzz_r[2]+0.3535533905932737*Pzz_c[2]; 
  avg_p_ij_z_r[3] = (-0.6123724356957944*Pzz_r[7])+0.6123724356957944*Pzz_c[7]+0.3535533905932737*Pzz_r[4]+0.3535533905932737*Pzz_c[4]; 
  ...
  q_lr[7] = ser_3x_p1_surfx3_eval_quad_node_0_r(Pyy_l) + q_lr[2]*q_lr[2]/q_lr[0]; 
  ...
  q_cl[7] = ser_3x_p1_surfx3_eval_quad_node_0_l(Pyy_c) + q_cl[2]*q_cl[2]/q_cl[0]; 
  ...
  q_cr[7] = ser_3x_p1_surfx3_eval_quad_node_0_r(Pyy_c) + q_cr[2]*q_cr[2]/q_cr[0]; 
  ...
  q_rl[7] = ser_3x_p1_surfx3_eval_quad_node_0_l(Pyy_r) + q_rl[2]*q_rl[2]/q_rl[0]; 
  q_rl[8] = ser_3x_p1_surfx3_eval_quad_node_0_l(Pyz_r) + q_rl[2]*q_rl[3]/q_rl[0]; 
  q_rl[9] = ser_3x_p1_surfx3_eval_quad_node_0_l(Pzz_r) + q_rl[3]*q_rl[3]/q_rl[0]; 
  ...
  q_lr[7] = ser_3x_p1_surfx3_eval_quad_node_1_r(Pyy_l) + q_lr[2]*q_lr[2]/q_lr[0]; 
  ...
  q_cl[7] = ser_3x_p1_surfx3_eval_quad_node_1_l(Pyy_c) + q_cl[2]*q_cl[2]/q_cl[0]; 
  ...
  q_cr[7] = ser_3x_p1_surfx3_eval_quad_node_1_r(Pyy_c) + q_cr[2]*q_cr[2]/q_cr[0]; 
  ...
  q_rl[7] = ser_3x_p1_surfx3_eval_quad_node_1_l(Pyy_r) + q_rl[2]*q_rl[2]/q_rl[0]; 
  q_rl[8] = ser_3x_p1_surfx3_eval_quad_node_1_l(Pyz_r) + q_rl[2]*q_rl[3]/q_rl[0]; 
  q_rl[9] = ser_3x_p1_surfx3_eval_quad_node_1_l(Pzz_r) + q_rl[3]*q_rl[3]/q_rl[0]; 
  ...
  q_lr[7] = ser_3x_p1_surfx3_eval_quad_node_2_r(Pyy_l) + q_lr[2]*q_lr[2]/q_lr[0]; 
  ...
  q_cl[7] = ser_3x_p1_surfx3_eval_quad_node_2_l(Pyy_c) + q_cl[2]*q_cl[2]/q_cl[0]; 
  ...
  q_cr[7] = ser_3x_p1_surfx3_eval_quad_node_2_r(Pyy_c) + q_cr[2]*q_cr[2]/q_cr[0]; 
  ...
  q_rl[7] = ser_3x_p1_surfx3_eval_quad_node_2_l(Pyy_r) + q_rl[2]*q_rl[2]/q_rl[0]; 
  q_rl[8] = ser_3x_p1_surfx3_eval_quad_node_2_l(Pyz_r) + q_rl[2]*q_rl[3]/q_rl[0]; 
  q_rl[9] = ser_3x_p1_surfx3_eval_quad_node_2_l(Pzz_r) + q_rl[3]*q_rl[3]/q_rl[0]; 
  ...
  q_lr[7] = ser_3x_p1_surfx3_eval_quad_node_3_r(Pyy_l) + q_lr[2]*q_lr[2]/q_lr[0]; 
  ...
  q_cl[7] = ser_3x_p1_surfx3_eval_quad_node_3_l(Pyy_c) + q_cl[2]*q_cl[2]/q_cl[0]; 
  ...
  q_cr[7] = ser_3x_p1_surfx3_eval_quad_node_3_r(Pyy_c) + q_cr[2]*q_cr[2]/q_cr[0]; 
  ...
  q_rl[7] = ser_3x_p1_surfx3_eval_quad_node_3_l(Pyy_r) + q_rl[2]*q_rl[2]/q_rl[0]; 
  q_rl[8] = ser_3x_p1_surfx3_eval_quad_node_3_l(Pyz_r) + q_rl[2]*q_rl[3]/q_rl[0]; 
  q_rl[9] = ser_3x_p1_surfx3_eval_quad_node_3_l(Pzz_r) + q_rl[3]*q_rl[3]/q_rl[0]; 
  ...
  outrhou1[2] += ((-0.1767766952966368*flux_rho_r[1]*uy_surf_rl[3])+0.1767766952966368*flux_rho_l[1]*uy_surf_lr[3]-0.1767766952966368*flux_rho_r[1]*uy_surf_cr[3]+0.1767766952966368*flux_rho_l[1]*uy_surf_cl[3]-0.1767766952966368*(uy_surf_rl[1]+uy_surf_cr[1])*flux_rho_r[3]+0.1767766952966368*(uy_surf_lr[1]+uy_surf_cl[1])*flux_rho_l[3]-0.1767766952966368*flux_rho_r[0]*uy_surf_rl[2]+0.1767766952966368*flux_rho_l[0]*uy_surf_lr[2]-0.1767766952966368*flux_rho_r[0]*uy_surf_cr[2]+0.1767766952966368*flux_rho_l[0]*uy_surf_cl[2]-0.1767766952966368*(uy_surf_rl[0]+uy_surf_cr[0])*flux_rho_r[2]+0.1767766952966368*(uy_surf_lr[0]+uy_surf_cl[0])*flux_rho_l[2]-0.7071067811865475*avg_p_ij_y_r[2]+0.7071067811865475*avg_p_ij_y_l[2]+0.3535533905932737*apdq_rhouy_r[2]-0.3535533905932737*(apdq_rhouy_l[2]+amdq_rhouy_r[2])+0.3535533905932737*amdq_rhouy_l[2])*dx1; 
  ...
  outrhou2[2] += ((-0.1767766952966368*flux_rho_r[1]*uz_surf_rl[3])+0.1767766952966368*flux_rho_l[1]*uz_surf_lr[3]-0.1767766952966368*flux_rho_r[1]*uz_surf_cr[3]+0.1767766952966368*flux_rho_l[1]*uz_surf_cl[3]-0.1767766952966368*(uz_surf_rl[1]+uz_surf_cr[1])*flux_rho_r[3]+0.1767766952966368*(uz_surf_lr[1]+uz_surf_cl[1])*flux_rho_l[3]-0.1767766952966368*flux_rho_r[0]*uz_surf_rl[2]+0.1767766952966368*flux_rho_l[0]*uz_surf_lr[2]-0.1767766952966368*flux_rho_r[0]*uz_surf_cr[2]+0.1767766952966368*flux_rho_l[0]*uz_surf_cl[2]-0.1767766952966368*(uz_surf_rl[0]+uz_surf_cr[0])*flux_rho_r[2]+0.1767766952966368*(uz_surf_lr[0]+uz_surf_cl[0])*flux_rho_l[2]-0.7071067811865475*avg_p_ij_z_r[2]+0.7071067811865475*avg_p_ij_z_l[2]+0.3535533905932737*apdq_rhouz_r[2]-0.3535533905932737*(apdq_rhouz_l[2]+amdq_rhouz_r[2])+0.3535533905932737*amdq_rhouz_l[2])*dx1; 
