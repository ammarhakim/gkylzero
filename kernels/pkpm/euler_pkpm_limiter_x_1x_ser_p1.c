...
{ 
  ...
  double *rhouy_l = &euler_pkpm_l[2]; 
  double *rhouz_l = &euler_pkpm_l[4]; 

  double *rhoux_c = &euler_pkpm_c[0]; 
  double *rhouy_c = &euler_pkpm_c[2]; 
  double *rhouz_c = &euler_pkpm_c[4]; 

  double *rhoux_r = &euler_pkpm_r[0]; 
  double *rhouy_r = &euler_pkpm_r[2]; 
  double *rhouz_r = &euler_pkpm_r[4]; 
  ...
  delta_c[2] = rhouy_c[1]; 
  delta_c[3] = rhouz_c[1]; 
  delta_c[4] = 0.7071067811865475*rhoux_c[0]*ux_c[1]+0.7071067811865475*ux_c[0]*rhoux_c[1]+Pxx_c[1]; 
  delta_c[5] = 0.7071067811865475*rhoux_c[0]*uy_c[1]+0.7071067811865475*uy_c[0]*rhoux_c[1]+Pxy_c[1]; 
  delta_c[6] = 0.7071067811865475*rhoux_c[0]*uz_c[1]+0.7071067811865475*uz_c[0]*rhoux_c[1]+Pxz_c[1]; 
  delta_c[7] = 0.7071067811865475*rhouy_c[0]*uy_c[1]+0.7071067811865475*uy_c[0]*rhouy_c[1]+Pyy_c[1]; 
  delta_c[8] = 0.7071067811865475*rhouy_c[0]*uz_c[1]+0.7071067811865475*uz_c[0]*rhouy_c[1]+Pyz_c[1]; 
  delta_c[9] = 0.7071067811865475*rhouz_c[0]*uz_c[1]+0.7071067811865475*uz_c[0]*rhouz_c[1]+Pzz_c[1]; 
