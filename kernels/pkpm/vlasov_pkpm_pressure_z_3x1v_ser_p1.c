...
GKYL_CU_DH void vlasov_pkpm_pressure_z_3x1v_ser_p1(const double *w, const double *dxv, 
...
{ 
  ...
  out_pressure[1] += dx1*volFact*((Ghat_F_0_r[1]-1.0*Ghat_F_0_l[1])*wvpar+(0.2886751345948129*Ghat_F_0_r[5]-0.2886751345948129*Ghat_F_0_l[5])*dvpar); 
  out_pressure[2] += dx1*volFact*((Ghat_F_0_r[2]-1.0*Ghat_F_0_l[2])*wvpar+(0.2886751345948129*Ghat_F_0_r[6]-0.2886751345948129*Ghat_F_0_l[6])*dvpar); 
  out_pressure[3] += dx1*volFact*((1.732050807568877*(Ghat_F_0_r[0]+Ghat_F_0_l[0])-0.6123724356957944*(F_0c[15]*alpha_c[15]+F_0c[14]*alpha_c[14]+F_0c[13]*alpha_c[13]+F_0c[12]*alpha_c[12]+F_0c[11]*alpha_c[11]+F_0c[10]*alpha_c[10]+F_0c[9]*alpha_c[9]+F_0c[8]*alpha_c[8]+F_0c[7]*alpha_c[7]+F_0c[6]*alpha_c[6]+F_0c[5]*alpha_c[5]+F_0c[4]*alpha_c[4]+F_0c[3]*alpha_c[3]+F_0c[2]*alpha_c[2]+F_0c[1]*alpha_c[1]+F_0c[0]*alpha_c[0]))*wvpar+((-0.1581138830084189*alpha_c[15]*F_0c[23])-0.1581138830084189*(alpha_c[14]*F_0c[22]+alpha_c[13]*F_0c[21]+alpha_c[12]*F_0c[20])-0.1581138830084189*(alpha_c[10]*F_0c[19]+alpha_c[9]*F_0c[18]+alpha_c[8]*F_0c[17])-0.1581138830084189*alpha_c[4]*F_0c[16]-0.1767766952966368*(F_0c[11]*alpha_c[15]+alpha_c[11]*F_0c[15]+F_0c[7]*alpha_c[14]+alpha_c[7]*F_0c[14]+F_0c[6]*alpha_c[13]+alpha_c[6]*F_0c[13]+F_0c[5]*alpha_c[12]+alpha_c[5]*F_0c[12]+F_0c[3]*alpha_c[10]+alpha_c[3]*F_0c[10]+F_0c[2]*alpha_c[9]+alpha_c[2]*F_0c[9]+F_0c[1]*alpha_c[8]+alpha_c[1]*F_0c[8]+F_0c[0]*alpha_c[4]+alpha_c[0]*F_0c[4])+0.5*(Ghat_F_0_r[3]+Ghat_F_0_l[3]))*dvpar); 
  out_pressure[4] += dx1*volFact*((Ghat_F_0_r[4]-1.0*Ghat_F_0_l[4])*wvpar+(0.2886751345948129*Ghat_F_0_r[7]-0.2886751345948129*Ghat_F_0_l[7])*dvpar); 
  out_pressure[5] += dx1*volFact*(((-0.6123724356957944*(F_0c[14]*alpha_c[15]+alpha_c[14]*F_0c[15]+F_0c[10]*alpha_c[13]+alpha_c[10]*F_0c[13]+F_0c[9]*alpha_c[12]+alpha_c[9]*F_0c[12]+F_0c[7]*alpha_c[11]+alpha_c[7]*F_0c[11]+F_0c[4]*alpha_c[8]+alpha_c[4]*F_0c[8]+F_0c[3]*alpha_c[6]+alpha_c[3]*F_0c[6]+F_0c[2]*alpha_c[5]+alpha_c[2]*F_0c[5]+F_0c[0]*alpha_c[1]))+1.732050807568877*(Ghat_F_0_r[1]+Ghat_F_0_l[1])-0.6123724356957944*alpha_c[0]*F_0c[1])*wvpar+((-0.1581138830084189*alpha_c[14]*F_0c[23])-0.1581138830084189*(alpha_c[15]*F_0c[22]+alpha_c[10]*F_0c[21]+alpha_c[9]*F_0c[20])-0.1581138830084189*(alpha_c[13]*F_0c[19]+alpha_c[12]*F_0c[18]+alpha_c[4]*F_0c[17])-0.1581138830084189*alpha_c[8]*F_0c[16]-0.1767766952966368*(F_0c[7]*alpha_c[15]+alpha_c[7]*F_0c[15]+F_0c[11]*alpha_c[14]+alpha_c[11]*F_0c[14]+F_0c[3]*alpha_c[13]+alpha_c[3]*F_0c[13]+F_0c[2]*alpha_c[12]+alpha_c[2]*F_0c[12]+F_0c[6]*alpha_c[10]+alpha_c[6]*F_0c[10]+F_0c[5]*alpha_c[9]+alpha_c[5]*F_0c[9]+F_0c[0]*alpha_c[8]+alpha_c[0]*F_0c[8])+0.5*(Ghat_F_0_r[5]+Ghat_F_0_l[5])-0.1767766952966368*(F_0c[1]*alpha_c[4]+alpha_c[1]*F_0c[4]))*dvpar); 
  out_pressure[6] += dx1*volFact*(((-0.6123724356957944*(F_0c[13]*alpha_c[15]+alpha_c[13]*F_0c[15]+F_0c[10]*alpha_c[14]+alpha_c[10]*F_0c[14]+F_0c[8]*alpha_c[12]+alpha_c[8]*F_0c[12]+F_0c[6]*alpha_c[11]+alpha_c[6]*F_0c[11]+F_0c[4]*alpha_c[9]+alpha_c[4]*F_0c[9]+F_0c[3]*alpha_c[7]+alpha_c[3]*F_0c[7]+F_0c[1]*alpha_c[5]+alpha_c[1]*F_0c[5]+F_0c[0]*alpha_c[2]))+1.732050807568877*(Ghat_F_0_r[2]+Ghat_F_0_l[2])-0.6123724356957944*alpha_c[0]*F_0c[2])*wvpar+((-0.1581138830084189*alpha_c[13]*F_0c[23])-0.1581138830084189*(alpha_c[10]*F_0c[22]+alpha_c[15]*F_0c[21]+alpha_c[8]*F_0c[20])-0.1581138830084189*(alpha_c[14]*F_0c[19]+alpha_c[4]*F_0c[18]+alpha_c[12]*F_0c[17])-0.1581138830084189*alpha_c[9]*F_0c[16]-0.1767766952966368*(F_0c[6]*alpha_c[15]+alpha_c[6]*F_0c[15]+F_0c[3]*alpha_c[14]+alpha_c[3]*F_0c[14]+F_0c[11]*alpha_c[13]+alpha_c[11]*F_0c[13]+F_0c[1]*alpha_c[12]+alpha_c[1]*F_0c[12]+F_0c[7]*alpha_c[10]+alpha_c[7]*F_0c[10]+F_0c[0]*alpha_c[9]+alpha_c[0]*F_0c[9]+F_0c[5]*alpha_c[8]+alpha_c[5]*F_0c[8])+0.5*(Ghat_F_0_r[6]+Ghat_F_0_l[6])-0.1767766952966368*(F_0c[2]*alpha_c[4]+alpha_c[2]*F_0c[4]))*dvpar); 
  out_pressure[7] += dx1*volFact*(((-0.6123724356957944*(F_0c[10]*alpha_c[15]+alpha_c[10]*F_0c[15]+F_0c[13]*alpha_c[14]+alpha_c[13]*F_0c[14]+F_0c[4]*alpha_c[12]+alpha_c[4]*F_0c[12]+F_0c[3]*alpha_c[11]+alpha_c[3]*F_0c[11]+F_0c[8]*alpha_c[9]+alpha_c[8]*F_0c[9]+F_0c[6]*alpha_c[7]+alpha_c[6]*F_0c[7]+F_0c[0]*alpha_c[5]+alpha_c[0]*F_0c[5]))+1.732050807568877*(Ghat_F_0_r[4]+Ghat_F_0_l[4])-0.6123724356957944*(F_0c[1]*alpha_c[2]+alpha_c[1]*F_0c[2]))*wvpar+((-0.1581138830084189*alpha_c[10]*F_0c[23])-0.1581138830084189*(alpha_c[13]*F_0c[22]+alpha_c[14]*F_0c[21]+alpha_c[4]*F_0c[20])-0.1581138830084189*(alpha_c[15]*F_0c[19]+alpha_c[8]*F_0c[18]+alpha_c[9]*F_0c[17])-0.1581138830084189*alpha_c[12]*F_0c[16]-0.1767766952966368*(F_0c[3]*alpha_c[15]+alpha_c[3]*F_0c[15]+F_0c[6]*alpha_c[14]+alpha_c[6]*F_0c[14]+F_0c[7]*alpha_c[13]+alpha_c[7]*F_0c[13]+F_0c[0]*alpha_c[12]+alpha_c[0]*F_0c[12]+F_0c[10]*alpha_c[11]+alpha_c[10]*F_0c[11]+F_0c[1]*alpha_c[9]+alpha_c[1]*F_0c[9]+F_0c[2]*alpha_c[8]+alpha_c[2]*F_0c[8])+0.5*(Ghat_F_0_r[7]+Ghat_F_0_l[7])-0.1767766952966368*(F_0c[4]*alpha_c[5]+alpha_c[4]*F_0c[5]))*dvpar); 
