...
{ 
  ...
  delta_c[2] = rhouy_c[1]; 
  delta_c[3] = rhouz_c[1]; 
  delta_c[4] = 0.6210590034081186*rhoux_c[2]*ux_c[3]+0.6210590034081186*ux_c[2]*rhoux_c[3]+0.6324555320336759*rhoux_c[1]*ux_c[2]+0.6324555320336759*ux_c[1]*rhoux_c[2]+0.7071067811865475*rhoux_c[0]*ux_c[1]+0.7071067811865475*ux_c[0]*rhoux_c[1]+Pxx_c[1]; 
  delta_c[5] = 0.6210590034081186*rhoux_c[2]*uy_c[3]+0.6210590034081186*uy_c[2]*rhoux_c[3]+0.6324555320336759*rhoux_c[1]*uy_c[2]+0.6324555320336759*uy_c[1]*rhoux_c[2]+0.7071067811865475*rhoux_c[0]*uy_c[1]+0.7071067811865475*uy_c[0]*rhoux_c[1]+Pxy_c[1]; 
  delta_c[6] = 0.6210590034081186*rhoux_c[2]*uz_c[3]+0.6210590034081186*uz_c[2]*rhoux_c[3]+0.6324555320336759*rhoux_c[1]*uz_c[2]+0.6324555320336759*uz_c[1]*rhoux_c[2]+0.7071067811865475*rhoux_c[0]*uz_c[1]+0.7071067811865475*uz_c[0]*rhoux_c[1]+Pxz_c[1]; 
  delta_c[7] = 0.6210590034081186*rhouy_c[2]*uy_c[3]+0.6210590034081186*uy_c[2]*rhouy_c[3]+0.6324555320336759*rhouy_c[1]*uy_c[2]+0.6324555320336759*uy_c[1]*rhouy_c[2]+0.7071067811865475*rhouy_c[0]*uy_c[1]+0.7071067811865475*uy_c[0]*rhouy_c[1]+Pyy_c[1]; 
  delta_c[8] = 0.6210590034081186*rhouy_c[2]*uz_c[3]+0.6210590034081186*uz_c[2]*rhouy_c[3]+0.6324555320336759*rhouy_c[1]*uz_c[2]+0.6324555320336759*uz_c[1]*rhouy_c[2]+0.7071067811865475*rhouy_c[0]*uz_c[1]+0.7071067811865475*uz_c[0]*rhouy_c[1]+Pyz_c[1]; 
  delta_c[9] = 0.6210590034081186*rhouz_c[2]*uz_c[3]+0.6210590034081186*uz_c[2]*rhouz_c[3]+0.6324555320336759*rhouz_c[1]*uz_c[2]+0.6324555320336759*uz_c[1]*rhouz_c[2]+0.7071067811865475*rhouz_c[0]*uz_c[1]+0.7071067811865475*uz_c[0]*rhouz_c[1]+Pzz_c[1]; 
