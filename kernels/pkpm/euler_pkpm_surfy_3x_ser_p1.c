...
{ 
  ...
  const double *u_l = &priml[8]; 
  const double *u_c = &primc[8]; 
  const double *u_r = &primr[8]; 
  ...
  const double *vth_sql = &priml[32]; 
  const double *vth_sqc = &primc[32]; 
  const double *vth_sqr = &primr[32]; 
  ...
  flux_rho_l[0] = 0.1875*rho_l[7]*u_l[7]-0.1875*rho_c[7]*u_l[7]+0.1082531754730548*rho_l[5]*u_l[7]+0.1082531754730548*rho_c[5]*u_l[7]-0.1875*rho_l[7]*u_c[7]+0.1875*rho_c[7]*u_c[7]-0.1082531754730548*rho_l[5]*u_c[7]-0.1082531754730548*rho_c[5]*u_c[7]+0.1082531754730548*u_l[5]*rho_l[7]+0.1082531754730548*u_c[5]*rho_l[7]-0.1082531754730548*u_l[5]*rho_c[7]-0.1082531754730548*u_c[5]*rho_c[7]+0.1875*rho_l[6]*u_l[6]-0.1875*rho_c[6]*u_l[6]+0.1082531754730548*rho_l[3]*u_l[6]+0.1082531754730548*rho_c[3]*u_l[6]-0.1875*rho_l[6]*u_c[6]+0.1875*rho_c[6]*u_c[6]-0.1082531754730548*rho_l[3]*u_c[6]-0.1082531754730548*rho_c[3]*u_c[6]+0.1082531754730548*u_l[3]*rho_l[6]+0.1082531754730548*u_c[3]*rho_l[6]-0.1082531754730548*u_l[3]*rho_c[6]-0.1082531754730548*u_c[3]*rho_c[6]+0.0625*rho_l[5]*u_l[5]+0.0625*rho_c[5]*u_l[5]+0.0625*rho_l[5]*u_c[5]+0.0625*rho_c[5]*u_c[5]+0.1875*rho_l[4]*u_l[4]-0.1875*rho_c[4]*u_l[4]+0.1082531754730548*rho_l[1]*u_l[4]+0.1082531754730548*rho_c[1]*u_l[4]-0.1875*rho_l[4]*u_c[4]+0.1875*rho_c[4]*u_c[4]-0.1082531754730548*rho_l[1]*u_c[4]-0.1082531754730548*rho_c[1]*u_c[4]+0.1082531754730548*u_l[1]*rho_l[4]+0.1082531754730548*u_c[1]*rho_l[4]-0.1082531754730548*u_l[1]*rho_c[4]-0.1082531754730548*u_c[1]*rho_c[4]+0.0625*rho_l[3]*u_l[3]+0.0625*rho_c[3]*u_l[3]+0.0625*rho_l[3]*u_c[3]+0.0625*rho_c[3]*u_c[3]+0.1875*rho_l[2]*u_l[2]-0.1875*rho_c[2]*u_l[2]+0.1082531754730548*rho_l[0]*u_l[2]+0.1082531754730548*rho_c[0]*u_l[2]-0.1875*rho_l[2]*u_c[2]+0.1875*rho_c[2]*u_c[2]-0.1082531754730548*rho_l[0]*u_c[2]-0.1082531754730548*rho_c[0]*u_c[2]+0.1082531754730548*u_l[0]*rho_l[2]+0.1082531754730548*u_c[0]*rho_l[2]-0.1082531754730548*u_l[0]*rho_c[2]-0.1082531754730548*u_c[0]*rho_c[2]+0.0625*rho_l[1]*u_l[1]+0.0625*rho_c[1]*u_l[1]+0.0625*rho_l[1]*u_c[1]+0.0625*rho_c[1]*u_c[1]+0.0625*rho_l[0]*u_l[0]+0.0625*rho_c[0]*u_l[0]+0.0625*rho_l[0]*u_c[0]+0.0625*rho_c[0]*u_c[0]; 
  flux_rho_l[1] = 0.1875*rho_l[6]*u_l[7]-0.1875*rho_c[6]*u_l[7]+0.1082531754730548*rho_l[3]*u_l[7]+0.1082531754730548*rho_c[3]*u_l[7]-0.1875*rho_l[6]*u_c[7]+0.1875*rho_c[6]*u_c[7]-0.1082531754730548*rho_l[3]*u_c[7]-0.1082531754730548*rho_c[3]*u_c[7]+0.1875*u_l[6]*rho_l[7]-0.1875*u_c[6]*rho_l[7]+0.1082531754730548*u_l[3]*rho_l[7]+0.1082531754730548*u_c[3]*rho_l[7]-0.1875*u_l[6]*rho_c[7]+0.1875*u_c[6]*rho_c[7]-0.1082531754730548*u_l[3]*rho_c[7]-0.1082531754730548*u_c[3]*rho_c[7]+0.1082531754730548*rho_l[5]*u_l[6]+0.1082531754730548*rho_c[5]*u_l[6]-0.1082531754730548*rho_l[5]*u_c[6]-0.1082531754730548*rho_c[5]*u_c[6]+0.1082531754730548*u_l[5]*rho_l[6]+0.1082531754730548*u_c[5]*rho_l[6]-0.1082531754730548*u_l[5]*rho_c[6]-0.1082531754730548*u_c[5]*rho_c[6]+0.0625*rho_l[3]*u_l[5]+0.0625*rho_c[3]*u_l[5]+0.0625*rho_l[3]*u_c[5]+0.0625*rho_c[3]*u_c[5]+0.0625*u_l[3]*rho_l[5]+0.0625*u_c[3]*rho_l[5]+0.0625*u_l[3]*rho_c[5]+0.0625*u_c[3]*rho_c[5]+0.1875*rho_l[2]*u_l[4]-0.1875*rho_c[2]*u_l[4]+0.1082531754730548*rho_l[0]*u_l[4]+0.1082531754730548*rho_c[0]*u_l[4]-0.1875*rho_l[2]*u_c[4]+0.1875*rho_c[2]*u_c[4]-0.1082531754730548*rho_l[0]*u_c[4]-0.1082531754730548*rho_c[0]*u_c[4]+0.1875*u_l[2]*rho_l[4]-0.1875*u_c[2]*rho_l[4]+0.1082531754730548*u_l[0]*rho_l[4]+0.1082531754730548*u_c[0]*rho_l[4]-0.1875*u_l[2]*rho_c[4]+0.1875*u_c[2]*rho_c[4]-0.1082531754730548*u_l[0]*rho_c[4]-0.1082531754730548*u_c[0]*rho_c[4]+0.1082531754730548*rho_l[1]*u_l[2]+0.1082531754730548*rho_c[1]*u_l[2]-0.1082531754730548*rho_l[1]*u_c[2]-0.1082531754730548*rho_c[1]*u_c[2]+0.1082531754730548*u_l[1]*rho_l[2]+0.1082531754730548*u_c[1]*rho_l[2]-0.1082531754730548*u_l[1]*rho_c[2]-0.1082531754730548*u_c[1]*rho_c[2]+0.0625*rho_l[0]*u_l[1]+0.0625*rho_c[0]*u_l[1]+0.0625*rho_l[0]*u_c[1]+0.0625*rho_c[0]*u_c[1]+0.0625*u_l[0]*rho_l[1]+0.0625*u_c[0]*rho_l[1]+0.0625*u_l[0]*rho_c[1]+0.0625*u_c[0]*rho_c[1]; 
  flux_rho_l[2] = 0.1875*rho_l[4]*u_l[7]-0.1875*rho_c[4]*u_l[7]+0.1082531754730548*rho_l[1]*u_l[7]+0.1082531754730548*rho_c[1]*u_l[7]-0.1875*rho_l[4]*u_c[7]+0.1875*rho_c[4]*u_c[7]-0.1082531754730548*rho_l[1]*u_c[7]-0.1082531754730548*rho_c[1]*u_c[7]+0.1875*u_l[4]*rho_l[7]-0.1875*u_c[4]*rho_l[7]+0.1082531754730548*u_l[1]*rho_l[7]+0.1082531754730548*u_c[1]*rho_l[7]-0.1875*u_l[4]*rho_c[7]+0.1875*u_c[4]*rho_c[7]-0.1082531754730548*u_l[1]*rho_c[7]-0.1082531754730548*u_c[1]*rho_c[7]+0.1875*rho_l[2]*u_l[6]-0.1875*rho_c[2]*u_l[6]+0.1082531754730548*rho_l[0]*u_l[6]+0.1082531754730548*rho_c[0]*u_l[6]-0.1875*rho_l[2]*u_c[6]+0.1875*rho_c[2]*u_c[6]-0.1082531754730548*rho_l[0]*u_c[6]-0.1082531754730548*rho_c[0]*u_c[6]+0.1875*u_l[2]*rho_l[6]-0.1875*u_c[2]*rho_l[6]+0.1082531754730548*u_l[0]*rho_l[6]+0.1082531754730548*u_c[0]*rho_l[6]-0.1875*u_l[2]*rho_c[6]+0.1875*u_c[2]*rho_c[6]-0.1082531754730548*u_l[0]*rho_c[6]-0.1082531754730548*u_c[0]*rho_c[6]+0.1082531754730548*rho_l[4]*u_l[5]-0.1082531754730548*rho_c[4]*u_l[5]+0.0625*rho_l[1]*u_l[5]+0.0625*rho_c[1]*u_l[5]+0.1082531754730548*rho_l[4]*u_c[5]-0.1082531754730548*rho_c[4]*u_c[5]+0.0625*rho_l[1]*u_c[5]+0.0625*rho_c[1]*u_c[5]+0.1082531754730548*u_l[4]*rho_l[5]-0.1082531754730548*u_c[4]*rho_l[5]+0.0625*u_l[1]*rho_l[5]+0.0625*u_c[1]*rho_l[5]+0.1082531754730548*u_l[4]*rho_c[5]-0.1082531754730548*u_c[4]*rho_c[5]+0.0625*u_l[1]*rho_c[5]+0.0625*u_c[1]*rho_c[5]+0.1082531754730548*rho_l[2]*u_l[3]-0.1082531754730548*rho_c[2]*u_l[3]+0.0625*rho_l[0]*u_l[3]+0.0625*rho_c[0]*u_l[3]+0.1082531754730548*rho_l[2]*u_c[3]-0.1082531754730548*rho_c[2]*u_c[3]+0.0625*rho_l[0]*u_c[3]+0.0625*rho_c[0]*u_c[3]+0.1082531754730548*u_l[2]*rho_l[3]-0.1082531754730548*u_c[2]*rho_l[3]+0.0625*u_l[0]*rho_l[3]+0.0625*u_c[0]*rho_l[3]+0.1082531754730548*u_l[2]*rho_c[3]-0.1082531754730548*u_c[2]*rho_c[3]+0.0625*u_l[0]*rho_c[3]+0.0625*u_c[0]*rho_c[3]; 
  flux_rho_l[3] = 0.1875*rho_l[2]*u_l[7]-0.1875*rho_c[2]*u_l[7]+0.1082531754730548*rho_l[0]*u_l[7]+0.1082531754730548*rho_c[0]*u_l[7]-0.1875*rho_l[2]*u_c[7]+0.1875*rho_c[2]*u_c[7]-0.1082531754730548*rho_l[0]*u_c[7]-0.1082531754730548*rho_c[0]*u_c[7]+0.1875*u_l[2]*rho_l[7]-0.1875*u_c[2]*rho_l[7]+0.1082531754730548*u_l[0]*rho_l[7]+0.1082531754730548*u_c[0]*rho_l[7]-0.1875*u_l[2]*rho_c[7]+0.1875*u_c[2]*rho_c[7]-0.1082531754730548*u_l[0]*rho_c[7]-0.1082531754730548*u_c[0]*rho_c[7]+0.1875*rho_l[4]*u_l[6]-0.1875*rho_c[4]*u_l[6]+0.1082531754730548*rho_l[1]*u_l[6]+0.1082531754730548*rho_c[1]*u_l[6]-0.1875*rho_l[4]*u_c[6]+0.1875*rho_c[4]*u_c[6]-0.1082531754730548*rho_l[1]*u_c[6]-0.1082531754730548*rho_c[1]*u_c[6]+0.1875*u_l[4]*rho_l[6]-0.1875*u_c[4]*rho_l[6]+0.1082531754730548*u_l[1]*rho_l[6]+0.1082531754730548*u_c[1]*rho_l[6]-0.1875*u_l[4]*rho_c[6]+0.1875*u_c[4]*rho_c[6]-0.1082531754730548*u_l[1]*rho_c[6]-0.1082531754730548*u_c[1]*rho_c[6]+0.1082531754730548*rho_l[2]*u_l[5]-0.1082531754730548*rho_c[2]*u_l[5]+0.0625*rho_l[0]*u_l[5]+0.0625*rho_c[0]*u_l[5]+0.1082531754730548*rho_l[2]*u_c[5]-0.1082531754730548*rho_c[2]*u_c[5]+0.0625*rho_l[0]*u_c[5]+0.0625*rho_c[0]*u_c[5]+0.1082531754730548*u_l[2]*rho_l[5]-0.1082531754730548*u_c[2]*rho_l[5]+0.0625*u_l[0]*rho_l[5]+0.0625*u_c[0]*rho_l[5]+0.1082531754730548*u_l[2]*rho_c[5]-0.1082531754730548*u_c[2]*rho_c[5]+0.0625*u_l[0]*rho_c[5]+0.0625*u_c[0]*rho_c[5]+0.1082531754730548*rho_l[3]*u_l[4]+0.1082531754730548*rho_c[3]*u_l[4]-0.1082531754730548*rho_l[3]*u_c[4]-0.1082531754730548*rho_c[3]*u_c[4]+0.1082531754730548*u_l[3]*rho_l[4]+0.1082531754730548*u_c[3]*rho_l[4]-0.1082531754730548*u_l[3]*rho_c[4]-0.1082531754730548*u_c[3]*rho_c[4]+0.0625*rho_l[1]*u_l[3]+0.0625*rho_c[1]*u_l[3]+0.0625*rho_l[1]*u_c[3]+0.0625*rho_c[1]*u_c[3]+0.0625*u_l[1]*rho_l[3]+0.0625*u_c[1]*rho_l[3]+0.0625*u_l[1]*rho_c[3]+0.0625*u_c[1]*rho_c[3]; 

  flux_rho_r[0] = 0.1875*rho_r[7]*u_r[7]-0.1875*rho_c[7]*u_r[7]-0.1082531754730548*rho_r[5]*u_r[7]-0.1082531754730548*rho_c[5]*u_r[7]-0.1875*rho_r[7]*u_c[7]+0.1875*rho_c[7]*u_c[7]+0.1082531754730548*rho_r[5]*u_c[7]+0.1082531754730548*rho_c[5]*u_c[7]-0.1082531754730548*u_r[5]*rho_r[7]-0.1082531754730548*u_c[5]*rho_r[7]+0.1082531754730548*u_r[5]*rho_c[7]+0.1082531754730548*u_c[5]*rho_c[7]+0.1875*rho_r[6]*u_r[6]-0.1875*rho_c[6]*u_r[6]-0.1082531754730548*rho_r[3]*u_r[6]-0.1082531754730548*rho_c[3]*u_r[6]-0.1875*rho_r[6]*u_c[6]+0.1875*rho_c[6]*u_c[6]+0.1082531754730548*rho_r[3]*u_c[6]+0.1082531754730548*rho_c[3]*u_c[6]-0.1082531754730548*u_r[3]*rho_r[6]-0.1082531754730548*u_c[3]*rho_r[6]+0.1082531754730548*u_r[3]*rho_c[6]+0.1082531754730548*u_c[3]*rho_c[6]+0.0625*rho_r[5]*u_r[5]+0.0625*rho_c[5]*u_r[5]+0.0625*rho_r[5]*u_c[5]+0.0625*rho_c[5]*u_c[5]+0.1875*rho_r[4]*u_r[4]-0.1875*rho_c[4]*u_r[4]-0.1082531754730548*rho_r[1]*u_r[4]-0.1082531754730548*rho_c[1]*u_r[4]-0.1875*rho_r[4]*u_c[4]+0.1875*rho_c[4]*u_c[4]+0.1082531754730548*rho_r[1]*u_c[4]+0.1082531754730548*rho_c[1]*u_c[4]-0.1082531754730548*u_r[1]*rho_r[4]-0.1082531754730548*u_c[1]*rho_r[4]+0.1082531754730548*u_r[1]*rho_c[4]+0.1082531754730548*u_c[1]*rho_c[4]+0.0625*rho_r[3]*u_r[3]+0.0625*rho_c[3]*u_r[3]+0.0625*rho_r[3]*u_c[3]+0.0625*rho_c[3]*u_c[3]+0.1875*rho_r[2]*u_r[2]-0.1875*rho_c[2]*u_r[2]-0.1082531754730548*rho_r[0]*u_r[2]-0.1082531754730548*rho_c[0]*u_r[2]-0.1875*rho_r[2]*u_c[2]+0.1875*rho_c[2]*u_c[2]+0.1082531754730548*rho_r[0]*u_c[2]+0.1082531754730548*rho_c[0]*u_c[2]-0.1082531754730548*u_r[0]*rho_r[2]-0.1082531754730548*u_c[0]*rho_r[2]+0.1082531754730548*u_r[0]*rho_c[2]+0.1082531754730548*u_c[0]*rho_c[2]+0.0625*rho_r[1]*u_r[1]+0.0625*rho_c[1]*u_r[1]+0.0625*rho_r[1]*u_c[1]+0.0625*rho_c[1]*u_c[1]+0.0625*rho_r[0]*u_r[0]+0.0625*rho_c[0]*u_r[0]+0.0625*rho_r[0]*u_c[0]+0.0625*rho_c[0]*u_c[0]; 
  flux_rho_r[1] = 0.1875*rho_r[6]*u_r[7]-0.1875*rho_c[6]*u_r[7]-0.1082531754730548*rho_r[3]*u_r[7]-0.1082531754730548*rho_c[3]*u_r[7]-0.1875*rho_r[6]*u_c[7]+0.1875*rho_c[6]*u_c[7]+0.1082531754730548*rho_r[3]*u_c[7]+0.1082531754730548*rho_c[3]*u_c[7]+0.1875*u_r[6]*rho_r[7]-0.1875*u_c[6]*rho_r[7]-0.1082531754730548*u_r[3]*rho_r[7]-0.1082531754730548*u_c[3]*rho_r[7]-0.1875*u_r[6]*rho_c[7]+0.1875*u_c[6]*rho_c[7]+0.1082531754730548*u_r[3]*rho_c[7]+0.1082531754730548*u_c[3]*rho_c[7]-0.1082531754730548*rho_r[5]*u_r[6]-0.1082531754730548*rho_c[5]*u_r[6]+0.1082531754730548*rho_r[5]*u_c[6]+0.1082531754730548*rho_c[5]*u_c[6]-0.1082531754730548*u_r[5]*rho_r[6]-0.1082531754730548*u_c[5]*rho_r[6]+0.1082531754730548*u_r[5]*rho_c[6]+0.1082531754730548*u_c[5]*rho_c[6]+0.0625*rho_r[3]*u_r[5]+0.0625*rho_c[3]*u_r[5]+0.0625*rho_r[3]*u_c[5]+0.0625*rho_c[3]*u_c[5]+0.0625*u_r[3]*rho_r[5]+0.0625*u_c[3]*rho_r[5]+0.0625*u_r[3]*rho_c[5]+0.0625*u_c[3]*rho_c[5]+0.1875*rho_r[2]*u_r[4]-0.1875*rho_c[2]*u_r[4]-0.1082531754730548*rho_r[0]*u_r[4]-0.1082531754730548*rho_c[0]*u_r[4]-0.1875*rho_r[2]*u_c[4]+0.1875*rho_c[2]*u_c[4]+0.1082531754730548*rho_r[0]*u_c[4]+0.1082531754730548*rho_c[0]*u_c[4]+0.1875*u_r[2]*rho_r[4]-0.1875*u_c[2]*rho_r[4]-0.1082531754730548*u_r[0]*rho_r[4]-0.1082531754730548*u_c[0]*rho_r[4]-0.1875*u_r[2]*rho_c[4]+0.1875*u_c[2]*rho_c[4]+0.1082531754730548*u_r[0]*rho_c[4]+0.1082531754730548*u_c[0]*rho_c[4]-0.1082531754730548*rho_r[1]*u_r[2]-0.1082531754730548*rho_c[1]*u_r[2]+0.1082531754730548*rho_r[1]*u_c[2]+0.1082531754730548*rho_c[1]*u_c[2]-0.1082531754730548*u_r[1]*rho_r[2]-0.1082531754730548*u_c[1]*rho_r[2]+0.1082531754730548*u_r[1]*rho_c[2]+0.1082531754730548*u_c[1]*rho_c[2]+0.0625*rho_r[0]*u_r[1]+0.0625*rho_c[0]*u_r[1]+0.0625*rho_r[0]*u_c[1]+0.0625*rho_c[0]*u_c[1]+0.0625*u_r[0]*rho_r[1]+0.0625*u_c[0]*rho_r[1]+0.0625*u_r[0]*rho_c[1]+0.0625*u_c[0]*rho_c[1]; 
  flux_rho_r[2] = 0.1875*rho_r[4]*u_r[7]-0.1875*rho_c[4]*u_r[7]-0.1082531754730548*rho_r[1]*u_r[7]-0.1082531754730548*rho_c[1]*u_r[7]-0.1875*rho_r[4]*u_c[7]+0.1875*rho_c[4]*u_c[7]+0.1082531754730548*rho_r[1]*u_c[7]+0.1082531754730548*rho_c[1]*u_c[7]+0.1875*u_r[4]*rho_r[7]-0.1875*u_c[4]*rho_r[7]-0.1082531754730548*u_r[1]*rho_r[7]-0.1082531754730548*u_c[1]*rho_r[7]-0.1875*u_r[4]*rho_c[7]+0.1875*u_c[4]*rho_c[7]+0.1082531754730548*u_r[1]*rho_c[7]+0.1082531754730548*u_c[1]*rho_c[7]+0.1875*rho_r[2]*u_r[6]-0.1875*rho_c[2]*u_r[6]-0.1082531754730548*rho_r[0]*u_r[6]-0.1082531754730548*rho_c[0]*u_r[6]-0.1875*rho_r[2]*u_c[6]+0.1875*rho_c[2]*u_c[6]+0.1082531754730548*rho_r[0]*u_c[6]+0.1082531754730548*rho_c[0]*u_c[6]+0.1875*u_r[2]*rho_r[6]-0.1875*u_c[2]*rho_r[6]-0.1082531754730548*u_r[0]*rho_r[6]-0.1082531754730548*u_c[0]*rho_r[6]-0.1875*u_r[2]*rho_c[6]+0.1875*u_c[2]*rho_c[6]+0.1082531754730548*u_r[0]*rho_c[6]+0.1082531754730548*u_c[0]*rho_c[6]-0.1082531754730548*rho_r[4]*u_r[5]+0.1082531754730548*rho_c[4]*u_r[5]+0.0625*rho_r[1]*u_r[5]+0.0625*rho_c[1]*u_r[5]-0.1082531754730548*rho_r[4]*u_c[5]+0.1082531754730548*rho_c[4]*u_c[5]+0.0625*rho_r[1]*u_c[5]+0.0625*rho_c[1]*u_c[5]-0.1082531754730548*u_r[4]*rho_r[5]+0.1082531754730548*u_c[4]*rho_r[5]+0.0625*u_r[1]*rho_r[5]+0.0625*u_c[1]*rho_r[5]-0.1082531754730548*u_r[4]*rho_c[5]+0.1082531754730548*u_c[4]*rho_c[5]+0.0625*u_r[1]*rho_c[5]+0.0625*u_c[1]*rho_c[5]-0.1082531754730548*rho_r[2]*u_r[3]+0.1082531754730548*rho_c[2]*u_r[3]+0.0625*rho_r[0]*u_r[3]+0.0625*rho_c[0]*u_r[3]-0.1082531754730548*rho_r[2]*u_c[3]+0.1082531754730548*rho_c[2]*u_c[3]+0.0625*rho_r[0]*u_c[3]+0.0625*rho_c[0]*u_c[3]-0.1082531754730548*u_r[2]*rho_r[3]+0.1082531754730548*u_c[2]*rho_r[3]+0.0625*u_r[0]*rho_r[3]+0.0625*u_c[0]*rho_r[3]-0.1082531754730548*u_r[2]*rho_c[3]+0.1082531754730548*u_c[2]*rho_c[3]+0.0625*u_r[0]*rho_c[3]+0.0625*u_c[0]*rho_c[3]; 
  flux_rho_r[3] = 0.1875*rho_r[2]*u_r[7]-0.1875*rho_c[2]*u_r[7]-0.1082531754730548*rho_r[0]*u_r[7]-0.1082531754730548*rho_c[0]*u_r[7]-0.1875*rho_r[2]*u_c[7]+0.1875*rho_c[2]*u_c[7]+0.1082531754730548*rho_r[0]*u_c[7]+0.1082531754730548*rho_c[0]*u_c[7]+0.1875*u_r[2]*rho_r[7]-0.1875*u_c[2]*rho_r[7]-0.1082531754730548*u_r[0]*rho_r[7]-0.1082531754730548*u_c[0]*rho_r[7]-0.1875*u_r[2]*rho_c[7]+0.1875*u_c[2]*rho_c[7]+0.1082531754730548*u_r[0]*rho_c[7]+0.1082531754730548*u_c[0]*rho_c[7]+0.1875*rho_r[4]*u_r[6]-0.1875*rho_c[4]*u_r[6]-0.1082531754730548*rho_r[1]*u_r[6]-0.1082531754730548*rho_c[1]*u_r[6]-0.1875*rho_r[4]*u_c[6]+0.1875*rho_c[4]*u_c[6]+0.1082531754730548*rho_r[1]*u_c[6]+0.1082531754730548*rho_c[1]*u_c[6]+0.1875*u_r[4]*rho_r[6]-0.1875*u_c[4]*rho_r[6]-0.1082531754730548*u_r[1]*rho_r[6]-0.1082531754730548*u_c[1]*rho_r[6]-0.1875*u_r[4]*rho_c[6]+0.1875*u_c[4]*rho_c[6]+0.1082531754730548*u_r[1]*rho_c[6]+0.1082531754730548*u_c[1]*rho_c[6]-0.1082531754730548*rho_r[2]*u_r[5]+0.1082531754730548*rho_c[2]*u_r[5]+0.0625*rho_r[0]*u_r[5]+0.0625*rho_c[0]*u_r[5]-0.1082531754730548*rho_r[2]*u_c[5]+0.1082531754730548*rho_c[2]*u_c[5]+0.0625*rho_r[0]*u_c[5]+0.0625*rho_c[0]*u_c[5]-0.1082531754730548*u_r[2]*rho_r[5]+0.1082531754730548*u_c[2]*rho_r[5]+0.0625*u_r[0]*rho_r[5]+0.0625*u_c[0]*rho_r[5]-0.1082531754730548*u_r[2]*rho_c[5]+0.1082531754730548*u_c[2]*rho_c[5]+0.0625*u_r[0]*rho_c[5]+0.0625*u_c[0]*rho_c[5]-0.1082531754730548*rho_r[3]*u_r[4]-0.1082531754730548*rho_c[3]*u_r[4]+0.1082531754730548*rho_r[3]*u_c[4]+0.1082531754730548*rho_c[3]*u_c[4]-0.1082531754730548*u_r[3]*rho_r[4]-0.1082531754730548*u_c[3]*rho_r[4]+0.1082531754730548*u_r[3]*rho_c[4]+0.1082531754730548*u_c[3]*rho_c[4]+0.0625*rho_r[1]*u_r[3]+0.0625*rho_c[1]*u_r[3]+0.0625*rho_r[1]*u_c[3]+0.0625*rho_c[1]*u_c[3]+0.0625*u_r[1]*rho_r[3]+0.0625*u_c[1]*rho_r[3]+0.0625*u_r[1]*rho_c[3]+0.0625*u_c[1]*rho_c[3]; 

  avg_ux_l[0] = 0.6123724356957944*ux_l[2]-0.6123724356957944*ux_c[2]+0.3535533905932737*ux_l[0]+0.3535533905932737*ux_c[0]; 
  avg_ux_l[1] = 0.6123724356957944*ux_l[4]-0.6123724356957944*ux_c[4]+0.3535533905932737*ux_l[1]+0.3535533905932737*ux_c[1]; 
  avg_ux_l[2] = 0.6123724356957944*ux_l[6]-0.6123724356957944*ux_c[6]+0.3535533905932737*ux_l[3]+0.3535533905932737*ux_c[3]; 
  avg_ux_l[3] = 0.6123724356957944*ux_l[7]-0.6123724356957944*ux_c[7]+0.3535533905932737*ux_l[5]+0.3535533905932737*ux_c[5]; 

  avg_ux_r[0] = (-0.6123724356957944*ux_r[2])+0.6123724356957944*ux_c[2]+0.3535533905932737*ux_r[0]+0.3535533905932737*ux_c[0]; 
  avg_ux_r[1] = (-0.6123724356957944*ux_r[4])+0.6123724356957944*ux_c[4]+0.3535533905932737*ux_r[1]+0.3535533905932737*ux_c[1]; 
  avg_ux_r[2] = (-0.6123724356957944*ux_r[6])+0.6123724356957944*ux_c[6]+0.3535533905932737*ux_r[3]+0.3535533905932737*ux_c[3]; 
  avg_ux_r[3] = (-0.6123724356957944*ux_r[7])+0.6123724356957944*ux_c[7]+0.3535533905932737*ux_r[5]+0.3535533905932737*ux_c[5]; 

  avg_uy_l[0] = 0.6123724356957944*uy_l[2]-0.6123724356957944*uy_c[2]+0.3535533905932737*uy_l[0]+0.3535533905932737*uy_c[0]; 
  avg_uy_l[1] = 0.6123724356957944*uy_l[4]-0.6123724356957944*uy_c[4]+0.3535533905932737*uy_l[1]+0.3535533905932737*uy_c[1]; 
  avg_uy_l[2] = 0.6123724356957944*uy_l[6]-0.6123724356957944*uy_c[6]+0.3535533905932737*uy_l[3]+0.3535533905932737*uy_c[3]; 
  avg_uy_l[3] = 0.6123724356957944*uy_l[7]-0.6123724356957944*uy_c[7]+0.3535533905932737*uy_l[5]+0.3535533905932737*uy_c[5]; 

  avg_uy_r[0] = (-0.6123724356957944*uy_r[2])+0.6123724356957944*uy_c[2]+0.3535533905932737*uy_r[0]+0.3535533905932737*uy_c[0]; 
  avg_uy_r[1] = (-0.6123724356957944*uy_r[4])+0.6123724356957944*uy_c[4]+0.3535533905932737*uy_r[1]+0.3535533905932737*uy_c[1]; 
  avg_uy_r[2] = (-0.6123724356957944*uy_r[6])+0.6123724356957944*uy_c[6]+0.3535533905932737*uy_r[3]+0.3535533905932737*uy_c[3]; 
  avg_uy_r[3] = (-0.6123724356957944*uy_r[7])+0.6123724356957944*uy_c[7]+0.3535533905932737*uy_r[5]+0.3535533905932737*uy_c[5]; 

  avg_uz_l[0] = 0.6123724356957944*uz_l[2]-0.6123724356957944*uz_c[2]+0.3535533905932737*uz_l[0]+0.3535533905932737*uz_c[0]; 
  avg_uz_l[1] = 0.6123724356957944*uz_l[4]-0.6123724356957944*uz_c[4]+0.3535533905932737*uz_l[1]+0.3535533905932737*uz_c[1]; 
  avg_uz_l[2] = 0.6123724356957944*uz_l[6]-0.6123724356957944*uz_c[6]+0.3535533905932737*uz_l[3]+0.3535533905932737*uz_c[3]; 
  avg_uz_l[3] = 0.6123724356957944*uz_l[7]-0.6123724356957944*uz_c[7]+0.3535533905932737*uz_l[5]+0.3535533905932737*uz_c[5]; 

  avg_uz_r[0] = (-0.6123724356957944*uz_r[2])+0.6123724356957944*uz_c[2]+0.3535533905932737*uz_r[0]+0.3535533905932737*uz_c[0]; 
  avg_uz_r[1] = (-0.6123724356957944*uz_r[4])+0.6123724356957944*uz_c[4]+0.3535533905932737*uz_r[1]+0.3535533905932737*uz_c[1]; 
  avg_uz_r[2] = (-0.6123724356957944*uz_r[6])+0.6123724356957944*uz_c[6]+0.3535533905932737*uz_r[3]+0.3535533905932737*uz_c[3]; 
  avg_uz_r[3] = (-0.6123724356957944*uz_r[7])+0.6123724356957944*uz_c[7]+0.3535533905932737*uz_r[5]+0.3535533905932737*uz_c[5]; 
  ...
  jump_rhoux_l[1] = (-0.6123724356957944*rhoux_l[4])-0.6123724356957944*rhoux_c[4]-0.3535533905932737*rhoux_l[1]+0.3535533905932737*rhoux_c[1]; 
  jump_rhoux_l[2] = (-0.6123724356957944*rhoux_l[6])-0.6123724356957944*rhoux_c[6]-0.3535533905932737*rhoux_l[3]+0.3535533905932737*rhoux_c[3]; 
  jump_rhoux_l[3] = (-0.6123724356957944*rhoux_l[7])-0.6123724356957944*rhoux_c[7]-0.3535533905932737*rhoux_l[5]+0.3535533905932737*rhoux_c[5]; 
  ...
  jump_rhoux_r[1] = (-0.6123724356957944*rhoux_r[4])-0.6123724356957944*rhoux_c[4]+0.3535533905932737*rhoux_r[1]-0.3535533905932737*rhoux_c[1]; 
  jump_rhoux_r[2] = (-0.6123724356957944*rhoux_r[6])-0.6123724356957944*rhoux_c[6]+0.3535533905932737*rhoux_r[3]-0.3535533905932737*rhoux_c[3]; 
  jump_rhoux_r[3] = (-0.6123724356957944*rhoux_r[7])-0.6123724356957944*rhoux_c[7]+0.3535533905932737*rhoux_r[5]-0.3535533905932737*rhoux_c[5]; 
  ...
  jump_rhouy_l[1] = (-0.6123724356957944*rhouy_l[4])-0.6123724356957944*rhouy_c[4]-0.3535533905932737*rhouy_l[1]+0.3535533905932737*rhouy_c[1]; 
  jump_rhouy_l[2] = (-0.6123724356957944*rhouy_l[6])-0.6123724356957944*rhouy_c[6]-0.3535533905932737*rhouy_l[3]+0.3535533905932737*rhouy_c[3]; 
  jump_rhouy_l[3] = (-0.6123724356957944*rhouy_l[7])-0.6123724356957944*rhouy_c[7]-0.3535533905932737*rhouy_l[5]+0.3535533905932737*rhouy_c[5]; 
  ...
  jump_rhouy_r[1] = (-0.6123724356957944*rhouy_r[4])-0.6123724356957944*rhouy_c[4]+0.3535533905932737*rhouy_r[1]-0.3535533905932737*rhouy_c[1]; 
  jump_rhouy_r[2] = (-0.6123724356957944*rhouy_r[6])-0.6123724356957944*rhouy_c[6]+0.3535533905932737*rhouy_r[3]-0.3535533905932737*rhouy_c[3]; 
  jump_rhouy_r[3] = (-0.6123724356957944*rhouy_r[7])-0.6123724356957944*rhouy_c[7]+0.3535533905932737*rhouy_r[5]-0.3535533905932737*rhouy_c[5]; 
  ...
  jump_rhouz_l[1] = (-0.6123724356957944*rhouz_l[4])-0.6123724356957944*rhouz_c[4]-0.3535533905932737*rhouz_l[1]+0.3535533905932737*rhouz_c[1]; 
  jump_rhouz_l[2] = (-0.6123724356957944*rhouz_l[6])-0.6123724356957944*rhouz_c[6]-0.3535533905932737*rhouz_l[3]+0.3535533905932737*rhouz_c[3]; 
  jump_rhouz_l[3] = (-0.6123724356957944*rhouz_l[7])-0.6123724356957944*rhouz_c[7]-0.3535533905932737*rhouz_l[5]+0.3535533905932737*rhouz_c[5]; 
  ...
  jump_rhouz_r[1] = (-0.6123724356957944*rhouz_r[4])-0.6123724356957944*rhouz_c[4]+0.3535533905932737*rhouz_r[1]-0.3535533905932737*rhouz_c[1]; 
  jump_rhouz_r[2] = (-0.6123724356957944*rhouz_r[6])-0.6123724356957944*rhouz_c[6]+0.3535533905932737*rhouz_r[3]-0.3535533905932737*rhouz_c[3]; 
  jump_rhouz_r[3] = (-0.6123724356957944*rhouz_r[7])-0.6123724356957944*rhouz_c[7]+0.3535533905932737*rhouz_r[5]-0.3535533905932737*rhouz_c[5]; 
  ...
  ul_r = ser_3x_p1_surfx2_eval_quad_node_0_r(u_l); 
  uc_l = ser_3x_p1_surfx2_eval_quad_node_0_l(u_c); 
  uc_r = ser_3x_p1_surfx2_eval_quad_node_0_r(u_c); 
  ur_l = ser_3x_p1_surfx2_eval_quad_node_0_l(u_r); 
  ...
  ul_r = ser_3x_p1_surfx2_eval_quad_node_1_r(u_l); 
  uc_l = ser_3x_p1_surfx2_eval_quad_node_1_l(u_c); 
  uc_r = ser_3x_p1_surfx2_eval_quad_node_1_r(u_c); 
  ur_l = ser_3x_p1_surfx2_eval_quad_node_1_l(u_r); 
  uQuad_l = fmax(fabs(ul_r), fabs(uc_l)); 
  uQuad_r = fmax(fabs(uc_r), fabs(ur_l)); 
  ...
  ul_r = ser_3x_p1_surfx2_eval_quad_node_2_r(u_l); 
  uc_l = ser_3x_p1_surfx2_eval_quad_node_2_l(u_c); 
  uc_r = ser_3x_p1_surfx2_eval_quad_node_2_r(u_c); 
  ur_l = ser_3x_p1_surfx2_eval_quad_node_2_l(u_r); 
  uQuad_l = fmax(fabs(ul_r), fabs(uc_l)); 
  uQuad_r = fmax(fabs(uc_r), fabs(ur_l)); 
  ...
  ul_r = ser_3x_p1_surfx2_eval_quad_node_3_r(u_l); 
  uc_l = ser_3x_p1_surfx2_eval_quad_node_3_l(u_c); 
  uc_r = ser_3x_p1_surfx2_eval_quad_node_3_r(u_c); 
  ur_l = ser_3x_p1_surfx2_eval_quad_node_3_l(u_r); 
  uQuad_l = fmax(fabs(ul_r), fabs(uc_l)); 
  uQuad_r = fmax(fabs(uc_r), fabs(ur_l)); 
