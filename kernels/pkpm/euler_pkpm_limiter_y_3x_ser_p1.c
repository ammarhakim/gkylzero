...
{ 
  ...
  delta_c[2] = rhouy_c[2]; 
  delta_c[3] = rhouz_c[2]; 
  delta_c[4] = 0.3535533905932737*rhoux_c[5]*ux_c[7]+0.3535533905932737*ux_c[5]*rhoux_c[7]+0.3535533905932737*rhoux_c[3]*ux_c[6]+0.3535533905932737*ux_c[3]*rhoux_c[6]+0.3535533905932737*rhoux_c[1]*ux_c[4]+0.3535533905932737*ux_c[1]*rhoux_c[4]+0.3535533905932737*rhoux_c[0]*ux_c[2]+0.3535533905932737*ux_c[0]*rhoux_c[2]+Pxx_c[2]; 
  delta_c[5] = 0.3535533905932737*rhoux_c[5]*uy_c[7]+0.3535533905932737*uy_c[5]*rhoux_c[7]+0.3535533905932737*rhoux_c[3]*uy_c[6]+0.3535533905932737*uy_c[3]*rhoux_c[6]+0.3535533905932737*rhoux_c[1]*uy_c[4]+0.3535533905932737*uy_c[1]*rhoux_c[4]+0.3535533905932737*rhoux_c[0]*uy_c[2]+0.3535533905932737*uy_c[0]*rhoux_c[2]+Pxy_c[2]; 
  delta_c[6] = 0.3535533905932737*rhoux_c[5]*uz_c[7]+0.3535533905932737*uz_c[5]*rhoux_c[7]+0.3535533905932737*rhoux_c[3]*uz_c[6]+0.3535533905932737*uz_c[3]*rhoux_c[6]+0.3535533905932737*rhoux_c[1]*uz_c[4]+0.3535533905932737*uz_c[1]*rhoux_c[4]+0.3535533905932737*rhoux_c[0]*uz_c[2]+0.3535533905932737*uz_c[0]*rhoux_c[2]+Pxz_c[2]; 
  delta_c[7] = 0.3535533905932737*rhouy_c[5]*uy_c[7]+0.3535533905932737*uy_c[5]*rhouy_c[7]+0.3535533905932737*rhouy_c[3]*uy_c[6]+0.3535533905932737*uy_c[3]*rhouy_c[6]+0.3535533905932737*rhouy_c[1]*uy_c[4]+0.3535533905932737*uy_c[1]*rhouy_c[4]+0.3535533905932737*rhouy_c[0]*uy_c[2]+0.3535533905932737*uy_c[0]*rhouy_c[2]+Pyy_c[2]; 
  delta_c[8] = 0.3535533905932737*rhouy_c[5]*uz_c[7]+0.3535533905932737*uz_c[5]*rhouy_c[7]+0.3535533905932737*rhouy_c[3]*uz_c[6]+0.3535533905932737*uz_c[3]*rhouy_c[6]+0.3535533905932737*rhouy_c[1]*uz_c[4]+0.3535533905932737*uz_c[1]*rhouy_c[4]+0.3535533905932737*rhouy_c[0]*uz_c[2]+0.3535533905932737*uz_c[0]*rhouy_c[2]+Pyz_c[2]; 
  delta_c[9] = 0.3535533905932737*rhouz_c[5]*uz_c[7]+0.3535533905932737*uz_c[5]*rhouz_c[7]+0.3535533905932737*rhouz_c[3]*uz_c[6]+0.3535533905932737*uz_c[3]*rhouz_c[6]+0.3535533905932737*rhouz_c[1]*uz_c[4]+0.3535533905932737*uz_c[1]*rhouz_c[4]+0.3535533905932737*rhouz_c[0]*uz_c[2]+0.3535533905932737*uz_c[0]*rhouz_c[2]+Pzz_c[2]; 
