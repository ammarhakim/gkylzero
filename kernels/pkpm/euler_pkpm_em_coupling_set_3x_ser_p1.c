...
{ 
  ...
  for (int s = 0; s < num_species; ++s) { 
    ...
    gkyl_mat_set(&lhs, 0 + num_species*(24), 7 + s*(24), 0.5*dt*qbym[s]*(0.3535533905932737*rho[s][7])); 
    gkyl_mat_set(&lhs, 8 + num_species*(24), 15 + s*(24), 0.5*dt*qbym[s]*(0.3535533905932737*rho[s][7])); 
    gkyl_mat_set(&lhs, 16 + num_species*(24), 23 + s*(24), 0.5*dt*qbym[s]*(0.3535533905932737*rho[s][7])); 
    ...
    gkyl_mat_set(&lhs, 1 + num_species*(24), 1 + s*(24), 0.5*dt*qbym[s]*(0.3535533905932737*rho[s][0])); 
    gkyl_mat_set(&lhs, 9 + num_species*(24), 9 + s*(24), 0.5*dt*qbym[s]*(0.3535533905932737*rho[s][0])); 
    gkyl_mat_set(&lhs, 17 + num_species*(24), 17 + s*(24), 0.5*dt*qbym[s]*(0.3535533905932737*rho[s][0])); 
    ...
    gkyl_mat_set(&lhs, 1 + num_species*(24), 4 + s*(24), 0.5*dt*qbym[s]*(0.3535533905932737*rho[s][2])); 
    gkyl_mat_set(&lhs, 9 + num_species*(24), 12 + s*(24), 0.5*dt*qbym[s]*(0.3535533905932737*rho[s][2])); 
    gkyl_mat_set(&lhs, 17 + num_species*(24), 20 + s*(24), 0.5*dt*qbym[s]*(0.3535533905932737*rho[s][2])); 
    ...
    gkyl_mat_set(&lhs, 1 + num_species*(24), 5 + s*(24), 0.5*dt*qbym[s]*(0.3535533905932737*rho[s][3])); 
    gkyl_mat_set(&lhs, 9 + num_species*(24), 13 + s*(24), 0.5*dt*qbym[s]*(0.3535533905932737*rho[s][3])); 
    gkyl_mat_set(&lhs, 17 + num_species*(24), 21 + s*(24), 0.5*dt*qbym[s]*(0.3535533905932737*rho[s][3])); 
    ...
    gkyl_mat_set(&lhs, 1 + num_species*(24), 6 + s*(24), 0.5*dt*qbym[s]*(0.3535533905932737*rho[s][7])); 
    gkyl_mat_set(&lhs, 9 + num_species*(24), 14 + s*(24), 0.5*dt*qbym[s]*(0.3535533905932737*rho[s][7])); 
    gkyl_mat_set(&lhs, 17 + num_species*(24), 22 + s*(24), 0.5*dt*qbym[s]*(0.3535533905932737*rho[s][7])); 
    ...
    gkyl_mat_set(&lhs, 1 + num_species*(24), 7 + s*(24), 0.5*dt*qbym[s]*(0.3535533905932737*rho[s][6])); 
    gkyl_mat_set(&lhs, 9 + num_species*(24), 15 + s*(24), 0.5*dt*qbym[s]*(0.3535533905932737*rho[s][6])); 
    gkyl_mat_set(&lhs, 17 + num_species*(24), 23 + s*(24), 0.5*dt*qbym[s]*(0.3535533905932737*rho[s][6])); 
    ...
    gkyl_mat_set(&lhs, 2 + num_species*(24), 2 + s*(24), 0.5*dt*qbym[s]*(0.3535533905932737*rho[s][0])); 
    gkyl_mat_set(&lhs, 10 + num_species*(24), 10 + s*(24), 0.5*dt*qbym[s]*(0.3535533905932737*rho[s][0])); 
    gkyl_mat_set(&lhs, 18 + num_species*(24), 18 + s*(24), 0.5*dt*qbym[s]*(0.3535533905932737*rho[s][0])); 
    ...
    gkyl_mat_set(&lhs, 2 + num_species*(24), 4 + s*(24), 0.5*dt*qbym[s]*(0.3535533905932737*rho[s][1])); 
    gkyl_mat_set(&lhs, 10 + num_species*(24), 12 + s*(24), 0.5*dt*qbym[s]*(0.3535533905932737*rho[s][1])); 
    gkyl_mat_set(&lhs, 18 + num_species*(24), 20 + s*(24), 0.5*dt*qbym[s]*(0.3535533905932737*rho[s][1])); 
    ...
    gkyl_mat_set(&lhs, 2 + num_species*(24), 5 + s*(24), 0.5*dt*qbym[s]*(0.3535533905932737*rho[s][7])); 
    gkyl_mat_set(&lhs, 10 + num_species*(24), 13 + s*(24), 0.5*dt*qbym[s]*(0.3535533905932737*rho[s][7])); 
    gkyl_mat_set(&lhs, 18 + num_species*(24), 21 + s*(24), 0.5*dt*qbym[s]*(0.3535533905932737*rho[s][7])); 
    ...
    gkyl_mat_set(&lhs, 2 + num_species*(24), 6 + s*(24), 0.5*dt*qbym[s]*(0.3535533905932737*rho[s][3])); 
    gkyl_mat_set(&lhs, 10 + num_species*(24), 14 + s*(24), 0.5*dt*qbym[s]*(0.3535533905932737*rho[s][3])); 
    gkyl_mat_set(&lhs, 18 + num_species*(24), 22 + s*(24), 0.5*dt*qbym[s]*(0.3535533905932737*rho[s][3])); 
    ...
    gkyl_mat_set(&lhs, 2 + num_species*(24), 7 + s*(24), 0.5*dt*qbym[s]*(0.3535533905932737*rho[s][5])); 
    gkyl_mat_set(&lhs, 10 + num_species*(24), 15 + s*(24), 0.5*dt*qbym[s]*(0.3535533905932737*rho[s][5])); 
    gkyl_mat_set(&lhs, 18 + num_species*(24), 23 + s*(24), 0.5*dt*qbym[s]*(0.3535533905932737*rho[s][5])); 
    ...
    gkyl_mat_set(&lhs, 3 + num_species*(24), 3 + s*(24), 0.5*dt*qbym[s]*(0.3535533905932737*rho[s][0])); 
    gkyl_mat_set(&lhs, 11 + num_species*(24), 11 + s*(24), 0.5*dt*qbym[s]*(0.3535533905932737*rho[s][0])); 
    gkyl_mat_set(&lhs, 19 + num_species*(24), 19 + s*(24), 0.5*dt*qbym[s]*(0.3535533905932737*rho[s][0])); 
    ...
    gkyl_mat_set(&lhs, 3 + num_species*(24), 4 + s*(24), 0.5*dt*qbym[s]*(0.3535533905932737*rho[s][7])); 
    gkyl_mat_set(&lhs, 11 + num_species*(24), 12 + s*(24), 0.5*dt*qbym[s]*(0.3535533905932737*rho[s][7])); 
    gkyl_mat_set(&lhs, 19 + num_species*(24), 20 + s*(24), 0.5*dt*qbym[s]*(0.3535533905932737*rho[s][7])); 
    ...
    gkyl_mat_set(&lhs, 3 + num_species*(24), 5 + s*(24), 0.5*dt*qbym[s]*(0.3535533905932737*rho[s][1])); 
    gkyl_mat_set(&lhs, 11 + num_species*(24), 13 + s*(24), 0.5*dt*qbym[s]*(0.3535533905932737*rho[s][1])); 
    gkyl_mat_set(&lhs, 19 + num_species*(24), 21 + s*(24), 0.5*dt*qbym[s]*(0.3535533905932737*rho[s][1])); 
    ...
    gkyl_mat_set(&lhs, 3 + num_species*(24), 6 + s*(24), 0.5*dt*qbym[s]*(0.3535533905932737*rho[s][2])); 
    gkyl_mat_set(&lhs, 11 + num_species*(24), 14 + s*(24), 0.5*dt*qbym[s]*(0.3535533905932737*rho[s][2])); 
    gkyl_mat_set(&lhs, 19 + num_species*(24), 22 + s*(24), 0.5*dt*qbym[s]*(0.3535533905932737*rho[s][2])); 
    ...
    gkyl_mat_set(&lhs, 3 + num_species*(24), 7 + s*(24), 0.5*dt*qbym[s]*(0.3535533905932737*rho[s][4])); 
    gkyl_mat_set(&lhs, 11 + num_species*(24), 15 + s*(24), 0.5*dt*qbym[s]*(0.3535533905932737*rho[s][4])); 
    gkyl_mat_set(&lhs, 19 + num_species*(24), 23 + s*(24), 0.5*dt*qbym[s]*(0.3535533905932737*rho[s][4])); 
    ...
    gkyl_mat_set(&lhs, 4 + num_species*(24), 1 + s*(24), 0.5*dt*qbym[s]*(0.3535533905932737*rho[s][2])); 
    gkyl_mat_set(&lhs, 12 + num_species*(24), 9 + s*(24), 0.5*dt*qbym[s]*(0.3535533905932737*rho[s][2])); 
    gkyl_mat_set(&lhs, 20 + num_species*(24), 17 + s*(24), 0.5*dt*qbym[s]*(0.3535533905932737*rho[s][2])); 
    ...
    gkyl_mat_set(&lhs, 4 + num_species*(24), 2 + s*(24), 0.5*dt*qbym[s]*(0.3535533905932737*rho[s][1])); 
    gkyl_mat_set(&lhs, 12 + num_species*(24), 10 + s*(24), 0.5*dt*qbym[s]*(0.3535533905932737*rho[s][1])); 
    gkyl_mat_set(&lhs, 20 + num_species*(24), 18 + s*(24), 0.5*dt*qbym[s]*(0.3535533905932737*rho[s][1])); 
    ...
    gkyl_mat_set(&lhs, 4 + num_species*(24), 3 + s*(24), 0.5*dt*qbym[s]*(0.3535533905932737*rho[s][7])); 
    gkyl_mat_set(&lhs, 12 + num_species*(24), 11 + s*(24), 0.5*dt*qbym[s]*(0.3535533905932737*rho[s][7])); 
    gkyl_mat_set(&lhs, 20 + num_species*(24), 19 + s*(24), 0.5*dt*qbym[s]*(0.3535533905932737*rho[s][7])); 
    ...
    gkyl_mat_set(&lhs, 4 + num_species*(24), 4 + s*(24), 0.5*dt*qbym[s]*(0.3535533905932737*rho[s][0])); 
    gkyl_mat_set(&lhs, 12 + num_species*(24), 12 + s*(24), 0.5*dt*qbym[s]*(0.3535533905932737*rho[s][0])); 
    gkyl_mat_set(&lhs, 20 + num_species*(24), 20 + s*(24), 0.5*dt*qbym[s]*(0.3535533905932737*rho[s][0])); 
    ...
    gkyl_mat_set(&lhs, 4 + num_species*(24), 5 + s*(24), 0.5*dt*qbym[s]*(0.3535533905932737*rho[s][6])); 
    gkyl_mat_set(&lhs, 12 + num_species*(24), 13 + s*(24), 0.5*dt*qbym[s]*(0.3535533905932737*rho[s][6])); 
    gkyl_mat_set(&lhs, 20 + num_species*(24), 21 + s*(24), 0.5*dt*qbym[s]*(0.3535533905932737*rho[s][6])); 
    ...
    gkyl_mat_set(&lhs, 4 + num_species*(24), 6 + s*(24), 0.5*dt*qbym[s]*(0.3535533905932737*rho[s][5])); 
    gkyl_mat_set(&lhs, 12 + num_species*(24), 14 + s*(24), 0.5*dt*qbym[s]*(0.3535533905932737*rho[s][5])); 
    gkyl_mat_set(&lhs, 20 + num_species*(24), 22 + s*(24), 0.5*dt*qbym[s]*(0.3535533905932737*rho[s][5])); 
    ...
    gkyl_mat_set(&lhs, 4 + num_species*(24), 7 + s*(24), 0.5*dt*qbym[s]*(0.3535533905932737*rho[s][3])); 
    gkyl_mat_set(&lhs, 12 + num_species*(24), 15 + s*(24), 0.5*dt*qbym[s]*(0.3535533905932737*rho[s][3])); 
    gkyl_mat_set(&lhs, 20 + num_species*(24), 23 + s*(24), 0.5*dt*qbym[s]*(0.3535533905932737*rho[s][3])); 
    ...
    gkyl_mat_set(&lhs, 5 + num_species*(24), 1 + s*(24), 0.5*dt*qbym[s]*(0.3535533905932737*rho[s][3])); 
    gkyl_mat_set(&lhs, 13 + num_species*(24), 9 + s*(24), 0.5*dt*qbym[s]*(0.3535533905932737*rho[s][3])); 
    gkyl_mat_set(&lhs, 21 + num_species*(24), 17 + s*(24), 0.5*dt*qbym[s]*(0.3535533905932737*rho[s][3])); 
    ...
    gkyl_mat_set(&lhs, 5 + num_species*(24), 2 + s*(24), 0.5*dt*qbym[s]*(0.3535533905932737*rho[s][7])); 
    gkyl_mat_set(&lhs, 13 + num_species*(24), 10 + s*(24), 0.5*dt*qbym[s]*(0.3535533905932737*rho[s][7])); 
    gkyl_mat_set(&lhs, 21 + num_species*(24), 18 + s*(24), 0.5*dt*qbym[s]*(0.3535533905932737*rho[s][7])); 
    ...
    gkyl_mat_set(&lhs, 5 + num_species*(24), 3 + s*(24), 0.5*dt*qbym[s]*(0.3535533905932737*rho[s][1])); 
    gkyl_mat_set(&lhs, 13 + num_species*(24), 11 + s*(24), 0.5*dt*qbym[s]*(0.3535533905932737*rho[s][1])); 
    gkyl_mat_set(&lhs, 21 + num_species*(24), 19 + s*(24), 0.5*dt*qbym[s]*(0.3535533905932737*rho[s][1])); 
    ...
    gkyl_mat_set(&lhs, 5 + num_species*(24), 4 + s*(24), 0.5*dt*qbym[s]*(0.3535533905932737*rho[s][6])); 
    gkyl_mat_set(&lhs, 13 + num_species*(24), 12 + s*(24), 0.5*dt*qbym[s]*(0.3535533905932737*rho[s][6])); 
    gkyl_mat_set(&lhs, 21 + num_species*(24), 20 + s*(24), 0.5*dt*qbym[s]*(0.3535533905932737*rho[s][6])); 
    ...
    gkyl_mat_set(&lhs, 5 + num_species*(24), 5 + s*(24), 0.5*dt*qbym[s]*(0.3535533905932737*rho[s][0])); 
    gkyl_mat_set(&lhs, 13 + num_species*(24), 13 + s*(24), 0.5*dt*qbym[s]*(0.3535533905932737*rho[s][0])); 
    gkyl_mat_set(&lhs, 21 + num_species*(24), 21 + s*(24), 0.5*dt*qbym[s]*(0.3535533905932737*rho[s][0])); 
    ...
    gkyl_mat_set(&lhs, 5 + num_species*(24), 6 + s*(24), 0.5*dt*qbym[s]*(0.3535533905932737*rho[s][4])); 
    gkyl_mat_set(&lhs, 13 + num_species*(24), 14 + s*(24), 0.5*dt*qbym[s]*(0.3535533905932737*rho[s][4])); 
    gkyl_mat_set(&lhs, 21 + num_species*(24), 22 + s*(24), 0.5*dt*qbym[s]*(0.3535533905932737*rho[s][4])); 
    ...
    gkyl_mat_set(&lhs, 5 + num_species*(24), 7 + s*(24), 0.5*dt*qbym[s]*(0.3535533905932737*rho[s][2])); 
    gkyl_mat_set(&lhs, 13 + num_species*(24), 15 + s*(24), 0.5*dt*qbym[s]*(0.3535533905932737*rho[s][2])); 
    gkyl_mat_set(&lhs, 21 + num_species*(24), 23 + s*(24), 0.5*dt*qbym[s]*(0.3535533905932737*rho[s][2])); 
    ...
    gkyl_mat_set(&lhs, 6 + num_species*(24), 1 + s*(24), 0.5*dt*qbym[s]*(0.3535533905932737*rho[s][7])); 
    gkyl_mat_set(&lhs, 14 + num_species*(24), 9 + s*(24), 0.5*dt*qbym[s]*(0.3535533905932737*rho[s][7])); 
    gkyl_mat_set(&lhs, 22 + num_species*(24), 17 + s*(24), 0.5*dt*qbym[s]*(0.3535533905932737*rho[s][7])); 
    ...
    gkyl_mat_set(&lhs, 6 + num_species*(24), 2 + s*(24), 0.5*dt*qbym[s]*(0.3535533905932737*rho[s][3])); 
    gkyl_mat_set(&lhs, 14 + num_species*(24), 10 + s*(24), 0.5*dt*qbym[s]*(0.3535533905932737*rho[s][3])); 
    gkyl_mat_set(&lhs, 22 + num_species*(24), 18 + s*(24), 0.5*dt*qbym[s]*(0.3535533905932737*rho[s][3])); 
    ...
    gkyl_mat_set(&lhs, 6 + num_species*(24), 3 + s*(24), 0.5*dt*qbym[s]*(0.3535533905932737*rho[s][2])); 
    gkyl_mat_set(&lhs, 14 + num_species*(24), 11 + s*(24), 0.5*dt*qbym[s]*(0.3535533905932737*rho[s][2])); 
    gkyl_mat_set(&lhs, 22 + num_species*(24), 19 + s*(24), 0.5*dt*qbym[s]*(0.3535533905932737*rho[s][2])); 
    ...
    gkyl_mat_set(&lhs, 6 + num_species*(24), 4 + s*(24), 0.5*dt*qbym[s]*(0.3535533905932737*rho[s][5])); 
    gkyl_mat_set(&lhs, 14 + num_species*(24), 12 + s*(24), 0.5*dt*qbym[s]*(0.3535533905932737*rho[s][5])); 
    gkyl_mat_set(&lhs, 22 + num_species*(24), 20 + s*(24), 0.5*dt*qbym[s]*(0.3535533905932737*rho[s][5])); 
    ...
    gkyl_mat_set(&lhs, 6 + num_species*(24), 5 + s*(24), 0.5*dt*qbym[s]*(0.3535533905932737*rho[s][4])); 
    gkyl_mat_set(&lhs, 14 + num_species*(24), 13 + s*(24), 0.5*dt*qbym[s]*(0.3535533905932737*rho[s][4])); 
    gkyl_mat_set(&lhs, 22 + num_species*(24), 21 + s*(24), 0.5*dt*qbym[s]*(0.3535533905932737*rho[s][4])); 
    ...
    gkyl_mat_set(&lhs, 6 + num_species*(24), 6 + s*(24), 0.5*dt*qbym[s]*(0.3535533905932737*rho[s][0])); 
    gkyl_mat_set(&lhs, 14 + num_species*(24), 14 + s*(24), 0.5*dt*qbym[s]*(0.3535533905932737*rho[s][0])); 
    gkyl_mat_set(&lhs, 22 + num_species*(24), 22 + s*(24), 0.5*dt*qbym[s]*(0.3535533905932737*rho[s][0])); 
    ...
    gkyl_mat_set(&lhs, 6 + num_species*(24), 7 + s*(24), 0.5*dt*qbym[s]*(0.3535533905932737*rho[s][1])); 
    gkyl_mat_set(&lhs, 14 + num_species*(24), 15 + s*(24), 0.5*dt*qbym[s]*(0.3535533905932737*rho[s][1])); 
    gkyl_mat_set(&lhs, 22 + num_species*(24), 23 + s*(24), 0.5*dt*qbym[s]*(0.3535533905932737*rho[s][1])); 
    ...
    gkyl_mat_set(&lhs, 7 + num_species*(24), 0 + s*(24), 0.5*dt*qbym[s]*(0.3535533905932737*rho[s][7])); 
    gkyl_mat_set(&lhs, 15 + num_species*(24), 8 + s*(24), 0.5*dt*qbym[s]*(0.3535533905932737*rho[s][7])); 
    gkyl_mat_set(&lhs, 23 + num_species*(24), 16 + s*(24), 0.5*dt*qbym[s]*(0.3535533905932737*rho[s][7])); 
    ...
    gkyl_mat_set(&lhs, 7 + num_species*(24), 1 + s*(24), 0.5*dt*qbym[s]*(0.3535533905932737*rho[s][6])); 
    gkyl_mat_set(&lhs, 15 + num_species*(24), 9 + s*(24), 0.5*dt*qbym[s]*(0.3535533905932737*rho[s][6])); 
    gkyl_mat_set(&lhs, 23 + num_species*(24), 17 + s*(24), 0.5*dt*qbym[s]*(0.3535533905932737*rho[s][6])); 
    ...
    gkyl_mat_set(&lhs, 7 + num_species*(24), 2 + s*(24), 0.5*dt*qbym[s]*(0.3535533905932737*rho[s][5])); 
    gkyl_mat_set(&lhs, 15 + num_species*(24), 10 + s*(24), 0.5*dt*qbym[s]*(0.3535533905932737*rho[s][5])); 
    gkyl_mat_set(&lhs, 23 + num_species*(24), 18 + s*(24), 0.5*dt*qbym[s]*(0.3535533905932737*rho[s][5])); 
    ...
    gkyl_mat_set(&lhs, 7 + num_species*(24), 3 + s*(24), 0.5*dt*qbym[s]*(0.3535533905932737*rho[s][4])); 
    gkyl_mat_set(&lhs, 15 + num_species*(24), 11 + s*(24), 0.5*dt*qbym[s]*(0.3535533905932737*rho[s][4])); 
    gkyl_mat_set(&lhs, 23 + num_species*(24), 19 + s*(24), 0.5*dt*qbym[s]*(0.3535533905932737*rho[s][4])); 
    ...
    gkyl_mat_set(&lhs, 7 + num_species*(24), 4 + s*(24), 0.5*dt*qbym[s]*(0.3535533905932737*rho[s][3])); 
    gkyl_mat_set(&lhs, 15 + num_species*(24), 12 + s*(24), 0.5*dt*qbym[s]*(0.3535533905932737*rho[s][3])); 
    gkyl_mat_set(&lhs, 23 + num_species*(24), 20 + s*(24), 0.5*dt*qbym[s]*(0.3535533905932737*rho[s][3])); 
    ...
    gkyl_mat_set(&lhs, 7 + num_species*(24), 5 + s*(24), 0.5*dt*qbym[s]*(0.3535533905932737*rho[s][2])); 
    gkyl_mat_set(&lhs, 15 + num_species*(24), 13 + s*(24), 0.5*dt*qbym[s]*(0.3535533905932737*rho[s][2])); 
    gkyl_mat_set(&lhs, 23 + num_species*(24), 21 + s*(24), 0.5*dt*qbym[s]*(0.3535533905932737*rho[s][2])); 
    ...
    gkyl_mat_set(&lhs, 7 + num_species*(24), 6 + s*(24), 0.5*dt*qbym[s]*(0.3535533905932737*rho[s][1])); 
    gkyl_mat_set(&lhs, 15 + num_species*(24), 14 + s*(24), 0.5*dt*qbym[s]*(0.3535533905932737*rho[s][1])); 
    gkyl_mat_set(&lhs, 23 + num_species*(24), 22 + s*(24), 0.5*dt*qbym[s]*(0.3535533905932737*rho[s][1])); 
    ...
    gkyl_mat_set(&lhs, 7 + num_species*(24), 7 + s*(24), 0.5*dt*qbym[s]*(0.3535533905932737*rho[s][0])); 
    gkyl_mat_set(&lhs, 15 + num_species*(24), 15 + s*(24), 0.5*dt*qbym[s]*(0.3535533905932737*rho[s][0])); 
    gkyl_mat_set(&lhs, 23 + num_species*(24), 23 + s*(24), 0.5*dt*qbym[s]*(0.3535533905932737*rho[s][0])); 
