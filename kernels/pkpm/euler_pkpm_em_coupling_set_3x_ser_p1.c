...
{ 
  ...
  for (int s = 0; s < num_species; ++s) { 
    ...
    gkyl_mat_set(&rhs, 0 + s*(24), 0, qbym[s]*rhoux[s][0] + 0.5*dt*qbym[s]*qbym[s]*(0.3535533905932737*(ext_Ex[7]*rho[s][7]+ext_Ex[6]*rho[s][6]+ext_Ex[5]*rho[s][5]+ext_Ex[4]*rho[s][4]+ext_Ex[3]*rho[s][3]+ext_Ex[2]*rho[s][2]+ext_Ex[1]*rho[s][1]+ext_Ex[0]*rho[s][0])) + 0.5*dt*qbym[s]*(0.3535533905932737*(app_accel_x[s][7]*rho[s][7]+app_accel_x[s][6]*rho[s][6]+app_accel_x[s][5]*rho[s][5]+app_accel_x[s][4]*rho[s][4]+app_accel_x[s][3]*rho[s][3]+app_accel_x[s][2]*rho[s][2]+app_accel_x[s][1]*rho[s][1]+app_accel_x[s][0]*rho[s][0]))); 
    gkyl_mat_set(&rhs, 8 + s*(24), 0, qbym[s]*rhouy[s][0] + 0.5*dt*qbym[s]*qbym[s]*(0.3535533905932737*(ext_Ey[7]*rho[s][7]+ext_Ey[6]*rho[s][6]+ext_Ey[5]*rho[s][5]+ext_Ey[4]*rho[s][4]+ext_Ey[3]*rho[s][3]+ext_Ey[2]*rho[s][2]+ext_Ey[1]*rho[s][1]+ext_Ey[0]*rho[s][0])) + 0.5*dt*qbym[s]*(0.3535533905932737*(app_accel_y[s][7]*rho[s][7]+app_accel_y[s][6]*rho[s][6]+app_accel_y[s][5]*rho[s][5]+app_accel_y[s][4]*rho[s][4]+app_accel_y[s][3]*rho[s][3]+app_accel_y[s][2]*rho[s][2]+app_accel_y[s][1]*rho[s][1]+app_accel_y[s][0]*rho[s][0]))); 
    gkyl_mat_set(&rhs, 16 + s*(24), 0, qbym[s]*rhouz[s][0] + 0.5*dt*qbym[s]*qbym[s]*(0.3535533905932737*(ext_Ez[7]*rho[s][7]+ext_Ez[6]*rho[s][6]+ext_Ez[5]*rho[s][5]+ext_Ez[4]*rho[s][4]+ext_Ez[3]*rho[s][3]+ext_Ez[2]*rho[s][2]+ext_Ez[1]*rho[s][1]+ext_Ez[0]*rho[s][0])) + 0.5*dt*qbym[s]*(0.3535533905932737*(app_accel_z[s][7]*rho[s][7]+app_accel_z[s][6]*rho[s][6]+app_accel_z[s][5]*rho[s][5]+app_accel_z[s][4]*rho[s][4]+app_accel_z[s][3]*rho[s][3]+app_accel_z[s][2]*rho[s][2]+app_accel_z[s][1]*rho[s][1]+app_accel_z[s][0]*rho[s][0]))); 

    gkyl_mat_set(&rhs, 1 + s*(24), 0, qbym[s]*rhoux[s][1] + 0.5*dt*qbym[s]*qbym[s]*(0.3535533905932737*(ext_Ex[6]*rho[s][7]+rho[s][6]*ext_Ex[7]+ext_Ex[3]*rho[s][5]+rho[s][3]*ext_Ex[5]+ext_Ex[2]*rho[s][4]+rho[s][2]*ext_Ex[4]+ext_Ex[0]*rho[s][1]+rho[s][0]*ext_Ex[1])) + 0.5*dt*qbym[s]*(0.3535533905932737*(app_accel_x[s][6]*rho[s][7]+rho[s][6]*app_accel_x[s][7]+app_accel_x[s][3]*rho[s][5]+rho[s][3]*app_accel_x[s][5]+app_accel_x[s][2]*rho[s][4]+rho[s][2]*app_accel_x[s][4]+app_accel_x[s][0]*rho[s][1]+rho[s][0]*app_accel_x[s][1]))); 
    gkyl_mat_set(&rhs, 9 + s*(24), 0, qbym[s]*rhouy[s][1] + 0.5*dt*qbym[s]*qbym[s]*(0.3535533905932737*(ext_Ey[6]*rho[s][7]+rho[s][6]*ext_Ey[7]+ext_Ey[3]*rho[s][5]+rho[s][3]*ext_Ey[5]+ext_Ey[2]*rho[s][4]+rho[s][2]*ext_Ey[4]+ext_Ey[0]*rho[s][1]+rho[s][0]*ext_Ey[1])) + 0.5*dt*qbym[s]*(0.3535533905932737*(app_accel_y[s][6]*rho[s][7]+rho[s][6]*app_accel_y[s][7]+app_accel_y[s][3]*rho[s][5]+rho[s][3]*app_accel_y[s][5]+app_accel_y[s][2]*rho[s][4]+rho[s][2]*app_accel_y[s][4]+app_accel_y[s][0]*rho[s][1]+rho[s][0]*app_accel_y[s][1]))); 
    gkyl_mat_set(&rhs, 17 + s*(24), 0, qbym[s]*rhouz[s][1] + 0.5*dt*qbym[s]*qbym[s]*(0.3535533905932737*(ext_Ez[6]*rho[s][7]+rho[s][6]*ext_Ez[7]+ext_Ez[3]*rho[s][5]+rho[s][3]*ext_Ez[5]+ext_Ez[2]*rho[s][4]+rho[s][2]*ext_Ez[4]+ext_Ez[0]*rho[s][1]+rho[s][0]*ext_Ez[1])) + 0.5*dt*qbym[s]*(0.3535533905932737*(app_accel_z[s][6]*rho[s][7]+rho[s][6]*app_accel_z[s][7]+app_accel_z[s][3]*rho[s][5]+rho[s][3]*app_accel_z[s][5]+app_accel_z[s][2]*rho[s][4]+rho[s][2]*app_accel_z[s][4]+app_accel_z[s][0]*rho[s][1]+rho[s][0]*app_accel_z[s][1]))); 

    gkyl_mat_set(&rhs, 2 + s*(24), 0, qbym[s]*rhoux[s][2] + 0.5*dt*qbym[s]*qbym[s]*(0.3535533905932737*(ext_Ex[5]*rho[s][7]+rho[s][5]*ext_Ex[7]+ext_Ex[3]*rho[s][6]+rho[s][3]*ext_Ex[6]+ext_Ex[1]*rho[s][4]+rho[s][1]*ext_Ex[4]+ext_Ex[0]*rho[s][2]+rho[s][0]*ext_Ex[2])) + 0.5*dt*qbym[s]*(0.3535533905932737*(app_accel_x[s][5]*rho[s][7]+rho[s][5]*app_accel_x[s][7]+app_accel_x[s][3]*rho[s][6]+rho[s][3]*app_accel_x[s][6]+app_accel_x[s][1]*rho[s][4]+rho[s][1]*app_accel_x[s][4]+app_accel_x[s][0]*rho[s][2]+rho[s][0]*app_accel_x[s][2]))); 
    gkyl_mat_set(&rhs, 10 + s*(24), 0, qbym[s]*rhouy[s][2] + 0.5*dt*qbym[s]*qbym[s]*(0.3535533905932737*(ext_Ey[5]*rho[s][7]+rho[s][5]*ext_Ey[7]+ext_Ey[3]*rho[s][6]+rho[s][3]*ext_Ey[6]+ext_Ey[1]*rho[s][4]+rho[s][1]*ext_Ey[4]+ext_Ey[0]*rho[s][2]+rho[s][0]*ext_Ey[2])) + 0.5*dt*qbym[s]*(0.3535533905932737*(app_accel_y[s][5]*rho[s][7]+rho[s][5]*app_accel_y[s][7]+app_accel_y[s][3]*rho[s][6]+rho[s][3]*app_accel_y[s][6]+app_accel_y[s][1]*rho[s][4]+rho[s][1]*app_accel_y[s][4]+app_accel_y[s][0]*rho[s][2]+rho[s][0]*app_accel_y[s][2]))); 
    gkyl_mat_set(&rhs, 18 + s*(24), 0, qbym[s]*rhouz[s][2] + 0.5*dt*qbym[s]*qbym[s]*(0.3535533905932737*(ext_Ez[5]*rho[s][7]+rho[s][5]*ext_Ez[7]+ext_Ez[3]*rho[s][6]+rho[s][3]*ext_Ez[6]+ext_Ez[1]*rho[s][4]+rho[s][1]*ext_Ez[4]+ext_Ez[0]*rho[s][2]+rho[s][0]*ext_Ez[2])) + 0.5*dt*qbym[s]*(0.3535533905932737*(app_accel_z[s][5]*rho[s][7]+rho[s][5]*app_accel_z[s][7]+app_accel_z[s][3]*rho[s][6]+rho[s][3]*app_accel_z[s][6]+app_accel_z[s][1]*rho[s][4]+rho[s][1]*app_accel_z[s][4]+app_accel_z[s][0]*rho[s][2]+rho[s][0]*app_accel_z[s][2]))); 

    gkyl_mat_set(&rhs, 3 + s*(24), 0, qbym[s]*rhoux[s][3] + 0.5*dt*qbym[s]*qbym[s]*(0.3535533905932737*(ext_Ex[4]*rho[s][7]+rho[s][4]*ext_Ex[7]+ext_Ex[2]*rho[s][6]+rho[s][2]*ext_Ex[6]+ext_Ex[1]*rho[s][5]+rho[s][1]*ext_Ex[5]+ext_Ex[0]*rho[s][3]+rho[s][0]*ext_Ex[3])) + 0.5*dt*qbym[s]*(0.3535533905932737*(app_accel_x[s][4]*rho[s][7]+rho[s][4]*app_accel_x[s][7]+app_accel_x[s][2]*rho[s][6]+rho[s][2]*app_accel_x[s][6]+app_accel_x[s][1]*rho[s][5]+rho[s][1]*app_accel_x[s][5]+app_accel_x[s][0]*rho[s][3]+rho[s][0]*app_accel_x[s][3]))); 
    gkyl_mat_set(&rhs, 11 + s*(24), 0, qbym[s]*rhouy[s][3] + 0.5*dt*qbym[s]*qbym[s]*(0.3535533905932737*(ext_Ey[4]*rho[s][7]+rho[s][4]*ext_Ey[7]+ext_Ey[2]*rho[s][6]+rho[s][2]*ext_Ey[6]+ext_Ey[1]*rho[s][5]+rho[s][1]*ext_Ey[5]+ext_Ey[0]*rho[s][3]+rho[s][0]*ext_Ey[3])) + 0.5*dt*qbym[s]*(0.3535533905932737*(app_accel_y[s][4]*rho[s][7]+rho[s][4]*app_accel_y[s][7]+app_accel_y[s][2]*rho[s][6]+rho[s][2]*app_accel_y[s][6]+app_accel_y[s][1]*rho[s][5]+rho[s][1]*app_accel_y[s][5]+app_accel_y[s][0]*rho[s][3]+rho[s][0]*app_accel_y[s][3]))); 
    gkyl_mat_set(&rhs, 19 + s*(24), 0, qbym[s]*rhouz[s][3] + 0.5*dt*qbym[s]*qbym[s]*(0.3535533905932737*(ext_Ez[4]*rho[s][7]+rho[s][4]*ext_Ez[7]+ext_Ez[2]*rho[s][6]+rho[s][2]*ext_Ez[6]+ext_Ez[1]*rho[s][5]+rho[s][1]*ext_Ez[5]+ext_Ez[0]*rho[s][3]+rho[s][0]*ext_Ez[3])) + 0.5*dt*qbym[s]*(0.3535533905932737*(app_accel_z[s][4]*rho[s][7]+rho[s][4]*app_accel_z[s][7]+app_accel_z[s][2]*rho[s][6]+rho[s][2]*app_accel_z[s][6]+app_accel_z[s][1]*rho[s][5]+rho[s][1]*app_accel_z[s][5]+app_accel_z[s][0]*rho[s][3]+rho[s][0]*app_accel_z[s][3]))); 

    gkyl_mat_set(&rhs, 4 + s*(24), 0, qbym[s]*rhoux[s][4] + 0.5*dt*qbym[s]*qbym[s]*(0.3535533905932737*(ext_Ex[3]*rho[s][7]+rho[s][3]*ext_Ex[7]+ext_Ex[5]*rho[s][6]+rho[s][5]*ext_Ex[6]+ext_Ex[0]*rho[s][4]+rho[s][0]*ext_Ex[4]+ext_Ex[1]*rho[s][2]+rho[s][1]*ext_Ex[2])) + 0.5*dt*qbym[s]*(0.3535533905932737*(app_accel_x[s][3]*rho[s][7]+rho[s][3]*app_accel_x[s][7]+app_accel_x[s][5]*rho[s][6]+rho[s][5]*app_accel_x[s][6]+app_accel_x[s][0]*rho[s][4]+rho[s][0]*app_accel_x[s][4]+app_accel_x[s][1]*rho[s][2]+rho[s][1]*app_accel_x[s][2]))); 
    gkyl_mat_set(&rhs, 12 + s*(24), 0, qbym[s]*rhouy[s][4] + 0.5*dt*qbym[s]*qbym[s]*(0.3535533905932737*(ext_Ey[3]*rho[s][7]+rho[s][3]*ext_Ey[7]+ext_Ey[5]*rho[s][6]+rho[s][5]*ext_Ey[6]+ext_Ey[0]*rho[s][4]+rho[s][0]*ext_Ey[4]+ext_Ey[1]*rho[s][2]+rho[s][1]*ext_Ey[2])) + 0.5*dt*qbym[s]*(0.3535533905932737*(app_accel_y[s][3]*rho[s][7]+rho[s][3]*app_accel_y[s][7]+app_accel_y[s][5]*rho[s][6]+rho[s][5]*app_accel_y[s][6]+app_accel_y[s][0]*rho[s][4]+rho[s][0]*app_accel_y[s][4]+app_accel_y[s][1]*rho[s][2]+rho[s][1]*app_accel_y[s][2]))); 
    gkyl_mat_set(&rhs, 20 + s*(24), 0, qbym[s]*rhouz[s][4] + 0.5*dt*qbym[s]*qbym[s]*(0.3535533905932737*(ext_Ez[3]*rho[s][7]+rho[s][3]*ext_Ez[7]+ext_Ez[5]*rho[s][6]+rho[s][5]*ext_Ez[6]+ext_Ez[0]*rho[s][4]+rho[s][0]*ext_Ez[4]+ext_Ez[1]*rho[s][2]+rho[s][1]*ext_Ez[2])) + 0.5*dt*qbym[s]*(0.3535533905932737*(app_accel_z[s][3]*rho[s][7]+rho[s][3]*app_accel_z[s][7]+app_accel_z[s][5]*rho[s][6]+rho[s][5]*app_accel_z[s][6]+app_accel_z[s][0]*rho[s][4]+rho[s][0]*app_accel_z[s][4]+app_accel_z[s][1]*rho[s][2]+rho[s][1]*app_accel_z[s][2]))); 

    gkyl_mat_set(&rhs, 5 + s*(24), 0, qbym[s]*rhoux[s][5] + 0.5*dt*qbym[s]*qbym[s]*(0.3535533905932737*(ext_Ex[2]*rho[s][7]+rho[s][2]*ext_Ex[7]+ext_Ex[4]*rho[s][6]+rho[s][4]*ext_Ex[6]+ext_Ex[0]*rho[s][5]+rho[s][0]*ext_Ex[5]+ext_Ex[1]*rho[s][3]+rho[s][1]*ext_Ex[3])) + 0.5*dt*qbym[s]*(0.3535533905932737*(app_accel_x[s][2]*rho[s][7]+rho[s][2]*app_accel_x[s][7]+app_accel_x[s][4]*rho[s][6]+rho[s][4]*app_accel_x[s][6]+app_accel_x[s][0]*rho[s][5]+rho[s][0]*app_accel_x[s][5]+app_accel_x[s][1]*rho[s][3]+rho[s][1]*app_accel_x[s][3]))); 
    gkyl_mat_set(&rhs, 13 + s*(24), 0, qbym[s]*rhouy[s][5] + 0.5*dt*qbym[s]*qbym[s]*(0.3535533905932737*(ext_Ey[2]*rho[s][7]+rho[s][2]*ext_Ey[7]+ext_Ey[4]*rho[s][6]+rho[s][4]*ext_Ey[6]+ext_Ey[0]*rho[s][5]+rho[s][0]*ext_Ey[5]+ext_Ey[1]*rho[s][3]+rho[s][1]*ext_Ey[3])) + 0.5*dt*qbym[s]*(0.3535533905932737*(app_accel_y[s][2]*rho[s][7]+rho[s][2]*app_accel_y[s][7]+app_accel_y[s][4]*rho[s][6]+rho[s][4]*app_accel_y[s][6]+app_accel_y[s][0]*rho[s][5]+rho[s][0]*app_accel_y[s][5]+app_accel_y[s][1]*rho[s][3]+rho[s][1]*app_accel_y[s][3]))); 
    gkyl_mat_set(&rhs, 21 + s*(24), 0, qbym[s]*rhouz[s][5] + 0.5*dt*qbym[s]*qbym[s]*(0.3535533905932737*(ext_Ez[2]*rho[s][7]+rho[s][2]*ext_Ez[7]+ext_Ez[4]*rho[s][6]+rho[s][4]*ext_Ez[6]+ext_Ez[0]*rho[s][5]+rho[s][0]*ext_Ez[5]+ext_Ez[1]*rho[s][3]+rho[s][1]*ext_Ez[3])) + 0.5*dt*qbym[s]*(0.3535533905932737*(app_accel_z[s][2]*rho[s][7]+rho[s][2]*app_accel_z[s][7]+app_accel_z[s][4]*rho[s][6]+rho[s][4]*app_accel_z[s][6]+app_accel_z[s][0]*rho[s][5]+rho[s][0]*app_accel_z[s][5]+app_accel_z[s][1]*rho[s][3]+rho[s][1]*app_accel_z[s][3]))); 

    gkyl_mat_set(&rhs, 6 + s*(24), 0, qbym[s]*rhoux[s][6] + 0.5*dt*qbym[s]*qbym[s]*(0.3535533905932737*(ext_Ex[1]*rho[s][7]+rho[s][1]*ext_Ex[7]+ext_Ex[0]*rho[s][6]+rho[s][0]*ext_Ex[6]+ext_Ex[4]*rho[s][5]+rho[s][4]*ext_Ex[5]+ext_Ex[2]*rho[s][3]+rho[s][2]*ext_Ex[3])) + 0.5*dt*qbym[s]*(0.3535533905932737*(app_accel_x[s][1]*rho[s][7]+rho[s][1]*app_accel_x[s][7]+app_accel_x[s][0]*rho[s][6]+rho[s][0]*app_accel_x[s][6]+app_accel_x[s][4]*rho[s][5]+rho[s][4]*app_accel_x[s][5]+app_accel_x[s][2]*rho[s][3]+rho[s][2]*app_accel_x[s][3]))); 
    gkyl_mat_set(&rhs, 14 + s*(24), 0, qbym[s]*rhouy[s][6] + 0.5*dt*qbym[s]*qbym[s]*(0.3535533905932737*(ext_Ey[1]*rho[s][7]+rho[s][1]*ext_Ey[7]+ext_Ey[0]*rho[s][6]+rho[s][0]*ext_Ey[6]+ext_Ey[4]*rho[s][5]+rho[s][4]*ext_Ey[5]+ext_Ey[2]*rho[s][3]+rho[s][2]*ext_Ey[3])) + 0.5*dt*qbym[s]*(0.3535533905932737*(app_accel_y[s][1]*rho[s][7]+rho[s][1]*app_accel_y[s][7]+app_accel_y[s][0]*rho[s][6]+rho[s][0]*app_accel_y[s][6]+app_accel_y[s][4]*rho[s][5]+rho[s][4]*app_accel_y[s][5]+app_accel_y[s][2]*rho[s][3]+rho[s][2]*app_accel_y[s][3]))); 
    gkyl_mat_set(&rhs, 22 + s*(24), 0, qbym[s]*rhouz[s][6] + 0.5*dt*qbym[s]*qbym[s]*(0.3535533905932737*(ext_Ez[1]*rho[s][7]+rho[s][1]*ext_Ez[7]+ext_Ez[0]*rho[s][6]+rho[s][0]*ext_Ez[6]+ext_Ez[4]*rho[s][5]+rho[s][4]*ext_Ez[5]+ext_Ez[2]*rho[s][3]+rho[s][2]*ext_Ez[3])) + 0.5*dt*qbym[s]*(0.3535533905932737*(app_accel_z[s][1]*rho[s][7]+rho[s][1]*app_accel_z[s][7]+app_accel_z[s][0]*rho[s][6]+rho[s][0]*app_accel_z[s][6]+app_accel_z[s][4]*rho[s][5]+rho[s][4]*app_accel_z[s][5]+app_accel_z[s][2]*rho[s][3]+rho[s][2]*app_accel_z[s][3]))); 

    gkyl_mat_set(&rhs, 7 + s*(24), 0, qbym[s]*rhoux[s][7] + 0.5*dt*qbym[s]*qbym[s]*(0.3535533905932737*(ext_Ex[0]*rho[s][7]+rho[s][0]*ext_Ex[7]+ext_Ex[1]*rho[s][6]+rho[s][1]*ext_Ex[6]+ext_Ex[2]*rho[s][5]+rho[s][2]*ext_Ex[5]+ext_Ex[3]*rho[s][4]+rho[s][3]*ext_Ex[4])) + 0.5*dt*qbym[s]*(0.3535533905932737*(app_accel_x[s][0]*rho[s][7]+rho[s][0]*app_accel_x[s][7]+app_accel_x[s][1]*rho[s][6]+rho[s][1]*app_accel_x[s][6]+app_accel_x[s][2]*rho[s][5]+rho[s][2]*app_accel_x[s][5]+app_accel_x[s][3]*rho[s][4]+rho[s][3]*app_accel_x[s][4]))); 
    gkyl_mat_set(&rhs, 15 + s*(24), 0, qbym[s]*rhouy[s][7] + 0.5*dt*qbym[s]*qbym[s]*(0.3535533905932737*(ext_Ey[0]*rho[s][7]+rho[s][0]*ext_Ey[7]+ext_Ey[1]*rho[s][6]+rho[s][1]*ext_Ey[6]+ext_Ey[2]*rho[s][5]+rho[s][2]*ext_Ey[5]+ext_Ey[3]*rho[s][4]+rho[s][3]*ext_Ey[4])) + 0.5*dt*qbym[s]*(0.3535533905932737*(app_accel_y[s][0]*rho[s][7]+rho[s][0]*app_accel_y[s][7]+app_accel_y[s][1]*rho[s][6]+rho[s][1]*app_accel_y[s][6]+app_accel_y[s][2]*rho[s][5]+rho[s][2]*app_accel_y[s][5]+app_accel_y[s][3]*rho[s][4]+rho[s][3]*app_accel_y[s][4]))); 
    gkyl_mat_set(&rhs, 23 + s*(24), 0, qbym[s]*rhouz[s][7] + 0.5*dt*qbym[s]*qbym[s]*(0.3535533905932737*(ext_Ez[0]*rho[s][7]+rho[s][0]*ext_Ez[7]+ext_Ez[1]*rho[s][6]+rho[s][1]*ext_Ez[6]+ext_Ez[2]*rho[s][5]+rho[s][2]*ext_Ez[5]+ext_Ez[3]*rho[s][4]+rho[s][3]*ext_Ez[4])) + 0.5*dt*qbym[s]*(0.3535533905932737*(app_accel_z[s][0]*rho[s][7]+rho[s][0]*app_accel_z[s][7]+app_accel_z[s][1]*rho[s][6]+rho[s][1]*app_accel_z[s][6]+app_accel_z[s][2]*rho[s][5]+rho[s][2]*app_accel_z[s][5]+app_accel_z[s][3]*rho[s][4]+rho[s][3]*app_accel_z[s][4]))); 
