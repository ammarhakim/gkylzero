...
{ 
  ...
  const double *Pxx_xr = &p_ij_surf[3]; 
  const double *Pyy_yl = &p_ij_surf[24]; 
  const double *Pyy_yr = &p_ij_surf[27]; 
  double rho_xl[3] = {0.0}; 
  double rho_xr[3] = {0.0}; 
  ...
  gkyl_mat_set(&rhs_ux_xl,0,0,rhoux[0]); 
  gkyl_mat_set(&rhs_ux_xr,0,0,rhoux[0]); 
  gkyl_mat_set(&rhs_uy_xl,0,0,rhouy[0]); 
  gkyl_mat_set(&rhs_uy_xr,0,0,rhouy[0]); 
  gkyl_mat_set(&rhs_uz_xl,0,0,rhouz[0]); 
  gkyl_mat_set(&rhs_uz_xr,0,0,rhouz[0]); 
  gkyl_mat_set(&rhs_Txx_xl,0,0,3.0*Pxx_xl[0]); 
  gkyl_mat_set(&rhs_Txx_xr,0,0,3.0*Pxx_xr[0]); 
 
  gkyl_mat_set(&rhs_ux_yl,0,0,rhoux[0]); 
  gkyl_mat_set(&rhs_ux_yr,0,0,rhoux[0]); 
  gkyl_mat_set(&rhs_uy_yl,0,0,rhouy[0]); 
  gkyl_mat_set(&rhs_uy_yr,0,0,rhouy[0]); 
  gkyl_mat_set(&rhs_uz_yl,0,0,rhouz[0]); 
  gkyl_mat_set(&rhs_uz_yr,0,0,rhouz[0]); 
  gkyl_mat_set(&rhs_Tyy_yl,0,0,3.0*Pyy_yl[0]); 
  gkyl_mat_set(&rhs_Tyy_yr,0,0,3.0*Pyy_yr[0]); 
  ...
  gkyl_mat_set(&rhs_ux_xl,1,0,0.0); 
  gkyl_mat_set(&rhs_ux_xr,1,0,0.0); 
  gkyl_mat_set(&rhs_uy_xl,1,0,0.0); 
  gkyl_mat_set(&rhs_uy_xr,1,0,0.0); 
  gkyl_mat_set(&rhs_uz_xl,1,0,0.0); 
  gkyl_mat_set(&rhs_uz_xr,1,0,0.0); 
  gkyl_mat_set(&rhs_Txx_xl,1,0,0.0); 
  gkyl_mat_set(&rhs_Txx_xr,1,0,0.0); 
 
  gkyl_mat_set(&rhs_ux_yl,1,0,0.0); 
  gkyl_mat_set(&rhs_ux_yr,1,0,0.0); 
  gkyl_mat_set(&rhs_uy_yl,1,0,0.0); 
  gkyl_mat_set(&rhs_uy_yr,1,0,0.0); 
  gkyl_mat_set(&rhs_uz_yl,1,0,0.0); 
  gkyl_mat_set(&rhs_uz_yr,1,0,0.0); 
  gkyl_mat_set(&rhs_Tyy_yl,1,0,0.0); 
  gkyl_mat_set(&rhs_Tyy_yr,1,0,0.0); 
  ...
  gkyl_mat_set(&rhs_ux_xl,2,0,0.0); 
  gkyl_mat_set(&rhs_ux_xr,2,0,0.0); 
  gkyl_mat_set(&rhs_uy_xl,2,0,0.0); 
  gkyl_mat_set(&rhs_uy_xr,2,0,0.0); 
  gkyl_mat_set(&rhs_uz_xl,2,0,0.0); 
  gkyl_mat_set(&rhs_uz_xr,2,0,0.0); 
  gkyl_mat_set(&rhs_Txx_xl,2,0,0.0); 
  gkyl_mat_set(&rhs_Txx_xr,2,0,0.0); 
 
  gkyl_mat_set(&rhs_ux_yl,2,0,0.0); 
  gkyl_mat_set(&rhs_ux_yr,2,0,0.0); 
  gkyl_mat_set(&rhs_uy_yl,2,0,0.0); 
  gkyl_mat_set(&rhs_uy_yr,2,0,0.0); 
  gkyl_mat_set(&rhs_uz_yl,2,0,0.0); 
  gkyl_mat_set(&rhs_uz_yr,2,0,0.0); 
  gkyl_mat_set(&rhs_Tyy_yl,2,0,0.0); 
  gkyl_mat_set(&rhs_Tyy_yr,2,0,0.0); 
  ...
  gkyl_mat_set(&rhs_Txx_xl,1,0,3.0*Pxx_xl[1]); 
  gkyl_mat_set(&rhs_Txx_xr,1,0,3.0*Pxx_xr[1]); 
  ...
  gkyl_mat_set(&rhs_Tyy_yl,1,0,3.0*Pyy_yl[1]); 
  gkyl_mat_set(&rhs_Tyy_yr,1,0,3.0*Pyy_yr[1]); 
  ...
  gkyl_mat_set(&rhs_Txx_xl,2,0,3.0*Pxx_xl[2]); 
  gkyl_mat_set(&rhs_Txx_xr,2,0,3.0*Pxx_xr[2]); 
  ...
  gkyl_mat_set(&rhs_Tyy_yl,2,0,3.0*Pyy_yl[2]); 
  gkyl_mat_set(&rhs_Tyy_yr,2,0,3.0*Pyy_yr[2]); 
