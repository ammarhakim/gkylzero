...
{ 
  ...
  const double *u_surf_lr = &pkpm_prim_surf_l[4]; 
  const double *u_surf_cl = &pkpm_prim_surf_c[0]; 
  const double *u_surf_cr = &pkpm_prim_surf_c[4]; 
  ...
  F_0_lr[1] = 1.224744871391589*F_0l[5]+0.7071067811865475*F_0l[2]; 
  F_0_lr[2] = 1.224744871391589*F_0l[6]+0.7071067811865475*F_0l[3]; 
  F_0_lr[3] = 1.224744871391589*F_0l[8]+0.7071067811865475*F_0l[4]; 
  F_0_lr[4] = 1.224744871391589*F_0l[11]+0.7071067811865475*F_0l[7]; 
  F_0_lr[5] = 1.224744871391589*F_0l[12]+0.7071067811865475*F_0l[9]; 
  F_0_lr[6] = 1.224744871391589*F_0l[13]+0.7071067811865475*F_0l[10]; 
  F_0_lr[7] = 1.224744871391589*F_0l[15]+0.7071067811865475*F_0l[14]; 
  F_0_lr[8] = 1.224744871391589*F_0l[17]+0.7071067811865475*F_0l[16]; 
  F_0_lr[9] = 1.224744871391589*F_0l[20]+0.7071067811865475*F_0l[18]; 
  F_0_lr[10] = 1.224744871391589*F_0l[21]+0.7071067811865475*F_0l[19]; 
  F_0_lr[11] = 1.224744871391589*F_0l[23]+0.7071067811865475*F_0l[22]; 

  F_0_cl[0] = 0.7071067811865475*F_0c[0]-1.224744871391589*F_0c[1]; 
  F_0_cl[1] = 0.7071067811865475*F_0c[2]-1.224744871391589*F_0c[5]; 
  F_0_cl[2] = 0.7071067811865475*F_0c[3]-1.224744871391589*F_0c[6]; 
  F_0_cl[3] = 0.7071067811865475*F_0c[4]-1.224744871391589*F_0c[8]; 
  F_0_cl[4] = 0.7071067811865475*F_0c[7]-1.224744871391589*F_0c[11]; 
  F_0_cl[5] = 0.7071067811865475*F_0c[9]-1.224744871391589*F_0c[12]; 
  F_0_cl[6] = 0.7071067811865475*F_0c[10]-1.224744871391589*F_0c[13]; 
  F_0_cl[7] = 0.7071067811865475*F_0c[14]-1.224744871391589*F_0c[15]; 
  F_0_cl[8] = 0.7071067811865475*F_0c[16]-1.224744871391589*F_0c[17]; 
  F_0_cl[9] = 0.7071067811865475*F_0c[18]-1.224744871391589*F_0c[20]; 
  F_0_cl[10] = 0.7071067811865475*F_0c[19]-1.224744871391589*F_0c[21]; 
  F_0_cl[11] = 0.7071067811865475*F_0c[22]-1.224744871391589*F_0c[23]; 

  F_0_cr[0] = 1.224744871391589*F_0c[1]+0.7071067811865475*F_0c[0]; 
  F_0_cr[1] = 1.224744871391589*F_0c[5]+0.7071067811865475*F_0c[2]; 
  F_0_cr[2] = 1.224744871391589*F_0c[6]+0.7071067811865475*F_0c[3]; 
  F_0_cr[3] = 1.224744871391589*F_0c[8]+0.7071067811865475*F_0c[4]; 
  F_0_cr[4] = 1.224744871391589*F_0c[11]+0.7071067811865475*F_0c[7]; 
  F_0_cr[5] = 1.224744871391589*F_0c[12]+0.7071067811865475*F_0c[9]; 
  F_0_cr[6] = 1.224744871391589*F_0c[13]+0.7071067811865475*F_0c[10]; 
  F_0_cr[7] = 1.224744871391589*F_0c[15]+0.7071067811865475*F_0c[14]; 
  F_0_cr[8] = 1.224744871391589*F_0c[17]+0.7071067811865475*F_0c[16]; 
  F_0_cr[9] = 1.224744871391589*F_0c[20]+0.7071067811865475*F_0c[18]; 
  F_0_cr[10] = 1.224744871391589*F_0c[21]+0.7071067811865475*F_0c[19]; 
  F_0_cr[11] = 1.224744871391589*F_0c[23]+0.7071067811865475*F_0c[22]; 

  F_0_rl[0] = 0.7071067811865475*F_0r[0]-1.224744871391589*F_0r[1]; 
  F_0_rl[1] = 0.7071067811865475*F_0r[2]-1.224744871391589*F_0r[5]; 
  F_0_rl[2] = 0.7071067811865475*F_0r[3]-1.224744871391589*F_0r[6]; 
  F_0_rl[3] = 0.7071067811865475*F_0r[4]-1.224744871391589*F_0r[8]; 
  F_0_rl[4] = 0.7071067811865475*F_0r[7]-1.224744871391589*F_0r[11]; 
  F_0_rl[5] = 0.7071067811865475*F_0r[9]-1.224744871391589*F_0r[12]; 
  F_0_rl[6] = 0.7071067811865475*F_0r[10]-1.224744871391589*F_0r[13]; 
  F_0_rl[7] = 0.7071067811865475*F_0r[14]-1.224744871391589*F_0r[15]; 
  F_0_rl[8] = 0.7071067811865475*F_0r[16]-1.224744871391589*F_0r[17]; 
  F_0_rl[9] = 0.7071067811865475*F_0r[18]-1.224744871391589*F_0r[20]; 
  F_0_rl[10] = 0.7071067811865475*F_0r[19]-1.224744871391589*F_0r[21]; 
  F_0_rl[11] = 0.7071067811865475*F_0r[22]-1.224744871391589*F_0r[23]; 

  G_1_lr[0] = 1.224744871391589*G_1l[1]+0.7071067811865475*G_1l[0]; 
  G_1_lr[1] = 1.224744871391589*G_1l[5]+0.7071067811865475*G_1l[2]; 
  G_1_lr[2] = 1.224744871391589*G_1l[6]+0.7071067811865475*G_1l[3]; 
  G_1_lr[3] = 1.224744871391589*G_1l[8]+0.7071067811865475*G_1l[4]; 
  G_1_lr[4] = 1.224744871391589*G_1l[11]+0.7071067811865475*G_1l[7]; 
  G_1_lr[5] = 1.224744871391589*G_1l[12]+0.7071067811865475*G_1l[9]; 
  G_1_lr[6] = 1.224744871391589*G_1l[13]+0.7071067811865475*G_1l[10]; 
  G_1_lr[7] = 1.224744871391589*G_1l[15]+0.7071067811865475*G_1l[14]; 
  G_1_lr[8] = 1.224744871391589*G_1l[17]+0.7071067811865475*G_1l[16]; 
  G_1_lr[9] = 1.224744871391589*G_1l[20]+0.7071067811865475*G_1l[18]; 
  G_1_lr[10] = 1.224744871391589*G_1l[21]+0.7071067811865475*G_1l[19]; 
  G_1_lr[11] = 1.224744871391589*G_1l[23]+0.7071067811865475*G_1l[22]; 

  G_1_cl[0] = 0.7071067811865475*G_1c[0]-1.224744871391589*G_1c[1]; 
  G_1_cl[1] = 0.7071067811865475*G_1c[2]-1.224744871391589*G_1c[5]; 
  G_1_cl[2] = 0.7071067811865475*G_1c[3]-1.224744871391589*G_1c[6]; 
  G_1_cl[3] = 0.7071067811865475*G_1c[4]-1.224744871391589*G_1c[8]; 
  G_1_cl[4] = 0.7071067811865475*G_1c[7]-1.224744871391589*G_1c[11]; 
  G_1_cl[5] = 0.7071067811865475*G_1c[9]-1.224744871391589*G_1c[12]; 
  G_1_cl[6] = 0.7071067811865475*G_1c[10]-1.224744871391589*G_1c[13]; 
  G_1_cl[7] = 0.7071067811865475*G_1c[14]-1.224744871391589*G_1c[15]; 
  G_1_cl[8] = 0.7071067811865475*G_1c[16]-1.224744871391589*G_1c[17]; 
  G_1_cl[9] = 0.7071067811865475*G_1c[18]-1.224744871391589*G_1c[20]; 
  G_1_cl[10] = 0.7071067811865475*G_1c[19]-1.224744871391589*G_1c[21]; 
  G_1_cl[11] = 0.7071067811865475*G_1c[22]-1.224744871391589*G_1c[23]; 

  G_1_cr[0] = 1.224744871391589*G_1c[1]+0.7071067811865475*G_1c[0]; 
  G_1_cr[1] = 1.224744871391589*G_1c[5]+0.7071067811865475*G_1c[2]; 
  G_1_cr[2] = 1.224744871391589*G_1c[6]+0.7071067811865475*G_1c[3]; 
  G_1_cr[3] = 1.224744871391589*G_1c[8]+0.7071067811865475*G_1c[4]; 
  G_1_cr[4] = 1.224744871391589*G_1c[11]+0.7071067811865475*G_1c[7]; 
  G_1_cr[5] = 1.224744871391589*G_1c[12]+0.7071067811865475*G_1c[9]; 
  G_1_cr[6] = 1.224744871391589*G_1c[13]+0.7071067811865475*G_1c[10]; 
  G_1_cr[7] = 1.224744871391589*G_1c[15]+0.7071067811865475*G_1c[14]; 
  G_1_cr[8] = 1.224744871391589*G_1c[17]+0.7071067811865475*G_1c[16]; 
  G_1_cr[9] = 1.224744871391589*G_1c[20]+0.7071067811865475*G_1c[18]; 
  G_1_cr[10] = 1.224744871391589*G_1c[21]+0.7071067811865475*G_1c[19]; 
  G_1_cr[11] = 1.224744871391589*G_1c[23]+0.7071067811865475*G_1c[22]; 

  G_1_rl[0] = 0.7071067811865475*G_1r[0]-1.224744871391589*G_1r[1]; 
  G_1_rl[1] = 0.7071067811865475*G_1r[2]-1.224744871391589*G_1r[5]; 
  G_1_rl[2] = 0.7071067811865475*G_1r[3]-1.224744871391589*G_1r[6]; 
  G_1_rl[3] = 0.7071067811865475*G_1r[4]-1.224744871391589*G_1r[8]; 
  G_1_rl[4] = 0.7071067811865475*G_1r[7]-1.224744871391589*G_1r[11]; 
  G_1_rl[5] = 0.7071067811865475*G_1r[9]-1.224744871391589*G_1r[12]; 
  G_1_rl[6] = 0.7071067811865475*G_1r[10]-1.224744871391589*G_1r[13]; 
  G_1_rl[7] = 0.7071067811865475*G_1r[14]-1.224744871391589*G_1r[15]; 
  G_1_rl[8] = 0.7071067811865475*G_1r[16]-1.224744871391589*G_1r[17]; 
  G_1_rl[9] = 0.7071067811865475*G_1r[18]-1.224744871391589*G_1r[20]; 
  G_1_rl[10] = 0.7071067811865475*G_1r[19]-1.224744871391589*G_1r[21]; 
  G_1_rl[11] = 0.7071067811865475*G_1r[22]-1.224744871391589*G_1r[23]; 
  ...
  out_F_0[8] += -1.224744871391589*(Ghat_F_0_u_r[3]+Ghat_F_0_u_l[3])*dx1; 
  ...
  out_F_0[13] += -1.224744871391589*(Ghat_F_0_u_r[6]+Ghat_F_0_u_l[6])*dx1; 
  out_F_0[14] += (0.7071067811865475*Ghat_F_0_u_l[7]-0.7071067811865475*Ghat_F_0_u_r[7])*dx1; 
  ...
  out_F_0[17] += -1.224744871391589*(Ghat_F_0_u_r[8]+Ghat_F_0_u_l[8])*dx1; 
  out_F_0[18] += (0.7071067811865475*Ghat_F_0_u_l[9]-0.7071067811865475*Ghat_F_0_u_r[9])*dx1; 
  ...
  out_F_0[21] += -1.224744871391589*(Ghat_F_0_u_r[10]+Ghat_F_0_u_l[10])*dx1; 
  out_F_0[22] += (0.7071067811865475*Ghat_F_0_u_l[11]-0.7071067811865475*Ghat_F_0_u_r[11])*dx1; 
  ...
  out_G_1[8] += -1.224744871391589*(Ghat_G_1_u_r[3]+Ghat_G_1_u_l[3])*dx1; 
  ...
  out_G_1[13] += -1.224744871391589*(Ghat_G_1_u_r[6]+Ghat_G_1_u_l[6])*dx1; 
  out_G_1[14] += (0.7071067811865475*Ghat_G_1_u_l[7]-0.7071067811865475*Ghat_G_1_u_r[7])*dx1; 
  ...
  out_G_1[17] += -1.224744871391589*(Ghat_G_1_u_r[8]+Ghat_G_1_u_l[8])*dx1; 
  out_G_1[18] += (0.7071067811865475*Ghat_G_1_u_l[9]-0.7071067811865475*Ghat_G_1_u_r[9])*dx1; 
  ...
  out_G_1[21] += -1.224744871391589*(Ghat_G_1_u_r[10]+Ghat_G_1_u_l[10])*dx1; 
  out_G_1[22] += (0.7071067811865475*Ghat_G_1_u_l[11]-0.7071067811865475*Ghat_G_1_u_r[11])*dx1; 
