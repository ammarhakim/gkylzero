...
{ 
  ...
  T_perp_over_m[0] = 0.7071067811865475*p_perp[1]*rho_inv[1]+0.7071067811865475*p_perp[0]*rho_inv[0]; 
  T_perp_over_m[1] = 0.7071067811865475*p_perp[0]*rho_inv[1]+0.7071067811865475*rho_inv[0]*p_perp[1]; 
