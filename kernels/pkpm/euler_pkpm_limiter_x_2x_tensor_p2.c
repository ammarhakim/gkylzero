...
{ 
  ...
  delta_c[2] = rhouy_c[1]; 
  delta_c[3] = rhouz_c[1]; 
  delta_c[4] = 0.447213595499958*rhoux_c[7]*ux_c[8]+0.447213595499958*ux_c[7]*rhoux_c[8]+0.5000000000000001*rhoux_c[5]*ux_c[7]+0.5000000000000001*ux_c[5]*rhoux_c[7]+0.447213595499958*rhoux_c[3]*ux_c[6]+0.447213595499958*ux_c[3]*rhoux_c[6]+0.4472135954999579*rhoux_c[1]*ux_c[4]+0.4472135954999579*ux_c[1]*rhoux_c[4]+0.5*rhoux_c[2]*ux_c[3]+0.5*ux_c[2]*rhoux_c[3]+0.5*rhoux_c[0]*ux_c[1]+0.5*ux_c[0]*rhoux_c[1]+Pxx_c[1]; 
  delta_c[5] = 0.447213595499958*rhoux_c[7]*uy_c[8]+0.447213595499958*uy_c[7]*rhoux_c[8]+0.5000000000000001*rhoux_c[5]*uy_c[7]+0.5000000000000001*uy_c[5]*rhoux_c[7]+0.447213595499958*rhoux_c[3]*uy_c[6]+0.447213595499958*uy_c[3]*rhoux_c[6]+0.4472135954999579*rhoux_c[1]*uy_c[4]+0.4472135954999579*uy_c[1]*rhoux_c[4]+0.5*rhoux_c[2]*uy_c[3]+0.5*uy_c[2]*rhoux_c[3]+0.5*rhoux_c[0]*uy_c[1]+0.5*uy_c[0]*rhoux_c[1]+Pxy_c[1]; 
  delta_c[6] = 0.447213595499958*rhoux_c[7]*uz_c[8]+0.447213595499958*uz_c[7]*rhoux_c[8]+0.5000000000000001*rhoux_c[5]*uz_c[7]+0.5000000000000001*uz_c[5]*rhoux_c[7]+0.447213595499958*rhoux_c[3]*uz_c[6]+0.447213595499958*uz_c[3]*rhoux_c[6]+0.4472135954999579*rhoux_c[1]*uz_c[4]+0.4472135954999579*uz_c[1]*rhoux_c[4]+0.5*rhoux_c[2]*uz_c[3]+0.5*uz_c[2]*rhoux_c[3]+0.5*rhoux_c[0]*uz_c[1]+0.5*uz_c[0]*rhoux_c[1]+Pxz_c[1]; 
  delta_c[7] = 0.447213595499958*rhouy_c[7]*uy_c[8]+0.447213595499958*uy_c[7]*rhouy_c[8]+0.5000000000000001*rhouy_c[5]*uy_c[7]+0.5000000000000001*uy_c[5]*rhouy_c[7]+0.447213595499958*rhouy_c[3]*uy_c[6]+0.447213595499958*uy_c[3]*rhouy_c[6]+0.4472135954999579*rhouy_c[1]*uy_c[4]+0.4472135954999579*uy_c[1]*rhouy_c[4]+0.5*rhouy_c[2]*uy_c[3]+0.5*uy_c[2]*rhouy_c[3]+0.5*rhouy_c[0]*uy_c[1]+0.5*uy_c[0]*rhouy_c[1]+Pyy_c[1]; 
  delta_c[8] = 0.447213595499958*rhouy_c[7]*uz_c[8]+0.447213595499958*uz_c[7]*rhouy_c[8]+0.5000000000000001*rhouy_c[5]*uz_c[7]+0.5000000000000001*uz_c[5]*rhouy_c[7]+0.447213595499958*rhouy_c[3]*uz_c[6]+0.447213595499958*uz_c[3]*rhouy_c[6]+0.4472135954999579*rhouy_c[1]*uz_c[4]+0.4472135954999579*uz_c[1]*rhouy_c[4]+0.5*rhouy_c[2]*uz_c[3]+0.5*uz_c[2]*rhouy_c[3]+0.5*rhouy_c[0]*uz_c[1]+0.5*uz_c[0]*rhouy_c[1]+Pyz_c[1]; 
  delta_c[9] = 0.447213595499958*rhouz_c[7]*uz_c[8]+0.447213595499958*uz_c[7]*rhouz_c[8]+0.5000000000000001*rhouz_c[5]*uz_c[7]+0.5000000000000001*uz_c[5]*rhouz_c[7]+0.447213595499958*rhouz_c[3]*uz_c[6]+0.447213595499958*uz_c[3]*rhouz_c[6]+0.4472135954999579*rhouz_c[1]*uz_c[4]+0.4472135954999579*uz_c[1]*rhouz_c[4]+0.5*rhouz_c[2]*uz_c[3]+0.5*uz_c[2]*rhouz_c[3]+0.5*rhouz_c[0]*uz_c[1]+0.5*uz_c[0]*rhouz_c[1]+Pzz_c[1]; 
  ...
  double speeds[5] = {0.0}; 
  double my_max_speed_l = wave_roe(wv_eqn, delta_l, q_c_local, q_c_local, waves_slope_l, speeds); 
  double my_max_speed_c = wave_roe(wv_eqn, delta_c_local, q_c_local, q_c_local, waves_slope_c, speeds); 
  double my_max_speed_r = wave_roe(wv_eqn, delta_r, q_c_local, q_c_local, waves_slope_r, speeds); 
