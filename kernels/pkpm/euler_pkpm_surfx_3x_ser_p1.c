...
{ 
  ...
  u_l_r = ser_3x_p1_surfx1_eval_quad_node_0_r(u_l); 
  u_c_l = ser_3x_p1_surfx1_eval_quad_node_0_l(u_c); 
  u_c_r = ser_3x_p1_surfx1_eval_quad_node_0_r(u_c); 
  u_r_l = ser_3x_p1_surfx1_eval_quad_node_0_l(u_r); 
  uQuad_l = fmax(fabs(u_l_r), fabs(u_c_l)); 
  uQuad_r = fmax(fabs(u_c_r), fabs(u_r_l)); 
  vth_sq_l_r = ser_3x_p1_surfx1_eval_quad_node_0_r(vth_sql); 
  vth_sq_c_l = ser_3x_p1_surfx1_eval_quad_node_0_l(vth_sqc); 
  vth_sq_c_r = ser_3x_p1_surfx1_eval_quad_node_0_r(vth_sqc); 
  vth_sq_r_l = ser_3x_p1_surfx1_eval_quad_node_0_l(vth_sqr); 
  ...
  rhoux_l_r = ser_3x_p1_surfx1_eval_quad_node_0_r(rhoux_l); 
  rhoux_c_l = ser_3x_p1_surfx1_eval_quad_node_0_l(rhoux_c); 
  rhoux_c_r = ser_3x_p1_surfx1_eval_quad_node_0_r(rhoux_c); 
  rhoux_r_l = ser_3x_p1_surfx1_eval_quad_node_0_l(rhoux_r); 
  rhouy_l_r = ser_3x_p1_surfx1_eval_quad_node_0_r(rhouy_l); 
  rhouy_c_l = ser_3x_p1_surfx1_eval_quad_node_0_l(rhouy_c); 
  rhouy_c_r = ser_3x_p1_surfx1_eval_quad_node_0_r(rhouy_c); 
  rhouy_r_l = ser_3x_p1_surfx1_eval_quad_node_0_l(rhouy_r); 
  rhouz_l_r = ser_3x_p1_surfx1_eval_quad_node_0_r(rhouz_l); 
  rhouz_c_l = ser_3x_p1_surfx1_eval_quad_node_0_l(rhouz_c); 
  rhouz_c_r = ser_3x_p1_surfx1_eval_quad_node_0_r(rhouz_c); 
  rhouz_r_l = ser_3x_p1_surfx1_eval_quad_node_0_l(rhouz_r); 
  ...
  u_l_r = ser_3x_p1_surfx1_eval_quad_node_1_r(u_l); 
  u_c_l = ser_3x_p1_surfx1_eval_quad_node_1_l(u_c); 
  u_c_r = ser_3x_p1_surfx1_eval_quad_node_1_r(u_c); 
  u_r_l = ser_3x_p1_surfx1_eval_quad_node_1_l(u_r); 
  uQuad_l = fmax(fabs(u_l_r), fabs(u_c_l)); 
  uQuad_r = fmax(fabs(u_c_r), fabs(u_r_l)); 
  vth_sq_l_r = ser_3x_p1_surfx1_eval_quad_node_1_r(vth_sql); 
  vth_sq_c_l = ser_3x_p1_surfx1_eval_quad_node_1_l(vth_sqc); 
  vth_sq_c_r = ser_3x_p1_surfx1_eval_quad_node_1_r(vth_sqc); 
  vth_sq_r_l = ser_3x_p1_surfx1_eval_quad_node_1_l(vth_sqr); 
  vthQuad_l = fmax(sqrt(fabs(vth_sq_l_r)), sqrt(fabs(vth_sq_c_l))); 
  vthQuad_r = fmax(sqrt(fabs(vth_sq_c_r)), sqrt(fabs(vth_sq_r_l))); 
  max_speed_l = uQuad_l + vthQuad_l; 
  max_speed_r = uQuad_r + vthQuad_r; 
  rhoux_l_r = ser_3x_p1_surfx1_eval_quad_node_1_r(rhoux_l); 
  rhoux_c_l = ser_3x_p1_surfx1_eval_quad_node_1_l(rhoux_c); 
  rhoux_c_r = ser_3x_p1_surfx1_eval_quad_node_1_r(rhoux_c); 
  rhoux_r_l = ser_3x_p1_surfx1_eval_quad_node_1_l(rhoux_r); 
  rhouy_l_r = ser_3x_p1_surfx1_eval_quad_node_1_r(rhouy_l); 
  rhouy_c_l = ser_3x_p1_surfx1_eval_quad_node_1_l(rhouy_c); 
  rhouy_c_r = ser_3x_p1_surfx1_eval_quad_node_1_r(rhouy_c); 
  rhouy_r_l = ser_3x_p1_surfx1_eval_quad_node_1_l(rhouy_r); 
  rhouz_l_r = ser_3x_p1_surfx1_eval_quad_node_1_r(rhouz_l); 
  rhouz_c_l = ser_3x_p1_surfx1_eval_quad_node_1_l(rhouz_c); 
  rhouz_c_r = ser_3x_p1_surfx1_eval_quad_node_1_r(rhouz_c); 
  rhouz_r_l = ser_3x_p1_surfx1_eval_quad_node_1_l(rhouz_r); 
  ...
  u_l_r = ser_3x_p1_surfx1_eval_quad_node_2_r(u_l); 
  u_c_l = ser_3x_p1_surfx1_eval_quad_node_2_l(u_c); 
  u_c_r = ser_3x_p1_surfx1_eval_quad_node_2_r(u_c); 
  u_r_l = ser_3x_p1_surfx1_eval_quad_node_2_l(u_r); 
  uQuad_l = fmax(fabs(u_l_r), fabs(u_c_l)); 
  uQuad_r = fmax(fabs(u_c_r), fabs(u_r_l)); 
  vth_sq_l_r = ser_3x_p1_surfx1_eval_quad_node_2_r(vth_sql); 
  vth_sq_c_l = ser_3x_p1_surfx1_eval_quad_node_2_l(vth_sqc); 
  vth_sq_c_r = ser_3x_p1_surfx1_eval_quad_node_2_r(vth_sqc); 
  vth_sq_r_l = ser_3x_p1_surfx1_eval_quad_node_2_l(vth_sqr); 
  vthQuad_l = fmax(sqrt(fabs(vth_sq_l_r)), sqrt(fabs(vth_sq_c_l))); 
  vthQuad_r = fmax(sqrt(fabs(vth_sq_c_r)), sqrt(fabs(vth_sq_r_l))); 
  max_speed_l = uQuad_l + vthQuad_l; 
  max_speed_r = uQuad_r + vthQuad_r; 
  rhoux_l_r = ser_3x_p1_surfx1_eval_quad_node_2_r(rhoux_l); 
  rhoux_c_l = ser_3x_p1_surfx1_eval_quad_node_2_l(rhoux_c); 
  rhoux_c_r = ser_3x_p1_surfx1_eval_quad_node_2_r(rhoux_c); 
  rhoux_r_l = ser_3x_p1_surfx1_eval_quad_node_2_l(rhoux_r); 
  rhouy_l_r = ser_3x_p1_surfx1_eval_quad_node_2_r(rhouy_l); 
  rhouy_c_l = ser_3x_p1_surfx1_eval_quad_node_2_l(rhouy_c); 
  rhouy_c_r = ser_3x_p1_surfx1_eval_quad_node_2_r(rhouy_c); 
  rhouy_r_l = ser_3x_p1_surfx1_eval_quad_node_2_l(rhouy_r); 
  rhouz_l_r = ser_3x_p1_surfx1_eval_quad_node_2_r(rhouz_l); 
  rhouz_c_l = ser_3x_p1_surfx1_eval_quad_node_2_l(rhouz_c); 
  rhouz_c_r = ser_3x_p1_surfx1_eval_quad_node_2_r(rhouz_c); 
  rhouz_r_l = ser_3x_p1_surfx1_eval_quad_node_2_l(rhouz_r); 
  ...
  u_l_r = ser_3x_p1_surfx1_eval_quad_node_3_r(u_l); 
  u_c_l = ser_3x_p1_surfx1_eval_quad_node_3_l(u_c); 
  u_c_r = ser_3x_p1_surfx1_eval_quad_node_3_r(u_c); 
  u_r_l = ser_3x_p1_surfx1_eval_quad_node_3_l(u_r); 
  uQuad_l = fmax(fabs(u_l_r), fabs(u_c_l)); 
  uQuad_r = fmax(fabs(u_c_r), fabs(u_r_l)); 
  vth_sq_l_r = ser_3x_p1_surfx1_eval_quad_node_3_r(vth_sql); 
  vth_sq_c_l = ser_3x_p1_surfx1_eval_quad_node_3_l(vth_sqc); 
  vth_sq_c_r = ser_3x_p1_surfx1_eval_quad_node_3_r(vth_sqc); 
  vth_sq_r_l = ser_3x_p1_surfx1_eval_quad_node_3_l(vth_sqr); 
  vthQuad_l = fmax(sqrt(fabs(vth_sq_l_r)), sqrt(fabs(vth_sq_c_l))); 
  vthQuad_r = fmax(sqrt(fabs(vth_sq_c_r)), sqrt(fabs(vth_sq_r_l))); 
  max_speed_l = uQuad_l + vthQuad_l; 
  max_speed_r = uQuad_r + vthQuad_r; 
  rhoux_l_r = ser_3x_p1_surfx1_eval_quad_node_3_r(rhoux_l); 
  rhoux_c_l = ser_3x_p1_surfx1_eval_quad_node_3_l(rhoux_c); 
  rhoux_c_r = ser_3x_p1_surfx1_eval_quad_node_3_r(rhoux_c); 
  rhoux_r_l = ser_3x_p1_surfx1_eval_quad_node_3_l(rhoux_r); 
  rhouy_l_r = ser_3x_p1_surfx1_eval_quad_node_3_r(rhouy_l); 
  rhouy_c_l = ser_3x_p1_surfx1_eval_quad_node_3_l(rhouy_c); 
  rhouy_c_r = ser_3x_p1_surfx1_eval_quad_node_3_r(rhouy_c); 
  rhouy_r_l = ser_3x_p1_surfx1_eval_quad_node_3_l(rhouy_r); 
  rhouz_l_r = ser_3x_p1_surfx1_eval_quad_node_3_r(rhouz_l); 
  rhouz_c_l = ser_3x_p1_surfx1_eval_quad_node_3_l(rhouz_c); 
  rhouz_c_r = ser_3x_p1_surfx1_eval_quad_node_3_r(rhouz_c); 
  rhouz_r_l = ser_3x_p1_surfx1_eval_quad_node_3_l(rhouz_r); 
  ...
  outrhou0[1] += (-1.224744871391589*lax_rhoux_modal_r[0]*dx1)-1.224744871391589*lax_rhoux_modal_l[0]*dx1; 
  outrhou0[2] += 0.7071067811865475*lax_rhoux_modal_l[1]*dx1-0.7071067811865475*lax_rhoux_modal_r[1]*dx1; 
  ...
  outrhou0[5] += (-1.224744871391589*lax_rhoux_modal_r[2]*dx1)-1.224744871391589*lax_rhoux_modal_l[2]*dx1; 
  outrhou0[6] += 0.7071067811865475*lax_rhoux_modal_l[3]*dx1-0.7071067811865475*lax_rhoux_modal_r[3]*dx1; 
  ...
  outrhou1[1] += (-1.224744871391589*lax_rhouy_modal_r[0]*dx1)-1.224744871391589*lax_rhouy_modal_l[0]*dx1; 
  outrhou1[2] += 0.7071067811865475*lax_rhouy_modal_l[1]*dx1-0.7071067811865475*lax_rhouy_modal_r[1]*dx1; 
  ...
  outrhou1[5] += (-1.224744871391589*lax_rhouy_modal_r[2]*dx1)-1.224744871391589*lax_rhouy_modal_l[2]*dx1; 
  outrhou1[6] += 0.7071067811865475*lax_rhouy_modal_l[3]*dx1-0.7071067811865475*lax_rhouy_modal_r[3]*dx1; 
  ...
  outrhou2[1] += (-1.224744871391589*lax_rhouz_modal_r[0]*dx1)-1.224744871391589*lax_rhouz_modal_l[0]*dx1; 
  outrhou2[2] += 0.7071067811865475*lax_rhouz_modal_l[1]*dx1-0.7071067811865475*lax_rhouz_modal_r[1]*dx1; 
  ...
  outrhou2[5] += (-1.224744871391589*lax_rhouz_modal_r[2]*dx1)-1.224744871391589*lax_rhouz_modal_l[2]*dx1; 
  outrhou2[6] += 0.7071067811865475*lax_rhouz_modal_l[3]*dx1-0.7071067811865475*lax_rhouz_modal_r[3]*dx1; 
