...
{ 
  ...
  const double *ul = &pkpm_priml[8]; 
  const double *uc = &pkpm_primc[8]; 
  const double *ur = &pkpm_primr[8]; 
  ...
  const double *vth_sql = &pkpm_priml[32]; 
  const double *vth_sqc = &pkpm_primc[32]; 
  const double *vth_sqr = &pkpm_primr[32]; 
  ...
  avg_u_l[0] = 0.6123724356957944*ul[2]-0.6123724356957944*uc[2]+0.3535533905932737*ul[0]+0.3535533905932737*uc[0]; 
  avg_u_l[1] = 0.6123724356957944*ul[4]-0.6123724356957944*uc[4]+0.3535533905932737*ul[1]+0.3535533905932737*uc[1]; 
  avg_u_l[2] = 0.6123724356957944*ul[6]-0.6123724356957944*uc[6]+0.3535533905932737*ul[3]+0.3535533905932737*uc[3]; 
  avg_u_l[3] = 0.6123724356957944*ul[7]-0.6123724356957944*uc[7]+0.3535533905932737*ul[5]+0.3535533905932737*uc[5]; 

  avg_u_r[0] = (-0.6123724356957944*ur[2])+0.6123724356957944*uc[2]+0.3535533905932737*ur[0]+0.3535533905932737*uc[0]; 
  avg_u_r[1] = (-0.6123724356957944*ur[4])+0.6123724356957944*uc[4]+0.3535533905932737*ur[1]+0.3535533905932737*uc[1]; 
  avg_u_r[2] = (-0.6123724356957944*ur[6])+0.6123724356957944*uc[6]+0.3535533905932737*ur[3]+0.3535533905932737*uc[3]; 
  avg_u_r[3] = (-0.6123724356957944*ur[7])+0.6123724356957944*uc[7]+0.3535533905932737*ur[5]+0.3535533905932737*uc[5]; 

  ul_r = ser_3x_p1_surfx2_eval_quad_node_0_r(ul); 
  uc_l = ser_3x_p1_surfx2_eval_quad_node_0_l(uc); 
  uc_r = ser_3x_p1_surfx2_eval_quad_node_0_r(uc); 
  ur_l = ser_3x_p1_surfx2_eval_quad_node_0_l(ur); 
  uQuad_l = fmax(fabs(ul_r), fabs(uc_l)); 
  uQuad_r = fmax(fabs(uc_r), fabs(ur_l)); 
  vth_sql_r = ser_3x_p1_surfx2_eval_quad_node_0_r(vth_sql); 
  vth_sqc_l = ser_3x_p1_surfx2_eval_quad_node_0_l(vth_sqc); 
  vth_sqc_r = ser_3x_p1_surfx2_eval_quad_node_0_r(vth_sqc); 
  vth_sqr_l = ser_3x_p1_surfx2_eval_quad_node_0_l(vth_sqr); 
  ...
  ul_r = ser_3x_p1_surfx2_eval_quad_node_1_r(ul); 
  uc_l = ser_3x_p1_surfx2_eval_quad_node_1_l(uc); 
  uc_r = ser_3x_p1_surfx2_eval_quad_node_1_r(uc); 
  ur_l = ser_3x_p1_surfx2_eval_quad_node_1_l(ur); 
  uQuad_l = fmax(fabs(ul_r), fabs(uc_l)); 
  uQuad_r = fmax(fabs(uc_r), fabs(ur_l)); 
  vth_sql_r = ser_3x_p1_surfx2_eval_quad_node_1_r(vth_sql); 
  vth_sqc_l = ser_3x_p1_surfx2_eval_quad_node_1_l(vth_sqc); 
  vth_sqc_r = ser_3x_p1_surfx2_eval_quad_node_1_r(vth_sqc); 
  vth_sqr_l = ser_3x_p1_surfx2_eval_quad_node_1_l(vth_sqr); 
  vthQuad_l = fmax(sqrt(fabs(vth_sql_r)), sqrt(fabs(vth_sqc_l))); 
  vthQuad_r = fmax(sqrt(fabs(vth_sqc_r)), sqrt(fabs(vth_sqr_l))); 
  max_speed_quad_l[1] = uQuad_l + vthQuad_l; 
  max_speed_quad_r[1] = uQuad_r + vthQuad_r; 
  ul_r = ser_3x_p1_surfx2_eval_quad_node_2_r(ul); 
  uc_l = ser_3x_p1_surfx2_eval_quad_node_2_l(uc); 
  uc_r = ser_3x_p1_surfx2_eval_quad_node_2_r(uc); 
  ur_l = ser_3x_p1_surfx2_eval_quad_node_2_l(ur); 
  uQuad_l = fmax(fabs(ul_r), fabs(uc_l)); 
  uQuad_r = fmax(fabs(uc_r), fabs(ur_l)); 
  vth_sql_r = ser_3x_p1_surfx2_eval_quad_node_2_r(vth_sql); 
  vth_sqc_l = ser_3x_p1_surfx2_eval_quad_node_2_l(vth_sqc); 
  vth_sqc_r = ser_3x_p1_surfx2_eval_quad_node_2_r(vth_sqc); 
  vth_sqr_l = ser_3x_p1_surfx2_eval_quad_node_2_l(vth_sqr); 
  vthQuad_l = fmax(sqrt(fabs(vth_sql_r)), sqrt(fabs(vth_sqc_l))); 
  vthQuad_r = fmax(sqrt(fabs(vth_sqc_r)), sqrt(fabs(vth_sqr_l))); 
  max_speed_quad_l[2] = uQuad_l + vthQuad_l; 
  max_speed_quad_r[2] = uQuad_r + vthQuad_r; 
  ul_r = ser_3x_p1_surfx2_eval_quad_node_3_r(ul); 
  uc_l = ser_3x_p1_surfx2_eval_quad_node_3_l(uc); 
  uc_r = ser_3x_p1_surfx2_eval_quad_node_3_r(uc); 
  ur_l = ser_3x_p1_surfx2_eval_quad_node_3_l(ur); 
  uQuad_l = fmax(fabs(ul_r), fabs(uc_l)); 
  uQuad_r = fmax(fabs(uc_r), fabs(ur_l)); 
  vth_sql_r = ser_3x_p1_surfx2_eval_quad_node_3_r(vth_sql); 
  vth_sqc_l = ser_3x_p1_surfx2_eval_quad_node_3_l(vth_sqc); 
  vth_sqc_r = ser_3x_p1_surfx2_eval_quad_node_3_r(vth_sqc); 
  vth_sqr_l = ser_3x_p1_surfx2_eval_quad_node_3_l(vth_sqr); 
  vthQuad_l = fmax(sqrt(fabs(vth_sql_r)), sqrt(fabs(vth_sqc_l))); 
  vthQuad_r = fmax(sqrt(fabs(vth_sqc_r)), sqrt(fabs(vth_sqr_l))); 
  ...
  F_0l_rx[0] = 0.4330127018922193*F_0l[2]+0.25*F_0l[0]; 
  F_0l_rx[1] = 0.4330127018922193*F_0l[5]+0.25*F_0l[1]; 
  F_0l_rx[2] = 0.4330127018922193*F_0l[7]+0.25*F_0l[3]; 
  F_0l_rx[3] = 0.4330127018922193*F_0l[11]+0.25*F_0l[6]; 

  F_0c_lx[0] = 0.25*F_0c[0]-0.4330127018922193*F_0c[2]; 
  F_0c_lx[1] = 0.25*F_0c[1]-0.4330127018922193*F_0c[5]; 
  F_0c_lx[2] = 0.25*F_0c[3]-0.4330127018922193*F_0c[7]; 
  F_0c_lx[3] = 0.25*F_0c[6]-0.4330127018922193*F_0c[11]; 

  F_0c_rx[0] = 0.4330127018922193*F_0c[2]+0.25*F_0c[0]; 
  F_0c_rx[1] = 0.4330127018922193*F_0c[5]+0.25*F_0c[1]; 
  F_0c_rx[2] = 0.4330127018922193*F_0c[7]+0.25*F_0c[3]; 
  F_0c_rx[3] = 0.4330127018922193*F_0c[11]+0.25*F_0c[6]; 

  F_0r_lx[0] = 0.25*F_0r[0]-0.4330127018922193*F_0r[2]; 
  F_0r_lx[1] = 0.25*F_0r[1]-0.4330127018922193*F_0r[5]; 
  F_0r_lx[2] = 0.25*F_0r[3]-0.4330127018922193*F_0r[7]; 
  F_0r_lx[3] = 0.25*F_0r[6]-0.4330127018922193*F_0r[11]; 

  G_1l_rx[0] = 0.4330127018922193*G_1l[2]+0.25*G_1l[0]; 
  G_1l_rx[1] = 0.4330127018922193*G_1l[5]+0.25*G_1l[1]; 
  G_1l_rx[2] = 0.4330127018922193*G_1l[7]+0.25*G_1l[3]; 
  G_1l_rx[3] = 0.4330127018922193*G_1l[11]+0.25*G_1l[6]; 

  G_1c_lx[0] = 0.25*G_1c[0]-0.4330127018922193*G_1c[2]; 
  G_1c_lx[1] = 0.25*G_1c[1]-0.4330127018922193*G_1c[5]; 
  G_1c_lx[2] = 0.25*G_1c[3]-0.4330127018922193*G_1c[7]; 
  G_1c_lx[3] = 0.25*G_1c[6]-0.4330127018922193*G_1c[11]; 

  G_1c_rx[0] = 0.4330127018922193*G_1c[2]+0.25*G_1c[0]; 
  G_1c_rx[1] = 0.4330127018922193*G_1c[5]+0.25*G_1c[1]; 
  G_1c_rx[2] = 0.4330127018922193*G_1c[7]+0.25*G_1c[3]; 
  G_1c_rx[3] = 0.4330127018922193*G_1c[11]+0.25*G_1c[6]; 

  G_1r_lx[0] = 0.25*G_1r[0]-0.4330127018922193*G_1r[2]; 
  G_1r_lx[1] = 0.25*G_1r[1]-0.4330127018922193*G_1r[5]; 
  G_1r_lx[2] = 0.25*G_1r[3]-0.4330127018922193*G_1r[7]; 
  G_1r_lx[3] = 0.25*G_1r[6]-0.4330127018922193*G_1r[11]; 
  ...
  F_0l_rx[0] = 0.4330127018922193*F_0l[5]+0.25*F_0l[1]; 
  F_0l_rx[1] = 0.4330127018922193*F_0l[2]+0.25*F_0l[0]; 
  F_0l_rx[2] = 0.4330127018922193*F_0l[11]+0.25*F_0l[6]; 
  F_0l_rx[3] = 0.4330127018922193*F_0l[7]+0.25*F_0l[3]; 

  F_0c_lx[0] = 0.25*F_0c[1]-0.4330127018922193*F_0c[5]; 
  F_0c_lx[1] = 0.25*F_0c[0]-0.4330127018922193*F_0c[2]; 
  F_0c_lx[2] = 0.25*F_0c[6]-0.4330127018922193*F_0c[11]; 
  F_0c_lx[3] = 0.25*F_0c[3]-0.4330127018922193*F_0c[7]; 

  F_0c_rx[0] = 0.4330127018922193*F_0c[5]+0.25*F_0c[1]; 
  F_0c_rx[1] = 0.4330127018922193*F_0c[2]+0.25*F_0c[0]; 
  F_0c_rx[2] = 0.4330127018922193*F_0c[11]+0.25*F_0c[6]; 
  F_0c_rx[3] = 0.4330127018922193*F_0c[7]+0.25*F_0c[3]; 

  F_0r_lx[0] = 0.25*F_0r[1]-0.4330127018922193*F_0r[5]; 
  F_0r_lx[1] = 0.25*F_0r[0]-0.4330127018922193*F_0r[2]; 
  F_0r_lx[2] = 0.25*F_0r[6]-0.4330127018922193*F_0r[11]; 
  F_0r_lx[3] = 0.25*F_0r[3]-0.4330127018922193*F_0r[7]; 

  G_1l_rx[0] = 0.4330127018922193*G_1l[5]+0.25*G_1l[1]; 
  G_1l_rx[1] = 0.4330127018922193*G_1l[2]+0.25*G_1l[0]; 
  G_1l_rx[2] = 0.4330127018922193*G_1l[11]+0.25*G_1l[6]; 
  G_1l_rx[3] = 0.4330127018922193*G_1l[7]+0.25*G_1l[3]; 

  G_1c_lx[0] = 0.25*G_1c[1]-0.4330127018922193*G_1c[5]; 
  G_1c_lx[1] = 0.25*G_1c[0]-0.4330127018922193*G_1c[2]; 
  G_1c_lx[2] = 0.25*G_1c[6]-0.4330127018922193*G_1c[11]; 
  G_1c_lx[3] = 0.25*G_1c[3]-0.4330127018922193*G_1c[7]; 

  G_1c_rx[0] = 0.4330127018922193*G_1c[5]+0.25*G_1c[1]; 
  G_1c_rx[1] = 0.4330127018922193*G_1c[2]+0.25*G_1c[0]; 
  G_1c_rx[2] = 0.4330127018922193*G_1c[11]+0.25*G_1c[6]; 
  G_1c_rx[3] = 0.4330127018922193*G_1c[7]+0.25*G_1c[3]; 

  G_1r_lx[0] = 0.25*G_1r[1]-0.4330127018922193*G_1r[5]; 
  G_1r_lx[1] = 0.25*G_1r[0]-0.4330127018922193*G_1r[2]; 
  G_1r_lx[2] = 0.25*G_1r[6]-0.4330127018922193*G_1r[11]; 
  G_1r_lx[3] = 0.25*G_1r[3]-0.4330127018922193*G_1r[7]; 
  ...
  F_0l_rx[0] = (-0.75*F_0l[2])-0.4330127018922193*F_0l[0]; 
  F_0l_rx[1] = (-0.75*F_0l[5])-0.4330127018922193*F_0l[1]; 
  F_0l_rx[2] = (-0.75*F_0l[7])-0.4330127018922193*F_0l[3]; 
  F_0l_rx[3] = (-0.75*F_0l[11])-0.4330127018922193*F_0l[6]; 

  F_0c_lx[0] = 0.75*F_0c[2]-0.4330127018922193*F_0c[0]; 
  F_0c_lx[1] = 0.75*F_0c[5]-0.4330127018922193*F_0c[1]; 
  F_0c_lx[2] = 0.75*F_0c[7]-0.4330127018922193*F_0c[3]; 
  F_0c_lx[3] = 0.75*F_0c[11]-0.4330127018922193*F_0c[6]; 

  F_0c_rx[0] = 0.75*F_0c[2]+0.4330127018922193*F_0c[0]; 
  F_0c_rx[1] = 0.75*F_0c[5]+0.4330127018922193*F_0c[1]; 
  F_0c_rx[2] = 0.75*F_0c[7]+0.4330127018922193*F_0c[3]; 
  F_0c_rx[3] = 0.75*F_0c[11]+0.4330127018922193*F_0c[6]; 

  F_0r_lx[0] = 0.4330127018922193*F_0r[0]-0.75*F_0r[2]; 
  F_0r_lx[1] = 0.4330127018922193*F_0r[1]-0.75*F_0r[5]; 
  F_0r_lx[2] = 0.4330127018922193*F_0r[3]-0.75*F_0r[7]; 
  F_0r_lx[3] = 0.4330127018922193*F_0r[6]-0.75*F_0r[11]; 

  G_1l_rx[0] = (-0.75*G_1l[2])-0.4330127018922193*G_1l[0]; 
  G_1l_rx[1] = (-0.75*G_1l[5])-0.4330127018922193*G_1l[1]; 
  G_1l_rx[2] = (-0.75*G_1l[7])-0.4330127018922193*G_1l[3]; 
  G_1l_rx[3] = (-0.75*G_1l[11])-0.4330127018922193*G_1l[6]; 

  G_1c_lx[0] = 0.75*G_1c[2]-0.4330127018922193*G_1c[0]; 
  G_1c_lx[1] = 0.75*G_1c[5]-0.4330127018922193*G_1c[1]; 
  G_1c_lx[2] = 0.75*G_1c[7]-0.4330127018922193*G_1c[3]; 
  G_1c_lx[3] = 0.75*G_1c[11]-0.4330127018922193*G_1c[6]; 

  G_1c_rx[0] = 0.75*G_1c[2]+0.4330127018922193*G_1c[0]; 
  G_1c_rx[1] = 0.75*G_1c[5]+0.4330127018922193*G_1c[1]; 
  G_1c_rx[2] = 0.75*G_1c[7]+0.4330127018922193*G_1c[3]; 
  G_1c_rx[3] = 0.75*G_1c[11]+0.4330127018922193*G_1c[6]; 

  G_1r_lx[0] = 0.4330127018922193*G_1r[0]-0.75*G_1r[2]; 
  G_1r_lx[1] = 0.4330127018922193*G_1r[1]-0.75*G_1r[5]; 
  G_1r_lx[2] = 0.4330127018922193*G_1r[3]-0.75*G_1r[7]; 
  G_1r_lx[3] = 0.4330127018922193*G_1r[6]-0.75*G_1r[11]; 
  ...
  F_0l_rx[0] = 0.4330127018922193*F_0l[7]+0.25*F_0l[3]; 
  F_0l_rx[1] = 0.4330127018922193*F_0l[11]+0.25*F_0l[6]; 
  F_0l_rx[2] = 0.4330127018922193*F_0l[2]+0.25*F_0l[0]; 
  F_0l_rx[3] = 0.4330127018922193*F_0l[5]+0.25*F_0l[1]; 

  F_0c_lx[0] = 0.25*F_0c[3]-0.4330127018922193*F_0c[7]; 
  F_0c_lx[1] = 0.25*F_0c[6]-0.4330127018922193*F_0c[11]; 
  F_0c_lx[2] = 0.25*F_0c[0]-0.4330127018922193*F_0c[2]; 
  F_0c_lx[3] = 0.25*F_0c[1]-0.4330127018922193*F_0c[5]; 

  F_0c_rx[0] = 0.4330127018922193*F_0c[7]+0.25*F_0c[3]; 
  F_0c_rx[1] = 0.4330127018922193*F_0c[11]+0.25*F_0c[6]; 
  F_0c_rx[2] = 0.4330127018922193*F_0c[2]+0.25*F_0c[0]; 
  F_0c_rx[3] = 0.4330127018922193*F_0c[5]+0.25*F_0c[1]; 

  F_0r_lx[0] = 0.25*F_0r[3]-0.4330127018922193*F_0r[7]; 
  F_0r_lx[1] = 0.25*F_0r[6]-0.4330127018922193*F_0r[11]; 
  F_0r_lx[2] = 0.25*F_0r[0]-0.4330127018922193*F_0r[2]; 
  F_0r_lx[3] = 0.25*F_0r[1]-0.4330127018922193*F_0r[5]; 

  G_1l_rx[0] = 0.4330127018922193*G_1l[7]+0.25*G_1l[3]; 
  G_1l_rx[1] = 0.4330127018922193*G_1l[11]+0.25*G_1l[6]; 
  G_1l_rx[2] = 0.4330127018922193*G_1l[2]+0.25*G_1l[0]; 
  G_1l_rx[3] = 0.4330127018922193*G_1l[5]+0.25*G_1l[1]; 

  G_1c_lx[0] = 0.25*G_1c[3]-0.4330127018922193*G_1c[7]; 
  G_1c_lx[1] = 0.25*G_1c[6]-0.4330127018922193*G_1c[11]; 
  G_1c_lx[2] = 0.25*G_1c[0]-0.4330127018922193*G_1c[2]; 
  G_1c_lx[3] = 0.25*G_1c[1]-0.4330127018922193*G_1c[5]; 

  G_1c_rx[0] = 0.4330127018922193*G_1c[7]+0.25*G_1c[3]; 
  G_1c_rx[1] = 0.4330127018922193*G_1c[11]+0.25*G_1c[6]; 
  G_1c_rx[2] = 0.4330127018922193*G_1c[2]+0.25*G_1c[0]; 
  G_1c_rx[3] = 0.4330127018922193*G_1c[5]+0.25*G_1c[1]; 

  G_1r_lx[0] = 0.25*G_1r[3]-0.4330127018922193*G_1r[7]; 
  G_1r_lx[1] = 0.25*G_1r[6]-0.4330127018922193*G_1r[11]; 
  G_1r_lx[2] = 0.25*G_1r[0]-0.4330127018922193*G_1r[2]; 
  G_1r_lx[3] = 0.25*G_1r[1]-0.4330127018922193*G_1r[5]; 
  ...
  F_0l_rx[0] = 0.4330127018922193*F_0l[9]+0.25*F_0l[4]; 
  F_0l_rx[1] = 0.4330127018922193*F_0l[12]+0.25*F_0l[8]; 
  F_0l_rx[2] = 0.4330127018922193*F_0l[14]+0.25*F_0l[10]; 
  F_0l_rx[3] = 0.4330127018922193*F_0l[15]+0.25*F_0l[13]; 

  F_0c_lx[0] = 0.25*F_0c[4]-0.4330127018922193*F_0c[9]; 
  F_0c_lx[1] = 0.25*F_0c[8]-0.4330127018922193*F_0c[12]; 
  F_0c_lx[2] = 0.25*F_0c[10]-0.4330127018922193*F_0c[14]; 
  F_0c_lx[3] = 0.25*F_0c[13]-0.4330127018922193*F_0c[15]; 

  F_0c_rx[0] = 0.4330127018922193*F_0c[9]+0.25*F_0c[4]; 
  F_0c_rx[1] = 0.4330127018922193*F_0c[12]+0.25*F_0c[8]; 
  F_0c_rx[2] = 0.4330127018922193*F_0c[14]+0.25*F_0c[10]; 
  F_0c_rx[3] = 0.4330127018922193*F_0c[15]+0.25*F_0c[13]; 

  F_0r_lx[0] = 0.25*F_0r[4]-0.4330127018922193*F_0r[9]; 
  F_0r_lx[1] = 0.25*F_0r[8]-0.4330127018922193*F_0r[12]; 
  F_0r_lx[2] = 0.25*F_0r[10]-0.4330127018922193*F_0r[14]; 
  F_0r_lx[3] = 0.25*F_0r[13]-0.4330127018922193*F_0r[15]; 

  G_1l_rx[0] = 0.4330127018922193*G_1l[9]+0.25*G_1l[4]; 
  G_1l_rx[1] = 0.4330127018922193*G_1l[12]+0.25*G_1l[8]; 
  G_1l_rx[2] = 0.4330127018922193*G_1l[14]+0.25*G_1l[10]; 
  G_1l_rx[3] = 0.4330127018922193*G_1l[15]+0.25*G_1l[13]; 

  G_1c_lx[0] = 0.25*G_1c[4]-0.4330127018922193*G_1c[9]; 
  G_1c_lx[1] = 0.25*G_1c[8]-0.4330127018922193*G_1c[12]; 
  G_1c_lx[2] = 0.25*G_1c[10]-0.4330127018922193*G_1c[14]; 
  G_1c_lx[3] = 0.25*G_1c[13]-0.4330127018922193*G_1c[15]; 

  G_1c_rx[0] = 0.4330127018922193*G_1c[9]+0.25*G_1c[4]; 
  G_1c_rx[1] = 0.4330127018922193*G_1c[12]+0.25*G_1c[8]; 
  G_1c_rx[2] = 0.4330127018922193*G_1c[14]+0.25*G_1c[10]; 
  G_1c_rx[3] = 0.4330127018922193*G_1c[15]+0.25*G_1c[13]; 

  G_1r_lx[0] = 0.25*G_1r[4]-0.4330127018922193*G_1r[9]; 
  G_1r_lx[1] = 0.25*G_1r[8]-0.4330127018922193*G_1r[12]; 
  G_1r_lx[2] = 0.25*G_1r[10]-0.4330127018922193*G_1r[14]; 
  G_1r_lx[3] = 0.25*G_1r[13]-0.4330127018922193*G_1r[15]; 
  ...
  F_0l_rx[0] = (-0.75*F_0l[5])-0.4330127018922193*F_0l[1]; 
  F_0l_rx[1] = (-0.75*F_0l[2])-0.4330127018922193*F_0l[0]; 
  F_0l_rx[2] = (-0.75*F_0l[11])-0.4330127018922193*F_0l[6]; 
  F_0l_rx[3] = (-0.75*F_0l[7])-0.4330127018922193*F_0l[3]; 

  F_0c_lx[0] = 0.75*F_0c[5]-0.4330127018922193*F_0c[1]; 
  F_0c_lx[1] = 0.75*F_0c[2]-0.4330127018922193*F_0c[0]; 
  F_0c_lx[2] = 0.75*F_0c[11]-0.4330127018922193*F_0c[6]; 
  F_0c_lx[3] = 0.75*F_0c[7]-0.4330127018922193*F_0c[3]; 

  F_0c_rx[0] = 0.75*F_0c[5]+0.4330127018922193*F_0c[1]; 
  F_0c_rx[1] = 0.75*F_0c[2]+0.4330127018922193*F_0c[0]; 
  F_0c_rx[2] = 0.75*F_0c[11]+0.4330127018922193*F_0c[6]; 
  F_0c_rx[3] = 0.75*F_0c[7]+0.4330127018922193*F_0c[3]; 

  F_0r_lx[0] = 0.4330127018922193*F_0r[1]-0.75*F_0r[5]; 
  F_0r_lx[1] = 0.4330127018922193*F_0r[0]-0.75*F_0r[2]; 
  F_0r_lx[2] = 0.4330127018922193*F_0r[6]-0.75*F_0r[11]; 
  F_0r_lx[3] = 0.4330127018922193*F_0r[3]-0.75*F_0r[7]; 

  G_1l_rx[0] = (-0.75*G_1l[5])-0.4330127018922193*G_1l[1]; 
  G_1l_rx[1] = (-0.75*G_1l[2])-0.4330127018922193*G_1l[0]; 
  G_1l_rx[2] = (-0.75*G_1l[11])-0.4330127018922193*G_1l[6]; 
  G_1l_rx[3] = (-0.75*G_1l[7])-0.4330127018922193*G_1l[3]; 

  G_1c_lx[0] = 0.75*G_1c[5]-0.4330127018922193*G_1c[1]; 
  G_1c_lx[1] = 0.75*G_1c[2]-0.4330127018922193*G_1c[0]; 
  G_1c_lx[2] = 0.75*G_1c[11]-0.4330127018922193*G_1c[6]; 
  G_1c_lx[3] = 0.75*G_1c[7]-0.4330127018922193*G_1c[3]; 

  G_1c_rx[0] = 0.75*G_1c[5]+0.4330127018922193*G_1c[1]; 
  G_1c_rx[1] = 0.75*G_1c[2]+0.4330127018922193*G_1c[0]; 
  G_1c_rx[2] = 0.75*G_1c[11]+0.4330127018922193*G_1c[6]; 
  G_1c_rx[3] = 0.75*G_1c[7]+0.4330127018922193*G_1c[3]; 

  G_1r_lx[0] = 0.4330127018922193*G_1r[1]-0.75*G_1r[5]; 
  G_1r_lx[1] = 0.4330127018922193*G_1r[0]-0.75*G_1r[2]; 
  G_1r_lx[2] = 0.4330127018922193*G_1r[6]-0.75*G_1r[11]; 
  G_1r_lx[3] = 0.4330127018922193*G_1r[3]-0.75*G_1r[7]; 
  ...
  F_0l_rx[0] = 0.4330127018922193*F_0l[11]+0.25*F_0l[6]; 
  F_0l_rx[1] = 0.4330127018922193*F_0l[7]+0.25*F_0l[3]; 
  F_0l_rx[2] = 0.4330127018922193*F_0l[5]+0.25*F_0l[1]; 
  F_0l_rx[3] = 0.4330127018922193*F_0l[2]+0.25*F_0l[0]; 

  F_0c_lx[0] = 0.25*F_0c[6]-0.4330127018922193*F_0c[11]; 
  F_0c_lx[1] = 0.25*F_0c[3]-0.4330127018922193*F_0c[7]; 
  F_0c_lx[2] = 0.25*F_0c[1]-0.4330127018922193*F_0c[5]; 
  F_0c_lx[3] = 0.25*F_0c[0]-0.4330127018922193*F_0c[2]; 

  F_0c_rx[0] = 0.4330127018922193*F_0c[11]+0.25*F_0c[6]; 
  F_0c_rx[1] = 0.4330127018922193*F_0c[7]+0.25*F_0c[3]; 
  F_0c_rx[2] = 0.4330127018922193*F_0c[5]+0.25*F_0c[1]; 
  F_0c_rx[3] = 0.4330127018922193*F_0c[2]+0.25*F_0c[0]; 

  F_0r_lx[0] = 0.25*F_0r[6]-0.4330127018922193*F_0r[11]; 
  F_0r_lx[1] = 0.25*F_0r[3]-0.4330127018922193*F_0r[7]; 
  F_0r_lx[2] = 0.25*F_0r[1]-0.4330127018922193*F_0r[5]; 
  F_0r_lx[3] = 0.25*F_0r[0]-0.4330127018922193*F_0r[2]; 

  G_1l_rx[0] = 0.4330127018922193*G_1l[11]+0.25*G_1l[6]; 
  G_1l_rx[1] = 0.4330127018922193*G_1l[7]+0.25*G_1l[3]; 
  G_1l_rx[2] = 0.4330127018922193*G_1l[5]+0.25*G_1l[1]; 
  G_1l_rx[3] = 0.4330127018922193*G_1l[2]+0.25*G_1l[0]; 

  G_1c_lx[0] = 0.25*G_1c[6]-0.4330127018922193*G_1c[11]; 
  G_1c_lx[1] = 0.25*G_1c[3]-0.4330127018922193*G_1c[7]; 
  G_1c_lx[2] = 0.25*G_1c[1]-0.4330127018922193*G_1c[5]; 
  G_1c_lx[3] = 0.25*G_1c[0]-0.4330127018922193*G_1c[2]; 

  G_1c_rx[0] = 0.4330127018922193*G_1c[11]+0.25*G_1c[6]; 
  G_1c_rx[1] = 0.4330127018922193*G_1c[7]+0.25*G_1c[3]; 
  G_1c_rx[2] = 0.4330127018922193*G_1c[5]+0.25*G_1c[1]; 
  G_1c_rx[3] = 0.4330127018922193*G_1c[2]+0.25*G_1c[0]; 

  G_1r_lx[0] = 0.25*G_1r[6]-0.4330127018922193*G_1r[11]; 
  G_1r_lx[1] = 0.25*G_1r[3]-0.4330127018922193*G_1r[7]; 
  G_1r_lx[2] = 0.25*G_1r[1]-0.4330127018922193*G_1r[5]; 
  G_1r_lx[3] = 0.25*G_1r[0]-0.4330127018922193*G_1r[2]; 
  ...
  F_0l_rx[0] = (-0.75*F_0l[7])-0.4330127018922193*F_0l[3]; 
  F_0l_rx[1] = (-0.75*F_0l[11])-0.4330127018922193*F_0l[6]; 
  F_0l_rx[2] = (-0.75*F_0l[2])-0.4330127018922193*F_0l[0]; 
  F_0l_rx[3] = (-0.75*F_0l[5])-0.4330127018922193*F_0l[1]; 

  F_0c_lx[0] = 0.75*F_0c[7]-0.4330127018922193*F_0c[3]; 
  F_0c_lx[1] = 0.75*F_0c[11]-0.4330127018922193*F_0c[6]; 
  F_0c_lx[2] = 0.75*F_0c[2]-0.4330127018922193*F_0c[0]; 
  F_0c_lx[3] = 0.75*F_0c[5]-0.4330127018922193*F_0c[1]; 

  F_0c_rx[0] = 0.75*F_0c[7]+0.4330127018922193*F_0c[3]; 
  F_0c_rx[1] = 0.75*F_0c[11]+0.4330127018922193*F_0c[6]; 
  F_0c_rx[2] = 0.75*F_0c[2]+0.4330127018922193*F_0c[0]; 
  F_0c_rx[3] = 0.75*F_0c[5]+0.4330127018922193*F_0c[1]; 

  F_0r_lx[0] = 0.4330127018922193*F_0r[3]-0.75*F_0r[7]; 
  F_0r_lx[1] = 0.4330127018922193*F_0r[6]-0.75*F_0r[11]; 
  F_0r_lx[2] = 0.4330127018922193*F_0r[0]-0.75*F_0r[2]; 
  F_0r_lx[3] = 0.4330127018922193*F_0r[1]-0.75*F_0r[5]; 

  G_1l_rx[0] = (-0.75*G_1l[7])-0.4330127018922193*G_1l[3]; 
  G_1l_rx[1] = (-0.75*G_1l[11])-0.4330127018922193*G_1l[6]; 
  G_1l_rx[2] = (-0.75*G_1l[2])-0.4330127018922193*G_1l[0]; 
  G_1l_rx[3] = (-0.75*G_1l[5])-0.4330127018922193*G_1l[1]; 

  G_1c_lx[0] = 0.75*G_1c[7]-0.4330127018922193*G_1c[3]; 
  G_1c_lx[1] = 0.75*G_1c[11]-0.4330127018922193*G_1c[6]; 
  G_1c_lx[2] = 0.75*G_1c[2]-0.4330127018922193*G_1c[0]; 
  G_1c_lx[3] = 0.75*G_1c[5]-0.4330127018922193*G_1c[1]; 

  G_1c_rx[0] = 0.75*G_1c[7]+0.4330127018922193*G_1c[3]; 
  G_1c_rx[1] = 0.75*G_1c[11]+0.4330127018922193*G_1c[6]; 
  G_1c_rx[2] = 0.75*G_1c[2]+0.4330127018922193*G_1c[0]; 
  G_1c_rx[3] = 0.75*G_1c[5]+0.4330127018922193*G_1c[1]; 

  G_1r_lx[0] = 0.4330127018922193*G_1r[3]-0.75*G_1r[7]; 
  G_1r_lx[1] = 0.4330127018922193*G_1r[6]-0.75*G_1r[11]; 
  G_1r_lx[2] = 0.4330127018922193*G_1r[0]-0.75*G_1r[2]; 
  G_1r_lx[3] = 0.4330127018922193*G_1r[1]-0.75*G_1r[5]; 
  ...
  F_0l_rx[0] = 0.4330127018922193*F_0l[12]+0.25*F_0l[8]; 
  F_0l_rx[1] = 0.4330127018922193*F_0l[9]+0.25*F_0l[4]; 
  F_0l_rx[2] = 0.4330127018922193*F_0l[15]+0.25*F_0l[13]; 
  F_0l_rx[3] = 0.4330127018922193*F_0l[14]+0.25*F_0l[10]; 

  F_0c_lx[0] = 0.25*F_0c[8]-0.4330127018922193*F_0c[12]; 
  F_0c_lx[1] = 0.25*F_0c[4]-0.4330127018922193*F_0c[9]; 
  F_0c_lx[2] = 0.25*F_0c[13]-0.4330127018922193*F_0c[15]; 
  F_0c_lx[3] = 0.25*F_0c[10]-0.4330127018922193*F_0c[14]; 

  F_0c_rx[0] = 0.4330127018922193*F_0c[12]+0.25*F_0c[8]; 
  F_0c_rx[1] = 0.4330127018922193*F_0c[9]+0.25*F_0c[4]; 
  F_0c_rx[2] = 0.4330127018922193*F_0c[15]+0.25*F_0c[13]; 
  F_0c_rx[3] = 0.4330127018922193*F_0c[14]+0.25*F_0c[10]; 

  F_0r_lx[0] = 0.25*F_0r[8]-0.4330127018922193*F_0r[12]; 
  F_0r_lx[1] = 0.25*F_0r[4]-0.4330127018922193*F_0r[9]; 
  F_0r_lx[2] = 0.25*F_0r[13]-0.4330127018922193*F_0r[15]; 
  F_0r_lx[3] = 0.25*F_0r[10]-0.4330127018922193*F_0r[14]; 

  G_1l_rx[0] = 0.4330127018922193*G_1l[12]+0.25*G_1l[8]; 
  G_1l_rx[1] = 0.4330127018922193*G_1l[9]+0.25*G_1l[4]; 
  G_1l_rx[2] = 0.4330127018922193*G_1l[15]+0.25*G_1l[13]; 
  G_1l_rx[3] = 0.4330127018922193*G_1l[14]+0.25*G_1l[10]; 

  G_1c_lx[0] = 0.25*G_1c[8]-0.4330127018922193*G_1c[12]; 
  G_1c_lx[1] = 0.25*G_1c[4]-0.4330127018922193*G_1c[9]; 
  G_1c_lx[2] = 0.25*G_1c[13]-0.4330127018922193*G_1c[15]; 
  G_1c_lx[3] = 0.25*G_1c[10]-0.4330127018922193*G_1c[14]; 

  G_1c_rx[0] = 0.4330127018922193*G_1c[12]+0.25*G_1c[8]; 
  G_1c_rx[1] = 0.4330127018922193*G_1c[9]+0.25*G_1c[4]; 
  G_1c_rx[2] = 0.4330127018922193*G_1c[15]+0.25*G_1c[13]; 
  G_1c_rx[3] = 0.4330127018922193*G_1c[14]+0.25*G_1c[10]; 

  G_1r_lx[0] = 0.25*G_1r[8]-0.4330127018922193*G_1r[12]; 
  G_1r_lx[1] = 0.25*G_1r[4]-0.4330127018922193*G_1r[9]; 
  G_1r_lx[2] = 0.25*G_1r[13]-0.4330127018922193*G_1r[15]; 
  G_1r_lx[3] = 0.25*G_1r[10]-0.4330127018922193*G_1r[14]; 
  ...
  F_0l_rx[0] = (-0.75*F_0l[9])-0.4330127018922193*F_0l[4]; 
  F_0l_rx[1] = (-0.75*F_0l[12])-0.4330127018922193*F_0l[8]; 
  F_0l_rx[2] = (-0.75*F_0l[14])-0.4330127018922193*F_0l[10]; 
  F_0l_rx[3] = (-0.75*F_0l[15])-0.4330127018922193*F_0l[13]; 

  F_0c_lx[0] = 0.75*F_0c[9]-0.4330127018922193*F_0c[4]; 
  F_0c_lx[1] = 0.75*F_0c[12]-0.4330127018922193*F_0c[8]; 
  F_0c_lx[2] = 0.75*F_0c[14]-0.4330127018922193*F_0c[10]; 
  F_0c_lx[3] = 0.75*F_0c[15]-0.4330127018922193*F_0c[13]; 

  F_0c_rx[0] = 0.75*F_0c[9]+0.4330127018922193*F_0c[4]; 
  F_0c_rx[1] = 0.75*F_0c[12]+0.4330127018922193*F_0c[8]; 
  F_0c_rx[2] = 0.75*F_0c[14]+0.4330127018922193*F_0c[10]; 
  F_0c_rx[3] = 0.75*F_0c[15]+0.4330127018922193*F_0c[13]; 

  F_0r_lx[0] = 0.4330127018922193*F_0r[4]-0.75*F_0r[9]; 
  F_0r_lx[1] = 0.4330127018922193*F_0r[8]-0.75*F_0r[12]; 
  F_0r_lx[2] = 0.4330127018922193*F_0r[10]-0.75*F_0r[14]; 
  F_0r_lx[3] = 0.4330127018922193*F_0r[13]-0.75*F_0r[15]; 

  G_1l_rx[0] = (-0.75*G_1l[9])-0.4330127018922193*G_1l[4]; 
  G_1l_rx[1] = (-0.75*G_1l[12])-0.4330127018922193*G_1l[8]; 
  G_1l_rx[2] = (-0.75*G_1l[14])-0.4330127018922193*G_1l[10]; 
  G_1l_rx[3] = (-0.75*G_1l[15])-0.4330127018922193*G_1l[13]; 

  G_1c_lx[0] = 0.75*G_1c[9]-0.4330127018922193*G_1c[4]; 
  G_1c_lx[1] = 0.75*G_1c[12]-0.4330127018922193*G_1c[8]; 
  G_1c_lx[2] = 0.75*G_1c[14]-0.4330127018922193*G_1c[10]; 
  G_1c_lx[3] = 0.75*G_1c[15]-0.4330127018922193*G_1c[13]; 

  G_1c_rx[0] = 0.75*G_1c[9]+0.4330127018922193*G_1c[4]; 
  G_1c_rx[1] = 0.75*G_1c[12]+0.4330127018922193*G_1c[8]; 
  G_1c_rx[2] = 0.75*G_1c[14]+0.4330127018922193*G_1c[10]; 
  G_1c_rx[3] = 0.75*G_1c[15]+0.4330127018922193*G_1c[13]; 

  G_1r_lx[0] = 0.4330127018922193*G_1r[4]-0.75*G_1r[9]; 
  G_1r_lx[1] = 0.4330127018922193*G_1r[8]-0.75*G_1r[12]; 
  G_1r_lx[2] = 0.4330127018922193*G_1r[10]-0.75*G_1r[14]; 
  G_1r_lx[3] = 0.4330127018922193*G_1r[13]-0.75*G_1r[15]; 
  ...
  F_0l_rx[0] = 0.4330127018922193*F_0l[14]+0.25*F_0l[10]; 
  F_0l_rx[1] = 0.4330127018922193*F_0l[15]+0.25*F_0l[13]; 
  F_0l_rx[2] = 0.4330127018922193*F_0l[9]+0.25*F_0l[4]; 
  F_0l_rx[3] = 0.4330127018922193*F_0l[12]+0.25*F_0l[8]; 

  F_0c_lx[0] = 0.25*F_0c[10]-0.4330127018922193*F_0c[14]; 
  F_0c_lx[1] = 0.25*F_0c[13]-0.4330127018922193*F_0c[15]; 
  F_0c_lx[2] = 0.25*F_0c[4]-0.4330127018922193*F_0c[9]; 
  F_0c_lx[3] = 0.25*F_0c[8]-0.4330127018922193*F_0c[12]; 

  F_0c_rx[0] = 0.4330127018922193*F_0c[14]+0.25*F_0c[10]; 
  F_0c_rx[1] = 0.4330127018922193*F_0c[15]+0.25*F_0c[13]; 
  F_0c_rx[2] = 0.4330127018922193*F_0c[9]+0.25*F_0c[4]; 
  F_0c_rx[3] = 0.4330127018922193*F_0c[12]+0.25*F_0c[8]; 

  F_0r_lx[0] = 0.25*F_0r[10]-0.4330127018922193*F_0r[14]; 
  F_0r_lx[1] = 0.25*F_0r[13]-0.4330127018922193*F_0r[15]; 
  F_0r_lx[2] = 0.25*F_0r[4]-0.4330127018922193*F_0r[9]; 
  F_0r_lx[3] = 0.25*F_0r[8]-0.4330127018922193*F_0r[12]; 

  G_1l_rx[0] = 0.4330127018922193*G_1l[14]+0.25*G_1l[10]; 
  G_1l_rx[1] = 0.4330127018922193*G_1l[15]+0.25*G_1l[13]; 
  G_1l_rx[2] = 0.4330127018922193*G_1l[9]+0.25*G_1l[4]; 
  G_1l_rx[3] = 0.4330127018922193*G_1l[12]+0.25*G_1l[8]; 

  G_1c_lx[0] = 0.25*G_1c[10]-0.4330127018922193*G_1c[14]; 
  G_1c_lx[1] = 0.25*G_1c[13]-0.4330127018922193*G_1c[15]; 
  G_1c_lx[2] = 0.25*G_1c[4]-0.4330127018922193*G_1c[9]; 
  G_1c_lx[3] = 0.25*G_1c[8]-0.4330127018922193*G_1c[12]; 

  G_1c_rx[0] = 0.4330127018922193*G_1c[14]+0.25*G_1c[10]; 
  G_1c_rx[1] = 0.4330127018922193*G_1c[15]+0.25*G_1c[13]; 
  G_1c_rx[2] = 0.4330127018922193*G_1c[9]+0.25*G_1c[4]; 
  G_1c_rx[3] = 0.4330127018922193*G_1c[12]+0.25*G_1c[8]; 

  G_1r_lx[0] = 0.25*G_1r[10]-0.4330127018922193*G_1r[14]; 
  G_1r_lx[1] = 0.25*G_1r[13]-0.4330127018922193*G_1r[15]; 
  G_1r_lx[2] = 0.25*G_1r[4]-0.4330127018922193*G_1r[9]; 
  G_1r_lx[3] = 0.25*G_1r[8]-0.4330127018922193*G_1r[12]; 
  ...
  F_0l_rx[0] = (-0.75*F_0l[11])-0.4330127018922193*F_0l[6]; 
  F_0l_rx[1] = (-0.75*F_0l[7])-0.4330127018922193*F_0l[3]; 
  F_0l_rx[2] = (-0.75*F_0l[5])-0.4330127018922193*F_0l[1]; 
  F_0l_rx[3] = (-0.75*F_0l[2])-0.4330127018922193*F_0l[0]; 

  F_0c_lx[0] = 0.75*F_0c[11]-0.4330127018922193*F_0c[6]; 
  F_0c_lx[1] = 0.75*F_0c[7]-0.4330127018922193*F_0c[3]; 
  F_0c_lx[2] = 0.75*F_0c[5]-0.4330127018922193*F_0c[1]; 
  F_0c_lx[3] = 0.75*F_0c[2]-0.4330127018922193*F_0c[0]; 

  F_0c_rx[0] = 0.75*F_0c[11]+0.4330127018922193*F_0c[6]; 
  F_0c_rx[1] = 0.75*F_0c[7]+0.4330127018922193*F_0c[3]; 
  F_0c_rx[2] = 0.75*F_0c[5]+0.4330127018922193*F_0c[1]; 
  F_0c_rx[3] = 0.75*F_0c[2]+0.4330127018922193*F_0c[0]; 

  F_0r_lx[0] = 0.4330127018922193*F_0r[6]-0.75*F_0r[11]; 
  F_0r_lx[1] = 0.4330127018922193*F_0r[3]-0.75*F_0r[7]; 
  F_0r_lx[2] = 0.4330127018922193*F_0r[1]-0.75*F_0r[5]; 
  F_0r_lx[3] = 0.4330127018922193*F_0r[0]-0.75*F_0r[2]; 

  G_1l_rx[0] = (-0.75*G_1l[11])-0.4330127018922193*G_1l[6]; 
  G_1l_rx[1] = (-0.75*G_1l[7])-0.4330127018922193*G_1l[3]; 
  G_1l_rx[2] = (-0.75*G_1l[5])-0.4330127018922193*G_1l[1]; 
  G_1l_rx[3] = (-0.75*G_1l[2])-0.4330127018922193*G_1l[0]; 

  G_1c_lx[0] = 0.75*G_1c[11]-0.4330127018922193*G_1c[6]; 
  G_1c_lx[1] = 0.75*G_1c[7]-0.4330127018922193*G_1c[3]; 
  G_1c_lx[2] = 0.75*G_1c[5]-0.4330127018922193*G_1c[1]; 
  G_1c_lx[3] = 0.75*G_1c[2]-0.4330127018922193*G_1c[0]; 

  G_1c_rx[0] = 0.75*G_1c[11]+0.4330127018922193*G_1c[6]; 
  G_1c_rx[1] = 0.75*G_1c[7]+0.4330127018922193*G_1c[3]; 
  G_1c_rx[2] = 0.75*G_1c[5]+0.4330127018922193*G_1c[1]; 
  G_1c_rx[3] = 0.75*G_1c[2]+0.4330127018922193*G_1c[0]; 

  G_1r_lx[0] = 0.4330127018922193*G_1r[6]-0.75*G_1r[11]; 
  G_1r_lx[1] = 0.4330127018922193*G_1r[3]-0.75*G_1r[7]; 
  G_1r_lx[2] = 0.4330127018922193*G_1r[1]-0.75*G_1r[5]; 
  G_1r_lx[3] = 0.4330127018922193*G_1r[0]-0.75*G_1r[2]; 
  ...
  F_0l_rx[0] = (-0.75*F_0l[12])-0.4330127018922193*F_0l[8]; 
  F_0l_rx[1] = (-0.75*F_0l[9])-0.4330127018922193*F_0l[4]; 
  F_0l_rx[2] = (-0.75*F_0l[15])-0.4330127018922193*F_0l[13]; 
  F_0l_rx[3] = (-0.75*F_0l[14])-0.4330127018922193*F_0l[10]; 

  F_0c_lx[0] = 0.75*F_0c[12]-0.4330127018922193*F_0c[8]; 
  F_0c_lx[1] = 0.75*F_0c[9]-0.4330127018922193*F_0c[4]; 
  F_0c_lx[2] = 0.75*F_0c[15]-0.4330127018922193*F_0c[13]; 
  F_0c_lx[3] = 0.75*F_0c[14]-0.4330127018922193*F_0c[10]; 

  F_0c_rx[0] = 0.75*F_0c[12]+0.4330127018922193*F_0c[8]; 
  F_0c_rx[1] = 0.75*F_0c[9]+0.4330127018922193*F_0c[4]; 
  F_0c_rx[2] = 0.75*F_0c[15]+0.4330127018922193*F_0c[13]; 
  F_0c_rx[3] = 0.75*F_0c[14]+0.4330127018922193*F_0c[10]; 

  F_0r_lx[0] = 0.4330127018922193*F_0r[8]-0.75*F_0r[12]; 
  F_0r_lx[1] = 0.4330127018922193*F_0r[4]-0.75*F_0r[9]; 
  F_0r_lx[2] = 0.4330127018922193*F_0r[13]-0.75*F_0r[15]; 
  F_0r_lx[3] = 0.4330127018922193*F_0r[10]-0.75*F_0r[14]; 

  G_1l_rx[0] = (-0.75*G_1l[12])-0.4330127018922193*G_1l[8]; 
  G_1l_rx[1] = (-0.75*G_1l[9])-0.4330127018922193*G_1l[4]; 
  G_1l_rx[2] = (-0.75*G_1l[15])-0.4330127018922193*G_1l[13]; 
  G_1l_rx[3] = (-0.75*G_1l[14])-0.4330127018922193*G_1l[10]; 

  G_1c_lx[0] = 0.75*G_1c[12]-0.4330127018922193*G_1c[8]; 
  G_1c_lx[1] = 0.75*G_1c[9]-0.4330127018922193*G_1c[4]; 
  G_1c_lx[2] = 0.75*G_1c[15]-0.4330127018922193*G_1c[13]; 
  G_1c_lx[3] = 0.75*G_1c[14]-0.4330127018922193*G_1c[10]; 

  G_1c_rx[0] = 0.75*G_1c[12]+0.4330127018922193*G_1c[8]; 
  G_1c_rx[1] = 0.75*G_1c[9]+0.4330127018922193*G_1c[4]; 
  G_1c_rx[2] = 0.75*G_1c[15]+0.4330127018922193*G_1c[13]; 
  G_1c_rx[3] = 0.75*G_1c[14]+0.4330127018922193*G_1c[10]; 

  G_1r_lx[0] = 0.4330127018922193*G_1r[8]-0.75*G_1r[12]; 
  G_1r_lx[1] = 0.4330127018922193*G_1r[4]-0.75*G_1r[9]; 
  G_1r_lx[2] = 0.4330127018922193*G_1r[13]-0.75*G_1r[15]; 
  G_1r_lx[3] = 0.4330127018922193*G_1r[10]-0.75*G_1r[14]; 
  ...
  F_0l_rx[0] = 0.4330127018922193*F_0l[15]+0.25*F_0l[13]; 
  F_0l_rx[1] = 0.4330127018922193*F_0l[14]+0.25*F_0l[10]; 
  F_0l_rx[2] = 0.4330127018922193*F_0l[12]+0.25*F_0l[8]; 
  F_0l_rx[3] = 0.4330127018922193*F_0l[9]+0.25*F_0l[4]; 

  F_0c_lx[0] = 0.25*F_0c[13]-0.4330127018922193*F_0c[15]; 
  F_0c_lx[1] = 0.25*F_0c[10]-0.4330127018922193*F_0c[14]; 
  F_0c_lx[2] = 0.25*F_0c[8]-0.4330127018922193*F_0c[12]; 
  F_0c_lx[3] = 0.25*F_0c[4]-0.4330127018922193*F_0c[9]; 

  F_0c_rx[0] = 0.4330127018922193*F_0c[15]+0.25*F_0c[13]; 
  F_0c_rx[1] = 0.4330127018922193*F_0c[14]+0.25*F_0c[10]; 
  F_0c_rx[2] = 0.4330127018922193*F_0c[12]+0.25*F_0c[8]; 
  F_0c_rx[3] = 0.4330127018922193*F_0c[9]+0.25*F_0c[4]; 

  F_0r_lx[0] = 0.25*F_0r[13]-0.4330127018922193*F_0r[15]; 
  F_0r_lx[1] = 0.25*F_0r[10]-0.4330127018922193*F_0r[14]; 
  F_0r_lx[2] = 0.25*F_0r[8]-0.4330127018922193*F_0r[12]; 
  F_0r_lx[3] = 0.25*F_0r[4]-0.4330127018922193*F_0r[9]; 

  G_1l_rx[0] = 0.4330127018922193*G_1l[15]+0.25*G_1l[13]; 
  G_1l_rx[1] = 0.4330127018922193*G_1l[14]+0.25*G_1l[10]; 
  G_1l_rx[2] = 0.4330127018922193*G_1l[12]+0.25*G_1l[8]; 
  G_1l_rx[3] = 0.4330127018922193*G_1l[9]+0.25*G_1l[4]; 

  G_1c_lx[0] = 0.25*G_1c[13]-0.4330127018922193*G_1c[15]; 
  G_1c_lx[1] = 0.25*G_1c[10]-0.4330127018922193*G_1c[14]; 
  G_1c_lx[2] = 0.25*G_1c[8]-0.4330127018922193*G_1c[12]; 
  G_1c_lx[3] = 0.25*G_1c[4]-0.4330127018922193*G_1c[9]; 

  G_1c_rx[0] = 0.4330127018922193*G_1c[15]+0.25*G_1c[13]; 
  G_1c_rx[1] = 0.4330127018922193*G_1c[14]+0.25*G_1c[10]; 
  G_1c_rx[2] = 0.4330127018922193*G_1c[12]+0.25*G_1c[8]; 
  G_1c_rx[3] = 0.4330127018922193*G_1c[9]+0.25*G_1c[4]; 

  G_1r_lx[0] = 0.25*G_1r[13]-0.4330127018922193*G_1r[15]; 
  G_1r_lx[1] = 0.25*G_1r[10]-0.4330127018922193*G_1r[14]; 
  G_1r_lx[2] = 0.25*G_1r[8]-0.4330127018922193*G_1r[12]; 
  G_1r_lx[3] = 0.25*G_1r[4]-0.4330127018922193*G_1r[9]; 
  ...
  F_0l_rx[0] = (-0.75*F_0l[14])-0.4330127018922193*F_0l[10]; 
  F_0l_rx[1] = (-0.75*F_0l[15])-0.4330127018922193*F_0l[13]; 
  F_0l_rx[2] = (-0.75*F_0l[9])-0.4330127018922193*F_0l[4]; 
  F_0l_rx[3] = (-0.75*F_0l[12])-0.4330127018922193*F_0l[8]; 

  F_0c_lx[0] = 0.75*F_0c[14]-0.4330127018922193*F_0c[10]; 
  F_0c_lx[1] = 0.75*F_0c[15]-0.4330127018922193*F_0c[13]; 
  F_0c_lx[2] = 0.75*F_0c[9]-0.4330127018922193*F_0c[4]; 
  F_0c_lx[3] = 0.75*F_0c[12]-0.4330127018922193*F_0c[8]; 

  F_0c_rx[0] = 0.75*F_0c[14]+0.4330127018922193*F_0c[10]; 
  F_0c_rx[1] = 0.75*F_0c[15]+0.4330127018922193*F_0c[13]; 
  F_0c_rx[2] = 0.75*F_0c[9]+0.4330127018922193*F_0c[4]; 
  F_0c_rx[3] = 0.75*F_0c[12]+0.4330127018922193*F_0c[8]; 

  F_0r_lx[0] = 0.4330127018922193*F_0r[10]-0.75*F_0r[14]; 
  F_0r_lx[1] = 0.4330127018922193*F_0r[13]-0.75*F_0r[15]; 
  F_0r_lx[2] = 0.4330127018922193*F_0r[4]-0.75*F_0r[9]; 
  F_0r_lx[3] = 0.4330127018922193*F_0r[8]-0.75*F_0r[12]; 

  G_1l_rx[0] = (-0.75*G_1l[14])-0.4330127018922193*G_1l[10]; 
  G_1l_rx[1] = (-0.75*G_1l[15])-0.4330127018922193*G_1l[13]; 
  G_1l_rx[2] = (-0.75*G_1l[9])-0.4330127018922193*G_1l[4]; 
  G_1l_rx[3] = (-0.75*G_1l[12])-0.4330127018922193*G_1l[8]; 

  G_1c_lx[0] = 0.75*G_1c[14]-0.4330127018922193*G_1c[10]; 
  G_1c_lx[1] = 0.75*G_1c[15]-0.4330127018922193*G_1c[13]; 
  G_1c_lx[2] = 0.75*G_1c[9]-0.4330127018922193*G_1c[4]; 
  G_1c_lx[3] = 0.75*G_1c[12]-0.4330127018922193*G_1c[8]; 

  G_1c_rx[0] = 0.75*G_1c[14]+0.4330127018922193*G_1c[10]; 
  G_1c_rx[1] = 0.75*G_1c[15]+0.4330127018922193*G_1c[13]; 
  G_1c_rx[2] = 0.75*G_1c[9]+0.4330127018922193*G_1c[4]; 
  G_1c_rx[3] = 0.75*G_1c[12]+0.4330127018922193*G_1c[8]; 

  G_1r_lx[0] = 0.4330127018922193*G_1r[10]-0.75*G_1r[14]; 
  G_1r_lx[1] = 0.4330127018922193*G_1r[13]-0.75*G_1r[15]; 
  G_1r_lx[2] = 0.4330127018922193*G_1r[4]-0.75*G_1r[9]; 
  G_1r_lx[3] = 0.4330127018922193*G_1r[8]-0.75*G_1r[12]; 
  ...
  F_0l_rx[0] = (-0.75*F_0l[15])-0.4330127018922193*F_0l[13]; 
  F_0l_rx[1] = (-0.75*F_0l[14])-0.4330127018922193*F_0l[10]; 
  F_0l_rx[2] = (-0.75*F_0l[12])-0.4330127018922193*F_0l[8]; 
  F_0l_rx[3] = (-0.75*F_0l[9])-0.4330127018922193*F_0l[4]; 

  F_0c_lx[0] = 0.75*F_0c[15]-0.4330127018922193*F_0c[13]; 
  F_0c_lx[1] = 0.75*F_0c[14]-0.4330127018922193*F_0c[10]; 
  F_0c_lx[2] = 0.75*F_0c[12]-0.4330127018922193*F_0c[8]; 
  F_0c_lx[3] = 0.75*F_0c[9]-0.4330127018922193*F_0c[4]; 

  F_0c_rx[0] = 0.75*F_0c[15]+0.4330127018922193*F_0c[13]; 
  F_0c_rx[1] = 0.75*F_0c[14]+0.4330127018922193*F_0c[10]; 
  F_0c_rx[2] = 0.75*F_0c[12]+0.4330127018922193*F_0c[8]; 
  F_0c_rx[3] = 0.75*F_0c[9]+0.4330127018922193*F_0c[4]; 

  F_0r_lx[0] = 0.4330127018922193*F_0r[13]-0.75*F_0r[15]; 
  F_0r_lx[1] = 0.4330127018922193*F_0r[10]-0.75*F_0r[14]; 
  F_0r_lx[2] = 0.4330127018922193*F_0r[8]-0.75*F_0r[12]; 
  F_0r_lx[3] = 0.4330127018922193*F_0r[4]-0.75*F_0r[9]; 

  G_1l_rx[0] = (-0.75*G_1l[15])-0.4330127018922193*G_1l[13]; 
  G_1l_rx[1] = (-0.75*G_1l[14])-0.4330127018922193*G_1l[10]; 
  G_1l_rx[2] = (-0.75*G_1l[12])-0.4330127018922193*G_1l[8]; 
  G_1l_rx[3] = (-0.75*G_1l[9])-0.4330127018922193*G_1l[4]; 

  G_1c_lx[0] = 0.75*G_1c[15]-0.4330127018922193*G_1c[13]; 
  G_1c_lx[1] = 0.75*G_1c[14]-0.4330127018922193*G_1c[10]; 
  G_1c_lx[2] = 0.75*G_1c[12]-0.4330127018922193*G_1c[8]; 
  G_1c_lx[3] = 0.75*G_1c[9]-0.4330127018922193*G_1c[4]; 

  G_1c_rx[0] = 0.75*G_1c[15]+0.4330127018922193*G_1c[13]; 
  G_1c_rx[1] = 0.75*G_1c[14]+0.4330127018922193*G_1c[10]; 
  G_1c_rx[2] = 0.75*G_1c[12]+0.4330127018922193*G_1c[8]; 
  G_1c_rx[3] = 0.75*G_1c[9]+0.4330127018922193*G_1c[4]; 

  G_1r_lx[0] = 0.4330127018922193*G_1r[13]-0.75*G_1r[15]; 
  G_1r_lx[1] = 0.4330127018922193*G_1r[10]-0.75*G_1r[14]; 
  G_1r_lx[2] = 0.4330127018922193*G_1r[8]-0.75*G_1r[12]; 
  G_1r_lx[3] = 0.4330127018922193*G_1r[4]-0.75*G_1r[9]; 
  ...
  F_0l_rx[0] = 0.4330127018922194*F_0l[18]+0.25*F_0l[16]; 
  F_0l_rx[1] = 0.4330127018922193*F_0l[20]+0.2500000000000001*F_0l[17]; 
  F_0l_rx[2] = 0.4330127018922193*F_0l[22]+0.2500000000000001*F_0l[19]; 
  F_0l_rx[3] = 0.4330127018922194*F_0l[23]+0.25*F_0l[21]; 

  F_0c_lx[0] = 0.25*F_0c[16]-0.4330127018922194*F_0c[18]; 
  F_0c_lx[1] = 0.2500000000000001*F_0c[17]-0.4330127018922193*F_0c[20]; 
  F_0c_lx[2] = 0.2500000000000001*F_0c[19]-0.4330127018922193*F_0c[22]; 
  F_0c_lx[3] = 0.25*F_0c[21]-0.4330127018922194*F_0c[23]; 

  F_0c_rx[0] = 0.4330127018922194*F_0c[18]+0.25*F_0c[16]; 
  F_0c_rx[1] = 0.4330127018922193*F_0c[20]+0.2500000000000001*F_0c[17]; 
  F_0c_rx[2] = 0.4330127018922193*F_0c[22]+0.2500000000000001*F_0c[19]; 
  F_0c_rx[3] = 0.4330127018922194*F_0c[23]+0.25*F_0c[21]; 

  F_0r_lx[0] = 0.25*F_0r[16]-0.4330127018922194*F_0r[18]; 
  F_0r_lx[1] = 0.2500000000000001*F_0r[17]-0.4330127018922193*F_0r[20]; 
  F_0r_lx[2] = 0.2500000000000001*F_0r[19]-0.4330127018922193*F_0r[22]; 
  F_0r_lx[3] = 0.25*F_0r[21]-0.4330127018922194*F_0r[23]; 

  G_1l_rx[0] = 0.4330127018922194*G_1l[18]+0.25*G_1l[16]; 
  G_1l_rx[1] = 0.4330127018922193*G_1l[20]+0.2500000000000001*G_1l[17]; 
  G_1l_rx[2] = 0.4330127018922193*G_1l[22]+0.2500000000000001*G_1l[19]; 
  G_1l_rx[3] = 0.4330127018922194*G_1l[23]+0.25*G_1l[21]; 

  G_1c_lx[0] = 0.25*G_1c[16]-0.4330127018922194*G_1c[18]; 
  G_1c_lx[1] = 0.2500000000000001*G_1c[17]-0.4330127018922193*G_1c[20]; 
  G_1c_lx[2] = 0.2500000000000001*G_1c[19]-0.4330127018922193*G_1c[22]; 
  G_1c_lx[3] = 0.25*G_1c[21]-0.4330127018922194*G_1c[23]; 

  G_1c_rx[0] = 0.4330127018922194*G_1c[18]+0.25*G_1c[16]; 
  G_1c_rx[1] = 0.4330127018922193*G_1c[20]+0.2500000000000001*G_1c[17]; 
  G_1c_rx[2] = 0.4330127018922193*G_1c[22]+0.2500000000000001*G_1c[19]; 
  G_1c_rx[3] = 0.4330127018922194*G_1c[23]+0.25*G_1c[21]; 

  G_1r_lx[0] = 0.25*G_1r[16]-0.4330127018922194*G_1r[18]; 
  G_1r_lx[1] = 0.2500000000000001*G_1r[17]-0.4330127018922193*G_1r[20]; 
  G_1r_lx[2] = 0.2500000000000001*G_1r[19]-0.4330127018922193*G_1r[22]; 
  G_1r_lx[3] = 0.25*G_1r[21]-0.4330127018922194*G_1r[23]; 
  ...
  F_0l_rx[0] = 0.4330127018922194*F_0l[20]+0.25*F_0l[17]; 
  F_0l_rx[1] = 0.4330127018922193*F_0l[18]+0.2500000000000001*F_0l[16]; 
  F_0l_rx[2] = 0.4330127018922193*F_0l[23]+0.2500000000000001*F_0l[21]; 
  F_0l_rx[3] = 0.4330127018922194*F_0l[22]+0.25*F_0l[19]; 

  F_0c_lx[0] = 0.25*F_0c[17]-0.4330127018922194*F_0c[20]; 
  F_0c_lx[1] = 0.2500000000000001*F_0c[16]-0.4330127018922193*F_0c[18]; 
  F_0c_lx[2] = 0.2500000000000001*F_0c[21]-0.4330127018922193*F_0c[23]; 
  F_0c_lx[3] = 0.25*F_0c[19]-0.4330127018922194*F_0c[22]; 

  F_0c_rx[0] = 0.4330127018922194*F_0c[20]+0.25*F_0c[17]; 
  F_0c_rx[1] = 0.4330127018922193*F_0c[18]+0.2500000000000001*F_0c[16]; 
  F_0c_rx[2] = 0.4330127018922193*F_0c[23]+0.2500000000000001*F_0c[21]; 
  F_0c_rx[3] = 0.4330127018922194*F_0c[22]+0.25*F_0c[19]; 

  F_0r_lx[0] = 0.25*F_0r[17]-0.4330127018922194*F_0r[20]; 
  F_0r_lx[1] = 0.2500000000000001*F_0r[16]-0.4330127018922193*F_0r[18]; 
  F_0r_lx[2] = 0.2500000000000001*F_0r[21]-0.4330127018922193*F_0r[23]; 
  F_0r_lx[3] = 0.25*F_0r[19]-0.4330127018922194*F_0r[22]; 

  G_1l_rx[0] = 0.4330127018922194*G_1l[20]+0.25*G_1l[17]; 
  G_1l_rx[1] = 0.4330127018922193*G_1l[18]+0.2500000000000001*G_1l[16]; 
  G_1l_rx[2] = 0.4330127018922193*G_1l[23]+0.2500000000000001*G_1l[21]; 
  G_1l_rx[3] = 0.4330127018922194*G_1l[22]+0.25*G_1l[19]; 

  G_1c_lx[0] = 0.25*G_1c[17]-0.4330127018922194*G_1c[20]; 
  G_1c_lx[1] = 0.2500000000000001*G_1c[16]-0.4330127018922193*G_1c[18]; 
  G_1c_lx[2] = 0.2500000000000001*G_1c[21]-0.4330127018922193*G_1c[23]; 
  G_1c_lx[3] = 0.25*G_1c[19]-0.4330127018922194*G_1c[22]; 

  G_1c_rx[0] = 0.4330127018922194*G_1c[20]+0.25*G_1c[17]; 
  G_1c_rx[1] = 0.4330127018922193*G_1c[18]+0.2500000000000001*G_1c[16]; 
  G_1c_rx[2] = 0.4330127018922193*G_1c[23]+0.2500000000000001*G_1c[21]; 
  G_1c_rx[3] = 0.4330127018922194*G_1c[22]+0.25*G_1c[19]; 

  G_1r_lx[0] = 0.25*G_1r[17]-0.4330127018922194*G_1r[20]; 
  G_1r_lx[1] = 0.2500000000000001*G_1r[16]-0.4330127018922193*G_1r[18]; 
  G_1r_lx[2] = 0.2500000000000001*G_1r[21]-0.4330127018922193*G_1r[23]; 
  G_1r_lx[3] = 0.25*G_1r[19]-0.4330127018922194*G_1r[22]; 
  ...
  F_0l_rx[0] = (-0.75*F_0l[18])-0.4330127018922194*F_0l[16]; 
  F_0l_rx[1] = (-0.75*F_0l[20])-0.4330127018922193*F_0l[17]; 
  F_0l_rx[2] = (-0.75*F_0l[22])-0.4330127018922193*F_0l[19]; 
  F_0l_rx[3] = (-0.75*F_0l[23])-0.4330127018922194*F_0l[21]; 

  F_0c_lx[0] = 0.75*F_0c[18]-0.4330127018922194*F_0c[16]; 
  F_0c_lx[1] = 0.75*F_0c[20]-0.4330127018922193*F_0c[17]; 
  F_0c_lx[2] = 0.75*F_0c[22]-0.4330127018922193*F_0c[19]; 
  F_0c_lx[3] = 0.75*F_0c[23]-0.4330127018922194*F_0c[21]; 

  F_0c_rx[0] = 0.75*F_0c[18]+0.4330127018922194*F_0c[16]; 
  F_0c_rx[1] = 0.75*F_0c[20]+0.4330127018922193*F_0c[17]; 
  F_0c_rx[2] = 0.75*F_0c[22]+0.4330127018922193*F_0c[19]; 
  F_0c_rx[3] = 0.75*F_0c[23]+0.4330127018922194*F_0c[21]; 

  F_0r_lx[0] = 0.4330127018922194*F_0r[16]-0.75*F_0r[18]; 
  F_0r_lx[1] = 0.4330127018922193*F_0r[17]-0.75*F_0r[20]; 
  F_0r_lx[2] = 0.4330127018922193*F_0r[19]-0.75*F_0r[22]; 
  F_0r_lx[3] = 0.4330127018922194*F_0r[21]-0.75*F_0r[23]; 

  G_1l_rx[0] = (-0.75*G_1l[18])-0.4330127018922194*G_1l[16]; 
  G_1l_rx[1] = (-0.75*G_1l[20])-0.4330127018922193*G_1l[17]; 
  G_1l_rx[2] = (-0.75*G_1l[22])-0.4330127018922193*G_1l[19]; 
  G_1l_rx[3] = (-0.75*G_1l[23])-0.4330127018922194*G_1l[21]; 

  G_1c_lx[0] = 0.75*G_1c[18]-0.4330127018922194*G_1c[16]; 
  G_1c_lx[1] = 0.75*G_1c[20]-0.4330127018922193*G_1c[17]; 
  G_1c_lx[2] = 0.75*G_1c[22]-0.4330127018922193*G_1c[19]; 
  G_1c_lx[3] = 0.75*G_1c[23]-0.4330127018922194*G_1c[21]; 

  G_1c_rx[0] = 0.75*G_1c[18]+0.4330127018922194*G_1c[16]; 
  G_1c_rx[1] = 0.75*G_1c[20]+0.4330127018922193*G_1c[17]; 
  G_1c_rx[2] = 0.75*G_1c[22]+0.4330127018922193*G_1c[19]; 
  G_1c_rx[3] = 0.75*G_1c[23]+0.4330127018922194*G_1c[21]; 

  G_1r_lx[0] = 0.4330127018922194*G_1r[16]-0.75*G_1r[18]; 
  G_1r_lx[1] = 0.4330127018922193*G_1r[17]-0.75*G_1r[20]; 
  G_1r_lx[2] = 0.4330127018922193*G_1r[19]-0.75*G_1r[22]; 
  G_1r_lx[3] = 0.4330127018922194*G_1r[21]-0.75*G_1r[23]; 
  ...
  F_0l_rx[0] = 0.4330127018922194*F_0l[22]+0.25*F_0l[19]; 
  F_0l_rx[1] = 0.4330127018922193*F_0l[23]+0.2500000000000001*F_0l[21]; 
  F_0l_rx[2] = 0.4330127018922193*F_0l[18]+0.2500000000000001*F_0l[16]; 
  F_0l_rx[3] = 0.4330127018922194*F_0l[20]+0.25*F_0l[17]; 

  F_0c_lx[0] = 0.25*F_0c[19]-0.4330127018922194*F_0c[22]; 
  F_0c_lx[1] = 0.2500000000000001*F_0c[21]-0.4330127018922193*F_0c[23]; 
  F_0c_lx[2] = 0.2500000000000001*F_0c[16]-0.4330127018922193*F_0c[18]; 
  F_0c_lx[3] = 0.25*F_0c[17]-0.4330127018922194*F_0c[20]; 

  F_0c_rx[0] = 0.4330127018922194*F_0c[22]+0.25*F_0c[19]; 
  F_0c_rx[1] = 0.4330127018922193*F_0c[23]+0.2500000000000001*F_0c[21]; 
  F_0c_rx[2] = 0.4330127018922193*F_0c[18]+0.2500000000000001*F_0c[16]; 
  F_0c_rx[3] = 0.4330127018922194*F_0c[20]+0.25*F_0c[17]; 

  F_0r_lx[0] = 0.25*F_0r[19]-0.4330127018922194*F_0r[22]; 
  F_0r_lx[1] = 0.2500000000000001*F_0r[21]-0.4330127018922193*F_0r[23]; 
  F_0r_lx[2] = 0.2500000000000001*F_0r[16]-0.4330127018922193*F_0r[18]; 
  F_0r_lx[3] = 0.25*F_0r[17]-0.4330127018922194*F_0r[20]; 

  G_1l_rx[0] = 0.4330127018922194*G_1l[22]+0.25*G_1l[19]; 
  G_1l_rx[1] = 0.4330127018922193*G_1l[23]+0.2500000000000001*G_1l[21]; 
  G_1l_rx[2] = 0.4330127018922193*G_1l[18]+0.2500000000000001*G_1l[16]; 
  G_1l_rx[3] = 0.4330127018922194*G_1l[20]+0.25*G_1l[17]; 

  G_1c_lx[0] = 0.25*G_1c[19]-0.4330127018922194*G_1c[22]; 
  G_1c_lx[1] = 0.2500000000000001*G_1c[21]-0.4330127018922193*G_1c[23]; 
  G_1c_lx[2] = 0.2500000000000001*G_1c[16]-0.4330127018922193*G_1c[18]; 
  G_1c_lx[3] = 0.25*G_1c[17]-0.4330127018922194*G_1c[20]; 

  G_1c_rx[0] = 0.4330127018922194*G_1c[22]+0.25*G_1c[19]; 
  G_1c_rx[1] = 0.4330127018922193*G_1c[23]+0.2500000000000001*G_1c[21]; 
  G_1c_rx[2] = 0.4330127018922193*G_1c[18]+0.2500000000000001*G_1c[16]; 
  G_1c_rx[3] = 0.4330127018922194*G_1c[20]+0.25*G_1c[17]; 

  G_1r_lx[0] = 0.25*G_1r[19]-0.4330127018922194*G_1r[22]; 
  G_1r_lx[1] = 0.2500000000000001*G_1r[21]-0.4330127018922193*G_1r[23]; 
  G_1r_lx[2] = 0.2500000000000001*G_1r[16]-0.4330127018922193*G_1r[18]; 
  G_1r_lx[3] = 0.25*G_1r[17]-0.4330127018922194*G_1r[20]; 
  ...
  F_0l_rx[0] = (-0.75*F_0l[20])-0.4330127018922194*F_0l[17]; 
  F_0l_rx[1] = (-0.75*F_0l[18])-0.4330127018922193*F_0l[16]; 
  F_0l_rx[2] = (-0.75*F_0l[23])-0.4330127018922193*F_0l[21]; 
  F_0l_rx[3] = (-0.75*F_0l[22])-0.4330127018922194*F_0l[19]; 

  F_0c_lx[0] = 0.75*F_0c[20]-0.4330127018922194*F_0c[17]; 
  F_0c_lx[1] = 0.75*F_0c[18]-0.4330127018922193*F_0c[16]; 
  F_0c_lx[2] = 0.75*F_0c[23]-0.4330127018922193*F_0c[21]; 
  F_0c_lx[3] = 0.75*F_0c[22]-0.4330127018922194*F_0c[19]; 

  F_0c_rx[0] = 0.75*F_0c[20]+0.4330127018922194*F_0c[17]; 
  F_0c_rx[1] = 0.75*F_0c[18]+0.4330127018922193*F_0c[16]; 
  F_0c_rx[2] = 0.75*F_0c[23]+0.4330127018922193*F_0c[21]; 
  F_0c_rx[3] = 0.75*F_0c[22]+0.4330127018922194*F_0c[19]; 

  F_0r_lx[0] = 0.4330127018922194*F_0r[17]-0.75*F_0r[20]; 
  F_0r_lx[1] = 0.4330127018922193*F_0r[16]-0.75*F_0r[18]; 
  F_0r_lx[2] = 0.4330127018922193*F_0r[21]-0.75*F_0r[23]; 
  F_0r_lx[3] = 0.4330127018922194*F_0r[19]-0.75*F_0r[22]; 

  G_1l_rx[0] = (-0.75*G_1l[20])-0.4330127018922194*G_1l[17]; 
  G_1l_rx[1] = (-0.75*G_1l[18])-0.4330127018922193*G_1l[16]; 
  G_1l_rx[2] = (-0.75*G_1l[23])-0.4330127018922193*G_1l[21]; 
  G_1l_rx[3] = (-0.75*G_1l[22])-0.4330127018922194*G_1l[19]; 

  G_1c_lx[0] = 0.75*G_1c[20]-0.4330127018922194*G_1c[17]; 
  G_1c_lx[1] = 0.75*G_1c[18]-0.4330127018922193*G_1c[16]; 
  G_1c_lx[2] = 0.75*G_1c[23]-0.4330127018922193*G_1c[21]; 
  G_1c_lx[3] = 0.75*G_1c[22]-0.4330127018922194*G_1c[19]; 

  G_1c_rx[0] = 0.75*G_1c[20]+0.4330127018922194*G_1c[17]; 
  G_1c_rx[1] = 0.75*G_1c[18]+0.4330127018922193*G_1c[16]; 
  G_1c_rx[2] = 0.75*G_1c[23]+0.4330127018922193*G_1c[21]; 
  G_1c_rx[3] = 0.75*G_1c[22]+0.4330127018922194*G_1c[19]; 

  G_1r_lx[0] = 0.4330127018922194*G_1r[17]-0.75*G_1r[20]; 
  G_1r_lx[1] = 0.4330127018922193*G_1r[16]-0.75*G_1r[18]; 
  G_1r_lx[2] = 0.4330127018922193*G_1r[21]-0.75*G_1r[23]; 
  G_1r_lx[3] = 0.4330127018922194*G_1r[19]-0.75*G_1r[22]; 

  out_F_0[20] += 0.5*dx1*(F_0r_lx[3]*max_speed_modal_r[3]-1.0*F_0c_rx[3]*max_speed_modal_r[3]+F_0l_rx[3]*max_speed_modal_l[3]-1.0*F_0c_lx[3]*max_speed_modal_l[3]-1.0*F_0r_lx[3]*avg_u_r[3]-1.0*F_0c_rx[3]*avg_u_r[3]+F_0l_rx[3]*avg_u_l[3]+F_0c_lx[3]*avg_u_l[3]+F_0r_lx[2]*max_speed_modal_r[2]-1.0*F_0c_rx[2]*max_speed_modal_r[2]+F_0l_rx[2]*max_speed_modal_l[2]-1.0*F_0c_lx[2]*max_speed_modal_l[2]-1.0*F_0r_lx[2]*avg_u_r[2]-1.0*F_0c_rx[2]*avg_u_r[2]+F_0l_rx[2]*avg_u_l[2]+F_0c_lx[2]*avg_u_l[2]+F_0r_lx[1]*max_speed_modal_r[1]-1.0*F_0c_rx[1]*max_speed_modal_r[1]+F_0l_rx[1]*max_speed_modal_l[1]-1.0*F_0c_lx[1]*max_speed_modal_l[1]-1.0*F_0r_lx[1]*avg_u_r[1]-1.0*F_0c_rx[1]*avg_u_r[1]+F_0l_rx[1]*avg_u_l[1]+F_0c_lx[1]*avg_u_l[1]+F_0r_lx[0]*max_speed_modal_r[0]-1.0*F_0c_rx[0]*max_speed_modal_r[0]+F_0l_rx[0]*max_speed_modal_l[0]-1.0*F_0c_lx[0]*max_speed_modal_l[0]-1.0*F_0r_lx[0]*avg_u_r[0]-1.0*F_0c_rx[0]*avg_u_r[0]+F_0l_rx[0]*avg_u_l[0]+F_0c_lx[0]*avg_u_l[0]); 
  out_G_1[20] += 0.5*dx1*(G_1r_lx[3]*max_speed_modal_r[3]-1.0*G_1c_rx[3]*max_speed_modal_r[3]+G_1l_rx[3]*max_speed_modal_l[3]-1.0*G_1c_lx[3]*max_speed_modal_l[3]-1.0*G_1r_lx[3]*avg_u_r[3]-1.0*G_1c_rx[3]*avg_u_r[3]+G_1l_rx[3]*avg_u_l[3]+G_1c_lx[3]*avg_u_l[3]+G_1r_lx[2]*max_speed_modal_r[2]-1.0*G_1c_rx[2]*max_speed_modal_r[2]+G_1l_rx[2]*max_speed_modal_l[2]-1.0*G_1c_lx[2]*max_speed_modal_l[2]-1.0*G_1r_lx[2]*avg_u_r[2]-1.0*G_1c_rx[2]*avg_u_r[2]+G_1l_rx[2]*avg_u_l[2]+G_1c_lx[2]*avg_u_l[2]+G_1r_lx[1]*max_speed_modal_r[1]-1.0*G_1c_rx[1]*max_speed_modal_r[1]+G_1l_rx[1]*max_speed_modal_l[1]-1.0*G_1c_lx[1]*max_speed_modal_l[1]-1.0*G_1r_lx[1]*avg_u_r[1]-1.0*G_1c_rx[1]*avg_u_r[1]+G_1l_rx[1]*avg_u_l[1]+G_1c_lx[1]*avg_u_l[1]+G_1r_lx[0]*max_speed_modal_r[0]-1.0*G_1c_rx[0]*max_speed_modal_r[0]+G_1l_rx[0]*max_speed_modal_l[0]-1.0*G_1c_lx[0]*max_speed_modal_l[0]-1.0*G_1r_lx[0]*avg_u_r[0]-1.0*G_1c_rx[0]*avg_u_r[0]+G_1l_rx[0]*avg_u_l[0]+G_1c_lx[0]*avg_u_l[0]); 

  F_0l_rx[0] = 0.4330127018922194*F_0l[23]+0.25*F_0l[21]; 
  F_0l_rx[1] = 0.4330127018922193*F_0l[22]+0.2500000000000001*F_0l[19]; 
  F_0l_rx[2] = 0.4330127018922193*F_0l[20]+0.2500000000000001*F_0l[17]; 
  F_0l_rx[3] = 0.4330127018922194*F_0l[18]+0.25*F_0l[16]; 

  F_0c_lx[0] = 0.25*F_0c[21]-0.4330127018922194*F_0c[23]; 
  F_0c_lx[1] = 0.2500000000000001*F_0c[19]-0.4330127018922193*F_0c[22]; 
  F_0c_lx[2] = 0.2500000000000001*F_0c[17]-0.4330127018922193*F_0c[20]; 
  F_0c_lx[3] = 0.25*F_0c[16]-0.4330127018922194*F_0c[18]; 

  F_0c_rx[0] = 0.4330127018922194*F_0c[23]+0.25*F_0c[21]; 
  F_0c_rx[1] = 0.4330127018922193*F_0c[22]+0.2500000000000001*F_0c[19]; 
  F_0c_rx[2] = 0.4330127018922193*F_0c[20]+0.2500000000000001*F_0c[17]; 
  F_0c_rx[3] = 0.4330127018922194*F_0c[18]+0.25*F_0c[16]; 

  F_0r_lx[0] = 0.25*F_0r[21]-0.4330127018922194*F_0r[23]; 
  F_0r_lx[1] = 0.2500000000000001*F_0r[19]-0.4330127018922193*F_0r[22]; 
  F_0r_lx[2] = 0.2500000000000001*F_0r[17]-0.4330127018922193*F_0r[20]; 
  F_0r_lx[3] = 0.25*F_0r[16]-0.4330127018922194*F_0r[18]; 

  G_1l_rx[0] = 0.4330127018922194*G_1l[23]+0.25*G_1l[21]; 
  G_1l_rx[1] = 0.4330127018922193*G_1l[22]+0.2500000000000001*G_1l[19]; 
  G_1l_rx[2] = 0.4330127018922193*G_1l[20]+0.2500000000000001*G_1l[17]; 
  G_1l_rx[3] = 0.4330127018922194*G_1l[18]+0.25*G_1l[16]; 

  G_1c_lx[0] = 0.25*G_1c[21]-0.4330127018922194*G_1c[23]; 
  G_1c_lx[1] = 0.2500000000000001*G_1c[19]-0.4330127018922193*G_1c[22]; 
  G_1c_lx[2] = 0.2500000000000001*G_1c[17]-0.4330127018922193*G_1c[20]; 
  G_1c_lx[3] = 0.25*G_1c[16]-0.4330127018922194*G_1c[18]; 

  G_1c_rx[0] = 0.4330127018922194*G_1c[23]+0.25*G_1c[21]; 
  G_1c_rx[1] = 0.4330127018922193*G_1c[22]+0.2500000000000001*G_1c[19]; 
  G_1c_rx[2] = 0.4330127018922193*G_1c[20]+0.2500000000000001*G_1c[17]; 
  G_1c_rx[3] = 0.4330127018922194*G_1c[18]+0.25*G_1c[16]; 

  G_1r_lx[0] = 0.25*G_1r[21]-0.4330127018922194*G_1r[23]; 
  G_1r_lx[1] = 0.2500000000000001*G_1r[19]-0.4330127018922193*G_1r[22]; 
  G_1r_lx[2] = 0.2500000000000001*G_1r[17]-0.4330127018922193*G_1r[20]; 
  G_1r_lx[3] = 0.25*G_1r[16]-0.4330127018922194*G_1r[18]; 
  ...
  F_0l_rx[0] = (-0.75*F_0l[22])-0.4330127018922194*F_0l[19]; 
  F_0l_rx[1] = (-0.75*F_0l[23])-0.4330127018922193*F_0l[21]; 
  F_0l_rx[2] = (-0.75*F_0l[18])-0.4330127018922193*F_0l[16]; 
  F_0l_rx[3] = (-0.75*F_0l[20])-0.4330127018922194*F_0l[17]; 

  F_0c_lx[0] = 0.75*F_0c[22]-0.4330127018922194*F_0c[19]; 
  F_0c_lx[1] = 0.75*F_0c[23]-0.4330127018922193*F_0c[21]; 
  F_0c_lx[2] = 0.75*F_0c[18]-0.4330127018922193*F_0c[16]; 
  F_0c_lx[3] = 0.75*F_0c[20]-0.4330127018922194*F_0c[17]; 

  F_0c_rx[0] = 0.75*F_0c[22]+0.4330127018922194*F_0c[19]; 
  F_0c_rx[1] = 0.75*F_0c[23]+0.4330127018922193*F_0c[21]; 
  F_0c_rx[2] = 0.75*F_0c[18]+0.4330127018922193*F_0c[16]; 
  F_0c_rx[3] = 0.75*F_0c[20]+0.4330127018922194*F_0c[17]; 

  F_0r_lx[0] = 0.4330127018922194*F_0r[19]-0.75*F_0r[22]; 
  F_0r_lx[1] = 0.4330127018922193*F_0r[21]-0.75*F_0r[23]; 
  F_0r_lx[2] = 0.4330127018922193*F_0r[16]-0.75*F_0r[18]; 
  F_0r_lx[3] = 0.4330127018922194*F_0r[17]-0.75*F_0r[20]; 

  G_1l_rx[0] = (-0.75*G_1l[22])-0.4330127018922194*G_1l[19]; 
  G_1l_rx[1] = (-0.75*G_1l[23])-0.4330127018922193*G_1l[21]; 
  G_1l_rx[2] = (-0.75*G_1l[18])-0.4330127018922193*G_1l[16]; 
  G_1l_rx[3] = (-0.75*G_1l[20])-0.4330127018922194*G_1l[17]; 

  G_1c_lx[0] = 0.75*G_1c[22]-0.4330127018922194*G_1c[19]; 
  G_1c_lx[1] = 0.75*G_1c[23]-0.4330127018922193*G_1c[21]; 
  G_1c_lx[2] = 0.75*G_1c[18]-0.4330127018922193*G_1c[16]; 
  G_1c_lx[3] = 0.75*G_1c[20]-0.4330127018922194*G_1c[17]; 

  G_1c_rx[0] = 0.75*G_1c[22]+0.4330127018922194*G_1c[19]; 
  G_1c_rx[1] = 0.75*G_1c[23]+0.4330127018922193*G_1c[21]; 
  G_1c_rx[2] = 0.75*G_1c[18]+0.4330127018922193*G_1c[16]; 
  G_1c_rx[3] = 0.75*G_1c[20]+0.4330127018922194*G_1c[17]; 

  G_1r_lx[0] = 0.4330127018922194*G_1r[19]-0.75*G_1r[22]; 
  G_1r_lx[1] = 0.4330127018922193*G_1r[21]-0.75*G_1r[23]; 
  G_1r_lx[2] = 0.4330127018922193*G_1r[16]-0.75*G_1r[18]; 
  G_1r_lx[3] = 0.4330127018922194*G_1r[17]-0.75*G_1r[20]; 
  ...
  F_0l_rx[0] = (-0.75*F_0l[23])-0.4330127018922194*F_0l[21]; 
  F_0l_rx[1] = (-0.75*F_0l[22])-0.4330127018922193*F_0l[19]; 
  F_0l_rx[2] = (-0.75*F_0l[20])-0.4330127018922193*F_0l[17]; 
  F_0l_rx[3] = (-0.75*F_0l[18])-0.4330127018922194*F_0l[16]; 

  F_0c_lx[0] = 0.75*F_0c[23]-0.4330127018922194*F_0c[21]; 
  F_0c_lx[1] = 0.75*F_0c[22]-0.4330127018922193*F_0c[19]; 
  F_0c_lx[2] = 0.75*F_0c[20]-0.4330127018922193*F_0c[17]; 
  F_0c_lx[3] = 0.75*F_0c[18]-0.4330127018922194*F_0c[16]; 

  F_0c_rx[0] = 0.75*F_0c[23]+0.4330127018922194*F_0c[21]; 
  F_0c_rx[1] = 0.75*F_0c[22]+0.4330127018922193*F_0c[19]; 
  F_0c_rx[2] = 0.75*F_0c[20]+0.4330127018922193*F_0c[17]; 
  F_0c_rx[3] = 0.75*F_0c[18]+0.4330127018922194*F_0c[16]; 

  F_0r_lx[0] = 0.4330127018922194*F_0r[21]-0.75*F_0r[23]; 
  F_0r_lx[1] = 0.4330127018922193*F_0r[19]-0.75*F_0r[22]; 
  F_0r_lx[2] = 0.4330127018922193*F_0r[17]-0.75*F_0r[20]; 
  F_0r_lx[3] = 0.4330127018922194*F_0r[16]-0.75*F_0r[18]; 

  G_1l_rx[0] = (-0.75*G_1l[23])-0.4330127018922194*G_1l[21]; 
  G_1l_rx[1] = (-0.75*G_1l[22])-0.4330127018922193*G_1l[19]; 
  G_1l_rx[2] = (-0.75*G_1l[20])-0.4330127018922193*G_1l[17]; 
  G_1l_rx[3] = (-0.75*G_1l[18])-0.4330127018922194*G_1l[16]; 

  G_1c_lx[0] = 0.75*G_1c[23]-0.4330127018922194*G_1c[21]; 
  G_1c_lx[1] = 0.75*G_1c[22]-0.4330127018922193*G_1c[19]; 
  G_1c_lx[2] = 0.75*G_1c[20]-0.4330127018922193*G_1c[17]; 
  G_1c_lx[3] = 0.75*G_1c[18]-0.4330127018922194*G_1c[16]; 

  G_1c_rx[0] = 0.75*G_1c[23]+0.4330127018922194*G_1c[21]; 
  G_1c_rx[1] = 0.75*G_1c[22]+0.4330127018922193*G_1c[19]; 
  G_1c_rx[2] = 0.75*G_1c[20]+0.4330127018922193*G_1c[17]; 
  G_1c_rx[3] = 0.75*G_1c[18]+0.4330127018922194*G_1c[16]; 

  G_1r_lx[0] = 0.4330127018922194*G_1r[21]-0.75*G_1r[23]; 
  G_1r_lx[1] = 0.4330127018922193*G_1r[19]-0.75*G_1r[22]; 
  G_1r_lx[2] = 0.4330127018922193*G_1r[17]-0.75*G_1r[20]; 
  G_1r_lx[3] = 0.4330127018922194*G_1r[16]-0.75*G_1r[18]; 
