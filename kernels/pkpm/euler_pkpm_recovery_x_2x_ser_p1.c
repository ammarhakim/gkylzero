...
{ 
  ...
  grad_u_x[2] += ((-0.4330127018922193*ux_l[3])+0.4330127018922193*ux_c[3]-0.25*(ux_l[2]+ux_c[2]))*dx1; 
  grad_u_x[3] += (0.75*ux_l[3]-0.75*ux_c[3]+0.4330127018922193*(ux_l[2]+ux_c[2]))*dx1; 
  ...
  div_p_x_comp[2] += ((-0.4330127018922193*Pxx_l[3])+0.4330127018922193*Pxx_c[3]-0.25*(Pxx_l[2]+Pxx_c[2]))*dx1; 
  div_p_x_comp[3] += (0.75*Pxx_l[3]-0.75*Pxx_c[3]+0.4330127018922193*(Pxx_l[2]+Pxx_c[2]))*dx1; 
  } else { 
  ...
  grad_u_x[2] += ((-0.2886751345948129*ux_l[3])+0.2886751345948129*ux_c[3]-0.25*(ux_l[2]+ux_c[2]))*dx1; 
  grad_u_x[3] += (0.5*ux_l[3]-0.5*ux_c[3]+0.4330127018922193*(ux_l[2]+ux_c[2]))*dx1; 
  ...
  div_p_x_comp[2] += ((-0.2886751345948129*Pxx_l[3])+0.2886751345948129*Pxx_c[3]-0.25*(Pxx_l[2]+Pxx_c[2]))*dx1; 
  div_p_x_comp[3] += (0.5*Pxx_l[3]-0.5*Pxx_c[3]+0.4330127018922193*(Pxx_l[2]+Pxx_c[2]))*dx1; 
  } 
  if (phi_x_r == 0.0) { 
  ...
  grad_u_x[2] += ((-0.4330127018922193*ux_r[3])+0.4330127018922193*ux_c[3]+0.25*(ux_r[2]+ux_c[2]))*dx1; 
  grad_u_x[3] += ((-0.75*ux_r[3])+0.75*ux_c[3]+0.4330127018922193*(ux_r[2]+ux_c[2]))*dx1; 
  ...
  div_p_x_comp[2] += ((-0.4330127018922193*Pxx_r[3])+0.4330127018922193*Pxx_c[3]+0.25*(Pxx_r[2]+Pxx_c[2]))*dx1; 
  div_p_x_comp[3] += ((-0.75*Pxx_r[3])+0.75*Pxx_c[3]+0.4330127018922193*(Pxx_r[2]+Pxx_c[2]))*dx1; 
  } else { 
  ...
  grad_u_x[2] += ((-0.2886751345948129*ux_r[3])+0.2886751345948129*ux_c[3]+0.25*(ux_r[2]+ux_c[2]))*dx1; 
  grad_u_x[3] += ((-0.5*ux_r[3])+0.5*ux_c[3]+0.4330127018922193*(ux_r[2]+ux_c[2]))*dx1; 
  ...
  div_p_x_comp[2] += ((-0.2886751345948129*Pxx_r[3])+0.2886751345948129*Pxx_c[3]+0.25*(Pxx_r[2]+Pxx_c[2]))*dx1; 
  div_p_x_comp[3] += ((-0.5*Pxx_r[3])+0.5*Pxx_c[3]+0.4330127018922193*(Pxx_r[2]+Pxx_c[2]))*dx1; 
  } 
  ...
  grad_u_y[2] += ((-0.4330127018922193*uy_l[3])+0.4330127018922193*uy_c[3]-0.25*(uy_l[2]+uy_c[2]))*dx1; 
  grad_u_y[3] += (0.75*uy_l[3]-0.75*uy_c[3]+0.4330127018922193*(uy_l[2]+uy_c[2]))*dx1; 
  ...
  div_p_y_comp[2] += ((-0.4330127018922193*Pxy_l[3])+0.4330127018922193*Pxy_c[3]-0.25*(Pxy_l[2]+Pxy_c[2]))*dx1; 
  div_p_y_comp[3] += (0.75*Pxy_l[3]-0.75*Pxy_c[3]+0.4330127018922193*(Pxy_l[2]+Pxy_c[2]))*dx1; 
  } else { 
  ...
  grad_u_y[2] += ((-0.2886751345948129*uy_l[3])+0.2886751345948129*uy_c[3]-0.25*(uy_l[2]+uy_c[2]))*dx1; 
  grad_u_y[3] += (0.5*uy_l[3]-0.5*uy_c[3]+0.4330127018922193*(uy_l[2]+uy_c[2]))*dx1; 
  ...
  div_p_y_comp[2] += ((-0.2886751345948129*Pxy_l[3])+0.2886751345948129*Pxy_c[3]-0.25*(Pxy_l[2]+Pxy_c[2]))*dx1; 
  div_p_y_comp[3] += (0.5*Pxy_l[3]-0.5*Pxy_c[3]+0.4330127018922193*(Pxy_l[2]+Pxy_c[2]))*dx1; 
  } 
  if (phi_y_r == 0.0) { 
  ...
  grad_u_y[2] += ((-0.4330127018922193*uy_r[3])+0.4330127018922193*uy_c[3]+0.25*(uy_r[2]+uy_c[2]))*dx1; 
  grad_u_y[3] += ((-0.75*uy_r[3])+0.75*uy_c[3]+0.4330127018922193*(uy_r[2]+uy_c[2]))*dx1; 
  ...
  div_p_y_comp[2] += ((-0.4330127018922193*Pxy_r[3])+0.4330127018922193*Pxy_c[3]+0.25*(Pxy_r[2]+Pxy_c[2]))*dx1; 
  div_p_y_comp[3] += ((-0.75*Pxy_r[3])+0.75*Pxy_c[3]+0.4330127018922193*(Pxy_r[2]+Pxy_c[2]))*dx1; 
  } else { 
  ...
  grad_u_y[2] += ((-0.2886751345948129*uy_r[3])+0.2886751345948129*uy_c[3]+0.25*(uy_r[2]+uy_c[2]))*dx1; 
  grad_u_y[3] += ((-0.5*uy_r[3])+0.5*uy_c[3]+0.4330127018922193*(uy_r[2]+uy_c[2]))*dx1; 
  ...
  div_p_y_comp[2] += ((-0.2886751345948129*Pxy_r[3])+0.2886751345948129*Pxy_c[3]+0.25*(Pxy_r[2]+Pxy_c[2]))*dx1; 
  div_p_y_comp[3] += ((-0.5*Pxy_r[3])+0.5*Pxy_c[3]+0.4330127018922193*(Pxy_r[2]+Pxy_c[2]))*dx1; 
  } 
  ...
  grad_u_z[2] += ((-0.4330127018922193*uz_l[3])+0.4330127018922193*uz_c[3]-0.25*(uz_l[2]+uz_c[2]))*dx1; 
  grad_u_z[3] += (0.75*uz_l[3]-0.75*uz_c[3]+0.4330127018922193*(uz_l[2]+uz_c[2]))*dx1; 
  ...
  div_p_z_comp[2] += ((-0.4330127018922193*Pxz_l[3])+0.4330127018922193*Pxz_c[3]-0.25*(Pxz_l[2]+Pxz_c[2]))*dx1; 
  div_p_z_comp[3] += (0.75*Pxz_l[3]-0.75*Pxz_c[3]+0.4330127018922193*(Pxz_l[2]+Pxz_c[2]))*dx1; 
  } else { 
  ...
  grad_u_z[2] += ((-0.2886751345948129*uy_l[3])+0.2886751345948129*uy_c[3]-0.25*(uy_l[2]+uy_c[2]))*dx1; 
  grad_u_z[3] += (0.5*uy_l[3]-0.5*uy_c[3]+0.4330127018922193*(uy_l[2]+uy_c[2]))*dx1; 
  ...
  div_p_z_comp[2] += ((-0.2886751345948129*Pxz_l[3])+0.2886751345948129*Pxz_c[3]-0.25*(Pxz_l[2]+Pxz_c[2]))*dx1; 
  div_p_z_comp[3] += (0.5*Pxz_l[3]-0.5*Pxz_c[3]+0.4330127018922193*(Pxz_l[2]+Pxz_c[2]))*dx1; 
  } 
  if (phi_z_r == 0.0) { 
  ...
  grad_u_z[2] += ((-0.4330127018922193*uz_r[3])+0.4330127018922193*uz_c[3]+0.25*(uz_r[2]+uz_c[2]))*dx1; 
  grad_u_z[3] += ((-0.75*uz_r[3])+0.75*uz_c[3]+0.4330127018922193*(uz_r[2]+uz_c[2]))*dx1; 
  ...
  div_p_z_comp[2] += ((-0.4330127018922193*Pxz_r[3])+0.4330127018922193*Pxz_c[3]+0.25*(Pxz_r[2]+Pxz_c[2]))*dx1; 
  div_p_z_comp[3] += ((-0.75*Pxz_r[3])+0.75*Pxz_c[3]+0.4330127018922193*(Pxz_r[2]+Pxz_c[2]))*dx1; 
  } else { 
  ...
  grad_u_z[2] += ((-0.2886751345948129*uy_r[3])+0.2886751345948129*uy_c[3]+0.25*(uy_r[2]+uy_c[2]))*dx1; 
  grad_u_z[3] += ((-0.5*uy_r[3])+0.5*uy_c[3]+0.4330127018922193*(uy_r[2]+uy_c[2]))*dx1; 
  ...
  div_p_z_comp[2] += ((-0.2886751345948129*Pxz_r[3])+0.2886751345948129*Pxz_c[3]+0.25*(Pxz_r[2]+Pxz_c[2]))*dx1; 
  div_p_z_comp[3] += ((-0.5*Pxz_r[3])+0.5*Pxz_c[3]+0.4330127018922193*(Pxz_r[2]+Pxz_c[2]))*dx1; 
  } 
