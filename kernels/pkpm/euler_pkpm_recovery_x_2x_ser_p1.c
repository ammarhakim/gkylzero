...
{ 
  ...
  grad_u_z[2] += ((-0.2886751345948129*uz_l[3])+0.2886751345948129*uz_c[3]-0.25*(uz_l[2]+uz_c[2]))*dx1; 
  grad_u_z[3] += (0.5*uz_l[3]-0.5*uz_c[3]+0.4330127018922193*(uz_l[2]+uz_c[2]))*dx1; 
  ...
  grad_u_z[2] += ((-0.2886751345948129*uz_r[3])+0.2886751345948129*uz_c[3]+0.25*(uz_r[2]+uz_c[2]))*dx1; 
  grad_u_z[3] += ((-0.5*uz_r[3])+0.5*uz_c[3]+0.4330127018922193*(uz_r[2]+uz_c[2]))*dx1; 
