...
{ 
  ...
  const double *u_surf_lr = &pkpm_prim_surf_l[2]; 
  const double *u_surf_cl = &pkpm_prim_surf_c[0]; 
  const double *u_surf_cr = &pkpm_prim_surf_c[2]; 
  ...
  double F_0_cr[6] = {0.0}; 
  double F_0_rl[6] = {0.0}; 
  double Ghat_F_0_u_l[6] = {0.0}; 
  double Ghat_F_0_u_r[6] = {0.0}; 

  double G_1_lr[6] = {0.0}; 
  double G_1_cl[6] = {0.0}; 
  double G_1_cr[6] = {0.0}; 
  double G_1_rl[6] = {0.0}; 
  double Ghat_G_1_u_l[6] = {0.0}; 
  double Ghat_G_1_u_r[6] = {0.0}; 

  F_0_lr[0] = 1.224744871391589*F_0l[1]+0.7071067811865475*F_0l[0]; 
  F_0_lr[1] = 1.224744871391589*F_0l[4]+0.7071067811865475*F_0l[2]; 
  F_0_lr[2] = 1.224744871391589*F_0l[5]+0.7071067811865475*F_0l[3]; 
  F_0_lr[3] = 1.224744871391589*F_0l[7]+0.7071067811865475*F_0l[6]; 
  F_0_lr[4] = 1.224744871391589*F_0l[9]+0.7071067811865475*F_0l[8]; 
  F_0_lr[5] = 1.224744871391589*F_0l[11]+0.7071067811865475*F_0l[10]; 

  F_0_cl[0] = 0.7071067811865475*F_0c[0]-1.224744871391589*F_0c[1]; 
  F_0_cl[1] = 0.7071067811865475*F_0c[2]-1.224744871391589*F_0c[4]; 
  F_0_cl[2] = 0.7071067811865475*F_0c[3]-1.224744871391589*F_0c[5]; 
  F_0_cl[3] = 0.7071067811865475*F_0c[6]-1.224744871391589*F_0c[7]; 
  F_0_cl[4] = 0.7071067811865475*F_0c[8]-1.224744871391589*F_0c[9]; 
  F_0_cl[5] = 0.7071067811865475*F_0c[10]-1.224744871391589*F_0c[11]; 

  F_0_cr[0] = 1.224744871391589*F_0c[1]+0.7071067811865475*F_0c[0]; 
  F_0_cr[1] = 1.224744871391589*F_0c[4]+0.7071067811865475*F_0c[2]; 
  F_0_cr[2] = 1.224744871391589*F_0c[5]+0.7071067811865475*F_0c[3]; 
  F_0_cr[3] = 1.224744871391589*F_0c[7]+0.7071067811865475*F_0c[6]; 
  F_0_cr[4] = 1.224744871391589*F_0c[9]+0.7071067811865475*F_0c[8]; 
  F_0_cr[5] = 1.224744871391589*F_0c[11]+0.7071067811865475*F_0c[10]; 

  F_0_rl[0] = 0.7071067811865475*F_0r[0]-1.224744871391589*F_0r[1]; 
  F_0_rl[1] = 0.7071067811865475*F_0r[2]-1.224744871391589*F_0r[4]; 
  F_0_rl[2] = 0.7071067811865475*F_0r[3]-1.224744871391589*F_0r[5]; 
  F_0_rl[3] = 0.7071067811865475*F_0r[6]-1.224744871391589*F_0r[7]; 
  F_0_rl[4] = 0.7071067811865475*F_0r[8]-1.224744871391589*F_0r[9]; 
  F_0_rl[5] = 0.7071067811865475*F_0r[10]-1.224744871391589*F_0r[11]; 

  G_1_lr[0] = 1.224744871391589*G_1l[1]+0.7071067811865475*G_1l[0]; 
  G_1_lr[1] = 1.224744871391589*G_1l[4]+0.7071067811865475*G_1l[2]; 
  G_1_lr[2] = 1.224744871391589*G_1l[5]+0.7071067811865475*G_1l[3]; 
  G_1_lr[3] = 1.224744871391589*G_1l[7]+0.7071067811865475*G_1l[6]; 
  G_1_lr[4] = 1.224744871391589*G_1l[9]+0.7071067811865475*G_1l[8]; 
  G_1_lr[5] = 1.224744871391589*G_1l[11]+0.7071067811865475*G_1l[10]; 

  G_1_cl[0] = 0.7071067811865475*G_1c[0]-1.224744871391589*G_1c[1]; 
  G_1_cl[1] = 0.7071067811865475*G_1c[2]-1.224744871391589*G_1c[4]; 
  G_1_cl[2] = 0.7071067811865475*G_1c[3]-1.224744871391589*G_1c[5]; 
  G_1_cl[3] = 0.7071067811865475*G_1c[6]-1.224744871391589*G_1c[7]; 
  G_1_cl[4] = 0.7071067811865475*G_1c[8]-1.224744871391589*G_1c[9]; 
  G_1_cl[5] = 0.7071067811865475*G_1c[10]-1.224744871391589*G_1c[11]; 

  G_1_cr[0] = 1.224744871391589*G_1c[1]+0.7071067811865475*G_1c[0]; 
  G_1_cr[1] = 1.224744871391589*G_1c[4]+0.7071067811865475*G_1c[2]; 
  G_1_cr[2] = 1.224744871391589*G_1c[5]+0.7071067811865475*G_1c[3]; 
  G_1_cr[3] = 1.224744871391589*G_1c[7]+0.7071067811865475*G_1c[6]; 
  G_1_cr[4] = 1.224744871391589*G_1c[9]+0.7071067811865475*G_1c[8]; 
  G_1_cr[5] = 1.224744871391589*G_1c[11]+0.7071067811865475*G_1c[10]; 

  G_1_rl[0] = 0.7071067811865475*G_1r[0]-1.224744871391589*G_1r[1]; 
  G_1_rl[1] = 0.7071067811865475*G_1r[2]-1.224744871391589*G_1r[4]; 
  G_1_rl[2] = 0.7071067811865475*G_1r[3]-1.224744871391589*G_1r[5]; 
  G_1_rl[3] = 0.7071067811865475*G_1r[6]-1.224744871391589*G_1r[7]; 
  G_1_rl[4] = 0.7071067811865475*G_1r[8]-1.224744871391589*G_1r[9]; 
  G_1_rl[5] = 0.7071067811865475*G_1r[10]-1.224744871391589*G_1r[11]; 

  Ghat_F_0_u_l[0] = 0.1767766952966368*F_0_lr[1]*u_surf_lr[1]+0.1767766952966368*F_0_cl[1]*u_surf_lr[1]+0.1767766952966368*F_0_lr[1]*u_surf_cl[1]+0.1767766952966368*F_0_cl[1]*u_surf_cl[1]+0.3535533905932737*F_0_lr[1]*pkpm_lax_l[1]-0.3535533905932737*F_0_cl[1]*pkpm_lax_l[1]+0.1767766952966368*F_0_lr[0]*u_surf_lr[0]+0.1767766952966368*F_0_cl[0]*u_surf_lr[0]+0.1767766952966368*F_0_lr[0]*u_surf_cl[0]+0.1767766952966368*F_0_cl[0]*u_surf_cl[0]+0.3535533905932737*F_0_lr[0]*pkpm_lax_l[0]-0.3535533905932737*F_0_cl[0]*pkpm_lax_l[0]; 
  Ghat_F_0_u_l[1] = 0.1767766952966368*F_0_lr[0]*u_surf_lr[1]+0.1767766952966368*F_0_cl[0]*u_surf_lr[1]+0.1767766952966368*F_0_lr[0]*u_surf_cl[1]+0.1767766952966368*F_0_cl[0]*u_surf_cl[1]+0.3535533905932737*F_0_lr[0]*pkpm_lax_l[1]-0.3535533905932737*F_0_cl[0]*pkpm_lax_l[1]+0.1767766952966368*u_surf_lr[0]*F_0_lr[1]+0.1767766952966368*u_surf_cl[0]*F_0_lr[1]+0.3535533905932737*pkpm_lax_l[0]*F_0_lr[1]+0.1767766952966368*u_surf_lr[0]*F_0_cl[1]+0.1767766952966368*u_surf_cl[0]*F_0_cl[1]-0.3535533905932737*pkpm_lax_l[0]*F_0_cl[1]; 
  Ghat_F_0_u_l[2] = 0.1767766952966368*u_surf_lr[1]*F_0_lr[3]+0.1767766952966368*u_surf_cl[1]*F_0_lr[3]+0.3535533905932737*pkpm_lax_l[1]*F_0_lr[3]+0.1767766952966368*u_surf_lr[1]*F_0_cl[3]+0.1767766952966368*u_surf_cl[1]*F_0_cl[3]-0.3535533905932737*pkpm_lax_l[1]*F_0_cl[3]+0.1767766952966368*u_surf_lr[0]*F_0_lr[2]+0.1767766952966368*u_surf_cl[0]*F_0_lr[2]+0.3535533905932737*pkpm_lax_l[0]*F_0_lr[2]+0.1767766952966368*u_surf_lr[0]*F_0_cl[2]+0.1767766952966368*u_surf_cl[0]*F_0_cl[2]-0.3535533905932737*pkpm_lax_l[0]*F_0_cl[2]; 
  Ghat_F_0_u_l[3] = 0.1767766952966368*u_surf_lr[0]*F_0_lr[3]+0.1767766952966368*u_surf_cl[0]*F_0_lr[3]+0.3535533905932737*pkpm_lax_l[0]*F_0_lr[3]+0.1767766952966368*u_surf_lr[0]*F_0_cl[3]+0.1767766952966368*u_surf_cl[0]*F_0_cl[3]-0.3535533905932737*pkpm_lax_l[0]*F_0_cl[3]+0.1767766952966368*u_surf_lr[1]*F_0_lr[2]+0.1767766952966368*u_surf_cl[1]*F_0_lr[2]+0.3535533905932737*pkpm_lax_l[1]*F_0_lr[2]+0.1767766952966368*u_surf_lr[1]*F_0_cl[2]+0.1767766952966368*u_surf_cl[1]*F_0_cl[2]-0.3535533905932737*pkpm_lax_l[1]*F_0_cl[2]; 
  Ghat_F_0_u_l[4] = 0.1767766952966368*u_surf_lr[1]*F_0_lr[5]+0.1767766952966368*u_surf_cl[1]*F_0_lr[5]+0.3535533905932737*pkpm_lax_l[1]*F_0_lr[5]+0.1767766952966368*u_surf_lr[1]*F_0_cl[5]+0.1767766952966368*u_surf_cl[1]*F_0_cl[5]-0.3535533905932737*pkpm_lax_l[1]*F_0_cl[5]+0.1767766952966368*u_surf_lr[0]*F_0_lr[4]+0.1767766952966368*u_surf_cl[0]*F_0_lr[4]+0.3535533905932737*pkpm_lax_l[0]*F_0_lr[4]+0.1767766952966368*u_surf_lr[0]*F_0_cl[4]+0.1767766952966368*u_surf_cl[0]*F_0_cl[4]-0.3535533905932737*pkpm_lax_l[0]*F_0_cl[4]; 
  Ghat_F_0_u_l[5] = 0.1767766952966368*u_surf_lr[0]*F_0_lr[5]+0.1767766952966368*u_surf_cl[0]*F_0_lr[5]+0.3535533905932737*pkpm_lax_l[0]*F_0_lr[5]+0.1767766952966368*u_surf_lr[0]*F_0_cl[5]+0.1767766952966368*u_surf_cl[0]*F_0_cl[5]-0.3535533905932737*pkpm_lax_l[0]*F_0_cl[5]+0.1767766952966368*u_surf_lr[1]*F_0_lr[4]+0.1767766952966368*u_surf_cl[1]*F_0_lr[4]+0.3535533905932737*pkpm_lax_l[1]*F_0_lr[4]+0.1767766952966368*u_surf_lr[1]*F_0_cl[4]+0.1767766952966368*u_surf_cl[1]*F_0_cl[4]-0.3535533905932737*pkpm_lax_l[1]*F_0_cl[4]; 
  Ghat_G_1_u_l[0] = 0.1767766952966368*G_1_lr[1]*u_surf_lr[1]+0.1767766952966368*G_1_cl[1]*u_surf_lr[1]+0.1767766952966368*G_1_lr[1]*u_surf_cl[1]+0.1767766952966368*G_1_cl[1]*u_surf_cl[1]+0.3535533905932737*G_1_lr[1]*pkpm_lax_l[1]-0.3535533905932737*G_1_cl[1]*pkpm_lax_l[1]+0.1767766952966368*G_1_lr[0]*u_surf_lr[0]+0.1767766952966368*G_1_cl[0]*u_surf_lr[0]+0.1767766952966368*G_1_lr[0]*u_surf_cl[0]+0.1767766952966368*G_1_cl[0]*u_surf_cl[0]+0.3535533905932737*G_1_lr[0]*pkpm_lax_l[0]-0.3535533905932737*G_1_cl[0]*pkpm_lax_l[0]; 
  Ghat_G_1_u_l[1] = 0.1767766952966368*G_1_lr[0]*u_surf_lr[1]+0.1767766952966368*G_1_cl[0]*u_surf_lr[1]+0.1767766952966368*G_1_lr[0]*u_surf_cl[1]+0.1767766952966368*G_1_cl[0]*u_surf_cl[1]+0.3535533905932737*G_1_lr[0]*pkpm_lax_l[1]-0.3535533905932737*G_1_cl[0]*pkpm_lax_l[1]+0.1767766952966368*u_surf_lr[0]*G_1_lr[1]+0.1767766952966368*u_surf_cl[0]*G_1_lr[1]+0.3535533905932737*pkpm_lax_l[0]*G_1_lr[1]+0.1767766952966368*u_surf_lr[0]*G_1_cl[1]+0.1767766952966368*u_surf_cl[0]*G_1_cl[1]-0.3535533905932737*pkpm_lax_l[0]*G_1_cl[1]; 
  Ghat_G_1_u_l[2] = 0.1767766952966368*u_surf_lr[1]*G_1_lr[3]+0.1767766952966368*u_surf_cl[1]*G_1_lr[3]+0.3535533905932737*pkpm_lax_l[1]*G_1_lr[3]+0.1767766952966368*u_surf_lr[1]*G_1_cl[3]+0.1767766952966368*u_surf_cl[1]*G_1_cl[3]-0.3535533905932737*pkpm_lax_l[1]*G_1_cl[3]+0.1767766952966368*u_surf_lr[0]*G_1_lr[2]+0.1767766952966368*u_surf_cl[0]*G_1_lr[2]+0.3535533905932737*pkpm_lax_l[0]*G_1_lr[2]+0.1767766952966368*u_surf_lr[0]*G_1_cl[2]+0.1767766952966368*u_surf_cl[0]*G_1_cl[2]-0.3535533905932737*pkpm_lax_l[0]*G_1_cl[2]; 
  Ghat_G_1_u_l[3] = 0.1767766952966368*u_surf_lr[0]*G_1_lr[3]+0.1767766952966368*u_surf_cl[0]*G_1_lr[3]+0.3535533905932737*pkpm_lax_l[0]*G_1_lr[3]+0.1767766952966368*u_surf_lr[0]*G_1_cl[3]+0.1767766952966368*u_surf_cl[0]*G_1_cl[3]-0.3535533905932737*pkpm_lax_l[0]*G_1_cl[3]+0.1767766952966368*u_surf_lr[1]*G_1_lr[2]+0.1767766952966368*u_surf_cl[1]*G_1_lr[2]+0.3535533905932737*pkpm_lax_l[1]*G_1_lr[2]+0.1767766952966368*u_surf_lr[1]*G_1_cl[2]+0.1767766952966368*u_surf_cl[1]*G_1_cl[2]-0.3535533905932737*pkpm_lax_l[1]*G_1_cl[2]; 
  Ghat_G_1_u_l[4] = 0.1767766952966368*u_surf_lr[1]*G_1_lr[5]+0.1767766952966368*u_surf_cl[1]*G_1_lr[5]+0.3535533905932737*pkpm_lax_l[1]*G_1_lr[5]+0.1767766952966368*u_surf_lr[1]*G_1_cl[5]+0.1767766952966368*u_surf_cl[1]*G_1_cl[5]-0.3535533905932737*pkpm_lax_l[1]*G_1_cl[5]+0.1767766952966368*u_surf_lr[0]*G_1_lr[4]+0.1767766952966368*u_surf_cl[0]*G_1_lr[4]+0.3535533905932737*pkpm_lax_l[0]*G_1_lr[4]+0.1767766952966368*u_surf_lr[0]*G_1_cl[4]+0.1767766952966368*u_surf_cl[0]*G_1_cl[4]-0.3535533905932737*pkpm_lax_l[0]*G_1_cl[4]; 
  Ghat_G_1_u_l[5] = 0.1767766952966368*u_surf_lr[0]*G_1_lr[5]+0.1767766952966368*u_surf_cl[0]*G_1_lr[5]+0.3535533905932737*pkpm_lax_l[0]*G_1_lr[5]+0.1767766952966368*u_surf_lr[0]*G_1_cl[5]+0.1767766952966368*u_surf_cl[0]*G_1_cl[5]-0.3535533905932737*pkpm_lax_l[0]*G_1_cl[5]+0.1767766952966368*u_surf_lr[1]*G_1_lr[4]+0.1767766952966368*u_surf_cl[1]*G_1_lr[4]+0.3535533905932737*pkpm_lax_l[1]*G_1_lr[4]+0.1767766952966368*u_surf_lr[1]*G_1_cl[4]+0.1767766952966368*u_surf_cl[1]*G_1_cl[4]-0.3535533905932737*pkpm_lax_l[1]*G_1_cl[4]; 

  Ghat_F_0_u_r[0] = 0.1767766952966368*F_0_rl[1]*u_surf_rl[1]+0.1767766952966368*F_0_cr[1]*u_surf_rl[1]+0.1767766952966368*F_0_rl[1]*u_surf_cr[1]+0.1767766952966368*F_0_cr[1]*u_surf_cr[1]-0.3535533905932737*F_0_rl[1]*pkpm_lax_r[1]+0.3535533905932737*F_0_cr[1]*pkpm_lax_r[1]+0.1767766952966368*F_0_rl[0]*u_surf_rl[0]+0.1767766952966368*F_0_cr[0]*u_surf_rl[0]+0.1767766952966368*F_0_rl[0]*u_surf_cr[0]+0.1767766952966368*F_0_cr[0]*u_surf_cr[0]-0.3535533905932737*F_0_rl[0]*pkpm_lax_r[0]+0.3535533905932737*F_0_cr[0]*pkpm_lax_r[0]; 
  Ghat_F_0_u_r[1] = 0.1767766952966368*F_0_rl[0]*u_surf_rl[1]+0.1767766952966368*F_0_cr[0]*u_surf_rl[1]+0.1767766952966368*F_0_rl[0]*u_surf_cr[1]+0.1767766952966368*F_0_cr[0]*u_surf_cr[1]-0.3535533905932737*F_0_rl[0]*pkpm_lax_r[1]+0.3535533905932737*F_0_cr[0]*pkpm_lax_r[1]+0.1767766952966368*u_surf_rl[0]*F_0_rl[1]+0.1767766952966368*u_surf_cr[0]*F_0_rl[1]-0.3535533905932737*pkpm_lax_r[0]*F_0_rl[1]+0.1767766952966368*u_surf_rl[0]*F_0_cr[1]+0.1767766952966368*u_surf_cr[0]*F_0_cr[1]+0.3535533905932737*pkpm_lax_r[0]*F_0_cr[1]; 
  ...
  Ghat_F_0_u_r[3] = 0.1767766952966368*u_surf_rl[0]*F_0_rl[3]+0.1767766952966368*u_surf_cr[0]*F_0_rl[3]-0.3535533905932737*pkpm_lax_r[0]*F_0_rl[3]+0.1767766952966368*u_surf_rl[0]*F_0_cr[3]+0.1767766952966368*u_surf_cr[0]*F_0_cr[3]+0.3535533905932737*pkpm_lax_r[0]*F_0_cr[3]+0.1767766952966368*u_surf_rl[1]*F_0_rl[2]+0.1767766952966368*u_surf_cr[1]*F_0_rl[2]-0.3535533905932737*pkpm_lax_r[1]*F_0_rl[2]+0.1767766952966368*u_surf_rl[1]*F_0_cr[2]+0.1767766952966368*u_surf_cr[1]*F_0_cr[2]+0.3535533905932737*pkpm_lax_r[1]*F_0_cr[2]; 
  Ghat_F_0_u_r[4] = 0.1767766952966368*u_surf_rl[1]*F_0_rl[5]+0.1767766952966368*u_surf_cr[1]*F_0_rl[5]-0.3535533905932737*pkpm_lax_r[1]*F_0_rl[5]+0.1767766952966368*u_surf_rl[1]*F_0_cr[5]+0.1767766952966368*u_surf_cr[1]*F_0_cr[5]+0.3535533905932737*pkpm_lax_r[1]*F_0_cr[5]+0.1767766952966368*u_surf_rl[0]*F_0_rl[4]+0.1767766952966368*u_surf_cr[0]*F_0_rl[4]-0.3535533905932737*pkpm_lax_r[0]*F_0_rl[4]+0.1767766952966368*u_surf_rl[0]*F_0_cr[4]+0.1767766952966368*u_surf_cr[0]*F_0_cr[4]+0.3535533905932737*pkpm_lax_r[0]*F_0_cr[4]; 
  Ghat_F_0_u_r[5] = 0.1767766952966368*u_surf_rl[0]*F_0_rl[5]+0.1767766952966368*u_surf_cr[0]*F_0_rl[5]-0.3535533905932737*pkpm_lax_r[0]*F_0_rl[5]+0.1767766952966368*u_surf_rl[0]*F_0_cr[5]+0.1767766952966368*u_surf_cr[0]*F_0_cr[5]+0.3535533905932737*pkpm_lax_r[0]*F_0_cr[5]+0.1767766952966368*u_surf_rl[1]*F_0_rl[4]+0.1767766952966368*u_surf_cr[1]*F_0_rl[4]-0.3535533905932737*pkpm_lax_r[1]*F_0_rl[4]+0.1767766952966368*u_surf_rl[1]*F_0_cr[4]+0.1767766952966368*u_surf_cr[1]*F_0_cr[4]+0.3535533905932737*pkpm_lax_r[1]*F_0_cr[4]; 
  Ghat_G_1_u_r[0] = 0.1767766952966368*G_1_rl[1]*u_surf_rl[1]+0.1767766952966368*G_1_cr[1]*u_surf_rl[1]+0.1767766952966368*G_1_rl[1]*u_surf_cr[1]+0.1767766952966368*G_1_cr[1]*u_surf_cr[1]-0.3535533905932737*G_1_rl[1]*pkpm_lax_r[1]+0.3535533905932737*G_1_cr[1]*pkpm_lax_r[1]+0.1767766952966368*G_1_rl[0]*u_surf_rl[0]+0.1767766952966368*G_1_cr[0]*u_surf_rl[0]+0.1767766952966368*G_1_rl[0]*u_surf_cr[0]+0.1767766952966368*G_1_cr[0]*u_surf_cr[0]-0.3535533905932737*G_1_rl[0]*pkpm_lax_r[0]+0.3535533905932737*G_1_cr[0]*pkpm_lax_r[0]; 
  Ghat_G_1_u_r[1] = 0.1767766952966368*G_1_rl[0]*u_surf_rl[1]+0.1767766952966368*G_1_cr[0]*u_surf_rl[1]+0.1767766952966368*G_1_rl[0]*u_surf_cr[1]+0.1767766952966368*G_1_cr[0]*u_surf_cr[1]-0.3535533905932737*G_1_rl[0]*pkpm_lax_r[1]+0.3535533905932737*G_1_cr[0]*pkpm_lax_r[1]+0.1767766952966368*u_surf_rl[0]*G_1_rl[1]+0.1767766952966368*u_surf_cr[0]*G_1_rl[1]-0.3535533905932737*pkpm_lax_r[0]*G_1_rl[1]+0.1767766952966368*u_surf_rl[0]*G_1_cr[1]+0.1767766952966368*u_surf_cr[0]*G_1_cr[1]+0.3535533905932737*pkpm_lax_r[0]*G_1_cr[1]; 
  ...
  Ghat_G_1_u_r[3] = 0.1767766952966368*u_surf_rl[0]*G_1_rl[3]+0.1767766952966368*u_surf_cr[0]*G_1_rl[3]-0.3535533905932737*pkpm_lax_r[0]*G_1_rl[3]+0.1767766952966368*u_surf_rl[0]*G_1_cr[3]+0.1767766952966368*u_surf_cr[0]*G_1_cr[3]+0.3535533905932737*pkpm_lax_r[0]*G_1_cr[3]+0.1767766952966368*u_surf_rl[1]*G_1_rl[2]+0.1767766952966368*u_surf_cr[1]*G_1_rl[2]-0.3535533905932737*pkpm_lax_r[1]*G_1_rl[2]+0.1767766952966368*u_surf_rl[1]*G_1_cr[2]+0.1767766952966368*u_surf_cr[1]*G_1_cr[2]+0.3535533905932737*pkpm_lax_r[1]*G_1_cr[2]; 
  Ghat_G_1_u_r[4] = 0.1767766952966368*u_surf_rl[1]*G_1_rl[5]+0.1767766952966368*u_surf_cr[1]*G_1_rl[5]-0.3535533905932737*pkpm_lax_r[1]*G_1_rl[5]+0.1767766952966368*u_surf_rl[1]*G_1_cr[5]+0.1767766952966368*u_surf_cr[1]*G_1_cr[5]+0.3535533905932737*pkpm_lax_r[1]*G_1_cr[5]+0.1767766952966368*u_surf_rl[0]*G_1_rl[4]+0.1767766952966368*u_surf_cr[0]*G_1_rl[4]-0.3535533905932737*pkpm_lax_r[0]*G_1_rl[4]+0.1767766952966368*u_surf_rl[0]*G_1_cr[4]+0.1767766952966368*u_surf_cr[0]*G_1_cr[4]+0.3535533905932737*pkpm_lax_r[0]*G_1_cr[4]; 
  Ghat_G_1_u_r[5] = 0.1767766952966368*u_surf_rl[0]*G_1_rl[5]+0.1767766952966368*u_surf_cr[0]*G_1_rl[5]-0.3535533905932737*pkpm_lax_r[0]*G_1_rl[5]+0.1767766952966368*u_surf_rl[0]*G_1_cr[5]+0.1767766952966368*u_surf_cr[0]*G_1_cr[5]+0.3535533905932737*pkpm_lax_r[0]*G_1_cr[5]+0.1767766952966368*u_surf_rl[1]*G_1_rl[4]+0.1767766952966368*u_surf_cr[1]*G_1_rl[4]-0.3535533905932737*pkpm_lax_r[1]*G_1_rl[4]+0.1767766952966368*u_surf_rl[1]*G_1_cr[4]+0.1767766952966368*u_surf_cr[1]*G_1_cr[4]+0.3535533905932737*pkpm_lax_r[1]*G_1_cr[4]; 
  ...
  out_F_0[7] += -1.224744871391589*(Ghat_F_0_u_r[3]+Ghat_F_0_u_l[3])*dx1; 
  out_F_0[8] += (0.7071067811865475*Ghat_F_0_u_l[4]-0.7071067811865475*Ghat_F_0_u_r[4])*dx1; 
  out_F_0[9] += -1.224744871391589*(Ghat_F_0_u_r[4]+Ghat_F_0_u_l[4])*dx1; 
  out_F_0[10] += (0.7071067811865475*Ghat_F_0_u_l[5]-0.7071067811865475*Ghat_F_0_u_r[5])*dx1; 
  out_F_0[11] += -1.224744871391589*(Ghat_F_0_u_r[5]+Ghat_F_0_u_l[5])*dx1; 
  ...
  out_G_1[7] += -1.224744871391589*(Ghat_G_1_u_r[3]+Ghat_G_1_u_l[3])*dx1; 
  out_G_1[8] += (0.7071067811865475*Ghat_G_1_u_l[4]-0.7071067811865475*Ghat_G_1_u_r[4])*dx1; 
  out_G_1[9] += -1.224744871391589*(Ghat_G_1_u_r[4]+Ghat_G_1_u_l[4])*dx1; 
  out_G_1[10] += (0.7071067811865475*Ghat_G_1_u_l[5]-0.7071067811865475*Ghat_G_1_u_r[5])*dx1; 
  out_G_1[11] += -1.224744871391589*(Ghat_G_1_u_r[5]+Ghat_G_1_u_l[5])*dx1; 
