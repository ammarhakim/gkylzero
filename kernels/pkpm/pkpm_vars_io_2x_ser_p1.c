...
{ 
  ...
  const double *T_perp_over_m = &prim[28]; 
  const double *T_perp_over_m_inv = &prim[32]; 

  const double *div_b = &pkpm_accel[0]; 
  const double *bb_grad_u = &pkpm_accel[4]; 
  const double *p_perp_source = &pkpm_accel[12]; 
  const double *p_perp_div_b = &pkpm_accel[16]; 
  ...
  double *pkpm_vars_io_div_b = &pkpm_vars_io[20]; 
  double *pkpm_vars_io_pkpm_div_ppar = &pkpm_vars_io[24]; 
  double *pkpm_vars_io_p_perp_div_b = &pkpm_vars_io[28]; 
  double *pkpm_vars_io_bb_grad_u = &pkpm_vars_io[32]; 
  double *pkpm_vars_io_p_perp_source = &pkpm_vars_io[36]; 
