...
{ 
  ...
  bb_grad_u_comp[1] = 0.447213595499958*grad_u_z[3]*bxbz[6]+0.447213595499958*grad_u_y[3]*bxby[6]+0.447213595499958*grad_u_x[3]*bxbx[6]+0.4472135954999579*grad_u_z[1]*bxbz[4]+0.4472135954999579*grad_u_y[1]*bxby[4]+0.4472135954999579*grad_u_x[1]*bxbx[4]+0.5*bxbz[2]*grad_u_z[3]+0.5*bxby[2]*grad_u_y[3]+0.5*bxbx[2]*grad_u_x[3]+0.5*grad_u_z[2]*bxbz[3]+0.5*grad_u_y[2]*bxby[3]+0.5*grad_u_x[2]*bxbx[3]+0.5*bxbz[0]*grad_u_z[1]+0.5*bxby[0]*grad_u_y[1]+0.5*bxbx[0]*grad_u_x[1]+0.5*grad_u_z[0]*bxbz[1]+0.5*grad_u_y[0]*bxby[1]+0.5*grad_u_x[0]*bxbx[1]; 
  bb_grad_u_comp[2] = 0.447213595499958*grad_u_z[3]*bxbz[7]+0.447213595499958*grad_u_y[3]*bxby[7]+0.447213595499958*grad_u_x[3]*bxbx[7]+0.4472135954999579*grad_u_z[2]*bxbz[5]+0.4472135954999579*grad_u_y[2]*bxby[5]+0.4472135954999579*grad_u_x[2]*bxbx[5]+0.5*bxbz[1]*grad_u_z[3]+0.5*bxby[1]*grad_u_y[3]+0.5*bxbx[1]*grad_u_x[3]+0.5*grad_u_z[1]*bxbz[3]+0.5*grad_u_y[1]*bxby[3]+0.5*grad_u_x[1]*bxbx[3]+0.5*bxbz[0]*grad_u_z[2]+0.5*bxby[0]*grad_u_y[2]+0.5*bxbx[0]*grad_u_x[2]+0.5*grad_u_z[0]*bxbz[2]+0.5*grad_u_y[0]*bxby[2]+0.5*grad_u_x[0]*bxbx[2]; 
  bb_grad_u_comp[3] = 0.4*grad_u_z[3]*bxbz[8]+0.4*grad_u_y[3]*bxby[8]+0.4*grad_u_x[3]*bxbx[8]+0.447213595499958*grad_u_z[2]*bxbz[7]+0.447213595499958*grad_u_y[2]*bxby[7]+0.447213595499958*grad_u_x[2]*bxbx[7]+0.447213595499958*grad_u_z[1]*bxbz[6]+0.447213595499958*grad_u_y[1]*bxby[6]+0.447213595499958*grad_u_x[1]*bxbx[6]+0.4472135954999579*grad_u_z[3]*bxbz[5]+0.4472135954999579*grad_u_y[3]*bxby[5]+0.4472135954999579*grad_u_x[3]*bxbx[5]+0.4472135954999579*grad_u_z[3]*bxbz[4]+0.4472135954999579*grad_u_y[3]*bxby[4]+0.4472135954999579*grad_u_x[3]*bxbx[4]+0.5*bxbz[0]*grad_u_z[3]+0.5*bxby[0]*grad_u_y[3]+0.5*bxbx[0]*grad_u_x[3]+0.5*grad_u_z[0]*bxbz[3]+0.5*grad_u_y[0]*bxby[3]+0.5*grad_u_x[0]*bxbx[3]+0.5*bxbz[1]*grad_u_z[2]+0.5*bxby[1]*grad_u_y[2]+0.5*bxbx[1]*grad_u_x[2]+0.5*grad_u_z[1]*bxbz[2]+0.5*grad_u_y[1]*bxby[2]+0.5*grad_u_x[1]*bxbx[2]; 
  bb_grad_u_comp[4] = 0.5000000000000001*grad_u_z[2]*bxbz[6]+0.5000000000000001*grad_u_y[2]*bxby[6]+0.5000000000000001*grad_u_x[2]*bxbx[6]+0.5*grad_u_z[0]*bxbz[4]+0.5*grad_u_y[0]*bxby[4]+0.5*grad_u_x[0]*bxbx[4]+0.4472135954999579*bxbz[3]*grad_u_z[3]+0.4472135954999579*bxby[3]*grad_u_y[3]+0.4472135954999579*bxbx[3]*grad_u_x[3]+0.4472135954999579*bxbz[1]*grad_u_z[1]+0.4472135954999579*bxby[1]*grad_u_y[1]+0.4472135954999579*bxbx[1]*grad_u_x[1]; 
  bb_grad_u_comp[5] = 0.5000000000000001*grad_u_z[1]*bxbz[7]+0.5000000000000001*grad_u_y[1]*bxby[7]+0.5000000000000001*grad_u_x[1]*bxbx[7]+0.5*grad_u_z[0]*bxbz[5]+0.5*grad_u_y[0]*bxby[5]+0.5*grad_u_x[0]*bxbx[5]+0.4472135954999579*bxbz[3]*grad_u_z[3]+0.4472135954999579*bxby[3]*grad_u_y[3]+0.4472135954999579*bxbx[3]*grad_u_x[3]+0.4472135954999579*bxbz[2]*grad_u_z[2]+0.4472135954999579*bxby[2]*grad_u_y[2]+0.4472135954999579*bxbx[2]*grad_u_x[2]; 
  bb_grad_u_comp[6] = 0.447213595499958*grad_u_z[2]*bxbz[8]+0.447213595499958*grad_u_y[2]*bxby[8]+0.447213595499958*grad_u_x[2]*bxbx[8]+0.4*grad_u_z[3]*bxbz[7]+0.4*grad_u_y[3]*bxby[7]+0.4*grad_u_x[3]*bxbx[7]+0.5*grad_u_z[0]*bxbz[6]+0.5*grad_u_y[0]*bxby[6]+0.5*grad_u_x[0]*bxbx[6]+0.5000000000000001*grad_u_z[2]*bxbz[4]+0.5000000000000001*grad_u_y[2]*bxby[4]+0.5000000000000001*grad_u_x[2]*bxbx[4]+0.447213595499958*bxbz[1]*grad_u_z[3]+0.447213595499958*bxby[1]*grad_u_y[3]+0.447213595499958*bxbx[1]*grad_u_x[3]+0.447213595499958*grad_u_z[1]*bxbz[3]+0.447213595499958*grad_u_y[1]*bxby[3]+0.447213595499958*grad_u_x[1]*bxbx[3]; 
  bb_grad_u_comp[7] = 0.447213595499958*grad_u_z[1]*bxbz[8]+0.447213595499958*grad_u_y[1]*bxby[8]+0.447213595499958*grad_u_x[1]*bxbx[8]+0.5*grad_u_z[0]*bxbz[7]+0.5*grad_u_y[0]*bxby[7]+0.5*grad_u_x[0]*bxbx[7]+0.4*grad_u_z[3]*bxbz[6]+0.4*grad_u_y[3]*bxby[6]+0.4*grad_u_x[3]*bxbx[6]+0.5000000000000001*grad_u_z[1]*bxbz[5]+0.5000000000000001*grad_u_y[1]*bxby[5]+0.5000000000000001*grad_u_x[1]*bxbx[5]+0.447213595499958*bxbz[2]*grad_u_z[3]+0.447213595499958*bxby[2]*grad_u_y[3]+0.447213595499958*bxbx[2]*grad_u_x[3]+0.447213595499958*grad_u_z[2]*bxbz[3]+0.447213595499958*grad_u_y[2]*bxby[3]+0.447213595499958*grad_u_x[2]*bxbx[3]; 
  bb_grad_u_comp[8] = 0.5*grad_u_z[0]*bxbz[8]+0.5*grad_u_y[0]*bxby[8]+0.5*grad_u_x[0]*bxbx[8]+0.447213595499958*grad_u_z[1]*bxbz[7]+0.447213595499958*grad_u_y[1]*bxby[7]+0.447213595499958*grad_u_x[1]*bxbx[7]+0.447213595499958*grad_u_z[2]*bxbz[6]+0.447213595499958*grad_u_y[2]*bxby[6]+0.447213595499958*grad_u_x[2]*bxbx[6]+0.4*bxbz[3]*grad_u_z[3]+0.4*bxby[3]*grad_u_y[3]+0.4*bxbx[3]*grad_u_x[3]; 
