...
{ 
  ...
  const double *pkpm_penalization_rhouy_l = &pkpm_penalization_l[2]; 
  const double *pkpm_penalization_rhouz_l = &pkpm_penalization_l[4]; 

  const double *pkpm_penalization_rhoux_r = &pkpm_penalization_r[0]; 
  const double *pkpm_penalization_rhouy_r = &pkpm_penalization_r[2]; 
  const double *pkpm_penalization_rhouz_r = &pkpm_penalization_r[4]; 
  ...
  flux_rho_r[0] = (-0.2165063509461096*ux_surf_rl[1]*rho_r[3])-0.2165063509461096*ux_surf_cr[1]*rho_r[3]+0.4330127018922193*pkpm_lax_dir_r[1]*rho_r[3]+0.2165063509461096*ux_surf_rl[1]*rho_c[3]+0.2165063509461096*ux_surf_cr[1]*rho_c[3]+0.4330127018922193*pkpm_lax_dir_r[1]*rho_c[3]+0.125*ux_surf_rl[1]*rho_r[2]+0.125*ux_surf_cr[1]*rho_r[2]-0.25*pkpm_lax_dir_r[1]*rho_r[2]+0.125*ux_surf_rl[1]*rho_c[2]+0.125*ux_surf_cr[1]*rho_c[2]+0.25*pkpm_lax_dir_r[1]*rho_c[2]-0.2165063509461096*ux_surf_rl[0]*rho_r[1]-0.2165063509461096*ux_surf_cr[0]*rho_r[1]+0.4330127018922193*pkpm_lax_dir_r[0]*rho_r[1]+0.2165063509461096*ux_surf_rl[0]*rho_c[1]+0.2165063509461096*ux_surf_cr[0]*rho_c[1]+0.4330127018922193*pkpm_lax_dir_r[0]*rho_c[1]+0.125*rho_r[0]*ux_surf_rl[0]+0.125*rho_c[0]*ux_surf_rl[0]+0.125*rho_r[0]*ux_surf_cr[0]+0.125*rho_c[0]*ux_surf_cr[0]-0.25*pkpm_lax_dir_r[0]*rho_r[0]+0.25*pkpm_lax_dir_r[0]*rho_c[0]; 
  flux_rho_r[1] = (-0.2165063509461096*ux_surf_rl[0]*rho_r[3])-0.2165063509461096*ux_surf_cr[0]*rho_r[3]+0.4330127018922193*pkpm_lax_dir_r[0]*rho_r[3]+0.2165063509461096*ux_surf_rl[0]*rho_c[3]+0.2165063509461096*ux_surf_cr[0]*rho_c[3]+0.4330127018922193*pkpm_lax_dir_r[0]*rho_c[3]+0.125*ux_surf_rl[0]*rho_r[2]+0.125*ux_surf_cr[0]*rho_r[2]-0.25*pkpm_lax_dir_r[0]*rho_r[2]+0.125*ux_surf_rl[0]*rho_c[2]+0.125*ux_surf_cr[0]*rho_c[2]+0.25*pkpm_lax_dir_r[0]*rho_c[2]-0.2165063509461096*rho_r[1]*ux_surf_rl[1]+0.2165063509461096*rho_c[1]*ux_surf_rl[1]+0.125*rho_r[0]*ux_surf_rl[1]+0.125*rho_c[0]*ux_surf_rl[1]-0.2165063509461096*rho_r[1]*ux_surf_cr[1]+0.2165063509461096*rho_c[1]*ux_surf_cr[1]+0.125*rho_r[0]*ux_surf_cr[1]+0.125*rho_c[0]*ux_surf_cr[1]+0.4330127018922193*pkpm_lax_dir_r[1]*rho_r[1]+0.4330127018922193*pkpm_lax_dir_r[1]*rho_c[1]-0.25*rho_r[0]*pkpm_lax_dir_r[1]+0.25*rho_c[0]*pkpm_lax_dir_r[1]; 
