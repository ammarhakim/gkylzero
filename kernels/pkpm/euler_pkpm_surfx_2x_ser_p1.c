...
{ 
  ...
  const double *P_surfx_lr = &p_ij_surf_l[2]; 
  const double *P_surfy_lr = &p_ij_surf_l[6]; 
  const double *P_surfz_lr = &p_ij_surf_l[10]; 

  const double *P_surfx_cl = &p_ij_surf_c[0]; 
  const double *P_surfy_cl = &p_ij_surf_c[4]; 
  const double *P_surfz_cl = &p_ij_surf_c[8]; 

  const double *P_surfx_cr = &p_ij_surf_c[2]; 
  const double *P_surfy_cr = &p_ij_surf_c[6]; 
  const double *P_surfz_cr = &p_ij_surf_c[10]; 

  const double *P_surfx_rl = &p_ij_surf_r[0]; 
  const double *P_surfy_rl = &p_ij_surf_r[4]; 
  const double *P_surfz_rl = &p_ij_surf_r[8]; 
  ...
  flux_rho_l[0] = 0.2165063509461096*ux_surf_lr[1]*rho_l[3]+0.2165063509461096*ux_surf_cl[1]*rho_l[3]-0.2165063509461096*ux_surf_lr[1]*rho_c[3]-0.2165063509461096*ux_surf_cl[1]*rho_c[3]+0.125*ux_surf_lr[1]*rho_l[2]+0.125*ux_surf_cl[1]*rho_l[2]+0.125*ux_surf_lr[1]*rho_c[2]+0.125*ux_surf_cl[1]*rho_c[2]+0.2165063509461096*ux_surf_lr[0]*rho_l[1]+0.2165063509461096*ux_surf_cl[0]*rho_l[1]-0.2165063509461096*ux_surf_lr[0]*rho_c[1]-0.2165063509461096*ux_surf_cl[0]*rho_c[1]+0.125*rho_l[0]*ux_surf_lr[0]+0.125*rho_c[0]*ux_surf_lr[0]+0.125*rho_l[0]*ux_surf_cl[0]+0.125*rho_c[0]*ux_surf_cl[0]; 
