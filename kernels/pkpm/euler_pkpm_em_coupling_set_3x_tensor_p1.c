...
GKYL_CU_DH void euler_pkpm_em_coupling_set_3x_tensor_p1(int count, 
...
{ 
  ...
  double rho[GKYL_MAX_SPECIES][27]; 
  ...
  for (int i = 0; i < num_species; ++i) { 
    ...
    rho[i][8] = inp_vlasov_pkpm_moms[8]; 
    rho[i][9] = inp_vlasov_pkpm_moms[9]; 
    rho[i][10] = inp_vlasov_pkpm_moms[10]; 
    rho[i][11] = inp_vlasov_pkpm_moms[11]; 
    rho[i][12] = inp_vlasov_pkpm_moms[12]; 
    rho[i][13] = inp_vlasov_pkpm_moms[13]; 
    rho[i][14] = inp_vlasov_pkpm_moms[14]; 
    rho[i][15] = inp_vlasov_pkpm_moms[15]; 
    rho[i][16] = inp_vlasov_pkpm_moms[16]; 
    rho[i][17] = inp_vlasov_pkpm_moms[17]; 
    rho[i][18] = inp_vlasov_pkpm_moms[18]; 
    rho[i][19] = inp_vlasov_pkpm_moms[19]; 
    rho[i][20] = inp_vlasov_pkpm_moms[20]; 
    rho[i][21] = inp_vlasov_pkpm_moms[21]; 
    rho[i][22] = inp_vlasov_pkpm_moms[22]; 
    rho[i][23] = inp_vlasov_pkpm_moms[23]; 
    rho[i][24] = inp_vlasov_pkpm_moms[24]; 
    rho[i][25] = inp_vlasov_pkpm_moms[25]; 
    rho[i][26] = inp_vlasov_pkpm_moms[26]; 
  ...
  for (int i = 0; i < num_species; ++i) { 
    ...
    gkyl_mat_set(&rhs, 0 + i*(24), 0, ux[i][0] + 0.5*dt*(qbym[i]*ext_Ex[0] + app_accel_x[i][0])); 
    gkyl_mat_set(&rhs, 8 + i*(24), 0, uy[i][0] + 0.5*dt*(qbym[i]*ext_Ey[0] + app_accel_y[i][0])); 
    gkyl_mat_set(&rhs, 16 + i*(24), 0, uz[i][0] + 0.5*dt*(qbym[i]*ext_Ez[0] + app_accel_z[i][0])); 

    gkyl_mat_set(&rhs, 1 + i*(24), 0, ux[i][1] + 0.5*dt*(qbym[i]*ext_Ex[1] + app_accel_x[i][1])); 
    gkyl_mat_set(&rhs, 9 + i*(24), 0, uy[i][1] + 0.5*dt*(qbym[i]*ext_Ey[1] + app_accel_y[i][1])); 
    gkyl_mat_set(&rhs, 17 + i*(24), 0, uz[i][1] + 0.5*dt*(qbym[i]*ext_Ez[1] + app_accel_z[i][1])); 

    gkyl_mat_set(&rhs, 2 + i*(24), 0, ux[i][2] + 0.5*dt*(qbym[i]*ext_Ex[2] + app_accel_x[i][2])); 
    gkyl_mat_set(&rhs, 10 + i*(24), 0, uy[i][2] + 0.5*dt*(qbym[i]*ext_Ey[2] + app_accel_y[i][2])); 
    gkyl_mat_set(&rhs, 18 + i*(24), 0, uz[i][2] + 0.5*dt*(qbym[i]*ext_Ez[2] + app_accel_z[i][2])); 

    gkyl_mat_set(&rhs, 3 + i*(24), 0, ux[i][3] + 0.5*dt*(qbym[i]*ext_Ex[3] + app_accel_x[i][3])); 
    gkyl_mat_set(&rhs, 11 + i*(24), 0, uy[i][3] + 0.5*dt*(qbym[i]*ext_Ey[3] + app_accel_y[i][3])); 
    gkyl_mat_set(&rhs, 19 + i*(24), 0, uz[i][3] + 0.5*dt*(qbym[i]*ext_Ez[3] + app_accel_z[i][3])); 

    gkyl_mat_set(&rhs, 4 + i*(24), 0, ux[i][4] + 0.5*dt*(qbym[i]*ext_Ex[4] + app_accel_x[i][4])); 
    gkyl_mat_set(&rhs, 12 + i*(24), 0, uy[i][4] + 0.5*dt*(qbym[i]*ext_Ey[4] + app_accel_y[i][4])); 
    gkyl_mat_set(&rhs, 20 + i*(24), 0, uz[i][4] + 0.5*dt*(qbym[i]*ext_Ez[4] + app_accel_z[i][4])); 

    gkyl_mat_set(&rhs, 5 + i*(24), 0, ux[i][5] + 0.5*dt*(qbym[i]*ext_Ex[5] + app_accel_x[i][5])); 
    gkyl_mat_set(&rhs, 13 + i*(24), 0, uy[i][5] + 0.5*dt*(qbym[i]*ext_Ey[5] + app_accel_y[i][5])); 
    gkyl_mat_set(&rhs, 21 + i*(24), 0, uz[i][5] + 0.5*dt*(qbym[i]*ext_Ez[5] + app_accel_z[i][5])); 

    gkyl_mat_set(&rhs, 6 + i*(24), 0, ux[i][6] + 0.5*dt*(qbym[i]*ext_Ex[6] + app_accel_x[i][6])); 
    gkyl_mat_set(&rhs, 14 + i*(24), 0, uy[i][6] + 0.5*dt*(qbym[i]*ext_Ey[6] + app_accel_y[i][6])); 
    gkyl_mat_set(&rhs, 22 + i*(24), 0, uz[i][6] + 0.5*dt*(qbym[i]*ext_Ez[6] + app_accel_z[i][6])); 

    gkyl_mat_set(&rhs, 7 + i*(24), 0, ux[i][7] + 0.5*dt*(qbym[i]*ext_Ex[7] + app_accel_x[i][7])); 
    gkyl_mat_set(&rhs, 15 + i*(24), 0, uy[i][7] + 0.5*dt*(qbym[i]*ext_Ey[7] + app_accel_y[i][7])); 
    gkyl_mat_set(&rhs, 23 + i*(24), 0, uz[i][7] + 0.5*dt*(qbym[i]*ext_Ez[7] + app_accel_z[i][7])); 
  ...
  for (int s = 0; s < num_species; ++s) { 
    ...
    gkyl_mat_set(&lhs, 0 + s*(24), 0 + num_species*(24), E_field_fac*(1.0)); 
    gkyl_mat_set(&lhs, 8 + s*(24), 8 + num_species*(24), E_field_fac*(1.0)); 
    gkyl_mat_set(&lhs, 16 + s*(24), 16 + num_species*(24), E_field_fac*(1.0)); 
    ...
    if (!pkpm_field_static) { 
      gkyl_mat_set(&lhs, 0 + num_species*(24), 0 + s*(24), 0.5*dt*qbym[s]*(0.3535533905932737*rho[s][0])); 
      gkyl_mat_set(&lhs, 8 + num_species*(24), 8 + s*(24), 0.5*dt*qbym[s]*(0.3535533905932737*rho[s][0])); 
      gkyl_mat_set(&lhs, 16 + num_species*(24), 16 + s*(24), 0.5*dt*qbym[s]*(0.3535533905932737*rho[s][0])); 
    } 
    ...
    gkyl_mat_set(&lhs, 0 + s*(24), 1 + num_species*(24), E_field_fac*(0.0)); 
    gkyl_mat_set(&lhs, 8 + s*(24), 9 + num_species*(24), E_field_fac*(0.0)); 
    gkyl_mat_set(&lhs, 16 + s*(24), 17 + num_species*(24), E_field_fac*(0.0)); 
    ...
    if (!pkpm_field_static) { 
      gkyl_mat_set(&lhs, 0 + num_species*(24), 1 + s*(24), 0.5*dt*qbym[s]*(0.3535533905932737*rho[s][1])); 
      gkyl_mat_set(&lhs, 8 + num_species*(24), 9 + s*(24), 0.5*dt*qbym[s]*(0.3535533905932737*rho[s][1])); 
      gkyl_mat_set(&lhs, 16 + num_species*(24), 17 + s*(24), 0.5*dt*qbym[s]*(0.3535533905932737*rho[s][1])); 
    } 
    ...
    gkyl_mat_set(&lhs, 0 + s*(24), 2 + num_species*(24), E_field_fac*(0.0)); 
    gkyl_mat_set(&lhs, 8 + s*(24), 10 + num_species*(24), E_field_fac*(0.0)); 
    gkyl_mat_set(&lhs, 16 + s*(24), 18 + num_species*(24), E_field_fac*(0.0)); 
    ...
    if (!pkpm_field_static) { 
      gkyl_mat_set(&lhs, 0 + num_species*(24), 2 + s*(24), 0.5*dt*qbym[s]*(0.3535533905932737*rho[s][2])); 
      gkyl_mat_set(&lhs, 8 + num_species*(24), 10 + s*(24), 0.5*dt*qbym[s]*(0.3535533905932737*rho[s][2])); 
      gkyl_mat_set(&lhs, 16 + num_species*(24), 18 + s*(24), 0.5*dt*qbym[s]*(0.3535533905932737*rho[s][2])); 
    } 
    ...
    gkyl_mat_set(&lhs, 0 + s*(24), 3 + num_species*(24), E_field_fac*(0.0)); 
    gkyl_mat_set(&lhs, 8 + s*(24), 11 + num_species*(24), E_field_fac*(0.0)); 
    gkyl_mat_set(&lhs, 16 + s*(24), 19 + num_species*(24), E_field_fac*(0.0)); 
    ...
    if (!pkpm_field_static) { 
      gkyl_mat_set(&lhs, 0 + num_species*(24), 3 + s*(24), 0.5*dt*qbym[s]*(0.3535533905932737*rho[s][3])); 
      gkyl_mat_set(&lhs, 8 + num_species*(24), 11 + s*(24), 0.5*dt*qbym[s]*(0.3535533905932737*rho[s][3])); 
      gkyl_mat_set(&lhs, 16 + num_species*(24), 19 + s*(24), 0.5*dt*qbym[s]*(0.3535533905932737*rho[s][3])); 
    } 
    ...
    gkyl_mat_set(&lhs, 0 + s*(24), 4 + num_species*(24), E_field_fac*(0.0)); 
    gkyl_mat_set(&lhs, 8 + s*(24), 12 + num_species*(24), E_field_fac*(0.0)); 
    gkyl_mat_set(&lhs, 16 + s*(24), 20 + num_species*(24), E_field_fac*(0.0)); 
    ...
    if (!pkpm_field_static) { 
      gkyl_mat_set(&lhs, 0 + num_species*(24), 4 + s*(24), 0.5*dt*qbym[s]*(0.3535533905932737*rho[s][4])); 
      gkyl_mat_set(&lhs, 8 + num_species*(24), 12 + s*(24), 0.5*dt*qbym[s]*(0.3535533905932737*rho[s][4])); 
      gkyl_mat_set(&lhs, 16 + num_species*(24), 20 + s*(24), 0.5*dt*qbym[s]*(0.3535533905932737*rho[s][4])); 
    } 
    ...
    gkyl_mat_set(&lhs, 0 + s*(24), 5 + num_species*(24), E_field_fac*(0.0)); 
    gkyl_mat_set(&lhs, 8 + s*(24), 13 + num_species*(24), E_field_fac*(0.0)); 
    gkyl_mat_set(&lhs, 16 + s*(24), 21 + num_species*(24), E_field_fac*(0.0)); 
    ...
    if (!pkpm_field_static) { 
      gkyl_mat_set(&lhs, 0 + num_species*(24), 5 + s*(24), 0.5*dt*qbym[s]*(0.3535533905932737*rho[s][5])); 
      gkyl_mat_set(&lhs, 8 + num_species*(24), 13 + s*(24), 0.5*dt*qbym[s]*(0.3535533905932737*rho[s][5])); 
      gkyl_mat_set(&lhs, 16 + num_species*(24), 21 + s*(24), 0.5*dt*qbym[s]*(0.3535533905932737*rho[s][5])); 
    } 
    ...
    gkyl_mat_set(&lhs, 0 + s*(24), 6 + num_species*(24), E_field_fac*(0.0)); 
    gkyl_mat_set(&lhs, 8 + s*(24), 14 + num_species*(24), E_field_fac*(0.0)); 
    gkyl_mat_set(&lhs, 16 + s*(24), 22 + num_species*(24), E_field_fac*(0.0)); 
    ...
    if (!pkpm_field_static) { 
      gkyl_mat_set(&lhs, 0 + num_species*(24), 6 + s*(24), 0.5*dt*qbym[s]*(0.3535533905932737*rho[s][6])); 
      gkyl_mat_set(&lhs, 8 + num_species*(24), 14 + s*(24), 0.5*dt*qbym[s]*(0.3535533905932737*rho[s][6])); 
      gkyl_mat_set(&lhs, 16 + num_species*(24), 22 + s*(24), 0.5*dt*qbym[s]*(0.3535533905932737*rho[s][6])); 
    } 
    ...
    gkyl_mat_set(&lhs, 0 + s*(24), 7 + num_species*(24), E_field_fac*(0.0)); 
    gkyl_mat_set(&lhs, 8 + s*(24), 15 + num_species*(24), E_field_fac*(0.0)); 
    gkyl_mat_set(&lhs, 16 + s*(24), 23 + num_species*(24), E_field_fac*(0.0)); 
    ...
    if (!pkpm_field_static) { 
      gkyl_mat_set(&lhs, 0 + num_species*(24), 7 + s*(24), 0.5*dt*qbym[s]*(0.3535533905932737*rho[s][10])); 
      gkyl_mat_set(&lhs, 8 + num_species*(24), 15 + s*(24), 0.5*dt*qbym[s]*(0.3535533905932737*rho[s][10])); 
      gkyl_mat_set(&lhs, 16 + num_species*(24), 23 + s*(24), 0.5*dt*qbym[s]*(0.3535533905932737*rho[s][10])); 
    } 
    ...
    gkyl_mat_set(&lhs, 1 + s*(24), 0 + num_species*(24), E_field_fac*(0.0)); 
    gkyl_mat_set(&lhs, 9 + s*(24), 8 + num_species*(24), E_field_fac*(0.0)); 
    gkyl_mat_set(&lhs, 17 + s*(24), 16 + num_species*(24), E_field_fac*(0.0)); 
    ...
    if (!pkpm_field_static) { 
      gkyl_mat_set(&lhs, 1 + num_species*(24), 0 + s*(24), 0.5*dt*qbym[s]*(0.3535533905932737*rho[s][1])); 
      gkyl_mat_set(&lhs, 9 + num_species*(24), 8 + s*(24), 0.5*dt*qbym[s]*(0.3535533905932737*rho[s][1])); 
      gkyl_mat_set(&lhs, 17 + num_species*(24), 16 + s*(24), 0.5*dt*qbym[s]*(0.3535533905932737*rho[s][1])); 
    } 
    ...
    gkyl_mat_set(&lhs, 1 + s*(24), 1 + num_species*(24), E_field_fac*(1.0)); 
    gkyl_mat_set(&lhs, 9 + s*(24), 9 + num_species*(24), E_field_fac*(1.0)); 
    gkyl_mat_set(&lhs, 17 + s*(24), 17 + num_species*(24), E_field_fac*(1.0)); 
    ...
    if (!pkpm_field_static) { 
      gkyl_mat_set(&lhs, 1 + num_species*(24), 1 + s*(24), 0.5*dt*qbym[s]*(0.3162277660168379*rho[s][7]+0.3535533905932737*rho[s][0])); 
      gkyl_mat_set(&lhs, 9 + num_species*(24), 9 + s*(24), 0.5*dt*qbym[s]*(0.3162277660168379*rho[s][7]+0.3535533905932737*rho[s][0])); 
      gkyl_mat_set(&lhs, 17 + num_species*(24), 17 + s*(24), 0.5*dt*qbym[s]*(0.3162277660168379*rho[s][7]+0.3535533905932737*rho[s][0])); 
    } 
    ...
    gkyl_mat_set(&lhs, 1 + s*(24), 2 + num_species*(24), E_field_fac*(0.0)); 
    gkyl_mat_set(&lhs, 9 + s*(24), 10 + num_species*(24), E_field_fac*(0.0)); 
    gkyl_mat_set(&lhs, 17 + s*(24), 18 + num_species*(24), E_field_fac*(0.0)); 
    ...
    if (!pkpm_field_static) { 
      gkyl_mat_set(&lhs, 1 + num_species*(24), 2 + s*(24), 0.5*dt*qbym[s]*(0.3535533905932737*rho[s][4])); 
      gkyl_mat_set(&lhs, 9 + num_species*(24), 10 + s*(24), 0.5*dt*qbym[s]*(0.3535533905932737*rho[s][4])); 
      gkyl_mat_set(&lhs, 17 + num_species*(24), 18 + s*(24), 0.5*dt*qbym[s]*(0.3535533905932737*rho[s][4])); 
    } 
    ...
    gkyl_mat_set(&lhs, 1 + s*(24), 3 + num_species*(24), E_field_fac*(0.0)); 
    gkyl_mat_set(&lhs, 9 + s*(24), 11 + num_species*(24), E_field_fac*(0.0)); 
    gkyl_mat_set(&lhs, 17 + s*(24), 19 + num_species*(24), E_field_fac*(0.0)); 
    ...
    if (!pkpm_field_static) { 
      gkyl_mat_set(&lhs, 1 + num_species*(24), 3 + s*(24), 0.5*dt*qbym[s]*(0.3535533905932737*rho[s][5])); 
      gkyl_mat_set(&lhs, 9 + num_species*(24), 11 + s*(24), 0.5*dt*qbym[s]*(0.3535533905932737*rho[s][5])); 
      gkyl_mat_set(&lhs, 17 + num_species*(24), 19 + s*(24), 0.5*dt*qbym[s]*(0.3535533905932737*rho[s][5])); 
    } 
    ...
    gkyl_mat_set(&lhs, 1 + s*(24), 4 + num_species*(24), E_field_fac*(0.0)); 
    gkyl_mat_set(&lhs, 9 + s*(24), 12 + num_species*(24), E_field_fac*(0.0)); 
    gkyl_mat_set(&lhs, 17 + s*(24), 20 + num_species*(24), E_field_fac*(0.0)); 
    ...
    if (!pkpm_field_static) { 
      gkyl_mat_set(&lhs, 1 + num_species*(24), 4 + s*(24), 0.5*dt*qbym[s]*(0.3162277660168379*rho[s][11]+0.3535533905932737*rho[s][2])); 
      gkyl_mat_set(&lhs, 9 + num_species*(24), 12 + s*(24), 0.5*dt*qbym[s]*(0.3162277660168379*rho[s][11]+0.3535533905932737*rho[s][2])); 
      gkyl_mat_set(&lhs, 17 + num_species*(24), 20 + s*(24), 0.5*dt*qbym[s]*(0.3162277660168379*rho[s][11]+0.3535533905932737*rho[s][2])); 
    } 
    ...
    gkyl_mat_set(&lhs, 1 + s*(24), 5 + num_species*(24), E_field_fac*(0.0)); 
    gkyl_mat_set(&lhs, 9 + s*(24), 13 + num_species*(24), E_field_fac*(0.0)); 
    gkyl_mat_set(&lhs, 17 + s*(24), 21 + num_species*(24), E_field_fac*(0.0)); 
    ...
    if (!pkpm_field_static) { 
      gkyl_mat_set(&lhs, 1 + num_species*(24), 5 + s*(24), 0.5*dt*qbym[s]*(0.3162277660168379*rho[s][13]+0.3535533905932737*rho[s][3])); 
      gkyl_mat_set(&lhs, 9 + num_species*(24), 13 + s*(24), 0.5*dt*qbym[s]*(0.3162277660168379*rho[s][13]+0.3535533905932737*rho[s][3])); 
      gkyl_mat_set(&lhs, 17 + num_species*(24), 21 + s*(24), 0.5*dt*qbym[s]*(0.3162277660168379*rho[s][13]+0.3535533905932737*rho[s][3])); 
    } 
    ...
    gkyl_mat_set(&lhs, 1 + s*(24), 6 + num_species*(24), E_field_fac*(0.0)); 
    gkyl_mat_set(&lhs, 9 + s*(24), 14 + num_species*(24), E_field_fac*(0.0)); 
    gkyl_mat_set(&lhs, 17 + s*(24), 22 + num_species*(24), E_field_fac*(0.0)); 
    ...
    if (!pkpm_field_static) { 
      gkyl_mat_set(&lhs, 1 + num_species*(24), 6 + s*(24), 0.5*dt*qbym[s]*(0.3535533905932737*rho[s][10])); 
      gkyl_mat_set(&lhs, 9 + num_species*(24), 14 + s*(24), 0.5*dt*qbym[s]*(0.3535533905932737*rho[s][10])); 
      gkyl_mat_set(&lhs, 17 + num_species*(24), 22 + s*(24), 0.5*dt*qbym[s]*(0.3535533905932737*rho[s][10])); 
    } 
    ...
    gkyl_mat_set(&lhs, 1 + s*(24), 7 + num_species*(24), E_field_fac*(0.0)); 
    gkyl_mat_set(&lhs, 9 + s*(24), 15 + num_species*(24), E_field_fac*(0.0)); 
    gkyl_mat_set(&lhs, 17 + s*(24), 23 + num_species*(24), E_field_fac*(0.0)); 
    ...
    if (!pkpm_field_static) { 
      gkyl_mat_set(&lhs, 1 + num_species*(24), 7 + s*(24), 0.5*dt*qbym[s]*(0.3162277660168379*rho[s][17]+0.3535533905932737*rho[s][6])); 
      gkyl_mat_set(&lhs, 9 + num_species*(24), 15 + s*(24), 0.5*dt*qbym[s]*(0.3162277660168379*rho[s][17]+0.3535533905932737*rho[s][6])); 
      gkyl_mat_set(&lhs, 17 + num_species*(24), 23 + s*(24), 0.5*dt*qbym[s]*(0.3162277660168379*rho[s][17]+0.3535533905932737*rho[s][6])); 
    } 
    ...
    gkyl_mat_set(&lhs, 2 + s*(24), 0 + num_species*(24), E_field_fac*(0.0)); 
    gkyl_mat_set(&lhs, 10 + s*(24), 8 + num_species*(24), E_field_fac*(0.0)); 
    gkyl_mat_set(&lhs, 18 + s*(24), 16 + num_species*(24), E_field_fac*(0.0)); 
    ...
    if (!pkpm_field_static) { 
      gkyl_mat_set(&lhs, 2 + num_species*(24), 0 + s*(24), 0.5*dt*qbym[s]*(0.3535533905932737*rho[s][2])); 
      gkyl_mat_set(&lhs, 10 + num_species*(24), 8 + s*(24), 0.5*dt*qbym[s]*(0.3535533905932737*rho[s][2])); 
      gkyl_mat_set(&lhs, 18 + num_species*(24), 16 + s*(24), 0.5*dt*qbym[s]*(0.3535533905932737*rho[s][2])); 
    } 
    ...
    gkyl_mat_set(&lhs, 2 + s*(24), 1 + num_species*(24), E_field_fac*(0.0)); 
    gkyl_mat_set(&lhs, 10 + s*(24), 9 + num_species*(24), E_field_fac*(0.0)); 
    gkyl_mat_set(&lhs, 18 + s*(24), 17 + num_species*(24), E_field_fac*(0.0)); 
    ...
    if (!pkpm_field_static) { 
      gkyl_mat_set(&lhs, 2 + num_species*(24), 1 + s*(24), 0.5*dt*qbym[s]*(0.3535533905932737*rho[s][4])); 
      gkyl_mat_set(&lhs, 10 + num_species*(24), 9 + s*(24), 0.5*dt*qbym[s]*(0.3535533905932737*rho[s][4])); 
      gkyl_mat_set(&lhs, 18 + num_species*(24), 17 + s*(24), 0.5*dt*qbym[s]*(0.3535533905932737*rho[s][4])); 
    } 
    ...
    gkyl_mat_set(&lhs, 2 + s*(24), 2 + num_species*(24), E_field_fac*(1.0)); 
    gkyl_mat_set(&lhs, 10 + s*(24), 10 + num_species*(24), E_field_fac*(1.0)); 
    gkyl_mat_set(&lhs, 18 + s*(24), 18 + num_species*(24), E_field_fac*(1.0)); 
    ...
    if (!pkpm_field_static) { 
      gkyl_mat_set(&lhs, 2 + num_species*(24), 2 + s*(24), 0.5*dt*qbym[s]*(0.3162277660168379*rho[s][8]+0.3535533905932737*rho[s][0])); 
      gkyl_mat_set(&lhs, 10 + num_species*(24), 10 + s*(24), 0.5*dt*qbym[s]*(0.3162277660168379*rho[s][8]+0.3535533905932737*rho[s][0])); 
      gkyl_mat_set(&lhs, 18 + num_species*(24), 18 + s*(24), 0.5*dt*qbym[s]*(0.3162277660168379*rho[s][8]+0.3535533905932737*rho[s][0])); 
    } 
    ...
    gkyl_mat_set(&lhs, 2 + s*(24), 3 + num_species*(24), E_field_fac*(0.0)); 
    gkyl_mat_set(&lhs, 10 + s*(24), 11 + num_species*(24), E_field_fac*(0.0)); 
    gkyl_mat_set(&lhs, 18 + s*(24), 19 + num_species*(24), E_field_fac*(0.0)); 
    ...
    if (!pkpm_field_static) { 
      gkyl_mat_set(&lhs, 2 + num_species*(24), 3 + s*(24), 0.5*dt*qbym[s]*(0.3535533905932737*rho[s][6])); 
      gkyl_mat_set(&lhs, 10 + num_species*(24), 11 + s*(24), 0.5*dt*qbym[s]*(0.3535533905932737*rho[s][6])); 
      gkyl_mat_set(&lhs, 18 + num_species*(24), 19 + s*(24), 0.5*dt*qbym[s]*(0.3535533905932737*rho[s][6])); 
    } 
    ...
    gkyl_mat_set(&lhs, 2 + s*(24), 4 + num_species*(24), E_field_fac*(0.0)); 
    gkyl_mat_set(&lhs, 10 + s*(24), 12 + num_species*(24), E_field_fac*(0.0)); 
    gkyl_mat_set(&lhs, 18 + s*(24), 20 + num_species*(24), E_field_fac*(0.0)); 
    ...
    if (!pkpm_field_static) { 
      gkyl_mat_set(&lhs, 2 + num_species*(24), 4 + s*(24), 0.5*dt*qbym[s]*(0.3162277660168379*rho[s][12]+0.3535533905932737*rho[s][1])); 
      gkyl_mat_set(&lhs, 10 + num_species*(24), 12 + s*(24), 0.5*dt*qbym[s]*(0.3162277660168379*rho[s][12]+0.3535533905932737*rho[s][1])); 
      gkyl_mat_set(&lhs, 18 + num_species*(24), 20 + s*(24), 0.5*dt*qbym[s]*(0.3162277660168379*rho[s][12]+0.3535533905932737*rho[s][1])); 
    } 
    ...
    gkyl_mat_set(&lhs, 2 + s*(24), 5 + num_species*(24), E_field_fac*(0.0)); 
    gkyl_mat_set(&lhs, 10 + s*(24), 13 + num_species*(24), E_field_fac*(0.0)); 
    gkyl_mat_set(&lhs, 18 + s*(24), 21 + num_species*(24), E_field_fac*(0.0)); 
    ...
    if (!pkpm_field_static) { 
      gkyl_mat_set(&lhs, 2 + num_species*(24), 5 + s*(24), 0.5*dt*qbym[s]*(0.3535533905932737*rho[s][10])); 
      gkyl_mat_set(&lhs, 10 + num_species*(24), 13 + s*(24), 0.5*dt*qbym[s]*(0.3535533905932737*rho[s][10])); 
      gkyl_mat_set(&lhs, 18 + num_species*(24), 21 + s*(24), 0.5*dt*qbym[s]*(0.3535533905932737*rho[s][10])); 
    } 
    ...
    gkyl_mat_set(&lhs, 2 + s*(24), 6 + num_species*(24), E_field_fac*(0.0)); 
    gkyl_mat_set(&lhs, 10 + s*(24), 14 + num_species*(24), E_field_fac*(0.0)); 
    gkyl_mat_set(&lhs, 18 + s*(24), 22 + num_species*(24), E_field_fac*(0.0)); 
    ...
    if (!pkpm_field_static) { 
      gkyl_mat_set(&lhs, 2 + num_species*(24), 6 + s*(24), 0.5*dt*qbym[s]*(0.3162277660168379*rho[s][14]+0.3535533905932737*rho[s][3])); 
      gkyl_mat_set(&lhs, 10 + num_species*(24), 14 + s*(24), 0.5*dt*qbym[s]*(0.3162277660168379*rho[s][14]+0.3535533905932737*rho[s][3])); 
      gkyl_mat_set(&lhs, 18 + num_species*(24), 22 + s*(24), 0.5*dt*qbym[s]*(0.3162277660168379*rho[s][14]+0.3535533905932737*rho[s][3])); 
    } 
    ...
    gkyl_mat_set(&lhs, 2 + s*(24), 7 + num_species*(24), E_field_fac*(0.0)); 
    gkyl_mat_set(&lhs, 10 + s*(24), 15 + num_species*(24), E_field_fac*(0.0)); 
    gkyl_mat_set(&lhs, 18 + s*(24), 23 + num_species*(24), E_field_fac*(0.0)); 
    ...
    if (!pkpm_field_static) { 
      gkyl_mat_set(&lhs, 2 + num_species*(24), 7 + s*(24), 0.5*dt*qbym[s]*(0.3162277660168379*rho[s][18]+0.3535533905932737*rho[s][5])); 
      gkyl_mat_set(&lhs, 10 + num_species*(24), 15 + s*(24), 0.5*dt*qbym[s]*(0.3162277660168379*rho[s][18]+0.3535533905932737*rho[s][5])); 
      gkyl_mat_set(&lhs, 18 + num_species*(24), 23 + s*(24), 0.5*dt*qbym[s]*(0.3162277660168379*rho[s][18]+0.3535533905932737*rho[s][5])); 
    } 
    ...
    gkyl_mat_set(&lhs, 3 + s*(24), 0 + num_species*(24), E_field_fac*(0.0)); 
    gkyl_mat_set(&lhs, 11 + s*(24), 8 + num_species*(24), E_field_fac*(0.0)); 
    gkyl_mat_set(&lhs, 19 + s*(24), 16 + num_species*(24), E_field_fac*(0.0)); 
    ...
    if (!pkpm_field_static) { 
      gkyl_mat_set(&lhs, 3 + num_species*(24), 0 + s*(24), 0.5*dt*qbym[s]*(0.3535533905932737*rho[s][3])); 
      gkyl_mat_set(&lhs, 11 + num_species*(24), 8 + s*(24), 0.5*dt*qbym[s]*(0.3535533905932737*rho[s][3])); 
      gkyl_mat_set(&lhs, 19 + num_species*(24), 16 + s*(24), 0.5*dt*qbym[s]*(0.3535533905932737*rho[s][3])); 
    } 
    ...
    gkyl_mat_set(&lhs, 3 + s*(24), 1 + num_species*(24), E_field_fac*(0.0)); 
    gkyl_mat_set(&lhs, 11 + s*(24), 9 + num_species*(24), E_field_fac*(0.0)); 
    gkyl_mat_set(&lhs, 19 + s*(24), 17 + num_species*(24), E_field_fac*(0.0)); 
    ...
    if (!pkpm_field_static) { 
      gkyl_mat_set(&lhs, 3 + num_species*(24), 1 + s*(24), 0.5*dt*qbym[s]*(0.3535533905932737*rho[s][5])); 
      gkyl_mat_set(&lhs, 11 + num_species*(24), 9 + s*(24), 0.5*dt*qbym[s]*(0.3535533905932737*rho[s][5])); 
      gkyl_mat_set(&lhs, 19 + num_species*(24), 17 + s*(24), 0.5*dt*qbym[s]*(0.3535533905932737*rho[s][5])); 
    } 
    ...
    gkyl_mat_set(&lhs, 3 + s*(24), 2 + num_species*(24), E_field_fac*(0.0)); 
    gkyl_mat_set(&lhs, 11 + s*(24), 10 + num_species*(24), E_field_fac*(0.0)); 
    gkyl_mat_set(&lhs, 19 + s*(24), 18 + num_species*(24), E_field_fac*(0.0)); 
    ...
    if (!pkpm_field_static) { 
      gkyl_mat_set(&lhs, 3 + num_species*(24), 2 + s*(24), 0.5*dt*qbym[s]*(0.3535533905932737*rho[s][6])); 
      gkyl_mat_set(&lhs, 11 + num_species*(24), 10 + s*(24), 0.5*dt*qbym[s]*(0.3535533905932737*rho[s][6])); 
      gkyl_mat_set(&lhs, 19 + num_species*(24), 18 + s*(24), 0.5*dt*qbym[s]*(0.3535533905932737*rho[s][6])); 
    } 
    ...
    gkyl_mat_set(&lhs, 3 + s*(24), 3 + num_species*(24), E_field_fac*(1.0)); 
    gkyl_mat_set(&lhs, 11 + s*(24), 11 + num_species*(24), E_field_fac*(1.0)); 
    gkyl_mat_set(&lhs, 19 + s*(24), 19 + num_species*(24), E_field_fac*(1.0)); 
    ...
    if (!pkpm_field_static) { 
      gkyl_mat_set(&lhs, 3 + num_species*(24), 3 + s*(24), 0.5*dt*qbym[s]*(0.3162277660168379*rho[s][9]+0.3535533905932737*rho[s][0])); 
      gkyl_mat_set(&lhs, 11 + num_species*(24), 11 + s*(24), 0.5*dt*qbym[s]*(0.3162277660168379*rho[s][9]+0.3535533905932737*rho[s][0])); 
      gkyl_mat_set(&lhs, 19 + num_species*(24), 19 + s*(24), 0.5*dt*qbym[s]*(0.3162277660168379*rho[s][9]+0.3535533905932737*rho[s][0])); 
    } 
    ...
    gkyl_mat_set(&lhs, 3 + s*(24), 4 + num_species*(24), E_field_fac*(0.0)); 
    gkyl_mat_set(&lhs, 11 + s*(24), 12 + num_species*(24), E_field_fac*(0.0)); 
    gkyl_mat_set(&lhs, 19 + s*(24), 20 + num_species*(24), E_field_fac*(0.0)); 
    ...
    if (!pkpm_field_static) { 
      gkyl_mat_set(&lhs, 3 + num_species*(24), 4 + s*(24), 0.5*dt*qbym[s]*(0.3535533905932737*rho[s][10])); 
      gkyl_mat_set(&lhs, 11 + num_species*(24), 12 + s*(24), 0.5*dt*qbym[s]*(0.3535533905932737*rho[s][10])); 
      gkyl_mat_set(&lhs, 19 + num_species*(24), 20 + s*(24), 0.5*dt*qbym[s]*(0.3535533905932737*rho[s][10])); 
    } 
    ...
    gkyl_mat_set(&lhs, 3 + s*(24), 5 + num_species*(24), E_field_fac*(0.0)); 
    gkyl_mat_set(&lhs, 11 + s*(24), 13 + num_species*(24), E_field_fac*(0.0)); 
    gkyl_mat_set(&lhs, 19 + s*(24), 21 + num_species*(24), E_field_fac*(0.0)); 
    ...
    if (!pkpm_field_static) { 
      gkyl_mat_set(&lhs, 3 + num_species*(24), 5 + s*(24), 0.5*dt*qbym[s]*(0.3162277660168379*rho[s][15]+0.3535533905932737*rho[s][1])); 
      gkyl_mat_set(&lhs, 11 + num_species*(24), 13 + s*(24), 0.5*dt*qbym[s]*(0.3162277660168379*rho[s][15]+0.3535533905932737*rho[s][1])); 
      gkyl_mat_set(&lhs, 19 + num_species*(24), 21 + s*(24), 0.5*dt*qbym[s]*(0.3162277660168379*rho[s][15]+0.3535533905932737*rho[s][1])); 
    } 
    ...
    gkyl_mat_set(&lhs, 3 + s*(24), 6 + num_species*(24), E_field_fac*(0.0)); 
    gkyl_mat_set(&lhs, 11 + s*(24), 14 + num_species*(24), E_field_fac*(0.0)); 
    gkyl_mat_set(&lhs, 19 + s*(24), 22 + num_species*(24), E_field_fac*(0.0)); 
    ...
    if (!pkpm_field_static) { 
      gkyl_mat_set(&lhs, 3 + num_species*(24), 6 + s*(24), 0.5*dt*qbym[s]*(0.3162277660168379*rho[s][16]+0.3535533905932737*rho[s][2])); 
      gkyl_mat_set(&lhs, 11 + num_species*(24), 14 + s*(24), 0.5*dt*qbym[s]*(0.3162277660168379*rho[s][16]+0.3535533905932737*rho[s][2])); 
      gkyl_mat_set(&lhs, 19 + num_species*(24), 22 + s*(24), 0.5*dt*qbym[s]*(0.3162277660168379*rho[s][16]+0.3535533905932737*rho[s][2])); 
    } 
    ...
    gkyl_mat_set(&lhs, 3 + s*(24), 7 + num_species*(24), E_field_fac*(0.0)); 
    gkyl_mat_set(&lhs, 11 + s*(24), 15 + num_species*(24), E_field_fac*(0.0)); 
    gkyl_mat_set(&lhs, 19 + s*(24), 23 + num_species*(24), E_field_fac*(0.0)); 
    ...
    if (!pkpm_field_static) { 
      gkyl_mat_set(&lhs, 3 + num_species*(24), 7 + s*(24), 0.5*dt*qbym[s]*(0.3162277660168379*rho[s][19]+0.3535533905932737*rho[s][4])); 
      gkyl_mat_set(&lhs, 11 + num_species*(24), 15 + s*(24), 0.5*dt*qbym[s]*(0.3162277660168379*rho[s][19]+0.3535533905932737*rho[s][4])); 
      gkyl_mat_set(&lhs, 19 + num_species*(24), 23 + s*(24), 0.5*dt*qbym[s]*(0.3162277660168379*rho[s][19]+0.3535533905932737*rho[s][4])); 
    } 
    ...
    gkyl_mat_set(&lhs, 4 + s*(24), 0 + num_species*(24), E_field_fac*(0.0)); 
    gkyl_mat_set(&lhs, 12 + s*(24), 8 + num_species*(24), E_field_fac*(0.0)); 
    gkyl_mat_set(&lhs, 20 + s*(24), 16 + num_species*(24), E_field_fac*(0.0)); 
    ...
    if (!pkpm_field_static) { 
      gkyl_mat_set(&lhs, 4 + num_species*(24), 0 + s*(24), 0.5*dt*qbym[s]*(0.3535533905932737*rho[s][4])); 
      gkyl_mat_set(&lhs, 12 + num_species*(24), 8 + s*(24), 0.5*dt*qbym[s]*(0.3535533905932737*rho[s][4])); 
      gkyl_mat_set(&lhs, 20 + num_species*(24), 16 + s*(24), 0.5*dt*qbym[s]*(0.3535533905932737*rho[s][4])); 
    } 
    ...
    gkyl_mat_set(&lhs, 4 + s*(24), 1 + num_species*(24), E_field_fac*(0.0)); 
    gkyl_mat_set(&lhs, 12 + s*(24), 9 + num_species*(24), E_field_fac*(0.0)); 
    gkyl_mat_set(&lhs, 20 + s*(24), 17 + num_species*(24), E_field_fac*(0.0)); 
    ...
    if (!pkpm_field_static) { 
      gkyl_mat_set(&lhs, 4 + num_species*(24), 1 + s*(24), 0.5*dt*qbym[s]*(0.3162277660168379*rho[s][11]+0.3535533905932737*rho[s][2])); 
      gkyl_mat_set(&lhs, 12 + num_species*(24), 9 + s*(24), 0.5*dt*qbym[s]*(0.3162277660168379*rho[s][11]+0.3535533905932737*rho[s][2])); 
      gkyl_mat_set(&lhs, 20 + num_species*(24), 17 + s*(24), 0.5*dt*qbym[s]*(0.3162277660168379*rho[s][11]+0.3535533905932737*rho[s][2])); 
    } 
    ...
    gkyl_mat_set(&lhs, 4 + s*(24), 2 + num_species*(24), E_field_fac*(0.0)); 
    gkyl_mat_set(&lhs, 12 + s*(24), 10 + num_species*(24), E_field_fac*(0.0)); 
    gkyl_mat_set(&lhs, 20 + s*(24), 18 + num_species*(24), E_field_fac*(0.0)); 
    ...
    if (!pkpm_field_static) { 
      gkyl_mat_set(&lhs, 4 + num_species*(24), 2 + s*(24), 0.5*dt*qbym[s]*(0.3162277660168379*rho[s][12]+0.3535533905932737*rho[s][1])); 
      gkyl_mat_set(&lhs, 12 + num_species*(24), 10 + s*(24), 0.5*dt*qbym[s]*(0.3162277660168379*rho[s][12]+0.3535533905932737*rho[s][1])); 
      gkyl_mat_set(&lhs, 20 + num_species*(24), 18 + s*(24), 0.5*dt*qbym[s]*(0.3162277660168379*rho[s][12]+0.3535533905932737*rho[s][1])); 
    } 
    ...
    gkyl_mat_set(&lhs, 4 + s*(24), 3 + num_species*(24), E_field_fac*(0.0)); 
    gkyl_mat_set(&lhs, 12 + s*(24), 11 + num_species*(24), E_field_fac*(0.0)); 
    gkyl_mat_set(&lhs, 20 + s*(24), 19 + num_species*(24), E_field_fac*(0.0)); 
    ...
    if (!pkpm_field_static) { 
      gkyl_mat_set(&lhs, 4 + num_species*(24), 3 + s*(24), 0.5*dt*qbym[s]*(0.3535533905932737*rho[s][10])); 
      gkyl_mat_set(&lhs, 12 + num_species*(24), 11 + s*(24), 0.5*dt*qbym[s]*(0.3535533905932737*rho[s][10])); 
      gkyl_mat_set(&lhs, 20 + num_species*(24), 19 + s*(24), 0.5*dt*qbym[s]*(0.3535533905932737*rho[s][10])); 
    } 
    ...
    gkyl_mat_set(&lhs, 4 + s*(24), 4 + num_species*(24), E_field_fac*(1.0)); 
    gkyl_mat_set(&lhs, 12 + s*(24), 12 + num_species*(24), E_field_fac*(1.0)); 
    gkyl_mat_set(&lhs, 20 + s*(24), 20 + num_species*(24), E_field_fac*(1.0)); 
    ...
    if (!pkpm_field_static) { 
      gkyl_mat_set(&lhs, 4 + num_species*(24), 4 + s*(24), 0.5*dt*qbym[s]*(0.2828427124746191*rho[s][20]+0.3162277660168379*rho[s][8]+0.3162277660168379*rho[s][7]+0.3535533905932737*rho[s][0])); 
      gkyl_mat_set(&lhs, 12 + num_species*(24), 12 + s*(24), 0.5*dt*qbym[s]*(0.2828427124746191*rho[s][20]+0.3162277660168379*rho[s][8]+0.3162277660168379*rho[s][7]+0.3535533905932737*rho[s][0])); 
      gkyl_mat_set(&lhs, 20 + num_species*(24), 20 + s*(24), 0.5*dt*qbym[s]*(0.2828427124746191*rho[s][20]+0.3162277660168379*rho[s][8]+0.3162277660168379*rho[s][7]+0.3535533905932737*rho[s][0])); 
    } 
    ...
    gkyl_mat_set(&lhs, 4 + s*(24), 5 + num_species*(24), E_field_fac*(0.0)); 
    gkyl_mat_set(&lhs, 12 + s*(24), 13 + num_species*(24), E_field_fac*(0.0)); 
    gkyl_mat_set(&lhs, 20 + s*(24), 21 + num_species*(24), E_field_fac*(0.0)); 
    ...
    if (!pkpm_field_static) { 
      gkyl_mat_set(&lhs, 4 + num_species*(24), 5 + s*(24), 0.5*dt*qbym[s]*(0.3162277660168379*rho[s][17]+0.3535533905932737*rho[s][6])); 
      gkyl_mat_set(&lhs, 12 + num_species*(24), 13 + s*(24), 0.5*dt*qbym[s]*(0.3162277660168379*rho[s][17]+0.3535533905932737*rho[s][6])); 
      gkyl_mat_set(&lhs, 20 + num_species*(24), 21 + s*(24), 0.5*dt*qbym[s]*(0.3162277660168379*rho[s][17]+0.3535533905932737*rho[s][6])); 
    } 
    ...
    gkyl_mat_set(&lhs, 4 + s*(24), 6 + num_species*(24), E_field_fac*(0.0)); 
    gkyl_mat_set(&lhs, 12 + s*(24), 14 + num_species*(24), E_field_fac*(0.0)); 
    gkyl_mat_set(&lhs, 20 + s*(24), 22 + num_species*(24), E_field_fac*(0.0)); 
    ...
    if (!pkpm_field_static) { 
      gkyl_mat_set(&lhs, 4 + num_species*(24), 6 + s*(24), 0.5*dt*qbym[s]*(0.3162277660168379*rho[s][18]+0.3535533905932737*rho[s][5])); 
      gkyl_mat_set(&lhs, 12 + num_species*(24), 14 + s*(24), 0.5*dt*qbym[s]*(0.3162277660168379*rho[s][18]+0.3535533905932737*rho[s][5])); 
      gkyl_mat_set(&lhs, 20 + num_species*(24), 22 + s*(24), 0.5*dt*qbym[s]*(0.3162277660168379*rho[s][18]+0.3535533905932737*rho[s][5])); 
    } 
    ...
    gkyl_mat_set(&lhs, 4 + s*(24), 7 + num_species*(24), E_field_fac*(0.0)); 
    gkyl_mat_set(&lhs, 12 + s*(24), 15 + num_species*(24), E_field_fac*(0.0)); 
    gkyl_mat_set(&lhs, 20 + s*(24), 23 + num_species*(24), E_field_fac*(0.0)); 
    ...
    if (!pkpm_field_static) { 
      gkyl_mat_set(&lhs, 4 + num_species*(24), 7 + s*(24), 0.5*dt*qbym[s]*(0.2828427124746191*rho[s][23]+0.3162277660168379*rho[s][14]+0.3162277660168379*rho[s][13]+0.3535533905932737*rho[s][3])); 
      gkyl_mat_set(&lhs, 12 + num_species*(24), 15 + s*(24), 0.5*dt*qbym[s]*(0.2828427124746191*rho[s][23]+0.3162277660168379*rho[s][14]+0.3162277660168379*rho[s][13]+0.3535533905932737*rho[s][3])); 
      gkyl_mat_set(&lhs, 20 + num_species*(24), 23 + s*(24), 0.5*dt*qbym[s]*(0.2828427124746191*rho[s][23]+0.3162277660168379*rho[s][14]+0.3162277660168379*rho[s][13]+0.3535533905932737*rho[s][3])); 
    } 
    ...
    gkyl_mat_set(&lhs, 5 + s*(24), 0 + num_species*(24), E_field_fac*(0.0)); 
    gkyl_mat_set(&lhs, 13 + s*(24), 8 + num_species*(24), E_field_fac*(0.0)); 
    gkyl_mat_set(&lhs, 21 + s*(24), 16 + num_species*(24), E_field_fac*(0.0)); 
    ...
    if (!pkpm_field_static) { 
      gkyl_mat_set(&lhs, 5 + num_species*(24), 0 + s*(24), 0.5*dt*qbym[s]*(0.3535533905932737*rho[s][5])); 
      gkyl_mat_set(&lhs, 13 + num_species*(24), 8 + s*(24), 0.5*dt*qbym[s]*(0.3535533905932737*rho[s][5])); 
      gkyl_mat_set(&lhs, 21 + num_species*(24), 16 + s*(24), 0.5*dt*qbym[s]*(0.3535533905932737*rho[s][5])); 
    } 
    ...
    gkyl_mat_set(&lhs, 5 + s*(24), 1 + num_species*(24), E_field_fac*(0.0)); 
    gkyl_mat_set(&lhs, 13 + s*(24), 9 + num_species*(24), E_field_fac*(0.0)); 
    gkyl_mat_set(&lhs, 21 + s*(24), 17 + num_species*(24), E_field_fac*(0.0)); 
    ...
    if (!pkpm_field_static) { 
      gkyl_mat_set(&lhs, 5 + num_species*(24), 1 + s*(24), 0.5*dt*qbym[s]*(0.3162277660168379*rho[s][13]+0.3535533905932737*rho[s][3])); 
      gkyl_mat_set(&lhs, 13 + num_species*(24), 9 + s*(24), 0.5*dt*qbym[s]*(0.3162277660168379*rho[s][13]+0.3535533905932737*rho[s][3])); 
      gkyl_mat_set(&lhs, 21 + num_species*(24), 17 + s*(24), 0.5*dt*qbym[s]*(0.3162277660168379*rho[s][13]+0.3535533905932737*rho[s][3])); 
    } 
    ...
    gkyl_mat_set(&lhs, 5 + s*(24), 2 + num_species*(24), E_field_fac*(0.0)); 
    gkyl_mat_set(&lhs, 13 + s*(24), 10 + num_species*(24), E_field_fac*(0.0)); 
    gkyl_mat_set(&lhs, 21 + s*(24), 18 + num_species*(24), E_field_fac*(0.0)); 
    ...
    if (!pkpm_field_static) { 
      gkyl_mat_set(&lhs, 5 + num_species*(24), 2 + s*(24), 0.5*dt*qbym[s]*(0.3535533905932737*rho[s][10])); 
      gkyl_mat_set(&lhs, 13 + num_species*(24), 10 + s*(24), 0.5*dt*qbym[s]*(0.3535533905932737*rho[s][10])); 
      gkyl_mat_set(&lhs, 21 + num_species*(24), 18 + s*(24), 0.5*dt*qbym[s]*(0.3535533905932737*rho[s][10])); 
    } 
    ...
    gkyl_mat_set(&lhs, 5 + s*(24), 3 + num_species*(24), E_field_fac*(0.0)); 
    gkyl_mat_set(&lhs, 13 + s*(24), 11 + num_species*(24), E_field_fac*(0.0)); 
    gkyl_mat_set(&lhs, 21 + s*(24), 19 + num_species*(24), E_field_fac*(0.0)); 
    ...
    if (!pkpm_field_static) { 
      gkyl_mat_set(&lhs, 5 + num_species*(24), 3 + s*(24), 0.5*dt*qbym[s]*(0.3162277660168379*rho[s][15]+0.3535533905932737*rho[s][1])); 
      gkyl_mat_set(&lhs, 13 + num_species*(24), 11 + s*(24), 0.5*dt*qbym[s]*(0.3162277660168379*rho[s][15]+0.3535533905932737*rho[s][1])); 
      gkyl_mat_set(&lhs, 21 + num_species*(24), 19 + s*(24), 0.5*dt*qbym[s]*(0.3162277660168379*rho[s][15]+0.3535533905932737*rho[s][1])); 
    } 
    ...
    gkyl_mat_set(&lhs, 5 + s*(24), 4 + num_species*(24), E_field_fac*(0.0)); 
    gkyl_mat_set(&lhs, 13 + s*(24), 12 + num_species*(24), E_field_fac*(0.0)); 
    gkyl_mat_set(&lhs, 21 + s*(24), 20 + num_species*(24), E_field_fac*(0.0)); 
    ...
    if (!pkpm_field_static) { 
      gkyl_mat_set(&lhs, 5 + num_species*(24), 4 + s*(24), 0.5*dt*qbym[s]*(0.3162277660168379*rho[s][17]+0.3535533905932737*rho[s][6])); 
      gkyl_mat_set(&lhs, 13 + num_species*(24), 12 + s*(24), 0.5*dt*qbym[s]*(0.3162277660168379*rho[s][17]+0.3535533905932737*rho[s][6])); 
      gkyl_mat_set(&lhs, 21 + num_species*(24), 20 + s*(24), 0.5*dt*qbym[s]*(0.3162277660168379*rho[s][17]+0.3535533905932737*rho[s][6])); 
    } 
    ...
    gkyl_mat_set(&lhs, 5 + s*(24), 5 + num_species*(24), E_field_fac*(1.0)); 
    gkyl_mat_set(&lhs, 13 + s*(24), 13 + num_species*(24), E_field_fac*(1.0)); 
    gkyl_mat_set(&lhs, 21 + s*(24), 21 + num_species*(24), E_field_fac*(1.0)); 
    ...
    if (!pkpm_field_static) { 
      gkyl_mat_set(&lhs, 5 + num_species*(24), 5 + s*(24), 0.5*dt*qbym[s]*(0.2828427124746191*rho[s][21]+0.3162277660168379*rho[s][9]+0.3162277660168379*rho[s][7]+0.3535533905932737*rho[s][0])); 
      gkyl_mat_set(&lhs, 13 + num_species*(24), 13 + s*(24), 0.5*dt*qbym[s]*(0.2828427124746191*rho[s][21]+0.3162277660168379*rho[s][9]+0.3162277660168379*rho[s][7]+0.3535533905932737*rho[s][0])); 
      gkyl_mat_set(&lhs, 21 + num_species*(24), 21 + s*(24), 0.5*dt*qbym[s]*(0.2828427124746191*rho[s][21]+0.3162277660168379*rho[s][9]+0.3162277660168379*rho[s][7]+0.3535533905932737*rho[s][0])); 
    } 
    ...
    gkyl_mat_set(&lhs, 5 + s*(24), 6 + num_species*(24), E_field_fac*(0.0)); 
    gkyl_mat_set(&lhs, 13 + s*(24), 14 + num_species*(24), E_field_fac*(0.0)); 
    gkyl_mat_set(&lhs, 21 + s*(24), 22 + num_species*(24), E_field_fac*(0.0)); 
    ...
    if (!pkpm_field_static) { 
      gkyl_mat_set(&lhs, 5 + num_species*(24), 6 + s*(24), 0.5*dt*qbym[s]*(0.3162277660168379*rho[s][19]+0.3535533905932737*rho[s][4])); 
      gkyl_mat_set(&lhs, 13 + num_species*(24), 14 + s*(24), 0.5*dt*qbym[s]*(0.3162277660168379*rho[s][19]+0.3535533905932737*rho[s][4])); 
      gkyl_mat_set(&lhs, 21 + num_species*(24), 22 + s*(24), 0.5*dt*qbym[s]*(0.3162277660168379*rho[s][19]+0.3535533905932737*rho[s][4])); 
    } 
    ...
    gkyl_mat_set(&lhs, 5 + s*(24), 7 + num_species*(24), E_field_fac*(0.0)); 
    gkyl_mat_set(&lhs, 13 + s*(24), 15 + num_species*(24), E_field_fac*(0.0)); 
    gkyl_mat_set(&lhs, 21 + s*(24), 23 + num_species*(24), E_field_fac*(0.0)); 
    ...
    if (!pkpm_field_static) { 
      gkyl_mat_set(&lhs, 5 + num_species*(24), 7 + s*(24), 0.5*dt*qbym[s]*(0.2828427124746191*rho[s][24]+0.3162277660168379*rho[s][16]+0.3162277660168379*rho[s][11]+0.3535533905932737*rho[s][2])); 
      gkyl_mat_set(&lhs, 13 + num_species*(24), 15 + s*(24), 0.5*dt*qbym[s]*(0.2828427124746191*rho[s][24]+0.3162277660168379*rho[s][16]+0.3162277660168379*rho[s][11]+0.3535533905932737*rho[s][2])); 
      gkyl_mat_set(&lhs, 21 + num_species*(24), 23 + s*(24), 0.5*dt*qbym[s]*(0.2828427124746191*rho[s][24]+0.3162277660168379*rho[s][16]+0.3162277660168379*rho[s][11]+0.3535533905932737*rho[s][2])); 
    } 
    ...
    gkyl_mat_set(&lhs, 6 + s*(24), 0 + num_species*(24), E_field_fac*(0.0)); 
    gkyl_mat_set(&lhs, 14 + s*(24), 8 + num_species*(24), E_field_fac*(0.0)); 
    gkyl_mat_set(&lhs, 22 + s*(24), 16 + num_species*(24), E_field_fac*(0.0)); 
    ...
    if (!pkpm_field_static) { 
      gkyl_mat_set(&lhs, 6 + num_species*(24), 0 + s*(24), 0.5*dt*qbym[s]*(0.3535533905932737*rho[s][6])); 
      gkyl_mat_set(&lhs, 14 + num_species*(24), 8 + s*(24), 0.5*dt*qbym[s]*(0.3535533905932737*rho[s][6])); 
      gkyl_mat_set(&lhs, 22 + num_species*(24), 16 + s*(24), 0.5*dt*qbym[s]*(0.3535533905932737*rho[s][6])); 
    } 
    ...
    gkyl_mat_set(&lhs, 6 + s*(24), 1 + num_species*(24), E_field_fac*(0.0)); 
    gkyl_mat_set(&lhs, 14 + s*(24), 9 + num_species*(24), E_field_fac*(0.0)); 
    gkyl_mat_set(&lhs, 22 + s*(24), 17 + num_species*(24), E_field_fac*(0.0)); 
    ...
    if (!pkpm_field_static) { 
      gkyl_mat_set(&lhs, 6 + num_species*(24), 1 + s*(24), 0.5*dt*qbym[s]*(0.3535533905932737*rho[s][10])); 
      gkyl_mat_set(&lhs, 14 + num_species*(24), 9 + s*(24), 0.5*dt*qbym[s]*(0.3535533905932737*rho[s][10])); 
      gkyl_mat_set(&lhs, 22 + num_species*(24), 17 + s*(24), 0.5*dt*qbym[s]*(0.3535533905932737*rho[s][10])); 
    } 
    ...
    gkyl_mat_set(&lhs, 6 + s*(24), 2 + num_species*(24), E_field_fac*(0.0)); 
    gkyl_mat_set(&lhs, 14 + s*(24), 10 + num_species*(24), E_field_fac*(0.0)); 
    gkyl_mat_set(&lhs, 22 + s*(24), 18 + num_species*(24), E_field_fac*(0.0)); 
    ...
    if (!pkpm_field_static) { 
      gkyl_mat_set(&lhs, 6 + num_species*(24), 2 + s*(24), 0.5*dt*qbym[s]*(0.3162277660168379*rho[s][14]+0.3535533905932737*rho[s][3])); 
      gkyl_mat_set(&lhs, 14 + num_species*(24), 10 + s*(24), 0.5*dt*qbym[s]*(0.3162277660168379*rho[s][14]+0.3535533905932737*rho[s][3])); 
      gkyl_mat_set(&lhs, 22 + num_species*(24), 18 + s*(24), 0.5*dt*qbym[s]*(0.3162277660168379*rho[s][14]+0.3535533905932737*rho[s][3])); 
    } 
    ...
    gkyl_mat_set(&lhs, 6 + s*(24), 3 + num_species*(24), E_field_fac*(0.0)); 
    gkyl_mat_set(&lhs, 14 + s*(24), 11 + num_species*(24), E_field_fac*(0.0)); 
    gkyl_mat_set(&lhs, 22 + s*(24), 19 + num_species*(24), E_field_fac*(0.0)); 
    ...
    if (!pkpm_field_static) { 
      gkyl_mat_set(&lhs, 6 + num_species*(24), 3 + s*(24), 0.5*dt*qbym[s]*(0.3162277660168379*rho[s][16]+0.3535533905932737*rho[s][2])); 
      gkyl_mat_set(&lhs, 14 + num_species*(24), 11 + s*(24), 0.5*dt*qbym[s]*(0.3162277660168379*rho[s][16]+0.3535533905932737*rho[s][2])); 
      gkyl_mat_set(&lhs, 22 + num_species*(24), 19 + s*(24), 0.5*dt*qbym[s]*(0.3162277660168379*rho[s][16]+0.3535533905932737*rho[s][2])); 
    } 
    ...
    gkyl_mat_set(&lhs, 6 + s*(24), 4 + num_species*(24), E_field_fac*(0.0)); 
    gkyl_mat_set(&lhs, 14 + s*(24), 12 + num_species*(24), E_field_fac*(0.0)); 
    gkyl_mat_set(&lhs, 22 + s*(24), 20 + num_species*(24), E_field_fac*(0.0)); 
    ...
    if (!pkpm_field_static) { 
      gkyl_mat_set(&lhs, 6 + num_species*(24), 4 + s*(24), 0.5*dt*qbym[s]*(0.3162277660168379*rho[s][18]+0.3535533905932737*rho[s][5])); 
      gkyl_mat_set(&lhs, 14 + num_species*(24), 12 + s*(24), 0.5*dt*qbym[s]*(0.3162277660168379*rho[s][18]+0.3535533905932737*rho[s][5])); 
      gkyl_mat_set(&lhs, 22 + num_species*(24), 20 + s*(24), 0.5*dt*qbym[s]*(0.3162277660168379*rho[s][18]+0.3535533905932737*rho[s][5])); 
    } 
    ...
    gkyl_mat_set(&lhs, 6 + s*(24), 5 + num_species*(24), E_field_fac*(0.0)); 
    gkyl_mat_set(&lhs, 14 + s*(24), 13 + num_species*(24), E_field_fac*(0.0)); 
    gkyl_mat_set(&lhs, 22 + s*(24), 21 + num_species*(24), E_field_fac*(0.0)); 
    ...
    if (!pkpm_field_static) { 
      gkyl_mat_set(&lhs, 6 + num_species*(24), 5 + s*(24), 0.5*dt*qbym[s]*(0.3162277660168379*rho[s][19]+0.3535533905932737*rho[s][4])); 
      gkyl_mat_set(&lhs, 14 + num_species*(24), 13 + s*(24), 0.5*dt*qbym[s]*(0.3162277660168379*rho[s][19]+0.3535533905932737*rho[s][4])); 
      gkyl_mat_set(&lhs, 22 + num_species*(24), 21 + s*(24), 0.5*dt*qbym[s]*(0.3162277660168379*rho[s][19]+0.3535533905932737*rho[s][4])); 
    } 
    ...
    gkyl_mat_set(&lhs, 6 + s*(24), 6 + num_species*(24), E_field_fac*(1.0)); 
    gkyl_mat_set(&lhs, 14 + s*(24), 14 + num_species*(24), E_field_fac*(1.0)); 
    gkyl_mat_set(&lhs, 22 + s*(24), 22 + num_species*(24), E_field_fac*(1.0)); 
    ...
    if (!pkpm_field_static) { 
      gkyl_mat_set(&lhs, 6 + num_species*(24), 6 + s*(24), 0.5*dt*qbym[s]*(0.2828427124746191*rho[s][22]+0.3162277660168379*rho[s][9]+0.3162277660168379*rho[s][8]+0.3535533905932737*rho[s][0])); 
      gkyl_mat_set(&lhs, 14 + num_species*(24), 14 + s*(24), 0.5*dt*qbym[s]*(0.2828427124746191*rho[s][22]+0.3162277660168379*rho[s][9]+0.3162277660168379*rho[s][8]+0.3535533905932737*rho[s][0])); 
      gkyl_mat_set(&lhs, 22 + num_species*(24), 22 + s*(24), 0.5*dt*qbym[s]*(0.2828427124746191*rho[s][22]+0.3162277660168379*rho[s][9]+0.3162277660168379*rho[s][8]+0.3535533905932737*rho[s][0])); 
    } 
    ...
    gkyl_mat_set(&lhs, 6 + s*(24), 7 + num_species*(24), E_field_fac*(0.0)); 
    gkyl_mat_set(&lhs, 14 + s*(24), 15 + num_species*(24), E_field_fac*(0.0)); 
    gkyl_mat_set(&lhs, 22 + s*(24), 23 + num_species*(24), E_field_fac*(0.0)); 
    ...
    if (!pkpm_field_static) { 
      gkyl_mat_set(&lhs, 6 + num_species*(24), 7 + s*(24), 0.5*dt*qbym[s]*(0.2828427124746191*rho[s][25]+0.3162277660168379*rho[s][15]+0.3162277660168379*rho[s][12]+0.3535533905932737*rho[s][1])); 
      gkyl_mat_set(&lhs, 14 + num_species*(24), 15 + s*(24), 0.5*dt*qbym[s]*(0.2828427124746191*rho[s][25]+0.3162277660168379*rho[s][15]+0.3162277660168379*rho[s][12]+0.3535533905932737*rho[s][1])); 
      gkyl_mat_set(&lhs, 22 + num_species*(24), 23 + s*(24), 0.5*dt*qbym[s]*(0.2828427124746191*rho[s][25]+0.3162277660168379*rho[s][15]+0.3162277660168379*rho[s][12]+0.3535533905932737*rho[s][1])); 
    } 
    ...
    gkyl_mat_set(&lhs, 7 + s*(24), 0 + num_species*(24), E_field_fac*(0.0)); 
    gkyl_mat_set(&lhs, 15 + s*(24), 8 + num_species*(24), E_field_fac*(0.0)); 
    gkyl_mat_set(&lhs, 23 + s*(24), 16 + num_species*(24), E_field_fac*(0.0)); 
    ...
    if (!pkpm_field_static) { 
      gkyl_mat_set(&lhs, 7 + num_species*(24), 0 + s*(24), 0.5*dt*qbym[s]*(0.3535533905932737*rho[s][10])); 
      gkyl_mat_set(&lhs, 15 + num_species*(24), 8 + s*(24), 0.5*dt*qbym[s]*(0.3535533905932737*rho[s][10])); 
      gkyl_mat_set(&lhs, 23 + num_species*(24), 16 + s*(24), 0.5*dt*qbym[s]*(0.3535533905932737*rho[s][10])); 
    } 
    ...
    gkyl_mat_set(&lhs, 7 + s*(24), 1 + num_species*(24), E_field_fac*(0.0)); 
    gkyl_mat_set(&lhs, 15 + s*(24), 9 + num_species*(24), E_field_fac*(0.0)); 
    gkyl_mat_set(&lhs, 23 + s*(24), 17 + num_species*(24), E_field_fac*(0.0)); 
    ...
    if (!pkpm_field_static) { 
      gkyl_mat_set(&lhs, 7 + num_species*(24), 1 + s*(24), 0.5*dt*qbym[s]*(0.3162277660168379*rho[s][17]+0.3535533905932737*rho[s][6])); 
      gkyl_mat_set(&lhs, 15 + num_species*(24), 9 + s*(24), 0.5*dt*qbym[s]*(0.3162277660168379*rho[s][17]+0.3535533905932737*rho[s][6])); 
      gkyl_mat_set(&lhs, 23 + num_species*(24), 17 + s*(24), 0.5*dt*qbym[s]*(0.3162277660168379*rho[s][17]+0.3535533905932737*rho[s][6])); 
    } 
    ...
    gkyl_mat_set(&lhs, 7 + s*(24), 2 + num_species*(24), E_field_fac*(0.0)); 
    gkyl_mat_set(&lhs, 15 + s*(24), 10 + num_species*(24), E_field_fac*(0.0)); 
    gkyl_mat_set(&lhs, 23 + s*(24), 18 + num_species*(24), E_field_fac*(0.0)); 
    ...
    if (!pkpm_field_static) { 
      gkyl_mat_set(&lhs, 7 + num_species*(24), 2 + s*(24), 0.5*dt*qbym[s]*(0.3162277660168379*rho[s][18]+0.3535533905932737*rho[s][5])); 
      gkyl_mat_set(&lhs, 15 + num_species*(24), 10 + s*(24), 0.5*dt*qbym[s]*(0.3162277660168379*rho[s][18]+0.3535533905932737*rho[s][5])); 
      gkyl_mat_set(&lhs, 23 + num_species*(24), 18 + s*(24), 0.5*dt*qbym[s]*(0.3162277660168379*rho[s][18]+0.3535533905932737*rho[s][5])); 
    } 
    ...
    gkyl_mat_set(&lhs, 7 + s*(24), 3 + num_species*(24), E_field_fac*(0.0)); 
    gkyl_mat_set(&lhs, 15 + s*(24), 11 + num_species*(24), E_field_fac*(0.0)); 
    gkyl_mat_set(&lhs, 23 + s*(24), 19 + num_species*(24), E_field_fac*(0.0)); 
    ...
    if (!pkpm_field_static) { 
      gkyl_mat_set(&lhs, 7 + num_species*(24), 3 + s*(24), 0.5*dt*qbym[s]*(0.3162277660168379*rho[s][19]+0.3535533905932737*rho[s][4])); 
      gkyl_mat_set(&lhs, 15 + num_species*(24), 11 + s*(24), 0.5*dt*qbym[s]*(0.3162277660168379*rho[s][19]+0.3535533905932737*rho[s][4])); 
      gkyl_mat_set(&lhs, 23 + num_species*(24), 19 + s*(24), 0.5*dt*qbym[s]*(0.3162277660168379*rho[s][19]+0.3535533905932737*rho[s][4])); 
    } 
    ...
    gkyl_mat_set(&lhs, 7 + s*(24), 4 + num_species*(24), E_field_fac*(0.0)); 
    gkyl_mat_set(&lhs, 15 + s*(24), 12 + num_species*(24), E_field_fac*(0.0)); 
    gkyl_mat_set(&lhs, 23 + s*(24), 20 + num_species*(24), E_field_fac*(0.0)); 
    ...
    if (!pkpm_field_static) { 
      gkyl_mat_set(&lhs, 7 + num_species*(24), 4 + s*(24), 0.5*dt*qbym[s]*(0.2828427124746191*rho[s][23]+0.3162277660168379*rho[s][14]+0.3162277660168379*rho[s][13]+0.3535533905932737*rho[s][3])); 
      gkyl_mat_set(&lhs, 15 + num_species*(24), 12 + s*(24), 0.5*dt*qbym[s]*(0.2828427124746191*rho[s][23]+0.3162277660168379*rho[s][14]+0.3162277660168379*rho[s][13]+0.3535533905932737*rho[s][3])); 
      gkyl_mat_set(&lhs, 23 + num_species*(24), 20 + s*(24), 0.5*dt*qbym[s]*(0.2828427124746191*rho[s][23]+0.3162277660168379*rho[s][14]+0.3162277660168379*rho[s][13]+0.3535533905932737*rho[s][3])); 
    } 
    ...
    gkyl_mat_set(&lhs, 7 + s*(24), 5 + num_species*(24), E_field_fac*(0.0)); 
    gkyl_mat_set(&lhs, 15 + s*(24), 13 + num_species*(24), E_field_fac*(0.0)); 
    gkyl_mat_set(&lhs, 23 + s*(24), 21 + num_species*(24), E_field_fac*(0.0)); 
    ...
    if (!pkpm_field_static) { 
      gkyl_mat_set(&lhs, 7 + num_species*(24), 5 + s*(24), 0.5*dt*qbym[s]*(0.2828427124746191*rho[s][24]+0.3162277660168379*rho[s][16]+0.3162277660168379*rho[s][11]+0.3535533905932737*rho[s][2])); 
      gkyl_mat_set(&lhs, 15 + num_species*(24), 13 + s*(24), 0.5*dt*qbym[s]*(0.2828427124746191*rho[s][24]+0.3162277660168379*rho[s][16]+0.3162277660168379*rho[s][11]+0.3535533905932737*rho[s][2])); 
      gkyl_mat_set(&lhs, 23 + num_species*(24), 21 + s*(24), 0.5*dt*qbym[s]*(0.2828427124746191*rho[s][24]+0.3162277660168379*rho[s][16]+0.3162277660168379*rho[s][11]+0.3535533905932737*rho[s][2])); 
    } 
    ...
    gkyl_mat_set(&lhs, 7 + s*(24), 6 + num_species*(24), E_field_fac*(0.0)); 
    gkyl_mat_set(&lhs, 15 + s*(24), 14 + num_species*(24), E_field_fac*(0.0)); 
    gkyl_mat_set(&lhs, 23 + s*(24), 22 + num_species*(24), E_field_fac*(0.0)); 
    ...
    if (!pkpm_field_static) { 
      gkyl_mat_set(&lhs, 7 + num_species*(24), 6 + s*(24), 0.5*dt*qbym[s]*(0.2828427124746191*rho[s][25]+0.3162277660168379*rho[s][15]+0.3162277660168379*rho[s][12]+0.3535533905932737*rho[s][1])); 
      gkyl_mat_set(&lhs, 15 + num_species*(24), 14 + s*(24), 0.5*dt*qbym[s]*(0.2828427124746191*rho[s][25]+0.3162277660168379*rho[s][15]+0.3162277660168379*rho[s][12]+0.3535533905932737*rho[s][1])); 
      gkyl_mat_set(&lhs, 23 + num_species*(24), 22 + s*(24), 0.5*dt*qbym[s]*(0.2828427124746191*rho[s][25]+0.3162277660168379*rho[s][15]+0.3162277660168379*rho[s][12]+0.3535533905932737*rho[s][1])); 
    } 
    ...
    gkyl_mat_set(&lhs, 7 + s*(24), 7 + num_species*(24), E_field_fac*(1.0)); 
    gkyl_mat_set(&lhs, 15 + s*(24), 15 + num_species*(24), E_field_fac*(1.0)); 
    gkyl_mat_set(&lhs, 23 + s*(24), 23 + num_species*(24), E_field_fac*(1.0)); 
    ...
    if (!pkpm_field_static) { 
      gkyl_mat_set(&lhs, 7 + num_species*(24), 7 + s*(24), 0.5*dt*qbym[s]*(0.2529822128134704*rho[s][26]+0.2828427124746191*rho[s][22]+0.2828427124746191*rho[s][21]+0.2828427124746191*rho[s][20]+0.3162277660168379*rho[s][9]+0.3162277660168379*rho[s][8]+0.3162277660168379*rho[s][7]+0.3535533905932737*rho[s][0])); 
      gkyl_mat_set(&lhs, 15 + num_species*(24), 15 + s*(24), 0.5*dt*qbym[s]*(0.2529822128134704*rho[s][26]+0.2828427124746191*rho[s][22]+0.2828427124746191*rho[s][21]+0.2828427124746191*rho[s][20]+0.3162277660168379*rho[s][9]+0.3162277660168379*rho[s][8]+0.3162277660168379*rho[s][7]+0.3535533905932737*rho[s][0])); 
      gkyl_mat_set(&lhs, 23 + num_species*(24), 23 + s*(24), 0.5*dt*qbym[s]*(0.2529822128134704*rho[s][26]+0.2828427124746191*rho[s][22]+0.2828427124746191*rho[s][21]+0.2828427124746191*rho[s][20]+0.3162277660168379*rho[s][9]+0.3162277660168379*rho[s][8]+0.3162277660168379*rho[s][7]+0.3535533905932737*rho[s][0])); 
    } 
