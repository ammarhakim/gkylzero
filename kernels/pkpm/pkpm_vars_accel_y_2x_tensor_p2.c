...
{ 
  ...
  const double *Tii_surf_lr = &prim_surf_l[45]; 
  const double *Tii_surf_cl = &prim_surf_c[42]; 
  ...
  ul_r = 0.6324555320336759*uy_surf_lr[2]-0.9486832980505137*uy_surf_lr[1]+0.7071067811865475*uy_surf_lr[0]; 
  uc_l = 0.6324555320336759*uy_surf_cl[2]-0.9486832980505137*uy_surf_cl[1]+0.7071067811865475*uy_surf_cl[0]; 
  uc_r = 0.6324555320336759*uy_surf_cr[2]-0.9486832980505137*uy_surf_cr[1]+0.7071067811865475*uy_surf_cr[0]; 
  ur_l = 0.6324555320336759*uy_surf_rl[2]-0.9486832980505137*uy_surf_rl[1]+0.7071067811865475*uy_surf_rl[0]; 
  ...
  ul_r = 0.7071067811865475*uy_surf_lr[0]-0.7905694150420947*uy_surf_lr[2]; 
  uc_l = 0.7071067811865475*uy_surf_cl[0]-0.7905694150420947*uy_surf_cl[2]; 
  uc_r = 0.7071067811865475*uy_surf_cr[0]-0.7905694150420947*uy_surf_cr[2]; 
  ur_l = 0.7071067811865475*uy_surf_rl[0]-0.7905694150420947*uy_surf_rl[2]; 
  uQuad_l = fmax(fabs(ul_r), fabs(uc_l)); 
  uQuad_r = fmax(fabs(uc_r), fabs(ur_l)); 
