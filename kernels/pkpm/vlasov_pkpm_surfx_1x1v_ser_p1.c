...
{ 
  ...
  out_F_0[4] += (0.7071067811865475*Ghat_F_0_u_l[2]-0.7071067811865475*Ghat_F_0_u_r[2])*dx1; 
  ...
  out_G_1[4] += (0.7071067811865475*Ghat_G_1_u_l[2]-0.7071067811865475*Ghat_G_1_u_r[2])*dx1; 
