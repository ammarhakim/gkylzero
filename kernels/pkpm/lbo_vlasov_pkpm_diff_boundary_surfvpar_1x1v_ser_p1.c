...
GKYL_CU_DH double lbo_vlasov_pkpm_diff_boundary_surfvpar_1x1v_ser_p1(const double *w, const double *dxv, const double *nuVtSq, const int edge, const double *fSkin, const double *fEdge, double* GKYL_RESTRICT out) 
{ 
  ...
  vol_incr_F_0[4] = 4.743416490252569*F_0Skin[1]*nuVtSq[1]*rdvSq4+4.743416490252569*F_0Skin[0]*nuVtSq[0]*rdvSq4; 
  vol_incr_F_0[5] = 4.743416490252569*F_0Skin[0]*nuVtSq[1]*rdvSq4+4.743416490252569*nuVtSq[0]*F_0Skin[1]*rdvSq4; 
  vol_incr_G_1[4] = 4.743416490252569*G_1Skin[1]*nuVtSq[1]*rdvSq4+4.743416490252569*G_1Skin[0]*nuVtSq[0]*rdvSq4; 
  vol_incr_G_1[5] = 4.743416490252569*G_1Skin[0]*nuVtSq[1]*rdvSq4+4.743416490252569*nuVtSq[0]*G_1Skin[1]*rdvSq4; 
  ...
  diff_F_0_incr[0] = 0.7071067811865475*nuVtSq[1]*temp_F_0_diff[1]+0.7071067811865475*nuVtSq[0]*temp_F_0_diff[0]; 
  diff_F_0_incr[1] = 0.7071067811865475*nuVtSq[0]*temp_F_0_diff[1]+0.7071067811865475*temp_F_0_diff[0]*nuVtSq[1]; 
  diff_F_0_incr[2] = 0.7071067811865475*nuVtSq[1]*temp_F_0_diff[3]+0.7071067811865475*nuVtSq[0]*temp_F_0_diff[2]; 
  diff_F_0_incr[3] = 0.7071067811865475*nuVtSq[0]*temp_F_0_diff[3]+0.7071067811865475*nuVtSq[1]*temp_F_0_diff[2]; 
  diff_F_0_incr[4] = 0.7071067811865475*nuVtSq[1]*temp_F_0_diff[5]+0.7071067811865475*nuVtSq[0]*temp_F_0_diff[4]; 
  diff_F_0_incr[5] = 0.7071067811865475*nuVtSq[0]*temp_F_0_diff[5]+0.7071067811865475*nuVtSq[1]*temp_F_0_diff[4]; 
  diff_G_1_incr[0] = 0.7071067811865475*nuVtSq[1]*temp_G_1_diff[1]+0.7071067811865475*nuVtSq[0]*temp_G_1_diff[0]; 
  diff_G_1_incr[1] = 0.7071067811865475*nuVtSq[0]*temp_G_1_diff[1]+0.7071067811865475*temp_G_1_diff[0]*nuVtSq[1]; 
  diff_G_1_incr[2] = 0.7071067811865475*nuVtSq[1]*temp_G_1_diff[3]+0.7071067811865475*nuVtSq[0]*temp_G_1_diff[2]; 
  diff_G_1_incr[3] = 0.7071067811865475*nuVtSq[0]*temp_G_1_diff[3]+0.7071067811865475*nuVtSq[1]*temp_G_1_diff[2]; 
  diff_G_1_incr[4] = 0.7071067811865475*nuVtSq[1]*temp_G_1_diff[5]+0.7071067811865475*nuVtSq[0]*temp_G_1_diff[4]; 
  diff_G_1_incr[5] = 0.7071067811865475*nuVtSq[0]*temp_G_1_diff[5]+0.7071067811865475*nuVtSq[1]*temp_G_1_diff[4]; 

  edge_F_0_incr[0] = 0.7071067811865475*nuVtSq[1]*temp_F_0_edge[1]+0.7071067811865475*nuVtSq[0]*temp_F_0_edge[0]; 
  edge_F_0_incr[1] = 0.7071067811865475*nuVtSq[0]*temp_F_0_edge[1]+0.7071067811865475*temp_F_0_edge[0]*nuVtSq[1]; 
  edge_F_0_incr[2] = 0.7071067811865475*nuVtSq[1]*temp_F_0_edge[3]+0.7071067811865475*nuVtSq[0]*temp_F_0_edge[2]; 
  edge_F_0_incr[3] = 0.7071067811865475*nuVtSq[0]*temp_F_0_edge[3]+0.7071067811865475*nuVtSq[1]*temp_F_0_edge[2]; 
  edge_F_0_incr[4] = 0.7071067811865475*nuVtSq[1]*temp_F_0_edge[5]+0.7071067811865475*nuVtSq[0]*temp_F_0_edge[4]; 
  edge_F_0_incr[5] = 0.7071067811865475*nuVtSq[0]*temp_F_0_edge[5]+0.7071067811865475*nuVtSq[1]*temp_F_0_edge[4]; 
  edge_G_1_incr[0] = 0.7071067811865475*nuVtSq[1]*temp_G_1_edge[1]+0.7071067811865475*nuVtSq[0]*temp_G_1_edge[0]; 
  edge_G_1_incr[1] = 0.7071067811865475*nuVtSq[0]*temp_G_1_edge[1]+0.7071067811865475*temp_G_1_edge[0]*nuVtSq[1]; 
  edge_G_1_incr[2] = 0.7071067811865475*nuVtSq[1]*temp_G_1_edge[3]+0.7071067811865475*nuVtSq[0]*temp_G_1_edge[2]; 
  edge_G_1_incr[3] = 0.7071067811865475*nuVtSq[0]*temp_G_1_edge[3]+0.7071067811865475*nuVtSq[1]*temp_G_1_edge[2]; 
  edge_G_1_incr[4] = 0.7071067811865475*nuVtSq[1]*temp_G_1_edge[5]+0.7071067811865475*nuVtSq[0]*temp_G_1_edge[4]; 
  edge_G_1_incr[5] = 0.7071067811865475*nuVtSq[0]*temp_G_1_edge[5]+0.7071067811865475*nuVtSq[1]*temp_G_1_edge[4]; 
