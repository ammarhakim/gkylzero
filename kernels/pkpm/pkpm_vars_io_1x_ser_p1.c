...
{ 
  ...
  const double *p_perp_div_b = &pkpm_accel[8]; 
  ...
  double *pkpm_vars_io_div_b = &pkpm_vars_io[10]; 
  double *pkpm_vars_io_pkpm_div_ppar = &pkpm_vars_io[12]; 
  double *pkpm_vars_io_p_perp_div_b = &pkpm_vars_io[14]; 
  double *pkpm_vars_io_bb_grad_u = &pkpm_vars_io[16]; 
  double *pkpm_vars_io_p_perp_source = &pkpm_vars_io[18]; 
