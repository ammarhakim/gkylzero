...
{ 
  ...
  alpha_l_r = tensor_2x_p2_surfx1_eval_quad_node_0_r(alpha_u_l); 
  alpha_c_l = tensor_2x_p2_surfx1_eval_quad_node_0_l(alpha_u_c); 
  alpha_c_r = tensor_2x_p2_surfx1_eval_quad_node_0_r(alpha_u_c); 
  alpha_r_l = tensor_2x_p2_surfx1_eval_quad_node_0_l(alpha_u_r); 
  alphaQuad_l = fmax(fabs(alpha_l_r), fabs(alpha_c_l)); 
  alphaQuad_r = fmax(fabs(alpha_c_r), fabs(alpha_r_l)); 
  vth_sq_l_r = tensor_2x_p2_surfx1_eval_quad_node_0_r(vth_sq_l); 
  vth_sq_c_l = tensor_2x_p2_surfx1_eval_quad_node_0_l(vth_sq_c); 
  vth_sq_c_r = tensor_2x_p2_surfx1_eval_quad_node_0_r(vth_sq_c); 
  vth_sq_r_l = tensor_2x_p2_surfx1_eval_quad_node_0_l(vth_sq_r); 
  ...
  F_0_l_r = tensor_2x_p2_surfx1_eval_quad_node_0_r(F_0l); 
  F_0_c_l = tensor_2x_p2_surfx1_eval_quad_node_0_l(F_0c); 
  F_0_c_r = tensor_2x_p2_surfx1_eval_quad_node_0_r(F_0c); 
  F_0_r_l = tensor_2x_p2_surfx1_eval_quad_node_0_l(F_0r); 
  lax_F_0_quad_l[0] = - 0.5*max_speed_l*(F_0_c_l - F_0_l_r); 
  lax_F_0_quad_r[0] = - 0.5*max_speed_r*(F_0_r_l - F_0_c_r); 
  G_1_l_r = tensor_2x_p2_surfx1_eval_quad_node_0_r(G_1l); 
  G_1_c_l = tensor_2x_p2_surfx1_eval_quad_node_0_l(G_1c); 
  G_1_c_r = tensor_2x_p2_surfx1_eval_quad_node_0_r(G_1c); 
  G_1_r_l = tensor_2x_p2_surfx1_eval_quad_node_0_l(G_1r); 
  lax_G_1_quad_l[0] = - 0.5*max_speed_l*(G_1_c_l - G_1_l_r); 
  lax_G_1_quad_r[0] = - 0.5*max_speed_r*(G_1_r_l - G_1_c_r); 

  alpha_l_r = tensor_2x_p2_surfx1_eval_quad_node_1_r(alpha_u_l); 
  alpha_c_l = tensor_2x_p2_surfx1_eval_quad_node_1_l(alpha_u_c); 
  alpha_c_r = tensor_2x_p2_surfx1_eval_quad_node_1_r(alpha_u_c); 
  alpha_r_l = tensor_2x_p2_surfx1_eval_quad_node_1_l(alpha_u_r); 
  alphaQuad_l = fmax(fabs(alpha_l_r), fabs(alpha_c_l)); 
  alphaQuad_r = fmax(fabs(alpha_c_r), fabs(alpha_r_l)); 
  vth_sq_l_r = tensor_2x_p2_surfx1_eval_quad_node_1_r(vth_sq_l); 
  vth_sq_c_l = tensor_2x_p2_surfx1_eval_quad_node_1_l(vth_sq_c); 
  vth_sq_c_r = tensor_2x_p2_surfx1_eval_quad_node_1_r(vth_sq_c); 
  vth_sq_r_l = tensor_2x_p2_surfx1_eval_quad_node_1_l(vth_sq_r); 
  vthQuad_l = fmax(sqrt(fabs(vth_sq_l_r)), sqrt(fabs(vth_sq_c_l))); 
  vthQuad_r = fmax(sqrt(fabs(vth_sq_c_r)), sqrt(fabs(vth_sq_r_l))); 
  max_speed_l = alphaQuad_l + vthQuad_l; 
  max_speed_r = alphaQuad_r + vthQuad_r; 
  F_0_l_r = tensor_2x_p2_surfx1_eval_quad_node_1_r(F_0l); 
  F_0_c_l = tensor_2x_p2_surfx1_eval_quad_node_1_l(F_0c); 
  F_0_c_r = tensor_2x_p2_surfx1_eval_quad_node_1_r(F_0c); 
  F_0_r_l = tensor_2x_p2_surfx1_eval_quad_node_1_l(F_0r); 
  lax_F_0_quad_l[1] = - 0.5*max_speed_l*(F_0_c_l - F_0_l_r); 
  lax_F_0_quad_r[1] = - 0.5*max_speed_r*(F_0_r_l - F_0_c_r); 
  G_1_l_r = tensor_2x_p2_surfx1_eval_quad_node_1_r(G_1l); 
  G_1_c_l = tensor_2x_p2_surfx1_eval_quad_node_1_l(G_1c); 
  G_1_c_r = tensor_2x_p2_surfx1_eval_quad_node_1_r(G_1c); 
  G_1_r_l = tensor_2x_p2_surfx1_eval_quad_node_1_l(G_1r); 
  lax_G_1_quad_l[1] = - 0.5*max_speed_l*(G_1_c_l - G_1_l_r); 
  lax_G_1_quad_r[1] = - 0.5*max_speed_r*(G_1_r_l - G_1_c_r); 

  alpha_l_r = tensor_2x_p2_surfx1_eval_quad_node_2_r(alpha_u_l); 
  alpha_c_l = tensor_2x_p2_surfx1_eval_quad_node_2_l(alpha_u_c); 
  alpha_c_r = tensor_2x_p2_surfx1_eval_quad_node_2_r(alpha_u_c); 
  alpha_r_l = tensor_2x_p2_surfx1_eval_quad_node_2_l(alpha_u_r); 
  alphaQuad_l = fmax(fabs(alpha_l_r), fabs(alpha_c_l)); 
  alphaQuad_r = fmax(fabs(alpha_c_r), fabs(alpha_r_l)); 
  vth_sq_l_r = tensor_2x_p2_surfx1_eval_quad_node_2_r(vth_sq_l); 
  vth_sq_c_l = tensor_2x_p2_surfx1_eval_quad_node_2_l(vth_sq_c); 
  vth_sq_c_r = tensor_2x_p2_surfx1_eval_quad_node_2_r(vth_sq_c); 
  vth_sq_r_l = tensor_2x_p2_surfx1_eval_quad_node_2_l(vth_sq_r); 
  vthQuad_l = fmax(sqrt(fabs(vth_sq_l_r)), sqrt(fabs(vth_sq_c_l))); 
  vthQuad_r = fmax(sqrt(fabs(vth_sq_c_r)), sqrt(fabs(vth_sq_r_l))); 
  max_speed_l = alphaQuad_l + vthQuad_l; 
  max_speed_r = alphaQuad_r + vthQuad_r; 
  F_0_l_r = tensor_2x_p2_surfx1_eval_quad_node_2_r(F_0l); 
  F_0_c_l = tensor_2x_p2_surfx1_eval_quad_node_2_l(F_0c); 
  F_0_c_r = tensor_2x_p2_surfx1_eval_quad_node_2_r(F_0c); 
  F_0_r_l = tensor_2x_p2_surfx1_eval_quad_node_2_l(F_0r); 
  lax_F_0_quad_l[2] = - 0.5*max_speed_l*(F_0_c_l - F_0_l_r); 
  lax_F_0_quad_r[2] = - 0.5*max_speed_r*(F_0_r_l - F_0_c_r); 
  G_1_l_r = tensor_2x_p2_surfx1_eval_quad_node_2_r(G_1l); 
  G_1_c_l = tensor_2x_p2_surfx1_eval_quad_node_2_l(G_1c); 
  G_1_c_r = tensor_2x_p2_surfx1_eval_quad_node_2_r(G_1c); 
  G_1_r_l = tensor_2x_p2_surfx1_eval_quad_node_2_l(G_1r); 
  lax_G_1_quad_l[2] = - 0.5*max_speed_l*(G_1_c_l - G_1_l_r); 
  lax_G_1_quad_r[2] = - 0.5*max_speed_r*(G_1_r_l - G_1_c_r); 

  // Project tensor nodal quadrature basis back onto modal basis. 
  tensor_2x_p2_upwind_quad_to_modal(lax_F_0_quad_l, lax_F_0_modal_l); 
  tensor_2x_p2_upwind_quad_to_modal(lax_F_0_quad_r, lax_F_0_modal_r); 
  tensor_2x_p2_upwind_quad_to_modal(lax_G_1_quad_l, lax_G_1_modal_l); 
  tensor_2x_p2_upwind_quad_to_modal(lax_G_1_quad_r, lax_G_1_modal_r); 
  ...
  out_F_0[4] += (1.58113883008419*lax_F_0_modal_l[0]-1.58113883008419*lax_F_0_modal_r[0])*dx1; 
  out_F_0[5] += (0.7071067811865475*lax_F_0_modal_l[2]-0.7071067811865475*lax_F_0_modal_r[2])*dx1; 
  out_F_0[6] += (1.58113883008419*lax_F_0_modal_l[1]-1.58113883008419*lax_F_0_modal_r[1])*dx1; 
  out_F_0[7] += -1.224744871391589*(lax_F_0_modal_r[2]+lax_F_0_modal_l[2])*dx1; 
  out_F_0[8] += (1.58113883008419*lax_F_0_modal_l[2]-1.58113883008419*lax_F_0_modal_r[2])*dx1; 
  ...
  out_G_1[4] += (1.58113883008419*lax_G_1_modal_l[0]-1.58113883008419*lax_G_1_modal_r[0])*dx1; 
  out_G_1[5] += (0.7071067811865475*lax_G_1_modal_l[2]-0.7071067811865475*lax_G_1_modal_r[2])*dx1; 
  out_G_1[6] += (1.58113883008419*lax_G_1_modal_l[1]-1.58113883008419*lax_G_1_modal_r[1])*dx1; 
  out_G_1[7] += -1.224744871391589*(lax_G_1_modal_r[2]+lax_G_1_modal_l[2])*dx1; 
  out_G_1[8] += (1.58113883008419*lax_G_1_modal_l[2]-1.58113883008419*lax_G_1_modal_r[2])*dx1; 
