...
{ 
  ...
  double ul_r = tensor_1x_p2_surfx1_eval_quad_node_0_r(ul); 
  double uc_l = tensor_1x_p2_surfx1_eval_quad_node_0_l(uc); 
  double uc_r = tensor_1x_p2_surfx1_eval_quad_node_0_r(uc); 
  double ur_l = tensor_1x_p2_surfx1_eval_quad_node_0_l(ur); 

  double vth_sql_r = tensor_1x_p2_surfx1_eval_quad_node_0_r(vth_sql); 
  double vth_sqc_l = tensor_1x_p2_surfx1_eval_quad_node_0_l(vth_sqc); 
  double vth_sqc_r = tensor_1x_p2_surfx1_eval_quad_node_0_r(vth_sqc); 
  double vth_sqr_l = tensor_1x_p2_surfx1_eval_quad_node_0_l(vth_sqr); 
