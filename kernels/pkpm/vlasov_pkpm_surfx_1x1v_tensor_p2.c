...
{ 
  ...
  out_F_0[8] += (1.58113883008419*Ghat_F_0_u_l[2]-1.58113883008419*Ghat_F_0_u_r[2])*dx1; 
  ...
  out_G_1[8] += (1.58113883008419*Ghat_G_1_u_l[2]-1.58113883008419*Ghat_G_1_u_r[2])*dx1; 
