...
GKYL_CU_DH void pkpm_vars_surf_set_1x_ser_p1(int count, struct gkyl_nmat *A, struct gkyl_nmat *rhs, 
  const double *vlasov_pkpm_moms, const double *euler_pkpm, const double *p_ij, const int *cell_avg_prim); 
...
GKYL_CU_DH void pkpm_vars_accel_x_1x_ser_p1(const double *dxv, 
      ...
      double* GKYL_RESTRICT pkpm_lax, double* GKYL_RESTRICT pkpm_accel_vars); 
