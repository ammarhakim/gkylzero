...
GKYL_CU_DH void pkpm_vars_p_force_1x_tensor_p2(const double *prim_c, const double *div_b, double* GKYL_RESTRICT pkpm_accel); 
...
GKYL_CU_DH void pkpm_vars_copy_1x_tensor_p2(int count, struct gkyl_nmat *x, double* GKYL_RESTRICT prim); 
...
GKYL_CU_DH void pkpm_vars_u_copy_1x_tensor_p1(int count, struct gkyl_nmat *x, double* GKYL_RESTRICT pkpm_u); 
GKYL_CU_DH void pkpm_vars_u_surf_1x_tensor_p1(const double* pkpm_u, double* GKYL_RESTRICT pkpm_u_surf); 
GKYL_CU_DH void euler_pkpm_em_coupling_set_1x_tensor_p1(int count, int num_species, double qbym[GKYL_MAX_SPECIES], double epsilon0, bool pkpm_field_static, double dt, 
...
GKYL_CU_DH void euler_pkpm_em_coupling_copy_1x_tensor_p1(int count, int num_species, double qbym[GKYL_MAX_SPECIES], double epsilon0, struct gkyl_nmat *x, 
  const double *vlasov_pkpm_moms[GKYL_MAX_SPECIES], const double* pkpm_u[GKYL_MAX_SPECIES], 
  double* GKYL_RESTRICT euler_pkpm[GKYL_MAX_SPECIES], double* GKYL_RESTRICT em) ; 
GKYL_CU_DH void euler_pkpm_explicit_source_1x_tensor_p1(const double *qmem, const double *vlasov_pkpm_moms, const double *euler_pkpm, double* GKYL_RESTRICT out); 
GKYL_CU_DH double euler_pkpm_vol_1x_tensor_p1(const double *w, const double *dxv, 
  const double *vlasov_pkpm_moms, const double *pkpm_u, const double *p_ij, const double *euler_pkpm, double* GKYL_RESTRICT out); 
...
GKYL_CU_DH double euler_pkpm_surfx_1x_tensor_p1(const double *w, const double *dxv, 
...
GKYL_CU_DH int pkpm_vars_u_set_2x_tensor_p1(int count, struct gkyl_nmat *A, struct gkyl_nmat *rhs, 
  const double *vlasov_pkpm_moms, const double *euler_pkpm); 
GKYL_CU_DH void pkpm_vars_u_copy_2x_tensor_p1(int count, struct gkyl_nmat *x, double* GKYL_RESTRICT pkpm_u); 
GKYL_CU_DH void pkpm_vars_u_surf_2x_tensor_p1(const double* pkpm_u, double* GKYL_RESTRICT pkpm_u_surf); 
GKYL_CU_DH void euler_pkpm_em_coupling_set_2x_tensor_p1(int count, int num_species, double qbym[GKYL_MAX_SPECIES], double epsilon0, bool pkpm_field_static, double dt, 
  struct gkyl_nmat *A, struct gkyl_nmat *rhs, 
  const double *app_accel[GKYL_MAX_SPECIES], const double *ext_em, const double *app_current, 
  const double *vlasov_pkpm_moms[GKYL_MAX_SPECIES], const double* pkpm_u[GKYL_MAX_SPECIES], 
  double* GKYL_RESTRICT em); 
GKYL_CU_DH void euler_pkpm_em_coupling_copy_2x_tensor_p1(int count, int num_species, double qbym[GKYL_MAX_SPECIES], double epsilon0, struct gkyl_nmat *x, 
  const double *vlasov_pkpm_moms[GKYL_MAX_SPECIES], const double* pkpm_u[GKYL_MAX_SPECIES], 
  double* GKYL_RESTRICT euler_pkpm[GKYL_MAX_SPECIES], double* GKYL_RESTRICT em) ; 
GKYL_CU_DH void euler_pkpm_explicit_source_2x_tensor_p1(const double *qmem, const double *vlasov_pkpm_moms, const double *euler_pkpm, double* GKYL_RESTRICT out); 
...
GKYL_CU_DH void pkpm_vars_p_force_3x_tensor_p2(const double *prim_c, const double *div_b, double* GKYL_RESTRICT pkpm_accel); 
GKYL_CU_DH int pkpm_vars_set_3x_tensor_p2(int count, struct gkyl_nmat *A, struct gkyl_nmat *rhs, 
  const double *vlasov_pkpm_moms, const double *p_ij, const double *pkpm_div_ppar); 
GKYL_CU_DH void pkpm_vars_copy_3x_tensor_p2(int count, struct gkyl_nmat *x, double* GKYL_RESTRICT prim); 
...
GKYL_CU_DH int pkpm_vars_u_set_3x_tensor_p1(int count, struct gkyl_nmat *A, struct gkyl_nmat *rhs, 
  const double *vlasov_pkpm_moms, const double *euler_pkpm); 
GKYL_CU_DH void pkpm_vars_u_copy_3x_tensor_p1(int count, struct gkyl_nmat *x, double* GKYL_RESTRICT pkpm_u); 
GKYL_CU_DH void pkpm_vars_u_surf_3x_tensor_p1(const double* pkpm_u, double* GKYL_RESTRICT pkpm_u_surf); 
GKYL_CU_DH void euler_pkpm_em_coupling_set_3x_tensor_p1(int count, int num_species, double qbym[GKYL_MAX_SPECIES], double epsilon0, bool pkpm_field_static, double dt, 
  struct gkyl_nmat *A, struct gkyl_nmat *rhs, 
  const double *app_accel[GKYL_MAX_SPECIES], const double *ext_em, const double *app_current, 
  const double *vlasov_pkpm_moms[GKYL_MAX_SPECIES], const double* pkpm_u[GKYL_MAX_SPECIES], 
  double* GKYL_RESTRICT em); 
GKYL_CU_DH void euler_pkpm_em_coupling_copy_3x_tensor_p1(int count, int num_species, double qbym[GKYL_MAX_SPECIES], double epsilon0, struct gkyl_nmat *x, 
  const double *vlasov_pkpm_moms[GKYL_MAX_SPECIES], const double* pkpm_u[GKYL_MAX_SPECIES], 
  double* GKYL_RESTRICT euler_pkpm[GKYL_MAX_SPECIES], double* GKYL_RESTRICT em) ; 
GKYL_CU_DH void euler_pkpm_explicit_source_3x_tensor_p1(const double *qmem, const double *vlasov_pkpm_moms, const double *euler_pkpm, double* GKYL_RESTRICT out); 
GKYL_CU_DH double euler_pkpm_vol_3x_tensor_p1(const double *w, const double *dxv, 
  const double *vlasov_pkpm_moms, const double *pkpm_u, const double *p_ij, const double *euler_pkpm, double* GKYL_RESTRICT out); 
