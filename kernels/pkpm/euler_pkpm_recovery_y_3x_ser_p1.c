...
{ 
  ...
  grad_u_z[1] += ((-0.2886751345948129*uz_l[4])+0.2886751345948129*uz_c[4]-0.25*(uz_l[1]+uz_c[1]))*dx1; 
  grad_u_z[2] += (0.5*uz_l[2]-0.5*uz_c[2]+0.4330127018922193*(uz_l[0]+uz_c[0]))*dx1; 
  grad_u_z[3] += ((-0.2886751345948129*uz_l[6])+0.2886751345948129*uz_c[6]-0.25*(uz_l[3]+uz_c[3]))*dx1; 
  grad_u_z[4] += (0.5*uz_l[4]-0.5*uz_c[4]+0.4330127018922193*(uz_l[1]+uz_c[1]))*dx1; 
  grad_u_z[5] += ((-0.2886751345948129*uz_l[7])+0.2886751345948129*uz_c[7]-0.25*(uz_l[5]+uz_c[5]))*dx1; 
  grad_u_z[6] += (0.5*uz_l[6]-0.5*uz_c[6]+0.4330127018922193*(uz_l[3]+uz_c[3]))*dx1; 
  grad_u_z[7] += (0.5*uz_l[7]-0.5*uz_c[7]+0.4330127018922193*(uz_l[5]+uz_c[5]))*dx1; 
  ...
  grad_u_z[1] += ((-0.2886751345948129*uz_r[4])+0.2886751345948129*uz_c[4]+0.25*(uz_r[1]+uz_c[1]))*dx1; 
  grad_u_z[2] += ((-0.5*uz_r[2])+0.5*uz_c[2]+0.4330127018922193*(uz_r[0]+uz_c[0]))*dx1; 
  grad_u_z[3] += ((-0.2886751345948129*uz_r[6])+0.2886751345948129*uz_c[6]+0.25*(uz_r[3]+uz_c[3]))*dx1; 
  grad_u_z[4] += ((-0.5*uz_r[4])+0.5*uz_c[4]+0.4330127018922193*(uz_r[1]+uz_c[1]))*dx1; 
  grad_u_z[5] += ((-0.2886751345948129*uz_r[7])+0.2886751345948129*uz_c[7]+0.25*(uz_r[5]+uz_c[5]))*dx1; 
  grad_u_z[6] += ((-0.5*uz_r[6])+0.5*uz_c[6]+0.4330127018922193*(uz_r[3]+uz_c[3]))*dx1; 
  grad_u_z[7] += ((-0.5*uz_r[7])+0.5*uz_c[7]+0.4330127018922193*(uz_r[5]+uz_c[5]))*dx1; 
