...
{ 
  ...
  const double *F_0_sourceSkin = &fSkin[9]; 
  const double *G_1_sourceSkin = &g_dist_sourceSkin[0]; 
  const double *F_0_sourceEdge = &fEdge[9]; 
  ...
  if (0.6324555320336759*div_b_Surf[2]-0.9486832980505137*div_b_Surf[1]+0.7071067811865475*div_b_Surf[0] > 0) { 
    F_0_div_b_UpwindQuad[0] = tensor_2x_p2_surfx2_eval_quad_node_0_r(F_0_sourceSkin); 
    G_1_div_b_UpwindQuad[0] = tensor_2x_p2_surfx2_eval_quad_node_0_r(G_1_sourceSkin); 
  } else { 
    F_0_div_b_UpwindQuad[0] = tensor_2x_p2_surfx2_eval_quad_node_0_l(F_0_sourceEdge); 
    G_1_div_b_UpwindQuad[0] = tensor_2x_p2_surfx2_eval_quad_node_0_l(G_1_sourceEdge); 
  } 
  if (0.7071067811865475*div_b_Surf[0]-0.7905694150420947*div_b_Surf[2] > 0) { 
    F_0_div_b_UpwindQuad[1] = tensor_2x_p2_surfx2_eval_quad_node_1_r(F_0_sourceSkin); 
    G_1_div_b_UpwindQuad[1] = tensor_2x_p2_surfx2_eval_quad_node_1_r(G_1_sourceSkin); 
  } else { 
    F_0_div_b_UpwindQuad[1] = tensor_2x_p2_surfx2_eval_quad_node_1_l(F_0_sourceEdge); 
    G_1_div_b_UpwindQuad[1] = tensor_2x_p2_surfx2_eval_quad_node_1_l(G_1_sourceEdge); 
  } 
  if (0.6324555320336759*div_b_Surf[2]+0.9486832980505137*div_b_Surf[1]+0.7071067811865475*div_b_Surf[0] > 0) { 
    F_0_div_b_UpwindQuad[2] = tensor_2x_p2_surfx2_eval_quad_node_2_r(F_0_sourceSkin); 
    G_1_div_b_UpwindQuad[2] = tensor_2x_p2_surfx2_eval_quad_node_2_r(G_1_sourceSkin); 
  } else { 
    F_0_div_b_UpwindQuad[2] = tensor_2x_p2_surfx2_eval_quad_node_2_l(F_0_sourceEdge); 
    G_1_div_b_UpwindQuad[2] = tensor_2x_p2_surfx2_eval_quad_node_2_l(G_1_sourceEdge); 
  } 

  // Project tensor nodal quadrature basis back onto modal basis. 
  tensor_2x_p2_upwind_quad_to_modal(F_0_div_b_UpwindQuad, F_0_div_b_Upwind); 
  tensor_2x_p2_upwind_quad_to_modal(G_1_div_b_UpwindQuad, G_1_div_b_Upwind); 
  ...
  out_F_0[8] += (-1.58113883008419*Ghat_F_0_div_b[2]*dv1par)-1.58113883008419*Ghat_F_0[2]*dv1par; 
  ...
  out_G_1[8] += (-1.58113883008419*Ghat_G_1_div_b[2]*dv1par)-1.58113883008419*Ghat_G_1[2]*dv1par; 
  ...
  if (0.6324555320336759*div_b_Surf[2]-0.9486832980505137*div_b_Surf[1]+0.7071067811865475*div_b_Surf[0] > 0) { 
    F_0_div_b_UpwindQuad[0] = tensor_2x_p2_surfx2_eval_quad_node_0_r(F_0_sourceEdge); 
    G_1_div_b_UpwindQuad[0] = tensor_2x_p2_surfx2_eval_quad_node_0_r(G_1_sourceEdge); 
  } else { 
    F_0_div_b_UpwindQuad[0] = tensor_2x_p2_surfx2_eval_quad_node_0_l(F_0_sourceSkin); 
    G_1_div_b_UpwindQuad[0] = tensor_2x_p2_surfx2_eval_quad_node_0_l(G_1_sourceSkin); 
  } 
  if (0.7071067811865475*div_b_Surf[0]-0.7905694150420947*div_b_Surf[2] > 0) { 
    F_0_div_b_UpwindQuad[1] = tensor_2x_p2_surfx2_eval_quad_node_1_r(F_0_sourceEdge); 
    G_1_div_b_UpwindQuad[1] = tensor_2x_p2_surfx2_eval_quad_node_1_r(G_1_sourceEdge); 
  } else { 
    F_0_div_b_UpwindQuad[1] = tensor_2x_p2_surfx2_eval_quad_node_1_l(F_0_sourceSkin); 
    G_1_div_b_UpwindQuad[1] = tensor_2x_p2_surfx2_eval_quad_node_1_l(G_1_sourceSkin); 
  } 
  if (0.6324555320336759*div_b_Surf[2]+0.9486832980505137*div_b_Surf[1]+0.7071067811865475*div_b_Surf[0] > 0) { 
    F_0_div_b_UpwindQuad[2] = tensor_2x_p2_surfx2_eval_quad_node_2_r(F_0_sourceEdge); 
    G_1_div_b_UpwindQuad[2] = tensor_2x_p2_surfx2_eval_quad_node_2_r(G_1_sourceEdge); 
  } else { 
    F_0_div_b_UpwindQuad[2] = tensor_2x_p2_surfx2_eval_quad_node_2_l(F_0_sourceSkin); 
    G_1_div_b_UpwindQuad[2] = tensor_2x_p2_surfx2_eval_quad_node_2_l(G_1_sourceSkin); 
  } 
