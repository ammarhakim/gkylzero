...
GKYL_CU_DH void euler_pkpm_em_coupling_set_2x_tensor_p1(int count, 
...
{ 
  ...
  for (int s = 0; s < num_species; ++s) { 
    ...
    if (!pkpm_field_static) { 
      gkyl_mat_set(&lhs, 1 + num_species*(12), 1 + s*(12), 0.5*dt*qbym[s]*(0.4472135954999579*rho[s][4]+0.5*rho[s][0])); 
      gkyl_mat_set(&lhs, 5 + num_species*(12), 5 + s*(12), 0.5*dt*qbym[s]*(0.4472135954999579*rho[s][4]+0.5*rho[s][0])); 
      gkyl_mat_set(&lhs, 9 + num_species*(12), 9 + s*(12), 0.5*dt*qbym[s]*(0.4472135954999579*rho[s][4]+0.5*rho[s][0])); 
    } 
    ...
    if (!pkpm_field_static) { 
      gkyl_mat_set(&lhs, 1 + num_species*(12), 3 + s*(12), 0.5*dt*qbym[s]*(0.447213595499958*rho[s][6]+0.5*rho[s][2])); 
      gkyl_mat_set(&lhs, 5 + num_species*(12), 7 + s*(12), 0.5*dt*qbym[s]*(0.447213595499958*rho[s][6]+0.5*rho[s][2])); 
      gkyl_mat_set(&lhs, 9 + num_species*(12), 11 + s*(12), 0.5*dt*qbym[s]*(0.447213595499958*rho[s][6]+0.5*rho[s][2])); 
    } 
    ...
    if (!pkpm_field_static) { 
      gkyl_mat_set(&lhs, 2 + num_species*(12), 2 + s*(12), 0.5*dt*qbym[s]*(0.4472135954999579*rho[s][5]+0.5*rho[s][0])); 
      gkyl_mat_set(&lhs, 6 + num_species*(12), 6 + s*(12), 0.5*dt*qbym[s]*(0.4472135954999579*rho[s][5]+0.5*rho[s][0])); 
      gkyl_mat_set(&lhs, 10 + num_species*(12), 10 + s*(12), 0.5*dt*qbym[s]*(0.4472135954999579*rho[s][5]+0.5*rho[s][0])); 
    } 
    ...
    if (!pkpm_field_static) { 
      gkyl_mat_set(&lhs, 2 + num_species*(12), 3 + s*(12), 0.5*dt*qbym[s]*(0.447213595499958*rho[s][7]+0.5*rho[s][1])); 
      gkyl_mat_set(&lhs, 6 + num_species*(12), 7 + s*(12), 0.5*dt*qbym[s]*(0.447213595499958*rho[s][7]+0.5*rho[s][1])); 
      gkyl_mat_set(&lhs, 10 + num_species*(12), 11 + s*(12), 0.5*dt*qbym[s]*(0.447213595499958*rho[s][7]+0.5*rho[s][1])); 
    } 
    ...
    if (!pkpm_field_static) { 
      gkyl_mat_set(&lhs, 3 + num_species*(12), 1 + s*(12), 0.5*dt*qbym[s]*(0.447213595499958*rho[s][6]+0.5*rho[s][2])); 
      gkyl_mat_set(&lhs, 7 + num_species*(12), 5 + s*(12), 0.5*dt*qbym[s]*(0.447213595499958*rho[s][6]+0.5*rho[s][2])); 
      gkyl_mat_set(&lhs, 11 + num_species*(12), 9 + s*(12), 0.5*dt*qbym[s]*(0.447213595499958*rho[s][6]+0.5*rho[s][2])); 
    } 
    ...
    if (!pkpm_field_static) { 
      gkyl_mat_set(&lhs, 3 + num_species*(12), 2 + s*(12), 0.5*dt*qbym[s]*(0.447213595499958*rho[s][7]+0.5*rho[s][1])); 
      gkyl_mat_set(&lhs, 7 + num_species*(12), 6 + s*(12), 0.5*dt*qbym[s]*(0.447213595499958*rho[s][7]+0.5*rho[s][1])); 
      gkyl_mat_set(&lhs, 11 + num_species*(12), 10 + s*(12), 0.5*dt*qbym[s]*(0.447213595499958*rho[s][7]+0.5*rho[s][1])); 
    } 
    ...
    if (!pkpm_field_static) { 
      gkyl_mat_set(&lhs, 3 + num_species*(12), 3 + s*(12), 0.5*dt*qbym[s]*(0.4*rho[s][8]+0.4472135954999579*rho[s][5]+0.4472135954999579*rho[s][4]+0.5*rho[s][0])); 
      gkyl_mat_set(&lhs, 7 + num_species*(12), 7 + s*(12), 0.5*dt*qbym[s]*(0.4*rho[s][8]+0.4472135954999579*rho[s][5]+0.4472135954999579*rho[s][4]+0.5*rho[s][0])); 
      gkyl_mat_set(&lhs, 11 + num_species*(12), 11 + s*(12), 0.5*dt*qbym[s]*(0.4*rho[s][8]+0.4472135954999579*rho[s][5]+0.4472135954999579*rho[s][4]+0.5*rho[s][0])); 
    } 
