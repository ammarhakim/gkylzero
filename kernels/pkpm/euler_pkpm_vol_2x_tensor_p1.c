...
{ 
  ...
  outrhoux[2] += 0.8660254037844386*rhouy_2p[3]*ux[3]*dx11+0.8660254037844386*rhouy_2p[2]*ux[2]*dx11+0.8660254037844386*rhouy_2p[1]*ux[1]*dx11+0.8660254037844386*rhouy_2p[0]*ux[0]*dx11+1.732050807568877*Pxy[0]*dx11; 
  outrhoux[3] += 0.7745966692414834*ux[3]*rhouy_2p[6]*dx11+0.7745966692414833*ux[1]*rhouy_2p[4]*dx11+0.8660254037844386*rhouy_2p[2]*ux[3]*dx11+0.8660254037844386*ux[2]*rhouy_2p[3]*dx11+0.8660254037844386*rhouy_2p[0]*ux[1]*dx11+0.8660254037844386*ux[0]*rhouy_2p[1]*dx11+1.732050807568877*Pxy[1]*dx11+0.7745966692414834*ux[3]*rhoux_2p[7]*dx10+0.7745966692414833*ux[2]*rhoux_2p[5]*dx10+0.8660254037844386*rhoux_2p[1]*ux[3]*dx10+0.8660254037844386*ux[1]*rhoux_2p[3]*dx10+0.8660254037844386*rhoux_2p[0]*ux[2]*dx10+0.8660254037844386*ux[0]*rhoux_2p[2]*dx10+1.732050807568877*Pxx[2]*dx10; 

  outrhouy[1] += 0.8660254037844386*rhoux_2p[3]*uy[3]*dx10+0.8660254037844386*rhoux_2p[2]*uy[2]*dx10+0.8660254037844386*rhoux_2p[1]*uy[1]*dx10+0.8660254037844386*rhoux_2p[0]*uy[0]*dx10+1.732050807568877*Pxy[0]*dx10; 
  ...
  outrhouy[3] += 0.7745966692414834*uy[3]*rhouy_2p[6]*dx11+0.7745966692414833*uy[1]*rhouy_2p[4]*dx11+0.8660254037844386*rhouy_2p[2]*uy[3]*dx11+0.8660254037844386*uy[2]*rhouy_2p[3]*dx11+0.8660254037844386*rhouy_2p[0]*uy[1]*dx11+0.8660254037844386*uy[0]*rhouy_2p[1]*dx11+1.732050807568877*Pyy[1]*dx11+0.7745966692414834*uy[3]*rhoux_2p[7]*dx10+0.7745966692414833*uy[2]*rhoux_2p[5]*dx10+0.8660254037844386*rhoux_2p[1]*uy[3]*dx10+0.8660254037844386*uy[1]*rhoux_2p[3]*dx10+0.8660254037844386*rhoux_2p[0]*uy[2]*dx10+0.8660254037844386*uy[0]*rhoux_2p[2]*dx10+1.732050807568877*Pxy[2]*dx10; 

  outrhouz[1] += 0.8660254037844386*rhoux_2p[3]*uz[3]*dx10+0.8660254037844386*rhoux_2p[2]*uz[2]*dx10+0.8660254037844386*rhoux_2p[1]*uz[1]*dx10+0.8660254037844386*rhoux_2p[0]*uz[0]*dx10+1.732050807568877*Pxz[0]*dx10; 
  outrhouz[2] += 0.8660254037844386*rhouy_2p[3]*uz[3]*dx11+0.8660254037844386*rhouy_2p[2]*uz[2]*dx11+0.8660254037844386*rhouy_2p[1]*uz[1]*dx11+0.8660254037844386*rhouy_2p[0]*uz[0]*dx11+1.732050807568877*Pyz[0]*dx11; 
  outrhouz[3] += 0.7745966692414834*uz[3]*rhouy_2p[6]*dx11+0.7745966692414833*uz[1]*rhouy_2p[4]*dx11+0.8660254037844386*rhouy_2p[2]*uz[3]*dx11+0.8660254037844386*uz[2]*rhouy_2p[3]*dx11+0.8660254037844386*rhouy_2p[0]*uz[1]*dx11+0.8660254037844386*uz[0]*rhouy_2p[1]*dx11+1.732050807568877*Pyz[1]*dx11+0.7745966692414834*uz[3]*rhoux_2p[7]*dx10+0.7745966692414833*uz[2]*rhoux_2p[5]*dx10+0.8660254037844386*rhoux_2p[1]*uz[3]*dx10+0.8660254037844386*uz[1]*rhoux_2p[3]*dx10+0.8660254037844386*rhoux_2p[0]*uz[2]*dx10+0.8660254037844386*uz[0]*rhoux_2p[2]*dx10+1.732050807568877*Pxz[2]*dx10; 
