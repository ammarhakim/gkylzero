...
{ 
  ...
  p_force[0] += 0.3535533905932737*pkpm_div_ppar[7]*rho_inv[7]-0.3535533905932737*T_perp_over_m[7]*div_b_comp[7]+0.3535533905932737*pkpm_div_ppar[6]*rho_inv[6]-0.3535533905932737*T_perp_over_m[6]*div_b_comp[6]+0.3535533905932737*pkpm_div_ppar[5]*rho_inv[5]-0.3535533905932737*T_perp_over_m[5]*div_b_comp[5]+0.3535533905932737*pkpm_div_ppar[4]*rho_inv[4]-0.3535533905932737*T_perp_over_m[4]*div_b_comp[4]+0.3535533905932737*pkpm_div_ppar[3]*rho_inv[3]-0.3535533905932737*T_perp_over_m[3]*div_b_comp[3]+0.3535533905932737*pkpm_div_ppar[2]*rho_inv[2]-0.3535533905932737*T_perp_over_m[2]*div_b_comp[2]+0.3535533905932737*pkpm_div_ppar[1]*rho_inv[1]-0.3535533905932737*T_perp_over_m[1]*div_b_comp[1]+0.3535533905932737*pkpm_div_ppar[0]*rho_inv[0]-0.3535533905932737*T_perp_over_m[0]*div_b_comp[0]; 
  p_force[1] += 0.3535533905932737*(pkpm_div_ppar[6]*rho_inv[7]+rho_inv[6]*pkpm_div_ppar[7])-0.3535533905932737*(T_perp_over_m[6]*div_b_comp[7]+div_b_comp[6]*T_perp_over_m[7])+0.3535533905932737*(pkpm_div_ppar[3]*rho_inv[5]+rho_inv[3]*pkpm_div_ppar[5])-0.3535533905932737*(T_perp_over_m[3]*div_b_comp[5]+div_b_comp[3]*T_perp_over_m[5])+0.3535533905932737*(pkpm_div_ppar[2]*rho_inv[4]+rho_inv[2]*pkpm_div_ppar[4])-0.3535533905932737*(T_perp_over_m[2]*div_b_comp[4]+div_b_comp[2]*T_perp_over_m[4])+0.3535533905932737*(pkpm_div_ppar[0]*rho_inv[1]+rho_inv[0]*pkpm_div_ppar[1])-0.3535533905932737*(T_perp_over_m[0]*div_b_comp[1]+div_b_comp[0]*T_perp_over_m[1]); 
  p_force[2] += 0.3535533905932737*(pkpm_div_ppar[5]*rho_inv[7]+rho_inv[5]*pkpm_div_ppar[7])-0.3535533905932737*(T_perp_over_m[5]*div_b_comp[7]+div_b_comp[5]*T_perp_over_m[7])+0.3535533905932737*(pkpm_div_ppar[3]*rho_inv[6]+rho_inv[3]*pkpm_div_ppar[6])-0.3535533905932737*(T_perp_over_m[3]*div_b_comp[6]+div_b_comp[3]*T_perp_over_m[6])+0.3535533905932737*(pkpm_div_ppar[1]*rho_inv[4]+rho_inv[1]*pkpm_div_ppar[4])-0.3535533905932737*(T_perp_over_m[1]*div_b_comp[4]+div_b_comp[1]*T_perp_over_m[4])+0.3535533905932737*(pkpm_div_ppar[0]*rho_inv[2]+rho_inv[0]*pkpm_div_ppar[2])-0.3535533905932737*(T_perp_over_m[0]*div_b_comp[2]+div_b_comp[0]*T_perp_over_m[2]); 
  p_force[3] += 0.3535533905932737*(pkpm_div_ppar[4]*rho_inv[7]+rho_inv[4]*pkpm_div_ppar[7])-0.3535533905932737*(T_perp_over_m[4]*div_b_comp[7]+div_b_comp[4]*T_perp_over_m[7])+0.3535533905932737*(pkpm_div_ppar[2]*rho_inv[6]+rho_inv[2]*pkpm_div_ppar[6])-0.3535533905932737*(T_perp_over_m[2]*div_b_comp[6]+div_b_comp[2]*T_perp_over_m[6])+0.3535533905932737*(pkpm_div_ppar[1]*rho_inv[5]+rho_inv[1]*pkpm_div_ppar[5])-0.3535533905932737*(T_perp_over_m[1]*div_b_comp[5]+div_b_comp[1]*T_perp_over_m[5])+0.3535533905932737*(pkpm_div_ppar[0]*rho_inv[3]+rho_inv[0]*pkpm_div_ppar[3])-0.3535533905932737*(T_perp_over_m[0]*div_b_comp[3]+div_b_comp[0]*T_perp_over_m[3]); 
  p_force[4] += 0.3535533905932737*(pkpm_div_ppar[3]*rho_inv[7]+rho_inv[3]*pkpm_div_ppar[7])-0.3535533905932737*(T_perp_over_m[3]*div_b_comp[7]+div_b_comp[3]*T_perp_over_m[7])+0.3535533905932737*(pkpm_div_ppar[5]*rho_inv[6]+rho_inv[5]*pkpm_div_ppar[6])-0.3535533905932737*(T_perp_over_m[5]*div_b_comp[6]+div_b_comp[5]*T_perp_over_m[6])+0.3535533905932737*(pkpm_div_ppar[0]*rho_inv[4]+rho_inv[0]*pkpm_div_ppar[4])-0.3535533905932737*(T_perp_over_m[0]*div_b_comp[4]+div_b_comp[0]*T_perp_over_m[4])+0.3535533905932737*(pkpm_div_ppar[1]*rho_inv[2]+rho_inv[1]*pkpm_div_ppar[2])-0.3535533905932737*(T_perp_over_m[1]*div_b_comp[2]+div_b_comp[1]*T_perp_over_m[2]); 
  p_force[5] += 0.3535533905932737*(pkpm_div_ppar[2]*rho_inv[7]+rho_inv[2]*pkpm_div_ppar[7])-0.3535533905932737*(T_perp_over_m[2]*div_b_comp[7]+div_b_comp[2]*T_perp_over_m[7])+0.3535533905932737*(pkpm_div_ppar[4]*rho_inv[6]+rho_inv[4]*pkpm_div_ppar[6])-0.3535533905932737*(T_perp_over_m[4]*div_b_comp[6]+div_b_comp[4]*T_perp_over_m[6])+0.3535533905932737*(pkpm_div_ppar[0]*rho_inv[5]+rho_inv[0]*pkpm_div_ppar[5])-0.3535533905932737*(T_perp_over_m[0]*div_b_comp[5]+div_b_comp[0]*T_perp_over_m[5])+0.3535533905932737*(pkpm_div_ppar[1]*rho_inv[3]+rho_inv[1]*pkpm_div_ppar[3])-0.3535533905932737*(T_perp_over_m[1]*div_b_comp[3]+div_b_comp[1]*T_perp_over_m[3]); 
  p_force[6] += 0.3535533905932737*(pkpm_div_ppar[1]*rho_inv[7]+rho_inv[1]*pkpm_div_ppar[7])-0.3535533905932737*(T_perp_over_m[1]*div_b_comp[7]+div_b_comp[1]*T_perp_over_m[7])+0.3535533905932737*(pkpm_div_ppar[0]*rho_inv[6]+rho_inv[0]*pkpm_div_ppar[6])-0.3535533905932737*(T_perp_over_m[0]*div_b_comp[6]+div_b_comp[0]*T_perp_over_m[6])+0.3535533905932737*(pkpm_div_ppar[4]*rho_inv[5]+rho_inv[4]*pkpm_div_ppar[5])-0.3535533905932737*(T_perp_over_m[4]*div_b_comp[5]+div_b_comp[4]*T_perp_over_m[5])+0.3535533905932737*(pkpm_div_ppar[2]*rho_inv[3]+rho_inv[2]*pkpm_div_ppar[3])-0.3535533905932737*(T_perp_over_m[2]*div_b_comp[3]+div_b_comp[2]*T_perp_over_m[3]); 
  p_force[7] += 0.3535533905932737*(pkpm_div_ppar[0]*rho_inv[7]+rho_inv[0]*pkpm_div_ppar[7])-0.3535533905932737*(T_perp_over_m[0]*div_b_comp[7]+div_b_comp[0]*T_perp_over_m[7])+0.3535533905932737*(pkpm_div_ppar[1]*rho_inv[6]+rho_inv[1]*pkpm_div_ppar[6])-0.3535533905932737*(T_perp_over_m[1]*div_b_comp[6]+div_b_comp[1]*T_perp_over_m[6])+0.3535533905932737*(pkpm_div_ppar[2]*rho_inv[5]+rho_inv[2]*pkpm_div_ppar[5])-0.3535533905932737*(T_perp_over_m[2]*div_b_comp[5]+div_b_comp[2]*T_perp_over_m[5])+0.3535533905932737*(pkpm_div_ppar[3]*rho_inv[4]+rho_inv[3]*pkpm_div_ppar[4])-0.3535533905932737*(T_perp_over_m[3]*div_b_comp[4]+div_b_comp[3]*T_perp_over_m[4]); 
