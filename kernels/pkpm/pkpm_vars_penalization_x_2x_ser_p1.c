...
{ 
  ...
  const double *Tii_l = &prim_l[24]; 

  const double *u_i_r = &prim_r[0]; 
  const double *Tii_r = &prim_r[24]; 
  ...
  double *pkpm_penalization_rhouy_l = &pkpm_penalization[2]; 
  double *pkpm_penalization_rhouz_l = &pkpm_penalization[4]; 
  ...
  int use_lax = 0;
  q_l[0] = ser_2x_p1_surfx1_eval_quad_node_0_r(rho_l); 
  q_l[1] = ser_2x_p1_surfx1_eval_quad_node_0_r(rhoux_l); 
  q_l[2] = ser_2x_p1_surfx1_eval_quad_node_0_r(rhouy_l); 
  q_l[3] = ser_2x_p1_surfx1_eval_quad_node_0_r(rhouz_l); 
  q_l[4] = ser_2x_p1_surfx1_eval_quad_node_0_r(Pxx_l) + q_l[1]*q_l[1]/q_l[0]; 
  q_l[5] = ser_2x_p1_surfx1_eval_quad_node_0_r(Pxy_l) + q_l[1]*q_l[2]/q_l[0]; 
  q_l[6] = ser_2x_p1_surfx1_eval_quad_node_0_r(Pxz_l) + q_l[1]*q_l[3]/q_l[0]; 
  q_l[7] = ser_2x_p1_surfx1_eval_quad_node_0_r(Pyy_l) + q_l[2]*q_l[2]/q_l[0]; 
  q_l[8] = ser_2x_p1_surfx1_eval_quad_node_0_r(Pyz_l) + q_l[2]*q_l[3]/q_l[0]; 
  q_l[9] = ser_2x_p1_surfx1_eval_quad_node_0_r(Pzz_l) + q_l[3]*q_l[3]/q_l[0]; 
  q_r[0] = ser_2x_p1_surfx1_eval_quad_node_0_l(rho_r); 
  q_r[1] = ser_2x_p1_surfx1_eval_quad_node_0_l(rhoux_r); 
  q_r[2] = ser_2x_p1_surfx1_eval_quad_node_0_l(rhouy_r); 
  q_r[3] = ser_2x_p1_surfx1_eval_quad_node_0_l(rhouz_r); 
  q_r[4] = ser_2x_p1_surfx1_eval_quad_node_0_l(Pxx_r) + q_r[1]*q_r[1]/q_r[0]; 
  q_r[5] = ser_2x_p1_surfx1_eval_quad_node_0_l(Pxy_r) + q_r[1]*q_r[2]/q_r[0]; 
  q_r[6] = ser_2x_p1_surfx1_eval_quad_node_0_l(Pxz_r) + q_r[1]*q_r[3]/q_r[0]; 
  q_r[7] = ser_2x_p1_surfx1_eval_quad_node_0_l(Pyy_r) + q_r[2]*q_r[2]/q_r[0]; 
  q_r[8] = ser_2x_p1_surfx1_eval_quad_node_0_l(Pyz_r) + q_r[2]*q_r[3]/q_r[0]; 
  q_r[9] = ser_2x_p1_surfx1_eval_quad_node_0_l(Pzz_r) + q_r[3]*q_r[3]/q_r[0]; 

  T_l = ser_2x_p1_surfx1_eval_quad_node_0_r(Tii_l); 
  T_r = ser_2x_p1_surfx1_eval_quad_node_0_l(Tii_r); 
  if (T_l > 0.0 && T_r > 0.0) { 
  ...
  u_l = ser_2x_p1_surfx1_eval_quad_node_0_r(u_i_l); 
  u_r = ser_2x_p1_surfx1_eval_quad_node_0_l(u_i_r); 
  ...
  q_l[0] = ser_2x_p1_surfx1_eval_quad_node_1_r(rho_l); 
  q_l[1] = ser_2x_p1_surfx1_eval_quad_node_1_r(rhoux_l); 
  q_l[2] = ser_2x_p1_surfx1_eval_quad_node_1_r(rhouy_l); 
  q_l[3] = ser_2x_p1_surfx1_eval_quad_node_1_r(rhouz_l); 
  q_l[4] = ser_2x_p1_surfx1_eval_quad_node_1_r(Pxx_l) + q_l[1]*q_l[1]/q_l[0]; 
  q_l[5] = ser_2x_p1_surfx1_eval_quad_node_1_r(Pxy_l) + q_l[1]*q_l[2]/q_l[0]; 
  q_l[6] = ser_2x_p1_surfx1_eval_quad_node_1_r(Pxz_l) + q_l[1]*q_l[3]/q_l[0]; 
  q_l[7] = ser_2x_p1_surfx1_eval_quad_node_1_r(Pyy_l) + q_l[2]*q_l[2]/q_l[0]; 
  q_l[8] = ser_2x_p1_surfx1_eval_quad_node_1_r(Pyz_l) + q_l[2]*q_l[3]/q_l[0]; 
  q_l[9] = ser_2x_p1_surfx1_eval_quad_node_1_r(Pzz_l) + q_l[3]*q_l[3]/q_l[0]; 
  q_r[0] = ser_2x_p1_surfx1_eval_quad_node_1_l(rho_r); 
  q_r[1] = ser_2x_p1_surfx1_eval_quad_node_1_l(rhoux_r); 
  q_r[2] = ser_2x_p1_surfx1_eval_quad_node_1_l(rhouy_r); 
  q_r[3] = ser_2x_p1_surfx1_eval_quad_node_1_l(rhouz_r); 
  q_r[4] = ser_2x_p1_surfx1_eval_quad_node_1_l(Pxx_r) + q_r[1]*q_r[1]/q_r[0]; 
  q_r[5] = ser_2x_p1_surfx1_eval_quad_node_1_l(Pxy_r) + q_r[1]*q_r[2]/q_r[0]; 
  q_r[6] = ser_2x_p1_surfx1_eval_quad_node_1_l(Pxz_r) + q_r[1]*q_r[3]/q_r[0]; 
  q_r[7] = ser_2x_p1_surfx1_eval_quad_node_1_l(Pyy_r) + q_r[2]*q_r[2]/q_r[0]; 
  q_r[8] = ser_2x_p1_surfx1_eval_quad_node_1_l(Pyz_r) + q_r[2]*q_r[3]/q_r[0]; 
  q_r[9] = ser_2x_p1_surfx1_eval_quad_node_1_l(Pzz_r) + q_r[3]*q_r[3]/q_r[0]; 

  T_l = ser_2x_p1_surfx1_eval_quad_node_1_r(Tii_l); 
  T_r = ser_2x_p1_surfx1_eval_quad_node_1_l(Tii_r); 
  if (T_l > 0.0 && T_r > 0.0) { 
    vth_max = fmax(sqrt(T_l), sqrt(T_r)); 
  } else if (T_l > 0.0 && T_r < 0.0) { 
    vth_max = sqrt(T_l); 
  ...
  u_l = ser_2x_p1_surfx1_eval_quad_node_1_r(u_i_l); 
  u_r = ser_2x_p1_surfx1_eval_quad_node_1_l(u_i_r); 
  u_max = fmax(fabs(u_l), fabs(u_r)); 
