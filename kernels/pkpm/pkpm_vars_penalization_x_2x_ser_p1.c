...
GKYL_CU_DH void pkpm_vars_penalization_x_2x_ser_p1(double tol, 
...
{ 
  ...
  const double *uy_l = &prim_l[4]; 
  const double *uz_l = &prim_l[8]; 
  const double *Tii_l = &prim_l[24]; 

  const double *ux_r = &prim_r[0]; 
  const double *uy_r = &prim_r[4]; 
  const double *uz_r = &prim_r[8]; 
  ...
  u_l[0] = ser_2x_p1_surfx1_eval_quad_node_0_r(ux_l); 
  u_l[1] = ser_2x_p1_surfx1_eval_quad_node_0_r(uy_l); 
  u_l[2] = ser_2x_p1_surfx1_eval_quad_node_0_r(uz_l); 
  q_l[1] = q_l[0]*u_l[0]; 
  q_l[2] = q_l[0]*u_l[1]; 
  q_l[3] = q_l[0]*u_l[2]; 
  ...
  u_r[0] = ser_2x_p1_surfx1_eval_quad_node_0_l(ux_r); 
  u_r[1] = ser_2x_p1_surfx1_eval_quad_node_0_l(uy_r); 
  u_r[2] = ser_2x_p1_surfx1_eval_quad_node_0_l(uz_r); 
  q_r[1] = q_r[0]*u_r[0]; 
  q_r[2] = q_r[0]*u_r[1]; 
  q_r[3] = q_r[0]*u_r[2]; 
  ...
  u_l[0] = ser_2x_p1_surfx1_eval_quad_node_1_r(ux_l); 
  u_l[1] = ser_2x_p1_surfx1_eval_quad_node_1_r(uy_l); 
  u_l[2] = ser_2x_p1_surfx1_eval_quad_node_1_r(uz_l); 
  q_l[1] = q_l[0]*u_l[0]; 
  q_l[2] = q_l[0]*u_l[1]; 
  q_l[3] = q_l[0]*u_l[2]; 
  ...
  u_r[0] = ser_2x_p1_surfx1_eval_quad_node_1_l(ux_r); 
  u_r[1] = ser_2x_p1_surfx1_eval_quad_node_1_l(uy_r); 
  u_r[2] = ser_2x_p1_surfx1_eval_quad_node_1_l(uz_r); 
  q_r[1] = q_r[0]*u_r[0]; 
  q_r[2] = q_r[0]*u_r[1]; 
  q_r[3] = q_r[0]*u_r[2]; 
