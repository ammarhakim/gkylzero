...
{ 
  ...
  q_l[1] = tensor_2x_p2_surfx1_eval_quad_node_0_r(rhoux_l); 
  q_l[2] = tensor_2x_p2_surfx1_eval_quad_node_0_r(rhouy_l); 
  q_l[3] = tensor_2x_p2_surfx1_eval_quad_node_0_r(rhouz_l); 
  ...
  q_r[1] = tensor_2x_p2_surfx1_eval_quad_node_0_l(rhoux_r); 
  q_r[2] = tensor_2x_p2_surfx1_eval_quad_node_0_l(rhouy_r); 
  q_r[3] = tensor_2x_p2_surfx1_eval_quad_node_0_l(rhouz_r); 
  ...
  u_l = tensor_2x_p2_surfx1_eval_quad_node_0_r(u_i_l); 
  u_r = tensor_2x_p2_surfx1_eval_quad_node_0_l(u_i_r); 
  ...
  q_l[1] = tensor_2x_p2_surfx1_eval_quad_node_1_r(rhoux_l); 
  q_l[2] = tensor_2x_p2_surfx1_eval_quad_node_1_r(rhouy_l); 
  q_l[3] = tensor_2x_p2_surfx1_eval_quad_node_1_r(rhouz_l); 
  ...
  q_r[1] = tensor_2x_p2_surfx1_eval_quad_node_1_l(rhoux_r); 
  q_r[2] = tensor_2x_p2_surfx1_eval_quad_node_1_l(rhouy_r); 
  q_r[3] = tensor_2x_p2_surfx1_eval_quad_node_1_l(rhouz_r); 
  ...
  u_l = tensor_2x_p2_surfx1_eval_quad_node_1_r(u_i_l); 
  u_r = tensor_2x_p2_surfx1_eval_quad_node_1_l(u_i_r); 
  u_max = fmax(fabs(u_l), fabs(u_r)); 
  ...
  q_l[1] = tensor_2x_p2_surfx1_eval_quad_node_2_r(rhoux_l); 
  q_l[2] = tensor_2x_p2_surfx1_eval_quad_node_2_r(rhouy_l); 
  q_l[3] = tensor_2x_p2_surfx1_eval_quad_node_2_r(rhouz_l); 
  ...
  q_r[1] = tensor_2x_p2_surfx1_eval_quad_node_2_l(rhoux_r); 
  q_r[2] = tensor_2x_p2_surfx1_eval_quad_node_2_l(rhouy_r); 
  q_r[3] = tensor_2x_p2_surfx1_eval_quad_node_2_l(rhouz_r); 
  ...
  u_l = tensor_2x_p2_surfx1_eval_quad_node_2_r(u_i_l); 
  u_r = tensor_2x_p2_surfx1_eval_quad_node_2_l(u_i_r); 
  u_max = fmax(fabs(u_l), fabs(u_r)); 
