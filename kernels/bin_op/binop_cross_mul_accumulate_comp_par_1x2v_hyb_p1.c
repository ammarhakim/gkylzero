...
GKYL_CU_DH
void
binop_cross_mul_accumulate_comp_par_1x2v_hyb_p1(double a, const double *f, const double *g, double *fg, int linc2) 
{ 
  ...
  switch (linc2) { 
    ...
    case 11: 
      ...
      break; 
    case 12: 
      fg[12] += a*(0.7071067811865475*f[1]*g[13]+0.7071067811865475*f[0]*g[12]); 
      break; 
    case 13: 
      fg[13] += a*(0.7071067811865475*f[0]*g[13]+0.7071067811865475*f[1]*g[12]); 
      break; 
    case 14: 
