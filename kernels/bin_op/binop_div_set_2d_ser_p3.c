...
{ 
  ...
  if (0.7637626158259733*g[11]-0.9334876415650785*g[10]-1.322875655532295*g[9]+0.5389493411427869*g[8]-0.6454972243679028*g[7]+0.6454972243679028*g[6]+1.118033988749895*g[5]-0.3726779962499649*g[4]+0.5*g[3]-0.8660254037844386*g[2]-0.2886751345948129*g[1]+0.5*g[0] < 0.0) { 
    avgg = true;
  }
  if ((-0.7637626158259733*g[11])+0.9334876415650785*g[10]-1.322875655532295*g[9]-0.5389493411427869*g[8]+0.6454972243679028*(g[7]+g[6])+1.118033988749895*g[5]-0.3726779962499649*g[4]-0.5*g[3]-0.8660254037844386*g[2]+0.2886751345948129*g[1]+0.5*g[0] < 0.0) { 
    avgg = true;
  }
  ...
  if ((-0.9334876415650785*g[11])+0.7637626158259733*g[10]+0.5389493411427869*g[9]-1.322875655532295*g[8]+0.6454972243679028*g[7]-0.6454972243679028*g[6]-0.3726779962499649*g[5]+1.118033988749895*g[4]+0.5*g[3]-0.2886751345948129*g[2]-0.8660254037844386*g[1]+0.5*g[0] < 0.0) { 
    avgg = true;
  }
  if (0.9334876415650785*g[11]-0.7637626158259733*g[10]+0.5389493411427869*g[9]+1.322875655532295*g[8]-0.6454972243679028*(g[7]+g[6])-0.3726779962499649*g[5]+1.118033988749895*g[4]-0.5*g[3]-0.2886751345948129*g[2]+0.8660254037844386*g[1]+0.5*g[0] < 0.0) { 
    avgg = true;
  }
  if (0.9334876415650785*g[11]-0.7637626158259733*g[10]-0.5389493411427869*g[9]-1.322875655532295*g[8]+0.6454972243679028*(g[7]+g[6])-0.3726779962499649*g[5]+1.118033988749895*g[4]-0.5*g[3]+0.2886751345948129*g[2]-0.8660254037844386*g[1]+0.5*g[0] < 0.0) { 
    avgg = true;
