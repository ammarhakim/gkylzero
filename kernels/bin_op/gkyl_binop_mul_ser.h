...
GKYL_CU_DH void binop_mul_comp_par_1d_ser_p0(const double *f, const double *g, double *fg, int linc1 );
struct gkyl_kern_op_count op_count_binop_mul_comp_par_1d_ser_p0(void);

GKYL_CU_DH void binop_mul_comp_par_1d_ser_p1(const double *f, const double *g, double *fg, int linc1 );
struct gkyl_kern_op_count op_count_binop_mul_comp_par_1d_ser_p1(void);

GKYL_CU_DH void binop_mul_comp_par_1d_ser_p2(const double *f, const double *g, double *fg, int linc1 );
struct gkyl_kern_op_count op_count_binop_mul_comp_par_1d_ser_p2(void);

GKYL_CU_DH void binop_mul_comp_par_1d_ser_p3(const double *f, const double *g, double *fg, int linc1 );
