...
GKYL_CU_DH void binop_mul_comp_par_1d_ser_p0(const double *f, const double *g, double *fg, int linc2 );

GKYL_CU_DH void binop_mul_comp_par_1d_ser_p1(const double *f, const double *g, double *fg, int linc2 );

GKYL_CU_DH void binop_mul_comp_par_1d_ser_p2(const double *f, const double *g, double *fg, int linc2 );

GKYL_CU_DH void binop_mul_comp_par_1d_ser_p3(const double *f, const double *g, double *fg, int linc2 );

GKYL_CU_DH void binop_mul_comp_par_2d_ser_p0(const double *f, const double *g, double *fg, int linc2 );

GKYL_CU_DH void binop_mul_comp_par_2d_ser_p1(const double *f, const double *g, double *fg, int linc2 );

GKYL_CU_DH void binop_mul_comp_par_2d_ser_p2(const double *f, const double *g, double *fg, int linc2 );

GKYL_CU_DH void binop_mul_comp_par_2d_ser_p3(const double *f, const double *g, double *fg, int linc2 );

GKYL_CU_DH void binop_mul_comp_par_3d_ser_p0(const double *f, const double *g, double *fg, int linc2 );

GKYL_CU_DH void binop_mul_comp_par_3d_ser_p1(const double *f, const double *g, double *fg, int linc2 );

GKYL_CU_DH void binop_mul_comp_par_3d_ser_p2(const double *f, const double *g, double *fg, int linc2 );

GKYL_CU_DH void binop_mul_comp_par_3d_ser_p3(const double *f, const double *g, double *fg, int linc2 );
...
GKYL_CU_DH void binop_mul_comp_par_2d_tensor_p2(const double *f, const double *g, double *fg, int linc2 );

GKYL_CU_DH void binop_mul_comp_par_3d_tensor_p2(const double *f, const double *g, double *fg, int linc2 );
