...
{ 
  ...
  bool avgg = false;
  if (2.29128784747792*(g[11]+g[10])-1.322875655532295*(g[9]+g[8])-1.936491673103708*(g[7]+g[6])+1.118033988749895*(g[5]+g[4])+1.5*g[3]-0.8660254037844386*(g[2]+g[1])+0.5*g[0] < 0.0) { 
    avgg = true;
  }
  if ((-2.29128784747792*(g[11]+g[10]))-1.322875655532295*g[9]+1.322875655532295*g[8]+1.936491673103708*g[7]-1.936491673103708*g[6]+1.118033988749895*(g[5]+g[4])-1.5*g[3]-0.8660254037844386*g[2]+0.8660254037844386*g[1]+0.5*g[0] < 0.0) { 
    avgg = true;
  }
  if ((-2.29128784747792*(g[11]+g[10]))+1.322875655532295*g[9]-1.322875655532295*g[8]-1.936491673103708*g[7]+1.936491673103708*g[6]+1.118033988749895*(g[5]+g[4])-1.5*g[3]+0.8660254037844386*g[2]-0.8660254037844386*g[1]+0.5*g[0] < 0.0) { 
    avgg = true;
  ...
  gkyl_mat_set(A,6,8,0.2981423969999718*lhs[10]+0.4391550328268399*lhs[3]); 
  gkyl_mat_set(A,6,10,0.2981423969999718*lhs[8]+0.3927922024247863*lhs[7]+0.4391550328268399*lhs[1]); 
  ...
  gkyl_mat_set(A,7,9,0.2981423969999718*lhs[11]+0.4391550328268399*lhs[3]); 
  gkyl_mat_set(A,7,10,0.3927922024247863*lhs[6]); 
  gkyl_mat_set(A,7,11,0.2981423969999718*lhs[9]+0.3927922024247863*lhs[6]+0.4391550328268399*lhs[2]); 
  ...
  gkyl_mat_set(A,8,6,0.2981423969999718*lhs[10]+0.4391550328268399*lhs[3]); 
  gkyl_mat_set(A,8,8,0.2981423969999719*lhs[4]+0.5*lhs[0]); 
  gkyl_mat_set(A,8,10,0.2981423969999718*lhs[6]+0.5*lhs[2]); 
  ...
  gkyl_mat_set(A,9,7,0.2981423969999718*lhs[11]+0.4391550328268399*lhs[3]); 
  gkyl_mat_set(A,9,9,0.2981423969999719*lhs[5]+0.5*lhs[0]); 
  gkyl_mat_set(A,9,11,0.2981423969999718*lhs[7]+0.5*lhs[1]); 
  ...
  gkyl_mat_set(A,10,6,0.2981423969999718*lhs[8]+0.3927922024247863*lhs[7]+0.4391550328268399*lhs[1]); 
  gkyl_mat_set(A,10,7,0.3927922024247863*lhs[6]); 
  gkyl_mat_set(A,10,8,0.2981423969999718*lhs[6]+0.5*lhs[2]); 
  ...
  gkyl_mat_set(A,11,7,0.2981423969999718*lhs[9]+0.3927922024247863*lhs[6]+0.4391550328268399*lhs[2]); 
  gkyl_mat_set(A,11,9,0.2981423969999718*lhs[7]+0.5*lhs[1]); 
