...
GKYL_CU_DH double dg_diffusion_gyrokinetic_order6_boundary_surfy_2x2v_ser_p2_constcoeff(const double *w, const double *dx, const double *coeff, const double *jacobgeo_inv, int edge, const double *qSkin, const double *qEdge, double* GKYL_RESTRICT out) 
{
  ...
  edgeSurf_incr[5] = (-70.53065765632414*coeff[1]*qSkin[20])+51.4683177492095*coeff[1]*qEdge[20]-61.5234375*coeff[1]*qSkin[5]-56.6015625*coeff[1]*qEdge[5]-34.09975027401226*coeff[1]*qSkin[1]+34.09975027401226*coeff[1]*qEdge[1]; 
  ...
  edgeSurf_incr[7] = (-70.53065765632414*coeff[1]*qSkin[22])+51.4683177492095*coeff[1]*qEdge[22]-61.5234375*coeff[1]*qSkin[7]-56.6015625*coeff[1]*qEdge[7]-34.09975027401226*coeff[1]*qSkin[3]+34.09975027401226*coeff[1]*qEdge[3]; 
  ...
  edgeSurf_incr[9] = (-70.53065765632414*coeff[1]*qSkin[26])+51.4683177492095*coeff[1]*qEdge[26]-61.5234375*coeff[1]*qSkin[9]-56.6015625*coeff[1]*qEdge[9]-34.09975027401226*coeff[1]*qSkin[4]+34.09975027401226*coeff[1]*qEdge[4]; 
  ...
  edgeSurf_incr[12] = (-70.6640625*coeff[1]*qSkin[12])-3.1640625*coeff[1]*qEdge[12]-31.316701275974*coeff[1]*qSkin[2]-12.2543613688594*coeff[1]*qEdge[2]-12.57788237343632*qSkin[0]*coeff[1]+12.57788237343632*qEdge[0]*coeff[1]; 
  ...
  edgeSurf_incr[20] = (-70.6640625*coeff[1]*qSkin[20])-3.1640625*coeff[1]*qEdge[20]-31.31670127597403*coeff[1]*qSkin[5]-12.2543613688594*coeff[1]*qEdge[5]-12.57788237343632*coeff[1]*qSkin[1]+12.57788237343632*coeff[1]*qEdge[1]; 
  ...
  edgeSurf_incr[22] = (-70.6640625*coeff[1]*qSkin[22])-3.1640625*coeff[1]*qEdge[22]-31.31670127597403*coeff[1]*qSkin[7]-12.2543613688594*coeff[1]*qEdge[7]-12.57788237343632*coeff[1]*qSkin[3]+12.57788237343632*coeff[1]*qEdge[3]; 
  ...
  edgeSurf_incr[26] = (-70.6640625*coeff[1]*qSkin[26])-3.1640625*coeff[1]*qEdge[26]-31.31670127597403*coeff[1]*qSkin[9]-12.2543613688594*coeff[1]*qEdge[9]-12.57788237343632*coeff[1]*qSkin[4]+12.57788237343632*coeff[1]*qEdge[4]; 
  ...
  edgeSurf_incr[31] = (-70.53065765632414*coeff[1]*qSkin[45])+51.4683177492095*coeff[1]*qEdge[45]-61.5234375*coeff[1]*qSkin[31]-56.6015625*coeff[1]*qEdge[31]-34.09975027401226*coeff[1]*qSkin[17]+34.09975027401226*coeff[1]*qEdge[17]; 
  ...
  edgeSurf_incr[33] = (-70.6640625*coeff[1]*qSkin[33])-3.1640625*coeff[1]*qEdge[33]-31.316701275974*coeff[1]*qSkin[15]-12.2543613688594*coeff[1]*qEdge[15]-12.57788237343632*coeff[1]*qSkin[6]+12.57788237343632*coeff[1]*qEdge[6]; 
  ...
  edgeSurf_incr[36] = (-70.6640625*coeff[1]*qSkin[36])-3.1640625*coeff[1]*qEdge[36]-31.316701275974*coeff[1]*qSkin[16]-12.2543613688594*coeff[1]*qEdge[16]-12.57788237343632*coeff[1]*qSkin[8]+12.57788237343632*coeff[1]*qEdge[8]; 
  ...
  edgeSurf_incr[38] = (-70.6640625*coeff[1]*qSkin[38])-3.1640625*coeff[1]*qEdge[38]-31.316701275974*coeff[1]*qSkin[18]-12.2543613688594*coeff[1]*qEdge[18]-12.57788237343632*coeff[1]*qSkin[10]+12.57788237343632*coeff[1]*qEdge[10]; 
  ...
  edgeSurf_incr[45] = (-70.6640625*coeff[1]*qSkin[45])-3.1640625*coeff[1]*qEdge[45]-31.31670127597403*coeff[1]*qSkin[31]-12.2543613688594*coeff[1]*qEdge[31]-12.57788237343632*coeff[1]*qSkin[17]+12.57788237343632*coeff[1]*qEdge[17]; 
  ...
  boundSurf_incr[2] = 19.06233990711463*coeff[1]*qSkin[12]-4.921875*coeff[1]*qSkin[2]; 
  boundSurf_incr[5] = 19.06233990711463*coeff[1]*qSkin[20]-4.921875*coeff[1]*qSkin[5]; 
  boundSurf_incr[7] = 19.06233990711463*coeff[1]*qSkin[22]-4.921875*coeff[1]*qSkin[7]; 
  boundSurf_incr[9] = 19.06233990711463*coeff[1]*qSkin[26]-4.921875*coeff[1]*qSkin[9]; 
  boundSurf_incr[12] = 19.06233990711463*coeff[1]*qSkin[2]-73.828125*coeff[1]*qSkin[12]; 
  boundSurf_incr[15] = 19.06233990711463*coeff[1]*qSkin[33]-4.921875*coeff[1]*qSkin[15]; 
  boundSurf_incr[16] = 19.06233990711463*coeff[1]*qSkin[36]-4.921875*coeff[1]*qSkin[16]; 
  boundSurf_incr[18] = 19.06233990711463*coeff[1]*qSkin[38]-4.921875*coeff[1]*qSkin[18]; 
  boundSurf_incr[19] = -4.921875*coeff[1]*qSkin[19]; 
  boundSurf_incr[20] = 19.06233990711463*coeff[1]*qSkin[5]-73.828125*coeff[1]*qSkin[20]; 
  boundSurf_incr[22] = 19.06233990711463*coeff[1]*qSkin[7]-73.828125*coeff[1]*qSkin[22]; 
  boundSurf_incr[24] = -4.921875*coeff[1]*qSkin[24]; 
  boundSurf_incr[26] = 19.06233990711463*coeff[1]*qSkin[9]-73.828125*coeff[1]*qSkin[26]; 
  boundSurf_incr[29] = -4.921875*coeff[1]*qSkin[29]; 
  boundSurf_incr[31] = 19.06233990711463*coeff[1]*qSkin[45]-4.921875*coeff[1]*qSkin[31]; 
  boundSurf_incr[32] = -4.921875*coeff[1]*qSkin[32]; 
  boundSurf_incr[33] = 19.06233990711463*coeff[1]*qSkin[15]-73.828125*coeff[1]*qSkin[33]; 
  boundSurf_incr[34] = -4.921875*coeff[1]*qSkin[34]; 
  boundSurf_incr[35] = -4.921875*coeff[1]*qSkin[35]; 
  boundSurf_incr[36] = 19.06233990711463*coeff[1]*qSkin[16]-73.828125*coeff[1]*qSkin[36]; 
  boundSurf_incr[38] = 19.06233990711463*coeff[1]*qSkin[18]-73.828125*coeff[1]*qSkin[38]; 
  ...
  boundSurf_incr[45] = 19.06233990711463*coeff[1]*qSkin[31]-73.828125*coeff[1]*qSkin[45]; 
  ...
  boundSurf_incr[7] = (-19.06233990711463*coeff[1]*qSkin[22])-4.921875*coeff[1]*qSkin[7]; 
  boundSurf_incr[9] = (-19.06233990711463*coeff[1]*qSkin[26])-4.921875*coeff[1]*qSkin[9]; 
  boundSurf_incr[12] = (-73.828125*coeff[1]*qSkin[12])-19.06233990711463*coeff[1]*qSkin[2]; 
  boundSurf_incr[15] = (-19.06233990711463*coeff[1]*qSkin[33])-4.921875*coeff[1]*qSkin[15]; 
  boundSurf_incr[16] = (-19.06233990711463*coeff[1]*qSkin[36])-4.921875*coeff[1]*qSkin[16]; 
  boundSurf_incr[18] = (-19.06233990711463*coeff[1]*qSkin[38])-4.921875*coeff[1]*qSkin[18]; 
  boundSurf_incr[19] = -4.921875*coeff[1]*qSkin[19]; 
  boundSurf_incr[20] = (-73.828125*coeff[1]*qSkin[20])-19.06233990711463*coeff[1]*qSkin[5]; 
  boundSurf_incr[22] = (-73.828125*coeff[1]*qSkin[22])-19.06233990711463*coeff[1]*qSkin[7]; 
  boundSurf_incr[24] = -4.921875*coeff[1]*qSkin[24]; 
  boundSurf_incr[26] = (-73.828125*coeff[1]*qSkin[26])-19.06233990711463*coeff[1]*qSkin[9]; 
  boundSurf_incr[29] = -4.921875*coeff[1]*qSkin[29]; 
  boundSurf_incr[31] = (-19.06233990711463*coeff[1]*qSkin[45])-4.921875*coeff[1]*qSkin[31]; 
  boundSurf_incr[32] = -4.921875*coeff[1]*qSkin[32]; 
  boundSurf_incr[33] = (-73.828125*coeff[1]*qSkin[33])-19.06233990711463*coeff[1]*qSkin[15]; 
  boundSurf_incr[34] = -4.921875*coeff[1]*qSkin[34]; 
  boundSurf_incr[35] = -4.921875*coeff[1]*qSkin[35]; 
  boundSurf_incr[36] = (-73.828125*coeff[1]*qSkin[36])-19.06233990711463*coeff[1]*qSkin[16]; 
  boundSurf_incr[38] = (-73.828125*coeff[1]*qSkin[38])-19.06233990711463*coeff[1]*qSkin[18]; 
  boundSurf_incr[40] = -4.921875*coeff[1]*qSkin[40]; 
  boundSurf_incr[41] = -4.921875*coeff[1]*qSkin[41]; 
  boundSurf_incr[43] = -4.921875*coeff[1]*qSkin[43]; 
  boundSurf_incr[44] = -4.921875*coeff[1]*qSkin[44]; 
  boundSurf_incr[45] = (-73.828125*coeff[1]*qSkin[45])-19.06233990711463*coeff[1]*qSkin[31]; 
  boundSurf_incr[46] = -4.921875*coeff[1]*qSkin[46]; 
  boundSurf_incr[47] = -4.921875*coeff[1]*qSkin[47]; 
