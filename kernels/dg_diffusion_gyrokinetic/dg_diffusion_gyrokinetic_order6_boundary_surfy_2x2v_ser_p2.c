...
GKYL_CU_DH double dg_diffusion_gyrokinetic_order6_boundary_surfy_2x2v_ser_p2_constcoeff(const double *w, const double *dx, const double *coeff, int edge, const double *fSkin, const double *fEdge, double* GKYL_RESTRICT out) 
{
  ...
  edgeSurf_incr[5] = (-70.53065765632414*coeff[1]*fSkin[20])+51.4683177492095*coeff[1]*fEdge[20]-61.5234375*coeff[1]*fSkin[5]-56.6015625*coeff[1]*fEdge[5]-34.09975027401226*coeff[1]*fSkin[1]+34.09975027401226*coeff[1]*fEdge[1]; 
  ...
  edgeSurf_incr[7] = (-70.53065765632414*coeff[1]*fSkin[22])+51.4683177492095*coeff[1]*fEdge[22]-61.5234375*coeff[1]*fSkin[7]-56.6015625*coeff[1]*fEdge[7]-34.09975027401226*coeff[1]*fSkin[3]+34.09975027401226*coeff[1]*fEdge[3]; 
  ...
  edgeSurf_incr[9] = (-70.53065765632414*coeff[1]*fSkin[26])+51.4683177492095*coeff[1]*fEdge[26]-61.5234375*coeff[1]*fSkin[9]-56.6015625*coeff[1]*fEdge[9]-34.09975027401226*coeff[1]*fSkin[4]+34.09975027401226*coeff[1]*fEdge[4]; 
  ...
  edgeSurf_incr[12] = (-70.6640625*coeff[1]*fSkin[12])-3.1640625*coeff[1]*fEdge[12]-31.316701275974*coeff[1]*fSkin[2]-12.2543613688594*coeff[1]*fEdge[2]-12.57788237343632*fSkin[0]*coeff[1]+12.57788237343632*fEdge[0]*coeff[1]; 
  ...
  edgeSurf_incr[20] = (-70.6640625*coeff[1]*fSkin[20])-3.1640625*coeff[1]*fEdge[20]-31.31670127597403*coeff[1]*fSkin[5]-12.2543613688594*coeff[1]*fEdge[5]-12.57788237343632*coeff[1]*fSkin[1]+12.57788237343632*coeff[1]*fEdge[1]; 
  ...
  edgeSurf_incr[22] = (-70.6640625*coeff[1]*fSkin[22])-3.1640625*coeff[1]*fEdge[22]-31.31670127597403*coeff[1]*fSkin[7]-12.2543613688594*coeff[1]*fEdge[7]-12.57788237343632*coeff[1]*fSkin[3]+12.57788237343632*coeff[1]*fEdge[3]; 
  ...
  edgeSurf_incr[26] = (-70.6640625*coeff[1]*fSkin[26])-3.1640625*coeff[1]*fEdge[26]-31.31670127597403*coeff[1]*fSkin[9]-12.2543613688594*coeff[1]*fEdge[9]-12.57788237343632*coeff[1]*fSkin[4]+12.57788237343632*coeff[1]*fEdge[4]; 
  ...
  edgeSurf_incr[31] = (-70.53065765632414*coeff[1]*fSkin[45])+51.4683177492095*coeff[1]*fEdge[45]-61.5234375*coeff[1]*fSkin[31]-56.6015625*coeff[1]*fEdge[31]-34.09975027401226*coeff[1]*fSkin[17]+34.09975027401226*coeff[1]*fEdge[17]; 
  ...
  edgeSurf_incr[33] = (-70.6640625*coeff[1]*fSkin[33])-3.1640625*coeff[1]*fEdge[33]-31.316701275974*coeff[1]*fSkin[15]-12.2543613688594*coeff[1]*fEdge[15]-12.57788237343632*coeff[1]*fSkin[6]+12.57788237343632*coeff[1]*fEdge[6]; 
  ...
  edgeSurf_incr[36] = (-70.6640625*coeff[1]*fSkin[36])-3.1640625*coeff[1]*fEdge[36]-31.316701275974*coeff[1]*fSkin[16]-12.2543613688594*coeff[1]*fEdge[16]-12.57788237343632*coeff[1]*fSkin[8]+12.57788237343632*coeff[1]*fEdge[8]; 
  ...
  edgeSurf_incr[38] = (-70.6640625*coeff[1]*fSkin[38])-3.1640625*coeff[1]*fEdge[38]-31.316701275974*coeff[1]*fSkin[18]-12.2543613688594*coeff[1]*fEdge[18]-12.57788237343632*coeff[1]*fSkin[10]+12.57788237343632*coeff[1]*fEdge[10]; 
  ...
  edgeSurf_incr[45] = (-70.6640625*coeff[1]*fSkin[45])-3.1640625*coeff[1]*fEdge[45]-31.31670127597403*coeff[1]*fSkin[31]-12.2543613688594*coeff[1]*fEdge[31]-12.57788237343632*coeff[1]*fSkin[17]+12.57788237343632*coeff[1]*fEdge[17]; 
  ...
  boundSurf_incr[2] = 19.06233990711463*coeff[1]*fSkin[12]-4.921875*coeff[1]*fSkin[2]; 
  boundSurf_incr[5] = 19.06233990711463*coeff[1]*fSkin[20]-4.921875*coeff[1]*fSkin[5]; 
  boundSurf_incr[7] = 19.06233990711463*coeff[1]*fSkin[22]-4.921875*coeff[1]*fSkin[7]; 
  boundSurf_incr[9] = 19.06233990711463*coeff[1]*fSkin[26]-4.921875*coeff[1]*fSkin[9]; 
  boundSurf_incr[12] = 19.06233990711463*coeff[1]*fSkin[2]-73.828125*coeff[1]*fSkin[12]; 
  boundSurf_incr[15] = 19.06233990711463*coeff[1]*fSkin[33]-4.921875*coeff[1]*fSkin[15]; 
  boundSurf_incr[16] = 19.06233990711463*coeff[1]*fSkin[36]-4.921875*coeff[1]*fSkin[16]; 
  boundSurf_incr[18] = 19.06233990711463*coeff[1]*fSkin[38]-4.921875*coeff[1]*fSkin[18]; 
  boundSurf_incr[19] = -4.921875*coeff[1]*fSkin[19]; 
  boundSurf_incr[20] = 19.06233990711463*coeff[1]*fSkin[5]-73.828125*coeff[1]*fSkin[20]; 
  boundSurf_incr[22] = 19.06233990711463*coeff[1]*fSkin[7]-73.828125*coeff[1]*fSkin[22]; 
  boundSurf_incr[24] = -4.921875*coeff[1]*fSkin[24]; 
  boundSurf_incr[26] = 19.06233990711463*coeff[1]*fSkin[9]-73.828125*coeff[1]*fSkin[26]; 
  boundSurf_incr[29] = -4.921875*coeff[1]*fSkin[29]; 
  boundSurf_incr[31] = 19.06233990711463*coeff[1]*fSkin[45]-4.921875*coeff[1]*fSkin[31]; 
  boundSurf_incr[32] = -4.921875*coeff[1]*fSkin[32]; 
  boundSurf_incr[33] = 19.06233990711463*coeff[1]*fSkin[15]-73.828125*coeff[1]*fSkin[33]; 
  boundSurf_incr[34] = -4.921875*coeff[1]*fSkin[34]; 
  boundSurf_incr[35] = -4.921875*coeff[1]*fSkin[35]; 
  boundSurf_incr[36] = 19.06233990711463*coeff[1]*fSkin[16]-73.828125*coeff[1]*fSkin[36]; 
  boundSurf_incr[38] = 19.06233990711463*coeff[1]*fSkin[18]-73.828125*coeff[1]*fSkin[38]; 
  ...
  boundSurf_incr[45] = 19.06233990711463*coeff[1]*fSkin[31]-73.828125*coeff[1]*fSkin[45]; 
  ...
  boundSurf_incr[7] = (-19.06233990711463*coeff[1]*fSkin[22])-4.921875*coeff[1]*fSkin[7]; 
  boundSurf_incr[9] = (-19.06233990711463*coeff[1]*fSkin[26])-4.921875*coeff[1]*fSkin[9]; 
  boundSurf_incr[12] = (-73.828125*coeff[1]*fSkin[12])-19.06233990711463*coeff[1]*fSkin[2]; 
  boundSurf_incr[15] = (-19.06233990711463*coeff[1]*fSkin[33])-4.921875*coeff[1]*fSkin[15]; 
  boundSurf_incr[16] = (-19.06233990711463*coeff[1]*fSkin[36])-4.921875*coeff[1]*fSkin[16]; 
  boundSurf_incr[18] = (-19.06233990711463*coeff[1]*fSkin[38])-4.921875*coeff[1]*fSkin[18]; 
  boundSurf_incr[19] = -4.921875*coeff[1]*fSkin[19]; 
  boundSurf_incr[20] = (-73.828125*coeff[1]*fSkin[20])-19.06233990711463*coeff[1]*fSkin[5]; 
  boundSurf_incr[22] = (-73.828125*coeff[1]*fSkin[22])-19.06233990711463*coeff[1]*fSkin[7]; 
  boundSurf_incr[24] = -4.921875*coeff[1]*fSkin[24]; 
  boundSurf_incr[26] = (-73.828125*coeff[1]*fSkin[26])-19.06233990711463*coeff[1]*fSkin[9]; 
  boundSurf_incr[29] = -4.921875*coeff[1]*fSkin[29]; 
  boundSurf_incr[31] = (-19.06233990711463*coeff[1]*fSkin[45])-4.921875*coeff[1]*fSkin[31]; 
  boundSurf_incr[32] = -4.921875*coeff[1]*fSkin[32]; 
  boundSurf_incr[33] = (-73.828125*coeff[1]*fSkin[33])-19.06233990711463*coeff[1]*fSkin[15]; 
  boundSurf_incr[34] = -4.921875*coeff[1]*fSkin[34]; 
  boundSurf_incr[35] = -4.921875*coeff[1]*fSkin[35]; 
  boundSurf_incr[36] = (-73.828125*coeff[1]*fSkin[36])-19.06233990711463*coeff[1]*fSkin[16]; 
  boundSurf_incr[38] = (-73.828125*coeff[1]*fSkin[38])-19.06233990711463*coeff[1]*fSkin[18]; 
  boundSurf_incr[40] = -4.921875*coeff[1]*fSkin[40]; 
  boundSurf_incr[41] = -4.921875*coeff[1]*fSkin[41]; 
  boundSurf_incr[43] = -4.921875*coeff[1]*fSkin[43]; 
  boundSurf_incr[44] = -4.921875*coeff[1]*fSkin[44]; 
  boundSurf_incr[45] = (-73.828125*coeff[1]*fSkin[45])-19.06233990711463*coeff[1]*fSkin[31]; 
  boundSurf_incr[46] = -4.921875*coeff[1]*fSkin[46]; 
  boundSurf_incr[47] = -4.921875*coeff[1]*fSkin[47]; 
