...
GKYL_CU_DH double dg_diffusion_gyrokinetic_order6_boundary_surfx_2x2v_ser_p2_constcoeff(const double *w, const double *dx, const double *coeff, const double *jacobgeo_inv, int edge, const double *qSkin, const double *qEdge, double* GKYL_RESTRICT out) 
{
  ...
  edgeSurf_incr[5] = (-70.53065765632414*coeff[0]*qSkin[19])+51.4683177492095*coeff[0]*qEdge[19]-61.5234375*coeff[0]*qSkin[5]-56.6015625*coeff[0]*qEdge[5]-34.09975027401226*coeff[0]*qSkin[2]+34.09975027401226*coeff[0]*qEdge[2]; 
  edgeSurf_incr[6] = (-70.53065765632414*coeff[0]*qSkin[21])+51.4683177492095*coeff[0]*qEdge[21]-61.5234375*coeff[0]*qSkin[6]-56.6015625*coeff[0]*qEdge[6]-34.09975027401226*coeff[0]*qSkin[3]+34.09975027401226*coeff[0]*qEdge[3]; 
  ...
  edgeSurf_incr[8] = (-70.53065765632414*coeff[0]*qSkin[25])+51.4683177492095*coeff[0]*qEdge[25]-61.5234375*coeff[0]*qSkin[8]-56.6015625*coeff[0]*qEdge[8]-34.09975027401226*coeff[0]*qSkin[4]+34.09975027401226*coeff[0]*qEdge[4]; 
  ...
  edgeSurf_incr[11] = (-70.6640625*coeff[0]*qSkin[11])-3.1640625*coeff[0]*qEdge[11]-31.316701275974*coeff[0]*qSkin[1]-12.2543613688594*coeff[0]*qEdge[1]-12.57788237343632*coeff[0]*qSkin[0]+12.57788237343632*coeff[0]*qEdge[0]; 
  ...
  edgeSurf_incr[19] = (-70.6640625*coeff[0]*qSkin[19])-3.1640625*coeff[0]*qEdge[19]-31.31670127597403*coeff[0]*qSkin[5]-12.2543613688594*coeff[0]*qEdge[5]-12.57788237343632*coeff[0]*qSkin[2]+12.57788237343632*coeff[0]*qEdge[2]; 
  ...
  edgeSurf_incr[21] = (-70.6640625*coeff[0]*qSkin[21])-3.1640625*coeff[0]*qEdge[21]-31.31670127597403*coeff[0]*qSkin[6]-12.2543613688594*coeff[0]*qEdge[6]-12.57788237343632*coeff[0]*qSkin[3]+12.57788237343632*coeff[0]*qEdge[3]; 
  ...
  edgeSurf_incr[25] = (-70.6640625*coeff[0]*qSkin[25])-3.1640625*coeff[0]*qEdge[25]-31.31670127597403*coeff[0]*qSkin[8]-12.2543613688594*coeff[0]*qEdge[8]-12.57788237343632*coeff[0]*qSkin[4]+12.57788237343632*coeff[0]*qEdge[4]; 
  ...
  edgeSurf_incr[31] = (-70.53065765632414*coeff[0]*qSkin[44])+51.4683177492095*coeff[0]*qEdge[44]-61.5234375*coeff[0]*qSkin[31]-56.6015625*coeff[0]*qEdge[31]-34.09975027401226*coeff[0]*qSkin[18]+34.09975027401226*coeff[0]*qEdge[18]; 
  edgeSurf_incr[32] = (-70.6640625*coeff[0]*qSkin[32])-3.1640625*coeff[0]*qEdge[32]-31.316701275974*coeff[0]*qSkin[15]-12.2543613688594*coeff[0]*qEdge[15]-12.57788237343632*coeff[0]*qSkin[7]+12.57788237343632*coeff[0]*qEdge[7]; 
  ...
  edgeSurf_incr[35] = (-70.6640625*coeff[0]*qSkin[35])-3.1640625*coeff[0]*qEdge[35]-31.316701275974*coeff[0]*qSkin[16]-12.2543613688594*coeff[0]*qEdge[16]-12.57788237343632*coeff[0]*qSkin[9]+12.57788237343632*coeff[0]*qEdge[9]; 
  ...
  edgeSurf_incr[37] = (-70.6640625*coeff[0]*qSkin[37])-3.1640625*coeff[0]*qEdge[37]-31.316701275974*coeff[0]*qSkin[17]-12.2543613688594*coeff[0]*qEdge[17]-12.57788237343632*coeff[0]*qSkin[10]+12.57788237343632*coeff[0]*qEdge[10]; 
  ...
  edgeSurf_incr[44] = (-70.6640625*coeff[0]*qSkin[44])-3.1640625*coeff[0]*qEdge[44]-31.31670127597403*coeff[0]*qSkin[31]-12.2543613688594*coeff[0]*qEdge[31]-12.57788237343632*coeff[0]*qSkin[18]+12.57788237343632*coeff[0]*qEdge[18]; 
  ...
  boundSurf_incr[1] = 19.06233990711463*coeff[0]*qSkin[11]-4.921875*coeff[0]*qSkin[1]; 
  boundSurf_incr[5] = 19.06233990711463*coeff[0]*qSkin[19]-4.921875*coeff[0]*qSkin[5]; 
  boundSurf_incr[6] = 19.06233990711463*coeff[0]*qSkin[21]-4.921875*coeff[0]*qSkin[6]; 
  boundSurf_incr[8] = 19.06233990711463*coeff[0]*qSkin[25]-4.921875*coeff[0]*qSkin[8]; 
  boundSurf_incr[11] = 19.06233990711463*coeff[0]*qSkin[1]-73.828125*coeff[0]*qSkin[11]; 
  boundSurf_incr[15] = 19.06233990711463*coeff[0]*qSkin[32]-4.921875*coeff[0]*qSkin[15]; 
  boundSurf_incr[16] = 19.06233990711463*coeff[0]*qSkin[35]-4.921875*coeff[0]*qSkin[16]; 
  boundSurf_incr[17] = 19.06233990711463*coeff[0]*qSkin[37]-4.921875*coeff[0]*qSkin[17]; 
  boundSurf_incr[19] = 19.06233990711463*coeff[0]*qSkin[5]-73.828125*coeff[0]*qSkin[19]; 
  boundSurf_incr[20] = -4.921875*coeff[0]*qSkin[20]; 
  boundSurf_incr[21] = 19.06233990711463*coeff[0]*qSkin[6]-73.828125*coeff[0]*qSkin[21]; 
  boundSurf_incr[23] = -4.921875*coeff[0]*qSkin[23]; 
  boundSurf_incr[25] = 19.06233990711463*coeff[0]*qSkin[8]-73.828125*coeff[0]*qSkin[25]; 
  boundSurf_incr[28] = -4.921875*coeff[0]*qSkin[28]; 
  boundSurf_incr[31] = 19.06233990711463*coeff[0]*qSkin[44]-4.921875*coeff[0]*qSkin[31]; 
  boundSurf_incr[32] = 19.06233990711463*coeff[0]*qSkin[15]-73.828125*coeff[0]*qSkin[32]; 
  boundSurf_incr[33] = -4.921875*coeff[0]*qSkin[33]; 
  boundSurf_incr[34] = -4.921875*coeff[0]*qSkin[34]; 
  boundSurf_incr[35] = 19.06233990711463*coeff[0]*qSkin[16]-73.828125*coeff[0]*qSkin[35]; 
  boundSurf_incr[36] = -4.921875*coeff[0]*qSkin[36]; 
  boundSurf_incr[37] = 19.06233990711463*coeff[0]*qSkin[17]-73.828125*coeff[0]*qSkin[37]; 
  ...
  boundSurf_incr[44] = 19.06233990711463*coeff[0]*qSkin[31]-73.828125*coeff[0]*qSkin[44]; 
  ...
  boundSurf_incr[6] = (-19.06233990711463*coeff[0]*qSkin[21])-4.921875*coeff[0]*qSkin[6]; 
  boundSurf_incr[8] = (-19.06233990711463*coeff[0]*qSkin[25])-4.921875*coeff[0]*qSkin[8]; 
  boundSurf_incr[11] = (-73.828125*coeff[0]*qSkin[11])-19.06233990711463*coeff[0]*qSkin[1]; 
  boundSurf_incr[15] = (-19.06233990711463*coeff[0]*qSkin[32])-4.921875*coeff[0]*qSkin[15]; 
  boundSurf_incr[16] = (-19.06233990711463*coeff[0]*qSkin[35])-4.921875*coeff[0]*qSkin[16]; 
  boundSurf_incr[17] = (-19.06233990711463*coeff[0]*qSkin[37])-4.921875*coeff[0]*qSkin[17]; 
  boundSurf_incr[19] = (-73.828125*coeff[0]*qSkin[19])-19.06233990711463*coeff[0]*qSkin[5]; 
  boundSurf_incr[20] = -4.921875*coeff[0]*qSkin[20]; 
  boundSurf_incr[21] = (-73.828125*coeff[0]*qSkin[21])-19.06233990711463*coeff[0]*qSkin[6]; 
  boundSurf_incr[23] = -4.921875*coeff[0]*qSkin[23]; 
  boundSurf_incr[25] = (-73.828125*coeff[0]*qSkin[25])-19.06233990711463*coeff[0]*qSkin[8]; 
  boundSurf_incr[28] = -4.921875*coeff[0]*qSkin[28]; 
  boundSurf_incr[31] = (-19.06233990711463*coeff[0]*qSkin[44])-4.921875*coeff[0]*qSkin[31]; 
  boundSurf_incr[32] = (-73.828125*coeff[0]*qSkin[32])-19.06233990711463*coeff[0]*qSkin[15]; 
  boundSurf_incr[33] = -4.921875*coeff[0]*qSkin[33]; 
  boundSurf_incr[34] = -4.921875*coeff[0]*qSkin[34]; 
  boundSurf_incr[35] = (-73.828125*coeff[0]*qSkin[35])-19.06233990711463*coeff[0]*qSkin[16]; 
  boundSurf_incr[36] = -4.921875*coeff[0]*qSkin[36]; 
  boundSurf_incr[37] = (-73.828125*coeff[0]*qSkin[37])-19.06233990711463*coeff[0]*qSkin[17]; 
  boundSurf_incr[39] = -4.921875*coeff[0]*qSkin[39]; 
  boundSurf_incr[41] = -4.921875*coeff[0]*qSkin[41]; 
  boundSurf_incr[42] = -4.921875*coeff[0]*qSkin[42]; 
  boundSurf_incr[44] = (-73.828125*coeff[0]*qSkin[44])-19.06233990711463*coeff[0]*qSkin[31]; 
  boundSurf_incr[45] = -4.921875*coeff[0]*qSkin[45]; 
  boundSurf_incr[46] = -4.921875*coeff[0]*qSkin[46]; 
  boundSurf_incr[47] = -4.921875*coeff[0]*qSkin[47]; 
