...
GKYL_CU_DH double dg_diffusion_gyrokinetic_order2_surfx_2x2v_ser_p1_constcoeff(const double *w, const double *dx, const double *coeff, const double *jacobgeo_inv, const double *ql, const double *qc, const double *qr, double* GKYL_RESTRICT out) 
{
  ...
  out[0] += -0.0625*(8.660254037844386*coeff[0]*fr[1]-8.660254037844386*coeff[0]*fl[1]-9.0*coeff[0]*fr[0]-9.0*coeff[0]*fl[0]+18.0*coeff[0]*fc[0])*rdx2Sq; 
  out[1] += -0.0625*(7.0*coeff[0]*fr[1]+7.0*coeff[0]*fl[1]+46.0*coeff[0]*fc[1]-8.660254037844386*coeff[0]*fr[0]+8.660254037844386*coeff[0]*fl[0])*rdx2Sq; 
  out[2] += -0.0625*(8.660254037844386*coeff[0]*fr[5]-8.660254037844386*coeff[0]*fl[5]-9.0*coeff[0]*fr[2]-9.0*coeff[0]*fl[2]+18.0*coeff[0]*fc[2])*rdx2Sq; 
  out[3] += -0.0625*(8.660254037844386*coeff[0]*fr[6]-8.660254037844386*coeff[0]*fl[6]-9.0*coeff[0]*fr[3]-9.0*coeff[0]*fl[3]+18.0*coeff[0]*fc[3])*rdx2Sq; 
  out[4] += -0.0625*(8.660254037844386*coeff[0]*fr[8]-8.660254037844386*coeff[0]*fl[8]-9.0*coeff[0]*fr[4]-9.0*coeff[0]*fl[4]+18.0*coeff[0]*fc[4])*rdx2Sq; 
  out[5] += -0.0625*(7.0*coeff[0]*fr[5]+7.0*coeff[0]*fl[5]+46.0*coeff[0]*fc[5]-8.660254037844386*coeff[0]*fr[2]+8.660254037844386*coeff[0]*fl[2])*rdx2Sq; 
  out[6] += -0.0625*(7.0*coeff[0]*fr[6]+7.0*coeff[0]*fl[6]+46.0*coeff[0]*fc[6]-8.660254037844386*coeff[0]*fr[3]+8.660254037844386*coeff[0]*fl[3])*rdx2Sq; 
  out[7] += -0.0625*(8.660254037844386*coeff[0]*fr[11]-8.660254037844386*coeff[0]*fl[11]-9.0*coeff[0]*fr[7]-9.0*coeff[0]*fl[7]+18.0*coeff[0]*fc[7])*rdx2Sq; 
  out[8] += -0.0625*(7.0*coeff[0]*fr[8]+7.0*coeff[0]*fl[8]+46.0*coeff[0]*fc[8]-8.660254037844386*coeff[0]*fr[4]+8.660254037844386*coeff[0]*fl[4])*rdx2Sq; 
  out[9] += -0.0625*(8.660254037844386*coeff[0]*fr[12]-8.660254037844386*coeff[0]*fl[12]-9.0*coeff[0]*fr[9]-9.0*coeff[0]*fl[9]+18.0*coeff[0]*fc[9])*rdx2Sq; 
  out[10] += -0.0625*(8.660254037844386*coeff[0]*fr[13]-8.660254037844386*coeff[0]*fl[13]-9.0*coeff[0]*fr[10]-9.0*coeff[0]*fl[10]+18.0*coeff[0]*fc[10])*rdx2Sq; 
  out[11] += -0.0625*(7.0*coeff[0]*fr[11]+7.0*coeff[0]*fl[11]+46.0*coeff[0]*fc[11]-8.660254037844386*coeff[0]*fr[7]+8.660254037844386*coeff[0]*fl[7])*rdx2Sq; 
  out[12] += -0.0625*(7.0*coeff[0]*fr[12]+7.0*coeff[0]*fl[12]+46.0*coeff[0]*fc[12]-8.660254037844386*coeff[0]*fr[9]+8.660254037844386*coeff[0]*fl[9])*rdx2Sq; 
  out[13] += -0.0625*(7.0*coeff[0]*fr[13]+7.0*coeff[0]*fl[13]+46.0*coeff[0]*fc[13]-8.660254037844386*coeff[0]*fr[10]+8.660254037844386*coeff[0]*fl[10])*rdx2Sq; 
  out[14] += -0.0625*(8.660254037844386*coeff[0]*fr[15]-8.660254037844386*coeff[0]*fl[15]-9.0*coeff[0]*fr[14]-9.0*coeff[0]*fl[14]+18.0*coeff[0]*fc[14])*rdx2Sq; 
  out[15] += -0.0625*(7.0*coeff[0]*fr[15]+7.0*coeff[0]*fl[15]+46.0*coeff[0]*fc[15]-8.660254037844386*coeff[0]*fr[14]+8.660254037844386*coeff[0]*fl[14])*rdx2Sq; 
  out[16] += -0.0625*(8.660254037844387*coeff[0]*fr[17]-8.660254037844387*coeff[0]*fl[17]-9.0*coeff[0]*fr[16]-9.0*coeff[0]*fl[16]+18.0*coeff[0]*fc[16])*rdx2Sq; 
  out[17] += -0.0625*(7.0*coeff[0]*fr[17]+7.0*coeff[0]*fl[17]+46.0*coeff[0]*fc[17]-8.660254037844387*coeff[0]*fr[16]+8.660254037844387*coeff[0]*fl[16])*rdx2Sq; 
  out[18] += -0.0625*(8.660254037844387*coeff[0]*fr[20]-8.660254037844387*coeff[0]*fl[20]-9.0*coeff[0]*fr[18]-9.0*coeff[0]*fl[18]+18.0*coeff[0]*fc[18])*rdx2Sq; 
  out[19] += -0.0625*(8.660254037844387*coeff[0]*fr[21]-8.660254037844387*coeff[0]*fl[21]-9.0*coeff[0]*fr[19]-9.0*coeff[0]*fl[19]+18.0*coeff[0]*fc[19])*rdx2Sq; 
  out[20] += -0.0625*(7.0*coeff[0]*fr[20]+7.0*coeff[0]*fl[20]+46.0*coeff[0]*fc[20]-8.660254037844387*coeff[0]*fr[18]+8.660254037844387*coeff[0]*fl[18])*rdx2Sq; 
  out[21] += -0.0625*(7.0*coeff[0]*fr[21]+7.0*coeff[0]*fl[21]+46.0*coeff[0]*fc[21]-8.660254037844387*coeff[0]*fr[19]+8.660254037844387*coeff[0]*fl[19])*rdx2Sq; 
  out[22] += -0.0625*(8.660254037844387*coeff[0]*fr[23]-8.660254037844387*coeff[0]*fl[23]-9.0*coeff[0]*fr[22]-9.0*coeff[0]*fl[22]+18.0*coeff[0]*fc[22])*rdx2Sq; 
  out[23] += -0.0625*(7.0*coeff[0]*fr[23]+7.0*coeff[0]*fl[23]+46.0*coeff[0]*fc[23]-8.660254037844387*coeff[0]*fr[22]+8.660254037844387*coeff[0]*fl[22])*rdx2Sq; 
