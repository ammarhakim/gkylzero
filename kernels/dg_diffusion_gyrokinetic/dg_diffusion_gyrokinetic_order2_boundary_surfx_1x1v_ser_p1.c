...
GKYL_CU_DH double dg_diffusion_gyrokinetic_order2_boundary_surfx_1x1v_ser_p1_constcoeff(const double *w, const double *dx, const double *coeff, const double *jacobgeo_inv, int edge, const double *qSkin, const double *qEdge, double* GKYL_RESTRICT out) 
{
  ...
  edgeSurf_incr[3] = (-1.4375*coeff[0]*qSkin[3])-0.4375*coeff[0]*qEdge[3]-1.407291281149712*coeff[0]*qSkin[2]+0.5412658773652739*coeff[0]*qEdge[2]; 
  ...
  edgeSurf_incr[5] = (-1.4375*coeff[0]*qSkin[5])-0.4375*coeff[0]*qEdge[5]-1.407291281149713*coeff[0]*qSkin[4]+0.5412658773652742*coeff[0]*qEdge[4]; 
