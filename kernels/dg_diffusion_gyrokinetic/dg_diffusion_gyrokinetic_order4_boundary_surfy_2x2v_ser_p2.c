...
GKYL_CU_DH double dg_diffusion_gyrokinetic_order4_boundary_surfy_2x2v_ser_p2_constcoeff(const double *w, const double *dx, const double *coeff, const double *jacobgeo_inv, int edge, const double *qSkin, const double *qEdge, double* GKYL_RESTRICT out) 
{
  ...
  edgeSurf_incr[1] = 6.708203932499369*coeff[1]*qSkin[20]-6.708203932499369*coeff[1]*qEdge[20]+8.11898816047911*coeff[1]*qSkin[5]+8.11898816047911*coeff[1]*qEdge[5]+4.6875*coeff[1]*qSkin[1]-4.6875*coeff[1]*qEdge[1]; 
  edgeSurf_incr[2] = 14.16059535957086*coeff[1]*qSkin[12]-9.077304717673634*coeff[1]*qEdge[12]+15.46875*coeff[1]*qSkin[2]+12.65625*coeff[1]*qEdge[2]+8.11898816047911*qSkin[0]*coeff[1]-8.11898816047911*qEdge[0]*coeff[1]; 
  edgeSurf_incr[3] = 6.708203932499369*coeff[1]*qSkin[22]-6.708203932499369*coeff[1]*qEdge[22]+8.11898816047911*coeff[1]*qSkin[7]+8.11898816047911*coeff[1]*qEdge[7]+4.6875*coeff[1]*qSkin[3]-4.6875*coeff[1]*qEdge[3]; 
  edgeSurf_incr[4] = 6.708203932499369*coeff[1]*qSkin[26]-6.708203932499369*coeff[1]*qEdge[26]+8.11898816047911*coeff[1]*qSkin[9]+8.11898816047911*coeff[1]*qEdge[9]+4.6875*coeff[1]*qSkin[4]-4.6875*coeff[1]*qEdge[4]; 
  edgeSurf_incr[5] = 14.16059535957087*coeff[1]*qSkin[20]-9.077304717673634*coeff[1]*qEdge[20]+15.46875*coeff[1]*qSkin[5]+12.65625*coeff[1]*qEdge[5]+8.11898816047911*coeff[1]*qSkin[1]-8.11898816047911*coeff[1]*qEdge[1]; 
  ...
  edgeSurf_incr[7] = 14.16059535957087*coeff[1]*qSkin[22]-9.077304717673634*coeff[1]*qEdge[22]+15.46875*coeff[1]*qSkin[7]+12.65625*coeff[1]*qEdge[7]+8.11898816047911*coeff[1]*qSkin[3]-8.11898816047911*coeff[1]*qEdge[3]; 
  ...
  edgeSurf_incr[9] = 14.16059535957087*coeff[1]*qSkin[26]-9.077304717673634*coeff[1]*qEdge[26]+15.46875*coeff[1]*qSkin[9]+12.65625*coeff[1]*qEdge[9]+8.11898816047911*coeff[1]*qSkin[4]-8.11898816047911*coeff[1]*qEdge[4]; 
  ...
  edgeSurf_incr[15] = 14.16059535957086*coeff[1]*qSkin[33]-9.077304717673634*coeff[1]*qEdge[33]+15.46875*coeff[1]*qSkin[15]+12.65625*coeff[1]*qEdge[15]+8.11898816047911*coeff[1]*qSkin[6]-8.11898816047911*coeff[1]*qEdge[6]; 
  edgeSurf_incr[16] = 14.16059535957086*coeff[1]*qSkin[36]-9.077304717673634*coeff[1]*qEdge[36]+15.46875*coeff[1]*qSkin[16]+12.65625*coeff[1]*qEdge[16]+8.11898816047911*coeff[1]*qSkin[8]-8.11898816047911*coeff[1]*qEdge[8]; 
  edgeSurf_incr[17] = 6.708203932499369*coeff[1]*qSkin[45]-6.708203932499369*coeff[1]*qEdge[45]+8.11898816047911*coeff[1]*qSkin[31]+8.11898816047911*coeff[1]*qEdge[31]+4.6875*coeff[1]*qSkin[17]-4.6875*coeff[1]*qEdge[17]; 
  edgeSurf_incr[18] = 14.16059535957086*coeff[1]*qSkin[38]-9.077304717673634*coeff[1]*qEdge[38]+15.46875*coeff[1]*qSkin[18]+12.65625*coeff[1]*qEdge[18]+8.11898816047911*coeff[1]*qSkin[10]-8.11898816047911*coeff[1]*qEdge[10]; 
  ...
  edgeSurf_incr[20] = 20.34375*coeff[1]*qSkin[20]-0.65625*coeff[1]*qEdge[20]+15.61296411439865*coeff[1]*qSkin[5]+4.72019845319029*coeff[1]*qEdge[5]+4.192627457812107*coeff[1]*qSkin[1]-4.192627457812107*coeff[1]*qEdge[1]; 
  ...
  edgeSurf_incr[22] = 20.34375*coeff[1]*qSkin[22]-0.65625*coeff[1]*qEdge[22]+15.61296411439865*coeff[1]*qSkin[7]+4.72019845319029*coeff[1]*qEdge[7]+4.192627457812107*coeff[1]*qSkin[3]-4.192627457812107*coeff[1]*qEdge[3]; 
  ...
  edgeSurf_incr[26] = 20.34375*coeff[1]*qSkin[26]-0.65625*coeff[1]*qEdge[26]+15.61296411439865*coeff[1]*qSkin[9]+4.72019845319029*coeff[1]*qEdge[9]+4.192627457812107*coeff[1]*qSkin[4]-4.192627457812107*coeff[1]*qEdge[4]; 
  ...
  edgeSurf_incr[31] = 14.16059535957087*coeff[1]*qSkin[45]-9.077304717673634*coeff[1]*qEdge[45]+15.46875*coeff[1]*qSkin[31]+12.65625*coeff[1]*qEdge[31]+8.11898816047911*coeff[1]*qSkin[17]-8.11898816047911*coeff[1]*qEdge[17]; 
  ...
  edgeSurf_incr[45] = 20.34375*coeff[1]*qSkin[45]-0.65625*coeff[1]*qEdge[45]+15.61296411439865*coeff[1]*qSkin[31]+4.72019845319029*coeff[1]*qEdge[31]+4.192627457812107*coeff[1]*qSkin[17]-4.192627457812107*coeff[1]*qEdge[17]; 
  ...
  boundSurf_incr[12] = 19.6875*coeff[1]*qSkin[12]-10.89276566120836*coeff[1]*qSkin[2]; 
  ...
  boundSurf_incr[20] = 19.6875*coeff[1]*qSkin[20]-10.89276566120836*coeff[1]*qSkin[5]; 
  boundSurf_incr[22] = 19.6875*coeff[1]*qSkin[22]-10.89276566120836*coeff[1]*qSkin[7]; 
  boundSurf_incr[24] = 2.8125*coeff[1]*qSkin[24]; 
  boundSurf_incr[26] = 19.6875*coeff[1]*qSkin[26]-10.89276566120836*coeff[1]*qSkin[9]; 
  ...
  boundSurf_incr[33] = 19.6875*coeff[1]*qSkin[33]-10.89276566120836*coeff[1]*qSkin[15]; 
  boundSurf_incr[34] = 2.8125*coeff[1]*qSkin[34]; 
  boundSurf_incr[35] = 2.8125*coeff[1]*qSkin[35]; 
  boundSurf_incr[36] = 19.6875*coeff[1]*qSkin[36]-10.89276566120836*coeff[1]*qSkin[16]; 
  boundSurf_incr[38] = 19.6875*coeff[1]*qSkin[38]-10.89276566120836*coeff[1]*qSkin[18]; 
  ...
  boundSurf_incr[45] = 19.6875*coeff[1]*qSkin[45]-10.89276566120836*coeff[1]*qSkin[31]; 
