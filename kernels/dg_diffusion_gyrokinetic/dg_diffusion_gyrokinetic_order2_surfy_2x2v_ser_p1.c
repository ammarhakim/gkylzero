...
GKYL_CU_DH double dg_diffusion_gyrokinetic_order2_surfy_2x2v_ser_p1_constcoeff(const double *w, const double *dx, const double *coeff, const double *jacobgeo_inv, const double *ql, const double *qc, const double *qr, double* GKYL_RESTRICT out) 
{
  ...
  out[0] += -0.0625*(8.660254037844386*coeff[1]*fr[2]-8.660254037844386*coeff[1]*fl[2]+((-9.0*fr[0])-9.0*fl[0]+18.0*fc[0])*coeff[1])*rdx2Sq; 
  out[1] += -0.0625*(8.660254037844386*coeff[1]*fr[5]-8.660254037844386*coeff[1]*fl[5]-9.0*coeff[1]*fr[1]-9.0*coeff[1]*fl[1]+18.0*coeff[1]*fc[1])*rdx2Sq; 
  out[2] += -0.0625*(7.0*coeff[1]*fr[2]+7.0*coeff[1]*fl[2]+46.0*coeff[1]*fc[2]+(8.660254037844386*fl[0]-8.660254037844386*fr[0])*coeff[1])*rdx2Sq; 
  out[3] += -0.0625*(8.660254037844386*coeff[1]*fr[7]-8.660254037844386*coeff[1]*fl[7]-9.0*coeff[1]*fr[3]-9.0*coeff[1]*fl[3]+18.0*coeff[1]*fc[3])*rdx2Sq; 
  out[4] += -0.0625*(8.660254037844386*coeff[1]*fr[9]-8.660254037844386*coeff[1]*fl[9]-9.0*coeff[1]*fr[4]-9.0*coeff[1]*fl[4]+18.0*coeff[1]*fc[4])*rdx2Sq; 
  out[5] += -0.0625*(7.0*coeff[1]*fr[5]+7.0*coeff[1]*fl[5]+46.0*coeff[1]*fc[5]-8.660254037844386*coeff[1]*fr[1]+8.660254037844386*coeff[1]*fl[1])*rdx2Sq; 
  out[6] += -0.0625*(8.660254037844386*coeff[1]*fr[11]-8.660254037844386*coeff[1]*fl[11]-9.0*coeff[1]*fr[6]-9.0*coeff[1]*fl[6]+18.0*coeff[1]*fc[6])*rdx2Sq; 
  out[7] += -0.0625*(7.0*coeff[1]*fr[7]+7.0*coeff[1]*fl[7]+46.0*coeff[1]*fc[7]-8.660254037844386*coeff[1]*fr[3]+8.660254037844386*coeff[1]*fl[3])*rdx2Sq; 
  out[8] += -0.0625*(8.660254037844386*coeff[1]*fr[12]-8.660254037844386*coeff[1]*fl[12]-9.0*coeff[1]*fr[8]-9.0*coeff[1]*fl[8]+18.0*coeff[1]*fc[8])*rdx2Sq; 
  out[9] += -0.0625*(7.0*coeff[1]*fr[9]+7.0*coeff[1]*fl[9]+46.0*coeff[1]*fc[9]-8.660254037844386*coeff[1]*fr[4]+8.660254037844386*coeff[1]*fl[4])*rdx2Sq; 
  out[10] += -0.0625*(8.660254037844386*coeff[1]*fr[14]-8.660254037844386*coeff[1]*fl[14]-9.0*coeff[1]*fr[10]-9.0*coeff[1]*fl[10]+18.0*coeff[1]*fc[10])*rdx2Sq; 
  out[11] += -0.0625*(7.0*coeff[1]*fr[11]+7.0*coeff[1]*fl[11]+46.0*coeff[1]*fc[11]-8.660254037844386*coeff[1]*fr[6]+8.660254037844386*coeff[1]*fl[6])*rdx2Sq; 
  out[12] += -0.0625*(7.0*coeff[1]*fr[12]+7.0*coeff[1]*fl[12]+46.0*coeff[1]*fc[12]-8.660254037844386*coeff[1]*fr[8]+8.660254037844386*coeff[1]*fl[8])*rdx2Sq; 
  out[13] += -0.0625*(8.660254037844386*coeff[1]*fr[15]-8.660254037844386*coeff[1]*fl[15]-9.0*coeff[1]*fr[13]-9.0*coeff[1]*fl[13]+18.0*coeff[1]*fc[13])*rdx2Sq; 
  out[14] += -0.0625*(7.0*coeff[1]*fr[14]+7.0*coeff[1]*fl[14]+46.0*coeff[1]*fc[14]-8.660254037844386*coeff[1]*fr[10]+8.660254037844386*coeff[1]*fl[10])*rdx2Sq; 
  out[15] += -0.0625*(7.0*coeff[1]*fr[15]+7.0*coeff[1]*fl[15]+46.0*coeff[1]*fc[15]-8.660254037844386*coeff[1]*fr[13]+8.660254037844386*coeff[1]*fl[13])*rdx2Sq; 
  out[16] += -0.0625*(8.660254037844387*coeff[1]*fr[18]-8.660254037844387*coeff[1]*fl[18]-9.0*coeff[1]*fr[16]-9.0*coeff[1]*fl[16]+18.0*coeff[1]*fc[16])*rdx2Sq; 
  out[17] += -0.0625*(8.660254037844387*coeff[1]*fr[20]-8.660254037844387*coeff[1]*fl[20]-9.0*coeff[1]*fr[17]-9.0*coeff[1]*fl[17]+18.0*coeff[1]*fc[17])*rdx2Sq; 
  out[18] += -0.0625*(7.0*coeff[1]*fr[18]+7.0*coeff[1]*fl[18]+46.0*coeff[1]*fc[18]-8.660254037844387*coeff[1]*fr[16]+8.660254037844387*coeff[1]*fl[16])*rdx2Sq; 
  out[19] += -0.0625*(8.660254037844387*coeff[1]*fr[22]-8.660254037844387*coeff[1]*fl[22]-9.0*coeff[1]*fr[19]-9.0*coeff[1]*fl[19]+18.0*coeff[1]*fc[19])*rdx2Sq; 
  out[20] += -0.0625*(7.0*coeff[1]*fr[20]+7.0*coeff[1]*fl[20]+46.0*coeff[1]*fc[20]-8.660254037844387*coeff[1]*fr[17]+8.660254037844387*coeff[1]*fl[17])*rdx2Sq; 
  out[21] += -0.0625*(8.660254037844387*coeff[1]*fr[23]-8.660254037844387*coeff[1]*fl[23]-9.0*coeff[1]*fr[21]-9.0*coeff[1]*fl[21]+18.0*coeff[1]*fc[21])*rdx2Sq; 
  out[22] += -0.0625*(7.0*coeff[1]*fr[22]+7.0*coeff[1]*fl[22]+46.0*coeff[1]*fc[22]-8.660254037844387*coeff[1]*fr[19]+8.660254037844387*coeff[1]*fl[19])*rdx2Sq; 
  out[23] += -0.0625*(7.0*coeff[1]*fr[23]+7.0*coeff[1]*fl[23]+46.0*coeff[1]*fc[23]-8.660254037844387*coeff[1]*fr[21]+8.660254037844387*coeff[1]*fl[21])*rdx2Sq; 
