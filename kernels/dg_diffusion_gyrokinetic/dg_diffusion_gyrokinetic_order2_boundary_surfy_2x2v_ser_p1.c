...
GKYL_CU_DH double dg_diffusion_gyrokinetic_order2_boundary_surfy_2x2v_ser_p1_constcoeff(const double *w, const double *dx, const double *coeff, const double *jacobgeo_inv, int edge, const double *qSkin, const double *qEdge, double* GKYL_RESTRICT out) 
{
  ...
  edgeSurf_incr[2] = (-1.4375*coeff[1]*qSkin[2])-0.4375*coeff[1]*qEdge[2]-1.407291281149712*qSkin[0]*coeff[1]+0.5412658773652739*qEdge[0]*coeff[1]; 
  ...
  edgeSurf_incr[5] = (-1.4375*coeff[1]*qSkin[5])-0.4375*coeff[1]*qEdge[5]-1.407291281149712*coeff[1]*qSkin[1]+0.5412658773652739*coeff[1]*qEdge[1]; 
  ...
  edgeSurf_incr[7] = (-1.4375*coeff[1]*qSkin[7])-0.4375*coeff[1]*qEdge[7]-1.407291281149712*coeff[1]*qSkin[3]+0.5412658773652739*coeff[1]*qEdge[3]; 
  ...
  edgeSurf_incr[9] = (-1.4375*coeff[1]*qSkin[9])-0.4375*coeff[1]*qEdge[9]-1.407291281149712*coeff[1]*qSkin[4]+0.5412658773652739*coeff[1]*qEdge[4]; 
  ...
  edgeSurf_incr[11] = (-1.4375*coeff[1]*qSkin[11])-0.4375*coeff[1]*qEdge[11]-1.407291281149712*coeff[1]*qSkin[6]+0.5412658773652739*coeff[1]*qEdge[6]; 
  edgeSurf_incr[12] = (-1.4375*coeff[1]*qSkin[12])-0.4375*coeff[1]*qEdge[12]-1.407291281149712*coeff[1]*qSkin[8]+0.5412658773652739*coeff[1]*qEdge[8]; 
  ...
  edgeSurf_incr[14] = (-1.4375*coeff[1]*qSkin[14])-0.4375*coeff[1]*qEdge[14]-1.407291281149712*coeff[1]*qSkin[10]+0.5412658773652739*coeff[1]*qEdge[10]; 
  edgeSurf_incr[15] = (-1.4375*coeff[1]*qSkin[15])-0.4375*coeff[1]*qEdge[15]-1.407291281149712*coeff[1]*qSkin[13]+0.5412658773652739*coeff[1]*qEdge[13]; 
  ...
  edgeSurf_incr[18] = (-1.4375*coeff[1]*qSkin[18])-0.4375*coeff[1]*qEdge[18]-1.407291281149713*coeff[1]*qSkin[16]+0.5412658773652742*coeff[1]*qEdge[16]; 
  ...
  edgeSurf_incr[20] = (-1.4375*coeff[1]*qSkin[20])-0.4375*coeff[1]*qEdge[20]-1.407291281149713*coeff[1]*qSkin[17]+0.5412658773652742*coeff[1]*qEdge[17]; 
  ...
  edgeSurf_incr[22] = (-1.4375*coeff[1]*qSkin[22])-0.4375*coeff[1]*qEdge[22]-1.407291281149713*coeff[1]*qSkin[19]+0.5412658773652742*coeff[1]*qEdge[19]; 
  edgeSurf_incr[23] = (-1.4375*coeff[1]*qSkin[23])-0.4375*coeff[1]*qEdge[23]-1.407291281149713*coeff[1]*qSkin[21]+0.5412658773652742*coeff[1]*qEdge[21]; 
