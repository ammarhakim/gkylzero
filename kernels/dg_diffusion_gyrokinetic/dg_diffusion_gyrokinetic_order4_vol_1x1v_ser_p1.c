...
GKYL_CU_DH double dg_diffusion_gyrokinetic_order4_vol_1x1v_ser_p1_constcoeff_diffx(const double *w, const double *dx, const double *coeff, const double *jacobgeo_inv, const double *q, double* GKYL_RESTRICT out) 
{
...
{ 
  ...
  cflFreq += dg_diffusion_gyrokinetic_order4_vol_1x1v_ser_p1_constcoeff_diffx(w, dx, coeff, jacobgeo_inv, q, out);
