...
GKYL_CU_DH double dg_diffusion_gyrokinetic_order4_surfy_2x2v_ser_p1_constcoeff(const double *w, const double *dx, const double *coeff, const double *jacobgeo_inv, const double *ql, const double *qc, const double *qr, double* GKYL_RESTRICT out) 
{
  ...
  out[1] += -0.0625*(25.98076211353316*coeff[1]*fr[5]-25.98076211353316*coeff[1]*fl[5]-15.0*coeff[1]*fr[1]-15.0*coeff[1]*fl[1]+30.0*coeff[1]*fc[1])*rdx2Sq; 
  ...
  out[3] += -0.0625*(25.98076211353316*coeff[1]*fr[7]-25.98076211353316*coeff[1]*fl[7]-15.0*coeff[1]*fr[3]-15.0*coeff[1]*fl[3]+30.0*coeff[1]*fc[3])*rdx2Sq; 
  out[4] += -0.0625*(25.98076211353316*coeff[1]*fr[9]-25.98076211353316*coeff[1]*fl[9]-15.0*coeff[1]*fr[4]-15.0*coeff[1]*fl[4]+30.0*coeff[1]*fc[4])*rdx2Sq; 
  out[5] += -0.0625*(33.0*coeff[1]*fr[5]+33.0*coeff[1]*fl[5]+114.0*coeff[1]*fc[5]-25.98076211353316*coeff[1]*fr[1]+25.98076211353316*coeff[1]*fl[1])*rdx2Sq; 
  out[6] += -0.0625*(25.98076211353316*coeff[1]*fr[11]-25.98076211353316*coeff[1]*fl[11]-15.0*coeff[1]*fr[6]-15.0*coeff[1]*fl[6]+30.0*coeff[1]*fc[6])*rdx2Sq; 
  out[7] += -0.0625*(33.0*coeff[1]*fr[7]+33.0*coeff[1]*fl[7]+114.0*coeff[1]*fc[7]-25.98076211353316*coeff[1]*fr[3]+25.98076211353316*coeff[1]*fl[3])*rdx2Sq; 
  out[8] += -0.0625*(25.98076211353316*coeff[1]*fr[12]-25.98076211353316*coeff[1]*fl[12]-15.0*coeff[1]*fr[8]-15.0*coeff[1]*fl[8]+30.0*coeff[1]*fc[8])*rdx2Sq; 
  out[9] += -0.0625*(33.0*coeff[1]*fr[9]+33.0*coeff[1]*fl[9]+114.0*coeff[1]*fc[9]-25.98076211353316*coeff[1]*fr[4]+25.98076211353316*coeff[1]*fl[4])*rdx2Sq; 
  out[10] += -0.0625*(25.98076211353316*coeff[1]*fr[14]-25.98076211353316*coeff[1]*fl[14]-15.0*coeff[1]*fr[10]-15.0*coeff[1]*fl[10]+30.0*coeff[1]*fc[10])*rdx2Sq; 
  out[11] += -0.0625*(33.0*coeff[1]*fr[11]+33.0*coeff[1]*fl[11]+114.0*coeff[1]*fc[11]-25.98076211353316*coeff[1]*fr[6]+25.98076211353316*coeff[1]*fl[6])*rdx2Sq; 
  out[12] += -0.0625*(33.0*coeff[1]*fr[12]+33.0*coeff[1]*fl[12]+114.0*coeff[1]*fc[12]-25.98076211353316*coeff[1]*fr[8]+25.98076211353316*coeff[1]*fl[8])*rdx2Sq; 
  out[13] += -0.0625*(25.98076211353316*coeff[1]*fr[15]-25.98076211353316*coeff[1]*fl[15]-15.0*coeff[1]*fr[13]-15.0*coeff[1]*fl[13]+30.0*coeff[1]*fc[13])*rdx2Sq; 
  out[14] += -0.0625*(33.0*coeff[1]*fr[14]+33.0*coeff[1]*fl[14]+114.0*coeff[1]*fc[14]-25.98076211353316*coeff[1]*fr[10]+25.98076211353316*coeff[1]*fl[10])*rdx2Sq; 
  out[15] += -0.0625*(33.0*coeff[1]*fr[15]+33.0*coeff[1]*fl[15]+114.0*coeff[1]*fc[15]-25.98076211353316*coeff[1]*fr[13]+25.98076211353316*coeff[1]*fl[13])*rdx2Sq; 
  out[16] += -0.0625*(25.98076211353316*coeff[1]*fr[18]-25.98076211353316*coeff[1]*fl[18]-15.0*coeff[1]*fr[16]-15.0*coeff[1]*fl[16]+30.0*coeff[1]*fc[16])*rdx2Sq; 
  out[17] += -0.0625*(25.98076211353316*coeff[1]*fr[20]-25.98076211353316*coeff[1]*fl[20]-15.0*coeff[1]*fr[17]-15.0*coeff[1]*fl[17]+30.0*coeff[1]*fc[17])*rdx2Sq; 
  out[18] += -0.0625*(33.0*coeff[1]*fr[18]+33.0*coeff[1]*fl[18]+114.0*coeff[1]*fc[18]-25.98076211353316*coeff[1]*fr[16]+25.98076211353316*coeff[1]*fl[16])*rdx2Sq; 
  out[19] += -0.0625*(25.98076211353316*coeff[1]*fr[22]-25.98076211353316*coeff[1]*fl[22]-15.0*coeff[1]*fr[19]-15.0*coeff[1]*fl[19]+30.0*coeff[1]*fc[19])*rdx2Sq; 
  out[20] += -0.0625*(33.0*coeff[1]*fr[20]+33.0*coeff[1]*fl[20]+114.0*coeff[1]*fc[20]-25.98076211353316*coeff[1]*fr[17]+25.98076211353316*coeff[1]*fl[17])*rdx2Sq; 
  out[21] += -0.0625*(25.98076211353316*coeff[1]*fr[23]-25.98076211353316*coeff[1]*fl[23]-15.0*coeff[1]*fr[21]-15.0*coeff[1]*fl[21]+30.0*coeff[1]*fc[21])*rdx2Sq; 
  out[22] += -0.0625*(33.0*coeff[1]*fr[22]+33.0*coeff[1]*fl[22]+114.0*coeff[1]*fc[22]-25.98076211353316*coeff[1]*fr[19]+25.98076211353316*coeff[1]*fl[19])*rdx2Sq; 
  out[23] += -0.0625*(33.0*coeff[1]*fr[23]+33.0*coeff[1]*fl[23]+114.0*coeff[1]*fc[23]-25.98076211353316*coeff[1]*fr[21]+25.98076211353316*coeff[1]*fl[21])*rdx2Sq; 
