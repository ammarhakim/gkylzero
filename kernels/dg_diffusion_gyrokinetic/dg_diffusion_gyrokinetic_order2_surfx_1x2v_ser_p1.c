...
GKYL_CU_DH double dg_diffusion_gyrokinetic_order2_surfx_1x2v_ser_p1_constcoeff(const double *w, const double *dx, const double *coeff, const double *jacobgeo_inv, const double *ql, const double *qc, const double *qr, double* GKYL_RESTRICT out) 
{
  ...
  out[2] += -0.0625*(8.660254037844386*coeff[0]*fr[4]-8.660254037844386*coeff[0]*fl[4]-9.0*coeff[0]*fr[2]-9.0*coeff[0]*fl[2]+18.0*coeff[0]*fc[2])*rdx2Sq; 
  out[3] += -0.0625*(8.660254037844386*coeff[0]*fr[5]-8.660254037844386*coeff[0]*fl[5]-9.0*coeff[0]*fr[3]-9.0*coeff[0]*fl[3]+18.0*coeff[0]*fc[3])*rdx2Sq; 
  out[4] += -0.0625*(7.0*coeff[0]*fr[4]+7.0*coeff[0]*fl[4]+46.0*coeff[0]*fc[4]-8.660254037844386*coeff[0]*fr[2]+8.660254037844386*coeff[0]*fl[2])*rdx2Sq; 
  out[5] += -0.0625*(7.0*coeff[0]*fr[5]+7.0*coeff[0]*fl[5]+46.0*coeff[0]*fc[5]-8.660254037844386*coeff[0]*fr[3]+8.660254037844386*coeff[0]*fl[3])*rdx2Sq; 
  out[6] += -0.0625*(8.660254037844386*coeff[0]*fr[7]-8.660254037844386*coeff[0]*fl[7]-9.0*coeff[0]*fr[6]-9.0*coeff[0]*fl[6]+18.0*coeff[0]*fc[6])*rdx2Sq; 
  out[7] += -0.0625*(7.0*coeff[0]*fr[7]+7.0*coeff[0]*fl[7]+46.0*coeff[0]*fc[7]-8.660254037844386*coeff[0]*fr[6]+8.660254037844386*coeff[0]*fl[6])*rdx2Sq; 
  out[8] += -0.0625*(8.660254037844387*coeff[0]*fr[9]-8.660254037844387*coeff[0]*fl[9]-9.0*coeff[0]*fr[8]-9.0*coeff[0]*fl[8]+18.0*coeff[0]*fc[8])*rdx2Sq; 
  out[9] += -0.0625*(7.0*coeff[0]*fr[9]+7.0*coeff[0]*fl[9]+46.0*coeff[0]*fc[9]-8.660254037844387*coeff[0]*fr[8]+8.660254037844387*coeff[0]*fl[8])*rdx2Sq; 
  out[10] += -0.0625*(8.660254037844387*coeff[0]*fr[11]-8.660254037844387*coeff[0]*fl[11]-9.0*coeff[0]*fr[10]-9.0*coeff[0]*fl[10]+18.0*coeff[0]*fc[10])*rdx2Sq; 
  out[11] += -0.0625*(7.0*coeff[0]*fr[11]+7.0*coeff[0]*fl[11]+46.0*coeff[0]*fc[11]-8.660254037844387*coeff[0]*fr[10]+8.660254037844387*coeff[0]*fl[10])*rdx2Sq; 
