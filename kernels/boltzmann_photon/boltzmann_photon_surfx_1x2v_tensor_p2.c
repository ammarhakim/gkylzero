...
{ 
  ...
  Ghat_r[4] = 1.58113883008419*fc[20]+1.224744871391589*fc[12]+0.7071067811865475*fc[8]; 
  Ghat_r[5] = 1.58113883008419*fc[21]+1.224744871391589*fc[15]+0.7071067811865475*fc[9]; 
  Ghat_r[6] = 1.58113883008419*fc[23]+1.224744871391589*fc[18]+0.7071067811865475*fc[14]; 
  Ghat_r[7] = 1.58113883008419*fc[24]+1.224744871391589*fc[19]+0.7071067811865475*fc[16]; 
  Ghat_r[8] = 1.58113883008419*fc[26]+1.224744871391589*fc[25]+0.7071067811865475*fc[22]; 
  ...
  Ghat_l[4] = 1.58113883008419*fl[20]+1.224744871391589*fl[12]+0.7071067811865475*fl[8]; 
  Ghat_l[5] = 1.58113883008419*fl[21]+1.224744871391589*fl[15]+0.7071067811865475*fl[9]; 
  Ghat_l[6] = 1.58113883008419*fl[23]+1.224744871391589*fl[18]+0.7071067811865475*fl[14]; 
  Ghat_l[7] = 1.58113883008419*fl[24]+1.224744871391589*fl[19]+0.7071067811865475*fl[16]; 
  Ghat_l[8] = 1.58113883008419*fl[26]+1.224744871391589*fl[25]+0.7071067811865475*fl[22]; 
  ...
  Ghat_r[4] = 1.58113883008419*fr[20]-1.224744871391589*fr[12]+0.7071067811865475*fr[8]; 
  Ghat_r[5] = 1.58113883008419*fr[21]-1.224744871391589*fr[15]+0.7071067811865475*fr[9]; 
  Ghat_r[6] = 1.58113883008419*fr[23]-1.224744871391589*fr[18]+0.7071067811865475*fr[14]; 
  Ghat_r[7] = 1.58113883008419*fr[24]-1.224744871391589*fr[19]+0.7071067811865475*fr[16]; 
  Ghat_r[8] = 1.58113883008419*fr[26]-1.224744871391589*fr[25]+0.7071067811865475*fr[22]; 
  ...
  Ghat_l[4] = 1.58113883008419*fc[20]-1.224744871391589*fc[12]+0.7071067811865475*fc[8]; 
  Ghat_l[5] = 1.58113883008419*fc[21]-1.224744871391589*fc[15]+0.7071067811865475*fc[9]; 
  Ghat_l[6] = 1.58113883008419*fc[23]-1.224744871391589*fc[18]+0.7071067811865475*fc[14]; 
  Ghat_l[7] = 1.58113883008419*fc[24]-1.224744871391589*fc[19]+0.7071067811865475*fc[16]; 
  Ghat_l[8] = 1.58113883008419*fc[26]-1.224744871391589*fc[25]+0.7071067811865475*fc[22]; 
  ...
  out[20] += (1.58113883008419*Ghat_l[4]-1.58113883008419*Ghat_r[4])*dx10*light_speed*sign_kpar; 
  out[21] += (1.58113883008419*Ghat_l[5]-1.58113883008419*Ghat_r[5])*dx10*light_speed*sign_kpar; 
  out[22] += (0.7071067811865475*Ghat_l[8]-0.7071067811865475*Ghat_r[8])*dx10*light_speed*sign_kpar; 
  out[23] += (1.58113883008419*Ghat_l[6]-1.58113883008419*Ghat_r[6])*dx10*light_speed*sign_kpar; 
  out[24] += (1.58113883008419*Ghat_l[7]-1.58113883008419*Ghat_r[7])*dx10*light_speed*sign_kpar; 
  out[25] += -1.224744871391589*(Ghat_r[8]+Ghat_l[8])*dx10*light_speed*sign_kpar; 
  out[26] += (1.58113883008419*Ghat_l[8]-1.58113883008419*Ghat_r[8])*dx10*light_speed*sign_kpar; 
