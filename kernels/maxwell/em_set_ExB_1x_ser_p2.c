...
{ 
  ...
  const double *num_ExB_y = &num_ExB[3]; 
  const double *num_ExB_z = &num_ExB[6]; 
  const double *B_x_sq  = &num_ExB[9]; 
  const double *B_y_sq  = &num_ExB[12]; 
  const double *B_z_sq  = &num_ExB[15]; 
