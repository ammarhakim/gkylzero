...
{ 
  ...
  ser_1x_p1_sqrt_with_sign(kappa_inv_bx_sq, kappa_inv_bx); 
  ser_1x_p1_sqrt_with_sign(kappa_inv_by_sq, kappa_inv_by); 
  ser_1x_p1_sqrt_with_sign(kappa_inv_bz_sq, kappa_inv_bz); 
} 
