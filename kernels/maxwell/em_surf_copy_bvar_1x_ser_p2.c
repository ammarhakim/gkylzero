...
{ 
  ...
  double B_x_xl = 1.58113883008419*B_x[2]-1.224744871391589*B_x[1]+0.7071067811865475*B_x[0]; 
  double B_x_xr = 1.58113883008419*B_x[2]+1.224744871391589*B_x[1]+0.7071067811865475*B_x[0]; 
  if (B_x_xl < 0.0) 
