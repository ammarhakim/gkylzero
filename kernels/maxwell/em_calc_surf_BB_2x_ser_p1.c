...
{ 
  ...
  double *B_x_B_y_xl = &out_surf[12]; 
  double *B_x_B_y_xr = &out_surf[14]; 
  double *B_x_B_z_xl = &out_surf[16]; 
  double *B_x_B_z_xr = &out_surf[18]; 
 
  double *Bx_sq_yl = &out_surf[20]; 
  double *Bx_sq_yr = &out_surf[22]; 
  double *By_sq_yl = &out_surf[24]; 
  double *By_sq_yr = &out_surf[26]; 
  double *Bz_sq_yl = &out_surf[28]; 
  double *Bz_sq_yr = &out_surf[30]; 
  double *B_x_B_y_yl = &out_surf[32]; 
  double *B_x_B_y_yr = &out_surf[34]; 
  double *B_y_B_z_yl = &out_surf[36]; 
  double *B_y_B_z_yr = &out_surf[38]; 
  ...
  binop_mul_1d_ser_p1(B_x_xl, B_y_xl, B_x_B_y_xl); 
  binop_mul_1d_ser_p1(B_x_xl, B_z_xl, B_x_B_z_xl); 
  ...
  binop_mul_1d_ser_p1(B_x_xr, B_y_xr, B_x_B_y_xr); 
  binop_mul_1d_ser_p1(B_x_xr, B_z_xr, B_x_B_z_xr); 
  ...
  binop_mul_1d_ser_p1(B_x_yl, B_y_yl, B_x_B_y_yl); 
  binop_mul_1d_ser_p1(B_y_yl, B_z_yl, B_y_B_z_yl); 
  ...
  binop_mul_1d_ser_p1(B_x_yr, B_y_yr, B_x_B_y_yr); 
  binop_mul_1d_ser_p1(B_y_yr, B_z_yr, B_y_B_z_yr); 
