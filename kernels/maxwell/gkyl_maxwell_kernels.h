...
GKYL_CU_DH void em_div_b_x_2x_ser_p2(const double *dxv, 
      const double *bvar_surf_l, const double *bvar_surf_c, const double *bvar_surf_r, 
      const double *bvar_c, double* GKYL_RESTRICT max_b, double* GKYL_RESTRICT div_b); 
GKYL_CU_DH void em_vars_limiterx_2x_ser_p2(double limiter_fac, const struct gkyl_wv_eqn *wv_eqn, double *ql, double *qc, double *qr); 
GKYL_CU_DH void em_div_b_y_2x_ser_p2(const double *dxv, 
      const double *bvar_surf_l, const double *bvar_surf_c, const double *bvar_surf_r, 
      const double *bvar_c, double* GKYL_RESTRICT max_b, double* GKYL_RESTRICT div_b); 
GKYL_CU_DH void em_vars_limitery_2x_ser_p2(double limiter_fac, const struct gkyl_wv_eqn *wv_eqn, double *ql, double *qc, double *qr); 
...
GKYL_CU_DH void em_div_b_x_3x_ser_p2(const double *dxv, 
      const double *bvar_surf_l, const double *bvar_surf_c, const double *bvar_surf_r, 
      const double *bvar_c, double* GKYL_RESTRICT max_b, double* GKYL_RESTRICT div_b); 
GKYL_CU_DH void em_vars_limiterx_3x_ser_p2(double limiter_fac, const struct gkyl_wv_eqn *wv_eqn, double *ql, double *qc, double *qr); 
GKYL_CU_DH void em_div_b_y_3x_ser_p2(const double *dxv, 
      const double *bvar_surf_l, const double *bvar_surf_c, const double *bvar_surf_r, 
      const double *bvar_c, double* GKYL_RESTRICT max_b, double* GKYL_RESTRICT div_b); 
GKYL_CU_DH void em_vars_limitery_3x_ser_p2(double limiter_fac, const struct gkyl_wv_eqn *wv_eqn, double *ql, double *qc, double *qr); 
GKYL_CU_DH void em_div_b_z_3x_ser_p2(const double *dxv, 
      const double *bvar_surf_l, const double *bvar_surf_c, const double *bvar_surf_r, 
      const double *bvar_c, double* GKYL_RESTRICT max_b, double* GKYL_RESTRICT div_b); 
GKYL_CU_DH void em_vars_limiterz_3x_ser_p2(double limiter_fac, const struct gkyl_wv_eqn *wv_eqn, double *ql, double *qc, double *qr); 
