...
GKYL_CU_DH void em_calc_surf_BB_2x_ser_p2(const double *em, double* GKYL_RESTRICT out_surf); 
...
GKYL_CU_DH void em_surf_set_bvar_2x_ser_p2(int count, struct gkyl_nmat *A, struct gkyl_nmat *rhs, const double *BB_surf, int* cell_avg_magB2_surf); 
...
GKYL_CU_DH void em_surf_copy_bvar_2x_ser_p2(int count, struct gkyl_nmat *x, const double *em, int* cell_avg_magB2_surf, double* GKYL_RESTRICT bvar_surf); 
...
GKYL_CU_DH void em_div_b_x_2x_ser_p2(const double *dxv, 
      const double *bvar_surf_l, const double *bvar_surf_c, const double *bvar_surf_r, 
      const double *bvar_c, double* GKYL_RESTRICT max_b, double* GKYL_RESTRICT div_b); 
GKYL_CU_DH void em_div_b_y_2x_ser_p2(const double *dxv, 
      const double *bvar_surf_l, const double *bvar_surf_c, const double *bvar_surf_r, 
      const double *bvar_c, double* GKYL_RESTRICT max_b, double* GKYL_RESTRICT div_b); 
...
GKYL_CU_DH void em_calc_surf_BB_3x_ser_p2(const double *em, double* GKYL_RESTRICT out_surf); 
...
GKYL_CU_DH void em_surf_set_bvar_3x_ser_p2(int count, struct gkyl_nmat *A, struct gkyl_nmat *rhs, const double *BB_surf, int* cell_avg_magB2_surf); 
...
GKYL_CU_DH void em_surf_copy_bvar_3x_ser_p2(int count, struct gkyl_nmat *x, const double *em, int* cell_avg_magB2_surf, double* GKYL_RESTRICT bvar_surf); 
...
GKYL_CU_DH void em_div_b_x_3x_ser_p2(const double *dxv, 
      const double *bvar_surf_l, const double *bvar_surf_c, const double *bvar_surf_r, 
      const double *bvar_c, double* GKYL_RESTRICT max_b, double* GKYL_RESTRICT div_b); 
GKYL_CU_DH void em_div_b_y_3x_ser_p2(const double *dxv, 
      const double *bvar_surf_l, const double *bvar_surf_c, const double *bvar_surf_r, 
      const double *bvar_c, double* GKYL_RESTRICT max_b, double* GKYL_RESTRICT div_b); 
GKYL_CU_DH void em_div_b_z_3x_ser_p2(const double *dxv, 
      const double *bvar_surf_l, const double *bvar_surf_c, const double *bvar_surf_r, 
      const double *bvar_c, double* GKYL_RESTRICT max_b, double* GKYL_RESTRICT div_b); 
