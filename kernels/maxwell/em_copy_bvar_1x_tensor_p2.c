...
#include <gkyl_basis_tensor_1x_p2_sqrt_with_sign.h> 
...
{ 
  ...
  tensor_1x_p2_sqrt_with_sign(B_x, bxbx, bx); 
  tensor_1x_p2_sqrt_with_sign(B_y, byby, by); 
  tensor_1x_p2_sqrt_with_sign(B_z, bzbz, bz); 
