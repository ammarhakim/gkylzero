...
{ 
  ...
  double *B_x_B_y_xl = &out_surf[18]; 
  double *B_x_B_y_xr = &out_surf[21]; 
  double *B_x_B_z_xl = &out_surf[24]; 
  double *B_x_B_z_xr = &out_surf[27]; 
 
  double *Bx_sq_yl = &out_surf[30]; 
  double *Bx_sq_yr = &out_surf[33]; 
  double *By_sq_yl = &out_surf[36]; 
  double *By_sq_yr = &out_surf[39]; 
  double *Bz_sq_yl = &out_surf[42]; 
  double *Bz_sq_yr = &out_surf[45]; 
  double *B_x_B_y_yl = &out_surf[48]; 
  double *B_x_B_y_yr = &out_surf[51]; 
  double *B_y_B_z_yl = &out_surf[54]; 
  double *B_y_B_z_yr = &out_surf[57]; 
  ...
  B_x_xl[2] = 0.7071067811865475*B_x[5]-1.224744871391589*B_x[7]; 
  ...
  B_x_xr[2] = 1.224744871391589*B_x[7]+0.7071067811865475*B_x[5]; 
  ...
  B_y_xl[2] = 0.7071067811865475*B_y[5]-1.224744871391589*B_y[7]; 
  ...
  B_y_xr[2] = 1.224744871391589*B_y[7]+0.7071067811865475*B_y[5]; 
  ...
  B_z_xl[2] = 0.7071067811865475*B_z[5]-1.224744871391589*B_z[7]; 
  ...
  B_z_xr[2] = 1.224744871391589*B_z[7]+0.7071067811865475*B_z[5]; 
  ...
  binop_mul_1d_ser_p2(B_x_xl, B_y_xl, B_x_B_y_xl); 
  binop_mul_1d_ser_p2(B_x_xl, B_z_xl, B_x_B_z_xl); 
  ...
  binop_mul_1d_ser_p2(B_x_xr, B_y_xr, B_x_B_y_xr); 
  binop_mul_1d_ser_p2(B_x_xr, B_z_xr, B_x_B_z_xr); 
  ...
  B_x_yl[2] = 0.7071067811865475*B_x[4]-1.224744871391589*B_x[6]; 
  ...
  B_x_yr[2] = 1.224744871391589*B_x[6]+0.7071067811865475*B_x[4]; 
  ...
  B_y_yl[2] = 0.7071067811865475*B_y[4]-1.224744871391589*B_y[6]; 
  ...
  B_y_yr[2] = 1.224744871391589*B_y[6]+0.7071067811865475*B_y[4]; 
  ...
  B_z_yl[2] = 0.7071067811865475*B_z[4]-1.224744871391589*B_z[6]; 
  ...
  B_z_yr[2] = 1.224744871391589*B_z[6]+0.7071067811865475*B_z[4]; 
  ...
  binop_mul_1d_ser_p2(B_x_yl, B_y_yl, B_x_B_y_yl); 
  binop_mul_1d_ser_p2(B_y_yl, B_z_yl, B_y_B_z_yl); 
  ...
  binop_mul_1d_ser_p2(B_x_yr, B_y_yr, B_x_B_y_yr); 
  binop_mul_1d_ser_p2(B_y_yr, B_z_yr, B_y_B_z_yr); 
