...
{ 
  ...
  const double *b_surf_lr = &bvar_surf_l[20]; 
  const double *b_surf_cl = &bvar_surf_c[16]; 
  const double *b_surf_cr = &bvar_surf_c[20]; 
  ...
  div_b[19] += ((-3.872983346207417*b_c[7])+0.7905694150420947*b_surf_rl[3]-0.7905694150420947*b_surf_lr[3]+0.7905694150420947*b_surf_cr[3]-0.7905694150420947*b_surf_cl[3])*dx1; 
