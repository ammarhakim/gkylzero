...
{ 
  ...
  div_b[4] += (0.6123724356957944*(b_surf_rl[1]+b_surf_lr[1]+b_surf_cr[1]+b_surf_cl[1])-1.732050807568877*b_c[2])*dx1; 
  div_b[5] += (0.6123724356957944*(b_surf_rl[2]+b_surf_lr[2]+b_surf_cr[2]+b_surf_cl[2])-1.732050807568877*b_c[3])*dx1; 
  div_b[6] += (0.3535533905932737*b_surf_rl[3]-0.3535533905932737*b_surf_lr[3]+0.3535533905932737*b_surf_cr[3]-0.3535533905932737*b_surf_cl[3])*dx1; 
  div_b[7] += ((-3.872983346207417*b_c[1])+0.7905694150420947*b_surf_rl[0]-0.7905694150420947*b_surf_lr[0]+0.7905694150420947*b_surf_cr[0]-0.7905694150420947*b_surf_cl[0])*dx1; 
  div_b[8] += (0.3535533905932737*b_surf_rl[4]-0.3535533905932737*b_surf_lr[4]+0.3535533905932737*b_surf_cr[4]-0.3535533905932737*b_surf_cl[4])*dx1; 
  ...
  div_b[10] += (0.6123724356957944*(b_surf_rl[3]+b_surf_lr[3]+b_surf_cr[3]+b_surf_cl[3])-1.732050807568877*b_c[6])*dx1; 
  div_b[11] += ((-3.872983346207417*b_c[4])+0.7905694150420948*b_surf_rl[1]-0.7905694150420948*b_surf_lr[1]+0.7905694150420948*b_surf_cr[1]-0.7905694150420948*b_surf_cl[1])*dx1; 
  div_b[12] += (0.6123724356957944*(b_surf_rl[4]+b_surf_lr[4]+b_surf_cr[4]+b_surf_cl[4])-1.732050807568877*b_c[8])*dx1; 
  div_b[13] += ((-3.872983346207417*b_c[5])+0.7905694150420948*b_surf_rl[2]-0.7905694150420948*b_surf_lr[2]+0.7905694150420948*b_surf_cr[2]-0.7905694150420948*b_surf_cl[2])*dx1; 
  div_b[14] += (0.3535533905932737*b_surf_rl[6]-0.3535533905932737*b_surf_lr[6]+0.3535533905932737*b_surf_cr[6]-0.3535533905932737*b_surf_cl[6])*dx1; 
  div_b[15] += (0.6123724356957944*(b_surf_rl[5]+b_surf_lr[5]+b_surf_cr[5]+b_surf_cl[5])-1.732050807568877*b_c[9])*dx1; 
  div_b[16] += (0.3535533905932737*b_surf_rl[7]-0.3535533905932737*b_surf_lr[7]+0.3535533905932737*b_surf_cr[7]-0.3535533905932737*b_surf_cl[7])*dx1; 
  div_b[17] += ((-3.872983346207417*b_c[10])+0.7905694150420947*b_surf_rl[3]-0.7905694150420947*b_surf_lr[3]+0.7905694150420947*b_surf_cr[3]-0.7905694150420947*b_surf_cl[3])*dx1; 
  div_b[18] += (0.6123724356957944*(b_surf_rl[6]+b_surf_lr[6]+b_surf_cr[6]+b_surf_cl[6])-1.732050807568877*b_c[14])*dx1; 
  div_b[19] += (0.6123724356957944*(b_surf_rl[7]+b_surf_lr[7]+b_surf_cr[7]+b_surf_cl[7])-1.732050807568877*b_c[16])*dx1; 
  div_b[20] += ((-3.872983346207417*b_c[12])+0.7905694150420947*b_surf_rl[4]-0.7905694150420947*b_surf_lr[4]+0.7905694150420947*b_surf_cr[4]-0.7905694150420947*b_surf_cl[4])*dx1; 
  div_b[21] += ((-3.872983346207417*b_c[15])+0.7905694150420947*b_surf_rl[5]-0.7905694150420947*b_surf_lr[5]+0.7905694150420947*b_surf_cr[5]-0.7905694150420947*b_surf_cl[5])*dx1; 
  div_b[22] += (0.3535533905932737*b_surf_rl[8]-0.3535533905932737*b_surf_lr[8]+0.3535533905932737*b_surf_cr[8]-0.3535533905932737*b_surf_cl[8])*dx1; 
  div_b[23] += ((-3.872983346207417*b_c[18])+0.7905694150420948*b_surf_rl[6]-0.7905694150420948*b_surf_lr[6]+0.7905694150420948*b_surf_cr[6]-0.7905694150420948*b_surf_cl[6])*dx1; 
  div_b[24] += ((-3.872983346207417*b_c[19])+0.7905694150420948*b_surf_rl[7]-0.7905694150420948*b_surf_lr[7]+0.7905694150420948*b_surf_cr[7]-0.7905694150420948*b_surf_cl[7])*dx1; 
  div_b[25] += (0.6123724356957944*(b_surf_rl[8]+b_surf_lr[8]+b_surf_cr[8]+b_surf_cl[8])-1.732050807568877*b_c[22])*dx1; 
  div_b[26] += ((-3.872983346207417*b_c[25])+0.7905694150420947*b_surf_rl[8]-0.7905694150420947*b_surf_lr[8]+0.7905694150420947*b_surf_cr[8]-0.7905694150420947*b_surf_cl[8])*dx1; 
