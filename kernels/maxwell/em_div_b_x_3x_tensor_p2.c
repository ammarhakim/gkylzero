...
{ 
  ...
  const double *b_surf_lr = &bvar_surf_l[4]; 
  const double *b_surf_cl = &bvar_surf_c[0]; 
  const double *b_surf_cr = &bvar_surf_c[4]; 
  const double *b_surf_rl = &bvar_surf_r[0]; 

  double *max_b_l = &max_b[0]; 
  double *max_b_r = &max_b[4]; 
  ...
  tensor_3x_p1_upwind_quad_to_modal(max_b_quad_l, max_b_l); 
  tensor_3x_p1_upwind_quad_to_modal(max_b_quad_r, max_b_r); 
  ...
  div_b[17] += ((-3.872983346207417*b_c[7])+0.7905694150420947*b_surf_rl[3]-0.7905694150420947*b_surf_lr[3]+0.7905694150420947*b_surf_cr[3]-0.7905694150420947*b_surf_cl[3])*dx1; 
