...
{ 
  ...
  double num_ExB_x[9] = {0.0}; 
  double num_ExB_y[9] = {0.0}; 
  double num_ExB_z[9] = {0.0}; 
  ...
  binop_mul_2d_tensor_p2(magB2_inv, num_ExB_x, ExB_x); 
  binop_mul_2d_tensor_p2(magB2_inv, num_ExB_y, ExB_y); 
  binop_mul_2d_tensor_p2(magB2_inv, num_ExB_z, ExB_z); 
