...
{ 
  ...
  binop_mul_1d_ser_p3(E_x, B_y, E_x_B_y); 
 
  double E_x_B_z[4] = {0.0}; 
  binop_mul_1d_ser_p3(E_x, B_z, E_x_B_z); 
 
  double E_y_B_x[4] = {0.0}; 
  binop_mul_1d_ser_p3(E_y, B_x, E_y_B_x); 
 
  double E_y_B_z[4] = {0.0}; 
  binop_mul_1d_ser_p3(E_y, B_z, E_y_B_z); 
 
  double E_z_B_x[4] = {0.0}; 
  binop_mul_1d_ser_p3(E_z, B_x, E_z_B_x); 
 
  double E_z_B_y[4] = {0.0}; 
  binop_mul_1d_ser_p3(E_z, B_y, E_z_B_y); 
