...
{ 
  ...
  if (notCellAvgMagB && (1.58113883008419*magB_sq[2]-1.224744871391589*magB_sq[1]+0.7071067811865475*magB_sq[0] < 0)) notCellAvgMagB = false; 
  if (notCellAvgMagB && (1.58113883008419*magB_sq[2]+1.224744871391589*magB_sq[1]+0.7071067811865475*magB_sq[0] < 0)) notCellAvgMagB = false; 
  ...
  if (notCellAvg && (1.156987065043442*bxbx[2]-1.109839118871799*bxbx[1]+0.7071067811865475*bxbx[0] < 0)) notCellAvg = false; 
  if (notCellAvg && (1.156987065043442*bzbz[2]-1.109839118871799*bzbz[1]+0.7071067811865475*bzbz[0] < 0)) notCellAvg = false; 
  if (notCellAvg && (1.156987065043442*bzbz[2]-1.109839118871799*bzbz[1]+0.7071067811865475*bzbz[0] < 0)) notCellAvg = false; 
  if (notCellAvg && ((-0.1028945116539821*bxbx[2])-0.6594875259537025*bxbx[1]+0.7071067811865475*bxbx[0] < 0)) notCellAvg = false; 
  if (notCellAvg && ((-0.1028945116539821*bzbz[2])-0.6594875259537025*bzbz[1]+0.7071067811865475*bzbz[0] < 0)) notCellAvg = false; 
  if (notCellAvg && ((-0.1028945116539821*bzbz[2])-0.6594875259537025*bzbz[1]+0.7071067811865475*bzbz[0] < 0)) notCellAvg = false; 
  if (notCellAvg && (0.7071067811865475*bxbx[0]-0.7905694150420947*bxbx[2] < 0)) notCellAvg = false; 
  if (notCellAvg && (0.7071067811865475*bzbz[0]-0.7905694150420947*bzbz[2] < 0)) notCellAvg = false; 
  if (notCellAvg && (0.7071067811865475*bzbz[0]-0.7905694150420947*bzbz[2] < 0)) notCellAvg = false; 
  if (notCellAvg && ((-0.1028945116539821*bxbx[2])+0.6594875259537025*bxbx[1]+0.7071067811865475*bxbx[0] < 0)) notCellAvg = false; 
  if (notCellAvg && ((-0.1028945116539821*bzbz[2])+0.6594875259537025*bzbz[1]+0.7071067811865475*bzbz[0] < 0)) notCellAvg = false; 
  if (notCellAvg && ((-0.1028945116539821*bzbz[2])+0.6594875259537025*bzbz[1]+0.7071067811865475*bzbz[0] < 0)) notCellAvg = false; 
