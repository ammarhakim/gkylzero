...
{ 
  ...
  incr_l[1] = ((-0.4330127018922193*bzl[3])+0.4330127018922193*bzc[3]-0.25*(bzl[1]+bzc[1]))*c2; 
  incr_l[2] = (0.75*bzl[2]-0.75*bzc[2]+0.4330127018922193*(bzl[0]+bzc[0]))*c2; 
  incr_l[3] = (0.75*bzl[3]-0.75*bzc[3]+0.4330127018922193*(bzl[1]+bzc[1]))*c2; 

  incr_r[0] = ((-0.4330127018922193*bzr[2])+0.4330127018922193*bzc[2]+0.25*(bzr[0]+bzc[0]))*c2; 
  incr_r[1] = ((-0.4330127018922193*bzr[3])+0.4330127018922193*bzc[3]+0.25*(bzr[1]+bzc[1]))*c2; 
  incr_r[2] = ((-0.75*bzr[2])+0.75*bzc[2]+0.4330127018922193*(bzr[0]+bzc[0]))*c2; 
  incr_r[3] = ((-0.75*bzr[3])+0.75*bzc[3]+0.4330127018922193*(bzr[1]+bzc[1]))*c2; 
  ...
  incr_l[1] = (0.4330127018922193*phl[3]-0.4330127018922193*phc[3]+0.25*(phl[1]+phc[1]))*c2chi; 
  incr_l[2] = ((-0.75*phl[2])+0.75*phc[2]-0.4330127018922193*(phl[0]+phc[0]))*c2chi; 
  incr_l[3] = ((-0.75*phl[3])+0.75*phc[3]-0.4330127018922193*(phl[1]+phc[1]))*c2chi; 

  incr_r[0] = (0.4330127018922193*phr[2]-0.4330127018922193*phc[2]-0.25*(phr[0]+phc[0]))*c2chi; 
  incr_r[1] = (0.4330127018922193*phr[3]-0.4330127018922193*phc[3]-0.25*(phr[1]+phc[1]))*c2chi; 
  incr_r[2] = (0.75*phr[2]-0.75*phc[2]-0.4330127018922193*(phr[0]+phc[0]))*c2chi; 
  incr_r[3] = (0.75*phr[3]-0.75*phc[3]-0.4330127018922193*(phr[1]+phc[1]))*c2chi; 
  ...
  incr_l[1] = (0.4330127018922193*bxl[3]-0.4330127018922193*bxc[3]+0.25*(bxl[1]+bxc[1]))*c2; 
  incr_l[2] = ((-0.75*bxl[2])+0.75*bxc[2]-0.4330127018922193*(bxl[0]+bxc[0]))*c2; 
  incr_l[3] = ((-0.75*bxl[3])+0.75*bxc[3]-0.4330127018922193*(bxl[1]+bxc[1]))*c2; 

  incr_r[0] = (0.4330127018922193*bxr[2]-0.4330127018922193*bxc[2]-0.25*(bxr[0]+bxc[0]))*c2; 
  incr_r[1] = (0.4330127018922193*bxr[3]-0.4330127018922193*bxc[3]-0.25*(bxr[1]+bxc[1]))*c2; 
  incr_r[2] = (0.75*bxr[2]-0.75*bxc[2]-0.4330127018922193*(bxr[0]+bxc[0]))*c2; 
  incr_r[3] = (0.75*bxr[3]-0.75*bxc[3]-0.4330127018922193*(bxr[1]+bxc[1]))*c2; 
  ...
  incr_l[1] = 0.4330127018922193*ezl[3]-0.4330127018922193*ezc[3]+0.25*(ezl[1]+ezc[1]); 
  incr_l[2] = (-0.75*ezl[2])+0.75*ezc[2]-0.4330127018922193*(ezl[0]+ezc[0]); 
  incr_l[3] = (-0.75*ezl[3])+0.75*ezc[3]-0.4330127018922193*(ezl[1]+ezc[1]); 

  incr_r[0] = 0.4330127018922193*ezr[2]-0.4330127018922193*ezc[2]-0.25*(ezr[0]+ezc[0]); 
  incr_r[1] = 0.4330127018922193*ezr[3]-0.4330127018922193*ezc[3]-0.25*(ezr[1]+ezc[1]); 
  incr_r[2] = 0.75*ezr[2]-0.75*ezc[2]-0.4330127018922193*(ezr[0]+ezc[0]); 
  incr_r[3] = 0.75*ezr[3]-0.75*ezc[3]-0.4330127018922193*(ezr[1]+ezc[1]); 
  ...
  incr_l[1] = (0.4330127018922193*psl[3]-0.4330127018922193*psc[3]+0.25*(psl[1]+psc[1]))*gamma; 
  incr_l[2] = ((-0.75*psl[2])+0.75*psc[2]-0.4330127018922193*(psl[0]+psc[0]))*gamma; 
  incr_l[3] = ((-0.75*psl[3])+0.75*psc[3]-0.4330127018922193*(psl[1]+psc[1]))*gamma; 

  incr_r[0] = (0.4330127018922193*psr[2]-0.4330127018922193*psc[2]-0.25*(psr[0]+psc[0]))*gamma; 
  incr_r[1] = (0.4330127018922193*psr[3]-0.4330127018922193*psc[3]-0.25*(psr[1]+psc[1]))*gamma; 
  incr_r[2] = (0.75*psr[2]-0.75*psc[2]-0.4330127018922193*(psr[0]+psc[0]))*gamma; 
  incr_r[3] = (0.75*psr[3]-0.75*psc[3]-0.4330127018922193*(psr[1]+psc[1]))*gamma; 
  ...
  incr_l[1] = (-0.4330127018922193*exl[3])+0.4330127018922193*exc[3]-0.25*(exl[1]+exc[1]); 
  incr_l[2] = 0.75*exl[2]-0.75*exc[2]+0.4330127018922193*(exl[0]+exc[0]); 
  incr_l[3] = 0.75*exl[3]-0.75*exc[3]+0.4330127018922193*(exl[1]+exc[1]); 

  incr_r[0] = (-0.4330127018922193*exr[2])+0.4330127018922193*exc[2]+0.25*(exr[0]+exc[0]); 
  incr_r[1] = (-0.4330127018922193*exr[3])+0.4330127018922193*exc[3]+0.25*(exr[1]+exc[1]); 
  incr_r[2] = (-0.75*exr[2])+0.75*exc[2]+0.4330127018922193*(exr[0]+exc[0]); 
  incr_r[3] = (-0.75*exr[3])+0.75*exc[3]+0.4330127018922193*(exr[1]+exc[1]); 
  ...
  incr_l[1] = (0.4330127018922193*eyl[3]-0.4330127018922193*eyc[3]+0.25*(eyl[1]+eyc[1]))*chi; 
  incr_l[2] = ((-0.75*eyl[2])+0.75*eyc[2]-0.4330127018922193*(eyl[0]+eyc[0]))*chi; 
  incr_l[3] = ((-0.75*eyl[3])+0.75*eyc[3]-0.4330127018922193*(eyl[1]+eyc[1]))*chi; 

  incr_r[0] = (0.4330127018922193*eyr[2]-0.4330127018922193*eyc[2]-0.25*(eyr[0]+eyc[0]))*chi; 
  incr_r[1] = (0.4330127018922193*eyr[3]-0.4330127018922193*eyc[3]-0.25*(eyr[1]+eyc[1]))*chi; 
  incr_r[2] = (0.75*eyr[2]-0.75*eyc[2]-0.4330127018922193*(eyr[0]+eyc[0]))*chi; 
  incr_r[3] = (0.75*eyr[3]-0.75*eyc[3]-0.4330127018922193*(eyr[1]+eyc[1]))*chi; 
  ...
  incr_l[1] = (0.4330127018922193*byl[3]-0.4330127018922193*byc[3]+0.25*(byl[1]+byc[1]))*c2gamma; 
  incr_l[2] = ((-0.75*byl[2])+0.75*byc[2]-0.4330127018922193*(byl[0]+byc[0]))*c2gamma; 
  incr_l[3] = ((-0.75*byl[3])+0.75*byc[3]-0.4330127018922193*(byl[1]+byc[1]))*c2gamma; 

  incr_r[0] = (0.4330127018922193*byr[2]-0.4330127018922193*byc[2]-0.25*(byr[0]+byc[0]))*c2gamma; 
  incr_r[1] = (0.4330127018922193*byr[3]-0.4330127018922193*byc[3]-0.25*(byr[1]+byc[1]))*c2gamma; 
  incr_r[2] = (0.75*byr[2]-0.75*byc[2]-0.4330127018922193*(byr[0]+byc[0]))*c2gamma; 
  incr_r[3] = (0.75*byr[3]-0.75*byc[3]-0.4330127018922193*(byr[1]+byc[1]))*c2gamma; 
