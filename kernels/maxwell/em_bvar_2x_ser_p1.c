...
{ 
  ...
  if (notCellAvg && (0.9*bxbx[3]-0.6708203932499369*bxbx[2]-0.6708203932499369*bxbx[1]+0.5*bxbx[0] < 0)) notCellAvg = false; 
  if (notCellAvg && (0.9*bzbz[3]-0.6708203932499369*bzbz[2]-0.6708203932499369*bzbz[1]+0.5*bzbz[0] < 0)) notCellAvg = false; 
  if (notCellAvg && (0.9*bzbz[3]-0.6708203932499369*bzbz[2]-0.6708203932499369*bzbz[1]+0.5*bzbz[0] < 0)) notCellAvg = false; 
  if (notCellAvg && (0.5*bxbx[0]-0.6708203932499369*bxbx[1] < 0)) notCellAvg = false; 
  if (notCellAvg && (0.5*bzbz[0]-0.6708203932499369*bzbz[1] < 0)) notCellAvg = false; 
  if (notCellAvg && (0.5*bzbz[0]-0.6708203932499369*bzbz[1] < 0)) notCellAvg = false; 
  if (notCellAvg && ((-0.9*bxbx[3])+0.6708203932499369*bxbx[2]-0.6708203932499369*bxbx[1]+0.5*bxbx[0] < 0)) notCellAvg = false; 
  if (notCellAvg && ((-0.9*bzbz[3])+0.6708203932499369*bzbz[2]-0.6708203932499369*bzbz[1]+0.5*bzbz[0] < 0)) notCellAvg = false; 
  if (notCellAvg && ((-0.9*bzbz[3])+0.6708203932499369*bzbz[2]-0.6708203932499369*bzbz[1]+0.5*bzbz[0] < 0)) notCellAvg = false; 
  if (notCellAvg && (0.5*bxbx[0]-0.6708203932499369*bxbx[2] < 0)) notCellAvg = false; 
  if (notCellAvg && (0.5*bzbz[0]-0.6708203932499369*bzbz[2] < 0)) notCellAvg = false; 
  if (notCellAvg && (0.5*bzbz[0]-0.6708203932499369*bzbz[2] < 0)) notCellAvg = false; 
  if (notCellAvg && (0.5*bxbx[0] < 0)) notCellAvg = false; 
  if (notCellAvg && (0.5*bzbz[0] < 0)) notCellAvg = false; 
  if (notCellAvg && (0.5*bzbz[0] < 0)) notCellAvg = false; 
  if (notCellAvg && (0.6708203932499369*bxbx[2]+0.5*bxbx[0] < 0)) notCellAvg = false; 
  if (notCellAvg && (0.6708203932499369*bzbz[2]+0.5*bzbz[0] < 0)) notCellAvg = false; 
  if (notCellAvg && (0.6708203932499369*bzbz[2]+0.5*bzbz[0] < 0)) notCellAvg = false; 
  if (notCellAvg && ((-0.9*bxbx[3])-0.6708203932499369*bxbx[2]+0.6708203932499369*bxbx[1]+0.5*bxbx[0] < 0)) notCellAvg = false; 
  if (notCellAvg && ((-0.9*bzbz[3])-0.6708203932499369*bzbz[2]+0.6708203932499369*bzbz[1]+0.5*bzbz[0] < 0)) notCellAvg = false; 
  if (notCellAvg && ((-0.9*bzbz[3])-0.6708203932499369*bzbz[2]+0.6708203932499369*bzbz[1]+0.5*bzbz[0] < 0)) notCellAvg = false; 
  if (notCellAvg && (0.6708203932499369*bxbx[1]+0.5*bxbx[0] < 0)) notCellAvg = false; 
  if (notCellAvg && (0.6708203932499369*bzbz[1]+0.5*bzbz[0] < 0)) notCellAvg = false; 
  if (notCellAvg && (0.6708203932499369*bzbz[1]+0.5*bzbz[0] < 0)) notCellAvg = false; 
  if (notCellAvg && (0.9*bxbx[3]+0.6708203932499369*bxbx[2]+0.6708203932499369*bxbx[1]+0.5*bxbx[0] < 0)) notCellAvg = false; 
  if (notCellAvg && (0.9*bzbz[3]+0.6708203932499369*bzbz[2]+0.6708203932499369*bzbz[1]+0.5*bzbz[0] < 0)) notCellAvg = false; 
  if (notCellAvg && (0.9*bzbz[3]+0.6708203932499369*bzbz[2]+0.6708203932499369*bzbz[1]+0.5*bzbz[0] < 0)) notCellAvg = false; 
