...
{ 
  ...
  if (notCellAvgMagB && (1.5*magB_sq[3]-0.8660254037844386*magB_sq[2]-0.8660254037844386*magB_sq[1]+0.5*magB_sq[0] < 0)) notCellAvgMagB = false; 
  if (notCellAvgMagB && ((-1.5*magB_sq[3])-0.8660254037844386*magB_sq[2]+0.8660254037844386*magB_sq[1]+0.5*magB_sq[0] < 0)) notCellAvgMagB = false; 
  if (notCellAvgMagB && ((-1.5*magB_sq[3])+0.8660254037844386*magB_sq[2]-0.8660254037844386*magB_sq[1]+0.5*magB_sq[0] < 0)) notCellAvgMagB = false; 
  if (notCellAvgMagB && (1.5*magB_sq[3]+0.8660254037844386*magB_sq[2]+0.8660254037844386*magB_sq[1]+0.5*magB_sq[0] < 0)) notCellAvgMagB = false; 
  ...
  if (notCellAvg && (1.112333620718714*bxbx[3]-0.7457659219616816*bxbx[2]-0.7457659219616816*bxbx[1]+0.5*bxbx[0] < 0)) notCellAvg = false; 
  if (notCellAvg && (1.112333620718714*bzbz[3]-0.7457659219616816*bzbz[2]-0.7457659219616816*bzbz[1]+0.5*bzbz[0] < 0)) notCellAvg = false; 
  if (notCellAvg && (1.112333620718714*bzbz[3]-0.7457659219616816*bzbz[2]-0.7457659219616816*bzbz[1]+0.5*bzbz[0] < 0)) notCellAvg = false; 
  if (notCellAvg && (0.4391550328268398*bxbx[3]-0.2944322205496299*bxbx[2]-0.7457659219616816*bxbx[1]+0.5*bxbx[0] < 0)) notCellAvg = false; 
  if (notCellAvg && (0.4391550328268398*bzbz[3]-0.2944322205496299*bzbz[2]-0.7457659219616816*bzbz[1]+0.5*bzbz[0] < 0)) notCellAvg = false; 
  if (notCellAvg && (0.4391550328268398*bzbz[3]-0.2944322205496299*bzbz[2]-0.7457659219616816*bzbz[1]+0.5*bzbz[0] < 0)) notCellAvg = false; 
  if (notCellAvg && ((-0.4391550328268398*bxbx[3])+0.2944322205496299*bxbx[2]-0.7457659219616816*bxbx[1]+0.5*bxbx[0] < 0)) notCellAvg = false; 
  if (notCellAvg && ((-0.4391550328268398*bzbz[3])+0.2944322205496299*bzbz[2]-0.7457659219616816*bzbz[1]+0.5*bzbz[0] < 0)) notCellAvg = false; 
  if (notCellAvg && ((-0.4391550328268398*bzbz[3])+0.2944322205496299*bzbz[2]-0.7457659219616816*bzbz[1]+0.5*bzbz[0] < 0)) notCellAvg = false; 
  ...
  if (notCellAvg && ((-1.112333620718714*bzbz[3])+0.7457659219616816*bzbz[2]-0.7457659219616816*bzbz[1]+0.5*bzbz[0] < 0)) notCellAvg = false; 
  if (notCellAvg && ((-1.112333620718714*bzbz[3])+0.7457659219616816*bzbz[2]-0.7457659219616816*bzbz[1]+0.5*bzbz[0] < 0)) notCellAvg = false; 
  if (notCellAvg && (0.4391550328268398*bxbx[3]-0.7457659219616816*bxbx[2]-0.2944322205496299*bxbx[1]+0.5*bxbx[0] < 0)) notCellAvg = false; 
  if (notCellAvg && (0.4391550328268398*bzbz[3]-0.7457659219616816*bzbz[2]-0.2944322205496299*bzbz[1]+0.5*bzbz[0] < 0)) notCellAvg = false; 
  if (notCellAvg && (0.4391550328268398*bzbz[3]-0.7457659219616816*bzbz[2]-0.2944322205496299*bzbz[1]+0.5*bzbz[0] < 0)) notCellAvg = false; 
  if (notCellAvg && (0.1733806649955719*bxbx[3]-0.2944322205496299*bxbx[2]-0.2944322205496299*bxbx[1]+0.5*bxbx[0] < 0)) notCellAvg = false; 
  if (notCellAvg && (0.1733806649955719*bzbz[3]-0.2944322205496299*bzbz[2]-0.2944322205496299*bzbz[1]+0.5*bzbz[0] < 0)) notCellAvg = false; 
  if (notCellAvg && (0.1733806649955719*bzbz[3]-0.2944322205496299*bzbz[2]-0.2944322205496299*bzbz[1]+0.5*bzbz[0] < 0)) notCellAvg = false; 
  if (notCellAvg && ((-0.1733806649955719*bxbx[3])+0.2944322205496299*bxbx[2]-0.2944322205496299*bxbx[1]+0.5*bxbx[0] < 0)) notCellAvg = false; 
  if (notCellAvg && ((-0.1733806649955719*bzbz[3])+0.2944322205496299*bzbz[2]-0.2944322205496299*bzbz[1]+0.5*bzbz[0] < 0)) notCellAvg = false; 
  if (notCellAvg && ((-0.1733806649955719*bzbz[3])+0.2944322205496299*bzbz[2]-0.2944322205496299*bzbz[1]+0.5*bzbz[0] < 0)) notCellAvg = false; 
