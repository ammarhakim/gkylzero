...
{ 
  ...
  double *B_x_B_y_xl = &out_surf[24]; 
  double *B_x_B_y_xr = &out_surf[28]; 
  double *B_x_B_z_xl = &out_surf[32]; 
  double *B_x_B_z_xr = &out_surf[36]; 
 
  double *Bx_sq_yl = &out_surf[40]; 
  double *Bx_sq_yr = &out_surf[44]; 
  double *By_sq_yl = &out_surf[48]; 
  double *By_sq_yr = &out_surf[52]; 
  double *Bz_sq_yl = &out_surf[56]; 
  double *Bz_sq_yr = &out_surf[60]; 
  double *B_x_B_y_yl = &out_surf[64]; 
  double *B_x_B_y_yr = &out_surf[68]; 
  double *B_y_B_z_yl = &out_surf[72]; 
  double *B_y_B_z_yr = &out_surf[76]; 
 
  double *Bx_sq_zl = &out_surf[80]; 
  double *Bx_sq_zr = &out_surf[84]; 
  double *By_sq_zl = &out_surf[88]; 
  double *By_sq_zr = &out_surf[92]; 
  double *Bz_sq_zl = &out_surf[96]; 
  double *Bz_sq_zr = &out_surf[100]; 
  double *B_x_B_z_zl = &out_surf[104]; 
  double *B_x_B_z_zr = &out_surf[108]; 
  double *B_y_B_z_zl = &out_surf[112]; 
  double *B_y_B_z_zr = &out_surf[116]; 
  ...
  binop_mul_2d_ser_p1(B_x_xl, B_y_xl, B_x_B_y_xl); 
  binop_mul_2d_ser_p1(B_x_xl, B_z_xl, B_x_B_z_xl); 
  ...
  binop_mul_2d_ser_p1(B_x_xr, B_y_xr, B_x_B_y_xr); 
  binop_mul_2d_ser_p1(B_x_xr, B_z_xr, B_x_B_z_xr); 
  ...
  binop_mul_2d_ser_p1(B_x_yl, B_y_yl, B_x_B_y_yl); 
  binop_mul_2d_ser_p1(B_y_yl, B_z_yl, B_y_B_z_yl); 
  ...
  binop_mul_2d_ser_p1(B_x_yr, B_y_yr, B_x_B_y_yr); 
  binop_mul_2d_ser_p1(B_y_yr, B_z_yr, B_y_B_z_yr); 
  ...
  binop_mul_2d_ser_p1(B_x_zl, B_z_zl, B_x_B_z_zl); 
  binop_mul_2d_ser_p1(B_y_zl, B_z_zl, B_y_B_z_zl); 
  ...
  binop_mul_2d_ser_p1(B_x_zr, B_z_zr, B_x_B_z_zr); 
  binop_mul_2d_ser_p1(B_y_zr, B_z_zr, B_y_B_z_zr); 
