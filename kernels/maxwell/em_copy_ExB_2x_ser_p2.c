...
{ 
  ...
  binop_mul_2d_ser_p2(E_x, B_y, E_x_B_y); 
 
  double E_x_B_z[8] = {0.0}; 
  binop_mul_2d_ser_p2(E_x, B_z, E_x_B_z); 
 
  double E_y_B_x[8] = {0.0}; 
  binop_mul_2d_ser_p2(E_y, B_x, E_y_B_x); 
 
  double E_y_B_z[8] = {0.0}; 
  binop_mul_2d_ser_p2(E_y, B_z, E_y_B_z); 
 
  double E_z_B_x[8] = {0.0}; 
  binop_mul_2d_ser_p2(E_z, B_x, E_z_B_x); 
 
  double E_z_B_y[8] = {0.0}; 
  binop_mul_2d_ser_p2(E_z, B_y, E_z_B_y); 
  ...
  binop_mul_2d_ser_p2(magB2_inv, num_ExB_x, ExB_x); 
  binop_mul_2d_ser_p2(magB2_inv, num_ExB_y, ExB_y); 
  binop_mul_2d_ser_p2(magB2_inv, num_ExB_z, ExB_z); 
