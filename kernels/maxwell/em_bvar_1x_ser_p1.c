...
{ 
  ...
  if (notCellAvg && (0.7071067811865475*B_x_sq[0]-0.7071067811865475*B_x_sq[1] < 0)) notCellAvg = false; 
  if (notCellAvg && (0.7071067811865475*B_y_sq[0]-0.7071067811865475*B_y_sq[1] < 0)) notCellAvg = false; 
  if (notCellAvg && (0.7071067811865475*B_z_sq[0]-0.7071067811865475*B_z_sq[1] < 0)) notCellAvg = false; 
  if (notCellAvg && (0.7071067811865475*B_x_sq[1]+0.7071067811865475*B_x_sq[0] < 0)) notCellAvg = false; 
  if (notCellAvg && (0.7071067811865475*B_y_sq[1]+0.7071067811865475*B_y_sq[0] < 0)) notCellAvg = false; 
  if (notCellAvg && (0.7071067811865475*B_z_sq[1]+0.7071067811865475*B_z_sq[0] < 0)) notCellAvg = false; 
  ...
  ser_1x_p1_sqrt_with_sign(bxbx, bx); 
  ser_1x_p1_sqrt_with_sign(byby, by); 
  ser_1x_p1_sqrt_with_sign(bzbz, bz); 
} 
