...
{ 
  ...
  double *max_b_l = &max_b[8]; 
  double *max_b_r = &max_b[12]; 
  ...
  div_b[18] += ((-3.872983346207417*b_c[7])+0.7905694150420947*b_surf_rl[3]-0.7905694150420947*b_surf_lr[3]+0.7905694150420947*b_surf_cr[3]-0.7905694150420947*b_surf_cl[3])*dx1; 
