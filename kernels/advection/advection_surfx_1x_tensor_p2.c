...
{ 
  ...
  double u_l_r = tensor_1x_p2_surfx1_eval_quad_node_0_r(ul_0); 
  double u_c_l = tensor_1x_p2_surfx1_eval_quad_node_0_l(uc_0); 
  double u_c_r = tensor_1x_p2_surfx1_eval_quad_node_0_r(uc_0); 
  double u_r_l = tensor_1x_p2_surfx1_eval_quad_node_0_l(ur_0); 
