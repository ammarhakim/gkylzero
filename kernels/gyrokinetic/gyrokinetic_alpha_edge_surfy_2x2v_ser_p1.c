...
{ 
  ...
  alphaR[0] = ((1.9364916731037085*jacobtot_inv_surf[0]*b_y_surf[1]*hamil[8]-0.8660254037844386*b_y_surf[1]*hamil[1]*jacobtot_inv_surf[1]-0.8660254037844386*b_y_surf[0]*jacobtot_inv_surf[0]*hamil[1])*rdx2+(0.8660254037844386*jacobtot_inv_surf[0]*vmap[0]*b_y_surf[1]*hamil[2]*rdx2)/vmap[1])/q_+(0.7071067811865475*cmag_surf[1]*jacobtot_inv_surf[1]*hamil[2]+0.7071067811865475*cmag_surf[0]*jacobtot_inv_surf[0]*hamil[2])/(vmap[1]*m_); 
  alphaR[1] = ((1.9364916731037085*b_y_surf[1]*jacobtot_inv_surf[1]*hamil[8]-0.8660254037844386*b_y_surf[0]*hamil[1]*jacobtot_inv_surf[1]-0.8660254037844386*jacobtot_inv_surf[0]*b_y_surf[1]*hamil[1])*rdx2+(0.8660254037844386*vmap[0]*b_y_surf[1]*jacobtot_inv_surf[1]*hamil[2]*rdx2)/vmap[1])/q_+(0.7071067811865475*cmag_surf[0]*jacobtot_inv_surf[1]*hamil[2]+0.7071067811865475*jacobtot_inv_surf[0]*cmag_surf[1]*hamil[2])/(vmap[1]*m_); 
  alphaR[2] = ((1.9364916731037085*jacobtot_inv_surf[0]*vmap[0]*b_y_surf[1]*hamil[8]*rdx2)/vmap[1]+0.8660254037844386*jacobtot_inv_surf[0]*b_y_surf[1]*hamil[2]*rdx2)/q_+(1.5811388300841895*cmag_surf[1]*jacobtot_inv_surf[1]*hamil[8]+1.5811388300841895*cmag_surf[0]*jacobtot_inv_surf[0]*hamil[8])/(vmap[1]*m_); 
  ...
  alphaR[4] = ((1.9364916731037085*vmap[0]*b_y_surf[1]*jacobtot_inv_surf[1]*hamil[8]*rdx2)/vmap[1]+0.8660254037844386*b_y_surf[1]*jacobtot_inv_surf[1]*hamil[2]*rdx2)/q_+(1.5811388300841895*cmag_surf[0]*jacobtot_inv_surf[1]*hamil[8]+1.5811388300841895*jacobtot_inv_surf[0]*cmag_surf[1]*hamil[8])/(vmap[1]*m_); 
  ...
  alphaR[8] = (1.7320508075688772*jacobtot_inv_surf[0]*b_y_surf[1]*hamil[8]*rdx2)/q_; 
  alphaR[9] = (1.7320508075688774*b_y_surf[1]*jacobtot_inv_surf[1]*hamil[8]*rdx2)/q_; 
