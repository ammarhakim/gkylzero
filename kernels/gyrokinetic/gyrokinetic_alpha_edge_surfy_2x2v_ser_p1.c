...
{ 
  ...
  alphaR[0] = ((2.371708245126284*b_y[3]*hamil[16]+1.369306393762915*b_y[1]*hamil[16]-1.837117307087383*b_y[2]*hamil[5]-1.060660171779821*b_y[0]*hamil[5]-1.060660171779821*hamil[1]*b_y[2]-0.6123724356957944*b_y[0]*hamil[1])*rdx2+(vmap[0]*(1.060660171779821*b_y[3]*hamil[3]+0.6123724356957944*b_y[1]*hamil[3])*rdx2)/vmap[1])/q_+(0.8660254037844386*cmag[2]*hamil[3]+0.5*cmag[0]*hamil[3])/(vmap[1]*m_); 
  alphaR[1] = ((-(1.837117307087383*b_y[3]*hamil[5])-1.060660171779821*b_y[1]*hamil[5]-1.060660171779821*hamil[1]*b_y[3]-0.6123724356957944*b_y[1]*hamil[1])*rdx2)/q_+(0.8660254037844386*cmag[3]*hamil[3]+0.5*cmag[1]*hamil[3])/(vmap[1]*m_); 
  alphaR[2] = ((vmap[0]*(2.371708245126284*b_y[3]*hamil[16]+1.369306393762915*b_y[1]*hamil[16])*rdx2)/vmap[1]+(1.060660171779821*b_y[3]*hamil[3]+0.6123724356957944*b_y[1]*hamil[3])*rdx2)/q_+(1.9364916731037085*cmag[2]*hamil[16]+1.118033988749895*cmag[0]*hamil[16])/(vmap[1]*m_); 
  alphaR[3] = ((-(1.837117307087383*b_y[2]*hamil[12])-1.060660171779821*b_y[0]*hamil[12]-1.060660171779821*b_y[2]*hamil[8]-0.6123724356957944*b_y[0]*hamil[8])*rdx2)/q_; 
  alphaR[4] = (1.9364916731037085*cmag[3]*hamil[16]+1.118033988749895*cmag[1]*hamil[16])/(vmap[1]*m_); 
  alphaR[5] = ((-(1.837117307087383*b_y[3]*hamil[12])-1.060660171779821*b_y[1]*hamil[12]-1.060660171779821*b_y[3]*hamil[8]-0.6123724356957944*b_y[1]*hamil[8])*rdx2)/q_; 
  alphaR[8] = ((2.1213203435596424*b_y[3]*hamil[16]+1.224744871391589*b_y[1]*hamil[16])*rdx2)/q_; 

  int const_sgn_alpha_surf = 1;  
  
  if (0.31622776601683783*alphaR[8]+0.3535533905932734*alphaR[5]+0.4743416490252568*alphaR[4]-0.3535533905932734*alphaR[3]-0.4743416490252568*alphaR[2]-0.3535533905932734*alphaR[1]+0.3535533905932734*alphaR[0] > 0.) 
  ...
  if (0.31622776601683783*alphaR[8]-0.3535533905932734*alphaR[5]-0.4743416490252568*alphaR[4]-0.3535533905932734*alphaR[3]-0.4743416490252568*alphaR[2]+0.3535533905932734*(alphaR[1]+alphaR[0]) > 0.) 
