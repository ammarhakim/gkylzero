...
{ 
  ...
  alphaR[0] = (0.8660254037844386*cmag[2]*hamil[3]+0.5*cmag[0]*hamil[3])/(vmap[1]*m_); 
  alphaR[1] = (0.8660254037844386*cmag[3]*hamil[3]+0.5*cmag[1]*hamil[3])/(vmap[1]*m_); 
  alphaR[2] = (1.9364916731037085*cmag[2]*hamil[16]+1.118033988749895*cmag[0]*hamil[16])/(vmap[1]*m_); 
