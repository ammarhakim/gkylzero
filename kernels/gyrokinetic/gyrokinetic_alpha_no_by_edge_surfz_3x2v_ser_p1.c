...
{ 
  ...
  alphaR[0] = ((0.4330127018922193*b_x_surf[0]*jacobtot_inv_surf[1]*hamil[5]+0.4330127018922193*jacobtot_inv_surf[0]*b_x_surf[1]*hamil[5]+0.4330127018922193*b_x_surf[1]*jacobtot_inv_surf[1]*hamil[2]+0.4330127018922193*b_x_surf[0]*jacobtot_inv_surf[0]*hamil[2])*rdy2)/q_+(0.3535533905932737*cmag_surf[1]*jacobtot_inv_surf[1]*hamil[3]+0.3535533905932737*cmag_surf[0]*jacobtot_inv_surf[0]*hamil[3])/(vmap[1]*m_); 
  alphaR[1] = ((0.7794228634059945*b_x_surf[1]*jacobtot_inv_surf[1]*hamil[5]+0.4330127018922193*b_x_surf[0]*jacobtot_inv_surf[0]*hamil[5]+0.4330127018922193*b_x_surf[0]*jacobtot_inv_surf[1]*hamil[2]+0.4330127018922193*jacobtot_inv_surf[0]*b_x_surf[1]*hamil[2])*rdy2)/q_+(0.3535533905932737*cmag_surf[0]*jacobtot_inv_surf[1]*hamil[3]+0.3535533905932737*jacobtot_inv_surf[0]*cmag_surf[1]*hamil[3])/(vmap[1]*m_); 
  alphaR[3] = (0.7905694150420947*cmag_surf[1]*jacobtot_inv_surf[1]*hamil[16]+0.7905694150420947*cmag_surf[0]*jacobtot_inv_surf[0]*hamil[16])/(vmap[1]*m_); 
  alphaR[6] = (0.7905694150420947*cmag_surf[0]*jacobtot_inv_surf[1]*hamil[16]+0.7905694150420947*jacobtot_inv_surf[0]*cmag_surf[1]*hamil[16])/(vmap[1]*m_); 
