...
{ 
  ...
  double hamil[24] = {0.}; 
  hamil[0] = (2.449489742783179*phi[2]+1.414213562373095*phi[0])*q_+vmapSq[0]*m_+1.414213562373095*bmag[0]*vmap[2]; 
  hamil[1] = 2.449489742783179*phi[3]*q_+1.414213562373095*(phi[1]*q_+bmag[1]*vmap[2]); 
  hamil[2] = vmapSq[1]*m_; 
...
double alphahat_quad = 0.0; 
double JfL_quad = 0.0; 
double JfR_quad = 0.0; 
double favg_quad = 0.0; 
double fjump_quad = 0.0; 
...
alphahat_quad = ((0.408248290463863*dxv[2]*(0.6123724356957944*hamil[2]-1.837117307087383*hamil[8]))/vmap[1])/m_/bmag_quad * B3_quad ;
alphahat_quad += ((0.408248290463863*dxv[2]*(0.6123724356957944*hamil[2]-1.837117307087383*hamil[8]))/vmap[1])/m_/bmag_quad * (0.6123724356957944*hamil[2]-1.837117307087383*hamil[8])/q_ * normcurlbhat_quad ;
alphahat_quad += 1/q_/bmag_quad/area_elem_quad * -bhat_quad[0]*(0.6123724356957944*hamil[1]-0.6123724356957944*hamil[5]) ;

alpha_quad = alphahat_quad*area_elem_quad/Jc_quad ;
...
favg_quad = (JfL_quad + JfR_quad)/2.0/Jc_quad ;
fjump_quad = (JfL_quad - JfR_quad)/2.0/Jc_quad ;
flux_surf_nodal[0] = alphahat_quad*favg_quad*area_elem_quad + fabs(alphahat_quad)*fjump_quad*area_elem_quad ;
alphahat_quad = ((0.2499999999999999*dxv[2]*hamil[2])/vmap[1])/m_/bmag_quad * B3_quad ;
alphahat_quad += ((0.2499999999999999*dxv[2]*hamil[2])/vmap[1])/m_/bmag_quad * (0.6123724356957944*hamil[2])/q_ * normcurlbhat_quad ;
alphahat_quad += 1/q_/bmag_quad/area_elem_quad * -bhat_quad[0]*(0.6123724356957944*hamil[1]-0.6123724356957944*hamil[5]) ;
...
favg_quad = (JfL_quad + JfR_quad)/2.0/Jc_quad ;
fjump_quad = (JfL_quad - JfR_quad)/2.0/Jc_quad ;
flux_surf_nodal[1] = alphahat_quad*favg_quad*area_elem_quad + fabs(alphahat_quad)*fjump_quad*area_elem_quad ;
alphahat_quad = ((0.408248290463863*dxv[2]*(1.837117307087383*hamil[8]+0.6123724356957944*hamil[2]))/vmap[1])/m_/bmag_quad * B3_quad ;
alphahat_quad += ((0.408248290463863*dxv[2]*(1.837117307087383*hamil[8]+0.6123724356957944*hamil[2]))/vmap[1])/m_/bmag_quad * (1.837117307087383*hamil[8]+0.6123724356957944*hamil[2])/q_ * normcurlbhat_quad ;
alphahat_quad += 1/q_/bmag_quad/area_elem_quad * -bhat_quad[0]*(0.6123724356957944*hamil[1]-0.6123724356957944*hamil[5]) ;
...
favg_quad = (JfL_quad + JfR_quad)/2.0/Jc_quad ;
fjump_quad = (JfL_quad - JfR_quad)/2.0/Jc_quad ;
flux_surf_nodal[2] = alphahat_quad*favg_quad*area_elem_quad + fabs(alphahat_quad)*fjump_quad*area_elem_quad ;
alphahat_quad = ((0.408248290463863*dxv[2]*(0.6123724356957944*hamil[2]-1.837117307087383*hamil[8]))/vmap[1])/m_/bmag_quad * B3_quad ;
alphahat_quad += ((0.408248290463863*dxv[2]*(0.6123724356957944*hamil[2]-1.837117307087383*hamil[8]))/vmap[1])/m_/bmag_quad * (0.6123724356957944*hamil[2]-1.837117307087383*hamil[8])/q_ * normcurlbhat_quad ;
alphahat_quad += 1/q_/bmag_quad/area_elem_quad * -bhat_quad[0]*(0.6123724356957944*hamil[5]+0.6123724356957944*hamil[1]) ;
...
favg_quad = (JfL_quad + JfR_quad)/2.0/Jc_quad ;
fjump_quad = (JfL_quad - JfR_quad)/2.0/Jc_quad ;
flux_surf_nodal[3] = alphahat_quad*favg_quad*area_elem_quad + fabs(alphahat_quad)*fjump_quad*area_elem_quad ;
alphahat_quad = ((0.2499999999999999*dxv[2]*hamil[2])/vmap[1])/m_/bmag_quad * B3_quad ;
alphahat_quad += ((0.2499999999999999*dxv[2]*hamil[2])/vmap[1])/m_/bmag_quad * (0.6123724356957944*hamil[2])/q_ * normcurlbhat_quad ;
alphahat_quad += 1/q_/bmag_quad/area_elem_quad * -bhat_quad[0]*(0.6123724356957944*hamil[5]+0.6123724356957944*hamil[1]) ;
...
favg_quad = (JfL_quad + JfR_quad)/2.0/Jc_quad ;
fjump_quad = (JfL_quad - JfR_quad)/2.0/Jc_quad ;
flux_surf_nodal[4] = alphahat_quad*favg_quad*area_elem_quad + fabs(alphahat_quad)*fjump_quad*area_elem_quad ;
alphahat_quad = ((0.408248290463863*dxv[2]*(1.837117307087383*hamil[8]+0.6123724356957944*hamil[2]))/vmap[1])/m_/bmag_quad * B3_quad ;
alphahat_quad += ((0.408248290463863*dxv[2]*(1.837117307087383*hamil[8]+0.6123724356957944*hamil[2]))/vmap[1])/m_/bmag_quad * (1.837117307087383*hamil[8]+0.6123724356957944*hamil[2])/q_ * normcurlbhat_quad ;
alphahat_quad += 1/q_/bmag_quad/area_elem_quad * -bhat_quad[0]*(0.6123724356957944*hamil[5]+0.6123724356957944*hamil[1]) ;
...
favg_quad = (JfL_quad + JfR_quad)/2.0/Jc_quad ;
fjump_quad = (JfL_quad - JfR_quad)/2.0/Jc_quad ;
flux_surf_nodal[5] = alphahat_quad*favg_quad*area_elem_quad + fabs(alphahat_quad)*fjump_quad*area_elem_quad ;
...
favg_quad = (JfL_quad + JfR_quad)/2.0/Jc_quad ;
fjump_quad = (JfL_quad - JfR_quad)/2.0/Jc_quad ;
flux_surf_nodal[6] = alphahat_quad*favg_quad*area_elem_quad + fabs(alphahat_quad)*fjump_quad*area_elem_quad ;
alphahat_quad = ((0.2499999999999999*dxv[2]*hamil[2])/vmap[1])/m_/bmag_quad * B3_quad ;
alphahat_quad += ((0.2499999999999999*dxv[2]*hamil[2])/vmap[1])/m_/bmag_quad * (0.6123724356957944*hamil[2])/q_ * normcurlbhat_quad ;
alphahat_quad += 1/q_/bmag_quad/area_elem_quad * -bhat_quad[0]*(0.6123724356957944*hamil[1]-0.6123724356957944*hamil[5]) ;
...
favg_quad = (JfL_quad + JfR_quad)/2.0/Jc_quad ;
fjump_quad = (JfL_quad - JfR_quad)/2.0/Jc_quad ;
flux_surf_nodal[7] = alphahat_quad*favg_quad*area_elem_quad + fabs(alphahat_quad)*fjump_quad*area_elem_quad ;
alphahat_quad = ((0.408248290463863*dxv[2]*(1.837117307087383*hamil[8]+0.6123724356957944*hamil[2]))/vmap[1])/m_/bmag_quad * B3_quad ;
alphahat_quad += ((0.408248290463863*dxv[2]*(1.837117307087383*hamil[8]+0.6123724356957944*hamil[2]))/vmap[1])/m_/bmag_quad * (1.837117307087383*hamil[8]+0.6123724356957944*hamil[2])/q_ * normcurlbhat_quad ;
alphahat_quad += 1/q_/bmag_quad/area_elem_quad * -bhat_quad[0]*(0.6123724356957944*hamil[1]-0.6123724356957944*hamil[5]) ;
...
favg_quad = (JfL_quad + JfR_quad)/2.0/Jc_quad ;
fjump_quad = (JfL_quad - JfR_quad)/2.0/Jc_quad ;
flux_surf_nodal[8] = alphahat_quad*favg_quad*area_elem_quad + fabs(alphahat_quad)*fjump_quad*area_elem_quad ;
alphahat_quad = ((0.408248290463863*dxv[2]*(0.6123724356957944*hamil[2]-1.837117307087383*hamil[8]))/vmap[1])/m_/bmag_quad * B3_quad ;
alphahat_quad += ((0.408248290463863*dxv[2]*(0.6123724356957944*hamil[2]-1.837117307087383*hamil[8]))/vmap[1])/m_/bmag_quad * (0.6123724356957944*hamil[2]-1.837117307087383*hamil[8])/q_ * normcurlbhat_quad ;
alphahat_quad += 1/q_/bmag_quad/area_elem_quad * -bhat_quad[0]*(0.6123724356957944*hamil[5]+0.6123724356957944*hamil[1]) ;
...
favg_quad = (JfL_quad + JfR_quad)/2.0/Jc_quad ;
fjump_quad = (JfL_quad - JfR_quad)/2.0/Jc_quad ;
flux_surf_nodal[9] = alphahat_quad*favg_quad*area_elem_quad + fabs(alphahat_quad)*fjump_quad*area_elem_quad ;
alphahat_quad = ((0.2499999999999999*dxv[2]*hamil[2])/vmap[1])/m_/bmag_quad * B3_quad ;
alphahat_quad += ((0.2499999999999999*dxv[2]*hamil[2])/vmap[1])/m_/bmag_quad * (0.6123724356957944*hamil[2])/q_ * normcurlbhat_quad ;
alphahat_quad += 1/q_/bmag_quad/area_elem_quad * -bhat_quad[0]*(0.6123724356957944*hamil[5]+0.6123724356957944*hamil[1]) ;
...
favg_quad = (JfL_quad + JfR_quad)/2.0/Jc_quad ;
fjump_quad = (JfL_quad - JfR_quad)/2.0/Jc_quad ;
flux_surf_nodal[10] = alphahat_quad*favg_quad*area_elem_quad + fabs(alphahat_quad)*fjump_quad*area_elem_quad ;
alphahat_quad = ((0.408248290463863*dxv[2]*(1.837117307087383*hamil[8]+0.6123724356957944*hamil[2]))/vmap[1])/m_/bmag_quad * B3_quad ;
alphahat_quad += ((0.408248290463863*dxv[2]*(1.837117307087383*hamil[8]+0.6123724356957944*hamil[2]))/vmap[1])/m_/bmag_quad * (1.837117307087383*hamil[8]+0.6123724356957944*hamil[2])/q_ * normcurlbhat_quad ;
alphahat_quad += 1/q_/bmag_quad/area_elem_quad * -bhat_quad[0]*(0.6123724356957944*hamil[5]+0.6123724356957944*hamil[1]) ;
...
favg_quad = (JfL_quad + JfR_quad)/2.0/Jc_quad ;
fjump_quad = (JfL_quad - JfR_quad)/2.0/Jc_quad ;
flux_surf_nodal[11] = alphahat_quad*favg_quad*area_elem_quad + fabs(alphahat_quad)*fjump_quad*area_elem_quad ;
