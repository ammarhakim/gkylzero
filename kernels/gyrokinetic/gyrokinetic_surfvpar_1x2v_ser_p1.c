...
{ 
  ...
  if (alphaL[3]-1.0*alphaL[2]-1.0*alphaL[1]+alphaL[0] > 0.) {
    fUpOrdL[0] = 0.7905694150420945*fl[11]-0.7905694150420947*(fl[10]+fl[9])+0.7905694150420947*fl[8]+0.6123724356957942*fl[7]-0.6123724356957944*fl[6]+0.3535533905932736*fl[5]-0.6123724356957944*fl[4]-0.3535533905932736*fl[3]+0.6123724356957944*fl[2]-0.3535533905932736*fl[1]+0.3535533905932737*fl[0]; 
  } else {
    fUpOrdL[0] = 0.7905694150420945*fc[11]-0.7905694150420947*(fc[10]+fc[9])+0.7905694150420947*fc[8]-0.6123724356957942*fc[7]+0.6123724356957944*fc[6]+0.3535533905932736*fc[5]+0.6123724356957944*fc[4]-0.3535533905932736*fc[3]-0.6123724356957944*fc[2]-0.3535533905932736*fc[1]+0.3535533905932737*fc[0]; 
  }
  if ((-1.0*alphaL[3])+alphaL[2]-1.0*alphaL[1]+alphaL[0] > 0.) {
    fUpOrdL[1] = (-0.7905694150420945*fl[11])+0.7905694150420947*fl[10]-0.7905694150420947*fl[9]+0.7905694150420947*fl[8]-0.6123724356957942*fl[7]+0.6123724356957944*fl[6]-0.3535533905932736*fl[5]-0.6123724356957944*fl[4]+0.3535533905932736*fl[3]+0.6123724356957944*fl[2]-0.3535533905932736*fl[1]+0.3535533905932737*fl[0]; 
  } else {
    fUpOrdL[1] = (-0.7905694150420945*fc[11])+0.7905694150420947*fc[10]-0.7905694150420947*fc[9]+0.7905694150420947*fc[8]+0.6123724356957942*fc[7]-0.6123724356957944*fc[6]-0.3535533905932736*fc[5]+0.6123724356957944*fc[4]+0.3535533905932736*fc[3]-0.6123724356957944*fc[2]-0.3535533905932736*fc[1]+0.3535533905932737*fc[0]; 
  }
  if ((-1.0*alphaL[3])-1.0*alphaL[2]+alphaL[1]+alphaL[0] > 0.) {
    fUpOrdL[2] = (-0.7905694150420945*fl[11])-0.7905694150420947*fl[10]+0.7905694150420947*(fl[9]+fl[8])-0.6123724356957942*fl[7]-0.6123724356957944*fl[6]-0.3535533905932736*fl[5]+0.6123724356957944*fl[4]-0.3535533905932736*fl[3]+0.6123724356957944*fl[2]+0.3535533905932736*fl[1]+0.3535533905932737*fl[0]; 
  } else {
    fUpOrdL[2] = (-0.7905694150420945*fc[11])-0.7905694150420947*fc[10]+0.7905694150420947*(fc[9]+fc[8])+0.6123724356957942*fc[7]+0.6123724356957944*fc[6]-0.3535533905932736*fc[5]-0.6123724356957944*fc[4]-0.3535533905932736*fc[3]-0.6123724356957944*fc[2]+0.3535533905932736*fc[1]+0.3535533905932737*fc[0]; 
  }
  if (alphaL[3]+alphaL[2]+alphaL[1]+alphaL[0] > 0.) {
    fUpOrdL[3] = 0.7905694150420945*fl[11]+0.7905694150420947*(fl[10]+fl[9]+fl[8])+0.6123724356957942*fl[7]+0.6123724356957944*fl[6]+0.3535533905932736*fl[5]+0.6123724356957944*fl[4]+0.3535533905932736*fl[3]+0.6123724356957944*fl[2]+0.3535533905932736*fl[1]+0.3535533905932737*fl[0]; 
  } else {
    fUpOrdL[3] = 0.7905694150420945*fc[11]+0.7905694150420947*(fc[10]+fc[9]+fc[8])-0.6123724356957942*fc[7]-0.6123724356957944*fc[6]+0.3535533905932736*fc[5]-0.6123724356957944*fc[4]+0.3535533905932736*fc[3]-0.6123724356957944*fc[2]+0.3535533905932736*fc[1]+0.3535533905932737*fc[0]; 
  }
  ...
  if (alphaR[3]-1.0*alphaR[2]-1.0*alphaR[1]+alphaR[0] > 0.) {
    fUpOrdR[0] = 0.7905694150420945*fc[11]-0.7905694150420947*(fc[10]+fc[9])+0.7905694150420947*fc[8]+0.6123724356957942*fc[7]-0.6123724356957944*fc[6]+0.3535533905932736*fc[5]-0.6123724356957944*fc[4]-0.3535533905932736*fc[3]+0.6123724356957944*fc[2]-0.3535533905932736*fc[1]+0.3535533905932737*fc[0]; 
  } else {
    fUpOrdR[0] = 0.7905694150420945*fr[11]-0.7905694150420947*(fr[10]+fr[9])+0.7905694150420947*fr[8]-0.6123724356957942*fr[7]+0.6123724356957944*fr[6]+0.3535533905932736*fr[5]+0.6123724356957944*fr[4]-0.3535533905932736*fr[3]-0.6123724356957944*fr[2]-0.3535533905932736*fr[1]+0.3535533905932737*fr[0]; 
  }
  if ((-1.0*alphaR[3])+alphaR[2]-1.0*alphaR[1]+alphaR[0] > 0.) {
    fUpOrdR[1] = (-0.7905694150420945*fc[11])+0.7905694150420947*fc[10]-0.7905694150420947*fc[9]+0.7905694150420947*fc[8]-0.6123724356957942*fc[7]+0.6123724356957944*fc[6]-0.3535533905932736*fc[5]-0.6123724356957944*fc[4]+0.3535533905932736*fc[3]+0.6123724356957944*fc[2]-0.3535533905932736*fc[1]+0.3535533905932737*fc[0]; 
  } else {
    fUpOrdR[1] = (-0.7905694150420945*fr[11])+0.7905694150420947*fr[10]-0.7905694150420947*fr[9]+0.7905694150420947*fr[8]+0.6123724356957942*fr[7]-0.6123724356957944*fr[6]-0.3535533905932736*fr[5]+0.6123724356957944*fr[4]+0.3535533905932736*fr[3]-0.6123724356957944*fr[2]-0.3535533905932736*fr[1]+0.3535533905932737*fr[0]; 
  }
  if ((-1.0*alphaR[3])-1.0*alphaR[2]+alphaR[1]+alphaR[0] > 0.) {
    fUpOrdR[2] = (-0.7905694150420945*fc[11])-0.7905694150420947*fc[10]+0.7905694150420947*(fc[9]+fc[8])-0.6123724356957942*fc[7]-0.6123724356957944*fc[6]-0.3535533905932736*fc[5]+0.6123724356957944*fc[4]-0.3535533905932736*fc[3]+0.6123724356957944*fc[2]+0.3535533905932736*fc[1]+0.3535533905932737*fc[0]; 
  } else {
    fUpOrdR[2] = (-0.7905694150420945*fr[11])-0.7905694150420947*fr[10]+0.7905694150420947*(fr[9]+fr[8])+0.6123724356957942*fr[7]+0.6123724356957944*fr[6]-0.3535533905932736*fr[5]-0.6123724356957944*fr[4]-0.3535533905932736*fr[3]-0.6123724356957944*fr[2]+0.3535533905932736*fr[1]+0.3535533905932737*fr[0]; 
  }
  if (alphaR[3]+alphaR[2]+alphaR[1]+alphaR[0] > 0.) {
    fUpOrdR[3] = 0.7905694150420945*fc[11]+0.7905694150420947*(fc[10]+fc[9]+fc[8])+0.6123724356957942*fc[7]+0.6123724356957944*fc[6]+0.3535533905932736*fc[5]+0.6123724356957944*fc[4]+0.3535533905932736*fc[3]+0.6123724356957944*fc[2]+0.3535533905932736*fc[1]+0.3535533905932737*fc[0]; 
  } else {
    fUpOrdR[3] = 0.7905694150420945*fr[11]+0.7905694150420947*(fr[10]+fr[9]+fr[8])-0.6123724356957942*fr[7]-0.6123724356957944*fr[6]+0.3535533905932736*fr[5]-0.6123724356957944*fr[4]+0.3535533905932736*fr[3]-0.6123724356957944*fr[2]+0.3535533905932736*fr[1]+0.3535533905932737*fr[0]; 
  }
