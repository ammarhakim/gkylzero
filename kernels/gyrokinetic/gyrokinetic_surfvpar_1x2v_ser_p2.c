...
{ 
  ...
  fUpL[0] = (1.58113883008419*fl[8]+1.224744871391589*fl[2]+0.7071067811865475*fl[0])/vmap_prime_l[0]; 
  fUpL[1] = (1.58113883008419*fl[12]+1.224744871391589*fl[4]+0.7071067811865475*fl[1])/vmap_prime_l[0]; 
  fUpL[2] = (1.58113883008419*fl[14]+1.224744871391589*fl[6]+0.7071067811865475*fl[3])/vmap_prime_l[0]; 
  fUpL[3] = (1.58113883008419*fl[18]+1.224744871391589*fl[10]+0.7071067811865475*fl[5])/vmap_prime_l[0]; 
  fUpL[4] = (1.224744871391589*fl[11]+0.7071067811865475*fl[7])/vmap_prime_l[0]; 
  fUpL[5] = (1.224744871391589*fl[16]+0.7071067811865475*fl[9])/vmap_prime_l[0]; 
  fUpL[6] = (1.224744871391589*fl[17]+0.7071067811865475*fl[13])/vmap_prime_l[0]; 
  fUpL[7] = (1.224744871391589*fl[19]+0.7071067811865475*fl[15])/vmap_prime_l[0]; 
    } else { 
  fUpL[0] = (1.58113883008419*fc[8]-1.224744871391589*fc[2]+0.7071067811865475*fc[0])/vmap_prime_c[0]; 
  fUpL[1] = (1.58113883008419*fc[12]-1.224744871391589*fc[4]+0.7071067811865475*fc[1])/vmap_prime_c[0]; 
  fUpL[2] = (1.58113883008419*fc[14]-1.224744871391589*fc[6]+0.7071067811865475*fc[3])/vmap_prime_c[0]; 
  fUpL[3] = (1.58113883008419*fc[18]-1.224744871391589*fc[10]+0.7071067811865475*fc[5])/vmap_prime_c[0]; 
  fUpL[4] = (0.7071067811865475*fc[7]-1.224744871391589*fc[11])/vmap_prime_c[0]; 
  fUpL[5] = (0.7071067811865475*fc[9]-1.224744871391589*fc[16])/vmap_prime_c[0]; 
  fUpL[6] = (0.7071067811865475*fc[13]-1.224744871391589*fc[17])/vmap_prime_c[0]; 
  fUpL[7] = (0.7071067811865475*fc[15]-1.224744871391589*fc[19])/vmap_prime_c[0]; 
    } 
  } else { 
  double f_lr[8] = {0.};
  double f_cl[8] = {0.};
  ...
  f_lr[0] = (1.58113883008419*fl[8]+1.224744871391589*fl[2]+0.7071067811865475*fl[0])/vmap_prime_l[0]; 
  f_lr[1] = (1.58113883008419*fl[12]+1.224744871391589*fl[4]+0.7071067811865475*fl[1])/vmap_prime_l[0]; 
  f_lr[2] = (1.58113883008419*fl[14]+1.224744871391589*fl[6]+0.7071067811865475*fl[3])/vmap_prime_l[0]; 
  f_lr[3] = (1.58113883008419*fl[18]+1.224744871391589*fl[10]+0.7071067811865475*fl[5])/vmap_prime_l[0]; 
  f_lr[4] = (1.224744871391589*fl[11]+0.7071067811865475*fl[7])/vmap_prime_l[0]; 
  f_lr[5] = (1.224744871391589*fl[16]+0.7071067811865475*fl[9])/vmap_prime_l[0]; 
  f_lr[6] = (1.224744871391589*fl[17]+0.7071067811865475*fl[13])/vmap_prime_l[0]; 
  f_lr[7] = (1.224744871391589*fl[19]+0.7071067811865475*fl[15])/vmap_prime_l[0]; 

  f_cl[0] = (1.58113883008419*fc[8]-1.224744871391589*fc[2]+0.7071067811865475*fc[0])/vmap_prime_c[0]; 
  f_cl[1] = (1.58113883008419*fc[12]-1.224744871391589*fc[4]+0.7071067811865475*fc[1])/vmap_prime_c[0]; 
  f_cl[2] = (1.58113883008419*fc[14]-1.224744871391589*fc[6]+0.7071067811865475*fc[3])/vmap_prime_c[0]; 
  f_cl[3] = (1.58113883008419*fc[18]-1.224744871391589*fc[10]+0.7071067811865475*fc[5])/vmap_prime_c[0]; 
  f_cl[4] = (0.7071067811865475*fc[7]-1.224744871391589*fc[11])/vmap_prime_c[0]; 
  f_cl[5] = (0.7071067811865475*fc[9]-1.224744871391589*fc[16])/vmap_prime_c[0]; 
  f_cl[6] = (0.7071067811865475*fc[13]-1.224744871391589*fc[17])/vmap_prime_c[0]; 
  f_cl[7] = (0.7071067811865475*fc[15]-1.224744871391589*fc[19])/vmap_prime_c[0]; 
  ...
  fUpR[0] = (1.58113883008419*fc[8]+1.224744871391589*fc[2]+0.7071067811865475*fc[0])/vmap_prime_c[0]; 
  fUpR[1] = (1.58113883008419*fc[12]+1.224744871391589*fc[4]+0.7071067811865475*fc[1])/vmap_prime_c[0]; 
  fUpR[2] = (1.58113883008419*fc[14]+1.224744871391589*fc[6]+0.7071067811865475*fc[3])/vmap_prime_c[0]; 
  fUpR[3] = (1.58113883008419*fc[18]+1.224744871391589*fc[10]+0.7071067811865475*fc[5])/vmap_prime_c[0]; 
  fUpR[4] = (1.224744871391589*fc[11]+0.7071067811865475*fc[7])/vmap_prime_c[0]; 
  fUpR[5] = (1.224744871391589*fc[16]+0.7071067811865475*fc[9])/vmap_prime_c[0]; 
  fUpR[6] = (1.224744871391589*fc[17]+0.7071067811865475*fc[13])/vmap_prime_c[0]; 
  fUpR[7] = (1.224744871391589*fc[19]+0.7071067811865475*fc[15])/vmap_prime_c[0]; 
    } else { 
  fUpR[0] = (1.58113883008419*fr[8]-1.224744871391589*fr[2]+0.7071067811865475*fr[0])/vmap_prime_r[0]; 
  fUpR[1] = (1.58113883008419*fr[12]-1.224744871391589*fr[4]+0.7071067811865475*fr[1])/vmap_prime_r[0]; 
  fUpR[2] = (1.58113883008419*fr[14]-1.224744871391589*fr[6]+0.7071067811865475*fr[3])/vmap_prime_r[0]; 
  fUpR[3] = (1.58113883008419*fr[18]-1.224744871391589*fr[10]+0.7071067811865475*fr[5])/vmap_prime_r[0]; 
  fUpR[4] = (0.7071067811865475*fr[7]-1.224744871391589*fr[11])/vmap_prime_r[0]; 
  fUpR[5] = (0.7071067811865475*fr[9]-1.224744871391589*fr[16])/vmap_prime_r[0]; 
  fUpR[6] = (0.7071067811865475*fr[13]-1.224744871391589*fr[17])/vmap_prime_r[0]; 
  fUpR[7] = (0.7071067811865475*fr[15]-1.224744871391589*fr[19])/vmap_prime_r[0]; 
    } 
  } else { 
  double f_cr[8] = {0.};
  double f_rl[8] = {0.};
  ...
  f_cr[0] = (1.58113883008419*fc[8]+1.224744871391589*fc[2]+0.7071067811865475*fc[0])/vmap_prime_c[0]; 
  f_cr[1] = (1.58113883008419*fc[12]+1.224744871391589*fc[4]+0.7071067811865475*fc[1])/vmap_prime_c[0]; 
  f_cr[2] = (1.58113883008419*fc[14]+1.224744871391589*fc[6]+0.7071067811865475*fc[3])/vmap_prime_c[0]; 
  f_cr[3] = (1.58113883008419*fc[18]+1.224744871391589*fc[10]+0.7071067811865475*fc[5])/vmap_prime_c[0]; 
  f_cr[4] = (1.224744871391589*fc[11]+0.7071067811865475*fc[7])/vmap_prime_c[0]; 
  f_cr[5] = (1.224744871391589*fc[16]+0.7071067811865475*fc[9])/vmap_prime_c[0]; 
  f_cr[6] = (1.224744871391589*fc[17]+0.7071067811865475*fc[13])/vmap_prime_c[0]; 
  f_cr[7] = (1.224744871391589*fc[19]+0.7071067811865475*fc[15])/vmap_prime_c[0]; 

  f_rl[0] = (1.58113883008419*fr[8]-1.224744871391589*fr[2]+0.7071067811865475*fr[0])/vmap_prime_r[0]; 
  f_rl[1] = (1.58113883008419*fr[12]-1.224744871391589*fr[4]+0.7071067811865475*fr[1])/vmap_prime_r[0]; 
  f_rl[2] = (1.58113883008419*fr[14]-1.224744871391589*fr[6]+0.7071067811865475*fr[3])/vmap_prime_r[0]; 
  f_rl[3] = (1.58113883008419*fr[18]-1.224744871391589*fr[10]+0.7071067811865475*fr[5])/vmap_prime_r[0]; 
  f_rl[4] = (0.7071067811865475*fr[7]-1.224744871391589*fr[11])/vmap_prime_r[0]; 
  f_rl[5] = (0.7071067811865475*fr[9]-1.224744871391589*fr[16])/vmap_prime_r[0]; 
  f_rl[6] = (0.7071067811865475*fr[13]-1.224744871391589*fr[17])/vmap_prime_r[0]; 
  f_rl[7] = (0.7071067811865475*fr[15]-1.224744871391589*fr[19])/vmap_prime_r[0]; 
