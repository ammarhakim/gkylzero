...
GKYL_CU_DH void gyrokinetic_int_mom_1x1v_ser_p1(const double *w, const double *dxv, const int *idx, double m_, const double *bmag, const double *jacobgeo_inv, const double *f, double* GKYL_RESTRICT out); 
...
GKYL_CU_DH void gyrokinetic_int_mom_1x2v_ser_p1(const double *w, const double *dxv, const int *idx, double m_, const double *bmag, const double *jacobgeo_inv, const double *f, double* GKYL_RESTRICT out); 
...
GKYL_CU_DH void gyrokinetic_int_mom_2x2v_ser_p2(const double *w, const double *dxv, const int *idx, double m_, const double *bmag, const double *jacobgeo_inv, const double *f, double* GKYL_RESTRICT out); 
