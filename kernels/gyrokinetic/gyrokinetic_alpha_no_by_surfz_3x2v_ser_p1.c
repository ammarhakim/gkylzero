...
{ 
  ...
  alphaL2[0] = (((-0.7954951288348656*b_x[3]*jacobtot_inv[5]*hamil[16])+0.4592793267718456*b_x[0]*jacobtot_inv[5]*hamil[16]-0.7954951288348656*jacobtot_inv[3]*b_x[5]*hamil[16]+0.4592793267718456*jacobtot_inv[0]*b_x[5]*hamil[16]+0.4592793267718456*b_x[1]*jacobtot_inv[3]*hamil[16]+0.4592793267718456*jacobtot_inv[1]*b_x[3]*hamil[16]-0.2651650429449552*b_x[0]*jacobtot_inv[1]*hamil[16]-0.2651650429449552*jacobtot_inv[0]*b_x[1]*hamil[16]-0.7954951288348656*b_x[5]*jacobtot_inv[5]*hamil[8]+0.4592793267718456*b_x[1]*jacobtot_inv[5]*hamil[8]+0.4592793267718456*jacobtot_inv[1]*b_x[5]*hamil[8]-0.7954951288348656*b_x[3]*jacobtot_inv[3]*hamil[8]+0.4592793267718456*b_x[0]*jacobtot_inv[3]*hamil[8]+0.4592793267718456*jacobtot_inv[0]*b_x[3]*hamil[8]-0.2651650429449552*b_x[1]*jacobtot_inv[1]*hamil[8]-0.2651650429449552*b_x[0]*jacobtot_inv[0]*hamil[8]+0.4592793267718456*b_x[3]*jacobtot_inv[5]*hamil[6]-0.2651650429449552*b_x[0]*jacobtot_inv[5]*hamil[6]+0.4592793267718456*jacobtot_inv[3]*b_x[5]*hamil[6]-0.2651650429449552*jacobtot_inv[0]*b_x[5]*hamil[6]-0.2651650429449552*b_x[1]*jacobtot_inv[3]*hamil[6]-0.2651650429449552*jacobtot_inv[1]*b_x[3]*hamil[6]+0.1530931089239486*b_x[0]*jacobtot_inv[1]*hamil[6]+0.1530931089239486*jacobtot_inv[0]*b_x[1]*hamil[6]+0.4592793267718456*hamil[2]*b_x[5]*jacobtot_inv[5]-0.2651650429449552*b_x[1]*hamil[2]*jacobtot_inv[5]-0.2651650429449552*jacobtot_inv[1]*hamil[2]*b_x[5]+0.4592793267718456*hamil[2]*b_x[3]*jacobtot_inv[3]-0.2651650429449552*b_x[0]*hamil[2]*jacobtot_inv[3]-0.2651650429449552*jacobtot_inv[0]*hamil[2]*b_x[3]+0.1530931089239486*b_x[1]*jacobtot_inv[1]*hamil[2]+0.1530931089239486*b_x[0]*jacobtot_inv[0]*hamil[2])*rdy2)/q_+((0.4592793267718456*hamil[4]*cmag[5]*jacobtot_inv[5]-0.2651650429449552*cmag[1]*hamil[4]*jacobtot_inv[5]-0.2651650429449552*jacobtot_inv[1]*hamil[4]*cmag[5]+0.4592793267718456*cmag[3]*jacobtot_inv[3]*hamil[4]-0.2651650429449552*cmag[0]*jacobtot_inv[3]*hamil[4]-0.2651650429449552*jacobtot_inv[0]*cmag[3]*hamil[4]+0.1530931089239486*cmag[1]*jacobtot_inv[1]*hamil[4]+0.1530931089239486*cmag[0]*jacobtot_inv[0]*hamil[4])*rdvpar2)/m_; 
  alphaL2[1] = (((-1.431891231902758*b_x[5]*jacobtot_inv[5]*hamil[16])+0.826702788189322*b_x[1]*jacobtot_inv[5]*hamil[16]+0.826702788189322*jacobtot_inv[1]*b_x[5]*hamil[16]-0.7954951288348656*b_x[3]*jacobtot_inv[3]*hamil[16]+0.4592793267718456*b_x[0]*jacobtot_inv[3]*hamil[16]+0.4592793267718456*jacobtot_inv[0]*b_x[3]*hamil[16]-0.4772970773009194*b_x[1]*jacobtot_inv[1]*hamil[16]-0.2651650429449552*b_x[0]*jacobtot_inv[0]*hamil[16]-0.7954951288348656*b_x[3]*jacobtot_inv[5]*hamil[8]+0.4592793267718456*b_x[0]*jacobtot_inv[5]*hamil[8]-0.7954951288348656*jacobtot_inv[3]*b_x[5]*hamil[8]+0.4592793267718456*jacobtot_inv[0]*b_x[5]*hamil[8]+0.4592793267718456*b_x[1]*jacobtot_inv[3]*hamil[8]+0.4592793267718456*jacobtot_inv[1]*b_x[3]*hamil[8]-0.2651650429449552*b_x[0]*jacobtot_inv[1]*hamil[8]-0.2651650429449552*jacobtot_inv[0]*b_x[1]*hamil[8]+0.826702788189322*b_x[5]*jacobtot_inv[5]*hamil[6]-0.4772970773009194*b_x[1]*jacobtot_inv[5]*hamil[6]-0.4772970773009194*jacobtot_inv[1]*b_x[5]*hamil[6]+0.4592793267718456*b_x[3]*jacobtot_inv[3]*hamil[6]-0.2651650429449552*b_x[0]*jacobtot_inv[3]*hamil[6]-0.2651650429449552*jacobtot_inv[0]*b_x[3]*hamil[6]+0.2755675960631073*b_x[1]*jacobtot_inv[1]*hamil[6]+0.1530931089239486*b_x[0]*jacobtot_inv[0]*hamil[6]+0.4592793267718456*hamil[2]*b_x[3]*jacobtot_inv[5]-0.2651650429449552*b_x[0]*hamil[2]*jacobtot_inv[5]+0.4592793267718456*hamil[2]*jacobtot_inv[3]*b_x[5]-0.2651650429449552*jacobtot_inv[0]*hamil[2]*b_x[5]-0.2651650429449552*b_x[1]*hamil[2]*jacobtot_inv[3]-0.2651650429449552*jacobtot_inv[1]*hamil[2]*b_x[3]+0.1530931089239486*b_x[0]*jacobtot_inv[1]*hamil[2]+0.1530931089239486*jacobtot_inv[0]*b_x[1]*hamil[2])*rdy2)/q_+((0.4592793267718456*cmag[3]*hamil[4]*jacobtot_inv[5]-0.2651650429449552*cmag[0]*hamil[4]*jacobtot_inv[5]+0.4592793267718456*jacobtot_inv[3]*hamil[4]*cmag[5]-0.2651650429449552*jacobtot_inv[0]*hamil[4]*cmag[5]-0.2651650429449552*cmag[1]*jacobtot_inv[3]*hamil[4]-0.2651650429449552*jacobtot_inv[1]*cmag[3]*hamil[4]+0.1530931089239486*cmag[0]*jacobtot_inv[1]*hamil[4]+0.1530931089239486*jacobtot_inv[0]*cmag[1]*hamil[4])*rdvpar2)/m_; 
  alphaL2[3] = ((1.026979795322186*cmag[5]*jacobtot_inv[5]*hamil[32]-0.592927061281571*cmag[1]*jacobtot_inv[5]*hamil[32]-0.592927061281571*jacobtot_inv[1]*cmag[5]*hamil[32]+1.026979795322186*cmag[3]*jacobtot_inv[3]*hamil[32]-0.592927061281571*cmag[0]*jacobtot_inv[3]*hamil[32]-0.592927061281571*jacobtot_inv[0]*cmag[3]*hamil[32]+0.3423265984407287*cmag[1]*jacobtot_inv[1]*hamil[32]+0.3423265984407287*cmag[0]*jacobtot_inv[0]*hamil[32])*rdvpar2)/m_; 
  alphaL2[6] = ((1.026979795322186*cmag[3]*jacobtot_inv[5]*hamil[32]-0.592927061281571*cmag[0]*jacobtot_inv[5]*hamil[32]+1.026979795322186*jacobtot_inv[3]*cmag[5]*hamil[32]-0.592927061281571*jacobtot_inv[0]*cmag[5]*hamil[32]-0.592927061281571*cmag[1]*jacobtot_inv[3]*hamil[32]-0.592927061281571*jacobtot_inv[1]*cmag[3]*hamil[32]+0.3423265984407287*cmag[0]*jacobtot_inv[1]*hamil[32]+0.3423265984407287*jacobtot_inv[0]*cmag[1]*hamil[32])*rdvpar2)/m_; 

  double *sgn_alpha_surf2 = &sgn_alpha_surf[48];
  int const_sgn_alpha_surf = 1; 
  
  if (0.3354101966249678*alphaL2[6]-0.3354101966249678*alphaL2[3]-0.25*alphaL2[1]+0.25*alphaL2[0] > 0.) 
    sgn_alpha_surf2[0] = 1.0; 
  else  
    sgn_alpha_surf2[0] = -1.0; 
  
  if (0.25*alphaL2[0]-0.25*alphaL2[1] > 0.) 
  ...
  if (0.25*(alphaL2[1]+alphaL2[0])-0.3354101966249678*(alphaL2[6]+alphaL2[3]) > 0.) 
  ...
  if (0.3354101966249678*(alphaL2[6]+alphaL2[3])+0.25*(alphaL2[1]+alphaL2[0]) > 0.) 
