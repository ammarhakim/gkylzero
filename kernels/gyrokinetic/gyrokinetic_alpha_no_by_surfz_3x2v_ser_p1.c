...
{ 
  ...
  alphaL[3] = (0.7905694150420947*cmag_surf[1]*jacobtot_inv_surf[1]*hamil[16]+0.7905694150420947*cmag_surf[0]*jacobtot_inv_surf[0]*hamil[16])/(vmap[1]*m_); 
  alphaL[6] = (0.7905694150420947*cmag_surf[0]*jacobtot_inv_surf[1]*hamil[16]+0.7905694150420947*jacobtot_inv_surf[0]*cmag_surf[1]*hamil[16])/(vmap[1]*m_); 
