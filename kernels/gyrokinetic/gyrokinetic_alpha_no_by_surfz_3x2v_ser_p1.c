...
{ 
  ...
  alphaL[3] = ((1.026979795322186*cmag[5]*jacobtot_inv[5]*hamil[32]-0.592927061281571*cmag[1]*jacobtot_inv[5]*hamil[32]-0.592927061281571*jacobtot_inv[1]*cmag[5]*hamil[32]+1.026979795322186*cmag[3]*jacobtot_inv[3]*hamil[32]-0.592927061281571*cmag[0]*jacobtot_inv[3]*hamil[32]-0.592927061281571*jacobtot_inv[0]*cmag[3]*hamil[32]+0.3423265984407287*cmag[1]*jacobtot_inv[1]*hamil[32]+0.3423265984407287*cmag[0]*jacobtot_inv[0]*hamil[32])*rdvpar2)/m_; 
  alphaL[6] = ((1.026979795322186*cmag[3]*jacobtot_inv[5]*hamil[32]-0.592927061281571*cmag[0]*jacobtot_inv[5]*hamil[32]+1.026979795322186*jacobtot_inv[3]*cmag[5]*hamil[32]-0.592927061281571*jacobtot_inv[0]*cmag[5]*hamil[32]-0.592927061281571*cmag[1]*jacobtot_inv[3]*hamil[32]-0.592927061281571*jacobtot_inv[1]*cmag[3]*hamil[32]+0.3423265984407287*cmag[0]*jacobtot_inv[1]*hamil[32]+0.3423265984407287*jacobtot_inv[0]*cmag[1]*hamil[32])*rdvpar2)/m_; 

  int const_sgn_alpha_surf = 1;  
  
  if (0.3354101966249678*alphaL[6]-0.3354101966249678*alphaL[3]-0.25*alphaL[1]+0.25*alphaL[0] > 0.) {
  ...
  if (0.25*(alphaL[1]+alphaL[0])-0.3354101966249678*(alphaL[6]+alphaL[3]) > 0.) {
  ...
  if (0.3354101966249678*(alphaL[6]+alphaL[3])+0.25*(alphaL[1]+alphaL[0]) > 0.) {
