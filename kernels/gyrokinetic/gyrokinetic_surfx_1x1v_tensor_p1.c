...
{ 
  ...
  double alphaL[2]; 
  alphaL[0] = (0.3535533905932737*(1.732050807568877*BstarZdBmag[0]-3.0*BstarZdBmag[1])*hamil[2]*rdvpar2)/m_; 
  alphaL[1] = (0.3535533905932737*hamil[2]*(1.732050807568877*BstarZdBmag[2]-3.0*BstarZdBmag[3])*rdvpar2)/m_; 
