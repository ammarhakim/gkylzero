...
{ 
  ...
  double hamil[12] = {0.}; 
  hamil[0] = (2.449489742783179*phi[1]+1.414213562373095*phi[0])*q_+0.7071067811865475*vmapSq[0]*m_; 
...
alphahat_quad = ((0.408248290463863*dxv[1]*(0.8660254037844386*hamil[1]-2.598076211353316*hamil[4]))/vmap[1])/m_/bmag_quad * B3_quad ;
alphahat_quad += ((0.408248290463863*dxv[1]*(0.8660254037844386*hamil[1]-2.598076211353316*hamil[4]))/vmap[1])/m_/bmag_quad * (0.8660254037844386*hamil[1]-2.598076211353316*hamil[4])/q_ * normcurlbhat_quad ;
...
alphahat_quad = ((0.3535533905932737*dxv[1]*hamil[1])/vmap[1])/m_/bmag_quad * B3_quad ;
alphahat_quad += ((0.3535533905932737*dxv[1]*hamil[1])/vmap[1])/m_/bmag_quad * (0.8660254037844386*hamil[1])/q_ * normcurlbhat_quad ;
...
alphahat_quad = ((0.408248290463863*dxv[1]*(2.598076211353316*hamil[4]+0.8660254037844386*hamil[1]))/vmap[1])/m_/bmag_quad * B3_quad ;
alphahat_quad += ((0.408248290463863*dxv[1]*(2.598076211353316*hamil[4]+0.8660254037844386*hamil[1]))/vmap[1])/m_/bmag_quad * (2.598076211353316*hamil[4]+0.8660254037844386*hamil[1])/q_ * normcurlbhat_quad ;
