...
{ 
  ...
  if (alphaR[2]-1.499999999999997*alphaR[1]+1.118033988749892*alphaR[0] > 0.) {
    fUpOrdR[0] = fskin[8]-1.5*fskin[7]+0.7745966692414833*fskin[6]+1.118033988749895*fskin[5]+0.4472135954999579*fskin[4]-1.161895003862225*fskin[3]+0.8660254037844386*fskin[2]-0.6708203932499369*fskin[1]+0.5*fskin[0]; 
  } else {
    fUpOrdR[0] = fedge[8]-1.5*fedge[7]-0.7745966692414833*fedge[6]+1.118033988749895*fedge[5]+0.4472135954999579*fedge[4]+1.161895003862225*fedge[3]-0.8660254037844386*fedge[2]-0.6708203932499369*fedge[1]+0.5*fedge[0]; 
  }
  if (alphaR[0]-1.118033988749896*alphaR[2] > 0.) {
    fUpOrdR[1] = (-1.25*fskin[8])-0.9682458365518543*fskin[6]+1.118033988749895*fskin[5]-0.5590169943749475*fskin[4]+0.8660254037844386*fskin[2]+0.5*fskin[0]; 
  } else {
    fUpOrdR[1] = (-1.25*fedge[8])+0.9682458365518543*fedge[6]+1.118033988749895*fedge[5]-0.5590169943749475*fedge[4]-0.8660254037844386*fedge[2]+0.5*fedge[0]; 
  }
  if (alphaR[2]+1.499999999999997*alphaR[1]+1.118033988749892*alphaR[0] > 0.) {
    fUpOrdR[2] = fskin[8]+1.5*fskin[7]+0.7745966692414833*fskin[6]+1.118033988749895*fskin[5]+0.4472135954999579*fskin[4]+1.161895003862225*fskin[3]+0.8660254037844386*fskin[2]+0.6708203932499369*fskin[1]+0.5*fskin[0]; 
  } else {
    fUpOrdR[2] = fedge[8]+1.5*fedge[7]-0.7745966692414833*fedge[6]+1.118033988749895*fedge[5]+0.4472135954999579*fedge[4]-1.161895003862225*fedge[3]-0.8660254037844386*fedge[2]+0.6708203932499369*fedge[1]+0.5*fedge[0]; 
  }
  ...
  if (alphaL[2]-1.499999999999997*alphaL[1]+1.118033988749892*alphaL[0] > 0.) {
    fUpOrdL[0] = fedge[8]-1.5*fedge[7]+0.7745966692414833*fedge[6]+1.118033988749895*fedge[5]+0.4472135954999579*fedge[4]-1.161895003862225*fedge[3]+0.8660254037844386*fedge[2]-0.6708203932499369*fedge[1]+0.5*fedge[0]; 
  } else {
    fUpOrdL[0] = fskin[8]-1.5*fskin[7]-0.7745966692414833*fskin[6]+1.118033988749895*fskin[5]+0.4472135954999579*fskin[4]+1.161895003862225*fskin[3]-0.8660254037844386*fskin[2]-0.6708203932499369*fskin[1]+0.5*fskin[0]; 
  }
  if (alphaL[0]-1.118033988749896*alphaL[2] > 0.) {
    fUpOrdL[1] = (-1.25*fedge[8])-0.9682458365518543*fedge[6]+1.118033988749895*fedge[5]-0.5590169943749475*fedge[4]+0.8660254037844386*fedge[2]+0.5*fedge[0]; 
  } else {
    fUpOrdL[1] = (-1.25*fskin[8])+0.9682458365518543*fskin[6]+1.118033988749895*fskin[5]-0.5590169943749475*fskin[4]-0.8660254037844386*fskin[2]+0.5*fskin[0]; 
  }
  if (alphaL[2]+1.499999999999997*alphaL[1]+1.118033988749892*alphaL[0] > 0.) {
    fUpOrdL[2] = fedge[8]+1.5*fedge[7]+0.7745966692414833*fedge[6]+1.118033988749895*fedge[5]+0.4472135954999579*fedge[4]+1.161895003862225*fedge[3]+0.8660254037844386*fedge[2]+0.6708203932499369*fedge[1]+0.5*fedge[0]; 
  } else {
    fUpOrdL[2] = fskin[8]+1.5*fskin[7]-0.7745966692414833*fskin[6]+1.118033988749895*fskin[5]+0.4472135954999579*fskin[4]-1.161895003862225*fskin[3]-0.8660254037844386*fskin[2]+0.6708203932499369*fskin[1]+0.5*fskin[0]; 
  }
