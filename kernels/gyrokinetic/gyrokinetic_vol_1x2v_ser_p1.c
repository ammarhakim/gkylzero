...
{ 
  ...
  alphax[2] = (2.23606797749979*cmag[0]*hamil[8]*rdx2)/(vmap[1]*m_); 
  alphax[4] = (2.23606797749979*cmag[1]*hamil[8]*rdx2)/(vmap[1]*m_); 

  double alphavpar[12] = {0.}; 
  alphavpar[0] = -((1.0*cmag[0]*hamil[1]*rdx2)/(vmap[1]*m_)); 
  alphavpar[1] = -((1.0*cmag[1]*hamil[1]*rdx2)/(vmap[1]*m_)); 
  alphavpar[3] = -((1.0*cmag[0]*hamil[5]*rdx2)/(vmap[1]*m_)); 
  alphavpar[5] = -((1.0*cmag[1]*hamil[5]*rdx2)/(vmap[1]*m_)); 
...
{ 
  ...
  out[8] += -((2.7386127875258306*(apardot[1]*fin[4]+apardot[0]*fin[2])*q_*rdvpar2)/m_); 
  out[9] += -((2.7386127875258306*(apardot[0]*fin[4]+apardot[1]*fin[2])*q_*rdvpar2)/m_); 
  out[10] += -((2.7386127875258306*(apardot[1]*fin[7]+apardot[0]*fin[6])*q_*rdvpar2)/m_); 
  out[11] += -((2.7386127875258306*(apardot[0]*fin[7]+apardot[1]*fin[6])*q_*rdvpar2)/m_); 
  double cflFreq = 0.0; 
  double alphaL = 0.0; 
  double alphaR = 0.0; 
