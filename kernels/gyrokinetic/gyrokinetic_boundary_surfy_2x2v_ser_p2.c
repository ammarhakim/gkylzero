...
GKYL_CU_DH double gyrokinetic_boundary_surfy_2x2v_ser_p2(const double *w, const double *dxv, const double *alpha_edge, const double *alpha_skin, const int edge, const double *fedge, const double *fskin, double* GKYL_RESTRICT out) 
{ 
  // w[NDIM]: cell-center.
  ...
  const double *alphaR = &alpha_edge[20];
  double fUpOrdR[27] = {0.};
  double alphaR_n = 0.;
  ...
  const double *alphaL = &alpha_skin[20];
  double fUpOrdL[27] = {0.};
  double alphaL_n = 0.;
