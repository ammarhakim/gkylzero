...
GKYL_CU_DH void gyrokinetic_flux_surfx_1x1v_ser_p1(const struct gkyl_basis *basis, const double *w, const double *dxv,
...
GKYL_CU_DH void gyrokinetic_flux_no_by_surfx_1x1v_ser_p1(const struct gkyl_basis *basis, const double *w, const double *dxv,
              const double *vmap, const double *vmapSq, const double q_, const double m_, const struct gkyl_dg_surf_geom *dgs, const struct gkyl_gk_dg_surf_geom *gkdgs, 
              const double *bmag, const double *phi, double* GKYL_RESTRICT flux_surf); 
GKYL_CU_DH void gyrokinetic_flux_edge_surfx_1x1v_ser_p1(const struct gkyl_basis *basis, const double *w, const double *dxv,
                const double *vmap, const double *vmapSq, const double q_, const double m_, const struct gkyl_dg_surf_geom *dgs, const struct gkyl_gk_dg_surf_geom *gkdgs, 
                const double *bmag, const double *phi, double* GKYL_RESTRICT flux_surf); 
...
GKYL_CU_DH double gyrokinetic_no_by_boundary_fluxx_1x1v_ser_p1(const double *w, const double *dxv,
                ...
                const double *flux_surf_edge, const double *flux_surf_skin, 
                const int edge, double* GKYL_RESTRICT out); 
GKYL_CU_DH void gyrokinetic_flux_surfvpar_1x1v_ser_p1(const struct gkyl_basis *basis, const double *w, const double *dxv,
              const double *vmap, const double *vmapSq, const double q_, const double m_, const struct gkyl_dg_vol_geom *dgv, const struct gkyl_gk_dg_vol_geom *gkdgv, 
              const double *bmag, const double *phi, double* GKYL_RESTRICT flux_surf); 
GKYL_CU_DH void gyrokinetic_flux_no_by_surfvpar_1x1v_ser_p1(const struct gkyl_basis *basis, const double *w, const double *dxv,
              const double *vmap, const double *vmapSq, const double q_, const double m_, const struct gkyl_dg_vol_geom *dgv, const struct gkyl_gk_dg_vol_geom *gkdgv, 
              const double *bmag, const double *phi, double* GKYL_RESTRICT flux_surf); 
...
GKYL_CU_DH double gyrokinetic_step2_vol_1x1v_ser_p2(const double *w, const double *dxv,
            const double q_, const double m_, const double *apardot, const double *f, double* GKYL_RESTRICT out); 
GKYL_CU_DH void gyrokinetic_flux_surfx_1x1v_ser_p2(const struct gkyl_basis *basis, const double *w, const double *dxv,
              const double *vmap, const double *vmapSq, const double q_, const double m_, const struct gkyl_dg_surf_geom *dgs, const struct gkyl_gk_dg_surf_geom *gkdgs, 
              const double *bmag, const double *phi, double* GKYL_RESTRICT flux_surf); 
GKYL_CU_DH void gyrokinetic_flux_no_by_surfx_1x1v_ser_p2(const struct gkyl_basis *basis, const double *w, const double *dxv,
              const double *vmap, const double *vmapSq, const double q_, const double m_, const struct gkyl_dg_surf_geom *dgs, const struct gkyl_gk_dg_surf_geom *gkdgs, 
              const double *bmag, const double *phi, double* GKYL_RESTRICT flux_surf); 
GKYL_CU_DH void gyrokinetic_flux_edge_surfx_1x1v_ser_p2(const struct gkyl_basis *basis, const double *w, const double *dxv,
                const double *vmap, const double *vmapSq, const double q_, const double m_, const struct gkyl_dg_surf_geom *dgs, const struct gkyl_gk_dg_surf_geom *gkdgs, 
                const double *bmag, const double *phi, double* GKYL_RESTRICT flux_surf); 
...
GKYL_CU_DH double gyrokinetic_no_by_boundary_fluxx_1x1v_ser_p2(const double *w, const double *dxv,
                ...
                const double *flux_surf_edge, const double *flux_surf_skin, 
                const int edge, double* GKYL_RESTRICT out); 
GKYL_CU_DH void gyrokinetic_flux_surfvpar_1x1v_ser_p2(const struct gkyl_basis *basis, const double *w, const double *dxv,
              const double *vmap, const double *vmapSq, const double q_, const double m_, const struct gkyl_dg_vol_geom *dgv, const struct gkyl_gk_dg_vol_geom *gkdgv, 
              const double *bmag, const double *phi, double* GKYL_RESTRICT flux_surf); 
GKYL_CU_DH void gyrokinetic_flux_no_by_surfvpar_1x1v_ser_p2(const struct gkyl_basis *basis, const double *w, const double *dxv,
              const double *vmap, const double *vmapSq, const double q_, const double m_, const struct gkyl_dg_vol_geom *dgv, const struct gkyl_gk_dg_vol_geom *gkdgv, 
              const double *bmag, const double *phi, double* GKYL_RESTRICT flux_surf); 
...
GKYL_CU_DH double gyrokinetic_step2_vol_1x2v_ser_p1(const double *w, const double *dxv,
            const double q_, const double m_, const double *apardot, const double *f, double* GKYL_RESTRICT out); 
GKYL_CU_DH void gyrokinetic_flux_surfx_1x2v_ser_p1(const struct gkyl_basis *basis, const double *w, const double *dxv,
              const double *vmap, const double *vmapSq, const double q_, const double m_, const struct gkyl_dg_surf_geom *dgs, const struct gkyl_gk_dg_surf_geom *gkdgs, 
              const double *bmag, const double *phi, double* GKYL_RESTRICT flux_surf); 
GKYL_CU_DH void gyrokinetic_flux_no_by_surfx_1x2v_ser_p1(const struct gkyl_basis *basis, const double *w, const double *dxv,
              const double *vmap, const double *vmapSq, const double q_, const double m_, const struct gkyl_dg_surf_geom *dgs, const struct gkyl_gk_dg_surf_geom *gkdgs, 
              const double *bmag, const double *phi, double* GKYL_RESTRICT flux_surf); 
GKYL_CU_DH void gyrokinetic_flux_edge_surfx_1x2v_ser_p1(const struct gkyl_basis *basis, const double *w, const double *dxv,
                const double *vmap, const double *vmapSq, const double q_, const double m_, const struct gkyl_dg_surf_geom *dgs, const struct gkyl_gk_dg_surf_geom *gkdgs, 
                const double *bmag, const double *phi, double* GKYL_RESTRICT flux_surf); 
...
GKYL_CU_DH double gyrokinetic_no_by_boundary_fluxx_1x2v_ser_p1(const double *w, const double *dxv,
                ...
                const double *flux_surf_edge, const double *flux_surf_skin, 
                const int edge, double* GKYL_RESTRICT out); 
GKYL_CU_DH void gyrokinetic_flux_surfvpar_1x2v_ser_p1(const struct gkyl_basis *basis, const double *w, const double *dxv,
              const double *vmap, const double *vmapSq, const double q_, const double m_, const struct gkyl_dg_vol_geom *dgv, const struct gkyl_gk_dg_vol_geom *gkdgv, 
              const double *bmag, const double *phi, double* GKYL_RESTRICT flux_surf); 
GKYL_CU_DH void gyrokinetic_flux_no_by_surfvpar_1x2v_ser_p1(const struct gkyl_basis *basis, const double *w, const double *dxv,
              const double *vmap, const double *vmapSq, const double q_, const double m_, const struct gkyl_dg_vol_geom *dgv, const struct gkyl_gk_dg_vol_geom *gkdgv, 
              const double *bmag, const double *phi, double* GKYL_RESTRICT flux_surf); 
...
GKYL_CU_DH double gyrokinetic_step2_vol_1x2v_ser_p2(const double *w, const double *dxv,
            const double q_, const double m_, const double *apardot, const double *f, double* GKYL_RESTRICT out); 
GKYL_CU_DH void gyrokinetic_flux_surfx_1x2v_ser_p2(const struct gkyl_basis *basis, const double *w, const double *dxv,
              const double *vmap, const double *vmapSq, const double q_, const double m_, const struct gkyl_dg_surf_geom *dgs, const struct gkyl_gk_dg_surf_geom *gkdgs, 
              const double *bmag, const double *phi, double* GKYL_RESTRICT flux_surf); 
GKYL_CU_DH void gyrokinetic_flux_no_by_surfx_1x2v_ser_p2(const struct gkyl_basis *basis, const double *w, const double *dxv,
              const double *vmap, const double *vmapSq, const double q_, const double m_, const struct gkyl_dg_surf_geom *dgs, const struct gkyl_gk_dg_surf_geom *gkdgs, 
              const double *bmag, const double *phi, double* GKYL_RESTRICT flux_surf); 
GKYL_CU_DH void gyrokinetic_flux_edge_surfx_1x2v_ser_p2(const struct gkyl_basis *basis, const double *w, const double *dxv,
                const double *vmap, const double *vmapSq, const double q_, const double m_, const struct gkyl_dg_surf_geom *dgs, const struct gkyl_gk_dg_surf_geom *gkdgs, 
                const double *bmag, const double *phi, double* GKYL_RESTRICT flux_surf); 
...
GKYL_CU_DH double gyrokinetic_no_by_boundary_fluxx_1x2v_ser_p2(const double *w, const double *dxv,
                ...
                const double *flux_surf_edge, const double *flux_surf_skin, 
                const int edge, double* GKYL_RESTRICT out); 
GKYL_CU_DH void gyrokinetic_flux_surfvpar_1x2v_ser_p2(const struct gkyl_basis *basis, const double *w, const double *dxv,
              const double *vmap, const double *vmapSq, const double q_, const double m_, const struct gkyl_dg_vol_geom *dgv, const struct gkyl_gk_dg_vol_geom *gkdgv, 
              const double *bmag, const double *phi, double* GKYL_RESTRICT flux_surf); 
GKYL_CU_DH void gyrokinetic_flux_no_by_surfvpar_1x2v_ser_p2(const struct gkyl_basis *basis, const double *w, const double *dxv,
              const double *vmap, const double *vmapSq, const double q_, const double m_, const struct gkyl_dg_vol_geom *dgv, const struct gkyl_gk_dg_vol_geom *gkdgv, 
              const double *bmag, const double *phi, double* GKYL_RESTRICT flux_surf); 
...
GKYL_CU_DH double gyrokinetic_step2_vol_2x2v_ser_p1(const double *w, const double *dxv,
            const double q_, const double m_, const double *apardot, const double *f, double* GKYL_RESTRICT out); 
GKYL_CU_DH void gyrokinetic_flux_surfx_2x2v_ser_p1(const struct gkyl_basis *basis, const double *w, const double *dxv,
              const double *vmap, const double *vmapSq, const double q_, const double m_, const struct gkyl_dg_surf_geom *dgs, const struct gkyl_gk_dg_surf_geom *gkdgs, 
              const double *bmag, const double *phi, double* GKYL_RESTRICT flux_surf); 
GKYL_CU_DH void gyrokinetic_flux_no_by_surfx_2x2v_ser_p1(const struct gkyl_basis *basis, const double *w, const double *dxv,
              const double *vmap, const double *vmapSq, const double q_, const double m_, const struct gkyl_dg_surf_geom *dgs, const struct gkyl_gk_dg_surf_geom *gkdgs, 
              const double *bmag, const double *phi, double* GKYL_RESTRICT flux_surf); 
GKYL_CU_DH void gyrokinetic_flux_edge_surfx_2x2v_ser_p1(const struct gkyl_basis *basis, const double *w, const double *dxv,
                const double *vmap, const double *vmapSq, const double q_, const double m_, const struct gkyl_dg_surf_geom *dgs, const struct gkyl_gk_dg_surf_geom *gkdgs, 
                const double *bmag, const double *phi, double* GKYL_RESTRICT flux_surf); 
...
GKYL_CU_DH double gyrokinetic_no_by_boundary_fluxx_2x2v_ser_p1(const double *w, const double *dxv,
                ...
                const double *flux_surf_edge, const double *flux_surf_skin, 
                const int edge, double* GKYL_RESTRICT out); 
GKYL_CU_DH void gyrokinetic_flux_surfy_2x2v_ser_p1(const struct gkyl_basis *basis, const double *w, const double *dxv,
              const double *vmap, const double *vmapSq, const double q_, const double m_, const struct gkyl_dg_surf_geom *dgs, const struct gkyl_gk_dg_surf_geom *gkdgs, 
              const double *bmag, const double *phi, double* GKYL_RESTRICT flux_surf); 
GKYL_CU_DH void gyrokinetic_flux_no_by_surfy_2x2v_ser_p1(const struct gkyl_basis *basis, const double *w, const double *dxv,
              const double *vmap, const double *vmapSq, const double q_, const double m_, const struct gkyl_dg_surf_geom *dgs, const struct gkyl_gk_dg_surf_geom *gkdgs, 
              const double *bmag, const double *phi, double* GKYL_RESTRICT flux_surf); 
GKYL_CU_DH void gyrokinetic_flux_edge_surfy_2x2v_ser_p1(const struct gkyl_basis *basis, const double *w, const double *dxv,
                const double *vmap, const double *vmapSq, const double q_, const double m_, const struct gkyl_dg_surf_geom *dgs, const struct gkyl_gk_dg_surf_geom *gkdgs, 
                const double *bmag, const double *phi, double* GKYL_RESTRICT flux_surf); 
...
GKYL_CU_DH double gyrokinetic_no_by_boundary_fluxy_2x2v_ser_p1(const double *w, const double *dxv,
                ...
                const double *flux_surf_edge, const double *flux_surf_skin, 
                const int edge, double* GKYL_RESTRICT out); 
GKYL_CU_DH void gyrokinetic_flux_surfvpar_2x2v_ser_p1(const struct gkyl_basis *basis, const double *w, const double *dxv,
              const double *vmap, const double *vmapSq, const double q_, const double m_, const struct gkyl_dg_vol_geom *dgv, const struct gkyl_gk_dg_vol_geom *gkdgv, 
              const double *bmag, const double *phi, double* GKYL_RESTRICT flux_surf); 
GKYL_CU_DH void gyrokinetic_flux_no_by_surfvpar_2x2v_ser_p1(const struct gkyl_basis *basis, const double *w, const double *dxv,
              const double *vmap, const double *vmapSq, const double q_, const double m_, const struct gkyl_dg_vol_geom *dgv, const struct gkyl_gk_dg_vol_geom *gkdgv, 
              const double *bmag, const double *phi, double* GKYL_RESTRICT flux_surf); 
...
GKYL_CU_DH double gyrokinetic_step2_vol_2x2v_ser_p2(const double *w, const double *dxv,
            const double q_, const double m_, const double *apardot, const double *f, double* GKYL_RESTRICT out); 
GKYL_CU_DH void gyrokinetic_flux_surfx_2x2v_ser_p2(const struct gkyl_basis *basis, const double *w, const double *dxv,
              const double *vmap, const double *vmapSq, const double q_, const double m_, const struct gkyl_dg_surf_geom *dgs, const struct gkyl_gk_dg_surf_geom *gkdgs, 
              const double *bmag, const double *phi, double* GKYL_RESTRICT flux_surf); 
GKYL_CU_DH void gyrokinetic_flux_no_by_surfx_2x2v_ser_p2(const struct gkyl_basis *basis, const double *w, const double *dxv,
              const double *vmap, const double *vmapSq, const double q_, const double m_, const struct gkyl_dg_surf_geom *dgs, const struct gkyl_gk_dg_surf_geom *gkdgs, 
              const double *bmag, const double *phi, double* GKYL_RESTRICT flux_surf); 
GKYL_CU_DH void gyrokinetic_flux_edge_surfx_2x2v_ser_p2(const struct gkyl_basis *basis, const double *w, const double *dxv,
                const double *vmap, const double *vmapSq, const double q_, const double m_, const struct gkyl_dg_surf_geom *dgs, const struct gkyl_gk_dg_surf_geom *gkdgs, 
                const double *bmag, const double *phi, double* GKYL_RESTRICT flux_surf); 
...
GKYL_CU_DH double gyrokinetic_no_by_boundary_fluxx_2x2v_ser_p2(const double *w, const double *dxv,
                ...
                const double *flux_surf_edge, const double *flux_surf_skin, 
                const int edge, double* GKYL_RESTRICT out); 
GKYL_CU_DH void gyrokinetic_flux_surfy_2x2v_ser_p2(const struct gkyl_basis *basis, const double *w, const double *dxv,
              const double *vmap, const double *vmapSq, const double q_, const double m_, const struct gkyl_dg_surf_geom *dgs, const struct gkyl_gk_dg_surf_geom *gkdgs, 
              const double *bmag, const double *phi, double* GKYL_RESTRICT flux_surf); 
GKYL_CU_DH void gyrokinetic_flux_no_by_surfy_2x2v_ser_p2(const struct gkyl_basis *basis, const double *w, const double *dxv,
              const double *vmap, const double *vmapSq, const double q_, const double m_, const struct gkyl_dg_surf_geom *dgs, const struct gkyl_gk_dg_surf_geom *gkdgs, 
              const double *bmag, const double *phi, double* GKYL_RESTRICT flux_surf); 
GKYL_CU_DH void gyrokinetic_flux_edge_surfy_2x2v_ser_p2(const struct gkyl_basis *basis, const double *w, const double *dxv,
                const double *vmap, const double *vmapSq, const double q_, const double m_, const struct gkyl_dg_surf_geom *dgs, const struct gkyl_gk_dg_surf_geom *gkdgs, 
                const double *bmag, const double *phi, double* GKYL_RESTRICT flux_surf); 
...
GKYL_CU_DH double gyrokinetic_no_by_boundary_fluxy_2x2v_ser_p2(const double *w, const double *dxv,
                ...
                const double *flux_surf_edge, const double *flux_surf_skin, 
                const int edge, double* GKYL_RESTRICT out); 
GKYL_CU_DH void gyrokinetic_flux_surfvpar_2x2v_ser_p2(const struct gkyl_basis *basis, const double *w, const double *dxv,
              const double *vmap, const double *vmapSq, const double q_, const double m_, const struct gkyl_dg_vol_geom *dgv, const struct gkyl_gk_dg_vol_geom *gkdgv, 
              const double *bmag, const double *phi, double* GKYL_RESTRICT flux_surf); 
GKYL_CU_DH void gyrokinetic_flux_no_by_surfvpar_2x2v_ser_p2(const struct gkyl_basis *basis, const double *w, const double *dxv,
              const double *vmap, const double *vmapSq, const double q_, const double m_, const struct gkyl_dg_vol_geom *dgv, const struct gkyl_gk_dg_vol_geom *gkdgv, 
              const double *bmag, const double *phi, double* GKYL_RESTRICT flux_surf); 
...
GKYL_CU_DH double gyrokinetic_step2_vol_3x2v_ser_p1(const double *w, const double *dxv,
            const double q_, const double m_, const double *apardot, const double *f, double* GKYL_RESTRICT out); 
GKYL_CU_DH void gyrokinetic_flux_surfx_3x2v_ser_p1(const struct gkyl_basis *basis, const double *w, const double *dxv,
              const double *vmap, const double *vmapSq, const double q_, const double m_, const struct gkyl_dg_surf_geom *dgs, const struct gkyl_gk_dg_surf_geom *gkdgs, 
              const double *bmag, const double *phi, double* GKYL_RESTRICT flux_surf); 
GKYL_CU_DH void gyrokinetic_flux_no_by_surfx_3x2v_ser_p1(const struct gkyl_basis *basis, const double *w, const double *dxv,
              const double *vmap, const double *vmapSq, const double q_, const double m_, const struct gkyl_dg_surf_geom *dgs, const struct gkyl_gk_dg_surf_geom *gkdgs, 
              const double *bmag, const double *phi, double* GKYL_RESTRICT flux_surf); 
GKYL_CU_DH void gyrokinetic_flux_edge_surfx_3x2v_ser_p1(const struct gkyl_basis *basis, const double *w, const double *dxv,
                const double *vmap, const double *vmapSq, const double q_, const double m_, const struct gkyl_dg_surf_geom *dgs, const struct gkyl_gk_dg_surf_geom *gkdgs, 
                const double *bmag, const double *phi, double* GKYL_RESTRICT flux_surf); 
...
GKYL_CU_DH double gyrokinetic_no_by_boundary_fluxx_3x2v_ser_p1(const double *w, const double *dxv,
                ...
                const double *flux_surf_edge, const double *flux_surf_skin, 
                const int edge, double* GKYL_RESTRICT out); 
GKYL_CU_DH void gyrokinetic_flux_surfy_3x2v_ser_p1(const struct gkyl_basis *basis, const double *w, const double *dxv,
              const double *vmap, const double *vmapSq, const double q_, const double m_, const struct gkyl_dg_surf_geom *dgs, const struct gkyl_gk_dg_surf_geom *gkdgs, 
              const double *bmag, const double *phi, double* GKYL_RESTRICT flux_surf); 
GKYL_CU_DH void gyrokinetic_flux_no_by_surfy_3x2v_ser_p1(const struct gkyl_basis *basis, const double *w, const double *dxv,
              const double *vmap, const double *vmapSq, const double q_, const double m_, const struct gkyl_dg_surf_geom *dgs, const struct gkyl_gk_dg_surf_geom *gkdgs, 
              const double *bmag, const double *phi, double* GKYL_RESTRICT flux_surf); 
GKYL_CU_DH void gyrokinetic_flux_edge_surfy_3x2v_ser_p1(const struct gkyl_basis *basis, const double *w, const double *dxv,
                const double *vmap, const double *vmapSq, const double q_, const double m_, const struct gkyl_dg_surf_geom *dgs, const struct gkyl_gk_dg_surf_geom *gkdgs, 
                const double *bmag, const double *phi, double* GKYL_RESTRICT flux_surf); 
...
GKYL_CU_DH double gyrokinetic_no_by_boundary_fluxy_3x2v_ser_p1(const double *w, const double *dxv,
                ...
                const double *flux_surf_edge, const double *flux_surf_skin, 
                const int edge, double* GKYL_RESTRICT out); 
GKYL_CU_DH void gyrokinetic_flux_surfz_3x2v_ser_p1(const struct gkyl_basis *basis, const double *w, const double *dxv,
              const double *vmap, const double *vmapSq, const double q_, const double m_, const struct gkyl_dg_surf_geom *dgs, const struct gkyl_gk_dg_surf_geom *gkdgs, 
              const double *bmag, const double *phi, double* GKYL_RESTRICT flux_surf); 
GKYL_CU_DH void gyrokinetic_flux_no_by_surfz_3x2v_ser_p1(const struct gkyl_basis *basis, const double *w, const double *dxv,
              const double *vmap, const double *vmapSq, const double q_, const double m_, const struct gkyl_dg_surf_geom *dgs, const struct gkyl_gk_dg_surf_geom *gkdgs, 
              const double *bmag, const double *phi, double* GKYL_RESTRICT flux_surf); 
GKYL_CU_DH void gyrokinetic_flux_edge_surfz_3x2v_ser_p1(const struct gkyl_basis *basis, const double *w, const double *dxv,
                const double *vmap, const double *vmapSq, const double q_, const double m_, const struct gkyl_dg_surf_geom *dgs, const struct gkyl_gk_dg_surf_geom *gkdgs, 
                const double *bmag, const double *phi, double* GKYL_RESTRICT flux_surf); 
...
GKYL_CU_DH double gyrokinetic_no_by_boundary_fluxz_3x2v_ser_p1(const double *w, const double *dxv,
                ...
                const double *flux_surf_edge, const double *flux_surf_skin, 
                const int edge, double* GKYL_RESTRICT out); 
GKYL_CU_DH void gyrokinetic_flux_surfvpar_3x2v_ser_p1(const struct gkyl_basis *basis, const double *w, const double *dxv,
              const double *vmap, const double *vmapSq, const double q_, const double m_, const struct gkyl_dg_vol_geom *dgv, const struct gkyl_gk_dg_vol_geom *gkdgv, 
              const double *bmag, const double *phi, double* GKYL_RESTRICT flux_surf); 
GKYL_CU_DH void gyrokinetic_flux_no_by_surfvpar_3x2v_ser_p1(const struct gkyl_basis *basis, const double *w, const double *dxv,
              const double *vmap, const double *vmapSq, const double q_, const double m_, const struct gkyl_dg_vol_geom *dgv, const struct gkyl_gk_dg_vol_geom *gkdgv, 
              const double *bmag, const double *phi, double* GKYL_RESTRICT flux_surf); 
