...
{ 
  ...
  alphaR0[7] = (((-1.778781183844713*b_y[5]*jacobtot_inv[5]*hamil[32])-1.026979795322186*b_y[3]*jacobtot_inv[5]*hamil[32]-1.026979795322186*jacobtot_inv[3]*b_y[5]*hamil[32]-0.592927061281571*b_y[3]*jacobtot_inv[3]*hamil[32])*rdvpar2*rdz2*wvpar)/q_+(((-0.4592793267718456*hamil[4]*b_y[5]*jacobtot_inv[5])-0.2651650429449552*b_y[3]*hamil[4]*jacobtot_inv[5]-0.2651650429449552*jacobtot_inv[3]*hamil[4]*b_y[5]-0.1530931089239486*b_y[3]*jacobtot_inv[3]*hamil[4])*rdz2)/q_; 
  ...
  alphaR0[16] = (((-0.9185586535436913*jacobtot_inv[1]*b_y[5]*hamil[32])-0.5303300858899105*jacobtot_inv[0]*b_y[5]*hamil[32]-0.5303300858899105*jacobtot_inv[1]*b_y[3]*hamil[32]-0.3061862178478971*jacobtot_inv[0]*b_y[3]*hamil[32])*rdz2)/q_; 
  alphaR0[18] = (((-0.9185586535436916*b_y[5]*jacobtot_inv[5]*hamil[32])-0.5303300858899104*b_y[3]*jacobtot_inv[5]*hamil[32]-0.5303300858899104*jacobtot_inv[3]*b_y[5]*hamil[32]-0.3061862178478971*b_y[3]*jacobtot_inv[3]*hamil[32])*rdz2)/q_; 
  ...
  if (0.2795084971874732*alphaR0[18]-0.2795084971874732*alphaR0[16]+0.25*(alphaR0[9]+alphaR0[5])-0.25*(alphaR0[4]+alphaR0[2]+alphaR0[1])+0.25*alphaR0[0] > 0.) 
  ...
  if ((-0.2236067977499786*alphaR0[18])+0.2236067977499786*alphaR0[16]-0.25*alphaR0[9]+0.3354101966249678*alphaR0[7]+0.25*(alphaR0[5]+alphaR0[4])-0.3354101966249678*alphaR0[3]-0.25*(alphaR0[2]+alphaR0[1])+0.25*alphaR0[0] > 0.) 
  ...
  if (0.2795084971874732*alphaR0[18]-0.2795084971874732*alphaR0[16]-0.25*alphaR0[9]+0.25*(alphaR0[5]+alphaR0[4])-0.25*(alphaR0[2]+alphaR0[1])+0.25*alphaR0[0] > 0.) 
  ...
  if (0.2236067977499786*(alphaR0[18]+alphaR0[16])-0.25*alphaR0[9]-0.3354101966249678*alphaR0[7]-0.25*(alphaR0[5]+alphaR0[4])-0.3354101966249678*alphaR0[3]+0.25*alphaR0[2]-0.25*alphaR0[1]+0.25*alphaR0[0] > 0.) 
  ...
  if ((-0.2795084971874732*(alphaR0[18]+alphaR0[16]))-0.25*(alphaR0[9]+alphaR0[5]+alphaR0[4])+0.25*alphaR0[2]-0.25*alphaR0[1]+0.25*alphaR0[0] > 0.) 
  ...
  if (0.2236067977499786*(alphaR0[18]+alphaR0[16])+0.25*alphaR0[9]-0.3354101966249678*alphaR0[7]-0.25*alphaR0[5]+0.25*alphaR0[4]-0.3354101966249678*alphaR0[3]+0.25*alphaR0[2]-0.25*alphaR0[1]+0.25*alphaR0[0] > 0.) 
  ...
  if ((-0.2795084971874732*(alphaR0[18]+alphaR0[16]))+0.25*alphaR0[9]-0.25*alphaR0[5]+0.25*(alphaR0[4]+alphaR0[2])-0.25*alphaR0[1]+0.25*alphaR0[0] > 0.) 
  ...
  if ((-0.2236067977499786*alphaR0[18])+0.2236067977499786*alphaR0[16]+0.25*alphaR0[9]+0.3354101966249678*alphaR0[7]-0.25*(alphaR0[5]+alphaR0[4])-0.3354101966249678*alphaR0[3]-0.25*alphaR0[2]+0.25*(alphaR0[1]+alphaR0[0]) > 0.) 
  ...
  if (0.2795084971874732*alphaR0[18]-0.2795084971874732*alphaR0[16]+0.25*alphaR0[9]-0.25*(alphaR0[5]+alphaR0[4]+alphaR0[2])+0.25*(alphaR0[1]+alphaR0[0]) > 0.) 
  ...
  if ((-0.2236067977499786*alphaR0[18])+0.2236067977499786*alphaR0[16]-0.25*alphaR0[9]+0.3354101966249678*alphaR0[7]-0.25*alphaR0[5]+0.25*alphaR0[4]-0.3354101966249678*alphaR0[3]-0.25*alphaR0[2]+0.25*(alphaR0[1]+alphaR0[0]) > 0.) 
  ...
  if (0.2795084971874732*alphaR0[18]-0.2795084971874732*alphaR0[16]-0.25*(alphaR0[9]+alphaR0[5])+0.25*alphaR0[4]-0.25*alphaR0[2]+0.25*(alphaR0[1]+alphaR0[0]) > 0.) 
  ...
  if (0.2236067977499786*(alphaR0[18]+alphaR0[16])-0.25*alphaR0[9]-0.3354101966249678*alphaR0[7]+0.25*alphaR0[5]-0.25*alphaR0[4]-0.3354101966249678*alphaR0[3]+0.25*(alphaR0[2]+alphaR0[1]+alphaR0[0]) > 0.) 
  ...
  if ((-0.2795084971874732*(alphaR0[18]+alphaR0[16]))-0.25*alphaR0[9]+0.25*alphaR0[5]-0.25*alphaR0[4]+0.25*(alphaR0[2]+alphaR0[1]+alphaR0[0]) > 0.) 
  ...
  if (0.2236067977499786*(alphaR0[18]+alphaR0[16])+0.25*alphaR0[9]-0.3354101966249678*alphaR0[7]+0.25*(alphaR0[5]+alphaR0[4])-0.3354101966249678*alphaR0[3]+0.25*(alphaR0[2]+alphaR0[1]+alphaR0[0]) > 0.) 
  ...
  if (0.25*(alphaR0[9]+alphaR0[5]+alphaR0[4]+alphaR0[2]+alphaR0[1]+alphaR0[0])-0.2795084971874732*(alphaR0[18]+alphaR0[16]) > 0.) 
