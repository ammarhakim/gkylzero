...
{ 
  ...
  fUpL[0] = 1.58113883008419*fl[32]+1.224744871391589*fl[4]+0.7071067811865475*fl[0]; 
  fUpL[1] = 1.58113883008419*fl[33]+1.224744871391589*fl[9]+0.7071067811865475*fl[1]; 
  fUpL[2] = 1.58113883008419*fl[34]+1.224744871391589*fl[10]+0.7071067811865475*fl[2]; 
  fUpL[3] = 1.58113883008419*fl[35]+1.224744871391589*fl[11]+0.7071067811865475*fl[3]; 
  fUpL[4] = 1.58113883008419*fl[36]+1.224744871391589*fl[15]+0.7071067811865475*fl[5]; 
  fUpL[5] = 1.58113883008419*fl[37]+1.224744871391589*fl[17]+0.7071067811865475*fl[6]; 
  fUpL[6] = 1.58113883008419*fl[38]+1.224744871391589*fl[18]+0.7071067811865475*fl[7]; 
  fUpL[7] = 1.58113883008419*fl[39]+1.224744871391589*fl[19]+0.7071067811865475*fl[8]; 
  fUpL[8] = 1.58113883008419*fl[40]+1.224744871391589*fl[23]+0.7071067811865475*fl[12]; 
  fUpL[9] = 1.58113883008419*fl[41]+1.224744871391589*fl[24]+0.7071067811865475*fl[13]; 
  fUpL[10] = 1.58113883008419*fl[42]+1.224744871391589*fl[25]+0.7071067811865475*fl[14]; 
  fUpL[11] = 1.58113883008419*fl[43]+1.224744871391589*fl[26]+0.7071067811865475*fl[16]; 
  fUpL[12] = 1.58113883008419*fl[44]+1.224744871391589*fl[28]+0.7071067811865475*fl[20]; 
  fUpL[13] = 1.58113883008419*fl[45]+1.224744871391589*fl[29]+0.7071067811865475*fl[21]; 
  fUpL[14] = 1.58113883008419*fl[46]+1.224744871391589*fl[30]+0.7071067811865475*fl[22]; 
  fUpL[15] = 1.58113883008419*fl[47]+1.224744871391589*fl[31]+0.7071067811865475*fl[27]; 
    } else { 
  fUpL[0] = 1.58113883008419*fc[32]-1.224744871391589*fc[4]+0.7071067811865475*fc[0]; 
  fUpL[1] = 1.58113883008419*fc[33]-1.224744871391589*fc[9]+0.7071067811865475*fc[1]; 
  fUpL[2] = 1.58113883008419*fc[34]-1.224744871391589*fc[10]+0.7071067811865475*fc[2]; 
  fUpL[3] = 1.58113883008419*fc[35]-1.224744871391589*fc[11]+0.7071067811865475*fc[3]; 
  fUpL[4] = 1.58113883008419*fc[36]-1.224744871391589*fc[15]+0.7071067811865475*fc[5]; 
  fUpL[5] = 1.58113883008419*fc[37]-1.224744871391589*fc[17]+0.7071067811865475*fc[6]; 
  fUpL[6] = 1.58113883008419*fc[38]-1.224744871391589*fc[18]+0.7071067811865475*fc[7]; 
  fUpL[7] = 1.58113883008419*fc[39]-1.224744871391589*fc[19]+0.7071067811865475*fc[8]; 
  fUpL[8] = 1.58113883008419*fc[40]-1.224744871391589*fc[23]+0.7071067811865475*fc[12]; 
  fUpL[9] = 1.58113883008419*fc[41]-1.224744871391589*fc[24]+0.7071067811865475*fc[13]; 
  fUpL[10] = 1.58113883008419*fc[42]-1.224744871391589*fc[25]+0.7071067811865475*fc[14]; 
  fUpL[11] = 1.58113883008419*fc[43]-1.224744871391589*fc[26]+0.7071067811865475*fc[16]; 
  fUpL[12] = 1.58113883008419*fc[44]-1.224744871391589*fc[28]+0.7071067811865475*fc[20]; 
  fUpL[13] = 1.58113883008419*fc[45]-1.224744871391589*fc[29]+0.7071067811865475*fc[21]; 
  fUpL[14] = 1.58113883008419*fc[46]-1.224744871391589*fc[30]+0.7071067811865475*fc[22]; 
  fUpL[15] = 1.58113883008419*fc[47]-1.224744871391589*fc[31]+0.7071067811865475*fc[27]; 
    } 
  } else { 
  double f_lr[16] = {0.};
  double f_cl[16] = {0.};
  ...
  f_lr[0] = 1.58113883008419*fl[32]+1.224744871391589*fl[4]+0.7071067811865475*fl[0]; 
  f_lr[1] = 1.58113883008419*fl[33]+1.224744871391589*fl[9]+0.7071067811865475*fl[1]; 
  f_lr[2] = 1.58113883008419*fl[34]+1.224744871391589*fl[10]+0.7071067811865475*fl[2]; 
  f_lr[3] = 1.58113883008419*fl[35]+1.224744871391589*fl[11]+0.7071067811865475*fl[3]; 
  f_lr[4] = 1.58113883008419*fl[36]+1.224744871391589*fl[15]+0.7071067811865475*fl[5]; 
  f_lr[5] = 1.58113883008419*fl[37]+1.224744871391589*fl[17]+0.7071067811865475*fl[6]; 
  f_lr[6] = 1.58113883008419*fl[38]+1.224744871391589*fl[18]+0.7071067811865475*fl[7]; 
  f_lr[7] = 1.58113883008419*fl[39]+1.224744871391589*fl[19]+0.7071067811865475*fl[8]; 
  f_lr[8] = 1.58113883008419*fl[40]+1.224744871391589*fl[23]+0.7071067811865475*fl[12]; 
  f_lr[9] = 1.58113883008419*fl[41]+1.224744871391589*fl[24]+0.7071067811865475*fl[13]; 
  f_lr[10] = 1.58113883008419*fl[42]+1.224744871391589*fl[25]+0.7071067811865475*fl[14]; 
  f_lr[11] = 1.58113883008419*fl[43]+1.224744871391589*fl[26]+0.7071067811865475*fl[16]; 
  f_lr[12] = 1.58113883008419*fl[44]+1.224744871391589*fl[28]+0.7071067811865475*fl[20]; 
  f_lr[13] = 1.58113883008419*fl[45]+1.224744871391589*fl[29]+0.7071067811865475*fl[21]; 
  f_lr[14] = 1.58113883008419*fl[46]+1.224744871391589*fl[30]+0.7071067811865475*fl[22]; 
  f_lr[15] = 1.58113883008419*fl[47]+1.224744871391589*fl[31]+0.7071067811865475*fl[27]; 

  f_cl[0] = 1.58113883008419*fc[32]-1.224744871391589*fc[4]+0.7071067811865475*fc[0]; 
  f_cl[1] = 1.58113883008419*fc[33]-1.224744871391589*fc[9]+0.7071067811865475*fc[1]; 
  f_cl[2] = 1.58113883008419*fc[34]-1.224744871391589*fc[10]+0.7071067811865475*fc[2]; 
  f_cl[3] = 1.58113883008419*fc[35]-1.224744871391589*fc[11]+0.7071067811865475*fc[3]; 
  f_cl[4] = 1.58113883008419*fc[36]-1.224744871391589*fc[15]+0.7071067811865475*fc[5]; 
  f_cl[5] = 1.58113883008419*fc[37]-1.224744871391589*fc[17]+0.7071067811865475*fc[6]; 
  f_cl[6] = 1.58113883008419*fc[38]-1.224744871391589*fc[18]+0.7071067811865475*fc[7]; 
  f_cl[7] = 1.58113883008419*fc[39]-1.224744871391589*fc[19]+0.7071067811865475*fc[8]; 
  f_cl[8] = 1.58113883008419*fc[40]-1.224744871391589*fc[23]+0.7071067811865475*fc[12]; 
  f_cl[9] = 1.58113883008419*fc[41]-1.224744871391589*fc[24]+0.7071067811865475*fc[13]; 
  f_cl[10] = 1.58113883008419*fc[42]-1.224744871391589*fc[25]+0.7071067811865475*fc[14]; 
  f_cl[11] = 1.58113883008419*fc[43]-1.224744871391589*fc[26]+0.7071067811865475*fc[16]; 
  f_cl[12] = 1.58113883008419*fc[44]-1.224744871391589*fc[28]+0.7071067811865475*fc[20]; 
  f_cl[13] = 1.58113883008419*fc[45]-1.224744871391589*fc[29]+0.7071067811865475*fc[21]; 
  f_cl[14] = 1.58113883008419*fc[46]-1.224744871391589*fc[30]+0.7071067811865475*fc[22]; 
  f_cl[15] = 1.58113883008419*fc[47]-1.224744871391589*fc[31]+0.7071067811865475*fc[27]; 
  ...
  fUpR[0] = 1.58113883008419*fc[32]+1.224744871391589*fc[4]+0.7071067811865475*fc[0]; 
  fUpR[1] = 1.58113883008419*fc[33]+1.224744871391589*fc[9]+0.7071067811865475*fc[1]; 
  fUpR[2] = 1.58113883008419*fc[34]+1.224744871391589*fc[10]+0.7071067811865475*fc[2]; 
  fUpR[3] = 1.58113883008419*fc[35]+1.224744871391589*fc[11]+0.7071067811865475*fc[3]; 
  fUpR[4] = 1.58113883008419*fc[36]+1.224744871391589*fc[15]+0.7071067811865475*fc[5]; 
  fUpR[5] = 1.58113883008419*fc[37]+1.224744871391589*fc[17]+0.7071067811865475*fc[6]; 
  fUpR[6] = 1.58113883008419*fc[38]+1.224744871391589*fc[18]+0.7071067811865475*fc[7]; 
  fUpR[7] = 1.58113883008419*fc[39]+1.224744871391589*fc[19]+0.7071067811865475*fc[8]; 
  fUpR[8] = 1.58113883008419*fc[40]+1.224744871391589*fc[23]+0.7071067811865475*fc[12]; 
  fUpR[9] = 1.58113883008419*fc[41]+1.224744871391589*fc[24]+0.7071067811865475*fc[13]; 
  fUpR[10] = 1.58113883008419*fc[42]+1.224744871391589*fc[25]+0.7071067811865475*fc[14]; 
  fUpR[11] = 1.58113883008419*fc[43]+1.224744871391589*fc[26]+0.7071067811865475*fc[16]; 
  fUpR[12] = 1.58113883008419*fc[44]+1.224744871391589*fc[28]+0.7071067811865475*fc[20]; 
  fUpR[13] = 1.58113883008419*fc[45]+1.224744871391589*fc[29]+0.7071067811865475*fc[21]; 
  fUpR[14] = 1.58113883008419*fc[46]+1.224744871391589*fc[30]+0.7071067811865475*fc[22]; 
  fUpR[15] = 1.58113883008419*fc[47]+1.224744871391589*fc[31]+0.7071067811865475*fc[27]; 
    } else { 
  fUpR[0] = 1.58113883008419*fr[32]-1.224744871391589*fr[4]+0.7071067811865475*fr[0]; 
  fUpR[1] = 1.58113883008419*fr[33]-1.224744871391589*fr[9]+0.7071067811865475*fr[1]; 
  fUpR[2] = 1.58113883008419*fr[34]-1.224744871391589*fr[10]+0.7071067811865475*fr[2]; 
  fUpR[3] = 1.58113883008419*fr[35]-1.224744871391589*fr[11]+0.7071067811865475*fr[3]; 
  fUpR[4] = 1.58113883008419*fr[36]-1.224744871391589*fr[15]+0.7071067811865475*fr[5]; 
  fUpR[5] = 1.58113883008419*fr[37]-1.224744871391589*fr[17]+0.7071067811865475*fr[6]; 
  fUpR[6] = 1.58113883008419*fr[38]-1.224744871391589*fr[18]+0.7071067811865475*fr[7]; 
  fUpR[7] = 1.58113883008419*fr[39]-1.224744871391589*fr[19]+0.7071067811865475*fr[8]; 
  fUpR[8] = 1.58113883008419*fr[40]-1.224744871391589*fr[23]+0.7071067811865475*fr[12]; 
  fUpR[9] = 1.58113883008419*fr[41]-1.224744871391589*fr[24]+0.7071067811865475*fr[13]; 
  fUpR[10] = 1.58113883008419*fr[42]-1.224744871391589*fr[25]+0.7071067811865475*fr[14]; 
  fUpR[11] = 1.58113883008419*fr[43]-1.224744871391589*fr[26]+0.7071067811865475*fr[16]; 
  fUpR[12] = 1.58113883008419*fr[44]-1.224744871391589*fr[28]+0.7071067811865475*fr[20]; 
  fUpR[13] = 1.58113883008419*fr[45]-1.224744871391589*fr[29]+0.7071067811865475*fr[21]; 
  fUpR[14] = 1.58113883008419*fr[46]-1.224744871391589*fr[30]+0.7071067811865475*fr[22]; 
  fUpR[15] = 1.58113883008419*fr[47]-1.224744871391589*fr[31]+0.7071067811865475*fr[27]; 
    } 
  } else { 
  double f_cr[16] = {0.};
  double f_rl[16] = {0.};
  ...
  f_cr[0] = 1.58113883008419*fc[32]+1.224744871391589*fc[4]+0.7071067811865475*fc[0]; 
  f_cr[1] = 1.58113883008419*fc[33]+1.224744871391589*fc[9]+0.7071067811865475*fc[1]; 
  f_cr[2] = 1.58113883008419*fc[34]+1.224744871391589*fc[10]+0.7071067811865475*fc[2]; 
  f_cr[3] = 1.58113883008419*fc[35]+1.224744871391589*fc[11]+0.7071067811865475*fc[3]; 
  f_cr[4] = 1.58113883008419*fc[36]+1.224744871391589*fc[15]+0.7071067811865475*fc[5]; 
  f_cr[5] = 1.58113883008419*fc[37]+1.224744871391589*fc[17]+0.7071067811865475*fc[6]; 
  f_cr[6] = 1.58113883008419*fc[38]+1.224744871391589*fc[18]+0.7071067811865475*fc[7]; 
  f_cr[7] = 1.58113883008419*fc[39]+1.224744871391589*fc[19]+0.7071067811865475*fc[8]; 
  f_cr[8] = 1.58113883008419*fc[40]+1.224744871391589*fc[23]+0.7071067811865475*fc[12]; 
  f_cr[9] = 1.58113883008419*fc[41]+1.224744871391589*fc[24]+0.7071067811865475*fc[13]; 
  f_cr[10] = 1.58113883008419*fc[42]+1.224744871391589*fc[25]+0.7071067811865475*fc[14]; 
  f_cr[11] = 1.58113883008419*fc[43]+1.224744871391589*fc[26]+0.7071067811865475*fc[16]; 
  f_cr[12] = 1.58113883008419*fc[44]+1.224744871391589*fc[28]+0.7071067811865475*fc[20]; 
  f_cr[13] = 1.58113883008419*fc[45]+1.224744871391589*fc[29]+0.7071067811865475*fc[21]; 
  f_cr[14] = 1.58113883008419*fc[46]+1.224744871391589*fc[30]+0.7071067811865475*fc[22]; 
  f_cr[15] = 1.58113883008419*fc[47]+1.224744871391589*fc[31]+0.7071067811865475*fc[27]; 

  f_rl[0] = 1.58113883008419*fr[32]-1.224744871391589*fr[4]+0.7071067811865475*fr[0]; 
  f_rl[1] = 1.58113883008419*fr[33]-1.224744871391589*fr[9]+0.7071067811865475*fr[1]; 
  f_rl[2] = 1.58113883008419*fr[34]-1.224744871391589*fr[10]+0.7071067811865475*fr[2]; 
  f_rl[3] = 1.58113883008419*fr[35]-1.224744871391589*fr[11]+0.7071067811865475*fr[3]; 
  f_rl[4] = 1.58113883008419*fr[36]-1.224744871391589*fr[15]+0.7071067811865475*fr[5]; 
  f_rl[5] = 1.58113883008419*fr[37]-1.224744871391589*fr[17]+0.7071067811865475*fr[6]; 
  f_rl[6] = 1.58113883008419*fr[38]-1.224744871391589*fr[18]+0.7071067811865475*fr[7]; 
  f_rl[7] = 1.58113883008419*fr[39]-1.224744871391589*fr[19]+0.7071067811865475*fr[8]; 
  f_rl[8] = 1.58113883008419*fr[40]-1.224744871391589*fr[23]+0.7071067811865475*fr[12]; 
  f_rl[9] = 1.58113883008419*fr[41]-1.224744871391589*fr[24]+0.7071067811865475*fr[13]; 
  f_rl[10] = 1.58113883008419*fr[42]-1.224744871391589*fr[25]+0.7071067811865475*fr[14]; 
  f_rl[11] = 1.58113883008419*fr[43]-1.224744871391589*fr[26]+0.7071067811865475*fr[16]; 
  f_rl[12] = 1.58113883008419*fr[44]-1.224744871391589*fr[28]+0.7071067811865475*fr[20]; 
  f_rl[13] = 1.58113883008419*fr[45]-1.224744871391589*fr[29]+0.7071067811865475*fr[21]; 
  f_rl[14] = 1.58113883008419*fr[46]-1.224744871391589*fr[30]+0.7071067811865475*fr[22]; 
  f_rl[15] = 1.58113883008419*fr[47]-1.224744871391589*fr[31]+0.7071067811865475*fr[27]; 
