...
GKYL_CU_DH int gyrokinetic_alpha_surfvpar_1x2v_ser_p1(const double *w, const double *dxv, const double *vmap, const double *vmapSq,
...
{ 
  ...
  alphaL[2] = -((0.8660254037844386*cmag[0]*hamil[5]*rdx2)/m_); 
  alphaL[3] = -((0.8660254037844386*cmag[1]*hamil[5]*rdx2)/m_); 
