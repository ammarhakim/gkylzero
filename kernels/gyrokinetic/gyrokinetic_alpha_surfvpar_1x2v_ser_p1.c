...
{ 
  ...
  alphaL1[2] = (((-0.6123724356957944*cmag[1]*jacobtot_inv[1]*hamil[5])-0.6123724356957944*cmag[0]*jacobtot_inv[0]*hamil[5])*rdx2)/m_; 
  alphaL1[3] = (((-0.6123724356957944*cmag[0]*jacobtot_inv[1]*hamil[5])-0.6123724356957944*jacobtot_inv[0]*cmag[1]*hamil[5])*rdx2)/m_; 

  double *sgn_alpha_surf1 = &sgn_alpha_surf[6];
  int const_sgn_alpha_surf = 1; 
  
  if (0.5*alphaL1[3]-0.5*(alphaL1[2]+alphaL1[1])+0.5*alphaL1[0] > 0.) 
    sgn_alpha_surf1[0] = 1.0; 
  else  
    sgn_alpha_surf1[0] = -1.0; 
  
  if ((-0.5*alphaL1[3])+0.5*alphaL1[2]-0.5*alphaL1[1]+0.5*alphaL1[0] > 0.) 
  ...
  if (0.5*(alphaL1[1]+alphaL1[0])-0.5*(alphaL1[3]+alphaL1[2]) > 0.) 
  ...
  if (0.5*(alphaL1[3]+alphaL1[2]+alphaL1[1]+alphaL1[0]) > 0.) 
