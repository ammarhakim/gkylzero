...
{ 
  ...
  double hamil[24] = {0.}; 
  hamil[0] = (1.414213562373095*phi[0]-2.449489742783179*phi[1])*q_+vmapSq[0]*m_+(bmag[0]-1.732050807568877*bmag[1])*vmap[2]; 
  hamil[1] = (1.414213562373095*phi[2]-2.449489742783179*phi[3])*q_+vmap[2]*(bmag[2]-1.732050807568877*bmag[3]); 
  hamil[2] = vmapSq[1]*m_; 
