...
{ 
  ...
  if (alphaL[0]-1.0*alphaL[1] > 0.) {
    fUpOrdL[0] = 0.6123724356957942*fl[7]+0.3535533905932736*fl[6]-0.6123724356957944*(fl[5]+fl[4])-0.3535533905932736*(fl[3]+fl[2])+0.6123724356957944*fl[1]+0.3535533905932737*fl[0]; 
  } else {
    fUpOrdL[0] = (-0.6123724356957942*fc[7])+0.3535533905932736*fc[6]+0.6123724356957944*(fc[5]+fc[4])-0.3535533905932736*(fc[3]+fc[2])-0.6123724356957944*fc[1]+0.3535533905932737*fc[0]; 
  }
  if (alphaL[0]-1.0*alphaL[1] > 0.) {
    fUpOrdL[1] = (-0.6123724356957942*fl[7])-0.3535533905932736*fl[6]+0.6123724356957944*fl[5]-0.6123724356957944*fl[4]+0.3535533905932736*fl[3]-0.3535533905932736*fl[2]+0.6123724356957944*fl[1]+0.3535533905932737*fl[0]; 
  } else {
    fUpOrdL[1] = 0.6123724356957942*fc[7]-0.3535533905932736*fc[6]-0.6123724356957944*fc[5]+0.6123724356957944*fc[4]+0.3535533905932736*fc[3]-0.3535533905932736*fc[2]-0.6123724356957944*fc[1]+0.3535533905932737*fc[0]; 
  }
  if (alphaL[1]+alphaL[0] > 0.) {
    fUpOrdL[2] = (-0.6123724356957942*fl[7])-0.3535533905932736*fl[6]-0.6123724356957944*fl[5]+0.6123724356957944*fl[4]-0.3535533905932736*fl[3]+0.3535533905932736*fl[2]+0.6123724356957944*fl[1]+0.3535533905932737*fl[0]; 
  } else {
    fUpOrdL[2] = 0.6123724356957942*fc[7]-0.3535533905932736*fc[6]+0.6123724356957944*fc[5]-0.6123724356957944*fc[4]-0.3535533905932736*fc[3]+0.3535533905932736*fc[2]-0.6123724356957944*fc[1]+0.3535533905932737*fc[0]; 
  }
  if (alphaL[1]+alphaL[0] > 0.) {
    fUpOrdL[3] = 0.6123724356957942*fl[7]+0.3535533905932736*fl[6]+0.6123724356957944*(fl[5]+fl[4])+0.3535533905932736*(fl[3]+fl[2])+0.6123724356957944*fl[1]+0.3535533905932737*fl[0]; 
  } else {
    fUpOrdL[3] = (-0.6123724356957942*fc[7])+0.3535533905932736*fc[6]-0.6123724356957944*(fc[5]+fc[4])+0.3535533905932736*(fc[3]+fc[2])-0.6123724356957944*fc[1]+0.3535533905932737*fc[0]; 
  }
  ...
  if (alphaR[0]-1.0*alphaR[1] > 0.) {
    fUpOrdR[0] = 0.6123724356957942*fc[7]+0.3535533905932736*fc[6]-0.6123724356957944*(fc[5]+fc[4])-0.3535533905932736*(fc[3]+fc[2])+0.6123724356957944*fc[1]+0.3535533905932737*fc[0]; 
  } else {
    fUpOrdR[0] = (-0.6123724356957942*fr[7])+0.3535533905932736*fr[6]+0.6123724356957944*(fr[5]+fr[4])-0.3535533905932736*(fr[3]+fr[2])-0.6123724356957944*fr[1]+0.3535533905932737*fr[0]; 
  }
  if (alphaR[0]-1.0*alphaR[1] > 0.) {
    fUpOrdR[1] = (-0.6123724356957942*fc[7])-0.3535533905932736*fc[6]+0.6123724356957944*fc[5]-0.6123724356957944*fc[4]+0.3535533905932736*fc[3]-0.3535533905932736*fc[2]+0.6123724356957944*fc[1]+0.3535533905932737*fc[0]; 
  } else {
    fUpOrdR[1] = 0.6123724356957942*fr[7]-0.3535533905932736*fr[6]-0.6123724356957944*fr[5]+0.6123724356957944*fr[4]+0.3535533905932736*fr[3]-0.3535533905932736*fr[2]-0.6123724356957944*fr[1]+0.3535533905932737*fr[0]; 
  }
  if (alphaR[1]+alphaR[0] > 0.) {
    fUpOrdR[2] = (-0.6123724356957942*fc[7])-0.3535533905932736*fc[6]-0.6123724356957944*fc[5]+0.6123724356957944*fc[4]-0.3535533905932736*fc[3]+0.3535533905932736*fc[2]+0.6123724356957944*fc[1]+0.3535533905932737*fc[0]; 
  } else {
    fUpOrdR[2] = 0.6123724356957942*fr[7]-0.3535533905932736*fr[6]+0.6123724356957944*fr[5]-0.6123724356957944*fr[4]-0.3535533905932736*fr[3]+0.3535533905932736*fr[2]-0.6123724356957944*fr[1]+0.3535533905932737*fr[0]; 
  }
  if (alphaR[1]+alphaR[0] > 0.) {
    fUpOrdR[3] = 0.6123724356957942*fc[7]+0.3535533905932736*fc[6]+0.6123724356957944*(fc[5]+fc[4])+0.3535533905932736*(fc[3]+fc[2])+0.6123724356957944*fc[1]+0.3535533905932737*fc[0]; 
  } else {
    fUpOrdR[3] = (-0.6123724356957942*fr[7])+0.3535533905932736*fr[6]-0.6123724356957944*(fr[5]+fr[4])+0.3535533905932736*(fr[3]+fr[2])-0.6123724356957944*fr[1]+0.3535533905932737*fr[0]; 
  }
