...
{ 
  ...
  GhatL[3] = 0.44721359549995804*alphaL[1]*fUpL[5]+0.5*(alphaL[0]*fUpL[3]+alphaL[1]*fUpL[2]); 
  GhatL[4] = 0.5*alphaL[0]*fUpL[4]+0.4472135954999579*alphaL[1]*fUpL[1]; 
  GhatL[5] = 0.5*alphaL[0]*fUpL[5]+0.44721359549995804*alphaL[1]*fUpL[3]; 
  ...
  GhatR[3] = 0.44721359549995804*alphaR[1]*fUpR[5]+0.5*(alphaR[0]*fUpR[3]+alphaR[1]*fUpR[2]); 
  GhatR[4] = 0.5*alphaR[0]*fUpR[4]+0.4472135954999579*alphaR[1]*fUpR[1]; 
  GhatR[5] = 0.5*alphaR[0]*fUpR[5]+0.44721359549995804*alphaR[1]*fUpR[3]; 
