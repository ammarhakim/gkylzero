...
GKYL_CU_DH int gyrokinetic_alpha_edge_surfx_1x2v_ser_p2(const double *w, const double *dxv, const double *vmap, const double *vmapSq,
...
{ 
  ...
  alphaR[0] = (2.5*cmag[2]*hamil[2]*jacobtot_inv[2]+1.936491673103709*cmag[1]*hamil[2]*jacobtot_inv[2]+1.118033988749895*cmag[0]*hamil[2]*jacobtot_inv[2]+1.936491673103709*jacobtot_inv[1]*cmag[2]*hamil[2]+1.118033988749895*jacobtot_inv[0]*cmag[2]*hamil[2]+1.5*cmag[1]*jacobtot_inv[1]*hamil[2]+0.8660254037844386*cmag[0]*jacobtot_inv[1]*hamil[2]+0.8660254037844386*jacobtot_inv[0]*cmag[1]*hamil[2]+0.5*cmag[0]*jacobtot_inv[0]*hamil[2])/(vmap[1]*m_); 
  alphaR[1] = (5.590169943749475*cmag[2]*jacobtot_inv[2]*hamil[8]+4.330127018922193*cmag[1]*jacobtot_inv[2]*hamil[8]+2.5*cmag[0]*jacobtot_inv[2]*hamil[8]+4.330127018922193*jacobtot_inv[1]*cmag[2]*hamil[8]+2.5*jacobtot_inv[0]*cmag[2]*hamil[8]+3.354101966249685*cmag[1]*jacobtot_inv[1]*hamil[8]+1.936491673103709*cmag[0]*jacobtot_inv[1]*hamil[8]+1.936491673103709*jacobtot_inv[0]*cmag[1]*hamil[8]+1.118033988749895*cmag[0]*jacobtot_inv[0]*hamil[8])/(vmap[1]*m_); 
