...
{ 
  ...
  alphaL = 0.25*((-0.7745966692414836*alphax[7])-1.5*alphax[6]+0.4472135954999581*alphax[5]+1.118033988749895*alphax[4]+1.161895003862225*alphax[3]-0.6708203932499369*alphax[2]-0.8660254037844386*alphax[1]+0.5*alphax[0]); 
  ...
  alphaR = 0.25*(0.7745966692414836*alphax[7]-1.5*alphax[6]+0.4472135954999581*alphax[5]+1.118033988749895*alphax[4]-1.161895003862225*alphax[3]-0.6708203932499369*alphax[2]+0.8660254037844386*alphax[1]+0.5*alphax[0]); 
  ...
  // Evaluate alpha at left surface quadrature points.
  alphaL = 0.25*((-0.7745966692414836*alphavpar[6])+0.4472135954999581*alphavpar[4]+1.161895003862225*alphavpar[3]-0.8660254037844386*alphavpar[2]-0.6708203932499369*alphavpar[1]+0.5*alphavpar[0]); 
  cflFreq += -0.5*(alphaL-fabs(alphaL)); 
  ...
  cflFreq += -0.5*(alphaL-fabs(alphaL)); 
  // Evaluate alpha at right surface quadrature points.
  alphaR = 0.25*(0.7745966692414836*alphavpar[6]+0.4472135954999581*alphavpar[4]-1.161895003862225*alphavpar[3]+0.8660254037844386*alphavpar[2]-0.6708203932499369*alphavpar[1]+0.5*alphavpar[0]); 
  cflFreq += 0.5*(alphaR+fabs(alphaR)); 
