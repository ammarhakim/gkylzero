...
{ 
  ...
  alphax[2] = ((1.936491673103709*cmag[2]*jacobtot_inv[2]*hamil[5]+1.936491673103709*cmag[1]*jacobtot_inv[1]*hamil[5]+1.936491673103709*cmag[0]*jacobtot_inv[0]*hamil[5])*rdvpar2*rdx2)/m_; 
  alphax[3] = ((1.732050807568877*cmag[1]*jacobtot_inv[2]*hamil[5]+1.732050807568877*jacobtot_inv[1]*cmag[2]*hamil[5]+1.936491673103709*cmag[0]*jacobtot_inv[1]*hamil[5]+1.936491673103709*jacobtot_inv[0]*cmag[1]*hamil[5])*rdvpar2*rdx2)/m_; 
  alphax[4] = ((0.5532833351724881*cmag[2]*hamil[2]*jacobtot_inv[2]+0.8660254037844386*cmag[0]*hamil[2]*jacobtot_inv[2]+0.8660254037844386*jacobtot_inv[0]*cmag[2]*hamil[2]+0.7745966692414833*cmag[1]*jacobtot_inv[1]*hamil[2])*rdvpar2*rdx2)/m_; 
  alphax[6] = ((1.237179148263484*cmag[2]*jacobtot_inv[2]*hamil[5]+1.936491673103709*cmag[0]*jacobtot_inv[2]*hamil[5]+1.936491673103709*jacobtot_inv[0]*cmag[2]*hamil[5]+1.732050807568877*cmag[1]*jacobtot_inv[1]*hamil[5])*rdvpar2*rdx2)/m_; 

  double alphavpar[8] = {0.}; 
  alphavpar[0] = (((-1.732050807568877*cmag[1]*jacobtot_inv[2]*hamil[4])-1.732050807568877*jacobtot_inv[1]*cmag[2]*hamil[4]-1.936491673103709*cmag[0]*jacobtot_inv[1]*hamil[4]-1.936491673103709*jacobtot_inv[0]*cmag[1]*hamil[4]-0.8660254037844386*hamil[1]*cmag[2]*jacobtot_inv[2]-0.8660254037844386*cmag[1]*hamil[1]*jacobtot_inv[1]-0.8660254037844386*cmag[0]*jacobtot_inv[0]*hamil[1])*rdvpar2*rdx2)/m_; 
  alphavpar[1] = (((-3.043058343448684*cmag[2]*jacobtot_inv[2]*hamil[4])-1.732050807568877*cmag[0]*jacobtot_inv[2]*hamil[4]-1.732050807568877*jacobtot_inv[0]*cmag[2]*hamil[4]-3.485685011586674*cmag[1]*jacobtot_inv[1]*hamil[4]-1.936491673103709*cmag[0]*jacobtot_inv[0]*hamil[4]-0.7745966692414833*cmag[1]*hamil[1]*jacobtot_inv[2]-0.7745966692414833*hamil[1]*jacobtot_inv[1]*cmag[2]-0.8660254037844386*cmag[0]*hamil[1]*jacobtot_inv[1]-0.8660254037844386*jacobtot_inv[0]*cmag[1]*hamil[1])*rdvpar2*rdx2)/m_; 
  alphavpar[4] = (((-3.043058343448684*cmag[1]*jacobtot_inv[2]*hamil[4])-3.043058343448684*jacobtot_inv[1]*cmag[2]*hamil[4]-1.732050807568877*cmag[0]*jacobtot_inv[1]*hamil[4]-1.732050807568877*jacobtot_inv[0]*cmag[1]*hamil[4]-0.5532833351724881*hamil[1]*cmag[2]*jacobtot_inv[2]-0.8660254037844386*cmag[0]*hamil[1]*jacobtot_inv[2]-0.8660254037844386*jacobtot_inv[0]*hamil[1]*cmag[2]-0.7745966692414833*cmag[1]*hamil[1]*jacobtot_inv[1])*rdvpar2*rdx2)/m_; 
