...
{ 
  ...
  alphaR[0] = ((-(1.2990381056766578*b_z[5]*hamil[16])-0.75*b_z[3]*hamil[16]-0.75*b_z[5]*hamil[8]-0.4330127018922193*b_z[3]*hamil[8]-1.2990381056766578*b_z[1]*hamil[6]-0.75*b_z[0]*hamil[6]-0.75*b_z[1]*hamil[2]-0.4330127018922193*b_z[0]*hamil[2])*rdy2)/q_; 
  alphaR[2] = ((-(1.2990381056766578*b_z[1]*hamil[16])-0.75*b_z[0]*hamil[16]-0.75*b_z[1]*hamil[8]-0.4330127018922193*b_z[0]*hamil[8]-1.2990381056766578*b_z[5]*hamil[6]-0.75*b_z[3]*hamil[6]-0.75*hamil[2]*b_z[5]-0.4330127018922193*hamil[2]*b_z[3])*rdy2)/q_; 
