...
{ 
  ...
  double hamil[24] = {0.}; 
  hamil[0] = (2.449489742783179*phi[1]+1.414213562373095*phi[0])*q_+vmapSq[0]*m_+1.414213562373095*bmag[0]*vmap[2]; 
  hamil[1] = 2.449489742783179*phi[3]*q_+1.414213562373095*(phi[2]*q_+bmag[1]*vmap[2]); 
  hamil[2] = vmapSq[1]*m_; 
...
alphahat_quad += 1/q_/bmag_quad/area_elem_quad * bhat_quad[1]*(0.6123724356957944*hamil[1]-0.6123724356957944*hamil[5])  ;
...
alphahat_quad = 0.0  ;
alphahat_quad += ((0.408248290463863*dxv[2]*(0.6123724356957944*hamil[2]-1.837117307087383*hamil[8]))/vmap[1])/m_/bmag_quad * (0.6123724356957944*hamil[2]-1.837117307087383*hamil[8])/q_ * normcurlbhat_quad ;
alphahat_quad += 1/q_/bmag_quad/area_elem_quad * bhat_quad[1]*(0.6123724356957944*hamil[5]+0.6123724356957944*hamil[1])  ;
