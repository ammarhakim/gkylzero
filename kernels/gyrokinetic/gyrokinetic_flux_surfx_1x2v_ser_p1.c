...
{ 
  ...
  cfl = fmax(fabs(alpha_quad), fabs(cfl)) ;
  if (alpha_quad > 0) {
    Jf_quad =  0.6846531968814572*JfL[11]+0.3952847075210473*JfL[10]-0.6846531968814573*JfL[9]-0.3952847075210472*JfL[8]-0.6123724356957944*JfL[5]-0.3535533905932737*JfL[3]+0.6123724356957944*JfL[1]+0.3535533905932737*JfL[0];
    flux_surf_nodal[1] = alpha_quad*Jf_quad;
  }
  else {
    Jf_quad =  (-0.6846531968814572*JfR[11])+0.3952847075210473*JfR[10]+0.6846531968814573*JfR[9]-0.3952847075210472*JfR[8]+0.6123724356957944*JfR[5]-0.3535533905932737*JfR[3]-0.6123724356957944*JfR[1]+0.3535533905932737*JfR[0];
    flux_surf_nodal[1] = alpha_quad*Jf_quad;
  }
