...
{ 
  ...
  if (alphaL[0]-1.0*alphaL[1] > 0.) {
    fUpOrdL[0] = (-0.8660254037844386*fl[3])+0.8660254037844386*fl[2]-0.5*fl[1]+0.5*fl[0]; 
  } else {
    fUpOrdL[0] = 0.8660254037844386*fc[3]-0.8660254037844386*fc[2]-0.5*fc[1]+0.5*fc[0]; 
  }
  if (alphaL[1]+alphaL[0] > 0.) {
    fUpOrdL[1] = 0.8660254037844386*(fl[3]+fl[2])+0.5*(fl[1]+fl[0]); 
  } else {
    fUpOrdL[1] = 0.5*(fc[1]+fc[0])-0.8660254037844386*(fc[3]+fc[2]); 
  }
  ...
  if (alphaR[0]-1.0*alphaR[1] > 0.) {
    fUpOrdR[0] = (-0.8660254037844386*fc[3])+0.8660254037844386*fc[2]-0.5*fc[1]+0.5*fc[0]; 
  } else {
    fUpOrdR[0] = 0.8660254037844386*fr[3]-0.8660254037844386*fr[2]-0.5*fr[1]+0.5*fr[0]; 
  }
  if (alphaR[1]+alphaR[0] > 0.) {
    fUpOrdR[1] = 0.8660254037844386*(fc[3]+fc[2])+0.5*(fc[1]+fc[0]); 
  } else {
    fUpOrdR[1] = 0.5*(fr[1]+fr[0])-0.8660254037844386*(fr[3]+fr[2]); 
  }
