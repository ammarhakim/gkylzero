...
{ 
  ...
  double alphaz[24] = {0.}; 
  alphaz[0] = (0.7071067811865475*cmag[0]*hamil[3]*rdz2)/(vmap[1]*m_); 
  alphaz[1] = (0.7071067811865475*cmag[1]*hamil[3]*rdz2)/(vmap[1]*m_); 
  alphaz[2] = (0.7071067811865475*cmag[2]*hamil[3]*rdz2)/(vmap[1]*m_); 
  alphaz[3] = (1.5811388300841895*cmag[0]*hamil[16]*rdz2)/(vmap[1]*m_); 
  alphaz[5] = (0.7071067811865475*cmag[3]*hamil[3]*rdz2)/(vmap[1]*m_); 
  alphaz[6] = (1.5811388300841895*cmag[1]*hamil[16]*rdz2)/(vmap[1]*m_); 
  alphaz[7] = (1.5811388300841895*cmag[2]*hamil[16]*rdz2)/(vmap[1]*m_); 
  alphaz[11] = (1.5811388300841895*cmag[3]*hamil[16]*rdz2)/(vmap[1]*m_); 

  double alphavpar[24] = {0.}; 
  alphavpar[0] = ((-(0.7071067811865475*cmag[1]*hamil[5])-0.7071067811865475*cmag[0]*hamil[2])*rdz2)/(vmap[1]*m_); 
  alphavpar[1] = ((-(0.7071067811865475*cmag[0]*hamil[5])-0.7071067811865475*cmag[1]*hamil[2])*rdz2)/(vmap[1]*m_); 
  alphavpar[2] = ((-(0.7071067811865475*cmag[3]*hamil[5])-0.7071067811865475*cmag[2]*hamil[2])*rdz2)/(vmap[1]*m_); 
  alphavpar[4] = ((-(0.7071067811865475*cmag[1]*hamil[12])-0.7071067811865475*cmag[0]*hamil[9])*rdz2)/(vmap[1]*m_); 
  alphavpar[5] = ((-(0.7071067811865475*cmag[2]*hamil[5])-0.7071067811865475*hamil[2]*cmag[3])*rdz2)/(vmap[1]*m_); 
  alphavpar[8] = ((-(0.7071067811865475*cmag[0]*hamil[12])-0.7071067811865475*cmag[1]*hamil[9])*rdz2)/(vmap[1]*m_); 
  alphavpar[9] = ((-(0.7071067811865475*cmag[3]*hamil[12])-0.7071067811865475*cmag[2]*hamil[9])*rdz2)/(vmap[1]*m_); 
  ...
  out[20] += 0.4330127018922193*alphaz[2]*fin[20]+0.43301270189221935*(alphaz[5]*fin[18]+alphaz[0]*fin[17])+0.4330127018922193*alphaz[1]*fin[16]+0.9682458365518543*(alphavpar[4]*fin[15]+alphavpar[8]*fin[14]+alphavpar[9]*fin[13]+fin[10]*alphavpar[12])+(0.38729833462074165*alphaz[7]+0.9682458365518543*alphavpar[0])*fin[11]+fin[7]*(0.38729833462074165*alphaz[11]+0.9682458365518543*alphavpar[1])+(0.38729833462074165*alphaz[3]+0.9682458365518543*alphavpar[2])*fin[6]+fin[3]*(0.38729833462074165*alphaz[6]+0.9682458365518543*alphavpar[5]); 
  ...
  out[22] += 0.43301270189221935*alphaz[5]*fin[23]+0.4330127018922193*(alphaz[2]*fin[22]+alphaz[1]*fin[21])+0.43301270189221935*alphaz[0]*fin[19]+(0.38729833462074165*alphaz[11]+0.9682458365518543*alphavpar[1])*fin[15]+(0.38729833462074165*alphaz[7]+0.9682458365518543*alphavpar[0])*fin[14]+0.38729833462074165*alphaz[6]*fin[13]+0.9682458365518543*(alphavpar[5]*fin[13]+fin[6]*alphavpar[12]+alphavpar[8]*fin[11])+0.38729833462074165*alphaz[3]*fin[10]+0.9682458365518543*(alphavpar[2]*fin[10]+fin[3]*alphavpar[9]+alphavpar[4]*fin[7]); 
