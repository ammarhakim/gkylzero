...
{ 
  ...
  double alphaL[4]; 
  alphaL[0] = (0.25*(1.732050807568877*BstarZdBmag[0]-3.0*BstarZdBmag[1])*hamil[2]*rdvpar2)/m_; 
  alphaL[1] = (0.25*hamil[2]*(1.732050807568877*BstarZdBmag[2]-3.0*BstarZdBmag[4])*rdvpar2)/m_; 
