...
{ 
  ...
  alphaL = 0.125*((-0.5477225575051661*alphax[12])-1.060660171779821*alphax[11]+0.3162277660168379*alphax[8]+0.7905694150420947*alphax[7]+0.821583836257749*alphax[4]-0.4743416490252567*alphax[2]-0.6123724356957944*alphax[1]+0.3535533905932737*alphax[0]); 
  ...
  alphaR = 0.125*(0.5477225575051661*alphax[12]-1.060660171779821*alphax[11]+0.3162277660168379*alphax[8]+0.7905694150420947*alphax[7]-0.821583836257749*alphax[4]-0.4743416490252567*alphax[2]+0.6123724356957944*alphax[1]+0.3535533905932737*alphax[0]); 
  ...
  // Evaluate alpha at left surface quadrature points.
  alphaL = 0.125*(0.7348469228349535*alphavpar[17]-0.4242640687119285*alphavpar[13]-0.5477225575051661*alphavpar[11]-1.10227038425243*alphavpar[10]+0.3162277660168379*alphavpar[7]+0.821583836257749*alphavpar[6]+0.6363961030678926*alphavpar[5]+0.821583836257749*alphavpar[4]-0.4743416490252567*alphavpar[3]-0.6123724356957944*alphavpar[2]-0.4743416490252567*alphavpar[1]+0.3535533905932737*alphavpar[0]); 
  cflFreq += -0.5*(alphaL-fabs(alphaL)); 
  alphaL = 0.125*((-0.5477225575051661*alphavpar[11])+0.3162277660168379*alphavpar[7]+0.821583836257749*alphavpar[4]-0.6123724356957944*alphavpar[2]-0.4743416490252567*alphavpar[1]+0.3535533905932737*alphavpar[0]); 
  cflFreq += -0.5*(alphaL-fabs(alphaL)); 
  alphaL = 0.125*((-0.7348469228349535*alphavpar[17])+0.4242640687119285*alphavpar[13]-0.5477225575051661*alphavpar[11]+1.10227038425243*alphavpar[10]+0.3162277660168379*alphavpar[7]-0.821583836257749*alphavpar[6]-0.6363961030678926*alphavpar[5]+0.821583836257749*alphavpar[4]+0.4743416490252567*alphavpar[3]-0.6123724356957944*alphavpar[2]-0.4743416490252567*alphavpar[1]+0.3535533905932737*alphavpar[0]); 
  cflFreq += -0.5*(alphaL-fabs(alphaL)); 
  ...
  cflFreq += -0.5*(alphaL-fabs(alphaL)); 
  // Evaluate alpha at right surface quadrature points.
  alphaR = 0.125*((-0.7348469228349535*alphavpar[17])-0.4242640687119285*alphavpar[13]+0.5477225575051661*alphavpar[11]+1.10227038425243*alphavpar[10]+0.3162277660168379*alphavpar[7]-0.821583836257749*alphavpar[6]+0.6363961030678926*alphavpar[5]-0.821583836257749*alphavpar[4]-0.4743416490252567*alphavpar[3]+0.6123724356957944*alphavpar[2]-0.4743416490252567*alphavpar[1]+0.3535533905932737*alphavpar[0]); 
  cflFreq += 0.5*(alphaR+fabs(alphaR)); 
  alphaR = 0.125*(0.5477225575051661*alphavpar[11]+0.3162277660168379*alphavpar[7]-0.821583836257749*alphavpar[4]+0.6123724356957944*alphavpar[2]-0.4743416490252567*alphavpar[1]+0.3535533905932737*alphavpar[0]); 
  cflFreq += 0.5*(alphaR+fabs(alphaR)); 
  alphaR = 0.125*(0.7348469228349535*alphavpar[17]+0.4242640687119285*alphavpar[13]+0.5477225575051661*alphavpar[11]-1.10227038425243*alphavpar[10]+0.3162277660168379*alphavpar[7]+0.821583836257749*alphavpar[6]-0.6363961030678926*alphavpar[5]-0.821583836257749*alphavpar[4]+0.4743416490252567*alphavpar[3]+0.6123724356957944*alphavpar[2]-0.4743416490252567*alphavpar[1]+0.3535533905932737*alphavpar[0]); 
  cflFreq += 0.5*(alphaR+fabs(alphaR)); 
