...
{ 
  ...
  fUpR[0] = 1.58113883008419*fskin[32]+1.224744871391589*fskin[4]+0.7071067811865475*fskin[0]; 
  fUpR[1] = 1.58113883008419*fskin[33]+1.224744871391589*fskin[9]+0.7071067811865475*fskin[1]; 
  fUpR[2] = 1.58113883008419*fskin[34]+1.224744871391589*fskin[10]+0.7071067811865475*fskin[2]; 
  fUpR[3] = 1.58113883008419*fskin[35]+1.224744871391589*fskin[11]+0.7071067811865475*fskin[3]; 
  fUpR[4] = 1.58113883008419*fskin[36]+1.224744871391589*fskin[15]+0.7071067811865475*fskin[5]; 
  fUpR[5] = 1.58113883008419*fskin[37]+1.224744871391589*fskin[17]+0.7071067811865475*fskin[6]; 
  fUpR[6] = 1.58113883008419*fskin[38]+1.224744871391589*fskin[18]+0.7071067811865475*fskin[7]; 
  fUpR[7] = 1.58113883008419*fskin[39]+1.224744871391589*fskin[19]+0.7071067811865475*fskin[8]; 
  fUpR[8] = 1.58113883008419*fskin[40]+1.224744871391589*fskin[23]+0.7071067811865475*fskin[12]; 
  fUpR[9] = 1.58113883008419*fskin[41]+1.224744871391589*fskin[24]+0.7071067811865475*fskin[13]; 
  fUpR[10] = 1.58113883008419*fskin[42]+1.224744871391589*fskin[25]+0.7071067811865475*fskin[14]; 
  fUpR[11] = 1.58113883008419*fskin[43]+1.224744871391589*fskin[26]+0.7071067811865475*fskin[16]; 
  fUpR[12] = 1.58113883008419*fskin[44]+1.224744871391589*fskin[28]+0.7071067811865475*fskin[20]; 
  fUpR[13] = 1.58113883008419*fskin[45]+1.224744871391589*fskin[29]+0.7071067811865475*fskin[21]; 
  fUpR[14] = 1.58113883008419*fskin[46]+1.224744871391589*fskin[30]+0.7071067811865475*fskin[22]; 
  fUpR[15] = 1.58113883008419*fskin[47]+1.224744871391589*fskin[31]+0.7071067811865475*fskin[27]; 
    } else { 
  fUpR[0] = 1.58113883008419*fedge[32]-1.224744871391589*fedge[4]+0.7071067811865475*fedge[0]; 
  fUpR[1] = 1.58113883008419*fedge[33]-1.224744871391589*fedge[9]+0.7071067811865475*fedge[1]; 
  fUpR[2] = 1.58113883008419*fedge[34]-1.224744871391589*fedge[10]+0.7071067811865475*fedge[2]; 
  fUpR[3] = 1.58113883008419*fedge[35]-1.224744871391589*fedge[11]+0.7071067811865475*fedge[3]; 
  fUpR[4] = 1.58113883008419*fedge[36]-1.224744871391589*fedge[15]+0.7071067811865475*fedge[5]; 
  fUpR[5] = 1.58113883008419*fedge[37]-1.224744871391589*fedge[17]+0.7071067811865475*fedge[6]; 
  fUpR[6] = 1.58113883008419*fedge[38]-1.224744871391589*fedge[18]+0.7071067811865475*fedge[7]; 
  fUpR[7] = 1.58113883008419*fedge[39]-1.224744871391589*fedge[19]+0.7071067811865475*fedge[8]; 
  fUpR[8] = 1.58113883008419*fedge[40]-1.224744871391589*fedge[23]+0.7071067811865475*fedge[12]; 
  fUpR[9] = 1.58113883008419*fedge[41]-1.224744871391589*fedge[24]+0.7071067811865475*fedge[13]; 
  fUpR[10] = 1.58113883008419*fedge[42]-1.224744871391589*fedge[25]+0.7071067811865475*fedge[14]; 
  fUpR[11] = 1.58113883008419*fedge[43]-1.224744871391589*fedge[26]+0.7071067811865475*fedge[16]; 
  fUpR[12] = 1.58113883008419*fedge[44]-1.224744871391589*fedge[28]+0.7071067811865475*fedge[20]; 
  fUpR[13] = 1.58113883008419*fedge[45]-1.224744871391589*fedge[29]+0.7071067811865475*fedge[21]; 
  fUpR[14] = 1.58113883008419*fedge[46]-1.224744871391589*fedge[30]+0.7071067811865475*fedge[22]; 
  fUpR[15] = 1.58113883008419*fedge[47]-1.224744871391589*fedge[31]+0.7071067811865475*fedge[27]; 
    } 
  } else { 
  double f_cr[16] = {0.};
  double f_rl[16] = {0.};
  ...
  f_cr[0] = 1.58113883008419*fskin[32]+1.224744871391589*fskin[4]+0.7071067811865475*fskin[0]; 
  f_cr[1] = 1.58113883008419*fskin[33]+1.224744871391589*fskin[9]+0.7071067811865475*fskin[1]; 
  f_cr[2] = 1.58113883008419*fskin[34]+1.224744871391589*fskin[10]+0.7071067811865475*fskin[2]; 
  f_cr[3] = 1.58113883008419*fskin[35]+1.224744871391589*fskin[11]+0.7071067811865475*fskin[3]; 
  f_cr[4] = 1.58113883008419*fskin[36]+1.224744871391589*fskin[15]+0.7071067811865475*fskin[5]; 
  f_cr[5] = 1.58113883008419*fskin[37]+1.224744871391589*fskin[17]+0.7071067811865475*fskin[6]; 
  f_cr[6] = 1.58113883008419*fskin[38]+1.224744871391589*fskin[18]+0.7071067811865475*fskin[7]; 
  f_cr[7] = 1.58113883008419*fskin[39]+1.224744871391589*fskin[19]+0.7071067811865475*fskin[8]; 
  f_cr[8] = 1.58113883008419*fskin[40]+1.224744871391589*fskin[23]+0.7071067811865475*fskin[12]; 
  f_cr[9] = 1.58113883008419*fskin[41]+1.224744871391589*fskin[24]+0.7071067811865475*fskin[13]; 
  f_cr[10] = 1.58113883008419*fskin[42]+1.224744871391589*fskin[25]+0.7071067811865475*fskin[14]; 
  f_cr[11] = 1.58113883008419*fskin[43]+1.224744871391589*fskin[26]+0.7071067811865475*fskin[16]; 
  f_cr[12] = 1.58113883008419*fskin[44]+1.224744871391589*fskin[28]+0.7071067811865475*fskin[20]; 
  f_cr[13] = 1.58113883008419*fskin[45]+1.224744871391589*fskin[29]+0.7071067811865475*fskin[21]; 
  f_cr[14] = 1.58113883008419*fskin[46]+1.224744871391589*fskin[30]+0.7071067811865475*fskin[22]; 
  f_cr[15] = 1.58113883008419*fskin[47]+1.224744871391589*fskin[31]+0.7071067811865475*fskin[27]; 

  f_rl[0] = 1.58113883008419*fedge[32]-1.224744871391589*fedge[4]+0.7071067811865475*fedge[0]; 
  f_rl[1] = 1.58113883008419*fedge[33]-1.224744871391589*fedge[9]+0.7071067811865475*fedge[1]; 
  f_rl[2] = 1.58113883008419*fedge[34]-1.224744871391589*fedge[10]+0.7071067811865475*fedge[2]; 
  f_rl[3] = 1.58113883008419*fedge[35]-1.224744871391589*fedge[11]+0.7071067811865475*fedge[3]; 
  f_rl[4] = 1.58113883008419*fedge[36]-1.224744871391589*fedge[15]+0.7071067811865475*fedge[5]; 
  f_rl[5] = 1.58113883008419*fedge[37]-1.224744871391589*fedge[17]+0.7071067811865475*fedge[6]; 
  f_rl[6] = 1.58113883008419*fedge[38]-1.224744871391589*fedge[18]+0.7071067811865475*fedge[7]; 
  f_rl[7] = 1.58113883008419*fedge[39]-1.224744871391589*fedge[19]+0.7071067811865475*fedge[8]; 
  f_rl[8] = 1.58113883008419*fedge[40]-1.224744871391589*fedge[23]+0.7071067811865475*fedge[12]; 
  f_rl[9] = 1.58113883008419*fedge[41]-1.224744871391589*fedge[24]+0.7071067811865475*fedge[13]; 
  f_rl[10] = 1.58113883008419*fedge[42]-1.224744871391589*fedge[25]+0.7071067811865475*fedge[14]; 
  f_rl[11] = 1.58113883008419*fedge[43]-1.224744871391589*fedge[26]+0.7071067811865475*fedge[16]; 
  f_rl[12] = 1.58113883008419*fedge[44]-1.224744871391589*fedge[28]+0.7071067811865475*fedge[20]; 
  f_rl[13] = 1.58113883008419*fedge[45]-1.224744871391589*fedge[29]+0.7071067811865475*fedge[21]; 
  f_rl[14] = 1.58113883008419*fedge[46]-1.224744871391589*fedge[30]+0.7071067811865475*fedge[22]; 
  f_rl[15] = 1.58113883008419*fedge[47]-1.224744871391589*fedge[31]+0.7071067811865475*fedge[27]; 
  ...
  fUpL[0] = 1.58113883008419*fedge[32]+1.224744871391589*fedge[4]+0.7071067811865475*fedge[0]; 
  fUpL[1] = 1.58113883008419*fedge[33]+1.224744871391589*fedge[9]+0.7071067811865475*fedge[1]; 
  fUpL[2] = 1.58113883008419*fedge[34]+1.224744871391589*fedge[10]+0.7071067811865475*fedge[2]; 
  fUpL[3] = 1.58113883008419*fedge[35]+1.224744871391589*fedge[11]+0.7071067811865475*fedge[3]; 
  fUpL[4] = 1.58113883008419*fedge[36]+1.224744871391589*fedge[15]+0.7071067811865475*fedge[5]; 
  fUpL[5] = 1.58113883008419*fedge[37]+1.224744871391589*fedge[17]+0.7071067811865475*fedge[6]; 
  fUpL[6] = 1.58113883008419*fedge[38]+1.224744871391589*fedge[18]+0.7071067811865475*fedge[7]; 
  fUpL[7] = 1.58113883008419*fedge[39]+1.224744871391589*fedge[19]+0.7071067811865475*fedge[8]; 
  fUpL[8] = 1.58113883008419*fedge[40]+1.224744871391589*fedge[23]+0.7071067811865475*fedge[12]; 
  fUpL[9] = 1.58113883008419*fedge[41]+1.224744871391589*fedge[24]+0.7071067811865475*fedge[13]; 
  fUpL[10] = 1.58113883008419*fedge[42]+1.224744871391589*fedge[25]+0.7071067811865475*fedge[14]; 
  fUpL[11] = 1.58113883008419*fedge[43]+1.224744871391589*fedge[26]+0.7071067811865475*fedge[16]; 
  fUpL[12] = 1.58113883008419*fedge[44]+1.224744871391589*fedge[28]+0.7071067811865475*fedge[20]; 
  fUpL[13] = 1.58113883008419*fedge[45]+1.224744871391589*fedge[29]+0.7071067811865475*fedge[21]; 
  fUpL[14] = 1.58113883008419*fedge[46]+1.224744871391589*fedge[30]+0.7071067811865475*fedge[22]; 
  fUpL[15] = 1.58113883008419*fedge[47]+1.224744871391589*fedge[31]+0.7071067811865475*fedge[27]; 
    } else { 
  fUpL[0] = 1.58113883008419*fskin[32]-1.224744871391589*fskin[4]+0.7071067811865475*fskin[0]; 
  fUpL[1] = 1.58113883008419*fskin[33]-1.224744871391589*fskin[9]+0.7071067811865475*fskin[1]; 
  fUpL[2] = 1.58113883008419*fskin[34]-1.224744871391589*fskin[10]+0.7071067811865475*fskin[2]; 
  fUpL[3] = 1.58113883008419*fskin[35]-1.224744871391589*fskin[11]+0.7071067811865475*fskin[3]; 
  fUpL[4] = 1.58113883008419*fskin[36]-1.224744871391589*fskin[15]+0.7071067811865475*fskin[5]; 
  fUpL[5] = 1.58113883008419*fskin[37]-1.224744871391589*fskin[17]+0.7071067811865475*fskin[6]; 
  fUpL[6] = 1.58113883008419*fskin[38]-1.224744871391589*fskin[18]+0.7071067811865475*fskin[7]; 
  fUpL[7] = 1.58113883008419*fskin[39]-1.224744871391589*fskin[19]+0.7071067811865475*fskin[8]; 
  fUpL[8] = 1.58113883008419*fskin[40]-1.224744871391589*fskin[23]+0.7071067811865475*fskin[12]; 
  fUpL[9] = 1.58113883008419*fskin[41]-1.224744871391589*fskin[24]+0.7071067811865475*fskin[13]; 
  fUpL[10] = 1.58113883008419*fskin[42]-1.224744871391589*fskin[25]+0.7071067811865475*fskin[14]; 
  fUpL[11] = 1.58113883008419*fskin[43]-1.224744871391589*fskin[26]+0.7071067811865475*fskin[16]; 
  fUpL[12] = 1.58113883008419*fskin[44]-1.224744871391589*fskin[28]+0.7071067811865475*fskin[20]; 
  fUpL[13] = 1.58113883008419*fskin[45]-1.224744871391589*fskin[29]+0.7071067811865475*fskin[21]; 
  fUpL[14] = 1.58113883008419*fskin[46]-1.224744871391589*fskin[30]+0.7071067811865475*fskin[22]; 
  fUpL[15] = 1.58113883008419*fskin[47]-1.224744871391589*fskin[31]+0.7071067811865475*fskin[27]; 
    } 
  } else { 
  double f_lr[16] = {0.};
  double f_cl[16] = {0.};
  ...
  f_lr[0] = 1.58113883008419*fedge[32]+1.224744871391589*fedge[4]+0.7071067811865475*fedge[0]; 
  f_lr[1] = 1.58113883008419*fedge[33]+1.224744871391589*fedge[9]+0.7071067811865475*fedge[1]; 
  f_lr[2] = 1.58113883008419*fedge[34]+1.224744871391589*fedge[10]+0.7071067811865475*fedge[2]; 
  f_lr[3] = 1.58113883008419*fedge[35]+1.224744871391589*fedge[11]+0.7071067811865475*fedge[3]; 
  f_lr[4] = 1.58113883008419*fedge[36]+1.224744871391589*fedge[15]+0.7071067811865475*fedge[5]; 
  f_lr[5] = 1.58113883008419*fedge[37]+1.224744871391589*fedge[17]+0.7071067811865475*fedge[6]; 
  f_lr[6] = 1.58113883008419*fedge[38]+1.224744871391589*fedge[18]+0.7071067811865475*fedge[7]; 
  f_lr[7] = 1.58113883008419*fedge[39]+1.224744871391589*fedge[19]+0.7071067811865475*fedge[8]; 
  f_lr[8] = 1.58113883008419*fedge[40]+1.224744871391589*fedge[23]+0.7071067811865475*fedge[12]; 
  f_lr[9] = 1.58113883008419*fedge[41]+1.224744871391589*fedge[24]+0.7071067811865475*fedge[13]; 
  f_lr[10] = 1.58113883008419*fedge[42]+1.224744871391589*fedge[25]+0.7071067811865475*fedge[14]; 
  f_lr[11] = 1.58113883008419*fedge[43]+1.224744871391589*fedge[26]+0.7071067811865475*fedge[16]; 
  f_lr[12] = 1.58113883008419*fedge[44]+1.224744871391589*fedge[28]+0.7071067811865475*fedge[20]; 
  f_lr[13] = 1.58113883008419*fedge[45]+1.224744871391589*fedge[29]+0.7071067811865475*fedge[21]; 
  f_lr[14] = 1.58113883008419*fedge[46]+1.224744871391589*fedge[30]+0.7071067811865475*fedge[22]; 
  f_lr[15] = 1.58113883008419*fedge[47]+1.224744871391589*fedge[31]+0.7071067811865475*fedge[27]; 

  f_cl[0] = 1.58113883008419*fskin[32]-1.224744871391589*fskin[4]+0.7071067811865475*fskin[0]; 
  f_cl[1] = 1.58113883008419*fskin[33]-1.224744871391589*fskin[9]+0.7071067811865475*fskin[1]; 
  f_cl[2] = 1.58113883008419*fskin[34]-1.224744871391589*fskin[10]+0.7071067811865475*fskin[2]; 
  f_cl[3] = 1.58113883008419*fskin[35]-1.224744871391589*fskin[11]+0.7071067811865475*fskin[3]; 
  f_cl[4] = 1.58113883008419*fskin[36]-1.224744871391589*fskin[15]+0.7071067811865475*fskin[5]; 
  f_cl[5] = 1.58113883008419*fskin[37]-1.224744871391589*fskin[17]+0.7071067811865475*fskin[6]; 
  f_cl[6] = 1.58113883008419*fskin[38]-1.224744871391589*fskin[18]+0.7071067811865475*fskin[7]; 
  f_cl[7] = 1.58113883008419*fskin[39]-1.224744871391589*fskin[19]+0.7071067811865475*fskin[8]; 
  f_cl[8] = 1.58113883008419*fskin[40]-1.224744871391589*fskin[23]+0.7071067811865475*fskin[12]; 
  f_cl[9] = 1.58113883008419*fskin[41]-1.224744871391589*fskin[24]+0.7071067811865475*fskin[13]; 
  f_cl[10] = 1.58113883008419*fskin[42]-1.224744871391589*fskin[25]+0.7071067811865475*fskin[14]; 
  f_cl[11] = 1.58113883008419*fskin[43]-1.224744871391589*fskin[26]+0.7071067811865475*fskin[16]; 
  f_cl[12] = 1.58113883008419*fskin[44]-1.224744871391589*fskin[28]+0.7071067811865475*fskin[20]; 
  f_cl[13] = 1.58113883008419*fskin[45]-1.224744871391589*fskin[29]+0.7071067811865475*fskin[21]; 
  f_cl[14] = 1.58113883008419*fskin[46]-1.224744871391589*fskin[30]+0.7071067811865475*fskin[22]; 
  f_cl[15] = 1.58113883008419*fskin[47]-1.224744871391589*fskin[31]+0.7071067811865475*fskin[27]; 
