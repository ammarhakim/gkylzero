...
GKYL_CU_DH double gyrokinetic_boundary_surfvpar_3x2v_ser_p1(const double *w, const double *dxv, const double *alpha_edge, const double *alpha_skin, const int edge, const double *fedge, const double *fskin, double* GKYL_RESTRICT out) 
{ 
  // w[NDIM]: cell-center.
  ...
  const double *alphaR = &alpha_edge[72];
  double fUpOrdR[16] = {0.};
  double alphaR_n = 0.;
  ...
  const double *alphaL = &alpha_skin[72];
  double fUpOrdL[16] = {0.};
  double alphaL_n = 0.;
