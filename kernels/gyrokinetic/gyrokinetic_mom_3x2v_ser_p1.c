...
{ 
  ...
  out[1] += volFact*(2.0*f[1]*wx1_sq+1.154700538379252*f[9]*dv1*wx1+0.149071198499986*f[33]*dv1_sq+0.1666666666666667*f[1]*dv1_sq); 
  out[2] += volFact*(2.0*f[2]*wx1_sq+1.154700538379252*f[10]*dv1*wx1+0.149071198499986*f[34]*dv1_sq+0.1666666666666667*f[2]*dv1_sq); 
  out[3] += volFact*(2.0*f[3]*wx1_sq+1.154700538379252*f[11]*dv1*wx1+0.149071198499986*f[35]*dv1_sq+0.1666666666666667*f[3]*dv1_sq); 
  out[4] += volFact*(2.0*f[6]*wx1_sq+1.154700538379252*f[17]*dv1*wx1+0.149071198499986*f[37]*dv1_sq+0.1666666666666667*f[6]*dv1_sq); 
  out[5] += volFact*(2.0*f[7]*wx1_sq+1.154700538379252*f[18]*dv1*wx1+0.149071198499986*f[38]*dv1_sq+0.1666666666666667*f[7]*dv1_sq); 
  out[6] += volFact*(2.0*f[8]*wx1_sq+1.154700538379252*f[19]*dv1*wx1+0.149071198499986*f[39]*dv1_sq+0.1666666666666667*f[8]*dv1_sq); 
  out[7] += volFact*(2.0*f[16]*wx1_sq+1.154700538379252*f[26]*dv1*wx1+0.149071198499986*f[43]*dv1_sq+0.1666666666666667*f[16]*dv1_sq); 
  double tmp[8]; 
...
{ 
  ...
  out[1] += volFact*(2.0*f[1]*wx1*wx1_sq+1.732050807568877*f[9]*dv1*wx1_sq+0.447213595499958*f[33]*dv1_sq*wx1+0.5*f[1]*dv1_sq*wx1+0.08660254037844387*f[9]*dv1*dv1_sq); 
  out[2] += volFact*(2.0*f[2]*wx1*wx1_sq+1.732050807568877*f[10]*dv1*wx1_sq+0.447213595499958*f[34]*dv1_sq*wx1+0.5*f[2]*dv1_sq*wx1+0.08660254037844387*f[10]*dv1*dv1_sq); 
  out[3] += volFact*(2.0*f[3]*wx1*wx1_sq+1.732050807568877*f[11]*dv1*wx1_sq+0.447213595499958*f[35]*dv1_sq*wx1+0.5*f[3]*dv1_sq*wx1+0.08660254037844387*f[11]*dv1*dv1_sq); 
  out[4] += volFact*(2.0*f[6]*wx1*wx1_sq+1.732050807568877*f[17]*dv1*wx1_sq+0.4472135954999579*f[37]*dv1_sq*wx1+0.5*f[6]*dv1_sq*wx1+0.08660254037844387*f[17]*dv1*dv1_sq); 
  out[5] += volFact*(2.0*f[7]*wx1*wx1_sq+1.732050807568877*f[18]*dv1*wx1_sq+0.4472135954999579*f[38]*dv1_sq*wx1+0.5*f[7]*dv1_sq*wx1+0.08660254037844387*f[18]*dv1*dv1_sq); 
  out[6] += volFact*(2.0*f[8]*wx1*wx1_sq+1.732050807568877*f[19]*dv1*wx1_sq+0.4472135954999579*f[39]*dv1_sq*wx1+0.5*f[8]*dv1_sq*wx1+0.08660254037844387*f[19]*dv1*dv1_sq); 
  out[7] += volFact*(2.0*f[16]*wx1*wx1_sq+1.732050807568877*f[26]*dv1*wx1_sq+0.447213595499958*f[43]*dv1_sq*wx1+0.5*f[16]*dv1_sq*wx1+0.08660254037844387*f[26]*dv1*dv1_sq); 
} 
...
{ 
  ...
  out[6] += 2.0*f[8]*volFact; 
  out[7] += 2.0*f[16]*volFact; 
  out[8] += volFact*(2.0*f[0]*wx1+0.5773502691896258*f[4]*dv1); 
  out[9] += volFact*(2.0*f[1]*wx1+0.5773502691896258*f[9]*dv1); 
  out[10] += volFact*(2.0*f[2]*wx1+0.5773502691896258*f[10]*dv1); 
  out[11] += volFact*(2.0*f[3]*wx1+0.5773502691896258*f[11]*dv1); 
  out[12] += volFact*(2.0*f[6]*wx1+0.5773502691896258*f[17]*dv1); 
  out[13] += volFact*(2.0*f[7]*wx1+0.5773502691896258*f[18]*dv1); 
  out[14] += volFact*(2.0*f[8]*wx1+0.5773502691896258*f[19]*dv1); 
  out[15] += volFact*(2.0*f[16]*wx1+0.5773502691896258*f[26]*dv1); 
  out[16] += volFact*(2.0*f[0]*wx1_sq+1.154700538379252*f[4]*dv1*wx1+(0.7071067811865475*bmag[7]*tmp[7])/m_+(0.7071067811865475*bmag[6]*tmp[6])/m_+(0.7071067811865475*bmag[5]*tmp[5])/m_+(0.7071067811865475*bmag[4]*tmp[4])/m_+(0.7071067811865475*bmag[3]*tmp[3])/m_+(0.7071067811865475*bmag[2]*tmp[2])/m_+(0.7071067811865475*bmag[1]*tmp[1])/m_+(0.7071067811865475*bmag[0]*tmp[0])/m_+0.149071198499986*f[32]*dv1_sq+0.1666666666666667*f[0]*dv1_sq); 
  out[17] += volFact*(2.0*f[1]*wx1_sq+1.154700538379252*f[9]*dv1*wx1+(0.7071067811865475*bmag[6]*tmp[7])/m_+(0.7071067811865475*tmp[6]*bmag[7])/m_+(0.7071067811865475*bmag[3]*tmp[5])/m_+(0.7071067811865475*tmp[3]*bmag[5])/m_+(0.7071067811865475*bmag[2]*tmp[4])/m_+(0.7071067811865475*tmp[2]*bmag[4])/m_+(0.7071067811865475*bmag[0]*tmp[1])/m_+(0.7071067811865475*tmp[0]*bmag[1])/m_+0.149071198499986*f[33]*dv1_sq+0.1666666666666667*f[1]*dv1_sq); 
  out[18] += volFact*(2.0*f[2]*wx1_sq+1.154700538379252*f[10]*dv1*wx1+(0.7071067811865475*bmag[5]*tmp[7])/m_+(0.7071067811865475*tmp[5]*bmag[7])/m_+(0.7071067811865475*bmag[3]*tmp[6])/m_+(0.7071067811865475*tmp[3]*bmag[6])/m_+(0.7071067811865475*bmag[1]*tmp[4])/m_+(0.7071067811865475*tmp[1]*bmag[4])/m_+(0.7071067811865475*bmag[0]*tmp[2])/m_+(0.7071067811865475*tmp[0]*bmag[2])/m_+0.149071198499986*f[34]*dv1_sq+0.1666666666666667*f[2]*dv1_sq); 
