...
{ 
  ...
  // if f is not realizable, no reflection from this node 
  if (0.02*(20.0*f[21]+2.23606797749979*(5.0*(2.0*(f[9]+f[7])-3.0*(f[3]+f[1]))-13.41640786499874*(f[15]+f[13]))+5.0*(9.0*f[5]+5.0*f[0])) <= 0. || fabs(xbarVal)>=.95) { 
  ...
  // if f is not realizable, no reflection from this node 
  if (-0.05*(10.0*f[21]+2.23606797749979*((-6.708203932499369*f[15])+5.0*f[9]+2.0*(3.0*f[1]-2.0*f[7]))-10.0*f[0]) <= 0. || fabs(xbarVal)>=.95) { 
  ...
  // if f is not realizable, no reflection from this node 
  if (0.02*(20.0*f[21]+2.23606797749979*(5.0*(2.0*(f[9]+f[7])+3.0*(f[3]-1.0*f[1]))-13.41640786499874*(f[15]-1.0*f[13]))+5.0*(5.0*f[0]-9.0*f[5])) <= 0. || fabs(xbarVal)>=.95) { 
  ...
  // if f is not realizable, no reflection from this node 
  if (-0.05*(10.0*f[21]-1.0*(2.23606797749979*(6.708203932499369*f[13]+4.0*f[9]-1.0*(5.0*f[7]+6.0*f[3]))+10.0*f[0])) <= 0. || fabs(xbarVal)>=.95) { 
  ...
  // if f is not realizable, no reflection from this node 
  if (0.125*(5.0*f[21]+2.0*(2.0*f[0]-2.23606797749979*(f[9]+f[7]))) <= 0. || fabs(xbarVal)>=.95) { 
  ...
  // if f is not realizable, no reflection from this node 
  if (-0.05*(10.0*f[21]+15.0*f[13]-1.0*(2.23606797749979*(4.0*f[9]-5.0*f[7]+6.0*f[3])+10.0*f[0])) <= 0. || fabs(xbarVal)>=.95) { 
  ...
  // if f is not realizable, no reflection from this node 
  if (0.02*(20.0*f[21]+2.23606797749979*(13.41640786499874*(f[15]-1.0*f[13])+5.0*(2.0*(f[9]+f[7])+3.0*(f[1]-1.0*f[3])))+5.0*(5.0*f[0]-9.0*f[5])) <= 0. || fabs(xbarVal)>=.95) { 
  ...
  // if f is not realizable, no reflection from this node 
  if (-0.05*(10.0*f[21]+2.23606797749979*(6.708203932499369*f[15]+5.0*f[9]-2.0*(2.0*f[7]+3.0*f[1]))-10.0*f[0]) <= 0. || fabs(xbarVal)>=.95) { 
  ...
  // if f is not realizable, no reflection from this node 
  if (0.02*(20.0*f[21]+2.23606797749979*(13.41640786499874*(f[15]+f[13])+5.0*(2.0*(f[9]+f[7])+3.0*(f[3]+f[1])))+5.0*(9.0*f[5]+5.0*f[0])) <= 0. || fabs(xbarVal)>=.95) { 
