...
GKYL_CU_DH double gyrokinetic_surfvpar_2x2v_ser_p2(const double *w, const double *dxv, const double *alpha_surf_l, const double *alpha_surf_r, const double *fl, const double *fc, const double *fr, double* GKYL_RESTRICT out) 
{ 
  // w[NDIM]: cell-center.
  ...
  const double *alphaL = &alpha_surf_l[40];
  const double *alphaR = &alpha_surf_r[40];
  double cflFreq = 0.0;
  double fUpOrdL[27] = {0.};
  double alphaL_n = 0.;
