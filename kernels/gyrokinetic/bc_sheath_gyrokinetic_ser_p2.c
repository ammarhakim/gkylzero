...
{ 
  ...
  if(0.1414213562373095*(2.23606797749979*(2.0*f[4]-3.0*f[1])+5.0*f[0]) <= 0. || fabsl(xbarVal)>=.95) { 
  fReflZQuad[0][0] = 0.0; 
  fReflZQuad[0][1] = 0.0; 
  fReflZQuad[0][2] = 0.0; 
  } else {
   ...
   if (wv > 0) {
    ...
    fac = b>500? 0. : b<-500? 1. : fabsl(b)<1e-10? (1.+xc)/2. : (expl(b*xc)-expl(-b))/(2.*sinhl(b)); 
    ...
    fac = (b>500 || fabsl(b)<1e-8)? 0. : b<-500? 1. : ((b*xc-1)*expl(b*xc)+(b+1)*expl(-b))/2./(b*coshl(b)-sinhl(b)); 
    if(isnan(fac) || isinf(fac)) {printf("reflect fac = %LG, b=%LG, xbarVal=%LG \n", fac, b, xbarVal); fac=0.;} 
    fReflZQuad[0][1] = (0.04714045207910316*(13.41640786499874*f[6]+3.0*(5.0*f[2]-6.708203932499369*f[3])))*fac; 
    fac = (((b*(3*b*xc*xc-(6*xc+b))+6)*expl(b*xc))/3-(2*(b*b+3*(b+1))*expl(-b))/3)/(-4*b*coshl(b) + 4/3*(3 + b*b)*sinhl(b)); 
    if(isnan(fac) || isinf(fac)) {printf("reflect fac = %LG, b=%LG, xbarVal=%LG \n", fac, b, xbarVal); fac=0.;} 
    fReflZQuad[0][2] = (-0.1414213562373095*(6.708203932499369*f[7]-5.0*f[5]))*fac; 
   } else { 
    xc = 2.*(-sqrt(vcutSq)-wv)/dv; 
    fac = b>500? 1. : b<-500? 0. : fabsl(b)<1e-10? (1.-xc)/2. : (expl(b)-expl(b*xc))/(2.*sinhl(b)); 
    if(isnan(fac) || isinf(fac)) {printf("reflect fac = %LG, b=%LG, xbarVal=%LG \n", fac, b, xbarVal); fac=0.;} 
    fReflZQuad[0][0] = (0.1414213562373095*(2.23606797749979*(2.0*f[4]-3.0*f[1])+5.0*f[0]))*fac; 
    fac = b>500? 1. : (b<-500 || fabsl(b)<1e-8)? 0. : ((b-1)*expl(b)-(b*xc-1)*expl(b*xc))/2./(b*coshl(b)-sinhl(b)); 
    if(isnan(fac) || isinf(fac)) {printf("reflect fac = %LG, b=%LG, xbarVal=%LG \n", fac, b, xbarVal); fac=0.;} 
    fReflZQuad[0][1] = (0.04714045207910316*(13.41640786499874*f[6]+3.0*(5.0*f[2]-6.708203932499369*f[3])))*fac; 
    fac = ((2*(b*b+3*(1-b))*expl(b))/3-((b*(3*b*xc*xc-(6*xc+b))+6)*expl(b*xc))/3)/(-4*b*coshl(b) + 4/3*(3 + b*b)*sinhl(b)); 
    if(isnan(fac) || isinf(fac)) {printf("reflect fac = %LG, b=%LG, xbarVal=%LG \n", fac, b, xbarVal); fac=0.;} 
    fReflZQuad[0][2] = (-0.1414213562373095*(6.708203932499369*f[7]-5.0*f[5]))*fac; 
   } 
  } 
  ...
  // if f is not realizable, no reflection from this node 
  if(-0.3535533905932737*(2.23606797749979*f[4]-2.0*f[0]) <= 0. || fabsl(xbarVal)>=.95) { 
  fReflZQuad[1][0] = 0.0; 
  fReflZQuad[1][1] = 0.0; 
  fReflZQuad[1][2] = 0.0; 
  } else {
...
void bc_sheath_gyrokinetic_reflectedf_upper_1x1v_ser_p2(const double wv, const double dv, const double vlowerSq, const double vupperSq, const double q2Dm, const double *phi, const double *phiWall, const double *f, double *fRefl) 
{ 
  double vcutSq; long double xc, b, xbarVal, fac; 
  double fReflZQuad[3][8]; 
...
{ 
  ...
  vcutSq = 0.5*(2.23606797749979*(1.414213562373095*phiWall[2]-1.414213562373095*phi[2])+1.732050807568877*(1.414213562373095*phi[1]-1.414213562373095*phiWall[1])+1.414213562373095*phiWall[0]-1.414213562373095*phi[0])*q2Dm; 
  if(vcutSq <= vlowerSq) { // absorb (no reflection) 
  fRefl[0] = 0.0; 
  fRefl[1] = 0.0; 
  fRefl[2] = 0.0; 
  ...
  // if f is not realizable, no reflection from this node 
  if (-0.02*(30.0*(f[15]+f[13])-1.0*(11.18033988749895*(2.0*(f[9]+f[7])-3.0*(f[3]+f[1]))+5.0*(9.0*f[5]+5.0*f[0]))) <= 0. || fabsl(xbarVal)>=.95) { 
  ...
  // if f is not realizable, no reflection from this node 
  if (0.05*(2.23606797749979*(6.708203932499369*f[15]-1.0*(5.0*f[9]+2.0*(3.0*f[1]-2.0*f[7])))+10.0*f[0]) <= 0. || fabsl(xbarVal)>=.95) { 
  ...
  // if f is not realizable, no reflection from this node 
  if (-0.02*(2.23606797749979*(13.41640786499874*(f[15]-1.0*f[13])-5.0*(2.0*(f[9]+f[7])+3.0*(f[3]-1.0*f[1])))+5.0*(9.0*f[5]-5.0*f[0])) <= 0. || fabsl(xbarVal)>=.95) { 
  ...
  // if f is not realizable, no reflection from this node 
  if (0.05*(2.23606797749979*(6.708203932499369*f[13]+4.0*f[9]-1.0*(5.0*f[7]+6.0*f[3]))+10.0*f[0]) <= 0. || fabsl(xbarVal)>=.95) { 
  ...
  // if f is not realizable, no reflection from this node 
  if (-0.25*(2.23606797749979*(f[9]+f[7])-2.0*f[0]) <= 0. || fabsl(xbarVal)>=.95) { 
  ...
  // if f is not realizable, no reflection from this node 
  if (-0.05*(15.0*f[13]-1.0*(2.23606797749979*(4.0*f[9]-5.0*f[7]+6.0*f[3])+10.0*f[0])) <= 0. || fabsl(xbarVal)>=.95) { 
  ...
  // if f is not realizable, no reflection from this node 
  if (0.02*(2.23606797749979*(13.41640786499874*(f[15]-1.0*f[13])+5.0*(2.0*(f[9]+f[7])+3.0*(f[1]-1.0*f[3])))+5.0*(5.0*f[0]-9.0*f[5])) <= 0. || fabsl(xbarVal)>=.95) { 
  ...
  // if f is not realizable, no reflection from this node 
  if (-0.05*(2.23606797749979*(6.708203932499369*f[15]+5.0*f[9]-2.0*(2.0*f[7]+3.0*f[1]))-10.0*f[0]) <= 0. || fabsl(xbarVal)>=.95) { 
  ...
  // if f is not realizable, no reflection from this node 
  if (0.02*(2.23606797749979*(13.41640786499874*(f[15]+f[13])+5.0*(2.0*(f[9]+f[7])+3.0*(f[3]+f[1])))+5.0*(9.0*f[5]+5.0*f[0])) <= 0. || fabsl(xbarVal)>=.95) { 
...
{ 
  ...
  vcutSq = 0.5*(2.23606797749979*(1.414213562373095*phiWall[2]-1.414213562373095*phi[2])+1.732050807568877*(1.414213562373095*phiWall[1]-1.414213562373095*phi[1])+1.414213562373095*phiWall[0]-1.414213562373095*phi[0])*q2Dm; 
  if(vcutSq <= vlowerSq) { // absorb (no reflection) 
  fRefl[0] = 0.0; 
  fRefl[1] = 0.0; 
  fRefl[2] = 0.0; 
...
void bc_sheath_gyrokinetic_reflectedf_lower_3x2v_ser_p2(const double wv, const double dv, const double vlowerSq, const double vupperSq, const double q2Dm, const double *phi, const double *phiWall, const double *f, double *fRefl) 
{ 
...
// node (x,y)_1 
  ...
  // if f is not realizable, no reflection from this node 
  if(0.005*(2.23606797749979*(6.708203932499369*(9.0*f[103]+5.0*(f[49]+f[48]+f[47])-4.0*(f[36]+f[35]+f[34]+f[33]+f[32]+f[31]))-1.0*(9.0*(5.0*(f[82]+f[81]+f[80])+2.0*(3.0*f[21]-2.0*(f[58]+f[57]+f[56])))+5.0*(5.0*f[20]+2.0*(3.0*(f[3]+f[2]+f[1])-2.0*(f[18]+f[17]+f[16])))))+10.0*(9.0*(f[8]+f[7]+f[6])+5.0*f[0])) <= 0. || fabsl(xbarVal)>=.95) { 
  ...
  // if f is not realizable, no reflection from this node 
  if(-0.002*(2.23606797749979*(13.41640786499874*(9.0*(f[103]-1.0*(f[93]+f[92]+f[91]))+5.0*(f[49]+f[48]+f[47]-1.0*(f[45]+f[44]+f[43]-1.0*(f[36]+f[35]+f[34]+f[33]))+f[32]+f[31]))-5.0*(9.0*(2.0*(f[82]+f[81]+f[80]-1.0*(f[73]+f[72]+f[71]+f[70]+f[69]+f[68]-1.0*(f[58]+f[57]+f[56])))+3.0*(f[27]+f[26]+f[25]-1.0*f[21]))+5.0*(2.0*(f[20]+f[18]+f[17]+f[16])+3.0*(f[5]-1.0*(f[3]+f[2]+f[1])))))+5.0*(81.0*f[52]+5.0*(9.0*(f[14]+f[13]+f[12])-1.0*(9.0*(f[8]+f[7]+f[6])+5.0*f[0])))) <= 0. || fabsl(xbarVal)>=.95) { 
  ...
  // if f is not realizable, no reflection from this node 
  if(0.005*(2.23606797749979*(6.708203932499369*(9.0*f[93]-4.0*(f[48]+f[47])+5.0*f[45]-4.0*(f[44]+f[43])+5.0*(f[36]+f[35])-4.0*(f[32]+f[31]))+9.0*(4.0*f[80]-5.0*(f[73]+f[72])+4.0*(f[69]+f[68])-1.0*(5.0*f[58]+6.0*f[25]))+5.0*(4.0*f[20]-5.0*f[18]+2.0*(2.0*(f[17]+f[16])-3.0*(f[5]+f[2]+f[1]))))+10.0*(9.0*(f[13]+f[12]+f[6])+5.0*f[0])) <= 0. || fabsl(xbarVal)>=.95) { 
  ...
  // if f is not realizable, no reflection from this node 
  if(-0.005*(11.18033988749895*(9.0*(f[80]+f[58])+5.0*(f[20]+f[18])+2.0*(3.0*(f[2]+f[1])-2.0*(f[17]+f[16])))-1.0*(15.0*(5.0*(f[48]+f[47]+f[36]+f[35])-4.0*(f[32]+f[31]))+10.0*(9.0*f[6]+5.0*f[0]))) <= 0. || fabsl(xbarVal)>=.95) { 
  ...
  // if f is not realizable, no reflection from this node 
  if(-0.005*(2.23606797749979*(6.708203932499369*(9.0*f[93]+4.0*(f[48]+f[47])+5.0*f[45]-1.0*(4.0*(f[44]+f[43])+5.0*(f[36]+f[35]))+4.0*(f[32]+f[31]))-1.0*(9.0*(4.0*f[80]+5.0*(f[73]+f[72])-1.0*(4.0*(f[69]+f[68])+5.0*f[58]-6.0*f[25]))+5.0*(4.0*f[20]-5.0*f[18]+2.0*(2.0*(f[17]+f[16])+3.0*(f[5]-1.0*(f[2]+f[1]))))))+10.0*(9.0*(f[13]+f[12])-1.0*(9.0*f[6]+5.0*f[0]))) <= 0. || fabsl(xbarVal)>=.95) { 
  ...
  // if f is not realizable, no reflection from this node 
  if(0.002*(2.23606797749979*(13.41640786499874*(9.0*(f[103]-1.0*f[93]+f[92]+f[91])+5.0*(f[49]-1.0*(f[48]+f[47]+f[45]+f[44]+f[43]+f[36]+f[35]-1.0*(f[34]+f[33]-1.0*(f[32]+f[31])))))-5.0*(9.0*(2.0*(f[82]+f[81]-1.0*(f[80]+f[73]+f[72]-1.0*(f[71]+f[70])+f[69]+f[68]+f[58]-1.0*(f[57]+f[56])))+3.0*((-1.0*(f[27]+f[26]))+f[25]-1.0*f[21]))+5.0*(3.0*(f[5]-1.0*f[3]+f[2]+f[1])-2.0*(f[20]+f[18]+f[17]+f[16]))))+5.0*(5.0*(9.0*((-1.0*f[14])+f[13]+f[12]-1.0*(f[8]+f[7]-1.0*f[6]))+5.0*f[0])-81.0*f[52])) <= 0. || fabsl(xbarVal)>=.95) { 
  ...
  // if f is not realizable, no reflection from this node 
  if(-0.005*(2.23606797749979*(6.708203932499369*(9.0*f[103]+5.0*(f[49]-1.0*(f[48]+f[47]))+4.0*(f[36]+f[35]-1.0*(f[34]+f[33]-1.0*(f[32]+f[31]))))-1.0*(9.0*(5.0*(f[82]+f[81]-1.0*f[80])+2.0*(2.0*(f[58]-1.0*(f[57]+f[56]))+3.0*f[21]))+5.0*(2.0*(2.0*(f[18]+f[17]+f[16])+3.0*(f[3]-1.0*(f[2]+f[1])))-5.0*f[20])))+10.0*(9.0*(f[8]+f[7])-1.0*(9.0*f[6]+5.0*f[0]))) <= 0. || fabsl(xbarVal)>=.95) { 
  ...
  // if f is not realizable, no reflection from this node 
  if(0.002*(2.23606797749979*(13.41640786499874*(9.0*(f[103]+f[93]-1.0*(f[92]+f[91]))+5.0*(f[49]-1.0*(f[48]+f[47]-1.0*f[45])+f[44]+f[43]-1.0*(f[36]+f[35]-1.0*(f[34]+f[33])+f[32]+f[31])))-5.0*(9.0*(2.0*(f[82]+f[81]-1.0*f[80]+f[73]+f[72]-1.0*(f[71]+f[70]-1.0*(f[69]+f[68])+f[58]-1.0*(f[57]+f[56])))+3.0*(f[27]+f[26]-1.0*(f[25]+f[21])))+5.0*(3.0*((-1.0*(f[5]+f[3]))+f[2]+f[1])-2.0*(f[20]+f[18]+f[17]+f[16]))))+5.0*(81.0*f[52]+5.0*(9.0*(f[14]-1.0*(f[13]+f[12]+f[8]+f[7]-1.0*f[6]))+5.0*f[0]))) <= 0. || fabsl(xbarVal)>=.95) { 
...
// node (x,y)_2 
  ...
  // if f is not realizable, no reflection from this node 
  if(0.005*(2.23606797749979*(6.708203932499369*(9.0*f[92]-4.0*(f[49]+f[47]+f[45])+5.0*f[44]-4.0*(f[43]+f[35])+5.0*f[34]-4.0*f[33]+5.0*f[32])+9.0*(4.0*(f[81]+f[72])-5.0*f[71]+4.0*f[70]-1.0*(5.0*(f[69]+f[57])+6.0*f[26]))+5.0*(4.0*(f[20]+f[18])-5.0*f[17]+2.0*(2.0*f[16]-3.0*(f[5]+f[3]+f[1]))))+10.0*(9.0*(f[14]+f[12]+f[7])+5.0*f[0])) <= 0. || fabsl(xbarVal)>=.95) { 
  fReflXYZMuQuad[0][0] = 0.0; 
  fReflXYZMuQuad[0][1] = 0.0; 
  fReflXYZMuQuad[0][2] = 0.0; 
  } else {
  ...
  // if f is not realizable, no reflection from this node 
  if(-0.005*(11.18033988749895*(9.0*(f[81]+f[57])+5.0*f[20]-4.0*f[18]+5.0*f[17]+2.0*(3.0*(f[3]+f[1])-2.0*f[16]))-1.0*(15.0*(5.0*(f[49]+f[47])-4.0*f[35]+5.0*f[34]-4.0*f[33]+5.0*f[32])+10.0*(9.0*f[7]+5.0*f[0]))) <= 0. || fabsl(xbarVal)>=.95) { 
  fReflXYZMuQuad[1][0] = 0.0; 
  fReflXYZMuQuad[1][1] = 0.0; 
  fReflXYZMuQuad[1][2] = 0.0; 
  } else {
  ...
  // if f is not realizable, no reflection from this node 
  if(-0.005*(2.23606797749979*(6.708203932499369*(9.0*f[92]+4.0*(f[49]+f[47]-1.0*f[45])+5.0*f[44]+4.0*(f[35]-1.0*f[43])-5.0*f[34]+4.0*f[33]-5.0*f[32])-1.0*(9.0*(4.0*(f[81]-1.0*f[72])+5.0*f[71]-4.0*f[70]+5.0*(f[69]-1.0*f[57])+6.0*f[26])+5.0*(4.0*(f[20]+f[18])-5.0*f[17]+2.0*(2.0*f[16]+3.0*(f[5]-1.0*(f[3]+f[1]))))))+10.0*(9.0*(f[14]+f[12])-1.0*(9.0*f[7]+5.0*f[0]))) <= 0. || fabsl(xbarVal)>=.95) { 
  fReflXYZMuQuad[2][0] = 0.0; 
  fReflXYZMuQuad[2][1] = 0.0; 
  fReflXYZMuQuad[2][2] = 0.0; 
  } else {
  ...
  // if f is not realizable, no reflection from this node 
  if(-0.005*(2.23606797749979*(5.0*(9.0*(f[72]+f[69])-4.0*f[20]+5.0*(f[18]+f[17])+2.0*(3.0*(f[5]+f[1])-2.0*f[16]))+6.708203932499369*(4.0*f[47]-5.0*(f[45]+f[44])+4.0*f[43]-5.0*(f[35]+f[32])))-10.0*(9.0*f[12]+5.0*f[0])) <= 0. || fabsl(xbarVal)>=.95) { 
  fReflXYZMuQuad[3][0] = 0.0; 
  fReflXYZMuQuad[3][1] = 0.0; 
  fReflXYZMuQuad[3][2] = 0.0; 
  } else {
  ...
  // if f is not realizable, no reflection from this node 
  if(0.025*(2.23606797749979*(6.708203932499369*(f[47]+f[35]+f[32])-1.0*(5.0*(f[20]+f[18]+f[17])+2.0*(3.0*f[1]-2.0*f[16])))+10.0*f[0]) <= 0. || fabsl(xbarVal)>=.95) { 
  fReflXYZMuQuad[4][0] = 0.0; 
  fReflXYZMuQuad[4][1] = 0.0; 
  fReflXYZMuQuad[4][2] = 0.0; 
  } else {
  ...
  // if f is not realizable, no reflection from this node 
  if(0.005*(2.23606797749979*(5.0*(9.0*(f[72]+f[69])+4.0*f[20]-5.0*(f[18]+f[17])+2.0*(2.0*f[16]+3.0*(f[5]-1.0*f[1])))-6.708203932499369*(4.0*f[47]+5.0*(f[45]+f[44])-1.0*(4.0*f[43]+5.0*(f[35]+f[32]))))+10.0*(5.0*f[0]-9.0*f[12])) <= 0. || fabsl(xbarVal)>=.95) { 
  fReflXYZMuQuad[5][0] = 0.0; 
  fReflXYZMuQuad[5][1] = 0.0; 
  fReflXYZMuQuad[5][2] = 0.0; 
  } else {
  ...
  // if f is not realizable, no reflection from this node 
  if(-0.005*(2.23606797749979*(6.708203932499369*(9.0*f[92]+4.0*((-1.0*f[49])+f[47]+f[45])-5.0*f[44]+4.0*(f[43]+f[35])+5.0*f[34]-1.0*(4.0*f[33]+5.0*f[32]))+9.0*(4.0*f[81]-1.0*(4.0*f[72]+5.0*f[71]-4.0*f[70])+5.0*f[69]-1.0*(5.0*f[57]+6.0*f[26]))+5.0*((-4.0*(f[20]+f[18]))+5.0*f[17]+2.0*(3.0*(f[5]-1.0*f[3]+f[1])-2.0*f[16])))+10.0*(9.0*(f[14]-1.0*f[12]+f[7])-5.0*f[0])) <= 0. || fabsl(xbarVal)>=.95) { 
  fReflXYZMuQuad[6][0] = 0.0; 
  fReflXYZMuQuad[6][1] = 0.0; 
  fReflXYZMuQuad[6][2] = 0.0; 
  } else {
  ...
  // if f is not realizable, no reflection from this node 
  if(0.005*(2.23606797749979*(5.0*(9.0*(f[81]+f[57])-5.0*f[20]+4.0*f[18]-5.0*f[17]+2.0*(2.0*f[16]+3.0*(f[3]-1.0*f[1])))-6.708203932499369*(5.0*(f[49]-1.0*f[47])+4.0*f[35]+5.0*f[34]-1.0*(4.0*f[33]+5.0*f[32])))+10.0*(5.0*f[0]-9.0*f[7])) <= 0. || fabsl(xbarVal)>=.95) { 
  fReflXYZMuQuad[7][0] = 0.0; 
  fReflXYZMuQuad[7][1] = 0.0; 
  fReflXYZMuQuad[7][2] = 0.0; 
  } else {
  ...
  // if f is not realizable, no reflection from this node 
  if(0.005*(2.23606797749979*(6.708203932499369*(9.0*f[92]+4.0*(f[49]-1.0*f[47]+f[45])-5.0*f[44]+4.0*f[43]-1.0*(4.0*f[35]+5.0*f[34])+4.0*f[33]+5.0*f[32])-1.0*(9.0*(4.0*(f[81]+f[72])+5.0*f[71]-1.0*(4.0*f[70]+5.0*(f[69]+f[57])-6.0*f[26]))+5.0*((-4.0*(f[20]+f[18]))+5.0*f[17]+2.0*(3.0*(f[1]-1.0*(f[5]+f[3]))-2.0*f[16]))))+10.0*(9.0*(f[14]-1.0*(f[12]+f[7]))+5.0*f[0])) <= 0. || fabsl(xbarVal)>=.95) { 
  fReflXYZMuQuad[8][0] = 0.0; 
  fReflXYZMuQuad[8][1] = 0.0; 
  fReflXYZMuQuad[8][2] = 0.0; 
  } else {
...
// node (x,y)_3 
  ...
  // if f is not realizable, no reflection from this node 
  if(0.002*(2.23606797749979*(13.41640786499874*(9.0*(f[103]+f[93]-1.0*f[92]+f[91])+5.0*((-1.0*f[49])+f[48]-1.0*(f[47]+f[45]+f[44]+f[43]-1.0*f[36]+f[35]+f[34]+f[33]+f[32]-1.0*f[31])))-5.0*(9.0*(2.0*(f[82]-1.0*f[81]+f[80]+f[73]-1.0*(f[72]+f[71]+f[70]+f[69]-1.0*(f[68]+f[58])+f[57]-1.0*f[56]))+3.0*((-1.0*f[27])+f[26]-1.0*(f[25]+f[21])))+5.0*(3.0*(f[5]+f[3]-1.0*f[2]+f[1])-2.0*(f[20]+f[18]+f[17]+f[16]))))+5.0*(5.0*(9.0*(f[14]-1.0*f[13]+f[12]-1.0*f[8]+f[7]-1.0*f[6])+5.0*f[0])-81.0*f[52])) <= 0. || fabsl(xbarVal)>=.95) { 
  fReflXYZMuQuad[0][0] = 0.0; 
  fReflXYZMuQuad[0][1] = 0.0; 
  fReflXYZMuQuad[0][2] = 0.0; 
  } else {
  ...
  // if f is not realizable, no reflection from this node 
  if(-0.005*(2.23606797749979*(6.708203932499369*(9.0*f[103]+5.0*((-1.0*f[49])+f[48]-1.0*f[47])+4.0*((-1.0*f[36])+f[35]+f[34]+f[33]+f[32]-1.0*f[31]))-1.0*(9.0*(5.0*(f[82]-1.0*f[81]+f[80])+2.0*(2.0*((-1.0*f[58])+f[57]-1.0*f[56])+3.0*f[21]))+5.0*(2.0*(2.0*(f[18]+f[17]+f[16])+3.0*((-1.0*f[3])+f[2]-1.0*f[1]))-5.0*f[20])))+10.0*(9.0*(f[8]-1.0*f[7]+f[6])-5.0*f[0])) <= 0. || fabsl(xbarVal)>=.95) { 
  fReflXYZMuQuad[1][0] = 0.0; 
  fReflXYZMuQuad[1][1] = 0.0; 
  fReflXYZMuQuad[1][2] = 0.0; 
  } else {
  ...
  // if f is not realizable, no reflection from this node 
  if(0.002*(2.23606797749979*(13.41640786499874*(9.0*(f[103]-1.0*f[93]+f[92]-1.0*f[91])+5.0*((-1.0*f[49])+f[48]-1.0*f[47]+f[45]+f[44]+f[43]+f[36]-1.0*(f[35]+f[34]+f[33]+f[32]-1.0*f[31])))-5.0*(9.0*(2.0*(f[82]-1.0*f[81]+f[80]-1.0*f[73]+f[72]+f[71]+f[70]+f[69]-1.0*f[68]+f[58]-1.0*f[57]+f[56])+3.0*(f[27]-1.0*f[26]+f[25]-1.0*f[21]))+5.0*(3.0*((-1.0*f[5])+f[3]-1.0*f[2]+f[1])-2.0*(f[20]+f[18]+f[17]+f[16]))))+5.0*(81.0*f[52]+5.0*(9.0*((-1.0*f[14])+f[13]-1.0*(f[12]+f[8]-1.0*f[7]+f[6]))+5.0*f[0]))) <= 0. || fabsl(xbarVal)>=.95) { 
  fReflXYZMuQuad[2][0] = 0.0; 
  fReflXYZMuQuad[2][1] = 0.0; 
  fReflXYZMuQuad[2][2] = 0.0; 
  } else {
  ...
  // if f is not realizable, no reflection from this node 
  if(-0.005*(2.23606797749979*(6.708203932499369*(9.0*f[93]+4.0*(f[47]-1.0*f[48])-5.0*f[45]+4.0*(f[44]+f[43])+5.0*(f[36]-1.0*f[35])+4.0*(f[32]-1.0*f[31]))+9.0*(4.0*f[80]+5.0*(f[72]-1.0*f[73])+4.0*(f[68]-1.0*f[69])-1.0*(5.0*f[58]+6.0*f[25]))+5.0*((-4.0*f[20])+5.0*f[18]+2.0*(3.0*(f[5]-1.0*f[2]+f[1])-2.0*(f[17]+f[16]))))+10.0*(9.0*(f[13]-1.0*f[12]+f[6])-5.0*f[0])) <= 0. || fabsl(xbarVal)>=.95) { 
  fReflXYZMuQuad[3][0] = 0.0; 
  fReflXYZMuQuad[3][1] = 0.0; 
  fReflXYZMuQuad[3][2] = 0.0; 
  } else {
  ...
  // if f is not realizable, no reflection from this node 
  if(0.005*(2.23606797749979*(5.0*(9.0*(f[80]+f[58])-5.0*(f[20]+f[18])+2.0*(2.0*(f[17]+f[16])+3.0*(f[2]-1.0*f[1])))-6.708203932499369*(5.0*(f[48]-1.0*f[47]+f[36]-1.0*f[35])+4.0*(f[32]-1.0*f[31])))+10.0*(5.0*f[0]-9.0*f[6])) <= 0. || fabsl(xbarVal)>=.95) { 
  fReflXYZMuQuad[4][0] = 0.0; 
  fReflXYZMuQuad[4][1] = 0.0; 
  fReflXYZMuQuad[4][2] = 0.0; 
  } else {
  ...
  // if f is not realizable, no reflection from this node 
  if(0.005*(2.23606797749979*(6.708203932499369*(9.0*f[93]+4.0*f[48]-1.0*(4.0*f[47]+5.0*f[45])+4.0*(f[44]+f[43])+5.0*(f[35]-1.0*f[36])+4.0*(f[31]-1.0*f[32]))-1.0*(9.0*(4.0*f[80]+5.0*(f[73]-1.0*f[72])+4.0*f[69]-1.0*(4.0*f[68]+5.0*f[58]-6.0*f[25]))+5.0*((-4.0*f[20])+5.0*f[18]+2.0*(3.0*(f[1]-1.0*(f[5]+f[2]))-2.0*(f[17]+f[16])))))+10.0*(9.0*(f[13]-1.0*(f[12]+f[6]))+5.0*f[0])) <= 0. || fabsl(xbarVal)>=.95) { 
  fReflXYZMuQuad[5][0] = 0.0; 
  fReflXYZMuQuad[5][1] = 0.0; 
  fReflXYZMuQuad[5][2] = 0.0; 
  } else {
  ...
  // if f is not realizable, no reflection from this node 
  if(-0.002*(2.23606797749979*(13.41640786499874*(9.0*(f[103]-1.0*(f[93]+f[92]-1.0*f[91]))+5.0*((-1.0*(f[49]+f[48]))+f[47]+f[45]+f[44]+f[43]-1.0*f[36]+f[35]-1.0*(f[34]+f[33]-1.0*f[32]+f[31])))-5.0*(9.0*(2.0*(f[82]-1.0*(f[81]+f[80]+f[73]-1.0*f[72]+f[71]+f[70]-1.0*f[69]+f[68]+f[58]+f[57]-1.0*f[56]))+3.0*((-1.0*f[27])+f[26]+f[25]-1.0*f[21]))+5.0*(2.0*(f[20]+f[18]+f[17]+f[16])+3.0*((-1.0*f[5])+f[3]+f[2]-1.0*f[1]))))+5.0*(5.0*(9.0*(f[14]+f[13]-1.0*(f[12]+f[8]-1.0*(f[7]+f[6])))-5.0*f[0])-81.0*f[52])) <= 0. || fabsl(xbarVal)>=.95) { 
  fReflXYZMuQuad[6][0] = 0.0; 
  fReflXYZMuQuad[6][1] = 0.0; 
  fReflXYZMuQuad[6][2] = 0.0; 
  } else {
  ...
  // if f is not realizable, no reflection from this node 
  if(0.005*(2.23606797749979*(6.708203932499369*(9.0*f[103]+5.0*(f[47]-1.0*(f[49]+f[48]))+4.0*(f[36]-1.0*f[35]+f[34]+f[33]-1.0*f[32]+f[31]))-1.0*(9.0*(5.0*(f[82]-1.0*(f[81]+f[80]))+2.0*(2.0*(f[58]+f[57]-1.0*f[56])+3.0*f[21]))+5.0*(5.0*f[20]+2.0*(3.0*(f[1]-1.0*(f[3]+f[2]))-2.0*(f[18]+f[17]+f[16])))))+10.0*(9.0*(f[8]-1.0*(f[7]+f[6]))+5.0*f[0])) <= 0. || fabsl(xbarVal)>=.95) { 
  fReflXYZMuQuad[7][0] = 0.0; 
  fReflXYZMuQuad[7][1] = 0.0; 
  fReflXYZMuQuad[7][2] = 0.0; 
  } else {
  ...
  // if f is not realizable, no reflection from this node 
  if(-0.002*(2.23606797749979*(13.41640786499874*(9.0*(f[103]+f[93]+f[92]-1.0*f[91])+5.0*((-1.0*(f[49]+f[48]))+f[47]-1.0*(f[45]+f[44]+f[43]+f[36]-1.0*f[35]+f[34]+f[33]-1.0*f[32]+f[31])))-5.0*(9.0*(2.0*(f[82]-1.0*(f[81]+f[80]-1.0*f[73]+f[72])+f[71]+f[70]-1.0*f[69]+f[68]-1.0*(f[58]+f[57]-1.0*f[56]))+3.0*(f[27]-1.0*(f[26]+f[25]+f[21])))+5.0*(2.0*(f[20]+f[18]+f[17]+f[16])+3.0*(f[5]+f[3]+f[2]-1.0*f[1]))))+5.0*(81.0*f[52]+5.0*(9.0*((-1.0*(f[14]+f[13]))+f[12]-1.0*f[8]+f[7]+f[6])-5.0*f[0]))) <= 0. || fabsl(xbarVal)>=.95) { 
  fReflXYZMuQuad[8][0] = 0.0; 
  fReflXYZMuQuad[8][1] = 0.0; 
  fReflXYZMuQuad[8][2] = 0.0; 
  } else {
...
// node (x,y)_4 
  ...
  // if f is not realizable, no reflection from this node 
  if(0.005*(2.23606797749979*(6.708203932499369*(9.0*f[91]-4.0*(f[49]+f[48]+f[45]+f[44])+5.0*f[43]-4.0*(f[36]+f[34])+5.0*(f[33]+f[31]))+9.0*(4.0*(f[82]+f[73]+f[71])-1.0*(5.0*(f[70]+f[68]+f[56])+6.0*f[27]))+5.0*(4.0*(f[20]+f[18]+f[17])-1.0*(5.0*f[16]+6.0*(f[5]+f[3]+f[2]))))+10.0*(9.0*(f[14]+f[13]+f[8])+5.0*f[0])) <= 0. || fabsl(xbarVal)>=.95) { 
  fReflXYZMuQuad[0][0] = 0.0; 
  fReflXYZMuQuad[0][1] = 0.0; 
  fReflXYZMuQuad[0][2] = 0.0; 
  } else {
  ...
  // if f is not realizable, no reflection from this node 
  if(-0.005*(11.18033988749895*(9.0*(f[82]+f[56])+5.0*f[20]-4.0*(f[18]+f[17])+5.0*f[16]+6.0*(f[3]+f[2]))-1.0*(15.0*(5.0*(f[49]+f[48])-4.0*(f[36]+f[34])+5.0*(f[33]+f[31]))+10.0*(9.0*f[8]+5.0*f[0]))) <= 0. || fabsl(xbarVal)>=.95) { 
  fReflXYZMuQuad[1][0] = 0.0; 
  fReflXYZMuQuad[1][1] = 0.0; 
  fReflXYZMuQuad[1][2] = 0.0; 
  } else {
  ...
  // if f is not realizable, no reflection from this node 
  if(-0.005*(2.23606797749979*(6.708203932499369*(9.0*f[91]+4.0*(f[49]+f[48]-1.0*(f[45]+f[44]))+5.0*f[43]+4.0*(f[36]+f[34])-5.0*(f[33]+f[31]))-1.0*(9.0*(4.0*(f[82]-1.0*(f[73]+f[71]))+5.0*(f[70]+f[68]-1.0*f[56])+6.0*f[27])+5.0*(4.0*(f[20]+f[18]+f[17])-5.0*f[16]+6.0*(f[5]-1.0*(f[3]+f[2])))))+10.0*(9.0*(f[14]+f[13])-1.0*(9.0*f[8]+5.0*f[0]))) <= 0. || fabsl(xbarVal)>=.95) { 
  fReflXYZMuQuad[2][0] = 0.0; 
  fReflXYZMuQuad[2][1] = 0.0; 
  fReflXYZMuQuad[2][2] = 0.0; 
  } else {
  ...
  // if f is not realizable, no reflection from this node 
  if(-0.005*(2.23606797749979*(5.0*(9.0*(f[73]+f[68])-4.0*f[20]+5.0*f[18]-4.0*f[17]+5.0*f[16]+6.0*(f[5]+f[2]))+6.708203932499369*(4.0*f[48]-5.0*f[45]+4.0*f[44]-5.0*(f[43]+f[36]+f[31])))-10.0*(9.0*f[13]+5.0*f[0])) <= 0. || fabsl(xbarVal)>=.95) { 
  fReflXYZMuQuad[3][0] = 0.0; 
  fReflXYZMuQuad[3][1] = 0.0; 
  fReflXYZMuQuad[3][2] = 0.0; 
  } else {
  ...
  // if f is not realizable, no reflection from this node 
  if(0.025*(2.23606797749979*(6.708203932499369*(f[48]+f[36]+f[31])-1.0*(5.0*(f[20]+f[18])-4.0*f[17]+5.0*f[16]+6.0*f[2]))+10.0*f[0]) <= 0. || fabsl(xbarVal)>=.95) { 
  fReflXYZMuQuad[4][0] = 0.0; 
  fReflXYZMuQuad[4][1] = 0.0; 
  fReflXYZMuQuad[4][2] = 0.0; 
  } else {
  ...
  // if f is not realizable, no reflection from this node 
  if(0.005*(2.23606797749979*(5.0*(9.0*(f[73]+f[68])+4.0*f[20]-5.0*f[18]+4.0*f[17]-5.0*f[16]+6.0*(f[5]-1.0*f[2]))-6.708203932499369*(4.0*f[48]+5.0*f[45]-4.0*f[44]+5.0*(f[43]-1.0*(f[36]+f[31]))))+10.0*(5.0*f[0]-9.0*f[13])) <= 0. || fabsl(xbarVal)>=.95) { 
  fReflXYZMuQuad[5][0] = 0.0; 
  fReflXYZMuQuad[5][1] = 0.0; 
  fReflXYZMuQuad[5][2] = 0.0; 
  } else {
  ...
  // if f is not realizable, no reflection from this node 
  if(-0.005*(2.23606797749979*(6.708203932499369*(9.0*f[91]+4.0*((-1.0*f[49])+f[48]+f[45]+f[44])-5.0*f[43]+4.0*(f[36]-1.0*f[34])+5.0*(f[33]-1.0*f[31]))+9.0*(4.0*(f[82]-1.0*f[73]+f[71])+5.0*(f[68]-1.0*f[70])-1.0*(5.0*f[56]+6.0*f[27]))+5.0*((-4.0*(f[20]+f[18]+f[17]))+5.0*f[16]+6.0*(f[5]-1.0*f[3]+f[2])))+10.0*(9.0*(f[14]-1.0*f[13]+f[8])-5.0*f[0])) <= 0. || fabsl(xbarVal)>=.95) { 
  fReflXYZMuQuad[6][0] = 0.0; 
  fReflXYZMuQuad[6][1] = 0.0; 
  fReflXYZMuQuad[6][2] = 0.0; 
  } else {
  ...
  // if f is not realizable, no reflection from this node 
  if(0.005*(2.23606797749979*(5.0*(9.0*(f[82]+f[56])-5.0*f[20]+4.0*(f[18]+f[17])-5.0*f[16]+6.0*(f[3]-1.0*f[2]))-6.708203932499369*(5.0*(f[49]-1.0*f[48])+4.0*(f[36]-1.0*f[34])+5.0*(f[33]-1.0*f[31])))+10.0*(5.0*f[0]-9.0*f[8])) <= 0. || fabsl(xbarVal)>=.95) { 
  fReflXYZMuQuad[7][0] = 0.0; 
  fReflXYZMuQuad[7][1] = 0.0; 
  fReflXYZMuQuad[7][2] = 0.0; 
  } else {
  ...
  // if f is not realizable, no reflection from this node 
  if(0.005*(2.23606797749979*(6.708203932499369*(9.0*f[91]+4.0*(f[49]-1.0*f[48]+f[45]+f[44])-5.0*f[43]+4.0*(f[34]-1.0*f[36])+5.0*(f[31]-1.0*f[33]))-1.0*(9.0*(4.0*(f[82]+f[73]-1.0*f[71])+5.0*(f[70]-1.0*(f[68]+f[56]))+6.0*f[27])+5.0*((-4.0*(f[20]+f[18]+f[17]))+5.0*f[16]+6.0*(f[2]-1.0*(f[5]+f[3])))))+10.0*(9.0*(f[14]-1.0*(f[13]+f[8]))+5.0*f[0])) <= 0. || fabsl(xbarVal)>=.95) { 
  fReflXYZMuQuad[8][0] = 0.0; 
  fReflXYZMuQuad[8][1] = 0.0; 
  fReflXYZMuQuad[8][2] = 0.0; 
  } else {
...
// node (x,y)_5 
  ...
  // if f is not realizable, no reflection from this node 
  if(-0.005*(2.23606797749979*(5.0*(9.0*(f[71]+f[70])-4.0*(f[20]+f[18])+5.0*(f[17]+f[16])+6.0*(f[5]+f[3]))+6.708203932499369*(4.0*(f[49]+f[45])-5.0*(f[44]+f[43]+f[34]+f[33])))-10.0*(9.0*f[14]+5.0*f[0])) <= 0. || fabsl(xbarVal)>=.95) { 
  fReflXYZMuQuad[0][0] = 0.0; 
  fReflXYZMuQuad[0][1] = 0.0; 
  fReflXYZMuQuad[0][2] = 0.0; 
  } else {
  ...
  // if f is not realizable, no reflection from this node 
  if(0.025*(2.23606797749979*(6.708203932499369*(f[49]+f[34]+f[33])-1.0*(5.0*f[20]-4.0*f[18]+5.0*(f[17]+f[16])+6.0*f[3]))+10.0*f[0]) <= 0. || fabsl(xbarVal)>=.95) { 
  fReflXYZMuQuad[1][0] = 0.0; 
  fReflXYZMuQuad[1][1] = 0.0; 
  fReflXYZMuQuad[1][2] = 0.0; 
  } else {
  ...
  // if f is not realizable, no reflection from this node 
  if(0.005*(2.23606797749979*(5.0*(9.0*(f[71]+f[70])+4.0*(f[20]+f[18])-5.0*(f[17]+f[16])+6.0*(f[5]-1.0*f[3]))-6.708203932499369*(4.0*(f[49]-1.0*f[45])+5.0*(f[44]+f[43]-1.0*(f[34]+f[33]))))+10.0*(5.0*f[0]-9.0*f[14])) <= 0. || fabsl(xbarVal)>=.95) { 
  fReflXYZMuQuad[2][0] = 0.0; 
  fReflXYZMuQuad[2][1] = 0.0; 
  fReflXYZMuQuad[2][2] = 0.0; 
  } else {
  ...
  // if f is not realizable, no reflection from this node 
  if(0.025*(2.23606797749979*(6.708203932499369*(f[45]+f[44]+f[43])+4.0*f[20]-1.0*(5.0*(f[18]+f[17]+f[16])+6.0*f[5]))+10.0*f[0]) <= 0. || fabsl(xbarVal)>=.95) { 
  fReflXYZMuQuad[3][0] = 0.0; 
  fReflXYZMuQuad[3][1] = 0.0; 
  fReflXYZMuQuad[3][2] = 0.0; 
  } else {
  ...
  // if f is not realizable, no reflection from this node 
  if(-0.125*(2.23606797749979*(f[20]+f[18]+f[17]+f[16])-2.0*f[0]) <= 0. || fabsl(xbarVal)>=.95) { 
  fReflXYZMuQuad[4][0] = 0.0; 
  fReflXYZMuQuad[4][1] = 0.0; 
  fReflXYZMuQuad[4][2] = 0.0; 
  } else {
  ...
  // if f is not realizable, no reflection from this node 
  if(-0.025*(15.0*(f[45]+f[44]+f[43])-1.0*(2.23606797749979*(4.0*f[20]-5.0*(f[18]+f[17]+f[16])+6.0*f[5])+10.0*f[0])) <= 0. || fabsl(xbarVal)>=.95) { 
  fReflXYZMuQuad[5][0] = 0.0; 
  fReflXYZMuQuad[5][1] = 0.0; 
  fReflXYZMuQuad[5][2] = 0.0; 
  } else {
  ...
  // if f is not realizable, no reflection from this node 
  if(0.005*(2.23606797749979*(5.0*(9.0*(f[71]+f[70])+4.0*(f[20]+f[18])-5.0*(f[17]+f[16])+6.0*(f[3]-1.0*f[5]))+6.708203932499369*(4.0*(f[49]-1.0*f[45])+5.0*(f[44]+f[43]-1.0*(f[34]+f[33]))))+10.0*(5.0*f[0]-9.0*f[14])) <= 0. || fabsl(xbarVal)>=.95) { 
  fReflXYZMuQuad[6][0] = 0.0; 
  fReflXYZMuQuad[6][1] = 0.0; 
  fReflXYZMuQuad[6][2] = 0.0; 
  } else {
  ...
  // if f is not realizable, no reflection from this node 
  if(-0.025*(2.23606797749979*(6.708203932499369*(f[49]+f[34]+f[33])+5.0*f[20]-4.0*f[18]+5.0*(f[17]+f[16])-6.0*f[3])-10.0*f[0]) <= 0. || fabsl(xbarVal)>=.95) { 
  fReflXYZMuQuad[7][0] = 0.0; 
  fReflXYZMuQuad[7][1] = 0.0; 
  fReflXYZMuQuad[7][2] = 0.0; 
  } else {
  ...
  // if f is not realizable, no reflection from this node 
  if(-0.005*(11.18033988749895*(9.0*(f[71]+f[70])-4.0*(f[20]+f[18])+5.0*(f[17]+f[16])-6.0*(f[5]+f[3]))-1.0*(15.0*(4.0*(f[49]+f[45])-5.0*(f[44]+f[43]+f[34]+f[33]))+10.0*(9.0*f[14]+5.0*f[0]))) <= 0. || fabsl(xbarVal)>=.95) { 
  fReflXYZMuQuad[8][0] = 0.0; 
  fReflXYZMuQuad[8][1] = 0.0; 
  fReflXYZMuQuad[8][2] = 0.0; 
  } else {
...
// node (x,y)_6 
  ...
  // if f is not realizable, no reflection from this node 
  if(-0.005*(2.23606797749979*(6.708203932499369*(9.0*f[91]+4.0*(f[49]-1.0*f[48]+f[45]+f[44])-5.0*f[43]+4.0*(f[34]-1.0*f[36])+5.0*(f[31]-1.0*f[33]))+9.0*(4.0*(f[82]+f[73]-1.0*f[71])+5.0*f[70]-1.0*(5.0*(f[68]+f[56])+6.0*f[27]))+5.0*((-4.0*(f[20]+f[18]+f[17]))+5.0*f[16]+6.0*(f[5]+f[3]-1.0*f[2])))+10.0*(9.0*((-1.0*f[14])+f[13]+f[8])-5.0*f[0])) <= 0. || fabsl(xbarVal)>=.95) { 
  fReflXYZMuQuad[0][0] = 0.0; 
  fReflXYZMuQuad[0][1] = 0.0; 
  fReflXYZMuQuad[0][2] = 0.0; 
  } else {
  ...
  // if f is not realizable, no reflection from this node 
  if(0.005*(2.23606797749979*(5.0*(9.0*(f[82]+f[56])-5.0*f[20]+4.0*(f[18]+f[17])-5.0*f[16]+6.0*(f[2]-1.0*f[3]))+6.708203932499369*(5.0*(f[49]-1.0*f[48])+4.0*(f[36]-1.0*f[34])+5.0*(f[33]-1.0*f[31])))+10.0*(5.0*f[0]-9.0*f[8])) <= 0. || fabsl(xbarVal)>=.95) { 
  fReflXYZMuQuad[1][0] = 0.0; 
  fReflXYZMuQuad[1][1] = 0.0; 
  fReflXYZMuQuad[1][2] = 0.0; 
  } else {
  ...
  // if f is not realizable, no reflection from this node 
  if(0.005*(2.23606797749979*(6.708203932499369*(9.0*f[91]+4.0*((-1.0*f[49])+f[48]+f[45]+f[44])-5.0*f[43]+4.0*(f[36]-1.0*f[34])+5.0*(f[33]-1.0*f[31]))-1.0*(9.0*(4.0*(f[82]-1.0*f[73]+f[71])+5.0*((-1.0*f[70])+f[68]-1.0*f[56])+6.0*f[27])+5.0*((-4.0*(f[20]+f[18]+f[17]))+5.0*f[16]+6.0*((-1.0*f[5])+f[3]-1.0*f[2]))))+10.0*(9.0*((-1.0*f[14])+f[13]-1.0*f[8])+5.0*f[0])) <= 0. || fabsl(xbarVal)>=.95) { 
  fReflXYZMuQuad[2][0] = 0.0; 
  fReflXYZMuQuad[2][1] = 0.0; 
  fReflXYZMuQuad[2][2] = 0.0; 
  } else {
  ...
  // if f is not realizable, no reflection from this node 
  if(0.005*(2.23606797749979*(5.0*(9.0*(f[73]+f[68])+4.0*f[20]-5.0*f[18]+4.0*f[17]-5.0*f[16]+6.0*(f[2]-1.0*f[5]))+6.708203932499369*(4.0*f[48]+5.0*f[45]-4.0*f[44]+5.0*(f[43]-1.0*(f[36]+f[31]))))+10.0*(5.0*f[0]-9.0*f[13])) <= 0. || fabsl(xbarVal)>=.95) { 
  fReflXYZMuQuad[3][0] = 0.0; 
  fReflXYZMuQuad[3][1] = 0.0; 
  fReflXYZMuQuad[3][2] = 0.0; 
  } else {
  ...
  // if f is not realizable, no reflection from this node 
  if(-0.025*(2.23606797749979*(6.708203932499369*(f[48]+f[36]+f[31])+5.0*(f[20]+f[18])-4.0*f[17]+5.0*f[16]-6.0*f[2])-10.0*f[0]) <= 0. || fabsl(xbarVal)>=.95) { 
  fReflXYZMuQuad[4][0] = 0.0; 
  fReflXYZMuQuad[4][1] = 0.0; 
  fReflXYZMuQuad[4][2] = 0.0; 
  } else {
  ...
  // if f is not realizable, no reflection from this node 
  if(-0.005*(11.18033988749895*(9.0*(f[73]+f[68])-4.0*f[20]+5.0*f[18]-4.0*f[17]+5.0*f[16]-6.0*(f[5]+f[2]))-1.0*(15.0*(4.0*f[48]-5.0*f[45]+4.0*f[44]-5.0*(f[43]+f[36]+f[31]))+10.0*(9.0*f[13]+5.0*f[0]))) <= 0. || fabsl(xbarVal)>=.95) { 
  fReflXYZMuQuad[5][0] = 0.0; 
  fReflXYZMuQuad[5][1] = 0.0; 
  fReflXYZMuQuad[5][2] = 0.0; 
  } else {
  ...
  // if f is not realizable, no reflection from this node 
  if(0.005*(2.23606797749979*(6.708203932499369*(9.0*f[91]+4.0*(f[49]+f[48]-1.0*(f[45]+f[44]))+5.0*f[43]+4.0*(f[36]+f[34])-5.0*(f[33]+f[31]))+9.0*(4.0*(f[82]-1.0*(f[73]+f[71]))+5.0*(f[70]+f[68])-1.0*(5.0*f[56]+6.0*f[27]))+5.0*(4.0*(f[20]+f[18]+f[17])-5.0*f[16]+6.0*((-1.0*f[5])+f[3]+f[2])))+10.0*(9.0*(f[8]-1.0*(f[14]+f[13]))+5.0*f[0])) <= 0. || fabsl(xbarVal)>=.95) { 
  fReflXYZMuQuad[6][0] = 0.0; 
  fReflXYZMuQuad[6][1] = 0.0; 
  fReflXYZMuQuad[6][2] = 0.0; 
  } else {
  ...
  // if f is not realizable, no reflection from this node 
  if(-0.005*(2.23606797749979*(5.0*(9.0*(f[82]+f[56])+5.0*f[20]-4.0*(f[18]+f[17])+5.0*f[16]-6.0*(f[3]+f[2]))+6.708203932499369*(5.0*(f[49]+f[48])-4.0*(f[36]+f[34])+5.0*(f[33]+f[31])))-10.0*(9.0*f[8]+5.0*f[0])) <= 0. || fabsl(xbarVal)>=.95) { 
  fReflXYZMuQuad[7][0] = 0.0; 
  fReflXYZMuQuad[7][1] = 0.0; 
  fReflXYZMuQuad[7][2] = 0.0; 
  } else {
  ...
  // if f is not realizable, no reflection from this node 
  if(-0.005*(15.0*(9.0*f[91]-4.0*(f[49]+f[48]+f[45]+f[44])+5.0*f[43]-4.0*(f[36]+f[34])+5.0*(f[33]+f[31]))-1.0*(2.23606797749979*(9.0*(4.0*(f[82]+f[73]+f[71])-5.0*(f[70]+f[68]+f[56])+6.0*f[27])+5.0*(4.0*(f[20]+f[18]+f[17])-5.0*f[16]+6.0*(f[5]+f[3]+f[2])))+10.0*(9.0*(f[14]+f[13]+f[8])+5.0*f[0]))) <= 0. || fabsl(xbarVal)>=.95) { 
  fReflXYZMuQuad[8][0] = 0.0; 
  fReflXYZMuQuad[8][1] = 0.0; 
  fReflXYZMuQuad[8][2] = 0.0; 
  } else {
...
// node (x,y)_7 
  ...
  // if f is not realizable, no reflection from this node 
  if(0.002*(2.23606797749979*(13.41640786499874*(9.0*(f[103]+f[93]+f[92]-1.0*f[91])+5.0*((-1.0*(f[49]+f[48]))+f[47]-1.0*(f[45]+f[44]+f[43]+f[36]-1.0*f[35]+f[34]+f[33]-1.0*f[32]+f[31])))+5.0*(9.0*(2.0*(f[82]-1.0*(f[81]+f[80]-1.0*f[73]+f[72])+f[71]+f[70]-1.0*f[69]+f[68]-1.0*(f[58]+f[57]-1.0*f[56]))+3.0*((-1.0*f[27])+f[26]+f[25]+f[21]))+5.0*(2.0*(f[20]+f[18]+f[17]+f[16])-3.0*(f[5]+f[3]+f[2]-1.0*f[1]))))+5.0*(5.0*(9.0*(f[14]+f[13]-1.0*f[12]+f[8]-1.0*(f[7]+f[6]))+5.0*f[0])-81.0*f[52])) <= 0. || fabsl(xbarVal)>=.95) { 
  fReflXYZMuQuad[0][0] = 0.0; 
  fReflXYZMuQuad[0][1] = 0.0; 
  fReflXYZMuQuad[0][2] = 0.0; 
  } else {
  ...
  // if f is not realizable, no reflection from this node 
  if(-0.005*(2.23606797749979*(6.708203932499369*(9.0*f[103]+5.0*(f[47]-1.0*(f[49]+f[48]))+4.0*(f[36]-1.0*f[35]+f[34]+f[33]-1.0*f[32]+f[31]))+9.0*(5.0*(f[82]-1.0*(f[81]+f[80]))+2.0*(2.0*(f[58]+f[57])-1.0*(2.0*f[56]+3.0*f[21])))+5.0*(5.0*f[20]+2.0*(3.0*(f[3]+f[2]-1.0*f[1])-2.0*(f[18]+f[17]+f[16]))))+10.0*(9.0*((-1.0*f[8])+f[7]+f[6])-5.0*f[0])) <= 0. || fabsl(xbarVal)>=.95) { 
  fReflXYZMuQuad[1][0] = 0.0; 
  fReflXYZMuQuad[1][1] = 0.0; 
  fReflXYZMuQuad[1][2] = 0.0; 
  } else {
  ...
  // if f is not realizable, no reflection from this node 
  if(0.002*(2.23606797749979*(13.41640786499874*(9.0*(f[103]-1.0*(f[93]+f[92]-1.0*f[91]))+5.0*((-1.0*(f[49]+f[48]))+f[47]+f[45]+f[44]+f[43]-1.0*f[36]+f[35]-1.0*(f[34]+f[33]-1.0*f[32]+f[31])))+5.0*(9.0*(2.0*(f[82]-1.0*(f[81]+f[80]+f[73]-1.0*f[72]+f[71]+f[70]-1.0*f[69]+f[68]+f[58]+f[57]-1.0*f[56]))+3.0*(f[27]-1.0*(f[26]+f[25]-1.0*f[21])))+5.0*(2.0*(f[20]+f[18]+f[17]+f[16])+3.0*(f[5]-1.0*(f[3]+f[2]-1.0*f[1])))))+5.0*(81.0*f[52]+5.0*(9.0*((-1.0*(f[14]+f[13]))+f[12]+f[8]-1.0*(f[7]+f[6]))+5.0*f[0]))) <= 0. || fabsl(xbarVal)>=.95) { 
  fReflXYZMuQuad[2][0] = 0.0; 
  fReflXYZMuQuad[2][1] = 0.0; 
  fReflXYZMuQuad[2][2] = 0.0; 
  } else {
  ...
  // if f is not realizable, no reflection from this node 
  if(-0.005*(2.23606797749979*(6.708203932499369*(9.0*f[93]+4.0*f[48]-1.0*(4.0*f[47]+5.0*f[45])+4.0*(f[44]+f[43])+5.0*(f[35]-1.0*f[36])+4.0*(f[31]-1.0*f[32]))+9.0*(4.0*f[80]+5.0*(f[73]-1.0*f[72])+4.0*f[69]-1.0*(4.0*f[68]+5.0*f[58]+6.0*f[25]))+5.0*((-4.0*f[20])+5.0*f[18]+2.0*(3.0*(f[5]+f[2]-1.0*f[1])-2.0*(f[17]+f[16]))))+10.0*(9.0*((-1.0*f[13])+f[12]+f[6])-5.0*f[0])) <= 0. || fabsl(xbarVal)>=.95) { 
  fReflXYZMuQuad[3][0] = 0.0; 
  fReflXYZMuQuad[3][1] = 0.0; 
  fReflXYZMuQuad[3][2] = 0.0; 
  } else {
  ...
  // if f is not realizable, no reflection from this node 
  if(0.005*(2.23606797749979*(5.0*(9.0*(f[80]+f[58])-5.0*(f[20]+f[18])+2.0*(2.0*(f[17]+f[16])+3.0*(f[1]-1.0*f[2])))+6.708203932499369*(5.0*(f[48]-1.0*f[47]+f[36]-1.0*f[35])+4.0*(f[32]-1.0*f[31])))+10.0*(5.0*f[0]-9.0*f[6])) <= 0. || fabsl(xbarVal)>=.95) { 
  fReflXYZMuQuad[4][0] = 0.0; 
  fReflXYZMuQuad[4][1] = 0.0; 
  fReflXYZMuQuad[4][2] = 0.0; 
  } else {
  ...
  // if f is not realizable, no reflection from this node 
  if(0.005*(2.23606797749979*(6.708203932499369*(9.0*f[93]+4.0*(f[47]-1.0*f[48])-5.0*f[45]+4.0*(f[44]+f[43])+5.0*(f[36]-1.0*f[35])+4.0*(f[32]-1.0*f[31]))-1.0*(9.0*(4.0*f[80]+5.0*(f[72]-1.0*f[73])+4.0*(f[68]-1.0*f[69])-5.0*f[58]+6.0*f[25])+5.0*((-4.0*f[20])+5.0*f[18]+2.0*(3.0*((-1.0*f[5])+f[2]-1.0*f[1])-2.0*(f[17]+f[16])))))+10.0*(9.0*((-1.0*f[13])+f[12]-1.0*f[6])+5.0*f[0])) <= 0. || fabsl(xbarVal)>=.95) { 
  fReflXYZMuQuad[5][0] = 0.0; 
  fReflXYZMuQuad[5][1] = 0.0; 
  fReflXYZMuQuad[5][2] = 0.0; 
  } else {
  ...
  // if f is not realizable, no reflection from this node 
  if(-0.002*(2.23606797749979*(13.41640786499874*(9.0*(f[103]-1.0*f[93]+f[92]-1.0*f[91])+5.0*((-1.0*f[49])+f[48]-1.0*f[47]+f[45]+f[44]+f[43]+f[36]-1.0*(f[35]+f[34]+f[33]+f[32]-1.0*f[31])))+5.0*(9.0*(2.0*(f[82]-1.0*f[81]+f[80]-1.0*f[73]+f[72]+f[71]+f[70]+f[69]-1.0*f[68]+f[58]-1.0*f[57]+f[56])+3.0*((-1.0*f[27])+f[26]-1.0*f[25]+f[21]))+5.0*(3.0*(f[5]-1.0*f[3]+f[2]-1.0*f[1])-2.0*(f[20]+f[18]+f[17]+f[16]))))+5.0*(5.0*(9.0*(f[14]-1.0*f[13]+f[12]+f[8]-1.0*f[7]+f[6])-5.0*f[0])-81.0*f[52])) <= 0. || fabsl(xbarVal)>=.95) { 
  fReflXYZMuQuad[6][0] = 0.0; 
  fReflXYZMuQuad[6][1] = 0.0; 
  fReflXYZMuQuad[6][2] = 0.0; 
  } else {
  ...
  // if f is not realizable, no reflection from this node 
  if(0.005*(2.23606797749979*(6.708203932499369*(9.0*f[103]+5.0*((-1.0*f[49])+f[48]-1.0*f[47])+4.0*((-1.0*f[36])+f[35]+f[34]+f[33]+f[32]-1.0*f[31]))+9.0*(5.0*(f[82]-1.0*f[81]+f[80])+2.0*(2.0*(f[57]-1.0*f[58])-1.0*(2.0*f[56]+3.0*f[21])))+5.0*(2.0*(2.0*(f[18]+f[17]+f[16])+3.0*(f[3]-1.0*f[2]+f[1]))-5.0*f[20]))+10.0*(9.0*((-1.0*f[8])+f[7]-1.0*f[6])+5.0*f[0])) <= 0. || fabsl(xbarVal)>=.95) { 
  fReflXYZMuQuad[7][0] = 0.0; 
  fReflXYZMuQuad[7][1] = 0.0; 
  fReflXYZMuQuad[7][2] = 0.0; 
  } else {
  ...
  // if f is not realizable, no reflection from this node 
  if(-0.002*(2.23606797749979*(13.41640786499874*(9.0*(f[103]+f[93]-1.0*f[92]+f[91])+5.0*((-1.0*f[49])+f[48]-1.0*(f[47]+f[45]+f[44]+f[43]-1.0*f[36]+f[35]+f[34]+f[33]+f[32]-1.0*f[31])))+5.0*(9.0*(2.0*(f[82]-1.0*f[81]+f[80]+f[73]-1.0*(f[72]+f[71]+f[70]+f[69]-1.0*(f[68]+f[58])+f[57]-1.0*f[56]))+3.0*(f[27]-1.0*f[26]+f[25]+f[21]))+5.0*(3.0*((-1.0*(f[5]+f[3]))+f[2]-1.0*f[1])-2.0*(f[20]+f[18]+f[17]+f[16]))))+5.0*(81.0*f[52]+5.0*(9.0*((-1.0*f[14])+f[13]-1.0*f[12]+f[8]-1.0*f[7]+f[6])-5.0*f[0]))) <= 0. || fabsl(xbarVal)>=.95) { 
  fReflXYZMuQuad[8][0] = 0.0; 
  fReflXYZMuQuad[8][1] = 0.0; 
  fReflXYZMuQuad[8][2] = 0.0; 
  } else {
...
// node (x,y)_8 
  ...
  // if f is not realizable, no reflection from this node 
  if(-0.005*(2.23606797749979*(6.708203932499369*(9.0*f[92]+4.0*(f[49]-1.0*f[47]+f[45])-5.0*f[44]+4.0*f[43]-1.0*(4.0*f[35]+5.0*f[34])+4.0*f[33]+5.0*f[32])+9.0*(4.0*(f[81]+f[72])+5.0*f[71]-1.0*(4.0*f[70]+5.0*(f[69]+f[57])+6.0*f[26]))+5.0*((-4.0*(f[20]+f[18]))+5.0*f[17]+2.0*(3.0*(f[5]+f[3]-1.0*f[1])-2.0*f[16])))+10.0*(9.0*((-1.0*f[14])+f[12]+f[7])-5.0*f[0])) <= 0. || fabsl(xbarVal)>=.95) { 
  fReflXYZMuQuad[0][0] = 0.0; 
  fReflXYZMuQuad[0][1] = 0.0; 
  fReflXYZMuQuad[0][2] = 0.0; 
  } else {
  ...
  // if f is not realizable, no reflection from this node 
  if(0.005*(2.23606797749979*(5.0*(9.0*(f[81]+f[57])-5.0*f[20]+4.0*f[18]-5.0*f[17]+2.0*(2.0*f[16]+3.0*(f[1]-1.0*f[3])))+6.708203932499369*(5.0*(f[49]-1.0*f[47])+4.0*f[35]+5.0*f[34]-1.0*(4.0*f[33]+5.0*f[32])))+10.0*(5.0*f[0]-9.0*f[7])) <= 0. || fabsl(xbarVal)>=.95) { 
  fReflXYZMuQuad[1][0] = 0.0; 
  fReflXYZMuQuad[1][1] = 0.0; 
  fReflXYZMuQuad[1][2] = 0.0; 
  } else {
  ...
  // if f is not realizable, no reflection from this node 
  if(0.005*(2.23606797749979*(6.708203932499369*(9.0*f[92]+4.0*((-1.0*f[49])+f[47]+f[45])-5.0*f[44]+4.0*(f[43]+f[35])+5.0*f[34]-1.0*(4.0*f[33]+5.0*f[32]))-1.0*(9.0*(4.0*f[81]-1.0*(4.0*f[72]+5.0*f[71]-4.0*f[70])+5.0*(f[69]-1.0*f[57])+6.0*f[26])+5.0*((-4.0*(f[20]+f[18]))+5.0*f[17]+2.0*(3.0*((-1.0*f[5])+f[3]-1.0*f[1])-2.0*f[16]))))+10.0*(9.0*((-1.0*f[14])+f[12]-1.0*f[7])+5.0*f[0])) <= 0. || fabsl(xbarVal)>=.95) { 
  fReflXYZMuQuad[2][0] = 0.0; 
  fReflXYZMuQuad[2][1] = 0.0; 
  fReflXYZMuQuad[2][2] = 0.0; 
  } else {
  ...
  // if f is not realizable, no reflection from this node 
  if(0.005*(2.23606797749979*(5.0*(9.0*(f[72]+f[69])+4.0*f[20]-5.0*(f[18]+f[17])+2.0*(2.0*f[16]+3.0*(f[1]-1.0*f[5])))+6.708203932499369*(4.0*f[47]+5.0*(f[45]+f[44])-1.0*(4.0*f[43]+5.0*(f[35]+f[32]))))+10.0*(5.0*f[0]-9.0*f[12])) <= 0. || fabsl(xbarVal)>=.95) { 
  fReflXYZMuQuad[3][0] = 0.0; 
  fReflXYZMuQuad[3][1] = 0.0; 
  fReflXYZMuQuad[3][2] = 0.0; 
  } else {
  ...
  // if f is not realizable, no reflection from this node 
  if(-0.025*(2.23606797749979*(6.708203932499369*(f[47]+f[35]+f[32])+5.0*(f[20]+f[18]+f[17])-2.0*(2.0*f[16]+3.0*f[1]))-10.0*f[0]) <= 0. || fabsl(xbarVal)>=.95) { 
  fReflXYZMuQuad[4][0] = 0.0; 
  fReflXYZMuQuad[4][1] = 0.0; 
  fReflXYZMuQuad[4][2] = 0.0; 
  } else {
  ...
  // if f is not realizable, no reflection from this node 
  if(-0.005*(11.18033988749895*(9.0*(f[72]+f[69])-4.0*f[20]+5.0*(f[18]+f[17])-2.0*(2.0*f[16]+3.0*(f[5]+f[1])))-1.0*(15.0*(4.0*f[47]-5.0*(f[45]+f[44])+4.0*f[43]-5.0*(f[35]+f[32]))+10.0*(9.0*f[12]+5.0*f[0]))) <= 0. || fabsl(xbarVal)>=.95) { 
  fReflXYZMuQuad[5][0] = 0.0; 
  fReflXYZMuQuad[5][1] = 0.0; 
  fReflXYZMuQuad[5][2] = 0.0; 
  } else {
  ...
  // if f is not realizable, no reflection from this node 
  if(0.005*(2.23606797749979*(6.708203932499369*(9.0*f[92]+4.0*(f[49]+f[47]-1.0*f[45])+5.0*f[44]+4.0*(f[35]-1.0*f[43])-5.0*f[34]+4.0*f[33]-5.0*f[32])+9.0*(4.0*(f[81]-1.0*f[72])+5.0*f[71]-4.0*f[70]+5.0*f[69]-1.0*(5.0*f[57]+6.0*f[26]))+5.0*(4.0*(f[20]+f[18])-5.0*f[17]+2.0*(2.0*f[16]+3.0*((-1.0*f[5])+f[3]+f[1]))))+10.0*(9.0*(f[7]-1.0*(f[14]+f[12]))+5.0*f[0])) <= 0. || fabsl(xbarVal)>=.95) { 
  fReflXYZMuQuad[6][0] = 0.0; 
  fReflXYZMuQuad[6][1] = 0.0; 
  fReflXYZMuQuad[6][2] = 0.0; 
  } else {
  ...
  // if f is not realizable, no reflection from this node 
  if(-0.005*(2.23606797749979*(5.0*(9.0*(f[81]+f[57])+5.0*f[20]-4.0*f[18]+5.0*f[17]-2.0*(2.0*f[16]+3.0*(f[3]+f[1])))+6.708203932499369*(5.0*(f[49]+f[47])-4.0*f[35]+5.0*f[34]-4.0*f[33]+5.0*f[32]))-10.0*(9.0*f[7]+5.0*f[0])) <= 0. || fabsl(xbarVal)>=.95) { 
  fReflXYZMuQuad[7][0] = 0.0; 
  fReflXYZMuQuad[7][1] = 0.0; 
  fReflXYZMuQuad[7][2] = 0.0; 
  } else {
  ...
  // if f is not realizable, no reflection from this node 
  if(-0.005*(15.0*(9.0*f[92]-4.0*(f[49]+f[47]+f[45])+5.0*f[44]-4.0*(f[43]+f[35])+5.0*f[34]-4.0*f[33]+5.0*f[32])-1.0*(2.23606797749979*(9.0*(4.0*(f[81]+f[72])-5.0*f[71]+4.0*f[70]-5.0*(f[69]+f[57])+6.0*f[26])+5.0*(4.0*(f[20]+f[18])-5.0*f[17]+2.0*(2.0*f[16]+3.0*(f[5]+f[3]+f[1]))))+10.0*(9.0*(f[14]+f[12]+f[7])+5.0*f[0]))) <= 0. || fabsl(xbarVal)>=.95) { 
  fReflXYZMuQuad[8][0] = 0.0; 
  fReflXYZMuQuad[8][1] = 0.0; 
  fReflXYZMuQuad[8][2] = 0.0; 
  } else {
...
// node (x,y)_9 
  ...
  // if f is not realizable, no reflection from this node 
  if(-0.002*(2.23606797749979*(13.41640786499874*(9.0*(f[103]+f[93]-1.0*(f[92]+f[91]))+5.0*(f[49]-1.0*(f[48]+f[47]-1.0*f[45])+f[44]+f[43]-1.0*(f[36]+f[35]-1.0*(f[34]+f[33])+f[32]+f[31])))+5.0*(9.0*(2.0*(f[82]+f[81]-1.0*f[80]+f[73]+f[72]-1.0*(f[71]+f[70]-1.0*(f[69]+f[68])+f[58]-1.0*(f[57]+f[56])))+3.0*((-1.0*(f[27]+f[26]))+f[25]+f[21]))+5.0*(3.0*(f[5]+f[3]-1.0*(f[2]+f[1]))-2.0*(f[20]+f[18]+f[17]+f[16]))))+5.0*(5.0*(9.0*((-1.0*f[14])+f[13]+f[12]+f[8]+f[7])-1.0*(9.0*f[6]+5.0*f[0]))-81.0*f[52])) <= 0. || fabsl(xbarVal)>=.95) { 
  fReflXYZMuQuad[0][0] = 0.0; 
  fReflXYZMuQuad[0][1] = 0.0; 
  fReflXYZMuQuad[0][2] = 0.0; 
  } else {
  ...
  // if f is not realizable, no reflection from this node 
  if(0.005*(2.23606797749979*(6.708203932499369*(9.0*f[103]+5.0*(f[49]-1.0*(f[48]+f[47]))+4.0*(f[36]+f[35]-1.0*(f[34]+f[33]-1.0*(f[32]+f[31]))))+9.0*(5.0*(f[82]+f[81]-1.0*f[80])+2.0*(2.0*f[58]-1.0*(2.0*(f[57]+f[56])+3.0*f[21])))+5.0*(2.0*(2.0*(f[18]+f[17]+f[16])+3.0*((-1.0*f[3])+f[2]+f[1]))-5.0*f[20]))+10.0*(9.0*(f[6]-1.0*(f[8]+f[7]))+5.0*f[0])) <= 0. || fabsl(xbarVal)>=.95) { 
  fReflXYZMuQuad[1][0] = 0.0; 
  fReflXYZMuQuad[1][1] = 0.0; 
  fReflXYZMuQuad[1][2] = 0.0; 
  } else {
  ...
  // if f is not realizable, no reflection from this node 
  if(-0.002*(2.23606797749979*(13.41640786499874*(9.0*(f[103]-1.0*f[93]+f[92]+f[91])+5.0*(f[49]-1.0*(f[48]+f[47]+f[45]+f[44]+f[43]+f[36]+f[35]-1.0*(f[34]+f[33]-1.0*(f[32]+f[31])))))+5.0*(9.0*(2.0*(f[82]+f[81]-1.0*(f[80]+f[73]+f[72]-1.0*(f[71]+f[70])+f[69]+f[68]+f[58]-1.0*(f[57]+f[56])))+3.0*(f[27]+f[26]-1.0*f[25]+f[21]))+5.0*(3.0*((-1.0*f[5])+f[3]-1.0*(f[2]+f[1]))-2.0*(f[20]+f[18]+f[17]+f[16]))))+5.0*(81.0*f[52]+5.0*(9.0*(f[14]-1.0*(f[13]+f[12]-1.0*f[8])+f[7])-1.0*(9.0*f[6]+5.0*f[0])))) <= 0. || fabsl(xbarVal)>=.95) { 
  fReflXYZMuQuad[2][0] = 0.0; 
  fReflXYZMuQuad[2][1] = 0.0; 
  fReflXYZMuQuad[2][2] = 0.0; 
  } else {
  ...
  // if f is not realizable, no reflection from this node 
  if(0.005*(2.23606797749979*(6.708203932499369*(9.0*f[93]+4.0*(f[48]+f[47])+5.0*f[45]-1.0*(4.0*(f[44]+f[43])+5.0*(f[36]+f[35]))+4.0*(f[32]+f[31]))+9.0*(4.0*f[80]+5.0*(f[73]+f[72])-1.0*(4.0*(f[69]+f[68])+5.0*f[58]+6.0*f[25]))+5.0*(4.0*f[20]-5.0*f[18]+2.0*(2.0*(f[17]+f[16])+3.0*((-1.0*f[5])+f[2]+f[1]))))+10.0*(9.0*(f[6]-1.0*(f[13]+f[12]))+5.0*f[0])) <= 0. || fabsl(xbarVal)>=.95) { 
  fReflXYZMuQuad[3][0] = 0.0; 
  fReflXYZMuQuad[3][1] = 0.0; 
  fReflXYZMuQuad[3][2] = 0.0; 
  } else {
  ...
  // if f is not realizable, no reflection from this node 
  if(-0.005*(2.23606797749979*(5.0*(9.0*(f[80]+f[58])+5.0*(f[20]+f[18])-2.0*(2.0*(f[17]+f[16])+3.0*(f[2]+f[1])))+6.708203932499369*(5.0*(f[48]+f[47]+f[36]+f[35])-4.0*(f[32]+f[31])))-10.0*(9.0*f[6]+5.0*f[0])) <= 0. || fabsl(xbarVal)>=.95) { 
  fReflXYZMuQuad[4][0] = 0.0; 
  fReflXYZMuQuad[4][1] = 0.0; 
  fReflXYZMuQuad[4][2] = 0.0; 
  } else {
  ...
  // if f is not realizable, no reflection from this node 
  if(-0.005*(15.0*(9.0*f[93]-4.0*(f[48]+f[47])+5.0*f[45]-4.0*(f[44]+f[43])+5.0*(f[36]+f[35])-4.0*(f[32]+f[31]))-1.0*(2.23606797749979*(9.0*(4.0*f[80]-5.0*(f[73]+f[72])+4.0*(f[69]+f[68])-5.0*f[58]+6.0*f[25])+5.0*(4.0*f[20]-5.0*f[18]+2.0*(2.0*(f[17]+f[16])+3.0*(f[5]+f[2]+f[1]))))+10.0*(9.0*(f[13]+f[12]+f[6])+5.0*f[0]))) <= 0. || fabsl(xbarVal)>=.95) { 
  fReflXYZMuQuad[5][0] = 0.0; 
  fReflXYZMuQuad[5][1] = 0.0; 
  fReflXYZMuQuad[5][2] = 0.0; 
  } else {
  ...
  // if f is not realizable, no reflection from this node 
  if(0.002*(2.23606797749979*(13.41640786499874*(9.0*(f[103]-1.0*(f[93]+f[92]+f[91]))+5.0*(f[49]+f[48]+f[47]-1.0*(f[45]+f[44]+f[43]-1.0*(f[36]+f[35]+f[34]+f[33]))+f[32]+f[31]))+5.0*(9.0*(2.0*(f[82]+f[81]+f[80])-1.0*(2.0*(f[73]+f[72]+f[71]+f[70]+f[69]+f[68]-1.0*(f[58]+f[57]+f[56]))+3.0*(f[27]+f[26]+f[25]-1.0*f[21])))+5.0*(2.0*(f[20]+f[18]+f[17]+f[16])+3.0*((-1.0*f[5])+f[3]+f[2]+f[1]))))+5.0*(5.0*(9.0*((-1.0*(f[14]+f[13]+f[12]-1.0*f[8]))+f[7]+f[6])+5.0*f[0])-81.0*f[52])) <= 0. || fabsl(xbarVal)>=.95) { 
  fReflXYZMuQuad[6][0] = 0.0; 
  fReflXYZMuQuad[6][1] = 0.0; 
  fReflXYZMuQuad[6][2] = 0.0; 
  } else {
  ...
  // if f is not realizable, no reflection from this node 
  if(-0.005*(2.23606797749979*(6.708203932499369*(9.0*f[103]+5.0*(f[49]+f[48]+f[47])-4.0*(f[36]+f[35]+f[34]+f[33]+f[32]+f[31]))+9.0*(5.0*(f[82]+f[81]+f[80])-2.0*(2.0*(f[58]+f[57]+f[56])+3.0*f[21]))+5.0*(5.0*f[20]-2.0*(2.0*(f[18]+f[17]+f[16])+3.0*(f[3]+f[2]+f[1]))))-10.0*(9.0*(f[8]+f[7]+f[6])+5.0*f[0])) <= 0. || fabsl(xbarVal)>=.95) { 
  fReflXYZMuQuad[7][0] = 0.0; 
  fReflXYZMuQuad[7][1] = 0.0; 
  fReflXYZMuQuad[7][2] = 0.0; 
  } else {
...
void bc_sheath_gyrokinetic_reflectedf_upper_3x2v_ser_p2(const double wv, const double dv, const double vlowerSq, const double vupperSq, const double q2Dm, const double *phi, const double *phiWall, const double *f, double *fRefl) 
{ 
  double vcutSq_i; long double xc, b, xbarVal, fac; 
  double fReflXYQuad[9][20]; 
  double fReflXYZMuQuad[9][8]; 
