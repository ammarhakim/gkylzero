...
{ 
  ...
  if (alphaL[5]+alphaL[4]-1.0*alphaL[3]-1.0*alphaL[2]-1.0*alphaL[1]+alphaL[0] > 0.) {
    fUpOrdL[0] = (-0.4330127018922193*fl[15])+0.4330127018922193*(fl[14]+fl[13])-0.25*fl[12]+0.4330127018922193*fl[11]-0.4330127018922193*fl[10]+0.25*(fl[9]+fl[8])-0.4330127018922193*(fl[7]+fl[6])+0.25*fl[5]-0.25*fl[4]+0.4330127018922193*fl[3]-0.25*(fl[2]+fl[1])+0.25*fl[0]; 
  } else {
    fUpOrdL[0] = 0.4330127018922193*fc[15]-0.4330127018922193*(fc[14]+fc[13])-0.25*fc[12]-0.4330127018922193*fc[11]+0.4330127018922193*fc[10]+0.25*(fc[9]+fc[8])+0.4330127018922193*(fc[7]+fc[6])+0.25*fc[5]-0.25*fc[4]-0.4330127018922193*fc[3]-0.25*(fc[2]+fc[1])+0.25*fc[0]; 
  }
  if ((-1.0*alphaL[5])+alphaL[4]+alphaL[3]-1.0*alphaL[2]-1.0*alphaL[1]+alphaL[0] > 0.) {
    fUpOrdL[1] = 0.4330127018922193*fl[15]-0.4330127018922193*(fl[14]+fl[13])+0.25*fl[12]+0.4330127018922193*(fl[11]+fl[10])-0.25*(fl[9]+fl[8])-0.4330127018922193*(fl[7]+fl[6])+0.25*(fl[5]+fl[4])+0.4330127018922193*fl[3]-0.25*(fl[2]+fl[1])+0.25*fl[0]; 
  } else {
    fUpOrdL[1] = (-0.4330127018922193*fc[15])+0.4330127018922193*(fc[14]+fc[13])+0.25*fc[12]-0.4330127018922193*(fc[11]+fc[10])-0.25*(fc[9]+fc[8])+0.4330127018922193*(fc[7]+fc[6])+0.25*(fc[5]+fc[4])-0.4330127018922193*fc[3]-0.25*(fc[2]+fc[1])+0.25*fc[0]; 
  }
  if (alphaL[5]-1.0*alphaL[4]-1.0*alphaL[3]+alphaL[2]-1.0*alphaL[1]+alphaL[0] > 0.) {
    fUpOrdL[2] = 0.4330127018922193*fl[15]-0.4330127018922193*fl[14]+0.4330127018922193*fl[13]+0.25*fl[12]-0.4330127018922193*(fl[11]+fl[10])-0.25*fl[9]+0.25*fl[8]+0.4330127018922193*fl[7]-0.4330127018922193*fl[6]-0.25*(fl[5]+fl[4])+0.4330127018922193*fl[3]+0.25*fl[2]-0.25*fl[1]+0.25*fl[0]; 
  } else {
    fUpOrdL[2] = (-0.4330127018922193*fc[15])+0.4330127018922193*fc[14]-0.4330127018922193*fc[13]+0.25*fc[12]+0.4330127018922193*(fc[11]+fc[10])-0.25*fc[9]+0.25*fc[8]-0.4330127018922193*fc[7]+0.4330127018922193*fc[6]-0.25*(fc[5]+fc[4])-0.4330127018922193*fc[3]+0.25*fc[2]-0.25*fc[1]+0.25*fc[0]; 
  }
  if ((-1.0*alphaL[5])-1.0*alphaL[4]+alphaL[3]+alphaL[2]-1.0*alphaL[1]+alphaL[0] > 0.) {
    fUpOrdL[3] = (-0.4330127018922193*fl[15])+0.4330127018922193*fl[14]-0.4330127018922193*fl[13]-0.25*fl[12]-0.4330127018922193*fl[11]+0.4330127018922193*fl[10]+0.25*fl[9]-0.25*fl[8]+0.4330127018922193*fl[7]-0.4330127018922193*fl[6]-0.25*fl[5]+0.25*fl[4]+0.4330127018922193*fl[3]+0.25*fl[2]-0.25*fl[1]+0.25*fl[0]; 
  } else {
    fUpOrdL[3] = 0.4330127018922193*fc[15]-0.4330127018922193*fc[14]+0.4330127018922193*fc[13]-0.25*fc[12]+0.4330127018922193*fc[11]-0.4330127018922193*fc[10]+0.25*fc[9]-0.25*fc[8]-0.4330127018922193*fc[7]+0.4330127018922193*fc[6]-0.25*fc[5]+0.25*fc[4]-0.4330127018922193*fc[3]+0.25*fc[2]-0.25*fc[1]+0.25*fc[0]; 
  }
  if ((-1.0*alphaL[5])-1.0*alphaL[4]-1.0*alphaL[3]-1.0*alphaL[2]+alphaL[1]+alphaL[0] > 0.) {
    fUpOrdL[4] = 0.4330127018922193*(fl[15]+fl[14])-0.4330127018922193*fl[13]+0.25*fl[12]-0.4330127018922193*(fl[11]+fl[10])+0.25*fl[9]-0.25*fl[8]-0.4330127018922193*fl[7]+0.4330127018922193*fl[6]-0.25*(fl[5]+fl[4])+0.4330127018922193*fl[3]-0.25*fl[2]+0.25*(fl[1]+fl[0]); 
  } else {
    fUpOrdL[4] = (-0.4330127018922193*(fc[15]+fc[14]))+0.4330127018922193*fc[13]+0.25*fc[12]+0.4330127018922193*(fc[11]+fc[10])+0.25*fc[9]-0.25*fc[8]+0.4330127018922193*fc[7]-0.4330127018922193*fc[6]-0.25*(fc[5]+fc[4])-0.4330127018922193*fc[3]-0.25*fc[2]+0.25*(fc[1]+fc[0]); 
  }
  if (alphaL[5]-1.0*alphaL[4]+alphaL[3]-1.0*alphaL[2]+alphaL[1]+alphaL[0] > 0.) {
    fUpOrdL[5] = (-0.4330127018922193*(fl[15]+fl[14]))+0.4330127018922193*fl[13]-0.25*fl[12]-0.4330127018922193*fl[11]+0.4330127018922193*fl[10]-0.25*fl[9]+0.25*fl[8]-0.4330127018922193*fl[7]+0.4330127018922193*fl[6]-0.25*fl[5]+0.25*fl[4]+0.4330127018922193*fl[3]-0.25*fl[2]+0.25*(fl[1]+fl[0]); 
  } else {
    fUpOrdL[5] = 0.4330127018922193*(fc[15]+fc[14])-0.4330127018922193*fc[13]-0.25*fc[12]+0.4330127018922193*fc[11]-0.4330127018922193*fc[10]-0.25*fc[9]+0.25*fc[8]+0.4330127018922193*fc[7]-0.4330127018922193*fc[6]-0.25*fc[5]+0.25*fc[4]-0.4330127018922193*fc[3]-0.25*fc[2]+0.25*(fc[1]+fc[0]); 
  }
  if ((-1.0*alphaL[5])+alphaL[4]-1.0*alphaL[3]+alphaL[2]+alphaL[1]+alphaL[0] > 0.) {
    fUpOrdL[6] = (-0.4330127018922193*(fl[15]+fl[14]+fl[13]))-0.25*fl[12]+0.4330127018922193*fl[11]-0.4330127018922193*fl[10]-0.25*(fl[9]+fl[8])+0.4330127018922193*(fl[7]+fl[6])+0.25*fl[5]-0.25*fl[4]+0.4330127018922193*fl[3]+0.25*(fl[2]+fl[1]+fl[0]); 
  } else {
    fUpOrdL[6] = 0.4330127018922193*(fc[15]+fc[14]+fc[13])-0.25*fc[12]-0.4330127018922193*fc[11]+0.4330127018922193*fc[10]-0.25*(fc[9]+fc[8])-0.4330127018922193*(fc[7]+fc[6])+0.25*fc[5]-0.25*fc[4]-0.4330127018922193*fc[3]+0.25*(fc[2]+fc[1]+fc[0]); 
  }
  if (alphaL[5]+alphaL[4]+alphaL[3]+alphaL[2]+alphaL[1]+alphaL[0] > 0.) {
    fUpOrdL[7] = 0.4330127018922193*(fl[15]+fl[14]+fl[13])+0.25*fl[12]+0.4330127018922193*(fl[11]+fl[10])+0.25*(fl[9]+fl[8])+0.4330127018922193*(fl[7]+fl[6])+0.25*(fl[5]+fl[4])+0.4330127018922193*fl[3]+0.25*(fl[2]+fl[1]+fl[0]); 
  } else {
    fUpOrdL[7] = (-0.4330127018922193*(fc[15]+fc[14]+fc[13]))+0.25*fc[12]-0.4330127018922193*(fc[11]+fc[10])+0.25*(fc[9]+fc[8])-0.4330127018922193*(fc[7]+fc[6])+0.25*(fc[5]+fc[4])-0.4330127018922193*fc[3]+0.25*(fc[2]+fc[1]+fc[0]); 
  }
  ...
  if (alphaR[5]+alphaR[4]-1.0*alphaR[3]-1.0*alphaR[2]-1.0*alphaR[1]+alphaR[0] > 0.) {
    fUpOrdR[0] = (-0.4330127018922193*fc[15])+0.4330127018922193*(fc[14]+fc[13])-0.25*fc[12]+0.4330127018922193*fc[11]-0.4330127018922193*fc[10]+0.25*(fc[9]+fc[8])-0.4330127018922193*(fc[7]+fc[6])+0.25*fc[5]-0.25*fc[4]+0.4330127018922193*fc[3]-0.25*(fc[2]+fc[1])+0.25*fc[0]; 
  } else {
    fUpOrdR[0] = 0.4330127018922193*fr[15]-0.4330127018922193*(fr[14]+fr[13])-0.25*fr[12]-0.4330127018922193*fr[11]+0.4330127018922193*fr[10]+0.25*(fr[9]+fr[8])+0.4330127018922193*(fr[7]+fr[6])+0.25*fr[5]-0.25*fr[4]-0.4330127018922193*fr[3]-0.25*(fr[2]+fr[1])+0.25*fr[0]; 
  }
  if ((-1.0*alphaR[5])+alphaR[4]+alphaR[3]-1.0*alphaR[2]-1.0*alphaR[1]+alphaR[0] > 0.) {
    fUpOrdR[1] = 0.4330127018922193*fc[15]-0.4330127018922193*(fc[14]+fc[13])+0.25*fc[12]+0.4330127018922193*(fc[11]+fc[10])-0.25*(fc[9]+fc[8])-0.4330127018922193*(fc[7]+fc[6])+0.25*(fc[5]+fc[4])+0.4330127018922193*fc[3]-0.25*(fc[2]+fc[1])+0.25*fc[0]; 
  } else {
    fUpOrdR[1] = (-0.4330127018922193*fr[15])+0.4330127018922193*(fr[14]+fr[13])+0.25*fr[12]-0.4330127018922193*(fr[11]+fr[10])-0.25*(fr[9]+fr[8])+0.4330127018922193*(fr[7]+fr[6])+0.25*(fr[5]+fr[4])-0.4330127018922193*fr[3]-0.25*(fr[2]+fr[1])+0.25*fr[0]; 
  }
  if (alphaR[5]-1.0*alphaR[4]-1.0*alphaR[3]+alphaR[2]-1.0*alphaR[1]+alphaR[0] > 0.) {
    fUpOrdR[2] = 0.4330127018922193*fc[15]-0.4330127018922193*fc[14]+0.4330127018922193*fc[13]+0.25*fc[12]-0.4330127018922193*(fc[11]+fc[10])-0.25*fc[9]+0.25*fc[8]+0.4330127018922193*fc[7]-0.4330127018922193*fc[6]-0.25*(fc[5]+fc[4])+0.4330127018922193*fc[3]+0.25*fc[2]-0.25*fc[1]+0.25*fc[0]; 
  } else {
    fUpOrdR[2] = (-0.4330127018922193*fr[15])+0.4330127018922193*fr[14]-0.4330127018922193*fr[13]+0.25*fr[12]+0.4330127018922193*(fr[11]+fr[10])-0.25*fr[9]+0.25*fr[8]-0.4330127018922193*fr[7]+0.4330127018922193*fr[6]-0.25*(fr[5]+fr[4])-0.4330127018922193*fr[3]+0.25*fr[2]-0.25*fr[1]+0.25*fr[0]; 
  }
  if ((-1.0*alphaR[5])-1.0*alphaR[4]+alphaR[3]+alphaR[2]-1.0*alphaR[1]+alphaR[0] > 0.) {
    fUpOrdR[3] = (-0.4330127018922193*fc[15])+0.4330127018922193*fc[14]-0.4330127018922193*fc[13]-0.25*fc[12]-0.4330127018922193*fc[11]+0.4330127018922193*fc[10]+0.25*fc[9]-0.25*fc[8]+0.4330127018922193*fc[7]-0.4330127018922193*fc[6]-0.25*fc[5]+0.25*fc[4]+0.4330127018922193*fc[3]+0.25*fc[2]-0.25*fc[1]+0.25*fc[0]; 
  } else {
    fUpOrdR[3] = 0.4330127018922193*fr[15]-0.4330127018922193*fr[14]+0.4330127018922193*fr[13]-0.25*fr[12]+0.4330127018922193*fr[11]-0.4330127018922193*fr[10]+0.25*fr[9]-0.25*fr[8]-0.4330127018922193*fr[7]+0.4330127018922193*fr[6]-0.25*fr[5]+0.25*fr[4]-0.4330127018922193*fr[3]+0.25*fr[2]-0.25*fr[1]+0.25*fr[0]; 
  }
  if ((-1.0*alphaR[5])-1.0*alphaR[4]-1.0*alphaR[3]-1.0*alphaR[2]+alphaR[1]+alphaR[0] > 0.) {
    fUpOrdR[4] = 0.4330127018922193*(fc[15]+fc[14])-0.4330127018922193*fc[13]+0.25*fc[12]-0.4330127018922193*(fc[11]+fc[10])+0.25*fc[9]-0.25*fc[8]-0.4330127018922193*fc[7]+0.4330127018922193*fc[6]-0.25*(fc[5]+fc[4])+0.4330127018922193*fc[3]-0.25*fc[2]+0.25*(fc[1]+fc[0]); 
  } else {
    fUpOrdR[4] = (-0.4330127018922193*(fr[15]+fr[14]))+0.4330127018922193*fr[13]+0.25*fr[12]+0.4330127018922193*(fr[11]+fr[10])+0.25*fr[9]-0.25*fr[8]+0.4330127018922193*fr[7]-0.4330127018922193*fr[6]-0.25*(fr[5]+fr[4])-0.4330127018922193*fr[3]-0.25*fr[2]+0.25*(fr[1]+fr[0]); 
  }
  if (alphaR[5]-1.0*alphaR[4]+alphaR[3]-1.0*alphaR[2]+alphaR[1]+alphaR[0] > 0.) {
    fUpOrdR[5] = (-0.4330127018922193*(fc[15]+fc[14]))+0.4330127018922193*fc[13]-0.25*fc[12]-0.4330127018922193*fc[11]+0.4330127018922193*fc[10]-0.25*fc[9]+0.25*fc[8]-0.4330127018922193*fc[7]+0.4330127018922193*fc[6]-0.25*fc[5]+0.25*fc[4]+0.4330127018922193*fc[3]-0.25*fc[2]+0.25*(fc[1]+fc[0]); 
  } else {
    fUpOrdR[5] = 0.4330127018922193*(fr[15]+fr[14])-0.4330127018922193*fr[13]-0.25*fr[12]+0.4330127018922193*fr[11]-0.4330127018922193*fr[10]-0.25*fr[9]+0.25*fr[8]+0.4330127018922193*fr[7]-0.4330127018922193*fr[6]-0.25*fr[5]+0.25*fr[4]-0.4330127018922193*fr[3]-0.25*fr[2]+0.25*(fr[1]+fr[0]); 
  }
  if ((-1.0*alphaR[5])+alphaR[4]-1.0*alphaR[3]+alphaR[2]+alphaR[1]+alphaR[0] > 0.) {
    fUpOrdR[6] = (-0.4330127018922193*(fc[15]+fc[14]+fc[13]))-0.25*fc[12]+0.4330127018922193*fc[11]-0.4330127018922193*fc[10]-0.25*(fc[9]+fc[8])+0.4330127018922193*(fc[7]+fc[6])+0.25*fc[5]-0.25*fc[4]+0.4330127018922193*fc[3]+0.25*(fc[2]+fc[1]+fc[0]); 
  } else {
    fUpOrdR[6] = 0.4330127018922193*(fr[15]+fr[14]+fr[13])-0.25*fr[12]-0.4330127018922193*fr[11]+0.4330127018922193*fr[10]-0.25*(fr[9]+fr[8])-0.4330127018922193*(fr[7]+fr[6])+0.25*fr[5]-0.25*fr[4]-0.4330127018922193*fr[3]+0.25*(fr[2]+fr[1]+fr[0]); 
  }
  if (alphaR[5]+alphaR[4]+alphaR[3]+alphaR[2]+alphaR[1]+alphaR[0] > 0.) {
    fUpOrdR[7] = 0.4330127018922193*(fc[15]+fc[14]+fc[13])+0.25*fc[12]+0.4330127018922193*(fc[11]+fc[10])+0.25*(fc[9]+fc[8])+0.4330127018922193*(fc[7]+fc[6])+0.25*(fc[5]+fc[4])+0.4330127018922193*fc[3]+0.25*(fc[2]+fc[1]+fc[0]); 
  } else {
    fUpOrdR[7] = (-0.4330127018922193*(fr[15]+fr[14]+fr[13]))+0.25*fr[12]-0.4330127018922193*(fr[11]+fr[10])+0.25*(fr[9]+fr[8])-0.4330127018922193*(fr[7]+fr[6])+0.25*(fr[5]+fr[4])-0.4330127018922193*fr[3]+0.25*(fr[2]+fr[1]+fr[0]); 
  }
