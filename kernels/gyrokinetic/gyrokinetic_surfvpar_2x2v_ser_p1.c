...
{ 
  ...
  const double *fnodal_l = &flux_surf_l[24]; 
  const double *fnodal_r = &flux_surf_r[24]; 
  GhatL[0] = 0.3535533905932737*(fnodal_l[7]+fnodal_l[6]+fnodal_l[5]+fnodal_l[4]+fnodal_l[3]+fnodal_l[2]+fnodal_l[1]+fnodal_l[0]); 
  GhatL[1] = 0.3535533905932737*(fnodal_l[7]+fnodal_l[6]+fnodal_l[5]+fnodal_l[4])-0.3535533905932737*(fnodal_l[3]+fnodal_l[2]+fnodal_l[1]+fnodal_l[0]); 
  GhatL[2] = 0.3535533905932737*(fnodal_l[7]+fnodal_l[6])-0.3535533905932737*(fnodal_l[5]+fnodal_l[4])+0.3535533905932737*(fnodal_l[3]+fnodal_l[2])-0.3535533905932737*(fnodal_l[1]+fnodal_l[0]); 
  ...
  GhatL[4] = 0.3535533905932737*(fnodal_l[7]+fnodal_l[6])-0.3535533905932737*(fnodal_l[5]+fnodal_l[4]+fnodal_l[3]+fnodal_l[2])+0.3535533905932737*(fnodal_l[1]+fnodal_l[0]); 
  GhatL[5] = 0.3535533905932737*fnodal_l[7]-0.3535533905932737*fnodal_l[6]+0.3535533905932737*fnodal_l[5]-0.3535533905932737*(fnodal_l[4]+fnodal_l[3])+0.3535533905932737*fnodal_l[2]-0.3535533905932737*fnodal_l[1]+0.3535533905932737*fnodal_l[0]; 
  GhatL[6] = 0.3535533905932737*fnodal_l[7]-0.3535533905932737*(fnodal_l[6]+fnodal_l[5])+0.3535533905932737*(fnodal_l[4]+fnodal_l[3])-0.3535533905932737*(fnodal_l[2]+fnodal_l[1])+0.3535533905932737*fnodal_l[0]; 
  GhatL[7] = 0.3535533905932737*fnodal_l[7]-0.3535533905932737*(fnodal_l[6]+fnodal_l[5])+0.3535533905932737*fnodal_l[4]-0.3535533905932737*fnodal_l[3]+0.3535533905932737*(fnodal_l[2]+fnodal_l[1])-0.3535533905932737*fnodal_l[0]; 
  GhatR[0] = 0.3535533905932737*(fnodal_r[7]+fnodal_r[6]+fnodal_r[5]+fnodal_r[4]+fnodal_r[3]+fnodal_r[2]+fnodal_r[1]+fnodal_r[0]); 
  GhatR[1] = 0.3535533905932737*(fnodal_r[7]+fnodal_r[6]+fnodal_r[5]+fnodal_r[4])-0.3535533905932737*(fnodal_r[3]+fnodal_r[2]+fnodal_r[1]+fnodal_r[0]); 
  GhatR[2] = 0.3535533905932737*(fnodal_r[7]+fnodal_r[6])-0.3535533905932737*(fnodal_r[5]+fnodal_r[4])+0.3535533905932737*(fnodal_r[3]+fnodal_r[2])-0.3535533905932737*(fnodal_r[1]+fnodal_r[0]); 
  ...
  GhatR[4] = 0.3535533905932737*(fnodal_r[7]+fnodal_r[6])-0.3535533905932737*(fnodal_r[5]+fnodal_r[4]+fnodal_r[3]+fnodal_r[2])+0.3535533905932737*(fnodal_r[1]+fnodal_r[0]); 
  GhatR[5] = 0.3535533905932737*fnodal_r[7]-0.3535533905932737*fnodal_r[6]+0.3535533905932737*fnodal_r[5]-0.3535533905932737*(fnodal_r[4]+fnodal_r[3])+0.3535533905932737*fnodal_r[2]-0.3535533905932737*fnodal_r[1]+0.3535533905932737*fnodal_r[0]; 
  GhatR[6] = 0.3535533905932737*fnodal_r[7]-0.3535533905932737*(fnodal_r[6]+fnodal_r[5])+0.3535533905932737*(fnodal_r[4]+fnodal_r[3])-0.3535533905932737*(fnodal_r[2]+fnodal_r[1])+0.3535533905932737*fnodal_r[0]; 
  GhatR[7] = 0.3535533905932737*fnodal_r[7]-0.3535533905932737*(fnodal_r[6]+fnodal_r[5])+0.3535533905932737*fnodal_r[4]-0.3535533905932737*fnodal_r[3]+0.3535533905932737*(fnodal_r[2]+fnodal_r[1])-0.3535533905932737*fnodal_r[0]; 
