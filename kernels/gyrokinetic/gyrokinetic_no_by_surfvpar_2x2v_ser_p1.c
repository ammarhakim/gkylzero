...
{ 
  ...
  fUpL[0] = (1.5811388300841895*fl[16]+1.224744871391589*fl[3]+0.7071067811865475*fl[0])/vmap_prime_l[0]; 
  fUpL[1] = (1.5811388300841898*fl[17]+1.224744871391589*fl[6]+0.7071067811865475*fl[1])/vmap_prime_l[0]; 
  fUpL[2] = (1.5811388300841898*fl[18]+1.224744871391589*fl[7]+0.7071067811865475*fl[2])/vmap_prime_l[0]; 
  fUpL[3] = (1.5811388300841898*fl[19]+1.224744871391589*fl[10]+0.7071067811865475*fl[4])/vmap_prime_l[0]; 
  fUpL[4] = (1.5811388300841895*fl[20]+1.224744871391589*fl[11]+0.7071067811865475*fl[5])/vmap_prime_l[0]; 
  fUpL[5] = (1.5811388300841895*fl[21]+1.224744871391589*fl[13]+0.7071067811865475*fl[8])/vmap_prime_l[0]; 
  fUpL[6] = (1.5811388300841895*fl[22]+1.224744871391589*fl[14]+0.7071067811865475*fl[9])/vmap_prime_l[0]; 
  fUpL[7] = (1.5811388300841898*fl[23]+1.224744871391589*fl[15]+0.7071067811865475*fl[12])/vmap_prime_l[0]; 
    } else { 
  fUpL[0] = (1.5811388300841895*fc[16]-1.224744871391589*fc[3]+0.7071067811865475*fc[0])/vmap_prime_c[0]; 
  fUpL[1] = (1.5811388300841898*fc[17]-1.224744871391589*fc[6]+0.7071067811865475*fc[1])/vmap_prime_c[0]; 
  fUpL[2] = (1.5811388300841898*fc[18]-1.224744871391589*fc[7]+0.7071067811865475*fc[2])/vmap_prime_c[0]; 
  fUpL[3] = (1.5811388300841898*fc[19]-1.224744871391589*fc[10]+0.7071067811865475*fc[4])/vmap_prime_c[0]; 
  fUpL[4] = (1.5811388300841895*fc[20]-1.224744871391589*fc[11]+0.7071067811865475*fc[5])/vmap_prime_c[0]; 
  fUpL[5] = (1.5811388300841895*fc[21]-1.224744871391589*fc[13]+0.7071067811865475*fc[8])/vmap_prime_c[0]; 
  fUpL[6] = (1.5811388300841895*fc[22]-1.224744871391589*fc[14]+0.7071067811865475*fc[9])/vmap_prime_c[0]; 
  fUpL[7] = (1.5811388300841898*fc[23]-1.224744871391589*fc[15]+0.7071067811865475*fc[12])/vmap_prime_c[0]; 
    } 
  } else { 
  double f_lr[8] = {0.};
  double f_cl[8] = {0.};
  ...
  f_lr[0] = (1.5811388300841895*fl[16]+1.224744871391589*fl[3]+0.7071067811865475*fl[0])/vmap_prime_l[0]; 
  f_lr[1] = (1.5811388300841898*fl[17]+1.224744871391589*fl[6]+0.7071067811865475*fl[1])/vmap_prime_l[0]; 
  f_lr[2] = (1.5811388300841898*fl[18]+1.224744871391589*fl[7]+0.7071067811865475*fl[2])/vmap_prime_l[0]; 
  f_lr[3] = (1.5811388300841898*fl[19]+1.224744871391589*fl[10]+0.7071067811865475*fl[4])/vmap_prime_l[0]; 
  f_lr[4] = (1.5811388300841895*fl[20]+1.224744871391589*fl[11]+0.7071067811865475*fl[5])/vmap_prime_l[0]; 
  f_lr[5] = (1.5811388300841895*fl[21]+1.224744871391589*fl[13]+0.7071067811865475*fl[8])/vmap_prime_l[0]; 
  f_lr[6] = (1.5811388300841895*fl[22]+1.224744871391589*fl[14]+0.7071067811865475*fl[9])/vmap_prime_l[0]; 
  f_lr[7] = (1.5811388300841898*fl[23]+1.224744871391589*fl[15]+0.7071067811865475*fl[12])/vmap_prime_l[0]; 

  f_cl[0] = (1.5811388300841895*fc[16]-1.224744871391589*fc[3]+0.7071067811865475*fc[0])/vmap_prime_c[0]; 
  f_cl[1] = (1.5811388300841898*fc[17]-1.224744871391589*fc[6]+0.7071067811865475*fc[1])/vmap_prime_c[0]; 
  f_cl[2] = (1.5811388300841898*fc[18]-1.224744871391589*fc[7]+0.7071067811865475*fc[2])/vmap_prime_c[0]; 
  f_cl[3] = (1.5811388300841898*fc[19]-1.224744871391589*fc[10]+0.7071067811865475*fc[4])/vmap_prime_c[0]; 
  f_cl[4] = (1.5811388300841895*fc[20]-1.224744871391589*fc[11]+0.7071067811865475*fc[5])/vmap_prime_c[0]; 
  f_cl[5] = (1.5811388300841895*fc[21]-1.224744871391589*fc[13]+0.7071067811865475*fc[8])/vmap_prime_c[0]; 
  f_cl[6] = (1.5811388300841895*fc[22]-1.224744871391589*fc[14]+0.7071067811865475*fc[9])/vmap_prime_c[0]; 
  f_cl[7] = (1.5811388300841898*fc[23]-1.224744871391589*fc[15]+0.7071067811865475*fc[12])/vmap_prime_c[0]; 
  ...
  fUpR[0] = (1.5811388300841895*fc[16]+1.224744871391589*fc[3]+0.7071067811865475*fc[0])/vmap_prime_c[0]; 
  fUpR[1] = (1.5811388300841898*fc[17]+1.224744871391589*fc[6]+0.7071067811865475*fc[1])/vmap_prime_c[0]; 
  fUpR[2] = (1.5811388300841898*fc[18]+1.224744871391589*fc[7]+0.7071067811865475*fc[2])/vmap_prime_c[0]; 
  fUpR[3] = (1.5811388300841898*fc[19]+1.224744871391589*fc[10]+0.7071067811865475*fc[4])/vmap_prime_c[0]; 
  fUpR[4] = (1.5811388300841895*fc[20]+1.224744871391589*fc[11]+0.7071067811865475*fc[5])/vmap_prime_c[0]; 
  fUpR[5] = (1.5811388300841895*fc[21]+1.224744871391589*fc[13]+0.7071067811865475*fc[8])/vmap_prime_c[0]; 
  fUpR[6] = (1.5811388300841895*fc[22]+1.224744871391589*fc[14]+0.7071067811865475*fc[9])/vmap_prime_c[0]; 
  fUpR[7] = (1.5811388300841898*fc[23]+1.224744871391589*fc[15]+0.7071067811865475*fc[12])/vmap_prime_c[0]; 
    } else { 
  fUpR[0] = (1.5811388300841895*fr[16]-1.224744871391589*fr[3]+0.7071067811865475*fr[0])/vmap_prime_r[0]; 
  fUpR[1] = (1.5811388300841898*fr[17]-1.224744871391589*fr[6]+0.7071067811865475*fr[1])/vmap_prime_r[0]; 
  fUpR[2] = (1.5811388300841898*fr[18]-1.224744871391589*fr[7]+0.7071067811865475*fr[2])/vmap_prime_r[0]; 
  fUpR[3] = (1.5811388300841898*fr[19]-1.224744871391589*fr[10]+0.7071067811865475*fr[4])/vmap_prime_r[0]; 
  fUpR[4] = (1.5811388300841895*fr[20]-1.224744871391589*fr[11]+0.7071067811865475*fr[5])/vmap_prime_r[0]; 
  fUpR[5] = (1.5811388300841895*fr[21]-1.224744871391589*fr[13]+0.7071067811865475*fr[8])/vmap_prime_r[0]; 
  fUpR[6] = (1.5811388300841895*fr[22]-1.224744871391589*fr[14]+0.7071067811865475*fr[9])/vmap_prime_r[0]; 
  fUpR[7] = (1.5811388300841898*fr[23]-1.224744871391589*fr[15]+0.7071067811865475*fr[12])/vmap_prime_r[0]; 
    } 
  } else { 
  double f_cr[8] = {0.};
  double f_rl[8] = {0.};
  ...
  f_cr[0] = (1.5811388300841895*fc[16]+1.224744871391589*fc[3]+0.7071067811865475*fc[0])/vmap_prime_c[0]; 
  f_cr[1] = (1.5811388300841898*fc[17]+1.224744871391589*fc[6]+0.7071067811865475*fc[1])/vmap_prime_c[0]; 
  f_cr[2] = (1.5811388300841898*fc[18]+1.224744871391589*fc[7]+0.7071067811865475*fc[2])/vmap_prime_c[0]; 
  f_cr[3] = (1.5811388300841898*fc[19]+1.224744871391589*fc[10]+0.7071067811865475*fc[4])/vmap_prime_c[0]; 
  f_cr[4] = (1.5811388300841895*fc[20]+1.224744871391589*fc[11]+0.7071067811865475*fc[5])/vmap_prime_c[0]; 
  f_cr[5] = (1.5811388300841895*fc[21]+1.224744871391589*fc[13]+0.7071067811865475*fc[8])/vmap_prime_c[0]; 
  f_cr[6] = (1.5811388300841895*fc[22]+1.224744871391589*fc[14]+0.7071067811865475*fc[9])/vmap_prime_c[0]; 
  f_cr[7] = (1.5811388300841898*fc[23]+1.224744871391589*fc[15]+0.7071067811865475*fc[12])/vmap_prime_c[0]; 

  f_rl[0] = (1.5811388300841895*fr[16]-1.224744871391589*fr[3]+0.7071067811865475*fr[0])/vmap_prime_r[0]; 
  f_rl[1] = (1.5811388300841898*fr[17]-1.224744871391589*fr[6]+0.7071067811865475*fr[1])/vmap_prime_r[0]; 
  f_rl[2] = (1.5811388300841898*fr[18]-1.224744871391589*fr[7]+0.7071067811865475*fr[2])/vmap_prime_r[0]; 
  f_rl[3] = (1.5811388300841898*fr[19]-1.224744871391589*fr[10]+0.7071067811865475*fr[4])/vmap_prime_r[0]; 
  f_rl[4] = (1.5811388300841895*fr[20]-1.224744871391589*fr[11]+0.7071067811865475*fr[5])/vmap_prime_r[0]; 
  f_rl[5] = (1.5811388300841895*fr[21]-1.224744871391589*fr[13]+0.7071067811865475*fr[8])/vmap_prime_r[0]; 
  f_rl[6] = (1.5811388300841895*fr[22]-1.224744871391589*fr[14]+0.7071067811865475*fr[9])/vmap_prime_r[0]; 
  f_rl[7] = (1.5811388300841898*fr[23]-1.224744871391589*fr[15]+0.7071067811865475*fr[12])/vmap_prime_r[0]; 
  ...
  out[16] += (1.5811388300841895*GhatL[0]-1.5811388300841895*GhatR[0])*rdvpar2; 
  out[17] += (1.5811388300841898*GhatL[1]-1.5811388300841898*GhatR[1])*rdvpar2; 
  out[18] += (1.5811388300841898*GhatL[2]-1.5811388300841898*GhatR[2])*rdvpar2; 
  out[19] += (1.5811388300841898*GhatL[3]-1.5811388300841898*GhatR[3])*rdvpar2; 
  out[20] += (1.5811388300841895*GhatL[4]-1.5811388300841895*GhatR[4])*rdvpar2; 
  out[21] += (1.5811388300841895*GhatL[5]-1.5811388300841895*GhatR[5])*rdvpar2; 
  out[22] += (1.5811388300841895*GhatL[6]-1.5811388300841895*GhatR[6])*rdvpar2; 
  out[23] += (1.5811388300841898*GhatL[7]-1.5811388300841898*GhatR[7])*rdvpar2; 

  double vmap_prime_min = fmin(fmin(fabs(vmap_prime_l[0]),fabs(vmap_prime_c[0])),fabs(vmap_prime_r[0]));
  double Jtot_inv_L = 0.5*jacobtot_inv[0];
  double Jtot_inv_R = 0.5*jacobtot_inv[0];
