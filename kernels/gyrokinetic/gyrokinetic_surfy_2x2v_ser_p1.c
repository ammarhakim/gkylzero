...
{ 
  ...
  double alphaL[8]; 
  alphaL[0] = (0.1767766952966368*(1.732050807568877*(hamil[1]*(b_z[1]*jacobtot_inv[1]+b_z[0]*jacobtot_inv[0])*m_*rdx2+BstarYdBmag[0]*hamil[3]*q_*rdvpar2)-3.0*((b_z[1]*jacobtot_inv[1]+b_z[0]*jacobtot_inv[0])*hamil[5]*m_*rdx2+BstarYdBmag[2]*hamil[3]*q_*rdvpar2)))/(m_*q_); 
  alphaL[1] = (0.1767766952966368*(1.732050807568877*(hamil[1]*(b_z[0]*jacobtot_inv[1]+jacobtot_inv[0]*b_z[1])*m_*rdx2+BstarYdBmag[1]*hamil[3]*q_*rdvpar2)-3.0*((b_z[0]*jacobtot_inv[1]+jacobtot_inv[0]*b_z[1])*hamil[5]*m_*rdx2+hamil[3]*BstarYdBmag[5]*q_*rdvpar2)))/(m_*q_); 
  alphaL[2] = (0.3061862178478971*BstarYdBmag[3]*hamil[3]*rdvpar2)/m_; 
  alphaL[3] = (0.3061862178478971*(b_z[1]*jacobtot_inv[1]+b_z[0]*jacobtot_inv[0])*hamil[8]*rdx2)/q_; 
  alphaL[4] = (0.3061862178478971*hamil[3]*BstarYdBmag[6]*rdvpar2)/m_; 
  alphaL[5] = (0.3061862178478971*(b_z[0]*jacobtot_inv[1]+jacobtot_inv[0]*b_z[1])*hamil[8]*rdx2)/q_; 

  double alphaR[8]; 
  alphaR[0] = (0.1767766952966368*(1.732050807568877*(hamil[1]*(b_z[1]*jacobtot_inv[1]+b_z[0]*jacobtot_inv[0])*m_*rdx2+BstarYdBmag[0]*hamil[3]*q_*rdvpar2)+3.0*((b_z[1]*jacobtot_inv[1]+b_z[0]*jacobtot_inv[0])*hamil[5]*m_*rdx2+BstarYdBmag[2]*hamil[3]*q_*rdvpar2)))/(m_*q_); 
  alphaR[1] = (0.1767766952966368*(1.732050807568877*(hamil[1]*(b_z[0]*jacobtot_inv[1]+jacobtot_inv[0]*b_z[1])*m_*rdx2+BstarYdBmag[1]*hamil[3]*q_*rdvpar2)+3.0*((b_z[0]*jacobtot_inv[1]+jacobtot_inv[0]*b_z[1])*hamil[5]*m_*rdx2+hamil[3]*BstarYdBmag[5]*q_*rdvpar2)))/(m_*q_); 
  alphaR[2] = (0.3061862178478971*BstarYdBmag[3]*hamil[3]*rdvpar2)/m_; 
  alphaR[3] = (0.3061862178478971*(b_z[1]*jacobtot_inv[1]+b_z[0]*jacobtot_inv[0])*hamil[8]*rdx2)/q_; 
  alphaR[4] = (0.3061862178478971*hamil[3]*BstarYdBmag[6]*rdvpar2)/m_; 
  ...
  if (alphaL[5]+alphaL[4]-1.0*alphaL[3]-1.0*alphaL[2]-1.0*alphaL[1]+alphaL[0] > 0.) {
    fUpOrdL[0] = (-0.4330127018922193*fl[15])+0.4330127018922192*fl[14]-0.25*fl[13]+0.4330127018922192*(fl[12]+fl[11])+0.25*fl[10]-0.4330127018922193*fl[9]+0.25*fl[8]-0.4330127018922193*fl[7]+0.25*fl[6]-0.4330127018922193*fl[5]-0.25*(fl[4]+fl[3])+0.4330127018922193*fl[2]-0.25*fl[1]+0.25*fl[0]; 
  } else {
    fUpOrdL[0] = 0.4330127018922193*fc[15]-0.4330127018922192*fc[14]-0.25*fc[13]-0.4330127018922192*(fc[12]+fc[11])+0.25*fc[10]+0.4330127018922193*fc[9]+0.25*fc[8]+0.4330127018922193*fc[7]+0.25*fc[6]+0.4330127018922193*fc[5]-0.25*(fc[4]+fc[3])-0.4330127018922193*fc[2]-0.25*fc[1]+0.25*fc[0]; 
  }
  if ((-1.0*alphaL[5])+alphaL[4]+alphaL[3]-1.0*alphaL[2]-1.0*alphaL[1]+alphaL[0] > 0.) {
    fUpOrdL[1] = 0.4330127018922193*fl[15]-0.4330127018922192*fl[14]+0.25*fl[13]-0.4330127018922192*fl[12]+0.4330127018922192*fl[11]-0.25*fl[10]+0.4330127018922193*fl[9]-0.25*fl[8]-0.4330127018922193*fl[7]+0.25*fl[6]-0.4330127018922193*fl[5]+0.25*fl[4]-0.25*fl[3]+0.4330127018922193*fl[2]-0.25*fl[1]+0.25*fl[0]; 
  } else {
    fUpOrdL[1] = (-0.4330127018922193*fc[15])+0.4330127018922192*fc[14]+0.25*fc[13]+0.4330127018922192*fc[12]-0.4330127018922192*fc[11]-0.25*fc[10]-0.4330127018922193*fc[9]-0.25*fc[8]+0.4330127018922193*fc[7]+0.25*fc[6]+0.4330127018922193*fc[5]+0.25*fc[4]-0.25*fc[3]-0.4330127018922193*fc[2]-0.25*fc[1]+0.25*fc[0]; 
  }
  if (alphaL[5]-1.0*alphaL[4]-1.0*alphaL[3]+alphaL[2]-1.0*alphaL[1]+alphaL[0] > 0.) {
    fUpOrdL[2] = 0.4330127018922193*fl[15]-0.4330127018922192*fl[14]+0.25*fl[13]+0.4330127018922192*fl[12]-0.4330127018922192*fl[11]-0.25*fl[10]-0.4330127018922193*fl[9]+0.25*fl[8]+0.4330127018922193*fl[7]-0.25*fl[6]-0.4330127018922193*fl[5]-0.25*fl[4]+0.25*fl[3]+0.4330127018922193*fl[2]-0.25*fl[1]+0.25*fl[0]; 
  } else {
    fUpOrdL[2] = (-0.4330127018922193*fc[15])+0.4330127018922192*fc[14]+0.25*fc[13]-0.4330127018922192*fc[12]+0.4330127018922192*fc[11]-0.25*fc[10]+0.4330127018922193*fc[9]+0.25*fc[8]-0.4330127018922193*fc[7]-0.25*fc[6]+0.4330127018922193*fc[5]-0.25*fc[4]+0.25*fc[3]-0.4330127018922193*fc[2]-0.25*fc[1]+0.25*fc[0]; 
  }
  if ((-1.0*alphaL[5])-1.0*alphaL[4]+alphaL[3]+alphaL[2]-1.0*alphaL[1]+alphaL[0] > 0.) {
    fUpOrdL[3] = (-0.4330127018922193*fl[15])+0.4330127018922192*fl[14]-0.25*fl[13]-0.4330127018922192*(fl[12]+fl[11])+0.25*fl[10]+0.4330127018922193*fl[9]-0.25*fl[8]+0.4330127018922193*fl[7]-0.25*fl[6]-0.4330127018922193*fl[5]+0.25*(fl[4]+fl[3])+0.4330127018922193*fl[2]-0.25*fl[1]+0.25*fl[0]; 
  } else {
    fUpOrdL[3] = 0.4330127018922193*fc[15]-0.4330127018922192*fc[14]-0.25*fc[13]+0.4330127018922192*(fc[12]+fc[11])+0.25*fc[10]-0.4330127018922193*fc[9]-0.25*fc[8]-0.4330127018922193*fc[7]-0.25*fc[6]+0.4330127018922193*fc[5]+0.25*(fc[4]+fc[3])-0.4330127018922193*fc[2]-0.25*fc[1]+0.25*fc[0]; 
  }
  if ((-1.0*alphaL[5])-1.0*alphaL[4]-1.0*alphaL[3]-1.0*alphaL[2]+alphaL[1]+alphaL[0] > 0.) {
    fUpOrdL[4] = 0.4330127018922193*fl[15]+0.4330127018922192*fl[14]+0.25*fl[13]-0.4330127018922192*(fl[12]+fl[11])+0.25*fl[10]-0.4330127018922193*fl[9]-0.25*fl[8]-0.4330127018922193*fl[7]-0.25*fl[6]+0.4330127018922193*fl[5]-0.25*(fl[4]+fl[3])+0.4330127018922193*fl[2]+0.25*fl[1]+0.25*fl[0]; 
  } else {
    fUpOrdL[4] = (-0.4330127018922193*fc[15])-0.4330127018922192*fc[14]+0.25*fc[13]+0.4330127018922192*(fc[12]+fc[11])+0.25*fc[10]+0.4330127018922193*fc[9]-0.25*fc[8]+0.4330127018922193*fc[7]-0.25*fc[6]-0.4330127018922193*fc[5]-0.25*(fc[4]+fc[3])-0.4330127018922193*fc[2]+0.25*fc[1]+0.25*fc[0]; 
  }
  if (alphaL[5]-1.0*alphaL[4]+alphaL[3]-1.0*alphaL[2]+alphaL[1]+alphaL[0] > 0.) {
    fUpOrdL[5] = (-0.4330127018922193*fl[15])-0.4330127018922192*fl[14]-0.25*fl[13]+0.4330127018922192*fl[12]-0.4330127018922192*fl[11]-0.25*fl[10]+0.4330127018922193*fl[9]+0.25*fl[8]-0.4330127018922193*fl[7]-0.25*fl[6]+0.4330127018922193*fl[5]+0.25*fl[4]-0.25*fl[3]+0.4330127018922193*fl[2]+0.25*fl[1]+0.25*fl[0]; 
  } else {
    fUpOrdL[5] = 0.4330127018922193*fc[15]+0.4330127018922192*fc[14]-0.25*fc[13]-0.4330127018922192*fc[12]+0.4330127018922192*fc[11]-0.25*fc[10]-0.4330127018922193*fc[9]+0.25*fc[8]+0.4330127018922193*fc[7]-0.25*fc[6]-0.4330127018922193*fc[5]+0.25*fc[4]-0.25*fc[3]-0.4330127018922193*fc[2]+0.25*fc[1]+0.25*fc[0]; 
  }
  if ((-1.0*alphaL[5])+alphaL[4]-1.0*alphaL[3]+alphaL[2]+alphaL[1]+alphaL[0] > 0.) {
    fUpOrdL[6] = (-0.4330127018922193*fl[15])-0.4330127018922192*fl[14]-0.25*fl[13]-0.4330127018922192*fl[12]+0.4330127018922192*fl[11]-0.25*fl[10]-0.4330127018922193*fl[9]-0.25*fl[8]+0.4330127018922193*fl[7]+0.25*fl[6]+0.4330127018922193*fl[5]-0.25*fl[4]+0.25*fl[3]+0.4330127018922193*fl[2]+0.25*fl[1]+0.25*fl[0]; 
  } else {
    fUpOrdL[6] = 0.4330127018922193*fc[15]+0.4330127018922192*fc[14]-0.25*fc[13]+0.4330127018922192*fc[12]-0.4330127018922192*fc[11]-0.25*fc[10]+0.4330127018922193*fc[9]-0.25*fc[8]-0.4330127018922193*fc[7]+0.25*fc[6]-0.4330127018922193*fc[5]-0.25*fc[4]+0.25*fc[3]-0.4330127018922193*fc[2]+0.25*fc[1]+0.25*fc[0]; 
  }
  if (alphaL[5]+alphaL[4]+alphaL[3]+alphaL[2]+alphaL[1]+alphaL[0] > 0.) {
    fUpOrdL[7] = 0.4330127018922193*fl[15]+0.4330127018922192*fl[14]+0.25*fl[13]+0.4330127018922192*(fl[12]+fl[11])+0.25*fl[10]+0.4330127018922193*fl[9]+0.25*fl[8]+0.4330127018922193*fl[7]+0.25*fl[6]+0.4330127018922193*fl[5]+0.25*(fl[4]+fl[3])+0.4330127018922193*fl[2]+0.25*fl[1]+0.25*fl[0]; 
  } else {
    fUpOrdL[7] = (-0.4330127018922193*fc[15])-0.4330127018922192*fc[14]+0.25*fc[13]-0.4330127018922192*(fc[12]+fc[11])+0.25*fc[10]-0.4330127018922193*fc[9]+0.25*fc[8]-0.4330127018922193*fc[7]+0.25*fc[6]-0.4330127018922193*fc[5]+0.25*(fc[4]+fc[3])-0.4330127018922193*fc[2]+0.25*fc[1]+0.25*fc[0]; 
  }
  ...
  if (alphaR[5]+alphaR[4]-1.0*alphaR[3]-1.0*alphaR[2]-1.0*alphaR[1]+alphaR[0] > 0.) {
    fUpOrdR[0] = (-0.4330127018922193*fc[15])+0.4330127018922192*fc[14]-0.25*fc[13]+0.4330127018922192*(fc[12]+fc[11])+0.25*fc[10]-0.4330127018922193*fc[9]+0.25*fc[8]-0.4330127018922193*fc[7]+0.25*fc[6]-0.4330127018922193*fc[5]-0.25*(fc[4]+fc[3])+0.4330127018922193*fc[2]-0.25*fc[1]+0.25*fc[0]; 
  } else {
    fUpOrdR[0] = 0.4330127018922193*fr[15]-0.4330127018922192*fr[14]-0.25*fr[13]-0.4330127018922192*(fr[12]+fr[11])+0.25*fr[10]+0.4330127018922193*fr[9]+0.25*fr[8]+0.4330127018922193*fr[7]+0.25*fr[6]+0.4330127018922193*fr[5]-0.25*(fr[4]+fr[3])-0.4330127018922193*fr[2]-0.25*fr[1]+0.25*fr[0]; 
  }
  if ((-1.0*alphaR[5])+alphaR[4]+alphaR[3]-1.0*alphaR[2]-1.0*alphaR[1]+alphaR[0] > 0.) {
    fUpOrdR[1] = 0.4330127018922193*fc[15]-0.4330127018922192*fc[14]+0.25*fc[13]-0.4330127018922192*fc[12]+0.4330127018922192*fc[11]-0.25*fc[10]+0.4330127018922193*fc[9]-0.25*fc[8]-0.4330127018922193*fc[7]+0.25*fc[6]-0.4330127018922193*fc[5]+0.25*fc[4]-0.25*fc[3]+0.4330127018922193*fc[2]-0.25*fc[1]+0.25*fc[0]; 
  } else {
    fUpOrdR[1] = (-0.4330127018922193*fr[15])+0.4330127018922192*fr[14]+0.25*fr[13]+0.4330127018922192*fr[12]-0.4330127018922192*fr[11]-0.25*fr[10]-0.4330127018922193*fr[9]-0.25*fr[8]+0.4330127018922193*fr[7]+0.25*fr[6]+0.4330127018922193*fr[5]+0.25*fr[4]-0.25*fr[3]-0.4330127018922193*fr[2]-0.25*fr[1]+0.25*fr[0]; 
  }
  if (alphaR[5]-1.0*alphaR[4]-1.0*alphaR[3]+alphaR[2]-1.0*alphaR[1]+alphaR[0] > 0.) {
    fUpOrdR[2] = 0.4330127018922193*fc[15]-0.4330127018922192*fc[14]+0.25*fc[13]+0.4330127018922192*fc[12]-0.4330127018922192*fc[11]-0.25*fc[10]-0.4330127018922193*fc[9]+0.25*fc[8]+0.4330127018922193*fc[7]-0.25*fc[6]-0.4330127018922193*fc[5]-0.25*fc[4]+0.25*fc[3]+0.4330127018922193*fc[2]-0.25*fc[1]+0.25*fc[0]; 
  } else {
    fUpOrdR[2] = (-0.4330127018922193*fr[15])+0.4330127018922192*fr[14]+0.25*fr[13]-0.4330127018922192*fr[12]+0.4330127018922192*fr[11]-0.25*fr[10]+0.4330127018922193*fr[9]+0.25*fr[8]-0.4330127018922193*fr[7]-0.25*fr[6]+0.4330127018922193*fr[5]-0.25*fr[4]+0.25*fr[3]-0.4330127018922193*fr[2]-0.25*fr[1]+0.25*fr[0]; 
  }
  if ((-1.0*alphaR[5])-1.0*alphaR[4]+alphaR[3]+alphaR[2]-1.0*alphaR[1]+alphaR[0] > 0.) {
    fUpOrdR[3] = (-0.4330127018922193*fc[15])+0.4330127018922192*fc[14]-0.25*fc[13]-0.4330127018922192*(fc[12]+fc[11])+0.25*fc[10]+0.4330127018922193*fc[9]-0.25*fc[8]+0.4330127018922193*fc[7]-0.25*fc[6]-0.4330127018922193*fc[5]+0.25*(fc[4]+fc[3])+0.4330127018922193*fc[2]-0.25*fc[1]+0.25*fc[0]; 
  } else {
    fUpOrdR[3] = 0.4330127018922193*fr[15]-0.4330127018922192*fr[14]-0.25*fr[13]+0.4330127018922192*(fr[12]+fr[11])+0.25*fr[10]-0.4330127018922193*fr[9]-0.25*fr[8]-0.4330127018922193*fr[7]-0.25*fr[6]+0.4330127018922193*fr[5]+0.25*(fr[4]+fr[3])-0.4330127018922193*fr[2]-0.25*fr[1]+0.25*fr[0]; 
  }
  if ((-1.0*alphaR[5])-1.0*alphaR[4]-1.0*alphaR[3]-1.0*alphaR[2]+alphaR[1]+alphaR[0] > 0.) {
    fUpOrdR[4] = 0.4330127018922193*fc[15]+0.4330127018922192*fc[14]+0.25*fc[13]-0.4330127018922192*(fc[12]+fc[11])+0.25*fc[10]-0.4330127018922193*fc[9]-0.25*fc[8]-0.4330127018922193*fc[7]-0.25*fc[6]+0.4330127018922193*fc[5]-0.25*(fc[4]+fc[3])+0.4330127018922193*fc[2]+0.25*fc[1]+0.25*fc[0]; 
  } else {
    fUpOrdR[4] = (-0.4330127018922193*fr[15])-0.4330127018922192*fr[14]+0.25*fr[13]+0.4330127018922192*(fr[12]+fr[11])+0.25*fr[10]+0.4330127018922193*fr[9]-0.25*fr[8]+0.4330127018922193*fr[7]-0.25*fr[6]-0.4330127018922193*fr[5]-0.25*(fr[4]+fr[3])-0.4330127018922193*fr[2]+0.25*fr[1]+0.25*fr[0]; 
  }
  if (alphaR[5]-1.0*alphaR[4]+alphaR[3]-1.0*alphaR[2]+alphaR[1]+alphaR[0] > 0.) {
    fUpOrdR[5] = (-0.4330127018922193*fc[15])-0.4330127018922192*fc[14]-0.25*fc[13]+0.4330127018922192*fc[12]-0.4330127018922192*fc[11]-0.25*fc[10]+0.4330127018922193*fc[9]+0.25*fc[8]-0.4330127018922193*fc[7]-0.25*fc[6]+0.4330127018922193*fc[5]+0.25*fc[4]-0.25*fc[3]+0.4330127018922193*fc[2]+0.25*fc[1]+0.25*fc[0]; 
  } else {
    fUpOrdR[5] = 0.4330127018922193*fr[15]+0.4330127018922192*fr[14]-0.25*fr[13]-0.4330127018922192*fr[12]+0.4330127018922192*fr[11]-0.25*fr[10]-0.4330127018922193*fr[9]+0.25*fr[8]+0.4330127018922193*fr[7]-0.25*fr[6]-0.4330127018922193*fr[5]+0.25*fr[4]-0.25*fr[3]-0.4330127018922193*fr[2]+0.25*fr[1]+0.25*fr[0]; 
  }
  if ((-1.0*alphaR[5])+alphaR[4]-1.0*alphaR[3]+alphaR[2]+alphaR[1]+alphaR[0] > 0.) {
    fUpOrdR[6] = (-0.4330127018922193*fc[15])-0.4330127018922192*fc[14]-0.25*fc[13]-0.4330127018922192*fc[12]+0.4330127018922192*fc[11]-0.25*fc[10]-0.4330127018922193*fc[9]-0.25*fc[8]+0.4330127018922193*fc[7]+0.25*fc[6]+0.4330127018922193*fc[5]-0.25*fc[4]+0.25*fc[3]+0.4330127018922193*fc[2]+0.25*fc[1]+0.25*fc[0]; 
  } else {
    fUpOrdR[6] = 0.4330127018922193*fr[15]+0.4330127018922192*fr[14]-0.25*fr[13]+0.4330127018922192*fr[12]-0.4330127018922192*fr[11]-0.25*fr[10]+0.4330127018922193*fr[9]-0.25*fr[8]-0.4330127018922193*fr[7]+0.25*fr[6]-0.4330127018922193*fr[5]-0.25*fr[4]+0.25*fr[3]-0.4330127018922193*fr[2]+0.25*fr[1]+0.25*fr[0]; 
  }
  if (alphaR[5]+alphaR[4]+alphaR[3]+alphaR[2]+alphaR[1]+alphaR[0] > 0.) {
    fUpOrdR[7] = 0.4330127018922193*fc[15]+0.4330127018922192*fc[14]+0.25*fc[13]+0.4330127018922192*(fc[12]+fc[11])+0.25*fc[10]+0.4330127018922193*fc[9]+0.25*fc[8]+0.4330127018922193*fc[7]+0.25*fc[6]+0.4330127018922193*fc[5]+0.25*(fc[4]+fc[3])+0.4330127018922193*fc[2]+0.25*fc[1]+0.25*fc[0]; 
  } else {
    fUpOrdR[7] = (-0.4330127018922193*fr[15])-0.4330127018922192*fr[14]+0.25*fr[13]-0.4330127018922192*(fr[12]+fr[11])+0.25*fr[10]-0.4330127018922193*fr[9]+0.25*fr[8]-0.4330127018922193*fr[7]+0.25*fr[6]-0.4330127018922193*fr[5]+0.25*(fr[4]+fr[3])-0.4330127018922193*fr[2]+0.25*fr[1]+0.25*fr[0]; 
  }
