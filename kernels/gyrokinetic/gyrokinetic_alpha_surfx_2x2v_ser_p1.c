...
{ 
  ...
  alphaL[0] = ((-(1.9364916731037085*jacobtot_inv_surf[0]*b_y_surf[1]*hamil[8])+0.8660254037844386*b_y_surf[1]*hamil[1]*jacobtot_inv_surf[1]+0.8660254037844386*b_y_surf[0]*jacobtot_inv_surf[0]*hamil[1])*rdz2-(0.8660254037844386*jacobtot_inv_surf[0]*vmap[0]*b_y_surf[1]*hamil[2]*rdz2)/vmap[1])/q_; 
  alphaL[1] = ((-(1.9364916731037085*b_y_surf[1]*jacobtot_inv_surf[1]*hamil[8])+0.8660254037844386*b_y_surf[0]*hamil[1]*jacobtot_inv_surf[1]+0.8660254037844386*jacobtot_inv_surf[0]*b_y_surf[1]*hamil[1])*rdz2-(0.8660254037844386*vmap[0]*b_y_surf[1]*jacobtot_inv_surf[1]*hamil[2]*rdz2)/vmap[1])/q_; 
  alphaL[2] = (-((1.9364916731037085*jacobtot_inv_surf[0]*vmap[0]*b_y_surf[1]*hamil[8]*rdz2)/vmap[1])-0.8660254037844386*jacobtot_inv_surf[0]*b_y_surf[1]*hamil[2]*rdz2)/q_; 
  ...
  alphaL[4] = (-((1.9364916731037085*vmap[0]*b_y_surf[1]*jacobtot_inv_surf[1]*hamil[8]*rdz2)/vmap[1])-0.8660254037844386*b_y_surf[1]*jacobtot_inv_surf[1]*hamil[2]*rdz2)/q_; 
  ...
  alphaL[8] = -((1.7320508075688772*jacobtot_inv_surf[0]*b_y_surf[1]*hamil[8]*rdz2)/q_); 
  alphaL[9] = -((1.7320508075688774*b_y_surf[1]*jacobtot_inv_surf[1]*hamil[8]*rdz2)/q_); 
