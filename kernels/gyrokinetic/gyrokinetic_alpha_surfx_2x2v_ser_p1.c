...
GKYL_CU_DH int gyrokinetic_alpha_surfx_2x2v_ser_p1(const double *w, const double *dxv, const double *vmap, const double *vmapSq,
...
{ 
  ...
  alphaL[9] = (vmap[1]*(-((3.181980515339463*jacobtot_inv[1]*b_y[3]*hamil[9])/inFlds_e[13][1])+(1.837117307087383*jacobtot_inv[0]*b_y[3]*hamil[9])/inFlds_e[13][1]+(1.837117307087383*jacobtot_inv[1]*b_y[2]*hamil[9])/inFlds_e[13][1]-(1.060660171779821*jacobtot_inv[0]*b_y[2]*hamil[9])/inFlds_e[13][1]-(3.181980515339463*b_y[3]*jacobtot_inv[3]*hamil[8])/inFlds_e[13][1]+(1.8371173070873832*b_y[2]*jacobtot_inv[3]*hamil[8])/inFlds_e[13][1]+(1.8371173070873832*jacobtot_inv[2]*b_y[3]*hamil[8])/inFlds_e[13][1]-(1.060660171779821*b_y[2]*jacobtot_inv[2]*hamil[8])/inFlds_e[13][1])*rdvpar2*rdz2)/q_; 
  ...
  alphaL[11] = (vmap[1]*(-((3.181980515339463*jacobtot_inv[1]*b_y[3]*hamil[11])/inFlds_e[13][1])+(1.837117307087383*jacobtot_inv[0]*b_y[3]*hamil[11])/inFlds_e[13][1]+(1.837117307087383*jacobtot_inv[1]*b_y[2]*hamil[11])/inFlds_e[13][1]-(1.060660171779821*jacobtot_inv[0]*b_y[2]*hamil[11])/inFlds_e[13][1]-(3.181980515339463*b_y[3]*jacobtot_inv[3]*hamil[10])/inFlds_e[13][1]+(1.8371173070873832*b_y[2]*jacobtot_inv[3]*hamil[10])/inFlds_e[13][1]+(1.8371173070873832*jacobtot_inv[2]*b_y[3]*hamil[10])/inFlds_e[13][1]-(1.060660171779821*b_y[2]*jacobtot_inv[2]*hamil[10])/inFlds_e[13][1])*rdvpar2*rdz2)/q_; 
