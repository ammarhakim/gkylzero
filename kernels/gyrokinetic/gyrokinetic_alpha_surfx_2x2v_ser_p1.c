...
{ 
  ...
  alphaL[0] = ((-(2.9047375096555625*jacobtot_inv[1]*b_y[3]*hamil[8])+1.6770509831248424*jacobtot_inv[0]*b_y[3]*hamil[8]+1.6770509831248424*jacobtot_inv[1]*b_y[2]*hamil[8]-0.9682458365518543*jacobtot_inv[0]*b_y[2]*hamil[8]+0.8660254037844386*b_y_surf[1]*hamil[1]*jacobtot_inv_surf[1]+0.8660254037844386*b_y_surf[0]*jacobtot_inv_surf[0]*hamil[1])*rdz2+(vmap[0]*(-(1.2990381056766578*jacobtot_inv[1]*hamil[2]*b_y[3])+0.75*jacobtot_inv[0]*hamil[2]*b_y[3]+0.75*jacobtot_inv[1]*b_y[2]*hamil[2]-0.4330127018922193*jacobtot_inv[0]*b_y[2]*hamil[2])*rdz2)/vmap[1])/q_; 
  alphaL[1] = ((-(2.9047375096555625*b_y[3]*jacobtot_inv[3]*hamil[8])+1.6770509831248424*b_y[2]*jacobtot_inv[3]*hamil[8]+1.6770509831248424*jacobtot_inv[2]*b_y[3]*hamil[8]-0.9682458365518543*b_y[2]*jacobtot_inv[2]*hamil[8]+0.8660254037844386*b_y_surf[0]*hamil[1]*jacobtot_inv_surf[1]+0.8660254037844386*jacobtot_inv_surf[0]*b_y_surf[1]*hamil[1])*rdz2+(vmap[0]*(-(1.2990381056766578*hamil[2]*b_y[3]*jacobtot_inv[3])+0.75*b_y[2]*hamil[2]*jacobtot_inv[3]+0.75*hamil[2]*jacobtot_inv[2]*b_y[3]-0.4330127018922193*b_y[2]*hamil[2]*jacobtot_inv[2])*rdz2)/vmap[1])/q_; 
  alphaL[2] = ((vmap[0]*(-(2.9047375096555625*jacobtot_inv[1]*b_y[3]*hamil[8])+1.6770509831248424*jacobtot_inv[0]*b_y[3]*hamil[8]+1.6770509831248424*jacobtot_inv[1]*b_y[2]*hamil[8]-0.9682458365518543*jacobtot_inv[0]*b_y[2]*hamil[8])*rdz2)/vmap[1]+(-(1.2990381056766578*jacobtot_inv[1]*hamil[2]*b_y[3])+0.75*jacobtot_inv[0]*hamil[2]*b_y[3]+0.75*jacobtot_inv[1]*b_y[2]*hamil[2]-0.4330127018922193*jacobtot_inv[0]*b_y[2]*hamil[2])*rdz2)/q_; 
  alphaL[3] = ((0.8660254037844386*b_y_surf[1]*jacobtot_inv_surf[1]*hamil[5]+0.8660254037844386*b_y_surf[0]*jacobtot_inv_surf[0]*hamil[5])*rdz2)/q_; 
  alphaL[4] = ((vmap[0]*(-(2.9047375096555625*b_y[3]*jacobtot_inv[3]*hamil[8])+1.6770509831248424*b_y[2]*jacobtot_inv[3]*hamil[8]+1.6770509831248424*jacobtot_inv[2]*b_y[3]*hamil[8]-0.9682458365518543*b_y[2]*jacobtot_inv[2]*hamil[8])*rdz2)/vmap[1]+(-(1.2990381056766578*hamil[2]*b_y[3]*jacobtot_inv[3])+0.75*b_y[2]*hamil[2]*jacobtot_inv[3]+0.75*hamil[2]*jacobtot_inv[2]*b_y[3]-0.4330127018922193*b_y[2]*hamil[2]*jacobtot_inv[2])*rdz2)/q_; 
  alphaL[5] = ((0.8660254037844386*b_y_surf[0]*jacobtot_inv_surf[1]*hamil[5]+0.8660254037844386*jacobtot_inv_surf[0]*b_y_surf[1]*hamil[5])*rdz2)/q_; 
  alphaL[8] = ((-(2.5980762113533156*jacobtot_inv[1]*b_y[3]*hamil[8])+1.5*jacobtot_inv[0]*b_y[3]*hamil[8]+1.5*jacobtot_inv[1]*b_y[2]*hamil[8]-0.8660254037844386*jacobtot_inv[0]*b_y[2]*hamil[8])*rdz2)/q_; 
  alphaL[9] = ((-(2.598076211353316*b_y[3]*jacobtot_inv[3]*hamil[8])+1.5*b_y[2]*jacobtot_inv[3]*hamil[8]+1.5*jacobtot_inv[2]*b_y[3]*hamil[8]-0.8660254037844387*b_y[2]*jacobtot_inv[2]*hamil[8])*rdz2)/q_; 
