...
{ 
  ...
  out[8] += volFact*(2.0*f[7]*wx1_sq+1.154700538379251*f[11]*dv1*wx1+(0.9035079029052515*bmag[2]*tmp[2])/m_+(1.414213562373095*bmag[0]*tmp[2])/m_+(1.414213562373095*tmp[0]*bmag[2])/m_+(1.264911064067352*bmag[1]*tmp[1])/m_+0.149071198499986*f[20]*dv1_sq+0.1666666666666667*f[7]*dv1_sq); 
} 
