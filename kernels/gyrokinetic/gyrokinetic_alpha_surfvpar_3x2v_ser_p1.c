...
{ 
  ...
  alphaL[0] = (vmap[1]*(0.9185586535436913*b_x[5]*hamil[6]+0.9185586535436913*hamil[2]*b_x[3])*rdy2*rdz2+vmap[0]*(-(0.5303300858899105*b_x[5]*hamil[6])-0.5303300858899105*hamil[2]*b_x[3])*rdy2*rdz2+vmap[1]*(0.9185586535436913*b_y[1]*hamil[3]-0.9185586535436913*hamil[1]*b_y[3])*rdx2*rdz2+vmap[0]*(0.5303300858899105*hamil[1]*b_y[3]-0.5303300858899105*b_y[1]*hamil[3])*rdx2*rdz2+vmap[0]*(0.5303300858899105*b_z[5]*hamil[8]+0.5303300858899105*b_z[1]*hamil[2])*rdx2*rdy2+vmap[1]*(-(0.9185586535436913*b_z[5]*hamil[8])-0.9185586535436913*b_z[1]*hamil[2])*rdx2*rdy2)/q_+((-(0.4330127018922193*cmag[1]*hamil[7])-0.4330127018922193*cmag[0]*hamil[3])*rdz2)/m_; 
  alphaL[1] = (vmap[1]*(0.9185586535436913*b_x[3]*hamil[6]+0.9185586535436913*hamil[2]*b_x[5])*rdy2*rdz2+vmap[0]*(-(0.5303300858899105*b_x[3]*hamil[6])-0.5303300858899105*hamil[2]*b_x[5])*rdy2*rdz2+vmap[1]*(0.9185586535436913*b_y[1]*hamil[7]-0.9185586535436913*hamil[1]*b_y[5])*rdx2*rdz2+vmap[0]*(0.5303300858899105*hamil[1]*b_y[5]-0.5303300858899105*b_y[1]*hamil[7])*rdx2*rdz2+vmap[0]*(0.5303300858899105*b_z[5]*hamil[16]+0.5303300858899105*b_z[1]*hamil[6])*rdx2*rdy2+vmap[1]*(-(0.9185586535436913*b_z[5]*hamil[16])-0.9185586535436913*b_z[1]*hamil[6])*rdx2*rdy2)/q_+((-(0.4330127018922193*cmag[0]*hamil[7])-0.4330127018922193*cmag[1]*hamil[3])*rdz2)/m_; 
  alphaL[2] = (vmap[1]*(0.9185586535436913*b_y[1]*hamil[8]-0.9185586535436913*b_y[3]*hamil[6])*rdx2*rdz2+vmap[0]*(0.5303300858899105*b_y[3]*hamil[6]-0.5303300858899105*b_y[1]*hamil[8])*rdx2*rdz2)/q_+((-(0.4330127018922193*cmag[1]*hamil[16])-0.4330127018922193*cmag[0]*hamil[8])*rdz2)/m_; 
  alphaL[3] = (vmap[1]*(0.9185586535436913*b_x[5]*hamil[16]+0.9185586535436913*b_x[3]*hamil[8])*rdy2*rdz2+vmap[0]*(-(0.5303300858899105*b_x[5]*hamil[16])-0.5303300858899105*b_x[3]*hamil[8])*rdy2*rdz2+vmap[0]*(0.5303300858899105*b_y[3]*hamil[7]-0.5303300858899105*hamil[3]*b_y[5])*rdx2*rdz2+vmap[1]*(0.9185586535436913*hamil[3]*b_y[5]-0.9185586535436913*b_y[3]*hamil[7])*rdx2*rdz2+vmap[0]*(0.5303300858899105*b_z[1]*hamil[8]+0.5303300858899105*hamil[2]*b_z[5])*rdx2*rdy2+vmap[1]*(-(0.9185586535436913*b_z[1]*hamil[8])-0.9185586535436913*hamil[2]*b_z[5])*rdx2*rdy2)/q_+((-(0.4330127018922193*cmag[5]*hamil[7])-0.4330127018922193*cmag[3]*hamil[3])*rdz2)/m_; 
  alphaL[4] = (vmap[1]*(0.9185586535436913*b_y[1]*hamil[14]-0.9185586535436913*b_y[3]*hamil[12])*rdx2*rdz2+vmap[0]*(0.5303300858899105*b_y[3]*hamil[12]-0.5303300858899105*b_y[1]*hamil[14])*rdx2*rdz2)/q_+((-(0.4330127018922193*cmag[1]*hamil[21])-0.4330127018922193*cmag[0]*hamil[14])*rdz2)/m_; 
  alphaL[5] = (vmap[1]*(0.9185586535436913*b_y[1]*hamil[16]-0.9185586535436913*b_y[5]*hamil[6])*rdx2*rdz2+vmap[0]*(0.5303300858899105*b_y[5]*hamil[6]-0.5303300858899105*b_y[1]*hamil[16])*rdx2*rdz2)/q_+((-(0.4330127018922193*cmag[0]*hamil[16])-0.4330127018922193*cmag[1]*hamil[8])*rdz2)/m_; 
  alphaL[6] = (vmap[1]*(0.9185586535436913*b_x[3]*hamil[16]+0.9185586535436913*b_x[5]*hamil[8])*rdy2*rdz2+vmap[0]*(-(0.5303300858899105*b_x[3]*hamil[16])-0.5303300858899105*b_x[5]*hamil[8])*rdy2*rdz2+vmap[0]*(0.5303300858899105*b_z[1]*hamil[16]+0.5303300858899105*b_z[5]*hamil[6])*rdx2*rdy2+vmap[1]*(-(0.9185586535436913*b_z[1]*hamil[16])-0.9185586535436913*b_z[5]*hamil[6])*rdx2*rdy2)/q_+((-(0.4330127018922193*cmag[3]*hamil[7])-0.4330127018922193*hamil[3]*cmag[5])*rdz2)/m_; 
  alphaL[7] = (vmap[0]*(0.5303300858899105*b_y[3]*hamil[16]-0.5303300858899105*b_y[5]*hamil[8])*rdx2*rdz2+vmap[1]*(0.9185586535436913*b_y[5]*hamil[8]-0.9185586535436913*b_y[3]*hamil[16])*rdx2*rdz2)/q_+((-(0.4330127018922193*cmag[5]*hamil[16])-0.4330127018922193*cmag[3]*hamil[8])*rdz2)/m_; 
  alphaL[8] = (vmap[1]*(0.9185586535436913*b_y[1]*hamil[21]-0.9185586535436913*b_y[5]*hamil[12])*rdx2*rdz2+vmap[0]*(0.5303300858899105*b_y[5]*hamil[12]-0.5303300858899105*b_y[1]*hamil[21])*rdx2*rdz2)/q_+((-(0.4330127018922193*cmag[0]*hamil[21])-0.4330127018922193*cmag[1]*hamil[14])*rdz2)/m_; 
  alphaL[10] = (vmap[0]*(0.5303300858899105*b_y[3]*hamil[21]-0.5303300858899105*b_y[5]*hamil[14])*rdx2*rdz2+vmap[1]*(0.9185586535436913*b_y[5]*hamil[14]-0.9185586535436913*b_y[3]*hamil[21])*rdx2*rdz2)/q_+((-(0.4330127018922193*cmag[5]*hamil[21])-0.4330127018922193*cmag[3]*hamil[14])*rdz2)/m_; 
  alphaL[11] = ((-(0.4330127018922193*cmag[3]*hamil[16])-0.4330127018922193*cmag[5]*hamil[8])*rdz2)/m_; 
  alphaL[13] = ((-(0.4330127018922193*cmag[3]*hamil[21])-0.4330127018922193*cmag[5]*hamil[14])*rdz2)/m_; 
