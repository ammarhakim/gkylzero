...
GKYL_CU_DH double gyrokinetic_no_by_boundary_surfz_3x2v_ser_p1(const double *w, const double *dxv, const double *jacobtot_inv, 
...
{ 
  ...
  Jtot_inv = 0.6123724356957944*jacobtot_inv[3]+0.3535533905932737*jacobtot_inv[0];
  ...
  out[47] += -(1.224744871391589*GhatL[23]*rdz2); 
    ...
    Jtot_inv = 0.3535533905932737*jacobtot_inv[0]-0.6123724356957944*jacobtot_inv[3];
