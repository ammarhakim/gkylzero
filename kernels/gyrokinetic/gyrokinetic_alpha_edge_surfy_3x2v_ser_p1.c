...
GKYL_CU_DH int gyrokinetic_alpha_edge_surfy_3x2v_ser_p1(const double *w, const double *dxv, const double *vmap, const double *vmapSq,
...
{ 
  ...
  alphaR[5] = ((0.9682458365518543*b_x_surf[2]*jacobtot_inv_surf[3]*hamil[16]+0.9682458365518543*jacobtot_inv_surf[2]*b_x_surf[3]*hamil[16]-0.7794228634059945*b_x_surf[1]*jacobtot_inv_surf[3]*hamil[5]-0.7794228634059945*jacobtot_inv_surf[1]*b_x_surf[3]*hamil[5]-0.4330127018922193*b_x_surf[0]*jacobtot_inv_surf[2]*hamil[5]-0.4330127018922193*jacobtot_inv_surf[0]*b_x_surf[2]*hamil[5]-0.4330127018922193*b_x_surf[0]*hamil[2]*jacobtot_inv_surf[3]-0.4330127018922193*jacobtot_inv_surf[0]*hamil[2]*b_x_surf[3]-0.4330127018922193*b_x_surf[1]*hamil[2]*jacobtot_inv_surf[2]-0.4330127018922193*jacobtot_inv_surf[1]*b_x_surf[2]*hamil[2])*rdz2+(vmap[0]*(0.4330127018922193*b_x_surf[2]*hamil[3]*jacobtot_inv_surf[3]+0.4330127018922193*jacobtot_inv_surf[2]*b_x_surf[3]*hamil[3])*rdz2)/vmap[1]+(-(0.9682458365518543*b_z_surf[1]*jacobtot_inv_surf[3]*hamil[16])-0.9682458365518543*jacobtot_inv_surf[1]*b_z_surf[3]*hamil[16]+0.7794228634059945*b_z_surf[2]*jacobtot_inv_surf[3]*hamil[5]+0.7794228634059945*jacobtot_inv_surf[2]*b_z_surf[3]*hamil[5]+0.4330127018922193*b_z_surf[0]*jacobtot_inv_surf[1]*hamil[5]+0.4330127018922193*jacobtot_inv_surf[0]*b_z_surf[1]*hamil[5]+0.4330127018922193*b_z_surf[0]*hamil[1]*jacobtot_inv_surf[3]+0.4330127018922193*jacobtot_inv_surf[0]*hamil[1]*b_z_surf[3]+0.4330127018922193*b_z_surf[1]*hamil[1]*jacobtot_inv_surf[2]+0.4330127018922193*hamil[1]*jacobtot_inv_surf[1]*b_z_surf[2])*rdx2+(vmap[0]*(-(0.4330127018922193*b_z_surf[1]*hamil[3]*jacobtot_inv_surf[3])-0.4330127018922193*jacobtot_inv_surf[1]*b_z_surf[3]*hamil[3])*rdx2)/vmap[1])/q_; 
  alphaR[6] = ((vmap[0]*(0.9682458365518543*jacobtot_inv_surf[0]*b_x_surf[3]*hamil[16]+0.9682458365518543*jacobtot_inv_surf[1]*b_x_surf[2]*hamil[16])*rdz2)/vmap[1]+(0.4330127018922193*jacobtot_inv_surf[0]*b_x_surf[3]*hamil[3]+0.4330127018922193*jacobtot_inv_surf[1]*b_x_surf[2]*hamil[3])*rdz2+(vmap[0]*(-(0.9682458365518543*b_z_surf[3]*jacobtot_inv_surf[3]*hamil[16])-0.9682458365518543*b_z_surf[1]*jacobtot_inv_surf[1]*hamil[16])*rdx2)/vmap[1]+(-(0.4330127018922193*b_z_surf[3]*hamil[3]*jacobtot_inv_surf[3])-0.4330127018922193*b_z_surf[1]*jacobtot_inv_surf[1]*hamil[3])*rdx2)/q_; 
  alphaR[7] = ((vmap[0]*(0.9682458365518543*b_x_surf[3]*jacobtot_inv_surf[3]*hamil[16]+0.9682458365518543*b_x_surf[2]*jacobtot_inv_surf[2]*hamil[16])*rdz2)/vmap[1]+(0.4330127018922193*b_x_surf[3]*hamil[3]*jacobtot_inv_surf[3]+0.4330127018922193*b_x_surf[2]*jacobtot_inv_surf[2]*hamil[3])*rdz2+(vmap[0]*(-(0.9682458365518543*jacobtot_inv_surf[0]*b_z_surf[3]*hamil[16])-0.9682458365518543*b_z_surf[1]*jacobtot_inv_surf[2]*hamil[16])*rdx2)/vmap[1]+(-(0.4330127018922193*jacobtot_inv_surf[0]*b_z_surf[3]*hamil[3])-0.4330127018922193*b_z_surf[1]*jacobtot_inv_surf[2]*hamil[3])*rdx2)/q_; 
  ...
  alphaR[11] = ((vmap[0]*(0.9682458365518543*b_x_surf[2]*jacobtot_inv_surf[3]*hamil[16]+0.9682458365518543*jacobtot_inv_surf[2]*b_x_surf[3]*hamil[16])*rdz2)/vmap[1]+(0.4330127018922193*b_x_surf[2]*hamil[3]*jacobtot_inv_surf[3]+0.4330127018922193*jacobtot_inv_surf[2]*b_x_surf[3]*hamil[3])*rdz2+(vmap[0]*(-(0.9682458365518543*b_z_surf[1]*jacobtot_inv_surf[3]*hamil[16])-0.9682458365518543*jacobtot_inv_surf[1]*b_z_surf[3]*hamil[16])*rdx2)/vmap[1]+(-(0.4330127018922193*b_z_surf[1]*hamil[3]*jacobtot_inv_surf[3])-0.4330127018922193*jacobtot_inv_surf[1]*b_z_surf[3]*hamil[3])*rdx2)/q_; 
  ...
  alphaR[16] = ((0.8660254037844386*jacobtot_inv_surf[1]*b_x_surf[3]*hamil[16]+0.8660254037844386*jacobtot_inv_surf[0]*b_x_surf[2]*hamil[16])*rdz2+(-(0.8660254037844386*jacobtot_inv_surf[2]*b_z_surf[3]*hamil[16])-0.8660254037844386*jacobtot_inv_surf[0]*b_z_surf[1]*hamil[16])*rdx2)/q_; 
  alphaR[17] = ((0.8660254037844387*jacobtot_inv_surf[0]*b_x_surf[3]*hamil[16]+0.8660254037844387*jacobtot_inv_surf[1]*b_x_surf[2]*hamil[16])*rdz2+(-(0.8660254037844387*b_z_surf[3]*jacobtot_inv_surf[3]*hamil[16])-0.8660254037844387*b_z_surf[1]*jacobtot_inv_surf[1]*hamil[16])*rdx2)/q_; 
  alphaR[18] = ((0.8660254037844387*b_x_surf[3]*jacobtot_inv_surf[3]*hamil[16]+0.8660254037844387*b_x_surf[2]*jacobtot_inv_surf[2]*hamil[16])*rdz2+(-(0.8660254037844387*jacobtot_inv_surf[0]*b_z_surf[3]*hamil[16])-0.8660254037844387*b_z_surf[1]*jacobtot_inv_surf[2]*hamil[16])*rdx2)/q_; 
  alphaR[20] = ((0.8660254037844386*b_x_surf[2]*jacobtot_inv_surf[3]*hamil[16]+0.8660254037844386*jacobtot_inv_surf[2]*b_x_surf[3]*hamil[16])*rdz2+(-(0.8660254037844386*b_z_surf[1]*jacobtot_inv_surf[3]*hamil[16])-0.8660254037844386*jacobtot_inv_surf[1]*b_z_surf[3]*hamil[16])*rdx2)/q_; 
