...
{ 
  ...
  alphaL[16] = ((0.8660254037844386*jacobtot_inv_surf[1]*b_x_surf[3]*hamil[16]+0.8660254037844386*jacobtot_inv_surf[0]*b_x_surf[2]*hamil[16])*rdz2+(-(0.8660254037844386*jacobtot_inv_surf[2]*b_z_surf[3]*hamil[16])-0.8660254037844386*jacobtot_inv_surf[0]*b_z_surf[1]*hamil[16])*rdx2)/q_; 
  alphaL[17] = ((0.8660254037844387*jacobtot_inv_surf[0]*b_x_surf[3]*hamil[16]+0.8660254037844387*jacobtot_inv_surf[1]*b_x_surf[2]*hamil[16])*rdz2+(-(0.8660254037844387*b_z_surf[3]*jacobtot_inv_surf[3]*hamil[16])-0.8660254037844387*b_z_surf[1]*jacobtot_inv_surf[1]*hamil[16])*rdx2)/q_; 
  alphaL[18] = ((0.8660254037844387*b_x_surf[3]*jacobtot_inv_surf[3]*hamil[16]+0.8660254037844387*b_x_surf[2]*jacobtot_inv_surf[2]*hamil[16])*rdz2+(-(0.8660254037844387*jacobtot_inv_surf[0]*b_z_surf[3]*hamil[16])-0.8660254037844387*b_z_surf[1]*jacobtot_inv_surf[2]*hamil[16])*rdx2)/q_; 
  alphaL[20] = ((0.8660254037844386*b_x_surf[2]*jacobtot_inv_surf[3]*hamil[16]+0.8660254037844386*jacobtot_inv_surf[2]*b_x_surf[3]*hamil[16])*rdz2+(-(0.8660254037844386*b_z_surf[1]*jacobtot_inv_surf[3]*hamil[16])-0.8660254037844386*jacobtot_inv_surf[1]*b_z_surf[3]*hamil[16])*rdx2)/q_; 
