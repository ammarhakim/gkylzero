...
{ 
  ...
  alphaL[0] = ((-(0.6123724356957944*cmag[1]*hamil[5])-0.6123724356957944*cmag[0]*hamil[2])*rdz2)/m_; 
  alphaL[1] = ((-(0.6123724356957944*cmag[0]*hamil[5])-0.6123724356957944*cmag[1]*hamil[2])*rdz2)/m_; 
  alphaL[2] = ((-(0.6123724356957944*cmag[3]*hamil[5])-0.6123724356957944*cmag[2]*hamil[2])*rdz2)/m_; 
  alphaL[3] = ((-(0.6123724356957944*cmag[1]*hamil[12])-0.6123724356957944*cmag[0]*hamil[9])*rdz2)/m_; 
  alphaL[4] = ((-(0.6123724356957944*cmag[2]*hamil[5])-0.6123724356957944*hamil[2]*cmag[3])*rdz2)/m_; 
  alphaL[5] = ((-(0.6123724356957944*cmag[0]*hamil[12])-0.6123724356957944*cmag[1]*hamil[9])*rdz2)/m_; 
  alphaL[6] = ((-(0.6123724356957944*cmag[3]*hamil[12])-0.6123724356957944*cmag[2]*hamil[9])*rdz2)/m_; 
