...
GKYL_CU_DH double gyrokinetic_vol_1x2v_tensor_p1(const double *w, const double *dxv, const double q_, const double m_, const double *bmag, const double *jacobtot_inv, const double *cmag, const double *b_i, const double *phi, const double *apar, const double* apardot, const double *fin, double* GKYL_RESTRICT out) 
{ 
  // w[NDIM]: cell-center.
  ...
  // Evaluate alpha at left surface quadrature points.
  alphaL = 0.125*((-0.6123724356957942*alphavpar[7])+0.6123724356957944*alphavpar[6]+0.3535533905932736*alphavpar[5]+0.6123724356957944*alphavpar[4]-0.3535533905932736*alphavpar[3]-0.6123724356957944*alphavpar[2]-0.3535533905932736*alphavpar[1]+0.3535533905932737*alphavpar[0]); 
  cflFreq += -0.5*(alphaL-fabs(alphaL)); 
  alphaL = 0.125*(0.6123724356957942*alphavpar[7]-0.6123724356957944*alphavpar[6]-0.3535533905932736*alphavpar[5]+0.6123724356957944*alphavpar[4]+0.3535533905932736*alphavpar[3]-0.6123724356957944*alphavpar[2]-0.3535533905932736*alphavpar[1]+0.3535533905932737*alphavpar[0]); 
  cflFreq += -0.5*(alphaL-fabs(alphaL)); 
  alphaL = 0.125*(0.6123724356957942*alphavpar[7]+0.6123724356957944*alphavpar[6]-0.3535533905932736*alphavpar[5]-0.6123724356957944*alphavpar[4]-0.3535533905932736*alphavpar[3]-0.6123724356957944*alphavpar[2]+0.3535533905932736*alphavpar[1]+0.3535533905932737*alphavpar[0]); 
  ...
  cflFreq += -0.5*(alphaL-fabs(alphaL)); 
  // Evaluate alpha at right surface quadrature points.
  alphaR = 0.125*(0.6123724356957942*alphavpar[7]-0.6123724356957944*alphavpar[6]+0.3535533905932736*alphavpar[5]-0.6123724356957944*alphavpar[4]-0.3535533905932736*alphavpar[3]+0.6123724356957944*alphavpar[2]-0.3535533905932736*alphavpar[1]+0.3535533905932737*alphavpar[0]); 
  cflFreq += 0.5*(alphaR+fabs(alphaR)); 
  alphaR = 0.125*((-0.6123724356957942*alphavpar[7])+0.6123724356957944*alphavpar[6]-0.3535533905932736*alphavpar[5]-0.6123724356957944*alphavpar[4]+0.3535533905932736*alphavpar[3]+0.6123724356957944*alphavpar[2]-0.3535533905932736*alphavpar[1]+0.3535533905932737*alphavpar[0]); 
  cflFreq += 0.5*(alphaR+fabs(alphaR)); 
  alphaR = 0.125*((-0.6123724356957942*alphavpar[7])-0.6123724356957944*alphavpar[6]-0.3535533905932736*alphavpar[5]+0.6123724356957944*alphavpar[4]-0.3535533905932736*alphavpar[3]+0.6123724356957944*alphavpar[2]+0.3535533905932736*alphavpar[1]+0.3535533905932737*alphavpar[0]); 
...
GKYL_CU_DH double gyrokinetic_step2_vol_1x2v_tensor_p1(const double *w, const double *dxv, const double q_, const double m_, const double *apardot, const double *fin, double* GKYL_RESTRICT out) 
{ 
  // w[NDIM]: cell-center.
  // dxv[NDIM]: cell length.
  // q_,m_: species charge and mass.
