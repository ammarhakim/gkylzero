...
GKYL_CU_DH void gyrokinetic_flux_surfx_1x1v_ser_p1(const struct gkyl_basis *basis, const double *w, const double *dxv, const double *vmap, const double *vmapSq,
...
{ 
  ...
  double hamil[6] = {0.}; 
  hamil[0] = 0.5*vmapSq[0]*mass+(phi[0]-1.732050807568877*phi[1])*charge; 
