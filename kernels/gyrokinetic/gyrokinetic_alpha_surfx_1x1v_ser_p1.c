...
{ 
  ...
  alphaL[0] = (1.4142135623730951*cmag_surf[0]*jacobtot_inv_surf[0]*hamil[1])/(vmap[1]*m_); 
  alphaL[1] = (3.1622776601683795*cmag_surf[0]*jacobtot_inv_surf[0]*hamil[2])/(vmap[1]*m_); 
