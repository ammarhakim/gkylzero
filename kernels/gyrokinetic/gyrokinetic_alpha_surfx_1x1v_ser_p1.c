...
{ 
  ...
  alphaL[1] = (3.354101966249685*cmag[1]*jacobtot_inv[1]*hamil[4]-1.936491673103709*cmag[0]*jacobtot_inv[1]*hamil[4]-1.936491673103709*jacobtot_inv[0]*cmag[1]*hamil[4]+1.118033988749895*cmag[0]*jacobtot_inv[0]*hamil[4])/(vmap[1]*m_); 
