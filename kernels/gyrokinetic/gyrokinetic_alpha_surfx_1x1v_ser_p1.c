...
{ 
  ...
  alphaL[0] = (0.7071067811865475*cmag[0]*hamil[2]-1.224744871391589*cmag[1]*hamil[2])/(vmap[1]*m_); 
  alphaL[1] = (1.5811388300841895*cmag[0]*hamil[4]-2.7386127875258306*cmag[1]*hamil[4])/(vmap[1]*m_); 
