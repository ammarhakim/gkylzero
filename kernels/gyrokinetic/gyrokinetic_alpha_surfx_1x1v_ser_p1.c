...
GKYL_CU_DH void gyrokinetic_alpha_surfx_1x1v_ser_p1(const double *w, const double *dxv, const double q_, const double m_, const double *bmag, const double *jacobtot_inv, const double *cmag, const double *b_i, const double *phi, const double *Bstar_Bmag, double* GKYL_RESTRICT alpha_surf) 
{ 
  // w[NDIM]: cell-center.
  ...
  alphaL0[1] = ((1.936491673103709*BstarZdBmag[0]-3.354101966249685*BstarZdBmag[1])*hamil[4]*rdvpar2)/m_; 
