...
{ 
  ...
  Jtot_inv = 1.224744871391589*jacobtot_inv[1]+0.7071067811865475*jacobtot_inv[0];
  ...
  out[5] += -(1.224744871391589*GhatL[2]*rdx2); 
    ...
    Jtot_inv = 0.7071067811865475*jacobtot_inv[0]-1.224744871391589*jacobtot_inv[1];
