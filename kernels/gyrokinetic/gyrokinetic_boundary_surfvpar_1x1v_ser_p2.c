...
{ 
  ...
  fUpR[0] = (1.58113883008419*fskin[5]+1.224744871391589*fskin[2]+0.7071067811865475*fskin[0])/vmap_prime_skin[0]; 
  fUpR[1] = (1.58113883008419*fskin[7]+1.224744871391589*fskin[3]+0.7071067811865475*fskin[1])/vmap_prime_skin[0]; 
  fUpR[2] = (1.224744871391589*fskin[6]+0.7071067811865475*fskin[4])/vmap_prime_skin[0]; 
    } else { 
  fUpR[0] = (1.58113883008419*fedge[5]-1.224744871391589*fedge[2]+0.7071067811865475*fedge[0])/vmap_prime_edge[0]; 
  fUpR[1] = (1.58113883008419*fedge[7]-1.224744871391589*fedge[3]+0.7071067811865475*fedge[1])/vmap_prime_edge[0]; 
  fUpR[2] = (0.7071067811865475*fedge[4]-1.224744871391589*fedge[6])/vmap_prime_edge[0]; 
    } 
  } else { 
  double f_cr[3] = {0.};
  double f_rl[3] = {0.};
  ...
  f_cr[0] = (1.58113883008419*fskin[5]+1.224744871391589*fskin[2]+0.7071067811865475*fskin[0])/vmap_prime_skin[0]; 
  f_cr[1] = (1.58113883008419*fskin[7]+1.224744871391589*fskin[3]+0.7071067811865475*fskin[1])/vmap_prime_skin[0]; 
  f_cr[2] = (1.224744871391589*fskin[6]+0.7071067811865475*fskin[4])/vmap_prime_skin[0]; 

  f_rl[0] = (1.58113883008419*fedge[5]-1.224744871391589*fedge[2]+0.7071067811865475*fedge[0])/vmap_prime_edge[0]; 
  f_rl[1] = (1.58113883008419*fedge[7]-1.224744871391589*fedge[3]+0.7071067811865475*fedge[1])/vmap_prime_edge[0]; 
  f_rl[2] = (0.7071067811865475*fedge[4]-1.224744871391589*fedge[6])/vmap_prime_edge[0]; 
  ...
  double GhatR[3] = {0.};
  GhatR[0] = 0.7071067811865475*(alphaR[2]*fUpR[2]+alphaR[1]*fUpR[1]+alphaR[0]*fUpR[0]); 
  GhatR[1] = 0.6324555320336759*(alphaR[1]*fUpR[2]+fUpR[1]*alphaR[2])+0.7071067811865475*(alphaR[0]*fUpR[1]+fUpR[0]*alphaR[1]); 
  GhatR[2] = 0.4517539514526256*alphaR[2]*fUpR[2]+0.7071067811865475*(alphaR[0]*fUpR[2]+fUpR[0]*alphaR[2])+0.6324555320336759*alphaR[1]*fUpR[1]; 
  ...
  fUpL[0] = (1.58113883008419*fedge[5]+1.224744871391589*fedge[2]+0.7071067811865475*fedge[0])/vmap_prime_edge[0]; 
  fUpL[1] = (1.58113883008419*fedge[7]+1.224744871391589*fedge[3]+0.7071067811865475*fedge[1])/vmap_prime_edge[0]; 
  fUpL[2] = (1.224744871391589*fedge[6]+0.7071067811865475*fedge[4])/vmap_prime_edge[0]; 
    } else { 
  fUpL[0] = (1.58113883008419*fskin[5]-1.224744871391589*fskin[2]+0.7071067811865475*fskin[0])/vmap_prime_skin[0]; 
  fUpL[1] = (1.58113883008419*fskin[7]-1.224744871391589*fskin[3]+0.7071067811865475*fskin[1])/vmap_prime_skin[0]; 
  fUpL[2] = (0.7071067811865475*fskin[4]-1.224744871391589*fskin[6])/vmap_prime_skin[0]; 
    } 
  } else { 
  double f_lr[3] = {0.};
  double f_cl[3] = {0.};
  ...
  f_lr[0] = (1.58113883008419*fedge[5]+1.224744871391589*fedge[2]+0.7071067811865475*fedge[0])/vmap_prime_edge[0]; 
  f_lr[1] = (1.58113883008419*fedge[7]+1.224744871391589*fedge[3]+0.7071067811865475*fedge[1])/vmap_prime_edge[0]; 
  f_lr[2] = (1.224744871391589*fedge[6]+0.7071067811865475*fedge[4])/vmap_prime_edge[0]; 

  f_cl[0] = (1.58113883008419*fskin[5]-1.224744871391589*fskin[2]+0.7071067811865475*fskin[0])/vmap_prime_skin[0]; 
  f_cl[1] = (1.58113883008419*fskin[7]-1.224744871391589*fskin[3]+0.7071067811865475*fskin[1])/vmap_prime_skin[0]; 
  f_cl[2] = (0.7071067811865475*fskin[4]-1.224744871391589*fskin[6])/vmap_prime_skin[0]; 
  ...
  double GhatL[3] = {0.};
  GhatL[0] = 0.7071067811865475*(alphaL[2]*fUpL[2]+alphaL[1]*fUpL[1]+alphaL[0]*fUpL[0]); 
  GhatL[1] = 0.6324555320336759*(alphaL[1]*fUpL[2]+fUpL[1]*alphaL[2])+0.7071067811865475*(alphaL[0]*fUpL[1]+fUpL[0]*alphaL[1]); 
  GhatL[2] = 0.4517539514526256*alphaL[2]*fUpL[2]+0.7071067811865475*(alphaL[0]*fUpL[2]+fUpL[0]*alphaL[2])+0.6324555320336759*alphaL[1]*fUpL[1]; 
