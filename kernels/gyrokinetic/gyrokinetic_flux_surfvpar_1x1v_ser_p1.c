...
{ 
  ...
  double *fmodal = &flux_surf[3]; 
  fmodal[0] = 0.7071067811865475*flux_surf_nodal[1]+0.7071067811865475*flux_surf_nodal[0]; 
  fmodal[1] = 0.7071067811865475*flux_surf_nodal[1]-0.7071067811865475*flux_surf_nodal[0]; 
