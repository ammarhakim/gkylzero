...
{ 
  ...
  out[6] += (2.8284271247461907*phi[2]*f[7]+2.8284271247461907*f[1]*phi[1]+2.8284271247461907*f[0]*phi[0])*q_*volFact+(0.4472135954999579*vmap1R2*f[8]+vmap[0]*vmap[1]*f[2]+0.5*f[0]*vmap1R2+0.5*f[0]*vmap0R2)*m_*volFact+(0.7071067811865475*bmag[2]*tmp[2]+0.7071067811865475*bmag[1]*tmp[1]+0.7071067811865475*bmag[0]*tmp[0])*volFact; 
  out[7] += (2.5298221281347044*phi[1]*f[7]+2.5298221281347044*f[1]*phi[2]+2.8284271247461907*f[0]*phi[1]+2.8284271247461907*phi[0]*f[1])*q_*volFact+(0.44721359549995804*vmap1R2*f[12]+vmap[0]*vmap[1]*f[4]+0.5*f[1]*vmap1R2+0.5*vmap0R2*f[1])*m_*volFact+(0.6324555320336759*bmag[1]*tmp[2]+0.6324555320336759*tmp[1]*bmag[2]+0.7071067811865475*bmag[0]*tmp[1]+0.7071067811865475*tmp[0]*bmag[1])*volFact; 
  out[8] += (1.8070158058105033*phi[2]*f[7]+2.8284271247461907*phi[0]*f[7]+2.8284271247461907*f[0]*phi[2]+2.5298221281347044*f[1]*phi[1])*q_*volFact+(1.0000000000000002*vmap[0]*vmap[1]*f[11]+0.5*vmap1R2*f[7]+0.5*vmap0R2*f[7])*m_*volFact+(0.45175395145262565*bmag[2]*tmp[2]+0.7071067811865475*bmag[0]*tmp[2]+0.7071067811865475*tmp[0]*bmag[2]+0.6324555320336759*bmag[1]*tmp[1])*volFact; 
} 
