...
{ 
  ...
  out[8] += volFact*(2.0*f[0]*wx1_sq+1.154700538379252*f[3]*dv1*wx1+(bmag[3]*tmp[3])/m_+(bmag[2]*tmp[2])/m_+(bmag[1]*tmp[1])/m_+(bmag[0]*tmp[0])/m_+0.1666666666666667*f[0]*dv1_sq); 
  out[9] += volFact*(2.0*f[1]*wx1_sq+1.154700538379252*f[6]*dv1*wx1+(bmag[2]*tmp[3])/m_+(tmp[2]*bmag[3])/m_+(bmag[0]*tmp[1])/m_+(tmp[0]*bmag[1])/m_+0.1666666666666667*f[1]*dv1_sq); 
  out[10] += volFact*(2.0*f[2]*wx1_sq+1.154700538379252*f[7]*dv1*wx1+(bmag[1]*tmp[3])/m_+(tmp[1]*bmag[3])/m_+(bmag[0]*tmp[2])/m_+(tmp[0]*bmag[2])/m_+0.1666666666666667*f[2]*dv1_sq); 
  out[11] += volFact*(2.0*f[5]*wx1_sq+1.154700538379252*f[11]*dv1*wx1+(bmag[0]*tmp[3])/m_+(tmp[0]*bmag[3])/m_+(bmag[1]*tmp[2])/m_+(tmp[1]*bmag[2])/m_+0.1666666666666667*f[5]*dv1_sq); 
} 
