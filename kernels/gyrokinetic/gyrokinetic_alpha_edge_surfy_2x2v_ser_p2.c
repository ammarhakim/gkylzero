...
{ 
  ...
  alphaR1[0] = ((0.6846531968814574*(b_z[4]*jacobtot_inv[4]+b_z[1]*jacobtot_inv[1]+b_z[0]*jacobtot_inv[0])*hamil[20]+(1.060660171779821*(b_z[1]*jacobtot_inv[4]+jacobtot_inv[1]*b_z[4])+1.185854122563142*(b_z[0]*jacobtot_inv[1]+jacobtot_inv[0]*b_z[1]))*hamil[19]+(0.6123724356957944*(b_z[1]*jacobtot_inv[4]+jacobtot_inv[1]*b_z[4])+0.6846531968814573*(b_z[0]*jacobtot_inv[1]+jacobtot_inv[0]*b_z[1]))*hamil[11]+(b_z[4]*jacobtot_inv[4]+b_z[1]*jacobtot_inv[1]+b_z[0]*jacobtot_inv[0])*(0.5303300858899105*hamil[5]+0.3061862178478971*hamil[1]))*rdx2)/q_+((1.369306393762915*BstarYdBmag[2]*hamil[13]+0.6123724356957944*BstarYdBmag[0]*hamil[3])*rdvpar2)/m_; 
  ...
  alphaR1[2] = ((1.369306393762915*BstarYdBmag[0]*hamil[13]+0.6123724356957944*BstarYdBmag[2]*hamil[3])*rdvpar2)/m_; 
  alphaR1[3] = (((0.6123724356957944*(b_z[1]*jacobtot_inv[4]+jacobtot_inv[1]*b_z[4])+0.6846531968814574*(b_z[0]*jacobtot_inv[1]+jacobtot_inv[0]*b_z[1]))*hamil[25]+0.3061862178478971*(b_z[4]*jacobtot_inv[4]+b_z[1]*jacobtot_inv[1]+b_z[0]*jacobtot_inv[0])*hamil[8])*rdx2)/q_; 
  alphaR1[4] = ((1.369306393762915*BstarYdBmag[1]*hamil[13]+0.6123724356957944*BstarYdBmag[3]*hamil[3])*rdvpar2)/m_; 
  ...
  alphaR1[8] = (1.224744871391589*BstarYdBmag[2]*hamil[13]*rdvpar2)/m_; 
  alphaR1[11] = ((1.369306393762915*BstarYdBmag[4]*hamil[13]+0.6123724356957944*hamil[3]*BstarYdBmag[6])*rdvpar2)/m_; 
  alphaR1[12] = (1.224744871391589*BstarYdBmag[3]*hamil[13]*rdvpar2)/m_; 
  alphaR1[13] = (((1.075883595099433*(b_z[1]*jacobtot_inv[4]+jacobtot_inv[1]*b_z[4])+0.6123724356957944*(b_z[0]*jacobtot_inv[1]+jacobtot_inv[0]*b_z[1]))*hamil[25]+(0.3061862178478971*(b_z[0]*jacobtot_inv[4]+jacobtot_inv[0]*b_z[4])+0.1956151991089878*b_z[4]*jacobtot_inv[4]+0.273861278752583*b_z[1]*jacobtot_inv[1])*hamil[8])*rdx2)/q_; 
  ...
  if ((-0.4242640687119282*alphaR1[12])-0.4242640687119286*alphaR1[11]+0.3162277660168378*alphaR1[8]+0.3162277660168378*alphaR1[7]+0.6363961030678927*alphaR1[4]-0.4743416490252568*alphaR1[2]-0.4743416490252568*alphaR1[1]+0.3535533905932734*alphaR1[0] > 0.) 
  ...
  if (0.5303300858899102*alphaR1[13]-0.3952847075210471*alphaR1[8]-0.3952847075210471*alphaR1[7]-0.4743416490252568*alphaR1[3]+0.3535533905932734*alphaR1[0] > 0.) 
  ...
  if ((-0.3952847075210471*alphaR1[8])-0.3952847075210471*alphaR1[7]+0.3535533905932734*alphaR1[0] > 0.) 
