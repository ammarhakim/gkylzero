...
{ 
  ...
  alpha_quad += -((0.6123724356957944*hamil[1]-0.6123724356957944*hamil[5])*rdx2)/m_/bmag_quad * 1/q_*dualcurlbhat_quad[0]*((0.8164965809277262*(0.6123724356957944*hamil[2]-2.371708245126284*hamil[8]))/vmap[1]);
  ...
  alpha_quad += -((0.6123724356957944*hamil[5]+0.6123724356957944*hamil[1])*rdx2)/m_/bmag_quad * 1/q_*dualcurlbhat_quad[0]*((0.8164965809277262*(0.6123724356957944*hamil[2]-2.371708245126284*hamil[8]))/vmap[1]);
