...
{ 
  ...
  if (alphaL[3]-1.0*alphaL[2]-1.0*alphaL[1]+alphaL[0] > 0.) {
    fUpOrdL[0] = 0.6123724356957944*fl[7]-0.6123724356957944*fl[6]+0.3535533905932737*fl[5]-0.6123724356957944*fl[4]-0.3535533905932737*fl[3]+0.6123724356957944*fl[2]-0.3535533905932737*fl[1]+0.3535533905932737*fl[0]; 
  } else {
    fUpOrdL[0] = (-0.6123724356957944*fc[7])+0.6123724356957944*fc[6]+0.3535533905932737*fc[5]+0.6123724356957944*fc[4]-0.3535533905932737*fc[3]-0.6123724356957944*fc[2]-0.3535533905932737*fc[1]+0.3535533905932737*fc[0]; 
  }
  if ((-1.0*alphaL[3])+alphaL[2]-1.0*alphaL[1]+alphaL[0] > 0.) {
    fUpOrdL[1] = (-0.6123724356957944*fl[7])+0.6123724356957944*fl[6]-0.3535533905932737*fl[5]-0.6123724356957944*fl[4]+0.3535533905932737*fl[3]+0.6123724356957944*fl[2]-0.3535533905932737*fl[1]+0.3535533905932737*fl[0]; 
  } else {
    fUpOrdL[1] = 0.6123724356957944*fc[7]-0.6123724356957944*fc[6]-0.3535533905932737*fc[5]+0.6123724356957944*fc[4]+0.3535533905932737*fc[3]-0.6123724356957944*fc[2]-0.3535533905932737*fc[1]+0.3535533905932737*fc[0]; 
  }
  if ((-1.0*alphaL[3])-1.0*alphaL[2]+alphaL[1]+alphaL[0] > 0.) {
    fUpOrdL[2] = (-0.6123724356957944*(fl[7]+fl[6]))-0.3535533905932737*fl[5]+0.6123724356957944*fl[4]-0.3535533905932737*fl[3]+0.6123724356957944*fl[2]+0.3535533905932737*(fl[1]+fl[0]); 
  } else {
    fUpOrdL[2] = 0.6123724356957944*(fc[7]+fc[6])-0.3535533905932737*fc[5]-0.6123724356957944*fc[4]-0.3535533905932737*fc[3]-0.6123724356957944*fc[2]+0.3535533905932737*(fc[1]+fc[0]); 
  }
  if (alphaL[3]+alphaL[2]+alphaL[1]+alphaL[0] > 0.) {
    fUpOrdL[3] = 0.6123724356957944*(fl[7]+fl[6])+0.3535533905932737*fl[5]+0.6123724356957944*fl[4]+0.3535533905932737*fl[3]+0.6123724356957944*fl[2]+0.3535533905932737*(fl[1]+fl[0]); 
  } else {
    fUpOrdL[3] = (-0.6123724356957944*(fc[7]+fc[6]))+0.3535533905932737*fc[5]-0.6123724356957944*fc[4]+0.3535533905932737*fc[3]-0.6123724356957944*fc[2]+0.3535533905932737*(fc[1]+fc[0]); 
  }
  ...
  if (alphaR[3]-1.0*alphaR[2]-1.0*alphaR[1]+alphaR[0] > 0.) {
    fUpOrdR[0] = 0.6123724356957944*fc[7]-0.6123724356957944*fc[6]+0.3535533905932737*fc[5]-0.6123724356957944*fc[4]-0.3535533905932737*fc[3]+0.6123724356957944*fc[2]-0.3535533905932737*fc[1]+0.3535533905932737*fc[0]; 
  } else {
    fUpOrdR[0] = (-0.6123724356957944*fr[7])+0.6123724356957944*fr[6]+0.3535533905932737*fr[5]+0.6123724356957944*fr[4]-0.3535533905932737*fr[3]-0.6123724356957944*fr[2]-0.3535533905932737*fr[1]+0.3535533905932737*fr[0]; 
  }
  if ((-1.0*alphaR[3])+alphaR[2]-1.0*alphaR[1]+alphaR[0] > 0.) {
    fUpOrdR[1] = (-0.6123724356957944*fc[7])+0.6123724356957944*fc[6]-0.3535533905932737*fc[5]-0.6123724356957944*fc[4]+0.3535533905932737*fc[3]+0.6123724356957944*fc[2]-0.3535533905932737*fc[1]+0.3535533905932737*fc[0]; 
  } else {
    fUpOrdR[1] = 0.6123724356957944*fr[7]-0.6123724356957944*fr[6]-0.3535533905932737*fr[5]+0.6123724356957944*fr[4]+0.3535533905932737*fr[3]-0.6123724356957944*fr[2]-0.3535533905932737*fr[1]+0.3535533905932737*fr[0]; 
  }
  if ((-1.0*alphaR[3])-1.0*alphaR[2]+alphaR[1]+alphaR[0] > 0.) {
    fUpOrdR[2] = (-0.6123724356957944*(fc[7]+fc[6]))-0.3535533905932737*fc[5]+0.6123724356957944*fc[4]-0.3535533905932737*fc[3]+0.6123724356957944*fc[2]+0.3535533905932737*(fc[1]+fc[0]); 
  } else {
    fUpOrdR[2] = 0.6123724356957944*(fr[7]+fr[6])-0.3535533905932737*fr[5]-0.6123724356957944*fr[4]-0.3535533905932737*fr[3]-0.6123724356957944*fr[2]+0.3535533905932737*(fr[1]+fr[0]); 
  }
  if (alphaR[3]+alphaR[2]+alphaR[1]+alphaR[0] > 0.) {
    fUpOrdR[3] = 0.6123724356957944*(fc[7]+fc[6])+0.3535533905932737*fc[5]+0.6123724356957944*fc[4]+0.3535533905932737*fc[3]+0.6123724356957944*fc[2]+0.3535533905932737*(fc[1]+fc[0]); 
  } else {
    fUpOrdR[3] = (-0.6123724356957944*(fr[7]+fr[6]))+0.3535533905932737*fr[5]-0.6123724356957944*fr[4]+0.3535533905932737*fr[3]-0.6123724356957944*fr[2]+0.3535533905932737*(fr[1]+fr[0]); 
  }
