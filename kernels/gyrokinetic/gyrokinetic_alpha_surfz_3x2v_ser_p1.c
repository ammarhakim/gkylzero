...
{ 
  ...
  alphaL[3] = ((1.778781183844713*jacobtot_inv[3]*b_y[5]*hamil[32]-1.026979795322186*jacobtot_inv[0]*b_y[5]*hamil[32]-1.026979795322186*b_y[1]*jacobtot_inv[3]*hamil[32]+0.592927061281571*jacobtot_inv[0]*b_y[1]*hamil[32])*rdvpar2*rdx2*wvpar)/q_+((0.4592793267718456*jacobtot_inv[3]*hamil[4]*b_y[5]-0.2651650429449552*jacobtot_inv[0]*hamil[4]*b_y[5]-0.2651650429449552*b_y[1]*jacobtot_inv[3]*hamil[4]+0.1530931089239486*jacobtot_inv[0]*b_y[1]*hamil[4])*rdx2)/q_+((1.026979795322186*cmag[5]*jacobtot_inv[5]*hamil[32]-0.592927061281571*cmag[1]*jacobtot_inv[5]*hamil[32]-0.592927061281571*jacobtot_inv[1]*cmag[5]*hamil[32]+1.026979795322186*cmag[3]*jacobtot_inv[3]*hamil[32]-0.592927061281571*cmag[0]*jacobtot_inv[3]*hamil[32]-0.592927061281571*jacobtot_inv[0]*cmag[3]*hamil[32]+0.3423265984407287*cmag[1]*jacobtot_inv[1]*hamil[32]+0.3423265984407287*cmag[0]*jacobtot_inv[0]*hamil[32])*rdvpar2)/m_; 
  ...
  alphaL[6] = ((1.778781183844713*b_y[5]*jacobtot_inv[5]*hamil[32]-1.026979795322186*b_y[1]*jacobtot_inv[5]*hamil[32]-1.026979795322186*jacobtot_inv[1]*b_y[5]*hamil[32]+0.592927061281571*b_y[1]*jacobtot_inv[1]*hamil[32])*rdvpar2*rdx2*wvpar)/q_+((0.4592793267718456*hamil[4]*b_y[5]*jacobtot_inv[5]-0.2651650429449552*b_y[1]*hamil[4]*jacobtot_inv[5]-0.2651650429449552*jacobtot_inv[1]*hamil[4]*b_y[5]+0.1530931089239486*b_y[1]*jacobtot_inv[1]*hamil[4])*rdx2)/q_+((1.026979795322186*cmag[3]*jacobtot_inv[5]*hamil[32]-0.592927061281571*cmag[0]*jacobtot_inv[5]*hamil[32]+1.026979795322186*jacobtot_inv[3]*cmag[5]*hamil[32]-0.592927061281571*jacobtot_inv[0]*cmag[5]*hamil[32]-0.592927061281571*cmag[1]*jacobtot_inv[3]*hamil[32]-0.592927061281571*jacobtot_inv[1]*cmag[3]*hamil[32]+0.3423265984407287*cmag[0]*jacobtot_inv[1]*hamil[32]+0.3423265984407287*jacobtot_inv[0]*cmag[1]*hamil[32])*rdvpar2)/m_; 
