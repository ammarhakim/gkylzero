...
{ 
  ...
  if (0.2795084971874732*alphaL2[17]-0.2795084971874732*alphaL2[16]+0.25*alphaL2[8]+0.25*alphaL2[5]-0.25*alphaL2[4]-0.25*alphaL2[2]-0.25*alphaL2[1]+0.25*alphaL2[0] > 0.) 
