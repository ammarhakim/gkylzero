...
{ 
  ...
  double m0_e = 0.7071067811865475*m0Elc[0]-1.224744871391589*m0Elc[1];
  double m0_i = 0.7071067811865475*m0Ion[0]-1.224744871391589*m0Ion[1];
  double m1_e = 0.7071067811865475*m1Elc[0]-1.224744871391589*m1Elc[1];
  double m1_i = 0.7071067811865475*m1Ion[0]-1.224744871391589*m1Ion[1];
  double m2par_e = 0.7071067811865475*m2parElc[0]-1.224744871391589*m2parElc[1];
  double m2par_i = 0.7071067811865475*m2parIon[0]-1.224744871391589*m2parIon[1];
  ...
  double Delta_phi_r = ((fmin(1.0,fabs(upar_i)/c_s)-1.0)*Tpar_e)/elem_q;
...
{ 
  ...
  double m0_e = 1.224744871391589*m0Elc[1]+0.7071067811865475*m0Elc[0];
  double m0_i = 1.224744871391589*m0Ion[1]+0.7071067811865475*m0Ion[0];
  double m1_e = 1.224744871391589*m1Elc[1]+0.7071067811865475*m1Elc[0];
  double m1_i = 1.224744871391589*m1Ion[1]+0.7071067811865475*m1Ion[0];
  double m2par_e = 1.224744871391589*m2parElc[1]+0.7071067811865475*m2parElc[0];
  double m2par_i = 1.224744871391589*m2parIon[1]+0.7071067811865475*m2parIon[0];
