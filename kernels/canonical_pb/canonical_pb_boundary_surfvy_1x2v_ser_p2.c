...
{ 
  ...
  fUpR[4] = 1.224744871391589*fskin[13]+0.7071067811865475*fskin[7]; 
  fUpR[5] = 1.224744871391589*fskin[14]+0.7071067811865475*fskin[8]; 
  fUpR[6] = 1.224744871391589*fskin[17]+0.7071067811865475*fskin[11]; 
  fUpR[7] = 1.224744871391589*fskin[18]+0.7071067811865475*fskin[12]; 
    } else { 
  ...
  fUpR[4] = 0.7071067811865475*fedge[7]-1.224744871391589*fedge[13]; 
  fUpR[5] = 0.7071067811865475*fedge[8]-1.224744871391589*fedge[14]; 
  fUpR[6] = 0.7071067811865475*fedge[11]-1.224744871391589*fedge[17]; 
  fUpR[7] = 0.7071067811865475*fedge[12]-1.224744871391589*fedge[18]; 
    } 
  } else { 
  double f_cr[8] = {0.};
  double f_rl[8] = {0.};
  ...
  f_cr[4] = 1.224744871391589*fskin[13]+0.7071067811865475*fskin[7]; 
  f_cr[5] = 1.224744871391589*fskin[14]+0.7071067811865475*fskin[8]; 
  f_cr[6] = 1.224744871391589*fskin[17]+0.7071067811865475*fskin[11]; 
  f_cr[7] = 1.224744871391589*fskin[18]+0.7071067811865475*fskin[12]; 
  ...
  f_rl[4] = 0.7071067811865475*fedge[7]-1.224744871391589*fedge[13]; 
  f_rl[5] = 0.7071067811865475*fedge[8]-1.224744871391589*fedge[14]; 
  f_rl[6] = 0.7071067811865475*fedge[11]-1.224744871391589*fedge[17]; 
  f_rl[7] = 0.7071067811865475*fedge[12]-1.224744871391589*fedge[18]; 
  ...
  fUpL[4] = 1.224744871391589*fedge[13]+0.7071067811865475*fedge[7]; 
  fUpL[5] = 1.224744871391589*fedge[14]+0.7071067811865475*fedge[8]; 
  fUpL[6] = 1.224744871391589*fedge[17]+0.7071067811865475*fedge[11]; 
  fUpL[7] = 1.224744871391589*fedge[18]+0.7071067811865475*fedge[12]; 
    } else { 
  ...
  fUpL[4] = 0.7071067811865475*fskin[7]-1.224744871391589*fskin[13]; 
  fUpL[5] = 0.7071067811865475*fskin[8]-1.224744871391589*fskin[14]; 
  fUpL[6] = 0.7071067811865475*fskin[11]-1.224744871391589*fskin[17]; 
  fUpL[7] = 0.7071067811865475*fskin[12]-1.224744871391589*fskin[18]; 
    } 
  } else { 
  double f_lr[8] = {0.};
  double f_cl[8] = {0.};
  ...
  f_lr[4] = 1.224744871391589*fedge[13]+0.7071067811865475*fedge[7]; 
  f_lr[5] = 1.224744871391589*fedge[14]+0.7071067811865475*fedge[8]; 
  f_lr[6] = 1.224744871391589*fedge[17]+0.7071067811865475*fedge[11]; 
  f_lr[7] = 1.224744871391589*fedge[18]+0.7071067811865475*fedge[12]; 
  ...
  f_cl[4] = 0.7071067811865475*fskin[7]-1.224744871391589*fskin[13]; 
  f_cl[5] = 0.7071067811865475*fskin[8]-1.224744871391589*fskin[14]; 
  f_cl[6] = 0.7071067811865475*fskin[11]-1.224744871391589*fskin[17]; 
  f_cl[7] = 0.7071067811865475*fskin[12]-1.224744871391589*fskin[18]; 
