...
{ 
  ...
  double dx = 2.0/dxv[0]; 
  double dy = 2.0/dxv[1]; 
  out[0] += 1.5*phi[1]*background_n_gradient[2]*dx*dy-1.5*background_n_gradient[1]*phi[2]*dx*dy; 
  out[1] += 1.5*phi[1]*background_n_gradient[3]*dx*dy-1.5*background_n_gradient[1]*phi[3]*dx*dy; 
  out[2] += 1.5*background_n_gradient[2]*phi[3]*dx*dy-1.5*phi[2]*background_n_gradient[3]*dx*dy; 
} 
