...
{ 
  ...
  alphaL[0] = 1.224744871391589*hamil[4]*rdvx2*rdx2-2.121320343559642*hamil[10]*rdvx2*rdx2; 
  alphaL[1] = 1.224744871391589*hamil[11]*rdvx2*rdx2-2.121320343559642*hamil[23]*rdvx2*rdx2; 
  alphaL[2] = 1.224744871391589*hamil[12]*rdvx2*rdx2-2.121320343559642*hamil[24]*rdvx2*rdx2; 
  alphaL[3] = 2.738612787525831*hamil[64]*rdvx2*rdx2-4.743416490252569*hamil[65]*rdvx2*rdx2; 
  alphaL[4] = 1.224744871391589*hamil[16]*rdvx2*rdx2-2.121320343559642*hamil[29]*rdvx2*rdx2; 
  alphaL[5] = 1.224744871391589*hamil[20]*rdvx2*rdx2-2.121320343559642*hamil[35]*rdvx2*rdx2; 
  alphaL[6] = 1.224744871391589*hamil[25]*rdvx2*rdx2-2.121320343559642*hamil[42]*rdvx2*rdx2; 
  alphaL[7] = 2.738612787525831*hamil[66]*rdvx2*rdx2-4.743416490252569*hamil[70]*rdvx2*rdx2; 
  alphaL[8] = 2.738612787525831*hamil[67]*rdvx2*rdx2-4.743416490252569*hamil[71]*rdvx2*rdx2; 
  alphaL[9] = 1.224744871391589*hamil[30]*rdvx2*rdx2-2.121320343559642*hamil[44]*rdvx2*rdx2; 
  alphaL[10] = 1.224744871391589*hamil[31]*rdvx2*rdx2-2.121320343559642*hamil[45]*rdvx2*rdx2; 
  alphaL[11] = 2.738612787525831*hamil[68]*rdvx2*rdx2-4.743416490252569*hamil[73]*rdvx2*rdx2; 
  alphaL[12] = 1.224744871391589*hamil[36]*rdvx2*rdx2-2.121320343559642*hamil[48]*rdvx2*rdx2; 
  alphaL[13] = 1.224744871391589*hamil[37]*rdvx2*rdx2-2.121320343559642*hamil[49]*rdvx2*rdx2; 
  alphaL[14] = 2.738612787525831*hamil[69]*rdvx2*rdx2-4.743416490252569*hamil[76]*rdvx2*rdx2; 
  alphaL[15] = 1.224744871391589*hamil[41]*rdvx2*rdx2-2.121320343559642*hamil[54]*rdvx2*rdx2; 
  alphaL[16] = 2.738612787525831*hamil[72]*rdvx2*rdx2-4.743416490252569*hamil[80]*rdvx2*rdx2; 
  alphaL[17] = 1.224744871391589*hamil[46]*rdvx2*rdx2-2.121320343559642*hamil[57]*rdvx2*rdx2; 
  alphaL[18] = 2.738612787525831*hamil[74]*rdvx2*rdx2-4.743416490252569*hamil[81]*rdvx2*rdx2; 
  alphaL[19] = 2.738612787525831*hamil[75]*rdvx2*rdx2-4.743416490252569*hamil[82]*rdvx2*rdx2; 
  alphaL[20] = 1.224744871391589*hamil[50]*rdvx2*rdx2-2.121320343559642*hamil[58]*rdvx2*rdx2; 
  alphaL[21] = 2.738612787525831*hamil[77]*rdvx2*rdx2-4.743416490252569*hamil[84]*rdvx2*rdx2; 
  alphaL[22] = 2.738612787525831*hamil[78]*rdvx2*rdx2-4.743416490252569*hamil[85]*rdvx2*rdx2; 
  alphaL[23] = 1.224744871391589*hamil[55]*rdvx2*rdx2-2.121320343559642*hamil[60]*rdvx2*rdx2; 
  alphaL[24] = 1.224744871391589*hamil[56]*rdvx2*rdx2-2.121320343559642*hamil[61]*rdvx2*rdx2; 
  alphaL[25] = 2.738612787525831*hamil[79]*rdvx2*rdx2-4.743416490252569*hamil[87]*rdvx2*rdx2; 
  alphaL[26] = 2.738612787525831*hamil[83]*rdvx2*rdx2-4.743416490252569*hamil[90]*rdvx2*rdx2; 
  alphaL[27] = 2.738612787525831*hamil[86]*rdvx2*rdx2-4.743416490252569*hamil[91]*rdvx2*rdx2; 
  alphaL[28] = 1.224744871391589*hamil[62]*rdvx2*rdx2-2.121320343559642*hamil[63]*rdvx2*rdx2; 
  alphaL[29] = 2.738612787525831*hamil[88]*rdvx2*rdx2-4.743416490252569*hamil[92]*rdvx2*rdx2; 
  alphaL[30] = 2.738612787525831*hamil[89]*rdvx2*rdx2-4.743416490252569*hamil[93]*rdvx2*rdx2; 
  alphaL[31] = 2.738612787525831*hamil[94]*rdvx2*rdx2-4.743416490252569*hamil[95]*rdvx2*rdx2; 
