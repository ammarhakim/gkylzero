...
{ 
  ...
  fUpL[0] = 1.224744871391589*fl[4]+0.7071067811865475*fl[0]; 
  fUpL[1] = 1.224744871391589*fl[9]+0.7071067811865475*fl[1]; 
  fUpL[2] = 1.224744871391589*fl[10]+0.7071067811865475*fl[2]; 
  fUpL[3] = 1.224744871391589*fl[11]+0.7071067811865475*fl[3]; 
  fUpL[4] = 1.224744871391589*fl[15]+0.7071067811865475*fl[5]; 
  fUpL[5] = 1.224744871391589*fl[17]+0.7071067811865475*fl[6]; 
  fUpL[6] = 1.224744871391589*fl[18]+0.7071067811865475*fl[7]; 
  fUpL[7] = 1.224744871391589*fl[19]+0.7071067811865475*fl[8]; 
  fUpL[8] = 1.224744871391589*fl[23]+0.7071067811865475*fl[12]; 
  fUpL[9] = 1.224744871391589*fl[24]+0.7071067811865475*fl[13]; 
  fUpL[10] = 1.224744871391589*fl[25]+0.7071067811865475*fl[14]; 
  fUpL[11] = 1.224744871391589*fl[26]+0.7071067811865475*fl[16]; 
  fUpL[12] = 1.224744871391589*fl[28]+0.7071067811865475*fl[20]; 
  fUpL[13] = 1.224744871391589*fl[29]+0.7071067811865475*fl[21]; 
  fUpL[14] = 1.224744871391589*fl[30]+0.7071067811865475*fl[22]; 
  fUpL[15] = 1.224744871391589*fl[31]+0.7071067811865475*fl[27]; 
    } else { 
  fUpL[0] = 0.7071067811865475*fc[0]-1.224744871391589*fc[4]; 
  fUpL[1] = 0.7071067811865475*fc[1]-1.224744871391589*fc[9]; 
  fUpL[2] = 0.7071067811865475*fc[2]-1.224744871391589*fc[10]; 
  fUpL[3] = 0.7071067811865475*fc[3]-1.224744871391589*fc[11]; 
  fUpL[4] = 0.7071067811865475*fc[5]-1.224744871391589*fc[15]; 
  fUpL[5] = 0.7071067811865475*fc[6]-1.224744871391589*fc[17]; 
  fUpL[6] = 0.7071067811865475*fc[7]-1.224744871391589*fc[18]; 
  fUpL[7] = 0.7071067811865475*fc[8]-1.224744871391589*fc[19]; 
  fUpL[8] = 0.7071067811865475*fc[12]-1.224744871391589*fc[23]; 
  fUpL[9] = 0.7071067811865475*fc[13]-1.224744871391589*fc[24]; 
  fUpL[10] = 0.7071067811865475*fc[14]-1.224744871391589*fc[25]; 
  fUpL[11] = 0.7071067811865475*fc[16]-1.224744871391589*fc[26]; 
  fUpL[12] = 0.7071067811865475*fc[20]-1.224744871391589*fc[28]; 
  fUpL[13] = 0.7071067811865475*fc[21]-1.224744871391589*fc[29]; 
  fUpL[14] = 0.7071067811865475*fc[22]-1.224744871391589*fc[30]; 
  fUpL[15] = 0.7071067811865475*fc[27]-1.224744871391589*fc[31]; 
    } 
  } else { 
  double f_lr[16] = {0.};
  double f_cl[16] = {0.};
  ...
  f_lr[0] = 1.224744871391589*fl[4]+0.7071067811865475*fl[0]; 
  f_lr[1] = 1.224744871391589*fl[9]+0.7071067811865475*fl[1]; 
  f_lr[2] = 1.224744871391589*fl[10]+0.7071067811865475*fl[2]; 
  f_lr[3] = 1.224744871391589*fl[11]+0.7071067811865475*fl[3]; 
  f_lr[4] = 1.224744871391589*fl[15]+0.7071067811865475*fl[5]; 
  f_lr[5] = 1.224744871391589*fl[17]+0.7071067811865475*fl[6]; 
  f_lr[6] = 1.224744871391589*fl[18]+0.7071067811865475*fl[7]; 
  f_lr[7] = 1.224744871391589*fl[19]+0.7071067811865475*fl[8]; 
  f_lr[8] = 1.224744871391589*fl[23]+0.7071067811865475*fl[12]; 
  f_lr[9] = 1.224744871391589*fl[24]+0.7071067811865475*fl[13]; 
  f_lr[10] = 1.224744871391589*fl[25]+0.7071067811865475*fl[14]; 
  f_lr[11] = 1.224744871391589*fl[26]+0.7071067811865475*fl[16]; 
  f_lr[12] = 1.224744871391589*fl[28]+0.7071067811865475*fl[20]; 
  f_lr[13] = 1.224744871391589*fl[29]+0.7071067811865475*fl[21]; 
  f_lr[14] = 1.224744871391589*fl[30]+0.7071067811865475*fl[22]; 
  f_lr[15] = 1.224744871391589*fl[31]+0.7071067811865475*fl[27]; 

  f_cl[0] = 0.7071067811865475*fc[0]-1.224744871391589*fc[4]; 
  f_cl[1] = 0.7071067811865475*fc[1]-1.224744871391589*fc[9]; 
  f_cl[2] = 0.7071067811865475*fc[2]-1.224744871391589*fc[10]; 
  f_cl[3] = 0.7071067811865475*fc[3]-1.224744871391589*fc[11]; 
  f_cl[4] = 0.7071067811865475*fc[5]-1.224744871391589*fc[15]; 
  f_cl[5] = 0.7071067811865475*fc[6]-1.224744871391589*fc[17]; 
  f_cl[6] = 0.7071067811865475*fc[7]-1.224744871391589*fc[18]; 
  f_cl[7] = 0.7071067811865475*fc[8]-1.224744871391589*fc[19]; 
  f_cl[8] = 0.7071067811865475*fc[12]-1.224744871391589*fc[23]; 
  f_cl[9] = 0.7071067811865475*fc[13]-1.224744871391589*fc[24]; 
  f_cl[10] = 0.7071067811865475*fc[14]-1.224744871391589*fc[25]; 
  f_cl[11] = 0.7071067811865475*fc[16]-1.224744871391589*fc[26]; 
  f_cl[12] = 0.7071067811865475*fc[20]-1.224744871391589*fc[28]; 
  f_cl[13] = 0.7071067811865475*fc[21]-1.224744871391589*fc[29]; 
  f_cl[14] = 0.7071067811865475*fc[22]-1.224744871391589*fc[30]; 
  f_cl[15] = 0.7071067811865475*fc[27]-1.224744871391589*fc[31]; 
  ...
  fUpR[0] = 1.224744871391589*fc[4]+0.7071067811865475*fc[0]; 
  fUpR[1] = 1.224744871391589*fc[9]+0.7071067811865475*fc[1]; 
  fUpR[2] = 1.224744871391589*fc[10]+0.7071067811865475*fc[2]; 
  fUpR[3] = 1.224744871391589*fc[11]+0.7071067811865475*fc[3]; 
  fUpR[4] = 1.224744871391589*fc[15]+0.7071067811865475*fc[5]; 
  fUpR[5] = 1.224744871391589*fc[17]+0.7071067811865475*fc[6]; 
  fUpR[6] = 1.224744871391589*fc[18]+0.7071067811865475*fc[7]; 
  fUpR[7] = 1.224744871391589*fc[19]+0.7071067811865475*fc[8]; 
  fUpR[8] = 1.224744871391589*fc[23]+0.7071067811865475*fc[12]; 
  fUpR[9] = 1.224744871391589*fc[24]+0.7071067811865475*fc[13]; 
  fUpR[10] = 1.224744871391589*fc[25]+0.7071067811865475*fc[14]; 
  fUpR[11] = 1.224744871391589*fc[26]+0.7071067811865475*fc[16]; 
  fUpR[12] = 1.224744871391589*fc[28]+0.7071067811865475*fc[20]; 
  fUpR[13] = 1.224744871391589*fc[29]+0.7071067811865475*fc[21]; 
  fUpR[14] = 1.224744871391589*fc[30]+0.7071067811865475*fc[22]; 
  fUpR[15] = 1.224744871391589*fc[31]+0.7071067811865475*fc[27]; 
    } else { 
  fUpR[0] = 0.7071067811865475*fr[0]-1.224744871391589*fr[4]; 
  fUpR[1] = 0.7071067811865475*fr[1]-1.224744871391589*fr[9]; 
  fUpR[2] = 0.7071067811865475*fr[2]-1.224744871391589*fr[10]; 
  fUpR[3] = 0.7071067811865475*fr[3]-1.224744871391589*fr[11]; 
  fUpR[4] = 0.7071067811865475*fr[5]-1.224744871391589*fr[15]; 
  fUpR[5] = 0.7071067811865475*fr[6]-1.224744871391589*fr[17]; 
  fUpR[6] = 0.7071067811865475*fr[7]-1.224744871391589*fr[18]; 
  fUpR[7] = 0.7071067811865475*fr[8]-1.224744871391589*fr[19]; 
  fUpR[8] = 0.7071067811865475*fr[12]-1.224744871391589*fr[23]; 
  fUpR[9] = 0.7071067811865475*fr[13]-1.224744871391589*fr[24]; 
  fUpR[10] = 0.7071067811865475*fr[14]-1.224744871391589*fr[25]; 
  fUpR[11] = 0.7071067811865475*fr[16]-1.224744871391589*fr[26]; 
  fUpR[12] = 0.7071067811865475*fr[20]-1.224744871391589*fr[28]; 
  fUpR[13] = 0.7071067811865475*fr[21]-1.224744871391589*fr[29]; 
  fUpR[14] = 0.7071067811865475*fr[22]-1.224744871391589*fr[30]; 
  fUpR[15] = 0.7071067811865475*fr[27]-1.224744871391589*fr[31]; 
    } 
  } else { 
  double f_cr[16] = {0.};
  double f_rl[16] = {0.};
  ...
  f_cr[0] = 1.224744871391589*fc[4]+0.7071067811865475*fc[0]; 
  f_cr[1] = 1.224744871391589*fc[9]+0.7071067811865475*fc[1]; 
  f_cr[2] = 1.224744871391589*fc[10]+0.7071067811865475*fc[2]; 
  f_cr[3] = 1.224744871391589*fc[11]+0.7071067811865475*fc[3]; 
  f_cr[4] = 1.224744871391589*fc[15]+0.7071067811865475*fc[5]; 
  f_cr[5] = 1.224744871391589*fc[17]+0.7071067811865475*fc[6]; 
  f_cr[6] = 1.224744871391589*fc[18]+0.7071067811865475*fc[7]; 
  f_cr[7] = 1.224744871391589*fc[19]+0.7071067811865475*fc[8]; 
  f_cr[8] = 1.224744871391589*fc[23]+0.7071067811865475*fc[12]; 
  f_cr[9] = 1.224744871391589*fc[24]+0.7071067811865475*fc[13]; 
  f_cr[10] = 1.224744871391589*fc[25]+0.7071067811865475*fc[14]; 
  f_cr[11] = 1.224744871391589*fc[26]+0.7071067811865475*fc[16]; 
  f_cr[12] = 1.224744871391589*fc[28]+0.7071067811865475*fc[20]; 
  f_cr[13] = 1.224744871391589*fc[29]+0.7071067811865475*fc[21]; 
  f_cr[14] = 1.224744871391589*fc[30]+0.7071067811865475*fc[22]; 
  f_cr[15] = 1.224744871391589*fc[31]+0.7071067811865475*fc[27]; 

  f_rl[0] = 0.7071067811865475*fr[0]-1.224744871391589*fr[4]; 
  f_rl[1] = 0.7071067811865475*fr[1]-1.224744871391589*fr[9]; 
  f_rl[2] = 0.7071067811865475*fr[2]-1.224744871391589*fr[10]; 
  f_rl[3] = 0.7071067811865475*fr[3]-1.224744871391589*fr[11]; 
  f_rl[4] = 0.7071067811865475*fr[5]-1.224744871391589*fr[15]; 
  f_rl[5] = 0.7071067811865475*fr[6]-1.224744871391589*fr[17]; 
  f_rl[6] = 0.7071067811865475*fr[7]-1.224744871391589*fr[18]; 
  f_rl[7] = 0.7071067811865475*fr[8]-1.224744871391589*fr[19]; 
  f_rl[8] = 0.7071067811865475*fr[12]-1.224744871391589*fr[23]; 
  f_rl[9] = 0.7071067811865475*fr[13]-1.224744871391589*fr[24]; 
  f_rl[10] = 0.7071067811865475*fr[14]-1.224744871391589*fr[25]; 
  f_rl[11] = 0.7071067811865475*fr[16]-1.224744871391589*fr[26]; 
  f_rl[12] = 0.7071067811865475*fr[20]-1.224744871391589*fr[28]; 
  f_rl[13] = 0.7071067811865475*fr[21]-1.224744871391589*fr[29]; 
  f_rl[14] = 0.7071067811865475*fr[22]-1.224744871391589*fr[30]; 
  f_rl[15] = 0.7071067811865475*fr[27]-1.224744871391589*fr[31]; 
  ...
  out[3] += (0.7071067811865475*GhatL[3]-0.7071067811865475*GhatR[3])*rdvy2; 
  out[4] += ((-1.224744871391589*GhatR[0])-1.224744871391589*GhatL[0])*rdvy2; 
  out[5] += (0.7071067811865475*GhatL[4]-0.7071067811865475*GhatR[4])*rdvy2; 
  out[6] += (0.7071067811865475*GhatL[5]-0.7071067811865475*GhatR[5])*rdvy2; 
  out[7] += (0.7071067811865475*GhatL[6]-0.7071067811865475*GhatR[6])*rdvy2; 
  out[8] += (0.7071067811865475*GhatL[7]-0.7071067811865475*GhatR[7])*rdvy2; 
  out[9] += ((-1.224744871391589*GhatR[1])-1.224744871391589*GhatL[1])*rdvy2; 
  out[10] += ((-1.224744871391589*GhatR[2])-1.224744871391589*GhatL[2])*rdvy2; 
  out[11] += ((-1.224744871391589*GhatR[3])-1.224744871391589*GhatL[3])*rdvy2; 
  out[12] += (0.7071067811865475*GhatL[8]-0.7071067811865475*GhatR[8])*rdvy2; 
  out[13] += (0.7071067811865475*GhatL[9]-0.7071067811865475*GhatR[9])*rdvy2; 
  out[14] += (0.7071067811865475*GhatL[10]-0.7071067811865475*GhatR[10])*rdvy2; 
  out[15] += ((-1.224744871391589*GhatR[4])-1.224744871391589*GhatL[4])*rdvy2; 
  out[16] += (0.7071067811865475*GhatL[11]-0.7071067811865475*GhatR[11])*rdvy2; 
  out[17] += ((-1.224744871391589*GhatR[5])-1.224744871391589*GhatL[5])*rdvy2; 
  out[18] += ((-1.224744871391589*GhatR[6])-1.224744871391589*GhatL[6])*rdvy2; 
  out[19] += ((-1.224744871391589*GhatR[7])-1.224744871391589*GhatL[7])*rdvy2; 
  out[20] += (0.7071067811865475*GhatL[12]-0.7071067811865475*GhatR[12])*rdvy2; 
  out[21] += (0.7071067811865475*GhatL[13]-0.7071067811865475*GhatR[13])*rdvy2; 
  out[22] += (0.7071067811865475*GhatL[14]-0.7071067811865475*GhatR[14])*rdvy2; 
  out[23] += ((-1.224744871391589*GhatR[8])-1.224744871391589*GhatL[8])*rdvy2; 
  out[24] += ((-1.224744871391589*GhatR[9])-1.224744871391589*GhatL[9])*rdvy2; 
  out[25] += ((-1.224744871391589*GhatR[10])-1.224744871391589*GhatL[10])*rdvy2; 
  out[26] += ((-1.224744871391589*GhatR[11])-1.224744871391589*GhatL[11])*rdvy2; 
  out[27] += (0.7071067811865475*GhatL[15]-0.7071067811865475*GhatR[15])*rdvy2; 
  out[28] += ((-1.224744871391589*GhatR[12])-1.224744871391589*GhatL[12])*rdvy2; 
  out[29] += ((-1.224744871391589*GhatR[13])-1.224744871391589*GhatL[13])*rdvy2; 
  out[30] += ((-1.224744871391589*GhatR[14])-1.224744871391589*GhatL[14])*rdvy2; 
  out[31] += ((-1.224744871391589*GhatR[15])-1.224744871391589*GhatL[15])*rdvy2; 
