...
{ 
  ...
  fUpL[1] = 1.224744871391589*fl[8]+0.7071067811865475*fl[1]; 
  fUpL[2] = 1.224744871391589*fl[9]+0.7071067811865475*fl[2]; 
  fUpL[3] = 1.224744871391589*fl[10]+0.7071067811865475*fl[3]; 
  fUpL[4] = 1.224744871391589*fl[12]+0.7071067811865475*fl[5]; 
  fUpL[5] = 1.224744871391589*fl[13]+0.7071067811865475*fl[6]; 
  fUpL[6] = 1.224744871391589*fl[14]+0.7071067811865475*fl[7]; 
  fUpL[7] = 1.224744871391589*fl[15]+0.7071067811865475*fl[11]; 
    } else { 
  fUpL[0] = 0.7071067811865475*fc[0]-1.224744871391589*fc[4]; 
  fUpL[1] = 0.7071067811865475*fc[1]-1.224744871391589*fc[8]; 
  fUpL[2] = 0.7071067811865475*fc[2]-1.224744871391589*fc[9]; 
  fUpL[3] = 0.7071067811865475*fc[3]-1.224744871391589*fc[10]; 
  fUpL[4] = 0.7071067811865475*fc[5]-1.224744871391589*fc[12]; 
  fUpL[5] = 0.7071067811865475*fc[6]-1.224744871391589*fc[13]; 
  fUpL[6] = 0.7071067811865475*fc[7]-1.224744871391589*fc[14]; 
  fUpL[7] = 0.7071067811865475*fc[11]-1.224744871391589*fc[15]; 
    } 
  } else { 
  double f_lr[8] = {0.};
  double f_cl[8] = {0.};
  ...
  f_lr[1] = 1.224744871391589*fl[8]+0.7071067811865475*fl[1]; 
  f_lr[2] = 1.224744871391589*fl[9]+0.7071067811865475*fl[2]; 
  f_lr[3] = 1.224744871391589*fl[10]+0.7071067811865475*fl[3]; 
  f_lr[4] = 1.224744871391589*fl[12]+0.7071067811865475*fl[5]; 
  f_lr[5] = 1.224744871391589*fl[13]+0.7071067811865475*fl[6]; 
  f_lr[6] = 1.224744871391589*fl[14]+0.7071067811865475*fl[7]; 
  f_lr[7] = 1.224744871391589*fl[15]+0.7071067811865475*fl[11]; 

  f_cl[0] = 0.7071067811865475*fc[0]-1.224744871391589*fc[4]; 
  f_cl[1] = 0.7071067811865475*fc[1]-1.224744871391589*fc[8]; 
  f_cl[2] = 0.7071067811865475*fc[2]-1.224744871391589*fc[9]; 
  f_cl[3] = 0.7071067811865475*fc[3]-1.224744871391589*fc[10]; 
  f_cl[4] = 0.7071067811865475*fc[5]-1.224744871391589*fc[12]; 
  f_cl[5] = 0.7071067811865475*fc[6]-1.224744871391589*fc[13]; 
  f_cl[6] = 0.7071067811865475*fc[7]-1.224744871391589*fc[14]; 
  f_cl[7] = 0.7071067811865475*fc[11]-1.224744871391589*fc[15]; 
  ...
  fUpR[1] = 1.224744871391589*fc[8]+0.7071067811865475*fc[1]; 
  fUpR[2] = 1.224744871391589*fc[9]+0.7071067811865475*fc[2]; 
  fUpR[3] = 1.224744871391589*fc[10]+0.7071067811865475*fc[3]; 
  fUpR[4] = 1.224744871391589*fc[12]+0.7071067811865475*fc[5]; 
  fUpR[5] = 1.224744871391589*fc[13]+0.7071067811865475*fc[6]; 
  fUpR[6] = 1.224744871391589*fc[14]+0.7071067811865475*fc[7]; 
  fUpR[7] = 1.224744871391589*fc[15]+0.7071067811865475*fc[11]; 
    } else { 
  fUpR[0] = 0.7071067811865475*fr[0]-1.224744871391589*fr[4]; 
  fUpR[1] = 0.7071067811865475*fr[1]-1.224744871391589*fr[8]; 
  fUpR[2] = 0.7071067811865475*fr[2]-1.224744871391589*fr[9]; 
  fUpR[3] = 0.7071067811865475*fr[3]-1.224744871391589*fr[10]; 
  fUpR[4] = 0.7071067811865475*fr[5]-1.224744871391589*fr[12]; 
  fUpR[5] = 0.7071067811865475*fr[6]-1.224744871391589*fr[13]; 
  fUpR[6] = 0.7071067811865475*fr[7]-1.224744871391589*fr[14]; 
  fUpR[7] = 0.7071067811865475*fr[11]-1.224744871391589*fr[15]; 
    } 
  } else { 
  double f_cr[8] = {0.};
  double f_rl[8] = {0.};
  ...
  f_cr[1] = 1.224744871391589*fc[8]+0.7071067811865475*fc[1]; 
  f_cr[2] = 1.224744871391589*fc[9]+0.7071067811865475*fc[2]; 
  f_cr[3] = 1.224744871391589*fc[10]+0.7071067811865475*fc[3]; 
  f_cr[4] = 1.224744871391589*fc[12]+0.7071067811865475*fc[5]; 
  f_cr[5] = 1.224744871391589*fc[13]+0.7071067811865475*fc[6]; 
  f_cr[6] = 1.224744871391589*fc[14]+0.7071067811865475*fc[7]; 
  f_cr[7] = 1.224744871391589*fc[15]+0.7071067811865475*fc[11]; 

  f_rl[0] = 0.7071067811865475*fr[0]-1.224744871391589*fr[4]; 
  f_rl[1] = 0.7071067811865475*fr[1]-1.224744871391589*fr[8]; 
  f_rl[2] = 0.7071067811865475*fr[2]-1.224744871391589*fr[9]; 
  f_rl[3] = 0.7071067811865475*fr[3]-1.224744871391589*fr[10]; 
  f_rl[4] = 0.7071067811865475*fr[5]-1.224744871391589*fr[12]; 
  f_rl[5] = 0.7071067811865475*fr[6]-1.224744871391589*fr[13]; 
  f_rl[6] = 0.7071067811865475*fr[7]-1.224744871391589*fr[14]; 
  f_rl[7] = 0.7071067811865475*fr[11]-1.224744871391589*fr[15]; 
  ...
  out[8] += ((-1.224744871391589*GhatR[1])-1.224744871391589*GhatL[1])*rdvy2; 
  out[9] += ((-1.224744871391589*GhatR[2])-1.224744871391589*GhatL[2])*rdvy2; 
  out[10] += ((-1.224744871391589*GhatR[3])-1.224744871391589*GhatL[3])*rdvy2; 
  out[11] += (0.7071067811865475*GhatL[7]-0.7071067811865475*GhatR[7])*rdvy2; 
  out[12] += ((-1.224744871391589*GhatR[4])-1.224744871391589*GhatL[4])*rdvy2; 
