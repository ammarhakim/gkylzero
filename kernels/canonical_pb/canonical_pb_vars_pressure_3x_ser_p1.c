...
GKYL_CU_DH void canonical_pb_vars_pressure_3x_ser_p1(const double *h_ij_inv, const double *MEnergy, const double *v_j, const double *nv_i, double* GKYL_RESTRICT d_Jv_P) 
{ 
