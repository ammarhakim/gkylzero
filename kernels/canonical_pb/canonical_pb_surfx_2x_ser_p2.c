...
{ 
  ...
  fUpL[0] = 1.5811388300841895*fl[4]+1.224744871391589*fl[1]+0.7071067811865475*fl[0]; 
  fUpL[1] = 1.5811388300841898*fl[6]+1.224744871391589*fl[3]+0.7071067811865475*fl[2]; 
  fUpL[2] = 1.224744871391589*fl[7]+0.7071067811865475*fl[5]; 
    } else { 
  fUpL[0] = 1.5811388300841895*fc[4]-1.224744871391589*fc[1]+0.7071067811865475*fc[0]; 
  fUpL[1] = 1.5811388300841898*fc[6]-1.224744871391589*fc[3]+0.7071067811865475*fc[2]; 
  fUpL[2] = 0.7071067811865475*fc[5]-1.224744871391589*fc[7]; 
    } 
  } else { 
  double f_lr[3] = {0.};
  double f_cl[3] = {0.};
  ...
  f_lr[0] = 1.5811388300841895*fl[4]+1.224744871391589*fl[1]+0.7071067811865475*fl[0]; 
  f_lr[1] = 1.5811388300841898*fl[6]+1.224744871391589*fl[3]+0.7071067811865475*fl[2]; 
  f_lr[2] = 1.224744871391589*fl[7]+0.7071067811865475*fl[5]; 

  f_cl[0] = 1.5811388300841895*fc[4]-1.224744871391589*fc[1]+0.7071067811865475*fc[0]; 
  f_cl[1] = 1.5811388300841898*fc[6]-1.224744871391589*fc[3]+0.7071067811865475*fc[2]; 
  f_cl[2] = 0.7071067811865475*fc[5]-1.224744871391589*fc[7]; 
  ...
  fUpR[0] = 1.5811388300841895*fc[4]+1.224744871391589*fc[1]+0.7071067811865475*fc[0]; 
  fUpR[1] = 1.5811388300841898*fc[6]+1.224744871391589*fc[3]+0.7071067811865475*fc[2]; 
  fUpR[2] = 1.224744871391589*fc[7]+0.7071067811865475*fc[5]; 
    } else { 
  fUpR[0] = 1.5811388300841895*fr[4]-1.224744871391589*fr[1]+0.7071067811865475*fr[0]; 
  fUpR[1] = 1.5811388300841898*fr[6]-1.224744871391589*fr[3]+0.7071067811865475*fr[2]; 
  fUpR[2] = 0.7071067811865475*fr[5]-1.224744871391589*fr[7]; 
    } 
  } else { 
  double f_cr[3] = {0.};
  double f_rl[3] = {0.};
  ...
  f_cr[0] = 1.5811388300841895*fc[4]+1.224744871391589*fc[1]+0.7071067811865475*fc[0]; 
  f_cr[1] = 1.5811388300841898*fc[6]+1.224744871391589*fc[3]+0.7071067811865475*fc[2]; 
  f_cr[2] = 1.224744871391589*fc[7]+0.7071067811865475*fc[5]; 

  f_rl[0] = 1.5811388300841895*fr[4]-1.224744871391589*fr[1]+0.7071067811865475*fr[0]; 
  f_rl[1] = 1.5811388300841898*fr[6]-1.224744871391589*fr[3]+0.7071067811865475*fr[2]; 
  f_rl[2] = 0.7071067811865475*fr[5]-1.224744871391589*fr[7]; 
  ...
  out[4] += (1.5811388300841895*GhatL[0]-1.5811388300841895*GhatR[0])*rdx2; 
  out[5] += (0.7071067811865475*GhatL[2]-0.7071067811865475*GhatR[2])*rdx2; 
  out[6] += (1.5811388300841898*GhatL[1]-1.5811388300841898*GhatR[1])*rdx2; 
