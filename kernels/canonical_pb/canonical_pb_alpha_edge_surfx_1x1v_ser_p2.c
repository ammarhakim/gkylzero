...
{ 
  ...
  alphaR[0] = 2.738612787525831*hamil[6]*rdvx2*rdx2+2.121320343559642*hamil[3]*rdvx2*rdx2+1.224744871391589*hamil[2]*rdvx2*rdx2; 
  alphaR[1] = 4.743416490252569*hamil[7]*rdvx2*rdx2+2.738612787525831*hamil[5]*rdvx2*rdx2; 
