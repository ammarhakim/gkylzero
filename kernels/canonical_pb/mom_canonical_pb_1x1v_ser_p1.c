...
{ 
  ...
  out[0] += (2.7386127875258306*f[3]*hamil[5]*rdvx2+2.7386127875258306*f[2]*hamil[4]*rdvx2+1.224744871391589*f[1]*hamil[3]*rdvx2+1.224744871391589*f[0]*hamil[2]*rdvx2)*volFact; 
  out[1] += (2.7386127875258306*f[2]*hamil[5]*rdvx2+2.7386127875258306*f[3]*hamil[4]*rdvx2+1.224744871391589*f[0]*hamil[3]*rdvx2+1.224744871391589*f[1]*hamil[2]*rdvx2)*volFact; 
} 
...
{ 
  ...
  out[1] += (3.872983346207417*f[3]*hamil[5]*rdvx2+3.872983346207417*f[2]*hamil[4]*rdvx2+1.7320508075688772*f[1]*hamil[3]*rdvx2+1.7320508075688772*f[0]*hamil[2]*rdvx2)*volFact; 
