...
{ 
  ...
  const double *alphaL = &alpha_surf_skin[64];
  const double *alphaR = &alpha_surf_edge[64];
  const double *sgn_alpha_surfL = &sgn_alpha_surf_skin[64];
  const double *sgn_alpha_surfR = &sgn_alpha_surf_edge[64];
  const int *const_sgn_alphaL = &const_sgn_alpha_skin[4];
  const int *const_sgn_alphaR = &const_sgn_alpha_edge[4];
  ...
  fUpR[0] = 1.224744871391589*fskin[5]+0.7071067811865475*fskin[0]; 
  fUpR[1] = 1.224744871391589*fskin[12]+0.7071067811865475*fskin[1]; 
  fUpR[2] = 1.224744871391589*fskin[13]+0.7071067811865475*fskin[2]; 
  fUpR[3] = 1.224744871391589*fskin[14]+0.7071067811865475*fskin[3]; 
  fUpR[4] = 1.224744871391589*fskin[15]+0.7071067811865475*fskin[4]; 
  fUpR[5] = 1.224744871391589*fskin[20]+0.7071067811865475*fskin[6]; 
  fUpR[6] = 1.224744871391589*fskin[21]+0.7071067811865475*fskin[7]; 
  fUpR[7] = 1.224744871391589*fskin[22]+0.7071067811865475*fskin[8]; 
  fUpR[8] = 1.224744871391589*fskin[23]+0.7071067811865475*fskin[9]; 
  fUpR[9] = 1.224744871391589*fskin[24]+0.7071067811865475*fskin[10]; 
  fUpR[10] = 1.224744871391589*fskin[25]+0.7071067811865475*fskin[11]; 
  fUpR[11] = 1.224744871391589*fskin[27]+0.7071067811865475*fskin[16]; 
  fUpR[12] = 1.224744871391589*fskin[28]+0.7071067811865475*fskin[17]; 
  fUpR[13] = 1.224744871391589*fskin[29]+0.7071067811865475*fskin[18]; 
  fUpR[14] = 1.224744871391589*fskin[30]+0.7071067811865475*fskin[19]; 
  fUpR[15] = 1.224744871391589*fskin[31]+0.7071067811865475*fskin[26]; 
    } else { 
  fUpR[0] = 0.7071067811865475*fedge[0]-1.224744871391589*fedge[5]; 
  fUpR[1] = 0.7071067811865475*fedge[1]-1.224744871391589*fedge[12]; 
  fUpR[2] = 0.7071067811865475*fedge[2]-1.224744871391589*fedge[13]; 
  fUpR[3] = 0.7071067811865475*fedge[3]-1.224744871391589*fedge[14]; 
  fUpR[4] = 0.7071067811865475*fedge[4]-1.224744871391589*fedge[15]; 
  fUpR[5] = 0.7071067811865475*fedge[6]-1.224744871391589*fedge[20]; 
  fUpR[6] = 0.7071067811865475*fedge[7]-1.224744871391589*fedge[21]; 
  fUpR[7] = 0.7071067811865475*fedge[8]-1.224744871391589*fedge[22]; 
  fUpR[8] = 0.7071067811865475*fedge[9]-1.224744871391589*fedge[23]; 
  fUpR[9] = 0.7071067811865475*fedge[10]-1.224744871391589*fedge[24]; 
  fUpR[10] = 0.7071067811865475*fedge[11]-1.224744871391589*fedge[25]; 
  fUpR[11] = 0.7071067811865475*fedge[16]-1.224744871391589*fedge[27]; 
  fUpR[12] = 0.7071067811865475*fedge[17]-1.224744871391589*fedge[28]; 
  fUpR[13] = 0.7071067811865475*fedge[18]-1.224744871391589*fedge[29]; 
  fUpR[14] = 0.7071067811865475*fedge[19]-1.224744871391589*fedge[30]; 
  fUpR[15] = 0.7071067811865475*fedge[26]-1.224744871391589*fedge[31]; 
    } 
  } else { 
  double f_cr[16] = {0.};
  double f_rl[16] = {0.};
  ...
  f_cr[0] = 1.224744871391589*fskin[5]+0.7071067811865475*fskin[0]; 
  f_cr[1] = 1.224744871391589*fskin[12]+0.7071067811865475*fskin[1]; 
  f_cr[2] = 1.224744871391589*fskin[13]+0.7071067811865475*fskin[2]; 
  f_cr[3] = 1.224744871391589*fskin[14]+0.7071067811865475*fskin[3]; 
  f_cr[4] = 1.224744871391589*fskin[15]+0.7071067811865475*fskin[4]; 
  f_cr[5] = 1.224744871391589*fskin[20]+0.7071067811865475*fskin[6]; 
  f_cr[6] = 1.224744871391589*fskin[21]+0.7071067811865475*fskin[7]; 
  f_cr[7] = 1.224744871391589*fskin[22]+0.7071067811865475*fskin[8]; 
  f_cr[8] = 1.224744871391589*fskin[23]+0.7071067811865475*fskin[9]; 
  f_cr[9] = 1.224744871391589*fskin[24]+0.7071067811865475*fskin[10]; 
  f_cr[10] = 1.224744871391589*fskin[25]+0.7071067811865475*fskin[11]; 
  f_cr[11] = 1.224744871391589*fskin[27]+0.7071067811865475*fskin[16]; 
  f_cr[12] = 1.224744871391589*fskin[28]+0.7071067811865475*fskin[17]; 
  f_cr[13] = 1.224744871391589*fskin[29]+0.7071067811865475*fskin[18]; 
  f_cr[14] = 1.224744871391589*fskin[30]+0.7071067811865475*fskin[19]; 
  f_cr[15] = 1.224744871391589*fskin[31]+0.7071067811865475*fskin[26]; 

  f_rl[0] = 0.7071067811865475*fedge[0]-1.224744871391589*fedge[5]; 
  f_rl[1] = 0.7071067811865475*fedge[1]-1.224744871391589*fedge[12]; 
  f_rl[2] = 0.7071067811865475*fedge[2]-1.224744871391589*fedge[13]; 
  f_rl[3] = 0.7071067811865475*fedge[3]-1.224744871391589*fedge[14]; 
  f_rl[4] = 0.7071067811865475*fedge[4]-1.224744871391589*fedge[15]; 
  f_rl[5] = 0.7071067811865475*fedge[6]-1.224744871391589*fedge[20]; 
  f_rl[6] = 0.7071067811865475*fedge[7]-1.224744871391589*fedge[21]; 
  f_rl[7] = 0.7071067811865475*fedge[8]-1.224744871391589*fedge[22]; 
  f_rl[8] = 0.7071067811865475*fedge[9]-1.224744871391589*fedge[23]; 
  f_rl[9] = 0.7071067811865475*fedge[10]-1.224744871391589*fedge[24]; 
  f_rl[10] = 0.7071067811865475*fedge[11]-1.224744871391589*fedge[25]; 
  f_rl[11] = 0.7071067811865475*fedge[16]-1.224744871391589*fedge[27]; 
  f_rl[12] = 0.7071067811865475*fedge[17]-1.224744871391589*fedge[28]; 
  f_rl[13] = 0.7071067811865475*fedge[18]-1.224744871391589*fedge[29]; 
  f_rl[14] = 0.7071067811865475*fedge[19]-1.224744871391589*fedge[30]; 
  f_rl[15] = 0.7071067811865475*fedge[26]-1.224744871391589*fedge[31]; 
  ...
  out[4] += -0.7071067811865475*GhatR[4]*rdvz2; 
  out[5] += -1.224744871391589*GhatR[0]*rdvz2; 
  out[6] += -0.7071067811865475*GhatR[5]*rdvz2; 
  out[7] += -0.7071067811865475*GhatR[6]*rdvz2; 
  out[8] += -0.7071067811865475*GhatR[7]*rdvz2; 
  out[9] += -0.7071067811865475*GhatR[8]*rdvz2; 
  out[10] += -0.7071067811865475*GhatR[9]*rdvz2; 
  out[11] += -0.7071067811865475*GhatR[10]*rdvz2; 
  out[12] += -1.224744871391589*GhatR[1]*rdvz2; 
  out[13] += -1.224744871391589*GhatR[2]*rdvz2; 
  out[14] += -1.224744871391589*GhatR[3]*rdvz2; 
  out[15] += -1.224744871391589*GhatR[4]*rdvz2; 
  out[16] += -0.7071067811865475*GhatR[11]*rdvz2; 
  out[17] += -0.7071067811865475*GhatR[12]*rdvz2; 
  out[18] += -0.7071067811865475*GhatR[13]*rdvz2; 
  out[19] += -0.7071067811865475*GhatR[14]*rdvz2; 
  out[20] += -1.224744871391589*GhatR[5]*rdvz2; 
  out[21] += -1.224744871391589*GhatR[6]*rdvz2; 
  out[22] += -1.224744871391589*GhatR[7]*rdvz2; 
  out[23] += -1.224744871391589*GhatR[8]*rdvz2; 
  out[24] += -1.224744871391589*GhatR[9]*rdvz2; 
  out[25] += -1.224744871391589*GhatR[10]*rdvz2; 
  out[26] += -0.7071067811865475*GhatR[15]*rdvz2; 
  out[27] += -1.224744871391589*GhatR[11]*rdvz2; 
  out[28] += -1.224744871391589*GhatR[12]*rdvz2; 
  out[29] += -1.224744871391589*GhatR[13]*rdvz2; 
  out[30] += -1.224744871391589*GhatR[14]*rdvz2; 
  out[31] += -1.224744871391589*GhatR[15]*rdvz2; 
  ...
  fUpL[0] = 1.224744871391589*fedge[5]+0.7071067811865475*fedge[0]; 
  fUpL[1] = 1.224744871391589*fedge[12]+0.7071067811865475*fedge[1]; 
  fUpL[2] = 1.224744871391589*fedge[13]+0.7071067811865475*fedge[2]; 
  fUpL[3] = 1.224744871391589*fedge[14]+0.7071067811865475*fedge[3]; 
  fUpL[4] = 1.224744871391589*fedge[15]+0.7071067811865475*fedge[4]; 
  fUpL[5] = 1.224744871391589*fedge[20]+0.7071067811865475*fedge[6]; 
  fUpL[6] = 1.224744871391589*fedge[21]+0.7071067811865475*fedge[7]; 
  fUpL[7] = 1.224744871391589*fedge[22]+0.7071067811865475*fedge[8]; 
  fUpL[8] = 1.224744871391589*fedge[23]+0.7071067811865475*fedge[9]; 
  fUpL[9] = 1.224744871391589*fedge[24]+0.7071067811865475*fedge[10]; 
  fUpL[10] = 1.224744871391589*fedge[25]+0.7071067811865475*fedge[11]; 
  fUpL[11] = 1.224744871391589*fedge[27]+0.7071067811865475*fedge[16]; 
  fUpL[12] = 1.224744871391589*fedge[28]+0.7071067811865475*fedge[17]; 
  fUpL[13] = 1.224744871391589*fedge[29]+0.7071067811865475*fedge[18]; 
  fUpL[14] = 1.224744871391589*fedge[30]+0.7071067811865475*fedge[19]; 
  fUpL[15] = 1.224744871391589*fedge[31]+0.7071067811865475*fedge[26]; 
    } else { 
  fUpL[0] = 0.7071067811865475*fskin[0]-1.224744871391589*fskin[5]; 
  fUpL[1] = 0.7071067811865475*fskin[1]-1.224744871391589*fskin[12]; 
  fUpL[2] = 0.7071067811865475*fskin[2]-1.224744871391589*fskin[13]; 
  fUpL[3] = 0.7071067811865475*fskin[3]-1.224744871391589*fskin[14]; 
  fUpL[4] = 0.7071067811865475*fskin[4]-1.224744871391589*fskin[15]; 
  fUpL[5] = 0.7071067811865475*fskin[6]-1.224744871391589*fskin[20]; 
  fUpL[6] = 0.7071067811865475*fskin[7]-1.224744871391589*fskin[21]; 
  fUpL[7] = 0.7071067811865475*fskin[8]-1.224744871391589*fskin[22]; 
  fUpL[8] = 0.7071067811865475*fskin[9]-1.224744871391589*fskin[23]; 
  fUpL[9] = 0.7071067811865475*fskin[10]-1.224744871391589*fskin[24]; 
  fUpL[10] = 0.7071067811865475*fskin[11]-1.224744871391589*fskin[25]; 
  fUpL[11] = 0.7071067811865475*fskin[16]-1.224744871391589*fskin[27]; 
  fUpL[12] = 0.7071067811865475*fskin[17]-1.224744871391589*fskin[28]; 
  fUpL[13] = 0.7071067811865475*fskin[18]-1.224744871391589*fskin[29]; 
  fUpL[14] = 0.7071067811865475*fskin[19]-1.224744871391589*fskin[30]; 
  fUpL[15] = 0.7071067811865475*fskin[26]-1.224744871391589*fskin[31]; 
    } 
  } else { 
  double f_lr[16] = {0.};
  double f_cl[16] = {0.};
  ...
  f_lr[0] = 1.224744871391589*fedge[5]+0.7071067811865475*fedge[0]; 
  f_lr[1] = 1.224744871391589*fedge[12]+0.7071067811865475*fedge[1]; 
  f_lr[2] = 1.224744871391589*fedge[13]+0.7071067811865475*fedge[2]; 
  f_lr[3] = 1.224744871391589*fedge[14]+0.7071067811865475*fedge[3]; 
  f_lr[4] = 1.224744871391589*fedge[15]+0.7071067811865475*fedge[4]; 
  f_lr[5] = 1.224744871391589*fedge[20]+0.7071067811865475*fedge[6]; 
  f_lr[6] = 1.224744871391589*fedge[21]+0.7071067811865475*fedge[7]; 
  f_lr[7] = 1.224744871391589*fedge[22]+0.7071067811865475*fedge[8]; 
  f_lr[8] = 1.224744871391589*fedge[23]+0.7071067811865475*fedge[9]; 
  f_lr[9] = 1.224744871391589*fedge[24]+0.7071067811865475*fedge[10]; 
  f_lr[10] = 1.224744871391589*fedge[25]+0.7071067811865475*fedge[11]; 
  f_lr[11] = 1.224744871391589*fedge[27]+0.7071067811865475*fedge[16]; 
  f_lr[12] = 1.224744871391589*fedge[28]+0.7071067811865475*fedge[17]; 
  f_lr[13] = 1.224744871391589*fedge[29]+0.7071067811865475*fedge[18]; 
  f_lr[14] = 1.224744871391589*fedge[30]+0.7071067811865475*fedge[19]; 
  f_lr[15] = 1.224744871391589*fedge[31]+0.7071067811865475*fedge[26]; 

  f_cl[0] = 0.7071067811865475*fskin[0]-1.224744871391589*fskin[5]; 
  f_cl[1] = 0.7071067811865475*fskin[1]-1.224744871391589*fskin[12]; 
  f_cl[2] = 0.7071067811865475*fskin[2]-1.224744871391589*fskin[13]; 
  f_cl[3] = 0.7071067811865475*fskin[3]-1.224744871391589*fskin[14]; 
  f_cl[4] = 0.7071067811865475*fskin[4]-1.224744871391589*fskin[15]; 
  f_cl[5] = 0.7071067811865475*fskin[6]-1.224744871391589*fskin[20]; 
  f_cl[6] = 0.7071067811865475*fskin[7]-1.224744871391589*fskin[21]; 
  f_cl[7] = 0.7071067811865475*fskin[8]-1.224744871391589*fskin[22]; 
  f_cl[8] = 0.7071067811865475*fskin[9]-1.224744871391589*fskin[23]; 
  f_cl[9] = 0.7071067811865475*fskin[10]-1.224744871391589*fskin[24]; 
  f_cl[10] = 0.7071067811865475*fskin[11]-1.224744871391589*fskin[25]; 
  f_cl[11] = 0.7071067811865475*fskin[16]-1.224744871391589*fskin[27]; 
  f_cl[12] = 0.7071067811865475*fskin[17]-1.224744871391589*fskin[28]; 
  f_cl[13] = 0.7071067811865475*fskin[18]-1.224744871391589*fskin[29]; 
  f_cl[14] = 0.7071067811865475*fskin[19]-1.224744871391589*fskin[30]; 
  f_cl[15] = 0.7071067811865475*fskin[26]-1.224744871391589*fskin[31]; 
  ...
  out[4] += 0.7071067811865475*GhatL[4]*rdvz2; 
  out[5] += -1.224744871391589*GhatL[0]*rdvz2; 
  out[6] += 0.7071067811865475*GhatL[5]*rdvz2; 
  out[7] += 0.7071067811865475*GhatL[6]*rdvz2; 
  out[8] += 0.7071067811865475*GhatL[7]*rdvz2; 
  out[9] += 0.7071067811865475*GhatL[8]*rdvz2; 
  out[10] += 0.7071067811865475*GhatL[9]*rdvz2; 
  out[11] += 0.7071067811865475*GhatL[10]*rdvz2; 
  out[12] += -1.224744871391589*GhatL[1]*rdvz2; 
  out[13] += -1.224744871391589*GhatL[2]*rdvz2; 
  out[14] += -1.224744871391589*GhatL[3]*rdvz2; 
  out[15] += -1.224744871391589*GhatL[4]*rdvz2; 
  out[16] += 0.7071067811865475*GhatL[11]*rdvz2; 
  out[17] += 0.7071067811865475*GhatL[12]*rdvz2; 
  out[18] += 0.7071067811865475*GhatL[13]*rdvz2; 
  out[19] += 0.7071067811865475*GhatL[14]*rdvz2; 
  out[20] += -1.224744871391589*GhatL[5]*rdvz2; 
  out[21] += -1.224744871391589*GhatL[6]*rdvz2; 
  out[22] += -1.224744871391589*GhatL[7]*rdvz2; 
  out[23] += -1.224744871391589*GhatL[8]*rdvz2; 
  out[24] += -1.224744871391589*GhatL[9]*rdvz2; 
  out[25] += -1.224744871391589*GhatL[10]*rdvz2; 
  out[26] += 0.7071067811865475*GhatL[15]*rdvz2; 
  out[27] += -1.224744871391589*GhatL[11]*rdvz2; 
  out[28] += -1.224744871391589*GhatL[12]*rdvz2; 
  out[29] += -1.224744871391589*GhatL[13]*rdvz2; 
  out[30] += -1.224744871391589*GhatL[14]*rdvz2; 
  out[31] += -1.224744871391589*GhatL[15]*rdvz2; 
