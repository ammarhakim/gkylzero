...
{ 
  ...
  fUpR[2] = 1.224744871391589*fskin[7]+0.7071067811865475*fskin[5]; 
    } else { 
  ...
  fUpR[2] = 0.7071067811865475*fedge[5]-1.224744871391589*fedge[7]; 
    } 
  } else { 
  double f_cr[3] = {0.};
  double f_rl[3] = {0.};
  ...
  f_cr[2] = 1.224744871391589*fskin[7]+0.7071067811865475*fskin[5]; 
  ...
  f_rl[2] = 0.7071067811865475*fedge[5]-1.224744871391589*fedge[7]; 
  ...
  fUpL[2] = 1.224744871391589*fedge[7]+0.7071067811865475*fedge[5]; 
    } else { 
  ...
  fUpL[2] = 0.7071067811865475*fskin[5]-1.224744871391589*fskin[7]; 
    } 
  } else { 
  double f_lr[3] = {0.};
  double f_cl[3] = {0.};
  ...
  f_lr[2] = 1.224744871391589*fedge[7]+0.7071067811865475*fedge[5]; 
  ...
  f_cl[2] = 0.7071067811865475*fskin[5]-1.224744871391589*fskin[7]; 
