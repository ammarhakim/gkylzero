...
{ 
  ...
  fUpL[2] = 1.224744871391589*fl[6]+0.7071067811865475*fl[2]; 
  fUpL[3] = 1.224744871391589*fl[7]+0.7071067811865475*fl[4]; 
    } else { 
  fUpL[0] = 0.7071067811865475*fc[0]-1.224744871391589*fc[3]; 
  fUpL[1] = 0.7071067811865475*fc[1]-1.224744871391589*fc[5]; 
  fUpL[2] = 0.7071067811865475*fc[2]-1.224744871391589*fc[6]; 
  fUpL[3] = 0.7071067811865475*fc[4]-1.224744871391589*fc[7]; 
    } 
  } else { 
  double f_lr[4] = {0.};
  double f_cl[4] = {0.};
  ...
  f_lr[2] = 1.224744871391589*fl[6]+0.7071067811865475*fl[2]; 
  f_lr[3] = 1.224744871391589*fl[7]+0.7071067811865475*fl[4]; 

  f_cl[0] = 0.7071067811865475*fc[0]-1.224744871391589*fc[3]; 
  f_cl[1] = 0.7071067811865475*fc[1]-1.224744871391589*fc[5]; 
  f_cl[2] = 0.7071067811865475*fc[2]-1.224744871391589*fc[6]; 
  f_cl[3] = 0.7071067811865475*fc[4]-1.224744871391589*fc[7]; 
  ...
  fUpR[2] = 1.224744871391589*fc[6]+0.7071067811865475*fc[2]; 
  fUpR[3] = 1.224744871391589*fc[7]+0.7071067811865475*fc[4]; 
    } else { 
  fUpR[0] = 0.7071067811865475*fr[0]-1.224744871391589*fr[3]; 
  fUpR[1] = 0.7071067811865475*fr[1]-1.224744871391589*fr[5]; 
  fUpR[2] = 0.7071067811865475*fr[2]-1.224744871391589*fr[6]; 
  fUpR[3] = 0.7071067811865475*fr[4]-1.224744871391589*fr[7]; 
    } 
  } else { 
  double f_cr[4] = {0.};
  double f_rl[4] = {0.};
  ...
  f_cr[2] = 1.224744871391589*fc[6]+0.7071067811865475*fc[2]; 
  f_cr[3] = 1.224744871391589*fc[7]+0.7071067811865475*fc[4]; 

  f_rl[0] = 0.7071067811865475*fr[0]-1.224744871391589*fr[3]; 
  f_rl[1] = 0.7071067811865475*fr[1]-1.224744871391589*fr[5]; 
  f_rl[2] = 0.7071067811865475*fr[2]-1.224744871391589*fr[6]; 
  f_rl[3] = 0.7071067811865475*fr[4]-1.224744871391589*fr[7]; 
