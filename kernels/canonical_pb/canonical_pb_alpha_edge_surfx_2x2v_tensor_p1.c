...
{ 
  ...
  if (0.3535533905932734*alphaR[5]-0.3535533905932734*(alphaR[3]+alphaR[1])+0.3535533905932734*alphaR[0] > 0.) 
    sgn_alpha_surfR[0] = 1.0; 
  else  
    sgn_alpha_surfR[0] = -1.0; 
  
  if ((-0.3535533905932734*alphaR[5])+0.3535533905932734*alphaR[3]-0.3535533905932734*alphaR[1]+0.3535533905932734*alphaR[0] > 0.) 
  ...
  if (0.3535533905932734*(alphaR[1]+alphaR[0])-0.3535533905932734*(alphaR[5]+alphaR[3]) > 0.) 
  ...
  if (0.3535533905932734*(alphaR[5]+alphaR[3]+alphaR[1]+alphaR[0]) > 0.) 
