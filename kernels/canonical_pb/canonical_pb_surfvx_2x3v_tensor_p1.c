...
{ 
  ...
  const double *alphaL = &alpha_surf_l[32];
  const double *alphaR = &alpha_surf_r[32];
  const double *sgn_alpha_surfL = &sgn_alpha_surf_l[32];
  const double *sgn_alpha_surfR = &sgn_alpha_surf_r[32];
  ...
  out[2] += (0.7071067811865475*GhatL[2]-0.7071067811865475*GhatR[2])*rdvx2; 
  out[3] += ((-1.224744871391589*GhatR[0])-1.224744871391589*GhatL[0])*rdvx2; 
  out[4] += (0.7071067811865475*GhatL[3]-0.7071067811865475*GhatR[3])*rdvx2; 
  out[5] += (0.7071067811865475*GhatL[4]-0.7071067811865475*GhatR[4])*rdvx2; 
  out[6] += (0.7071067811865475*GhatL[5]-0.7071067811865475*GhatR[5])*rdvx2; 
  out[7] += ((-1.224744871391589*GhatR[1])-1.224744871391589*GhatL[1])*rdvx2; 
  out[8] += ((-1.224744871391589*GhatR[2])-1.224744871391589*GhatL[2])*rdvx2; 
  out[9] += (0.7071067811865475*GhatL[6]-0.7071067811865475*GhatR[6])*rdvx2; 
  out[10] += (0.7071067811865475*GhatL[7]-0.7071067811865475*GhatR[7])*rdvx2; 
  out[11] += ((-1.224744871391589*GhatR[3])-1.224744871391589*GhatL[3])*rdvx2; 
  out[12] += (0.7071067811865475*GhatL[8]-0.7071067811865475*GhatR[8])*rdvx2; 
  out[13] += (0.7071067811865475*GhatL[9]-0.7071067811865475*GhatR[9])*rdvx2; 
  out[14] += ((-1.224744871391589*GhatR[4])-1.224744871391589*GhatL[4])*rdvx2; 
  out[15] += (0.7071067811865475*GhatL[10]-0.7071067811865475*GhatR[10])*rdvx2; 
  out[16] += ((-1.224744871391589*GhatR[5])-1.224744871391589*GhatL[5])*rdvx2; 
  out[17] += (0.7071067811865475*GhatL[11]-0.7071067811865475*GhatR[11])*rdvx2; 
  out[18] += ((-1.224744871391589*GhatR[6])-1.224744871391589*GhatL[6])*rdvx2; 
  out[19] += ((-1.224744871391589*GhatR[7])-1.224744871391589*GhatL[7])*rdvx2; 
  out[20] += (0.7071067811865475*GhatL[12]-0.7071067811865475*GhatR[12])*rdvx2; 
  out[21] += ((-1.224744871391589*GhatR[8])-1.224744871391589*GhatL[8])*rdvx2; 
  out[22] += ((-1.224744871391589*GhatR[9])-1.224744871391589*GhatL[9])*rdvx2; 
  out[23] += (0.7071067811865475*GhatL[13]-0.7071067811865475*GhatR[13])*rdvx2; 
  out[24] += (0.7071067811865475*GhatL[14]-0.7071067811865475*GhatR[14])*rdvx2; 
  out[25] += ((-1.224744871391589*GhatR[10])-1.224744871391589*GhatL[10])*rdvx2; 
  out[26] += ((-1.224744871391589*GhatR[11])-1.224744871391589*GhatL[11])*rdvx2; 
  out[27] += ((-1.224744871391589*GhatR[12])-1.224744871391589*GhatL[12])*rdvx2; 
  out[28] += (0.7071067811865475*GhatL[15]-0.7071067811865475*GhatR[15])*rdvx2; 
  out[29] += ((-1.224744871391589*GhatR[13])-1.224744871391589*GhatL[13])*rdvx2; 
  out[30] += ((-1.224744871391589*GhatR[14])-1.224744871391589*GhatL[14])*rdvx2; 
  out[31] += ((-1.224744871391589*GhatR[15])-1.224744871391589*GhatL[15])*rdvx2; 
