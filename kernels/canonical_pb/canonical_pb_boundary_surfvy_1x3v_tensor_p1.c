...
{ 
  ...
  fUpR[2] = 1.224744871391589*fskin[7]+0.7071067811865475*fskin[2]; 
  fUpR[3] = 1.224744871391589*fskin[10]+0.7071067811865475*fskin[4]; 
  fUpR[4] = 1.224744871391589*fskin[11]+0.7071067811865475*fskin[5]; 
  fUpR[5] = 1.224744871391589*fskin[13]+0.7071067811865475*fskin[8]; 
  fUpR[6] = 1.224744871391589*fskin[14]+0.7071067811865475*fskin[9]; 
  fUpR[7] = 1.224744871391589*fskin[15]+0.7071067811865475*fskin[12]; 
    } else { 
  fUpR[0] = 0.7071067811865475*fedge[0]-1.224744871391589*fedge[3]; 
  fUpR[1] = 0.7071067811865475*fedge[1]-1.224744871391589*fedge[6]; 
  fUpR[2] = 0.7071067811865475*fedge[2]-1.224744871391589*fedge[7]; 
  fUpR[3] = 0.7071067811865475*fedge[4]-1.224744871391589*fedge[10]; 
  fUpR[4] = 0.7071067811865475*fedge[5]-1.224744871391589*fedge[11]; 
  fUpR[5] = 0.7071067811865475*fedge[8]-1.224744871391589*fedge[13]; 
  fUpR[6] = 0.7071067811865475*fedge[9]-1.224744871391589*fedge[14]; 
  fUpR[7] = 0.7071067811865475*fedge[12]-1.224744871391589*fedge[15]; 
    } 
  } else { 
  double f_cr[8] = {0.};
  double f_rl[8] = {0.};
  ...
  f_cr[2] = 1.224744871391589*fskin[7]+0.7071067811865475*fskin[2]; 
  f_cr[3] = 1.224744871391589*fskin[10]+0.7071067811865475*fskin[4]; 
  f_cr[4] = 1.224744871391589*fskin[11]+0.7071067811865475*fskin[5]; 
  f_cr[5] = 1.224744871391589*fskin[13]+0.7071067811865475*fskin[8]; 
  f_cr[6] = 1.224744871391589*fskin[14]+0.7071067811865475*fskin[9]; 
  f_cr[7] = 1.224744871391589*fskin[15]+0.7071067811865475*fskin[12]; 

  f_rl[0] = 0.7071067811865475*fedge[0]-1.224744871391589*fedge[3]; 
  f_rl[1] = 0.7071067811865475*fedge[1]-1.224744871391589*fedge[6]; 
  f_rl[2] = 0.7071067811865475*fedge[2]-1.224744871391589*fedge[7]; 
  f_rl[3] = 0.7071067811865475*fedge[4]-1.224744871391589*fedge[10]; 
  f_rl[4] = 0.7071067811865475*fedge[5]-1.224744871391589*fedge[11]; 
  f_rl[5] = 0.7071067811865475*fedge[8]-1.224744871391589*fedge[13]; 
  f_rl[6] = 0.7071067811865475*fedge[9]-1.224744871391589*fedge[14]; 
  f_rl[7] = 0.7071067811865475*fedge[12]-1.224744871391589*fedge[15]; 
  ...
  out[6] += -1.224744871391589*GhatR[1]*rdvy2; 
  out[7] += -1.224744871391589*GhatR[2]*rdvy2; 
  out[8] += -0.7071067811865475*GhatR[5]*rdvy2; 
  out[9] += -0.7071067811865475*GhatR[6]*rdvy2; 
  out[10] += -1.224744871391589*GhatR[3]*rdvy2; 
  out[11] += -1.224744871391589*GhatR[4]*rdvy2; 
  ...
  fUpL[2] = 1.224744871391589*fedge[7]+0.7071067811865475*fedge[2]; 
  fUpL[3] = 1.224744871391589*fedge[10]+0.7071067811865475*fedge[4]; 
  fUpL[4] = 1.224744871391589*fedge[11]+0.7071067811865475*fedge[5]; 
  fUpL[5] = 1.224744871391589*fedge[13]+0.7071067811865475*fedge[8]; 
  fUpL[6] = 1.224744871391589*fedge[14]+0.7071067811865475*fedge[9]; 
  fUpL[7] = 1.224744871391589*fedge[15]+0.7071067811865475*fedge[12]; 
    } else { 
  fUpL[0] = 0.7071067811865475*fskin[0]-1.224744871391589*fskin[3]; 
  fUpL[1] = 0.7071067811865475*fskin[1]-1.224744871391589*fskin[6]; 
  fUpL[2] = 0.7071067811865475*fskin[2]-1.224744871391589*fskin[7]; 
  fUpL[3] = 0.7071067811865475*fskin[4]-1.224744871391589*fskin[10]; 
  fUpL[4] = 0.7071067811865475*fskin[5]-1.224744871391589*fskin[11]; 
  fUpL[5] = 0.7071067811865475*fskin[8]-1.224744871391589*fskin[13]; 
  fUpL[6] = 0.7071067811865475*fskin[9]-1.224744871391589*fskin[14]; 
  fUpL[7] = 0.7071067811865475*fskin[12]-1.224744871391589*fskin[15]; 
    } 
  } else { 
  double f_lr[8] = {0.};
  double f_cl[8] = {0.};
  ...
  f_lr[2] = 1.224744871391589*fedge[7]+0.7071067811865475*fedge[2]; 
  f_lr[3] = 1.224744871391589*fedge[10]+0.7071067811865475*fedge[4]; 
  f_lr[4] = 1.224744871391589*fedge[11]+0.7071067811865475*fedge[5]; 
  f_lr[5] = 1.224744871391589*fedge[13]+0.7071067811865475*fedge[8]; 
  f_lr[6] = 1.224744871391589*fedge[14]+0.7071067811865475*fedge[9]; 
  f_lr[7] = 1.224744871391589*fedge[15]+0.7071067811865475*fedge[12]; 

  f_cl[0] = 0.7071067811865475*fskin[0]-1.224744871391589*fskin[3]; 
  f_cl[1] = 0.7071067811865475*fskin[1]-1.224744871391589*fskin[6]; 
  f_cl[2] = 0.7071067811865475*fskin[2]-1.224744871391589*fskin[7]; 
  f_cl[3] = 0.7071067811865475*fskin[4]-1.224744871391589*fskin[10]; 
  f_cl[4] = 0.7071067811865475*fskin[5]-1.224744871391589*fskin[11]; 
  f_cl[5] = 0.7071067811865475*fskin[8]-1.224744871391589*fskin[13]; 
  f_cl[6] = 0.7071067811865475*fskin[9]-1.224744871391589*fskin[14]; 
  f_cl[7] = 0.7071067811865475*fskin[12]-1.224744871391589*fskin[15]; 
  ...
  out[6] += -1.224744871391589*GhatL[1]*rdvy2; 
  out[7] += -1.224744871391589*GhatL[2]*rdvy2; 
  out[8] += 0.7071067811865475*GhatL[5]*rdvy2; 
  out[9] += 0.7071067811865475*GhatL[6]*rdvy2; 
  out[10] += -1.224744871391589*GhatL[3]*rdvy2; 
  out[11] += -1.224744871391589*GhatL[4]*rdvy2; 
