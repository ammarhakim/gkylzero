...
GKYL_CU_DH void canonical_pb_vars_pressure_1x_tensor_p2(const double *h_ij_inv, const double *MEnergy, const double *v_j, const double *nv_i, double* GKYL_RESTRICT d_Jv_P) 
{ 
