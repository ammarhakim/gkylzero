...
{ 
  ...
  fUpR[5] = 1.224744871391589*fskin[13]+0.7071067811865475*fskin[12]; 
  fUpR[6] = 1.224744871391589*fskin[11]+0.7071067811865475*fskin[10]; 
  ...
  fUpR[5] = 0.7071067811865475*fedge[12]-1.224744871391589*fedge[13]; 
  fUpR[6] = 0.7071067811865475*fedge[10]-1.224744871391589*fedge[11]; 
  ...
  f_cr[5] = 1.224744871391589*fskin[13]+0.7071067811865475*fskin[12]; 
  f_cr[6] = 1.224744871391589*fskin[11]+0.7071067811865475*fskin[10]; 
  ...
  f_rl[5] = 0.7071067811865475*fedge[12]-1.224744871391589*fedge[13]; 
  f_rl[6] = 0.7071067811865475*fedge[10]-1.224744871391589*fedge[11]; 
  ...
  out[11] += -1.224744871391589*GhatR[6]*rdx2; 
  out[12] += -0.7071067811865475*GhatR[5]*rdx2; 
  out[13] += -1.224744871391589*GhatR[5]*rdx2; 
  ...
  fUpL[5] = 1.224744871391589*fedge[13]+0.7071067811865475*fedge[12]; 
  fUpL[6] = 1.224744871391589*fedge[11]+0.7071067811865475*fedge[10]; 
  ...
  fUpL[5] = 0.7071067811865475*fskin[12]-1.224744871391589*fskin[13]; 
  fUpL[6] = 0.7071067811865475*fskin[10]-1.224744871391589*fskin[11]; 
  ...
  f_lr[5] = 1.224744871391589*fedge[13]+0.7071067811865475*fedge[12]; 
  f_lr[6] = 1.224744871391589*fedge[11]+0.7071067811865475*fedge[10]; 
  ...
  f_cl[5] = 0.7071067811865475*fskin[12]-1.224744871391589*fskin[13]; 
  f_cl[6] = 0.7071067811865475*fskin[10]-1.224744871391589*fskin[11]; 
  ...
  out[11] += -1.224744871391589*GhatL[6]*rdx2; 
  out[12] += 0.7071067811865475*GhatL[5]*rdx2; 
  out[13] += -1.224744871391589*GhatL[5]*rdx2; 
