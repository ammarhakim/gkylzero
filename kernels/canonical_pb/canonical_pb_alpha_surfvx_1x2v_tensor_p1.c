...
{ 
  ...
  double *alphaL = &alpha_surf[4];
  double *sgn_alpha_surfL = &sgn_alpha_surf[4];
  alphaL[0] = 2.121320343559642*hamil[4]*rdx2-1.224744871391589*hamil[1]*rdx2; 
  alphaL[2] = 2.121320343559642*hamil[7]*rdx2-1.224744871391589*hamil[5]*rdx2; 
