...
{ 
  ...
  fUpR[0] = 1.58113883008419*fskin[4]+1.224744871391589*fskin[1]+0.7071067811865475*fskin[0]; 
  fUpR[1] = 1.58113883008419*fskin[6]+1.224744871391589*fskin[3]+0.7071067811865475*fskin[2]; 
  fUpR[2] = 1.58113883008419*fskin[8]+1.224744871391589*fskin[7]+0.7071067811865475*fskin[5]; 
    } else { 
  fUpR[0] = 1.58113883008419*fedge[4]-1.224744871391589*fedge[1]+0.7071067811865475*fedge[0]; 
  fUpR[1] = 1.58113883008419*fedge[6]-1.224744871391589*fedge[3]+0.7071067811865475*fedge[2]; 
  fUpR[2] = 1.58113883008419*fedge[8]-1.224744871391589*fedge[7]+0.7071067811865475*fedge[5]; 
    } 
  } else { 
  double f_cr[3] = {0.};
  double f_rl[3] = {0.};
  ...
  f_cr[0] = 1.58113883008419*fskin[4]+1.224744871391589*fskin[1]+0.7071067811865475*fskin[0]; 
  f_cr[1] = 1.58113883008419*fskin[6]+1.224744871391589*fskin[3]+0.7071067811865475*fskin[2]; 
  f_cr[2] = 1.58113883008419*fskin[8]+1.224744871391589*fskin[7]+0.7071067811865475*fskin[5]; 

  f_rl[0] = 1.58113883008419*fedge[4]-1.224744871391589*fedge[1]+0.7071067811865475*fedge[0]; 
  f_rl[1] = 1.58113883008419*fedge[6]-1.224744871391589*fedge[3]+0.7071067811865475*fedge[2]; 
  f_rl[2] = 1.58113883008419*fedge[8]-1.224744871391589*fedge[7]+0.7071067811865475*fedge[5]; 
  ...
  out[8] += -1.58113883008419*GhatR[2]*rdx2; 
  ...
  fUpL[0] = 1.58113883008419*fedge[4]+1.224744871391589*fedge[1]+0.7071067811865475*fedge[0]; 
  fUpL[1] = 1.58113883008419*fedge[6]+1.224744871391589*fedge[3]+0.7071067811865475*fedge[2]; 
  fUpL[2] = 1.58113883008419*fedge[8]+1.224744871391589*fedge[7]+0.7071067811865475*fedge[5]; 
    } else { 
  fUpL[0] = 1.58113883008419*fskin[4]-1.224744871391589*fskin[1]+0.7071067811865475*fskin[0]; 
  fUpL[1] = 1.58113883008419*fskin[6]-1.224744871391589*fskin[3]+0.7071067811865475*fskin[2]; 
  fUpL[2] = 1.58113883008419*fskin[8]-1.224744871391589*fskin[7]+0.7071067811865475*fskin[5]; 
    } 
  } else { 
  double f_lr[3] = {0.};
  double f_cl[3] = {0.};
  ...
  f_lr[0] = 1.58113883008419*fedge[4]+1.224744871391589*fedge[1]+0.7071067811865475*fedge[0]; 
  f_lr[1] = 1.58113883008419*fedge[6]+1.224744871391589*fedge[3]+0.7071067811865475*fedge[2]; 
  f_lr[2] = 1.58113883008419*fedge[8]+1.224744871391589*fedge[7]+0.7071067811865475*fedge[5]; 

  f_cl[0] = 1.58113883008419*fskin[4]-1.224744871391589*fskin[1]+0.7071067811865475*fskin[0]; 
  f_cl[1] = 1.58113883008419*fskin[6]-1.224744871391589*fskin[3]+0.7071067811865475*fskin[2]; 
  f_cl[2] = 1.58113883008419*fskin[8]-1.224744871391589*fskin[7]+0.7071067811865475*fskin[5]; 
  ...
  out[8] += 1.58113883008419*GhatL[2]*rdx2; 

  } 

  double cflFreq = fmax(fabs(alphaL[0]), fabs(alphaR[0])); 
  return 1.767766952966369*rdx2*cflFreq; 
