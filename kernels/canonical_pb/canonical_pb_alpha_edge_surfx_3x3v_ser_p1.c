...
{ 
  ...
  alphaR[0] = 2.121320343559642*hamil[10]*rdvx2*rdx2+1.224744871391589*hamil[4]*rdvx2*rdx2; 
  alphaR[1] = 2.121320343559642*hamil[23]*rdvx2*rdx2+1.224744871391589*hamil[11]*rdvx2*rdx2; 
  alphaR[2] = 2.121320343559642*hamil[24]*rdvx2*rdx2+1.224744871391589*hamil[12]*rdvx2*rdx2; 
  alphaR[3] = 4.743416490252569*hamil[65]*rdvx2*rdx2+2.738612787525831*hamil[64]*rdvx2*rdx2; 
  alphaR[4] = 2.121320343559642*hamil[29]*rdvx2*rdx2+1.224744871391589*hamil[16]*rdvx2*rdx2; 
  alphaR[5] = 2.121320343559642*hamil[35]*rdvx2*rdx2+1.224744871391589*hamil[20]*rdvx2*rdx2; 
  alphaR[6] = 2.121320343559642*hamil[42]*rdvx2*rdx2+1.224744871391589*hamil[25]*rdvx2*rdx2; 
  alphaR[7] = 4.743416490252569*hamil[70]*rdvx2*rdx2+2.738612787525831*hamil[66]*rdvx2*rdx2; 
  alphaR[8] = 4.743416490252569*hamil[71]*rdvx2*rdx2+2.738612787525831*hamil[67]*rdvx2*rdx2; 
  alphaR[9] = 2.121320343559642*hamil[44]*rdvx2*rdx2+1.224744871391589*hamil[30]*rdvx2*rdx2; 
  alphaR[10] = 2.121320343559642*hamil[45]*rdvx2*rdx2+1.224744871391589*hamil[31]*rdvx2*rdx2; 
  alphaR[11] = 4.743416490252569*hamil[73]*rdvx2*rdx2+2.738612787525831*hamil[68]*rdvx2*rdx2; 
  alphaR[12] = 2.121320343559642*hamil[48]*rdvx2*rdx2+1.224744871391589*hamil[36]*rdvx2*rdx2; 
  alphaR[13] = 2.121320343559642*hamil[49]*rdvx2*rdx2+1.224744871391589*hamil[37]*rdvx2*rdx2; 
  alphaR[14] = 4.743416490252569*hamil[76]*rdvx2*rdx2+2.738612787525831*hamil[69]*rdvx2*rdx2; 
  alphaR[15] = 2.121320343559642*hamil[54]*rdvx2*rdx2+1.224744871391589*hamil[41]*rdvx2*rdx2; 
  alphaR[16] = 4.743416490252569*hamil[80]*rdvx2*rdx2+2.738612787525831*hamil[72]*rdvx2*rdx2; 
  alphaR[17] = 2.121320343559642*hamil[57]*rdvx2*rdx2+1.224744871391589*hamil[46]*rdvx2*rdx2; 
  alphaR[18] = 4.743416490252569*hamil[81]*rdvx2*rdx2+2.738612787525831*hamil[74]*rdvx2*rdx2; 
  alphaR[19] = 4.743416490252569*hamil[82]*rdvx2*rdx2+2.738612787525831*hamil[75]*rdvx2*rdx2; 
  alphaR[20] = 2.121320343559642*hamil[58]*rdvx2*rdx2+1.224744871391589*hamil[50]*rdvx2*rdx2; 
  alphaR[21] = 4.743416490252569*hamil[84]*rdvx2*rdx2+2.738612787525831*hamil[77]*rdvx2*rdx2; 
  alphaR[22] = 4.743416490252569*hamil[85]*rdvx2*rdx2+2.738612787525831*hamil[78]*rdvx2*rdx2; 
  alphaR[23] = 2.121320343559642*hamil[60]*rdvx2*rdx2+1.224744871391589*hamil[55]*rdvx2*rdx2; 
  alphaR[24] = 2.121320343559642*hamil[61]*rdvx2*rdx2+1.224744871391589*hamil[56]*rdvx2*rdx2; 
  alphaR[25] = 4.743416490252569*hamil[87]*rdvx2*rdx2+2.738612787525831*hamil[79]*rdvx2*rdx2; 
  alphaR[26] = 4.743416490252569*hamil[90]*rdvx2*rdx2+2.738612787525831*hamil[83]*rdvx2*rdx2; 
  alphaR[27] = 4.743416490252569*hamil[91]*rdvx2*rdx2+2.738612787525831*hamil[86]*rdvx2*rdx2; 
  alphaR[28] = 2.121320343559642*hamil[63]*rdvx2*rdx2+1.224744871391589*hamil[62]*rdvx2*rdx2; 
  alphaR[29] = 4.743416490252569*hamil[92]*rdvx2*rdx2+2.738612787525831*hamil[88]*rdvx2*rdx2; 
  alphaR[30] = 4.743416490252569*hamil[93]*rdvx2*rdx2+2.738612787525831*hamil[89]*rdvx2*rdx2; 
  alphaR[31] = 4.743416490252569*hamil[95]*rdvx2*rdx2+2.738612787525831*hamil[94]*rdvx2*rdx2; 
