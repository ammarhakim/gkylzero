...
{ 
  ...
  fUpL[0] = 1.58113883008419*fl[7]+1.224744871391589*fl[1]+0.7071067811865475*fl[0]; 
  fUpL[1] = 1.58113883008419*fl[11]+1.224744871391589*fl[4]+0.7071067811865475*fl[2]; 
  fUpL[2] = 1.58113883008419*fl[13]+1.224744871391589*fl[5]+0.7071067811865475*fl[3]; 
  fUpL[3] = 1.58113883008419*fl[17]+1.224744871391589*fl[10]+0.7071067811865475*fl[6]; 
  fUpL[4] = 1.224744871391589*fl[12]+0.7071067811865475*fl[8]; 
  fUpL[5] = 1.224744871391589*fl[15]+0.7071067811865475*fl[9]; 
  fUpL[6] = 1.224744871391589*fl[18]+0.7071067811865475*fl[14]; 
  fUpL[7] = 1.224744871391589*fl[19]+0.7071067811865475*fl[16]; 
    } else { 
  fUpL[0] = 1.58113883008419*fc[7]-1.224744871391589*fc[1]+0.7071067811865475*fc[0]; 
  fUpL[1] = 1.58113883008419*fc[11]-1.224744871391589*fc[4]+0.7071067811865475*fc[2]; 
  fUpL[2] = 1.58113883008419*fc[13]-1.224744871391589*fc[5]+0.7071067811865475*fc[3]; 
  fUpL[3] = 1.58113883008419*fc[17]-1.224744871391589*fc[10]+0.7071067811865475*fc[6]; 
  fUpL[4] = 0.7071067811865475*fc[8]-1.224744871391589*fc[12]; 
  fUpL[5] = 0.7071067811865475*fc[9]-1.224744871391589*fc[15]; 
  fUpL[6] = 0.7071067811865475*fc[14]-1.224744871391589*fc[18]; 
  fUpL[7] = 0.7071067811865475*fc[16]-1.224744871391589*fc[19]; 
    } 
  } else { 
  double f_lr[8] = {0.};
  double f_cl[8] = {0.};
  ...
  f_lr[0] = 1.58113883008419*fl[7]+1.224744871391589*fl[1]+0.7071067811865475*fl[0]; 
  f_lr[1] = 1.58113883008419*fl[11]+1.224744871391589*fl[4]+0.7071067811865475*fl[2]; 
  f_lr[2] = 1.58113883008419*fl[13]+1.224744871391589*fl[5]+0.7071067811865475*fl[3]; 
  f_lr[3] = 1.58113883008419*fl[17]+1.224744871391589*fl[10]+0.7071067811865475*fl[6]; 
  f_lr[4] = 1.224744871391589*fl[12]+0.7071067811865475*fl[8]; 
  f_lr[5] = 1.224744871391589*fl[15]+0.7071067811865475*fl[9]; 
  f_lr[6] = 1.224744871391589*fl[18]+0.7071067811865475*fl[14]; 
  f_lr[7] = 1.224744871391589*fl[19]+0.7071067811865475*fl[16]; 

  f_cl[0] = 1.58113883008419*fc[7]-1.224744871391589*fc[1]+0.7071067811865475*fc[0]; 
  f_cl[1] = 1.58113883008419*fc[11]-1.224744871391589*fc[4]+0.7071067811865475*fc[2]; 
  f_cl[2] = 1.58113883008419*fc[13]-1.224744871391589*fc[5]+0.7071067811865475*fc[3]; 
  f_cl[3] = 1.58113883008419*fc[17]-1.224744871391589*fc[10]+0.7071067811865475*fc[6]; 
  f_cl[4] = 0.7071067811865475*fc[8]-1.224744871391589*fc[12]; 
  f_cl[5] = 0.7071067811865475*fc[9]-1.224744871391589*fc[15]; 
  f_cl[6] = 0.7071067811865475*fc[14]-1.224744871391589*fc[18]; 
  f_cl[7] = 0.7071067811865475*fc[16]-1.224744871391589*fc[19]; 
  ...
  fUpR[0] = 1.58113883008419*fc[7]+1.224744871391589*fc[1]+0.7071067811865475*fc[0]; 
  fUpR[1] = 1.58113883008419*fc[11]+1.224744871391589*fc[4]+0.7071067811865475*fc[2]; 
  fUpR[2] = 1.58113883008419*fc[13]+1.224744871391589*fc[5]+0.7071067811865475*fc[3]; 
  fUpR[3] = 1.58113883008419*fc[17]+1.224744871391589*fc[10]+0.7071067811865475*fc[6]; 
  fUpR[4] = 1.224744871391589*fc[12]+0.7071067811865475*fc[8]; 
  fUpR[5] = 1.224744871391589*fc[15]+0.7071067811865475*fc[9]; 
  fUpR[6] = 1.224744871391589*fc[18]+0.7071067811865475*fc[14]; 
  fUpR[7] = 1.224744871391589*fc[19]+0.7071067811865475*fc[16]; 
    } else { 
  fUpR[0] = 1.58113883008419*fr[7]-1.224744871391589*fr[1]+0.7071067811865475*fr[0]; 
  fUpR[1] = 1.58113883008419*fr[11]-1.224744871391589*fr[4]+0.7071067811865475*fr[2]; 
  fUpR[2] = 1.58113883008419*fr[13]-1.224744871391589*fr[5]+0.7071067811865475*fr[3]; 
  fUpR[3] = 1.58113883008419*fr[17]-1.224744871391589*fr[10]+0.7071067811865475*fr[6]; 
  fUpR[4] = 0.7071067811865475*fr[8]-1.224744871391589*fr[12]; 
  fUpR[5] = 0.7071067811865475*fr[9]-1.224744871391589*fr[15]; 
  fUpR[6] = 0.7071067811865475*fr[14]-1.224744871391589*fr[18]; 
  fUpR[7] = 0.7071067811865475*fr[16]-1.224744871391589*fr[19]; 
    } 
  } else { 
  double f_cr[8] = {0.};
  double f_rl[8] = {0.};
  ...
  f_cr[0] = 1.58113883008419*fc[7]+1.224744871391589*fc[1]+0.7071067811865475*fc[0]; 
  f_cr[1] = 1.58113883008419*fc[11]+1.224744871391589*fc[4]+0.7071067811865475*fc[2]; 
  f_cr[2] = 1.58113883008419*fc[13]+1.224744871391589*fc[5]+0.7071067811865475*fc[3]; 
  f_cr[3] = 1.58113883008419*fc[17]+1.224744871391589*fc[10]+0.7071067811865475*fc[6]; 
  f_cr[4] = 1.224744871391589*fc[12]+0.7071067811865475*fc[8]; 
  f_cr[5] = 1.224744871391589*fc[15]+0.7071067811865475*fc[9]; 
  f_cr[6] = 1.224744871391589*fc[18]+0.7071067811865475*fc[14]; 
  f_cr[7] = 1.224744871391589*fc[19]+0.7071067811865475*fc[16]; 

  f_rl[0] = 1.58113883008419*fr[7]-1.224744871391589*fr[1]+0.7071067811865475*fr[0]; 
  f_rl[1] = 1.58113883008419*fr[11]-1.224744871391589*fr[4]+0.7071067811865475*fr[2]; 
  f_rl[2] = 1.58113883008419*fr[13]-1.224744871391589*fr[5]+0.7071067811865475*fr[3]; 
  f_rl[3] = 1.58113883008419*fr[17]-1.224744871391589*fr[10]+0.7071067811865475*fr[6]; 
  f_rl[4] = 0.7071067811865475*fr[8]-1.224744871391589*fr[12]; 
  f_rl[5] = 0.7071067811865475*fr[9]-1.224744871391589*fr[15]; 
  f_rl[6] = 0.7071067811865475*fr[14]-1.224744871391589*fr[18]; 
  f_rl[7] = 0.7071067811865475*fr[16]-1.224744871391589*fr[19]; 
