...
{ 
  ...
  alpha[2] = 0.5773502691896258*By[0]*dv1; 
  alpha[3] = -(0.5773502691896258*Bx[0]*dv2); 
  alpha[4] = 0.5773502691896258*By[1]*dv1; 
  alpha[5] = -(0.5773502691896258*Bx[1]*dv2); 
  ...
  Ghat_l[2] = 0.31622776601683794*alpha[4]*fUpwind_l[9]+0.3162277660168379*alpha[2]*fUpwind_l[8]+0.3535533905932737*alpha[5]*fUpwind_l[7]+0.3535533905932737*alpha[3]*fUpwind_l[6]+0.3535533905932737*alpha[1]*fUpwind_l[4]+0.3535533905932737*fUpwind_l[1]*alpha[4]+0.3535533905932737*alpha[0]*fUpwind_l[2]+0.3535533905932737*fUpwind_l[0]*alpha[2]; 
  Ghat_l[3] = 0.31622776601683794*alpha[5]*fUpwind_l[13]+0.3162277660168379*alpha[3]*fUpwind_l[12]+0.3535533905932737*alpha[4]*fUpwind_l[7]+0.3535533905932737*alpha[2]*fUpwind_l[6]+0.3535533905932737*alpha[1]*fUpwind_l[5]+0.3535533905932737*fUpwind_l[1]*alpha[5]+0.3535533905932737*alpha[0]*fUpwind_l[3]+0.3535533905932737*fUpwind_l[0]*alpha[3]; 
  Ghat_l[4] = 0.31622776601683794*alpha[2]*fUpwind_l[9]+0.3162277660168379*alpha[4]*fUpwind_l[8]+0.3535533905932737*alpha[3]*fUpwind_l[7]+0.3535533905932737*alpha[5]*fUpwind_l[6]+0.3535533905932737*alpha[0]*fUpwind_l[4]+0.3535533905932737*fUpwind_l[0]*alpha[4]+0.3535533905932737*alpha[1]*fUpwind_l[2]+0.3535533905932737*fUpwind_l[1]*alpha[2]; 
  Ghat_l[5] = 0.31622776601683794*alpha[3]*fUpwind_l[13]+0.3162277660168379*alpha[5]*fUpwind_l[12]+0.3535533905932737*alpha[2]*fUpwind_l[7]+0.3535533905932737*alpha[4]*fUpwind_l[6]+0.3535533905932737*alpha[0]*fUpwind_l[5]+0.3535533905932737*fUpwind_l[0]*alpha[5]+0.3535533905932737*alpha[1]*fUpwind_l[3]+0.3535533905932737*fUpwind_l[1]*alpha[3]; 
  Ghat_l[6] = 0.3162277660168379*alpha[5]*fUpwind_l[15]+0.31622776601683794*alpha[3]*fUpwind_l[14]+0.3162277660168379*alpha[4]*fUpwind_l[11]+0.31622776601683794*alpha[2]*fUpwind_l[10]+0.3535533905932737*alpha[1]*fUpwind_l[7]+0.3535533905932737*alpha[0]*fUpwind_l[6]+0.3535533905932737*alpha[4]*fUpwind_l[5]+0.3535533905932737*fUpwind_l[4]*alpha[5]+0.3535533905932737*alpha[2]*fUpwind_l[3]+0.3535533905932737*fUpwind_l[2]*alpha[3]; 
  Ghat_l[7] = 0.3162277660168379*alpha[3]*fUpwind_l[15]+0.31622776601683794*alpha[5]*fUpwind_l[14]+0.3162277660168379*alpha[2]*fUpwind_l[11]+0.31622776601683794*alpha[4]*fUpwind_l[10]+0.3535533905932737*alpha[0]*fUpwind_l[7]+0.3535533905932737*alpha[1]*fUpwind_l[6]+0.3535533905932737*alpha[2]*fUpwind_l[5]+0.3535533905932737*fUpwind_l[2]*alpha[5]+0.3535533905932737*alpha[3]*fUpwind_l[4]+0.3535533905932737*fUpwind_l[3]*alpha[4]; 
  ...
  Ghat_l[9] = 0.3535533905932737*alpha[3]*fUpwind_l[11]+0.3535533905932737*alpha[5]*fUpwind_l[10]+0.3535533905932737*alpha[0]*fUpwind_l[9]+0.3535533905932737*alpha[1]*fUpwind_l[8]+0.31622776601683794*alpha[2]*fUpwind_l[4]+0.31622776601683794*fUpwind_l[2]*alpha[4]; 
  Ghat_l[10] = 0.3535533905932737*alpha[1]*fUpwind_l[11]+0.3535533905932737*alpha[0]*fUpwind_l[10]+0.3535533905932737*alpha[5]*fUpwind_l[9]+0.3535533905932737*alpha[3]*fUpwind_l[8]+0.31622776601683794*alpha[4]*fUpwind_l[7]+0.31622776601683794*alpha[2]*fUpwind_l[6]; 
  ...
  Ghat_l[13] = 0.3535533905932737*alpha[2]*fUpwind_l[15]+0.3535533905932737*alpha[4]*fUpwind_l[14]+0.3535533905932737*alpha[0]*fUpwind_l[13]+0.3535533905932737*alpha[1]*fUpwind_l[12]+0.31622776601683794*alpha[3]*fUpwind_l[5]+0.31622776601683794*fUpwind_l[3]*alpha[5]; 
  Ghat_l[14] = 0.3535533905932737*alpha[1]*fUpwind_l[15]+0.3535533905932737*alpha[0]*fUpwind_l[14]+0.3535533905932737*alpha[4]*fUpwind_l[13]+0.3535533905932737*alpha[2]*fUpwind_l[12]+0.31622776601683794*alpha[5]*fUpwind_l[7]+0.31622776601683794*alpha[3]*fUpwind_l[6]; 
  ...
  Ghat_r[2] = 0.31622776601683794*alpha[4]*fUpwind_r[9]+0.3162277660168379*alpha[2]*fUpwind_r[8]+0.3535533905932737*alpha[5]*fUpwind_r[7]+0.3535533905932737*alpha[3]*fUpwind_r[6]+0.3535533905932737*alpha[1]*fUpwind_r[4]+0.3535533905932737*fUpwind_r[1]*alpha[4]+0.3535533905932737*alpha[0]*fUpwind_r[2]+0.3535533905932737*fUpwind_r[0]*alpha[2]; 
  Ghat_r[3] = 0.31622776601683794*alpha[5]*fUpwind_r[13]+0.3162277660168379*alpha[3]*fUpwind_r[12]+0.3535533905932737*alpha[4]*fUpwind_r[7]+0.3535533905932737*alpha[2]*fUpwind_r[6]+0.3535533905932737*alpha[1]*fUpwind_r[5]+0.3535533905932737*fUpwind_r[1]*alpha[5]+0.3535533905932737*alpha[0]*fUpwind_r[3]+0.3535533905932737*fUpwind_r[0]*alpha[3]; 
  Ghat_r[4] = 0.31622776601683794*alpha[2]*fUpwind_r[9]+0.3162277660168379*alpha[4]*fUpwind_r[8]+0.3535533905932737*alpha[3]*fUpwind_r[7]+0.3535533905932737*alpha[5]*fUpwind_r[6]+0.3535533905932737*alpha[0]*fUpwind_r[4]+0.3535533905932737*fUpwind_r[0]*alpha[4]+0.3535533905932737*alpha[1]*fUpwind_r[2]+0.3535533905932737*fUpwind_r[1]*alpha[2]; 
  Ghat_r[5] = 0.31622776601683794*alpha[3]*fUpwind_r[13]+0.3162277660168379*alpha[5]*fUpwind_r[12]+0.3535533905932737*alpha[2]*fUpwind_r[7]+0.3535533905932737*alpha[4]*fUpwind_r[6]+0.3535533905932737*alpha[0]*fUpwind_r[5]+0.3535533905932737*fUpwind_r[0]*alpha[5]+0.3535533905932737*alpha[1]*fUpwind_r[3]+0.3535533905932737*fUpwind_r[1]*alpha[3]; 
  Ghat_r[6] = 0.3162277660168379*alpha[5]*fUpwind_r[15]+0.31622776601683794*alpha[3]*fUpwind_r[14]+0.3162277660168379*alpha[4]*fUpwind_r[11]+0.31622776601683794*alpha[2]*fUpwind_r[10]+0.3535533905932737*alpha[1]*fUpwind_r[7]+0.3535533905932737*alpha[0]*fUpwind_r[6]+0.3535533905932737*alpha[4]*fUpwind_r[5]+0.3535533905932737*fUpwind_r[4]*alpha[5]+0.3535533905932737*alpha[2]*fUpwind_r[3]+0.3535533905932737*fUpwind_r[2]*alpha[3]; 
  Ghat_r[7] = 0.3162277660168379*alpha[3]*fUpwind_r[15]+0.31622776601683794*alpha[5]*fUpwind_r[14]+0.3162277660168379*alpha[2]*fUpwind_r[11]+0.31622776601683794*alpha[4]*fUpwind_r[10]+0.3535533905932737*alpha[0]*fUpwind_r[7]+0.3535533905932737*alpha[1]*fUpwind_r[6]+0.3535533905932737*alpha[2]*fUpwind_r[5]+0.3535533905932737*fUpwind_r[2]*alpha[5]+0.3535533905932737*alpha[3]*fUpwind_r[4]+0.3535533905932737*fUpwind_r[3]*alpha[4]; 
  ...
  Ghat_r[9] = 0.3535533905932737*alpha[3]*fUpwind_r[11]+0.3535533905932737*alpha[5]*fUpwind_r[10]+0.3535533905932737*alpha[0]*fUpwind_r[9]+0.3535533905932737*alpha[1]*fUpwind_r[8]+0.31622776601683794*alpha[2]*fUpwind_r[4]+0.31622776601683794*fUpwind_r[2]*alpha[4]; 
  Ghat_r[10] = 0.3535533905932737*alpha[1]*fUpwind_r[11]+0.3535533905932737*alpha[0]*fUpwind_r[10]+0.3535533905932737*alpha[5]*fUpwind_r[9]+0.3535533905932737*alpha[3]*fUpwind_r[8]+0.31622776601683794*alpha[4]*fUpwind_r[7]+0.31622776601683794*alpha[2]*fUpwind_r[6]; 
  ...
  Ghat_r[13] = 0.3535533905932737*alpha[2]*fUpwind_r[15]+0.3535533905932737*alpha[4]*fUpwind_r[14]+0.3535533905932737*alpha[0]*fUpwind_r[13]+0.3535533905932737*alpha[1]*fUpwind_r[12]+0.31622776601683794*alpha[3]*fUpwind_r[5]+0.31622776601683794*fUpwind_r[3]*alpha[5]; 
  Ghat_r[14] = 0.3535533905932737*alpha[1]*fUpwind_r[15]+0.3535533905932737*alpha[0]*fUpwind_r[14]+0.3535533905932737*alpha[4]*fUpwind_r[13]+0.3535533905932737*alpha[2]*fUpwind_r[12]+0.31622776601683794*alpha[5]*fUpwind_r[7]+0.31622776601683794*alpha[3]*fUpwind_r[6]; 
  ...
  out[32] += (1.5811388300841895*Ghat_l[0]-1.5811388300841895*Ghat_r[0])*dv12; 
  out[33] += (1.5811388300841898*Ghat_l[1]-1.5811388300841898*Ghat_r[1])*dv12; 
  out[34] += (1.5811388300841898*Ghat_l[2]-1.5811388300841898*Ghat_r[2])*dv12; 
  out[35] += (1.5811388300841898*Ghat_l[3]-1.5811388300841898*Ghat_r[3])*dv12; 
  out[36] += (1.5811388300841895*Ghat_l[4]-1.5811388300841895*Ghat_r[4])*dv12; 
  out[37] += (1.5811388300841895*Ghat_l[5]-1.5811388300841895*Ghat_r[5])*dv12; 
  out[38] += (1.5811388300841895*Ghat_l[6]-1.5811388300841895*Ghat_r[6])*dv12; 
  out[39] += (1.5811388300841898*Ghat_l[7]-1.5811388300841898*Ghat_r[7])*dv12; 
