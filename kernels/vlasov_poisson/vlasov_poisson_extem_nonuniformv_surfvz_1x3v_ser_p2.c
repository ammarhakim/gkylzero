...
GKYL_CU_DH double vlasov_poisson_extem_nonuniformv_surfvz_1x3v_ser_p2(const double *w, const double *dxv, const double *vcoord, const double *field, const double *fl, const double *fc, const double *fr, double* GKYL_RESTRICT out) 
{ 
  ...
  alpha[0] = -1.224744871391589*vcoord[0]*A2[1]*rdx2; 
  alpha[1] = -2.738612787525831*vcoord[0]*A2[2]*rdx2; 
  alpha[2] = -1.224744871391589*A2[1]*vcoord[1]*rdx2; 
  alpha[4] = -2.738612787525831*vcoord[1]*A2[2]*rdx2; 
  alpha[8] = -1.224744871391589*A2[1]*vcoord[7]*rdx2; 
  alpha[12] = -2.738612787525831*A2[2]*vcoord[7]*rdx2; 
