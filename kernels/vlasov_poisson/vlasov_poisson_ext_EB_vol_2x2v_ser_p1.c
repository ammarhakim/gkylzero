...
{ 
  ...
  alpha_vdim[2] = dv10*(2.0*Bz[2]*wv2-3.4641016151377544*phi[3]*dx10+2.0*Ex[2]); 
  alpha_vdim[4] = 0.5773502691896258*Bz[0]*dv10*dv2; 
  alpha_vdim[5] = 2.0*dv10*(Bz[3]*wv2+Ex[3]); 
  alpha_vdim[8] = 0.5773502691896258*Bz[1]*dv10*dv2; 
  alpha_vdim[9] = 0.5773502691896258*Bz[2]*dv10*dv2; 
  alpha_vdim[12] = 0.5773502691896258*Bz[3]*dv10*dv2; 
  cflFreq_mid += 5.0*fabs(0.125*alpha_vdim[0]); 

  alpha_vdim[32] = dv11*(-(2.0*Bz[0]*wv1)-3.4641016151377544*phi[2]*dx11+2.0*Ey[0]); 
  alpha_vdim[33] = dv11*(-(2.0*Bz[1]*wv1)-3.4641016151377544*phi[3]*dx11+2.0*Ey[1]); 
  alpha_vdim[34] = dv11*(2.0*Ey[2]-2.0*Bz[2]*wv1); 
  alpha_vdim[35] = -(0.5773502691896258*Bz[0]*dv1*dv11); 
  alpha_vdim[37] = dv11*(2.0*Ey[3]-2.0*Bz[3]*wv1); 
  alpha_vdim[38] = -(0.5773502691896258*Bz[1]*dv1*dv11); 
  alpha_vdim[39] = -(0.5773502691896258*Bz[2]*dv1*dv11); 
  alpha_vdim[43] = -(0.5773502691896258*Bz[3]*dv1*dv11); 
  ...
  out[6] += 0.38729833462074165*alpha_cdim[3]*f[16]+0.4330127018922193*(alpha_vdim[9]*f[12]+f[9]*alpha_vdim[12]+alpha_vdim[4]*f[8]+f[4]*alpha_vdim[8]+alpha_vdim[2]*f[5]+f[2]*alpha_vdim[5]+alpha_cdim[0]*f[3]+f[0]*alpha_cdim[3]+alpha_vdim[0]*f[1]+f[0]*alpha_vdim[1]); 
  ...
  out[9] += 0.4330127018922193*(f[6]*alpha_vdim[43]+f[3]*alpha_vdim[39]+f[11]*alpha_vdim[38]+f[1]*alpha_vdim[37])+0.38729833462074165*f[24]*alpha_cdim[36]+0.4330127018922193*(f[0]*alpha_cdim[36]+f[7]*alpha_vdim[35]+f[0]*alpha_vdim[34]+f[5]*alpha_vdim[33]+f[2]*alpha_vdim[32]+f[4]*alpha_cdim[32]); 
  out[10] += (0.38729833462074165*f[20]+0.4330127018922193*f[5])*alpha_vdim[43]+(0.38729833462074165*f[18]+0.4330127018922193*f[2])*alpha_vdim[39]+0.38729833462074165*f[17]*alpha_vdim[38]+0.4330127018922193*(f[1]*alpha_vdim[38]+f[11]*alpha_vdim[37])+0.38729833462074165*f[16]*alpha_vdim[35]+0.4330127018922193*(f[0]*alpha_vdim[35]+f[7]*alpha_vdim[34]+f[6]*alpha_vdim[33]+f[3]*alpha_vdim[32])+0.38729833462074165*(alpha_vdim[12]*f[28]+alpha_vdim[9]*f[26]+alpha_vdim[8]*f[25]+alpha_vdim[4]*f[24])+0.4330127018922193*(alpha_vdim[5]*f[12]+f[5]*alpha_vdim[12]+alpha_vdim[2]*f[9]+f[2]*alpha_vdim[9]+alpha_vdim[1]*f[8]+f[1]*alpha_vdim[8]+alpha_vdim[0]*f[4]+f[0]*alpha_vdim[4]); 
  out[11] += 0.4330127018922193*(f[13]*alpha_cdim[36]+f[6]*alpha_cdim[32])+0.38729833462074165*alpha_cdim[3]*f[18]+0.4330127018922193*(alpha_vdim[4]*f[12]+f[4]*alpha_vdim[12]+alpha_vdim[8]*f[9]+f[8]*alpha_vdim[9]+alpha_cdim[0]*f[7]+alpha_vdim[0]*f[5]+f[0]*alpha_vdim[5]+f[2]*(alpha_cdim[3]+alpha_vdim[1])+f[1]*alpha_vdim[2]); 
  out[12] += 0.4330127018922193*(f[3]*alpha_vdim[43]+f[6]*alpha_vdim[39]+f[7]*alpha_vdim[38]+f[0]*alpha_vdim[37])+0.38729833462074165*f[25]*alpha_cdim[36]+0.4330127018922193*(f[1]*alpha_cdim[36]+f[11]*alpha_vdim[35]+f[1]*alpha_vdim[34]+f[2]*alpha_vdim[33]+f[5]*alpha_vdim[32]+f[8]*alpha_cdim[32]+alpha_cdim[3]*f[14]+alpha_cdim[0]*f[9]); 
  out[13] += (0.38729833462074165*f[18]+0.4330127018922193*f[2])*alpha_vdim[43]+(0.38729833462074165*f[20]+0.4330127018922193*f[5])*alpha_vdim[39]+0.38729833462074165*f[16]*alpha_vdim[38]+0.4330127018922193*(f[0]*alpha_vdim[38]+f[7]*alpha_vdim[37])+0.38729833462074165*f[17]*alpha_vdim[35]+0.4330127018922193*(f[1]*alpha_vdim[35]+f[11]*alpha_vdim[34]+f[3]*alpha_vdim[33]+f[6]*alpha_vdim[32])+0.38729833462074165*(alpha_vdim[9]*f[28]+alpha_vdim[12]*f[26]+alpha_vdim[4]*f[25]+alpha_vdim[8]*f[24]+alpha_cdim[3]*f[19])+0.4330127018922193*(alpha_vdim[2]*f[12]+f[2]*alpha_vdim[12]+alpha_cdim[0]*f[10]+alpha_vdim[5]*f[9]+f[5]*alpha_vdim[9]+alpha_vdim[0]*f[8]+f[0]*alpha_vdim[8]+(alpha_cdim[3]+alpha_vdim[1])*f[4]+f[1]*alpha_vdim[4]); 
  out[14] += (0.38729833462074165*f[17]+0.4330127018922193*f[1])*alpha_vdim[43]+(0.38729833462074165*f[16]+0.4330127018922193*f[0])*alpha_vdim[39]+0.38729833462074165*f[20]*alpha_vdim[38]+0.4330127018922193*(f[5]*alpha_vdim[38]+f[6]*alpha_vdim[37])+(0.38729833462074165*f[27]+0.4330127018922193*f[3])*alpha_cdim[36]+0.38729833462074165*f[18]*alpha_vdim[35]+0.4330127018922193*(f[2]*alpha_vdim[35]+f[3]*alpha_vdim[34]+f[11]*alpha_vdim[33]+f[7]*alpha_vdim[32]+f[10]*alpha_cdim[32])+0.38729833462074165*(alpha_vdim[8]*f[28]+alpha_vdim[4]*f[26]+alpha_vdim[12]*f[25]+alpha_vdim[9]*f[24])+0.4330127018922193*(alpha_vdim[1]*f[12]+f[1]*alpha_vdim[12]+alpha_vdim[0]*f[9]+f[0]*alpha_vdim[9]+alpha_vdim[5]*f[8]+f[5]*alpha_vdim[8]+alpha_vdim[2]*f[4]+f[2]*alpha_vdim[4]); 
  out[15] += (0.38729833462074165*f[16]+0.4330127018922193*f[0])*alpha_vdim[43]+(0.38729833462074165*f[17]+0.4330127018922193*f[1])*alpha_vdim[39]+0.38729833462074165*f[18]*alpha_vdim[38]+0.4330127018922193*(f[2]*alpha_vdim[38]+f[3]*alpha_vdim[37])+(0.38729833462074165*f[29]+0.4330127018922193*f[6])*alpha_cdim[36]+0.38729833462074165*f[20]*alpha_vdim[35]+0.4330127018922193*(f[5]*alpha_vdim[35]+f[6]*alpha_vdim[34]+f[7]*alpha_vdim[33]+f[11]*alpha_vdim[32]+f[13]*alpha_cdim[32])+0.38729833462074165*(alpha_vdim[4]*f[28]+alpha_vdim[8]*f[26]+alpha_vdim[9]*f[25]+alpha_vdim[12]*f[24]+alpha_cdim[3]*f[22])+0.4330127018922193*(alpha_cdim[0]*f[14]+alpha_vdim[0]*f[12]+f[0]*alpha_vdim[12]+(alpha_cdim[3]+alpha_vdim[1])*f[9]+f[1]*alpha_vdim[9]+alpha_vdim[2]*f[8]+f[2]*alpha_vdim[8]+alpha_vdim[4]*f[5]+f[4]*alpha_vdim[5]); 
  ...
  out[17] += 0.4330127018922193*alpha_cdim[0]*f[16]+0.9682458365518543*(alpha_vdim[9]*f[15]+alpha_vdim[12]*f[14]+alpha_vdim[4]*f[13]+alpha_vdim[2]*f[11]+alpha_vdim[8]*f[10]+alpha_vdim[5]*f[7]+alpha_vdim[0]*f[6])+(0.38729833462074165*alpha_cdim[3]+0.9682458365518543*alpha_vdim[1])*f[3]; 
