...
GKYL_CU_DH double vlasov_poisson_extem_nonuniformv_boundary_surfvx_2x2v_ser_p1(const double *w, const double *dxv, const double *vcoord, const double *field, const int edge, const double *fEdge, const double *fSkin, double* GKYL_RESTRICT out) 
{ 
  ...
  alpha[1] = -1.224744871391589*A0[3]*vcoord[8]*rdy2; 
  alpha[2] = 1.224744871391589*A1[3]*vcoord[8]*rdx2-2.449489742783178*phi[3]*rdx2; 
  alpha[3] = 1.224744871391589*A1[1]*vcoord[10]*rdx2-1.224744871391589*A0[2]*vcoord[10]*rdy2; 
  alpha[5] = -1.224744871391589*A0[3]*vcoord[10]*rdy2; 
  alpha[6] = 1.224744871391589*A1[3]*vcoord[10]*rdx2; 
  alpha[8] = 1.224744871391589*A1[1]*vcoord[13]*rdx2-1.224744871391589*A0[2]*vcoord[13]*rdy2; 
  alpha[9] = -1.224744871391589*A0[3]*vcoord[13]*rdy2; 
  alpha[10] = 1.224744871391589*A1[3]*vcoord[13]*rdx2; 
  ...
  Ghat[0] = 0.3535533905932737*alpha[10]*fUpwind[10]+0.3535533905932737*alpha[9]*fUpwind[9]+0.3535533905932737*alpha[8]*fUpwind[8]+0.3535533905932737*alpha[6]*fUpwind[6]+0.3535533905932737*alpha[5]*fUpwind[5]+0.3535533905932737*alpha[3]*fUpwind[3]+0.3535533905932737*alpha[2]*fUpwind[2]+0.3535533905932737*alpha[1]*fUpwind[1]+0.3535533905932737*alpha[0]*fUpwind[0]; 
  Ghat[1] = 0.3535533905932737*alpha[10]*fUpwind[11]+0.3535533905932737*alpha[8]*fUpwind[9]+0.3535533905932737*fUpwind[8]*alpha[9]+0.3535533905932737*alpha[6]*fUpwind[7]+0.3535533905932737*alpha[3]*fUpwind[5]+0.3535533905932737*fUpwind[3]*alpha[5]+0.3535533905932737*alpha[2]*fUpwind[4]+0.3535533905932737*alpha[0]*fUpwind[1]+0.3535533905932737*fUpwind[0]*alpha[1]; 
  Ghat[2] = 0.3535533905932737*alpha[9]*fUpwind[11]+0.3535533905932737*alpha[8]*fUpwind[10]+0.3535533905932737*fUpwind[8]*alpha[10]+0.3535533905932737*alpha[5]*fUpwind[7]+0.3535533905932737*alpha[3]*fUpwind[6]+0.3535533905932737*fUpwind[3]*alpha[6]+0.3535533905932737*alpha[1]*fUpwind[4]+0.3535533905932737*alpha[0]*fUpwind[2]+0.3535533905932737*fUpwind[0]*alpha[2]; 
  Ghat[3] = 0.3162277660168379*alpha[6]*fUpwind[10]+0.3162277660168379*fUpwind[6]*alpha[10]+0.3162277660168379*alpha[5]*fUpwind[9]+0.3162277660168379*fUpwind[5]*alpha[9]+0.3162277660168379*alpha[3]*fUpwind[8]+0.3162277660168379*fUpwind[3]*alpha[8]+0.3535533905932737*alpha[2]*fUpwind[6]+0.3535533905932737*fUpwind[2]*alpha[6]+0.3535533905932737*alpha[1]*fUpwind[5]+0.3535533905932737*fUpwind[1]*alpha[5]+0.3535533905932737*alpha[0]*fUpwind[3]+0.3535533905932737*fUpwind[0]*alpha[3]; 
  Ghat[4] = 0.3535533905932737*alpha[8]*fUpwind[11]+0.3535533905932737*alpha[9]*fUpwind[10]+0.3535533905932737*fUpwind[9]*alpha[10]+0.3535533905932737*alpha[3]*fUpwind[7]+0.3535533905932737*alpha[5]*fUpwind[6]+0.3535533905932737*fUpwind[5]*alpha[6]+0.3535533905932737*alpha[0]*fUpwind[4]+0.3535533905932737*alpha[1]*fUpwind[2]+0.3535533905932737*fUpwind[1]*alpha[2]; 
  Ghat[5] = 0.3162277660168379*alpha[6]*fUpwind[11]+0.3162277660168379*fUpwind[7]*alpha[10]+0.3162277660168379*alpha[3]*fUpwind[9]+0.3162277660168379*fUpwind[3]*alpha[9]+0.3162277660168379*alpha[5]*fUpwind[8]+0.3162277660168379*fUpwind[5]*alpha[8]+0.3535533905932737*alpha[2]*fUpwind[7]+0.3535533905932737*fUpwind[4]*alpha[6]+0.3535533905932737*alpha[0]*fUpwind[5]+0.3535533905932737*fUpwind[0]*alpha[5]+0.3535533905932737*alpha[1]*fUpwind[3]+0.3535533905932737*fUpwind[1]*alpha[3]; 
  Ghat[6] = 0.3162277660168379*alpha[5]*fUpwind[11]+0.3162277660168379*alpha[3]*fUpwind[10]+0.3162277660168379*fUpwind[3]*alpha[10]+0.3162277660168379*fUpwind[7]*alpha[9]+0.3162277660168379*alpha[6]*fUpwind[8]+0.3162277660168379*fUpwind[6]*alpha[8]+0.3535533905932737*alpha[1]*fUpwind[7]+0.3535533905932737*alpha[0]*fUpwind[6]+0.3535533905932737*fUpwind[0]*alpha[6]+0.3535533905932737*fUpwind[4]*alpha[5]+0.3535533905932737*alpha[2]*fUpwind[3]+0.3535533905932737*fUpwind[2]*alpha[3]; 
  Ghat[7] = 0.3162277660168379*alpha[3]*fUpwind[11]+0.3162277660168379*alpha[5]*fUpwind[10]+0.3162277660168379*fUpwind[5]*alpha[10]+0.3162277660168379*alpha[6]*fUpwind[9]+0.3162277660168379*fUpwind[6]*alpha[9]+0.3162277660168379*fUpwind[7]*alpha[8]+0.3535533905932737*alpha[0]*fUpwind[7]+0.3535533905932737*alpha[1]*fUpwind[6]+0.3535533905932737*fUpwind[1]*alpha[6]+0.3535533905932737*alpha[2]*fUpwind[5]+0.3535533905932737*fUpwind[2]*alpha[5]+0.3535533905932737*alpha[3]*fUpwind[4]; 
  Ghat[8] = 0.2258769757263128*alpha[10]*fUpwind[10]+0.3535533905932737*alpha[2]*fUpwind[10]+0.3535533905932737*fUpwind[2]*alpha[10]+0.2258769757263128*alpha[9]*fUpwind[9]+0.3535533905932737*alpha[1]*fUpwind[9]+0.3535533905932737*fUpwind[1]*alpha[9]+0.2258769757263128*alpha[8]*fUpwind[8]+0.3535533905932737*alpha[0]*fUpwind[8]+0.3535533905932737*fUpwind[0]*alpha[8]+0.3162277660168379*alpha[6]*fUpwind[6]+0.3162277660168379*alpha[5]*fUpwind[5]+0.3162277660168379*alpha[3]*fUpwind[3]; 
  Ghat[9] = 0.2258769757263128*alpha[10]*fUpwind[11]+0.3535533905932737*alpha[2]*fUpwind[11]+0.3535533905932737*fUpwind[4]*alpha[10]+0.2258769757263128*alpha[8]*fUpwind[9]+0.3535533905932737*alpha[0]*fUpwind[9]+0.2258769757263128*fUpwind[8]*alpha[9]+0.3535533905932737*fUpwind[0]*alpha[9]+0.3535533905932737*alpha[1]*fUpwind[8]+0.3535533905932737*fUpwind[1]*alpha[8]+0.3162277660168379*alpha[6]*fUpwind[7]+0.3162277660168379*alpha[3]*fUpwind[5]+0.3162277660168379*fUpwind[3]*alpha[5]; 
  Ghat[10] = 0.2258769757263128*alpha[9]*fUpwind[11]+0.3535533905932737*alpha[1]*fUpwind[11]+0.2258769757263128*alpha[8]*fUpwind[10]+0.3535533905932737*alpha[0]*fUpwind[10]+0.2258769757263128*fUpwind[8]*alpha[10]+0.3535533905932737*fUpwind[0]*alpha[10]+0.3535533905932737*fUpwind[4]*alpha[9]+0.3535533905932737*alpha[2]*fUpwind[8]+0.3535533905932737*fUpwind[2]*alpha[8]+0.3162277660168379*alpha[5]*fUpwind[7]+0.3162277660168379*alpha[3]*fUpwind[6]+0.3162277660168379*fUpwind[3]*alpha[6]; 
  Ghat[11] = 0.2258769757263128*alpha[8]*fUpwind[11]+0.3535533905932737*alpha[0]*fUpwind[11]+0.2258769757263128*alpha[9]*fUpwind[10]+0.3535533905932737*alpha[1]*fUpwind[10]+0.2258769757263128*fUpwind[9]*alpha[10]+0.3535533905932737*fUpwind[1]*alpha[10]+0.3535533905932737*alpha[2]*fUpwind[9]+0.3535533905932737*fUpwind[2]*alpha[9]+0.3535533905932737*fUpwind[4]*alpha[8]+0.3162277660168379*alpha[3]*fUpwind[7]+0.3162277660168379*alpha[5]*fUpwind[6]+0.3162277660168379*fUpwind[5]*alpha[6]; 
