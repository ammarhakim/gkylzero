...
GKYL_CU_DH double vlasov_poisson_ext_EB_boundary_surfvz_1x3v_ser_p2(const double *w, const double *dxv, const double *pots, const double *EBext, const int edge, const double *fEdge, const double *fSkin, double* GKYL_RESTRICT out) 
{ 
  ...
  alpha[7] = -(2.0*Bx[2]*wv2)+2.0*By[2]*wv1+2.0*Ez[2]; 
  alpha[11] = 0.5773502691896257*By[2]*dv1; 
  alpha[13] = -(0.5773502691896257*Bx[2]*dv2); 
