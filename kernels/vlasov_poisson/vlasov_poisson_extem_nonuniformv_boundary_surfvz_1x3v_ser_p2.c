...
GKYL_CU_DH double vlasov_poisson_extem_nonuniformv_boundary_surfvz_1x3v_ser_p2(const double *w, const double *dxv, const double *vcoord, const double *field, const int edge, const double *fEdge, const double *fSkin, double* GKYL_RESTRICT out) 
{ 
  ...
  Ghat[0] = 0.3535533905932737*alpha[12]*fUpwind[12]+0.3535533905932737*alpha[8]*fUpwind[8]+0.3535533905932737*alpha[4]*fUpwind[4]+0.3535533905932737*alpha[2]*fUpwind[2]+0.3535533905932737*alpha[1]*fUpwind[1]+0.3535533905932737*alpha[0]*fUpwind[0]; 
  Ghat[1] = 0.3535533905932737*alpha[8]*fUpwind[12]+0.3535533905932737*fUpwind[8]*alpha[12]+0.3162277660168379*alpha[4]*fUpwind[11]+0.3162277660168379*alpha[1]*fUpwind[7]+0.3535533905932737*alpha[2]*fUpwind[4]+0.3535533905932737*fUpwind[2]*alpha[4]+0.3535533905932737*alpha[0]*fUpwind[1]+0.3535533905932737*fUpwind[0]*alpha[1]; 
  Ghat[2] = 0.3162277660168379*alpha[4]*fUpwind[12]+0.3162277660168379*fUpwind[4]*alpha[12]+0.3162277660168379*alpha[2]*fUpwind[8]+0.3162277660168379*fUpwind[2]*alpha[8]+0.3535533905932737*alpha[1]*fUpwind[4]+0.3535533905932737*fUpwind[1]*alpha[4]+0.3535533905932737*alpha[0]*fUpwind[2]+0.3535533905932737*fUpwind[0]*alpha[2]; 
  Ghat[3] = 0.3535533905932737*alpha[12]*fUpwind[18]+0.3535533905932737*alpha[8]*fUpwind[14]+0.3535533905932737*alpha[4]*fUpwind[10]+0.3535533905932737*alpha[2]*fUpwind[6]+0.3535533905932737*alpha[1]*fUpwind[5]+0.3535533905932737*alpha[0]*fUpwind[3]; 
  Ghat[4] = 0.3162277660168379*alpha[2]*fUpwind[12]+0.2828427124746191*fUpwind[11]*alpha[12]+0.3162277660168379*fUpwind[2]*alpha[12]+0.3162277660168379*alpha[1]*fUpwind[11]+0.3162277660168379*alpha[4]*fUpwind[8]+0.3162277660168379*fUpwind[4]*alpha[8]+0.3162277660168379*alpha[4]*fUpwind[7]+0.3535533905932737*alpha[0]*fUpwind[4]+0.3535533905932737*fUpwind[0]*alpha[4]+0.3535533905932737*alpha[1]*fUpwind[2]+0.3535533905932737*fUpwind[1]*alpha[2]; 
  Ghat[5] = 0.3535533905932737*alpha[8]*fUpwind[18]+0.3162277660168379*alpha[4]*fUpwind[17]+0.3535533905932737*alpha[12]*fUpwind[14]+0.3162277660168379*alpha[1]*fUpwind[13]+0.3535533905932737*alpha[2]*fUpwind[10]+0.3535533905932737*alpha[4]*fUpwind[6]+0.3535533905932737*alpha[0]*fUpwind[5]+0.3535533905932737*alpha[1]*fUpwind[3]; 
  Ghat[6] = 0.3162277660168379*alpha[4]*fUpwind[18]+0.3162277660168379*alpha[2]*fUpwind[14]+0.3162277660168379*fUpwind[10]*alpha[12]+0.3535533905932737*alpha[1]*fUpwind[10]+0.3162277660168379*fUpwind[6]*alpha[8]+0.3535533905932737*alpha[0]*fUpwind[6]+0.3535533905932737*alpha[4]*fUpwind[5]+0.3535533905932737*alpha[2]*fUpwind[3]; 
  Ghat[7] = 0.3162277660168379*alpha[12]*fUpwind[12]+0.3535533905932737*alpha[2]*fUpwind[11]+0.3535533905932737*alpha[0]*fUpwind[7]+0.3162277660168379*alpha[4]*fUpwind[4]+0.3162277660168379*alpha[1]*fUpwind[1]; 
  Ghat[8] = 0.2258769757263128*alpha[12]*fUpwind[12]+0.3535533905932737*alpha[1]*fUpwind[12]+0.3535533905932737*fUpwind[1]*alpha[12]+0.2258769757263128*alpha[8]*fUpwind[8]+0.3535533905932737*alpha[0]*fUpwind[8]+0.3535533905932737*fUpwind[0]*alpha[8]+0.3162277660168379*alpha[4]*fUpwind[4]+0.3162277660168379*alpha[2]*fUpwind[2]; 
  ...
  Ghat[10] = 0.3162277660168379*alpha[2]*fUpwind[18]+0.282842712474619*alpha[12]*fUpwind[17]+0.3162277660168379*alpha[1]*fUpwind[17]+0.3162277660168379*alpha[4]*fUpwind[14]+0.3162277660168379*alpha[4]*fUpwind[13]+0.3162277660168379*fUpwind[6]*alpha[12]+0.3162277660168379*alpha[8]*fUpwind[10]+0.3535533905932737*alpha[0]*fUpwind[10]+0.3535533905932737*alpha[1]*fUpwind[6]+0.3535533905932737*alpha[2]*fUpwind[5]+0.3535533905932737*fUpwind[3]*alpha[4]; 
  Ghat[11] = 0.2828427124746191*alpha[4]*fUpwind[12]+0.2828427124746191*fUpwind[4]*alpha[12]+0.3162277660168379*alpha[8]*fUpwind[11]+0.3535533905932737*alpha[0]*fUpwind[11]+0.3535533905932737*alpha[2]*fUpwind[7]+0.3162277660168379*alpha[1]*fUpwind[4]+0.3162277660168379*fUpwind[1]*alpha[4]; 
  Ghat[12] = 0.2258769757263128*alpha[8]*fUpwind[12]+0.3535533905932737*alpha[0]*fUpwind[12]+0.2258769757263128*fUpwind[8]*alpha[12]+0.3162277660168379*fUpwind[7]*alpha[12]+0.3535533905932737*fUpwind[0]*alpha[12]+0.2828427124746191*alpha[4]*fUpwind[11]+0.3535533905932737*alpha[1]*fUpwind[8]+0.3535533905932737*fUpwind[1]*alpha[8]+0.3162277660168379*alpha[2]*fUpwind[4]+0.3162277660168379*fUpwind[2]*alpha[4]; 
  Ghat[13] = 0.3162277660168379*alpha[12]*fUpwind[18]+0.3535533905932737*alpha[2]*fUpwind[17]+0.3535533905932737*alpha[0]*fUpwind[13]+0.3162277660168379*alpha[4]*fUpwind[10]+0.3162277660168379*alpha[1]*fUpwind[5]; 
  Ghat[14] = 0.2258769757263128*alpha[12]*fUpwind[18]+0.3535533905932737*alpha[1]*fUpwind[18]+0.2258769757263128*alpha[8]*fUpwind[14]+0.3535533905932737*alpha[0]*fUpwind[14]+0.3535533905932737*fUpwind[5]*alpha[12]+0.3162277660168379*alpha[4]*fUpwind[10]+0.3535533905932737*fUpwind[3]*alpha[8]+0.3162277660168379*alpha[2]*fUpwind[6]; 
  ...
  Ghat[16] = 0.3162277660168379*alpha[12]*fUpwind[19]+0.3535533905932737*alpha[1]*fUpwind[19]+0.3162277660168379*alpha[8]*fUpwind[16]+0.3535533905932737*alpha[0]*fUpwind[16]+0.3535533905932737*alpha[4]*fUpwind[15]+0.3535533905932737*alpha[2]*fUpwind[9]; 
  Ghat[17] = 0.2828427124746191*alpha[4]*fUpwind[18]+0.3162277660168379*alpha[8]*fUpwind[17]+0.3535533905932737*alpha[0]*fUpwind[17]+0.3535533905932737*alpha[2]*fUpwind[13]+0.282842712474619*fUpwind[10]*alpha[12]+0.3162277660168379*alpha[1]*fUpwind[10]+0.3162277660168379*alpha[4]*fUpwind[5]; 
  Ghat[18] = 0.2258769757263128*alpha[8]*fUpwind[18]+0.3535533905932737*alpha[0]*fUpwind[18]+0.2828427124746191*alpha[4]*fUpwind[17]+0.2258769757263128*alpha[12]*fUpwind[14]+0.3535533905932737*alpha[1]*fUpwind[14]+0.3162277660168379*alpha[12]*fUpwind[13]+0.3535533905932737*fUpwind[3]*alpha[12]+0.3162277660168379*alpha[2]*fUpwind[10]+0.3535533905932737*fUpwind[5]*alpha[8]+0.3162277660168379*alpha[4]*fUpwind[6]; 
  Ghat[19] = 0.3162277660168379*alpha[8]*fUpwind[19]+0.3535533905932737*alpha[0]*fUpwind[19]+0.3162277660168379*alpha[12]*fUpwind[16]+0.3535533905932737*alpha[1]*fUpwind[16]+0.3535533905932737*alpha[2]*fUpwind[15]+0.3535533905932737*alpha[4]*fUpwind[9]; 
