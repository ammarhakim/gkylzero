...
GKYL_CU_DH double vlasov_poisson_ext_phiA_boundary_surfvy_2x2v_ser_p2(const double *w, const double *dxv, const double *pots, const double *EBext, const int edge, const double *fEdge, const double *fSkin, double* GKYL_RESTRICT out) 
{ 
  ...
  alpha[0] = 2.4494897427831783*Ax[2]*dx11*wv1-2.4494897427831783*Ay[1]*dx10*wv1-2.4494897427831783*phi[2]*dx11; 
  alpha[1] = 2.4494897427831783*Ax[3]*dx11*wv1-5.477225575051662*Ay[4]*dx10*wv1-2.4494897427831783*phi[3]*dx11; 
  alpha[2] = 5.477225575051662*Ax[5]*dx11*wv1-2.4494897427831783*Ay[3]*dx10*wv1-5.477225575051662*phi[5]*dx11; 
  alpha[3] = 0.7071067811865475*Ax[2]*dv1*dx11-0.7071067811865475*Ay[1]*dv1*dx10; 
  alpha[4] = 5.477225575051662*Ax[7]*dx11*wv1-5.477225575051662*Ay[6]*dx10*wv1-5.477225575051662*phi[7]*dx11; 
  alpha[5] = 0.7071067811865475*Ax[3]*dv1*dx11-1.5811388300841895*Ay[4]*dv1*dx10; 
  alpha[6] = 1.5811388300841895*Ax[5]*dv1*dx11-0.7071067811865475*Ay[3]*dv1*dx10; 
  alpha[7] = 2.4494897427831783*Ax[6]*dx11*wv1-2.4494897427831783*phi[6]*dx11; 
  alpha[8] = -(2.4494897427831783*Ay[7]*dx10*wv1); 
  alpha[10] = 1.5811388300841898*Ax[7]*dv1*dx11-1.5811388300841898*Ay[6]*dv1*dx10; 
  alpha[13] = 0.7071067811865475*Ax[6]*dv1*dx11; 
  alpha[14] = -(0.7071067811865475*Ay[7]*dv1*dx10); 
  ...
  Ghat[10] = 0.282842712474619*alpha[14]*fUpwind[19]+0.282842712474619*alpha[13]*fUpwind[19]+0.3162277660168379*alpha[3]*fUpwind[19]+0.3162277660168379*alpha[2]*fUpwind[18]+0.3162277660168379*alpha[1]*fUpwind[17]+0.31622776601683794*alpha[5]*fUpwind[16]+0.31622776601683794*alpha[6]*fUpwind[15]+0.31622776601683794*alpha[4]*fUpwind[14]+0.31622776601683794*fUpwind[4]*alpha[14]+0.31622776601683794*alpha[4]*fUpwind[13]+0.31622776601683794*fUpwind[4]*alpha[13]+0.31622776601683794*alpha[6]*fUpwind[12]+0.31622776601683794*alpha[5]*fUpwind[11]+0.3162277660168379*alpha[8]*fUpwind[10]+0.3162277660168379*alpha[7]*fUpwind[10]+0.3535533905932737*alpha[0]*fUpwind[10]+0.3162277660168379*fUpwind[9]*alpha[10]+0.3162277660168379*fUpwind[8]*alpha[10]+0.3162277660168379*fUpwind[7]*alpha[10]+0.3535533905932737*fUpwind[0]*alpha[10]+0.3535533905932737*alpha[1]*fUpwind[6]+0.3535533905932737*fUpwind[1]*alpha[6]+0.3535533905932737*alpha[2]*fUpwind[5]+0.3535533905932737*fUpwind[2]*alpha[5]+0.3535533905932737*alpha[3]*fUpwind[4]+0.3535533905932737*fUpwind[3]*alpha[4]; 
  Ghat[11] = 0.282842712474619*alpha[10]*fUpwind[18]+0.3162277660168379*alpha[14]*fUpwind[17]+0.22587697572631277*alpha[13]*fUpwind[17]+0.3535533905932737*alpha[3]*fUpwind[17]+0.3535533905932737*alpha[6]*fUpwind[13]+0.3535533905932737*fUpwind[6]*alpha[13]+0.28284271247461906*alpha[4]*fUpwind[12]+0.3162277660168379*alpha[8]*fUpwind[11]+0.22587697572631277*alpha[7]*fUpwind[11]+0.3535533905932737*alpha[0]*fUpwind[11]+0.31622776601683794*alpha[5]*fUpwind[10]+0.31622776601683794*fUpwind[5]*alpha[10]+0.3535533905932737*alpha[2]*fUpwind[7]+0.3535533905932737*fUpwind[2]*alpha[7]+0.31622776601683794*alpha[1]*fUpwind[4]+0.31622776601683794*fUpwind[1]*alpha[4]; 
  Ghat[12] = 0.22587697572631277*alpha[14]*fUpwind[18]+0.3162277660168379*alpha[13]*fUpwind[18]+0.3535533905932737*alpha[3]*fUpwind[18]+0.282842712474619*alpha[10]*fUpwind[17]+0.3535533905932737*alpha[5]*fUpwind[14]+0.3535533905932737*fUpwind[5]*alpha[14]+0.22587697572631277*alpha[8]*fUpwind[12]+0.3162277660168379*alpha[7]*fUpwind[12]+0.3535533905932737*alpha[0]*fUpwind[12]+0.28284271247461906*alpha[4]*fUpwind[11]+0.31622776601683794*alpha[6]*fUpwind[10]+0.31622776601683794*fUpwind[6]*alpha[10]+0.3535533905932737*alpha[1]*fUpwind[8]+0.3535533905932737*fUpwind[1]*alpha[8]+0.31622776601683794*alpha[2]*fUpwind[4]+0.31622776601683794*fUpwind[2]*alpha[4]; 
  Ghat[13] = 0.282842712474619*alpha[10]*fUpwind[19]+0.3535533905932737*alpha[2]*fUpwind[17]+0.28284271247461906*alpha[5]*fUpwind[15]+0.22587697572631277*alpha[7]*fUpwind[13]+0.3535533905932737*alpha[0]*fUpwind[13]+0.3162277660168379*fUpwind[9]*alpha[13]+0.22587697572631277*fUpwind[7]*alpha[13]+0.3535533905932737*fUpwind[0]*alpha[13]+0.3535533905932737*alpha[6]*fUpwind[11]+0.31622776601683794*alpha[4]*fUpwind[10]+0.31622776601683794*fUpwind[4]*alpha[10]+0.3535533905932737*alpha[3]*fUpwind[7]+0.3535533905932737*fUpwind[3]*alpha[7]+0.31622776601683794*alpha[1]*fUpwind[5]+0.31622776601683794*fUpwind[1]*alpha[5]; 
  Ghat[14] = 0.282842712474619*alpha[10]*fUpwind[19]+0.3535533905932737*alpha[1]*fUpwind[18]+0.28284271247461906*alpha[6]*fUpwind[16]+0.22587697572631277*alpha[8]*fUpwind[14]+0.3535533905932737*alpha[0]*fUpwind[14]+0.3162277660168379*fUpwind[9]*alpha[14]+0.22587697572631277*fUpwind[8]*alpha[14]+0.3535533905932737*fUpwind[0]*alpha[14]+0.3535533905932737*alpha[5]*fUpwind[12]+0.31622776601683794*alpha[4]*fUpwind[10]+0.31622776601683794*fUpwind[4]*alpha[10]+0.3535533905932737*alpha[3]*fUpwind[8]+0.3535533905932737*fUpwind[3]*alpha[8]+0.31622776601683794*alpha[2]*fUpwind[6]+0.31622776601683794*fUpwind[2]*alpha[6]; 
  Ghat[15] = 0.3535533905932737*alpha[2]*fUpwind[19]+0.3162277660168379*alpha[14]*fUpwind[18]+0.282842712474619*alpha[10]*fUpwind[17]+0.3535533905932737*alpha[4]*fUpwind[16]+0.3162277660168379*alpha[7]*fUpwind[15]+0.3535533905932737*alpha[0]*fUpwind[15]+0.28284271247461906*alpha[5]*fUpwind[13]+0.28284271247461906*fUpwind[5]*alpha[13]+0.31622776601683794*alpha[6]*fUpwind[10]+0.31622776601683794*fUpwind[6]*alpha[10]+0.3535533905932737*alpha[1]*fUpwind[9]+0.31622776601683794*alpha[3]*fUpwind[5]+0.31622776601683794*fUpwind[3]*alpha[5]; 
  ...
  Ghat[17] = 0.28284271247461906*alpha[5]*fUpwind[19]+0.28284271247461906*alpha[4]*fUpwind[18]+0.3162277660168379*alpha[8]*fUpwind[17]+0.22587697572631277*alpha[7]*fUpwind[17]+0.3535533905932737*alpha[0]*fUpwind[17]+0.3162277660168379*alpha[13]*fUpwind[16]+0.282842712474619*alpha[10]*fUpwind[15]+0.3162277660168379*fUpwind[11]*alpha[14]+0.3535533905932737*alpha[2]*fUpwind[13]+0.22587697572631277*fUpwind[11]*alpha[13]+0.3535533905932737*fUpwind[2]*alpha[13]+0.282842712474619*alpha[10]*fUpwind[12]+0.3535533905932737*alpha[3]*fUpwind[11]+0.3162277660168379*alpha[1]*fUpwind[10]+0.3162277660168379*fUpwind[1]*alpha[10]+0.3535533905932737*alpha[6]*fUpwind[7]+0.3535533905932737*fUpwind[6]*alpha[7]+0.3162277660168379*alpha[4]*fUpwind[5]+0.3162277660168379*fUpwind[4]*alpha[5]; 
  Ghat[18] = 0.28284271247461906*alpha[6]*fUpwind[19]+0.22587697572631277*alpha[8]*fUpwind[18]+0.3162277660168379*alpha[7]*fUpwind[18]+0.3535533905932737*alpha[0]*fUpwind[18]+0.28284271247461906*alpha[4]*fUpwind[17]+0.282842712474619*alpha[10]*fUpwind[16]+0.3162277660168379*alpha[14]*fUpwind[15]+0.3535533905932737*alpha[1]*fUpwind[14]+0.22587697572631277*fUpwind[12]*alpha[14]+0.3535533905932737*fUpwind[1]*alpha[14]+0.3162277660168379*fUpwind[12]*alpha[13]+0.3535533905932737*alpha[3]*fUpwind[12]+0.282842712474619*alpha[10]*fUpwind[11]+0.3162277660168379*alpha[2]*fUpwind[10]+0.3162277660168379*fUpwind[2]*alpha[10]+0.3535533905932737*alpha[5]*fUpwind[8]+0.3535533905932737*fUpwind[5]*alpha[8]+0.3162277660168379*alpha[4]*fUpwind[6]+0.3162277660168379*fUpwind[4]*alpha[6]; 
  Ghat[19] = 0.3162277660168379*alpha[8]*fUpwind[19]+0.3162277660168379*alpha[7]*fUpwind[19]+0.3535533905932737*alpha[0]*fUpwind[19]+0.28284271247461906*alpha[6]*fUpwind[18]+0.28284271247461906*alpha[5]*fUpwind[17]+0.3535533905932737*alpha[1]*fUpwind[16]+0.3535533905932737*alpha[2]*fUpwind[15]+0.282842712474619*alpha[10]*fUpwind[14]+0.282842712474619*fUpwind[10]*alpha[14]+0.282842712474619*alpha[10]*fUpwind[13]+0.282842712474619*fUpwind[10]*alpha[13]+0.3162277660168379*alpha[3]*fUpwind[10]+0.3162277660168379*fUpwind[3]*alpha[10]+0.3535533905932737*alpha[4]*fUpwind[9]+0.3162277660168379*alpha[5]*fUpwind[6]+0.3162277660168379*fUpwind[5]*alpha[6]; 
