...
GKYL_CU_DH double vlasov_poisson_nonuniformv_surfvx_2x3v_ser_p1(const double *w, const double *dxv, const double *vcoord, const double *field, const double *fl, const double *fc, const double *fr, double* GKYL_RESTRICT out) 
{ 
  ...
  Ghat_l[16] = 0.2500000000000001*alpha[2]*fUpwind_l[18]+0.25*alpha[0]*fUpwind_l[16]; 
  Ghat_l[17] = 0.2500000000000001*alpha[2]*fUpwind_l[20]+0.25*alpha[0]*fUpwind_l[17]; 
  Ghat_l[18] = 0.25*alpha[0]*fUpwind_l[18]+0.2500000000000001*alpha[2]*fUpwind_l[16]; 
  Ghat_l[19] = 0.2500000000000001*alpha[2]*fUpwind_l[22]+0.25*alpha[0]*fUpwind_l[19]; 
  Ghat_l[20] = 0.25*alpha[0]*fUpwind_l[20]+0.2500000000000001*alpha[2]*fUpwind_l[17]; 
  Ghat_l[21] = 0.2500000000000001*alpha[2]*fUpwind_l[23]+0.25*alpha[0]*fUpwind_l[21]; 
  Ghat_l[22] = 0.25*alpha[0]*fUpwind_l[22]+0.2500000000000001*alpha[2]*fUpwind_l[19]; 
  Ghat_l[23] = 0.25*alpha[0]*fUpwind_l[23]+0.2500000000000001*alpha[2]*fUpwind_l[21]; 
  Ghat_l[24] = 0.2500000000000001*alpha[2]*fUpwind_l[26]+0.25*alpha[0]*fUpwind_l[24]; 
  Ghat_l[25] = 0.2500000000000001*alpha[2]*fUpwind_l[28]+0.25*alpha[0]*fUpwind_l[25]; 
  Ghat_l[26] = 0.25*alpha[0]*fUpwind_l[26]+0.2500000000000001*alpha[2]*fUpwind_l[24]; 
  Ghat_l[27] = 0.2500000000000001*alpha[2]*fUpwind_l[30]+0.25*alpha[0]*fUpwind_l[27]; 
  Ghat_l[28] = 0.25*alpha[0]*fUpwind_l[28]+0.2500000000000001*alpha[2]*fUpwind_l[25]; 
  Ghat_l[29] = 0.2500000000000001*alpha[2]*fUpwind_l[31]+0.25*alpha[0]*fUpwind_l[29]; 
  Ghat_l[30] = 0.25*alpha[0]*fUpwind_l[30]+0.2500000000000001*alpha[2]*fUpwind_l[27]; 
  Ghat_l[31] = 0.25*alpha[0]*fUpwind_l[31]+0.2500000000000001*alpha[2]*fUpwind_l[29]; 
  ...
  Ghat_r[16] = 0.2500000000000001*alpha[2]*fUpwind_r[18]+0.25*alpha[0]*fUpwind_r[16]; 
  Ghat_r[17] = 0.2500000000000001*alpha[2]*fUpwind_r[20]+0.25*alpha[0]*fUpwind_r[17]; 
  Ghat_r[18] = 0.25*alpha[0]*fUpwind_r[18]+0.2500000000000001*alpha[2]*fUpwind_r[16]; 
  Ghat_r[19] = 0.2500000000000001*alpha[2]*fUpwind_r[22]+0.25*alpha[0]*fUpwind_r[19]; 
  Ghat_r[20] = 0.25*alpha[0]*fUpwind_r[20]+0.2500000000000001*alpha[2]*fUpwind_r[17]; 
  Ghat_r[21] = 0.2500000000000001*alpha[2]*fUpwind_r[23]+0.25*alpha[0]*fUpwind_r[21]; 
  Ghat_r[22] = 0.25*alpha[0]*fUpwind_r[22]+0.2500000000000001*alpha[2]*fUpwind_r[19]; 
  Ghat_r[23] = 0.25*alpha[0]*fUpwind_r[23]+0.2500000000000001*alpha[2]*fUpwind_r[21]; 
  Ghat_r[24] = 0.2500000000000001*alpha[2]*fUpwind_r[26]+0.25*alpha[0]*fUpwind_r[24]; 
  Ghat_r[25] = 0.2500000000000001*alpha[2]*fUpwind_r[28]+0.25*alpha[0]*fUpwind_r[25]; 
  Ghat_r[26] = 0.25*alpha[0]*fUpwind_r[26]+0.2500000000000001*alpha[2]*fUpwind_r[24]; 
  Ghat_r[27] = 0.2500000000000001*alpha[2]*fUpwind_r[30]+0.25*alpha[0]*fUpwind_r[27]; 
  Ghat_r[28] = 0.25*alpha[0]*fUpwind_r[28]+0.2500000000000001*alpha[2]*fUpwind_r[25]; 
  Ghat_r[29] = 0.2500000000000001*alpha[2]*fUpwind_r[31]+0.25*alpha[0]*fUpwind_r[29]; 
  Ghat_r[30] = 0.25*alpha[0]*fUpwind_r[30]+0.2500000000000001*alpha[2]*fUpwind_r[27]; 
  Ghat_r[31] = 0.25*alpha[0]*fUpwind_r[31]+0.2500000000000001*alpha[2]*fUpwind_r[29]; 
