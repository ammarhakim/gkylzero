...
GKYL_CU_DH double vlasov_poisson_nonuniformv_boundary_surfvx_2x2v_ser_p1(const double *w, const double *dxv, const double *vcoord, const double *field, const int edge, const double *fEdge, const double *fSkin, double* GKYL_RESTRICT out) 
{ 
  ...
  Ghat[2] = 0.3535533905932737*alpha[0]*fUpwind[2]+0.3535533905932737*fUpwind[0]*alpha[2]; 
  Ghat[3] = 0.3535533905932737*alpha[2]*fUpwind[6]+0.3535533905932737*alpha[0]*fUpwind[3]; 
  Ghat[4] = 0.3535533905932737*alpha[0]*fUpwind[4]+0.3535533905932737*fUpwind[1]*alpha[2]; 
  Ghat[5] = 0.3535533905932737*alpha[2]*fUpwind[7]+0.3535533905932737*alpha[0]*fUpwind[5]; 
  Ghat[6] = 0.3535533905932737*alpha[0]*fUpwind[6]+0.3535533905932737*alpha[2]*fUpwind[3]; 
  Ghat[7] = 0.3535533905932737*alpha[0]*fUpwind[7]+0.3535533905932737*alpha[2]*fUpwind[5]; 
  Ghat[8] = 0.3535533905932737*alpha[2]*fUpwind[10]+0.3535533905932737*alpha[0]*fUpwind[8]; 
  Ghat[9] = 0.3535533905932737*alpha[2]*fUpwind[11]+0.3535533905932737*alpha[0]*fUpwind[9]; 
  Ghat[10] = 0.3535533905932737*alpha[0]*fUpwind[10]+0.3535533905932737*alpha[2]*fUpwind[8]; 
  Ghat[11] = 0.3535533905932737*alpha[0]*fUpwind[11]+0.3535533905932737*alpha[2]*fUpwind[9]; 
