...
{ 
  ...
  out[7] += 0.3872983346207416*f[16]*alpha_vdim[42]+0.4330127018922193*(f[0]*alpha_vdim[42]+f[2]*alpha_vdim[40])+0.3872983346207416*alpha_vdim[3]*f[24]+0.4330127018922193*(alpha_vdim[4]*f[10]+alpha_vdim[0]*f[3]+f[0]*alpha_vdim[3]); 
  out[8] += 0.4330127018922193*(f[5]*alpha_vdim[82]+f[1]*alpha_vdim[80]+alpha_cdim[2]*f[9]+alpha_cdim[0]*f[4]); 
  out[9] += 0.3872983346207416*f[16]*alpha_vdim[82]+0.4330127018922193*(f[0]*alpha_vdim[82]+f[2]*alpha_vdim[80])+0.3872983346207416*alpha_vdim[4]*f[32]+0.4330127018922193*(alpha_vdim[3]*f[10]+alpha_vdim[0]*f[4]+f[0]*alpha_vdim[4]); 
  out[10] += 0.4330127018922193*(f[7]*alpha_vdim[82]+f[3]*alpha_vdim[80]+f[9]*alpha_vdim[42]+f[4]*alpha_vdim[40]); 
  out[11] += 0.3872983346207416*f[17]*alpha_vdim[42]+0.4330127018922193*(f[1]*alpha_vdim[42]+f[5]*alpha_vdim[40])+0.3872983346207416*(alpha_vdim[3]*f[25]+alpha_cdim[2]*f[18])+0.4330127018922193*(alpha_vdim[4]*f[13]+alpha_cdim[0]*f[7]+alpha_vdim[0]*f[6]+alpha_cdim[2]*f[3]+f[1]*alpha_vdim[3]); 
  out[12] += 0.3872983346207416*f[17]*alpha_vdim[82]+0.4330127018922193*(f[1]*alpha_vdim[82]+f[5]*alpha_vdim[80])+0.3872983346207416*(alpha_vdim[4]*f[33]+alpha_cdim[2]*f[19])+0.4330127018922193*(alpha_vdim[3]*f[13]+alpha_cdim[0]*f[9]+alpha_vdim[0]*f[8]+alpha_cdim[2]*f[4]+f[1]*alpha_vdim[4]); 
  ...
  out[14] += 0.3872983346207416*f[18]*alpha_vdim[82]+0.4330127018922193*(f[3]*alpha_vdim[82]+f[7]*alpha_vdim[80])+0.3872983346207416*f[19]*alpha_vdim[42]+0.4330127018922193*(f[4]*alpha_vdim[42]+f[9]*alpha_vdim[40])+0.3872983346207416*(alpha_vdim[4]*f[35]+alpha_vdim[3]*f[27])+0.4330127018922193*(alpha_vdim[0]*f[10]+alpha_vdim[3]*f[4]+f[3]*alpha_vdim[4]); 
  out[15] += 0.3872983346207416*f[20]*alpha_vdim[82]+0.4330127018922193*(f[6]*alpha_vdim[82]+f[11]*alpha_vdim[80])+0.3872983346207416*f[21]*alpha_vdim[42]+0.4330127018922193*(f[8]*alpha_vdim[42]+f[12]*alpha_vdim[40])+0.3872983346207416*(alpha_vdim[4]*f[37]+alpha_vdim[3]*f[29]+alpha_cdim[2]*f[22])+0.4330127018922193*(alpha_cdim[0]*f[14]+alpha_vdim[0]*f[13]+alpha_cdim[2]*f[10]+alpha_vdim[3]*f[8]+alpha_vdim[4]*f[6]); 
  ...
  out[18] += 0.3872983346207416*f[2]*alpha_vdim[42]+0.4330127018922193*f[16]*alpha_vdim[40]+0.8660254037844386*alpha_vdim[3]*f[26]+0.9682458365518543*(alpha_vdim[4]*f[14]+alpha_vdim[0]*f[7]+f[2]*alpha_vdim[3]); 
  out[19] += 0.3872983346207416*f[2]*alpha_vdim[82]+0.4330127018922193*f[16]*alpha_vdim[80]+0.8660254037844386*alpha_vdim[4]*f[34]+0.9682458365518543*(alpha_vdim[3]*f[14]+alpha_vdim[0]*f[9]+f[2]*alpha_vdim[4]); 
  out[20] += 0.3872983346207416*f[5]*alpha_vdim[42]+0.4330127018922193*f[17]*alpha_vdim[40]+0.8660254037844386*alpha_vdim[3]*f[28]+0.4330127018922193*alpha_cdim[0]*f[18]+0.9682458365518543*(alpha_vdim[4]*f[15]+alpha_vdim[0]*f[11])+0.3872983346207416*alpha_cdim[2]*f[7]+0.9682458365518543*alpha_vdim[3]*f[5]; 
  out[21] += 0.3872983346207416*f[5]*alpha_vdim[82]+0.4330127018922193*f[17]*alpha_vdim[80]+0.8660254037844386*alpha_vdim[4]*f[36]+0.4330127018922193*alpha_cdim[0]*f[19]+0.9682458365518543*(alpha_vdim[3]*f[15]+alpha_vdim[0]*f[12])+0.3872983346207416*alpha_cdim[2]*f[9]+0.9682458365518543*alpha_vdim[4]*f[5]; 
  out[22] += 0.3872983346207416*f[7]*alpha_vdim[82]+0.4330127018922193*f[18]*alpha_vdim[80]+0.3872983346207416*f[9]*alpha_vdim[42]+0.4330127018922193*f[19]*alpha_vdim[40]+0.8660254037844386*(alpha_vdim[4]*f[38]+alpha_vdim[3]*f[30])+0.9682458365518543*(alpha_vdim[0]*f[14]+alpha_vdim[3]*f[9]+alpha_vdim[4]*f[7]); 
  out[23] += 0.3872983346207416*f[11]*alpha_vdim[82]+0.4330127018922193*f[20]*alpha_vdim[80]+0.3872983346207416*f[12]*alpha_vdim[42]+0.4330127018922193*f[21]*alpha_vdim[40]+0.8660254037844386*(alpha_vdim[4]*f[39]+alpha_vdim[3]*f[31])+0.4330127018922193*alpha_cdim[0]*f[22]+0.9682458365518543*alpha_vdim[0]*f[15]+0.3872983346207416*alpha_cdim[2]*f[14]+0.9682458365518543*(alpha_vdim[3]*f[12]+alpha_vdim[4]*f[11]); 
  ...
  out[26] += 0.8660254037844386*f[18]*alpha_vdim[42]+0.9682458365518543*(f[3]*alpha_vdim[42]+f[7]*alpha_vdim[40])+0.4330127018922193*(alpha_vdim[4]*f[27]+alpha_vdim[0]*f[24])+0.3872983346207416*alpha_vdim[3]*f[3]; 
  out[27] += 0.4330127018922193*(f[26]*alpha_vdim[82]+f[24]*alpha_vdim[80])+0.9682458365518543*(f[14]*alpha_vdim[42]+f[10]*alpha_vdim[40]); 
  out[28] += 0.8660254037844386*f[20]*alpha_vdim[42]+0.9682458365518543*(f[6]*alpha_vdim[42]+f[11]*alpha_vdim[40])+0.4330127018922193*(alpha_vdim[4]*f[29]+alpha_cdim[0]*f[26]+alpha_vdim[0]*f[25]+alpha_cdim[2]*f[24])+0.3872983346207416*alpha_vdim[3]*f[6]; 
  ...
  out[30] += 0.4330127018922193*(f[24]*alpha_vdim[82]+f[26]*alpha_vdim[80])+0.8660254037844386*f[22]*alpha_vdim[42]+0.9682458365518543*(f[10]*alpha_vdim[42]+f[14]*alpha_vdim[40])+0.4330127018922193*(alpha_vdim[0]*f[27]+alpha_vdim[4]*f[24])+0.3872983346207416*alpha_vdim[3]*f[10]; 
  out[31] += 0.4330127018922193*(f[25]*alpha_vdim[82]+f[28]*alpha_vdim[80])+0.8660254037844386*f[23]*alpha_vdim[42]+0.9682458365518543*(f[13]*alpha_vdim[42]+f[15]*alpha_vdim[40])+0.4330127018922193*(alpha_cdim[0]*f[30]+alpha_vdim[0]*f[29]+alpha_cdim[2]*f[27]+alpha_vdim[4]*f[25])+0.3872983346207416*alpha_vdim[3]*f[13]; 
  ...
  out[34] += 0.8660254037844386*f[19]*alpha_vdim[82]+0.9682458365518543*(f[4]*alpha_vdim[82]+f[9]*alpha_vdim[80])+0.4330127018922193*(alpha_vdim[3]*f[35]+alpha_vdim[0]*f[32])+0.3872983346207416*alpha_vdim[4]*f[4]; 
  out[35] += 0.9682458365518543*(f[14]*alpha_vdim[82]+f[10]*alpha_vdim[80])+0.4330127018922193*(f[34]*alpha_vdim[42]+f[32]*alpha_vdim[40]); 
  out[36] += 0.8660254037844386*f[21]*alpha_vdim[82]+0.9682458365518543*(f[8]*alpha_vdim[82]+f[12]*alpha_vdim[80])+0.4330127018922193*(alpha_vdim[3]*f[37]+alpha_cdim[0]*f[34]+alpha_vdim[0]*f[33]+alpha_cdim[2]*f[32])+0.3872983346207416*alpha_vdim[4]*f[8]; 
  ...
  out[38] += 0.8660254037844386*f[22]*alpha_vdim[82]+0.9682458365518543*(f[10]*alpha_vdim[82]+f[14]*alpha_vdim[80])+0.4330127018922193*(f[32]*alpha_vdim[42]+f[34]*alpha_vdim[40]+alpha_vdim[0]*f[35]+alpha_vdim[3]*f[32])+0.3872983346207416*alpha_vdim[4]*f[10]; 
  out[39] += 0.8660254037844386*f[23]*alpha_vdim[82]+0.9682458365518543*(f[13]*alpha_vdim[82]+f[15]*alpha_vdim[80])+0.4330127018922193*(f[33]*alpha_vdim[42]+f[36]*alpha_vdim[40]+alpha_cdim[0]*f[38]+alpha_vdim[0]*f[37]+alpha_cdim[2]*f[35]+alpha_vdim[3]*f[33])+0.3872983346207416*alpha_vdim[4]*f[13]; 
