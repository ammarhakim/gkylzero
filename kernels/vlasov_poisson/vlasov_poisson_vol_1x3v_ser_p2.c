...
{ 
  ...
  out[44] += 0.8660254037844386*alpha_cdim[2]*f[45]+0.4330127018922193*alpha_vdim[0]*f[37]+0.9682458365518543*alpha_cdim[0]*f[31]+(0.9682458365518543*alpha_cdim[2]+0.3872983346207416*alpha_vdim[1])*f[17]; 
  out[45] += 0.8660254037844386*alpha_vdim[1]*f[44]+0.4330127018922193*alpha_cdim[0]*f[38]+0.9682458365518543*alpha_vdim[0]*f[31]+(0.3872983346207416*alpha_cdim[2]+0.9682458365518543*alpha_vdim[1])*f[18]; 
