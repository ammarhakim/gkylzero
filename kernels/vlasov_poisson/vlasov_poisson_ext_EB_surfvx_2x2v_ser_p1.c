...
{ 
  ...
  alpha[2] = 1.4142135623730951*Bz[2]*wv2-2.4494897427831783*phi[3]*dx10+1.4142135623730951*Ex[2]; 
  alpha[3] = 0.408248290463863*Bz[0]*dv2; 
  alpha[4] = 1.4142135623730951*Bz[3]*wv2+1.4142135623730951*Ex[3]; 
  alpha[5] = 0.408248290463863*Bz[1]*dv2; 
  alpha[6] = 0.408248290463863*Bz[2]*dv2; 
  alpha[7] = 0.408248290463863*Bz[3]*dv2; 
  ...
  Ghat_l[3] = 0.3162277660168379*alpha[7]*fUpwind_l[11]+0.31622776601683794*alpha[6]*fUpwind_l[10]+0.31622776601683794*alpha[5]*fUpwind_l[9]+0.3162277660168379*alpha[3]*fUpwind_l[8]+0.3535533905932737*alpha[4]*fUpwind_l[7]+0.3535533905932737*fUpwind_l[4]*alpha[7]+0.3535533905932737*alpha[2]*fUpwind_l[6]+0.3535533905932737*fUpwind_l[2]*alpha[6]+0.3535533905932737*alpha[1]*fUpwind_l[5]+0.3535533905932737*fUpwind_l[1]*alpha[5]+0.3535533905932737*alpha[0]*fUpwind_l[3]+0.3535533905932737*fUpwind_l[0]*alpha[3]; 
  ...
  Ghat_l[5] = 0.3162277660168379*alpha[6]*fUpwind_l[11]+0.31622776601683794*alpha[7]*fUpwind_l[10]+0.31622776601683794*alpha[3]*fUpwind_l[9]+0.3162277660168379*alpha[5]*fUpwind_l[8]+0.3535533905932737*alpha[2]*fUpwind_l[7]+0.3535533905932737*fUpwind_l[2]*alpha[7]+0.3535533905932737*alpha[4]*fUpwind_l[6]+0.3535533905932737*fUpwind_l[4]*alpha[6]+0.3535533905932737*alpha[0]*fUpwind_l[5]+0.3535533905932737*fUpwind_l[0]*alpha[5]+0.3535533905932737*alpha[1]*fUpwind_l[3]+0.3535533905932737*fUpwind_l[1]*alpha[3]; 
  Ghat_l[6] = 0.3162277660168379*alpha[5]*fUpwind_l[11]+0.31622776601683794*alpha[3]*fUpwind_l[10]+0.31622776601683794*alpha[7]*fUpwind_l[9]+0.3162277660168379*alpha[6]*fUpwind_l[8]+0.3535533905932737*alpha[1]*fUpwind_l[7]+0.3535533905932737*fUpwind_l[1]*alpha[7]+0.3535533905932737*alpha[0]*fUpwind_l[6]+0.3535533905932737*fUpwind_l[0]*alpha[6]+0.3535533905932737*alpha[4]*fUpwind_l[5]+0.3535533905932737*fUpwind_l[4]*alpha[5]+0.3535533905932737*alpha[2]*fUpwind_l[3]+0.3535533905932737*fUpwind_l[2]*alpha[3]; 
  Ghat_l[7] = 0.3162277660168379*alpha[3]*fUpwind_l[11]+0.31622776601683794*alpha[5]*fUpwind_l[10]+0.31622776601683794*alpha[6]*fUpwind_l[9]+0.3162277660168379*alpha[7]*fUpwind_l[8]+0.3535533905932737*alpha[0]*fUpwind_l[7]+0.3535533905932737*fUpwind_l[0]*alpha[7]+0.3535533905932737*alpha[1]*fUpwind_l[6]+0.3535533905932737*fUpwind_l[1]*alpha[6]+0.3535533905932737*alpha[2]*fUpwind_l[5]+0.3535533905932737*fUpwind_l[2]*alpha[5]+0.3535533905932737*alpha[3]*fUpwind_l[4]+0.3535533905932737*fUpwind_l[3]*alpha[4]; 
  ...
  Ghat_l[9] = 0.3535533905932737*alpha[2]*fUpwind_l[11]+0.3535533905932737*alpha[4]*fUpwind_l[10]+0.3535533905932737*alpha[0]*fUpwind_l[9]+0.3535533905932737*alpha[1]*fUpwind_l[8]+0.31622776601683794*alpha[6]*fUpwind_l[7]+0.31622776601683794*fUpwind_l[6]*alpha[7]+0.31622776601683794*alpha[3]*fUpwind_l[5]+0.31622776601683794*fUpwind_l[3]*alpha[5]; 
  Ghat_l[10] = 0.3535533905932737*alpha[1]*fUpwind_l[11]+0.3535533905932737*alpha[0]*fUpwind_l[10]+0.3535533905932737*alpha[4]*fUpwind_l[9]+0.3535533905932737*alpha[2]*fUpwind_l[8]+0.31622776601683794*alpha[5]*fUpwind_l[7]+0.31622776601683794*fUpwind_l[5]*alpha[7]+0.31622776601683794*alpha[3]*fUpwind_l[6]+0.31622776601683794*fUpwind_l[3]*alpha[6]; 
  ...
  Ghat_r[3] = 0.3162277660168379*alpha[7]*fUpwind_r[11]+0.31622776601683794*alpha[6]*fUpwind_r[10]+0.31622776601683794*alpha[5]*fUpwind_r[9]+0.3162277660168379*alpha[3]*fUpwind_r[8]+0.3535533905932737*alpha[4]*fUpwind_r[7]+0.3535533905932737*fUpwind_r[4]*alpha[7]+0.3535533905932737*alpha[2]*fUpwind_r[6]+0.3535533905932737*fUpwind_r[2]*alpha[6]+0.3535533905932737*alpha[1]*fUpwind_r[5]+0.3535533905932737*fUpwind_r[1]*alpha[5]+0.3535533905932737*alpha[0]*fUpwind_r[3]+0.3535533905932737*fUpwind_r[0]*alpha[3]; 
  ...
  Ghat_r[5] = 0.3162277660168379*alpha[6]*fUpwind_r[11]+0.31622776601683794*alpha[7]*fUpwind_r[10]+0.31622776601683794*alpha[3]*fUpwind_r[9]+0.3162277660168379*alpha[5]*fUpwind_r[8]+0.3535533905932737*alpha[2]*fUpwind_r[7]+0.3535533905932737*fUpwind_r[2]*alpha[7]+0.3535533905932737*alpha[4]*fUpwind_r[6]+0.3535533905932737*fUpwind_r[4]*alpha[6]+0.3535533905932737*alpha[0]*fUpwind_r[5]+0.3535533905932737*fUpwind_r[0]*alpha[5]+0.3535533905932737*alpha[1]*fUpwind_r[3]+0.3535533905932737*fUpwind_r[1]*alpha[3]; 
  Ghat_r[6] = 0.3162277660168379*alpha[5]*fUpwind_r[11]+0.31622776601683794*alpha[3]*fUpwind_r[10]+0.31622776601683794*alpha[7]*fUpwind_r[9]+0.3162277660168379*alpha[6]*fUpwind_r[8]+0.3535533905932737*alpha[1]*fUpwind_r[7]+0.3535533905932737*fUpwind_r[1]*alpha[7]+0.3535533905932737*alpha[0]*fUpwind_r[6]+0.3535533905932737*fUpwind_r[0]*alpha[6]+0.3535533905932737*alpha[4]*fUpwind_r[5]+0.3535533905932737*fUpwind_r[4]*alpha[5]+0.3535533905932737*alpha[2]*fUpwind_r[3]+0.3535533905932737*fUpwind_r[2]*alpha[3]; 
  Ghat_r[7] = 0.3162277660168379*alpha[3]*fUpwind_r[11]+0.31622776601683794*alpha[5]*fUpwind_r[10]+0.31622776601683794*alpha[6]*fUpwind_r[9]+0.3162277660168379*alpha[7]*fUpwind_r[8]+0.3535533905932737*alpha[0]*fUpwind_r[7]+0.3535533905932737*fUpwind_r[0]*alpha[7]+0.3535533905932737*alpha[1]*fUpwind_r[6]+0.3535533905932737*fUpwind_r[1]*alpha[6]+0.3535533905932737*alpha[2]*fUpwind_r[5]+0.3535533905932737*fUpwind_r[2]*alpha[5]+0.3535533905932737*alpha[3]*fUpwind_r[4]+0.3535533905932737*fUpwind_r[3]*alpha[4]; 
  ...
  Ghat_r[9] = 0.3535533905932737*alpha[2]*fUpwind_r[11]+0.3535533905932737*alpha[4]*fUpwind_r[10]+0.3535533905932737*alpha[0]*fUpwind_r[9]+0.3535533905932737*alpha[1]*fUpwind_r[8]+0.31622776601683794*alpha[6]*fUpwind_r[7]+0.31622776601683794*fUpwind_r[6]*alpha[7]+0.31622776601683794*alpha[3]*fUpwind_r[5]+0.31622776601683794*fUpwind_r[3]*alpha[5]; 
  Ghat_r[10] = 0.3535533905932737*alpha[1]*fUpwind_r[11]+0.3535533905932737*alpha[0]*fUpwind_r[10]+0.3535533905932737*alpha[4]*fUpwind_r[9]+0.3535533905932737*alpha[2]*fUpwind_r[8]+0.31622776601683794*alpha[5]*fUpwind_r[7]+0.31622776601683794*fUpwind_r[5]*alpha[7]+0.31622776601683794*alpha[3]*fUpwind_r[6]+0.31622776601683794*fUpwind_r[3]*alpha[6]; 
