...
{ 
  ...
  Ghat_l[3] = 0.44721359549995804*alpha[1]*fUpwind_l[6]+0.5*alpha[0]*fUpwind_l[3]+0.5*alpha[1]*fUpwind_l[2]; 
  ...
  Ghat_l[6] = 0.5*alpha[0]*fUpwind_l[6]+0.44721359549995804*alpha[1]*fUpwind_l[3]; 
  ...
  Ghat_r[3] = 0.44721359549995804*alpha[1]*fUpwind_r[6]+0.5*alpha[0]*fUpwind_r[3]+0.5*alpha[1]*fUpwind_r[2]; 
  ...
  Ghat_r[6] = 0.5*alpha[0]*fUpwind_r[6]+0.44721359549995804*alpha[1]*fUpwind_r[3]; 
