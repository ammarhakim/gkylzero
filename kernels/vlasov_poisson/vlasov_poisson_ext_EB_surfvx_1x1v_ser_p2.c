...
{ 
  ...
  Ghat_l[2] = 0.45175395145262565*alpha[2]*fUpwind_l[2]+0.7071067811865475*alpha[0]*fUpwind_l[2]+0.7071067811865475*fUpwind_l[0]*alpha[2]+0.6324555320336759*alpha[1]*fUpwind_l[1]; 
  ...
  Ghat_r[2] = 0.45175395145262565*alpha[2]*fUpwind_r[2]+0.7071067811865475*alpha[0]*fUpwind_r[2]+0.7071067811865475*fUpwind_r[0]*alpha[2]+0.6324555320336759*alpha[1]*fUpwind_r[1]; 
