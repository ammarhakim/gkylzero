...
GKYL_CU_DH double vlasov_poisson_nonuniformv_boundary_surfvx_1x2v_ser_p2(const double *w, const double *dxv, const double *vcoord, const double *field, const int edge, const double *fEdge, const double *fSkin, double* GKYL_RESTRICT out) 
{ 
  ...
  Ghat[3] = 0.447213595499958*alpha[1]*fUpwind[6]+0.5*alpha[0]*fUpwind[3]+0.5*alpha[1]*fUpwind[2]; 
