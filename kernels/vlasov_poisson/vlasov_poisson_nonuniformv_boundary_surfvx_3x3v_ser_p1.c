...
GKYL_CU_DH double vlasov_poisson_nonuniformv_boundary_surfvx_3x3v_ser_p1(const double *w, const double *dxv, const double *vcoord, const double *field, const int edge, const double *fEdge, const double *fSkin, double* GKYL_RESTRICT out) 
{ 
  ...
  out[80] += -1.58113883008419*Ghat[16]*rdv2; 
  out[81] += -1.58113883008419*Ghat[17]*rdv2; 
  out[82] += -1.58113883008419*Ghat[18]*rdv2; 
  out[83] += -1.58113883008419*Ghat[19]*rdv2; 
  out[84] += -1.58113883008419*Ghat[20]*rdv2; 
  out[85] += -1.58113883008419*Ghat[21]*rdv2; 
  out[86] += -1.58113883008419*Ghat[22]*rdv2; 
  out[87] += -1.58113883008419*Ghat[23]*rdv2; 
  out[88] += -1.58113883008419*Ghat[24]*rdv2; 
  out[89] += -1.58113883008419*Ghat[25]*rdv2; 
  out[90] += -1.58113883008419*Ghat[26]*rdv2; 
  out[91] += -1.58113883008419*Ghat[27]*rdv2; 
  out[92] += -1.58113883008419*Ghat[28]*rdv2; 
  out[93] += -1.58113883008419*Ghat[29]*rdv2; 
  out[94] += -1.58113883008419*Ghat[30]*rdv2; 
  out[95] += -1.58113883008419*Ghat[31]*rdv2; 
  out[96] += -0.7071067811865475*Ghat[32]*rdv2; 
  out[97] += -0.7071067811865475*Ghat[33]*rdv2; 
  out[98] += -0.7071067811865475*Ghat[34]*rdv2; 
  out[99] += -0.7071067811865475*Ghat[35]*rdv2; 
  out[100] += -1.224744871391589*Ghat[32]*rdv2; 
  out[101] += -0.7071067811865475*Ghat[36]*rdv2; 
  out[102] += -0.7071067811865475*Ghat[37]*rdv2; 
  out[103] += -0.7071067811865475*Ghat[38]*rdv2; 
  out[104] += -0.7071067811865475*Ghat[39]*rdv2; 
  out[105] += -1.224744871391589*Ghat[33]*rdv2; 
  out[106] += -1.224744871391589*Ghat[34]*rdv2; 
  out[107] += -1.224744871391589*Ghat[35]*rdv2; 
  out[108] += -0.7071067811865475*Ghat[40]*rdv2; 
  out[109] += -0.7071067811865475*Ghat[41]*rdv2; 
  out[110] += -0.7071067811865475*Ghat[42]*rdv2; 
  out[111] += -1.224744871391589*Ghat[36]*rdv2; 
  out[112] += -0.7071067811865475*Ghat[43]*rdv2; 
  out[113] += -1.224744871391589*Ghat[37]*rdv2; 
  out[114] += -1.224744871391589*Ghat[38]*rdv2; 
  out[115] += -1.224744871391589*Ghat[39]*rdv2; 
  out[116] += -0.7071067811865475*Ghat[44]*rdv2; 
  out[117] += -0.7071067811865475*Ghat[45]*rdv2; 
  out[118] += -0.7071067811865475*Ghat[46]*rdv2; 
  out[119] += -1.224744871391589*Ghat[40]*rdv2; 
  out[120] += -1.224744871391589*Ghat[41]*rdv2; 
  out[121] += -1.224744871391589*Ghat[42]*rdv2; 
  out[122] += -1.224744871391589*Ghat[43]*rdv2; 
  out[123] += -0.7071067811865475*Ghat[47]*rdv2; 
  out[124] += -1.224744871391589*Ghat[44]*rdv2; 
  out[125] += -1.224744871391589*Ghat[45]*rdv2; 
  out[126] += -1.224744871391589*Ghat[46]*rdv2; 
  out[127] += -1.224744871391589*Ghat[47]*rdv2; 
  ...
  out[132] += -1.224744871391589*Ghat[48]*rdv2; 
  out[133] += -0.7071067811865475*Ghat[52]*rdv2; 
  out[134] += -0.7071067811865475*Ghat[53]*rdv2; 
  out[135] += -0.7071067811865475*Ghat[54]*rdv2; 
  out[136] += -0.7071067811865475*Ghat[55]*rdv2; 
  out[137] += -1.224744871391589*Ghat[49]*rdv2; 
  out[138] += -1.224744871391589*Ghat[50]*rdv2; 
  out[139] += -1.224744871391589*Ghat[51]*rdv2; 
  out[140] += -0.7071067811865475*Ghat[56]*rdv2; 
  out[141] += -0.7071067811865475*Ghat[57]*rdv2; 
  out[142] += -0.7071067811865475*Ghat[58]*rdv2; 
  out[143] += -1.224744871391589*Ghat[52]*rdv2; 
  out[144] += -0.7071067811865475*Ghat[59]*rdv2; 
  out[145] += -1.224744871391589*Ghat[53]*rdv2; 
  out[146] += -1.224744871391589*Ghat[54]*rdv2; 
  out[147] += -1.224744871391589*Ghat[55]*rdv2; 
  out[148] += -0.7071067811865475*Ghat[60]*rdv2; 
  out[149] += -0.7071067811865475*Ghat[61]*rdv2; 
  out[150] += -0.7071067811865475*Ghat[62]*rdv2; 
  out[151] += -1.224744871391589*Ghat[56]*rdv2; 
  out[152] += -1.224744871391589*Ghat[57]*rdv2; 
  out[153] += -1.224744871391589*Ghat[58]*rdv2; 
  out[154] += -1.224744871391589*Ghat[59]*rdv2; 
  out[155] += -0.7071067811865475*Ghat[63]*rdv2; 
