...
{ 
  ...
  alpha_vdim[1] = dv10*dx10*(10.954451150103324*(A2[2]*wv3+A1[2]*wv2)-10.954451150103324*phi[2]); 
  alpha_vdim[3] = 1.4142135623730951*A1[1]*dv10*dv2*dx10; 
  alpha_vdim[4] = 1.4142135623730951*A2[1]*dv10*dv3*dx10; 
  alpha_vdim[6] = 3.1622776601683795*A1[2]*dv10*dv2*dx10; 
  alpha_vdim[8] = 3.1622776601683795*A2[2]*dv10*dv3*dx10; 
  cflFreq_mid += 5.0*fabs(0.125*alpha_vdim[0]); 

  alpha_vdim[48] = -(4.898979485566357*A1[1]*dv11*dx10*wv1); 
  alpha_vdim[49] = -(10.954451150103324*A1[2]*dv11*dx10*wv1); 
  alpha_vdim[50] = -(1.4142135623730951*A1[1]*dv1*dv11*dx10); 
  alpha_vdim[53] = -(3.1622776601683795*A1[2]*dv1*dv11*dx10); 
  cflFreq_mid += 5.0*fabs(0.125*alpha_vdim[48]); 

  alpha_vdim[96] = -(4.898979485566357*A2[1]*dv12*dx10*wv1); 
  alpha_vdim[97] = -(10.954451150103324*A2[2]*dv12*dx10*wv1); 
  alpha_vdim[98] = -(1.4142135623730951*A2[1]*dv1*dv12*dx10); 
  alpha_vdim[101] = -(3.1622776601683795*A2[2]*dv1*dv12*dx10); 
