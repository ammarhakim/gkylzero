...
GKYL_CU_DH double vlasov_poisson_extem_boundary_surfvy_3x3v_ser_p1(const double *w, const double *dxv, const double *vcoord, const double *field, const int edge, const double *fEdge, const double *fSkin, double* GKYL_RESTRICT out) 
{ 
  ...
  if ((-0.2371708245126284*(alpha[21]+alpha[20]+alpha[19]+alpha[18]))+0.2371708245126284*(alpha[14]+alpha[13]+alpha[12]+alpha[11]+alpha[10]+alpha[9])+0.1767766952966368*(alpha[8]+alpha[7]+alpha[6])-0.2371708245126284*(alpha[5]+alpha[4])-0.1767766952966368*(alpha[3]+alpha[2]+alpha[1])+0.1767766952966368*alpha[0] > 0) { 
  ...
  if ((-0.2371708245126284*(alpha[21]+alpha[20]+alpha[19]+alpha[18]+alpha[14]+alpha[13]+alpha[12]+alpha[11]+alpha[10]+alpha[9]))+0.1767766952966368*(alpha[8]+alpha[7]+alpha[6])-0.2371708245126284*(alpha[5]+alpha[4])+0.1767766952966368*(alpha[3]+alpha[2]+alpha[1]+alpha[0]) > 0) { 
