...
GKYL_CU_DH double vlasov_poisson_nonuniformv_boundary_surfvy_2x3v_ser_p2(const double *w, const double *dxv, const double *vcoord, const double *field, const int edge, const double *fEdge, const double *fSkin, double* GKYL_RESTRICT out) 
{ 
  ...
  alpha[2] = -7.745966692414834*phi[5]*rdy2; 
  alpha[5] = -7.745966692414834*phi[7]*rdy2; 
  alpha[11] = -3.464101615137754*phi[6]*rdy2; 
