...
GKYL_CU_DH double vlasov_poisson_ext_EB_boundary_surfvy_1x2v_ser_p2(const double *w, const double *dxv, const double *pots, const double *EBext, const int edge, const double *fEdge, const double *fSkin, double* GKYL_RESTRICT out) 
{ 
  ...
  alpha[0] = 1.4142135623730951*Ey[0]-1.4142135623730951*Bz[0]*wv1; 
  alpha[1] = 1.4142135623730951*Ey[1]-1.4142135623730951*Bz[1]*wv1; 
  alpha[2] = -(0.408248290463863*Bz[0]*dv1); 
  alpha[3] = -(0.408248290463863*Bz[1]*dv1); 
  alpha[4] = 1.4142135623730951*Ey[2]-1.4142135623730951*Bz[2]*wv1; 
  alpha[6] = -(0.40824829046386296*Bz[2]*dv1); 
