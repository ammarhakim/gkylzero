...
{ 
  ...
  temp_sq[0] = 1.414213562373095*GammaV2[1]*V_drift_1_sq[1]*wx2_sq+1.414213562373095*GammaV2[0]*V_drift_1_sq[0]*wx2_sq+2.828427124746191*V_drift_0[1]*V_drift_1[1]*wx1*wx2+2.828427124746191*V_drift_0[0]*V_drift_1[0]*wx1*wx2+1.414213562373095*GammaV2[1]*V_drift_0_sq[1]*wx1_sq+1.414213562373095*GammaV2[0]*V_drift_0_sq[0]*wx1_sq+0.1178511301977579*GammaV2[1]*V_drift_1_sq[1]*dv2_sq+0.1178511301977579*GammaV2[0]*V_drift_1_sq[0]*dv2_sq+0.1178511301977579*GammaV2[1]*V_drift_0_sq[1]*dv1_sq+0.1178511301977579*GammaV2[0]*V_drift_0_sq[0]*dv1_sq; 
  temp_sq[1] = 1.414213562373095*GammaV2[0]*V_drift_1_sq[1]*wx2_sq+1.414213562373095*V_drift_1_sq[0]*GammaV2[1]*wx2_sq+2.828427124746191*V_drift_0[0]*V_drift_1[1]*wx1*wx2+2.828427124746191*V_drift_1[0]*V_drift_0[1]*wx1*wx2+1.414213562373095*GammaV2[0]*V_drift_0_sq[1]*wx1_sq+1.414213562373095*V_drift_0_sq[0]*GammaV2[1]*wx1_sq+0.1178511301977579*GammaV2[0]*V_drift_1_sq[1]*dv2_sq+0.1178511301977579*V_drift_1_sq[0]*GammaV2[1]*dv2_sq+0.1178511301977579*GammaV2[0]*V_drift_0_sq[1]*dv1_sq+0.1178511301977579*V_drift_0_sq[0]*GammaV2[1]*dv1_sq; 
  temp_sq[2] = 0.8164965809277261*V_drift_0[1]*V_drift_1[1]*dv1*wx2+0.8164965809277261*V_drift_0[0]*V_drift_1[0]*dv1*wx2+0.8164965809277261*GammaV2[1]*V_drift_0_sq[1]*dv1*wx1+0.8164965809277261*GammaV2[0]*V_drift_0_sq[0]*dv1*wx1; 
  temp_sq[3] = 0.8164965809277261*GammaV2[1]*V_drift_1_sq[1]*dv2*wx2+0.8164965809277261*GammaV2[0]*V_drift_1_sq[0]*dv2*wx2+0.8164965809277261*V_drift_0[1]*V_drift_1[1]*dv2*wx1+0.8164965809277261*V_drift_0[0]*V_drift_1[0]*dv2*wx1; 
  temp_sq[4] = 0.8164965809277261*V_drift_0[0]*V_drift_1[1]*dv1*wx2+0.8164965809277261*V_drift_1[0]*V_drift_0[1]*dv1*wx2+0.8164965809277261*GammaV2[0]*V_drift_0_sq[1]*dv1*wx1+0.8164965809277261*V_drift_0_sq[0]*GammaV2[1]*dv1*wx1; 
  temp_sq[5] = 0.8164965809277261*GammaV2[0]*V_drift_1_sq[1]*dv2*wx2+0.8164965809277261*V_drift_1_sq[0]*GammaV2[1]*dv2*wx2+0.8164965809277261*V_drift_0[0]*V_drift_1[1]*dv2*wx1+0.8164965809277261*V_drift_1[0]*V_drift_0[1]*dv2*wx1; 
  temp_sq[6] = 0.2357022603955158*V_drift_0[1]*V_drift_1[1]*dv1*dv2+0.2357022603955158*V_drift_0[0]*V_drift_1[0]*dv1*dv2; 
  temp_sq[7] = 0.2357022603955158*V_drift_0[0]*V_drift_1[1]*dv1*dv2+0.2357022603955158*V_drift_1[0]*V_drift_0[1]*dv1*dv2; 
