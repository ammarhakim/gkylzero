...
{ 
  ...
  temp_sq[0] = 1.414213562373095*GammaV2[1]*V_drift_1_sq[1]*wx2_sq+1.414213562373095*GammaV2[0]*V_drift_1_sq[0]*wx2_sq+1.414213562373095*GammaV2[1]*V_drift_0_sq[1]*wx1_sq+1.414213562373095*GammaV2[0]*V_drift_0_sq[0]*wx1_sq+0.1178511301977579*GammaV2[1]*V_drift_1_sq[1]*dv2_sq+0.1178511301977579*GammaV2[0]*V_drift_1_sq[0]*dv2_sq+0.1178511301977579*GammaV2[1]*V_drift_0_sq[1]*dv1_sq+0.1178511301977579*GammaV2[0]*V_drift_0_sq[0]*dv1_sq; 
  temp_sq[1] = 1.414213562373095*GammaV2[0]*V_drift_1_sq[1]*wx2_sq+1.414213562373095*V_drift_1_sq[0]*GammaV2[1]*wx2_sq+1.414213562373095*GammaV2[0]*V_drift_0_sq[1]*wx1_sq+1.414213562373095*V_drift_0_sq[0]*GammaV2[1]*wx1_sq+0.1178511301977579*GammaV2[0]*V_drift_1_sq[1]*dv2_sq+0.1178511301977579*V_drift_1_sq[0]*GammaV2[1]*dv2_sq+0.1178511301977579*GammaV2[0]*V_drift_0_sq[1]*dv1_sq+0.1178511301977579*V_drift_0_sq[0]*GammaV2[1]*dv1_sq; 
  temp_sq[2] = 0.8164965809277261*GammaV2[1]*V_drift_0_sq[1]*dv1*wx1+0.8164965809277261*GammaV2[0]*V_drift_0_sq[0]*dv1*wx1; 
  temp_sq[3] = 0.8164965809277261*GammaV2[1]*V_drift_1_sq[1]*dv2*wx2+0.8164965809277261*GammaV2[0]*V_drift_1_sq[0]*dv2*wx2; 
  temp_sq[4] = 0.8164965809277261*GammaV2[0]*V_drift_0_sq[1]*dv1*wx1+0.8164965809277261*V_drift_0_sq[0]*GammaV2[1]*dv1*wx1; 
  temp_sq[5] = 0.8164965809277261*GammaV2[0]*V_drift_1_sq[1]*dv2*wx2+0.8164965809277261*V_drift_1_sq[0]*GammaV2[1]*dv2*wx2; 
  ...
  p_fac[0] = 0.5*gamma_inv[5]*temp_sq[12]+0.5*gamma_inv[4]*temp_sq[8]+0.5*gamma_inv[2]*temp_sq[3]+0.5*gamma_inv[1]*temp_sq[2]-1.414213562373095*GammaV2[1]*temp[1]+GammaV2[0]*gamma[0]+0.5*gamma_inv[0]*temp_sq[0]-1.414213562373095*GammaV2[0]*temp[0]-1.414213562373095*gamma_inv[0]; 
  p_fac[1] = 0.5000000000000001*gamma_inv[5]*temp_sq[13]+0.5000000000000001*gamma_inv[4]*temp_sq[9]+0.5*gamma_inv[2]*temp_sq[5]+0.5*gamma_inv[1]*temp_sq[4]+0.5*gamma_inv[0]*temp_sq[1]-1.414213562373095*GammaV2[0]*temp[1]+gamma[0]*GammaV2[1]-1.414213562373095*temp[0]*GammaV2[1]; 
  p_fac[2] = 0.5000000000000001*gamma_inv[7]*temp_sq[12]+0.4472135954999579*gamma_inv[1]*temp_sq[8]-1.414213562373095*GammaV2[1]*temp[4]+0.4472135954999579*temp_sq[2]*gamma_inv[4]+0.5*gamma_inv[3]*temp_sq[3]+0.5*gamma_inv[0]*temp_sq[2]-1.414213562373095*GammaV2[0]*temp[2]+GammaV2[0]*gamma[1]+0.5*temp_sq[0]*gamma_inv[1]-1.414213562373095*gamma_inv[1]; 
  p_fac[3] = 0.4472135954999579*gamma_inv[2]*temp_sq[12]+0.5000000000000001*gamma_inv[6]*temp_sq[8]-1.414213562373095*GammaV2[1]*temp[5]+0.4472135954999579*temp_sq[3]*gamma_inv[5]+0.5*gamma_inv[0]*temp_sq[3]-1.414213562373095*GammaV2[0]*temp[3]+0.5*temp_sq[2]*gamma_inv[3]+GammaV2[0]*gamma[2]+0.5*temp_sq[0]*gamma_inv[2]-1.414213562373095*gamma_inv[2]; 
  p_fac[4] = 0.5*gamma_inv[7]*temp_sq[13]+0.447213595499958*gamma_inv[1]*temp_sq[9]+0.5*gamma_inv[3]*temp_sq[5]+0.4472135954999579*gamma_inv[4]*temp_sq[4]+0.5*gamma_inv[0]*temp_sq[4]-1.414213562373095*GammaV2[0]*temp[4]-1.414213562373095*GammaV2[1]*temp[2]+GammaV2[1]*gamma[1]+0.5*gamma_inv[1]*temp_sq[1]; 
  p_fac[5] = 0.447213595499958*gamma_inv[2]*temp_sq[13]+0.5*gamma_inv[6]*temp_sq[9]+0.4472135954999579*gamma_inv[5]*temp_sq[5]+0.5*gamma_inv[0]*temp_sq[5]-1.414213562373095*GammaV2[0]*temp[5]+0.5*gamma_inv[3]*temp_sq[4]-1.414213562373095*GammaV2[1]*temp[3]+GammaV2[1]*gamma[2]+0.5*temp_sq[1]*gamma_inv[2]; 
  p_fac[6] = 0.4472135954999579*gamma_inv[3]*temp_sq[12]+0.4472135954999579*gamma_inv[3]*temp_sq[8]+0.447213595499958*temp_sq[3]*gamma_inv[7]+0.447213595499958*temp_sq[2]*gamma_inv[6]+GammaV2[0]*gamma[3]+0.5*gamma_inv[1]*temp_sq[3]+0.5*temp_sq[0]*gamma_inv[3]-1.414213562373095*gamma_inv[3]+0.5*gamma_inv[2]*temp_sq[2]; 
  p_fac[7] = 0.447213595499958*gamma_inv[3]*temp_sq[13]+0.447213595499958*gamma_inv[3]*temp_sq[9]+0.447213595499958*temp_sq[5]*gamma_inv[7]+0.447213595499958*temp_sq[4]*gamma_inv[6]+0.5*gamma_inv[1]*temp_sq[5]+0.5*gamma_inv[2]*temp_sq[4]+GammaV2[1]*gamma[3]+0.5*temp_sq[1]*gamma_inv[3]; 
  ...
  p_fac[9] = 0.31943828249997*gamma_inv[4]*temp_sq[9]+0.5*gamma_inv[0]*temp_sq[9]+0.5*temp_sq[5]*gamma_inv[6]+1.0*GammaV2[1]*gamma[4]+0.447213595499958*gamma_inv[1]*temp_sq[4]+0.5000000000000001*temp_sq[1]*gamma_inv[4]; 
  p_fac[10] = 0.4472135954999579*gamma_inv[6]*temp_sq[12]+0.31943828249997*gamma_inv[6]*temp_sq[8]+0.5000000000000001*gamma_inv[2]*temp_sq[8]+GammaV2[0]*gamma[6]+0.5*temp_sq[0]*gamma_inv[6]-1.414213562373095*gamma_inv[6]+0.5000000000000001*temp_sq[3]*gamma_inv[4]+0.447213595499958*temp_sq[2]*gamma_inv[3]; 
  p_fac[11] = 0.4472135954999579*gamma_inv[6]*temp_sq[13]+0.31943828249997*gamma_inv[6]*temp_sq[9]+0.5000000000000001*gamma_inv[2]*temp_sq[9]+1.0*GammaV2[1]*gamma[6]+0.5000000000000001*temp_sq[1]*gamma_inv[6]+0.5*gamma_inv[4]*temp_sq[5]+0.4472135954999579*gamma_inv[3]*temp_sq[4]; 
  p_fac[12] = 0.31943828249997*gamma_inv[5]*temp_sq[12]+0.5*gamma_inv[0]*temp_sq[12]+0.5000000000000001*temp_sq[2]*gamma_inv[7]+GammaV2[0]*gamma[5]+0.5*temp_sq[0]*gamma_inv[5]-1.414213562373095*gamma_inv[5]+0.4472135954999579*gamma_inv[2]*temp_sq[3]; 
  p_fac[13] = 0.31943828249997*gamma_inv[5]*temp_sq[13]+0.5*gamma_inv[0]*temp_sq[13]+0.5*temp_sq[4]*gamma_inv[7]+1.0*GammaV2[1]*gamma[5]+0.447213595499958*gamma_inv[2]*temp_sq[5]+0.5000000000000001*temp_sq[1]*gamma_inv[5]; 
  p_fac[14] = 0.31943828249997*gamma_inv[7]*temp_sq[12]+0.5000000000000001*gamma_inv[1]*temp_sq[12]+0.4472135954999579*gamma_inv[7]*temp_sq[8]+GammaV2[0]*gamma[7]+0.5*temp_sq[0]*gamma_inv[7]-1.414213562373095*gamma_inv[7]+0.5000000000000001*temp_sq[2]*gamma_inv[5]+0.447213595499958*gamma_inv[3]*temp_sq[3]; 
  p_fac[15] = 0.31943828249997*gamma_inv[7]*temp_sq[13]+0.5000000000000001*gamma_inv[1]*temp_sq[13]+0.4472135954999579*gamma_inv[7]*temp_sq[9]+1.0*GammaV2[1]*gamma[7]+0.5000000000000001*temp_sq[1]*gamma_inv[7]+0.4472135954999579*gamma_inv[3]*temp_sq[5]+0.5*temp_sq[4]*gamma_inv[5]; 
