...
{ 
  ...
  double alpha_u_l[8] = {0.0}; 
  double alpha_u_c[8] = {0.0}; 
  double alpha_u_r[8] = {0.0}; 
  double vth_sq_l[8] = {0.0}; 
  double vth_sq_c[8] = {0.0}; 
  double vth_sq_r[8] = {0.0}; 
  ...
  alpha_l_r = ser_2x_p2_surfx1_eval_quad_node_0_r(alpha_u_l); 
  alpha_c_l = ser_2x_p2_surfx1_eval_quad_node_0_l(alpha_u_c); 
  alpha_c_r = ser_2x_p2_surfx1_eval_quad_node_0_r(alpha_u_c); 
  alpha_r_l = ser_2x_p2_surfx1_eval_quad_node_0_l(alpha_u_r); 
  alphaQuad_l = fmax(fabs(alpha_l_r), fabs(alpha_c_l)); 
  alphaQuad_r = fmax(fabs(alpha_c_r), fabs(alpha_r_l)); 
  vth_sq_l_r = ser_2x_p2_surfx1_eval_quad_node_0_r(vth_sq_l); 
  vth_sq_c_l = ser_2x_p2_surfx1_eval_quad_node_0_l(vth_sq_c); 
  vth_sq_c_r = ser_2x_p2_surfx1_eval_quad_node_0_r(vth_sq_c); 
  vth_sq_r_l = ser_2x_p2_surfx1_eval_quad_node_0_l(vth_sq_r); 
  ...
  F_0_l_r = ser_2x_p2_surfx1_eval_quad_node_0_r(F_0l); 
  F_0_c_l = ser_2x_p2_surfx1_eval_quad_node_0_l(F_0c); 
  F_0_c_r = ser_2x_p2_surfx1_eval_quad_node_0_r(F_0c); 
  F_0_r_l = ser_2x_p2_surfx1_eval_quad_node_0_l(F_0r); 
  ...
  G_1_l_r = ser_2x_p2_surfx1_eval_quad_node_0_r(G_1l); 
  G_1_c_l = ser_2x_p2_surfx1_eval_quad_node_0_l(G_1c); 
  G_1_c_r = ser_2x_p2_surfx1_eval_quad_node_0_r(G_1c); 
  G_1_r_l = ser_2x_p2_surfx1_eval_quad_node_0_l(G_1r); 
  ...
  alpha_l_r = ser_2x_p2_surfx1_eval_quad_node_1_r(alpha_u_l); 
  alpha_c_l = ser_2x_p2_surfx1_eval_quad_node_1_l(alpha_u_c); 
  alpha_c_r = ser_2x_p2_surfx1_eval_quad_node_1_r(alpha_u_c); 
  alpha_r_l = ser_2x_p2_surfx1_eval_quad_node_1_l(alpha_u_r); 
  alphaQuad_l = fmax(fabs(alpha_l_r), fabs(alpha_c_l)); 
  alphaQuad_r = fmax(fabs(alpha_c_r), fabs(alpha_r_l)); 
  vth_sq_l_r = ser_2x_p2_surfx1_eval_quad_node_1_r(vth_sq_l); 
  vth_sq_c_l = ser_2x_p2_surfx1_eval_quad_node_1_l(vth_sq_c); 
  vth_sq_c_r = ser_2x_p2_surfx1_eval_quad_node_1_r(vth_sq_c); 
  vth_sq_r_l = ser_2x_p2_surfx1_eval_quad_node_1_l(vth_sq_r); 
  vthQuad_l = fmax(sqrt(fabs(vth_sq_l_r)), sqrt(fabs(vth_sq_c_l))); 
  vthQuad_r = fmax(sqrt(fabs(vth_sq_c_r)), sqrt(fabs(vth_sq_r_l))); 
  max_speed_l = alphaQuad_l + vthQuad_l; 
  max_speed_r = alphaQuad_r + vthQuad_r; 
  F_0_l_r = ser_2x_p2_surfx1_eval_quad_node_1_r(F_0l); 
  F_0_c_l = ser_2x_p2_surfx1_eval_quad_node_1_l(F_0c); 
  F_0_c_r = ser_2x_p2_surfx1_eval_quad_node_1_r(F_0c); 
  F_0_r_l = ser_2x_p2_surfx1_eval_quad_node_1_l(F_0r); 
  ...
  G_1_l_r = ser_2x_p2_surfx1_eval_quad_node_1_r(G_1l); 
  G_1_c_l = ser_2x_p2_surfx1_eval_quad_node_1_l(G_1c); 
  G_1_c_r = ser_2x_p2_surfx1_eval_quad_node_1_r(G_1c); 
  G_1_r_l = ser_2x_p2_surfx1_eval_quad_node_1_l(G_1r); 
  ...
  alpha_l_r = ser_2x_p2_surfx1_eval_quad_node_2_r(alpha_u_l); 
  alpha_c_l = ser_2x_p2_surfx1_eval_quad_node_2_l(alpha_u_c); 
  alpha_c_r = ser_2x_p2_surfx1_eval_quad_node_2_r(alpha_u_c); 
  alpha_r_l = ser_2x_p2_surfx1_eval_quad_node_2_l(alpha_u_r); 
  alphaQuad_l = fmax(fabs(alpha_l_r), fabs(alpha_c_l)); 
  alphaQuad_r = fmax(fabs(alpha_c_r), fabs(alpha_r_l)); 
  vth_sq_l_r = ser_2x_p2_surfx1_eval_quad_node_2_r(vth_sq_l); 
  vth_sq_c_l = ser_2x_p2_surfx1_eval_quad_node_2_l(vth_sq_c); 
  vth_sq_c_r = ser_2x_p2_surfx1_eval_quad_node_2_r(vth_sq_c); 
  vth_sq_r_l = ser_2x_p2_surfx1_eval_quad_node_2_l(vth_sq_r); 
  vthQuad_l = fmax(sqrt(fabs(vth_sq_l_r)), sqrt(fabs(vth_sq_c_l))); 
  vthQuad_r = fmax(sqrt(fabs(vth_sq_c_r)), sqrt(fabs(vth_sq_r_l))); 
  max_speed_l = alphaQuad_l + vthQuad_l; 
  max_speed_r = alphaQuad_r + vthQuad_r; 
  F_0_l_r = ser_2x_p2_surfx1_eval_quad_node_2_r(F_0l); 
  F_0_c_l = ser_2x_p2_surfx1_eval_quad_node_2_l(F_0c); 
  F_0_c_r = ser_2x_p2_surfx1_eval_quad_node_2_r(F_0c); 
  F_0_r_l = ser_2x_p2_surfx1_eval_quad_node_2_l(F_0r); 
  ...
  G_1_l_r = ser_2x_p2_surfx1_eval_quad_node_2_r(G_1l); 
  G_1_c_l = ser_2x_p2_surfx1_eval_quad_node_2_l(G_1c); 
  G_1_c_r = ser_2x_p2_surfx1_eval_quad_node_2_r(G_1c); 
  G_1_r_l = ser_2x_p2_surfx1_eval_quad_node_2_l(G_1r); 
  ...
  // Project tensor nodal quadrature basis back onto modal basis. 
  ser_2x_p2_upwind_quad_to_modal(lax_F_0_quad_l, lax_F_0_modal_l); 
  ser_2x_p2_upwind_quad_to_modal(lax_F_0_quad_r, lax_F_0_modal_r); 
  ser_2x_p2_upwind_quad_to_modal(lax_G_1_quad_l, lax_G_1_modal_l); 
  ser_2x_p2_upwind_quad_to_modal(lax_G_1_quad_r, lax_G_1_modal_r); 
