...
{ 
  ...
  if ((-0.25*(alpha[12]+alpha[11]))+0.25*(alpha[9]+alpha[8]+alpha[7]+alpha[6]+alpha[5])-0.25*(alpha[4]+alpha[3]+alpha[2]+alpha[1])+0.25*alpha[0] > 0) { 
    fUpwindQuad[0] = tensor_5x_p1_surfx5_eval_quad_node_0_r(fSkin); 
  } else { 
    fUpwindQuad[0] = tensor_5x_p1_surfx5_eval_quad_node_0_l(fEdge); 
  } 
  if (0.25*alpha[12]-0.25*(alpha[11]+alpha[9]+alpha[8])+0.25*(alpha[7]+alpha[6]+alpha[5]+alpha[4])-0.25*(alpha[3]+alpha[2]+alpha[1])+0.25*alpha[0] > 0) { 
    fUpwindQuad[1] = tensor_5x_p1_surfx5_eval_quad_node_1_r(fSkin); 
  } else { 
    fUpwindQuad[1] = tensor_5x_p1_surfx5_eval_quad_node_1_l(fEdge); 
  } 
  if ((-0.25*alpha[12])+0.25*(alpha[11]+alpha[9]+alpha[8])-0.25*(alpha[7]+alpha[6])+0.25*alpha[5]-0.25*alpha[4]+0.25*alpha[3]-0.25*(alpha[2]+alpha[1])+0.25*alpha[0] > 0) { 
    fUpwindQuad[2] = tensor_5x_p1_surfx5_eval_quad_node_2_r(fSkin); 
  } else { 
    fUpwindQuad[2] = tensor_5x_p1_surfx5_eval_quad_node_2_l(fEdge); 
  } 
  if (0.25*(alpha[12]+alpha[11])-0.25*(alpha[9]+alpha[8]+alpha[7]+alpha[6])+0.25*(alpha[5]+alpha[4]+alpha[3])-0.25*(alpha[2]+alpha[1])+0.25*alpha[0] > 0) { 
    fUpwindQuad[3] = tensor_5x_p1_surfx5_eval_quad_node_3_r(fSkin); 
  } else { 
    fUpwindQuad[3] = tensor_5x_p1_surfx5_eval_quad_node_3_l(fEdge); 
  } 
  if (0.25*(alpha[12]+alpha[11])-0.25*alpha[9]+0.25*alpha[8]-0.25*alpha[7]+0.25*alpha[6]-0.25*(alpha[5]+alpha[4]+alpha[3])+0.25*alpha[2]-0.25*alpha[1]+0.25*alpha[0] > 0) { 
    fUpwindQuad[4] = tensor_5x_p1_surfx5_eval_quad_node_4_r(fSkin); 
  } else { 
    fUpwindQuad[4] = tensor_5x_p1_surfx5_eval_quad_node_4_l(fEdge); 
  } 
  if ((-0.25*alpha[12])+0.25*(alpha[11]+alpha[9])-0.25*(alpha[8]+alpha[7])+0.25*alpha[6]-0.25*alpha[5]+0.25*alpha[4]-0.25*alpha[3]+0.25*alpha[2]-0.25*alpha[1]+0.25*alpha[0] > 0) { 
    fUpwindQuad[5] = tensor_5x_p1_surfx5_eval_quad_node_5_r(fSkin); 
  } else { 
    fUpwindQuad[5] = tensor_5x_p1_surfx5_eval_quad_node_5_l(fEdge); 
  } 
  if (0.25*alpha[12]-0.25*(alpha[11]+alpha[9])+0.25*(alpha[8]+alpha[7])-0.25*(alpha[6]+alpha[5]+alpha[4])+0.25*(alpha[3]+alpha[2])-0.25*alpha[1]+0.25*alpha[0] > 0) { 
    fUpwindQuad[6] = tensor_5x_p1_surfx5_eval_quad_node_6_r(fSkin); 
  } else { 
    fUpwindQuad[6] = tensor_5x_p1_surfx5_eval_quad_node_6_l(fEdge); 
  } 
  if ((-0.25*(alpha[12]+alpha[11]))+0.25*alpha[9]-0.25*alpha[8]+0.25*alpha[7]-0.25*(alpha[6]+alpha[5])+0.25*(alpha[4]+alpha[3]+alpha[2])-0.25*alpha[1]+0.25*alpha[0] > 0) { 
    fUpwindQuad[7] = tensor_5x_p1_surfx5_eval_quad_node_7_r(fSkin); 
  } else { 
    fUpwindQuad[7] = tensor_5x_p1_surfx5_eval_quad_node_7_l(fEdge); 
  } 
  if (0.25*(alpha[12]+alpha[11]+alpha[9])-0.25*alpha[8]+0.25*alpha[7]-0.25*(alpha[6]+alpha[5]+alpha[4]+alpha[3]+alpha[2])+0.25*(alpha[1]+alpha[0]) > 0) { 
    fUpwindQuad[8] = tensor_5x_p1_surfx5_eval_quad_node_8_r(fSkin); 
  } else { 
    fUpwindQuad[8] = tensor_5x_p1_surfx5_eval_quad_node_8_l(fEdge); 
  } 
  if ((-0.25*alpha[12])+0.25*alpha[11]-0.25*alpha[9]+0.25*(alpha[8]+alpha[7])-0.25*(alpha[6]+alpha[5])+0.25*alpha[4]-0.25*(alpha[3]+alpha[2])+0.25*(alpha[1]+alpha[0]) > 0) { 
    fUpwindQuad[9] = tensor_5x_p1_surfx5_eval_quad_node_9_r(fSkin); 
  } else { 
    fUpwindQuad[9] = tensor_5x_p1_surfx5_eval_quad_node_9_l(fEdge); 
  } 
  if (0.25*alpha[12]-0.25*alpha[11]+0.25*alpha[9]-0.25*(alpha[8]+alpha[7])+0.25*alpha[6]-0.25*(alpha[5]+alpha[4])+0.25*alpha[3]-0.25*alpha[2]+0.25*(alpha[1]+alpha[0]) > 0) { 
    fUpwindQuad[10] = tensor_5x_p1_surfx5_eval_quad_node_10_r(fSkin); 
  } else { 
    fUpwindQuad[10] = tensor_5x_p1_surfx5_eval_quad_node_10_l(fEdge); 
  } 
  if ((-0.25*(alpha[12]+alpha[11]+alpha[9]))+0.25*alpha[8]-0.25*alpha[7]+0.25*alpha[6]-0.25*alpha[5]+0.25*(alpha[4]+alpha[3])-0.25*alpha[2]+0.25*(alpha[1]+alpha[0]) > 0) { 
    fUpwindQuad[11] = tensor_5x_p1_surfx5_eval_quad_node_11_r(fSkin); 
  } else { 
    fUpwindQuad[11] = tensor_5x_p1_surfx5_eval_quad_node_11_l(fEdge); 
  } 
  if ((-0.25*(alpha[12]+alpha[11]+alpha[9]+alpha[8]+alpha[7]+alpha[6]))+0.25*alpha[5]-0.25*(alpha[4]+alpha[3])+0.25*(alpha[2]+alpha[1]+alpha[0]) > 0) { 
    fUpwindQuad[12] = tensor_5x_p1_surfx5_eval_quad_node_12_r(fSkin); 
  } else { 
    fUpwindQuad[12] = tensor_5x_p1_surfx5_eval_quad_node_12_l(fEdge); 
  } 
  if (0.25*alpha[12]-0.25*alpha[11]+0.25*(alpha[9]+alpha[8])-0.25*(alpha[7]+alpha[6])+0.25*(alpha[5]+alpha[4])-0.25*alpha[3]+0.25*(alpha[2]+alpha[1]+alpha[0]) > 0) { 
    fUpwindQuad[13] = tensor_5x_p1_surfx5_eval_quad_node_13_r(fSkin); 
  } else { 
    fUpwindQuad[13] = tensor_5x_p1_surfx5_eval_quad_node_13_l(fEdge); 
  } 
  if ((-0.25*alpha[12])+0.25*alpha[11]-0.25*(alpha[9]+alpha[8])+0.25*(alpha[7]+alpha[6]+alpha[5])-0.25*alpha[4]+0.25*(alpha[3]+alpha[2]+alpha[1]+alpha[0]) > 0) { 
    fUpwindQuad[14] = tensor_5x_p1_surfx5_eval_quad_node_14_r(fSkin); 
  } else { 
    fUpwindQuad[14] = tensor_5x_p1_surfx5_eval_quad_node_14_l(fEdge); 
  } 
  if (0.25*(alpha[12]+alpha[11]+alpha[9]+alpha[8]+alpha[7]+alpha[6]+alpha[5]+alpha[4]+alpha[3]+alpha[2]+alpha[1]+alpha[0]) > 0) { 
    fUpwindQuad[15] = tensor_5x_p1_surfx5_eval_quad_node_15_r(fSkin); 
  } else { 
    fUpwindQuad[15] = tensor_5x_p1_surfx5_eval_quad_node_15_l(fEdge); 
  } 
  ...
  if ((-0.25*(alpha[12]+alpha[11]))+0.25*(alpha[9]+alpha[8]+alpha[7]+alpha[6]+alpha[5])-0.25*(alpha[4]+alpha[3]+alpha[2]+alpha[1])+0.25*alpha[0] > 0) { 
    fUpwindQuad[0] = tensor_5x_p1_surfx5_eval_quad_node_0_r(fEdge); 
  } else { 
    fUpwindQuad[0] = tensor_5x_p1_surfx5_eval_quad_node_0_l(fSkin); 
  } 
  if (0.25*alpha[12]-0.25*(alpha[11]+alpha[9]+alpha[8])+0.25*(alpha[7]+alpha[6]+alpha[5]+alpha[4])-0.25*(alpha[3]+alpha[2]+alpha[1])+0.25*alpha[0] > 0) { 
    fUpwindQuad[1] = tensor_5x_p1_surfx5_eval_quad_node_1_r(fEdge); 
  } else { 
    fUpwindQuad[1] = tensor_5x_p1_surfx5_eval_quad_node_1_l(fSkin); 
  } 
  if ((-0.25*alpha[12])+0.25*(alpha[11]+alpha[9]+alpha[8])-0.25*(alpha[7]+alpha[6])+0.25*alpha[5]-0.25*alpha[4]+0.25*alpha[3]-0.25*(alpha[2]+alpha[1])+0.25*alpha[0] > 0) { 
    fUpwindQuad[2] = tensor_5x_p1_surfx5_eval_quad_node_2_r(fEdge); 
  } else { 
    fUpwindQuad[2] = tensor_5x_p1_surfx5_eval_quad_node_2_l(fSkin); 
  } 
  if (0.25*(alpha[12]+alpha[11])-0.25*(alpha[9]+alpha[8]+alpha[7]+alpha[6])+0.25*(alpha[5]+alpha[4]+alpha[3])-0.25*(alpha[2]+alpha[1])+0.25*alpha[0] > 0) { 
    fUpwindQuad[3] = tensor_5x_p1_surfx5_eval_quad_node_3_r(fEdge); 
  } else { 
    fUpwindQuad[3] = tensor_5x_p1_surfx5_eval_quad_node_3_l(fSkin); 
  } 
  if (0.25*(alpha[12]+alpha[11])-0.25*alpha[9]+0.25*alpha[8]-0.25*alpha[7]+0.25*alpha[6]-0.25*(alpha[5]+alpha[4]+alpha[3])+0.25*alpha[2]-0.25*alpha[1]+0.25*alpha[0] > 0) { 
    fUpwindQuad[4] = tensor_5x_p1_surfx5_eval_quad_node_4_r(fEdge); 
  } else { 
    fUpwindQuad[4] = tensor_5x_p1_surfx5_eval_quad_node_4_l(fSkin); 
  } 
  if ((-0.25*alpha[12])+0.25*(alpha[11]+alpha[9])-0.25*(alpha[8]+alpha[7])+0.25*alpha[6]-0.25*alpha[5]+0.25*alpha[4]-0.25*alpha[3]+0.25*alpha[2]-0.25*alpha[1]+0.25*alpha[0] > 0) { 
    fUpwindQuad[5] = tensor_5x_p1_surfx5_eval_quad_node_5_r(fEdge); 
  } else { 
    fUpwindQuad[5] = tensor_5x_p1_surfx5_eval_quad_node_5_l(fSkin); 
  } 
  if (0.25*alpha[12]-0.25*(alpha[11]+alpha[9])+0.25*(alpha[8]+alpha[7])-0.25*(alpha[6]+alpha[5]+alpha[4])+0.25*(alpha[3]+alpha[2])-0.25*alpha[1]+0.25*alpha[0] > 0) { 
    fUpwindQuad[6] = tensor_5x_p1_surfx5_eval_quad_node_6_r(fEdge); 
  } else { 
    fUpwindQuad[6] = tensor_5x_p1_surfx5_eval_quad_node_6_l(fSkin); 
  } 
  if ((-0.25*(alpha[12]+alpha[11]))+0.25*alpha[9]-0.25*alpha[8]+0.25*alpha[7]-0.25*(alpha[6]+alpha[5])+0.25*(alpha[4]+alpha[3]+alpha[2])-0.25*alpha[1]+0.25*alpha[0] > 0) { 
    fUpwindQuad[7] = tensor_5x_p1_surfx5_eval_quad_node_7_r(fEdge); 
  } else { 
    fUpwindQuad[7] = tensor_5x_p1_surfx5_eval_quad_node_7_l(fSkin); 
  } 
  if (0.25*(alpha[12]+alpha[11]+alpha[9])-0.25*alpha[8]+0.25*alpha[7]-0.25*(alpha[6]+alpha[5]+alpha[4]+alpha[3]+alpha[2])+0.25*(alpha[1]+alpha[0]) > 0) { 
    fUpwindQuad[8] = tensor_5x_p1_surfx5_eval_quad_node_8_r(fEdge); 
  } else { 
    fUpwindQuad[8] = tensor_5x_p1_surfx5_eval_quad_node_8_l(fSkin); 
  } 
  if ((-0.25*alpha[12])+0.25*alpha[11]-0.25*alpha[9]+0.25*(alpha[8]+alpha[7])-0.25*(alpha[6]+alpha[5])+0.25*alpha[4]-0.25*(alpha[3]+alpha[2])+0.25*(alpha[1]+alpha[0]) > 0) { 
    fUpwindQuad[9] = tensor_5x_p1_surfx5_eval_quad_node_9_r(fEdge); 
  } else { 
    fUpwindQuad[9] = tensor_5x_p1_surfx5_eval_quad_node_9_l(fSkin); 
  } 
  if (0.25*alpha[12]-0.25*alpha[11]+0.25*alpha[9]-0.25*(alpha[8]+alpha[7])+0.25*alpha[6]-0.25*(alpha[5]+alpha[4])+0.25*alpha[3]-0.25*alpha[2]+0.25*(alpha[1]+alpha[0]) > 0) { 
    fUpwindQuad[10] = tensor_5x_p1_surfx5_eval_quad_node_10_r(fEdge); 
  } else { 
    fUpwindQuad[10] = tensor_5x_p1_surfx5_eval_quad_node_10_l(fSkin); 
  } 
  if ((-0.25*(alpha[12]+alpha[11]+alpha[9]))+0.25*alpha[8]-0.25*alpha[7]+0.25*alpha[6]-0.25*alpha[5]+0.25*(alpha[4]+alpha[3])-0.25*alpha[2]+0.25*(alpha[1]+alpha[0]) > 0) { 
    fUpwindQuad[11] = tensor_5x_p1_surfx5_eval_quad_node_11_r(fEdge); 
  } else { 
    fUpwindQuad[11] = tensor_5x_p1_surfx5_eval_quad_node_11_l(fSkin); 
  } 
  if ((-0.25*(alpha[12]+alpha[11]+alpha[9]+alpha[8]+alpha[7]+alpha[6]))+0.25*alpha[5]-0.25*(alpha[4]+alpha[3])+0.25*(alpha[2]+alpha[1]+alpha[0]) > 0) { 
    fUpwindQuad[12] = tensor_5x_p1_surfx5_eval_quad_node_12_r(fEdge); 
  } else { 
    fUpwindQuad[12] = tensor_5x_p1_surfx5_eval_quad_node_12_l(fSkin); 
  } 
  if (0.25*alpha[12]-0.25*alpha[11]+0.25*(alpha[9]+alpha[8])-0.25*(alpha[7]+alpha[6])+0.25*(alpha[5]+alpha[4])-0.25*alpha[3]+0.25*(alpha[2]+alpha[1]+alpha[0]) > 0) { 
    fUpwindQuad[13] = tensor_5x_p1_surfx5_eval_quad_node_13_r(fEdge); 
  } else { 
    fUpwindQuad[13] = tensor_5x_p1_surfx5_eval_quad_node_13_l(fSkin); 
  } 
  if ((-0.25*alpha[12])+0.25*alpha[11]-0.25*(alpha[9]+alpha[8])+0.25*(alpha[7]+alpha[6]+alpha[5])-0.25*alpha[4]+0.25*(alpha[3]+alpha[2]+alpha[1]+alpha[0]) > 0) { 
    fUpwindQuad[14] = tensor_5x_p1_surfx5_eval_quad_node_14_r(fEdge); 
  } else { 
    fUpwindQuad[14] = tensor_5x_p1_surfx5_eval_quad_node_14_l(fSkin); 
  } 
  if (0.25*(alpha[12]+alpha[11]+alpha[9]+alpha[8]+alpha[7]+alpha[6]+alpha[5]+alpha[4]+alpha[3]+alpha[2]+alpha[1]+alpha[0]) > 0) { 
    fUpwindQuad[15] = tensor_5x_p1_surfx5_eval_quad_node_15_r(fEdge); 
  } else { 
    fUpwindQuad[15] = tensor_5x_p1_surfx5_eval_quad_node_15_l(fSkin); 
  } 
