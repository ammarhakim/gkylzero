...
GKYL_CU_DH double vlasov_stream_vol_1x2v_ser_p2(const double *w, const double *dxv, const double *qmem, const double *cot_vec, const double *f, double* GKYL_RESTRICT out) 
{ 
