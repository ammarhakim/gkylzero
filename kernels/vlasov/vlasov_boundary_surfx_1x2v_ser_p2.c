...
{ 
  ...
  Ghat[4] = (0.7071067811865475*fedge[8]-1.224744871391589*fedge[12])*wv+(0.408248290463863*fedge[11]-0.3162277660168379*fedge[4]+0.1825741858350554*fedge[2])*dv; 
  Ghat[5] = (0.7071067811865475*fedge[9]-1.224744871391589*fedge[15])*wv+(0.2041241452319315*fedge[16]-0.3535533905932737*fedge[19])*dv; 
  Ghat[6] = (0.7071067811865475*fedge[14]-1.224744871391589*fedge[18])*wv+(0.408248290463863*fedge[17]-0.3162277660168379*fedge[10]+0.1825741858350554*fedge[6])*dv; 
  Ghat[7] = (0.7071067811865475*fedge[16]-1.224744871391589*fedge[19])*wv+(0.2041241452319315*fedge[9]-0.3535533905932737*fedge[15])*dv; 
  ...
  Ghat[2] = (1.58113883008419*fskin[13]-1.224744871391589*fskin[5]+0.7071067811865475*fskin[3])*wv+(0.4564354645876384*fskin[17]-0.3535533905932737*fskin[10]+0.2041241452319315*fskin[6])*dv; 
  Ghat[3] = (1.58113883008419*fskin[17]-1.224744871391589*fskin[10]+0.7071067811865475*fskin[6])*wv+((-0.3162277660168379*fskin[18])+0.1825741858350554*fskin[14]+0.4564354645876384*fskin[13]-0.3535533905932737*fskin[5]+0.2041241452319315*fskin[3])*dv; 
  Ghat[4] = (0.7071067811865475*fskin[8]-1.224744871391589*fskin[12])*wv+(0.408248290463863*fskin[11]-0.3162277660168379*fskin[4]+0.1825741858350554*fskin[2])*dv; 
  Ghat[5] = (0.7071067811865475*fskin[9]-1.224744871391589*fskin[15])*wv+(0.2041241452319315*fskin[16]-0.3535533905932737*fskin[19])*dv; 
  Ghat[6] = (0.7071067811865475*fskin[14]-1.224744871391589*fskin[18])*wv+(0.408248290463863*fskin[17]-0.3162277660168379*fskin[10]+0.1825741858350554*fskin[6])*dv; 
  Ghat[7] = (0.7071067811865475*fskin[16]-1.224744871391589*fskin[19])*wv+(0.2041241452319315*fskin[9]-0.3535533905932737*fskin[15])*dv; 
