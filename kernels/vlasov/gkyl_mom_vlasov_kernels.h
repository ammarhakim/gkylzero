...
GKYL_CU_DH void mom_vlasov_pkpm_surfx_1x1v_ser_p1(const double *w, const double *dxv, const int *idx, double mass, const double *u_il, const double *u_ir, const double *bvarl, const double *bvarr, const double *fl, const double *fr, double* GKYL_RESTRICT out); 
...
GKYL_CU_DH void mom_vlasov_pkpm_surfx_2x1v_ser_p1(const double *w, const double *dxv, const int *idx, double mass, const double *u_il, const double *u_ir, const double *bvarl, const double *bvarr, const double *fl, const double *fr, double* GKYL_RESTRICT out); 
GKYL_CU_DH void mom_vlasov_pkpm_surfy_2x1v_ser_p1(const double *w, const double *dxv, const int *idx, double mass, const double *u_il, const double *u_ir, const double *bvarl, const double *bvarr, const double *fl, const double *fr, double* GKYL_RESTRICT out); 
...
GKYL_CU_DH void mom_vlasov_pkpm_surfy_2x1v_ser_p2(const double *w, const double *dxv, const int *idx, double mass, const double *u_il, const double *u_ir, const double *bvarl, const double *bvarr, const double *fl, const double *fr, double* GKYL_RESTRICT out); 
...
GKYL_CU_DH void mom_vlasov_pkpm_surfx_3x1v_ser_p1(const double *w, const double *dxv, const int *idx, double mass, const double *u_il, const double *u_ir, const double *bvarl, const double *bvarr, const double *fl, const double *fr, double* GKYL_RESTRICT out); 
GKYL_CU_DH void mom_vlasov_pkpm_surfy_3x1v_ser_p1(const double *w, const double *dxv, const int *idx, double mass, const double *u_il, const double *u_ir, const double *bvarl, const double *bvarr, const double *fl, const double *fr, double* GKYL_RESTRICT out); 
GKYL_CU_DH void mom_vlasov_pkpm_surfz_3x1v_ser_p1(const double *w, const double *dxv, const int *idx, double mass, const double *u_il, const double *u_ir, const double *bvarl, const double *bvarr, const double *fl, const double *fr, double* GKYL_RESTRICT out); 
...
GKYL_CU_DH void mom_vlasov_pkpm_surfx_3x1v_ser_p2(const double *w, const double *dxv, const int *idx, double mass, const double *u_il, const double *u_ir, const double *bvarl, const double *bvarr, const double *fl, const double *fr, double* GKYL_RESTRICT out); 
GKYL_CU_DH void mom_vlasov_pkpm_surfy_3x1v_ser_p2(const double *w, const double *dxv, const int *idx, double mass, const double *u_il, const double *u_ir, const double *bvarl, const double *bvarr, const double *fl, const double *fr, double* GKYL_RESTRICT out); 
GKYL_CU_DH void mom_vlasov_pkpm_surfz_3x1v_ser_p2(const double *w, const double *dxv, const int *idx, double mass, const double *u_il, const double *u_ir, const double *bvarl, const double *bvarr, const double *fl, const double *fr, double* GKYL_RESTRICT out); 
...
GKYL_CU_DH void mom_vlasov_pkpm_surfx_1x1v_tensor_p2(const double *w, const double *dxv, const int *idx, double mass, const double *u_il, const double *u_ir, const double *bvarl, const double *bvarr, const double *fl, const double *fr, double* GKYL_RESTRICT out); 
...
GKYL_CU_DH void mom_vlasov_pkpm_surfx_2x1v_tensor_p2(const double *w, const double *dxv, const int *idx, double mass, const double *u_il, const double *u_ir, const double *bvarl, const double *bvarr, const double *fl, const double *fr, double* GKYL_RESTRICT out); 
GKYL_CU_DH void mom_vlasov_pkpm_surfy_2x1v_tensor_p2(const double *w, const double *dxv, const int *idx, double mass, const double *u_il, const double *u_ir, const double *bvarl, const double *bvarr, const double *fl, const double *fr, double* GKYL_RESTRICT out); 
