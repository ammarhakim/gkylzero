...
{ 
  ...
  alphaSurf_l[0] = ((-2.738612787525831*bxbz[1]*uz[2])-2.738612787525831*bxby[1]*uy[2]-2.738612787525831*bxbx[1]*ux[2]-1.224744871391589*bxbz[0]*uz[1]-1.224744871391589*bxby[0]*uy[1]-1.224744871391589*bxbx[0]*ux[1])*dx0*wvpar+(1.369306393762915*bxbz[1]*uz[2]+1.369306393762915*bxby[1]*uy[2]+1.369306393762915*bxbx[1]*ux[2]+0.6123724356957944*bxbz[0]*uz[1]+0.6123724356957944*bxby[0]*uy[1]+0.6123724356957944*bxbx[0]*ux[1])*dvpar*dx0+(2.738612787525831*rho_inv_bz[1]*Pxz[2]+2.738612787525831*rho_inv_by[1]*Pxy[2]+2.738612787525831*rho_inv_bx[1]*Pxx[2]+1.224744871391589*rho_inv_bz[0]*Pxz[1]+1.224744871391589*rho_inv_by[0]*Pxy[1]+1.224744871391589*rho_inv_bx[0]*Pxx[1])*dx0; 
  alphaSurf_l[1] = ((-2.449489742783178*bxbz[2]*uz[2])-2.738612787525831*bxbz[0]*uz[2]-2.449489742783178*bxby[2]*uy[2]-2.738612787525831*bxby[0]*uy[2]-2.449489742783178*bxbx[2]*ux[2]-2.738612787525831*bxbx[0]*ux[2]-1.224744871391589*bxbz[1]*uz[1]-1.224744871391589*bxby[1]*uy[1]-1.224744871391589*bxbx[1]*ux[1])*dx0*wvpar+(1.224744871391589*bxbz[2]*uz[2]+1.369306393762915*bxbz[0]*uz[2]+1.224744871391589*bxby[2]*uy[2]+1.369306393762915*bxby[0]*uy[2]+1.224744871391589*bxbx[2]*ux[2]+1.369306393762915*bxbx[0]*ux[2]+0.6123724356957944*bxbz[1]*uz[1]+0.6123724356957944*bxby[1]*uy[1]+0.6123724356957944*bxbx[1]*ux[1])*dvpar*dx0+(2.449489742783178*Pxz[2]*rho_inv_bz[2]+2.449489742783178*Pxy[2]*rho_inv_by[2]+2.449489742783178*Pxx[2]*rho_inv_bx[2]+2.738612787525831*rho_inv_bz[0]*Pxz[2]+2.738612787525831*rho_inv_by[0]*Pxy[2]+2.738612787525831*rho_inv_bx[0]*Pxx[2]+1.224744871391589*Pxz[1]*rho_inv_bz[1]+1.224744871391589*Pxy[1]*rho_inv_by[1]+1.224744871391589*Pxx[1]*rho_inv_bx[1])*dx0; 
  alphaSurf_l[2] = ((-2.449489742783178*bxbz[1]*uz[2])-2.449489742783178*bxby[1]*uy[2]-2.449489742783178*bxbx[1]*ux[2]-1.224744871391589*uz[1]*bxbz[2]-1.224744871391589*uy[1]*bxby[2]-1.224744871391589*ux[1]*bxbx[2])*dx0*wvpar+(1.224744871391589*bxbz[1]*uz[2]+1.224744871391589*bxby[1]*uy[2]+1.224744871391589*bxbx[1]*ux[2]+0.6123724356957944*uz[1]*bxbz[2]+0.6123724356957944*uy[1]*bxby[2]+0.6123724356957944*ux[1]*bxbx[2])*dvpar*dx0+(1.224744871391589*Pxz[1]*rho_inv_bz[2]+1.224744871391589*Pxy[1]*rho_inv_by[2]+1.224744871391589*Pxx[1]*rho_inv_bx[2]+2.449489742783178*rho_inv_bz[1]*Pxz[2]+2.449489742783178*rho_inv_by[1]*Pxy[2]+2.449489742783178*rho_inv_bx[1]*Pxx[2])*dx0; 

  double alphaSurf_r[3] = {0.0}; 
  alphaSurf_r[0] = ((-2.738612787525831*bxbz[1]*uz[2])-2.738612787525831*bxby[1]*uy[2]-2.738612787525831*bxbx[1]*ux[2]-1.224744871391589*bxbz[0]*uz[1]-1.224744871391589*bxby[0]*uy[1]-1.224744871391589*bxbx[0]*ux[1])*dx0*wvpar+((-1.369306393762915*bxbz[1]*uz[2])-1.369306393762915*bxby[1]*uy[2]-1.369306393762915*bxbx[1]*ux[2]-0.6123724356957944*bxbz[0]*uz[1]-0.6123724356957944*bxby[0]*uy[1]-0.6123724356957944*bxbx[0]*ux[1])*dvpar*dx0+(2.738612787525831*rho_inv_bz[1]*Pxz[2]+2.738612787525831*rho_inv_by[1]*Pxy[2]+2.738612787525831*rho_inv_bx[1]*Pxx[2]+1.224744871391589*rho_inv_bz[0]*Pxz[1]+1.224744871391589*rho_inv_by[0]*Pxy[1]+1.224744871391589*rho_inv_bx[0]*Pxx[1])*dx0; 
