...
{ 
  ...
  alphaSurf_l[0] = (-2.738612787525831*bxbz[1]*uz[2]*wvpar)-2.738612787525831*bxby[1]*uy[2]*wvpar-2.738612787525831*bxbx[1]*ux[2]*wvpar-1.224744871391589*bxbz[0]*uz[1]*wvpar-1.224744871391589*bxby[0]*uy[1]*wvpar-1.224744871391589*bxbx[0]*ux[1]*wvpar+1.369306393762915*bxbz[1]*uz[2]*dvpar+1.369306393762915*bxby[1]*uy[2]*dvpar+1.369306393762915*bxbx[1]*ux[2]*dvpar+0.6123724356957944*bxbz[0]*uz[1]*dvpar+0.6123724356957944*bxby[0]*uy[1]*dvpar+0.6123724356957944*bxbx[0]*ux[1]*dvpar+2.738612787525831*rho_inv_bz[1]*Pxz[2]+2.738612787525831*rho_inv_by[1]*Pxy[2]+2.738612787525831*rho_inv_bx[1]*Pxx[2]+1.224744871391589*rho_inv_bz[0]*Pxz[1]+1.224744871391589*rho_inv_by[0]*Pxy[1]+1.224744871391589*rho_inv_bx[0]*Pxx[1]; 
  ...
  alphaSurf_r[0] = (-2.738612787525831*bxbz[1]*uz[2]*wvpar)-2.738612787525831*bxby[1]*uy[2]*wvpar-2.738612787525831*bxbx[1]*ux[2]*wvpar-1.224744871391589*bxbz[0]*uz[1]*wvpar-1.224744871391589*bxby[0]*uy[1]*wvpar-1.224744871391589*bxbx[0]*ux[1]*wvpar-1.369306393762915*bxbz[1]*uz[2]*dvpar-1.369306393762915*bxby[1]*uy[2]*dvpar-1.369306393762915*bxbx[1]*ux[2]*dvpar-0.6123724356957944*bxbz[0]*uz[1]*dvpar-0.6123724356957944*bxby[0]*uy[1]*dvpar-0.6123724356957944*bxbx[0]*ux[1]*dvpar+2.738612787525831*rho_inv_bz[1]*Pxz[2]+2.738612787525831*rho_inv_by[1]*Pxy[2]+2.738612787525831*rho_inv_bx[1]*Pxx[2]+1.224744871391589*rho_inv_bz[0]*Pxz[1]+1.224744871391589*rho_inv_by[0]*Pxy[1]+1.224744871391589*rho_inv_bx[0]*Pxx[1]; 
