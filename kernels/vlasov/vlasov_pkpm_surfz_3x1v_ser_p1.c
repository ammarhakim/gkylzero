...
{ 
  ...
  const double *uc = &u_i[16]; 
  const double *bc = &bvar[16]; 
  double alphaSurf_l[12] = {0.0}; 
  alphaSurf_l[0] = (-1.732050807568877*bc[3]*wvpar)+bc[0]*wvpar-1.732050807568877*uc[3]+uc[0]; 
  alphaSurf_l[1] = (-1.732050807568877*bc[5]*wvpar)+bc[1]*wvpar-1.732050807568877*uc[5]+uc[1]; 
  alphaSurf_l[2] = (-1.732050807568877*bc[6]*wvpar)+bc[2]*wvpar-1.732050807568877*uc[6]+uc[2]; 
  alphaSurf_l[3] = 0.2886751345948129*bc[0]*dvpar-0.5*bc[3]*dvpar; 
  alphaSurf_l[4] = (-1.732050807568877*bc[7]*wvpar)+bc[4]*wvpar-1.732050807568877*uc[7]+uc[4]; 
  alphaSurf_l[5] = 0.2886751345948129*bc[1]*dvpar-0.5*bc[5]*dvpar; 
  alphaSurf_l[6] = 0.2886751345948129*bc[2]*dvpar-0.5*bc[6]*dvpar; 
  alphaSurf_l[7] = 0.2886751345948129*bc[4]*dvpar-0.5*bc[7]*dvpar; 

  double alphaSurf_r[12] = {0.0}; 
  alphaSurf_r[0] = 1.732050807568877*bc[3]*wvpar+bc[0]*wvpar+1.732050807568877*uc[3]+uc[0]; 
  alphaSurf_r[1] = 1.732050807568877*bc[5]*wvpar+bc[1]*wvpar+1.732050807568877*uc[5]+uc[1]; 
  alphaSurf_r[2] = 1.732050807568877*bc[6]*wvpar+bc[2]*wvpar+1.732050807568877*uc[6]+uc[2]; 
  alphaSurf_r[3] = 0.5*bc[3]*dvpar+0.2886751345948129*bc[0]*dvpar; 
  alphaSurf_r[4] = 1.732050807568877*bc[7]*wvpar+bc[4]*wvpar+1.732050807568877*uc[7]+uc[4]; 
  alphaSurf_r[5] = 0.5*bc[5]*dvpar+0.2886751345948129*bc[1]*dvpar; 
  alphaSurf_r[6] = 0.5*bc[6]*dvpar+0.2886751345948129*bc[2]*dvpar; 
  alphaSurf_r[7] = 0.5*bc[7]*dvpar+0.2886751345948129*bc[4]*dvpar; 
