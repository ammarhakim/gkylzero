...
{ 
  ...
  alpha[0] = -0.7071067811865475*(2.0*B2[0]*wv1-2.0*E1[0]); 
  alpha[1] = -0.7071067811865475*(2.0*B2[1]*wv1-2.0*E1[1]); 
  alpha[2] = -0.7071067811865475*(2.0*B2[2]*wv1-2.0*E1[2]); 
  alpha[3] = -0.408248290463863*B2[0]*dv1; 
  alpha[4] = -0.7071067811865475*(2.0*B2[3]*wv1-2.0*E1[3]); 
