...
{ 
  ...
  if (0.6363961030678926*alpha[4]-0.4743416490252568*(alpha[2]+alpha[1])+0.3535533905932737*alpha[0] > 0) { 
    ...
    fUpwindQuad_l[0] = tensor_1x3v_p2_surfvy_quad_0(1, fl); 
    fUpwindQuad_r[0] = tensor_1x3v_p2_surfvy_quad_0(1, fc); 
  } else { 

    fUpwindQuad_l[0] = tensor_1x3v_p2_surfvy_quad_0(-1, fc); 
    fUpwindQuad_r[0] = tensor_1x3v_p2_surfvy_quad_0(-1, fr); 
  } 
  if (0.3535533905932737*alpha[0]-0.4743416490252568*alpha[2] > 0) { 

    fUpwindQuad_l[1] = tensor_1x3v_p2_surfvy_quad_1(1, fl); 
    fUpwindQuad_r[1] = tensor_1x3v_p2_surfvy_quad_1(1, fc); 
  } else { 

    fUpwindQuad_l[1] = tensor_1x3v_p2_surfvy_quad_1(-1, fc); 
    fUpwindQuad_r[1] = tensor_1x3v_p2_surfvy_quad_1(-1, fr); 
  } 
  if ((-0.6363961030678926*alpha[4])-0.4743416490252568*alpha[2]+0.4743416490252568*alpha[1]+0.3535533905932737*alpha[0] > 0) { 

    fUpwindQuad_l[2] = tensor_1x3v_p2_surfvy_quad_2(1, fl); 
    fUpwindQuad_r[2] = tensor_1x3v_p2_surfvy_quad_2(1, fc); 
  } else { 

    fUpwindQuad_l[2] = tensor_1x3v_p2_surfvy_quad_2(-1, fc); 
    fUpwindQuad_r[2] = tensor_1x3v_p2_surfvy_quad_2(-1, fr); 
  } 
  if (0.3535533905932737*alpha[0]-0.4743416490252568*alpha[1] > 0) { 

    fUpwindQuad_l[3] = tensor_1x3v_p2_surfvy_quad_3(1, fl); 
    fUpwindQuad_r[3] = tensor_1x3v_p2_surfvy_quad_3(1, fc); 
  } else { 

    fUpwindQuad_l[3] = tensor_1x3v_p2_surfvy_quad_3(-1, fc); 
    fUpwindQuad_r[3] = tensor_1x3v_p2_surfvy_quad_3(-1, fr); 
  } 
  if (0.3535533905932737*alpha[0] > 0) { 

    fUpwindQuad_l[4] = tensor_1x3v_p2_surfvy_quad_4(1, fl); 
    fUpwindQuad_r[4] = tensor_1x3v_p2_surfvy_quad_4(1, fc); 
  } else { 

    fUpwindQuad_l[4] = tensor_1x3v_p2_surfvy_quad_4(-1, fc); 
    fUpwindQuad_r[4] = tensor_1x3v_p2_surfvy_quad_4(-1, fr); 
  } 
  if (0.4743416490252568*alpha[1]+0.3535533905932737*alpha[0] > 0) { 

    fUpwindQuad_l[5] = tensor_1x3v_p2_surfvy_quad_5(1, fl); 
    fUpwindQuad_r[5] = tensor_1x3v_p2_surfvy_quad_5(1, fc); 
  } else { 

    fUpwindQuad_l[5] = tensor_1x3v_p2_surfvy_quad_5(-1, fc); 
    fUpwindQuad_r[5] = tensor_1x3v_p2_surfvy_quad_5(-1, fr); 
  } 
  if ((-0.6363961030678926*alpha[4])+0.4743416490252568*alpha[2]-0.4743416490252568*alpha[1]+0.3535533905932737*alpha[0] > 0) { 

    fUpwindQuad_l[6] = tensor_1x3v_p2_surfvy_quad_6(1, fl); 
    fUpwindQuad_r[6] = tensor_1x3v_p2_surfvy_quad_6(1, fc); 
  } else { 

    fUpwindQuad_l[6] = tensor_1x3v_p2_surfvy_quad_6(-1, fc); 
    fUpwindQuad_r[6] = tensor_1x3v_p2_surfvy_quad_6(-1, fr); 
  } 
  if (0.4743416490252568*alpha[2]+0.3535533905932737*alpha[0] > 0) { 

    fUpwindQuad_l[7] = tensor_1x3v_p2_surfvy_quad_7(1, fl); 
    fUpwindQuad_r[7] = tensor_1x3v_p2_surfvy_quad_7(1, fc); 
  } else { 

    fUpwindQuad_l[7] = tensor_1x3v_p2_surfvy_quad_7(-1, fc); 
    fUpwindQuad_r[7] = tensor_1x3v_p2_surfvy_quad_7(-1, fr); 
  } 
  if (0.6363961030678926*alpha[4]+0.4743416490252568*(alpha[2]+alpha[1])+0.3535533905932737*alpha[0] > 0) { 

    fUpwindQuad_l[8] = tensor_1x3v_p2_surfvy_quad_8(1, fl); 
    fUpwindQuad_r[8] = tensor_1x3v_p2_surfvy_quad_8(1, fc); 
  } else { 

    fUpwindQuad_l[8] = tensor_1x3v_p2_surfvy_quad_8(-1, fc); 
    fUpwindQuad_r[8] = tensor_1x3v_p2_surfvy_quad_8(-1, fr); 
  } 
  if (0.6363961030678926*alpha[4]-0.4743416490252568*(alpha[2]+alpha[1])+0.3535533905932737*alpha[0] > 0) { 

    fUpwindQuad_l[9] = tensor_1x3v_p2_surfvy_quad_9(1, fl); 
    fUpwindQuad_r[9] = tensor_1x3v_p2_surfvy_quad_9(1, fc); 
  } else { 

    fUpwindQuad_l[9] = tensor_1x3v_p2_surfvy_quad_9(-1, fc); 
    fUpwindQuad_r[9] = tensor_1x3v_p2_surfvy_quad_9(-1, fr); 
  } 
  if (0.3535533905932737*alpha[0]-0.4743416490252568*alpha[2] > 0) { 

    fUpwindQuad_l[10] = tensor_1x3v_p2_surfvy_quad_10(1, fl); 
    fUpwindQuad_r[10] = tensor_1x3v_p2_surfvy_quad_10(1, fc); 
  } else { 

    fUpwindQuad_l[10] = tensor_1x3v_p2_surfvy_quad_10(-1, fc); 
    fUpwindQuad_r[10] = tensor_1x3v_p2_surfvy_quad_10(-1, fr); 
  } 
  if ((-0.6363961030678926*alpha[4])-0.4743416490252568*alpha[2]+0.4743416490252568*alpha[1]+0.3535533905932737*alpha[0] > 0) { 

    fUpwindQuad_l[11] = tensor_1x3v_p2_surfvy_quad_11(1, fl); 
    fUpwindQuad_r[11] = tensor_1x3v_p2_surfvy_quad_11(1, fc); 
  } else { 

    fUpwindQuad_l[11] = tensor_1x3v_p2_surfvy_quad_11(-1, fc); 
    fUpwindQuad_r[11] = tensor_1x3v_p2_surfvy_quad_11(-1, fr); 
  } 
  if (0.3535533905932737*alpha[0]-0.4743416490252568*alpha[1] > 0) { 

    fUpwindQuad_l[12] = tensor_1x3v_p2_surfvy_quad_12(1, fl); 
    fUpwindQuad_r[12] = tensor_1x3v_p2_surfvy_quad_12(1, fc); 
  } else { 

    fUpwindQuad_l[12] = tensor_1x3v_p2_surfvy_quad_12(-1, fc); 
    fUpwindQuad_r[12] = tensor_1x3v_p2_surfvy_quad_12(-1, fr); 
  } 
  if (0.3535533905932737*alpha[0] > 0) { 

    fUpwindQuad_l[13] = tensor_1x3v_p2_surfvy_quad_13(1, fl); 
    fUpwindQuad_r[13] = tensor_1x3v_p2_surfvy_quad_13(1, fc); 
  } else { 

    fUpwindQuad_l[13] = tensor_1x3v_p2_surfvy_quad_13(-1, fc); 
    fUpwindQuad_r[13] = tensor_1x3v_p2_surfvy_quad_13(-1, fr); 
  } 
  if (0.4743416490252568*alpha[1]+0.3535533905932737*alpha[0] > 0) { 

    fUpwindQuad_l[14] = tensor_1x3v_p2_surfvy_quad_14(1, fl); 
    fUpwindQuad_r[14] = tensor_1x3v_p2_surfvy_quad_14(1, fc); 
  } else { 

    fUpwindQuad_l[14] = tensor_1x3v_p2_surfvy_quad_14(-1, fc); 
    fUpwindQuad_r[14] = tensor_1x3v_p2_surfvy_quad_14(-1, fr); 
  } 
  if ((-0.6363961030678926*alpha[4])+0.4743416490252568*alpha[2]-0.4743416490252568*alpha[1]+0.3535533905932737*alpha[0] > 0) { 

    fUpwindQuad_l[15] = tensor_1x3v_p2_surfvy_quad_15(1, fl); 
    fUpwindQuad_r[15] = tensor_1x3v_p2_surfvy_quad_15(1, fc); 
  } else { 

    fUpwindQuad_l[15] = tensor_1x3v_p2_surfvy_quad_15(-1, fc); 
    fUpwindQuad_r[15] = tensor_1x3v_p2_surfvy_quad_15(-1, fr); 
  } 
  if (0.4743416490252568*alpha[2]+0.3535533905932737*alpha[0] > 0) { 

    fUpwindQuad_l[16] = tensor_1x3v_p2_surfvy_quad_16(1, fl); 
    fUpwindQuad_r[16] = tensor_1x3v_p2_surfvy_quad_16(1, fc); 
  } else { 

    fUpwindQuad_l[16] = tensor_1x3v_p2_surfvy_quad_16(-1, fc); 
    fUpwindQuad_r[16] = tensor_1x3v_p2_surfvy_quad_16(-1, fr); 
  } 
  if (0.6363961030678926*alpha[4]+0.4743416490252568*(alpha[2]+alpha[1])+0.3535533905932737*alpha[0] > 0) { 

    fUpwindQuad_l[17] = tensor_1x3v_p2_surfvy_quad_17(1, fl); 
    fUpwindQuad_r[17] = tensor_1x3v_p2_surfvy_quad_17(1, fc); 
  } else { 

    fUpwindQuad_l[17] = tensor_1x3v_p2_surfvy_quad_17(-1, fc); 
    fUpwindQuad_r[17] = tensor_1x3v_p2_surfvy_quad_17(-1, fr); 
  } 
  if (0.6363961030678926*alpha[4]-0.4743416490252568*(alpha[2]+alpha[1])+0.3535533905932737*alpha[0] > 0) { 

    fUpwindQuad_l[18] = tensor_1x3v_p2_surfvy_quad_18(1, fl); 
    fUpwindQuad_r[18] = tensor_1x3v_p2_surfvy_quad_18(1, fc); 
  } else { 

    fUpwindQuad_l[18] = tensor_1x3v_p2_surfvy_quad_18(-1, fc); 
    fUpwindQuad_r[18] = tensor_1x3v_p2_surfvy_quad_18(-1, fr); 
  } 
  if (0.3535533905932737*alpha[0]-0.4743416490252568*alpha[2] > 0) { 

    fUpwindQuad_l[19] = tensor_1x3v_p2_surfvy_quad_19(1, fl); 
    fUpwindQuad_r[19] = tensor_1x3v_p2_surfvy_quad_19(1, fc); 
  } else { 

    fUpwindQuad_l[19] = tensor_1x3v_p2_surfvy_quad_19(-1, fc); 
    fUpwindQuad_r[19] = tensor_1x3v_p2_surfvy_quad_19(-1, fr); 
  } 
  if ((-0.6363961030678926*alpha[4])-0.4743416490252568*alpha[2]+0.4743416490252568*alpha[1]+0.3535533905932737*alpha[0] > 0) { 

    fUpwindQuad_l[20] = tensor_1x3v_p2_surfvy_quad_20(1, fl); 
    fUpwindQuad_r[20] = tensor_1x3v_p2_surfvy_quad_20(1, fc); 
  } else { 

    fUpwindQuad_l[20] = tensor_1x3v_p2_surfvy_quad_20(-1, fc); 
    fUpwindQuad_r[20] = tensor_1x3v_p2_surfvy_quad_20(-1, fr); 
  } 
  if (0.3535533905932737*alpha[0]-0.4743416490252568*alpha[1] > 0) { 

    fUpwindQuad_l[21] = tensor_1x3v_p2_surfvy_quad_21(1, fl); 
    fUpwindQuad_r[21] = tensor_1x3v_p2_surfvy_quad_21(1, fc); 
  } else { 

    fUpwindQuad_l[21] = tensor_1x3v_p2_surfvy_quad_21(-1, fc); 
    fUpwindQuad_r[21] = tensor_1x3v_p2_surfvy_quad_21(-1, fr); 
  } 
  if (0.3535533905932737*alpha[0] > 0) { 

    fUpwindQuad_l[22] = tensor_1x3v_p2_surfvy_quad_22(1, fl); 
    fUpwindQuad_r[22] = tensor_1x3v_p2_surfvy_quad_22(1, fc); 
  } else { 

    fUpwindQuad_l[22] = tensor_1x3v_p2_surfvy_quad_22(-1, fc); 
    fUpwindQuad_r[22] = tensor_1x3v_p2_surfvy_quad_22(-1, fr); 
  } 
  if (0.4743416490252568*alpha[1]+0.3535533905932737*alpha[0] > 0) { 

    fUpwindQuad_l[23] = tensor_1x3v_p2_surfvy_quad_23(1, fl); 
    fUpwindQuad_r[23] = tensor_1x3v_p2_surfvy_quad_23(1, fc); 
  } else { 

    fUpwindQuad_l[23] = tensor_1x3v_p2_surfvy_quad_23(-1, fc); 
    fUpwindQuad_r[23] = tensor_1x3v_p2_surfvy_quad_23(-1, fr); 
  } 
  if ((-0.6363961030678926*alpha[4])+0.4743416490252568*alpha[2]-0.4743416490252568*alpha[1]+0.3535533905932737*alpha[0] > 0) { 

    fUpwindQuad_l[24] = tensor_1x3v_p2_surfvy_quad_24(1, fl); 
    fUpwindQuad_r[24] = tensor_1x3v_p2_surfvy_quad_24(1, fc); 
  } else { 

    fUpwindQuad_l[24] = tensor_1x3v_p2_surfvy_quad_24(-1, fc); 
    fUpwindQuad_r[24] = tensor_1x3v_p2_surfvy_quad_24(-1, fr); 
  } 
  if (0.4743416490252568*alpha[2]+0.3535533905932737*alpha[0] > 0) { 

    fUpwindQuad_l[25] = tensor_1x3v_p2_surfvy_quad_25(1, fl); 
    fUpwindQuad_r[25] = tensor_1x3v_p2_surfvy_quad_25(1, fc); 
  } else { 

    fUpwindQuad_l[25] = tensor_1x3v_p2_surfvy_quad_25(-1, fc); 
    fUpwindQuad_r[25] = tensor_1x3v_p2_surfvy_quad_25(-1, fr); 
  } 
  if (0.6363961030678926*alpha[4]+0.4743416490252568*(alpha[2]+alpha[1])+0.3535533905932737*alpha[0] > 0) { 

    fUpwindQuad_l[26] = tensor_1x3v_p2_surfvy_quad_26(1, fl); 
    fUpwindQuad_r[26] = tensor_1x3v_p2_surfvy_quad_26(1, fc); 
  } else { 

    fUpwindQuad_l[26] = tensor_1x3v_p2_surfvy_quad_26(-1, fc); 
    fUpwindQuad_r[26] = tensor_1x3v_p2_surfvy_quad_26(-1, fr); 
  } 
