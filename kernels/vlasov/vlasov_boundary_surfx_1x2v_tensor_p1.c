...
{ 
  ...
  Ghat[1] = (0.7071067811865475*fedge[2]-1.224744871391589*fedge[4])*wv+(0.2041241452319315*fedge[0]-0.3535533905932737*fedge[1])*dv; 
  Ghat[2] = (0.7071067811865475*fedge[3]-1.224744871391589*fedge[5])*wv+(0.2041241452319315*fedge[6]-0.3535533905932737*fedge[7])*dv; 
  Ghat[3] = (0.7071067811865475*fedge[6]-1.224744871391589*fedge[7])*wv+(0.2041241452319315*fedge[3]-0.3535533905932737*fedge[5])*dv; 
  Ghat[4] = (0.1825741858350554*fedge[2]-0.3162277660168379*fedge[4])*dv; 
  Ghat[6] = (0.1825741858350554*fedge[6]-0.3162277660168379*fedge[7])*dv; 
  ...
  Ghat[1] = (0.7071067811865475*fskin[2]-1.224744871391589*fskin[4])*wv+(0.2041241452319315*fskin[0]-0.3535533905932737*fskin[1])*dv; 
  Ghat[2] = (0.7071067811865475*fskin[3]-1.224744871391589*fskin[5])*wv+(0.2041241452319315*fskin[6]-0.3535533905932737*fskin[7])*dv; 
  Ghat[3] = (0.7071067811865475*fskin[6]-1.224744871391589*fskin[7])*wv+(0.2041241452319315*fskin[3]-0.3535533905932737*fskin[5])*dv; 
  Ghat[4] = (0.1825741858350554*fskin[2]-0.3162277660168379*fskin[4])*dv; 
  Ghat[6] = (0.1825741858350554*fskin[6]-0.3162277660168379*fskin[7])*dv; 
