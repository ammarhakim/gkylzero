...
{ 
  ...
  out[3] += volFact*(4.0*f[0]*wx2_sq+2.3094010767585034*f[4]*dv2*wx2+4.0*f[0]*wx1_sq+2.3094010767585034*f[3]*dv1*wx1+0.2981423969999719*f[24]*dv2_sq+0.3333333333333333*f[0]*dv2_sq+0.2981423969999719*f[16]*dv1_sq+0.3333333333333333*f[0]*dv1_sq); 
} 
