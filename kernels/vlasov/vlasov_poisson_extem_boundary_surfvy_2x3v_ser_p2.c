...
GKYL_CU_DH void vlasov_poisson_extem_boundary_surfvy_2x3v_ser_p2(const double *w, const double *dxv, const double *fac_phi, const double *vecA, const int edge, const double *fEdge, const double *fSkin, double* GKYL_RESTRICT out) 
{ 
  ...
  Ghat[28] += 0.25*alpha[7]*fUpwind[47]+0.2500000000000001*alpha[15]*fUpwind[43]+0.223606797749979*alpha[21]*fUpwind[42]+0.2500000000000001*(alpha[3]*fUpwind[42]+alpha[2]*fUpwind[41])+0.2*alpha[16]*fUpwind[35]+0.25*(alpha[6]*fUpwind[30]+alpha[5]*fUpwind[29])+(0.223606797749979*alpha[11]+0.25*alpha[0])*fUpwind[28]+0.2*(alpha[8]*fUpwind[25]+fUpwind[8]*alpha[25])+0.223606797749979*(alpha[9]*fUpwind[16]+fUpwind[9]*alpha[16])+0.2500000000000001*alpha[1]*fUpwind[14]+0.223606797749979*(alpha[4]*fUpwind[8]+fUpwind[4]*alpha[8]); 
  ...
  Ghat[42] += 0.2500000000000001*alpha[2]*fUpwind[47]+0.2*alpha[16]*fUpwind[44]+0.25*alpha[5]*fUpwind[43]+0.223606797749979*alpha[11]*fUpwind[42]+0.25*(alpha[0]*fUpwind[42]+alpha[7]*fUpwind[41])+0.2*alpha[8]*fUpwind[37]+0.223606797749979*alpha[9]*fUpwind[31]+0.2500000000000001*(alpha[1]*fUpwind[30]+alpha[15]*fUpwind[29])+(0.223606797749979*alpha[21]+0.2500000000000001*alpha[3])*fUpwind[28]+0.2*fUpwind[17]*alpha[25]+0.223606797749979*(alpha[16]*fUpwind[18]+alpha[4]*fUpwind[17])+0.25*alpha[6]*fUpwind[14]+0.223606797749979*alpha[8]*fUpwind[10]; 
  ...
  Ghat[44] += 0.2*(alpha[8]*fUpwind[47]+alpha[6]*fUpwind[46]+alpha[5]*fUpwind[45])+(0.223606797749979*alpha[12]+0.159719141249985*alpha[11]+0.25*alpha[0])*fUpwind[44]+0.223606797749979*alpha[25]*fUpwind[43]+0.2*alpha[16]*fUpwind[42]+0.223606797749979*alpha[21]*fUpwind[40]+0.2*alpha[15]*fUpwind[39]+0.2500000000000001*alpha[2]*fUpwind[37]+0.2*alpha[15]*fUpwind[36]+(0.223606797749979*alpha[22]+0.159719141249985*alpha[21]+0.2500000000000001*alpha[3])*fUpwind[35]+0.2*alpha[16]*fUpwind[33]+(0.159719141249985*alpha[25]+0.2500000000000001*alpha[4])*fUpwind[32]+0.223606797749979*alpha[1]*fUpwind[31]+0.25*(alpha[7]*fUpwind[25]+fUpwind[7]*alpha[25]+alpha[9]*fUpwind[21]+fUpwind[9]*alpha[21])+0.2500000000000001*alpha[11]*fUpwind[18]+0.223606797749979*(alpha[5]*fUpwind[17]+alpha[6]*fUpwind[16]+fUpwind[6]*alpha[16]+alpha[8]*fUpwind[15]+fUpwind[8]*alpha[15]); 
  Ghat[45] += 0.2*(alpha[9]*fUpwind[47]+alpha[7]*fUpwind[46])+(0.159719141249985*alpha[12]+0.223606797749979*alpha[11]+0.25*alpha[0])*fUpwind[45]+0.2*(alpha[5]*fUpwind[44]+alpha[16]*fUpwind[43]+alpha[15]*fUpwind[40])+0.223606797749979*alpha[22]*fUpwind[39]+0.2500000000000001*alpha[1]*fUpwind[38]+(0.159719141249985*alpha[22]+0.223606797749979*alpha[21]+0.2500000000000001*alpha[3])*fUpwind[36]+0.2*alpha[15]*fUpwind[35]+(0.223606797749979*alpha[25]+0.2500000000000001*alpha[4])*fUpwind[33]+0.2*alpha[16]*fUpwind[32]+0.223606797749979*alpha[2]*fUpwind[31]+0.25*(alpha[6]*fUpwind[26]+alpha[8]*fUpwind[22]+fUpwind[8]*alpha[22])+0.223606797749979*alpha[5]*fUpwind[18]+0.2500000000000001*alpha[12]*fUpwind[17]+0.223606797749979*(alpha[7]*fUpwind[16]+fUpwind[7]*alpha[16]+alpha[9]*fUpwind[15]+fUpwind[9]*alpha[15]); 
  Ghat[46] += (0.223606797749979*(alpha[12]+alpha[11])+0.25*alpha[0])*fUpwind[46]+0.2*(alpha[7]*fUpwind[45]+alpha[6]*fUpwind[44])+0.2500000000000001*(alpha[1]*fUpwind[40]+alpha[2]*fUpwind[39])+0.2*alpha[15]*(fUpwind[38]+fUpwind[37])+(0.223606797749979*alpha[25]+0.2500000000000001*alpha[4])*fUpwind[34]+(0.2*(alpha[22]+alpha[21])+0.223606797749979*alpha[3])*fUpwind[31]+0.25*(alpha[5]*fUpwind[27]+alpha[8]*fUpwind[24]+alpha[9]*fUpwind[23])+0.223606797749979*(alpha[6]*fUpwind[18]+alpha[7]*fUpwind[17])+0.2500000000000001*fUpwind[13]*alpha[16]+0.223606797749979*fUpwind[10]*alpha[15]; 
  Ghat[47] += (0.223606797749979*(alpha[12]+alpha[11])+0.25*alpha[0])*fUpwind[47]+0.2*(alpha[9]*fUpwind[45]+alpha[8]*fUpwind[44])+0.2500000000000001*(alpha[1]*fUpwind[43]+alpha[2]*fUpwind[42])+(0.223606797749979*(alpha[22]+alpha[21])+0.2500000000000001*alpha[3])*fUpwind[41]+0.2*alpha[16]*(fUpwind[38]+fUpwind[37])+(0.2*alpha[25]+0.223606797749979*alpha[4])*fUpwind[31]+0.25*(alpha[5]*fUpwind[30]+alpha[6]*fUpwind[29]+alpha[7]*fUpwind[28])+0.223606797749979*(alpha[8]*fUpwind[18]+alpha[9]*fUpwind[17]+fUpwind[10]*alpha[16])+0.2500000000000001*fUpwind[14]*alpha[15]; 
