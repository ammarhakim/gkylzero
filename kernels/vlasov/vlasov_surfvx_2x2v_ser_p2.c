...
{ 
  ...
  alpha[7] = 1.414213562373095*B2[4]*wv2+1.414213562373095*E0[4]; 
  alpha[8] = 1.414213562373095*B2[5]*wv2+1.414213562373095*E0[5]; 
  alpha[10] = 0.408248290463863*B2[3]*dv2; 
  alpha[11] = 1.414213562373095*B2[6]*wv2+1.414213562373095*E0[6]; 
  alpha[12] = 1.414213562373095*B2[7]*wv2+1.414213562373095*E0[7]; 
  ...
  if (0.569209978830308*(alpha[18]+alpha[17])-0.4242640687119284*(alpha[14]+alpha[13]+alpha[12]+alpha[11])-0.8538149682454622*alpha[10]+0.3162277660168378*(alpha[8]+alpha[7])+0.6363961030678926*(alpha[6]+alpha[5]+alpha[4])-0.4743416490252567*(alpha[3]+alpha[2]+alpha[1])+0.3535533905932737*alpha[0] > 0) { 
  ...
  if ((-0.4242640687119284*(alpha[12]+alpha[11]))+0.3162277660168378*(alpha[8]+alpha[7])+0.6363961030678926*alpha[4]-0.4743416490252567*(alpha[2]+alpha[1])+0.3535533905932737*alpha[0] > 0) { 
  ...
  if ((-0.569209978830308*(alpha[18]+alpha[17]))+0.4242640687119284*(alpha[14]+alpha[13])-0.4242640687119284*(alpha[12]+alpha[11])+0.8538149682454622*alpha[10]+0.3162277660168378*(alpha[8]+alpha[7])-0.6363961030678926*(alpha[6]+alpha[5])+0.6363961030678926*alpha[4]+0.4743416490252567*alpha[3]-0.4743416490252567*(alpha[2]+alpha[1])+0.3535533905932737*alpha[0] > 0) { 
  ...
  if ((-0.711512473537885*alpha[18])+0.5303300858899105*alpha[14]-0.4242640687119284*alpha[13]+0.5303300858899105*alpha[12]-0.3952847075210473*alpha[8]+0.3162277660168378*alpha[7]+0.6363961030678926*alpha[5]-0.4743416490252567*(alpha[3]+alpha[1])+0.3535533905932737*alpha[0] > 0) { 
  ...
  if (0.5303300858899105*alpha[12]-0.3952847075210473*alpha[8]+0.3162277660168378*alpha[7]-0.4743416490252567*alpha[1]+0.3535533905932737*alpha[0] > 0) { 
  ...
  if (0.711512473537885*alpha[18]-0.5303300858899105*alpha[14]+0.4242640687119284*alpha[13]+0.5303300858899105*alpha[12]-0.3952847075210473*alpha[8]+0.3162277660168378*alpha[7]-0.6363961030678926*alpha[5]+0.4743416490252567*alpha[3]-0.4743416490252567*alpha[1]+0.3535533905932737*alpha[0] > 0) { 
  ...
  if (0.569209978830308*alpha[18]-0.569209978830308*alpha[17]-0.4242640687119284*(alpha[14]+alpha[13]+alpha[12])+0.4242640687119284*alpha[11]+0.8538149682454622*alpha[10]+0.3162277660168378*(alpha[8]+alpha[7])-0.6363961030678926*alpha[6]+0.6363961030678926*alpha[5]-0.6363961030678926*alpha[4]-0.4743416490252567*alpha[3]+0.4743416490252567*alpha[2]-0.4743416490252567*alpha[1]+0.3535533905932737*alpha[0] > 0) { 
  ...
  if ((-0.4242640687119284*alpha[12])+0.4242640687119284*alpha[11]+0.3162277660168378*(alpha[8]+alpha[7])-0.6363961030678926*alpha[4]+0.4743416490252567*alpha[2]-0.4743416490252567*alpha[1]+0.3535533905932737*alpha[0] > 0) { 
  ...
  if ((-0.569209978830308*alpha[18])+0.569209978830308*alpha[17]+0.4242640687119284*(alpha[14]+alpha[13])-0.4242640687119284*alpha[12]+0.4242640687119284*alpha[11]-0.8538149682454622*alpha[10]+0.3162277660168378*(alpha[8]+alpha[7])+0.6363961030678926*alpha[6]-0.6363961030678926*(alpha[5]+alpha[4])+0.4743416490252567*(alpha[3]+alpha[2])-0.4743416490252567*alpha[1]+0.3535533905932737*alpha[0] > 0) { 
  ...
  if ((-0.711512473537885*alpha[17])-0.4242640687119284*alpha[14]+0.5303300858899105*(alpha[13]+alpha[11])+0.3162277660168378*alpha[8]-0.3952847075210473*alpha[7]+0.6363961030678926*alpha[6]-0.4743416490252567*(alpha[3]+alpha[2])+0.3535533905932737*alpha[0] > 0) { 
  ...
  if (0.5303300858899105*alpha[11]+0.3162277660168378*alpha[8]-0.3952847075210473*alpha[7]-0.4743416490252567*alpha[2]+0.3535533905932737*alpha[0] > 0) { 
  ...
  if (0.711512473537885*alpha[17]+0.4242640687119284*alpha[14]-0.5303300858899105*alpha[13]+0.5303300858899105*alpha[11]+0.3162277660168378*alpha[8]-0.3952847075210473*alpha[7]-0.6363961030678926*alpha[6]+0.4743416490252567*alpha[3]-0.4743416490252567*alpha[2]+0.3535533905932737*alpha[0] > 0) { 
