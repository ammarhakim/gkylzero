...
{ 
  ...
  Ghat_l[0] += 0.25*(alpha[11]*fUpwind_l[11]+alpha[5]*fUpwind_l[5]+alpha[2]*fUpwind_l[2]+alpha[1]*fUpwind_l[1]+alpha[0]*fUpwind_l[0]); 
  Ghat_l[1] += 0.223606797749979*alpha[5]*fUpwind_l[19]+0.223606797749979*(alpha[1]*fUpwind_l[11]+fUpwind_l[1]*alpha[11])+0.25*(alpha[2]*fUpwind_l[5]+fUpwind_l[2]*alpha[5]+alpha[0]*fUpwind_l[1]+fUpwind_l[0]*alpha[1]); 
  Ghat_l[2] += 0.223606797749979*alpha[5]*fUpwind_l[20]+0.2500000000000001*alpha[11]*fUpwind_l[19]+0.223606797749979*alpha[2]*fUpwind_l[12]+0.25*(alpha[1]*fUpwind_l[5]+fUpwind_l[1]*alpha[5]+alpha[0]*fUpwind_l[2]+fUpwind_l[0]*alpha[2]); 
  Ghat_l[3] += 0.2500000000000001*alpha[11]*fUpwind_l[21]+0.25*(alpha[5]*fUpwind_l[15]+alpha[2]*fUpwind_l[7]+alpha[1]*fUpwind_l[6]+alpha[0]*fUpwind_l[3]); 
  Ghat_l[4] += 0.2500000000000001*alpha[11]*fUpwind_l[25]+0.25*(alpha[5]*fUpwind_l[16]+alpha[2]*fUpwind_l[9]+alpha[1]*fUpwind_l[8]+alpha[0]*fUpwind_l[4]); 
  Ghat_l[5] += 0.223606797749979*(alpha[2]*fUpwind_l[20]+alpha[1]*fUpwind_l[19])+0.223606797749979*(alpha[5]*(fUpwind_l[12]+fUpwind_l[11])+fUpwind_l[5]*alpha[11])+0.25*(alpha[0]*fUpwind_l[5]+fUpwind_l[0]*alpha[5]+alpha[1]*fUpwind_l[2]+fUpwind_l[1]*alpha[2]); 
  Ghat_l[6] += 0.223606797749979*alpha[5]*fUpwind_l[32]+0.223606797749979*alpha[1]*fUpwind_l[21]+0.25*alpha[2]*fUpwind_l[15]+0.223606797749979*fUpwind_l[6]*alpha[11]+0.25*(alpha[5]*fUpwind_l[7]+alpha[0]*fUpwind_l[6]+alpha[1]*fUpwind_l[3]); 
  Ghat_l[7] += 0.223606797749979*alpha[5]*fUpwind_l[33]+0.25*alpha[11]*fUpwind_l[32]+0.223606797749979*alpha[2]*fUpwind_l[22]+0.25*(alpha[1]*fUpwind_l[15]+alpha[0]*fUpwind_l[7]+alpha[5]*fUpwind_l[6]+alpha[2]*fUpwind_l[3]); 
  Ghat_l[8] += 0.223606797749979*alpha[5]*fUpwind_l[35]+0.223606797749979*alpha[1]*fUpwind_l[25]+0.25*alpha[2]*fUpwind_l[16]+0.223606797749979*fUpwind_l[8]*alpha[11]+0.25*(alpha[5]*fUpwind_l[9]+alpha[0]*fUpwind_l[8]+alpha[1]*fUpwind_l[4]); 
  Ghat_l[9] += 0.223606797749979*alpha[5]*fUpwind_l[36]+0.25*alpha[11]*fUpwind_l[35]+0.223606797749979*alpha[2]*fUpwind_l[26]+0.25*(alpha[1]*fUpwind_l[16]+alpha[0]*fUpwind_l[9]+alpha[5]*fUpwind_l[8]+alpha[2]*fUpwind_l[4]); 
  Ghat_l[10] += 0.25*(alpha[11]*fUpwind_l[37]+alpha[5]*fUpwind_l[31]+alpha[2]*fUpwind_l[18]+alpha[1]*fUpwind_l[17]+alpha[0]*fUpwind_l[10]); 
  Ghat_l[11] += 0.2500000000000001*alpha[2]*fUpwind_l[19]+0.159719141249985*alpha[11]*fUpwind_l[11]+0.25*(alpha[0]*fUpwind_l[11]+fUpwind_l[0]*alpha[11])+0.223606797749979*(alpha[5]*fUpwind_l[5]+alpha[1]*fUpwind_l[1]); 
  Ghat_l[12] += 0.2500000000000001*alpha[1]*fUpwind_l[20]+0.25*alpha[0]*fUpwind_l[12]+0.223606797749979*(alpha[5]*fUpwind_l[5]+alpha[2]*fUpwind_l[2]); 
  Ghat_l[13] += 0.25*alpha[5]*fUpwind_l[34]+0.2500000000000001*(alpha[2]*fUpwind_l[24]+alpha[1]*fUpwind_l[23])+0.25*alpha[0]*fUpwind_l[13]; 
  Ghat_l[14] += 0.25*alpha[5]*fUpwind_l[41]+0.2500000000000001*(alpha[2]*fUpwind_l[29]+alpha[1]*fUpwind_l[28])+0.25*alpha[0]*fUpwind_l[14]; 
  Ghat_l[15] += 0.223606797749979*(alpha[2]*fUpwind_l[33]+alpha[1]*fUpwind_l[32])+0.223606797749979*alpha[5]*(fUpwind_l[22]+fUpwind_l[21])+0.223606797749979*alpha[11]*fUpwind_l[15]+0.25*(alpha[0]*fUpwind_l[15]+alpha[1]*fUpwind_l[7]+alpha[2]*fUpwind_l[6]+fUpwind_l[3]*alpha[5]); 
  Ghat_l[16] += 0.223606797749979*(alpha[2]*fUpwind_l[36]+alpha[1]*fUpwind_l[35])+0.223606797749979*alpha[5]*(fUpwind_l[26]+fUpwind_l[25])+0.223606797749979*alpha[11]*fUpwind_l[16]+0.25*(alpha[0]*fUpwind_l[16]+alpha[1]*fUpwind_l[9]+alpha[2]*fUpwind_l[8]+fUpwind_l[4]*alpha[5]); 
  Ghat_l[17] += 0.223606797749979*alpha[5]*fUpwind_l[44]+0.223606797749979*alpha[1]*fUpwind_l[37]+0.25*(alpha[2]*fUpwind_l[31]+alpha[5]*fUpwind_l[18])+0.223606797749979*alpha[11]*fUpwind_l[17]+0.25*(alpha[0]*fUpwind_l[17]+alpha[1]*fUpwind_l[10]); 
  Ghat_l[18] += 0.223606797749979*alpha[5]*fUpwind_l[45]+0.2500000000000001*alpha[11]*fUpwind_l[44]+0.223606797749979*alpha[2]*fUpwind_l[38]+0.25*(alpha[1]*fUpwind_l[31]+alpha[0]*fUpwind_l[18]+alpha[5]*fUpwind_l[17]+alpha[2]*fUpwind_l[10]); 
  Ghat_l[19] += 0.2*alpha[5]*fUpwind_l[20]+(0.159719141249985*alpha[11]+0.25*alpha[0])*fUpwind_l[19]+0.2500000000000001*(alpha[2]*fUpwind_l[11]+fUpwind_l[2]*alpha[11])+0.223606797749979*(alpha[1]*fUpwind_l[5]+fUpwind_l[1]*alpha[5]); 
  Ghat_l[20] += (0.223606797749979*alpha[11]+0.25*alpha[0])*fUpwind_l[20]+0.2*alpha[5]*fUpwind_l[19]+0.2500000000000001*alpha[1]*fUpwind_l[12]+0.223606797749979*(alpha[2]*fUpwind_l[5]+fUpwind_l[2]*alpha[5]); 
  Ghat_l[21] += 0.2500000000000001*alpha[2]*fUpwind_l[32]+(0.159719141249985*alpha[11]+0.25*alpha[0])*fUpwind_l[21]+0.223606797749979*alpha[5]*fUpwind_l[15]+0.2500000000000001*fUpwind_l[3]*alpha[11]+0.223606797749979*alpha[1]*fUpwind_l[6]; 
  Ghat_l[22] += 0.2500000000000001*alpha[1]*fUpwind_l[33]+0.25*alpha[0]*fUpwind_l[22]+0.223606797749979*(alpha[5]*fUpwind_l[15]+alpha[2]*fUpwind_l[7]); 
  Ghat_l[23] += 0.2500000000000001*alpha[2]*fUpwind_l[34]+0.25*alpha[5]*fUpwind_l[24]+(0.223606797749979*alpha[11]+0.25*alpha[0])*fUpwind_l[23]+0.2500000000000001*alpha[1]*fUpwind_l[13]; 
  Ghat_l[24] += 0.2500000000000001*alpha[1]*fUpwind_l[34]+0.25*(alpha[0]*fUpwind_l[24]+alpha[5]*fUpwind_l[23])+0.2500000000000001*alpha[2]*fUpwind_l[13]; 
  Ghat_l[25] += 0.2500000000000001*alpha[2]*fUpwind_l[35]+(0.159719141249985*alpha[11]+0.25*alpha[0])*fUpwind_l[25]+0.223606797749979*alpha[5]*fUpwind_l[16]+0.2500000000000001*fUpwind_l[4]*alpha[11]+0.223606797749979*alpha[1]*fUpwind_l[8]; 
  Ghat_l[26] += 0.2500000000000001*alpha[1]*fUpwind_l[36]+0.25*alpha[0]*fUpwind_l[26]+0.223606797749979*(alpha[5]*fUpwind_l[16]+alpha[2]*fUpwind_l[9]); 
  Ghat_l[27] += 0.25*alpha[5]*fUpwind_l[46]+0.2500000000000001*(alpha[2]*fUpwind_l[40]+alpha[1]*fUpwind_l[39])+0.25*alpha[0]*fUpwind_l[27]; 
  Ghat_l[28] += 0.2500000000000001*alpha[2]*fUpwind_l[41]+0.25*alpha[5]*fUpwind_l[29]+(0.223606797749979*alpha[11]+0.25*alpha[0])*fUpwind_l[28]+0.2500000000000001*alpha[1]*fUpwind_l[14]; 
  Ghat_l[29] += 0.2500000000000001*alpha[1]*fUpwind_l[41]+0.25*(alpha[0]*fUpwind_l[29]+alpha[5]*fUpwind_l[28])+0.2500000000000001*alpha[2]*fUpwind_l[14]; 
  Ghat_l[30] += 0.25*alpha[5]*fUpwind_l[47]+0.2500000000000001*(alpha[2]*fUpwind_l[43]+alpha[1]*fUpwind_l[42])+0.25*alpha[0]*fUpwind_l[30]; 
  Ghat_l[31] += 0.223606797749979*(alpha[2]*fUpwind_l[45]+alpha[1]*fUpwind_l[44])+0.223606797749979*(alpha[5]*(fUpwind_l[38]+fUpwind_l[37])+alpha[11]*fUpwind_l[31])+0.25*(alpha[0]*fUpwind_l[31]+alpha[1]*fUpwind_l[18]+alpha[2]*fUpwind_l[17]+alpha[5]*fUpwind_l[10]); 
  Ghat_l[32] += 0.2*alpha[5]*fUpwind_l[33]+(0.159719141249985*alpha[11]+0.25*alpha[0])*fUpwind_l[32]+0.2500000000000001*alpha[2]*fUpwind_l[21]+0.223606797749979*alpha[1]*fUpwind_l[15]+0.25*fUpwind_l[7]*alpha[11]+0.223606797749979*alpha[5]*fUpwind_l[6]; 
  Ghat_l[33] += (0.223606797749979*alpha[11]+0.25*alpha[0])*fUpwind_l[33]+0.2*alpha[5]*fUpwind_l[32]+0.2500000000000001*alpha[1]*fUpwind_l[22]+0.223606797749979*(alpha[2]*fUpwind_l[15]+alpha[5]*fUpwind_l[7]); 
  Ghat_l[34] += (0.223606797749979*alpha[11]+0.25*alpha[0])*fUpwind_l[34]+0.2500000000000001*(alpha[1]*fUpwind_l[24]+alpha[2]*fUpwind_l[23])+0.25*alpha[5]*fUpwind_l[13]; 
  Ghat_l[35] += 0.2*alpha[5]*fUpwind_l[36]+(0.159719141249985*alpha[11]+0.25*alpha[0])*fUpwind_l[35]+0.2500000000000001*alpha[2]*fUpwind_l[25]+0.223606797749979*alpha[1]*fUpwind_l[16]+0.25*fUpwind_l[9]*alpha[11]+0.223606797749979*alpha[5]*fUpwind_l[8]; 
  Ghat_l[36] += (0.223606797749979*alpha[11]+0.25*alpha[0])*fUpwind_l[36]+0.2*alpha[5]*fUpwind_l[35]+0.2500000000000001*alpha[1]*fUpwind_l[26]+0.223606797749979*(alpha[2]*fUpwind_l[16]+alpha[5]*fUpwind_l[9]); 
  Ghat_l[37] += 0.2500000000000001*alpha[2]*fUpwind_l[44]+(0.159719141249985*alpha[11]+0.25*alpha[0])*fUpwind_l[37]+0.223606797749979*(alpha[5]*fUpwind_l[31]+alpha[1]*fUpwind_l[17])+0.25*fUpwind_l[10]*alpha[11]; 
  Ghat_l[38] += 0.2500000000000001*alpha[1]*fUpwind_l[45]+0.25*alpha[0]*fUpwind_l[38]+0.223606797749979*(alpha[5]*fUpwind_l[31]+alpha[2]*fUpwind_l[18]); 
  Ghat_l[39] += 0.2500000000000001*alpha[2]*fUpwind_l[46]+0.25*alpha[5]*fUpwind_l[40]+(0.223606797749979*alpha[11]+0.25*alpha[0])*fUpwind_l[39]+0.2500000000000001*alpha[1]*fUpwind_l[27]; 
  Ghat_l[40] += 0.2500000000000001*alpha[1]*fUpwind_l[46]+0.25*(alpha[0]*fUpwind_l[40]+alpha[5]*fUpwind_l[39])+0.2500000000000001*alpha[2]*fUpwind_l[27]; 
  Ghat_l[41] += (0.223606797749979*alpha[11]+0.25*alpha[0])*fUpwind_l[41]+0.2500000000000001*(alpha[1]*fUpwind_l[29]+alpha[2]*fUpwind_l[28])+0.25*alpha[5]*fUpwind_l[14]; 
  Ghat_l[42] += 0.2500000000000001*alpha[2]*fUpwind_l[47]+0.25*alpha[5]*fUpwind_l[43]+(0.223606797749979*alpha[11]+0.25*alpha[0])*fUpwind_l[42]+0.2500000000000001*alpha[1]*fUpwind_l[30]; 
  Ghat_l[43] += 0.2500000000000001*alpha[1]*fUpwind_l[47]+0.25*(alpha[0]*fUpwind_l[43]+alpha[5]*fUpwind_l[42])+0.2500000000000001*alpha[2]*fUpwind_l[30]; 
  Ghat_l[44] += 0.2*alpha[5]*fUpwind_l[45]+(0.159719141249985*alpha[11]+0.25*alpha[0])*fUpwind_l[44]+0.2500000000000001*alpha[2]*fUpwind_l[37]+0.223606797749979*alpha[1]*fUpwind_l[31]+0.2500000000000001*alpha[11]*fUpwind_l[18]+0.223606797749979*alpha[5]*fUpwind_l[17]; 
  Ghat_l[45] += (0.223606797749979*alpha[11]+0.25*alpha[0])*fUpwind_l[45]+0.2*alpha[5]*fUpwind_l[44]+0.2500000000000001*alpha[1]*fUpwind_l[38]+0.223606797749979*(alpha[2]*fUpwind_l[31]+alpha[5]*fUpwind_l[18]); 
  Ghat_l[46] += (0.223606797749979*alpha[11]+0.25*alpha[0])*fUpwind_l[46]+0.2500000000000001*(alpha[1]*fUpwind_l[40]+alpha[2]*fUpwind_l[39])+0.25*alpha[5]*fUpwind_l[27]; 
  Ghat_l[47] += (0.223606797749979*alpha[11]+0.25*alpha[0])*fUpwind_l[47]+0.2500000000000001*(alpha[1]*fUpwind_l[43]+alpha[2]*fUpwind_l[42])+0.25*alpha[5]*fUpwind_l[30]; 

  Ghat_r[0] += 0.25*(alpha[11]*fUpwind_r[11]+alpha[5]*fUpwind_r[5]+alpha[2]*fUpwind_r[2]+alpha[1]*fUpwind_r[1]+alpha[0]*fUpwind_r[0]); 
  Ghat_r[1] += 0.223606797749979*alpha[5]*fUpwind_r[19]+0.223606797749979*(alpha[1]*fUpwind_r[11]+fUpwind_r[1]*alpha[11])+0.25*(alpha[2]*fUpwind_r[5]+fUpwind_r[2]*alpha[5]+alpha[0]*fUpwind_r[1]+fUpwind_r[0]*alpha[1]); 
  Ghat_r[2] += 0.223606797749979*alpha[5]*fUpwind_r[20]+0.2500000000000001*alpha[11]*fUpwind_r[19]+0.223606797749979*alpha[2]*fUpwind_r[12]+0.25*(alpha[1]*fUpwind_r[5]+fUpwind_r[1]*alpha[5]+alpha[0]*fUpwind_r[2]+fUpwind_r[0]*alpha[2]); 
  Ghat_r[3] += 0.2500000000000001*alpha[11]*fUpwind_r[21]+0.25*(alpha[5]*fUpwind_r[15]+alpha[2]*fUpwind_r[7]+alpha[1]*fUpwind_r[6]+alpha[0]*fUpwind_r[3]); 
  Ghat_r[4] += 0.2500000000000001*alpha[11]*fUpwind_r[25]+0.25*(alpha[5]*fUpwind_r[16]+alpha[2]*fUpwind_r[9]+alpha[1]*fUpwind_r[8]+alpha[0]*fUpwind_r[4]); 
  Ghat_r[5] += 0.223606797749979*(alpha[2]*fUpwind_r[20]+alpha[1]*fUpwind_r[19])+0.223606797749979*(alpha[5]*(fUpwind_r[12]+fUpwind_r[11])+fUpwind_r[5]*alpha[11])+0.25*(alpha[0]*fUpwind_r[5]+fUpwind_r[0]*alpha[5]+alpha[1]*fUpwind_r[2]+fUpwind_r[1]*alpha[2]); 
  Ghat_r[6] += 0.223606797749979*alpha[5]*fUpwind_r[32]+0.223606797749979*alpha[1]*fUpwind_r[21]+0.25*alpha[2]*fUpwind_r[15]+0.223606797749979*fUpwind_r[6]*alpha[11]+0.25*(alpha[5]*fUpwind_r[7]+alpha[0]*fUpwind_r[6]+alpha[1]*fUpwind_r[3]); 
  Ghat_r[7] += 0.223606797749979*alpha[5]*fUpwind_r[33]+0.25*alpha[11]*fUpwind_r[32]+0.223606797749979*alpha[2]*fUpwind_r[22]+0.25*(alpha[1]*fUpwind_r[15]+alpha[0]*fUpwind_r[7]+alpha[5]*fUpwind_r[6]+alpha[2]*fUpwind_r[3]); 
  Ghat_r[8] += 0.223606797749979*alpha[5]*fUpwind_r[35]+0.223606797749979*alpha[1]*fUpwind_r[25]+0.25*alpha[2]*fUpwind_r[16]+0.223606797749979*fUpwind_r[8]*alpha[11]+0.25*(alpha[5]*fUpwind_r[9]+alpha[0]*fUpwind_r[8]+alpha[1]*fUpwind_r[4]); 
  Ghat_r[9] += 0.223606797749979*alpha[5]*fUpwind_r[36]+0.25*alpha[11]*fUpwind_r[35]+0.223606797749979*alpha[2]*fUpwind_r[26]+0.25*(alpha[1]*fUpwind_r[16]+alpha[0]*fUpwind_r[9]+alpha[5]*fUpwind_r[8]+alpha[2]*fUpwind_r[4]); 
  Ghat_r[10] += 0.25*(alpha[11]*fUpwind_r[37]+alpha[5]*fUpwind_r[31]+alpha[2]*fUpwind_r[18]+alpha[1]*fUpwind_r[17]+alpha[0]*fUpwind_r[10]); 
  Ghat_r[11] += 0.2500000000000001*alpha[2]*fUpwind_r[19]+0.159719141249985*alpha[11]*fUpwind_r[11]+0.25*(alpha[0]*fUpwind_r[11]+fUpwind_r[0]*alpha[11])+0.223606797749979*(alpha[5]*fUpwind_r[5]+alpha[1]*fUpwind_r[1]); 
  Ghat_r[12] += 0.2500000000000001*alpha[1]*fUpwind_r[20]+0.25*alpha[0]*fUpwind_r[12]+0.223606797749979*(alpha[5]*fUpwind_r[5]+alpha[2]*fUpwind_r[2]); 
  Ghat_r[13] += 0.25*alpha[5]*fUpwind_r[34]+0.2500000000000001*(alpha[2]*fUpwind_r[24]+alpha[1]*fUpwind_r[23])+0.25*alpha[0]*fUpwind_r[13]; 
  Ghat_r[14] += 0.25*alpha[5]*fUpwind_r[41]+0.2500000000000001*(alpha[2]*fUpwind_r[29]+alpha[1]*fUpwind_r[28])+0.25*alpha[0]*fUpwind_r[14]; 
  Ghat_r[15] += 0.223606797749979*(alpha[2]*fUpwind_r[33]+alpha[1]*fUpwind_r[32])+0.223606797749979*alpha[5]*(fUpwind_r[22]+fUpwind_r[21])+0.223606797749979*alpha[11]*fUpwind_r[15]+0.25*(alpha[0]*fUpwind_r[15]+alpha[1]*fUpwind_r[7]+alpha[2]*fUpwind_r[6]+fUpwind_r[3]*alpha[5]); 
  Ghat_r[16] += 0.223606797749979*(alpha[2]*fUpwind_r[36]+alpha[1]*fUpwind_r[35])+0.223606797749979*alpha[5]*(fUpwind_r[26]+fUpwind_r[25])+0.223606797749979*alpha[11]*fUpwind_r[16]+0.25*(alpha[0]*fUpwind_r[16]+alpha[1]*fUpwind_r[9]+alpha[2]*fUpwind_r[8]+fUpwind_r[4]*alpha[5]); 
  Ghat_r[17] += 0.223606797749979*alpha[5]*fUpwind_r[44]+0.223606797749979*alpha[1]*fUpwind_r[37]+0.25*(alpha[2]*fUpwind_r[31]+alpha[5]*fUpwind_r[18])+0.223606797749979*alpha[11]*fUpwind_r[17]+0.25*(alpha[0]*fUpwind_r[17]+alpha[1]*fUpwind_r[10]); 
  Ghat_r[18] += 0.223606797749979*alpha[5]*fUpwind_r[45]+0.2500000000000001*alpha[11]*fUpwind_r[44]+0.223606797749979*alpha[2]*fUpwind_r[38]+0.25*(alpha[1]*fUpwind_r[31]+alpha[0]*fUpwind_r[18]+alpha[5]*fUpwind_r[17]+alpha[2]*fUpwind_r[10]); 
  Ghat_r[19] += 0.2*alpha[5]*fUpwind_r[20]+(0.159719141249985*alpha[11]+0.25*alpha[0])*fUpwind_r[19]+0.2500000000000001*(alpha[2]*fUpwind_r[11]+fUpwind_r[2]*alpha[11])+0.223606797749979*(alpha[1]*fUpwind_r[5]+fUpwind_r[1]*alpha[5]); 
  Ghat_r[20] += (0.223606797749979*alpha[11]+0.25*alpha[0])*fUpwind_r[20]+0.2*alpha[5]*fUpwind_r[19]+0.2500000000000001*alpha[1]*fUpwind_r[12]+0.223606797749979*(alpha[2]*fUpwind_r[5]+fUpwind_r[2]*alpha[5]); 
  Ghat_r[21] += 0.2500000000000001*alpha[2]*fUpwind_r[32]+(0.159719141249985*alpha[11]+0.25*alpha[0])*fUpwind_r[21]+0.223606797749979*alpha[5]*fUpwind_r[15]+0.2500000000000001*fUpwind_r[3]*alpha[11]+0.223606797749979*alpha[1]*fUpwind_r[6]; 
  Ghat_r[22] += 0.2500000000000001*alpha[1]*fUpwind_r[33]+0.25*alpha[0]*fUpwind_r[22]+0.223606797749979*(alpha[5]*fUpwind_r[15]+alpha[2]*fUpwind_r[7]); 
  Ghat_r[23] += 0.2500000000000001*alpha[2]*fUpwind_r[34]+0.25*alpha[5]*fUpwind_r[24]+(0.223606797749979*alpha[11]+0.25*alpha[0])*fUpwind_r[23]+0.2500000000000001*alpha[1]*fUpwind_r[13]; 
  Ghat_r[24] += 0.2500000000000001*alpha[1]*fUpwind_r[34]+0.25*(alpha[0]*fUpwind_r[24]+alpha[5]*fUpwind_r[23])+0.2500000000000001*alpha[2]*fUpwind_r[13]; 
  Ghat_r[25] += 0.2500000000000001*alpha[2]*fUpwind_r[35]+(0.159719141249985*alpha[11]+0.25*alpha[0])*fUpwind_r[25]+0.223606797749979*alpha[5]*fUpwind_r[16]+0.2500000000000001*fUpwind_r[4]*alpha[11]+0.223606797749979*alpha[1]*fUpwind_r[8]; 
  Ghat_r[26] += 0.2500000000000001*alpha[1]*fUpwind_r[36]+0.25*alpha[0]*fUpwind_r[26]+0.223606797749979*(alpha[5]*fUpwind_r[16]+alpha[2]*fUpwind_r[9]); 
  Ghat_r[27] += 0.25*alpha[5]*fUpwind_r[46]+0.2500000000000001*(alpha[2]*fUpwind_r[40]+alpha[1]*fUpwind_r[39])+0.25*alpha[0]*fUpwind_r[27]; 
  Ghat_r[28] += 0.2500000000000001*alpha[2]*fUpwind_r[41]+0.25*alpha[5]*fUpwind_r[29]+(0.223606797749979*alpha[11]+0.25*alpha[0])*fUpwind_r[28]+0.2500000000000001*alpha[1]*fUpwind_r[14]; 
  Ghat_r[29] += 0.2500000000000001*alpha[1]*fUpwind_r[41]+0.25*(alpha[0]*fUpwind_r[29]+alpha[5]*fUpwind_r[28])+0.2500000000000001*alpha[2]*fUpwind_r[14]; 
  Ghat_r[30] += 0.25*alpha[5]*fUpwind_r[47]+0.2500000000000001*(alpha[2]*fUpwind_r[43]+alpha[1]*fUpwind_r[42])+0.25*alpha[0]*fUpwind_r[30]; 
  Ghat_r[31] += 0.223606797749979*(alpha[2]*fUpwind_r[45]+alpha[1]*fUpwind_r[44])+0.223606797749979*(alpha[5]*(fUpwind_r[38]+fUpwind_r[37])+alpha[11]*fUpwind_r[31])+0.25*(alpha[0]*fUpwind_r[31]+alpha[1]*fUpwind_r[18]+alpha[2]*fUpwind_r[17]+alpha[5]*fUpwind_r[10]); 
  Ghat_r[32] += 0.2*alpha[5]*fUpwind_r[33]+(0.159719141249985*alpha[11]+0.25*alpha[0])*fUpwind_r[32]+0.2500000000000001*alpha[2]*fUpwind_r[21]+0.223606797749979*alpha[1]*fUpwind_r[15]+0.25*fUpwind_r[7]*alpha[11]+0.223606797749979*alpha[5]*fUpwind_r[6]; 
  Ghat_r[33] += (0.223606797749979*alpha[11]+0.25*alpha[0])*fUpwind_r[33]+0.2*alpha[5]*fUpwind_r[32]+0.2500000000000001*alpha[1]*fUpwind_r[22]+0.223606797749979*(alpha[2]*fUpwind_r[15]+alpha[5]*fUpwind_r[7]); 
  Ghat_r[34] += (0.223606797749979*alpha[11]+0.25*alpha[0])*fUpwind_r[34]+0.2500000000000001*(alpha[1]*fUpwind_r[24]+alpha[2]*fUpwind_r[23])+0.25*alpha[5]*fUpwind_r[13]; 
  Ghat_r[35] += 0.2*alpha[5]*fUpwind_r[36]+(0.159719141249985*alpha[11]+0.25*alpha[0])*fUpwind_r[35]+0.2500000000000001*alpha[2]*fUpwind_r[25]+0.223606797749979*alpha[1]*fUpwind_r[16]+0.25*fUpwind_r[9]*alpha[11]+0.223606797749979*alpha[5]*fUpwind_r[8]; 
  Ghat_r[36] += (0.223606797749979*alpha[11]+0.25*alpha[0])*fUpwind_r[36]+0.2*alpha[5]*fUpwind_r[35]+0.2500000000000001*alpha[1]*fUpwind_r[26]+0.223606797749979*(alpha[2]*fUpwind_r[16]+alpha[5]*fUpwind_r[9]); 
  Ghat_r[37] += 0.2500000000000001*alpha[2]*fUpwind_r[44]+(0.159719141249985*alpha[11]+0.25*alpha[0])*fUpwind_r[37]+0.223606797749979*(alpha[5]*fUpwind_r[31]+alpha[1]*fUpwind_r[17])+0.25*fUpwind_r[10]*alpha[11]; 
  Ghat_r[38] += 0.2500000000000001*alpha[1]*fUpwind_r[45]+0.25*alpha[0]*fUpwind_r[38]+0.223606797749979*(alpha[5]*fUpwind_r[31]+alpha[2]*fUpwind_r[18]); 
  Ghat_r[39] += 0.2500000000000001*alpha[2]*fUpwind_r[46]+0.25*alpha[5]*fUpwind_r[40]+(0.223606797749979*alpha[11]+0.25*alpha[0])*fUpwind_r[39]+0.2500000000000001*alpha[1]*fUpwind_r[27]; 
  Ghat_r[40] += 0.2500000000000001*alpha[1]*fUpwind_r[46]+0.25*(alpha[0]*fUpwind_r[40]+alpha[5]*fUpwind_r[39])+0.2500000000000001*alpha[2]*fUpwind_r[27]; 
  Ghat_r[41] += (0.223606797749979*alpha[11]+0.25*alpha[0])*fUpwind_r[41]+0.2500000000000001*(alpha[1]*fUpwind_r[29]+alpha[2]*fUpwind_r[28])+0.25*alpha[5]*fUpwind_r[14]; 
  Ghat_r[42] += 0.2500000000000001*alpha[2]*fUpwind_r[47]+0.25*alpha[5]*fUpwind_r[43]+(0.223606797749979*alpha[11]+0.25*alpha[0])*fUpwind_r[42]+0.2500000000000001*alpha[1]*fUpwind_r[30]; 
  Ghat_r[43] += 0.2500000000000001*alpha[1]*fUpwind_r[47]+0.25*(alpha[0]*fUpwind_r[43]+alpha[5]*fUpwind_r[42])+0.2500000000000001*alpha[2]*fUpwind_r[30]; 
  Ghat_r[44] += 0.2*alpha[5]*fUpwind_r[45]+(0.159719141249985*alpha[11]+0.25*alpha[0])*fUpwind_r[44]+0.2500000000000001*alpha[2]*fUpwind_r[37]+0.223606797749979*alpha[1]*fUpwind_r[31]+0.2500000000000001*alpha[11]*fUpwind_r[18]+0.223606797749979*alpha[5]*fUpwind_r[17]; 
  Ghat_r[45] += (0.223606797749979*alpha[11]+0.25*alpha[0])*fUpwind_r[45]+0.2*alpha[5]*fUpwind_r[44]+0.2500000000000001*alpha[1]*fUpwind_r[38]+0.223606797749979*(alpha[2]*fUpwind_r[31]+alpha[5]*fUpwind_r[18]); 
  Ghat_r[46] += (0.223606797749979*alpha[11]+0.25*alpha[0])*fUpwind_r[46]+0.2500000000000001*(alpha[1]*fUpwind_r[40]+alpha[2]*fUpwind_r[39])+0.25*alpha[5]*fUpwind_r[27]; 
  Ghat_r[47] += (0.223606797749979*alpha[11]+0.25*alpha[0])*fUpwind_r[47]+0.2500000000000001*(alpha[1]*fUpwind_r[43]+alpha[2]*fUpwind_r[42])+0.25*alpha[5]*fUpwind_r[30]; 
