...
{ 
  ...
  alphaSurf_l[0] = 2.23606797749979*bc[4]*wvpar-1.732050807568877*bc[1]*wvpar+bc[0]*wvpar+2.23606797749979*uc[4]-1.732050807568877*uc[1]+uc[0]; 
  alphaSurf_l[1] = 2.23606797749979*bc[6]*wvpar-1.732050807568877*bc[3]*wvpar+bc[2]*wvpar+2.23606797749979*uc[6]-1.732050807568877*uc[3]+uc[2]; 
  alphaSurf_l[2] = 0.6454972243679029*bc[4]*dvpar-0.5*bc[1]*dvpar+0.2886751345948129*bc[0]*dvpar; 
  alphaSurf_l[3] = 0.6454972243679028*bc[6]*dvpar-0.5*bc[3]*dvpar+0.2886751345948129*bc[2]*dvpar; 
  alphaSurf_l[4] = (-1.732050807568877*bc[7]*wvpar)+bc[5]*wvpar-1.732050807568877*uc[7]+uc[5]; 
  alphaSurf_l[6] = 0.2886751345948129*bc[5]*dvpar-0.5*bc[7]*dvpar; 

  double alphaSurf_r[8] = {0.0}; 
  alphaSurf_r[0] = 2.23606797749979*bc[4]*wvpar+1.732050807568877*bc[1]*wvpar+bc[0]*wvpar+2.23606797749979*uc[4]+1.732050807568877*uc[1]+uc[0]; 
  alphaSurf_r[1] = 2.23606797749979*bc[6]*wvpar+1.732050807568877*bc[3]*wvpar+bc[2]*wvpar+2.23606797749979*uc[6]+1.732050807568877*uc[3]+uc[2]; 
  alphaSurf_r[2] = 0.6454972243679029*bc[4]*dvpar+0.5*bc[1]*dvpar+0.2886751345948129*bc[0]*dvpar; 
  alphaSurf_r[3] = 0.6454972243679028*bc[6]*dvpar+0.5*bc[3]*dvpar+0.2886751345948129*bc[2]*dvpar; 
  alphaSurf_r[4] = 1.732050807568877*bc[7]*wvpar+bc[5]*wvpar+1.732050807568877*uc[7]+uc[5]; 
  alphaSurf_r[6] = 0.5*bc[7]*dvpar+0.2886751345948129*bc[5]*dvpar; 
