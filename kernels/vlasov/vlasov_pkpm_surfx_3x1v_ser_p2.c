...
{ 
  ...
  alphaSurf_l[0] = 2.23606797749979*bc[7]*wvpar-1.732050807568877*bc[1]*wvpar+bc[0]*wvpar+2.23606797749979*uc[7]-1.732050807568877*uc[1]+uc[0]; 
  alphaSurf_l[1] = 2.23606797749979*bc[11]*wvpar-1.732050807568877*bc[4]*wvpar+bc[2]*wvpar+2.23606797749979*uc[11]-1.732050807568877*uc[4]+uc[2]; 
  alphaSurf_l[2] = 2.23606797749979*bc[13]*wvpar-1.732050807568877*bc[5]*wvpar+bc[3]*wvpar+2.23606797749979*uc[13]-1.732050807568877*uc[5]+uc[3]; 
  alphaSurf_l[3] = 0.6454972243679029*bc[7]*dvpar-0.5*bc[1]*dvpar+0.2886751345948129*bc[0]*dvpar; 
  alphaSurf_l[4] = 2.23606797749979*bc[17]*wvpar-1.732050807568877*bc[10]*wvpar+bc[6]*wvpar+2.23606797749979*uc[17]-1.732050807568877*uc[10]+uc[6]; 
  alphaSurf_l[5] = 0.6454972243679028*bc[11]*dvpar-0.5*bc[4]*dvpar+0.2886751345948129*bc[2]*dvpar; 
  alphaSurf_l[6] = 0.6454972243679028*bc[13]*dvpar-0.5*bc[5]*dvpar+0.2886751345948129*bc[3]*dvpar; 
  alphaSurf_l[7] = (-1.732050807568877*bc[12]*wvpar)+bc[8]*wvpar-1.732050807568877*uc[12]+uc[8]; 
  alphaSurf_l[8] = (-1.732050807568877*bc[15]*wvpar)+bc[9]*wvpar-1.732050807568877*uc[15]+uc[9]; 
  alphaSurf_l[10] = 0.6454972243679029*bc[17]*dvpar-0.5*bc[10]*dvpar+0.2886751345948129*bc[6]*dvpar; 
  alphaSurf_l[11] = (-1.732050807568877*bc[18]*wvpar)+bc[14]*wvpar-1.732050807568877*uc[18]+uc[14]; 
  alphaSurf_l[12] = (-1.732050807568877*bc[19]*wvpar)+bc[16]*wvpar-1.732050807568877*uc[19]+uc[16]; 
  alphaSurf_l[13] = 0.2886751345948129*bc[8]*dvpar-0.5*bc[12]*dvpar; 
  alphaSurf_l[14] = 0.2886751345948129*bc[9]*dvpar-0.5*bc[15]*dvpar; 
  alphaSurf_l[17] = 0.2886751345948129*bc[14]*dvpar-0.5*bc[18]*dvpar; 
  alphaSurf_l[18] = 0.2886751345948129*bc[16]*dvpar-0.5*bc[19]*dvpar; 

  double alphaSurf_r[20] = {0.0}; 
  alphaSurf_r[0] = 2.23606797749979*bc[7]*wvpar+1.732050807568877*bc[1]*wvpar+bc[0]*wvpar+2.23606797749979*uc[7]+1.732050807568877*uc[1]+uc[0]; 
  alphaSurf_r[1] = 2.23606797749979*bc[11]*wvpar+1.732050807568877*bc[4]*wvpar+bc[2]*wvpar+2.23606797749979*uc[11]+1.732050807568877*uc[4]+uc[2]; 
  alphaSurf_r[2] = 2.23606797749979*bc[13]*wvpar+1.732050807568877*bc[5]*wvpar+bc[3]*wvpar+2.23606797749979*uc[13]+1.732050807568877*uc[5]+uc[3]; 
  alphaSurf_r[3] = 0.6454972243679029*bc[7]*dvpar+0.5*bc[1]*dvpar+0.2886751345948129*bc[0]*dvpar; 
  alphaSurf_r[4] = 2.23606797749979*bc[17]*wvpar+1.732050807568877*bc[10]*wvpar+bc[6]*wvpar+2.23606797749979*uc[17]+1.732050807568877*uc[10]+uc[6]; 
  alphaSurf_r[5] = 0.6454972243679028*bc[11]*dvpar+0.5*bc[4]*dvpar+0.2886751345948129*bc[2]*dvpar; 
  alphaSurf_r[6] = 0.6454972243679028*bc[13]*dvpar+0.5*bc[5]*dvpar+0.2886751345948129*bc[3]*dvpar; 
  alphaSurf_r[7] = 1.732050807568877*bc[12]*wvpar+bc[8]*wvpar+1.732050807568877*uc[12]+uc[8]; 
  alphaSurf_r[8] = 1.732050807568877*bc[15]*wvpar+bc[9]*wvpar+1.732050807568877*uc[15]+uc[9]; 
  alphaSurf_r[10] = 0.6454972243679029*bc[17]*dvpar+0.5*bc[10]*dvpar+0.2886751345948129*bc[6]*dvpar; 
  alphaSurf_r[11] = 1.732050807568877*bc[18]*wvpar+bc[14]*wvpar+1.732050807568877*uc[18]+uc[14]; 
  alphaSurf_r[12] = 1.732050807568877*bc[19]*wvpar+bc[16]*wvpar+1.732050807568877*uc[19]+uc[16]; 
  alphaSurf_r[13] = 0.5*bc[12]*dvpar+0.2886751345948129*bc[8]*dvpar; 
  alphaSurf_r[14] = 0.5*bc[15]*dvpar+0.2886751345948129*bc[9]*dvpar; 
  alphaSurf_r[17] = 0.5*bc[18]*dvpar+0.2886751345948129*bc[14]*dvpar; 
  alphaSurf_r[18] = 0.5*bc[19]*dvpar+0.2886751345948129*bc[16]*dvpar; 
