...
{ 
  ...
  const double *G_1_sourceSkin = &g_dist_sourceSkin[12]; 
  const double *F_0_sourceEdge = &g_dist_sourceEdge[0]; 
  const double *G_1_sourceEdge = &g_dist_sourceEdge[12]; 
  ...
  double alphaSurf_F_0[4] = {0.0}; 
  double alphaSurf_G_1[4] = {0.0}; 
  ...
  if (0.5*alphaSurf_F_0[3]-0.5*(alphaSurf_F_0[2]+alphaSurf_F_0[1])+0.5*alphaSurf_F_0[0] > 0) { 
  ...
  if ((-0.5*alphaSurf_F_0[3])+0.5*alphaSurf_F_0[2]-0.5*alphaSurf_F_0[1]+0.5*alphaSurf_F_0[0] > 0) { 
  ...
  if (0.5*(alphaSurf_F_0[1]+alphaSurf_F_0[0])-0.5*(alphaSurf_F_0[3]+alphaSurf_F_0[2]) > 0) { 
  ...
  if (0.5*(alphaSurf_F_0[3]+alphaSurf_F_0[2]+alphaSurf_F_0[1]+alphaSurf_F_0[0]) > 0) { 
  ...
  if (0.5*alphaSurf_G_1[3]-0.5*(alphaSurf_G_1[2]+alphaSurf_G_1[1])+0.5*alphaSurf_G_1[0] > 0) { 
  ...
  if ((-0.5*alphaSurf_G_1[3])+0.5*alphaSurf_G_1[2]-0.5*alphaSurf_G_1[1]+0.5*alphaSurf_G_1[0] > 0) { 
  ...
  if (0.5*(alphaSurf_G_1[1]+alphaSurf_G_1[0])-0.5*(alphaSurf_G_1[3]+alphaSurf_G_1[2]) > 0) { 
  ...
  if (0.5*(alphaSurf_G_1[3]+alphaSurf_G_1[2]+alphaSurf_G_1[1]+alphaSurf_G_1[0]) > 0) { 
  ...
  Ghat_F_0[0] = 0.5*F_0_Upwind[3]*alphaSurf_F_0[3]+0.5*F_0_Upwind[2]*alphaSurf_F_0[2]+0.5*F_0_Upwind[1]*alphaSurf_F_0[1]+0.5*F_0_Upwind[0]*alphaSurf_F_0[0]; 
  Ghat_F_0[1] = 0.5*F_0_Upwind[2]*alphaSurf_F_0[3]+0.5*alphaSurf_F_0[2]*F_0_Upwind[3]+0.5*F_0_Upwind[0]*alphaSurf_F_0[1]+0.5*alphaSurf_F_0[0]*F_0_Upwind[1]; 
  Ghat_F_0[2] = 0.5*F_0_Upwind[1]*alphaSurf_F_0[3]+0.5*alphaSurf_F_0[1]*F_0_Upwind[3]+0.5*F_0_Upwind[0]*alphaSurf_F_0[2]+0.5*alphaSurf_F_0[0]*F_0_Upwind[2]; 
  Ghat_F_0[3] = 0.5*F_0_Upwind[0]*alphaSurf_F_0[3]+0.5*alphaSurf_F_0[0]*F_0_Upwind[3]+0.5*F_0_Upwind[1]*alphaSurf_F_0[2]+0.5*alphaSurf_F_0[1]*F_0_Upwind[2]; 
  Ghat_G_1[0] = 0.5*G_1_Upwind[3]*alphaSurf_G_1[3]+0.5*G_1_Upwind[2]*alphaSurf_G_1[2]+0.5*G_1_Upwind[1]*alphaSurf_G_1[1]+0.5*G_1_Upwind[0]*alphaSurf_G_1[0]; 
  Ghat_G_1[1] = 0.5*G_1_Upwind[2]*alphaSurf_G_1[3]+0.5*alphaSurf_G_1[2]*G_1_Upwind[3]+0.5*G_1_Upwind[0]*alphaSurf_G_1[1]+0.5*alphaSurf_G_1[0]*G_1_Upwind[1]; 
  Ghat_G_1[2] = 0.5*G_1_Upwind[1]*alphaSurf_G_1[3]+0.5*alphaSurf_G_1[1]*G_1_Upwind[3]+0.5*G_1_Upwind[0]*alphaSurf_G_1[2]+0.5*alphaSurf_G_1[0]*G_1_Upwind[2]; 
  Ghat_G_1[3] = 0.5*G_1_Upwind[0]*alphaSurf_G_1[3]+0.5*alphaSurf_G_1[0]*G_1_Upwind[3]+0.5*G_1_Upwind[1]*alphaSurf_G_1[2]+0.5*alphaSurf_G_1[1]*G_1_Upwind[2]; 
  ...
  out_F_0[6] += 1.224744871391589*Ghat_F_0_div_b[2]*dv1par-1.224744871391589*Ghat_F_0[2]*dv1par; 
  out_F_0[7] += 1.224744871391589*Ghat_F_0_div_b[3]*dv1par-1.224744871391589*Ghat_F_0[3]*dv1par; 
  out_F_0[8] += 1.58113883008419*Ghat_F_0[0]*dv1par-1.58113883008419*Ghat_F_0_div_b[0]*dv1par; 
  out_F_0[9] += 1.58113883008419*Ghat_F_0[1]*dv1par-1.58113883008419*Ghat_F_0_div_b[1]*dv1par; 
  out_F_0[10] += 1.58113883008419*Ghat_F_0[2]*dv1par-1.58113883008419*Ghat_F_0_div_b[2]*dv1par; 
  out_F_0[11] += 1.58113883008419*Ghat_F_0[3]*dv1par-1.58113883008419*Ghat_F_0_div_b[3]*dv1par; 
  ...
  out_G_1[6] += 1.224744871391589*Ghat_G_1_div_b[2]*dv1par-1.224744871391589*Ghat_G_1[2]*dv1par; 
  out_G_1[7] += 1.224744871391589*Ghat_G_1_div_b[3]*dv1par-1.224744871391589*Ghat_G_1[3]*dv1par; 
  out_G_1[8] += 1.58113883008419*Ghat_G_1[0]*dv1par-1.58113883008419*Ghat_G_1_div_b[0]*dv1par; 
  out_G_1[9] += 1.58113883008419*Ghat_G_1[1]*dv1par-1.58113883008419*Ghat_G_1_div_b[1]*dv1par; 
  out_G_1[10] += 1.58113883008419*Ghat_G_1[2]*dv1par-1.58113883008419*Ghat_G_1_div_b[2]*dv1par; 
  out_G_1[11] += 1.58113883008419*Ghat_G_1[3]*dv1par-1.58113883008419*Ghat_G_1_div_b[3]*dv1par; 
