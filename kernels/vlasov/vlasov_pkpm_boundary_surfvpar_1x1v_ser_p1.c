...
{ 
  ...
  alphaSurf[0] = ((-1.224744871391589*bxbz[0]*uz[1])-1.224744871391589*bxby[0]*uy[1]-1.224744871391589*bxbx[0]*ux[1])*dx0*wvpar+((-0.6123724356957944*bxbz[0]*uz[1])-0.6123724356957944*bxby[0]*uy[1]-0.6123724356957944*bxbx[0]*ux[1])*dvpar*dx0+0.7071067811865475*div_p_z[1]*rho_inv_bz[1]+0.7071067811865475*div_p_y[1]*rho_inv_by[1]+0.7071067811865475*div_p_x[1]*rho_inv_bx[1]+0.7071067811865475*div_p_z[0]*rho_inv_bz[0]+0.7071067811865475*div_p_y[0]*rho_inv_by[0]+0.7071067811865475*div_p_x[0]*rho_inv_bx[0]; 
  alphaSurf[1] = ((-1.224744871391589*bxbz[1]*uz[1])-1.224744871391589*bxby[1]*uy[1]-1.224744871391589*bxbx[1]*ux[1])*dx0*wvpar+((-0.6123724356957944*bxbz[1]*uz[1])-0.6123724356957944*bxby[1]*uy[1]-0.6123724356957944*bxbx[1]*ux[1])*dvpar*dx0+0.7071067811865475*div_p_z[0]*rho_inv_bz[1]+0.7071067811865475*div_p_y[0]*rho_inv_by[1]+0.7071067811865475*div_p_x[0]*rho_inv_bx[1]+0.7071067811865475*rho_inv_bz[0]*div_p_z[1]+0.7071067811865475*rho_inv_by[0]*div_p_y[1]+0.7071067811865475*rho_inv_bx[0]*div_p_x[1]; 
