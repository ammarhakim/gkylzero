...
GKYL_CU_DH void vlasov_poisson_boundary_surfvy_2x3v_ser_p2(const double *w, const double *dxv, const double *fac_phi, const double *vecA, const int edge, const double *fEdge, const double *fSkin, double* GKYL_RESTRICT out) 
{ 
  ...
  if ((-0.2795084971874737*alpha[11])-0.3354101966249685*alpha[2]+0.25*alpha[0] > 0) { 
  ...
  if (0.223606797749979*alpha[11]-0.45*alpha[5]-0.3354101966249685*alpha[2]+0.3354101966249685*alpha[1]+0.25*alpha[0] > 0) { 
  ...
  if (0.223606797749979*alpha[11]-0.3354101966249685*alpha[1]+0.25*alpha[0] > 0) { 
  ...
  if (0.25*alpha[0]-0.2795084971874737*alpha[11] > 0) { 
  ...
  Ghat[0] += 0.25*(alpha[11]*fUpwind[11]+alpha[5]*fUpwind[5]+alpha[2]*fUpwind[2]+alpha[1]*fUpwind[1]+alpha[0]*fUpwind[0]); 
  Ghat[1] += 0.223606797749979*alpha[5]*fUpwind[19]+0.223606797749979*(alpha[1]*fUpwind[11]+fUpwind[1]*alpha[11])+0.25*(alpha[2]*fUpwind[5]+fUpwind[2]*alpha[5]+alpha[0]*fUpwind[1]+fUpwind[0]*alpha[1]); 
  Ghat[2] += 0.223606797749979*alpha[5]*fUpwind[20]+0.2500000000000001*alpha[11]*fUpwind[19]+0.223606797749979*alpha[2]*fUpwind[12]+0.25*(alpha[1]*fUpwind[5]+fUpwind[1]*alpha[5]+alpha[0]*fUpwind[2]+fUpwind[0]*alpha[2]); 
  Ghat[3] += 0.2500000000000001*alpha[11]*fUpwind[21]+0.25*(alpha[5]*fUpwind[15]+alpha[2]*fUpwind[7]+alpha[1]*fUpwind[6]+alpha[0]*fUpwind[3]); 
  Ghat[4] += 0.2500000000000001*alpha[11]*fUpwind[25]+0.25*(alpha[5]*fUpwind[16]+alpha[2]*fUpwind[9]+alpha[1]*fUpwind[8]+alpha[0]*fUpwind[4]); 
  Ghat[5] += 0.223606797749979*(alpha[2]*fUpwind[20]+alpha[1]*fUpwind[19])+0.223606797749979*(alpha[5]*(fUpwind[12]+fUpwind[11])+fUpwind[5]*alpha[11])+0.25*(alpha[0]*fUpwind[5]+fUpwind[0]*alpha[5]+alpha[1]*fUpwind[2]+fUpwind[1]*alpha[2]); 
  Ghat[6] += 0.223606797749979*alpha[5]*fUpwind[32]+0.223606797749979*alpha[1]*fUpwind[21]+0.25*alpha[2]*fUpwind[15]+0.223606797749979*fUpwind[6]*alpha[11]+0.25*(alpha[5]*fUpwind[7]+alpha[0]*fUpwind[6]+alpha[1]*fUpwind[3]); 
  Ghat[7] += 0.223606797749979*alpha[5]*fUpwind[33]+0.25*alpha[11]*fUpwind[32]+0.223606797749979*alpha[2]*fUpwind[22]+0.25*(alpha[1]*fUpwind[15]+alpha[0]*fUpwind[7]+alpha[5]*fUpwind[6]+alpha[2]*fUpwind[3]); 
  Ghat[8] += 0.223606797749979*alpha[5]*fUpwind[35]+0.223606797749979*alpha[1]*fUpwind[25]+0.25*alpha[2]*fUpwind[16]+0.223606797749979*fUpwind[8]*alpha[11]+0.25*(alpha[5]*fUpwind[9]+alpha[0]*fUpwind[8]+alpha[1]*fUpwind[4]); 
  Ghat[9] += 0.223606797749979*alpha[5]*fUpwind[36]+0.25*alpha[11]*fUpwind[35]+0.223606797749979*alpha[2]*fUpwind[26]+0.25*(alpha[1]*fUpwind[16]+alpha[0]*fUpwind[9]+alpha[5]*fUpwind[8]+alpha[2]*fUpwind[4]); 
  Ghat[10] += 0.25*(alpha[11]*fUpwind[37]+alpha[5]*fUpwind[31]+alpha[2]*fUpwind[18]+alpha[1]*fUpwind[17]+alpha[0]*fUpwind[10]); 
  Ghat[11] += 0.2500000000000001*alpha[2]*fUpwind[19]+0.159719141249985*alpha[11]*fUpwind[11]+0.25*(alpha[0]*fUpwind[11]+fUpwind[0]*alpha[11])+0.223606797749979*(alpha[5]*fUpwind[5]+alpha[1]*fUpwind[1]); 
  Ghat[12] += 0.2500000000000001*alpha[1]*fUpwind[20]+0.25*alpha[0]*fUpwind[12]+0.223606797749979*(alpha[5]*fUpwind[5]+alpha[2]*fUpwind[2]); 
  ...
  Ghat[15] += 0.223606797749979*(alpha[2]*fUpwind[33]+alpha[1]*fUpwind[32])+0.223606797749979*alpha[5]*(fUpwind[22]+fUpwind[21])+0.223606797749979*alpha[11]*fUpwind[15]+0.25*(alpha[0]*fUpwind[15]+alpha[1]*fUpwind[7]+alpha[2]*fUpwind[6]+fUpwind[3]*alpha[5]); 
  Ghat[16] += 0.223606797749979*(alpha[2]*fUpwind[36]+alpha[1]*fUpwind[35])+0.223606797749979*alpha[5]*(fUpwind[26]+fUpwind[25])+0.223606797749979*alpha[11]*fUpwind[16]+0.25*(alpha[0]*fUpwind[16]+alpha[1]*fUpwind[9]+alpha[2]*fUpwind[8]+fUpwind[4]*alpha[5]); 
  Ghat[17] += 0.223606797749979*alpha[5]*fUpwind[44]+0.223606797749979*alpha[1]*fUpwind[37]+0.25*(alpha[2]*fUpwind[31]+alpha[5]*fUpwind[18])+0.223606797749979*alpha[11]*fUpwind[17]+0.25*(alpha[0]*fUpwind[17]+alpha[1]*fUpwind[10]); 
  Ghat[18] += 0.223606797749979*alpha[5]*fUpwind[45]+0.2500000000000001*alpha[11]*fUpwind[44]+0.223606797749979*alpha[2]*fUpwind[38]+0.25*(alpha[1]*fUpwind[31]+alpha[0]*fUpwind[18]+alpha[5]*fUpwind[17]+alpha[2]*fUpwind[10]); 
  Ghat[19] += 0.2*alpha[5]*fUpwind[20]+(0.159719141249985*alpha[11]+0.25*alpha[0])*fUpwind[19]+0.2500000000000001*(alpha[2]*fUpwind[11]+fUpwind[2]*alpha[11])+0.223606797749979*(alpha[1]*fUpwind[5]+fUpwind[1]*alpha[5]); 
  Ghat[20] += (0.223606797749979*alpha[11]+0.25*alpha[0])*fUpwind[20]+0.2*alpha[5]*fUpwind[19]+0.2500000000000001*alpha[1]*fUpwind[12]+0.223606797749979*(alpha[2]*fUpwind[5]+fUpwind[2]*alpha[5]); 
  Ghat[21] += 0.2500000000000001*alpha[2]*fUpwind[32]+(0.159719141249985*alpha[11]+0.25*alpha[0])*fUpwind[21]+0.223606797749979*alpha[5]*fUpwind[15]+0.2500000000000001*fUpwind[3]*alpha[11]+0.223606797749979*alpha[1]*fUpwind[6]; 
  Ghat[22] += 0.2500000000000001*alpha[1]*fUpwind[33]+0.25*alpha[0]*fUpwind[22]+0.223606797749979*(alpha[5]*fUpwind[15]+alpha[2]*fUpwind[7]); 
  Ghat[23] += 0.2500000000000001*alpha[2]*fUpwind[34]+0.25*alpha[5]*fUpwind[24]+(0.223606797749979*alpha[11]+0.25*alpha[0])*fUpwind[23]+0.2500000000000001*alpha[1]*fUpwind[13]; 
  Ghat[24] += 0.2500000000000001*alpha[1]*fUpwind[34]+0.25*(alpha[0]*fUpwind[24]+alpha[5]*fUpwind[23])+0.2500000000000001*alpha[2]*fUpwind[13]; 
  Ghat[25] += 0.2500000000000001*alpha[2]*fUpwind[35]+(0.159719141249985*alpha[11]+0.25*alpha[0])*fUpwind[25]+0.223606797749979*alpha[5]*fUpwind[16]+0.2500000000000001*fUpwind[4]*alpha[11]+0.223606797749979*alpha[1]*fUpwind[8]; 
  Ghat[26] += 0.2500000000000001*alpha[1]*fUpwind[36]+0.25*alpha[0]*fUpwind[26]+0.223606797749979*(alpha[5]*fUpwind[16]+alpha[2]*fUpwind[9]); 
  Ghat[27] += 0.25*alpha[5]*fUpwind[46]+0.2500000000000001*(alpha[2]*fUpwind[40]+alpha[1]*fUpwind[39])+0.25*alpha[0]*fUpwind[27]; 
  Ghat[28] += 0.2500000000000001*alpha[2]*fUpwind[41]+0.25*alpha[5]*fUpwind[29]+(0.223606797749979*alpha[11]+0.25*alpha[0])*fUpwind[28]+0.2500000000000001*alpha[1]*fUpwind[14]; 
  Ghat[29] += 0.2500000000000001*alpha[1]*fUpwind[41]+0.25*(alpha[0]*fUpwind[29]+alpha[5]*fUpwind[28])+0.2500000000000001*alpha[2]*fUpwind[14]; 
  Ghat[30] += 0.25*alpha[5]*fUpwind[47]+0.2500000000000001*(alpha[2]*fUpwind[43]+alpha[1]*fUpwind[42])+0.25*alpha[0]*fUpwind[30]; 
  Ghat[31] += 0.223606797749979*(alpha[2]*fUpwind[45]+alpha[1]*fUpwind[44])+0.223606797749979*(alpha[5]*(fUpwind[38]+fUpwind[37])+alpha[11]*fUpwind[31])+0.25*(alpha[0]*fUpwind[31]+alpha[1]*fUpwind[18]+alpha[2]*fUpwind[17]+alpha[5]*fUpwind[10]); 
  Ghat[32] += 0.2*alpha[5]*fUpwind[33]+(0.159719141249985*alpha[11]+0.25*alpha[0])*fUpwind[32]+0.2500000000000001*alpha[2]*fUpwind[21]+0.223606797749979*alpha[1]*fUpwind[15]+0.25*fUpwind[7]*alpha[11]+0.223606797749979*alpha[5]*fUpwind[6]; 
  Ghat[33] += (0.223606797749979*alpha[11]+0.25*alpha[0])*fUpwind[33]+0.2*alpha[5]*fUpwind[32]+0.2500000000000001*alpha[1]*fUpwind[22]+0.223606797749979*(alpha[2]*fUpwind[15]+alpha[5]*fUpwind[7]); 
  Ghat[34] += (0.223606797749979*alpha[11]+0.25*alpha[0])*fUpwind[34]+0.2500000000000001*(alpha[1]*fUpwind[24]+alpha[2]*fUpwind[23])+0.25*alpha[5]*fUpwind[13]; 
  Ghat[35] += 0.2*alpha[5]*fUpwind[36]+(0.159719141249985*alpha[11]+0.25*alpha[0])*fUpwind[35]+0.2500000000000001*alpha[2]*fUpwind[25]+0.223606797749979*alpha[1]*fUpwind[16]+0.25*fUpwind[9]*alpha[11]+0.223606797749979*alpha[5]*fUpwind[8]; 
  Ghat[36] += (0.223606797749979*alpha[11]+0.25*alpha[0])*fUpwind[36]+0.2*alpha[5]*fUpwind[35]+0.2500000000000001*alpha[1]*fUpwind[26]+0.223606797749979*(alpha[2]*fUpwind[16]+alpha[5]*fUpwind[9]); 
  Ghat[37] += 0.2500000000000001*alpha[2]*fUpwind[44]+(0.159719141249985*alpha[11]+0.25*alpha[0])*fUpwind[37]+0.223606797749979*(alpha[5]*fUpwind[31]+alpha[1]*fUpwind[17])+0.25*fUpwind[10]*alpha[11]; 
  Ghat[38] += 0.2500000000000001*alpha[1]*fUpwind[45]+0.25*alpha[0]*fUpwind[38]+0.223606797749979*(alpha[5]*fUpwind[31]+alpha[2]*fUpwind[18]); 
  Ghat[39] += 0.2500000000000001*alpha[2]*fUpwind[46]+0.25*alpha[5]*fUpwind[40]+(0.223606797749979*alpha[11]+0.25*alpha[0])*fUpwind[39]+0.2500000000000001*alpha[1]*fUpwind[27]; 
  Ghat[40] += 0.2500000000000001*alpha[1]*fUpwind[46]+0.25*(alpha[0]*fUpwind[40]+alpha[5]*fUpwind[39])+0.2500000000000001*alpha[2]*fUpwind[27]; 
  Ghat[41] += (0.223606797749979*alpha[11]+0.25*alpha[0])*fUpwind[41]+0.2500000000000001*(alpha[1]*fUpwind[29]+alpha[2]*fUpwind[28])+0.25*alpha[5]*fUpwind[14]; 
  Ghat[42] += 0.2500000000000001*alpha[2]*fUpwind[47]+0.25*alpha[5]*fUpwind[43]+(0.223606797749979*alpha[11]+0.25*alpha[0])*fUpwind[42]+0.2500000000000001*alpha[1]*fUpwind[30]; 
  Ghat[43] += 0.2500000000000001*alpha[1]*fUpwind[47]+0.25*(alpha[0]*fUpwind[43]+alpha[5]*fUpwind[42])+0.2500000000000001*alpha[2]*fUpwind[30]; 
  Ghat[44] += 0.2*alpha[5]*fUpwind[45]+(0.159719141249985*alpha[11]+0.25*alpha[0])*fUpwind[44]+0.2500000000000001*alpha[2]*fUpwind[37]+0.223606797749979*alpha[1]*fUpwind[31]+0.2500000000000001*alpha[11]*fUpwind[18]+0.223606797749979*alpha[5]*fUpwind[17]; 
  Ghat[45] += (0.223606797749979*alpha[11]+0.25*alpha[0])*fUpwind[45]+0.2*alpha[5]*fUpwind[44]+0.2500000000000001*alpha[1]*fUpwind[38]+0.223606797749979*(alpha[2]*fUpwind[31]+alpha[5]*fUpwind[18]); 
  Ghat[46] += (0.223606797749979*alpha[11]+0.25*alpha[0])*fUpwind[46]+0.2500000000000001*(alpha[1]*fUpwind[40]+alpha[2]*fUpwind[39])+0.25*alpha[5]*fUpwind[27]; 
  Ghat[47] += (0.223606797749979*alpha[11]+0.25*alpha[0])*fUpwind[47]+0.2500000000000001*(alpha[1]*fUpwind[43]+alpha[2]*fUpwind[42])+0.25*alpha[5]*fUpwind[30]; 
