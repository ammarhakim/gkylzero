...
GKYL_CU_DH double vlasov_poisson_extem_boundary_surfvx_1x3v_ser_p1(const double *w, const double *dxv, const double *field, const double *ext_field, const int edge, const double *fEdge, const double *fSkin, double* GKYL_RESTRICT out) 
{ 
  ...
  Ghat[4] = 0.3162277660168379*alpha[2]*fUpwind[9]+0.3535533905932737*alpha[3]*fUpwind[7]+0.3535533905932737*alpha[0]*fUpwind[4]+0.3535533905932737*fUpwind[1]*alpha[2]; 
  Ghat[5] = 0.3162277660168379*alpha[3]*fUpwind[13]+0.3535533905932737*alpha[2]*fUpwind[7]+0.3535533905932737*alpha[0]*fUpwind[5]+0.3535533905932737*fUpwind[1]*alpha[3]; 
  Ghat[6] = 0.3162277660168379*alpha[3]*fUpwind[14]+0.3162277660168379*alpha[2]*fUpwind[10]+0.3535533905932737*alpha[0]*fUpwind[6]+0.3535533905932737*alpha[2]*fUpwind[3]+0.3535533905932737*fUpwind[2]*alpha[3]; 
  ...
  Ghat[9] = 0.3535533905932737*alpha[3]*fUpwind[11]+0.3535533905932737*alpha[0]*fUpwind[9]+0.3162277660168379*alpha[2]*fUpwind[4]; 
  Ghat[10] = 0.3535533905932737*alpha[0]*fUpwind[10]+0.3535533905932737*alpha[3]*fUpwind[8]+0.3162277660168379*alpha[2]*fUpwind[6]; 
  ...
  Ghat[13] = 0.3535533905932737*alpha[2]*fUpwind[15]+0.3535533905932737*alpha[0]*fUpwind[13]+0.3162277660168379*alpha[3]*fUpwind[5]; 
  Ghat[14] = 0.3535533905932737*alpha[0]*fUpwind[14]+0.3535533905932737*alpha[2]*fUpwind[12]+0.3162277660168379*alpha[3]*fUpwind[6]; 
