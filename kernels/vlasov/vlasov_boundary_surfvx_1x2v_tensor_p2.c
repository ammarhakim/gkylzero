...
{ 
  ...
  if ((-0.5999999999999999*alpha[6])+0.4472135954999579*alpha[4]+0.9*alpha[3]-0.6708203932499369*(alpha[2]+alpha[1])+0.5*alpha[0] > 0) { 
    ...
    fUpwindQuad[0] = tensor_1x2v_p2_surfvx_quad_0(1, fSkin); 
  } else { 

    fUpwindQuad[0] = tensor_1x2v_p2_surfvx_quad_0(-1, fEdge); 
  } 
  if (0.75*alpha[6]-0.5590169943749475*alpha[4]-0.6708203932499369*alpha[2]+0.5*alpha[0] > 0) { 

    fUpwindQuad[1] = tensor_1x2v_p2_surfvx_quad_1(1, fSkin); 
  } else { 

    fUpwindQuad[1] = tensor_1x2v_p2_surfvx_quad_1(-1, fEdge); 
  } 
  if ((-0.5999999999999999*alpha[6])+0.4472135954999579*alpha[4]-0.9*alpha[3]-0.6708203932499369*alpha[2]+0.6708203932499369*alpha[1]+0.5*alpha[0] > 0) { 
    ...
    fUpwindQuad[2] = tensor_1x2v_p2_surfvx_quad_2(1, fSkin); 
  } else { 

    fUpwindQuad[2] = tensor_1x2v_p2_surfvx_quad_2(-1, fEdge); 
  } 
  if (0.4472135954999579*alpha[4]-0.6708203932499369*alpha[1]+0.5*alpha[0] > 0) { 

    fUpwindQuad[3] = tensor_1x2v_p2_surfvx_quad_3(1, fSkin); 
  } else { 

    fUpwindQuad[3] = tensor_1x2v_p2_surfvx_quad_3(-1, fEdge); 
  } 
  if (0.5*alpha[0]-0.5590169943749475*alpha[4] > 0) { 

    fUpwindQuad[4] = tensor_1x2v_p2_surfvx_quad_4(1, fSkin); 
  } else { 

    fUpwindQuad[4] = tensor_1x2v_p2_surfvx_quad_4(-1, fEdge); 
  } 
  if (0.4472135954999579*alpha[4]+0.6708203932499369*alpha[1]+0.5*alpha[0] > 0) { 

    fUpwindQuad[5] = tensor_1x2v_p2_surfvx_quad_5(1, fSkin); 
  } else { 

    fUpwindQuad[5] = tensor_1x2v_p2_surfvx_quad_5(-1, fEdge); 
  } 
  if (0.5999999999999999*alpha[6]+0.4472135954999579*alpha[4]-0.9*alpha[3]+0.6708203932499369*alpha[2]-0.6708203932499369*alpha[1]+0.5*alpha[0] > 0) { 

    fUpwindQuad[6] = tensor_1x2v_p2_surfvx_quad_6(1, fSkin); 
  } else { 

    fUpwindQuad[6] = tensor_1x2v_p2_surfvx_quad_6(-1, fEdge); 
  } 
  if ((-0.75*alpha[6])-0.5590169943749475*alpha[4]+0.6708203932499369*alpha[2]+0.5*alpha[0] > 0) { 

    fUpwindQuad[7] = tensor_1x2v_p2_surfvx_quad_7(1, fSkin); 
  } else { 

    fUpwindQuad[7] = tensor_1x2v_p2_surfvx_quad_7(-1, fEdge); 
  } 
  if (0.5999999999999999*alpha[6]+0.4472135954999579*alpha[4]+0.9*alpha[3]+0.6708203932499369*(alpha[2]+alpha[1])+0.5*alpha[0] > 0) { 

    fUpwindQuad[8] = tensor_1x2v_p2_surfvx_quad_8(1, fSkin); 
  } else { 

    fUpwindQuad[8] = tensor_1x2v_p2_surfvx_quad_8(-1, fEdge); 
  } 
