...
{ 
  ...
  Ghat_r[12] = (0.3162277660168379*fc[9]+0.1825741858350554*fc[4])*dv; 
  Ghat_r[13] = (0.3162277660168379*fc[12]+0.1825741858350554*fc[8])*dv; 
  Ghat_r[14] = (0.3162277660168379*fc[14]+0.1825741858350554*fc[10])*dv; 
  Ghat_r[15] = (0.3162277660168379*fc[15]+0.1825741858350554*fc[13])*dv; 
  ...
  Ghat_l[12] = (0.3162277660168379*fl[9]+0.1825741858350554*fl[4])*dv; 
  Ghat_l[13] = (0.3162277660168379*fl[12]+0.1825741858350554*fl[8])*dv; 
  Ghat_l[14] = (0.3162277660168379*fl[14]+0.1825741858350554*fl[10])*dv; 
  Ghat_l[15] = (0.3162277660168379*fl[15]+0.1825741858350554*fl[13])*dv; 

  } else { 

  Ghat_r[0] = -0.1178511301977579*((10.39230484541326*fr[2]-6.0*fr[0])*wv+(3.0*fr[9]-1.732050807568877*fr[4])*dv); 
  Ghat_r[1] = -0.1178511301977579*((10.39230484541326*fr[5]-6.0*fr[1])*wv+(3.0*fr[12]-1.732050807568877*fr[8])*dv); 
  Ghat_r[2] = -0.1178511301977579*((10.39230484541326*fr[7]-6.0*fr[3])*wv+(3.0*fr[14]-1.732050807568877*fr[10])*dv); 
  Ghat_r[3] = -0.1178511301977579*((10.39230484541326*fr[9]-6.0*fr[4])*wv+(3.0*fr[2]-1.732050807568877*fr[0])*dv); 
  Ghat_r[4] = -0.1178511301977579*((10.39230484541326*fr[11]-6.0*fr[6])*wv+(3.0*fr[15]-1.732050807568877*fr[13])*dv); 
  Ghat_r[5] = -0.1178511301977579*((10.39230484541326*fr[12]-6.0*fr[8])*wv+(3.0*fr[5]-1.732050807568877*fr[1])*dv); 
  Ghat_r[6] = -0.1178511301977579*((10.39230484541326*fr[14]-6.0*fr[10])*wv+(3.0*fr[7]-1.732050807568877*fr[3])*dv); 
  Ghat_r[7] = -0.1178511301977579*((10.39230484541326*fr[15]-6.0*fr[13])*wv+(3.0*fr[11]-1.732050807568877*fr[6])*dv); 
  Ghat_r[12] = -0.04714045207910316*(6.708203932499369*fr[9]-3.872983346207417*fr[4])*dv; 
  Ghat_r[13] = -0.04714045207910316*(6.708203932499369*fr[12]-3.872983346207417*fr[8])*dv; 
  Ghat_r[14] = -0.04714045207910316*(6.708203932499369*fr[14]-3.872983346207417*fr[10])*dv; 
  Ghat_r[15] = -0.04714045207910316*(6.708203932499369*fr[15]-3.872983346207417*fr[13])*dv; 

  Ghat_l[0] = -0.1178511301977579*((10.39230484541326*fc[2]-6.0*fc[0])*wv+(3.0*fc[9]-1.732050807568877*fc[4])*dv); 
  Ghat_l[1] = -0.1178511301977579*((10.39230484541326*fc[5]-6.0*fc[1])*wv+(3.0*fc[12]-1.732050807568877*fc[8])*dv); 
  Ghat_l[2] = -0.1178511301977579*((10.39230484541326*fc[7]-6.0*fc[3])*wv+(3.0*fc[14]-1.732050807568877*fc[10])*dv); 
  Ghat_l[3] = -0.1178511301977579*((10.39230484541326*fc[9]-6.0*fc[4])*wv+(3.0*fc[2]-1.732050807568877*fc[0])*dv); 
  Ghat_l[4] = -0.1178511301977579*((10.39230484541326*fc[11]-6.0*fc[6])*wv+(3.0*fc[15]-1.732050807568877*fc[13])*dv); 
  Ghat_l[5] = -0.1178511301977579*((10.39230484541326*fc[12]-6.0*fc[8])*wv+(3.0*fc[5]-1.732050807568877*fc[1])*dv); 
  Ghat_l[6] = -0.1178511301977579*((10.39230484541326*fc[14]-6.0*fc[10])*wv+(3.0*fc[7]-1.732050807568877*fc[3])*dv); 
  Ghat_l[7] = -0.1178511301977579*((10.39230484541326*fc[15]-6.0*fc[13])*wv+(3.0*fc[11]-1.732050807568877*fc[6])*dv); 
  Ghat_l[12] = -0.04714045207910316*(6.708203932499369*fc[9]-3.872983346207417*fc[4])*dv; 
  Ghat_l[13] = -0.04714045207910316*(6.708203932499369*fc[12]-3.872983346207417*fc[8])*dv; 
  Ghat_l[14] = -0.04714045207910316*(6.708203932499369*fc[14]-3.872983346207417*fc[10])*dv; 
  Ghat_l[15] = -0.04714045207910316*(6.708203932499369*fc[15]-3.872983346207417*fc[13])*dv; 
