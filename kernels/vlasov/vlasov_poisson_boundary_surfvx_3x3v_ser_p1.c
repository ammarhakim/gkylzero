...
GKYL_CU_DH double vlasov_poisson_boundary_surfvx_3x3v_ser_p1(const double *w, const double *dxv, const double *fac_phi, const double *vecA, const int edge, const double *fEdge, const double *fSkin, double* GKYL_RESTRICT out) 
{ 
  ...
  Ghat[32] = 0.01178511301977579*(15.0*alpha[8]*fUpwind[39]+15.0*(alpha[3]*fUpwind[35]+alpha[2]*fUpwind[34])+15.0*alpha[0]*fUpwind[32]); 
  Ghat[33] = 0.01178511301977579*(15.0*alpha[8]*fUpwind[43]+15.0*(alpha[3]*fUpwind[38]+alpha[2]*fUpwind[37])+15.0*alpha[0]*fUpwind[33]); 
  Ghat[34] = 0.01178511301977579*(15.0*alpha[3]*fUpwind[39]+15.0*(alpha[8]*fUpwind[35]+alpha[0]*fUpwind[34])+15.0*alpha[2]*fUpwind[32]); 
  Ghat[35] = 0.01178511301977579*(15.0*alpha[2]*fUpwind[39]+15.0*(alpha[0]*fUpwind[35]+alpha[8]*fUpwind[34])+15.0*alpha[3]*fUpwind[32]); 
  Ghat[36] = 0.01178511301977579*(15.0*alpha[8]*fUpwind[46]+15.0*(alpha[3]*fUpwind[42]+alpha[2]*fUpwind[41])+15.0*alpha[0]*fUpwind[36]); 
  Ghat[37] = 0.01178511301977579*(15.0*alpha[3]*fUpwind[43]+15.0*(alpha[8]*fUpwind[38]+alpha[0]*fUpwind[37])+15.0*alpha[2]*fUpwind[33]); 
  Ghat[38] = 0.01178511301977579*(15.0*alpha[2]*fUpwind[43]+15.0*(alpha[0]*fUpwind[38]+alpha[8]*fUpwind[37])+15.0*alpha[3]*fUpwind[33]); 
  Ghat[39] = 0.01178511301977579*(15.0*alpha[0]*fUpwind[39]+15.0*(alpha[2]*fUpwind[35]+alpha[3]*fUpwind[34])+15.0*alpha[8]*fUpwind[32]); 
  Ghat[40] = 0.01178511301977579*(15.0*alpha[8]*fUpwind[47]+15.0*(alpha[3]*fUpwind[45]+alpha[2]*fUpwind[44])+15.0*alpha[0]*fUpwind[40]); 
  Ghat[41] = 0.01178511301977579*(15.0*alpha[3]*fUpwind[46]+15.0*(alpha[8]*fUpwind[42]+alpha[0]*fUpwind[41])+15.0*alpha[2]*fUpwind[36]); 
  Ghat[42] = 0.01178511301977579*(15.0*alpha[2]*fUpwind[46]+15.0*(alpha[0]*fUpwind[42]+alpha[8]*fUpwind[41])+15.0*alpha[3]*fUpwind[36]); 
  Ghat[43] = 0.01178511301977579*(15.0*alpha[0]*fUpwind[43]+15.0*(alpha[2]*fUpwind[38]+alpha[3]*fUpwind[37])+15.0*alpha[8]*fUpwind[33]); 
  Ghat[44] = 0.01178511301977579*(15.0*alpha[3]*fUpwind[47]+15.0*(alpha[8]*fUpwind[45]+alpha[0]*fUpwind[44])+15.0*alpha[2]*fUpwind[40]); 
  Ghat[45] = 0.01178511301977579*(15.0*alpha[2]*fUpwind[47]+15.0*(alpha[0]*fUpwind[45]+alpha[8]*fUpwind[44])+15.0*alpha[3]*fUpwind[40]); 
  Ghat[46] = 0.01178511301977579*(15.0*alpha[0]*fUpwind[46]+15.0*(alpha[2]*fUpwind[42]+alpha[3]*fUpwind[41])+15.0*alpha[8]*fUpwind[36]); 
  Ghat[47] = 0.01178511301977579*(15.0*alpha[0]*fUpwind[47]+15.0*(alpha[2]*fUpwind[45]+alpha[3]*fUpwind[44])+15.0*alpha[8]*fUpwind[40]); 
  Ghat[48] = 0.01178511301977579*(15.0*alpha[8]*fUpwind[55]+15.0*(alpha[3]*fUpwind[51]+alpha[2]*fUpwind[50])+15.0*alpha[0]*fUpwind[48]); 
  Ghat[49] = 0.01178511301977579*(15.0*alpha[8]*fUpwind[59]+15.0*(alpha[3]*fUpwind[54]+alpha[2]*fUpwind[53])+15.0*alpha[0]*fUpwind[49]); 
  Ghat[50] = 0.01178511301977579*(15.0*alpha[3]*fUpwind[55]+15.0*(alpha[8]*fUpwind[51]+alpha[0]*fUpwind[50])+15.0*alpha[2]*fUpwind[48]); 
  Ghat[51] = 0.01178511301977579*(15.0*alpha[2]*fUpwind[55]+15.0*(alpha[0]*fUpwind[51]+alpha[8]*fUpwind[50])+15.0*alpha[3]*fUpwind[48]); 
  Ghat[52] = 0.01178511301977579*(15.0*alpha[8]*fUpwind[62]+15.0*(alpha[3]*fUpwind[58]+alpha[2]*fUpwind[57])+15.0*alpha[0]*fUpwind[52]); 
  Ghat[53] = 0.01178511301977579*(15.0*alpha[3]*fUpwind[59]+15.0*(alpha[8]*fUpwind[54]+alpha[0]*fUpwind[53])+15.0*alpha[2]*fUpwind[49]); 
  Ghat[54] = 0.01178511301977579*(15.0*alpha[2]*fUpwind[59]+15.0*(alpha[0]*fUpwind[54]+alpha[8]*fUpwind[53])+15.0*alpha[3]*fUpwind[49]); 
  Ghat[55] = 0.01178511301977579*(15.0*alpha[0]*fUpwind[55]+15.0*(alpha[2]*fUpwind[51]+alpha[3]*fUpwind[50])+15.0*alpha[8]*fUpwind[48]); 
  Ghat[56] = 0.01178511301977579*(15.0*alpha[8]*fUpwind[63]+15.0*(alpha[3]*fUpwind[61]+alpha[2]*fUpwind[60])+15.0*alpha[0]*fUpwind[56]); 
  Ghat[57] = 0.01178511301977579*(15.0*alpha[3]*fUpwind[62]+15.0*(alpha[8]*fUpwind[58]+alpha[0]*fUpwind[57])+15.0*alpha[2]*fUpwind[52]); 
  Ghat[58] = 0.01178511301977579*(15.0*alpha[2]*fUpwind[62]+15.0*(alpha[0]*fUpwind[58]+alpha[8]*fUpwind[57])+15.0*alpha[3]*fUpwind[52]); 
  Ghat[59] = 0.01178511301977579*(15.0*alpha[0]*fUpwind[59]+15.0*(alpha[2]*fUpwind[54]+alpha[3]*fUpwind[53])+15.0*alpha[8]*fUpwind[49]); 
  Ghat[60] = 0.01178511301977579*(15.0*alpha[3]*fUpwind[63]+15.0*(alpha[8]*fUpwind[61]+alpha[0]*fUpwind[60])+15.0*alpha[2]*fUpwind[56]); 
  Ghat[61] = 0.01178511301977579*(15.0*alpha[2]*fUpwind[63]+15.0*(alpha[0]*fUpwind[61]+alpha[8]*fUpwind[60])+15.0*alpha[3]*fUpwind[56]); 
  Ghat[62] = 0.01178511301977579*(15.0*alpha[0]*fUpwind[62]+15.0*(alpha[2]*fUpwind[58]+alpha[3]*fUpwind[57])+15.0*alpha[8]*fUpwind[52]); 
  Ghat[63] = 0.01178511301977579*(15.0*alpha[0]*fUpwind[63]+15.0*(alpha[2]*fUpwind[61]+alpha[3]*fUpwind[60])+15.0*alpha[8]*fUpwind[56]); 
