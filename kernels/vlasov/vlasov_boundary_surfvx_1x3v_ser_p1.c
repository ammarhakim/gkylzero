...
{ 
  ...
  if ((-alpha[5])-alpha[4]-alpha[3]-alpha[2]+alpha[1]+alpha[0] > 0) { 
    ...
    fUpwindQuad[1] = 0.4330127018922193*(fSkin[15]+fSkin[14])+0.25*fSkin[13]-0.4330127018922193*(fSkin[12]+fSkin[11])+0.25*fSkin[10]-0.4330127018922193*fSkin[9]-0.25*fSkin[8]-0.4330127018922193*fSkin[7]-0.25*fSkin[6]+0.4330127018922193*fSkin[5]-0.25*(fSkin[4]+fSkin[3])+0.4330127018922193*fSkin[2]+0.25*(fSkin[1]+fSkin[0]); 
  } else { 

    fUpwindQuad[1] = (-0.4330127018922193*(fEdge[15]+fEdge[14]))+0.25*fEdge[13]+0.4330127018922193*(fEdge[12]+fEdge[11])+0.25*fEdge[10]+0.4330127018922193*fEdge[9]-0.25*fEdge[8]+0.4330127018922193*fEdge[7]-0.25*fEdge[6]-0.4330127018922193*fEdge[5]-0.25*(fEdge[4]+fEdge[3])-0.4330127018922193*fEdge[2]+0.25*(fEdge[1]+fEdge[0]); 
  } 
  if (alpha[5]-alpha[4]-alpha[3]+alpha[2]-alpha[1]+alpha[0] > 0) { 
  ...
  if ((-alpha[5])+alpha[4]+alpha[3]-alpha[2]-alpha[1]+alpha[0] > 0) { 
    ...
    fUpwindQuad[4] = 0.4330127018922193*fSkin[15]-0.4330127018922193*fSkin[14]+0.25*fSkin[13]-0.4330127018922193*fSkin[12]+0.4330127018922193*fSkin[11]-0.25*fSkin[10]+0.4330127018922193*fSkin[9]-0.25*fSkin[8]-0.4330127018922193*fSkin[7]+0.25*fSkin[6]-0.4330127018922193*fSkin[5]+0.25*fSkin[4]-0.25*fSkin[3]+0.4330127018922193*fSkin[2]-0.25*fSkin[1]+0.25*fSkin[0]; 
  } else { 
  ...
  if (alpha[5]+alpha[4]+alpha[3]+alpha[2]+alpha[1]+alpha[0] > 0) { 
    ...
    fUpwindQuad[7] = 0.4330127018922193*(fSkin[15]+fSkin[14])+0.25*fSkin[13]+0.4330127018922193*(fSkin[12]+fSkin[11])+0.25*fSkin[10]+0.4330127018922193*fSkin[9]+0.25*fSkin[8]+0.4330127018922193*fSkin[7]+0.25*fSkin[6]+0.4330127018922193*fSkin[5]+0.25*(fSkin[4]+fSkin[3])+0.4330127018922193*fSkin[2]+0.25*(fSkin[1]+fSkin[0]); 
  } else { 

    fUpwindQuad[7] = (-0.4330127018922193*(fEdge[15]+fEdge[14]))+0.25*fEdge[13]-0.4330127018922193*(fEdge[12]+fEdge[11])+0.25*fEdge[10]-0.4330127018922193*fEdge[9]+0.25*fEdge[8]-0.4330127018922193*fEdge[7]+0.25*fEdge[6]-0.4330127018922193*fEdge[5]+0.25*(fEdge[4]+fEdge[3])-0.4330127018922193*fEdge[2]+0.25*(fEdge[1]+fEdge[0]); 
  } 
