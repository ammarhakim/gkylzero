...
{ 
  ...
  out[64] += (0.7071067811865475*Ghat_l[32]-0.7071067811865475*Ghat_r[32])*dv11; 
  out[65] += (0.7071067811865475*Ghat_l[33]-0.7071067811865475*Ghat_r[33])*dv11; 
  out[66] += (0.7071067811865475*Ghat_l[34]-0.7071067811865475*Ghat_r[34])*dv11; 
  out[67] += (0.7071067811865475*Ghat_l[35]-0.7071067811865475*Ghat_r[35])*dv11; 
  out[68] += -1.224744871391589*(Ghat_r[32]+Ghat_l[32])*dv11; 
  ...
  out[73] += -1.224744871391589*(Ghat_r[33]+Ghat_l[33])*dv11; 
  out[74] += -1.224744871391589*(Ghat_r[34]+Ghat_l[34])*dv11; 
  out[75] += -1.224744871391589*(Ghat_r[35]+Ghat_l[35])*dv11; 
  out[76] += (0.7071067811865475*Ghat_l[40]-0.7071067811865475*Ghat_r[40])*dv11; 
  out[77] += (0.7071067811865475*Ghat_l[41]-0.7071067811865475*Ghat_r[41])*dv11; 
  out[78] += (0.7071067811865475*Ghat_l[42]-0.7071067811865475*Ghat_r[42])*dv11; 
  out[79] += -1.224744871391589*(Ghat_r[36]+Ghat_l[36])*dv11; 
  out[80] += (0.7071067811865475*Ghat_l[43]-0.7071067811865475*Ghat_r[43])*dv11; 
  out[81] += -1.224744871391589*(Ghat_r[37]+Ghat_l[37])*dv11; 
  out[82] += -1.224744871391589*(Ghat_r[38]+Ghat_l[38])*dv11; 
  out[83] += -1.224744871391589*(Ghat_r[39]+Ghat_l[39])*dv11; 
  out[84] += (0.7071067811865475*Ghat_l[44]-0.7071067811865475*Ghat_r[44])*dv11; 
  out[85] += (0.7071067811865475*Ghat_l[45]-0.7071067811865475*Ghat_r[45])*dv11; 
  out[86] += (0.7071067811865475*Ghat_l[46]-0.7071067811865475*Ghat_r[46])*dv11; 
  out[87] += -1.224744871391589*(Ghat_r[40]+Ghat_l[40])*dv11; 
  out[88] += -1.224744871391589*(Ghat_r[41]+Ghat_l[41])*dv11; 
  out[89] += -1.224744871391589*(Ghat_r[42]+Ghat_l[42])*dv11; 
  out[90] += -1.224744871391589*(Ghat_r[43]+Ghat_l[43])*dv11; 
  out[91] += (0.7071067811865475*Ghat_l[47]-0.7071067811865475*Ghat_r[47])*dv11; 
  out[92] += -1.224744871391589*(Ghat_r[44]+Ghat_l[44])*dv11; 
  out[93] += -1.224744871391589*(Ghat_r[45]+Ghat_l[45])*dv11; 
  out[94] += -1.224744871391589*(Ghat_r[46]+Ghat_l[46])*dv11; 
  out[95] += -1.224744871391589*(Ghat_r[47]+Ghat_l[47])*dv11; 
  out[96] += (1.58113883008419*Ghat_l[0]-1.58113883008419*Ghat_r[0])*dv11; 
  out[97] += (1.58113883008419*Ghat_l[1]-1.58113883008419*Ghat_r[1])*dv11; 
  out[98] += (1.58113883008419*Ghat_l[2]-1.58113883008419*Ghat_r[2])*dv11; 
  out[99] += (1.58113883008419*Ghat_l[3]-1.58113883008419*Ghat_r[3])*dv11; 
  out[100] += (1.58113883008419*Ghat_l[4]-1.58113883008419*Ghat_r[4])*dv11; 
  out[101] += (1.58113883008419*Ghat_l[5]-1.58113883008419*Ghat_r[5])*dv11; 
  out[102] += (1.58113883008419*Ghat_l[6]-1.58113883008419*Ghat_r[6])*dv11; 
  out[103] += (1.58113883008419*Ghat_l[7]-1.58113883008419*Ghat_r[7])*dv11; 
  out[104] += (1.58113883008419*Ghat_l[8]-1.58113883008419*Ghat_r[8])*dv11; 
  out[105] += (1.58113883008419*Ghat_l[9]-1.58113883008419*Ghat_r[9])*dv11; 
  out[106] += (1.58113883008419*Ghat_l[10]-1.58113883008419*Ghat_r[10])*dv11; 
  out[107] += (1.58113883008419*Ghat_l[11]-1.58113883008419*Ghat_r[11])*dv11; 
  out[108] += (1.58113883008419*Ghat_l[12]-1.58113883008419*Ghat_r[12])*dv11; 
  out[109] += (1.58113883008419*Ghat_l[13]-1.58113883008419*Ghat_r[13])*dv11; 
  out[110] += (1.58113883008419*Ghat_l[14]-1.58113883008419*Ghat_r[14])*dv11; 
  out[111] += (1.58113883008419*Ghat_l[15]-1.58113883008419*Ghat_r[15])*dv11; 
  out[112] += (1.58113883008419*Ghat_l[16]-1.58113883008419*Ghat_r[16])*dv11; 
  out[113] += (1.58113883008419*Ghat_l[17]-1.58113883008419*Ghat_r[17])*dv11; 
  out[114] += (1.58113883008419*Ghat_l[18]-1.58113883008419*Ghat_r[18])*dv11; 
  out[115] += (1.58113883008419*Ghat_l[19]-1.58113883008419*Ghat_r[19])*dv11; 
  out[116] += (1.58113883008419*Ghat_l[20]-1.58113883008419*Ghat_r[20])*dv11; 
  out[117] += (1.58113883008419*Ghat_l[21]-1.58113883008419*Ghat_r[21])*dv11; 
  out[118] += (1.58113883008419*Ghat_l[22]-1.58113883008419*Ghat_r[22])*dv11; 
  out[119] += (1.58113883008419*Ghat_l[23]-1.58113883008419*Ghat_r[23])*dv11; 
  out[120] += (1.58113883008419*Ghat_l[24]-1.58113883008419*Ghat_r[24])*dv11; 
  out[121] += (1.58113883008419*Ghat_l[25]-1.58113883008419*Ghat_r[25])*dv11; 
  out[122] += (1.58113883008419*Ghat_l[26]-1.58113883008419*Ghat_r[26])*dv11; 
  out[123] += (1.58113883008419*Ghat_l[27]-1.58113883008419*Ghat_r[27])*dv11; 
  out[124] += (1.58113883008419*Ghat_l[28]-1.58113883008419*Ghat_r[28])*dv11; 
  out[125] += (1.58113883008419*Ghat_l[29]-1.58113883008419*Ghat_r[29])*dv11; 
  out[126] += (1.58113883008419*Ghat_l[30]-1.58113883008419*Ghat_r[30])*dv11; 
  out[127] += (1.58113883008419*Ghat_l[31]-1.58113883008419*Ghat_r[31])*dv11; 
  out[128] += (0.7071067811865475*Ghat_l[48]-0.7071067811865475*Ghat_r[48])*dv11; 
  out[129] += (0.7071067811865475*Ghat_l[49]-0.7071067811865475*Ghat_r[49])*dv11; 
  out[130] += (0.7071067811865475*Ghat_l[50]-0.7071067811865475*Ghat_r[50])*dv11; 
  out[131] += (0.7071067811865475*Ghat_l[51]-0.7071067811865475*Ghat_r[51])*dv11; 
  out[132] += (0.7071067811865475*Ghat_l[52]-0.7071067811865475*Ghat_r[52])*dv11; 
  out[133] += -1.224744871391589*(Ghat_r[48]+Ghat_l[48])*dv11; 
  out[134] += (0.7071067811865475*Ghat_l[53]-0.7071067811865475*Ghat_r[53])*dv11; 
  out[135] += (0.7071067811865475*Ghat_l[54]-0.7071067811865475*Ghat_r[54])*dv11; 
  out[136] += (0.7071067811865475*Ghat_l[55]-0.7071067811865475*Ghat_r[55])*dv11; 
  out[137] += (0.7071067811865475*Ghat_l[56]-0.7071067811865475*Ghat_r[56])*dv11; 
  out[138] += (0.7071067811865475*Ghat_l[57]-0.7071067811865475*Ghat_r[57])*dv11; 
  out[139] += (0.7071067811865475*Ghat_l[58]-0.7071067811865475*Ghat_r[58])*dv11; 
  out[140] += -1.224744871391589*(Ghat_r[49]+Ghat_l[49])*dv11; 
  out[141] += -1.224744871391589*(Ghat_r[50]+Ghat_l[50])*dv11; 
  out[142] += -1.224744871391589*(Ghat_r[51]+Ghat_l[51])*dv11; 
  out[143] += -1.224744871391589*(Ghat_r[52]+Ghat_l[52])*dv11; 
  out[144] += (0.7071067811865475*Ghat_l[59]-0.7071067811865475*Ghat_r[59])*dv11; 
  out[145] += (0.7071067811865475*Ghat_l[60]-0.7071067811865475*Ghat_r[60])*dv11; 
  out[146] += (0.7071067811865475*Ghat_l[61]-0.7071067811865475*Ghat_r[61])*dv11; 
  out[147] += (0.7071067811865475*Ghat_l[62]-0.7071067811865475*Ghat_r[62])*dv11; 
  out[148] += -1.224744871391589*(Ghat_r[53]+Ghat_l[53])*dv11; 
  out[149] += -1.224744871391589*(Ghat_r[54]+Ghat_l[54])*dv11; 
  out[150] += -1.224744871391589*(Ghat_r[55]+Ghat_l[55])*dv11; 
  out[151] += -1.224744871391589*(Ghat_r[56]+Ghat_l[56])*dv11; 
  out[152] += -1.224744871391589*(Ghat_r[57]+Ghat_l[57])*dv11; 
  out[153] += -1.224744871391589*(Ghat_r[58]+Ghat_l[58])*dv11; 
  out[154] += (0.7071067811865475*Ghat_l[63]-0.7071067811865475*Ghat_r[63])*dv11; 
  out[155] += -1.224744871391589*(Ghat_r[59]+Ghat_l[59])*dv11; 
  out[156] += -1.224744871391589*(Ghat_r[60]+Ghat_l[60])*dv11; 
  out[157] += -1.224744871391589*(Ghat_r[61]+Ghat_l[61])*dv11; 
  out[158] += -1.224744871391589*(Ghat_r[62]+Ghat_l[62])*dv11; 
  out[159] += -1.224744871391589*(Ghat_r[63]+Ghat_l[63])*dv11; 
