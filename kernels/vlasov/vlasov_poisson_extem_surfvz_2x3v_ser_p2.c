...
GKYL_CU_DH double vlasov_poisson_extem_surfvz_2x3v_ser_p2(const double *w, const double *dxv, const double *field, const double *ext_field, const double *fl, const double *fc, const double *fr, double* GKYL_RESTRICT out) 
{ 
  ...
  Ghat_l[11] = 0.25*alpha[9]*fUpwind_l[35]+0.25*alpha[7]*fUpwind_l[32]+0.159719141249985*alpha[25]*fUpwind_l[25]+0.2500000000000001*alpha[4]*fUpwind_l[25]+0.2500000000000001*fUpwind_l[4]*alpha[25]+0.2500000000000001*alpha[3]*fUpwind_l[21]+0.2500000000000001*alpha[2]*fUpwind_l[19]+0.223606797749979*alpha[16]*fUpwind_l[16]+0.223606797749979*alpha[15]*fUpwind_l[15]+0.159719141249985*alpha[11]*fUpwind_l[11]+0.25*alpha[0]*fUpwind_l[11]+0.25*fUpwind_l[0]*alpha[11]+0.223606797749979*alpha[8]*fUpwind_l[8]+0.223606797749979*alpha[6]*fUpwind_l[6]+0.223606797749979*alpha[5]*fUpwind_l[5]+0.223606797749979*alpha[1]*fUpwind_l[1]; 
  ...
  Ghat_l[13] = 0.2500000000000001*alpha[16]*fUpwind_l[46]+0.25*alpha[9]*fUpwind_l[40]+0.25*alpha[8]*fUpwind_l[39]+0.25*alpha[5]*fUpwind_l[34]+0.2500000000000001*alpha[4]*fUpwind_l[27]+0.2500000000000001*alpha[2]*fUpwind_l[24]+0.2500000000000001*alpha[1]*fUpwind_l[23]+0.223606797749979*alpha[22]*fUpwind_l[22]+0.223606797749979*alpha[15]*fUpwind_l[15]+0.25*alpha[0]*fUpwind_l[13]+0.223606797749979*alpha[7]*fUpwind_l[7]+0.223606797749979*alpha[6]*fUpwind_l[6]+0.223606797749979*alpha[3]*fUpwind_l[3]; 
  ...
  Ghat_l[27] = 0.25*alpha[5]*fUpwind_l[46]+0.2500000000000001*alpha[2]*fUpwind_l[40]+0.2500000000000001*alpha[1]*fUpwind_l[39]+0.223606797749979*alpha[22]*fUpwind_l[38]+0.2500000000000001*alpha[16]*fUpwind_l[34]+0.223606797749979*alpha[15]*fUpwind_l[31]+0.25*alpha[0]*fUpwind_l[27]+0.25*alpha[9]*fUpwind_l[24]+0.25*alpha[8]*fUpwind_l[23]+0.223606797749979*alpha[7]*fUpwind_l[18]+0.223606797749979*alpha[6]*fUpwind_l[17]+0.2500000000000001*alpha[4]*fUpwind_l[13]+0.223606797749979*alpha[3]*fUpwind_l[10]; 
  Ghat_l[28] = 0.25*alpha[7]*fUpwind_l[47]+0.2500000000000001*alpha[15]*fUpwind_l[43]+0.2500000000000001*alpha[3]*fUpwind_l[42]+0.2500000000000001*alpha[2]*fUpwind_l[41]+0.2*alpha[16]*fUpwind_l[35]+0.25*alpha[6]*fUpwind_l[30]+0.25*alpha[5]*fUpwind_l[29]+0.223606797749979*alpha[11]*fUpwind_l[28]+0.25*alpha[0]*fUpwind_l[28]+0.2*alpha[8]*fUpwind_l[25]+0.2*fUpwind_l[8]*alpha[25]+0.223606797749979*alpha[9]*fUpwind_l[16]+0.223606797749979*fUpwind_l[9]*alpha[16]+0.2500000000000001*alpha[1]*fUpwind_l[14]+0.223606797749979*alpha[4]*fUpwind_l[8]+0.223606797749979*fUpwind_l[4]*alpha[8]; 
  ...
  Ghat_l[31] = 0.2*alpha[25]*fUpwind_l[47]+0.223606797749979*alpha[4]*fUpwind_l[47]+0.2*alpha[22]*fUpwind_l[46]+0.223606797749979*alpha[3]*fUpwind_l[46]+0.223606797749979*alpha[2]*fUpwind_l[45]+0.223606797749979*alpha[1]*fUpwind_l[44]+0.223606797749979*alpha[8]*fUpwind_l[43]+0.223606797749979*alpha[9]*fUpwind_l[42]+0.223606797749979*alpha[6]*fUpwind_l[40]+0.223606797749979*alpha[7]*fUpwind_l[39]+0.223606797749979*alpha[5]*fUpwind_l[38]+0.223606797749979*alpha[5]*fUpwind_l[37]+0.223606797749979*alpha[7]*fUpwind_l[36]+0.223606797749979*alpha[6]*fUpwind_l[35]+0.223606797749979*alpha[9]*fUpwind_l[33]+0.223606797749979*alpha[8]*fUpwind_l[32]+0.223606797749979*alpha[12]*fUpwind_l[31]+0.223606797749979*alpha[11]*fUpwind_l[31]+0.25*alpha[0]*fUpwind_l[31]+0.223606797749979*alpha[16]*fUpwind_l[30]+0.223606797749979*alpha[15]*fUpwind_l[27]+0.223606797749979*alpha[15]*fUpwind_l[26]+0.223606797749979*alpha[15]*fUpwind_l[25]+0.223606797749979*fUpwind_l[15]*alpha[25]+0.223606797749979*alpha[16]*fUpwind_l[22]+0.223606797749979*fUpwind_l[16]*alpha[22]+0.223606797749979*alpha[16]*fUpwind_l[21]+0.25*alpha[1]*fUpwind_l[18]+0.25*alpha[2]*fUpwind_l[17]+0.25*alpha[3]*fUpwind_l[16]+0.25*fUpwind_l[3]*alpha[16]+0.25*alpha[4]*fUpwind_l[15]+0.25*fUpwind_l[4]*alpha[15]+0.25*alpha[5]*fUpwind_l[10]+0.25*alpha[6]*fUpwind_l[9]+0.25*fUpwind_l[6]*alpha[9]+0.25*alpha[7]*fUpwind_l[8]+0.25*fUpwind_l[7]*alpha[8]; 
  ...
  Ghat_l[44] = 0.2*alpha[8]*fUpwind_l[47]+0.2*alpha[6]*fUpwind_l[46]+0.2*alpha[5]*fUpwind_l[45]+0.223606797749979*alpha[12]*fUpwind_l[44]+0.159719141249985*alpha[11]*fUpwind_l[44]+0.25*alpha[0]*fUpwind_l[44]+0.223606797749979*alpha[25]*fUpwind_l[43]+0.2*alpha[16]*fUpwind_l[42]+0.2*alpha[15]*fUpwind_l[39]+0.2500000000000001*alpha[2]*fUpwind_l[37]+0.2*alpha[15]*fUpwind_l[36]+0.223606797749979*alpha[22]*fUpwind_l[35]+0.2500000000000001*alpha[3]*fUpwind_l[35]+0.2*alpha[16]*fUpwind_l[33]+0.159719141249985*alpha[25]*fUpwind_l[32]+0.2500000000000001*alpha[4]*fUpwind_l[32]+0.223606797749979*alpha[1]*fUpwind_l[31]+0.25*alpha[7]*fUpwind_l[25]+0.25*fUpwind_l[7]*alpha[25]+0.25*alpha[9]*fUpwind_l[21]+0.2500000000000001*alpha[11]*fUpwind_l[18]+0.223606797749979*alpha[5]*fUpwind_l[17]+0.223606797749979*alpha[6]*fUpwind_l[16]+0.223606797749979*fUpwind_l[6]*alpha[16]+0.223606797749979*alpha[8]*fUpwind_l[15]+0.223606797749979*fUpwind_l[8]*alpha[15]; 
  Ghat_l[45] = 0.2*alpha[9]*fUpwind_l[47]+0.2*alpha[7]*fUpwind_l[46]+0.159719141249985*alpha[12]*fUpwind_l[45]+0.223606797749979*alpha[11]*fUpwind_l[45]+0.25*alpha[0]*fUpwind_l[45]+0.2*alpha[5]*fUpwind_l[44]+0.2*alpha[16]*fUpwind_l[43]+0.2*alpha[15]*fUpwind_l[40]+0.223606797749979*alpha[22]*fUpwind_l[39]+0.2500000000000001*alpha[1]*fUpwind_l[38]+0.159719141249985*alpha[22]*fUpwind_l[36]+0.2500000000000001*alpha[3]*fUpwind_l[36]+0.2*alpha[15]*fUpwind_l[35]+0.223606797749979*alpha[25]*fUpwind_l[33]+0.2500000000000001*alpha[4]*fUpwind_l[33]+0.2*alpha[16]*fUpwind_l[32]+0.223606797749979*alpha[2]*fUpwind_l[31]+0.25*alpha[6]*fUpwind_l[26]+0.25*alpha[8]*fUpwind_l[22]+0.25*fUpwind_l[8]*alpha[22]+0.223606797749979*alpha[5]*fUpwind_l[18]+0.2500000000000001*alpha[12]*fUpwind_l[17]+0.223606797749979*alpha[7]*fUpwind_l[16]+0.223606797749979*fUpwind_l[7]*alpha[16]+0.223606797749979*alpha[9]*fUpwind_l[15]+0.223606797749979*fUpwind_l[9]*alpha[15]; 
  Ghat_l[46] = 0.223606797749979*alpha[12]*fUpwind_l[46]+0.223606797749979*alpha[11]*fUpwind_l[46]+0.25*alpha[0]*fUpwind_l[46]+0.2*alpha[7]*fUpwind_l[45]+0.2*alpha[6]*fUpwind_l[44]+0.2500000000000001*alpha[1]*fUpwind_l[40]+0.2500000000000001*alpha[2]*fUpwind_l[39]+0.2*alpha[15]*fUpwind_l[38]+0.2*alpha[15]*fUpwind_l[37]+0.223606797749979*alpha[25]*fUpwind_l[34]+0.2500000000000001*alpha[4]*fUpwind_l[34]+0.2*alpha[22]*fUpwind_l[31]+0.223606797749979*alpha[3]*fUpwind_l[31]+0.25*alpha[5]*fUpwind_l[27]+0.25*alpha[8]*fUpwind_l[24]+0.25*alpha[9]*fUpwind_l[23]+0.223606797749979*alpha[6]*fUpwind_l[18]+0.223606797749979*alpha[7]*fUpwind_l[17]+0.2500000000000001*fUpwind_l[13]*alpha[16]+0.223606797749979*fUpwind_l[10]*alpha[15]; 
  Ghat_l[47] = 0.223606797749979*alpha[12]*fUpwind_l[47]+0.223606797749979*alpha[11]*fUpwind_l[47]+0.25*alpha[0]*fUpwind_l[47]+0.2*alpha[9]*fUpwind_l[45]+0.2*alpha[8]*fUpwind_l[44]+0.2500000000000001*alpha[1]*fUpwind_l[43]+0.2500000000000001*alpha[2]*fUpwind_l[42]+0.223606797749979*alpha[22]*fUpwind_l[41]+0.2500000000000001*alpha[3]*fUpwind_l[41]+0.2*alpha[16]*fUpwind_l[38]+0.2*alpha[16]*fUpwind_l[37]+0.2*alpha[25]*fUpwind_l[31]+0.223606797749979*alpha[4]*fUpwind_l[31]+0.25*alpha[5]*fUpwind_l[30]+0.25*alpha[6]*fUpwind_l[29]+0.25*alpha[7]*fUpwind_l[28]+0.223606797749979*alpha[8]*fUpwind_l[18]+0.223606797749979*alpha[9]*fUpwind_l[17]+0.223606797749979*fUpwind_l[10]*alpha[16]+0.2500000000000001*fUpwind_l[14]*alpha[15]; 
  ...
  Ghat_r[11] = 0.25*alpha[9]*fUpwind_r[35]+0.25*alpha[7]*fUpwind_r[32]+0.159719141249985*alpha[25]*fUpwind_r[25]+0.2500000000000001*alpha[4]*fUpwind_r[25]+0.2500000000000001*fUpwind_r[4]*alpha[25]+0.2500000000000001*alpha[3]*fUpwind_r[21]+0.2500000000000001*alpha[2]*fUpwind_r[19]+0.223606797749979*alpha[16]*fUpwind_r[16]+0.223606797749979*alpha[15]*fUpwind_r[15]+0.159719141249985*alpha[11]*fUpwind_r[11]+0.25*alpha[0]*fUpwind_r[11]+0.25*fUpwind_r[0]*alpha[11]+0.223606797749979*alpha[8]*fUpwind_r[8]+0.223606797749979*alpha[6]*fUpwind_r[6]+0.223606797749979*alpha[5]*fUpwind_r[5]+0.223606797749979*alpha[1]*fUpwind_r[1]; 
  ...
  Ghat_r[25] = 0.25*alpha[7]*fUpwind_r[44]+0.2*alpha[16]*fUpwind_r[41]+0.2500000000000001*alpha[3]*fUpwind_r[37]+0.2500000000000001*alpha[2]*fUpwind_r[35]+0.223606797749979*alpha[15]*fUpwind_r[31]+0.2*alpha[8]*fUpwind_r[28]+0.159719141249985*alpha[11]*fUpwind_r[25]+0.25*alpha[0]*fUpwind_r[25]+0.223606797749979*fUpwind_r[14]*alpha[25]+0.159719141249985*fUpwind_r[11]*alpha[25]+0.25*fUpwind_r[0]*alpha[25]+0.25*alpha[9]*fUpwind_r[19]+0.223606797749979*alpha[6]*fUpwind_r[17]+0.223606797749979*alpha[5]*fUpwind_r[16]+0.223606797749979*fUpwind_r[5]*alpha[16]+0.2500000000000001*alpha[4]*fUpwind_r[11]+0.2500000000000001*fUpwind_r[4]*alpha[11]+0.223606797749979*alpha[1]*fUpwind_r[8]+0.223606797749979*fUpwind_r[1]*alpha[8]; 
  ...
  Ghat_r[28] = 0.25*alpha[7]*fUpwind_r[47]+0.2500000000000001*alpha[15]*fUpwind_r[43]+0.2500000000000001*alpha[3]*fUpwind_r[42]+0.2500000000000001*alpha[2]*fUpwind_r[41]+0.2*alpha[16]*fUpwind_r[35]+0.25*alpha[6]*fUpwind_r[30]+0.25*alpha[5]*fUpwind_r[29]+0.223606797749979*alpha[11]*fUpwind_r[28]+0.25*alpha[0]*fUpwind_r[28]+0.2*alpha[8]*fUpwind_r[25]+0.2*fUpwind_r[8]*alpha[25]+0.223606797749979*alpha[9]*fUpwind_r[16]+0.223606797749979*fUpwind_r[9]*alpha[16]+0.2500000000000001*alpha[1]*fUpwind_r[14]+0.223606797749979*alpha[4]*fUpwind_r[8]+0.223606797749979*fUpwind_r[4]*alpha[8]; 
