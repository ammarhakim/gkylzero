...
{ 
  ...
  if ((-0.25*(alpha[12]+alpha[11]))+0.25*(alpha[9]+alpha[8]+alpha[7]+alpha[6]+alpha[5])-0.25*(alpha[4]+alpha[3]+alpha[2]+alpha[1])+0.25*alpha[0] > 0) { 
    fUpwindQuad_l[0] = tensor_5x_p1_surfx3_eval_quad_node_0_r(fl); 
    fUpwindQuad_r[0] = tensor_5x_p1_surfx3_eval_quad_node_0_r(fc); 
  } else { 
    fUpwindQuad_l[0] = tensor_5x_p1_surfx3_eval_quad_node_0_l(fc); 
    fUpwindQuad_r[0] = tensor_5x_p1_surfx3_eval_quad_node_0_l(fr); 
  } 
  if (0.25*alpha[12]-0.25*(alpha[11]+alpha[9]+alpha[8])+0.25*(alpha[7]+alpha[6]+alpha[5]+alpha[4])-0.25*(alpha[3]+alpha[2]+alpha[1])+0.25*alpha[0] > 0) { 
    fUpwindQuad_l[1] = tensor_5x_p1_surfx3_eval_quad_node_1_r(fl); 
    fUpwindQuad_r[1] = tensor_5x_p1_surfx3_eval_quad_node_1_r(fc); 
  } else { 
    fUpwindQuad_l[1] = tensor_5x_p1_surfx3_eval_quad_node_1_l(fc); 
    fUpwindQuad_r[1] = tensor_5x_p1_surfx3_eval_quad_node_1_l(fr); 
  } 
  if ((-0.25*alpha[12])+0.25*(alpha[11]+alpha[9]+alpha[8])-0.25*(alpha[7]+alpha[6])+0.25*alpha[5]-0.25*alpha[4]+0.25*alpha[3]-0.25*(alpha[2]+alpha[1])+0.25*alpha[0] > 0) { 
    fUpwindQuad_l[2] = tensor_5x_p1_surfx3_eval_quad_node_2_r(fl); 
    fUpwindQuad_r[2] = tensor_5x_p1_surfx3_eval_quad_node_2_r(fc); 
  } else { 
    fUpwindQuad_l[2] = tensor_5x_p1_surfx3_eval_quad_node_2_l(fc); 
    fUpwindQuad_r[2] = tensor_5x_p1_surfx3_eval_quad_node_2_l(fr); 
  } 
  if (0.25*(alpha[12]+alpha[11])-0.25*(alpha[9]+alpha[8]+alpha[7]+alpha[6])+0.25*(alpha[5]+alpha[4]+alpha[3])-0.25*(alpha[2]+alpha[1])+0.25*alpha[0] > 0) { 
    fUpwindQuad_l[3] = tensor_5x_p1_surfx3_eval_quad_node_3_r(fl); 
    fUpwindQuad_r[3] = tensor_5x_p1_surfx3_eval_quad_node_3_r(fc); 
  } else { 
    fUpwindQuad_l[3] = tensor_5x_p1_surfx3_eval_quad_node_3_l(fc); 
    fUpwindQuad_r[3] = tensor_5x_p1_surfx3_eval_quad_node_3_l(fr); 
  } 
  if (0.25*(alpha[12]+alpha[11])-0.25*alpha[9]+0.25*alpha[8]-0.25*alpha[7]+0.25*alpha[6]-0.25*(alpha[5]+alpha[4]+alpha[3])+0.25*alpha[2]-0.25*alpha[1]+0.25*alpha[0] > 0) { 
    fUpwindQuad_l[4] = tensor_5x_p1_surfx3_eval_quad_node_4_r(fl); 
    fUpwindQuad_r[4] = tensor_5x_p1_surfx3_eval_quad_node_4_r(fc); 
  } else { 
    fUpwindQuad_l[4] = tensor_5x_p1_surfx3_eval_quad_node_4_l(fc); 
    fUpwindQuad_r[4] = tensor_5x_p1_surfx3_eval_quad_node_4_l(fr); 
  } 
  if ((-0.25*alpha[12])+0.25*(alpha[11]+alpha[9])-0.25*(alpha[8]+alpha[7])+0.25*alpha[6]-0.25*alpha[5]+0.25*alpha[4]-0.25*alpha[3]+0.25*alpha[2]-0.25*alpha[1]+0.25*alpha[0] > 0) { 
    fUpwindQuad_l[5] = tensor_5x_p1_surfx3_eval_quad_node_5_r(fl); 
    fUpwindQuad_r[5] = tensor_5x_p1_surfx3_eval_quad_node_5_r(fc); 
  } else { 
    fUpwindQuad_l[5] = tensor_5x_p1_surfx3_eval_quad_node_5_l(fc); 
    fUpwindQuad_r[5] = tensor_5x_p1_surfx3_eval_quad_node_5_l(fr); 
  } 
  if (0.25*alpha[12]-0.25*(alpha[11]+alpha[9])+0.25*(alpha[8]+alpha[7])-0.25*(alpha[6]+alpha[5]+alpha[4])+0.25*(alpha[3]+alpha[2])-0.25*alpha[1]+0.25*alpha[0] > 0) { 
    fUpwindQuad_l[6] = tensor_5x_p1_surfx3_eval_quad_node_6_r(fl); 
    fUpwindQuad_r[6] = tensor_5x_p1_surfx3_eval_quad_node_6_r(fc); 
  } else { 
    fUpwindQuad_l[6] = tensor_5x_p1_surfx3_eval_quad_node_6_l(fc); 
    fUpwindQuad_r[6] = tensor_5x_p1_surfx3_eval_quad_node_6_l(fr); 
  } 
  if ((-0.25*(alpha[12]+alpha[11]))+0.25*alpha[9]-0.25*alpha[8]+0.25*alpha[7]-0.25*(alpha[6]+alpha[5])+0.25*(alpha[4]+alpha[3]+alpha[2])-0.25*alpha[1]+0.25*alpha[0] > 0) { 
    fUpwindQuad_l[7] = tensor_5x_p1_surfx3_eval_quad_node_7_r(fl); 
    fUpwindQuad_r[7] = tensor_5x_p1_surfx3_eval_quad_node_7_r(fc); 
  } else { 
    fUpwindQuad_l[7] = tensor_5x_p1_surfx3_eval_quad_node_7_l(fc); 
    fUpwindQuad_r[7] = tensor_5x_p1_surfx3_eval_quad_node_7_l(fr); 
  } 
  if (0.25*(alpha[12]+alpha[11]+alpha[9])-0.25*alpha[8]+0.25*alpha[7]-0.25*(alpha[6]+alpha[5]+alpha[4]+alpha[3]+alpha[2])+0.25*(alpha[1]+alpha[0]) > 0) { 
    fUpwindQuad_l[8] = tensor_5x_p1_surfx3_eval_quad_node_8_r(fl); 
    fUpwindQuad_r[8] = tensor_5x_p1_surfx3_eval_quad_node_8_r(fc); 
  } else { 
    fUpwindQuad_l[8] = tensor_5x_p1_surfx3_eval_quad_node_8_l(fc); 
    fUpwindQuad_r[8] = tensor_5x_p1_surfx3_eval_quad_node_8_l(fr); 
  } 
  if ((-0.25*alpha[12])+0.25*alpha[11]-0.25*alpha[9]+0.25*(alpha[8]+alpha[7])-0.25*(alpha[6]+alpha[5])+0.25*alpha[4]-0.25*(alpha[3]+alpha[2])+0.25*(alpha[1]+alpha[0]) > 0) { 
    fUpwindQuad_l[9] = tensor_5x_p1_surfx3_eval_quad_node_9_r(fl); 
    fUpwindQuad_r[9] = tensor_5x_p1_surfx3_eval_quad_node_9_r(fc); 
  } else { 
    fUpwindQuad_l[9] = tensor_5x_p1_surfx3_eval_quad_node_9_l(fc); 
    fUpwindQuad_r[9] = tensor_5x_p1_surfx3_eval_quad_node_9_l(fr); 
  } 
  if (0.25*alpha[12]-0.25*alpha[11]+0.25*alpha[9]-0.25*(alpha[8]+alpha[7])+0.25*alpha[6]-0.25*(alpha[5]+alpha[4])+0.25*alpha[3]-0.25*alpha[2]+0.25*(alpha[1]+alpha[0]) > 0) { 
    fUpwindQuad_l[10] = tensor_5x_p1_surfx3_eval_quad_node_10_r(fl); 
    fUpwindQuad_r[10] = tensor_5x_p1_surfx3_eval_quad_node_10_r(fc); 
  } else { 
    fUpwindQuad_l[10] = tensor_5x_p1_surfx3_eval_quad_node_10_l(fc); 
    fUpwindQuad_r[10] = tensor_5x_p1_surfx3_eval_quad_node_10_l(fr); 
  } 
  if ((-0.25*(alpha[12]+alpha[11]+alpha[9]))+0.25*alpha[8]-0.25*alpha[7]+0.25*alpha[6]-0.25*alpha[5]+0.25*(alpha[4]+alpha[3])-0.25*alpha[2]+0.25*(alpha[1]+alpha[0]) > 0) { 
    fUpwindQuad_l[11] = tensor_5x_p1_surfx3_eval_quad_node_11_r(fl); 
    fUpwindQuad_r[11] = tensor_5x_p1_surfx3_eval_quad_node_11_r(fc); 
  } else { 
    fUpwindQuad_l[11] = tensor_5x_p1_surfx3_eval_quad_node_11_l(fc); 
    fUpwindQuad_r[11] = tensor_5x_p1_surfx3_eval_quad_node_11_l(fr); 
  } 
  if ((-0.25*(alpha[12]+alpha[11]+alpha[9]+alpha[8]+alpha[7]+alpha[6]))+0.25*alpha[5]-0.25*(alpha[4]+alpha[3])+0.25*(alpha[2]+alpha[1]+alpha[0]) > 0) { 
    fUpwindQuad_l[12] = tensor_5x_p1_surfx3_eval_quad_node_12_r(fl); 
    fUpwindQuad_r[12] = tensor_5x_p1_surfx3_eval_quad_node_12_r(fc); 
  } else { 
    fUpwindQuad_l[12] = tensor_5x_p1_surfx3_eval_quad_node_12_l(fc); 
    fUpwindQuad_r[12] = tensor_5x_p1_surfx3_eval_quad_node_12_l(fr); 
  } 
  if (0.25*alpha[12]-0.25*alpha[11]+0.25*(alpha[9]+alpha[8])-0.25*(alpha[7]+alpha[6])+0.25*(alpha[5]+alpha[4])-0.25*alpha[3]+0.25*(alpha[2]+alpha[1]+alpha[0]) > 0) { 
    fUpwindQuad_l[13] = tensor_5x_p1_surfx3_eval_quad_node_13_r(fl); 
    fUpwindQuad_r[13] = tensor_5x_p1_surfx3_eval_quad_node_13_r(fc); 
  } else { 
    fUpwindQuad_l[13] = tensor_5x_p1_surfx3_eval_quad_node_13_l(fc); 
    fUpwindQuad_r[13] = tensor_5x_p1_surfx3_eval_quad_node_13_l(fr); 
  } 
  if ((-0.25*alpha[12])+0.25*alpha[11]-0.25*(alpha[9]+alpha[8])+0.25*(alpha[7]+alpha[6]+alpha[5])-0.25*alpha[4]+0.25*(alpha[3]+alpha[2]+alpha[1]+alpha[0]) > 0) { 
    fUpwindQuad_l[14] = tensor_5x_p1_surfx3_eval_quad_node_14_r(fl); 
    fUpwindQuad_r[14] = tensor_5x_p1_surfx3_eval_quad_node_14_r(fc); 
  } else { 
    fUpwindQuad_l[14] = tensor_5x_p1_surfx3_eval_quad_node_14_l(fc); 
    fUpwindQuad_r[14] = tensor_5x_p1_surfx3_eval_quad_node_14_l(fr); 
  } 
  if (0.25*(alpha[12]+alpha[11]+alpha[9]+alpha[8]+alpha[7]+alpha[6]+alpha[5]+alpha[4]+alpha[3]+alpha[2]+alpha[1]+alpha[0]) > 0) { 
    fUpwindQuad_l[15] = tensor_5x_p1_surfx3_eval_quad_node_15_r(fl); 
    fUpwindQuad_r[15] = tensor_5x_p1_surfx3_eval_quad_node_15_r(fc); 
  } else { 
    fUpwindQuad_l[15] = tensor_5x_p1_surfx3_eval_quad_node_15_l(fc); 
    fUpwindQuad_r[15] = tensor_5x_p1_surfx3_eval_quad_node_15_l(fr); 
  } 
