...
GKYL_CU_DH void vlasov_poisson_boundary_surfvy_2x2v_tensor_p2(const double *w, const double *dxv, const double *fac_phi, const double *vecA, const int edge, const double *fEdge, const double *fSkin, double* GKYL_RESTRICT out) 
{ 
  ...
  Ghat[0] += 0.3535533905932737*(alpha[11]*fUpwind[11]+alpha[7]*fUpwind[7]+alpha[4]*fUpwind[4]+alpha[2]*fUpwind[2]+alpha[1]*fUpwind[1]+alpha[0]*fUpwind[0]); 
  Ghat[1] += 0.3162277660168379*(alpha[4]*fUpwind[11]+fUpwind[4]*alpha[11])+0.3162277660168379*(alpha[1]*fUpwind[7]+fUpwind[1]*alpha[7])+0.3535533905932737*(alpha[2]*fUpwind[4]+fUpwind[2]*alpha[4]+alpha[0]*fUpwind[1]+fUpwind[0]*alpha[1]); 
  Ghat[2] += 0.3162277660168379*(alpha[11]*fUpwind[20]+alpha[4]*fUpwind[12])+0.3535533905932737*(alpha[7]*fUpwind[11]+fUpwind[7]*alpha[11])+0.3162277660168379*alpha[2]*fUpwind[8]+0.3535533905932737*(alpha[1]*fUpwind[4]+fUpwind[1]*alpha[4]+alpha[0]*fUpwind[2]+fUpwind[0]*alpha[2]); 
  Ghat[3] += 0.3535533905932737*(alpha[11]*fUpwind[17]+alpha[7]*fUpwind[13]+alpha[4]*fUpwind[10]+alpha[2]*fUpwind[6]+alpha[1]*fUpwind[5]+alpha[0]*fUpwind[3]); 
  Ghat[4] += 0.2828427124746191*(alpha[4]*fUpwind[20]+alpha[11]*fUpwind[12])+0.3162277660168379*(alpha[2]*fUpwind[12]+alpha[1]*fUpwind[11]+fUpwind[1]*alpha[11])+0.3162277660168379*(alpha[4]*(fUpwind[8]+fUpwind[7])+fUpwind[4]*alpha[7])+0.3535533905932737*(alpha[0]*fUpwind[4]+fUpwind[0]*alpha[4]+alpha[1]*fUpwind[2]+fUpwind[1]*alpha[2]); 
  Ghat[5] += 0.3162277660168379*alpha[4]*fUpwind[17]+0.3162277660168379*alpha[1]*fUpwind[13]+fUpwind[10]*(0.3162277660168379*alpha[11]+0.3535533905932737*alpha[2])+0.3162277660168379*fUpwind[5]*alpha[7]+0.3535533905932737*(alpha[4]*fUpwind[6]+alpha[0]*fUpwind[5]+alpha[1]*fUpwind[3]); 
  Ghat[6] += 0.3162277660168379*alpha[11]*fUpwind[23]+0.3162277660168379*alpha[4]*fUpwind[18]+0.3535533905932737*alpha[7]*fUpwind[17]+0.3162277660168379*alpha[2]*fUpwind[14]+0.3535533905932737*(alpha[11]*fUpwind[13]+alpha[1]*fUpwind[10]+alpha[0]*fUpwind[6]+alpha[4]*fUpwind[5]+alpha[2]*fUpwind[3]); 
  Ghat[7] += 0.2258769757263128*alpha[11]*fUpwind[11]+0.3535533905932737*(alpha[2]*fUpwind[11]+fUpwind[2]*alpha[11])+0.2258769757263128*alpha[7]*fUpwind[7]+0.3535533905932737*(alpha[0]*fUpwind[7]+fUpwind[0]*alpha[7])+0.3162277660168379*(alpha[4]*fUpwind[4]+alpha[1]*fUpwind[1]); 
  Ghat[8] += 0.3535533905932737*(alpha[7]*fUpwind[20]+alpha[1]*fUpwind[12])+0.3162277660168379*alpha[11]*fUpwind[11]+0.3535533905932737*alpha[0]*fUpwind[8]+0.3162277660168379*(alpha[4]*fUpwind[4]+alpha[2]*fUpwind[2]); 
  Ghat[9] += 0.3535533905932737*(alpha[11]*fUpwind[24]+alpha[7]*fUpwind[21]+alpha[4]*fUpwind[19]+alpha[2]*fUpwind[16]+alpha[1]*fUpwind[15]+alpha[0]*fUpwind[9]); 
  Ghat[10] += 0.2828427124746191*alpha[4]*fUpwind[23]+0.282842712474619*alpha[11]*fUpwind[18]+0.3162277660168379*(alpha[2]*fUpwind[18]+alpha[1]*fUpwind[17])+0.3162277660168379*(alpha[4]*(fUpwind[14]+fUpwind[13])+fUpwind[5]*alpha[11])+0.3162277660168379*alpha[7]*fUpwind[10]+0.3535533905932737*(alpha[0]*fUpwind[10]+alpha[1]*fUpwind[6]+alpha[2]*fUpwind[5]+fUpwind[3]*alpha[4]); 
  Ghat[11] += (0.2020305089104422*alpha[11]+0.3162277660168379*alpha[2])*fUpwind[20]+0.2828427124746191*alpha[4]*fUpwind[12]+(0.2258769757263128*alpha[7]+0.3535533905932737*alpha[0])*fUpwind[11]+(0.3162277660168379*fUpwind[8]+0.2258769757263128*fUpwind[7])*alpha[11]+0.3535533905932737*(fUpwind[0]*alpha[11]+alpha[2]*fUpwind[7]+fUpwind[2]*alpha[7])+0.3162277660168379*(alpha[1]*fUpwind[4]+fUpwind[1]*alpha[4]); 
  Ghat[12] += 0.3162277660168379*alpha[1]*fUpwind[20]+(0.3162277660168379*alpha[7]+0.3535533905932737*alpha[0])*fUpwind[12]+0.2828427124746191*(alpha[4]*fUpwind[11]+fUpwind[4]*alpha[11])+0.3535533905932737*alpha[1]*fUpwind[8]+0.3162277660168379*(alpha[2]*fUpwind[4]+fUpwind[2]*alpha[4]); 
  Ghat[13] += (0.2258769757263128*alpha[11]+0.3535533905932737*alpha[2])*fUpwind[17]+0.2258769757263128*alpha[7]*fUpwind[13]+0.3535533905932737*(alpha[0]*fUpwind[13]+fUpwind[6]*alpha[11])+0.3162277660168379*alpha[4]*fUpwind[10]+0.3535533905932737*fUpwind[3]*alpha[7]+0.3162277660168379*alpha[1]*fUpwind[5]; 
  Ghat[14] += 0.3535533905932737*(alpha[7]*fUpwind[23]+alpha[1]*fUpwind[18])+0.3162277660168379*alpha[11]*fUpwind[17]+0.3535533905932737*alpha[0]*fUpwind[14]+0.3162277660168379*(alpha[4]*fUpwind[10]+alpha[2]*fUpwind[6]); 
  Ghat[15] += 0.3162277660168379*(alpha[4]*fUpwind[24]+alpha[1]*fUpwind[21])+0.3162277660168379*alpha[11]*fUpwind[19]+0.3535533905932737*(alpha[2]*fUpwind[19]+alpha[4]*fUpwind[16])+0.3162277660168379*alpha[7]*fUpwind[15]+0.3535533905932737*(alpha[0]*fUpwind[15]+alpha[1]*fUpwind[9]); 
  Ghat[16] += 0.3162277660168379*alpha[11]*fUpwind[26]+0.3162277660168379*alpha[4]*fUpwind[25]+0.3535533905932737*alpha[7]*fUpwind[24]+0.3162277660168379*alpha[2]*fUpwind[22]+0.3535533905932737*(alpha[11]*fUpwind[21]+alpha[1]*fUpwind[19]+alpha[0]*fUpwind[16]+alpha[4]*fUpwind[15]+alpha[2]*fUpwind[9]); 
  Ghat[17] += (0.2020305089104422*alpha[11]+0.3162277660168379*alpha[2])*fUpwind[23]+0.2828427124746191*alpha[4]*fUpwind[18]+(0.2258769757263128*alpha[7]+0.3535533905932737*alpha[0])*fUpwind[17]+alpha[11]*(0.3162277660168379*fUpwind[14]+0.2258769757263128*fUpwind[13])+0.3535533905932737*(alpha[2]*fUpwind[13]+fUpwind[3]*alpha[11])+0.3162277660168379*alpha[1]*fUpwind[10]+0.3535533905932737*fUpwind[6]*alpha[7]+0.3162277660168379*alpha[4]*fUpwind[5]; 
  Ghat[18] += 0.3162277660168379*alpha[1]*fUpwind[23]+(0.3162277660168379*alpha[7]+0.3535533905932737*alpha[0])*fUpwind[18]+0.2828427124746191*alpha[4]*fUpwind[17]+0.3535533905932737*alpha[1]*fUpwind[14]+0.282842712474619*fUpwind[10]*alpha[11]+0.3162277660168379*(alpha[2]*fUpwind[10]+alpha[4]*fUpwind[6]); 
  Ghat[19] += 0.2828427124746191*alpha[4]*fUpwind[26]+0.282842712474619*alpha[11]*fUpwind[25]+0.3162277660168379*(alpha[2]*fUpwind[25]+alpha[1]*fUpwind[24]+alpha[4]*(fUpwind[22]+fUpwind[21])+alpha[7]*fUpwind[19])+0.3535533905932737*(alpha[0]*fUpwind[19]+alpha[1]*fUpwind[16])+0.3162277660168379*alpha[11]*fUpwind[15]+0.3535533905932737*(alpha[2]*fUpwind[15]+alpha[4]*fUpwind[9]); 
  Ghat[20] += (0.2258769757263128*alpha[7]+0.3535533905932737*alpha[0])*fUpwind[20]+0.3162277660168379*alpha[1]*fUpwind[12]+0.2020305089104422*alpha[11]*fUpwind[11]+0.3162277660168379*(alpha[2]*fUpwind[11]+fUpwind[2]*alpha[11])+0.3535533905932737*alpha[7]*fUpwind[8]+0.2828427124746191*alpha[4]*fUpwind[4]; 
  Ghat[21] += (0.2258769757263128*alpha[11]+0.3535533905932737*alpha[2])*fUpwind[24]+(0.2258769757263128*alpha[7]+0.3535533905932737*alpha[0])*fUpwind[21]+0.3162277660168379*alpha[4]*fUpwind[19]+0.3535533905932737*alpha[11]*fUpwind[16]+0.3162277660168379*alpha[1]*fUpwind[15]+0.3535533905932737*alpha[7]*fUpwind[9]; 
  Ghat[22] += 0.3535533905932737*(alpha[7]*fUpwind[26]+alpha[1]*fUpwind[25])+0.3162277660168379*alpha[11]*fUpwind[24]+0.3535533905932737*alpha[0]*fUpwind[22]+0.3162277660168379*alpha[4]*fUpwind[19]+0.3162277660168379*alpha[2]*fUpwind[16]; 
  Ghat[23] += (0.2258769757263128*alpha[7]+0.3535533905932737*alpha[0])*fUpwind[23]+0.3162277660168379*alpha[1]*fUpwind[18]+(0.2020305089104422*alpha[11]+0.3162277660168379*alpha[2])*fUpwind[17]+0.3535533905932737*alpha[7]*fUpwind[14]+0.3162277660168379*fUpwind[6]*alpha[11]+0.2828427124746191*alpha[4]*fUpwind[10]; 
  Ghat[24] += (0.2020305089104422*alpha[11]+0.3162277660168379*alpha[2])*fUpwind[26]+0.2828427124746191*alpha[4]*fUpwind[25]+(0.2258769757263128*alpha[7]+0.3535533905932737*alpha[0])*fUpwind[24]+0.3162277660168379*alpha[11]*fUpwind[22]+(0.2258769757263128*alpha[11]+0.3535533905932737*alpha[2])*fUpwind[21]+0.3162277660168379*alpha[1]*fUpwind[19]+0.3535533905932737*alpha[7]*fUpwind[16]+0.3162277660168379*alpha[4]*fUpwind[15]+0.3535533905932737*fUpwind[9]*alpha[11]; 
  Ghat[25] += 0.3162277660168379*alpha[1]*fUpwind[26]+(0.3162277660168379*alpha[7]+0.3535533905932737*alpha[0])*fUpwind[25]+0.2828427124746191*alpha[4]*fUpwind[24]+0.3535533905932737*alpha[1]*fUpwind[22]+(0.282842712474619*alpha[11]+0.3162277660168379*alpha[2])*fUpwind[19]+0.3162277660168379*alpha[4]*fUpwind[16]; 
  Ghat[26] += (0.2258769757263128*alpha[7]+0.3535533905932737*alpha[0])*fUpwind[26]+0.3162277660168379*alpha[1]*fUpwind[25]+(0.2020305089104422*alpha[11]+0.3162277660168379*alpha[2])*fUpwind[24]+0.3535533905932737*alpha[7]*fUpwind[22]+0.2828427124746191*alpha[4]*fUpwind[19]+0.3162277660168379*alpha[11]*fUpwind[16]; 
