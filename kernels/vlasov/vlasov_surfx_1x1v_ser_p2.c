...
{ 
  ...
  Ghat_r[1] = (1.58113883008419*fc[6]+1.224744871391589*fc[3]+0.7071067811865475*fc[2])*wv+(0.3162277660168379*fc[7]+0.1825741858350554*fc[5]+0.4564354645876384*fc[4]+0.3535533905932737*fc[1]+0.2041241452319315*fc[0])*dv; 
  Ghat_r[2] = (1.224744871391589*fc[7]+0.7071067811865475*fc[5])*wv+(0.408248290463863*fc[6]+0.3162277660168379*fc[3]+0.1825741858350554*fc[2])*dv; 
  ...
  Ghat_l[1] = (1.58113883008419*fl[6]+1.224744871391589*fl[3]+0.7071067811865475*fl[2])*wv+(0.3162277660168379*fl[7]+0.1825741858350554*fl[5]+0.4564354645876384*fl[4]+0.3535533905932737*fl[1]+0.2041241452319315*fl[0])*dv; 
  Ghat_l[2] = (1.224744871391589*fl[7]+0.7071067811865475*fl[5])*wv+(0.408248290463863*fl[6]+0.3162277660168379*fl[3]+0.1825741858350554*fl[2])*dv; 
  ...
  Ghat_r[1] = 1.58113883008419*fr[6]*wv-1.224744871391589*fr[3]*wv+0.7071067811865475*fr[2]*wv-0.3162277660168379*fr[7]*dv+0.1825741858350554*fr[5]*dv+0.4564354645876384*fr[4]*dv-0.3535533905932737*fr[1]*dv+0.2041241452319315*fr[0]*dv; 
  Ghat_r[2] = (-1.224744871391589*fr[7]*wv)+0.7071067811865475*fr[5]*wv+0.408248290463863*fr[6]*dv-0.3162277660168379*fr[3]*dv+0.1825741858350554*fr[2]*dv; 
  ...
  Ghat_l[1] = 1.58113883008419*fc[6]*wv-1.224744871391589*fc[3]*wv+0.7071067811865475*fc[2]*wv-0.3162277660168379*fc[7]*dv+0.1825741858350554*fc[5]*dv+0.4564354645876384*fc[4]*dv-0.3535533905932737*fc[1]*dv+0.2041241452319315*fc[0]*dv; 
  Ghat_l[2] = (-1.224744871391589*fc[7]*wv)+0.7071067811865475*fc[5]*wv+0.408248290463863*fc[6]*dv-0.3162277660168379*fc[3]*dv+0.1825741858350554*fc[2]*dv; 
