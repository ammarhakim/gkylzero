...
{ 
  ...
  if ((-0.4242640687119285*(alpha[13]+alpha[11]))+0.3162277660168379*alpha[7]+0.6363961030678926*(alpha[5]+alpha[4])-0.4743416490252568*(alpha[3]+alpha[2]+alpha[1])+0.3535533905932737*alpha[0] > 0) { 
    fUpwindQuad_l[0] = tensor_4x_p2_surfx2_quad_0_r(fl); 
    fUpwindQuad_r[0] = tensor_4x_p2_surfx2_quad_0_r(fc); 
  } else { 
    fUpwindQuad_l[0] = tensor_4x_p2_surfx2_quad_0_l(fc); 
    fUpwindQuad_r[0] = tensor_4x_p2_surfx2_quad_0_l(fr); 
  } 
  if (0.5303300858899104*(alpha[13]+alpha[11])-0.3952847075210473*alpha[7]-0.4743416490252568*(alpha[3]+alpha[2])+0.3535533905932737*alpha[0] > 0) { 
    fUpwindQuad_l[1] = tensor_4x_p2_surfx2_quad_1_r(fl); 
    fUpwindQuad_r[1] = tensor_4x_p2_surfx2_quad_1_r(fc); 
  } else { 
    fUpwindQuad_l[1] = tensor_4x_p2_surfx2_quad_1_l(fc); 
    fUpwindQuad_r[1] = tensor_4x_p2_surfx2_quad_1_l(fr); 
  } 
  if ((-0.4242640687119285*(alpha[13]+alpha[11]))+0.3162277660168379*alpha[7]-0.6363961030678926*(alpha[5]+alpha[4])-0.4743416490252568*(alpha[3]+alpha[2])+0.4743416490252568*alpha[1]+0.3535533905932737*alpha[0] > 0) { 
    fUpwindQuad_l[2] = tensor_4x_p2_surfx2_quad_2_r(fl); 
    fUpwindQuad_r[2] = tensor_4x_p2_surfx2_quad_2_r(fc); 
  } else { 
    fUpwindQuad_l[2] = tensor_4x_p2_surfx2_quad_2_l(fc); 
    fUpwindQuad_r[2] = tensor_4x_p2_surfx2_quad_2_l(fr); 
  } 
  if ((-0.4242640687119285*alpha[13])+0.3162277660168379*alpha[7]+0.6363961030678926*alpha[5]-0.4743416490252568*(alpha[3]+alpha[1])+0.3535533905932737*alpha[0] > 0) { 
    fUpwindQuad_l[3] = tensor_4x_p2_surfx2_quad_3_r(fl); 
    fUpwindQuad_r[3] = tensor_4x_p2_surfx2_quad_3_r(fc); 
  } else { 
    fUpwindQuad_l[3] = tensor_4x_p2_surfx2_quad_3_l(fc); 
    fUpwindQuad_r[3] = tensor_4x_p2_surfx2_quad_3_l(fr); 
  } 
  if (0.5303300858899104*alpha[13]-0.3952847075210473*alpha[7]-0.4743416490252568*alpha[3]+0.3535533905932737*alpha[0] > 0) { 
    fUpwindQuad_l[4] = tensor_4x_p2_surfx2_quad_4_r(fl); 
    fUpwindQuad_r[4] = tensor_4x_p2_surfx2_quad_4_r(fc); 
  } else { 
    fUpwindQuad_l[4] = tensor_4x_p2_surfx2_quad_4_l(fc); 
    fUpwindQuad_r[4] = tensor_4x_p2_surfx2_quad_4_l(fr); 
  } 
  if ((-0.4242640687119285*alpha[13])+0.3162277660168379*alpha[7]-0.6363961030678926*alpha[5]-0.4743416490252568*alpha[3]+0.4743416490252568*alpha[1]+0.3535533905932737*alpha[0] > 0) { 
    fUpwindQuad_l[5] = tensor_4x_p2_surfx2_quad_5_r(fl); 
    fUpwindQuad_r[5] = tensor_4x_p2_surfx2_quad_5_r(fc); 
  } else { 
    fUpwindQuad_l[5] = tensor_4x_p2_surfx2_quad_5_l(fc); 
    fUpwindQuad_r[5] = tensor_4x_p2_surfx2_quad_5_l(fr); 
  } 
  if ((-0.4242640687119285*alpha[13])+0.4242640687119285*alpha[11]+0.3162277660168379*alpha[7]+0.6363961030678926*alpha[5]-0.6363961030678926*alpha[4]-0.4743416490252568*alpha[3]+0.4743416490252568*alpha[2]-0.4743416490252568*alpha[1]+0.3535533905932737*alpha[0] > 0) { 
    fUpwindQuad_l[6] = tensor_4x_p2_surfx2_quad_6_r(fl); 
    fUpwindQuad_r[6] = tensor_4x_p2_surfx2_quad_6_r(fc); 
  } else { 
    fUpwindQuad_l[6] = tensor_4x_p2_surfx2_quad_6_l(fc); 
    fUpwindQuad_r[6] = tensor_4x_p2_surfx2_quad_6_l(fr); 
  } 
  if (0.5303300858899104*alpha[13]-0.5303300858899104*alpha[11]-0.3952847075210473*alpha[7]-0.4743416490252568*alpha[3]+0.4743416490252568*alpha[2]+0.3535533905932737*alpha[0] > 0) { 
    fUpwindQuad_l[7] = tensor_4x_p2_surfx2_quad_7_r(fl); 
    fUpwindQuad_r[7] = tensor_4x_p2_surfx2_quad_7_r(fc); 
  } else { 
    fUpwindQuad_l[7] = tensor_4x_p2_surfx2_quad_7_l(fc); 
    fUpwindQuad_r[7] = tensor_4x_p2_surfx2_quad_7_l(fr); 
  } 
  if ((-0.4242640687119285*alpha[13])+0.4242640687119285*alpha[11]+0.3162277660168379*alpha[7]-0.6363961030678926*alpha[5]+0.6363961030678926*alpha[4]-0.4743416490252568*alpha[3]+0.4743416490252568*(alpha[2]+alpha[1])+0.3535533905932737*alpha[0] > 0) { 
    fUpwindQuad_l[8] = tensor_4x_p2_surfx2_quad_8_r(fl); 
    fUpwindQuad_r[8] = tensor_4x_p2_surfx2_quad_8_r(fc); 
  } else { 
    fUpwindQuad_l[8] = tensor_4x_p2_surfx2_quad_8_l(fc); 
    fUpwindQuad_r[8] = tensor_4x_p2_surfx2_quad_8_l(fr); 
  } 
  if ((-0.4242640687119285*alpha[11])+0.3162277660168379*alpha[7]+0.6363961030678926*alpha[4]-0.4743416490252568*(alpha[2]+alpha[1])+0.3535533905932737*alpha[0] > 0) { 
    fUpwindQuad_l[9] = tensor_4x_p2_surfx2_quad_9_r(fl); 
    fUpwindQuad_r[9] = tensor_4x_p2_surfx2_quad_9_r(fc); 
  } else { 
    fUpwindQuad_l[9] = tensor_4x_p2_surfx2_quad_9_l(fc); 
    fUpwindQuad_r[9] = tensor_4x_p2_surfx2_quad_9_l(fr); 
  } 
  if (0.5303300858899104*alpha[11]-0.3952847075210473*alpha[7]-0.4743416490252568*alpha[2]+0.3535533905932737*alpha[0] > 0) { 
    fUpwindQuad_l[10] = tensor_4x_p2_surfx2_quad_10_r(fl); 
    fUpwindQuad_r[10] = tensor_4x_p2_surfx2_quad_10_r(fc); 
  } else { 
    fUpwindQuad_l[10] = tensor_4x_p2_surfx2_quad_10_l(fc); 
    fUpwindQuad_r[10] = tensor_4x_p2_surfx2_quad_10_l(fr); 
  } 
  if ((-0.4242640687119285*alpha[11])+0.3162277660168379*alpha[7]-0.6363961030678926*alpha[4]-0.4743416490252568*alpha[2]+0.4743416490252568*alpha[1]+0.3535533905932737*alpha[0] > 0) { 
    fUpwindQuad_l[11] = tensor_4x_p2_surfx2_quad_11_r(fl); 
    fUpwindQuad_r[11] = tensor_4x_p2_surfx2_quad_11_r(fc); 
  } else { 
    fUpwindQuad_l[11] = tensor_4x_p2_surfx2_quad_11_l(fc); 
    fUpwindQuad_r[11] = tensor_4x_p2_surfx2_quad_11_l(fr); 
  } 
  if (0.3162277660168379*alpha[7]-0.4743416490252568*alpha[1]+0.3535533905932737*alpha[0] > 0) { 
    fUpwindQuad_l[12] = tensor_4x_p2_surfx2_quad_12_r(fl); 
    fUpwindQuad_r[12] = tensor_4x_p2_surfx2_quad_12_r(fc); 
  } else { 
    fUpwindQuad_l[12] = tensor_4x_p2_surfx2_quad_12_l(fc); 
    fUpwindQuad_r[12] = tensor_4x_p2_surfx2_quad_12_l(fr); 
  } 
  if (0.3535533905932737*alpha[0]-0.3952847075210473*alpha[7] > 0) { 
    fUpwindQuad_l[13] = tensor_4x_p2_surfx2_quad_13_r(fl); 
    fUpwindQuad_r[13] = tensor_4x_p2_surfx2_quad_13_r(fc); 
  } else { 
    fUpwindQuad_l[13] = tensor_4x_p2_surfx2_quad_13_l(fc); 
    fUpwindQuad_r[13] = tensor_4x_p2_surfx2_quad_13_l(fr); 
  } 
  if (0.3162277660168379*alpha[7]+0.4743416490252568*alpha[1]+0.3535533905932737*alpha[0] > 0) { 
    fUpwindQuad_l[14] = tensor_4x_p2_surfx2_quad_14_r(fl); 
    fUpwindQuad_r[14] = tensor_4x_p2_surfx2_quad_14_r(fc); 
  } else { 
    fUpwindQuad_l[14] = tensor_4x_p2_surfx2_quad_14_l(fc); 
    fUpwindQuad_r[14] = tensor_4x_p2_surfx2_quad_14_l(fr); 
  } 
  if (0.4242640687119285*alpha[11]+0.3162277660168379*alpha[7]-0.6363961030678926*alpha[4]+0.4743416490252568*alpha[2]-0.4743416490252568*alpha[1]+0.3535533905932737*alpha[0] > 0) { 
    fUpwindQuad_l[15] = tensor_4x_p2_surfx2_quad_15_r(fl); 
    fUpwindQuad_r[15] = tensor_4x_p2_surfx2_quad_15_r(fc); 
  } else { 
    fUpwindQuad_l[15] = tensor_4x_p2_surfx2_quad_15_l(fc); 
    fUpwindQuad_r[15] = tensor_4x_p2_surfx2_quad_15_l(fr); 
  } 
  if ((-0.5303300858899104*alpha[11])-0.3952847075210473*alpha[7]+0.4743416490252568*alpha[2]+0.3535533905932737*alpha[0] > 0) { 
    fUpwindQuad_l[16] = tensor_4x_p2_surfx2_quad_16_r(fl); 
    fUpwindQuad_r[16] = tensor_4x_p2_surfx2_quad_16_r(fc); 
  } else { 
    fUpwindQuad_l[16] = tensor_4x_p2_surfx2_quad_16_l(fc); 
    fUpwindQuad_r[16] = tensor_4x_p2_surfx2_quad_16_l(fr); 
  } 
  if (0.4242640687119285*alpha[11]+0.3162277660168379*alpha[7]+0.6363961030678926*alpha[4]+0.4743416490252568*(alpha[2]+alpha[1])+0.3535533905932737*alpha[0] > 0) { 
    fUpwindQuad_l[17] = tensor_4x_p2_surfx2_quad_17_r(fl); 
    fUpwindQuad_r[17] = tensor_4x_p2_surfx2_quad_17_r(fc); 
  } else { 
    fUpwindQuad_l[17] = tensor_4x_p2_surfx2_quad_17_l(fc); 
    fUpwindQuad_r[17] = tensor_4x_p2_surfx2_quad_17_l(fr); 
  } 
  if (0.4242640687119285*alpha[13]-0.4242640687119285*alpha[11]+0.3162277660168379*alpha[7]-0.6363961030678926*alpha[5]+0.6363961030678926*alpha[4]+0.4743416490252568*alpha[3]-0.4743416490252568*(alpha[2]+alpha[1])+0.3535533905932737*alpha[0] > 0) { 
    fUpwindQuad_l[18] = tensor_4x_p2_surfx2_quad_18_r(fl); 
    fUpwindQuad_r[18] = tensor_4x_p2_surfx2_quad_18_r(fc); 
  } else { 
    fUpwindQuad_l[18] = tensor_4x_p2_surfx2_quad_18_l(fc); 
    fUpwindQuad_r[18] = tensor_4x_p2_surfx2_quad_18_l(fr); 
  } 
  if ((-0.5303300858899104*alpha[13])+0.5303300858899104*alpha[11]-0.3952847075210473*alpha[7]+0.4743416490252568*alpha[3]-0.4743416490252568*alpha[2]+0.3535533905932737*alpha[0] > 0) { 
    fUpwindQuad_l[19] = tensor_4x_p2_surfx2_quad_19_r(fl); 
    fUpwindQuad_r[19] = tensor_4x_p2_surfx2_quad_19_r(fc); 
  } else { 
    fUpwindQuad_l[19] = tensor_4x_p2_surfx2_quad_19_l(fc); 
    fUpwindQuad_r[19] = tensor_4x_p2_surfx2_quad_19_l(fr); 
  } 
  if (0.4242640687119285*alpha[13]-0.4242640687119285*alpha[11]+0.3162277660168379*alpha[7]+0.6363961030678926*alpha[5]-0.6363961030678926*alpha[4]+0.4743416490252568*alpha[3]-0.4743416490252568*alpha[2]+0.4743416490252568*alpha[1]+0.3535533905932737*alpha[0] > 0) { 
    fUpwindQuad_l[20] = tensor_4x_p2_surfx2_quad_20_r(fl); 
    fUpwindQuad_r[20] = tensor_4x_p2_surfx2_quad_20_r(fc); 
  } else { 
    fUpwindQuad_l[20] = tensor_4x_p2_surfx2_quad_20_l(fc); 
    fUpwindQuad_r[20] = tensor_4x_p2_surfx2_quad_20_l(fr); 
  } 
  if (0.4242640687119285*alpha[13]+0.3162277660168379*alpha[7]-0.6363961030678926*alpha[5]+0.4743416490252568*alpha[3]-0.4743416490252568*alpha[1]+0.3535533905932737*alpha[0] > 0) { 
    fUpwindQuad_l[21] = tensor_4x_p2_surfx2_quad_21_r(fl); 
    fUpwindQuad_r[21] = tensor_4x_p2_surfx2_quad_21_r(fc); 
  } else { 
    fUpwindQuad_l[21] = tensor_4x_p2_surfx2_quad_21_l(fc); 
    fUpwindQuad_r[21] = tensor_4x_p2_surfx2_quad_21_l(fr); 
  } 
  if ((-0.5303300858899104*alpha[13])-0.3952847075210473*alpha[7]+0.4743416490252568*alpha[3]+0.3535533905932737*alpha[0] > 0) { 
    fUpwindQuad_l[22] = tensor_4x_p2_surfx2_quad_22_r(fl); 
    fUpwindQuad_r[22] = tensor_4x_p2_surfx2_quad_22_r(fc); 
  } else { 
    fUpwindQuad_l[22] = tensor_4x_p2_surfx2_quad_22_l(fc); 
    fUpwindQuad_r[22] = tensor_4x_p2_surfx2_quad_22_l(fr); 
  } 
  if (0.4242640687119285*alpha[13]+0.3162277660168379*alpha[7]+0.6363961030678926*alpha[5]+0.4743416490252568*(alpha[3]+alpha[1])+0.3535533905932737*alpha[0] > 0) { 
    fUpwindQuad_l[23] = tensor_4x_p2_surfx2_quad_23_r(fl); 
    fUpwindQuad_r[23] = tensor_4x_p2_surfx2_quad_23_r(fc); 
  } else { 
    fUpwindQuad_l[23] = tensor_4x_p2_surfx2_quad_23_l(fc); 
    fUpwindQuad_r[23] = tensor_4x_p2_surfx2_quad_23_l(fr); 
  } 
  if (0.4242640687119285*(alpha[13]+alpha[11])+0.3162277660168379*alpha[7]-0.6363961030678926*(alpha[5]+alpha[4])+0.4743416490252568*(alpha[3]+alpha[2])-0.4743416490252568*alpha[1]+0.3535533905932737*alpha[0] > 0) { 
    fUpwindQuad_l[24] = tensor_4x_p2_surfx2_quad_24_r(fl); 
    fUpwindQuad_r[24] = tensor_4x_p2_surfx2_quad_24_r(fc); 
  } else { 
    fUpwindQuad_l[24] = tensor_4x_p2_surfx2_quad_24_l(fc); 
    fUpwindQuad_r[24] = tensor_4x_p2_surfx2_quad_24_l(fr); 
  } 
  if ((-0.5303300858899104*(alpha[13]+alpha[11]))-0.3952847075210473*alpha[7]+0.4743416490252568*(alpha[3]+alpha[2])+0.3535533905932737*alpha[0] > 0) { 
    fUpwindQuad_l[25] = tensor_4x_p2_surfx2_quad_25_r(fl); 
    fUpwindQuad_r[25] = tensor_4x_p2_surfx2_quad_25_r(fc); 
  } else { 
    fUpwindQuad_l[25] = tensor_4x_p2_surfx2_quad_25_l(fc); 
    fUpwindQuad_r[25] = tensor_4x_p2_surfx2_quad_25_l(fr); 
  } 
  if (0.4242640687119285*(alpha[13]+alpha[11])+0.3162277660168379*alpha[7]+0.6363961030678926*(alpha[5]+alpha[4])+0.4743416490252568*(alpha[3]+alpha[2]+alpha[1])+0.3535533905932737*alpha[0] > 0) { 
    fUpwindQuad_l[26] = tensor_4x_p2_surfx2_quad_26_r(fl); 
    fUpwindQuad_r[26] = tensor_4x_p2_surfx2_quad_26_r(fc); 
  } else { 
    fUpwindQuad_l[26] = tensor_4x_p2_surfx2_quad_26_l(fc); 
    fUpwindQuad_r[26] = tensor_4x_p2_surfx2_quad_26_l(fr); 
  } 
