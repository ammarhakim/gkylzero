...
{ 
  ...
  Ghat_l[5] += 0.223606797749979*(alpha[9]*fUpwind_l[36]+alpha[8]*fUpwind_l[35]+alpha[7]*fUpwind_l[33]+alpha[6]*fUpwind_l[32])+0.223606797749979*(alpha[16]*(fUpwind_l[26]+fUpwind_l[25])+fUpwind_l[16]*alpha[25]+alpha[15]*fUpwind_l[22]+fUpwind_l[15]*alpha[22]+alpha[15]*fUpwind_l[21]+fUpwind_l[15]*alpha[21]+alpha[2]*fUpwind_l[20]+alpha[1]*fUpwind_l[19])+0.25*(alpha[4]*fUpwind_l[16]+fUpwind_l[4]*alpha[16]+alpha[3]*fUpwind_l[15]+fUpwind_l[3]*alpha[15])+0.223606797749979*(alpha[5]*fUpwind_l[12]+fUpwind_l[5]*alpha[12]+alpha[5]*fUpwind_l[11]+fUpwind_l[5]*alpha[11])+0.25*(alpha[8]*fUpwind_l[9]+fUpwind_l[8]*alpha[9]+alpha[6]*fUpwind_l[7]+fUpwind_l[6]*alpha[7]+alpha[0]*fUpwind_l[5]+fUpwind_l[0]*alpha[5]+alpha[1]*fUpwind_l[2]+fUpwind_l[1]*alpha[2]); 
  Ghat_l[6] += 0.223606797749979*alpha[16]*fUpwind_l[44]+0.223606797749979*(alpha[8]*fUpwind_l[37]+alpha[7]*fUpwind_l[34])+0.25*alpha[12]*fUpwind_l[33]+0.223606797749979*alpha[5]*fUpwind_l[32]+0.25*alpha[9]*fUpwind_l[31]+0.223606797749979*(fUpwind_l[17]*alpha[25]+alpha[15]*fUpwind_l[24])+(0.2*alpha[21]+0.223606797749979*alpha[3])*fUpwind_l[23]+0.25*fUpwind_l[20]*alpha[22]+0.223606797749979*(alpha[1]*fUpwind_l[21]+fUpwind_l[1]*alpha[21]+alpha[15]*fUpwind_l[19])+0.25*(alpha[16]*fUpwind_l[18]+alpha[4]*fUpwind_l[17]+alpha[2]*fUpwind_l[15]+fUpwind_l[2]*alpha[15])+0.223606797749979*(alpha[6]*(fUpwind_l[13]+fUpwind_l[11])+fUpwind_l[6]*alpha[11])+0.25*(alpha[8]*fUpwind_l[10]+alpha[5]*fUpwind_l[7]+fUpwind_l[5]*alpha[7]+alpha[0]*fUpwind_l[6]+fUpwind_l[0]*alpha[6]+alpha[1]*fUpwind_l[3]+fUpwind_l[1]*alpha[3]); 
  Ghat_l[7] += 0.223606797749979*alpha[16]*fUpwind_l[45]+0.25*alpha[25]*fUpwind_l[44]+0.223606797749979*(alpha[9]*fUpwind_l[38]+alpha[6]*fUpwind_l[34]+alpha[5]*fUpwind_l[33])+0.25*(alpha[11]*fUpwind_l[32]+alpha[8]*fUpwind_l[31])+0.2*alpha[22]*fUpwind_l[24]+0.223606797749979*(alpha[3]*fUpwind_l[24]+alpha[15]*fUpwind_l[23]+alpha[2]*fUpwind_l[22]+fUpwind_l[2]*alpha[22])+0.25*fUpwind_l[19]*alpha[21]+0.223606797749979*alpha[15]*fUpwind_l[20]+0.25*(alpha[4]*fUpwind_l[18]+alpha[16]*fUpwind_l[17]+alpha[1]*fUpwind_l[15]+fUpwind_l[1]*alpha[15])+0.223606797749979*(alpha[7]*(fUpwind_l[13]+fUpwind_l[12])+fUpwind_l[7]*alpha[12])+0.25*(alpha[9]*fUpwind_l[10]+alpha[0]*fUpwind_l[7]+fUpwind_l[0]*alpha[7]+alpha[5]*fUpwind_l[6]+fUpwind_l[5]*alpha[6]+alpha[2]*fUpwind_l[3]+fUpwind_l[2]*alpha[3]); 
  Ghat_l[8] += 0.25*alpha[22]*fUpwind_l[45]+0.223606797749979*alpha[15]*fUpwind_l[44]+0.223606797749979*(alpha[9]*fUpwind_l[41]+alpha[6]*fUpwind_l[37])+0.25*alpha[12]*fUpwind_l[36]+0.223606797749979*alpha[5]*fUpwind_l[35]+0.25*alpha[7]*fUpwind_l[31]+0.223606797749979*alpha[16]*fUpwind_l[29]+0.2*alpha[25]*fUpwind_l[28]+0.223606797749979*(alpha[4]*fUpwind_l[28]+alpha[1]*fUpwind_l[25]+fUpwind_l[1]*alpha[25]+fUpwind_l[17]*alpha[21]+alpha[16]*fUpwind_l[19])+0.25*(alpha[15]*fUpwind_l[18]+alpha[3]*fUpwind_l[17]+alpha[2]*fUpwind_l[16]+fUpwind_l[2]*alpha[16])+0.223606797749979*(alpha[8]*(fUpwind_l[14]+fUpwind_l[11])+fUpwind_l[8]*alpha[11])+0.25*(alpha[6]*fUpwind_l[10]+alpha[5]*fUpwind_l[9]+fUpwind_l[5]*alpha[9]+alpha[0]*fUpwind_l[8]+fUpwind_l[0]*alpha[8]+alpha[1]*fUpwind_l[4]+fUpwind_l[1]*alpha[4]); 
  ...
  Ghat_l[10] += 0.223606797749979*(alpha[16]*fUpwind_l[47]+alpha[15]*fUpwind_l[46])+0.223606797749979*(alpha[9]*fUpwind_l[43]+alpha[8]*fUpwind_l[42]+alpha[7]*fUpwind_l[40]+alpha[6]*fUpwind_l[39])+0.25*(alpha[12]*fUpwind_l[38]+alpha[11]*fUpwind_l[37]+alpha[5]*fUpwind_l[31])+0.223606797749979*(alpha[4]*fUpwind_l[30]+alpha[3]*fUpwind_l[27])+0.25*(alpha[22]*fUpwind_l[26]+alpha[21]*fUpwind_l[25]+fUpwind_l[21]*alpha[25]+alpha[2]*fUpwind_l[18]+alpha[1]*fUpwind_l[17]+alpha[15]*fUpwind_l[16]+fUpwind_l[15]*alpha[16]+alpha[0]*fUpwind_l[10]+alpha[7]*fUpwind_l[9]+fUpwind_l[7]*alpha[9]+alpha[6]*fUpwind_l[8]+fUpwind_l[6]*alpha[8]+alpha[3]*fUpwind_l[4]+fUpwind_l[3]*alpha[4]); 
  Ghat_l[11] += 0.25*(alpha[9]*fUpwind_l[35]+alpha[7]*fUpwind_l[32])+0.159719141249985*alpha[25]*fUpwind_l[25]+0.2500000000000001*(alpha[4]*fUpwind_l[25]+fUpwind_l[4]*alpha[25])+0.159719141249985*alpha[21]*fUpwind_l[21]+0.2500000000000001*(alpha[3]*fUpwind_l[21]+fUpwind_l[3]*alpha[21]+alpha[2]*fUpwind_l[19])+0.223606797749979*(alpha[16]*fUpwind_l[16]+alpha[15]*fUpwind_l[15])+0.159719141249985*alpha[11]*fUpwind_l[11]+0.25*(alpha[0]*fUpwind_l[11]+fUpwind_l[0]*alpha[11])+0.223606797749979*(alpha[8]*fUpwind_l[8]+alpha[6]*fUpwind_l[6]+alpha[5]*fUpwind_l[5]+alpha[1]*fUpwind_l[1]); 
  ...
  Ghat_l[17] += 0.223606797749979*(alpha[9]*fUpwind_l[47]+alpha[7]*fUpwind_l[46])+0.2500000000000001*alpha[12]*fUpwind_l[45]+0.223606797749979*alpha[5]*fUpwind_l[44]+0.223606797749979*alpha[16]*fUpwind_l[43]+0.2*alpha[25]*fUpwind_l[42]+0.223606797749979*(alpha[4]*fUpwind_l[42]+alpha[15]*fUpwind_l[40])+0.2*alpha[21]*fUpwind_l[39]+0.223606797749979*(alpha[3]*fUpwind_l[39]+alpha[1]*fUpwind_l[37])+0.2500000000000001*alpha[22]*fUpwind_l[36]+0.223606797749979*(alpha[15]*fUpwind_l[35]+alpha[16]*fUpwind_l[32])+0.25*alpha[2]*fUpwind_l[31]+0.223606797749979*(alpha[8]*fUpwind_l[30]+alpha[6]*(fUpwind_l[27]+fUpwind_l[25])+fUpwind_l[6]*alpha[25]+alpha[8]*fUpwind_l[21]+fUpwind_l[8]*alpha[21])+0.25*alpha[5]*fUpwind_l[18]+0.223606797749979*alpha[11]*fUpwind_l[17]+0.25*(alpha[0]*fUpwind_l[17]+alpha[7]*fUpwind_l[16]+fUpwind_l[7]*alpha[16]+alpha[9]*fUpwind_l[15]+fUpwind_l[9]*alpha[15]+alpha[1]*fUpwind_l[10]+alpha[3]*fUpwind_l[8]+fUpwind_l[3]*alpha[8]+alpha[4]*fUpwind_l[6]+fUpwind_l[4]*alpha[6]); 
  Ghat_l[18] += 0.223606797749979*(alpha[8]*fUpwind_l[47]+alpha[6]*fUpwind_l[46]+alpha[5]*fUpwind_l[45])+0.2500000000000001*alpha[11]*fUpwind_l[44]+0.223606797749979*(alpha[4]*fUpwind_l[43]+alpha[16]*fUpwind_l[42])+0.2*alpha[22]*fUpwind_l[40]+0.223606797749979*(alpha[3]*fUpwind_l[40]+alpha[15]*fUpwind_l[39]+alpha[2]*fUpwind_l[38]+alpha[15]*fUpwind_l[36])+0.2500000000000001*alpha[21]*fUpwind_l[35]+0.223606797749979*alpha[16]*fUpwind_l[33]+0.2500000000000001*alpha[25]*fUpwind_l[32]+0.25*alpha[1]*fUpwind_l[31]+0.223606797749979*(alpha[9]*fUpwind_l[30]+alpha[7]*(fUpwind_l[27]+fUpwind_l[26])+alpha[9]*fUpwind_l[22]+fUpwind_l[9]*alpha[22])+0.223606797749979*alpha[12]*fUpwind_l[18]+0.25*(alpha[0]*fUpwind_l[18]+alpha[5]*fUpwind_l[17]+alpha[6]*fUpwind_l[16]+fUpwind_l[6]*alpha[16]+alpha[8]*fUpwind_l[15]+fUpwind_l[8]*alpha[15]+alpha[2]*fUpwind_l[10]+alpha[3]*fUpwind_l[9]+fUpwind_l[3]*alpha[9]+alpha[4]*fUpwind_l[7]+fUpwind_l[4]*alpha[7]); 
  Ghat_l[19] += 0.2*alpha[16]*fUpwind_l[36]+(0.159719141249985*alpha[25]+0.2500000000000001*alpha[4])*fUpwind_l[35]+0.2*alpha[15]*fUpwind_l[33]+(0.223606797749979*alpha[22]+0.159719141249985*alpha[21]+0.2500000000000001*alpha[3])*fUpwind_l[32]+0.25*(alpha[9]*fUpwind_l[25]+fUpwind_l[9]*alpha[25]+alpha[7]*fUpwind_l[21]+fUpwind_l[7]*alpha[21])+0.2*alpha[5]*fUpwind_l[20]+(0.223606797749979*alpha[12]+0.159719141249985*alpha[11]+0.25*alpha[0])*fUpwind_l[19]+0.223606797749979*(alpha[8]*fUpwind_l[16]+fUpwind_l[8]*alpha[16]+alpha[6]*fUpwind_l[15]+fUpwind_l[6]*alpha[15])+0.2500000000000001*(alpha[2]*fUpwind_l[11]+fUpwind_l[2]*alpha[11])+0.223606797749979*(alpha[1]*fUpwind_l[5]+fUpwind_l[1]*alpha[5]); 
  Ghat_l[20] += (0.223606797749979*alpha[25]+0.2500000000000001*alpha[4])*fUpwind_l[36]+0.2*alpha[16]*fUpwind_l[35]+(0.159719141249985*alpha[22]+0.223606797749979*alpha[21]+0.2500000000000001*alpha[3])*fUpwind_l[33]+0.2*alpha[15]*fUpwind_l[32]+0.25*(alpha[8]*fUpwind_l[26]+alpha[6]*fUpwind_l[22]+fUpwind_l[6]*alpha[22])+(0.159719141249985*alpha[12]+0.223606797749979*alpha[11]+0.25*alpha[0])*fUpwind_l[20]+0.2*alpha[5]*fUpwind_l[19]+0.223606797749979*(alpha[9]*fUpwind_l[16]+fUpwind_l[9]*alpha[16]+alpha[7]*fUpwind_l[15]+fUpwind_l[7]*alpha[15])+0.2500000000000001*(alpha[1]*fUpwind_l[12]+fUpwind_l[1]*alpha[12])+0.223606797749979*(alpha[2]*fUpwind_l[5]+fUpwind_l[2]*alpha[5]); 
  Ghat_l[21] += 0.25*alpha[9]*fUpwind_l[44]+(0.159719141249985*alpha[25]+0.2500000000000001*alpha[4])*fUpwind_l[37]+0.2*alpha[15]*fUpwind_l[34]+0.2500000000000001*alpha[2]*fUpwind_l[32]+0.223606797749979*alpha[16]*fUpwind_l[31]+0.25*fUpwind_l[10]*alpha[25]+0.2*alpha[6]*fUpwind_l[23]+(0.159719141249985*alpha[11]+0.25*alpha[0])*fUpwind_l[21]+(0.223606797749979*fUpwind_l[13]+0.159719141249985*fUpwind_l[11])*alpha[21]+0.25*(fUpwind_l[0]*alpha[21]+alpha[7]*fUpwind_l[19])+0.223606797749979*(alpha[8]*fUpwind_l[17]+alpha[5]*fUpwind_l[15]+fUpwind_l[5]*alpha[15])+0.2500000000000001*(alpha[3]*fUpwind_l[11]+fUpwind_l[3]*alpha[11])+0.223606797749979*(alpha[1]*fUpwind_l[6]+fUpwind_l[1]*alpha[6]); 
  ...
  Ghat_l[28] += 0.25*alpha[7]*fUpwind_l[47]+0.2500000000000001*alpha[15]*fUpwind_l[43]+0.223606797749979*alpha[21]*fUpwind_l[42]+0.2500000000000001*(alpha[3]*fUpwind_l[42]+alpha[2]*fUpwind_l[41])+0.2*alpha[16]*fUpwind_l[35]+0.25*(alpha[6]*fUpwind_l[30]+alpha[5]*fUpwind_l[29])+(0.223606797749979*alpha[11]+0.25*alpha[0])*fUpwind_l[28]+0.2*(alpha[8]*fUpwind_l[25]+fUpwind_l[8]*alpha[25])+0.223606797749979*(alpha[9]*fUpwind_l[16]+fUpwind_l[9]*alpha[16])+0.2500000000000001*alpha[1]*fUpwind_l[14]+0.223606797749979*(alpha[4]*fUpwind_l[8]+fUpwind_l[4]*alpha[8]); 
  ...
  Ghat_l[37] += 0.2*(alpha[16]*fUpwind_l[47]+alpha[15]*fUpwind_l[46])+0.2500000000000001*alpha[2]*fUpwind_l[44]+0.2*(alpha[8]*fUpwind_l[42]+alpha[6]*fUpwind_l[39])+0.159719141249985*alpha[11]*fUpwind_l[37]+0.25*(alpha[0]*fUpwind_l[37]+alpha[7]*fUpwind_l[35]+alpha[9]*fUpwind_l[32])+0.223606797749979*(alpha[5]*fUpwind_l[31]+alpha[25]*fUpwind_l[30]+alpha[21]*fUpwind_l[27])+(0.159719141249985*alpha[21]+0.2500000000000001*alpha[3])*fUpwind_l[25]+0.159719141249985*fUpwind_l[21]*alpha[25]+0.2500000000000001*(fUpwind_l[3]*alpha[25]+alpha[4]*fUpwind_l[21]+fUpwind_l[4]*alpha[21])+0.223606797749979*(alpha[1]*fUpwind_l[17]+alpha[15]*fUpwind_l[16]+fUpwind_l[15]*alpha[16])+0.25*fUpwind_l[10]*alpha[11]+0.223606797749979*(alpha[6]*fUpwind_l[8]+fUpwind_l[6]*alpha[8]); 
  ...
  Ghat_l[42] += 0.2500000000000001*alpha[2]*fUpwind_l[47]+0.2*alpha[16]*fUpwind_l[44]+0.25*alpha[5]*fUpwind_l[43]+0.223606797749979*alpha[11]*fUpwind_l[42]+0.25*(alpha[0]*fUpwind_l[42]+alpha[7]*fUpwind_l[41])+0.2*alpha[8]*fUpwind_l[37]+0.223606797749979*alpha[9]*fUpwind_l[31]+0.2500000000000001*(alpha[1]*fUpwind_l[30]+alpha[15]*fUpwind_l[29])+(0.223606797749979*alpha[21]+0.2500000000000001*alpha[3])*fUpwind_l[28]+0.2*fUpwind_l[17]*alpha[25]+0.223606797749979*(alpha[16]*fUpwind_l[18]+alpha[4]*fUpwind_l[17])+0.25*alpha[6]*fUpwind_l[14]+0.223606797749979*alpha[8]*fUpwind_l[10]; 
  ...
  Ghat_l[44] += 0.2*(alpha[8]*fUpwind_l[47]+alpha[6]*fUpwind_l[46]+alpha[5]*fUpwind_l[45])+(0.223606797749979*alpha[12]+0.159719141249985*alpha[11]+0.25*alpha[0])*fUpwind_l[44]+0.223606797749979*alpha[25]*fUpwind_l[43]+0.2*alpha[16]*fUpwind_l[42]+0.223606797749979*alpha[21]*fUpwind_l[40]+0.2*alpha[15]*fUpwind_l[39]+0.2500000000000001*alpha[2]*fUpwind_l[37]+0.2*alpha[15]*fUpwind_l[36]+(0.223606797749979*alpha[22]+0.159719141249985*alpha[21]+0.2500000000000001*alpha[3])*fUpwind_l[35]+0.2*alpha[16]*fUpwind_l[33]+(0.159719141249985*alpha[25]+0.2500000000000001*alpha[4])*fUpwind_l[32]+0.223606797749979*alpha[1]*fUpwind_l[31]+0.25*(alpha[7]*fUpwind_l[25]+fUpwind_l[7]*alpha[25]+alpha[9]*fUpwind_l[21]+fUpwind_l[9]*alpha[21])+0.2500000000000001*alpha[11]*fUpwind_l[18]+0.223606797749979*(alpha[5]*fUpwind_l[17]+alpha[6]*fUpwind_l[16]+fUpwind_l[6]*alpha[16]+alpha[8]*fUpwind_l[15]+fUpwind_l[8]*alpha[15]); 
  Ghat_l[45] += 0.2*(alpha[9]*fUpwind_l[47]+alpha[7]*fUpwind_l[46])+(0.159719141249985*alpha[12]+0.223606797749979*alpha[11]+0.25*alpha[0])*fUpwind_l[45]+0.2*(alpha[5]*fUpwind_l[44]+alpha[16]*fUpwind_l[43]+alpha[15]*fUpwind_l[40])+0.223606797749979*alpha[22]*fUpwind_l[39]+0.2500000000000001*alpha[1]*fUpwind_l[38]+(0.159719141249985*alpha[22]+0.223606797749979*alpha[21]+0.2500000000000001*alpha[3])*fUpwind_l[36]+0.2*alpha[15]*fUpwind_l[35]+(0.223606797749979*alpha[25]+0.2500000000000001*alpha[4])*fUpwind_l[33]+0.2*alpha[16]*fUpwind_l[32]+0.223606797749979*alpha[2]*fUpwind_l[31]+0.25*(alpha[6]*fUpwind_l[26]+alpha[8]*fUpwind_l[22]+fUpwind_l[8]*alpha[22])+0.223606797749979*alpha[5]*fUpwind_l[18]+0.2500000000000001*alpha[12]*fUpwind_l[17]+0.223606797749979*(alpha[7]*fUpwind_l[16]+fUpwind_l[7]*alpha[16]+alpha[9]*fUpwind_l[15]+fUpwind_l[9]*alpha[15]); 
  Ghat_l[46] += (0.223606797749979*(alpha[12]+alpha[11])+0.25*alpha[0])*fUpwind_l[46]+0.2*(alpha[7]*fUpwind_l[45]+alpha[6]*fUpwind_l[44])+0.2500000000000001*(alpha[1]*fUpwind_l[40]+alpha[2]*fUpwind_l[39])+0.2*alpha[15]*(fUpwind_l[38]+fUpwind_l[37])+(0.223606797749979*alpha[25]+0.2500000000000001*alpha[4])*fUpwind_l[34]+(0.2*(alpha[22]+alpha[21])+0.223606797749979*alpha[3])*fUpwind_l[31]+0.25*(alpha[5]*fUpwind_l[27]+alpha[8]*fUpwind_l[24]+alpha[9]*fUpwind_l[23])+0.223606797749979*(alpha[6]*fUpwind_l[18]+alpha[7]*fUpwind_l[17])+0.2500000000000001*fUpwind_l[13]*alpha[16]+0.223606797749979*fUpwind_l[10]*alpha[15]; 
  ...
  Ghat_r[25] += 0.25*alpha[7]*fUpwind_r[44]+0.2*alpha[16]*fUpwind_r[41]+0.159719141249985*alpha[21]*fUpwind_r[37]+0.2500000000000001*(alpha[3]*fUpwind_r[37]+alpha[2]*fUpwind_r[35])+0.223606797749979*alpha[15]*fUpwind_r[31]+0.2*alpha[8]*fUpwind_r[28]+(0.159719141249985*alpha[11]+0.25*alpha[0])*fUpwind_r[25]+(0.223606797749979*fUpwind_r[14]+0.159719141249985*fUpwind_r[11])*alpha[25]+0.25*(fUpwind_r[0]*alpha[25]+fUpwind_r[10]*alpha[21]+alpha[9]*fUpwind_r[19])+0.223606797749979*(alpha[6]*fUpwind_r[17]+alpha[5]*fUpwind_r[16]+fUpwind_r[5]*alpha[16])+0.2500000000000001*(alpha[4]*fUpwind_r[11]+fUpwind_r[4]*alpha[11])+0.223606797749979*(alpha[1]*fUpwind_r[8]+fUpwind_r[1]*alpha[8]); 
  ...
  Ghat_r[37] += 0.2*(alpha[16]*fUpwind_r[47]+alpha[15]*fUpwind_r[46])+0.2500000000000001*alpha[2]*fUpwind_r[44]+0.2*(alpha[8]*fUpwind_r[42]+alpha[6]*fUpwind_r[39])+0.159719141249985*alpha[11]*fUpwind_r[37]+0.25*(alpha[0]*fUpwind_r[37]+alpha[7]*fUpwind_r[35]+alpha[9]*fUpwind_r[32])+0.223606797749979*(alpha[5]*fUpwind_r[31]+alpha[25]*fUpwind_r[30]+alpha[21]*fUpwind_r[27])+(0.159719141249985*alpha[21]+0.2500000000000001*alpha[3])*fUpwind_r[25]+0.159719141249985*fUpwind_r[21]*alpha[25]+0.2500000000000001*(fUpwind_r[3]*alpha[25]+alpha[4]*fUpwind_r[21]+fUpwind_r[4]*alpha[21])+0.223606797749979*(alpha[1]*fUpwind_r[17]+alpha[15]*fUpwind_r[16]+fUpwind_r[15]*alpha[16])+0.25*fUpwind_r[10]*alpha[11]+0.223606797749979*(alpha[6]*fUpwind_r[8]+fUpwind_r[6]*alpha[8]); 
  ...
  Ghat_r[40] += 0.2500000000000001*alpha[1]*fUpwind_r[46]+0.2*alpha[15]*fUpwind_r[45]+0.223606797749979*(alpha[21]*fUpwind_r[44]+alpha[12]*fUpwind_r[40])+0.25*(alpha[0]*fUpwind_r[40]+alpha[5]*fUpwind_r[39])+0.2*alpha[7]*fUpwind_r[38]+0.25*alpha[8]*fUpwind_r[34]+0.223606797749979*alpha[6]*fUpwind_r[31]+0.2500000000000001*(alpha[2]*fUpwind_r[27]+alpha[4]*fUpwind_r[24]+alpha[16]*fUpwind_r[23])+0.2*fUpwind_r[18]*alpha[22]+0.223606797749979*(alpha[3]*fUpwind_r[18]+alpha[15]*fUpwind_r[17])+0.25*alpha[9]*fUpwind_r[13]+0.223606797749979*alpha[7]*fUpwind_r[10]; 
  ...
  Ghat_r[44] += 0.2*(alpha[8]*fUpwind_r[47]+alpha[6]*fUpwind_r[46]+alpha[5]*fUpwind_r[45])+(0.223606797749979*alpha[12]+0.159719141249985*alpha[11]+0.25*alpha[0])*fUpwind_r[44]+0.223606797749979*alpha[25]*fUpwind_r[43]+0.2*alpha[16]*fUpwind_r[42]+0.223606797749979*alpha[21]*fUpwind_r[40]+0.2*alpha[15]*fUpwind_r[39]+0.2500000000000001*alpha[2]*fUpwind_r[37]+0.2*alpha[15]*fUpwind_r[36]+(0.223606797749979*alpha[22]+0.159719141249985*alpha[21]+0.2500000000000001*alpha[3])*fUpwind_r[35]+0.2*alpha[16]*fUpwind_r[33]+(0.159719141249985*alpha[25]+0.2500000000000001*alpha[4])*fUpwind_r[32]+0.223606797749979*alpha[1]*fUpwind_r[31]+0.25*(alpha[7]*fUpwind_r[25]+fUpwind_r[7]*alpha[25]+alpha[9]*fUpwind_r[21]+fUpwind_r[9]*alpha[21])+0.2500000000000001*alpha[11]*fUpwind_r[18]+0.223606797749979*(alpha[5]*fUpwind_r[17]+alpha[6]*fUpwind_r[16]+fUpwind_r[6]*alpha[16]+alpha[8]*fUpwind_r[15]+fUpwind_r[8]*alpha[15]); 
  ...
  Ghat_r[46] += (0.223606797749979*(alpha[12]+alpha[11])+0.25*alpha[0])*fUpwind_r[46]+0.2*(alpha[7]*fUpwind_r[45]+alpha[6]*fUpwind_r[44])+0.2500000000000001*(alpha[1]*fUpwind_r[40]+alpha[2]*fUpwind_r[39])+0.2*alpha[15]*(fUpwind_r[38]+fUpwind_r[37])+(0.223606797749979*alpha[25]+0.2500000000000001*alpha[4])*fUpwind_r[34]+(0.2*(alpha[22]+alpha[21])+0.223606797749979*alpha[3])*fUpwind_r[31]+0.25*(alpha[5]*fUpwind_r[27]+alpha[8]*fUpwind_r[24]+alpha[9]*fUpwind_r[23])+0.223606797749979*(alpha[6]*fUpwind_r[18]+alpha[7]*fUpwind_r[17])+0.2500000000000001*fUpwind_r[13]*alpha[16]+0.223606797749979*fUpwind_r[10]*alpha[15]; 
  Ghat_r[47] += (0.223606797749979*(alpha[12]+alpha[11])+0.25*alpha[0])*fUpwind_r[47]+0.2*(alpha[9]*fUpwind_r[45]+alpha[8]*fUpwind_r[44])+0.2500000000000001*(alpha[1]*fUpwind_r[43]+alpha[2]*fUpwind_r[42])+(0.223606797749979*(alpha[22]+alpha[21])+0.2500000000000001*alpha[3])*fUpwind_r[41]+0.2*alpha[16]*(fUpwind_r[38]+fUpwind_r[37])+(0.2*alpha[25]+0.223606797749979*alpha[4])*fUpwind_r[31]+0.25*(alpha[5]*fUpwind_r[30]+alpha[6]*fUpwind_r[29]+alpha[7]*fUpwind_r[28])+0.223606797749979*(alpha[8]*fUpwind_r[18]+alpha[9]*fUpwind_r[17]+fUpwind_r[10]*alpha[16])+0.2500000000000001*fUpwind_r[14]*alpha[15]; 
