...
{ 
  ...
  if (0.3162277660168378*alpha[8]+0.6363961030678926*alpha[4]-0.4743416490252567*(alpha[2]+alpha[1])+0.3535533905932737*alpha[0] > 0) { 
  ...
  if ((-0.3952847075210473*alpha[8])-0.4743416490252567*alpha[1]+0.3535533905932737*alpha[0] > 0) { 
  ...
  if (0.3162277660168378*alpha[8]-0.6363961030678926*alpha[4]+0.4743416490252567*alpha[2]-0.4743416490252567*alpha[1]+0.3535533905932737*alpha[0] > 0) { 
