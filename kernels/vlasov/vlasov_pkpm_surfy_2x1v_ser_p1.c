...
{ 
  ...
  const double *uc = &u_i[4]; 
  const double *bc = &bvar[4]; 
  double alphaSurf_l[6] = {0.0}; 
  alphaSurf_l[0] = (-1.732050807568877*bc[2]*wvpar)+bc[0]*wvpar-1.732050807568877*uc[2]+uc[0]; 
  alphaSurf_l[1] = (-1.732050807568877*bc[3]*wvpar)+bc[1]*wvpar-1.732050807568877*uc[3]+uc[1]; 
  alphaSurf_l[2] = 0.2886751345948129*bc[0]*dvpar-0.5*bc[2]*dvpar; 
  alphaSurf_l[3] = 0.2886751345948129*bc[1]*dvpar-0.5*bc[3]*dvpar; 

  double alphaSurf_r[6] = {0.0}; 
  alphaSurf_r[0] = 1.732050807568877*bc[2]*wvpar+bc[0]*wvpar+1.732050807568877*uc[2]+uc[0]; 
  alphaSurf_r[1] = 1.732050807568877*bc[3]*wvpar+bc[1]*wvpar+1.732050807568877*uc[3]+uc[1]; 
  alphaSurf_r[2] = 0.5*bc[2]*dvpar+0.2886751345948129*bc[0]*dvpar; 
  alphaSurf_r[3] = 0.5*bc[3]*dvpar+0.2886751345948129*bc[1]*dvpar; 
