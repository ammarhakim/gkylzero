...
{ 
  ...
  Ghat[1] = (0.7071067811865475*fedge[2]-1.224744871391589*fedge[3])*wv+((-0.3162277660168379*fedge[5])+0.1825741858350554*fedge[4]-0.3535533905932737*fedge[1]+0.2041241452319315*fedge[0])*dv; 
  Ghat[2] = (0.7071067811865475*fedge[4]-1.224744871391589*fedge[5])*wv+(0.1825741858350554*fedge[2]-0.3162277660168379*fedge[3])*dv; 
  ...
  Ghat[1] = (0.7071067811865475*fskin[2]-1.224744871391589*fskin[3])*wv+((-0.3162277660168379*fskin[5])+0.1825741858350554*fskin[4]-0.3535533905932737*fskin[1]+0.2041241452319315*fskin[0])*dv; 
  Ghat[2] = (0.7071067811865475*fskin[4]-1.224744871391589*fskin[5])*wv+(0.1825741858350554*fskin[2]-0.3162277660168379*fskin[3])*dv; 
