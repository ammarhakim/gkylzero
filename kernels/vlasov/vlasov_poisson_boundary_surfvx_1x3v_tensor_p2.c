...
GKYL_CU_DH void vlasov_poisson_boundary_surfvx_1x3v_tensor_p2(const double *w, const double *dxv, const double *fac_phi, const double *vecA, const int edge, const double *fEdge, const double *fSkin, double* GKYL_RESTRICT out) 
{ 
  ...
  Ghat[12] += 0.3162277660168379*alpha[1]*fUpwind[20]+0.3535533905932737*(alpha[0]*fUpwind[12]+alpha[1]*fUpwind[8]); 
  ...
  Ghat[15] += 0.3162277660168379*alpha[1]*fUpwind[21]+0.3535533905932737*(alpha[0]*fUpwind[15]+alpha[1]*fUpwind[9]); 
  ...
  Ghat[18] += 0.3162277660168379*alpha[1]*fUpwind[23]+0.3535533905932737*(alpha[0]*fUpwind[18]+alpha[1]*fUpwind[14]); 
  Ghat[19] += 0.3162277660168379*alpha[1]*fUpwind[24]+0.3535533905932737*(alpha[0]*fUpwind[19]+alpha[1]*fUpwind[16]); 
  Ghat[20] += 0.3535533905932737*alpha[0]*fUpwind[20]+0.3162277660168379*alpha[1]*fUpwind[12]; 
  Ghat[21] += 0.3535533905932737*alpha[0]*fUpwind[21]+0.3162277660168379*alpha[1]*fUpwind[15]; 
  Ghat[22] += 0.3535533905932737*(alpha[1]*fUpwind[25]+alpha[0]*fUpwind[22]); 
  Ghat[23] += 0.3535533905932737*alpha[0]*fUpwind[23]+0.3162277660168379*alpha[1]*fUpwind[18]; 
  Ghat[24] += 0.3535533905932737*alpha[0]*fUpwind[24]+0.3162277660168379*alpha[1]*fUpwind[19]; 
  Ghat[25] += 0.3162277660168379*alpha[1]*fUpwind[26]+0.3535533905932737*(alpha[0]*fUpwind[25]+alpha[1]*fUpwind[22]); 
  Ghat[26] += 0.3535533905932737*alpha[0]*fUpwind[26]+0.3162277660168379*alpha[1]*fUpwind[25]; 
