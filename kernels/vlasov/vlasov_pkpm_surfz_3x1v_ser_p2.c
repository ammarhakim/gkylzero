...
{ 
  ...
  const double *ul = &u_il[40]; 
  const double *uc = &u_ic[40]; 
  const double *ur = &u_ir[40]; 
  const double *bl = &bvarl[40]; 
  const double *bc = &bvarc[40]; 
  const double *br = &bvarr[40]; 
  ...
  alphaSurf_l[0] = 0.3458741190809163*alpha_l[13]+0.3458741190809163*alpha_c[13]+0.4975526040028326*alpha_l[3]-0.4975526040028326*alpha_c[3]+0.3535533905932737*alpha_l[0]+0.3535533905932737*alpha_c[0]; 
  alphaSurf_l[1] = 0.3458741190809163*alpha_l[23]+0.3458741190809163*alpha_c[23]+0.4975526040028326*alpha_l[6]-0.4975526040028326*alpha_c[6]+0.3535533905932737*alpha_l[1]+0.3535533905932737*alpha_c[1]; 
  alphaSurf_l[2] = 0.3458741190809163*alpha_l[24]+0.3458741190809163*alpha_c[24]+0.4975526040028326*alpha_l[7]-0.4975526040028326*alpha_c[7]+0.3535533905932737*alpha_l[2]+0.3535533905932737*alpha_c[2]; 
  alphaSurf_l[3] = 0.3458741190809163*alpha_l[27]+0.3458741190809163*alpha_c[27]+0.4975526040028326*alpha_l[10]-0.4975526040028326*alpha_c[10]+0.3535533905932737*alpha_l[4]+0.3535533905932737*alpha_c[4]; 
  alphaSurf_l[4] = 0.3458741190809163*alpha_l[34]+0.3458741190809163*alpha_c[34]+0.4975526040028326*alpha_l[15]-0.4975526040028326*alpha_c[15]+0.3535533905932737*alpha_l[5]+0.3535533905932737*alpha_c[5]; 
  alphaSurf_l[5] = 0.3458741190809163*alpha_l[39]+0.3458741190809163*alpha_c[39]+0.4975526040028326*alpha_l[17]-0.4975526040028326*alpha_c[17]+0.3535533905932737*alpha_l[8]+0.3535533905932737*alpha_c[8]; 
  alphaSurf_l[6] = 0.3458741190809163*alpha_l[40]+0.3458741190809163*alpha_c[40]+0.4975526040028326*alpha_l[18]-0.4975526040028326*alpha_c[18]+0.3535533905932737*alpha_l[9]+0.3535533905932737*alpha_c[9]; 
  alphaSurf_l[7] = 0.4975526040028326*alpha_l[21]-0.4975526040028326*alpha_c[21]+0.3535533905932737*alpha_l[11]+0.3535533905932737*alpha_c[11]; 
  alphaSurf_l[8] = 0.4975526040028326*alpha_l[22]-0.4975526040028326*alpha_c[22]+0.3535533905932737*alpha_l[12]+0.3535533905932737*alpha_c[12]; 
  alphaSurf_l[10] = 0.3458741190809163*alpha_l[46]+0.3458741190809163*alpha_c[46]+0.4975526040028326*alpha_l[31]-0.4975526040028326*alpha_c[31]+0.3535533905932737*alpha_l[16]+0.3535533905932737*alpha_c[16]; 
  alphaSurf_l[11] = 0.4975526040028326*alpha_l[32]-0.4975526040028326*alpha_c[32]+0.3535533905932737*alpha_l[19]+0.3535533905932737*alpha_c[19]; 
  alphaSurf_l[12] = 0.4975526040028326*alpha_l[33]-0.4975526040028326*alpha_c[33]+0.3535533905932737*alpha_l[20]+0.3535533905932737*alpha_c[20]; 
  alphaSurf_l[13] = 0.4975526040028326*alpha_l[37]-0.4975526040028326*alpha_c[37]+0.3535533905932737*alpha_l[25]+0.3535533905932737*alpha_c[25]; 
  alphaSurf_l[14] = 0.4975526040028326*alpha_l[38]-0.4975526040028326*alpha_c[38]+0.3535533905932737*alpha_l[26]+0.3535533905932737*alpha_c[26]; 
  alphaSurf_l[17] = 0.4975526040028326*alpha_l[44]-0.4975526040028326*alpha_c[44]+0.3535533905932737*alpha_l[35]+0.3535533905932737*alpha_c[35]; 
  alphaSurf_l[18] = 0.4975526040028326*alpha_l[45]-0.4975526040028326*alpha_c[45]+0.3535533905932737*alpha_l[36]+0.3535533905932737*alpha_c[36]; 

  double alphaSurf_r[20] = {0.0}; 
  alphaSurf_r[0] = 0.3458741190809163*alpha_r[13]+0.3458741190809163*alpha_c[13]-0.4975526040028326*alpha_r[3]+0.4975526040028326*alpha_c[3]+0.3535533905932737*alpha_r[0]+0.3535533905932737*alpha_c[0]; 
  alphaSurf_r[1] = 0.3458741190809163*alpha_r[23]+0.3458741190809163*alpha_c[23]-0.4975526040028326*alpha_r[6]+0.4975526040028326*alpha_c[6]+0.3535533905932737*alpha_r[1]+0.3535533905932737*alpha_c[1]; 
  alphaSurf_r[2] = 0.3458741190809163*alpha_r[24]+0.3458741190809163*alpha_c[24]-0.4975526040028326*alpha_r[7]+0.4975526040028326*alpha_c[7]+0.3535533905932737*alpha_r[2]+0.3535533905932737*alpha_c[2]; 
  alphaSurf_r[3] = 0.3458741190809163*alpha_r[27]+0.3458741190809163*alpha_c[27]-0.4975526040028326*alpha_r[10]+0.4975526040028326*alpha_c[10]+0.3535533905932737*alpha_r[4]+0.3535533905932737*alpha_c[4]; 
  alphaSurf_r[4] = 0.3458741190809163*alpha_r[34]+0.3458741190809163*alpha_c[34]-0.4975526040028326*alpha_r[15]+0.4975526040028326*alpha_c[15]+0.3535533905932737*alpha_r[5]+0.3535533905932737*alpha_c[5]; 
  alphaSurf_r[5] = 0.3458741190809163*alpha_r[39]+0.3458741190809163*alpha_c[39]-0.4975526040028326*alpha_r[17]+0.4975526040028326*alpha_c[17]+0.3535533905932737*alpha_r[8]+0.3535533905932737*alpha_c[8]; 
  alphaSurf_r[6] = 0.3458741190809163*alpha_r[40]+0.3458741190809163*alpha_c[40]-0.4975526040028326*alpha_r[18]+0.4975526040028326*alpha_c[18]+0.3535533905932737*alpha_r[9]+0.3535533905932737*alpha_c[9]; 
  alphaSurf_r[7] = (-0.4975526040028326*alpha_r[21])+0.4975526040028326*alpha_c[21]+0.3535533905932737*alpha_r[11]+0.3535533905932737*alpha_c[11]; 
  alphaSurf_r[8] = (-0.4975526040028326*alpha_r[22])+0.4975526040028326*alpha_c[22]+0.3535533905932737*alpha_r[12]+0.3535533905932737*alpha_c[12]; 
  alphaSurf_r[10] = 0.3458741190809163*alpha_r[46]+0.3458741190809163*alpha_c[46]-0.4975526040028326*alpha_r[31]+0.4975526040028326*alpha_c[31]+0.3535533905932737*alpha_r[16]+0.3535533905932737*alpha_c[16]; 
  alphaSurf_r[11] = (-0.4975526040028326*alpha_r[32])+0.4975526040028326*alpha_c[32]+0.3535533905932737*alpha_r[19]+0.3535533905932737*alpha_c[19]; 
  alphaSurf_r[12] = (-0.4975526040028326*alpha_r[33])+0.4975526040028326*alpha_c[33]+0.3535533905932737*alpha_r[20]+0.3535533905932737*alpha_c[20]; 
  alphaSurf_r[13] = (-0.4975526040028326*alpha_r[37])+0.4975526040028326*alpha_c[37]+0.3535533905932737*alpha_r[25]+0.3535533905932737*alpha_c[25]; 
  alphaSurf_r[14] = (-0.4975526040028326*alpha_r[38])+0.4975526040028326*alpha_c[38]+0.3535533905932737*alpha_r[26]+0.3535533905932737*alpha_c[26]; 
  alphaSurf_r[17] = (-0.4975526040028326*alpha_r[44])+0.4975526040028326*alpha_c[44]+0.3535533905932737*alpha_r[35]+0.3535533905932737*alpha_c[35]; 
  alphaSurf_r[18] = (-0.4975526040028326*alpha_r[45])+0.4975526040028326*alpha_c[45]+0.3535533905932737*alpha_r[36]+0.3535533905932737*alpha_c[36]; 
  ...
  out[12] += (0.7071067811865475*Ghat_l[8]-0.7071067811865475*Ghat_r[8])*dx1; 
  out[13] += (1.58113883008419*Ghat_l[0]-1.58113883008419*Ghat_r[0])*dx1; 
  out[14] += (0.7071067811865475*Ghat_l[9]-0.7071067811865475*Ghat_r[9])*dx1; 
  out[15] += -1.224744871391589*(Ghat_r[4]+Ghat_l[4])*dx1; 
  out[16] += (0.7071067811865475*Ghat_l[10]-0.7071067811865475*Ghat_r[10])*dx1; 
  out[17] += -1.224744871391589*(Ghat_r[5]+Ghat_l[5])*dx1; 
  out[18] += -1.224744871391589*(Ghat_r[6]+Ghat_l[6])*dx1; 
  out[19] += (0.7071067811865475*Ghat_l[11]-0.7071067811865475*Ghat_r[11])*dx1; 
  out[20] += (0.7071067811865475*Ghat_l[12]-0.7071067811865475*Ghat_r[12])*dx1; 
  out[21] += -1.224744871391589*(Ghat_r[7]+Ghat_l[7])*dx1; 
  out[22] += -1.224744871391589*(Ghat_r[8]+Ghat_l[8])*dx1; 
  out[23] += (1.58113883008419*Ghat_l[1]-1.58113883008419*Ghat_r[1])*dx1; 
  out[24] += (1.58113883008419*Ghat_l[2]-1.58113883008419*Ghat_r[2])*dx1; 
  out[25] += (0.7071067811865475*Ghat_l[13]-0.7071067811865475*Ghat_r[13])*dx1; 
  out[26] += (0.7071067811865475*Ghat_l[14]-0.7071067811865475*Ghat_r[14])*dx1; 
  out[27] += (1.58113883008419*Ghat_l[3]-1.58113883008419*Ghat_r[3])*dx1; 
  out[28] += (0.7071067811865475*Ghat_l[15]-0.7071067811865475*Ghat_r[15])*dx1; 
  out[29] += (0.7071067811865475*Ghat_l[16]-0.7071067811865475*Ghat_r[16])*dx1; 
  out[30] += -1.224744871391589*(Ghat_r[9]+Ghat_l[9])*dx1; 
  out[31] += -1.224744871391589*(Ghat_r[10]+Ghat_l[10])*dx1; 
  out[32] += -1.224744871391589*(Ghat_r[11]+Ghat_l[11])*dx1; 
  out[33] += -1.224744871391589*(Ghat_r[12]+Ghat_l[12])*dx1; 
  out[34] += (1.58113883008419*Ghat_l[4]-1.58113883008419*Ghat_r[4])*dx1; 
  out[35] += (0.7071067811865475*Ghat_l[17]-0.7071067811865475*Ghat_r[17])*dx1; 
  out[36] += (0.7071067811865475*Ghat_l[18]-0.7071067811865475*Ghat_r[18])*dx1; 
  out[37] += -1.224744871391589*(Ghat_r[13]+Ghat_l[13])*dx1; 
  out[38] += -1.224744871391589*(Ghat_r[14]+Ghat_l[14])*dx1; 
  out[39] += (1.58113883008419*Ghat_l[5]-1.58113883008419*Ghat_r[5])*dx1; 
  out[40] += (1.58113883008419*Ghat_l[6]-1.58113883008419*Ghat_r[6])*dx1; 
  out[41] += (0.7071067811865475*Ghat_l[19]-0.7071067811865475*Ghat_r[19])*dx1; 
  out[42] += -1.224744871391589*(Ghat_r[15]+Ghat_l[15])*dx1; 
  out[43] += -1.224744871391589*(Ghat_r[16]+Ghat_l[16])*dx1; 
  out[44] += -1.224744871391589*(Ghat_r[17]+Ghat_l[17])*dx1; 
  out[45] += -1.224744871391589*(Ghat_r[18]+Ghat_l[18])*dx1; 
  out[46] += (1.58113883008419*Ghat_l[10]-1.58113883008419*Ghat_r[10])*dx1; 
