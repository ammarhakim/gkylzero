...
{ 
  ...
  Ghat_r[1] = (1.58113883008419*fr[6]-1.224744871391589*fr[3]+0.7071067811865475*fr[2])*wv+((-0.3162277660168379*fr[7])+0.1825741858350554*fr[5]+0.4564354645876384*fr[4]-0.3535533905932737*fr[1]+0.2041241452319315*fr[0])*dv; 
  Ghat_r[2] = (0.7071067811865475*fr[5]-1.224744871391589*fr[7])*wv+(0.408248290463863*fr[6]-0.3162277660168379*fr[3]+0.1825741858350554*fr[2])*dv; 
  ...
  Ghat_l[1] = (1.58113883008419*fc[6]-1.224744871391589*fc[3]+0.7071067811865475*fc[2])*wv+((-0.3162277660168379*fc[7])+0.1825741858350554*fc[5]+0.4564354645876384*fc[4]-0.3535533905932737*fc[1]+0.2041241452319315*fc[0])*dv; 
  Ghat_l[2] = (0.7071067811865475*fc[5]-1.224744871391589*fc[7])*wv+(0.408248290463863*fc[6]-0.3162277660168379*fc[3]+0.1825741858350554*fc[2])*dv; 
