...
GKYL_CU_DH double vlasov_poisson_extem_surfvy_1x2v_ser_p1(const double *w, const double *dxv, const double *field, const double *ext_field, const double *fl, const double *fc, const double *fr, double* GKYL_RESTRICT out) 
{ 
  ...
  Ghat_l[3] = 0.447213595499958*alpha[2]*fUpwind_l[5]+0.5*alpha[0]*fUpwind_l[3]+0.5*fUpwind_l[1]*alpha[2]; 
  Ghat_l[4] = 0.5*alpha[0]*fUpwind_l[4]+0.4472135954999579*alpha[2]*fUpwind_l[2]; 
  Ghat_l[5] = 0.5*alpha[0]*fUpwind_l[5]+0.447213595499958*alpha[2]*fUpwind_l[3]; 
  ...
  Ghat_r[3] = 0.447213595499958*alpha[2]*fUpwind_r[5]+0.5*alpha[0]*fUpwind_r[3]+0.5*fUpwind_r[1]*alpha[2]; 
  Ghat_r[4] = 0.5*alpha[0]*fUpwind_r[4]+0.4472135954999579*alpha[2]*fUpwind_r[2]; 
  Ghat_r[5] = 0.5*alpha[0]*fUpwind_r[5]+0.447213595499958*alpha[2]*fUpwind_r[3]; 
