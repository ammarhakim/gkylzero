...
GKYL_CU_DH void vlasov_poisson_extem_boundary_surfvx_2x2v_tensor_p2(const double *w, const double *dxv, const double *fac_phi, const double *vecA, const int edge, const double *fEdge, const double *fSkin, double* GKYL_RESTRICT out) 
{ 
  ...
  alpha[11] = -5.477225575051662*A0[8]*dx11*wv2; 
  alpha[12] = 5.477225575051662*A1[8]*dx10*wv2-5.477225575051662*phi[8]*dx10; 
  alpha[13] = -0.7071067811865475*A0[6]*dv2*dx11; 
  alpha[14] = 0.7071067811865475*A1[7]*dv2*dx10; 
  alpha[17] = -1.58113883008419*A0[8]*dv2*dx11; 
  alpha[18] = 1.58113883008419*A1[8]*dv2*dx10; 
