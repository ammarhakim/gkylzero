...
{ 
  ...
  if (0.3535533905932737*(alpha[5]+alpha[4])-0.3535533905932737*(alpha[3]+alpha[2]+alpha[1])+0.3535533905932737*alpha[0] > 0) { 
    fUpwindQuad_l[0] = tensor_4x_p1_surfx2_eval_quad_node_0_r(fl); 
    fUpwindQuad_r[0] = tensor_4x_p1_surfx2_eval_quad_node_0_r(fc); 
  } else { 
    fUpwindQuad_l[0] = tensor_4x_p1_surfx2_eval_quad_node_0_l(fc); 
    fUpwindQuad_r[0] = tensor_4x_p1_surfx2_eval_quad_node_0_l(fr); 
  } 
  if ((-0.3535533905932737*alpha[5])+0.3535533905932737*(alpha[4]+alpha[3])-0.3535533905932737*(alpha[2]+alpha[1])+0.3535533905932737*alpha[0] > 0) { 
    fUpwindQuad_l[1] = tensor_4x_p1_surfx2_eval_quad_node_1_r(fl); 
    fUpwindQuad_r[1] = tensor_4x_p1_surfx2_eval_quad_node_1_r(fc); 
  } else { 
    fUpwindQuad_l[1] = tensor_4x_p1_surfx2_eval_quad_node_1_l(fc); 
    fUpwindQuad_r[1] = tensor_4x_p1_surfx2_eval_quad_node_1_l(fr); 
  } 
  if (0.3535533905932737*alpha[5]-0.3535533905932737*(alpha[4]+alpha[3])+0.3535533905932737*alpha[2]-0.3535533905932737*alpha[1]+0.3535533905932737*alpha[0] > 0) { 
    fUpwindQuad_l[2] = tensor_4x_p1_surfx2_eval_quad_node_2_r(fl); 
    fUpwindQuad_r[2] = tensor_4x_p1_surfx2_eval_quad_node_2_r(fc); 
  } else { 
    fUpwindQuad_l[2] = tensor_4x_p1_surfx2_eval_quad_node_2_l(fc); 
    fUpwindQuad_r[2] = tensor_4x_p1_surfx2_eval_quad_node_2_l(fr); 
  } 
  if ((-0.3535533905932737*(alpha[5]+alpha[4]))+0.3535533905932737*(alpha[3]+alpha[2])-0.3535533905932737*alpha[1]+0.3535533905932737*alpha[0] > 0) { 
    fUpwindQuad_l[3] = tensor_4x_p1_surfx2_eval_quad_node_3_r(fl); 
    fUpwindQuad_r[3] = tensor_4x_p1_surfx2_eval_quad_node_3_r(fc); 
  } else { 
    fUpwindQuad_l[3] = tensor_4x_p1_surfx2_eval_quad_node_3_l(fc); 
    fUpwindQuad_r[3] = tensor_4x_p1_surfx2_eval_quad_node_3_l(fr); 
  } 
  if (0.3535533905932737*(alpha[1]+alpha[0])-0.3535533905932737*(alpha[5]+alpha[4]+alpha[3]+alpha[2]) > 0) { 
    fUpwindQuad_l[4] = tensor_4x_p1_surfx2_eval_quad_node_4_r(fl); 
    fUpwindQuad_r[4] = tensor_4x_p1_surfx2_eval_quad_node_4_r(fc); 
  } else { 
    fUpwindQuad_l[4] = tensor_4x_p1_surfx2_eval_quad_node_4_l(fc); 
    fUpwindQuad_r[4] = tensor_4x_p1_surfx2_eval_quad_node_4_l(fr); 
  } 
  if (0.3535533905932737*alpha[5]-0.3535533905932737*alpha[4]+0.3535533905932737*alpha[3]-0.3535533905932737*alpha[2]+0.3535533905932737*(alpha[1]+alpha[0]) > 0) { 
    fUpwindQuad_l[5] = tensor_4x_p1_surfx2_eval_quad_node_5_r(fl); 
    fUpwindQuad_r[5] = tensor_4x_p1_surfx2_eval_quad_node_5_r(fc); 
  } else { 
    fUpwindQuad_l[5] = tensor_4x_p1_surfx2_eval_quad_node_5_l(fc); 
    fUpwindQuad_r[5] = tensor_4x_p1_surfx2_eval_quad_node_5_l(fr); 
  } 
  if ((-0.3535533905932737*alpha[5])+0.3535533905932737*alpha[4]-0.3535533905932737*alpha[3]+0.3535533905932737*(alpha[2]+alpha[1]+alpha[0]) > 0) { 
    fUpwindQuad_l[6] = tensor_4x_p1_surfx2_eval_quad_node_6_r(fl); 
    fUpwindQuad_r[6] = tensor_4x_p1_surfx2_eval_quad_node_6_r(fc); 
  } else { 
    fUpwindQuad_l[6] = tensor_4x_p1_surfx2_eval_quad_node_6_l(fc); 
    fUpwindQuad_r[6] = tensor_4x_p1_surfx2_eval_quad_node_6_l(fr); 
  } 
  if (0.3535533905932737*(alpha[5]+alpha[4]+alpha[3]+alpha[2]+alpha[1]+alpha[0]) > 0) { 
    fUpwindQuad_l[7] = tensor_4x_p1_surfx2_eval_quad_node_7_r(fl); 
    fUpwindQuad_r[7] = tensor_4x_p1_surfx2_eval_quad_node_7_r(fc); 
  } else { 
    fUpwindQuad_l[7] = tensor_4x_p1_surfx2_eval_quad_node_7_l(fc); 
    fUpwindQuad_r[7] = tensor_4x_p1_surfx2_eval_quad_node_7_l(fr); 
  } 
