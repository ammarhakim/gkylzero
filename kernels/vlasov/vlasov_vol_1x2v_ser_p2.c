...
GKYL_CU_DH double vlasov_vol_1x2v_ser_p2(const double *w, const double *dxv, const double *qmem, const double *cot_vec, const double *f, double* GKYL_RESTRICT out) 
{ 
  ...
  cflFreq_mid += 5.0*fabs(0.1767766952966368*alpha_vdim[20]-0.1976423537605236*alpha_vdim[27]); 
