...
{ 
  ...
  alpha_mid += fabs(0.1767766952966368*alpha_vdim[0]-0.1976423537605236*alpha_vdim[7]); 
  ...
  alpha_mid += fabs(0.1767766952966368*alpha_vdim[20]-0.1976423537605236*alpha_vdim[27]); 
