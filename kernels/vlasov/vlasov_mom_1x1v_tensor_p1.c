...
{ 
  ...
  out[2] += tempM1i[0]; 
  out[3] += tempM1i[1]; 
  out[4] += (-1.0*tempM0[0]*wx1_sq)+2.0*tempM1i[0]*wx1+0.1178511301977579*f[0]*dv1_sq*volFact; 
  out[5] += (-1.0*tempM0[1]*wx1_sq)+2.0*tempM1i[1]*wx1+0.1178511301977579*f[1]*dv1_sq*volFact; 
} 
