...
GKYL_CU_DH void vlasov_poisson_boundary_surfvx_1x2v_tensor_p2(const double *w, const double *dxv, const double *fac_phi, const double *vecA, const int edge, const double *fEdge, const double *fSkin, double* GKYL_RESTRICT out) 
{ 
  ...
  Ghat[0] += 0.5*(alpha[1]*fUpwind[1]+alpha[0]*fUpwind[0]); 
  Ghat[1] += 0.4472135954999579*alpha[1]*fUpwind[4]+0.5*(alpha[0]*fUpwind[1]+fUpwind[0]*alpha[1]); 
  Ghat[2] += 0.5*(alpha[1]*fUpwind[3]+alpha[0]*fUpwind[2]); 
  Ghat[3] += 0.447213595499958*alpha[1]*fUpwind[6]+0.5*(alpha[0]*fUpwind[3]+alpha[1]*fUpwind[2]); 
  ...
  Ghat[6] += 0.5*alpha[0]*fUpwind[6]+0.447213595499958*alpha[1]*fUpwind[3]; 
  Ghat[7] += 0.447213595499958*alpha[1]*fUpwind[8]+0.5*alpha[0]*fUpwind[7]+0.5000000000000001*alpha[1]*fUpwind[5]; 
  Ghat[8] += 0.5*alpha[0]*fUpwind[8]+0.447213595499958*alpha[1]*fUpwind[7]; 
