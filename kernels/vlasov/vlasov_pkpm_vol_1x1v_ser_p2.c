...
{ 
  ...
  alpha_vdim[4] = dv1par*(((-3.464101615137754*(bxbz[1]*uz[2]+bxby[1]*uy[2]+bxbx[1]*ux[2]))-1.732050807568877*(uz[1]*bxbz[2]+uy[1]*bxby[2]+ux[1]*bxbx[2]))*wvpar+1.732050807568877*(Pxz[1]*bz[2]+Pxy[1]*by[2]+Pxx[1]*bx[2])+3.464101615137754*(bz[1]*Pxz[2]+by[1]*Pxy[2]+bx[1]*Pxx[2])); 
