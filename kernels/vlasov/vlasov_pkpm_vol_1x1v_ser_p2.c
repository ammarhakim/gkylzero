...
GKYL_CU_DH double vlasov_pkpm_vol_1x1v_ser_p2(const double *w, const double *dxv, const double *u_i, const double *div_p, const double *bvar, const double *rho_inv_b, const double *f, double* GKYL_RESTRICT out) 
{ 
  ...
  alpha_vdim[0] = ((-3.872983346207417*bxbz[1]*uz[2])-3.872983346207417*bxby[1]*uy[2]-3.872983346207417*bxbx[1]*ux[2]-1.732050807568877*bxbz[0]*uz[1]-1.732050807568877*bxby[0]*uy[1]-1.732050807568877*bxbx[0]*ux[1])*dv1par*dx0*wvpar+(div_p_z[2]*rho_inv_bz[2]+div_p_y[2]*rho_inv_by[2]+div_p_x[2]*rho_inv_bx[2]+div_p_z[1]*rho_inv_bz[1]+div_p_y[1]*rho_inv_by[1]+div_p_x[1]*rho_inv_bx[1]+div_p_z[0]*rho_inv_bz[0]+div_p_y[0]*rho_inv_by[0]+div_p_x[0]*rho_inv_bx[0])*dv1par; 
  alpha_vdim[1] = ((-3.464101615137754*bxbz[2]*uz[2])-3.872983346207417*bxbz[0]*uz[2]-3.464101615137754*bxby[2]*uy[2]-3.872983346207417*bxby[0]*uy[2]-3.464101615137754*bxbx[2]*ux[2]-3.872983346207417*bxbx[0]*ux[2]-1.732050807568877*bxbz[1]*uz[1]-1.732050807568877*bxby[1]*uy[1]-1.732050807568877*bxbx[1]*ux[1])*dv1par*dx0*wvpar+(0.8944271909999159*div_p_z[1]*rho_inv_bz[2]+0.8944271909999159*div_p_y[1]*rho_inv_by[2]+0.8944271909999159*div_p_x[1]*rho_inv_bx[2]+0.8944271909999159*rho_inv_bz[1]*div_p_z[2]+0.8944271909999159*rho_inv_by[1]*div_p_y[2]+0.8944271909999159*rho_inv_bx[1]*div_p_x[2]+div_p_z[0]*rho_inv_bz[1]+div_p_y[0]*rho_inv_by[1]+div_p_x[0]*rho_inv_bx[1]+rho_inv_bz[0]*div_p_z[1]+rho_inv_by[0]*div_p_y[1]+rho_inv_bx[0]*div_p_x[1])*dv1par; 
