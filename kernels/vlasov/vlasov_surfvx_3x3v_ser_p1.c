...
{ 
  ...
  out[64] += (1.58113883008419*Ghat_l[0]-1.58113883008419*Ghat_r[0])*dv10; 
  out[65] += (1.58113883008419*Ghat_l[1]-1.58113883008419*Ghat_r[1])*dv10; 
  out[66] += (1.58113883008419*Ghat_l[2]-1.58113883008419*Ghat_r[2])*dv10; 
  out[67] += (1.58113883008419*Ghat_l[3]-1.58113883008419*Ghat_r[3])*dv10; 
  out[68] += (1.58113883008419*Ghat_l[4]-1.58113883008419*Ghat_r[4])*dv10; 
  out[69] += (1.58113883008419*Ghat_l[5]-1.58113883008419*Ghat_r[5])*dv10; 
  out[70] += (1.58113883008419*Ghat_l[6]-1.58113883008419*Ghat_r[6])*dv10; 
  out[71] += (1.58113883008419*Ghat_l[7]-1.58113883008419*Ghat_r[7])*dv10; 
  ...
  out[74] += (1.58113883008419*Ghat_l[10]-1.58113883008419*Ghat_r[10])*dv10; 
  out[75] += (1.58113883008419*Ghat_l[11]-1.58113883008419*Ghat_r[11])*dv10; 
  out[76] += (1.58113883008419*Ghat_l[12]-1.58113883008419*Ghat_r[12])*dv10; 
  out[77] += (1.58113883008419*Ghat_l[13]-1.58113883008419*Ghat_r[13])*dv10; 
  out[78] += (1.58113883008419*Ghat_l[14]-1.58113883008419*Ghat_r[14])*dv10; 
  out[79] += (1.58113883008419*Ghat_l[15]-1.58113883008419*Ghat_r[15])*dv10; 
  out[80] += (1.58113883008419*Ghat_l[16]-1.58113883008419*Ghat_r[16])*dv10; 
  out[81] += (1.58113883008419*Ghat_l[17]-1.58113883008419*Ghat_r[17])*dv10; 
  out[82] += (1.58113883008419*Ghat_l[18]-1.58113883008419*Ghat_r[18])*dv10; 
  out[83] += (1.58113883008419*Ghat_l[19]-1.58113883008419*Ghat_r[19])*dv10; 
  out[84] += (1.58113883008419*Ghat_l[20]-1.58113883008419*Ghat_r[20])*dv10; 
  out[85] += (1.58113883008419*Ghat_l[21]-1.58113883008419*Ghat_r[21])*dv10; 
  out[86] += (1.58113883008419*Ghat_l[22]-1.58113883008419*Ghat_r[22])*dv10; 
  out[87] += (1.58113883008419*Ghat_l[23]-1.58113883008419*Ghat_r[23])*dv10; 
  out[88] += (1.58113883008419*Ghat_l[24]-1.58113883008419*Ghat_r[24])*dv10; 
  out[89] += (1.58113883008419*Ghat_l[25]-1.58113883008419*Ghat_r[25])*dv10; 
  out[90] += (1.58113883008419*Ghat_l[26]-1.58113883008419*Ghat_r[26])*dv10; 
  out[91] += (1.58113883008419*Ghat_l[27]-1.58113883008419*Ghat_r[27])*dv10; 
  out[92] += (1.58113883008419*Ghat_l[28]-1.58113883008419*Ghat_r[28])*dv10; 
  out[93] += (1.58113883008419*Ghat_l[29]-1.58113883008419*Ghat_r[29])*dv10; 
  out[94] += (1.58113883008419*Ghat_l[30]-1.58113883008419*Ghat_r[30])*dv10; 
  out[95] += (1.58113883008419*Ghat_l[31]-1.58113883008419*Ghat_r[31])*dv10; 
  out[96] += (0.7071067811865475*Ghat_l[32]-0.7071067811865475*Ghat_r[32])*dv10; 
  out[97] += (0.7071067811865475*Ghat_l[33]-0.7071067811865475*Ghat_r[33])*dv10; 
  out[98] += (0.7071067811865475*Ghat_l[34]-0.7071067811865475*Ghat_r[34])*dv10; 
  out[99] += (0.7071067811865475*Ghat_l[35]-0.7071067811865475*Ghat_r[35])*dv10; 
  out[100] += -1.224744871391589*(Ghat_r[32]+Ghat_l[32])*dv10; 
  out[101] += (0.7071067811865475*Ghat_l[36]-0.7071067811865475*Ghat_r[36])*dv10; 
  out[102] += (0.7071067811865475*Ghat_l[37]-0.7071067811865475*Ghat_r[37])*dv10; 
  out[103] += (0.7071067811865475*Ghat_l[38]-0.7071067811865475*Ghat_r[38])*dv10; 
  out[104] += (0.7071067811865475*Ghat_l[39]-0.7071067811865475*Ghat_r[39])*dv10; 
  out[105] += -1.224744871391589*(Ghat_r[33]+Ghat_l[33])*dv10; 
  out[106] += -1.224744871391589*(Ghat_r[34]+Ghat_l[34])*dv10; 
  out[107] += -1.224744871391589*(Ghat_r[35]+Ghat_l[35])*dv10; 
  out[108] += (0.7071067811865475*Ghat_l[40]-0.7071067811865475*Ghat_r[40])*dv10; 
  out[109] += (0.7071067811865475*Ghat_l[41]-0.7071067811865475*Ghat_r[41])*dv10; 
  out[110] += (0.7071067811865475*Ghat_l[42]-0.7071067811865475*Ghat_r[42])*dv10; 
  out[111] += -1.224744871391589*(Ghat_r[36]+Ghat_l[36])*dv10; 
  out[112] += (0.7071067811865475*Ghat_l[43]-0.7071067811865475*Ghat_r[43])*dv10; 
  out[113] += -1.224744871391589*(Ghat_r[37]+Ghat_l[37])*dv10; 
  out[114] += -1.224744871391589*(Ghat_r[38]+Ghat_l[38])*dv10; 
  out[115] += -1.224744871391589*(Ghat_r[39]+Ghat_l[39])*dv10; 
  out[116] += (0.7071067811865475*Ghat_l[44]-0.7071067811865475*Ghat_r[44])*dv10; 
  out[117] += (0.7071067811865475*Ghat_l[45]-0.7071067811865475*Ghat_r[45])*dv10; 
  out[118] += (0.7071067811865475*Ghat_l[46]-0.7071067811865475*Ghat_r[46])*dv10; 
  out[119] += -1.224744871391589*(Ghat_r[40]+Ghat_l[40])*dv10; 
  out[120] += -1.224744871391589*(Ghat_r[41]+Ghat_l[41])*dv10; 
  out[121] += -1.224744871391589*(Ghat_r[42]+Ghat_l[42])*dv10; 
  out[122] += -1.224744871391589*(Ghat_r[43]+Ghat_l[43])*dv10; 
  out[123] += (0.7071067811865475*Ghat_l[47]-0.7071067811865475*Ghat_r[47])*dv10; 
  out[124] += -1.224744871391589*(Ghat_r[44]+Ghat_l[44])*dv10; 
  out[125] += -1.224744871391589*(Ghat_r[45]+Ghat_l[45])*dv10; 
  out[126] += -1.224744871391589*(Ghat_r[46]+Ghat_l[46])*dv10; 
  out[127] += -1.224744871391589*(Ghat_r[47]+Ghat_l[47])*dv10; 
  out[128] += (0.7071067811865475*Ghat_l[48]-0.7071067811865475*Ghat_r[48])*dv10; 
  out[129] += (0.7071067811865475*Ghat_l[49]-0.7071067811865475*Ghat_r[49])*dv10; 
  out[130] += (0.7071067811865475*Ghat_l[50]-0.7071067811865475*Ghat_r[50])*dv10; 
  out[131] += (0.7071067811865475*Ghat_l[51]-0.7071067811865475*Ghat_r[51])*dv10; 
  out[132] += -1.224744871391589*(Ghat_r[48]+Ghat_l[48])*dv10; 
  out[133] += (0.7071067811865475*Ghat_l[52]-0.7071067811865475*Ghat_r[52])*dv10; 
  out[134] += (0.7071067811865475*Ghat_l[53]-0.7071067811865475*Ghat_r[53])*dv10; 
  out[135] += (0.7071067811865475*Ghat_l[54]-0.7071067811865475*Ghat_r[54])*dv10; 
  out[136] += (0.7071067811865475*Ghat_l[55]-0.7071067811865475*Ghat_r[55])*dv10; 
  out[137] += -1.224744871391589*(Ghat_r[49]+Ghat_l[49])*dv10; 
  out[138] += -1.224744871391589*(Ghat_r[50]+Ghat_l[50])*dv10; 
  out[139] += -1.224744871391589*(Ghat_r[51]+Ghat_l[51])*dv10; 
  out[140] += (0.7071067811865475*Ghat_l[56]-0.7071067811865475*Ghat_r[56])*dv10; 
  out[141] += (0.7071067811865475*Ghat_l[57]-0.7071067811865475*Ghat_r[57])*dv10; 
  out[142] += (0.7071067811865475*Ghat_l[58]-0.7071067811865475*Ghat_r[58])*dv10; 
  out[143] += -1.224744871391589*(Ghat_r[52]+Ghat_l[52])*dv10; 
  out[144] += (0.7071067811865475*Ghat_l[59]-0.7071067811865475*Ghat_r[59])*dv10; 
  out[145] += -1.224744871391589*(Ghat_r[53]+Ghat_l[53])*dv10; 
  out[146] += -1.224744871391589*(Ghat_r[54]+Ghat_l[54])*dv10; 
  out[147] += -1.224744871391589*(Ghat_r[55]+Ghat_l[55])*dv10; 
  out[148] += (0.7071067811865475*Ghat_l[60]-0.7071067811865475*Ghat_r[60])*dv10; 
  out[149] += (0.7071067811865475*Ghat_l[61]-0.7071067811865475*Ghat_r[61])*dv10; 
  out[150] += (0.7071067811865475*Ghat_l[62]-0.7071067811865475*Ghat_r[62])*dv10; 
  out[151] += -1.224744871391589*(Ghat_r[56]+Ghat_l[56])*dv10; 
  out[152] += -1.224744871391589*(Ghat_r[57]+Ghat_l[57])*dv10; 
  out[153] += -1.224744871391589*(Ghat_r[58]+Ghat_l[58])*dv10; 
  out[154] += -1.224744871391589*(Ghat_r[59]+Ghat_l[59])*dv10; 
  out[155] += (0.7071067811865475*Ghat_l[63]-0.7071067811865475*Ghat_r[63])*dv10; 
  out[156] += -1.224744871391589*(Ghat_r[60]+Ghat_l[60])*dv10; 
  out[157] += -1.224744871391589*(Ghat_r[61]+Ghat_l[61])*dv10; 
  out[158] += -1.224744871391589*(Ghat_r[62]+Ghat_l[62])*dv10; 
  out[159] += -1.224744871391589*(Ghat_r[63]+Ghat_l[63])*dv10; 
