...
{ 
  ...
  Ghat[8] = 0.02357022603955158*(15.0*alpha[2]*fUpwind[10]+15.0*alpha[0]*fUpwind[8]); 
  Ghat[9] = 0.02357022603955158*(15.0*alpha[2]*fUpwind[11]+15.0*alpha[0]*fUpwind[9]); 
  Ghat[10] = 0.02357022603955158*(15.0*alpha[0]*fUpwind[10]+15.0*alpha[2]*fUpwind[8]); 
  Ghat[11] = 0.02357022603955158*(15.0*alpha[0]*fUpwind[11]+15.0*alpha[2]*fUpwind[9]); 
