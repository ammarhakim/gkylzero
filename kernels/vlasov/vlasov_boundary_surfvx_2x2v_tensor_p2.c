...
GKYL_CU_DH void vlasov_boundary_surfvx_2x2v_tensor_p2(const double *w, const double *dxv, const double *qmem, const int edge, const double *fEdge, const double *fSkin, double* GKYL_RESTRICT out) 
{ 
  ...
  alpha[20] = 1.414213562373095*(B2[8]*wv2+E0[8]); 
  alpha[23] = 0.408248290463863*B2[8]*dv2; 
