...
{ 
  ...
  if (0.5*alpha[3]-0.5*(alpha[2]+alpha[1])+0.5*alpha[0] > 0) { 
    fUpwindQuad_l[0] = tensor_3x_p1_surfx2_eval_quad_node_0_r(fl); 
    fUpwindQuad_r[0] = tensor_3x_p1_surfx2_eval_quad_node_0_r(fc); 
  } else { 
    fUpwindQuad_l[0] = tensor_3x_p1_surfx2_eval_quad_node_0_l(fc); 
    fUpwindQuad_r[0] = tensor_3x_p1_surfx2_eval_quad_node_0_l(fr); 
  } 
  if ((-0.5*alpha[3])+0.5*alpha[2]-0.5*alpha[1]+0.5*alpha[0] > 0) { 
    fUpwindQuad_l[1] = tensor_3x_p1_surfx2_eval_quad_node_1_r(fl); 
    fUpwindQuad_r[1] = tensor_3x_p1_surfx2_eval_quad_node_1_r(fc); 
  } else { 
    fUpwindQuad_l[1] = tensor_3x_p1_surfx2_eval_quad_node_1_l(fc); 
    fUpwindQuad_r[1] = tensor_3x_p1_surfx2_eval_quad_node_1_l(fr); 
  } 
  if (0.5*(alpha[1]+alpha[0])-0.5*(alpha[3]+alpha[2]) > 0) { 
    fUpwindQuad_l[2] = tensor_3x_p1_surfx2_eval_quad_node_2_r(fl); 
    fUpwindQuad_r[2] = tensor_3x_p1_surfx2_eval_quad_node_2_r(fc); 
  } else { 
    fUpwindQuad_l[2] = tensor_3x_p1_surfx2_eval_quad_node_2_l(fc); 
    fUpwindQuad_r[2] = tensor_3x_p1_surfx2_eval_quad_node_2_l(fr); 
  } 
  if (0.5*(alpha[3]+alpha[2]+alpha[1]+alpha[0]) > 0) { 
    fUpwindQuad_l[3] = tensor_3x_p1_surfx2_eval_quad_node_3_r(fl); 
    fUpwindQuad_r[3] = tensor_3x_p1_surfx2_eval_quad_node_3_r(fc); 
  } else { 
    fUpwindQuad_l[3] = tensor_3x_p1_surfx2_eval_quad_node_3_l(fc); 
    fUpwindQuad_r[3] = tensor_3x_p1_surfx2_eval_quad_node_3_l(fr); 
  } 
