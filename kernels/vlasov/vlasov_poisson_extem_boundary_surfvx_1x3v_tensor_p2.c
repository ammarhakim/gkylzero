...
GKYL_CU_DH void vlasov_poisson_extem_boundary_surfvx_1x3v_tensor_p2(const double *w, const double *dxv, const double *fac_phi, const double *vecA, const int edge, const double *fEdge, const double *fSkin, double* GKYL_RESTRICT out) 
{ 
  ...
  Ghat[4] += 0.2828427124746191*alpha[4]*fUpwind[20]+0.3162277660168379*alpha[5]*fUpwind[17]+0.3162277660168379*(alpha[2]*fUpwind[12]+alpha[1]*fUpwind[11])+0.3535533905932737*alpha[3]*fUpwind[10]+0.3162277660168379*alpha[4]*(fUpwind[8]+fUpwind[7])+0.3535533905932737*(alpha[5]*fUpwind[6]+alpha[0]*fUpwind[4]+fUpwind[0]*alpha[4]+alpha[1]*fUpwind[2]+fUpwind[1]*alpha[2]); 
  Ghat[5] += 0.2828427124746191*alpha[5]*fUpwind[21]+0.3162277660168379*alpha[4]*fUpwind[17]+0.3162277660168379*(alpha[3]*fUpwind[15]+alpha[1]*fUpwind[13])+0.3535533905932737*alpha[2]*fUpwind[10]+0.3162277660168379*alpha[5]*(fUpwind[9]+fUpwind[7])+0.3535533905932737*(alpha[4]*fUpwind[6]+alpha[0]*fUpwind[5]+fUpwind[0]*alpha[5]+alpha[1]*fUpwind[3]+fUpwind[1]*alpha[3]); 
  ...
  Ghat[10] += 0.2828427124746191*(alpha[5]*fUpwind[24]+alpha[4]*fUpwind[23])+0.3162277660168379*(alpha[3]*fUpwind[19]+alpha[2]*fUpwind[18]+alpha[1]*fUpwind[17])+0.3162277660168379*(alpha[5]*fUpwind[16]+alpha[4]*(fUpwind[14]+fUpwind[13])+alpha[5]*fUpwind[11])+0.3535533905932737*(alpha[0]*fUpwind[10]+alpha[1]*fUpwind[6]+alpha[2]*fUpwind[5]+fUpwind[2]*alpha[5]+alpha[3]*fUpwind[4]+fUpwind[3]*alpha[4]); 
  Ghat[11] += 0.3162277660168379*alpha[2]*fUpwind[20]+0.3535533905932737*alpha[3]*fUpwind[17]+0.2828427124746191*alpha[4]*fUpwind[12]+0.3535533905932737*alpha[0]*fUpwind[11]+0.3162277660168379*alpha[5]*fUpwind[10]+0.3535533905932737*alpha[2]*fUpwind[7]+0.3162277660168379*(alpha[1]*fUpwind[4]+fUpwind[1]*alpha[4]); 
  Ghat[12] += 0.3162277660168379*(alpha[5]*fUpwind[23]+alpha[1]*fUpwind[20])+0.3535533905932737*(alpha[3]*fUpwind[18]+alpha[5]*fUpwind[14]+alpha[0]*fUpwind[12])+0.2828427124746191*alpha[4]*fUpwind[11]+0.3535533905932737*alpha[1]*fUpwind[8]+0.3162277660168379*(alpha[2]*fUpwind[4]+fUpwind[2]*alpha[4]); 
  Ghat[13] += 0.3162277660168379*alpha[3]*fUpwind[21]+0.3535533905932737*alpha[2]*fUpwind[17]+0.2828427124746191*alpha[5]*fUpwind[15]+0.3535533905932737*alpha[0]*fUpwind[13]+0.3162277660168379*alpha[4]*fUpwind[10]+0.3535533905932737*alpha[3]*fUpwind[7]+0.3162277660168379*(alpha[1]*fUpwind[5]+fUpwind[1]*alpha[5]); 
  Ghat[14] += 0.3162277660168379*(alpha[5]*fUpwind[25]+alpha[3]*fUpwind[22])+0.3535533905932737*(alpha[1]*fUpwind[18]+alpha[0]*fUpwind[14]+alpha[5]*fUpwind[12])+0.3162277660168379*alpha[4]*fUpwind[10]+0.3535533905932737*alpha[3]*fUpwind[8]+0.3162277660168379*alpha[2]*fUpwind[6]; 
  Ghat[15] += 0.3162277660168379*(alpha[4]*fUpwind[24]+alpha[1]*fUpwind[21])+0.3535533905932737*(alpha[2]*fUpwind[19]+alpha[4]*fUpwind[16]+alpha[0]*fUpwind[15])+0.2828427124746191*alpha[5]*fUpwind[13]+0.3535533905932737*alpha[1]*fUpwind[9]+0.3162277660168379*(alpha[3]*fUpwind[5]+fUpwind[3]*alpha[5]); 
  Ghat[16] += 0.3162277660168379*(alpha[4]*fUpwind[25]+alpha[2]*fUpwind[22])+0.3535533905932737*(alpha[1]*fUpwind[19]+alpha[0]*fUpwind[16]+alpha[4]*fUpwind[15])+0.3162277660168379*alpha[5]*fUpwind[10]+0.3535533905932737*alpha[2]*fUpwind[9]+0.3162277660168379*alpha[3]*fUpwind[6]; 
  Ghat[17] += 0.3162277660168379*(alpha[3]*fUpwind[24]+alpha[2]*fUpwind[23])+0.2828427124746191*(alpha[5]*fUpwind[19]+alpha[4]*fUpwind[18])+0.3535533905932737*(alpha[0]*fUpwind[17]+alpha[2]*fUpwind[13]+alpha[3]*fUpwind[11])+0.3162277660168379*(alpha[1]*fUpwind[10]+alpha[4]*fUpwind[5]+fUpwind[4]*alpha[5]); 
  Ghat[18] += 0.2828427124746191*alpha[5]*fUpwind[26]+0.3162277660168379*(alpha[3]*fUpwind[25]+alpha[1]*fUpwind[23]+alpha[5]*(fUpwind[22]+fUpwind[20]))+0.3535533905932737*alpha[0]*fUpwind[18]+0.2828427124746191*alpha[4]*fUpwind[17]+0.3535533905932737*(alpha[1]*fUpwind[14]+alpha[3]*fUpwind[12])+0.3162277660168379*alpha[2]*fUpwind[10]+0.3535533905932737*alpha[5]*fUpwind[8]+0.3162277660168379*alpha[4]*fUpwind[6]; 
  Ghat[19] += 0.2828427124746191*alpha[4]*fUpwind[26]+0.3162277660168379*(alpha[2]*fUpwind[25]+alpha[1]*fUpwind[24]+alpha[4]*(fUpwind[22]+fUpwind[21]))+0.3535533905932737*alpha[0]*fUpwind[19]+0.2828427124746191*alpha[5]*fUpwind[17]+0.3535533905932737*(alpha[1]*fUpwind[16]+alpha[2]*fUpwind[15])+0.3162277660168379*alpha[3]*fUpwind[10]+0.3535533905932737*alpha[4]*fUpwind[9]+0.3162277660168379*alpha[5]*fUpwind[6]; 
  Ghat[20] += 0.3535533905932737*(alpha[3]*fUpwind[23]+alpha[0]*fUpwind[20])+0.3162277660168379*alpha[5]*fUpwind[18]+0.3162277660168379*(alpha[1]*fUpwind[12]+alpha[2]*fUpwind[11])+0.2828427124746191*alpha[4]*fUpwind[4]; 
  Ghat[21] += 0.3535533905932737*(alpha[2]*fUpwind[24]+alpha[0]*fUpwind[21])+0.3162277660168379*alpha[4]*fUpwind[19]+0.3162277660168379*(alpha[1]*fUpwind[15]+alpha[3]*fUpwind[13])+0.2828427124746191*alpha[5]*fUpwind[5]; 
  Ghat[22] += 0.3535533905932737*(alpha[1]*fUpwind[25]+alpha[0]*fUpwind[22])+0.3162277660168379*(alpha[4]*fUpwind[19]+alpha[5]*fUpwind[18])+0.3162277660168379*(alpha[2]*fUpwind[16]+alpha[3]*fUpwind[14]); 
  Ghat[23] += 0.3162277660168379*alpha[3]*fUpwind[26]+0.2828427124746191*alpha[5]*fUpwind[25]+0.3535533905932737*(alpha[0]*fUpwind[23]+alpha[3]*fUpwind[20])+0.3162277660168379*(alpha[1]*fUpwind[18]+alpha[2]*fUpwind[17])+0.3162277660168379*alpha[5]*fUpwind[12]+0.2828427124746191*alpha[4]*fUpwind[10]; 
  Ghat[24] += 0.3162277660168379*alpha[2]*fUpwind[26]+0.2828427124746191*alpha[4]*fUpwind[25]+0.3535533905932737*(alpha[0]*fUpwind[24]+alpha[2]*fUpwind[21])+0.3162277660168379*(alpha[1]*fUpwind[19]+alpha[3]*fUpwind[17])+0.3162277660168379*alpha[4]*fUpwind[15]+0.2828427124746191*alpha[5]*fUpwind[10]; 
  Ghat[25] += 0.3162277660168379*alpha[1]*fUpwind[26]+0.3535533905932737*alpha[0]*fUpwind[25]+0.2828427124746191*(alpha[4]*fUpwind[24]+alpha[5]*fUpwind[23])+0.3535533905932737*alpha[1]*fUpwind[22]+0.3162277660168379*(alpha[2]*fUpwind[19]+alpha[3]*fUpwind[18])+0.3162277660168379*(alpha[4]*fUpwind[16]+alpha[5]*fUpwind[14]); 
  Ghat[26] += 0.3535533905932737*alpha[0]*fUpwind[26]+0.3162277660168379*(alpha[1]*fUpwind[25]+alpha[2]*fUpwind[24]+alpha[3]*fUpwind[23])+0.2828427124746191*(alpha[4]*fUpwind[19]+alpha[5]*fUpwind[18]); 
