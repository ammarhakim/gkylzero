...
{ 
  ...
  if (0.6363961030678926*(alpha[5]+alpha[4])-0.4743416490252567*(alpha[3]+alpha[2]+alpha[1])+0.3535533905932737*alpha[0] > 0) { 
  ...
  if ((-0.6363961030678926*alpha[5])+0.6363961030678926*alpha[4]+0.4743416490252567*alpha[3]-0.4743416490252567*(alpha[2]+alpha[1])+0.3535533905932737*alpha[0] > 0) { 
    fUpwindQuad[2] = ser_4x_p2_surfx2_eval_quad_node_2_r(fSkin); 
  } else { 
    fUpwindQuad[2] = ser_4x_p2_surfx2_eval_quad_node_2_l(fEdge); 
  } 
  if (0.6363961030678926*alpha[5]-0.4743416490252567*(alpha[3]+alpha[1])+0.3535533905932737*alpha[0] > 0) { 
  ...
  if ((-0.6363961030678926*alpha[5])+0.4743416490252567*alpha[3]-0.4743416490252567*alpha[1]+0.3535533905932737*alpha[0] > 0) { 
    fUpwindQuad[5] = ser_4x_p2_surfx2_eval_quad_node_5_r(fSkin); 
  } else { 
    fUpwindQuad[5] = ser_4x_p2_surfx2_eval_quad_node_5_l(fEdge); 
  } 
  if (0.6363961030678926*alpha[5]-0.6363961030678926*alpha[4]-0.4743416490252567*alpha[3]+0.4743416490252567*alpha[2]-0.4743416490252567*alpha[1]+0.3535533905932737*alpha[0] > 0) { 
  ...
  if ((-0.6363961030678926*(alpha[5]+alpha[4]))+0.4743416490252567*(alpha[3]+alpha[2])-0.4743416490252567*alpha[1]+0.3535533905932737*alpha[0] > 0) { 
    fUpwindQuad[8] = ser_4x_p2_surfx2_eval_quad_node_8_r(fSkin); 
  } else { 
    fUpwindQuad[8] = ser_4x_p2_surfx2_eval_quad_node_8_l(fEdge); 
  } 
  if (0.3535533905932737*alpha[0]-0.4743416490252567*(alpha[3]+alpha[2]) > 0) { 
  ...
  if (0.4743416490252567*alpha[3]-0.4743416490252567*alpha[2]+0.3535533905932737*alpha[0] > 0) { 
    fUpwindQuad[11] = ser_4x_p2_surfx2_eval_quad_node_11_r(fSkin); 
  } else { 
    fUpwindQuad[11] = ser_4x_p2_surfx2_eval_quad_node_11_l(fEdge); 
  } 
  if (0.3535533905932737*alpha[0]-0.4743416490252567*alpha[3] > 0) { 
  ...
  if (0.4743416490252567*alpha[3]+0.3535533905932737*alpha[0] > 0) { 
  ...
  if (0.4743416490252567*(alpha[3]+alpha[2])+0.3535533905932737*alpha[0] > 0) { 
