...
GKYL_CU_DH double vlasov_stream_vol_1x2v_tensor_p2(const double *w, const double *dxv, const double *qmem, const double *cot_vec, const double *f, double* GKYL_RESTRICT out) 
{ 
  // w[NDIM]:   Cell-center coordinates.
  // dxv[NDIM]: Cell spacing.
  // qmem:      q/m*EM fields (unused in streaming-only update).
  // cot_vec:   cotangent vectors (only used in gen geo update).
  ...
  out[19] += 3.464101615137755*f[16]*w1Ddx0+(0.8944271909999159*f[22]+f[9])*dv1Ddx0; 
  out[20] += 7.745966692414834*f[12]*w1Ddx0+2.0*f[4]*dv1Ddx0; 
  out[21] += 7.745966692414834*f[15]*w1Ddx0+2.23606797749979*f[19]*dv1Ddx0; 
  out[23] += 7.745966692414834*f[18]*w1Ddx0+2.0*f[10]*dv1Ddx0; 
  out[24] += 7.745966692414834*f[19]*w1Ddx0+(2.0*f[25]+2.23606797749979*f[15])*dv1Ddx0; 
