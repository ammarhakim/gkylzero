...
{ 
  ...
  out[4] += tempM1i[1]; 
  out[5] += tempM1i[2]; 
  out[6] += (-1.0*tempM0[0]*wx1_sq)+2.0*tempM1i[0]*wx1+(0.105409255338946*f[5]*dv1_sq+0.1178511301977579*f[0]*dv1_sq)*volFact; 
  out[7] += (-1.0*tempM0[1]*wx1_sq)+2.0*tempM1i[1]*wx1+(0.105409255338946*f[7]*dv1_sq+0.1178511301977579*f[1]*dv1_sq)*volFact; 
  out[8] += (-1.0*tempM0[2]*wx1_sq)+2.0*tempM1i[2]*wx1+(0.105409255338946*f[8]*dv1_sq+0.1178511301977579*f[4]*dv1_sq)*volFact; 
} 
