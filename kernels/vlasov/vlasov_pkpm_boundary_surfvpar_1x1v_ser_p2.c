...
{ 
  ...
  const double *G_1_sourceSkin = &g_dist_sourceSkin[8]; 
  const double *F_0_sourceEdge = &g_dist_sourceEdge[0]; 
  const double *G_1_sourceEdge = &g_dist_sourceEdge[8]; 
  ...
  double alphaSurf_F_0[3] = {0.0}; 
  double alphaSurf_G_1[3] = {0.0}; 
  ...
  if (0.6324555320336759*alphaSurf_F_0[2]-0.9486832980505137*alphaSurf_F_0[1]+0.7071067811865475*alphaSurf_F_0[0] > 0) { 
    F_0_UpwindQuad[0] = ser_2x_p2_surfx2_eval_quad_node_0_r(F_0Skin); 
  } else { 
    F_0_UpwindQuad[0] = ser_2x_p2_surfx2_eval_quad_node_0_l(F_0Edge); 
  } 
  if (0.7071067811865475*alphaSurf_F_0[0]-0.7905694150420947*alphaSurf_F_0[2] > 0) { 
  ...
  if (0.6324555320336759*alphaSurf_G_1[2]-0.9486832980505137*alphaSurf_G_1[1]+0.7071067811865475*alphaSurf_G_1[0] > 0) { 
    G_1_UpwindQuad[0] = ser_2x_p2_surfx2_eval_quad_node_0_r(G_1Skin); 
  } else { 
    G_1_UpwindQuad[0] = ser_2x_p2_surfx2_eval_quad_node_0_l(G_1Edge); 
  } 
  if (0.7071067811865475*alphaSurf_G_1[0]-0.7905694150420947*alphaSurf_G_1[2] > 0) { 
  ...
  Ghat_F_0[0] = 0.7071067811865475*F_0_Upwind[2]*alphaSurf_F_0[2]+0.7071067811865475*F_0_Upwind[1]*alphaSurf_F_0[1]+0.7071067811865475*F_0_Upwind[0]*alphaSurf_F_0[0]; 
  Ghat_F_0[1] = 0.6324555320336759*F_0_Upwind[1]*alphaSurf_F_0[2]+0.6324555320336759*alphaSurf_F_0[1]*F_0_Upwind[2]+0.7071067811865475*F_0_Upwind[0]*alphaSurf_F_0[1]+0.7071067811865475*alphaSurf_F_0[0]*F_0_Upwind[1]; 
  Ghat_F_0[2] = 0.4517539514526256*F_0_Upwind[2]*alphaSurf_F_0[2]+0.7071067811865475*F_0_Upwind[0]*alphaSurf_F_0[2]+0.7071067811865475*alphaSurf_F_0[0]*F_0_Upwind[2]+0.6324555320336759*F_0_Upwind[1]*alphaSurf_F_0[1]; 
  Ghat_G_1[0] = 0.7071067811865475*G_1_Upwind[2]*alphaSurf_G_1[2]+0.7071067811865475*G_1_Upwind[1]*alphaSurf_G_1[1]+0.7071067811865475*G_1_Upwind[0]*alphaSurf_G_1[0]; 
  Ghat_G_1[1] = 0.6324555320336759*G_1_Upwind[1]*alphaSurf_G_1[2]+0.6324555320336759*alphaSurf_G_1[1]*G_1_Upwind[2]+0.7071067811865475*G_1_Upwind[0]*alphaSurf_G_1[1]+0.7071067811865475*alphaSurf_G_1[0]*G_1_Upwind[1]; 
  Ghat_G_1[2] = 0.4517539514526256*G_1_Upwind[2]*alphaSurf_G_1[2]+0.7071067811865475*G_1_Upwind[0]*alphaSurf_G_1[2]+0.7071067811865475*alphaSurf_G_1[0]*G_1_Upwind[2]+0.6324555320336759*G_1_Upwind[1]*alphaSurf_G_1[1]; 
  ...
  out_F_0[2] += 1.224744871391589*Ghat_F_0_div_b[0]*dv1par-1.224744871391589*Ghat_F_0[0]*dv1par; 
  out_F_0[3] += 1.224744871391589*Ghat_F_0_div_b[1]*dv1par-1.224744871391589*Ghat_F_0[1]*dv1par; 
  out_F_0[4] += 0.7071067811865475*Ghat_F_0[2]*dv1par-0.7071067811865475*Ghat_F_0_div_b[2]*dv1par; 
  out_F_0[5] += 1.58113883008419*Ghat_F_0[0]*dv1par-1.58113883008419*Ghat_F_0_div_b[0]*dv1par; 
  out_F_0[6] += 1.224744871391589*Ghat_F_0_div_b[2]*dv1par-1.224744871391589*Ghat_F_0[2]*dv1par; 
  out_F_0[7] += 1.58113883008419*Ghat_F_0[1]*dv1par-1.58113883008419*Ghat_F_0_div_b[1]*dv1par; 
  ...
  out_G_1[2] += 1.224744871391589*Ghat_G_1_div_b[0]*dv1par-1.224744871391589*Ghat_G_1[0]*dv1par; 
  out_G_1[3] += 1.224744871391589*Ghat_G_1_div_b[1]*dv1par-1.224744871391589*Ghat_G_1[1]*dv1par; 
  out_G_1[4] += 0.7071067811865475*Ghat_G_1[2]*dv1par-0.7071067811865475*Ghat_G_1_div_b[2]*dv1par; 
  out_G_1[5] += 1.58113883008419*Ghat_G_1[0]*dv1par-1.58113883008419*Ghat_G_1_div_b[0]*dv1par; 
  out_G_1[6] += 1.224744871391589*Ghat_G_1_div_b[2]*dv1par-1.224744871391589*Ghat_G_1[2]*dv1par; 
  out_G_1[7] += 1.58113883008419*Ghat_G_1[1]*dv1par-1.58113883008419*Ghat_G_1_div_b[1]*dv1par; 
