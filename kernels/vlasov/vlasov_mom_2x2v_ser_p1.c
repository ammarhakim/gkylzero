...
{ 
  ...
  out[4] += volFact*(2.0*f[0]*wx1_sq*wx2+1.154700538379252*f[3]*dv1*wx1*wx2+0.1666666666666667*f[0]*dv1_sq*wx2+0.5773502691896258*f[4]*dv2*wx1_sq+0.3333333333333333*f[10]*dv1*dv2*wx1+0.04811252243246882*f[4]*dv1_sq*dv2); 
  out[5] += volFact*(2.0*f[1]*wx1_sq*wx2+1.154700538379252*f[6]*dv1*wx1*wx2+0.1666666666666667*f[1]*dv1_sq*wx2+0.5773502691896258*f[8]*dv2*wx1_sq+0.3333333333333333*f[13]*dv1*dv2*wx1+0.04811252243246882*f[8]*dv1_sq*dv2); 
  out[6] += volFact*(2.0*f[2]*wx1_sq*wx2+1.154700538379252*f[7]*dv1*wx1*wx2+0.1666666666666667*f[2]*dv1_sq*wx2+0.5773502691896258*f[9]*dv2*wx1_sq+0.3333333333333333*f[14]*dv1*dv2*wx1+0.04811252243246882*f[9]*dv1_sq*dv2); 
  out[7] += volFact*(2.0*f[5]*wx1_sq*wx2+1.154700538379252*f[11]*dv1*wx1*wx2+0.1666666666666667*f[5]*dv1_sq*wx2+0.5773502691896258*f[12]*dv2*wx1_sq+0.3333333333333333*f[15]*dv1*dv2*wx1+0.04811252243246882*f[12]*dv1_sq*dv2); 
  out[8] += volFact*(2.0*f[0]*wx1*wx2_sq+0.5773502691896258*f[3]*dv1*wx2_sq+1.154700538379252*f[4]*dv2*wx1*wx2+0.3333333333333333*f[10]*dv1*dv2*wx2+0.1666666666666667*f[0]*dv2_sq*wx1+0.04811252243246882*f[3]*dv1*dv2_sq); 
  out[9] += volFact*(2.0*f[1]*wx1*wx2_sq+0.5773502691896258*f[6]*dv1*wx2_sq+1.154700538379252*f[8]*dv2*wx1*wx2+0.3333333333333333*f[13]*dv1*dv2*wx2+0.1666666666666667*f[1]*dv2_sq*wx1+0.04811252243246882*f[6]*dv1*dv2_sq); 
  out[10] += volFact*(2.0*f[2]*wx1*wx2_sq+0.5773502691896258*f[7]*dv1*wx2_sq+1.154700538379252*f[9]*dv2*wx1*wx2+0.3333333333333333*f[14]*dv1*dv2*wx2+0.1666666666666667*f[2]*dv2_sq*wx1+0.04811252243246882*f[7]*dv1*dv2_sq); 
  out[11] += volFact*(2.0*f[5]*wx1*wx2_sq+0.5773502691896258*f[11]*dv1*wx2_sq+1.154700538379252*f[12]*dv2*wx1*wx2+0.3333333333333333*f[15]*dv1*dv2*wx2+0.1666666666666667*f[5]*dv2_sq*wx1+0.04811252243246882*f[11]*dv1*dv2_sq); 
  out[12] += volFact*(2.0*f[0]*wx2*wx2_sq+1.732050807568877*f[4]*dv2*wx2_sq+0.5*f[0]*dv2_sq*wx2+0.08660254037844387*f[4]*dv2*dv2_sq); 
  out[13] += volFact*(2.0*f[1]*wx2*wx2_sq+1.732050807568877*f[8]*dv2*wx2_sq+0.5*f[1]*dv2_sq*wx2+0.08660254037844387*f[8]*dv2*dv2_sq); 
  out[14] += volFact*(2.0*f[2]*wx2*wx2_sq+1.732050807568877*f[9]*dv2*wx2_sq+0.5*f[2]*dv2_sq*wx2+0.08660254037844387*f[9]*dv2*dv2_sq); 
  out[15] += volFact*(2.0*f[5]*wx2*wx2_sq+1.732050807568877*f[12]*dv2*wx2_sq+0.5*f[5]*dv2_sq*wx2+0.08660254037844387*f[12]*dv2*dv2_sq); 
} 
