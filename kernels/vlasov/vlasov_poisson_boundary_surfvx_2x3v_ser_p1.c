...
{ 
  ...
  Ghat[16] = 0.01666666666666667*(15.0*alpha[2]*fUpwind[18]+15.0*alpha[0]*fUpwind[16]); 
  Ghat[17] = 0.01666666666666667*(15.0*alpha[2]*fUpwind[20]+15.0*alpha[0]*fUpwind[17]); 
  Ghat[18] = 0.01666666666666667*(15.0*alpha[0]*fUpwind[18]+15.0*alpha[2]*fUpwind[16]); 
  Ghat[19] = 0.01666666666666667*(15.0*alpha[2]*fUpwind[22]+15.0*alpha[0]*fUpwind[19]); 
  Ghat[20] = 0.01666666666666667*(15.0*alpha[0]*fUpwind[20]+15.0*alpha[2]*fUpwind[17]); 
  Ghat[21] = 0.01666666666666667*(15.0*alpha[2]*fUpwind[23]+15.0*alpha[0]*fUpwind[21]); 
  Ghat[22] = 0.01666666666666667*(15.0*alpha[0]*fUpwind[22]+15.0*alpha[2]*fUpwind[19]); 
  Ghat[23] = 0.01666666666666667*(15.0*alpha[0]*fUpwind[23]+15.0*alpha[2]*fUpwind[21]); 
  Ghat[24] = 0.01666666666666667*(15.0*alpha[2]*fUpwind[26]+15.0*alpha[0]*fUpwind[24]); 
  Ghat[25] = 0.01666666666666667*(15.0*alpha[2]*fUpwind[28]+15.0*alpha[0]*fUpwind[25]); 
  Ghat[26] = 0.01666666666666667*(15.0*alpha[0]*fUpwind[26]+15.0*alpha[2]*fUpwind[24]); 
  Ghat[27] = 0.01666666666666667*(15.0*alpha[2]*fUpwind[30]+15.0*alpha[0]*fUpwind[27]); 
  Ghat[28] = 0.01666666666666667*(15.0*alpha[0]*fUpwind[28]+15.0*alpha[2]*fUpwind[25]); 
  Ghat[29] = 0.01666666666666667*(15.0*alpha[2]*fUpwind[31]+15.0*alpha[0]*fUpwind[29]); 
  Ghat[30] = 0.01666666666666667*(15.0*alpha[0]*fUpwind[30]+15.0*alpha[2]*fUpwind[27]); 
  Ghat[31] = 0.01666666666666667*(15.0*alpha[0]*fUpwind[31]+15.0*alpha[2]*fUpwind[29]); 
