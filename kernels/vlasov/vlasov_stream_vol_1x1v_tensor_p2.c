...
GKYL_CU_DH double vlasov_stream_vol_1x1v_tensor_p2(const double *w, const double *dxv, const double *qmem, const double *cot_vec, const double *f, double* GKYL_RESTRICT out) 
{ 
  ...
  out[8] += 7.745966692414834*f[7]*w1Ddx0+2.0*f[3]*dv1Ddx0; 
