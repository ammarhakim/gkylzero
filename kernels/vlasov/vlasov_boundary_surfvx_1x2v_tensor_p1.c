...
{ 
  ...
  if (0.5*alpha[3]-0.5*(alpha[2]+alpha[1])+0.5*alpha[0] > 0) { 
    fUpwindQuad[0] = tensor_3x_p1_surfx2_eval_quad_node_0_r(fSkin); 
  } else { 
    fUpwindQuad[0] = tensor_3x_p1_surfx2_eval_quad_node_0_l(fEdge); 
  } 
  if ((-0.5*alpha[3])+0.5*alpha[2]-0.5*alpha[1]+0.5*alpha[0] > 0) { 
    fUpwindQuad[1] = tensor_3x_p1_surfx2_eval_quad_node_1_r(fSkin); 
  } else { 
    fUpwindQuad[1] = tensor_3x_p1_surfx2_eval_quad_node_1_l(fEdge); 
  } 
  if (0.5*(alpha[1]+alpha[0])-0.5*(alpha[3]+alpha[2]) > 0) { 
    fUpwindQuad[2] = tensor_3x_p1_surfx2_eval_quad_node_2_r(fSkin); 
  } else { 
    fUpwindQuad[2] = tensor_3x_p1_surfx2_eval_quad_node_2_l(fEdge); 
  } 
  if (0.5*(alpha[3]+alpha[2]+alpha[1]+alpha[0]) > 0) { 
    fUpwindQuad[3] = tensor_3x_p1_surfx2_eval_quad_node_3_r(fSkin); 
  } else { 
    fUpwindQuad[3] = tensor_3x_p1_surfx2_eval_quad_node_3_l(fEdge); 
  } 
  ...
  if (0.5*alpha[3]-0.5*(alpha[2]+alpha[1])+0.5*alpha[0] > 0) { 
    fUpwindQuad[0] = tensor_3x_p1_surfx2_eval_quad_node_0_r(fEdge); 
  } else { 
    fUpwindQuad[0] = tensor_3x_p1_surfx2_eval_quad_node_0_l(fSkin); 
  } 
  if ((-0.5*alpha[3])+0.5*alpha[2]-0.5*alpha[1]+0.5*alpha[0] > 0) { 
    fUpwindQuad[1] = tensor_3x_p1_surfx2_eval_quad_node_1_r(fEdge); 
  } else { 
    fUpwindQuad[1] = tensor_3x_p1_surfx2_eval_quad_node_1_l(fSkin); 
  } 
  if (0.5*(alpha[1]+alpha[0])-0.5*(alpha[3]+alpha[2]) > 0) { 
    fUpwindQuad[2] = tensor_3x_p1_surfx2_eval_quad_node_2_r(fEdge); 
  } else { 
    fUpwindQuad[2] = tensor_3x_p1_surfx2_eval_quad_node_2_l(fSkin); 
  } 
  if (0.5*(alpha[3]+alpha[2]+alpha[1]+alpha[0]) > 0) { 
    fUpwindQuad[3] = tensor_3x_p1_surfx2_eval_quad_node_3_r(fEdge); 
  } else { 
    fUpwindQuad[3] = tensor_3x_p1_surfx2_eval_quad_node_3_l(fSkin); 
  } 
