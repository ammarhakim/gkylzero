...
{ 
  ...
  fUpwind_l[2] = 1.58113883008419*fl[8]+1.224744871391589*fl[7]+0.7071067811865475*fl[5]; 
  ...
  fUpwind_r[2] = 1.58113883008419*fc[8]+1.224744871391589*fc[7]+0.7071067811865475*fc[5]; 
  ...
  fUpwind_l[2] = 1.58113883008419*fc[8]-1.224744871391589*fc[7]+0.7071067811865475*fc[5]; 
  ...
  fUpwind_r[2] = 1.58113883008419*fr[8]-1.224744871391589*fr[7]+0.7071067811865475*fr[5]; 
