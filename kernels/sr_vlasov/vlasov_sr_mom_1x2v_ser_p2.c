...
{ 
  ...
  out[1] += 2.0*f[1]*volFact; 
  out[2] += 2.0*f[7]*volFact; 
  out[3] += (p0_over_gamma[7]*f[16]+p0_over_gamma[6]*f[14]+p0_over_gamma[5]*f[9]+p0_over_gamma[4]*f[8]+p0_over_gamma[3]*f[6]+p0_over_gamma[2]*f[3]+p0_over_gamma[1]*f[2]+f[0]*p0_over_gamma[0])*volFact; 
  out[4] += (1.0*p0_over_gamma[7]*f[19]+1.0*p0_over_gamma[6]*f[18]+1.0*p0_over_gamma[5]*f[15]+1.0*p0_over_gamma[4]*f[12]+p0_over_gamma[3]*f[10]+p0_over_gamma[2]*f[5]+p0_over_gamma[1]*f[4]+p0_over_gamma[0]*f[1])*volFact; 
  out[5] += (p0_over_gamma[3]*f[17]+1.0*p0_over_gamma[2]*f[13]+1.0*p0_over_gamma[1]*f[11]+p0_over_gamma[0]*f[7])*volFact; 
  out[6] += (p1_over_gamma[7]*f[16]+p1_over_gamma[6]*f[14]+p1_over_gamma[5]*f[9]+p1_over_gamma[4]*f[8]+p1_over_gamma[3]*f[6]+p1_over_gamma[2]*f[3]+p1_over_gamma[1]*f[2]+f[0]*p1_over_gamma[0])*volFact; 
  out[7] += (1.0*p1_over_gamma[7]*f[19]+1.0*p1_over_gamma[6]*f[18]+1.0*p1_over_gamma[5]*f[15]+1.0*p1_over_gamma[4]*f[12]+p1_over_gamma[3]*f[10]+p1_over_gamma[2]*f[5]+p1_over_gamma[1]*f[4]+p1_over_gamma[0]*f[1])*volFact; 
...
{ 
  ...
  temp_sq[11] = 0.5216405309573011*GammaV2[2]*V_drift_0_sq[2]*dv1*wx1+0.816496580927726*GammaV2[0]*V_drift_0_sq[2]*dv1*wx1+0.816496580927726*V_drift_0_sq[0]*GammaV2[2]*dv1*wx1+0.7302967433402215*GammaV2[1]*V_drift_0_sq[1]*dv1*wx1; 
  temp_sq[12] = 0.09428090415820635*GammaV2[1]*V_drift_0_sq[2]*dv1_sq+0.09428090415820635*V_drift_0_sq[1]*GammaV2[2]*dv1_sq+0.105409255338946*GammaV2[0]*V_drift_0_sq[1]*dv1_sq+0.105409255338946*V_drift_0_sq[0]*GammaV2[1]*dv1_sq; 
  temp_sq[13] = 0.5216405309573011*GammaV2[2]*V_drift_1_sq[2]*dv2*wx2+0.816496580927726*GammaV2[0]*V_drift_1_sq[2]*dv2*wx2+0.816496580927726*V_drift_1_sq[0]*GammaV2[2]*dv2*wx2+0.7302967433402215*GammaV2[1]*V_drift_1_sq[1]*dv2*wx2; 
  ...
  p_fac[0] = 0.5*gamma_inv[5]*temp_sq[9]+0.5*gamma_inv[4]*temp_sq[8]-1.414213562373095*GammaV2[2]*temp[7]+0.5*gamma_inv[2]*temp_sq[3]+0.5*gamma_inv[1]*temp_sq[2]-1.414213562373095*GammaV2[1]*temp[1]+GammaV2[0]*gamma[0]+0.5*gamma_inv[0]*temp_sq[0]-1.414213562373095*GammaV2[0]*temp[0]-1.414213562373095*gamma_inv[0]; 
  p_fac[1] = 0.5000000000000001*gamma_inv[5]*temp_sq[15]+0.5000000000000001*gamma_inv[4]*temp_sq[12]-1.264911064067352*GammaV2[1]*temp[7]+0.5*gamma_inv[2]*temp_sq[5]+0.5*gamma_inv[1]*temp_sq[4]-1.264911064067352*temp[1]*GammaV2[2]+0.5*gamma_inv[0]*temp_sq[1]-1.414213562373095*GammaV2[0]*temp[1]+gamma[0]*GammaV2[1]-1.414213562373095*temp[0]*GammaV2[1]; 
  p_fac[2] = (-1.414213562373095*GammaV2[2]*temp[11])+0.5000000000000001*gamma_inv[7]*temp_sq[9]+0.4472135954999579*gamma_inv[1]*temp_sq[8]-1.414213562373095*GammaV2[1]*temp[4]+0.4472135954999579*temp_sq[2]*gamma_inv[4]+0.5*gamma_inv[3]*temp_sq[3]+0.5*gamma_inv[0]*temp_sq[2]-1.414213562373095*GammaV2[0]*temp[2]+GammaV2[0]*gamma[1]+0.5*temp_sq[0]*gamma_inv[1]-1.414213562373095*gamma_inv[1]; 
  p_fac[3] = (-1.414213562373095*GammaV2[2]*temp[13])+0.4472135954999579*gamma_inv[2]*temp_sq[9]+0.5000000000000001*gamma_inv[6]*temp_sq[8]-1.414213562373095*GammaV2[1]*temp[5]+0.4472135954999579*temp_sq[3]*gamma_inv[5]+0.5*gamma_inv[0]*temp_sq[3]-1.414213562373095*GammaV2[0]*temp[3]+0.5*temp_sq[2]*gamma_inv[3]+GammaV2[0]*gamma[2]+0.5*temp_sq[0]*gamma_inv[2]-1.414213562373095*gamma_inv[2]; 
  ...
  p_fac[5] = 0.447213595499958*gamma_inv[2]*temp_sq[15]-1.264911064067352*GammaV2[1]*temp[13]+0.5*gamma_inv[6]*temp_sq[12]+0.4472135954999579*gamma_inv[5]*temp_sq[5]+0.5*gamma_inv[0]*temp_sq[5]-1.264911064067352*GammaV2[2]*temp[5]-1.414213562373095*GammaV2[0]*temp[5]+0.5*gamma_inv[3]*temp_sq[4]-1.414213562373095*GammaV2[1]*temp[3]+GammaV2[1]*gamma[2]+0.5*temp_sq[1]*gamma_inv[2]; 
  p_fac[6] = 0.4472135954999579*gamma_inv[3]*temp_sq[9]+0.4472135954999579*gamma_inv[3]*temp_sq[8]+0.447213595499958*temp_sq[3]*gamma_inv[7]+0.447213595499958*temp_sq[2]*gamma_inv[6]+GammaV2[0]*gamma[3]+0.5*gamma_inv[1]*temp_sq[3]+0.5*temp_sq[0]*gamma_inv[3]-1.414213562373095*gamma_inv[3]+0.5*gamma_inv[2]*temp_sq[2]; 
  p_fac[7] = 0.5000000000000001*gamma_inv[2]*temp_sq[13]+0.5000000000000001*gamma_inv[1]*temp_sq[11]+0.5*gamma_inv[0]*temp_sq[7]-0.9035079029052515*GammaV2[2]*temp[7]-1.414213562373095*GammaV2[0]*temp[7]+gamma[0]*GammaV2[2]-1.414213562373095*temp[0]*GammaV2[2]-1.264911064067352*GammaV2[1]*temp[1]; 
  p_fac[8] = 0.31943828249997*gamma_inv[4]*temp_sq[8]+0.5*gamma_inv[0]*temp_sq[8]+0.5000000000000001*temp_sq[3]*gamma_inv[6]+GammaV2[0]*gamma[4]+0.5*temp_sq[0]*gamma_inv[4]-1.414213562373095*gamma_inv[4]+0.4472135954999579*gamma_inv[1]*temp_sq[2]; 
  p_fac[9] = 0.31943828249997*gamma_inv[5]*temp_sq[9]+0.5*gamma_inv[0]*temp_sq[9]+0.5000000000000001*temp_sq[2]*gamma_inv[7]+GammaV2[0]*gamma[5]+0.5*temp_sq[0]*gamma_inv[5]-1.414213562373095*gamma_inv[5]+0.4472135954999579*gamma_inv[2]*temp_sq[3]; 
  p_fac[10] = 0.447213595499958*gamma_inv[3]*temp_sq[15]+0.447213595499958*gamma_inv[3]*temp_sq[12]+0.447213595499958*temp_sq[5]*gamma_inv[7]+0.447213595499958*temp_sq[4]*gamma_inv[6]+0.5*gamma_inv[1]*temp_sq[5]+0.5*gamma_inv[2]*temp_sq[4]+GammaV2[1]*gamma[3]+0.5*temp_sq[1]*gamma_inv[3]; 
  ...
  p_fac[12] = 0.31943828249997*gamma_inv[4]*temp_sq[12]+0.5*gamma_inv[0]*temp_sq[12]+0.5*temp_sq[5]*gamma_inv[6]+1.0*GammaV2[1]*gamma[4]+0.447213595499958*gamma_inv[1]*temp_sq[4]+0.5000000000000001*temp_sq[1]*gamma_inv[4]; 
  p_fac[13] = 0.4472135954999579*gamma_inv[5]*temp_sq[13]+0.5*gamma_inv[0]*temp_sq[13]-0.9035079029052515*GammaV2[2]*temp[13]-1.414213562373095*GammaV2[0]*temp[13]+0.5*gamma_inv[3]*temp_sq[11]+0.5000000000000001*gamma_inv[2]*temp_sq[7]-1.264911064067352*GammaV2[1]*temp[5]-1.414213562373095*GammaV2[2]*temp[3]+1.0*GammaV2[2]*gamma[2]; 
  p_fac[14] = 0.4472135954999579*gamma_inv[6]*temp_sq[9]+0.31943828249997*gamma_inv[6]*temp_sq[8]+0.5000000000000001*gamma_inv[2]*temp_sq[8]+GammaV2[0]*gamma[6]+0.5*temp_sq[0]*gamma_inv[6]-1.414213562373095*gamma_inv[6]+0.5000000000000001*temp_sq[3]*gamma_inv[4]+0.447213595499958*temp_sq[2]*gamma_inv[3]; 
  p_fac[15] = 0.31943828249997*gamma_inv[5]*temp_sq[15]+0.5*gamma_inv[0]*temp_sq[15]+0.5*temp_sq[4]*gamma_inv[7]+1.0*GammaV2[1]*gamma[5]+0.447213595499958*gamma_inv[2]*temp_sq[5]+0.5000000000000001*temp_sq[1]*gamma_inv[5]; 
  p_fac[16] = 0.31943828249997*gamma_inv[7]*temp_sq[9]+0.5000000000000001*gamma_inv[1]*temp_sq[9]+0.4472135954999579*gamma_inv[7]*temp_sq[8]+GammaV2[0]*gamma[7]+0.5*temp_sq[0]*gamma_inv[7]-1.414213562373095*gamma_inv[7]+0.5000000000000001*temp_sq[2]*gamma_inv[5]+0.447213595499958*gamma_inv[3]*temp_sq[3]; 
  p_fac[17] = 0.4472135954999579*gamma_inv[7]*temp_sq[13]+0.5000000000000001*gamma_inv[1]*temp_sq[13]+0.4472135954999579*gamma_inv[6]*temp_sq[11]+0.5000000000000001*gamma_inv[2]*temp_sq[11]+0.5*gamma_inv[3]*temp_sq[7]+GammaV2[2]*gamma[3]; 
  p_fac[18] = 0.4472135954999579*gamma_inv[6]*temp_sq[15]+0.31943828249997*gamma_inv[6]*temp_sq[12]+0.5000000000000001*gamma_inv[2]*temp_sq[12]+1.0*GammaV2[1]*gamma[6]+0.5000000000000001*temp_sq[1]*gamma_inv[6]+0.5*gamma_inv[4]*temp_sq[5]+0.4472135954999579*gamma_inv[3]*temp_sq[4]; 
  p_fac[19] = 0.31943828249997*gamma_inv[7]*temp_sq[15]+0.5000000000000001*gamma_inv[1]*temp_sq[15]+0.4472135954999579*gamma_inv[7]*temp_sq[12]+1.0*GammaV2[1]*gamma[7]+0.5000000000000001*temp_sq[1]*gamma_inv[7]+0.4472135954999579*gamma_inv[3]*temp_sq[5]+0.5*temp_sq[4]*gamma_inv[5]; 
...
{ 
  ...
  out[9] += volFact*(p0_over_gamma[7]*f[16]*wx1+p0_over_gamma[6]*f[14]*wx1+p0_over_gamma[5]*f[9]*wx1+p0_over_gamma[4]*f[8]*wx1+p0_over_gamma[3]*f[6]*wx1+p0_over_gamma[2]*f[3]*wx1+p0_over_gamma[1]*f[2]*wx1+f[0]*p0_over_gamma[0]*wx1+0.2886751345948129*p0_over_gamma[5]*f[16]*dv1+0.2581988897471611*p0_over_gamma[3]*f[14]*dv1+0.2886751345948129*p0_over_gamma[7]*f[9]*dv1+0.2581988897471612*p0_over_gamma[1]*f[8]*dv1+0.2581988897471611*f[6]*p0_over_gamma[6]*dv1+0.2886751345948129*p0_over_gamma[2]*f[6]*dv1+0.2581988897471612*f[2]*p0_over_gamma[4]*dv1+0.2886751345948129*f[3]*p0_over_gamma[3]*dv1+0.2886751345948129*p0_over_gamma[0]*f[2]*dv1+0.2886751345948129*f[0]*p0_over_gamma[1]*dv1); 
  out[10] += volFact*(1.0*p0_over_gamma[7]*f[19]*wx1+1.0*p0_over_gamma[6]*f[18]*wx1+1.0*p0_over_gamma[5]*f[15]*wx1+1.0*p0_over_gamma[4]*f[12]*wx1+p0_over_gamma[3]*f[10]*wx1+p0_over_gamma[2]*f[5]*wx1+p0_over_gamma[1]*f[4]*wx1+p0_over_gamma[0]*f[1]*wx1+0.2886751345948129*p0_over_gamma[5]*f[19]*dv1+0.2581988897471612*p0_over_gamma[3]*f[18]*dv1+0.2886751345948129*p0_over_gamma[7]*f[15]*dv1+0.2581988897471611*p0_over_gamma[1]*f[12]*dv1+0.2581988897471611*p0_over_gamma[6]*f[10]*dv1+0.2886751345948129*p0_over_gamma[2]*f[10]*dv1+0.2886751345948129*p0_over_gamma[3]*f[5]*dv1+0.2581988897471612*f[4]*p0_over_gamma[4]*dv1+0.2886751345948129*p0_over_gamma[0]*f[4]*dv1+0.2886751345948129*f[1]*p0_over_gamma[1]*dv1); 
  out[11] += volFact*(p0_over_gamma[3]*f[17]*wx1+1.0*p0_over_gamma[2]*f[13]*wx1+1.0*p0_over_gamma[1]*f[11]*wx1+p0_over_gamma[0]*f[7]*wx1+0.2581988897471611*p0_over_gamma[6]*f[17]*dv1+0.2886751345948129*p0_over_gamma[2]*f[17]*dv1+0.2886751345948129*p0_over_gamma[3]*f[13]*dv1+0.2581988897471611*p0_over_gamma[4]*f[11]*dv1+0.2886751345948129*p0_over_gamma[0]*f[11]*dv1+0.2886751345948129*p0_over_gamma[1]*f[7]*dv1); 
  out[12] += volFact*(p0_over_gamma[7]*f[16]*wx2+p0_over_gamma[6]*f[14]*wx2+p0_over_gamma[5]*f[9]*wx2+p0_over_gamma[4]*f[8]*wx2+p0_over_gamma[3]*f[6]*wx2+p0_over_gamma[2]*f[3]*wx2+p0_over_gamma[1]*f[2]*wx2+f[0]*p0_over_gamma[0]*wx2+0.2581988897471611*p0_over_gamma[3]*f[16]*dv2+0.2886751345948129*p0_over_gamma[4]*f[14]*dv2+0.2581988897471612*p0_over_gamma[2]*f[9]*dv2+0.2886751345948129*p0_over_gamma[6]*f[8]*dv2+0.2581988897471611*f[6]*p0_over_gamma[7]*dv2+0.2886751345948129*p0_over_gamma[1]*f[6]*dv2+0.2581988897471612*f[3]*p0_over_gamma[5]*dv2+0.2886751345948129*f[2]*p0_over_gamma[3]*dv2+0.2886751345948129*p0_over_gamma[0]*f[3]*dv2+0.2886751345948129*f[0]*p0_over_gamma[2]*dv2); 
  out[13] += volFact*(1.0*p0_over_gamma[7]*f[19]*wx2+1.0*p0_over_gamma[6]*f[18]*wx2+1.0*p0_over_gamma[5]*f[15]*wx2+1.0*p0_over_gamma[4]*f[12]*wx2+p0_over_gamma[3]*f[10]*wx2+p0_over_gamma[2]*f[5]*wx2+p0_over_gamma[1]*f[4]*wx2+p0_over_gamma[0]*f[1]*wx2+0.2581988897471612*p0_over_gamma[3]*f[19]*dv2+0.2886751345948129*p0_over_gamma[4]*f[18]*dv2+0.2581988897471611*p0_over_gamma[2]*f[15]*dv2+0.2886751345948129*p0_over_gamma[6]*f[12]*dv2+0.2581988897471611*p0_over_gamma[7]*f[10]*dv2+0.2886751345948129*p0_over_gamma[1]*f[10]*dv2+0.2581988897471612*f[5]*p0_over_gamma[5]*dv2+0.2886751345948129*p0_over_gamma[0]*f[5]*dv2+0.2886751345948129*p0_over_gamma[3]*f[4]*dv2+0.2886751345948129*f[1]*p0_over_gamma[2]*dv2); 
  out[14] += volFact*(p0_over_gamma[3]*f[17]*wx2+1.0*p0_over_gamma[2]*f[13]*wx2+1.0*p0_over_gamma[1]*f[11]*wx2+p0_over_gamma[0]*f[7]*wx2+0.2581988897471611*p0_over_gamma[7]*f[17]*dv2+0.2886751345948129*p0_over_gamma[1]*f[17]*dv2+0.2581988897471611*p0_over_gamma[5]*f[13]*dv2+0.2886751345948129*p0_over_gamma[0]*f[13]*dv2+0.2886751345948129*p0_over_gamma[3]*f[11]*dv2+0.2886751345948129*p0_over_gamma[2]*f[7]*dv2); 
  out[15] += volFact*(p1_over_gamma[7]*f[16]*wx2+p1_over_gamma[6]*f[14]*wx2+p1_over_gamma[5]*f[9]*wx2+p1_over_gamma[4]*f[8]*wx2+p1_over_gamma[3]*f[6]*wx2+p1_over_gamma[2]*f[3]*wx2+p1_over_gamma[1]*f[2]*wx2+f[0]*p1_over_gamma[0]*wx2+0.2581988897471611*p1_over_gamma[3]*f[16]*dv2+0.2886751345948129*p1_over_gamma[4]*f[14]*dv2+0.2581988897471612*p1_over_gamma[2]*f[9]*dv2+0.2886751345948129*p1_over_gamma[6]*f[8]*dv2+0.2581988897471611*f[6]*p1_over_gamma[7]*dv2+0.2886751345948129*p1_over_gamma[1]*f[6]*dv2+0.2581988897471612*f[3]*p1_over_gamma[5]*dv2+0.2886751345948129*f[2]*p1_over_gamma[3]*dv2+0.2886751345948129*p1_over_gamma[0]*f[3]*dv2+0.2886751345948129*f[0]*p1_over_gamma[2]*dv2); 
  out[16] += volFact*(1.0*p1_over_gamma[7]*f[19]*wx2+1.0*p1_over_gamma[6]*f[18]*wx2+1.0*p1_over_gamma[5]*f[15]*wx2+1.0*p1_over_gamma[4]*f[12]*wx2+p1_over_gamma[3]*f[10]*wx2+p1_over_gamma[2]*f[5]*wx2+p1_over_gamma[1]*f[4]*wx2+p1_over_gamma[0]*f[1]*wx2+0.2581988897471612*p1_over_gamma[3]*f[19]*dv2+0.2886751345948129*p1_over_gamma[4]*f[18]*dv2+0.2581988897471611*p1_over_gamma[2]*f[15]*dv2+0.2886751345948129*p1_over_gamma[6]*f[12]*dv2+0.2581988897471611*p1_over_gamma[7]*f[10]*dv2+0.2886751345948129*p1_over_gamma[1]*f[10]*dv2+0.2581988897471612*f[5]*p1_over_gamma[5]*dv2+0.2886751345948129*p1_over_gamma[0]*f[5]*dv2+0.2886751345948129*p1_over_gamma[3]*f[4]*dv2+0.2886751345948129*f[1]*p1_over_gamma[2]*dv2); 
  out[17] += volFact*(p1_over_gamma[3]*f[17]*wx2+1.0*p1_over_gamma[2]*f[13]*wx2+1.0*p1_over_gamma[1]*f[11]*wx2+p1_over_gamma[0]*f[7]*wx2+0.2581988897471611*p1_over_gamma[7]*f[17]*dv2+0.2886751345948129*p1_over_gamma[1]*f[17]*dv2+0.2581988897471611*p1_over_gamma[5]*f[13]*dv2+0.2886751345948129*p1_over_gamma[0]*f[13]*dv2+0.2886751345948129*p1_over_gamma[3]*f[11]*dv2+0.2886751345948129*p1_over_gamma[2]*f[7]*dv2); 
} 
