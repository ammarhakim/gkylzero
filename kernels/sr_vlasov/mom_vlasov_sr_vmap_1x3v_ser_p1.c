...
{ 
  ...
  out[0] += (p0_over_gamma[19]*f[38]+p0_over_gamma[16]*f[35]+p0_over_gamma[15]*f[34]+p0_over_gamma[9]*f[32]+p0_over_gamma[18]*f[30]+p0_over_gamma[14]*f[27]+p0_over_gamma[12]*f[26]+p0_over_gamma[8]*f[24]+p0_over_gamma[17]*f[22]+p0_over_gamma[13]*f[19]+p0_over_gamma[11]*f[18]+p0_over_gamma[7]*f[16]+p0_over_gamma[10]*f[14]+p0_over_gamma[6]*f[10]+p0_over_gamma[5]*f[9]+p0_over_gamma[4]*f[7]+p0_over_gamma[3]*f[4]+p0_over_gamma[2]*f[3]+p0_over_gamma[1]*f[2]+f[0]*p0_over_gamma[0])*volFact; 
  out[1] += (1.0*p0_over_gamma[19]*f[39]+1.0*p0_over_gamma[16]*f[37]+1.0*p0_over_gamma[15]*f[36]+1.0*p0_over_gamma[9]*f[33]+1.0*p0_over_gamma[18]*f[31]+1.0*p0_over_gamma[14]*f[29]+1.0*p0_over_gamma[12]*f[28]+1.0*p0_over_gamma[8]*f[25]+1.0*p0_over_gamma[17]*f[23]+1.0*p0_over_gamma[13]*f[21]+1.0*p0_over_gamma[11]*f[20]+1.0*p0_over_gamma[7]*f[17]+p0_over_gamma[10]*f[15]+p0_over_gamma[6]*f[13]+p0_over_gamma[5]*f[12]+p0_over_gamma[4]*f[11]+p0_over_gamma[3]*f[8]+p0_over_gamma[2]*f[6]+p0_over_gamma[1]*f[5]+p0_over_gamma[0]*f[1])*volFact; 
  out[2] += (p1_over_gamma[19]*f[38]+p1_over_gamma[16]*f[35]+p1_over_gamma[15]*f[34]+p1_over_gamma[9]*f[32]+p1_over_gamma[18]*f[30]+p1_over_gamma[14]*f[27]+p1_over_gamma[12]*f[26]+p1_over_gamma[8]*f[24]+p1_over_gamma[17]*f[22]+p1_over_gamma[13]*f[19]+p1_over_gamma[11]*f[18]+p1_over_gamma[7]*f[16]+p1_over_gamma[10]*f[14]+p1_over_gamma[6]*f[10]+p1_over_gamma[5]*f[9]+p1_over_gamma[4]*f[7]+p1_over_gamma[3]*f[4]+p1_over_gamma[2]*f[3]+p1_over_gamma[1]*f[2]+f[0]*p1_over_gamma[0])*volFact; 
  out[3] += (1.0*p1_over_gamma[19]*f[39]+1.0*p1_over_gamma[16]*f[37]+1.0*p1_over_gamma[15]*f[36]+1.0*p1_over_gamma[9]*f[33]+1.0*p1_over_gamma[18]*f[31]+1.0*p1_over_gamma[14]*f[29]+1.0*p1_over_gamma[12]*f[28]+1.0*p1_over_gamma[8]*f[25]+1.0*p1_over_gamma[17]*f[23]+1.0*p1_over_gamma[13]*f[21]+1.0*p1_over_gamma[11]*f[20]+1.0*p1_over_gamma[7]*f[17]+p1_over_gamma[10]*f[15]+p1_over_gamma[6]*f[13]+p1_over_gamma[5]*f[12]+p1_over_gamma[4]*f[11]+p1_over_gamma[3]*f[8]+p1_over_gamma[2]*f[6]+p1_over_gamma[1]*f[5]+p1_over_gamma[0]*f[1])*volFact; 
  out[4] += (p2_over_gamma[19]*f[38]+p2_over_gamma[16]*f[35]+p2_over_gamma[15]*f[34]+p2_over_gamma[9]*f[32]+p2_over_gamma[18]*f[30]+p2_over_gamma[14]*f[27]+p2_over_gamma[12]*f[26]+p2_over_gamma[8]*f[24]+p2_over_gamma[17]*f[22]+p2_over_gamma[13]*f[19]+p2_over_gamma[11]*f[18]+p2_over_gamma[7]*f[16]+p2_over_gamma[10]*f[14]+p2_over_gamma[6]*f[10]+p2_over_gamma[5]*f[9]+p2_over_gamma[4]*f[7]+p2_over_gamma[3]*f[4]+p2_over_gamma[2]*f[3]+p2_over_gamma[1]*f[2]+f[0]*p2_over_gamma[0])*volFact; 
  out[5] += (1.0*p2_over_gamma[19]*f[39]+1.0*p2_over_gamma[16]*f[37]+1.0*p2_over_gamma[15]*f[36]+1.0*p2_over_gamma[9]*f[33]+1.0*p2_over_gamma[18]*f[31]+1.0*p2_over_gamma[14]*f[29]+1.0*p2_over_gamma[12]*f[28]+1.0*p2_over_gamma[8]*f[25]+1.0*p2_over_gamma[17]*f[23]+1.0*p2_over_gamma[13]*f[21]+1.0*p2_over_gamma[11]*f[20]+1.0*p2_over_gamma[7]*f[17]+p2_over_gamma[10]*f[15]+p2_over_gamma[6]*f[13]+p2_over_gamma[5]*f[12]+p2_over_gamma[4]*f[11]+p2_over_gamma[3]*f[8]+p2_over_gamma[2]*f[6]+p2_over_gamma[1]*f[5]+p2_over_gamma[0]*f[1])*volFact; 
} 
...
{ 
  ...
  out[0] += (2.0*p0[2]*f[16]+2.0*p0[1]*f[2]+2.0*f[0]*p0[0])*volFact; 
  out[1] += (2.0*p0[2]*f[17]+2.0*p0[1]*f[5]+2.0*p0[0]*f[1])*volFact; 
  out[2] += (2.0*p1[2]*f[24]+2.0*p1[1]*f[3]+2.0*f[0]*p1[0])*volFact; 
  out[3] += (2.0*p1[2]*f[25]+2.0*p1[1]*f[6]+2.0*p1[0]*f[1])*volFact; 
  out[4] += (2.0*p2[2]*f[32]+2.0*p2[1]*f[4]+2.0*f[0]*p2[0])*volFact; 
  out[5] += (2.0*p2[2]*f[33]+2.0*p2[1]*f[8]+2.0*p2[0]*f[1])*volFact; 
} 
...
{ 
  ...
  out[2] += (2.828427124746191*p0[2]*f[16]+2.828427124746191*p0[1]*f[2]+2.828427124746191*f[0]*p0[0])*volFact; 
  out[3] += (2.828427124746191*p1[2]*f[24]+2.828427124746191*p1[1]*f[3]+2.828427124746191*f[0]*p1[0])*volFact; 
  out[4] += (2.828427124746191*p2[2]*f[32]+2.828427124746191*p2[1]*f[4]+2.828427124746191*f[0]*p2[0])*volFact; 
} 
