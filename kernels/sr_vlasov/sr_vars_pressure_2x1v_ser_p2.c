...
{ 
  ...
  temp[7] = 1.414213562373095*V_0[4]*wx1; 
  temp[8] = 1.414213562373095*V_0[5]*wx1; 
  temp[10] = 0.408248290463863*V_0[3]*dv1; 
  temp[11] = 1.414213562373095*V_0[6]*wx1; 
  temp[12] = 1.414213562373095*V_0[7]*wx1; 
  temp[13] = 0.408248290463863*V_0[4]*dv1; 
  temp[14] = 0.408248290463863*V_0[5]*dv1; 
  temp[17] = 0.408248290463863*V_0[6]*dv1; 
  temp[18] = 0.408248290463863*V_0[7]*dv1; 
  ...
  temp_sq[7] = 1.414213562373095*V_0_sq[4]*wx1_sq+0.1178511301977579*V_0_sq[4]*dv1_sq; 
  temp_sq[8] = 1.414213562373095*V_0_sq[5]*wx1_sq+0.1178511301977579*V_0_sq[5]*dv1_sq; 
  temp_sq[9] = 0.105409255338946*V_0_sq[0]*dv1_sq; 
  temp_sq[10] = 0.8164965809277261*V_0_sq[3]*dv1*wx1; 
  temp_sq[11] = 1.414213562373095*V_0_sq[6]*wx1_sq+0.1178511301977579*V_0_sq[6]*dv1_sq; 
  temp_sq[12] = 1.414213562373095*V_0_sq[7]*wx1_sq+0.1178511301977579*V_0_sq[7]*dv1_sq; 
  ...
  temp_sq[19] = 0.105409255338946*V_0_sq[3]*dv1_sq; 
  ...
  p_fac[9] = 0.4517539514526256*gamma_inv[2]*temp_sq[9]+0.7071067811865475*gamma_inv[0]*temp_sq[9]+0.6324555320336759*gamma_inv[1]*temp_sq[3]+GammaV_sq[0]*gamma[2]+0.7071067811865475*temp_sq[0]*gamma_inv[2]-2.0*gamma_inv[2]; 
  ...
  p_fac[15] = 0.4517539514526256*gamma_inv[2]*temp_sq[15]+0.7071067811865475*gamma_inv[0]*temp_sq[15]+0.632455532033676*gamma_inv[1]*temp_sq[5]+1.0*GammaV_sq[1]*gamma[2]+0.7071067811865475*temp_sq[1]*gamma_inv[2]; 
  p_fac[16] = 0.4517539514526256*gamma_inv[2]*temp_sq[16]+0.7071067811865475*gamma_inv[0]*temp_sq[16]+0.632455532033676*gamma_inv[1]*temp_sq[6]+1.0*GammaV_sq[2]*gamma[2]+0.7071067811865475*gamma_inv[2]*temp_sq[2]; 
  ...
  p_fac[19] = 0.4517539514526256*gamma_inv[2]*temp_sq[19]+0.7071067811865475*gamma_inv[0]*temp_sq[19]+0.6324555320336759*gamma_inv[1]*temp_sq[10]+0.7071067811865475*gamma_inv[2]*temp_sq[4]+gamma[2]*GammaV_sq[3]; 
