...
{ 
  ...
  out[2] += (gamma[2]*f[8]+1.0*gamma[1]*f[6]+gamma[0]*f[4])*volFact; 
} 
...
{ 
  ...
  out[8] += volFact*(1.0*p0_over_gamma[1]*f[6]*wx1+p0_over_gamma[0]*f[4]*wx1+0.2581988897471612*p0_over_gamma[1]*f[8]*dv1+0.2886751345948129*p0_over_gamma[0]*f[6]*dv1+0.2886751345948129*p0_over_gamma[1]*f[4]*dv1); 
} 
