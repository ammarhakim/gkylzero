...
{ 
  ...
  alpha_l[8] = B0[0]*p2_over_gamma_l[4]-1.0*B2[0]*p0_over_gamma_l[4]; 
  alpha_l[9] = 1.0*B0[1]*p2_over_gamma_l[4]-1.0*B2[1]*p0_over_gamma_l[4]; 
  alpha_l[10] = B0[0]*p2_over_gamma_l[6]-1.0*B2[0]*p0_over_gamma_l[6]; 
  alpha_l[11] = 1.0*B0[1]*p2_over_gamma_l[6]-1.0*B2[1]*p0_over_gamma_l[6]; 
  alpha_l[12] = B0[0]*p2_over_gamma_l[5]-1.0*B2[0]*p0_over_gamma_l[5]; 
  alpha_l[13] = 1.0*B0[1]*p2_over_gamma_l[5]-1.0*B2[1]*p0_over_gamma_l[5]; 
  alpha_l[14] = B0[0]*p2_over_gamma_l[7]-1.0*B2[0]*p0_over_gamma_l[7]; 
  alpha_l[15] = 1.0*B0[1]*p2_over_gamma_l[7]-1.0*B2[1]*p0_over_gamma_l[7]; 
  ...
  alpha_r[8] = B0[0]*p2_over_gamma_r[4]-1.0*B2[0]*p0_over_gamma_r[4]; 
  alpha_r[9] = 1.0*B0[1]*p2_over_gamma_r[4]-1.0*B2[1]*p0_over_gamma_r[4]; 
  alpha_r[10] = B0[0]*p2_over_gamma_r[6]-1.0*B2[0]*p0_over_gamma_r[6]; 
  alpha_r[11] = 1.0*B0[1]*p2_over_gamma_r[6]-1.0*B2[1]*p0_over_gamma_r[6]; 
  alpha_r[12] = B0[0]*p2_over_gamma_r[5]-1.0*B2[0]*p0_over_gamma_r[5]; 
  alpha_r[13] = 1.0*B0[1]*p2_over_gamma_r[5]-1.0*B2[1]*p0_over_gamma_r[5]; 
  alpha_r[14] = B0[0]*p2_over_gamma_r[7]-1.0*B2[0]*p0_over_gamma_r[7]; 
  alpha_r[15] = 1.0*B0[1]*p2_over_gamma_r[7]-1.0*B2[1]*p0_over_gamma_r[7]; 
  ...
  out[6] += ((-1.936491673103709*(Ghat_r[1]+Ghat_l[1])*jacob_vel_inv1[2])+(1.5*Ghat_l[1]-1.5*Ghat_r[1])*jacob_vel_inv1[1]-0.8660254037844386*jacob_vel_inv1[0]*(Ghat_r[1]+Ghat_l[1]))*dv11; 
  out[7] += ((-1.936491673103709*(Ghat_r[2]+Ghat_l[2])*jacob_vel_inv1[2])+((-1.5*jacob_vel_inv1[1])-0.8660254037844386*jacob_vel_inv1[0])*Ghat_r[2]+(1.5*jacob_vel_inv1[1]-0.8660254037844386*jacob_vel_inv1[0])*Ghat_l[2])*dv11; 
  ...
  out[9] += (((-1.118033988749895*jacob_vel_inv1[2])-0.8660254037844386*jacob_vel_inv1[1]-0.5*jacob_vel_inv1[0])*Ghat_r[6]+(1.118033988749895*jacob_vel_inv1[2]-0.8660254037844386*jacob_vel_inv1[1]+0.5*jacob_vel_inv1[0])*Ghat_l[6])*dv11; 
  ...
  out[11] += (((-1.936491673103709*jacob_vel_inv1[2])-1.5*jacob_vel_inv1[1]-0.8660254037844386*jacob_vel_inv1[0])*Ghat_r[4]+((-1.936491673103709*jacob_vel_inv1[2])+1.5*jacob_vel_inv1[1]-0.8660254037844386*jacob_vel_inv1[0])*Ghat_l[4])*dv11; 
  ...
  out[18] += (((-1.936491673103709*jacob_vel_inv1[2])-1.5*jacob_vel_inv1[1]-0.8660254037844387*jacob_vel_inv1[0])*Ghat_r[8]+((-1.936491673103709*jacob_vel_inv1[2])+1.5*jacob_vel_inv1[1]-0.8660254037844387*jacob_vel_inv1[0])*Ghat_l[8])*dv11; 
  out[19] += (((-1.118033988749895*jacob_vel_inv1[2])-0.8660254037844386*jacob_vel_inv1[1]-0.5*jacob_vel_inv1[0])*Ghat_r[10]+(1.118033988749895*jacob_vel_inv1[2]-0.8660254037844386*jacob_vel_inv1[1]+0.5*jacob_vel_inv1[0])*Ghat_l[10])*dv11; 
  out[20] += (((-1.936491673103709*jacob_vel_inv1[2])-1.5*jacob_vel_inv1[1]-0.8660254037844387*jacob_vel_inv1[0])*Ghat_r[9]+((-1.936491673103709*jacob_vel_inv1[2])+1.5*jacob_vel_inv1[1]-0.8660254037844387*jacob_vel_inv1[0])*Ghat_l[9])*dv11; 
  out[21] += (((-1.118033988749895*jacob_vel_inv1[2])-0.8660254037844386*jacob_vel_inv1[1]-0.5*jacob_vel_inv1[0])*Ghat_r[11]+(1.118033988749895*jacob_vel_inv1[2]-0.8660254037844386*jacob_vel_inv1[1]+0.5*jacob_vel_inv1[0])*Ghat_l[11])*dv11; 
  ...
  out[32] += (((-1.118033988749895*jacob_vel_inv1[2])-0.8660254037844386*jacob_vel_inv1[1]-0.5*jacob_vel_inv1[0])*Ghat_r[12]+(1.118033988749895*jacob_vel_inv1[2]-0.8660254037844386*jacob_vel_inv1[1]+0.5*jacob_vel_inv1[0])*Ghat_l[12])*dv11; 
  out[33] += (((-1.118033988749895*jacob_vel_inv1[2])-0.8660254037844386*jacob_vel_inv1[1]-0.5*jacob_vel_inv1[0])*Ghat_r[13]+(1.118033988749895*jacob_vel_inv1[2]-0.8660254037844386*jacob_vel_inv1[1]+0.5*jacob_vel_inv1[0])*Ghat_l[13])*dv11; 
  out[34] += (((-1.118033988749895*jacob_vel_inv1[2])-0.8660254037844386*jacob_vel_inv1[1]-0.5*jacob_vel_inv1[0])*Ghat_r[14]+(1.118033988749895*jacob_vel_inv1[2]-0.8660254037844386*jacob_vel_inv1[1]+0.5*jacob_vel_inv1[0])*Ghat_l[14])*dv11; 
  out[35] += (((-1.936491673103709*jacob_vel_inv1[2])-1.5*jacob_vel_inv1[1]-0.8660254037844387*jacob_vel_inv1[0])*Ghat_r[12]+((-1.936491673103709*jacob_vel_inv1[2])+1.5*jacob_vel_inv1[1]-0.8660254037844387*jacob_vel_inv1[0])*Ghat_l[12])*dv11; 
  out[36] += (((-1.118033988749895*jacob_vel_inv1[2])-0.8660254037844386*jacob_vel_inv1[1]-0.5*jacob_vel_inv1[0])*Ghat_r[15]+(1.118033988749895*jacob_vel_inv1[2]-0.8660254037844386*jacob_vel_inv1[1]+0.5*jacob_vel_inv1[0])*Ghat_l[15])*dv11; 
  out[37] += (((-1.936491673103709*jacob_vel_inv1[2])-1.5*jacob_vel_inv1[1]-0.8660254037844387*jacob_vel_inv1[0])*Ghat_r[13]+((-1.936491673103709*jacob_vel_inv1[2])+1.5*jacob_vel_inv1[1]-0.8660254037844387*jacob_vel_inv1[0])*Ghat_l[13])*dv11; 
  out[38] += (((-1.936491673103709*jacob_vel_inv1[2])-1.5*jacob_vel_inv1[1]-0.8660254037844387*jacob_vel_inv1[0])*Ghat_r[14]+((-1.936491673103709*jacob_vel_inv1[2])+1.5*jacob_vel_inv1[1]-0.8660254037844387*jacob_vel_inv1[0])*Ghat_l[14])*dv11; 
  out[39] += (((-1.936491673103709*jacob_vel_inv1[2])-1.5*jacob_vel_inv1[1]-0.8660254037844387*jacob_vel_inv1[0])*Ghat_r[15]+((-1.936491673103709*jacob_vel_inv1[2])+1.5*jacob_vel_inv1[1]-0.8660254037844387*jacob_vel_inv1[0])*Ghat_l[15])*dv11; 
