...
GKYL_CU_DH double vlasov_sr_boundary_surfvy_2x2v_ser_p1(const double *w, const double *dxv, const double *p_over_gamma, const double *qmem, const int edge, const double *fEdge, const double *fSkin, double* GKYL_RESTRICT out) 
{ 
  ...
  alpha[2] = (-1.224744871391589*B2[2]*p0_over_gamma[2])+1.414213562373095*E1[2]-0.7071067811865475*p0_over_gamma[0]*B2[2]; 
  alpha[3] = (-1.224744871391589*B2[0]*p0_over_gamma[3])-0.7071067811865475*B2[0]*p0_over_gamma[1]; 
  alpha[4] = 1.414213562373095*E1[3]-1.224744871391589*p0_over_gamma[2]*B2[3]-0.7071067811865475*p0_over_gamma[0]*B2[3]; 
  alpha[5] = (-1.224744871391589*B2[1]*p0_over_gamma[3])-0.7071067811865475*B2[1]*p0_over_gamma[1]; 
  alpha[6] = (-1.224744871391589*B2[2]*p0_over_gamma[3])-0.7071067811865475*p0_over_gamma[1]*B2[2]; 
  alpha[7] = (-1.224744871391589*B2[3]*p0_over_gamma[3])-0.7071067811865475*p0_over_gamma[1]*B2[3]; 
