...
{ 
  ...
  alpha_l[7] = 1.414213562373095*E1[4]-1.0*p0_over_gamma_l[0]*B2[4]; 
  alpha_l[8] = 1.414213562373095*E1[5]-1.0*p0_over_gamma_l[0]*B2[5]; 
  alpha_l[10] = -1.0*p0_over_gamma_l[1]*B2[3]; 
  alpha_l[11] = 1.414213562373095*E1[6]-1.0*p0_over_gamma_l[0]*B2[6]; 
  alpha_l[12] = 1.414213562373095*E1[7]-1.0*p0_over_gamma_l[0]*B2[7]; 
  alpha_l[13] = -1.0*p0_over_gamma_l[1]*B2[4]; 
  alpha_l[14] = -1.0*p0_over_gamma_l[1]*B2[5]; 
  alpha_l[17] = -1.0*p0_over_gamma_l[1]*B2[6]; 
  alpha_l[18] = -1.0*p0_over_gamma_l[1]*B2[7]; 
  ...
  alpha_r[7] = 1.414213562373095*E1[4]-1.0*p0_over_gamma_r[0]*B2[4]; 
  alpha_r[8] = 1.414213562373095*E1[5]-1.0*p0_over_gamma_r[0]*B2[5]; 
  alpha_r[10] = -1.0*p0_over_gamma_r[1]*B2[3]; 
  alpha_r[11] = 1.414213562373095*E1[6]-1.0*p0_over_gamma_r[0]*B2[6]; 
  alpha_r[12] = 1.414213562373095*E1[7]-1.0*p0_over_gamma_r[0]*B2[7]; 
  alpha_r[13] = -1.0*p0_over_gamma_r[1]*B2[4]; 
  alpha_r[14] = -1.0*p0_over_gamma_r[1]*B2[5]; 
  alpha_r[17] = -1.0*p0_over_gamma_r[1]*B2[6]; 
  alpha_r[18] = -1.0*p0_over_gamma_r[1]*B2[7]; 
