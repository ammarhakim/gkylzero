...
GKYL_CU_DH double vlasov_sr_surfvy_2x2v_ser_p2(const double *w, const double *dxv, const double *p_over_gamma, const double *qmem, const double *fl, const double *fc, const double *fr, double* GKYL_RESTRICT out) 
{ 
  ...
  alpha_l[0] = (-1.58113883008419*B2[0]*p0_over_gamma[5])+1.224744871391589*B2[0]*p0_over_gamma[2]-0.7071067811865475*B2[0]*p0_over_gamma[0]+1.414213562373095*E1[0]; 
  alpha_l[1] = (-1.58113883008419*B2[1]*p0_over_gamma[5])+1.224744871391589*B2[1]*p0_over_gamma[2]+1.414213562373095*E1[1]-0.7071067811865475*p0_over_gamma[0]*B2[1]; 
  alpha_l[2] = (-1.58113883008419*B2[2]*p0_over_gamma[5])+1.224744871391589*B2[2]*p0_over_gamma[2]+1.414213562373095*E1[2]-0.7071067811865475*p0_over_gamma[0]*B2[2]; 
  alpha_l[3] = (-1.58113883008419*B2[0]*p0_over_gamma[7])+1.224744871391589*B2[0]*p0_over_gamma[3]-0.7071067811865475*B2[0]*p0_over_gamma[1]; 
  alpha_l[4] = (-1.58113883008419*B2[3]*p0_over_gamma[5])+1.414213562373095*E1[3]+1.224744871391589*p0_over_gamma[2]*B2[3]-0.7071067811865475*p0_over_gamma[0]*B2[3]; 
  alpha_l[5] = (-1.58113883008419*B2[1]*p0_over_gamma[7])+1.224744871391589*B2[1]*p0_over_gamma[3]-0.7071067811865475*B2[1]*p0_over_gamma[1]; 
  alpha_l[6] = (-1.58113883008419*B2[2]*p0_over_gamma[7])+1.224744871391589*B2[2]*p0_over_gamma[3]-0.7071067811865475*p0_over_gamma[1]*B2[2]; 
  alpha_l[7] = (-1.58113883008419*B2[4]*p0_over_gamma[5])+1.414213562373095*E1[4]+1.224744871391589*p0_over_gamma[2]*B2[4]-0.7071067811865475*p0_over_gamma[0]*B2[4]; 
  alpha_l[8] = (-1.58113883008419*B2[5]*p0_over_gamma[5])+1.414213562373095*E1[5]+1.224744871391589*p0_over_gamma[2]*B2[5]-0.7071067811865475*p0_over_gamma[0]*B2[5]; 
  alpha_l[9] = 1.224744871391589*B2[0]*p0_over_gamma[6]-0.7071067811865475*B2[0]*p0_over_gamma[4]; 
  alpha_l[10] = (-1.58113883008419*B2[3]*p0_over_gamma[7])+1.224744871391589*B2[3]*p0_over_gamma[3]-0.7071067811865475*p0_over_gamma[1]*B2[3]; 
  alpha_l[11] = 1.414213562373095*E1[6]-1.58113883008419*p0_over_gamma[5]*B2[6]+1.224744871391589*p0_over_gamma[2]*B2[6]-0.7071067811865475*p0_over_gamma[0]*B2[6]; 
  alpha_l[12] = 1.414213562373095*E1[7]-1.58113883008419*p0_over_gamma[5]*B2[7]+1.224744871391589*p0_over_gamma[2]*B2[7]-0.7071067811865475*p0_over_gamma[0]*B2[7]; 
  alpha_l[13] = (-1.58113883008419*B2[4]*p0_over_gamma[7])+1.224744871391589*p0_over_gamma[3]*B2[4]-0.7071067811865475*p0_over_gamma[1]*B2[4]; 
  alpha_l[14] = (-1.58113883008419*B2[5]*p0_over_gamma[7])+1.224744871391589*p0_over_gamma[3]*B2[5]-0.7071067811865475*p0_over_gamma[1]*B2[5]; 
  alpha_l[15] = 1.224744871391589*B2[1]*p0_over_gamma[6]-0.7071067811865475*B2[1]*p0_over_gamma[4]; 
  alpha_l[16] = 1.224744871391589*B2[2]*p0_over_gamma[6]-0.7071067811865475*B2[2]*p0_over_gamma[4]; 
  alpha_l[17] = (-1.58113883008419*B2[6]*p0_over_gamma[7])+1.224744871391589*p0_over_gamma[3]*B2[6]-0.7071067811865475*p0_over_gamma[1]*B2[6]; 
  alpha_l[18] = (-1.58113883008419*B2[7]*p0_over_gamma[7])+1.224744871391589*p0_over_gamma[3]*B2[7]-0.7071067811865475*p0_over_gamma[1]*B2[7]; 
  alpha_l[19] = 1.224744871391589*B2[3]*p0_over_gamma[6]-0.7071067811865475*B2[3]*p0_over_gamma[4]; 

  alpha_r[0] = (-1.58113883008419*B2[0]*p0_over_gamma[5])-1.224744871391589*B2[0]*p0_over_gamma[2]-0.7071067811865475*B2[0]*p0_over_gamma[0]+1.414213562373095*E1[0]; 
  alpha_r[1] = (-1.58113883008419*B2[1]*p0_over_gamma[5])-1.224744871391589*B2[1]*p0_over_gamma[2]+1.414213562373095*E1[1]-0.7071067811865475*p0_over_gamma[0]*B2[1]; 
  alpha_r[2] = (-1.58113883008419*B2[2]*p0_over_gamma[5])-1.224744871391589*B2[2]*p0_over_gamma[2]+1.414213562373095*E1[2]-0.7071067811865475*p0_over_gamma[0]*B2[2]; 
  alpha_r[3] = (-1.58113883008419*B2[0]*p0_over_gamma[7])-1.224744871391589*B2[0]*p0_over_gamma[3]-0.7071067811865475*B2[0]*p0_over_gamma[1]; 
  alpha_r[4] = (-1.58113883008419*B2[3]*p0_over_gamma[5])+1.414213562373095*E1[3]-1.224744871391589*p0_over_gamma[2]*B2[3]-0.7071067811865475*p0_over_gamma[0]*B2[3]; 
  alpha_r[5] = (-1.58113883008419*B2[1]*p0_over_gamma[7])-1.224744871391589*B2[1]*p0_over_gamma[3]-0.7071067811865475*B2[1]*p0_over_gamma[1]; 
  alpha_r[6] = (-1.58113883008419*B2[2]*p0_over_gamma[7])-1.224744871391589*B2[2]*p0_over_gamma[3]-0.7071067811865475*p0_over_gamma[1]*B2[2]; 
  alpha_r[7] = (-1.58113883008419*B2[4]*p0_over_gamma[5])+1.414213562373095*E1[4]-1.224744871391589*p0_over_gamma[2]*B2[4]-0.7071067811865475*p0_over_gamma[0]*B2[4]; 
  alpha_r[8] = (-1.58113883008419*B2[5]*p0_over_gamma[5])+1.414213562373095*E1[5]-1.224744871391589*p0_over_gamma[2]*B2[5]-0.7071067811865475*p0_over_gamma[0]*B2[5]; 
  alpha_r[9] = (-1.224744871391589*B2[0]*p0_over_gamma[6])-0.7071067811865475*B2[0]*p0_over_gamma[4]; 
  alpha_r[10] = (-1.58113883008419*B2[3]*p0_over_gamma[7])-1.224744871391589*B2[3]*p0_over_gamma[3]-0.7071067811865475*p0_over_gamma[1]*B2[3]; 
  alpha_r[11] = 1.414213562373095*E1[6]-1.58113883008419*p0_over_gamma[5]*B2[6]-1.224744871391589*p0_over_gamma[2]*B2[6]-0.7071067811865475*p0_over_gamma[0]*B2[6]; 
  alpha_r[12] = 1.414213562373095*E1[7]-1.58113883008419*p0_over_gamma[5]*B2[7]-1.224744871391589*p0_over_gamma[2]*B2[7]-0.7071067811865475*p0_over_gamma[0]*B2[7]; 
  alpha_r[13] = (-1.58113883008419*B2[4]*p0_over_gamma[7])-1.224744871391589*p0_over_gamma[3]*B2[4]-0.7071067811865475*p0_over_gamma[1]*B2[4]; 
  alpha_r[14] = (-1.58113883008419*B2[5]*p0_over_gamma[7])-1.224744871391589*p0_over_gamma[3]*B2[5]-0.7071067811865475*p0_over_gamma[1]*B2[5]; 
  alpha_r[15] = (-1.224744871391589*B2[1]*p0_over_gamma[6])-0.7071067811865475*B2[1]*p0_over_gamma[4]; 
  alpha_r[16] = (-1.224744871391589*B2[2]*p0_over_gamma[6])-0.7071067811865475*B2[2]*p0_over_gamma[4]; 
  alpha_r[17] = (-1.58113883008419*B2[6]*p0_over_gamma[7])-1.224744871391589*p0_over_gamma[3]*B2[6]-0.7071067811865475*p0_over_gamma[1]*B2[6]; 
  alpha_r[18] = (-1.58113883008419*B2[7]*p0_over_gamma[7])-1.224744871391589*p0_over_gamma[3]*B2[7]-0.7071067811865475*p0_over_gamma[1]*B2[7]; 
  alpha_r[19] = (-1.224744871391589*B2[3]*p0_over_gamma[6])-0.7071067811865475*B2[3]*p0_over_gamma[4]; 
