...
{ 
  ...
  p_fac[5] = (-1.414213562373095*GammaV[1]*temp[7])+0.4517539514526256*gamma_inv[2]*temp_sq[5]+0.7071067811865475*gamma_inv[0]*temp_sq[5]-1.414213562373095*GammaV[0]*temp[5]+GammaV_sq[0]*gamma[2]+0.6324555320336759*gamma_inv[1]*temp_sq[2]+0.7071067811865475*temp_sq[0]*gamma_inv[2]-1.414213562373095*gamma_inv[2]; 
  ...
  p_fac[7] = 0.4517539514526256*gamma_inv[2]*temp_sq[7]+0.7071067811865475*gamma_inv[0]*temp_sq[7]-1.264911064067352*GammaV[2]*temp[7]-1.414213562373095*GammaV[0]*temp[7]-1.414213562373095*GammaV[1]*temp[5]+0.632455532033676*gamma_inv[1]*temp_sq[3]+1.0*GammaV_sq[1]*gamma[2]+0.7071067811865475*temp_sq[1]*gamma_inv[2]; 
