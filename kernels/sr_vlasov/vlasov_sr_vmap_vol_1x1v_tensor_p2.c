...
{ 
  ...
  out[3] += 0.7745966692414833*(alpha_vdim[7]*f[8]+f[7]*alpha_vdim[8])+0.8660254037844386*(alpha_vdim[5]*f[7]+f[5]*alpha_vdim[7])+0.7745966692414833*(alpha_vdim[3]*f[6]+f[3]*alpha_vdim[6]+alpha_cdim[2]*f[5]+f[2]*alpha_cdim[5]+alpha_vdim[1]*f[4]+f[1]*alpha_vdim[4])+0.8660254037844386*(alpha_vdim[2]*f[3]+f[2]*(alpha_vdim[3]+alpha_cdim[0])+f[0]*alpha_cdim[2]+alpha_vdim[0]*f[1]+f[0]*alpha_vdim[1]); 
  ...
  out[8] += (1.106566670344976*alpha_vdim[6]+1.732050807568877*alpha_vdim[2])*f[8]+(1.106566670344976*f[6]+1.732050807568877*f[2])*alpha_vdim[8]+(1.237179148263484*alpha_cdim[5]+1.549193338482967*alpha_vdim[3]+1.936491673103709*alpha_cdim[0])*f[7]+1.549193338482967*f[3]*alpha_vdim[7]+(1.732050807568877*alpha_vdim[5]+1.237179148263484*alpha_vdim[4]+1.936491673103709*alpha_vdim[0])*f[6]+(1.732050807568877*f[5]+1.237179148263484*f[4])*alpha_vdim[6]+1.936491673103709*(f[0]*alpha_vdim[6]+f[1]*alpha_cdim[5]+alpha_vdim[2]*f[4]+f[2]*alpha_vdim[4])+1.732050807568877*((alpha_cdim[2]+alpha_vdim[1])*f[3]+f[1]*alpha_vdim[3]); 
