...
{ 
  ...
  alpha_l[4] = 2.23606797749979*E1[2]*jacob_vel_inv1[2]-1.732050807568877*jacob_vel_inv1[1]*E1[2]+jacob_vel_inv1[0]*E1[2]-1.0*p0_over_gamma_l[0]*B2[2]; 
  ...
  alpha_r[4] = 2.23606797749979*E1[2]*jacob_vel_inv1[2]+1.732050807568877*jacob_vel_inv1[1]*E1[2]+jacob_vel_inv1[0]*E1[2]-1.0*p0_over_gamma_r[0]*B2[2]; 
