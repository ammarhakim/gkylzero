...
{ 
  ...
  alpha_l[7] = 2.0*E0[2]+p1_over_gamma_l[0]*B2[2]-1.0*p2_over_gamma_l[0]*B1[2]; 
  alpha_l[8] = -1.0*B1[0]*p2_over_gamma_l[4]; 
  alpha_l[9] = B2[0]*p1_over_gamma_l[5]; 
  alpha_l[10] = B2[1]*p1_over_gamma_l[3]-1.0*B1[1]*p2_over_gamma_l[3]; 
  alpha_l[11] = 1.0*p1_over_gamma_l[1]*B2[2]-1.0*p2_over_gamma_l[1]*B1[2]; 
  alpha_l[12] = -1.0*B1[1]*p2_over_gamma_l[4]; 
  alpha_l[13] = 1.0*B2[2]*p1_over_gamma_l[2]-1.0*B1[2]*p2_over_gamma_l[2]; 
  alpha_l[15] = 1.0*B2[1]*p1_over_gamma_l[5]; 
  alpha_l[17] = B2[2]*p1_over_gamma_l[3]-1.0*B1[2]*p2_over_gamma_l[3]; 
  ...
  alpha_r[7] = 2.0*E0[2]+p1_over_gamma_r[0]*B2[2]-1.0*p2_over_gamma_r[0]*B1[2]; 
  alpha_r[8] = -1.0*B1[0]*p2_over_gamma_r[4]; 
  alpha_r[9] = B2[0]*p1_over_gamma_r[5]; 
  alpha_r[10] = B2[1]*p1_over_gamma_r[3]-1.0*B1[1]*p2_over_gamma_r[3]; 
  alpha_r[11] = 1.0*p1_over_gamma_r[1]*B2[2]-1.0*p2_over_gamma_r[1]*B1[2]; 
  alpha_r[12] = -1.0*B1[1]*p2_over_gamma_r[4]; 
  alpha_r[13] = 1.0*B2[2]*p1_over_gamma_r[2]-1.0*B1[2]*p2_over_gamma_r[2]; 
  alpha_r[15] = 1.0*B2[1]*p1_over_gamma_r[5]; 
  alpha_r[17] = B2[2]*p1_over_gamma_r[3]-1.0*B1[2]*p2_over_gamma_r[3]; 
