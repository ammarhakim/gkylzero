...
{ 
  ...
  out[8] += ((2.5*Ghat_l[2]-2.5*Ghat_r[2])*jacob_vel_inv0[2]+((-1.936491673103709*jacob_vel_inv0[1])-1.118033988749895*jacob_vel_inv0[0])*Ghat_r[2]+(1.118033988749895*jacob_vel_inv0[0]-1.936491673103709*jacob_vel_inv0[1])*Ghat_l[2])*dv10; 
