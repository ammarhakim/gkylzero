...
{ 
  ...
  fUpwind_l[8] = 1.224744871391589*fl[17]+0.7071067811865475*fl[16]; 
  fUpwind_l[9] = 1.224744871391589*fl[20]+0.7071067811865475*fl[18]; 
  fUpwind_l[10] = 1.224744871391589*fl[21]+0.7071067811865475*fl[19]; 
  fUpwind_l[11] = 1.224744871391589*fl[23]+0.7071067811865475*fl[22]; 
  fUpwind_l[12] = 1.224744871391589*fl[25]+0.7071067811865475*fl[24]; 
  fUpwind_l[13] = 1.224744871391589*fl[28]+0.7071067811865475*fl[26]; 
  fUpwind_l[14] = 1.224744871391589*fl[29]+0.7071067811865475*fl[27]; 
  ...
  fUpwind_r[8] = 1.224744871391589*fc[17]+0.7071067811865475*fc[16]; 
  fUpwind_r[9] = 1.224744871391589*fc[20]+0.7071067811865475*fc[18]; 
  fUpwind_r[10] = 1.224744871391589*fc[21]+0.7071067811865475*fc[19]; 
  fUpwind_r[11] = 1.224744871391589*fc[23]+0.7071067811865475*fc[22]; 
  fUpwind_r[12] = 1.224744871391589*fc[25]+0.7071067811865475*fc[24]; 
  fUpwind_r[13] = 1.224744871391589*fc[28]+0.7071067811865475*fc[26]; 
  fUpwind_r[14] = 1.224744871391589*fc[29]+0.7071067811865475*fc[27]; 
  ...
  fUpwind_l[8] = 0.7071067811865475*fc[16]-1.224744871391589*fc[17]; 
  fUpwind_l[9] = 0.7071067811865475*fc[18]-1.224744871391589*fc[20]; 
  fUpwind_l[10] = 0.7071067811865475*fc[19]-1.224744871391589*fc[21]; 
  fUpwind_l[11] = 0.7071067811865475*fc[22]-1.224744871391589*fc[23]; 
  fUpwind_l[12] = 0.7071067811865475*fc[24]-1.224744871391589*fc[25]; 
  fUpwind_l[13] = 0.7071067811865475*fc[26]-1.224744871391589*fc[28]; 
  fUpwind_l[14] = 0.7071067811865475*fc[27]-1.224744871391589*fc[29]; 
  ...
  fUpwind_r[8] = 0.7071067811865475*fr[16]-1.224744871391589*fr[17]; 
  fUpwind_r[9] = 0.7071067811865475*fr[18]-1.224744871391589*fr[20]; 
  fUpwind_r[10] = 0.7071067811865475*fr[19]-1.224744871391589*fr[21]; 
  fUpwind_r[11] = 0.7071067811865475*fr[22]-1.224744871391589*fr[23]; 
  fUpwind_r[12] = 0.7071067811865475*fr[24]-1.224744871391589*fr[25]; 
  fUpwind_r[13] = 0.7071067811865475*fr[26]-1.224744871391589*fr[28]; 
  fUpwind_r[14] = 0.7071067811865475*fr[27]-1.224744871391589*fr[29]; 
