...
GKYL_CU_DH double vlasov_sr_vmap_boundary_surfvx_2x2v_ser_p1(const double *w, const double *dxv, const double *jacob_vel_inv, const double *gamma, const double *qmem, const int edge, const double *fEdge, const double *fSkin, double* GKYL_RESTRICT out) 
{ 
  ...
  alpha[8] = B2[0]*p1_over_gamma_r[2]; 
  alpha[9] = 1.0*B2[1]*p1_over_gamma_r[2]; 
  alpha[10] = 1.0*B2[2]*p1_over_gamma_r[2]; 
  alpha[11] = p1_over_gamma_r[2]*B2[3]; 
  ...
  out[12] += ((-1.118033988749895*jacob_vel_inv0[2])-0.8660254037844386*jacob_vel_inv0[1]-0.5*jacob_vel_inv0[0])*Ghat[7]*dv10; 
  out[13] += ((-1.936491673103709*jacob_vel_inv0[2])-1.5*jacob_vel_inv0[1]-0.8660254037844386*jacob_vel_inv0[0])*Ghat[5]*dv10; 
  ...
  out[26] += ((-1.118033988749895*jacob_vel_inv0[2])-0.8660254037844386*jacob_vel_inv0[1]-0.5*jacob_vel_inv0[0])*Ghat[10]*dv10; 
  out[27] += ((-1.936491673103709*jacob_vel_inv0[2])-1.5*jacob_vel_inv0[1]-0.8660254037844387*jacob_vel_inv0[0])*Ghat[8]*dv10; 
  out[28] += ((-1.118033988749895*jacob_vel_inv0[2])-0.8660254037844386*jacob_vel_inv0[1]-0.5*jacob_vel_inv0[0])*Ghat[11]*dv10; 
  ...
  alpha[8] = B2[0]*p1_over_gamma_l[2]; 
  alpha[9] = 1.0*B2[1]*p1_over_gamma_l[2]; 
  alpha[10] = 1.0*B2[2]*p1_over_gamma_l[2]; 
  alpha[11] = p1_over_gamma_l[2]*B2[3]; 
