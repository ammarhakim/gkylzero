...
GKYL_CU_DH double vlasov_sr_boundary_surfvx_1x3v_ser_p1(const double *w, const double *dxv, const double *jacob_vel_inv, const double *gamma, const double *qmem, const int edge, const double *fEdge, const double *fSkin, double* GKYL_RESTRICT out) 
{ 
  ...
  alpha[9] = -1.0*B1[1]*p2_over_gamma_r[4]; 
  alpha[12] = B2[0]*p1_over_gamma_r[5]; 
  alpha[13] = 1.0*B2[1]*p1_over_gamma_r[5]; 
  ...
  alpha[9] = -1.0*B1[1]*p2_over_gamma_l[4]; 
  alpha[12] = B2[0]*p1_over_gamma_l[5]; 
  alpha[13] = 1.0*B2[1]*p1_over_gamma_l[5]; 
