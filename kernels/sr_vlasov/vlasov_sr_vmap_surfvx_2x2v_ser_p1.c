...
{ 
  ...
  out[2] += ((1.118033988749895*Ghat_l[2]-1.118033988749895*Ghat_r[2])*jacob_vel_inv0[2]+((-0.8660254037844386*jacob_vel_inv0[1])-0.5*jacob_vel_inv0[0])*Ghat_r[2]+(0.5*jacob_vel_inv0[0]-0.8660254037844386*jacob_vel_inv0[1])*Ghat_l[2])*dv10; 
  out[3] += ((-1.936491673103709*(Ghat_r[0]+Ghat_l[0])*jacob_vel_inv0[2])+(1.5*Ghat_l[0]-1.5*Ghat_r[0])*jacob_vel_inv0[1]-0.8660254037844386*(Ghat_r[0]+Ghat_l[0])*jacob_vel_inv0[0])*dv10; 
  ...
  out[5] += (((-1.118033988749895*jacob_vel_inv0[2])-0.8660254037844386*jacob_vel_inv0[1]-0.5*jacob_vel_inv0[0])*Ghat_r[4]+(1.118033988749895*jacob_vel_inv0[2]-0.8660254037844386*jacob_vel_inv0[1]+0.5*jacob_vel_inv0[0])*Ghat_l[4])*dv10; 
  out[6] += ((-1.936491673103709*(Ghat_r[1]+Ghat_l[1])*jacob_vel_inv0[2])+(1.5*Ghat_l[1]-1.5*Ghat_r[1])*jacob_vel_inv0[1]-0.8660254037844386*jacob_vel_inv0[0]*(Ghat_r[1]+Ghat_l[1]))*dv10; 
  ...
  out[9] += (((-1.118033988749895*jacob_vel_inv0[2])-0.8660254037844386*jacob_vel_inv0[1]-0.5*jacob_vel_inv0[0])*Ghat_r[6]+(1.118033988749895*jacob_vel_inv0[2]-0.8660254037844386*jacob_vel_inv0[1]+0.5*jacob_vel_inv0[0])*Ghat_l[6])*dv10; 
  ...
  out[12] += (((-1.118033988749895*jacob_vel_inv0[2])-0.8660254037844386*jacob_vel_inv0[1]-0.5*jacob_vel_inv0[0])*Ghat_r[7]+(1.118033988749895*jacob_vel_inv0[2]-0.8660254037844386*jacob_vel_inv0[1]+0.5*jacob_vel_inv0[0])*Ghat_l[7])*dv10; 
  out[13] += (((-1.936491673103709*jacob_vel_inv0[2])-1.5*jacob_vel_inv0[1]-0.8660254037844386*jacob_vel_inv0[0])*Ghat_r[5]+((-1.936491673103709*jacob_vel_inv0[2])+1.5*jacob_vel_inv0[1]-0.8660254037844386*jacob_vel_inv0[0])*Ghat_l[5])*dv10; 
  ...
  out[26] += (((-1.118033988749895*jacob_vel_inv0[2])-0.8660254037844386*jacob_vel_inv0[1]-0.5*jacob_vel_inv0[0])*Ghat_r[10]+(1.118033988749895*jacob_vel_inv0[2]-0.8660254037844386*jacob_vel_inv0[1]+0.5*jacob_vel_inv0[0])*Ghat_l[10])*dv10; 
  out[27] += (((-1.936491673103709*jacob_vel_inv0[2])-1.5*jacob_vel_inv0[1]-0.8660254037844387*jacob_vel_inv0[0])*Ghat_r[8]+((-1.936491673103709*jacob_vel_inv0[2])+1.5*jacob_vel_inv0[1]-0.8660254037844387*jacob_vel_inv0[0])*Ghat_l[8])*dv10; 
  out[28] += (((-1.118033988749895*jacob_vel_inv0[2])-0.8660254037844386*jacob_vel_inv0[1]-0.5*jacob_vel_inv0[0])*Ghat_r[11]+(1.118033988749895*jacob_vel_inv0[2]-0.8660254037844386*jacob_vel_inv0[1]+0.5*jacob_vel_inv0[0])*Ghat_l[11])*dv10; 
  out[29] += (((-1.936491673103709*jacob_vel_inv0[2])-1.5*jacob_vel_inv0[1]-0.8660254037844387*jacob_vel_inv0[0])*Ghat_r[9]+((-1.936491673103709*jacob_vel_inv0[2])+1.5*jacob_vel_inv0[1]-0.8660254037844387*jacob_vel_inv0[0])*Ghat_l[9])*dv10; 
