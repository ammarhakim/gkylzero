...
{ 
  ...
  alpha_l[0] = (-1.224744871391589*B0[0]*p2_over_gamma[2])+1.224744871391589*B2[0]*p0_over_gamma[2]+0.7071067811865475*B0[0]*p2_over_gamma[0]-0.7071067811865475*B2[0]*p0_over_gamma[0]+2.0*E1[0]; 
  alpha_l[1] = (-1.224744871391589*B0[1]*p2_over_gamma[2])+1.224744871391589*B2[1]*p0_over_gamma[2]+2.0*E1[1]-0.7071067811865475*p0_over_gamma[0]*B2[1]+0.7071067811865475*p2_over_gamma[0]*B0[1]; 
  alpha_l[2] = (-1.224744871391589*B0[2]*p2_over_gamma[2])+1.224744871391589*B2[2]*p0_over_gamma[2]+2.0*E1[2]-0.7071067811865475*p0_over_gamma[0]*B2[2]+0.7071067811865475*p2_over_gamma[0]*B0[2]; 
  alpha_l[3] = 2.0*E1[3]+1.224744871391589*p0_over_gamma[2]*B2[3]-0.7071067811865475*p0_over_gamma[0]*B2[3]-1.224744871391589*p2_over_gamma[2]*B0[3]+0.7071067811865475*p2_over_gamma[0]*B0[3]; 
  alpha_l[4] = (-1.224744871391589*B0[0]*p2_over_gamma[4])+1.224744871391589*B2[0]*p0_over_gamma[4]+0.7071067811865475*B0[0]*p2_over_gamma[1]-0.7071067811865475*B2[0]*p0_over_gamma[1]; 
  alpha_l[5] = (-1.224744871391589*B0[0]*p2_over_gamma[6])+1.224744871391589*B2[0]*p0_over_gamma[6]+0.7071067811865475*B0[0]*p2_over_gamma[3]-0.7071067811865475*B2[0]*p0_over_gamma[3]; 
  alpha_l[6] = 2.0*E1[4]+1.224744871391589*p0_over_gamma[2]*B2[4]-0.7071067811865475*p0_over_gamma[0]*B2[4]-1.224744871391589*p2_over_gamma[2]*B0[4]+0.7071067811865475*p2_over_gamma[0]*B0[4]; 
  alpha_l[7] = 2.0*E1[5]+1.224744871391589*p0_over_gamma[2]*B2[5]-0.7071067811865475*p0_over_gamma[0]*B2[5]-1.224744871391589*p2_over_gamma[2]*B0[5]+0.7071067811865475*p2_over_gamma[0]*B0[5]; 
  alpha_l[8] = 2.0*E1[6]+1.224744871391589*p0_over_gamma[2]*B2[6]-0.7071067811865475*p0_over_gamma[0]*B2[6]-1.224744871391589*p2_over_gamma[2]*B0[6]+0.7071067811865475*p2_over_gamma[0]*B0[6]; 
  alpha_l[9] = (-1.224744871391589*B0[1]*p2_over_gamma[4])+1.224744871391589*B2[1]*p0_over_gamma[4]+0.7071067811865475*B0[1]*p2_over_gamma[1]-0.7071067811865475*B2[1]*p0_over_gamma[1]; 
  alpha_l[10] = (-1.224744871391589*B0[2]*p2_over_gamma[4])+1.224744871391589*B2[2]*p0_over_gamma[4]-0.7071067811865475*p0_over_gamma[1]*B2[2]+0.7071067811865475*p2_over_gamma[1]*B0[2]; 
  alpha_l[11] = (-1.224744871391589*B0[3]*p2_over_gamma[4])+1.224744871391589*B2[3]*p0_over_gamma[4]-0.7071067811865475*p0_over_gamma[1]*B2[3]+0.7071067811865475*p2_over_gamma[1]*B0[3]; 
  alpha_l[12] = (-1.224744871391589*B0[1]*p2_over_gamma[6])+1.224744871391589*B2[1]*p0_over_gamma[6]+0.7071067811865475*B0[1]*p2_over_gamma[3]-0.7071067811865475*B2[1]*p0_over_gamma[3]; 
  alpha_l[13] = (-1.224744871391589*B0[2]*p2_over_gamma[6])+1.224744871391589*B2[2]*p0_over_gamma[6]+0.7071067811865475*B0[2]*p2_over_gamma[3]-0.7071067811865475*B2[2]*p0_over_gamma[3]; 
  alpha_l[14] = (-1.224744871391589*B0[3]*p2_over_gamma[6])+1.224744871391589*B2[3]*p0_over_gamma[6]+0.7071067811865475*B0[3]*p2_over_gamma[3]-0.7071067811865475*B2[3]*p0_over_gamma[3]; 
  alpha_l[15] = (-1.224744871391589*B0[0]*p2_over_gamma[7])+1.224744871391589*B2[0]*p0_over_gamma[7]+0.7071067811865475*B0[0]*p2_over_gamma[5]-0.7071067811865475*B2[0]*p0_over_gamma[5]; 
  alpha_l[16] = 2.0*E1[7]+1.224744871391589*p0_over_gamma[2]*B2[7]-0.7071067811865475*p0_over_gamma[0]*B2[7]-1.224744871391589*p2_over_gamma[2]*B0[7]+0.7071067811865475*p2_over_gamma[0]*B0[7]; 
  alpha_l[17] = (-1.224744871391589*B0[4]*p2_over_gamma[4])+1.224744871391589*B2[4]*p0_over_gamma[4]-0.7071067811865475*p0_over_gamma[1]*B2[4]+0.7071067811865475*p2_over_gamma[1]*B0[4]; 
  alpha_l[18] = 1.224744871391589*p0_over_gamma[4]*B2[5]-0.7071067811865475*p0_over_gamma[1]*B2[5]-1.224744871391589*p2_over_gamma[4]*B0[5]+0.7071067811865475*p2_over_gamma[1]*B0[5]; 
  alpha_l[19] = 1.224744871391589*p0_over_gamma[4]*B2[6]-0.7071067811865475*p0_over_gamma[1]*B2[6]-1.224744871391589*p2_over_gamma[4]*B0[6]+0.7071067811865475*p2_over_gamma[1]*B0[6]; 
  alpha_l[20] = (-1.224744871391589*B0[4]*p2_over_gamma[6])+1.224744871391589*B2[4]*p0_over_gamma[6]-0.7071067811865475*p0_over_gamma[3]*B2[4]+0.7071067811865475*p2_over_gamma[3]*B0[4]; 
  alpha_l[21] = (-1.224744871391589*B0[5]*p2_over_gamma[6])+1.224744871391589*B2[5]*p0_over_gamma[6]-0.7071067811865475*p0_over_gamma[3]*B2[5]+0.7071067811865475*p2_over_gamma[3]*B0[5]; 
  alpha_l[22] = (-1.224744871391589*B0[6]*p2_over_gamma[6])+1.224744871391589*B2[6]*p0_over_gamma[6]-0.7071067811865475*p0_over_gamma[3]*B2[6]+0.7071067811865475*p2_over_gamma[3]*B0[6]; 
  alpha_l[23] = (-1.224744871391589*B0[1]*p2_over_gamma[7])+1.224744871391589*B2[1]*p0_over_gamma[7]+0.7071067811865475*B0[1]*p2_over_gamma[5]-0.7071067811865475*B2[1]*p0_over_gamma[5]; 
  alpha_l[24] = (-1.224744871391589*B0[2]*p2_over_gamma[7])+1.224744871391589*B2[2]*p0_over_gamma[7]+0.7071067811865475*B0[2]*p2_over_gamma[5]-0.7071067811865475*B2[2]*p0_over_gamma[5]; 
  alpha_l[25] = (-1.224744871391589*B0[3]*p2_over_gamma[7])+1.224744871391589*B2[3]*p0_over_gamma[7]+0.7071067811865475*B0[3]*p2_over_gamma[5]-0.7071067811865475*B2[3]*p0_over_gamma[5]; 
  alpha_l[26] = 1.224744871391589*p0_over_gamma[4]*B2[7]-0.7071067811865475*p0_over_gamma[1]*B2[7]-1.224744871391589*p2_over_gamma[4]*B0[7]+0.7071067811865475*p2_over_gamma[1]*B0[7]; 
  alpha_l[27] = 1.224744871391589*p0_over_gamma[6]*B2[7]-0.7071067811865475*p0_over_gamma[3]*B2[7]-1.224744871391589*p2_over_gamma[6]*B0[7]+0.7071067811865475*p2_over_gamma[3]*B0[7]; 
  alpha_l[28] = (-1.224744871391589*B0[4]*p2_over_gamma[7])+1.224744871391589*B2[4]*p0_over_gamma[7]+0.7071067811865475*B0[4]*p2_over_gamma[5]-0.7071067811865475*B2[4]*p0_over_gamma[5]; 
  alpha_l[29] = (-1.224744871391589*B0[5]*p2_over_gamma[7])+1.224744871391589*B2[5]*p0_over_gamma[7]+0.7071067811865475*B0[5]*p2_over_gamma[5]-0.7071067811865475*B2[5]*p0_over_gamma[5]; 
  alpha_l[30] = (-1.224744871391589*B0[6]*p2_over_gamma[7])+1.224744871391589*B2[6]*p0_over_gamma[7]-0.7071067811865475*p0_over_gamma[5]*B2[6]+0.7071067811865475*p2_over_gamma[5]*B0[6]; 
  alpha_l[31] = (-1.224744871391589*B0[7]*p2_over_gamma[7])+1.224744871391589*B2[7]*p0_over_gamma[7]-0.7071067811865475*p0_over_gamma[5]*B2[7]+0.7071067811865475*p2_over_gamma[5]*B0[7]; 

  alpha_r[0] = 1.224744871391589*B0[0]*p2_over_gamma[2]-1.224744871391589*B2[0]*p0_over_gamma[2]+0.7071067811865475*B0[0]*p2_over_gamma[0]-0.7071067811865475*B2[0]*p0_over_gamma[0]+2.0*E1[0]; 
  alpha_r[1] = 1.224744871391589*B0[1]*p2_over_gamma[2]-1.224744871391589*B2[1]*p0_over_gamma[2]+2.0*E1[1]-0.7071067811865475*p0_over_gamma[0]*B2[1]+0.7071067811865475*p2_over_gamma[0]*B0[1]; 
  alpha_r[2] = 1.224744871391589*B0[2]*p2_over_gamma[2]-1.224744871391589*B2[2]*p0_over_gamma[2]+2.0*E1[2]-0.7071067811865475*p0_over_gamma[0]*B2[2]+0.7071067811865475*p2_over_gamma[0]*B0[2]; 
  alpha_r[3] = 2.0*E1[3]-1.224744871391589*p0_over_gamma[2]*B2[3]-0.7071067811865475*p0_over_gamma[0]*B2[3]+1.224744871391589*p2_over_gamma[2]*B0[3]+0.7071067811865475*p2_over_gamma[0]*B0[3]; 
  alpha_r[4] = 1.224744871391589*B0[0]*p2_over_gamma[4]-1.224744871391589*B2[0]*p0_over_gamma[4]+0.7071067811865475*B0[0]*p2_over_gamma[1]-0.7071067811865475*B2[0]*p0_over_gamma[1]; 
  alpha_r[5] = 1.224744871391589*B0[0]*p2_over_gamma[6]-1.224744871391589*B2[0]*p0_over_gamma[6]+0.7071067811865475*B0[0]*p2_over_gamma[3]-0.7071067811865475*B2[0]*p0_over_gamma[3]; 
  alpha_r[6] = 2.0*E1[4]-1.224744871391589*p0_over_gamma[2]*B2[4]-0.7071067811865475*p0_over_gamma[0]*B2[4]+1.224744871391589*p2_over_gamma[2]*B0[4]+0.7071067811865475*p2_over_gamma[0]*B0[4]; 
  alpha_r[7] = 2.0*E1[5]-1.224744871391589*p0_over_gamma[2]*B2[5]-0.7071067811865475*p0_over_gamma[0]*B2[5]+1.224744871391589*p2_over_gamma[2]*B0[5]+0.7071067811865475*p2_over_gamma[0]*B0[5]; 
  alpha_r[8] = 2.0*E1[6]-1.224744871391589*p0_over_gamma[2]*B2[6]-0.7071067811865475*p0_over_gamma[0]*B2[6]+1.224744871391589*p2_over_gamma[2]*B0[6]+0.7071067811865475*p2_over_gamma[0]*B0[6]; 
  alpha_r[9] = 1.224744871391589*B0[1]*p2_over_gamma[4]-1.224744871391589*B2[1]*p0_over_gamma[4]+0.7071067811865475*B0[1]*p2_over_gamma[1]-0.7071067811865475*B2[1]*p0_over_gamma[1]; 
  alpha_r[10] = 1.224744871391589*B0[2]*p2_over_gamma[4]-1.224744871391589*B2[2]*p0_over_gamma[4]-0.7071067811865475*p0_over_gamma[1]*B2[2]+0.7071067811865475*p2_over_gamma[1]*B0[2]; 
  alpha_r[11] = 1.224744871391589*B0[3]*p2_over_gamma[4]-1.224744871391589*B2[3]*p0_over_gamma[4]-0.7071067811865475*p0_over_gamma[1]*B2[3]+0.7071067811865475*p2_over_gamma[1]*B0[3]; 
  alpha_r[12] = 1.224744871391589*B0[1]*p2_over_gamma[6]-1.224744871391589*B2[1]*p0_over_gamma[6]+0.7071067811865475*B0[1]*p2_over_gamma[3]-0.7071067811865475*B2[1]*p0_over_gamma[3]; 
  alpha_r[13] = 1.224744871391589*B0[2]*p2_over_gamma[6]-1.224744871391589*B2[2]*p0_over_gamma[6]+0.7071067811865475*B0[2]*p2_over_gamma[3]-0.7071067811865475*B2[2]*p0_over_gamma[3]; 
  alpha_r[14] = 1.224744871391589*B0[3]*p2_over_gamma[6]-1.224744871391589*B2[3]*p0_over_gamma[6]+0.7071067811865475*B0[3]*p2_over_gamma[3]-0.7071067811865475*B2[3]*p0_over_gamma[3]; 
  alpha_r[15] = 1.224744871391589*B0[0]*p2_over_gamma[7]-1.224744871391589*B2[0]*p0_over_gamma[7]+0.7071067811865475*B0[0]*p2_over_gamma[5]-0.7071067811865475*B2[0]*p0_over_gamma[5]; 
  alpha_r[16] = 2.0*E1[7]-1.224744871391589*p0_over_gamma[2]*B2[7]-0.7071067811865475*p0_over_gamma[0]*B2[7]+1.224744871391589*p2_over_gamma[2]*B0[7]+0.7071067811865475*p2_over_gamma[0]*B0[7]; 
  alpha_r[17] = 1.224744871391589*B0[4]*p2_over_gamma[4]-1.224744871391589*B2[4]*p0_over_gamma[4]-0.7071067811865475*p0_over_gamma[1]*B2[4]+0.7071067811865475*p2_over_gamma[1]*B0[4]; 
  alpha_r[18] = (-1.224744871391589*p0_over_gamma[4]*B2[5])-0.7071067811865475*p0_over_gamma[1]*B2[5]+1.224744871391589*p2_over_gamma[4]*B0[5]+0.7071067811865475*p2_over_gamma[1]*B0[5]; 
  alpha_r[19] = (-1.224744871391589*p0_over_gamma[4]*B2[6])-0.7071067811865475*p0_over_gamma[1]*B2[6]+1.224744871391589*p2_over_gamma[4]*B0[6]+0.7071067811865475*p2_over_gamma[1]*B0[6]; 
  alpha_r[20] = 1.224744871391589*B0[4]*p2_over_gamma[6]-1.224744871391589*B2[4]*p0_over_gamma[6]-0.7071067811865475*p0_over_gamma[3]*B2[4]+0.7071067811865475*p2_over_gamma[3]*B0[4]; 
  alpha_r[21] = 1.224744871391589*B0[5]*p2_over_gamma[6]-1.224744871391589*B2[5]*p0_over_gamma[6]-0.7071067811865475*p0_over_gamma[3]*B2[5]+0.7071067811865475*p2_over_gamma[3]*B0[5]; 
  alpha_r[22] = 1.224744871391589*B0[6]*p2_over_gamma[6]-1.224744871391589*B2[6]*p0_over_gamma[6]-0.7071067811865475*p0_over_gamma[3]*B2[6]+0.7071067811865475*p2_over_gamma[3]*B0[6]; 
  alpha_r[23] = 1.224744871391589*B0[1]*p2_over_gamma[7]-1.224744871391589*B2[1]*p0_over_gamma[7]+0.7071067811865475*B0[1]*p2_over_gamma[5]-0.7071067811865475*B2[1]*p0_over_gamma[5]; 
  alpha_r[24] = 1.224744871391589*B0[2]*p2_over_gamma[7]-1.224744871391589*B2[2]*p0_over_gamma[7]+0.7071067811865475*B0[2]*p2_over_gamma[5]-0.7071067811865475*B2[2]*p0_over_gamma[5]; 
  alpha_r[25] = 1.224744871391589*B0[3]*p2_over_gamma[7]-1.224744871391589*B2[3]*p0_over_gamma[7]+0.7071067811865475*B0[3]*p2_over_gamma[5]-0.7071067811865475*B2[3]*p0_over_gamma[5]; 
  alpha_r[26] = (-1.224744871391589*p0_over_gamma[4]*B2[7])-0.7071067811865475*p0_over_gamma[1]*B2[7]+1.224744871391589*p2_over_gamma[4]*B0[7]+0.7071067811865475*p2_over_gamma[1]*B0[7]; 
  alpha_r[27] = (-1.224744871391589*p0_over_gamma[6]*B2[7])-0.7071067811865475*p0_over_gamma[3]*B2[7]+1.224744871391589*p2_over_gamma[6]*B0[7]+0.7071067811865475*p2_over_gamma[3]*B0[7]; 
  alpha_r[28] = 1.224744871391589*B0[4]*p2_over_gamma[7]-1.224744871391589*B2[4]*p0_over_gamma[7]+0.7071067811865475*B0[4]*p2_over_gamma[5]-0.7071067811865475*B2[4]*p0_over_gamma[5]; 
  alpha_r[29] = 1.224744871391589*B0[5]*p2_over_gamma[7]-1.224744871391589*B2[5]*p0_over_gamma[7]+0.7071067811865475*B0[5]*p2_over_gamma[5]-0.7071067811865475*B2[5]*p0_over_gamma[5]; 
  alpha_r[30] = 1.224744871391589*B0[6]*p2_over_gamma[7]-1.224744871391589*B2[6]*p0_over_gamma[7]-0.7071067811865475*p0_over_gamma[5]*B2[6]+0.7071067811865475*p2_over_gamma[5]*B0[6]; 
  alpha_r[31] = 1.224744871391589*B0[7]*p2_over_gamma[7]-1.224744871391589*B2[7]*p0_over_gamma[7]-0.7071067811865475*p0_over_gamma[5]*B2[7]+0.7071067811865475*p2_over_gamma[5]*B0[7]; 
