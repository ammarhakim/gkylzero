...
{ 
  ...
  alpha_l[7] = B1[1]*p0_over_gamma_l[3]-1.0*B0[1]*p1_over_gamma_l[3]; 
  alpha_l[8] = B1[0]*p0_over_gamma_l[4]-1.0*B0[0]*p1_over_gamma_l[4]; 
  alpha_l[9] = 1.0*B1[1]*p0_over_gamma_l[4]-1.0*B0[1]*p1_over_gamma_l[4]; 
  alpha_l[10] = B1[0]*p0_over_gamma_l[6]-1.0*B0[0]*p1_over_gamma_l[6]; 
  alpha_l[11] = 1.0*B1[1]*p0_over_gamma_l[6]-1.0*B0[1]*p1_over_gamma_l[6]; 
  alpha_l[12] = B1[0]*p0_over_gamma_l[5]-1.0*B0[0]*p1_over_gamma_l[5]; 
  alpha_l[13] = 1.0*B1[1]*p0_over_gamma_l[5]-1.0*B0[1]*p1_over_gamma_l[5]; 
  alpha_l[14] = B1[0]*p0_over_gamma_l[7]-1.0*B0[0]*p1_over_gamma_l[7]; 
  alpha_l[15] = 1.0*B1[1]*p0_over_gamma_l[7]-1.0*B0[1]*p1_over_gamma_l[7]; 
  ...
  alpha_r[2] = B1[0]*p0_over_gamma_r[1]-1.0*B0[0]*p1_over_gamma_r[1]; 
  alpha_r[3] = B1[0]*p0_over_gamma_r[2]-1.0*B0[0]*p1_over_gamma_r[2]; 
  alpha_r[4] = B1[1]*p0_over_gamma_r[1]-1.0*B0[1]*p1_over_gamma_r[1]; 
  alpha_r[5] = B1[1]*p0_over_gamma_r[2]-1.0*B0[1]*p1_over_gamma_r[2]; 
  alpha_r[6] = B1[0]*p0_over_gamma_r[3]-1.0*B0[0]*p1_over_gamma_r[3]; 
  alpha_r[7] = B1[1]*p0_over_gamma_r[3]-1.0*B0[1]*p1_over_gamma_r[3]; 
  alpha_r[8] = B1[0]*p0_over_gamma_r[4]-1.0*B0[0]*p1_over_gamma_r[4]; 
  alpha_r[9] = 1.0*B1[1]*p0_over_gamma_r[4]-1.0*B0[1]*p1_over_gamma_r[4]; 
  alpha_r[10] = B1[0]*p0_over_gamma_r[6]-1.0*B0[0]*p1_over_gamma_r[6]; 
  alpha_r[11] = 1.0*B1[1]*p0_over_gamma_r[6]-1.0*B0[1]*p1_over_gamma_r[6]; 
  alpha_r[12] = B1[0]*p0_over_gamma_r[5]-1.0*B0[0]*p1_over_gamma_r[5]; 
  alpha_r[13] = 1.0*B1[1]*p0_over_gamma_r[5]-1.0*B0[1]*p1_over_gamma_r[5]; 
  alpha_r[14] = B1[0]*p0_over_gamma_r[7]-1.0*B0[0]*p1_over_gamma_r[7]; 
  alpha_r[15] = 1.0*B1[1]*p0_over_gamma_r[7]-1.0*B0[1]*p1_over_gamma_r[7]; 
  ...
  out[0] += ((1.118033988749895*Ghat_l[0]-1.118033988749895*Ghat_r[0])*jacob_vel_inv2[2]-0.8660254037844386*(Ghat_r[0]+Ghat_l[0])*jacob_vel_inv2[1]+(0.5*Ghat_l[0]-0.5*Ghat_r[0])*jacob_vel_inv2[0])*dv12; 
  out[1] += ((1.118033988749895*Ghat_l[1]-1.118033988749895*Ghat_r[1])*jacob_vel_inv2[2]-0.8660254037844386*(Ghat_r[1]+Ghat_l[1])*jacob_vel_inv2[1]+jacob_vel_inv2[0]*(0.5*Ghat_l[1]-0.5*Ghat_r[1]))*dv12; 
  out[2] += ((1.118033988749895*Ghat_l[2]-1.118033988749895*Ghat_r[2])*jacob_vel_inv2[2]+((-0.8660254037844386*jacob_vel_inv2[1])-0.5*jacob_vel_inv2[0])*Ghat_r[2]+(0.5*jacob_vel_inv2[0]-0.8660254037844386*jacob_vel_inv2[1])*Ghat_l[2])*dv12; 
  out[3] += (((-1.118033988749895*jacob_vel_inv2[2])-0.8660254037844386*jacob_vel_inv2[1]-0.5*jacob_vel_inv2[0])*Ghat_r[3]+(1.118033988749895*jacob_vel_inv2[2]-0.8660254037844386*jacob_vel_inv2[1]+0.5*jacob_vel_inv2[0])*Ghat_l[3])*dv12; 
  out[4] += ((-1.936491673103709*(Ghat_r[0]+Ghat_l[0])*jacob_vel_inv2[2])+(1.5*Ghat_l[0]-1.5*Ghat_r[0])*jacob_vel_inv2[1]-0.8660254037844386*(Ghat_r[0]+Ghat_l[0])*jacob_vel_inv2[0])*dv12; 
  out[5] += (((-1.118033988749895*jacob_vel_inv2[2])-0.8660254037844386*jacob_vel_inv2[1]-0.5*jacob_vel_inv2[0])*Ghat_r[4]+(1.118033988749895*jacob_vel_inv2[2]-0.8660254037844386*jacob_vel_inv2[1]+0.5*jacob_vel_inv2[0])*Ghat_l[4])*dv12; 
  out[6] += (((-1.118033988749895*jacob_vel_inv2[2])-0.8660254037844386*jacob_vel_inv2[1]-0.5*jacob_vel_inv2[0])*Ghat_r[5]+(1.118033988749895*jacob_vel_inv2[2]-0.8660254037844386*jacob_vel_inv2[1]+0.5*jacob_vel_inv2[0])*Ghat_l[5])*dv12; 
  out[7] += (((-1.118033988749895*jacob_vel_inv2[2])-0.8660254037844386*jacob_vel_inv2[1]-0.5*jacob_vel_inv2[0])*Ghat_r[6]+(1.118033988749895*jacob_vel_inv2[2]-0.8660254037844386*jacob_vel_inv2[1]+0.5*jacob_vel_inv2[0])*Ghat_l[6])*dv12; 
  out[8] += ((-1.936491673103709*(Ghat_r[1]+Ghat_l[1])*jacob_vel_inv2[2])+(1.5*Ghat_l[1]-1.5*Ghat_r[1])*jacob_vel_inv2[1]-0.8660254037844386*jacob_vel_inv2[0]*(Ghat_r[1]+Ghat_l[1]))*dv12; 
  out[9] += ((-1.936491673103709*(Ghat_r[2]+Ghat_l[2])*jacob_vel_inv2[2])+((-1.5*jacob_vel_inv2[1])-0.8660254037844386*jacob_vel_inv2[0])*Ghat_r[2]+(1.5*jacob_vel_inv2[1]-0.8660254037844386*jacob_vel_inv2[0])*Ghat_l[2])*dv12; 
  out[10] += (((-1.936491673103709*jacob_vel_inv2[2])-1.5*jacob_vel_inv2[1]-0.8660254037844386*jacob_vel_inv2[0])*Ghat_r[3]+((-1.936491673103709*jacob_vel_inv2[2])+1.5*jacob_vel_inv2[1]-0.8660254037844386*jacob_vel_inv2[0])*Ghat_l[3])*dv12; 
  out[11] += (((-1.118033988749895*jacob_vel_inv2[2])-0.8660254037844386*jacob_vel_inv2[1]-0.5*jacob_vel_inv2[0])*Ghat_r[7]+(1.118033988749895*jacob_vel_inv2[2]-0.8660254037844386*jacob_vel_inv2[1]+0.5*jacob_vel_inv2[0])*Ghat_l[7])*dv12; 
  out[12] += (((-1.936491673103709*jacob_vel_inv2[2])-1.5*jacob_vel_inv2[1]-0.8660254037844386*jacob_vel_inv2[0])*Ghat_r[4]+((-1.936491673103709*jacob_vel_inv2[2])+1.5*jacob_vel_inv2[1]-0.8660254037844386*jacob_vel_inv2[0])*Ghat_l[4])*dv12; 
  out[13] += (((-1.936491673103709*jacob_vel_inv2[2])-1.5*jacob_vel_inv2[1]-0.8660254037844386*jacob_vel_inv2[0])*Ghat_r[5]+((-1.936491673103709*jacob_vel_inv2[2])+1.5*jacob_vel_inv2[1]-0.8660254037844386*jacob_vel_inv2[0])*Ghat_l[5])*dv12; 
  out[14] += (((-1.936491673103709*jacob_vel_inv2[2])-1.5*jacob_vel_inv2[1]-0.8660254037844386*jacob_vel_inv2[0])*Ghat_r[6]+((-1.936491673103709*jacob_vel_inv2[2])+1.5*jacob_vel_inv2[1]-0.8660254037844386*jacob_vel_inv2[0])*Ghat_l[6])*dv12; 
  out[15] += (((-1.936491673103709*jacob_vel_inv2[2])-1.5*jacob_vel_inv2[1]-0.8660254037844386*jacob_vel_inv2[0])*Ghat_r[7]+((-1.936491673103709*jacob_vel_inv2[2])+1.5*jacob_vel_inv2[1]-0.8660254037844386*jacob_vel_inv2[0])*Ghat_l[7])*dv12; 
  out[16] += (((-1.118033988749895*jacob_vel_inv2[2])-0.8660254037844386*jacob_vel_inv2[1]-0.5*jacob_vel_inv2[0])*Ghat_r[8]+(1.118033988749895*jacob_vel_inv2[2]-0.8660254037844386*jacob_vel_inv2[1]+0.5*jacob_vel_inv2[0])*Ghat_l[8])*dv12; 
  out[17] += (((-1.118033988749895*jacob_vel_inv2[2])-0.8660254037844386*jacob_vel_inv2[1]-0.5*jacob_vel_inv2[0])*Ghat_r[9]+(1.118033988749895*jacob_vel_inv2[2]-0.8660254037844386*jacob_vel_inv2[1]+0.5*jacob_vel_inv2[0])*Ghat_l[9])*dv12; 
  out[18] += (((-1.118033988749895*jacob_vel_inv2[2])-0.8660254037844386*jacob_vel_inv2[1]-0.5*jacob_vel_inv2[0])*Ghat_r[10]+(1.118033988749895*jacob_vel_inv2[2]-0.8660254037844386*jacob_vel_inv2[1]+0.5*jacob_vel_inv2[0])*Ghat_l[10])*dv12; 
  out[19] += (((-1.936491673103709*jacob_vel_inv2[2])-1.5*jacob_vel_inv2[1]-0.8660254037844387*jacob_vel_inv2[0])*Ghat_r[8]+((-1.936491673103709*jacob_vel_inv2[2])+1.5*jacob_vel_inv2[1]-0.8660254037844387*jacob_vel_inv2[0])*Ghat_l[8])*dv12; 
  out[20] += (((-1.118033988749895*jacob_vel_inv2[2])-0.8660254037844386*jacob_vel_inv2[1]-0.5*jacob_vel_inv2[0])*Ghat_r[11]+(1.118033988749895*jacob_vel_inv2[2]-0.8660254037844386*jacob_vel_inv2[1]+0.5*jacob_vel_inv2[0])*Ghat_l[11])*dv12; 
  out[21] += (((-1.936491673103709*jacob_vel_inv2[2])-1.5*jacob_vel_inv2[1]-0.8660254037844387*jacob_vel_inv2[0])*Ghat_r[9]+((-1.936491673103709*jacob_vel_inv2[2])+1.5*jacob_vel_inv2[1]-0.8660254037844387*jacob_vel_inv2[0])*Ghat_l[9])*dv12; 
  out[22] += (((-1.936491673103709*jacob_vel_inv2[2])-1.5*jacob_vel_inv2[1]-0.8660254037844387*jacob_vel_inv2[0])*Ghat_r[10]+((-1.936491673103709*jacob_vel_inv2[2])+1.5*jacob_vel_inv2[1]-0.8660254037844387*jacob_vel_inv2[0])*Ghat_l[10])*dv12; 
  out[23] += (((-1.936491673103709*jacob_vel_inv2[2])-1.5*jacob_vel_inv2[1]-0.8660254037844387*jacob_vel_inv2[0])*Ghat_r[11]+((-1.936491673103709*jacob_vel_inv2[2])+1.5*jacob_vel_inv2[1]-0.8660254037844387*jacob_vel_inv2[0])*Ghat_l[11])*dv12; 
  out[24] += (((-1.118033988749895*jacob_vel_inv2[2])-0.8660254037844386*jacob_vel_inv2[1]-0.5*jacob_vel_inv2[0])*Ghat_r[12]+(1.118033988749895*jacob_vel_inv2[2]-0.8660254037844386*jacob_vel_inv2[1]+0.5*jacob_vel_inv2[0])*Ghat_l[12])*dv12; 
  out[25] += (((-1.118033988749895*jacob_vel_inv2[2])-0.8660254037844386*jacob_vel_inv2[1]-0.5*jacob_vel_inv2[0])*Ghat_r[13]+(1.118033988749895*jacob_vel_inv2[2]-0.8660254037844386*jacob_vel_inv2[1]+0.5*jacob_vel_inv2[0])*Ghat_l[13])*dv12; 
  out[26] += (((-1.118033988749895*jacob_vel_inv2[2])-0.8660254037844386*jacob_vel_inv2[1]-0.5*jacob_vel_inv2[0])*Ghat_r[14]+(1.118033988749895*jacob_vel_inv2[2]-0.8660254037844386*jacob_vel_inv2[1]+0.5*jacob_vel_inv2[0])*Ghat_l[14])*dv12; 
  out[27] += (((-1.936491673103709*jacob_vel_inv2[2])-1.5*jacob_vel_inv2[1]-0.8660254037844387*jacob_vel_inv2[0])*Ghat_r[12]+((-1.936491673103709*jacob_vel_inv2[2])+1.5*jacob_vel_inv2[1]-0.8660254037844387*jacob_vel_inv2[0])*Ghat_l[12])*dv12; 
  out[28] += (((-1.118033988749895*jacob_vel_inv2[2])-0.8660254037844386*jacob_vel_inv2[1]-0.5*jacob_vel_inv2[0])*Ghat_r[15]+(1.118033988749895*jacob_vel_inv2[2]-0.8660254037844386*jacob_vel_inv2[1]+0.5*jacob_vel_inv2[0])*Ghat_l[15])*dv12; 
  out[29] += (((-1.936491673103709*jacob_vel_inv2[2])-1.5*jacob_vel_inv2[1]-0.8660254037844387*jacob_vel_inv2[0])*Ghat_r[13]+((-1.936491673103709*jacob_vel_inv2[2])+1.5*jacob_vel_inv2[1]-0.8660254037844387*jacob_vel_inv2[0])*Ghat_l[13])*dv12; 
  out[30] += (((-1.936491673103709*jacob_vel_inv2[2])-1.5*jacob_vel_inv2[1]-0.8660254037844387*jacob_vel_inv2[0])*Ghat_r[14]+((-1.936491673103709*jacob_vel_inv2[2])+1.5*jacob_vel_inv2[1]-0.8660254037844387*jacob_vel_inv2[0])*Ghat_l[14])*dv12; 
  out[31] += (((-1.936491673103709*jacob_vel_inv2[2])-1.5*jacob_vel_inv2[1]-0.8660254037844387*jacob_vel_inv2[0])*Ghat_r[15]+((-1.936491673103709*jacob_vel_inv2[2])+1.5*jacob_vel_inv2[1]-0.8660254037844387*jacob_vel_inv2[0])*Ghat_l[15])*dv12; 
  out[32] += ((2.5*Ghat_l[0]-2.5*Ghat_r[0])*jacob_vel_inv2[2]-1.936491673103709*(Ghat_r[0]+Ghat_l[0])*jacob_vel_inv2[1]+(1.118033988749895*Ghat_l[0]-1.118033988749895*Ghat_r[0])*jacob_vel_inv2[0])*dv12; 
  out[33] += ((2.5*Ghat_l[1]-2.5*Ghat_r[1])*jacob_vel_inv2[2]-1.936491673103709*(Ghat_r[1]+Ghat_l[1])*jacob_vel_inv2[1]+jacob_vel_inv2[0]*(1.118033988749895*Ghat_l[1]-1.118033988749895*Ghat_r[1]))*dv12; 
  out[34] += ((2.5*Ghat_l[2]-2.5*Ghat_r[2])*jacob_vel_inv2[2]+((-1.936491673103709*jacob_vel_inv2[1])-1.118033988749895*jacob_vel_inv2[0])*Ghat_r[2]+(1.118033988749895*jacob_vel_inv2[0]-1.936491673103709*jacob_vel_inv2[1])*Ghat_l[2])*dv12; 
  out[35] += (((-2.5*jacob_vel_inv2[2])-1.936491673103709*jacob_vel_inv2[1]-1.118033988749895*jacob_vel_inv2[0])*Ghat_r[3]+(2.5*jacob_vel_inv2[2]-1.936491673103709*jacob_vel_inv2[1]+1.118033988749895*jacob_vel_inv2[0])*Ghat_l[3])*dv12; 
  out[36] += (((-2.5*jacob_vel_inv2[2])-1.936491673103709*jacob_vel_inv2[1]-1.118033988749895*jacob_vel_inv2[0])*Ghat_r[4]+(2.5*jacob_vel_inv2[2]-1.936491673103709*jacob_vel_inv2[1]+1.118033988749895*jacob_vel_inv2[0])*Ghat_l[4])*dv12; 
  out[37] += (((-2.5*jacob_vel_inv2[2])-1.936491673103709*jacob_vel_inv2[1]-1.118033988749895*jacob_vel_inv2[0])*Ghat_r[5]+(2.5*jacob_vel_inv2[2]-1.936491673103709*jacob_vel_inv2[1]+1.118033988749895*jacob_vel_inv2[0])*Ghat_l[5])*dv12; 
  out[38] += (((-2.5*jacob_vel_inv2[2])-1.936491673103709*jacob_vel_inv2[1]-1.118033988749895*jacob_vel_inv2[0])*Ghat_r[6]+(2.5*jacob_vel_inv2[2]-1.936491673103709*jacob_vel_inv2[1]+1.118033988749895*jacob_vel_inv2[0])*Ghat_l[6])*dv12; 
  out[39] += (((-2.5*jacob_vel_inv2[2])-1.936491673103709*jacob_vel_inv2[1]-1.118033988749895*jacob_vel_inv2[0])*Ghat_r[7]+(2.5*jacob_vel_inv2[2]-1.936491673103709*jacob_vel_inv2[1]+1.118033988749895*jacob_vel_inv2[0])*Ghat_l[7])*dv12; 
