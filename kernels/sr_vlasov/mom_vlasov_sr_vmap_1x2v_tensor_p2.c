...
{ 
  ...
  out[0] += (p0_over_gamma[8]*f[22]+p0_over_gamma[7]*f[16]+p0_over_gamma[6]*f[14]+p0_over_gamma[5]*f[9]+p0_over_gamma[4]*f[8]+p0_over_gamma[3]*f[6]+p0_over_gamma[2]*f[3]+p0_over_gamma[1]*f[2]+f[0]*p0_over_gamma[0])*volFact; 
  out[1] += (p0_over_gamma[8]*f[25]+1.0*p0_over_gamma[7]*f[19]+1.0*p0_over_gamma[6]*f[18]+1.0*p0_over_gamma[5]*f[15]+1.0*p0_over_gamma[4]*f[12]+p0_over_gamma[3]*f[10]+p0_over_gamma[2]*f[5]+p0_over_gamma[1]*f[4]+p0_over_gamma[0]*f[1])*volFact; 
  out[2] += (p0_over_gamma[8]*f[26]+1.0*p0_over_gamma[7]*f[24]+1.0*p0_over_gamma[6]*f[23]+p0_over_gamma[5]*f[21]+p0_over_gamma[4]*f[20]+p0_over_gamma[3]*f[17]+1.0*p0_over_gamma[2]*f[13]+1.0*p0_over_gamma[1]*f[11]+p0_over_gamma[0]*f[7])*volFact; 
  out[3] += (p1_over_gamma[8]*f[22]+p1_over_gamma[7]*f[16]+p1_over_gamma[6]*f[14]+p1_over_gamma[5]*f[9]+p1_over_gamma[4]*f[8]+p1_over_gamma[3]*f[6]+p1_over_gamma[2]*f[3]+p1_over_gamma[1]*f[2]+f[0]*p1_over_gamma[0])*volFact; 
  out[4] += (p1_over_gamma[8]*f[25]+1.0*p1_over_gamma[7]*f[19]+1.0*p1_over_gamma[6]*f[18]+1.0*p1_over_gamma[5]*f[15]+1.0*p1_over_gamma[4]*f[12]+p1_over_gamma[3]*f[10]+p1_over_gamma[2]*f[5]+p1_over_gamma[1]*f[4]+p1_over_gamma[0]*f[1])*volFact; 
  out[5] += (p1_over_gamma[8]*f[26]+1.0*p1_over_gamma[7]*f[24]+1.0*p1_over_gamma[6]*f[23]+p1_over_gamma[5]*f[21]+p1_over_gamma[4]*f[20]+p1_over_gamma[3]*f[17]+1.0*p1_over_gamma[2]*f[13]+1.0*p1_over_gamma[1]*f[11]+p1_over_gamma[0]*f[7])*volFact; 
} 
...
{ 
  ...
  out[0] += (1.414213562373095*p0[2]*f[8]+1.414213562373095*p0[1]*f[2]+1.414213562373095*f[0]*p0[0])*volFact; 
  out[1] += (1.414213562373095*p0[2]*f[12]+1.414213562373095*p0[1]*f[4]+1.414213562373095*p0[0]*f[1])*volFact; 
  out[2] += (1.414213562373095*p0[2]*f[20]+1.414213562373095*p0[1]*f[11]+1.414213562373095*p0[0]*f[7])*volFact; 
  out[3] += (1.414213562373095*p1[2]*f[9]+1.414213562373095*p1[1]*f[3]+1.414213562373095*f[0]*p1[0])*volFact; 
  out[4] += (1.414213562373095*p1[2]*f[15]+1.414213562373095*p1[1]*f[5]+1.414213562373095*p1[0]*f[1])*volFact; 
  out[5] += (1.414213562373095*p1[2]*f[21]+1.414213562373095*p1[1]*f[13]+1.414213562373095*p1[0]*f[7])*volFact; 
} 
...
{ 
  ...
  out[2] += (2.0*p0[2]*f[8]+2.0*p0[1]*f[2]+2.0*f[0]*p0[0])*volFact; 
  out[3] += (2.0*p1[2]*f[9]+2.0*p1[1]*f[3]+2.0*f[0]*p1[0])*volFact; 
} 
