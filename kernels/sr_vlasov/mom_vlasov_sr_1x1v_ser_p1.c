...
{ 
  ...
  out[0] += 1.414213562373095*f[0]*volFact; 
  out[1] += 1.414213562373095*f[1]*volFact; 
  out[2] += (p0_over_gamma[2]*f[4]+p0_over_gamma[1]*f[2]+f[0]*p0_over_gamma[0])*volFact; 
  out[3] += (1.0*p0_over_gamma[2]*f[5]+p0_over_gamma[1]*f[3]+p0_over_gamma[0]*f[1])*volFact; 
} 
...
{ 
  ...
  out[4] += volFact*(p0_over_gamma[2]*f[4]*wx1+p0_over_gamma[1]*f[2]*wx1+f[0]*p0_over_gamma[0]*wx1+0.2581988897471612*p0_over_gamma[1]*f[4]*dv1+0.2581988897471612*f[2]*p0_over_gamma[2]*dv1+0.2886751345948129*p0_over_gamma[0]*f[2]*dv1+0.2886751345948129*f[0]*p0_over_gamma[1]*dv1); 
  out[5] += volFact*(1.0*p0_over_gamma[2]*f[5]*wx1+p0_over_gamma[1]*f[3]*wx1+p0_over_gamma[0]*f[1]*wx1+0.2581988897471611*p0_over_gamma[1]*f[5]*dv1+0.2581988897471612*p0_over_gamma[2]*f[3]*dv1+0.2886751345948129*p0_over_gamma[0]*f[3]*dv1+0.2886751345948129*f[1]*p0_over_gamma[1]*dv1); 
} 
...
{ 
  ...
  out[0] += (1.414213562373095*GammaV_inv[1]*f[1]+1.414213562373095*GammaV_inv[0]*f[0])*volFact; 
  out[1] += (1.0*GammaV_inv[1]*p0_over_gamma[2]*f[5]+GammaV_inv[0]*p0_over_gamma[2]*f[4]+GammaV_inv[1]*p0_over_gamma[1]*f[3]+GammaV_inv[0]*p0_over_gamma[1]*f[2]+p0_over_gamma[0]*GammaV_inv[1]*f[1]+GammaV_inv[0]*f[0]*p0_over_gamma[0])*volFact; 
  out[2] += (1.0*GammaV_inv[1]*gamma[2]*f[5]+GammaV_inv[0]*gamma[2]*f[4]+GammaV_inv[1]*gamma[1]*f[3]+GammaV_inv[0]*gamma[1]*f[2]+gamma[0]*GammaV_inv[1]*f[1]+GammaV_inv[0]*f[0]*gamma[0])*volFact; 
} 
