...
{ 
  ...
  alpha_l[3] = (-1.224744871391589*B0[0]*p2_over_gamma[4])+1.224744871391589*B2[0]*p0_over_gamma[4]+0.7071067811865475*B0[0]*p2_over_gamma[1]-0.7071067811865475*B2[0]*p0_over_gamma[1]; 
  alpha_l[4] = (-1.224744871391589*B0[0]*p2_over_gamma[6])+1.224744871391589*B2[0]*p0_over_gamma[6]+0.7071067811865475*B0[0]*p2_over_gamma[3]-0.7071067811865475*B2[0]*p0_over_gamma[3]; 
  alpha_l[5] = 2.0*E1[3]+1.224744871391589*p0_over_gamma[2]*B2[3]-0.7071067811865475*p0_over_gamma[0]*B2[3]-1.224744871391589*p2_over_gamma[2]*B0[3]+0.7071067811865475*p2_over_gamma[0]*B0[3]; 
  alpha_l[6] = (-1.224744871391589*B0[1]*p2_over_gamma[4])+1.224744871391589*B2[1]*p0_over_gamma[4]+0.7071067811865475*B0[1]*p2_over_gamma[1]-0.7071067811865475*B2[1]*p0_over_gamma[1]; 
  alpha_l[7] = (-1.224744871391589*B0[2]*p2_over_gamma[4])+1.224744871391589*B2[2]*p0_over_gamma[4]-0.7071067811865475*p0_over_gamma[1]*B2[2]+0.7071067811865475*p2_over_gamma[1]*B0[2]; 
  alpha_l[8] = (-1.224744871391589*B0[1]*p2_over_gamma[6])+1.224744871391589*B2[1]*p0_over_gamma[6]+0.7071067811865475*B0[1]*p2_over_gamma[3]-0.7071067811865475*B2[1]*p0_over_gamma[3]; 
  alpha_l[9] = (-1.224744871391589*B0[2]*p2_over_gamma[6])+1.224744871391589*B2[2]*p0_over_gamma[6]+0.7071067811865475*B0[2]*p2_over_gamma[3]-0.7071067811865475*B2[2]*p0_over_gamma[3]; 
  alpha_l[10] = (-1.224744871391589*B0[0]*p2_over_gamma[7])+1.224744871391589*B2[0]*p0_over_gamma[7]+0.7071067811865475*B0[0]*p2_over_gamma[5]-0.7071067811865475*B2[0]*p0_over_gamma[5]; 
  ...
  alpha_l[12] = (-1.224744871391589*B0[3]*p2_over_gamma[6])+1.224744871391589*B2[3]*p0_over_gamma[6]+0.7071067811865475*B0[3]*p2_over_gamma[3]-0.7071067811865475*B2[3]*p0_over_gamma[3]; 
  alpha_l[13] = (-1.224744871391589*B0[1]*p2_over_gamma[7])+1.224744871391589*B2[1]*p0_over_gamma[7]+0.7071067811865475*B0[1]*p2_over_gamma[5]-0.7071067811865475*B2[1]*p0_over_gamma[5]; 
  alpha_l[14] = (-1.224744871391589*B0[2]*p2_over_gamma[7])+1.224744871391589*B2[2]*p0_over_gamma[7]+0.7071067811865475*B0[2]*p2_over_gamma[5]-0.7071067811865475*B2[2]*p0_over_gamma[5]; 
  alpha_l[15] = (-1.224744871391589*B0[3]*p2_over_gamma[7])+1.224744871391589*B2[3]*p0_over_gamma[7]+0.7071067811865475*B0[3]*p2_over_gamma[5]-0.7071067811865475*B2[3]*p0_over_gamma[5]; 
  ...
  alpha_r[3] = 1.224744871391589*B0[0]*p2_over_gamma[4]-1.224744871391589*B2[0]*p0_over_gamma[4]+0.7071067811865475*B0[0]*p2_over_gamma[1]-0.7071067811865475*B2[0]*p0_over_gamma[1]; 
  alpha_r[4] = 1.224744871391589*B0[0]*p2_over_gamma[6]-1.224744871391589*B2[0]*p0_over_gamma[6]+0.7071067811865475*B0[0]*p2_over_gamma[3]-0.7071067811865475*B2[0]*p0_over_gamma[3]; 
  alpha_r[5] = 2.0*E1[3]-1.224744871391589*p0_over_gamma[2]*B2[3]-0.7071067811865475*p0_over_gamma[0]*B2[3]+1.224744871391589*p2_over_gamma[2]*B0[3]+0.7071067811865475*p2_over_gamma[0]*B0[3]; 
  alpha_r[6] = 1.224744871391589*B0[1]*p2_over_gamma[4]-1.224744871391589*B2[1]*p0_over_gamma[4]+0.7071067811865475*B0[1]*p2_over_gamma[1]-0.7071067811865475*B2[1]*p0_over_gamma[1]; 
  alpha_r[7] = 1.224744871391589*B0[2]*p2_over_gamma[4]-1.224744871391589*B2[2]*p0_over_gamma[4]-0.7071067811865475*p0_over_gamma[1]*B2[2]+0.7071067811865475*p2_over_gamma[1]*B0[2]; 
  alpha_r[8] = 1.224744871391589*B0[1]*p2_over_gamma[6]-1.224744871391589*B2[1]*p0_over_gamma[6]+0.7071067811865475*B0[1]*p2_over_gamma[3]-0.7071067811865475*B2[1]*p0_over_gamma[3]; 
  alpha_r[9] = 1.224744871391589*B0[2]*p2_over_gamma[6]-1.224744871391589*B2[2]*p0_over_gamma[6]+0.7071067811865475*B0[2]*p2_over_gamma[3]-0.7071067811865475*B2[2]*p0_over_gamma[3]; 
  alpha_r[10] = 1.224744871391589*B0[0]*p2_over_gamma[7]-1.224744871391589*B2[0]*p0_over_gamma[7]+0.7071067811865475*B0[0]*p2_over_gamma[5]-0.7071067811865475*B2[0]*p0_over_gamma[5]; 
  ...
  alpha_r[12] = 1.224744871391589*B0[3]*p2_over_gamma[6]-1.224744871391589*B2[3]*p0_over_gamma[6]+0.7071067811865475*B0[3]*p2_over_gamma[3]-0.7071067811865475*B2[3]*p0_over_gamma[3]; 
  alpha_r[13] = 1.224744871391589*B0[1]*p2_over_gamma[7]-1.224744871391589*B2[1]*p0_over_gamma[7]+0.7071067811865475*B0[1]*p2_over_gamma[5]-0.7071067811865475*B2[1]*p0_over_gamma[5]; 
  alpha_r[14] = 1.224744871391589*B0[2]*p2_over_gamma[7]-1.224744871391589*B2[2]*p0_over_gamma[7]+0.7071067811865475*B0[2]*p2_over_gamma[5]-0.7071067811865475*B2[2]*p0_over_gamma[5]; 
  alpha_r[15] = 1.224744871391589*B0[3]*p2_over_gamma[7]-1.224744871391589*B2[3]*p0_over_gamma[7]+0.7071067811865475*B0[3]*p2_over_gamma[5]-0.7071067811865475*B2[3]*p0_over_gamma[5]; 
