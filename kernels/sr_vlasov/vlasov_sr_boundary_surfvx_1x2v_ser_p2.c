...
GKYL_CU_DH double vlasov_sr_boundary_surfvx_1x2v_ser_p2(const double *w, const double *dxv, const double *p_over_gamma, const double *qmem, const int edge, const double *fEdge, const double *fSkin, double* GKYL_RESTRICT out) 
{ 
  ...
  alpha[0] = 1.58113883008419*B2[0]*p1_over_gamma[4]+1.224744871391589*B2[0]*p1_over_gamma[1]+0.7071067811865475*B2[0]*p1_over_gamma[0]+1.414213562373095*E0[0]; 
  alpha[1] = 1.58113883008419*B2[1]*p1_over_gamma[4]+1.224744871391589*B2[1]*p1_over_gamma[1]+1.414213562373095*E0[1]+0.7071067811865475*p1_over_gamma[0]*B2[1]; 
  alpha[2] = 1.58113883008419*B2[0]*p1_over_gamma[6]+1.224744871391589*B2[0]*p1_over_gamma[3]+0.7071067811865475*B2[0]*p1_over_gamma[2]; 
  alpha[3] = 1.58113883008419*B2[1]*p1_over_gamma[6]+1.224744871391589*B2[1]*p1_over_gamma[3]+0.7071067811865475*B2[1]*p1_over_gamma[2]; 
  alpha[4] = 1.58113883008419*B2[2]*p1_over_gamma[4]+1.414213562373095*E0[2]+1.224744871391589*p1_over_gamma[1]*B2[2]+0.7071067811865475*p1_over_gamma[0]*B2[2]; 
  alpha[5] = 1.224744871391589*B2[0]*p1_over_gamma[7]+0.7071067811865475*B2[0]*p1_over_gamma[5]; 
  alpha[6] = 1.58113883008419*B2[2]*p1_over_gamma[6]+1.224744871391589*B2[2]*p1_over_gamma[3]+0.7071067811865475*B2[2]*p1_over_gamma[2]; 
  alpha[7] = 1.224744871391589*B2[1]*p1_over_gamma[7]+0.7071067811865475*B2[1]*p1_over_gamma[5]; 
  ...
  alpha[3] = 1.58113883008419*B2[1]*p1_over_gamma[6]-1.224744871391589*B2[1]*p1_over_gamma[3]+0.7071067811865475*B2[1]*p1_over_gamma[2]; 
  alpha[4] = 1.58113883008419*B2[2]*p1_over_gamma[4]+1.414213562373095*E0[2]-1.224744871391589*p1_over_gamma[1]*B2[2]+0.7071067811865475*p1_over_gamma[0]*B2[2]; 
  alpha[5] = 0.7071067811865475*B2[0]*p1_over_gamma[5]-1.224744871391589*B2[0]*p1_over_gamma[7]; 
  alpha[6] = 1.58113883008419*B2[2]*p1_over_gamma[6]-1.224744871391589*B2[2]*p1_over_gamma[3]+0.7071067811865475*B2[2]*p1_over_gamma[2]; 
  alpha[7] = 0.7071067811865475*B2[1]*p1_over_gamma[5]-1.224744871391589*B2[1]*p1_over_gamma[7]; 
