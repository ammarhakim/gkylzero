...
GKYL_CU_DH double vlasov_sr_boundary_surfvx_1x2v_ser_p1(const double *w, const double *dxv, const double *p_over_gamma, const double *qmem, const int edge, const double *fEdge, const double *fSkin, double* GKYL_RESTRICT out) 
{ 
  ...
  alpha[2] = 1.224744871391589*B2[0]*p1_over_gamma[3]+0.7071067811865475*B2[0]*p1_over_gamma[2]; 
  alpha[3] = 1.224744871391589*B2[1]*p1_over_gamma[3]+0.7071067811865475*B2[1]*p1_over_gamma[2]; 
  ...
  alpha[0] = (-1.224744871391589*B2[0]*p1_over_gamma[1])+0.7071067811865475*B2[0]*p1_over_gamma[0]+1.414213562373095*E0[0]; 
  alpha[1] = (-1.224744871391589*B2[1]*p1_over_gamma[1])+1.414213562373095*E0[1]+0.7071067811865475*p1_over_gamma[0]*B2[1]; 
  alpha[2] = 0.7071067811865475*B2[0]*p1_over_gamma[2]-1.224744871391589*B2[0]*p1_over_gamma[3]; 
  alpha[3] = 0.7071067811865475*B2[1]*p1_over_gamma[2]-1.224744871391589*B2[1]*p1_over_gamma[3]; 
