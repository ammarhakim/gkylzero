...
GKYL_CU_DH double vlasov_sr_vmap_boundary_surfvx_2x1v_ser_p2(const double *w, const double *dxv, const double *jacob_vel_inv, const double *gamma, const double *qmem, const int edge, const double *fEdge, const double *fSkin, double* GKYL_RESTRICT out) 
{ 
  ...
  alpha[4] = 1.58113883008419*jacob_vel_inv0[2]*E0[4]+1.224744871391589*jacob_vel_inv0[1]*E0[4]+0.7071067811865475*jacob_vel_inv0[0]*E0[4]; 
  alpha[5] = 1.58113883008419*jacob_vel_inv0[2]*E0[5]+1.224744871391589*jacob_vel_inv0[1]*E0[5]+0.7071067811865475*jacob_vel_inv0[0]*E0[5]; 
  alpha[6] = 1.58113883008419*jacob_vel_inv0[2]*E0[6]+1.224744871391589*jacob_vel_inv0[1]*E0[6]+0.7071067811865475*jacob_vel_inv0[0]*E0[6]; 
  alpha[7] = 1.58113883008419*jacob_vel_inv0[2]*E0[7]+1.224744871391589*jacob_vel_inv0[1]*E0[7]+0.7071067811865475*jacob_vel_inv0[0]*E0[7]; 
