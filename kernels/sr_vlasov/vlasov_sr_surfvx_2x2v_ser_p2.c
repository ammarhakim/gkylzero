...
GKYL_CU_DH double vlasov_sr_surfvx_2x2v_ser_p2(const double *w, const double *dxv, const double *p_over_gamma, const double *qmem, const double *fl, const double *fc, const double *fr, double* GKYL_RESTRICT out) 
{ 
  ...
  alpha_l[0] = 1.58113883008419*B2[0]*p1_over_gamma[4]-1.224744871391589*B2[0]*p1_over_gamma[1]+0.7071067811865475*B2[0]*p1_over_gamma[0]+1.414213562373095*E0[0]; 
  alpha_l[1] = 1.58113883008419*B2[1]*p1_over_gamma[4]-1.224744871391589*B2[1]*p1_over_gamma[1]+1.414213562373095*E0[1]+0.7071067811865475*p1_over_gamma[0]*B2[1]; 
  alpha_l[2] = 1.58113883008419*B2[2]*p1_over_gamma[4]+1.414213562373095*E0[2]-1.224744871391589*p1_over_gamma[1]*B2[2]+0.7071067811865475*p1_over_gamma[0]*B2[2]; 
  alpha_l[3] = 1.58113883008419*B2[0]*p1_over_gamma[6]-1.224744871391589*B2[0]*p1_over_gamma[3]+0.7071067811865475*B2[0]*p1_over_gamma[2]; 
  alpha_l[4] = 1.58113883008419*B2[3]*p1_over_gamma[4]+1.414213562373095*E0[3]-1.224744871391589*p1_over_gamma[1]*B2[3]+0.7071067811865475*p1_over_gamma[0]*B2[3]; 
  alpha_l[5] = 1.58113883008419*B2[1]*p1_over_gamma[6]-1.224744871391589*B2[1]*p1_over_gamma[3]+0.7071067811865475*B2[1]*p1_over_gamma[2]; 
  alpha_l[6] = 1.58113883008419*B2[2]*p1_over_gamma[6]-1.224744871391589*B2[2]*p1_over_gamma[3]+0.7071067811865475*B2[2]*p1_over_gamma[2]; 
  alpha_l[7] = 1.58113883008419*B2[4]*p1_over_gamma[4]+1.414213562373095*E0[4]-1.224744871391589*p1_over_gamma[1]*B2[4]+0.7071067811865475*p1_over_gamma[0]*B2[4]; 
  alpha_l[8] = 1.414213562373095*E0[5]+1.58113883008419*p1_over_gamma[4]*B2[5]-1.224744871391589*p1_over_gamma[1]*B2[5]+0.7071067811865475*p1_over_gamma[0]*B2[5]; 
  alpha_l[9] = 0.7071067811865475*B2[0]*p1_over_gamma[5]-1.224744871391589*B2[0]*p1_over_gamma[7]; 
  alpha_l[10] = 1.58113883008419*B2[3]*p1_over_gamma[6]-1.224744871391589*B2[3]*p1_over_gamma[3]+0.7071067811865475*p1_over_gamma[2]*B2[3]; 
  alpha_l[11] = 1.414213562373095*E0[6]+1.58113883008419*p1_over_gamma[4]*B2[6]-1.224744871391589*p1_over_gamma[1]*B2[6]+0.7071067811865475*p1_over_gamma[0]*B2[6]; 
  alpha_l[12] = 1.414213562373095*E0[7]+1.58113883008419*p1_over_gamma[4]*B2[7]-1.224744871391589*p1_over_gamma[1]*B2[7]+0.7071067811865475*p1_over_gamma[0]*B2[7]; 
  alpha_l[13] = 1.58113883008419*B2[4]*p1_over_gamma[6]-1.224744871391589*p1_over_gamma[3]*B2[4]+0.7071067811865475*p1_over_gamma[2]*B2[4]; 
  alpha_l[14] = 1.58113883008419*B2[5]*p1_over_gamma[6]-1.224744871391589*p1_over_gamma[3]*B2[5]+0.7071067811865475*p1_over_gamma[2]*B2[5]; 
  alpha_l[15] = 0.7071067811865475*B2[1]*p1_over_gamma[5]-1.224744871391589*B2[1]*p1_over_gamma[7]; 
  alpha_l[16] = 0.7071067811865475*B2[2]*p1_over_gamma[5]-1.224744871391589*B2[2]*p1_over_gamma[7]; 
  alpha_l[17] = 1.58113883008419*B2[6]*p1_over_gamma[6]-1.224744871391589*p1_over_gamma[3]*B2[6]+0.7071067811865475*p1_over_gamma[2]*B2[6]; 
  alpha_l[18] = 1.58113883008419*p1_over_gamma[6]*B2[7]-1.224744871391589*p1_over_gamma[3]*B2[7]+0.7071067811865475*p1_over_gamma[2]*B2[7]; 
  alpha_l[19] = 0.7071067811865475*B2[3]*p1_over_gamma[5]-1.224744871391589*B2[3]*p1_over_gamma[7]; 

  alpha_r[0] = 1.58113883008419*B2[0]*p1_over_gamma[4]+1.224744871391589*B2[0]*p1_over_gamma[1]+0.7071067811865475*B2[0]*p1_over_gamma[0]+1.414213562373095*E0[0]; 
  alpha_r[1] = 1.58113883008419*B2[1]*p1_over_gamma[4]+1.224744871391589*B2[1]*p1_over_gamma[1]+1.414213562373095*E0[1]+0.7071067811865475*p1_over_gamma[0]*B2[1]; 
  alpha_r[2] = 1.58113883008419*B2[2]*p1_over_gamma[4]+1.414213562373095*E0[2]+1.224744871391589*p1_over_gamma[1]*B2[2]+0.7071067811865475*p1_over_gamma[0]*B2[2]; 
  alpha_r[3] = 1.58113883008419*B2[0]*p1_over_gamma[6]+1.224744871391589*B2[0]*p1_over_gamma[3]+0.7071067811865475*B2[0]*p1_over_gamma[2]; 
  alpha_r[4] = 1.58113883008419*B2[3]*p1_over_gamma[4]+1.414213562373095*E0[3]+1.224744871391589*p1_over_gamma[1]*B2[3]+0.7071067811865475*p1_over_gamma[0]*B2[3]; 
  alpha_r[5] = 1.58113883008419*B2[1]*p1_over_gamma[6]+1.224744871391589*B2[1]*p1_over_gamma[3]+0.7071067811865475*B2[1]*p1_over_gamma[2]; 
  alpha_r[6] = 1.58113883008419*B2[2]*p1_over_gamma[6]+1.224744871391589*B2[2]*p1_over_gamma[3]+0.7071067811865475*B2[2]*p1_over_gamma[2]; 
  alpha_r[7] = 1.58113883008419*B2[4]*p1_over_gamma[4]+1.414213562373095*E0[4]+1.224744871391589*p1_over_gamma[1]*B2[4]+0.7071067811865475*p1_over_gamma[0]*B2[4]; 
  alpha_r[8] = 1.414213562373095*E0[5]+1.58113883008419*p1_over_gamma[4]*B2[5]+1.224744871391589*p1_over_gamma[1]*B2[5]+0.7071067811865475*p1_over_gamma[0]*B2[5]; 
  alpha_r[9] = 1.224744871391589*B2[0]*p1_over_gamma[7]+0.7071067811865475*B2[0]*p1_over_gamma[5]; 
  alpha_r[10] = 1.58113883008419*B2[3]*p1_over_gamma[6]+1.224744871391589*B2[3]*p1_over_gamma[3]+0.7071067811865475*p1_over_gamma[2]*B2[3]; 
  alpha_r[11] = 1.414213562373095*E0[6]+1.58113883008419*p1_over_gamma[4]*B2[6]+1.224744871391589*p1_over_gamma[1]*B2[6]+0.7071067811865475*p1_over_gamma[0]*B2[6]; 
  alpha_r[12] = 1.414213562373095*E0[7]+1.58113883008419*p1_over_gamma[4]*B2[7]+1.224744871391589*p1_over_gamma[1]*B2[7]+0.7071067811865475*p1_over_gamma[0]*B2[7]; 
  alpha_r[13] = 1.58113883008419*B2[4]*p1_over_gamma[6]+1.224744871391589*p1_over_gamma[3]*B2[4]+0.7071067811865475*p1_over_gamma[2]*B2[4]; 
  alpha_r[14] = 1.58113883008419*B2[5]*p1_over_gamma[6]+1.224744871391589*p1_over_gamma[3]*B2[5]+0.7071067811865475*p1_over_gamma[2]*B2[5]; 
  alpha_r[15] = 1.224744871391589*B2[1]*p1_over_gamma[7]+0.7071067811865475*B2[1]*p1_over_gamma[5]; 
  alpha_r[16] = 1.224744871391589*B2[2]*p1_over_gamma[7]+0.7071067811865475*B2[2]*p1_over_gamma[5]; 
  alpha_r[17] = 1.58113883008419*B2[6]*p1_over_gamma[6]+1.224744871391589*p1_over_gamma[3]*B2[6]+0.7071067811865475*p1_over_gamma[2]*B2[6]; 
  alpha_r[18] = 1.58113883008419*p1_over_gamma[6]*B2[7]+1.224744871391589*p1_over_gamma[3]*B2[7]+0.7071067811865475*p1_over_gamma[2]*B2[7]; 
  alpha_r[19] = 1.224744871391589*B2[3]*p1_over_gamma[7]+0.7071067811865475*B2[3]*p1_over_gamma[5]; 
  ...
  if (0.711512473537885*alpha_l[18]-0.4242640687119281*alpha_l[15]-0.5303300858899104*alpha_l[14]+0.4242640687119285*alpha_l[13]+0.5303300858899104*alpha_l[12]+0.3162277660168379*alpha_l[9]-0.3952847075210473*alpha_l[8]+0.3162277660168379*alpha_l[7]-0.6363961030678926*alpha_l[5]+0.4743416490252568*alpha_l[3]-0.4743416490252568*alpha_l[1]+0.3535533905932737*alpha_l[0] > 0) { 
    fUpwindQuad_l[5] = ser_4x_p2_surfx3_eval_quad_node_5_r(fl); 
  } else { 
    fUpwindQuad_l[5] = ser_4x_p2_surfx3_eval_quad_node_5_l(fc); 
  } 
  if (0.711512473537885*alpha_r[18]-0.4242640687119281*alpha_r[15]-0.5303300858899104*alpha_r[14]+0.4242640687119285*alpha_r[13]+0.5303300858899104*alpha_r[12]+0.3162277660168379*alpha_r[9]-0.3952847075210473*alpha_r[8]+0.3162277660168379*alpha_r[7]-0.6363961030678926*alpha_r[5]+0.4743416490252568*alpha_r[3]-0.4743416490252568*alpha_r[1]+0.3535533905932737*alpha_r[0] > 0) { 
    fUpwindQuad_r[5] = ser_4x_p2_surfx3_eval_quad_node_5_r(fc); 
  } else { 
    fUpwindQuad_r[5] = ser_4x_p2_surfx3_eval_quad_node_5_l(fr); 
  } 
  if ((-0.5692099788303082*alpha_l[19])+0.5692099788303082*alpha_l[18]-0.5692099788303082*alpha_l[17]+0.4242640687119281*alpha_l[16]-0.4242640687119281*alpha_l[15]-0.4242640687119285*(alpha_l[14]+alpha_l[13])-0.4242640687119281*alpha_l[12]+0.4242640687119285*alpha_l[11]+0.853814968245462*alpha_l[10]+0.3162277660168379*(alpha_l[9]+alpha_l[8]+alpha_l[7])-0.6363961030678926*alpha_l[6]+0.6363961030678926*alpha_l[5]-0.6363961030678926*alpha_l[4]-0.4743416490252568*alpha_l[3]+0.4743416490252568*alpha_l[2]-0.4743416490252568*alpha_l[1]+0.3535533905932737*alpha_l[0] > 0) { 
    fUpwindQuad_l[6] = ser_4x_p2_surfx3_eval_quad_node_6_r(fl); 
  } else { 
    fUpwindQuad_l[6] = ser_4x_p2_surfx3_eval_quad_node_6_l(fc); 
  } 
  if ((-0.5692099788303082*alpha_r[19])+0.5692099788303082*alpha_r[18]-0.5692099788303082*alpha_r[17]+0.4242640687119281*alpha_r[16]-0.4242640687119281*alpha_r[15]-0.4242640687119285*(alpha_r[14]+alpha_r[13])-0.4242640687119281*alpha_r[12]+0.4242640687119285*alpha_r[11]+0.853814968245462*alpha_r[10]+0.3162277660168379*(alpha_r[9]+alpha_r[8]+alpha_r[7])-0.6363961030678926*alpha_r[6]+0.6363961030678926*alpha_r[5]-0.6363961030678926*alpha_r[4]-0.4743416490252568*alpha_r[3]+0.4743416490252568*alpha_r[2]-0.4743416490252568*alpha_r[1]+0.3535533905932737*alpha_r[0] > 0) { 
    fUpwindQuad_r[6] = ser_4x_p2_surfx3_eval_quad_node_6_r(fc); 
  } else { 
    fUpwindQuad_r[6] = ser_4x_p2_surfx3_eval_quad_node_6_l(fr); 
  } 
  if (0.711512473537885*alpha_l[19]-0.5303300858899104*alpha_l[16]+0.5303300858899104*alpha_l[15]-0.4242640687119281*alpha_l[12]+0.4242640687119285*alpha_l[11]-0.3952847075210473*alpha_l[9]+0.3162277660168379*(alpha_l[8]+alpha_l[7])-0.6363961030678926*alpha_l[4]+0.4743416490252568*alpha_l[2]-0.4743416490252568*alpha_l[1]+0.3535533905932737*alpha_l[0] > 0) { 
    fUpwindQuad_l[7] = ser_4x_p2_surfx3_eval_quad_node_7_r(fl); 
  } else { 
    fUpwindQuad_l[7] = ser_4x_p2_surfx3_eval_quad_node_7_l(fc); 
  } 
  if (0.711512473537885*alpha_r[19]-0.5303300858899104*alpha_r[16]+0.5303300858899104*alpha_r[15]-0.4242640687119281*alpha_r[12]+0.4242640687119285*alpha_r[11]-0.3952847075210473*alpha_r[9]+0.3162277660168379*(alpha_r[8]+alpha_r[7])-0.6363961030678926*alpha_r[4]+0.4743416490252568*alpha_r[2]-0.4743416490252568*alpha_r[1]+0.3535533905932737*alpha_r[0] > 0) { 
    fUpwindQuad_r[7] = ser_4x_p2_surfx3_eval_quad_node_7_r(fc); 
  } else { 
    fUpwindQuad_r[7] = ser_4x_p2_surfx3_eval_quad_node_7_l(fr); 
  } 
  if ((-0.5692099788303082*(alpha_l[19]+alpha_l[18]))+0.5692099788303082*alpha_l[17]+0.4242640687119281*alpha_l[16]-0.4242640687119281*alpha_l[15]+0.4242640687119285*(alpha_l[14]+alpha_l[13])-0.4242640687119281*alpha_l[12]+0.4242640687119285*alpha_l[11]-0.853814968245462*alpha_l[10]+0.3162277660168379*(alpha_l[9]+alpha_l[8]+alpha_l[7])+0.6363961030678926*alpha_l[6]-0.6363961030678926*(alpha_l[5]+alpha_l[4])+0.4743416490252568*(alpha_l[3]+alpha_l[2])-0.4743416490252568*alpha_l[1]+0.3535533905932737*alpha_l[0] > 0) { 
    fUpwindQuad_l[8] = ser_4x_p2_surfx3_eval_quad_node_8_r(fl); 
  } else { 
    fUpwindQuad_l[8] = ser_4x_p2_surfx3_eval_quad_node_8_l(fc); 
  } 
  if ((-0.5692099788303082*(alpha_r[19]+alpha_r[18]))+0.5692099788303082*alpha_r[17]+0.4242640687119281*alpha_r[16]-0.4242640687119281*alpha_r[15]+0.4242640687119285*(alpha_r[14]+alpha_r[13])-0.4242640687119281*alpha_r[12]+0.4242640687119285*alpha_r[11]-0.853814968245462*alpha_r[10]+0.3162277660168379*(alpha_r[9]+alpha_r[8]+alpha_r[7])+0.6363961030678926*alpha_r[6]-0.6363961030678926*(alpha_r[5]+alpha_r[4])+0.4743416490252568*(alpha_r[3]+alpha_r[2])-0.4743416490252568*alpha_r[1]+0.3535533905932737*alpha_r[0] > 0) { 
    fUpwindQuad_r[8] = ser_4x_p2_surfx3_eval_quad_node_8_r(fc); 
  } else { 
    fUpwindQuad_r[8] = ser_4x_p2_surfx3_eval_quad_node_8_l(fr); 
  } 
  if ((-0.711512473537885*alpha_l[17])-0.4242640687119281*alpha_l[16]-0.4242640687119285*alpha_l[14]+0.5303300858899104*(alpha_l[13]+alpha_l[11])+0.3162277660168379*(alpha_l[9]+alpha_l[8])-0.3952847075210473*alpha_l[7]+0.6363961030678926*alpha_l[6]-0.4743416490252568*(alpha_l[3]+alpha_l[2])+0.3535533905932737*alpha_l[0] > 0) { 
    fUpwindQuad_l[9] = ser_4x_p2_surfx3_eval_quad_node_9_r(fl); 
  } else { 
    fUpwindQuad_l[9] = ser_4x_p2_surfx3_eval_quad_node_9_l(fc); 
  } 
  if ((-0.711512473537885*alpha_r[17])-0.4242640687119281*alpha_r[16]-0.4242640687119285*alpha_r[14]+0.5303300858899104*(alpha_r[13]+alpha_r[11])+0.3162277660168379*(alpha_r[9]+alpha_r[8])-0.3952847075210473*alpha_r[7]+0.6363961030678926*alpha_r[6]-0.4743416490252568*(alpha_r[3]+alpha_r[2])+0.3535533905932737*alpha_r[0] > 0) { 
    fUpwindQuad_r[9] = ser_4x_p2_surfx3_eval_quad_node_9_r(fc); 
  } else { 
    fUpwindQuad_r[9] = ser_4x_p2_surfx3_eval_quad_node_9_l(fr); 
  } 
  if (0.5303300858899104*(alpha_l[16]+alpha_l[11])-0.3952847075210473*alpha_l[9]+0.3162277660168379*alpha_l[8]-0.3952847075210473*alpha_l[7]-0.4743416490252568*alpha_l[2]+0.3535533905932737*alpha_l[0] > 0) { 
    fUpwindQuad_l[10] = ser_4x_p2_surfx3_eval_quad_node_10_r(fl); 
  } else { 
    fUpwindQuad_l[10] = ser_4x_p2_surfx3_eval_quad_node_10_l(fc); 
  } 
  if (0.5303300858899104*(alpha_r[16]+alpha_r[11])-0.3952847075210473*alpha_r[9]+0.3162277660168379*alpha_r[8]-0.3952847075210473*alpha_r[7]-0.4743416490252568*alpha_r[2]+0.3535533905932737*alpha_r[0] > 0) { 
    fUpwindQuad_r[10] = ser_4x_p2_surfx3_eval_quad_node_10_r(fc); 
  } else { 
    fUpwindQuad_r[10] = ser_4x_p2_surfx3_eval_quad_node_10_l(fr); 
  } 
  if (0.711512473537885*alpha_l[17]-0.4242640687119281*alpha_l[16]+0.4242640687119285*alpha_l[14]-0.5303300858899104*alpha_l[13]+0.5303300858899104*alpha_l[11]+0.3162277660168379*(alpha_l[9]+alpha_l[8])-0.3952847075210473*alpha_l[7]-0.6363961030678926*alpha_l[6]+0.4743416490252568*alpha_l[3]-0.4743416490252568*alpha_l[2]+0.3535533905932737*alpha_l[0] > 0) { 
    fUpwindQuad_l[11] = ser_4x_p2_surfx3_eval_quad_node_11_r(fl); 
  } else { 
    fUpwindQuad_l[11] = ser_4x_p2_surfx3_eval_quad_node_11_l(fc); 
  } 
  if (0.711512473537885*alpha_r[17]-0.4242640687119281*alpha_r[16]+0.4242640687119285*alpha_r[14]-0.5303300858899104*alpha_r[13]+0.5303300858899104*alpha_r[11]+0.3162277660168379*(alpha_r[9]+alpha_r[8])-0.3952847075210473*alpha_r[7]-0.6363961030678926*alpha_r[6]+0.4743416490252568*alpha_r[3]-0.4743416490252568*alpha_r[2]+0.3535533905932737*alpha_r[0] > 0) { 
    fUpwindQuad_r[11] = ser_4x_p2_surfx3_eval_quad_node_11_r(fc); 
  } else { 
    fUpwindQuad_r[11] = ser_4x_p2_surfx3_eval_quad_node_11_l(fr); 
  } 
  if (0.5303300858899104*(alpha_l[14]+alpha_l[13])+0.3162277660168379*alpha_l[9]-0.3952847075210473*(alpha_l[8]+alpha_l[7])-0.4743416490252568*alpha_l[3]+0.3535533905932737*alpha_l[0] > 0) { 
    fUpwindQuad_l[12] = ser_4x_p2_surfx3_eval_quad_node_12_r(fl); 
  } else { 
    fUpwindQuad_l[12] = ser_4x_p2_surfx3_eval_quad_node_12_l(fc); 
  } 
  if (0.5303300858899104*(alpha_r[14]+alpha_r[13])+0.3162277660168379*alpha_r[9]-0.3952847075210473*(alpha_r[8]+alpha_r[7])-0.4743416490252568*alpha_r[3]+0.3535533905932737*alpha_r[0] > 0) { 
