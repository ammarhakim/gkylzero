...
{ 
  ...
  Ghat_l[0] = 0.7071067811865475*(alpha_l[1]*fUpwind_l[1]+alpha_l[0]*fUpwind_l[0]); 
  Ghat_l[1] = 0.7071067811865475*(alpha_l[0]*fUpwind_l[1]+fUpwind_l[0]*alpha_l[1]); 

  Ghat_r[0] = 0.7071067811865475*(alpha_r[1]*fUpwind_r[1]+alpha_r[0]*fUpwind_r[0]); 
  Ghat_r[1] = 0.7071067811865475*(alpha_r[0]*fUpwind_r[1]+fUpwind_r[0]*alpha_r[1]); 
