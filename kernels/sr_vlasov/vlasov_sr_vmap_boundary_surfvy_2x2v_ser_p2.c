...
{ 
  ...
  alpha[7] = 2.23606797749979*jacob_vel_inv1[2]*E1[4]+1.732050807568877*jacob_vel_inv1[1]*E1[4]+jacob_vel_inv1[0]*E1[4]-1.0*p0_over_gamma_r[0]*B2[4]; 
  alpha[8] = 2.23606797749979*jacob_vel_inv1[2]*E1[5]+1.732050807568877*jacob_vel_inv1[1]*E1[5]+jacob_vel_inv1[0]*E1[5]-1.0*p0_over_gamma_r[0]*B2[5]; 
  alpha[9] = -1.0*B2[0]*p0_over_gamma_r[2]; 
  alpha[10] = -1.0*p0_over_gamma_r[1]*B2[3]; 
  alpha[11] = 2.23606797749979*jacob_vel_inv1[2]*E1[6]+1.732050807568877*jacob_vel_inv1[1]*E1[6]+jacob_vel_inv1[0]*E1[6]-1.0*p0_over_gamma_r[0]*B2[6]; 
  alpha[12] = 2.23606797749979*jacob_vel_inv1[2]*E1[7]+1.732050807568877*jacob_vel_inv1[1]*E1[7]+jacob_vel_inv1[0]*E1[7]-1.0*p0_over_gamma_r[0]*B2[7]; 
  ...
  alpha[7] = 2.23606797749979*jacob_vel_inv1[2]*E1[4]-1.732050807568877*jacob_vel_inv1[1]*E1[4]+jacob_vel_inv1[0]*E1[4]-1.0*p0_over_gamma_l[0]*B2[4]; 
  alpha[8] = 2.23606797749979*jacob_vel_inv1[2]*E1[5]-1.732050807568877*jacob_vel_inv1[1]*E1[5]+jacob_vel_inv1[0]*E1[5]-1.0*p0_over_gamma_l[0]*B2[5]; 
  alpha[9] = -1.0*B2[0]*p0_over_gamma_l[2]; 
  alpha[10] = -1.0*p0_over_gamma_l[1]*B2[3]; 
  alpha[11] = 2.23606797749979*jacob_vel_inv1[2]*E1[6]-1.732050807568877*jacob_vel_inv1[1]*E1[6]+jacob_vel_inv1[0]*E1[6]-1.0*p0_over_gamma_l[0]*B2[6]; 
  alpha[12] = 2.23606797749979*jacob_vel_inv1[2]*E1[7]-1.732050807568877*jacob_vel_inv1[1]*E1[7]+jacob_vel_inv1[0]*E1[7]-1.0*p0_over_gamma_l[0]*B2[7]; 
