...
{ 
  ...
  alpha_l[9] = -1.0*B0[1]*p1_over_gamma_l[4]; 
  alpha_l[12] = B1[0]*p0_over_gamma_l[5]; 
  alpha_l[13] = 1.0*B1[1]*p0_over_gamma_l[5]; 
  ...
  alpha_r[9] = -1.0*B0[1]*p1_over_gamma_r[4]; 
  alpha_r[12] = B1[0]*p0_over_gamma_r[5]; 
  alpha_r[13] = 1.0*B1[1]*p0_over_gamma_r[5]; 
