...
{ 
  ...
  alpha_l[2] = 2.23606797749979*E1[2]*jacob_vel_inv1[2]-1.732050807568877*jacob_vel_inv1[1]*E1[2]+jacob_vel_inv1[0]*E1[2]-1.0*p0_over_gamma_l[0]*B2[2]; 
  alpha_l[3] = -1.0*B2[0]*p0_over_gamma_l[1]; 
  alpha_l[4] = 2.23606797749979*jacob_vel_inv1[2]*E1[3]-1.732050807568877*jacob_vel_inv1[1]*E1[3]+jacob_vel_inv1[0]*E1[3]-1.0*p0_over_gamma_l[0]*B2[3]; 
  ...
  alpha_r[2] = 2.23606797749979*E1[2]*jacob_vel_inv1[2]+1.732050807568877*jacob_vel_inv1[1]*E1[2]+jacob_vel_inv1[0]*E1[2]-1.0*p0_over_gamma_r[0]*B2[2]; 
  alpha_r[3] = -1.0*B2[0]*p0_over_gamma_r[1]; 
  alpha_r[4] = 2.23606797749979*jacob_vel_inv1[2]*E1[3]+1.732050807568877*jacob_vel_inv1[1]*E1[3]+jacob_vel_inv1[0]*E1[3]-1.0*p0_over_gamma_r[0]*B2[3]; 
