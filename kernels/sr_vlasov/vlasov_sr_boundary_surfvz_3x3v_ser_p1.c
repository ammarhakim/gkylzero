...
GKYL_CU_DH double vlasov_sr_boundary_surfvz_3x3v_ser_p1(const double *w, const double *dxv, const double *p_over_gamma, const double *qmem, const int edge, const double *fEdge, const double *fSkin, double* GKYL_RESTRICT out) 
{ 
  ...
  alpha[0] = (-1.224744871391589*B0[0]*p1_over_gamma[3])+1.224744871391589*B1[0]*p0_over_gamma[3]-0.7071067811865475*B0[0]*p1_over_gamma[0]+0.7071067811865475*B1[0]*p0_over_gamma[0]+2.0*E2[0]; 
  alpha[1] = (-1.224744871391589*B0[1]*p1_over_gamma[3])+1.224744871391589*B1[1]*p0_over_gamma[3]+2.0*E2[1]+0.7071067811865475*p0_over_gamma[0]*B1[1]-0.7071067811865475*p1_over_gamma[0]*B0[1]; 
  alpha[2] = (-1.224744871391589*B0[2]*p1_over_gamma[3])+1.224744871391589*B1[2]*p0_over_gamma[3]+2.0*E2[2]+0.7071067811865475*p0_over_gamma[0]*B1[2]-0.7071067811865475*p1_over_gamma[0]*B0[2]; 
  alpha[3] = (-1.224744871391589*B0[3]*p1_over_gamma[3])+1.224744871391589*B1[3]*p0_over_gamma[3]+2.0*E2[3]+0.7071067811865475*p0_over_gamma[0]*B1[3]-0.7071067811865475*p1_over_gamma[0]*B0[3]; 
  alpha[4] = (-1.224744871391589*B0[0]*p1_over_gamma[5])+1.224744871391589*B1[0]*p0_over_gamma[5]-0.7071067811865475*B0[0]*p1_over_gamma[1]+0.7071067811865475*B1[0]*p0_over_gamma[1]; 
  alpha[5] = (-1.224744871391589*B0[0]*p1_over_gamma[6])+1.224744871391589*B1[0]*p0_over_gamma[6]-0.7071067811865475*B0[0]*p1_over_gamma[2]+0.7071067811865475*B1[0]*p0_over_gamma[2]; 
  alpha[6] = 2.0*E2[4]+1.224744871391589*p0_over_gamma[3]*B1[4]+0.7071067811865475*p0_over_gamma[0]*B1[4]-1.224744871391589*p1_over_gamma[3]*B0[4]-0.7071067811865475*p1_over_gamma[0]*B0[4]; 
  alpha[7] = 2.0*E2[5]+1.224744871391589*p0_over_gamma[3]*B1[5]+0.7071067811865475*p0_over_gamma[0]*B1[5]-1.224744871391589*p1_over_gamma[3]*B0[5]-0.7071067811865475*p1_over_gamma[0]*B0[5]; 
  alpha[8] = 2.0*E2[6]+1.224744871391589*p0_over_gamma[3]*B1[6]+0.7071067811865475*p0_over_gamma[0]*B1[6]-1.224744871391589*p1_over_gamma[3]*B0[6]-0.7071067811865475*p1_over_gamma[0]*B0[6]; 
  alpha[9] = (-1.224744871391589*B0[1]*p1_over_gamma[5])+1.224744871391589*B1[1]*p0_over_gamma[5]-0.7071067811865475*B0[1]*p1_over_gamma[1]+0.7071067811865475*B1[1]*p0_over_gamma[1]; 
  alpha[10] = (-1.224744871391589*B0[2]*p1_over_gamma[5])+1.224744871391589*B1[2]*p0_over_gamma[5]+0.7071067811865475*p0_over_gamma[1]*B1[2]-0.7071067811865475*p1_over_gamma[1]*B0[2]; 
  alpha[11] = (-1.224744871391589*B0[3]*p1_over_gamma[5])+1.224744871391589*B1[3]*p0_over_gamma[5]+0.7071067811865475*p0_over_gamma[1]*B1[3]-0.7071067811865475*p1_over_gamma[1]*B0[3]; 
  alpha[12] = (-1.224744871391589*B0[1]*p1_over_gamma[6])+1.224744871391589*B1[1]*p0_over_gamma[6]-0.7071067811865475*B0[1]*p1_over_gamma[2]+0.7071067811865475*B1[1]*p0_over_gamma[2]; 
  alpha[13] = (-1.224744871391589*B0[2]*p1_over_gamma[6])+1.224744871391589*B1[2]*p0_over_gamma[6]-0.7071067811865475*B0[2]*p1_over_gamma[2]+0.7071067811865475*B1[2]*p0_over_gamma[2]; 
  alpha[14] = (-1.224744871391589*B0[3]*p1_over_gamma[6])+1.224744871391589*B1[3]*p0_over_gamma[6]+0.7071067811865475*p0_over_gamma[2]*B1[3]-0.7071067811865475*p1_over_gamma[2]*B0[3]; 
  alpha[15] = (-1.224744871391589*B0[0]*p1_over_gamma[7])+1.224744871391589*B1[0]*p0_over_gamma[7]-0.7071067811865475*B0[0]*p1_over_gamma[4]+0.7071067811865475*B1[0]*p0_over_gamma[4]; 
  alpha[16] = 2.0*E2[7]+1.224744871391589*p0_over_gamma[3]*B1[7]+0.7071067811865475*p0_over_gamma[0]*B1[7]-1.224744871391589*p1_over_gamma[3]*B0[7]-0.7071067811865475*p1_over_gamma[0]*B0[7]; 
  alpha[17] = (-1.224744871391589*B0[4]*p1_over_gamma[5])+1.224744871391589*B1[4]*p0_over_gamma[5]+0.7071067811865475*p0_over_gamma[1]*B1[4]-0.7071067811865475*p1_over_gamma[1]*B0[4]; 
  alpha[18] = (-1.224744871391589*B0[5]*p1_over_gamma[5])+1.224744871391589*B1[5]*p0_over_gamma[5]+0.7071067811865475*p0_over_gamma[1]*B1[5]-0.7071067811865475*p1_over_gamma[1]*B0[5]; 
  alpha[19] = 1.224744871391589*p0_over_gamma[5]*B1[6]+0.7071067811865475*p0_over_gamma[1]*B1[6]-1.224744871391589*p1_over_gamma[5]*B0[6]-0.7071067811865475*p1_over_gamma[1]*B0[6]; 
  alpha[20] = (-1.224744871391589*B0[4]*p1_over_gamma[6])+1.224744871391589*B1[4]*p0_over_gamma[6]+0.7071067811865475*p0_over_gamma[2]*B1[4]-0.7071067811865475*p1_over_gamma[2]*B0[4]; 
  alpha[21] = (-1.224744871391589*B0[5]*p1_over_gamma[6])+1.224744871391589*B1[5]*p0_over_gamma[6]+0.7071067811865475*p0_over_gamma[2]*B1[5]-0.7071067811865475*p1_over_gamma[2]*B0[5]; 
  alpha[22] = (-1.224744871391589*B0[6]*p1_over_gamma[6])+1.224744871391589*B1[6]*p0_over_gamma[6]+0.7071067811865475*p0_over_gamma[2]*B1[6]-0.7071067811865475*p1_over_gamma[2]*B0[6]; 
  alpha[23] = (-1.224744871391589*B0[1]*p1_over_gamma[7])+1.224744871391589*B1[1]*p0_over_gamma[7]-0.7071067811865475*B0[1]*p1_over_gamma[4]+0.7071067811865475*B1[1]*p0_over_gamma[4]; 
  alpha[24] = (-1.224744871391589*B0[2]*p1_over_gamma[7])+1.224744871391589*B1[2]*p0_over_gamma[7]-0.7071067811865475*B0[2]*p1_over_gamma[4]+0.7071067811865475*B1[2]*p0_over_gamma[4]; 
  alpha[25] = (-1.224744871391589*B0[3]*p1_over_gamma[7])+1.224744871391589*B1[3]*p0_over_gamma[7]-0.7071067811865475*B0[3]*p1_over_gamma[4]+0.7071067811865475*B1[3]*p0_over_gamma[4]; 
  alpha[26] = 1.224744871391589*p0_over_gamma[5]*B1[7]+0.7071067811865475*p0_over_gamma[1]*B1[7]-1.224744871391589*p1_over_gamma[5]*B0[7]-0.7071067811865475*p1_over_gamma[1]*B0[7]; 
  alpha[27] = 1.224744871391589*p0_over_gamma[6]*B1[7]+0.7071067811865475*p0_over_gamma[2]*B1[7]-1.224744871391589*p1_over_gamma[6]*B0[7]-0.7071067811865475*p1_over_gamma[2]*B0[7]; 
  alpha[28] = (-1.224744871391589*B0[4]*p1_over_gamma[7])+1.224744871391589*B1[4]*p0_over_gamma[7]-0.7071067811865475*B0[4]*p1_over_gamma[4]+0.7071067811865475*B1[4]*p0_over_gamma[4]; 
  alpha[29] = (-1.224744871391589*B0[5]*p1_over_gamma[7])+1.224744871391589*B1[5]*p0_over_gamma[7]+0.7071067811865475*p0_over_gamma[4]*B1[5]-0.7071067811865475*p1_over_gamma[4]*B0[5]; 
  alpha[30] = (-1.224744871391589*B0[6]*p1_over_gamma[7])+1.224744871391589*B1[6]*p0_over_gamma[7]+0.7071067811865475*p0_over_gamma[4]*B1[6]-0.7071067811865475*p1_over_gamma[4]*B0[6]; 
  alpha[31] = (-1.224744871391589*B0[7]*p1_over_gamma[7])+1.224744871391589*B1[7]*p0_over_gamma[7]+0.7071067811865475*p0_over_gamma[4]*B1[7]-0.7071067811865475*p1_over_gamma[4]*B0[7]; 
