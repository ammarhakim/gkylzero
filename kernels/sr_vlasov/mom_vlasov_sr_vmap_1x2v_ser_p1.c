...
{ 
  ...
  out[1] += (1.414213562373095*p0[2]*f[9]+1.414213562373095*p0[1]*f[4]+1.414213562373095*p0[0]*f[1])*volFact; 
  out[2] += (1.414213562373095*p1[2]*f[12]+1.414213562373095*p1[1]*f[3]+1.414213562373095*f[0]*p1[0])*volFact; 
  out[3] += (1.414213562373095*p1[2]*f[13]+1.414213562373095*p1[1]*f[5]+1.414213562373095*p1[0]*f[1])*volFact; 
} 
...
{ 
  ...
  out[3] += (2.0*p1[2]*f[12]+2.0*p1[1]*f[3]+2.0*f[0]*p1[0])*volFact; 
} 
