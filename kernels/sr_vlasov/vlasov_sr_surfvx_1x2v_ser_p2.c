...
{ 
  ...
  alpha_l[2] = 1.58113883008419*B2[0]*p1_over_gamma[6]-1.224744871391589*B2[0]*p1_over_gamma[3]+0.7071067811865475*B2[0]*p1_over_gamma[2]; 
  alpha_l[3] = 1.58113883008419*B2[1]*p1_over_gamma[6]-1.224744871391589*B2[1]*p1_over_gamma[3]+0.7071067811865475*B2[1]*p1_over_gamma[2]; 
  alpha_l[4] = 1.58113883008419*B2[2]*p1_over_gamma[4]+1.414213562373095*E0[2]-1.224744871391589*p1_over_gamma[1]*B2[2]+0.7071067811865475*p1_over_gamma[0]*B2[2]; 
  alpha_l[5] = 0.7071067811865475*B2[0]*p1_over_gamma[5]-1.224744871391589*B2[0]*p1_over_gamma[7]; 
  ...
  alpha_l[7] = 0.7071067811865475*B2[1]*p1_over_gamma[5]-1.224744871391589*B2[1]*p1_over_gamma[7]; 
  ...
  alpha_r[2] = 1.58113883008419*B2[0]*p1_over_gamma[6]+1.224744871391589*B2[0]*p1_over_gamma[3]+0.7071067811865475*B2[0]*p1_over_gamma[2]; 
  alpha_r[3] = 1.58113883008419*B2[1]*p1_over_gamma[6]+1.224744871391589*B2[1]*p1_over_gamma[3]+0.7071067811865475*B2[1]*p1_over_gamma[2]; 
  alpha_r[4] = 1.58113883008419*B2[2]*p1_over_gamma[4]+1.414213562373095*E0[2]+1.224744871391589*p1_over_gamma[1]*B2[2]+0.7071067811865475*p1_over_gamma[0]*B2[2]; 
  alpha_r[5] = 1.224744871391589*B2[0]*p1_over_gamma[7]+0.7071067811865475*B2[0]*p1_over_gamma[5]; 
  ...
  alpha_r[7] = 1.224744871391589*B2[1]*p1_over_gamma[7]+0.7071067811865475*B2[1]*p1_over_gamma[5]; 
