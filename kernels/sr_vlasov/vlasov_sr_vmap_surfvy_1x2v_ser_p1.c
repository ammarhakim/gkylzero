...
{ 
  ...
  out[7] += (((-1.936491673103709*jacob_vel_inv1[2])-1.5*jacob_vel_inv1[1]-0.8660254037844386*jacob_vel_inv1[0])*Ghat_r[3]+((-1.936491673103709*jacob_vel_inv1[2])+1.5*jacob_vel_inv1[1]-0.8660254037844386*jacob_vel_inv1[0])*Ghat_l[3])*dv11; 
  out[8] += (((-1.118033988749895*jacob_vel_inv1[2])-0.8660254037844386*jacob_vel_inv1[1]-0.5*jacob_vel_inv1[0])*Ghat_r[4]+(1.118033988749895*jacob_vel_inv1[2]-0.8660254037844386*jacob_vel_inv1[1]+0.5*jacob_vel_inv1[0])*Ghat_l[4])*dv11; 
  out[9] += (((-1.118033988749895*jacob_vel_inv1[2])-0.8660254037844386*jacob_vel_inv1[1]-0.5*jacob_vel_inv1[0])*Ghat_r[5]+(1.118033988749895*jacob_vel_inv1[2]-0.8660254037844386*jacob_vel_inv1[1]+0.5*jacob_vel_inv1[0])*Ghat_l[5])*dv11; 
  out[10] += (((-1.936491673103709*jacob_vel_inv1[2])-1.5*jacob_vel_inv1[1]-0.8660254037844387*jacob_vel_inv1[0])*Ghat_r[4]+((-1.936491673103709*jacob_vel_inv1[2])+1.5*jacob_vel_inv1[1]-0.8660254037844387*jacob_vel_inv1[0])*Ghat_l[4])*dv11; 
  out[11] += (((-1.936491673103709*jacob_vel_inv1[2])-1.5*jacob_vel_inv1[1]-0.8660254037844387*jacob_vel_inv1[0])*Ghat_r[5]+((-1.936491673103709*jacob_vel_inv1[2])+1.5*jacob_vel_inv1[1]-0.8660254037844387*jacob_vel_inv1[0])*Ghat_l[5])*dv11; 
  out[12] += ((2.5*Ghat_l[0]-2.5*Ghat_r[0])*jacob_vel_inv1[2]-1.936491673103709*(Ghat_r[0]+Ghat_l[0])*jacob_vel_inv1[1]+(1.118033988749895*Ghat_l[0]-1.118033988749895*Ghat_r[0])*jacob_vel_inv1[0])*dv11; 
  out[13] += ((2.5*Ghat_l[1]-2.5*Ghat_r[1])*jacob_vel_inv1[2]-1.936491673103709*(Ghat_r[1]+Ghat_l[1])*jacob_vel_inv1[1]+jacob_vel_inv1[0]*(1.118033988749895*Ghat_l[1]-1.118033988749895*Ghat_r[1]))*dv11; 
  out[14] += ((2.5*Ghat_l[2]-2.5*Ghat_r[2])*jacob_vel_inv1[2]+((-1.936491673103709*jacob_vel_inv1[1])-1.118033988749895*jacob_vel_inv1[0])*Ghat_r[2]+(1.118033988749895*jacob_vel_inv1[0]-1.936491673103709*jacob_vel_inv1[1])*Ghat_l[2])*dv11; 
  out[15] += (((-2.5*jacob_vel_inv1[2])-1.936491673103709*jacob_vel_inv1[1]-1.118033988749895*jacob_vel_inv1[0])*Ghat_r[3]+(2.5*jacob_vel_inv1[2]-1.936491673103709*jacob_vel_inv1[1]+1.118033988749895*jacob_vel_inv1[0])*Ghat_l[3])*dv11; 
