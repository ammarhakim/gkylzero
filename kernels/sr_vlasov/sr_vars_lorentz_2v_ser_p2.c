...
{ 
  ...
  gamma_nodal[4] = sqrt(1.0 + (-0.7905694150420947*p1_sq[2])-0.7905694150420947*p0_sq[2]+0.7071067811865475*p1_sq[0]+0.7071067811865475*p0_sq[0]);
  gamma_inv_nodal[4] = 1.0/gamma_nodal[4];
  gamma_nodal[5] = sqrt(1.0 + (-0.7905694150420947*p1_sq[2])+1.58113883008419*p0_sq[2]+1.224744871391589*p0_sq[1]+0.7071067811865475*p1_sq[0]+0.7071067811865475*p0_sq[0]);
  gamma_inv_nodal[5] = 1.0/gamma_nodal[5];
  gamma_nodal[6] = sqrt(1.0 + 1.58113883008419*p1_sq[2]+1.58113883008419*p0_sq[2]+1.224744871391589*p1_sq[1]-1.224744871391589*p0_sq[1]+0.7071067811865475*p1_sq[0]+0.7071067811865475*p0_sq[0]);
  gamma_inv_nodal[6] = 1.0/gamma_nodal[6];
  gamma_nodal[7] = sqrt(1.0 + 1.58113883008419*p1_sq[2]-0.7905694150420947*p0_sq[2]+1.224744871391589*p1_sq[1]+0.7071067811865475*p1_sq[0]+0.7071067811865475*p0_sq[0]);
  gamma_inv_nodal[7] = 1.0/gamma_nodal[7];
  gamma_nodal[8] = sqrt(1.0 + 1.58113883008419*p1_sq[2]+1.58113883008419*p0_sq[2]+1.224744871391589*p1_sq[1]+1.224744871391589*p0_sq[1]+0.7071067811865475*p1_sq[0]+0.7071067811865475*p0_sq[0]);
