...
GKYL_CU_DH double vlasov_sr_boundary_surfvx_3x3v_ser_p1(const double *w, const double *dxv, const double *p_over_gamma, const double *qmem, const int edge, const double *fEdge, const double *fSkin, double* GKYL_RESTRICT out) 
{ 
  ...
  alpha[0] = (-1.224744871391589*B1[0]*p2_over_gamma[1])+1.224744871391589*B2[0]*p1_over_gamma[1]-0.7071067811865475*B1[0]*p2_over_gamma[0]+0.7071067811865475*B2[0]*p1_over_gamma[0]+2.0*E0[0]; 
  alpha[1] = (-1.224744871391589*B1[1]*p2_over_gamma[1])+1.224744871391589*B2[1]*p1_over_gamma[1]+2.0*E0[1]+0.7071067811865475*p1_over_gamma[0]*B2[1]-0.7071067811865475*p2_over_gamma[0]*B1[1]; 
  alpha[2] = 2.0*E0[2]+1.224744871391589*p1_over_gamma[1]*B2[2]+0.7071067811865475*p1_over_gamma[0]*B2[2]-1.224744871391589*p2_over_gamma[1]*B1[2]-0.7071067811865475*p2_over_gamma[0]*B1[2]; 
  alpha[3] = 2.0*E0[3]+1.224744871391589*p1_over_gamma[1]*B2[3]+0.7071067811865475*p1_over_gamma[0]*B2[3]-1.224744871391589*p2_over_gamma[1]*B1[3]-0.7071067811865475*p2_over_gamma[0]*B1[3]; 
  alpha[4] = (-1.224744871391589*B1[0]*p2_over_gamma[4])+1.224744871391589*B2[0]*p1_over_gamma[4]-0.7071067811865475*B1[0]*p2_over_gamma[2]+0.7071067811865475*B2[0]*p1_over_gamma[2]; 
  alpha[5] = (-1.224744871391589*B1[0]*p2_over_gamma[5])+1.224744871391589*B2[0]*p1_over_gamma[5]-0.7071067811865475*B1[0]*p2_over_gamma[3]+0.7071067811865475*B2[0]*p1_over_gamma[3]; 
  alpha[6] = 2.0*E0[4]+1.224744871391589*p1_over_gamma[1]*B2[4]+0.7071067811865475*p1_over_gamma[0]*B2[4]-1.224744871391589*p2_over_gamma[1]*B1[4]-0.7071067811865475*p2_over_gamma[0]*B1[4]; 
  alpha[7] = 2.0*E0[5]+1.224744871391589*p1_over_gamma[1]*B2[5]+0.7071067811865475*p1_over_gamma[0]*B2[5]-1.224744871391589*p2_over_gamma[1]*B1[5]-0.7071067811865475*p2_over_gamma[0]*B1[5]; 
  alpha[8] = 2.0*E0[6]+1.224744871391589*p1_over_gamma[1]*B2[6]+0.7071067811865475*p1_over_gamma[0]*B2[6]-1.224744871391589*p2_over_gamma[1]*B1[6]-0.7071067811865475*p2_over_gamma[0]*B1[6]; 
  alpha[9] = (-1.224744871391589*B1[1]*p2_over_gamma[4])+1.224744871391589*B2[1]*p1_over_gamma[4]-0.7071067811865475*B1[1]*p2_over_gamma[2]+0.7071067811865475*B2[1]*p1_over_gamma[2]; 
  alpha[10] = (-1.224744871391589*B1[2]*p2_over_gamma[4])+1.224744871391589*B2[2]*p1_over_gamma[4]-0.7071067811865475*B1[2]*p2_over_gamma[2]+0.7071067811865475*B2[2]*p1_over_gamma[2]; 
  alpha[11] = (-1.224744871391589*B1[3]*p2_over_gamma[4])+1.224744871391589*B2[3]*p1_over_gamma[4]+0.7071067811865475*p1_over_gamma[2]*B2[3]-0.7071067811865475*p2_over_gamma[2]*B1[3]; 
  alpha[12] = (-1.224744871391589*B1[1]*p2_over_gamma[5])+1.224744871391589*B2[1]*p1_over_gamma[5]-0.7071067811865475*B1[1]*p2_over_gamma[3]+0.7071067811865475*B2[1]*p1_over_gamma[3]; 
  alpha[13] = (-1.224744871391589*B1[2]*p2_over_gamma[5])+1.224744871391589*B2[2]*p1_over_gamma[5]-0.7071067811865475*B1[2]*p2_over_gamma[3]+0.7071067811865475*B2[2]*p1_over_gamma[3]; 
  alpha[14] = (-1.224744871391589*B1[3]*p2_over_gamma[5])+1.224744871391589*B2[3]*p1_over_gamma[5]-0.7071067811865475*B1[3]*p2_over_gamma[3]+0.7071067811865475*B2[3]*p1_over_gamma[3]; 
  alpha[15] = (-1.224744871391589*B1[0]*p2_over_gamma[7])+1.224744871391589*B2[0]*p1_over_gamma[7]-0.7071067811865475*B1[0]*p2_over_gamma[6]+0.7071067811865475*B2[0]*p1_over_gamma[6]; 
  alpha[16] = 2.0*E0[7]+1.224744871391589*p1_over_gamma[1]*B2[7]+0.7071067811865475*p1_over_gamma[0]*B2[7]-1.224744871391589*p2_over_gamma[1]*B1[7]-0.7071067811865475*p2_over_gamma[0]*B1[7]; 
  alpha[17] = (-1.224744871391589*B1[4]*p2_over_gamma[4])+1.224744871391589*B2[4]*p1_over_gamma[4]+0.7071067811865475*p1_over_gamma[2]*B2[4]-0.7071067811865475*p2_over_gamma[2]*B1[4]; 
  alpha[18] = 1.224744871391589*p1_over_gamma[4]*B2[5]+0.7071067811865475*p1_over_gamma[2]*B2[5]-1.224744871391589*p2_over_gamma[4]*B1[5]-0.7071067811865475*p2_over_gamma[2]*B1[5]; 
  alpha[19] = 1.224744871391589*p1_over_gamma[4]*B2[6]+0.7071067811865475*p1_over_gamma[2]*B2[6]-1.224744871391589*p2_over_gamma[4]*B1[6]-0.7071067811865475*p2_over_gamma[2]*B1[6]; 
  alpha[20] = (-1.224744871391589*B1[4]*p2_over_gamma[5])+1.224744871391589*B2[4]*p1_over_gamma[5]+0.7071067811865475*p1_over_gamma[3]*B2[4]-0.7071067811865475*p2_over_gamma[3]*B1[4]; 
  alpha[21] = (-1.224744871391589*B1[5]*p2_over_gamma[5])+1.224744871391589*B2[5]*p1_over_gamma[5]+0.7071067811865475*p1_over_gamma[3]*B2[5]-0.7071067811865475*p2_over_gamma[3]*B1[5]; 
  alpha[22] = 1.224744871391589*p1_over_gamma[5]*B2[6]+0.7071067811865475*p1_over_gamma[3]*B2[6]-1.224744871391589*p2_over_gamma[5]*B1[6]-0.7071067811865475*p2_over_gamma[3]*B1[6]; 
  alpha[23] = (-1.224744871391589*B1[1]*p2_over_gamma[7])+1.224744871391589*B2[1]*p1_over_gamma[7]-0.7071067811865475*B1[1]*p2_over_gamma[6]+0.7071067811865475*B2[1]*p1_over_gamma[6]; 
  alpha[24] = (-1.224744871391589*B1[2]*p2_over_gamma[7])+1.224744871391589*B2[2]*p1_over_gamma[7]-0.7071067811865475*B1[2]*p2_over_gamma[6]+0.7071067811865475*B2[2]*p1_over_gamma[6]; 
  alpha[25] = (-1.224744871391589*B1[3]*p2_over_gamma[7])+1.224744871391589*B2[3]*p1_over_gamma[7]-0.7071067811865475*B1[3]*p2_over_gamma[6]+0.7071067811865475*B2[3]*p1_over_gamma[6]; 
  alpha[26] = 1.224744871391589*p1_over_gamma[4]*B2[7]+0.7071067811865475*p1_over_gamma[2]*B2[7]-1.224744871391589*p2_over_gamma[4]*B1[7]-0.7071067811865475*p2_over_gamma[2]*B1[7]; 
  alpha[27] = 1.224744871391589*p1_over_gamma[5]*B2[7]+0.7071067811865475*p1_over_gamma[3]*B2[7]-1.224744871391589*p2_over_gamma[5]*B1[7]-0.7071067811865475*p2_over_gamma[3]*B1[7]; 
  alpha[28] = (-1.224744871391589*B1[4]*p2_over_gamma[7])+1.224744871391589*B2[4]*p1_over_gamma[7]-0.7071067811865475*B1[4]*p2_over_gamma[6]+0.7071067811865475*B2[4]*p1_over_gamma[6]; 
  alpha[29] = (-1.224744871391589*B1[5]*p2_over_gamma[7])+1.224744871391589*B2[5]*p1_over_gamma[7]-0.7071067811865475*B1[5]*p2_over_gamma[6]+0.7071067811865475*B2[5]*p1_over_gamma[6]; 
  alpha[30] = (-1.224744871391589*B1[6]*p2_over_gamma[7])+1.224744871391589*B2[6]*p1_over_gamma[7]-0.7071067811865475*B1[6]*p2_over_gamma[6]+0.7071067811865475*B2[6]*p1_over_gamma[6]; 
  alpha[31] = (-1.224744871391589*B1[7]*p2_over_gamma[7])+1.224744871391589*B2[7]*p1_over_gamma[7]+0.7071067811865475*p1_over_gamma[6]*B2[7]-0.7071067811865475*p2_over_gamma[6]*B1[7]; 
