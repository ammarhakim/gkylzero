...
{ 
  ...
  out[1] += 1.224744871391589*(p0_over_gamma[2]*f[4]+p0_over_gamma[1]*f[2]+f[0]*p0_over_gamma[0])*dx10; 
  out[3] += (1.095445115010332*(p0_over_gamma[1]*f[4]+f[2]*p0_over_gamma[2])+1.224744871391589*(p0_over_gamma[0]*f[2]+f[0]*p0_over_gamma[1]))*dx10; 
  out[5] += (0.7824607964359517*p0_over_gamma[2]*f[4]+1.224744871391589*(p0_over_gamma[0]*f[4]+f[0]*p0_over_gamma[2])+1.095445115010332*p0_over_gamma[1]*f[2])*dx10; 
  ...
  out[3] += 0.8660254037844387*(alpha_vdim[4]*f[5]+f[4]*alpha_vdim[5])+0.8660254037844386*(alpha_vdim[2]*f[3]+f[2]*alpha_vdim[3]+alpha_vdim[0]*f[1]+f[0]*alpha_vdim[1]); 
  out[4] += 1.732050807568877*(alpha_vdim[3]*f[5]+f[3]*alpha_vdim[5])+1.732050807568877*(alpha_vdim[2]*f[4]+f[2]*alpha_vdim[4])+1.936491673103709*(alpha_vdim[1]*f[3]+f[1]*alpha_vdim[3]+alpha_vdim[0]*f[2]+f[0]*alpha_vdim[2]); 
  out[5] += 1.732050807568877*(alpha_vdim[2]*f[5]+f[2]*alpha_vdim[5])+1.732050807568877*(alpha_vdim[3]*f[4]+f[3]*alpha_vdim[4])+1.936491673103709*(alpha_vdim[0]*f[3]+f[0]*alpha_vdim[3]+alpha_vdim[1]*f[2]+f[1]*alpha_vdim[2]); 
