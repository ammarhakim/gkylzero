...
{ 
  ...
  alpha[2] = 2.23606797749979*E0[2]*jacob_vel_inv0[2]+1.732050807568877*jacob_vel_inv0[1]*E0[2]+jacob_vel_inv0[0]*E0[2]+p1_over_gamma_r[0]*B2[2]; 
  alpha[3] = B2[0]*p1_over_gamma_r[1]; 
  alpha[4] = 2.23606797749979*jacob_vel_inv0[2]*E0[3]+1.732050807568877*jacob_vel_inv0[1]*E0[3]+jacob_vel_inv0[0]*E0[3]+p1_over_gamma_r[0]*B2[3]; 
  alpha[5] = B2[1]*p1_over_gamma_r[1]; 
  alpha[6] = p1_over_gamma_r[1]*B2[2]; 
  alpha[7] = 2.23606797749979*jacob_vel_inv0[2]*E0[4]+1.732050807568877*jacob_vel_inv0[1]*E0[4]+jacob_vel_inv0[0]*E0[4]+p1_over_gamma_r[0]*B2[4]; 
  alpha[8] = 2.23606797749979*jacob_vel_inv0[2]*E0[5]+1.732050807568877*jacob_vel_inv0[1]*E0[5]+jacob_vel_inv0[0]*E0[5]+p1_over_gamma_r[0]*B2[5]; 
  alpha[9] = B2[0]*p1_over_gamma_r[2]; 
  alpha[10] = p1_over_gamma_r[1]*B2[3]; 
  alpha[11] = 2.23606797749979*jacob_vel_inv0[2]*E0[6]+1.732050807568877*jacob_vel_inv0[1]*E0[6]+jacob_vel_inv0[0]*E0[6]+p1_over_gamma_r[0]*B2[6]; 
  alpha[12] = 2.23606797749979*jacob_vel_inv0[2]*E0[7]+1.732050807568877*jacob_vel_inv0[1]*E0[7]+jacob_vel_inv0[0]*E0[7]+p1_over_gamma_r[0]*B2[7]; 
  ...
  alpha[2] = 2.23606797749979*E0[2]*jacob_vel_inv0[2]-1.732050807568877*jacob_vel_inv0[1]*E0[2]+jacob_vel_inv0[0]*E0[2]+p1_over_gamma_l[0]*B2[2]; 
  alpha[3] = B2[0]*p1_over_gamma_l[1]; 
  alpha[4] = 2.23606797749979*jacob_vel_inv0[2]*E0[3]-1.732050807568877*jacob_vel_inv0[1]*E0[3]+jacob_vel_inv0[0]*E0[3]+p1_over_gamma_l[0]*B2[3]; 
  alpha[5] = B2[1]*p1_over_gamma_l[1]; 
  alpha[6] = p1_over_gamma_l[1]*B2[2]; 
  alpha[7] = 2.23606797749979*jacob_vel_inv0[2]*E0[4]-1.732050807568877*jacob_vel_inv0[1]*E0[4]+jacob_vel_inv0[0]*E0[4]+p1_over_gamma_l[0]*B2[4]; 
  alpha[8] = 2.23606797749979*jacob_vel_inv0[2]*E0[5]-1.732050807568877*jacob_vel_inv0[1]*E0[5]+jacob_vel_inv0[0]*E0[5]+p1_over_gamma_l[0]*B2[5]; 
  alpha[9] = B2[0]*p1_over_gamma_l[2]; 
  alpha[10] = p1_over_gamma_l[1]*B2[3]; 
  alpha[11] = 2.23606797749979*jacob_vel_inv0[2]*E0[6]-1.732050807568877*jacob_vel_inv0[1]*E0[6]+jacob_vel_inv0[0]*E0[6]+p1_over_gamma_l[0]*B2[6]; 
  alpha[12] = 2.23606797749979*jacob_vel_inv0[2]*E0[7]-1.732050807568877*jacob_vel_inv0[1]*E0[7]+jacob_vel_inv0[0]*E0[7]+p1_over_gamma_l[0]*B2[7]; 
