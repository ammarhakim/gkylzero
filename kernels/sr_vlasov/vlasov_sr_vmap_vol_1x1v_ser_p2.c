...
{ 
  ...
  out[3] += 0.8660254037844387*(alpha_vdim[5]*f[7]+f[5]*alpha_vdim[7])+0.7745966692414834*(alpha_vdim[3]*f[6]+f[3]*alpha_vdim[6])+0.7745966692414833*(alpha_vdim[1]*f[4]+f[1]*alpha_vdim[4])+0.8660254037844386*(alpha_vdim[2]*f[3]+f[2]*alpha_vdim[3]+alpha_vdim[0]*f[1]+f[0]*alpha_vdim[1]); 
  ...
  out[6] += 0.7745966692414834*alpha_vdim[7]*f[7]+0.5532833351724881*alpha_vdim[6]*f[6]+0.8660254037844386*(alpha_vdim[2]*f[6]+f[2]*alpha_vdim[6])+0.5532833351724881*alpha_vdim[4]*f[4]+0.8660254037844387*(alpha_vdim[0]*f[4]+f[0]*alpha_vdim[4])+0.7745966692414834*(alpha_vdim[3]*f[3]+alpha_vdim[1]*f[1]); 
