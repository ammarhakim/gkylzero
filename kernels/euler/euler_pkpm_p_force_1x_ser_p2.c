...
{ 
  ...
  b_div_p[0] = (-0.7071067811865475*div_b[2]*p_perp[2])+0.7071067811865475*bz[2]*div_p_z[2]+0.7071067811865475*by[2]*div_p_y[2]+0.7071067811865475*bx[2]*div_p_x[2]-0.7071067811865475*div_b[1]*p_perp[1]+0.7071067811865475*bz[1]*div_p_z[1]+0.7071067811865475*by[1]*div_p_y[1]+0.7071067811865475*bx[1]*div_p_x[1]-0.7071067811865475*div_b[0]*p_perp[0]+0.7071067811865475*bz[0]*div_p_z[0]+0.7071067811865475*by[0]*div_p_y[0]+0.7071067811865475*bx[0]*div_p_x[0]; 
  b_div_p[1] = (-0.6324555320336759*div_b[1]*p_perp[2])+0.6324555320336759*bz[1]*div_p_z[2]+0.6324555320336759*by[1]*div_p_y[2]+0.6324555320336759*bx[1]*div_p_x[2]-0.6324555320336759*p_perp[1]*div_b[2]+0.6324555320336759*div_p_z[1]*bz[2]+0.6324555320336759*div_p_y[1]*by[2]+0.6324555320336759*div_p_x[1]*bx[2]-0.7071067811865475*div_b[0]*p_perp[1]+0.7071067811865475*bz[0]*div_p_z[1]+0.7071067811865475*by[0]*div_p_y[1]+0.7071067811865475*bx[0]*div_p_x[1]-0.7071067811865475*p_perp[0]*div_b[1]+0.7071067811865475*div_p_z[0]*bz[1]+0.7071067811865475*div_p_y[0]*by[1]+0.7071067811865475*div_p_x[0]*bx[1]; 
  b_div_p[2] = (-0.4517539514526256*div_b[2]*p_perp[2])-0.7071067811865475*div_b[0]*p_perp[2]+0.4517539514526256*bz[2]*div_p_z[2]+0.7071067811865475*bz[0]*div_p_z[2]+0.4517539514526256*by[2]*div_p_y[2]+0.7071067811865475*by[0]*div_p_y[2]+0.4517539514526256*bx[2]*div_p_x[2]+0.7071067811865475*bx[0]*div_p_x[2]-0.7071067811865475*p_perp[0]*div_b[2]+0.7071067811865475*div_p_z[0]*bz[2]+0.7071067811865475*div_p_y[0]*by[2]+0.7071067811865475*div_p_x[0]*bx[2]-0.6324555320336759*div_b[1]*p_perp[1]+0.6324555320336759*bz[1]*div_p_z[1]+0.6324555320336759*by[1]*div_p_y[1]+0.6324555320336759*bx[1]*div_p_x[1]; 
