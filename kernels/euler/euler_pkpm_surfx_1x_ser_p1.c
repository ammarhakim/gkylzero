...
{ 
  ...
  double Pxxrec_l = 0.408248290463863*Pxx_l[1]-0.408248290463863*Pxx_c[1]+0.3535533905932737*Pxx_l[0]+0.3535533905932737*Pxx_c[0]; 
  double Pxxrec_r = (-0.408248290463863*Pxx_r[1])+0.408248290463863*Pxx_c[1]+0.3535533905932737*Pxx_r[0]+0.3535533905932737*Pxx_c[0]; 
  double Pxyrec_l = 0.408248290463863*Pxy_l[1]-0.408248290463863*Pxy_c[1]+0.3535533905932737*Pxy_l[0]+0.3535533905932737*Pxy_c[0]; 
  double Pxyrec_r = (-0.408248290463863*Pxy_r[1])+0.408248290463863*Pxy_c[1]+0.3535533905932737*Pxy_r[0]+0.3535533905932737*Pxy_c[0]; 
  double Pxzrec_l = 0.408248290463863*Pxz_l[1]-0.408248290463863*Pxz_c[1]+0.3535533905932737*Pxz_l[0]+0.3535533905932737*Pxz_c[0]; 
  double Pxzrec_r = (-0.408248290463863*Pxz_r[1])+0.408248290463863*Pxz_c[1]+0.3535533905932737*Pxz_r[0]+0.3535533905932737*Pxz_c[0]; 
