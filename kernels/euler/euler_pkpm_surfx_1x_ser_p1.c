...
{ 
  ...
  if (ux_c_l > 0) { 
  Ghat_rhoux_l = (1.224744871391589*rhoux_l[1]+0.7071067811865475*rhoux_l[0])*ux_c_l; 
  Ghat_rhouy_l = (1.224744871391589*rhouy_l[1]+0.7071067811865475*rhouy_l[0])*ux_c_l; 
  Ghat_rhouz_l = (1.224744871391589*rhouz_l[1]+0.7071067811865475*rhouz_l[0])*ux_c_l; 
  Ghat_p_perp_l = (1.224744871391589*p_perp_l[1]+0.7071067811865475*p_perp_l[0])*ux_c_l; 
  } else { 
  Ghat_rhoux_l = (0.7071067811865475*rhoux_c[0]-1.224744871391589*rhoux_c[1])*ux_c_l; 
  Ghat_rhouy_l = (0.7071067811865475*rhouy_c[0]-1.224744871391589*rhouy_c[1])*ux_c_l; 
  Ghat_rhouz_l = (0.7071067811865475*rhouz_c[0]-1.224744871391589*rhouz_c[1])*ux_c_l; 
  Ghat_p_perp_l = (0.7071067811865475*p_perp_c[0]-1.224744871391589*p_perp_c[1])*ux_c_l; 
  } 
  if (ux_c_r > 0) { 
  Ghat_rhoux_r = (1.224744871391589*rhoux_c[1]+0.7071067811865475*rhoux_c[0])*ux_c_r; 
  Ghat_rhouy_r = (1.224744871391589*rhouy_c[1]+0.7071067811865475*rhouy_c[0])*ux_c_r; 
  Ghat_rhouz_r = (1.224744871391589*rhouz_c[1]+0.7071067811865475*rhouz_c[0])*ux_c_r; 
  Ghat_p_perp_r = (1.224744871391589*p_perp_c[1]+0.7071067811865475*p_perp_c[0])*ux_c_r; 
  } else { 
  Ghat_rhoux_r = (0.7071067811865475*rhoux_r[0]-1.224744871391589*rhoux_r[1])*ux_c_r; 
  Ghat_rhouy_r = (0.7071067811865475*rhouy_r[0]-1.224744871391589*rhouy_r[1])*ux_c_r; 
  Ghat_rhouz_r = (0.7071067811865475*rhouz_r[0]-1.224744871391589*rhouz_r[1])*ux_c_r; 
