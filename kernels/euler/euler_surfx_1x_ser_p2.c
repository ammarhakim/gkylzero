...
{ 
  ...
  outrhou0[0] += (-0.5590169943749475*ur_0[2]*Ghat_rho_r*dx1)-0.5590169943749475*uc_0[2]*Ghat_rho_r*dx1+0.4330127018922193*ur_0[1]*Ghat_rho_r*dx1-0.4330127018922193*uc_0[1]*Ghat_rho_r*dx1-0.25*ur_0[0]*Ghat_rho_r*dx1-0.25*uc_0[0]*Ghat_rho_r*dx1+0.5590169943749475*ul_0[2]*Ghat_rho_l*dx1+0.5590169943749475*uc_0[2]*Ghat_rho_l*dx1+0.4330127018922193*ul_0[1]*Ghat_rho_l*dx1-0.4330127018922193*uc_0[1]*Ghat_rho_l*dx1+0.25*ul_0[0]*Ghat_rho_l*dx1+0.25*uc_0[0]*Ghat_rho_l*dx1-0.5590169943749475*pr[2]*dx1+0.5590169943749475*pl[2]*dx1+0.4330127018922193*pr[1]*dx1+0.4330127018922193*pl[1]*dx1-0.8660254037844386*pc[1]*dx1-0.25*pr[0]*dx1+0.25*pl[0]*dx1; 
  outrhou0[1] += (-0.9682458365518543*ur_0[2]*Ghat_rho_r*dx1)-0.9682458365518543*uc_0[2]*Ghat_rho_r*dx1+0.75*ur_0[1]*Ghat_rho_r*dx1-0.75*uc_0[1]*Ghat_rho_r*dx1-0.4330127018922193*ur_0[0]*Ghat_rho_r*dx1-0.4330127018922193*uc_0[0]*Ghat_rho_r*dx1-0.9682458365518543*ul_0[2]*Ghat_rho_l*dx1-0.9682458365518543*uc_0[2]*Ghat_rho_l*dx1-0.75*ul_0[1]*Ghat_rho_l*dx1+0.75*uc_0[1]*Ghat_rho_l*dx1-0.4330127018922193*ul_0[0]*Ghat_rho_l*dx1-0.4330127018922193*uc_0[0]*Ghat_rho_l*dx1-0.9682458365518543*pr[2]*dx1-0.9682458365518543*pl[2]*dx1-1.936491673103709*pc[2]*dx1+0.75*pr[1]*dx1-0.75*pl[1]*dx1-0.4330127018922193*pr[0]*dx1-0.4330127018922193*pl[0]*dx1-0.8660254037844386*pc[0]*dx1; 
  outrhou0[2] += (-1.25*ur_0[2]*Ghat_rho_r*dx1)-1.25*uc_0[2]*Ghat_rho_r*dx1+0.9682458365518543*ur_0[1]*Ghat_rho_r*dx1-0.9682458365518543*uc_0[1]*Ghat_rho_r*dx1-0.5590169943749475*ur_0[0]*Ghat_rho_r*dx1-0.5590169943749475*uc_0[0]*Ghat_rho_r*dx1+1.25*ul_0[2]*Ghat_rho_l*dx1+1.25*uc_0[2]*Ghat_rho_l*dx1+0.9682458365518543*ul_0[1]*Ghat_rho_l*dx1-0.9682458365518543*uc_0[1]*Ghat_rho_l*dx1+0.5590169943749475*ul_0[0]*Ghat_rho_l*dx1+0.5590169943749475*uc_0[0]*Ghat_rho_l*dx1-1.25*pr[2]*dx1+1.25*pl[2]*dx1+0.9682458365518543*pr[1]*dx1+0.9682458365518543*pl[1]*dx1-1.936491673103709*pc[1]*dx1-0.5590169943749475*pr[0]*dx1+0.5590169943749475*pl[0]*dx1; 

  outrhou1[0] += (-0.5590169943749475*ur_1[2]*Ghat_rho_r*dx1)-0.5590169943749475*uc_1[2]*Ghat_rho_r*dx1+0.4330127018922193*ur_1[1]*Ghat_rho_r*dx1-0.4330127018922193*uc_1[1]*Ghat_rho_r*dx1-0.25*ur_1[0]*Ghat_rho_r*dx1-0.25*uc_1[0]*Ghat_rho_r*dx1+0.5590169943749475*ul_1[2]*Ghat_rho_l*dx1+0.5590169943749475*uc_1[2]*Ghat_rho_l*dx1+0.4330127018922193*ul_1[1]*Ghat_rho_l*dx1-0.4330127018922193*uc_1[1]*Ghat_rho_l*dx1+0.25*ul_1[0]*Ghat_rho_l*dx1+0.25*uc_1[0]*Ghat_rho_l*dx1; 
  outrhou1[1] += (-0.9682458365518543*ur_1[2]*Ghat_rho_r*dx1)-0.9682458365518543*uc_1[2]*Ghat_rho_r*dx1+0.75*ur_1[1]*Ghat_rho_r*dx1-0.75*uc_1[1]*Ghat_rho_r*dx1-0.4330127018922193*ur_1[0]*Ghat_rho_r*dx1-0.4330127018922193*uc_1[0]*Ghat_rho_r*dx1-0.9682458365518543*ul_1[2]*Ghat_rho_l*dx1-0.9682458365518543*uc_1[2]*Ghat_rho_l*dx1-0.75*ul_1[1]*Ghat_rho_l*dx1+0.75*uc_1[1]*Ghat_rho_l*dx1-0.4330127018922193*ul_1[0]*Ghat_rho_l*dx1-0.4330127018922193*uc_1[0]*Ghat_rho_l*dx1; 
  outrhou1[2] += (-1.25*ur_1[2]*Ghat_rho_r*dx1)-1.25*uc_1[2]*Ghat_rho_r*dx1+0.9682458365518543*ur_1[1]*Ghat_rho_r*dx1-0.9682458365518543*uc_1[1]*Ghat_rho_r*dx1-0.5590169943749475*ur_1[0]*Ghat_rho_r*dx1-0.5590169943749475*uc_1[0]*Ghat_rho_r*dx1+1.25*ul_1[2]*Ghat_rho_l*dx1+1.25*uc_1[2]*Ghat_rho_l*dx1+0.9682458365518543*ul_1[1]*Ghat_rho_l*dx1-0.9682458365518543*uc_1[1]*Ghat_rho_l*dx1+0.5590169943749475*ul_1[0]*Ghat_rho_l*dx1+0.5590169943749475*uc_1[0]*Ghat_rho_l*dx1; 

  outrhou2[0] += (-0.5590169943749475*ur_2[2]*Ghat_rho_r*dx1)-0.5590169943749475*uc_2[2]*Ghat_rho_r*dx1+0.4330127018922193*ur_2[1]*Ghat_rho_r*dx1-0.4330127018922193*uc_2[1]*Ghat_rho_r*dx1-0.25*ur_2[0]*Ghat_rho_r*dx1-0.25*uc_2[0]*Ghat_rho_r*dx1+0.5590169943749475*ul_2[2]*Ghat_rho_l*dx1+0.5590169943749475*uc_2[2]*Ghat_rho_l*dx1+0.4330127018922193*ul_2[1]*Ghat_rho_l*dx1-0.4330127018922193*uc_2[1]*Ghat_rho_l*dx1+0.25*ul_2[0]*Ghat_rho_l*dx1+0.25*uc_2[0]*Ghat_rho_l*dx1; 
  outrhou2[1] += (-0.9682458365518543*ur_2[2]*Ghat_rho_r*dx1)-0.9682458365518543*uc_2[2]*Ghat_rho_r*dx1+0.75*ur_2[1]*Ghat_rho_r*dx1-0.75*uc_2[1]*Ghat_rho_r*dx1-0.4330127018922193*ur_2[0]*Ghat_rho_r*dx1-0.4330127018922193*uc_2[0]*Ghat_rho_r*dx1-0.9682458365518543*ul_2[2]*Ghat_rho_l*dx1-0.9682458365518543*uc_2[2]*Ghat_rho_l*dx1-0.75*ul_2[1]*Ghat_rho_l*dx1+0.75*uc_2[1]*Ghat_rho_l*dx1-0.4330127018922193*ul_2[0]*Ghat_rho_l*dx1-0.4330127018922193*uc_2[0]*Ghat_rho_l*dx1; 
  outrhou2[2] += (-1.25*ur_2[2]*Ghat_rho_r*dx1)-1.25*uc_2[2]*Ghat_rho_r*dx1+0.9682458365518543*ur_2[1]*Ghat_rho_r*dx1-0.9682458365518543*uc_2[1]*Ghat_rho_r*dx1-0.5590169943749475*ur_2[0]*Ghat_rho_r*dx1-0.5590169943749475*uc_2[0]*Ghat_rho_r*dx1+1.25*ul_2[2]*Ghat_rho_l*dx1+1.25*uc_2[2]*Ghat_rho_l*dx1+0.9682458365518543*ul_2[1]*Ghat_rho_l*dx1-0.9682458365518543*uc_2[1]*Ghat_rho_l*dx1+0.5590169943749475*ul_2[0]*Ghat_rho_l*dx1+0.5590169943749475*uc_2[0]*Ghat_rho_l*dx1; 
