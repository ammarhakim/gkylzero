...
{ 
  ...
  outrhou0[0] += (-0.7071067811865475*Ghat_rho_r*dx1*urec_0_r)+0.7071067811865475*Ghat_rho_l*dx1*urec_0_l+0.5590169943749475*rhou0_r[2]*dx1*u_max_r-0.5590169943749475*rhou0_c[2]*dx1*u_max_r-0.4330127018922193*rhou0_r[1]*dx1*u_max_r-0.4330127018922193*rhou0_c[1]*dx1*u_max_r+0.25*rhou0_r[0]*dx1*u_max_r-0.25*rhou0_c[0]*dx1*u_max_r+0.5590169943749475*rhou0_l[2]*dx1*u_max_l-0.5590169943749475*rhou0_c[2]*dx1*u_max_l+0.4330127018922193*rhou0_l[1]*dx1*u_max_l+0.4330127018922193*rhou0_c[1]*dx1*u_max_l+0.25*rhou0_l[0]*dx1*u_max_l-0.25*rhou0_c[0]*dx1*u_max_l-0.7071067811865475*dx1*prec_r+0.7071067811865475*dx1*prec_l; 
  outrhou0[1] += (-1.224744871391589*Ghat_rho_r*dx1*urec_0_r)-1.224744871391589*Ghat_rho_l*dx1*urec_0_l+0.9682458365518543*rhou0_r[2]*dx1*u_max_r-0.9682458365518543*rhou0_c[2]*dx1*u_max_r-0.75*rhou0_r[1]*dx1*u_max_r-0.75*rhou0_c[1]*dx1*u_max_r+0.4330127018922193*rhou0_r[0]*dx1*u_max_r-0.4330127018922193*rhou0_c[0]*dx1*u_max_r-0.9682458365518543*rhou0_l[2]*dx1*u_max_l+0.9682458365518543*rhou0_c[2]*dx1*u_max_l-0.75*rhou0_l[1]*dx1*u_max_l-0.75*rhou0_c[1]*dx1*u_max_l-0.4330127018922193*rhou0_l[0]*dx1*u_max_l+0.4330127018922193*rhou0_c[0]*dx1*u_max_l-1.224744871391589*dx1*prec_r-1.224744871391589*dx1*prec_l; 
  outrhou0[2] += (-1.58113883008419*Ghat_rho_r*dx1*urec_0_r)+1.58113883008419*Ghat_rho_l*dx1*urec_0_l+1.25*rhou0_r[2]*dx1*u_max_r-1.25*rhou0_c[2]*dx1*u_max_r-0.9682458365518543*rhou0_r[1]*dx1*u_max_r-0.9682458365518543*rhou0_c[1]*dx1*u_max_r+0.5590169943749475*rhou0_r[0]*dx1*u_max_r-0.5590169943749475*rhou0_c[0]*dx1*u_max_r+1.25*rhou0_l[2]*dx1*u_max_l-1.25*rhou0_c[2]*dx1*u_max_l+0.9682458365518543*rhou0_l[1]*dx1*u_max_l+0.9682458365518543*rhou0_c[1]*dx1*u_max_l+0.5590169943749475*rhou0_l[0]*dx1*u_max_l-0.5590169943749475*rhou0_c[0]*dx1*u_max_l-1.58113883008419*dx1*prec_r+1.58113883008419*dx1*prec_l; 
