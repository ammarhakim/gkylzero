...
{ 
  ...
  double Ghat_rhoux_l = 0.7905694150420948*rhou0_l[2]*u_max_l-0.7905694150420948*rhou0_c[2]*u_max_l+0.6123724356957945*rhou0_l[1]*u_max_l+0.6123724356957945*rhou0_c[1]*u_max_l+0.3535533905932737*rhou0_l[0]*u_max_l-0.3535533905932737*rhou0_c[0]*u_max_l+0.7905694150420948*ul_0[2]*Ghat_rho_l+0.7905694150420948*uc_0[2]*Ghat_rho_l+0.6123724356957945*ul_0[1]*Ghat_rho_l-0.6123724356957945*uc_0[1]*Ghat_rho_l+0.3535533905932737*ul_0[0]*Ghat_rho_l+0.3535533905932737*uc_0[0]*Ghat_rho_l+0.7905694150420948*pl[2]+0.7905694150420948*pc[2]+0.6123724356957945*pl[1]-0.6123724356957945*pc[1]+0.3535533905932737*pl[0]+0.3535533905932737*pc[0]; 
  double Ghat_rhoux_r = (-0.7905694150420948*rhou0_r[2]*u_max_r)+0.7905694150420948*rhou0_c[2]*u_max_r+0.6123724356957945*rhou0_r[1]*u_max_r+0.6123724356957945*rhou0_c[1]*u_max_r-0.3535533905932737*rhou0_r[0]*u_max_r+0.3535533905932737*rhou0_c[0]*u_max_r+0.7905694150420948*ur_0[2]*Ghat_rho_r+0.7905694150420948*uc_0[2]*Ghat_rho_r-0.6123724356957945*ur_0[1]*Ghat_rho_r+0.6123724356957945*uc_0[1]*Ghat_rho_r+0.3535533905932737*ur_0[0]*Ghat_rho_r+0.3535533905932737*uc_0[0]*Ghat_rho_r+0.7905694150420948*pr[2]+0.7905694150420948*pc[2]-0.6123724356957945*pr[1]+0.6123724356957945*pc[1]+0.3535533905932737*pr[0]+0.3535533905932737*pc[0]; 
  double Ghat_rhouy_l = 0.7905694150420948*rhou1_l[2]*u_max_l-0.7905694150420948*rhou1_c[2]*u_max_l+0.6123724356957945*rhou1_l[1]*u_max_l+0.6123724356957945*rhou1_c[1]*u_max_l+0.3535533905932737*rhou1_l[0]*u_max_l-0.3535533905932737*rhou1_c[0]*u_max_l+0.7905694150420948*ul_1[2]*Ghat_rho_l+0.7905694150420948*uc_1[2]*Ghat_rho_l+0.6123724356957945*ul_1[1]*Ghat_rho_l-0.6123724356957945*uc_1[1]*Ghat_rho_l+0.3535533905932737*ul_1[0]*Ghat_rho_l+0.3535533905932737*uc_1[0]*Ghat_rho_l; 
  double Ghat_rhouy_r = (-0.7905694150420948*rhou1_r[2]*u_max_r)+0.7905694150420948*rhou1_c[2]*u_max_r+0.6123724356957945*rhou1_r[1]*u_max_r+0.6123724356957945*rhou1_c[1]*u_max_r-0.3535533905932737*rhou1_r[0]*u_max_r+0.3535533905932737*rhou1_c[0]*u_max_r+0.7905694150420948*ur_1[2]*Ghat_rho_r+0.7905694150420948*uc_1[2]*Ghat_rho_r-0.6123724356957945*ur_1[1]*Ghat_rho_r+0.6123724356957945*uc_1[1]*Ghat_rho_r+0.3535533905932737*ur_1[0]*Ghat_rho_r+0.3535533905932737*uc_1[0]*Ghat_rho_r; 
  double Ghat_rhouz_l = 0.7905694150420948*rhou2_l[2]*u_max_l-0.7905694150420948*rhou2_c[2]*u_max_l+0.6123724356957945*rhou2_l[1]*u_max_l+0.6123724356957945*rhou2_c[1]*u_max_l+0.3535533905932737*rhou2_l[0]*u_max_l-0.3535533905932737*rhou2_c[0]*u_max_l+0.7905694150420948*ul_2[2]*Ghat_rho_l+0.7905694150420948*uc_2[2]*Ghat_rho_l+0.6123724356957945*ul_2[1]*Ghat_rho_l-0.6123724356957945*uc_2[1]*Ghat_rho_l+0.3535533905932737*ul_2[0]*Ghat_rho_l+0.3535533905932737*uc_2[0]*Ghat_rho_l; 
  double Ghat_rhouz_r = (-0.7905694150420948*rhou2_r[2]*u_max_r)+0.7905694150420948*rhou2_c[2]*u_max_r+0.6123724356957945*rhou2_r[1]*u_max_r+0.6123724356957945*rhou2_c[1]*u_max_r-0.3535533905932737*rhou2_r[0]*u_max_r+0.3535533905932737*rhou2_c[0]*u_max_r+0.7905694150420948*ur_2[2]*Ghat_rho_r+0.7905694150420948*uc_2[2]*Ghat_rho_r-0.6123724356957945*ur_2[1]*Ghat_rho_r+0.6123724356957945*uc_2[1]*Ghat_rho_r+0.3535533905932737*ur_2[0]*Ghat_rho_r+0.3535533905932737*uc_2[0]*Ghat_rho_r; 
