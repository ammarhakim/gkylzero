...
{ 
  ...
  double Ghat_rhoux_l = 0.7905694150420948*rho_flux_l[0]*ux_l[2]+0.7905694150420948*rho_flux_l[0]*ux_c[2]+0.7905694150420948*Pxx_l[2]+0.7905694150420948*Pxx_c[2]+0.6123724356957945*rho_flux_l[0]*ux_l[1]-0.6123724356957945*rho_flux_l[0]*ux_c[1]+0.6123724356957945*Pxx_l[1]-0.6123724356957945*Pxx_c[1]+0.3535533905932737*rho_flux_l[0]*ux_l[0]+0.3535533905932737*rho_flux_l[0]*ux_c[0]+0.3535533905932737*Pxx_l[0]+0.3535533905932737*Pxx_c[0]; 
  double Ghat_rhoux_r = 0.7905694150420948*rho_flux_r[0]*ux_r[2]+0.7905694150420948*rho_flux_r[0]*ux_c[2]+0.7905694150420948*Pxx_r[2]+0.7905694150420948*Pxx_c[2]-0.6123724356957945*rho_flux_r[0]*ux_r[1]+0.6123724356957945*rho_flux_r[0]*ux_c[1]-0.6123724356957945*Pxx_r[1]+0.6123724356957945*Pxx_c[1]+0.3535533905932737*rho_flux_r[0]*ux_r[0]+0.3535533905932737*rho_flux_r[0]*ux_c[0]+0.3535533905932737*Pxx_r[0]+0.3535533905932737*Pxx_c[0]; 
  double Ghat_rhouy_l = 0.7905694150420948*rho_flux_l[0]*uy_l[2]+0.7905694150420948*rho_flux_l[0]*uy_c[2]+0.7905694150420948*Pxy_l[2]+0.7905694150420948*Pxy_c[2]+0.6123724356957945*rho_flux_l[0]*uy_l[1]-0.6123724356957945*rho_flux_l[0]*uy_c[1]+0.6123724356957945*Pxy_l[1]-0.6123724356957945*Pxy_c[1]+0.3535533905932737*rho_flux_l[0]*uy_l[0]+0.3535533905932737*rho_flux_l[0]*uy_c[0]+0.3535533905932737*Pxy_l[0]+0.3535533905932737*Pxy_c[0]; 
  double Ghat_rhouy_r = 0.7905694150420948*rho_flux_r[0]*uy_r[2]+0.7905694150420948*rho_flux_r[0]*uy_c[2]+0.7905694150420948*Pxy_r[2]+0.7905694150420948*Pxy_c[2]-0.6123724356957945*rho_flux_r[0]*uy_r[1]+0.6123724356957945*rho_flux_r[0]*uy_c[1]-0.6123724356957945*Pxy_r[1]+0.6123724356957945*Pxy_c[1]+0.3535533905932737*rho_flux_r[0]*uy_r[0]+0.3535533905932737*rho_flux_r[0]*uy_c[0]+0.3535533905932737*Pxy_r[0]+0.3535533905932737*Pxy_c[0]; 
  double Ghat_rhouz_l = 0.7905694150420948*rho_flux_l[0]*uz_l[2]+0.7905694150420948*rho_flux_l[0]*uz_c[2]+0.7905694150420948*Pxz_l[2]+0.7905694150420948*Pxz_c[2]+0.6123724356957945*rho_flux_l[0]*uz_l[1]-0.6123724356957945*rho_flux_l[0]*uz_c[1]+0.6123724356957945*Pxz_l[1]-0.6123724356957945*Pxz_c[1]+0.3535533905932737*rho_flux_l[0]*uz_l[0]+0.3535533905932737*rho_flux_l[0]*uz_c[0]+0.3535533905932737*Pxz_l[0]+0.3535533905932737*Pxz_c[0]; 
  double Ghat_rhouz_r = 0.7905694150420948*rho_flux_r[0]*uz_r[2]+0.7905694150420948*rho_flux_r[0]*uz_c[2]+0.7905694150420948*Pxz_r[2]+0.7905694150420948*Pxz_c[2]-0.6123724356957945*rho_flux_r[0]*uz_r[1]+0.6123724356957945*rho_flux_r[0]*uz_c[1]-0.6123724356957945*Pxz_r[1]+0.6123724356957945*Pxz_c[1]+0.3535533905932737*rho_flux_r[0]*uz_r[0]+0.3535533905932737*rho_flux_r[0]*uz_c[0]+0.3535533905932737*Pxz_r[0]+0.3535533905932737*Pxz_c[0]; 
