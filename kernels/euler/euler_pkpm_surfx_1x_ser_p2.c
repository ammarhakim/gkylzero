...
{ 
  ...
  double ux_perprec_l = 0.3458741190809163*ux_perp_l[2]+0.3458741190809163*ux_perp_c[2]+0.4975526040028326*ux_perp_l[1]-0.4975526040028326*ux_perp_c[1]+0.3535533905932737*ux_perp_l[0]+0.3535533905932737*ux_perp_c[0]; 
  double ux_perprec_r = 0.3458741190809163*ux_perp_r[2]+0.3458741190809163*ux_perp_c[2]-0.4975526040028326*ux_perp_r[1]+0.4975526040028326*ux_perp_c[1]+0.3535533905932737*ux_perp_r[0]+0.3535533905932737*ux_perp_c[0]; 
  ...
  if (uxrec_l > 0) { 
  Ghat_E_perp_l = (1.58113883008419*E_perp_l[2]+1.224744871391589*E_perp_l[1]+0.7071067811865475*E_perp_l[0])*uxrec_l; 
  } else { 
  Ghat_E_perp_l = (1.58113883008419*E_perp_c[2]-1.224744871391589*E_perp_c[1]+0.7071067811865475*E_perp_c[0])*uxrec_l; 
  } 
  if (uxrec_r > 0) { 
  Ghat_E_perp_r = (1.58113883008419*E_perp_c[2]+1.224744871391589*E_perp_c[1]+0.7071067811865475*E_perp_c[0])*uxrec_r; 
  } else { 
  Ghat_E_perp_r = (1.58113883008419*E_perp_r[2]-1.224744871391589*E_perp_r[1]+0.7071067811865475*E_perp_r[0])*uxrec_r; 
  } 

  if (ux_perprec_l > 0) { 
  Ghat_E_perp_l += (1.58113883008419*p_perp_l[2]+1.224744871391589*p_perp_l[1]+0.7071067811865475*p_perp_l[0])*ux_perprec_l; 
  } else { 
  Ghat_E_perp_l += (1.58113883008419*p_perp_c[2]-1.224744871391589*p_perp_c[1]+0.7071067811865475*p_perp_c[0])*ux_perprec_l; 
  } 
  if (ux_perprec_r > 0) { 
  Ghat_E_perp_r += (1.58113883008419*p_perp_c[2]+1.224744871391589*p_perp_c[1]+0.7071067811865475*p_perp_c[0])*ux_perprec_r; 
  } else { 
  Ghat_E_perp_r += (1.58113883008419*p_perp_r[2]-1.224744871391589*p_perp_r[1]+0.7071067811865475*p_perp_r[0])*ux_perprec_r; 
  } 
