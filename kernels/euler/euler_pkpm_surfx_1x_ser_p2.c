...
{ 
  ...
  double ux_perp_l_r = ser_1x_p2_surfx1_eval_quad_node_0_r(ux_perp_l); 
  double ux_perp_c_l = ser_1x_p2_surfx1_eval_quad_node_0_l(ux_perp_c); 
  double ux_perp_c_r = ser_1x_p2_surfx1_eval_quad_node_0_r(ux_perp_c); 
  double ux_perp_r_l = ser_1x_p2_surfx1_eval_quad_node_0_l(ux_perp_r); 
  ...
  double Ghat_E_perp_l = 0.7905694150420948*p_perp_l[2]*ux_perp_l_r+0.6123724356957945*p_perp_l[1]*ux_perp_l_r+0.3535533905932737*p_perp_l[0]*ux_perp_l_r+0.7905694150420948*p_perp_c[2]*ux_perp_c_l-0.6123724356957945*p_perp_c[1]*ux_perp_c_l+0.3535533905932737*p_perp_c[0]*ux_perp_c_l+0.7905694150420948*E_perp_l[2]*ux_max_l-0.7905694150420948*E_perp_c[2]*ux_max_l+0.6123724356957945*E_perp_l[1]*ux_max_l+0.6123724356957945*E_perp_c[1]*ux_max_l+0.3535533905932737*E_perp_l[0]*ux_max_l-0.3535533905932737*E_perp_c[0]*ux_max_l+0.7905694150420948*E_perp_l[2]*ux_l_r+0.6123724356957945*E_perp_l[1]*ux_l_r+0.3535533905932737*E_perp_l[0]*ux_l_r+0.7905694150420948*E_perp_c[2]*ux_c_l-0.6123724356957945*E_perp_c[1]*ux_c_l+0.3535533905932737*E_perp_c[0]*ux_c_l; 
  double Ghat_E_perp_r = 0.7905694150420948*E_perp_r[2]*ux_r_l-0.6123724356957945*E_perp_r[1]*ux_r_l+0.3535533905932737*E_perp_r[0]*ux_r_l+0.7905694150420948*p_perp_r[2]*ux_perp_r_l-0.6123724356957945*p_perp_r[1]*ux_perp_r_l+0.3535533905932737*p_perp_r[0]*ux_perp_r_l+0.7905694150420948*p_perp_c[2]*ux_perp_c_r+0.6123724356957945*p_perp_c[1]*ux_perp_c_r+0.3535533905932737*p_perp_c[0]*ux_perp_c_r-0.7905694150420948*E_perp_r[2]*ux_max_r+0.7905694150420948*E_perp_c[2]*ux_max_r+0.6123724356957945*E_perp_r[1]*ux_max_r+0.6123724356957945*E_perp_c[1]*ux_max_r-0.3535533905932737*E_perp_r[0]*ux_max_r+0.3535533905932737*E_perp_c[0]*ux_max_r+0.7905694150420948*E_perp_c[2]*ux_c_r+0.6123724356957945*E_perp_c[1]*ux_c_r+0.3535533905932737*E_perp_c[0]*ux_c_r; 
  ...
  outE_perp[2] += 1.58113883008419*Ghat_E_perp_l*dx1-1.58113883008419*Ghat_E_perp_r*dx1; 
