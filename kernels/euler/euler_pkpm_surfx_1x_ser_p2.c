...
{ 
  ...
  double Ghat_p_perp_l = 0.7905694150420948*p_perp_l[2]*ux_l_r+0.6123724356957945*p_perp_l[1]*ux_l_r+0.3535533905932737*p_perp_l[0]*ux_l_r+0.7905694150420948*p_perp_c[2]*ux_c_l-0.6123724356957945*p_perp_c[1]*ux_c_l+0.3535533905932737*p_perp_c[0]*ux_c_l+0.7905694150420948*p_perp_l[2]*max_speed_l-0.7905694150420948*p_perp_c[2]*max_speed_l+0.6123724356957945*p_perp_l[1]*max_speed_l+0.6123724356957945*p_perp_c[1]*max_speed_l+0.3535533905932737*p_perp_l[0]*max_speed_l-0.3535533905932737*p_perp_c[0]*max_speed_l; 
  double Ghat_p_perp_r = 0.7905694150420948*p_perp_r[2]*ux_r_l-0.6123724356957945*p_perp_r[1]*ux_r_l+0.3535533905932737*p_perp_r[0]*ux_r_l+0.7905694150420948*p_perp_c[2]*ux_c_r+0.6123724356957945*p_perp_c[1]*ux_c_r+0.3535533905932737*p_perp_c[0]*ux_c_r-0.7905694150420948*p_perp_r[2]*max_speed_r+0.7905694150420948*p_perp_c[2]*max_speed_r+0.6123724356957945*p_perp_r[1]*max_speed_r+0.6123724356957945*p_perp_c[1]*max_speed_r-0.3535533905932737*p_perp_r[0]*max_speed_r+0.3535533905932737*p_perp_c[0]*max_speed_r; 
