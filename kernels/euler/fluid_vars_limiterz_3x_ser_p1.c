...
GKYL_CU_DH void fluid_vars_limiterz_3x_ser_p1(double limiter_fac, const struct gkyl_wv_eqn *wv_eqn, 
...
{ 
  ...
  rho_c[3] = slope[0]; 
  rhoux_c[3] = slope[1]*norm[0] + slope[2]*tau1[0] + slope[3]*tau2[0]; 
  rhouy_c[3] = slope[1]*norm[1] + slope[2]*tau1[1] + slope[3]*tau2[1]; 
  rhouz_c[3] = slope[1]*norm[2] + slope[2]*tau1[2] + slope[3]*tau2[2]; 
  energy_c[3] = slope[4]; 
  for (int i = 0; i < 3; ++i) { 
