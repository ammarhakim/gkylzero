...
{ 
  ...
  Ghat_rhouy_r[0] = (-0.4330127018922193*Ghat_rho_r[1]*ur_1[3])+0.4330127018922193*Ghat_rho_r[1]*uc_1[3]+0.4330127018922193*uMax_r[1]*rhou1_r[3]+0.4330127018922193*uMax_r[1]*rhou1_c[3]-0.4330127018922193*Ghat_rho_r[0]*ur_1[2]+0.4330127018922193*Ghat_rho_r[0]*uc_1[2]+0.4330127018922193*uMax_r[0]*rhou1_r[2]+0.4330127018922193*uMax_r[0]*rhou1_c[2]-0.6123724356957944*pr[2]+0.6123724356957944*pc[2]+0.25*Ghat_rho_r[1]*ur_1[1]+0.25*Ghat_rho_r[1]*uc_1[1]-0.25*rhou1_r[1]*uMax_r[1]+0.25*rhou1_c[1]*uMax_r[1]+0.25*Ghat_rho_r[0]*ur_1[0]+0.25*Ghat_rho_r[0]*uc_1[0]-0.25*rhou1_r[0]*uMax_r[0]+0.25*rhou1_c[0]*uMax_r[0]+0.3535533905932737*pr[0]+0.3535533905932737*pc[0]; 
  Ghat_rhouy_r[1] = (-0.4330127018922193*Ghat_rho_r[0]*ur_1[3])+0.4330127018922193*Ghat_rho_r[0]*uc_1[3]+0.4330127018922193*uMax_r[0]*rhou1_r[3]+0.4330127018922193*uMax_r[0]*rhou1_c[3]-0.6123724356957944*pr[3]+0.6123724356957944*pc[3]-0.4330127018922193*Ghat_rho_r[1]*ur_1[2]+0.4330127018922193*Ghat_rho_r[1]*uc_1[2]+0.4330127018922193*uMax_r[1]*rhou1_r[2]+0.4330127018922193*uMax_r[1]*rhou1_c[2]+0.25*Ghat_rho_r[0]*ur_1[1]+0.25*Ghat_rho_r[0]*uc_1[1]-0.25*rhou1_r[0]*uMax_r[1]+0.25*rhou1_c[0]*uMax_r[1]-0.25*uMax_r[0]*rhou1_r[1]+0.25*uMax_r[0]*rhou1_c[1]+0.3535533905932737*pr[1]+0.3535533905932737*pc[1]+0.25*ur_1[0]*Ghat_rho_r[1]+0.25*uc_1[0]*Ghat_rho_r[1]; 
