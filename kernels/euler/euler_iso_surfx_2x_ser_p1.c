...
GKYL_CU_DH double euler_iso_surfx_2x_ser_p1(const double *w, const double *dxv, const double vth, const double *ul, const double *uc, const double *ur, const double *statevecl, const double *statevecc, const double *statevecr, double* GKYL_RESTRICT out) 
{ 
  ...
  Ghat_rhoux_r[0] = (-0.6123724356957944*rho_r[1]*vthsq)+0.6123724356957944*rho_c[1]*vthsq+0.3535533905932737*rho_r[0]*vthsq+0.3535533905932737*rho_c[0]*vthsq-0.4330127018922193*Ghat_rho_r[1]*ur_0[3]+0.4330127018922193*Ghat_rho_r[1]*uc_0[3]+0.4330127018922193*uMax_r[1]*rhou0_r[3]+0.4330127018922193*uMax_r[1]*rhou0_c[3]+0.25*Ghat_rho_r[1]*ur_0[2]+0.25*Ghat_rho_r[1]*uc_0[2]-0.25*uMax_r[1]*rhou0_r[2]+0.25*uMax_r[1]*rhou0_c[2]-0.4330127018922193*Ghat_rho_r[0]*ur_0[1]+0.4330127018922193*Ghat_rho_r[0]*uc_0[1]+0.4330127018922193*uMax_r[0]*rhou0_r[1]+0.4330127018922193*uMax_r[0]*rhou0_c[1]+0.25*Ghat_rho_r[0]*ur_0[0]+0.25*Ghat_rho_r[0]*uc_0[0]-0.25*rhou0_r[0]*uMax_r[0]+0.25*rhou0_c[0]*uMax_r[0]; 
  Ghat_rhoux_r[1] = (-0.6123724356957944*rho_r[3]*vthsq)+0.6123724356957944*rho_c[3]*vthsq+0.3535533905932737*rho_r[2]*vthsq+0.3535533905932737*rho_c[2]*vthsq-0.4330127018922193*Ghat_rho_r[0]*ur_0[3]+0.4330127018922193*Ghat_rho_r[0]*uc_0[3]+0.4330127018922193*uMax_r[0]*rhou0_r[3]+0.4330127018922193*uMax_r[0]*rhou0_c[3]+0.25*Ghat_rho_r[0]*ur_0[2]+0.25*Ghat_rho_r[0]*uc_0[2]-0.25*uMax_r[0]*rhou0_r[2]+0.25*uMax_r[0]*rhou0_c[2]-0.4330127018922193*Ghat_rho_r[1]*ur_0[1]+0.4330127018922193*Ghat_rho_r[1]*uc_0[1]+0.4330127018922193*rhou0_r[1]*uMax_r[1]+0.4330127018922193*rhou0_c[1]*uMax_r[1]-0.25*rhou0_r[0]*uMax_r[1]+0.25*rhou0_c[0]*uMax_r[1]+0.25*ur_0[0]*Ghat_rho_r[1]+0.25*uc_0[0]*Ghat_rho_r[1]; 
