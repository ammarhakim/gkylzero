...
{ 
  ...
  out_F_0_source[12] = tmp_T_perp_F_1[12]; 
  out_F_0_source[13] = tmp_T_perp_F_1[13]; 
  out_F_0_source[14] = tmp_T_perp_F_1[14]; 
  out_F_0_source[15] = tmp_T_perp_F_1[15]; 
  out_F_0_source[16] = tmp_T_perp_F_1[16]; 
  out_F_0_source[17] = tmp_T_perp_F_1[17]; 
  out_F_0_source[18] = tmp_T_perp_F_1[18]; 
  out_F_0_source[19] = tmp_T_perp_F_1[19]; 
  out_F_0_source[20] = tmp_T_perp_F_1[20]; 
  out_F_0_source[21] = tmp_T_perp_F_1[21]; 
  out_F_0_source[22] = tmp_T_perp_F_1[22]; 
  out_F_0_source[23] = tmp_T_perp_F_1[23]; 
