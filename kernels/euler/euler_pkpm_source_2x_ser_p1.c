...
{ 
  ...
  outp_perp[0] += 0.5*nu_vth_sq[3]*rho[3]-0.5*nu[3]*p_perp[3]+0.5*nu_vth_sq[2]*rho[2]-0.5*nu[2]*p_perp[2]+0.5*nu_vth_sq[1]*rho[1]-0.5*nu[1]*p_perp[1]+0.5*nu_vth_sq[0]*rho[0]+p_perp_source[0]-0.5*nu[0]*p_perp[0]; 
  outp_perp[1] += 0.5*nu_vth_sq[2]*rho[3]-0.5*nu[2]*p_perp[3]+0.5*rho[2]*nu_vth_sq[3]-0.5*p_perp[2]*nu[3]+0.5*nu_vth_sq[0]*rho[1]+p_perp_source[1]-0.5*nu[0]*p_perp[1]+0.5*rho[0]*nu_vth_sq[1]-0.5*p_perp[0]*nu[1]; 
  outp_perp[2] += 0.5*nu_vth_sq[1]*rho[3]-0.5*nu[1]*p_perp[3]+0.5*rho[1]*nu_vth_sq[3]-0.5*p_perp[1]*nu[3]+0.5*nu_vth_sq[0]*rho[2]+p_perp_source[2]-0.5*nu[0]*p_perp[2]+0.5*rho[0]*nu_vth_sq[2]-0.5*p_perp[0]*nu[2]; 
  outp_perp[3] += 0.5*nu_vth_sq[0]*rho[3]+p_perp_source[3]-0.5*nu[0]*p_perp[3]+0.5*rho[0]*nu_vth_sq[3]-0.5*p_perp[0]*nu[3]+0.5*nu_vth_sq[1]*rho[2]-0.5*nu[1]*p_perp[2]+0.5*rho[1]*nu_vth_sq[2]-0.5*p_perp[1]*nu[2]; 
