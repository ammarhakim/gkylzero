...
{ 
  ...
  if (0.7071067811865475*uSurf_l[0]-0.7071067811865475*uSurf_l[1] > 0) { 
    rhouxUpwindQuad_l[0] = ser_2x_p1_surfx2_eval_quad_node_0_r(rhoux_l); 
    rhouyUpwindQuad_l[0] = ser_2x_p1_surfx2_eval_quad_node_0_r(rhouy_l); 
    rhouzUpwindQuad_l[0] = ser_2x_p1_surfx2_eval_quad_node_0_r(rhouz_l); 
    p_perpUpwindQuad_l[0] = ser_2x_p1_surfx2_eval_quad_node_0_r(p_perp_l); 
  } else { 
    rhouxUpwindQuad_l[0] = ser_2x_p1_surfx2_eval_quad_node_0_r(rhoux_c); 
    rhouyUpwindQuad_l[0] = ser_2x_p1_surfx2_eval_quad_node_0_r(rhouy_c); 
    rhouzUpwindQuad_l[0] = ser_2x_p1_surfx2_eval_quad_node_0_r(rhouz_c); 
  ...
  if (0.7071067811865475*uSurf_r[0]-0.7071067811865475*uSurf_r[1] > 0) { 
    rhouxUpwindQuad_r[0] = ser_2x_p1_surfx2_eval_quad_node_0_r(rhoux_c); 
    rhouyUpwindQuad_r[0] = ser_2x_p1_surfx2_eval_quad_node_0_r(rhouy_c); 
    rhouzUpwindQuad_r[0] = ser_2x_p1_surfx2_eval_quad_node_0_r(rhouz_c); 
    p_perpUpwindQuad_r[0] = ser_2x_p1_surfx2_eval_quad_node_0_r(p_perp_c); 
  } else { 
    rhouxUpwindQuad_r[0] = ser_2x_p1_surfx2_eval_quad_node_0_r(rhoux_r); 
    rhouyUpwindQuad_r[0] = ser_2x_p1_surfx2_eval_quad_node_0_r(rhouy_r); 
    rhouzUpwindQuad_r[0] = ser_2x_p1_surfx2_eval_quad_node_0_r(rhouz_r); 
    p_perpUpwindQuad_r[0] = ser_2x_p1_surfx2_eval_quad_node_0_r(p_perp_r); 
  } 
  if (0.7071067811865475*(uSurf_l[1]+uSurf_l[0]) > 0) { 
    rhouxUpwindQuad_l[1] = ser_2x_p1_surfx2_eval_quad_node_1_r(rhoux_l); 
    rhouyUpwindQuad_l[1] = ser_2x_p1_surfx2_eval_quad_node_1_r(rhouy_l); 
    rhouzUpwindQuad_l[1] = ser_2x_p1_surfx2_eval_quad_node_1_r(rhouz_l); 
    p_perpUpwindQuad_l[1] = ser_2x_p1_surfx2_eval_quad_node_1_r(p_perp_l); 
  } else { 
    rhouxUpwindQuad_l[1] = ser_2x_p1_surfx2_eval_quad_node_1_r(rhoux_c); 
    rhouyUpwindQuad_l[1] = ser_2x_p1_surfx2_eval_quad_node_1_r(rhouy_c); 
    rhouzUpwindQuad_l[1] = ser_2x_p1_surfx2_eval_quad_node_1_r(rhouz_c); 
    p_perpUpwindQuad_l[1] = ser_2x_p1_surfx2_eval_quad_node_1_r(p_perp_c); 
  } 
  if (0.7071067811865475*(uSurf_r[1]+uSurf_r[0]) > 0) { 
    rhouxUpwindQuad_r[1] = ser_2x_p1_surfx2_eval_quad_node_1_r(rhoux_c); 
    rhouyUpwindQuad_r[1] = ser_2x_p1_surfx2_eval_quad_node_1_r(rhouy_c); 
    rhouzUpwindQuad_r[1] = ser_2x_p1_surfx2_eval_quad_node_1_r(rhouz_c); 
    p_perpUpwindQuad_r[1] = ser_2x_p1_surfx2_eval_quad_node_1_r(p_perp_c); 
  } else { 
    rhouxUpwindQuad_r[1] = ser_2x_p1_surfx2_eval_quad_node_1_r(rhoux_r); 
    rhouyUpwindQuad_r[1] = ser_2x_p1_surfx2_eval_quad_node_1_r(rhouy_r); 
    rhouzUpwindQuad_r[1] = ser_2x_p1_surfx2_eval_quad_node_1_r(rhouz_r); 
