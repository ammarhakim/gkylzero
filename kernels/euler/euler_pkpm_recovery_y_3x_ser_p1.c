...
{ 
  ...
  div_p_z[0] += (4.871392896287466*rhouy_r[2]-4.871392896287466*rhouy_l[2]-2.8125*(rhouy_r[0]+rhouy_l[0])+5.625*rhouy_c[0])*dx14*nuHyp+((-0.2886751345948129*(Pyz_r[2]+Pyz_l[2]))+0.5773502691896258*Pyz_c[2]+0.25*Pyz_r[0]-0.25*Pyz_l[0])*dx1; 
  div_p_z[1] += (4.871392896287466*rhouy_r[4]-4.871392896287466*rhouy_l[4]-2.8125*(rhouy_r[1]+rhouy_l[1])+5.625*rhouy_c[1])*dx14*nuHyp+((-0.2886751345948129*(Pyz_r[4]+Pyz_l[4]))+0.5773502691896258*Pyz_c[4]+0.25*Pyz_r[1]-0.25*Pyz_l[1])*dx1; 
  div_p_z[2] += (72.1875*(rhouy_r[2]+rhouy_l[2])+249.375*rhouy_c[2]-56.83291712335378*rhouy_r[0]+56.83291712335378*rhouy_l[0])*dx14*nuHyp+((-0.5*Pyz_r[2])+0.5*Pyz_l[2]+0.4330127018922193*(Pyz_r[0]+Pyz_l[0])-0.8660254037844386*Pyz_c[0])*dx1; 
  div_p_z[3] += (4.871392896287466*rhouy_r[6]-4.871392896287466*rhouy_l[6]-2.8125*(rhouy_r[3]+rhouy_l[3])+5.625*rhouy_c[3])*dx14*nuHyp+((-0.2886751345948129*(Pyz_r[6]+Pyz_l[6]))+0.5773502691896258*Pyz_c[6]+0.25*Pyz_r[3]-0.25*Pyz_l[3])*dx1; 
  div_p_z[4] += (72.1875*(rhouy_r[4]+rhouy_l[4])+249.375*rhouy_c[4]-56.83291712335378*rhouy_r[1]+56.83291712335378*rhouy_l[1])*dx14*nuHyp+((-0.5*Pyz_r[4])+0.5*Pyz_l[4]+0.4330127018922193*(Pyz_r[1]+Pyz_l[1])-0.8660254037844386*Pyz_c[1])*dx1; 
  div_p_z[5] += (4.871392896287466*rhouy_r[7]-4.871392896287466*rhouy_l[7]-2.8125*(rhouy_r[5]+rhouy_l[5])+5.625*rhouy_c[5])*dx14*nuHyp+((-0.2886751345948129*(Pyz_r[7]+Pyz_l[7]))+0.5773502691896258*Pyz_c[7]+0.25*Pyz_r[5]-0.25*Pyz_l[5])*dx1; 
  div_p_z[6] += (72.1875*(rhouy_r[6]+rhouy_l[6])+249.375*rhouy_c[6]-56.83291712335378*rhouy_r[3]+56.83291712335378*rhouy_l[3])*dx14*nuHyp+((-0.5*Pyz_r[6])+0.5*Pyz_l[6]+0.4330127018922193*(Pyz_r[3]+Pyz_l[3])-0.8660254037844386*Pyz_c[3])*dx1; 
  div_p_z[7] += (72.1875*(rhouy_r[7]+rhouy_l[7])+249.375*rhouy_c[7]-56.83291712335378*rhouy_r[5]+56.83291712335378*rhouy_l[5])*dx14*nuHyp+((-0.5*Pyz_r[7])+0.5*Pyz_l[7]+0.4330127018922193*(Pyz_r[5]+Pyz_l[5])-0.8660254037844386*Pyz_c[5])*dx1; 
  ...
  div_ppar_b[1] = (-0.2886751345948129*ppar_b_r[4])-0.2886751345948129*ppar_b_l[4]+0.5773502691896258*ppar_b_c[4]+0.25*ppar_b_r[1]-0.25*ppar_b_l[1]; 
  ...
  div_ppar_b[3] = (-0.2886751345948129*ppar_b_r[6])-0.2886751345948129*ppar_b_l[6]+0.5773502691896258*ppar_b_c[6]+0.25*ppar_b_r[3]-0.25*ppar_b_l[3]; 
  div_ppar_b[4] = (-0.5*ppar_b_r[4])+0.5*ppar_b_l[4]+0.4330127018922193*ppar_b_r[1]+0.4330127018922193*ppar_b_l[1]-0.8660254037844386*ppar_b_c[1]; 
  div_ppar_b[5] = (-0.2886751345948129*ppar_b_r[7])-0.2886751345948129*ppar_b_l[7]+0.5773502691896258*ppar_b_c[7]+0.25*ppar_b_r[5]-0.25*ppar_b_l[5]; 
  div_ppar_b[6] = (-0.5*ppar_b_r[6])+0.5*ppar_b_l[6]+0.4330127018922193*ppar_b_r[3]+0.4330127018922193*ppar_b_l[3]-0.8660254037844386*ppar_b_c[3]; 
  div_ppar_b[7] = (-0.5*ppar_b_r[7])+0.5*ppar_b_l[7]+0.4330127018922193*ppar_b_r[5]+0.4330127018922193*ppar_b_l[5]-0.8660254037844386*ppar_b_c[5]; 
  ...
  p_perp_source[0] += 0.3535533905932737*(bb_grad_u[7]*p_perp[7]+bb_grad_u[6]*p_perp[6]+bb_grad_u[5]*p_perp[5]+bb_grad_u[4]*p_perp[4]+bb_grad_u[3]*p_perp[3]+bb_grad_u[2]*p_perp[2]+bb_grad_u[1]*p_perp[1]+bb_grad_u[0]*p_perp[0])-0.3535533905932737*(grad_u_y[7]*p_perp[7]+grad_u_y[6]*p_perp[6]+grad_u_y[5]*p_perp[5]+grad_u_y[4]*p_perp[4]+grad_u_y[3]*p_perp[3]+grad_u_y[2]*p_perp[2]+grad_u_y[1]*p_perp[1]+grad_u_y[0]*p_perp[0])*dx1; 
  p_perp_source[1] += 0.3535533905932737*(bb_grad_u[6]*p_perp[7]+p_perp[6]*bb_grad_u[7]+bb_grad_u[3]*p_perp[5]+p_perp[3]*bb_grad_u[5]+bb_grad_u[2]*p_perp[4]+p_perp[2]*bb_grad_u[4]+bb_grad_u[0]*p_perp[1]+p_perp[0]*bb_grad_u[1])-0.3535533905932737*(grad_u_y[6]*p_perp[7]+p_perp[6]*grad_u_y[7]+grad_u_y[3]*p_perp[5]+p_perp[3]*grad_u_y[5]+grad_u_y[2]*p_perp[4]+p_perp[2]*grad_u_y[4]+grad_u_y[0]*p_perp[1]+p_perp[0]*grad_u_y[1])*dx1; 
  p_perp_source[2] += 0.3535533905932737*(bb_grad_u[5]*p_perp[7]+p_perp[5]*bb_grad_u[7]+bb_grad_u[3]*p_perp[6]+p_perp[3]*bb_grad_u[6]+bb_grad_u[1]*p_perp[4]+p_perp[1]*bb_grad_u[4]+bb_grad_u[0]*p_perp[2]+p_perp[0]*bb_grad_u[2])-0.3535533905932737*(grad_u_y[5]*p_perp[7]+p_perp[5]*grad_u_y[7]+grad_u_y[3]*p_perp[6]+p_perp[3]*grad_u_y[6]+grad_u_y[1]*p_perp[4]+p_perp[1]*grad_u_y[4]+grad_u_y[0]*p_perp[2]+p_perp[0]*grad_u_y[2])*dx1; 
  p_perp_source[3] += 0.3535533905932737*(bb_grad_u[4]*p_perp[7]+p_perp[4]*bb_grad_u[7]+bb_grad_u[2]*p_perp[6]+p_perp[2]*bb_grad_u[6]+bb_grad_u[1]*p_perp[5]+p_perp[1]*bb_grad_u[5]+bb_grad_u[0]*p_perp[3]+p_perp[0]*bb_grad_u[3])-0.3535533905932737*(grad_u_y[4]*p_perp[7]+p_perp[4]*grad_u_y[7]+grad_u_y[2]*p_perp[6]+p_perp[2]*grad_u_y[6]+grad_u_y[1]*p_perp[5]+p_perp[1]*grad_u_y[5]+grad_u_y[0]*p_perp[3]+p_perp[0]*grad_u_y[3])*dx1; 
  p_perp_source[4] += 0.3535533905932737*(bb_grad_u[3]*p_perp[7]+p_perp[3]*bb_grad_u[7]+bb_grad_u[5]*p_perp[6]+p_perp[5]*bb_grad_u[6]+bb_grad_u[0]*p_perp[4]+p_perp[0]*bb_grad_u[4]+bb_grad_u[1]*p_perp[2]+p_perp[1]*bb_grad_u[2])-0.3535533905932737*(grad_u_y[3]*p_perp[7]+p_perp[3]*grad_u_y[7]+grad_u_y[5]*p_perp[6]+p_perp[5]*grad_u_y[6]+grad_u_y[0]*p_perp[4]+p_perp[0]*grad_u_y[4]+grad_u_y[1]*p_perp[2]+p_perp[1]*grad_u_y[2])*dx1; 
  p_perp_source[5] += 0.3535533905932737*(bb_grad_u[2]*p_perp[7]+p_perp[2]*bb_grad_u[7]+bb_grad_u[4]*p_perp[6]+p_perp[4]*bb_grad_u[6]+bb_grad_u[0]*p_perp[5]+p_perp[0]*bb_grad_u[5]+bb_grad_u[1]*p_perp[3]+p_perp[1]*bb_grad_u[3])-0.3535533905932737*(grad_u_y[2]*p_perp[7]+p_perp[2]*grad_u_y[7]+grad_u_y[4]*p_perp[6]+p_perp[4]*grad_u_y[6]+grad_u_y[0]*p_perp[5]+p_perp[0]*grad_u_y[5]+grad_u_y[1]*p_perp[3]+p_perp[1]*grad_u_y[3])*dx1; 
  p_perp_source[6] += 0.3535533905932737*(bb_grad_u[1]*p_perp[7]+p_perp[1]*bb_grad_u[7]+bb_grad_u[0]*p_perp[6]+p_perp[0]*bb_grad_u[6]+bb_grad_u[4]*p_perp[5]+p_perp[4]*bb_grad_u[5]+bb_grad_u[2]*p_perp[3]+p_perp[2]*bb_grad_u[3])-0.3535533905932737*(grad_u_y[1]*p_perp[7]+p_perp[1]*grad_u_y[7]+grad_u_y[0]*p_perp[6]+p_perp[0]*grad_u_y[6]+grad_u_y[4]*p_perp[5]+p_perp[4]*grad_u_y[5]+grad_u_y[2]*p_perp[3]+p_perp[2]*grad_u_y[3])*dx1; 
  p_perp_source[7] += 0.3535533905932737*(bb_grad_u[0]*p_perp[7]+p_perp[0]*bb_grad_u[7]+bb_grad_u[1]*p_perp[6]+p_perp[1]*bb_grad_u[6]+bb_grad_u[2]*p_perp[5]+p_perp[2]*bb_grad_u[5]+bb_grad_u[3]*p_perp[4]+p_perp[3]*bb_grad_u[4])-0.3535533905932737*(grad_u_y[0]*p_perp[7]+p_perp[0]*grad_u_y[7]+grad_u_y[1]*p_perp[6]+p_perp[1]*grad_u_y[6]+grad_u_y[2]*p_perp[5]+p_perp[2]*grad_u_y[5]+grad_u_y[3]*p_perp[4]+p_perp[3]*grad_u_y[4])*dx1; 
