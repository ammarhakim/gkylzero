...
{ 
  ...
  p_perp_source[0] += ((-4.871392896287466*p_perp_r[2])+4.871392896287466*p_perp_l[2]+2.8125*(p_perp_r[0]+p_perp_l[0])-5.625*p_perp_c[0])*dx14*nuHyp-0.3535533905932737*(grad_u_y[7]*p_perp_c[7]+grad_u_y[6]*p_perp_c[6]+grad_u_y[5]*p_perp_c[5]+grad_u_y[4]*p_perp_c[4]+grad_u_y[3]*p_perp_c[3]+grad_u_y[2]*p_perp_c[2]+grad_u_y[1]*p_perp_c[1]+grad_u_y[0]*p_perp_c[0])*dx1+0.3535533905932737*(bb_grad_u[7]*p_perp_c[7]+bb_grad_u[6]*p_perp_c[6]+bb_grad_u[5]*p_perp_c[5]+bb_grad_u[4]*p_perp_c[4]+bb_grad_u[3]*p_perp_c[3]+bb_grad_u[2]*p_perp_c[2]+bb_grad_u[1]*p_perp_c[1]+bb_grad_u[0]*p_perp_c[0]); 
  p_perp_source[1] += ((-4.871392896287466*p_perp_r[4])+4.871392896287466*p_perp_l[4]+2.8125*(p_perp_r[1]+p_perp_l[1])-5.625*p_perp_c[1])*dx14*nuHyp-0.3535533905932737*(grad_u_y[6]*p_perp_c[7]+p_perp_c[6]*grad_u_y[7]+grad_u_y[3]*p_perp_c[5]+p_perp_c[3]*grad_u_y[5]+grad_u_y[2]*p_perp_c[4]+p_perp_c[2]*grad_u_y[4]+grad_u_y[0]*p_perp_c[1]+p_perp_c[0]*grad_u_y[1])*dx1+0.3535533905932737*(bb_grad_u[6]*p_perp_c[7]+p_perp_c[6]*bb_grad_u[7]+bb_grad_u[3]*p_perp_c[5]+p_perp_c[3]*bb_grad_u[5]+bb_grad_u[2]*p_perp_c[4]+p_perp_c[2]*bb_grad_u[4]+bb_grad_u[0]*p_perp_c[1]+p_perp_c[0]*bb_grad_u[1]); 
  p_perp_source[2] += ((-72.1875*(p_perp_r[2]+p_perp_l[2]))-249.375*p_perp_c[2]+56.83291712335378*p_perp_r[0]-56.83291712335378*p_perp_l[0])*dx14*nuHyp-0.3535533905932737*(grad_u_y[5]*p_perp_c[7]+p_perp_c[5]*grad_u_y[7]+grad_u_y[3]*p_perp_c[6]+p_perp_c[3]*grad_u_y[6]+grad_u_y[1]*p_perp_c[4]+p_perp_c[1]*grad_u_y[4]+grad_u_y[0]*p_perp_c[2]+p_perp_c[0]*grad_u_y[2])*dx1+0.3535533905932737*(bb_grad_u[5]*p_perp_c[7]+p_perp_c[5]*bb_grad_u[7]+bb_grad_u[3]*p_perp_c[6]+p_perp_c[3]*bb_grad_u[6]+bb_grad_u[1]*p_perp_c[4]+p_perp_c[1]*bb_grad_u[4]+bb_grad_u[0]*p_perp_c[2]+p_perp_c[0]*bb_grad_u[2]); 
  p_perp_source[3] += ((-4.871392896287466*p_perp_r[6])+4.871392896287466*p_perp_l[6]+2.8125*(p_perp_r[3]+p_perp_l[3])-5.625*p_perp_c[3])*dx14*nuHyp-0.3535533905932737*(grad_u_y[4]*p_perp_c[7]+p_perp_c[4]*grad_u_y[7]+grad_u_y[2]*p_perp_c[6]+p_perp_c[2]*grad_u_y[6]+grad_u_y[1]*p_perp_c[5]+p_perp_c[1]*grad_u_y[5]+grad_u_y[0]*p_perp_c[3]+p_perp_c[0]*grad_u_y[3])*dx1+0.3535533905932737*(bb_grad_u[4]*p_perp_c[7]+p_perp_c[4]*bb_grad_u[7]+bb_grad_u[2]*p_perp_c[6]+p_perp_c[2]*bb_grad_u[6]+bb_grad_u[1]*p_perp_c[5]+p_perp_c[1]*bb_grad_u[5]+bb_grad_u[0]*p_perp_c[3]+p_perp_c[0]*bb_grad_u[3]); 
  p_perp_source[4] += ((-72.1875*(p_perp_r[4]+p_perp_l[4]))-249.375*p_perp_c[4]+56.83291712335378*p_perp_r[1]-56.83291712335378*p_perp_l[1])*dx14*nuHyp-0.3535533905932737*(grad_u_y[3]*p_perp_c[7]+p_perp_c[3]*grad_u_y[7]+grad_u_y[5]*p_perp_c[6]+p_perp_c[5]*grad_u_y[6]+grad_u_y[0]*p_perp_c[4]+p_perp_c[0]*grad_u_y[4]+grad_u_y[1]*p_perp_c[2]+p_perp_c[1]*grad_u_y[2])*dx1+0.3535533905932737*(bb_grad_u[3]*p_perp_c[7]+p_perp_c[3]*bb_grad_u[7]+bb_grad_u[5]*p_perp_c[6]+p_perp_c[5]*bb_grad_u[6]+bb_grad_u[0]*p_perp_c[4]+p_perp_c[0]*bb_grad_u[4]+bb_grad_u[1]*p_perp_c[2]+p_perp_c[1]*bb_grad_u[2]); 
  p_perp_source[5] += ((-4.871392896287466*p_perp_r[7])+4.871392896287466*p_perp_l[7]+2.8125*(p_perp_r[5]+p_perp_l[5])-5.625*p_perp_c[5])*dx14*nuHyp-0.3535533905932737*(grad_u_y[2]*p_perp_c[7]+p_perp_c[2]*grad_u_y[7]+grad_u_y[4]*p_perp_c[6]+p_perp_c[4]*grad_u_y[6]+grad_u_y[0]*p_perp_c[5]+p_perp_c[0]*grad_u_y[5]+grad_u_y[1]*p_perp_c[3]+p_perp_c[1]*grad_u_y[3])*dx1+0.3535533905932737*(bb_grad_u[2]*p_perp_c[7]+p_perp_c[2]*bb_grad_u[7]+bb_grad_u[4]*p_perp_c[6]+p_perp_c[4]*bb_grad_u[6]+bb_grad_u[0]*p_perp_c[5]+p_perp_c[0]*bb_grad_u[5]+bb_grad_u[1]*p_perp_c[3]+p_perp_c[1]*bb_grad_u[3]); 
  p_perp_source[6] += ((-72.1875*(p_perp_r[6]+p_perp_l[6]))-249.375*p_perp_c[6]+56.83291712335378*p_perp_r[3]-56.83291712335378*p_perp_l[3])*dx14*nuHyp-0.3535533905932737*(grad_u_y[1]*p_perp_c[7]+p_perp_c[1]*grad_u_y[7]+grad_u_y[0]*p_perp_c[6]+p_perp_c[0]*grad_u_y[6]+grad_u_y[4]*p_perp_c[5]+p_perp_c[4]*grad_u_y[5]+grad_u_y[2]*p_perp_c[3]+p_perp_c[2]*grad_u_y[3])*dx1+0.3535533905932737*(bb_grad_u[1]*p_perp_c[7]+p_perp_c[1]*bb_grad_u[7]+bb_grad_u[0]*p_perp_c[6]+p_perp_c[0]*bb_grad_u[6]+bb_grad_u[4]*p_perp_c[5]+p_perp_c[4]*bb_grad_u[5]+bb_grad_u[2]*p_perp_c[3]+p_perp_c[2]*bb_grad_u[3]); 
  p_perp_source[7] += ((-72.1875*(p_perp_r[7]+p_perp_l[7]))-249.375*p_perp_c[7]+56.83291712335378*p_perp_r[5]-56.83291712335378*p_perp_l[5])*dx14*nuHyp-0.3535533905932737*(grad_u_y[0]*p_perp_c[7]+p_perp_c[0]*grad_u_y[7]+grad_u_y[1]*p_perp_c[6]+p_perp_c[1]*grad_u_y[6]+grad_u_y[2]*p_perp_c[5]+p_perp_c[2]*grad_u_y[5]+grad_u_y[3]*p_perp_c[4]+p_perp_c[3]*grad_u_y[4])*dx1+0.3535533905932737*(bb_grad_u[0]*p_perp_c[7]+p_perp_c[0]*bb_grad_u[7]+bb_grad_u[1]*p_perp_c[6]+p_perp_c[1]*bb_grad_u[6]+bb_grad_u[2]*p_perp_c[5]+p_perp_c[2]*bb_grad_u[5]+bb_grad_u[3]*p_perp_c[4]+p_perp_c[3]*bb_grad_u[4]); 
