...
{ 
  ...
  uxrec_l[0] = 0.408248290463863*ux_l[1]-0.408248290463863*ux_c[1]+0.3535533905932737*ux_l[0]+0.3535533905932737*ux_c[0]; 
  uxrec_l[1] = 0.408248290463863*ux_l[3]-0.408248290463863*ux_c[3]+0.3535533905932737*ux_l[2]+0.3535533905932737*ux_c[2]; 

  uyrec_l[0] = 0.408248290463863*uy_l[1]-0.408248290463863*uy_c[1]+0.3535533905932737*uy_l[0]+0.3535533905932737*uy_c[0]; 
  uyrec_l[1] = 0.408248290463863*uy_l[3]-0.408248290463863*uy_c[3]+0.3535533905932737*uy_l[2]+0.3535533905932737*uy_c[2]; 

  uzrec_l[0] = 0.408248290463863*uz_l[1]-0.408248290463863*uz_c[1]+0.3535533905932737*uz_l[0]+0.3535533905932737*uz_c[0]; 
  uzrec_l[1] = 0.408248290463863*uz_l[3]-0.408248290463863*uz_c[3]+0.3535533905932737*uz_l[2]+0.3535533905932737*uz_c[2]; 

  uxrec_r[0] = (-0.408248290463863*ux_r[1])+0.408248290463863*ux_c[1]+0.3535533905932737*ux_r[0]+0.3535533905932737*ux_c[0]; 
  uxrec_r[1] = (-0.408248290463863*ux_r[3])+0.408248290463863*ux_c[3]+0.3535533905932737*ux_r[2]+0.3535533905932737*ux_c[2]; 

  uyrec_r[0] = (-0.408248290463863*uy_r[1])+0.408248290463863*uy_c[1]+0.3535533905932737*uy_r[0]+0.3535533905932737*uy_c[0]; 
  uyrec_r[1] = (-0.408248290463863*uy_r[3])+0.408248290463863*uy_c[3]+0.3535533905932737*uy_r[2]+0.3535533905932737*uy_c[2]; 

  uzrec_r[0] = (-0.408248290463863*uz_r[1])+0.408248290463863*uz_c[1]+0.3535533905932737*uz_r[0]+0.3535533905932737*uz_c[0]; 
  uzrec_r[1] = (-0.408248290463863*uz_r[3])+0.408248290463863*uz_c[3]+0.3535533905932737*uz_r[2]+0.3535533905932737*uz_c[2]; 

  Pixrec_l[0] = 0.408248290463863*Pxx_l[1]-0.408248290463863*Pxx_c[1]+0.3535533905932737*Pxx_l[0]+0.3535533905932737*Pxx_c[0]; 
  Pixrec_l[1] = 0.408248290463863*Pxx_l[3]-0.408248290463863*Pxx_c[3]+0.3535533905932737*Pxx_l[2]+0.3535533905932737*Pxx_c[2]; 

  Piyrec_l[0] = 0.408248290463863*Pxy_l[1]-0.408248290463863*Pxy_c[1]+0.3535533905932737*Pxy_l[0]+0.3535533905932737*Pxy_c[0]; 
  Piyrec_l[1] = 0.408248290463863*Pxy_l[3]-0.408248290463863*Pxy_c[3]+0.3535533905932737*Pxy_l[2]+0.3535533905932737*Pxy_c[2]; 

  Pizrec_l[0] = 0.408248290463863*Pxz_l[1]-0.408248290463863*Pxz_c[1]+0.3535533905932737*Pxz_l[0]+0.3535533905932737*Pxz_c[0]; 
  Pizrec_l[1] = 0.408248290463863*Pxz_l[3]-0.408248290463863*Pxz_c[3]+0.3535533905932737*Pxz_l[2]+0.3535533905932737*Pxz_c[2]; 

  Pixrec_r[0] = (-0.408248290463863*Pxx_r[1])+0.408248290463863*Pxx_c[1]+0.3535533905932737*Pxx_r[0]+0.3535533905932737*Pxx_c[0]; 
  Pixrec_r[1] = (-0.408248290463863*Pxx_r[3])+0.408248290463863*Pxx_c[3]+0.3535533905932737*Pxx_r[2]+0.3535533905932737*Pxx_c[2]; 

  Piyrec_r[0] = (-0.408248290463863*Pxy_r[1])+0.408248290463863*Pxy_c[1]+0.3535533905932737*Pxy_r[0]+0.3535533905932737*Pxy_c[0]; 
  Piyrec_r[1] = (-0.408248290463863*Pxy_r[3])+0.408248290463863*Pxy_c[3]+0.3535533905932737*Pxy_r[2]+0.3535533905932737*Pxy_c[2]; 

  Pizrec_r[0] = (-0.408248290463863*Pxz_r[1])+0.408248290463863*Pxz_c[1]+0.3535533905932737*Pxz_r[0]+0.3535533905932737*Pxz_c[0]; 
  Pizrec_r[1] = (-0.408248290463863*Pxz_r[3])+0.408248290463863*Pxz_c[3]+0.3535533905932737*Pxz_r[2]+0.3535533905932737*Pxz_c[2]; 
  ...
  outrhou0[1] += (-0.8660254037844386*rho_flux_r[1]*uxrec_r[1]*dx1)-0.8660254037844386*rho_flux_l[1]*uxrec_l[1]*dx1-0.8660254037844386*rho_flux_r[0]*uxrec_r[0]*dx1-0.8660254037844386*rho_flux_l[0]*uxrec_l[0]*dx1-1.224744871391589*Pixrec_r[0]*dx1-1.224744871391589*Pixrec_l[0]*dx1; 
  outrhou0[2] += (-0.5*rho_flux_r[0]*uxrec_r[1]*dx1)+0.5*rho_flux_l[0]*uxrec_l[1]*dx1-0.5*uxrec_r[0]*rho_flux_r[1]*dx1+0.5*uxrec_l[0]*rho_flux_l[1]*dx1-0.7071067811865475*Pixrec_r[1]*dx1+0.7071067811865475*Pixrec_l[1]*dx1; 
  ...
  outrhou1[1] += (-0.8660254037844386*rho_flux_r[1]*uyrec_r[1]*dx1)-0.8660254037844386*rho_flux_l[1]*uyrec_l[1]*dx1-0.8660254037844386*rho_flux_r[0]*uyrec_r[0]*dx1-0.8660254037844386*rho_flux_l[0]*uyrec_l[0]*dx1-1.224744871391589*Piyrec_r[0]*dx1-1.224744871391589*Piyrec_l[0]*dx1; 
  outrhou1[2] += (-0.5*rho_flux_r[0]*uyrec_r[1]*dx1)+0.5*rho_flux_l[0]*uyrec_l[1]*dx1-0.5*uyrec_r[0]*rho_flux_r[1]*dx1+0.5*uyrec_l[0]*rho_flux_l[1]*dx1-0.7071067811865475*Piyrec_r[1]*dx1+0.7071067811865475*Piyrec_l[1]*dx1; 
  ...
  outrhou2[1] += (-0.8660254037844386*rho_flux_r[1]*uzrec_r[1]*dx1)-0.8660254037844386*rho_flux_l[1]*uzrec_l[1]*dx1-0.8660254037844386*rho_flux_r[0]*uzrec_r[0]*dx1-0.8660254037844386*rho_flux_l[0]*uzrec_l[0]*dx1-1.224744871391589*Pizrec_r[0]*dx1-1.224744871391589*Piyrec_l[0]*dx1; 
  outrhou2[2] += (-0.5*rho_flux_r[0]*uzrec_r[1]*dx1)+0.5*rho_flux_l[0]*uzrec_l[1]*dx1-0.5*uzrec_r[0]*rho_flux_r[1]*dx1+0.5*uzrec_l[0]*rho_flux_l[1]*dx1-0.7071067811865475*Pizrec_r[1]*dx1+0.7071067811865475*Piyrec_l[1]*dx1; 
