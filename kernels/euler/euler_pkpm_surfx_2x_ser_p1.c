...
{ 
  ...
  Ghat_p_perp_l[0] = 0.5303300858899105*p_perp_l[3]*u_l[3]+0.3061862178478971*p_perp_l[2]*u_l[3]+0.5303300858899105*p_perp_c[3]*u_c[3]-0.3061862178478971*p_perp_c[2]*u_c[3]+0.3061862178478971*u_l[2]*p_perp_l[3]+0.4330127018922193*uMax_l[1]*p_perp_l[3]-0.3061862178478971*u_c[2]*p_perp_c[3]+0.4330127018922193*uMax_l[1]*p_perp_c[3]+0.1767766952966368*p_perp_l[2]*u_l[2]+0.1767766952966368*p_perp_c[2]*u_c[2]+0.25*uMax_l[1]*p_perp_l[2]-0.25*uMax_l[1]*p_perp_c[2]+0.5303300858899105*p_perp_l[1]*u_l[1]+0.3061862178478971*p_perp_l[0]*u_l[1]+0.5303300858899105*p_perp_c[1]*u_c[1]-0.3061862178478971*p_perp_c[0]*u_c[1]+0.3061862178478971*u_l[0]*p_perp_l[1]+0.4330127018922193*uMax_l[0]*p_perp_l[1]-0.3061862178478971*u_c[0]*p_perp_c[1]+0.4330127018922193*uMax_l[0]*p_perp_c[1]+0.1767766952966368*p_perp_l[0]*u_l[0]+0.1767766952966368*p_perp_c[0]*u_c[0]+0.25*p_perp_l[0]*uMax_l[0]-0.25*p_perp_c[0]*uMax_l[0]; 
  Ghat_p_perp_l[1] = 0.5303300858899105*p_perp_l[1]*u_l[3]+0.3061862178478971*p_perp_l[0]*u_l[3]+0.5303300858899105*p_perp_c[1]*u_c[3]-0.3061862178478971*p_perp_c[0]*u_c[3]+0.5303300858899105*u_l[1]*p_perp_l[3]+0.3061862178478971*u_l[0]*p_perp_l[3]+0.4330127018922193*uMax_l[0]*p_perp_l[3]+0.5303300858899105*u_c[1]*p_perp_c[3]-0.3061862178478971*u_c[0]*p_perp_c[3]+0.4330127018922193*uMax_l[0]*p_perp_c[3]+0.3061862178478971*p_perp_l[1]*u_l[2]+0.1767766952966368*p_perp_l[0]*u_l[2]-0.3061862178478971*p_perp_c[1]*u_c[2]+0.1767766952966368*p_perp_c[0]*u_c[2]+0.3061862178478971*u_l[1]*p_perp_l[2]+0.1767766952966368*u_l[0]*p_perp_l[2]+0.25*uMax_l[0]*p_perp_l[2]-0.3061862178478971*u_c[1]*p_perp_c[2]+0.1767766952966368*u_c[0]*p_perp_c[2]-0.25*uMax_l[0]*p_perp_c[2]+0.4330127018922193*p_perp_l[1]*uMax_l[1]+0.4330127018922193*p_perp_c[1]*uMax_l[1]+0.25*p_perp_l[0]*uMax_l[1]-0.25*p_perp_c[0]*uMax_l[1]; 

  Ghat_p_perp_r[0] = 0.5303300858899105*p_perp_r[3]*u_r[3]-0.3061862178478971*p_perp_r[2]*u_r[3]+0.5303300858899105*p_perp_c[3]*u_c[3]+0.3061862178478971*p_perp_c[2]*u_c[3]-0.3061862178478971*u_r[2]*p_perp_r[3]+0.4330127018922193*uMax_r[1]*p_perp_r[3]+0.3061862178478971*u_c[2]*p_perp_c[3]+0.4330127018922193*uMax_r[1]*p_perp_c[3]+0.1767766952966368*p_perp_r[2]*u_r[2]+0.1767766952966368*p_perp_c[2]*u_c[2]-0.25*uMax_r[1]*p_perp_r[2]+0.25*uMax_r[1]*p_perp_c[2]+0.5303300858899105*p_perp_r[1]*u_r[1]-0.3061862178478971*p_perp_r[0]*u_r[1]+0.5303300858899105*p_perp_c[1]*u_c[1]+0.3061862178478971*p_perp_c[0]*u_c[1]-0.3061862178478971*u_r[0]*p_perp_r[1]+0.4330127018922193*uMax_r[0]*p_perp_r[1]+0.3061862178478971*u_c[0]*p_perp_c[1]+0.4330127018922193*uMax_r[0]*p_perp_c[1]+0.1767766952966368*p_perp_r[0]*u_r[0]+0.1767766952966368*p_perp_c[0]*u_c[0]-0.25*p_perp_r[0]*uMax_r[0]+0.25*p_perp_c[0]*uMax_r[0]; 
  Ghat_p_perp_r[1] = 0.5303300858899105*p_perp_r[1]*u_r[3]-0.3061862178478971*p_perp_r[0]*u_r[3]+0.5303300858899105*p_perp_c[1]*u_c[3]+0.3061862178478971*p_perp_c[0]*u_c[3]+0.5303300858899105*u_r[1]*p_perp_r[3]-0.3061862178478971*u_r[0]*p_perp_r[3]+0.4330127018922193*uMax_r[0]*p_perp_r[3]+0.5303300858899105*u_c[1]*p_perp_c[3]+0.3061862178478971*u_c[0]*p_perp_c[3]+0.4330127018922193*uMax_r[0]*p_perp_c[3]-0.3061862178478971*p_perp_r[1]*u_r[2]+0.1767766952966368*p_perp_r[0]*u_r[2]+0.3061862178478971*p_perp_c[1]*u_c[2]+0.1767766952966368*p_perp_c[0]*u_c[2]-0.3061862178478971*u_r[1]*p_perp_r[2]+0.1767766952966368*u_r[0]*p_perp_r[2]-0.25*uMax_r[0]*p_perp_r[2]+0.3061862178478971*u_c[1]*p_perp_c[2]+0.1767766952966368*u_c[0]*p_perp_c[2]+0.25*uMax_r[0]*p_perp_c[2]+0.4330127018922193*p_perp_r[1]*uMax_r[1]+0.4330127018922193*p_perp_c[1]*uMax_r[1]-0.25*p_perp_r[0]*uMax_r[1]+0.25*p_perp_c[0]*uMax_r[1]; 
