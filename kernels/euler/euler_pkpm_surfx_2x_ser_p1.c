...
{ 
  ...
  vth_sq_l_r = ser_2x_p1_surfx1_eval_quad_node_0_r(vth_sql); 
  vth_sq_c_l = ser_2x_p1_surfx1_eval_quad_node_0_l(vth_sqc); 
  vth_sq_c_r = ser_2x_p1_surfx1_eval_quad_node_0_r(vth_sqc); 
  ...
  uQuad_l = fmax(fabs(u_l_r), fabs(u_c_l)); 
  uQuad_r = fmax(fabs(u_c_r), fabs(u_r_l)); 
  vth_sq_l_r = ser_2x_p1_surfx1_eval_quad_node_1_r(vth_sql); 
  vth_sq_c_l = ser_2x_p1_surfx1_eval_quad_node_1_l(vth_sqc); 
  vth_sq_c_r = ser_2x_p1_surfx1_eval_quad_node_1_r(vth_sqc); 
  ...
  outp_perp[1] += (-1.224744871391589*lax_p_perp_modal_r[0]*dx1)-1.224744871391589*lax_p_perp_modal_l[0]*dx1; 
  outp_perp[2] += 0.7071067811865475*lax_p_perp_modal_l[1]*dx1-0.7071067811865475*lax_p_perp_modal_r[1]*dx1; 
