...
{ 
  ...
  prec_l[0] = 0.408248290463863*pl[1]-0.408248290463863*pc[1]+0.3535533905932737*pl[0]+0.3535533905932737*pc[0]; 
  prec_l[1] = 0.408248290463863*pl[3]-0.408248290463863*pc[3]+0.3535533905932737*pl[2]+0.3535533905932737*pc[2]; 
  ...
  prec_r[0] = (-0.408248290463863*pr[1])+0.408248290463863*pc[1]+0.3535533905932737*pr[0]+0.3535533905932737*pc[0]; 
  prec_r[1] = (-0.408248290463863*pr[3])+0.408248290463863*pc[3]+0.3535533905932737*pr[2]+0.3535533905932737*pc[2]; 
  ...
  outrhou0[0] += (-0.5*Ghat_rho_r[1]*urec_0_r[1]*dx1)+0.5*Ghat_rho_l[1]*urec_0_l[1]*dx1-0.5*Ghat_rho_r[0]*urec_0_r[0]*dx1+0.5*Ghat_rho_l[0]*urec_0_l[0]*dx1-0.7071067811865475*prec_r[0]*dx1+0.7071067811865475*prec_l[0]*dx1; 
  outrhou0[1] += (-0.8660254037844386*Ghat_rho_r[1]*urec_0_r[1]*dx1)-0.8660254037844386*Ghat_rho_l[1]*urec_0_l[1]*dx1-0.8660254037844386*Ghat_rho_r[0]*urec_0_r[0]*dx1-0.8660254037844386*Ghat_rho_l[0]*urec_0_l[0]*dx1-1.224744871391589*prec_r[0]*dx1-1.224744871391589*prec_l[0]*dx1; 
  outrhou0[2] += (-0.5*Ghat_rho_r[0]*urec_0_r[1]*dx1)+0.5*Ghat_rho_l[0]*urec_0_l[1]*dx1-0.7071067811865475*prec_r[1]*dx1+0.7071067811865475*prec_l[1]*dx1-0.5*urec_0_r[0]*Ghat_rho_r[1]*dx1+0.5*urec_0_l[0]*Ghat_rho_l[1]*dx1; 
  outrhou0[3] += (-0.8660254037844386*Ghat_rho_r[0]*urec_0_r[1]*dx1)-0.8660254037844386*Ghat_rho_l[0]*urec_0_l[1]*dx1-1.224744871391589*prec_r[1]*dx1-1.224744871391589*prec_l[1]*dx1-0.8660254037844386*urec_0_r[0]*Ghat_rho_r[1]*dx1-0.8660254037844386*urec_0_l[0]*Ghat_rho_l[1]*dx1; 

  outrhou1[0] += (-0.5*Ghat_rho_r[1]*urec_1_r[1]*dx1)+0.5*Ghat_rho_l[1]*urec_1_l[1]*dx1-0.5*Ghat_rho_r[0]*urec_1_r[0]*dx1+0.5*Ghat_rho_l[0]*urec_1_l[0]*dx1; 
  outrhou1[1] += (-0.8660254037844386*Ghat_rho_r[1]*urec_1_r[1]*dx1)-0.8660254037844386*Ghat_rho_l[1]*urec_1_l[1]*dx1-0.8660254037844386*Ghat_rho_r[0]*urec_1_r[0]*dx1-0.8660254037844386*Ghat_rho_l[0]*urec_1_l[0]*dx1; 
  outrhou1[2] += (-0.5*Ghat_rho_r[0]*urec_1_r[1]*dx1)+0.5*Ghat_rho_l[0]*urec_1_l[1]*dx1-0.5*urec_1_r[0]*Ghat_rho_r[1]*dx1+0.5*urec_1_l[0]*Ghat_rho_l[1]*dx1; 
  outrhou1[3] += (-0.8660254037844386*Ghat_rho_r[0]*urec_1_r[1]*dx1)-0.8660254037844386*Ghat_rho_l[0]*urec_1_l[1]*dx1-0.8660254037844386*urec_1_r[0]*Ghat_rho_r[1]*dx1-0.8660254037844386*urec_1_l[0]*Ghat_rho_l[1]*dx1; 
  ...
  outrhou2[1] += (-0.8660254037844386*Ghat_rho_r[1]*urec_2_r[1]*dx1)-0.8660254037844386*Ghat_rho_l[1]*urec_2_l[1]*dx1-0.8660254037844386*Ghat_rho_r[0]*urec_2_r[0]*dx1-0.8660254037844386*Ghat_rho_l[0]*urec_2_l[0]*dx1; 
  outrhou2[2] += (-0.5*Ghat_rho_r[0]*urec_2_r[1]*dx1)+0.5*Ghat_rho_l[0]*urec_2_l[1]*dx1-0.5*urec_2_r[0]*Ghat_rho_r[1]*dx1+0.5*urec_2_l[0]*Ghat_rho_l[1]*dx1; 
