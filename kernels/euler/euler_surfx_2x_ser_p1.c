...
{ 
  ...
  outrhou0[0] += (-0.3061862178478971*uMax_r[1]*rhou0_r[3]*dx1)+0.3061862178478971*uMax_l[1]*rhou0_l[3]*dx1-0.3061862178478971*uMax_r[1]*rhou0_c[3]*dx1+0.3061862178478971*uMax_l[1]*rhou0_c[3]*dx1+0.1767766952966368*uMax_r[1]*rhou0_r[2]*dx1+0.1767766952966368*uMax_l[1]*rhou0_l[2]*dx1-0.1767766952966368*uMax_r[1]*rhou0_c[2]*dx1-0.1767766952966368*uMax_l[1]*rhou0_c[2]*dx1-0.5*Ghat_rho_r[1]*urec_0_r[1]*dx1+0.5*Ghat_rho_l[1]*urec_0_l[1]*dx1-0.3061862178478971*uMax_r[0]*rhou0_r[1]*dx1+0.3061862178478971*uMax_l[0]*rhou0_l[1]*dx1-0.3061862178478971*uMax_r[0]*rhou0_c[1]*dx1+0.3061862178478971*uMax_l[0]*rhou0_c[1]*dx1-0.5*Ghat_rho_r[0]*urec_0_r[0]*dx1+0.5*Ghat_rho_l[0]*urec_0_l[0]*dx1+0.1767766952966368*rhou0_r[0]*uMax_r[0]*dx1-0.1767766952966368*rhou0_c[0]*uMax_r[0]*dx1+0.1767766952966368*rhou0_l[0]*uMax_l[0]*dx1-0.1767766952966368*rhou0_c[0]*uMax_l[0]*dx1-0.7071067811865475*prec_r[0]*dx1+0.7071067811865475*prec_l[0]*dx1; 
  outrhou0[1] += (-0.5303300858899105*uMax_r[1]*rhou0_r[3]*dx1)-0.5303300858899105*uMax_l[1]*rhou0_l[3]*dx1-0.5303300858899105*uMax_r[1]*rhou0_c[3]*dx1-0.5303300858899105*uMax_l[1]*rhou0_c[3]*dx1+0.3061862178478971*uMax_r[1]*rhou0_r[2]*dx1-0.3061862178478971*uMax_l[1]*rhou0_l[2]*dx1-0.3061862178478971*uMax_r[1]*rhou0_c[2]*dx1+0.3061862178478971*uMax_l[1]*rhou0_c[2]*dx1-0.8660254037844386*Ghat_rho_r[1]*urec_0_r[1]*dx1-0.8660254037844386*Ghat_rho_l[1]*urec_0_l[1]*dx1-0.5303300858899105*uMax_r[0]*rhou0_r[1]*dx1-0.5303300858899105*uMax_l[0]*rhou0_l[1]*dx1-0.5303300858899105*uMax_r[0]*rhou0_c[1]*dx1-0.5303300858899105*uMax_l[0]*rhou0_c[1]*dx1-0.8660254037844386*Ghat_rho_r[0]*urec_0_r[0]*dx1-0.8660254037844386*Ghat_rho_l[0]*urec_0_l[0]*dx1+0.3061862178478971*rhou0_r[0]*uMax_r[0]*dx1-0.3061862178478971*rhou0_c[0]*uMax_r[0]*dx1-0.3061862178478971*rhou0_l[0]*uMax_l[0]*dx1+0.3061862178478971*rhou0_c[0]*uMax_l[0]*dx1-1.224744871391589*prec_r[0]*dx1-1.224744871391589*prec_l[0]*dx1; 
  outrhou0[2] += (-0.3061862178478971*uMax_r[0]*rhou0_r[3]*dx1)+0.3061862178478971*uMax_l[0]*rhou0_l[3]*dx1-0.3061862178478971*uMax_r[0]*rhou0_c[3]*dx1+0.3061862178478971*uMax_l[0]*rhou0_c[3]*dx1+0.1767766952966368*uMax_r[0]*rhou0_r[2]*dx1+0.1767766952966368*uMax_l[0]*rhou0_l[2]*dx1-0.1767766952966368*uMax_r[0]*rhou0_c[2]*dx1-0.1767766952966368*uMax_l[0]*rhou0_c[2]*dx1-0.5*Ghat_rho_r[0]*urec_0_r[1]*dx1+0.5*Ghat_rho_l[0]*urec_0_l[1]*dx1-0.3061862178478971*rhou0_r[1]*uMax_r[1]*dx1-0.3061862178478971*rhou0_c[1]*uMax_r[1]*dx1+0.1767766952966368*rhou0_r[0]*uMax_r[1]*dx1-0.1767766952966368*rhou0_c[0]*uMax_r[1]*dx1+0.3061862178478971*rhou0_l[1]*uMax_l[1]*dx1+0.3061862178478971*rhou0_c[1]*uMax_l[1]*dx1+0.1767766952966368*rhou0_l[0]*uMax_l[1]*dx1-0.1767766952966368*rhou0_c[0]*uMax_l[1]*dx1-0.7071067811865475*prec_r[1]*dx1+0.7071067811865475*prec_l[1]*dx1-0.5*urec_0_r[0]*Ghat_rho_r[1]*dx1+0.5*urec_0_l[0]*Ghat_rho_l[1]*dx1; 
  outrhou0[3] += (-0.5303300858899105*uMax_r[0]*rhou0_r[3]*dx1)-0.5303300858899105*uMax_l[0]*rhou0_l[3]*dx1-0.5303300858899105*uMax_r[0]*rhou0_c[3]*dx1-0.5303300858899105*uMax_l[0]*rhou0_c[3]*dx1+0.3061862178478971*uMax_r[0]*rhou0_r[2]*dx1-0.3061862178478971*uMax_l[0]*rhou0_l[2]*dx1-0.3061862178478971*uMax_r[0]*rhou0_c[2]*dx1+0.3061862178478971*uMax_l[0]*rhou0_c[2]*dx1-0.8660254037844386*Ghat_rho_r[0]*urec_0_r[1]*dx1-0.8660254037844386*Ghat_rho_l[0]*urec_0_l[1]*dx1-0.5303300858899105*rhou0_r[1]*uMax_r[1]*dx1-0.5303300858899105*rhou0_c[1]*uMax_r[1]*dx1+0.3061862178478971*rhou0_r[0]*uMax_r[1]*dx1-0.3061862178478971*rhou0_c[0]*uMax_r[1]*dx1-0.5303300858899105*rhou0_l[1]*uMax_l[1]*dx1-0.5303300858899105*rhou0_c[1]*uMax_l[1]*dx1-0.3061862178478971*rhou0_l[0]*uMax_l[1]*dx1+0.3061862178478971*rhou0_c[0]*uMax_l[1]*dx1-1.224744871391589*prec_r[1]*dx1-1.224744871391589*prec_l[1]*dx1-0.8660254037844386*urec_0_r[0]*Ghat_rho_r[1]*dx1-0.8660254037844386*urec_0_l[0]*Ghat_rho_l[1]*dx1; 
