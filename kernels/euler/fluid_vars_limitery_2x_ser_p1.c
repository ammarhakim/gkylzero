...
GKYL_CU_DH void fluid_vars_limitery_2x_ser_p1(const struct gkyl_wv_eqn *wv_eqn, 
...
{ 
  ...
  delta_l[0] = 0.1443375672974065*(fluid_avg_c[0] - fluid_avg_l[0]);
  delta_l[1] = 0.1443375672974065*(fluid_avg_c[1] - fluid_avg_l[1]);
  delta_l[2] = 0.1443375672974065*(fluid_avg_c[2] - fluid_avg_l[2]);
  delta_l[3] = 0.1443375672974065*(fluid_avg_c[3] - fluid_avg_l[3]);
  delta_l[4] = 0.1443375672974065*(fluid_avg_c[4] - fluid_avg_l[4]);
  ...
  delta_r[0] = 0.1443375672974065*(fluid_avg_r[0] - fluid_avg_c[0]);
  delta_r[1] = 0.1443375672974065*(fluid_avg_r[1] - fluid_avg_c[1]);
  delta_r[2] = 0.1443375672974065*(fluid_avg_r[2] - fluid_avg_c[2]);
  delta_r[3] = 0.1443375672974065*(fluid_avg_r[3] - fluid_avg_c[3]);
  delta_r[4] = 0.1443375672974065*(fluid_avg_r[4] - fluid_avg_c[4]);
  ...
  // Zero out x*y cross coefficient if limiter applied
  for (int i=0; i<3; ++i) {
