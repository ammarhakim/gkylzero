...
{ 
  ...
  p_force_F_0[0] += 0.7071067811865475*(div_ppar_b[2]*rho_inv[2]+div_ppar_b[1]*rho_inv[1]+div_ppar_b[0]*rho_inv[0]); 
  p_force_F_0[1] += 0.6324555320336759*(div_ppar_b[1]*rho_inv[2]+rho_inv[1]*div_ppar_b[2])+0.7071067811865475*(div_ppar_b[0]*rho_inv[1]+rho_inv[0]*div_ppar_b[1]); 
  p_force_F_0[2] += 0.4517539514526256*div_ppar_b[2]*rho_inv[2]+0.7071067811865475*(div_ppar_b[0]*rho_inv[2]+rho_inv[0]*div_ppar_b[2])+0.6324555320336759*div_ppar_b[1]*rho_inv[1]; 
  p_force_G_1[0] += 0.7071067811865475*div_ppar_b[2]*rho_inv[2]+2.121320343559642*T_perp_over_m[2]*div_b_comp[2]+0.7071067811865475*div_ppar_b[1]*rho_inv[1]+2.121320343559642*T_perp_over_m[1]*div_b_comp[1]+0.7071067811865475*div_ppar_b[0]*rho_inv[0]+2.121320343559642*T_perp_over_m[0]*div_b_comp[0]; 
  p_force_G_1[1] += 0.6324555320336759*(div_ppar_b[1]*rho_inv[2]+rho_inv[1]*div_ppar_b[2])+1.897366596101028*(T_perp_over_m[1]*div_b_comp[2]+div_b_comp[1]*T_perp_over_m[2])+0.7071067811865475*(div_ppar_b[0]*rho_inv[1]+rho_inv[0]*div_ppar_b[1])+2.121320343559642*(T_perp_over_m[0]*div_b_comp[1]+div_b_comp[0]*T_perp_over_m[1]); 
  p_force_G_1[2] += 0.4517539514526256*div_ppar_b[2]*rho_inv[2]+0.7071067811865475*(div_ppar_b[0]*rho_inv[2]+rho_inv[0]*div_ppar_b[2])+1.355261854357877*T_perp_over_m[2]*div_b_comp[2]+2.121320343559642*(T_perp_over_m[0]*div_b_comp[2]+div_b_comp[0]*T_perp_over_m[2])+0.6324555320336759*div_ppar_b[1]*rho_inv[1]+1.897366596101028*T_perp_over_m[1]*div_b_comp[1]; 
