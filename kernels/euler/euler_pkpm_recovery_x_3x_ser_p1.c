...
{ 
  ...
  grad_u_x[2] = (-0.2886751345948129*ux_r[4]*dx1)-0.2886751345948129*ux_l[4]*dx1+0.5773502691896258*ux_c[4]*dx1+0.25*ux_r[2]*dx1-0.25*ux_l[2]*dx1; 
  grad_u_x[3] = (-0.2886751345948129*ux_r[5]*dx1)-0.2886751345948129*ux_l[5]*dx1+0.5773502691896258*ux_c[5]*dx1+0.25*ux_r[3]*dx1-0.25*ux_l[3]*dx1; 
  grad_u_x[4] = (-0.5*ux_r[4]*dx1)+0.5*ux_l[4]*dx1+0.4330127018922193*ux_r[2]*dx1+0.4330127018922193*ux_l[2]*dx1-0.8660254037844386*ux_c[2]*dx1; 
  grad_u_x[5] = (-0.5*ux_r[5]*dx1)+0.5*ux_l[5]*dx1+0.4330127018922193*ux_r[3]*dx1+0.4330127018922193*ux_l[3]*dx1-0.8660254037844386*ux_c[3]*dx1; 
  grad_u_x[6] = (-0.2886751345948129*ux_r[7]*dx1)-0.2886751345948129*ux_l[7]*dx1+0.5773502691896258*ux_c[7]*dx1+0.25*ux_r[6]*dx1-0.25*ux_l[6]*dx1; 
  grad_u_x[7] = (-0.5*ux_r[7]*dx1)+0.5*ux_l[7]*dx1+0.4330127018922193*ux_r[6]*dx1+0.4330127018922193*ux_l[6]*dx1-0.8660254037844386*ux_c[6]*dx1; 
  ...
  grad_u_y[2] = (-0.2886751345948129*uy_r[4]*dx1)-0.2886751345948129*uy_l[4]*dx1+0.5773502691896258*uy_c[4]*dx1+0.25*uy_r[2]*dx1-0.25*uy_l[2]*dx1; 
  grad_u_y[3] = (-0.2886751345948129*uy_r[5]*dx1)-0.2886751345948129*uy_l[5]*dx1+0.5773502691896258*uy_c[5]*dx1+0.25*uy_r[3]*dx1-0.25*uy_l[3]*dx1; 
  grad_u_y[4] = (-0.5*uy_r[4]*dx1)+0.5*uy_l[4]*dx1+0.4330127018922193*uy_r[2]*dx1+0.4330127018922193*uy_l[2]*dx1-0.8660254037844386*uy_c[2]*dx1; 
  grad_u_y[5] = (-0.5*uy_r[5]*dx1)+0.5*uy_l[5]*dx1+0.4330127018922193*uy_r[3]*dx1+0.4330127018922193*uy_l[3]*dx1-0.8660254037844386*uy_c[3]*dx1; 
  grad_u_y[6] = (-0.2886751345948129*uy_r[7]*dx1)-0.2886751345948129*uy_l[7]*dx1+0.5773502691896258*uy_c[7]*dx1+0.25*uy_r[6]*dx1-0.25*uy_l[6]*dx1; 
  grad_u_y[7] = (-0.5*uy_r[7]*dx1)+0.5*uy_l[7]*dx1+0.4330127018922193*uy_r[6]*dx1+0.4330127018922193*uy_l[6]*dx1-0.8660254037844386*uy_c[6]*dx1; 
  ...
  grad_u_z[2] = (-0.2886751345948129*uz_r[4]*dx1)-0.2886751345948129*uz_l[4]*dx1+0.5773502691896258*uz_c[4]*dx1+0.25*uz_r[2]*dx1-0.25*uz_l[2]*dx1; 
  grad_u_z[3] = (-0.2886751345948129*uz_r[5]*dx1)-0.2886751345948129*uz_l[5]*dx1+0.5773502691896258*uz_c[5]*dx1+0.25*uz_r[3]*dx1-0.25*uz_l[3]*dx1; 
  grad_u_z[4] = (-0.5*uz_r[4]*dx1)+0.5*uz_l[4]*dx1+0.4330127018922193*uz_r[2]*dx1+0.4330127018922193*uz_l[2]*dx1-0.8660254037844386*uz_c[2]*dx1; 
  grad_u_z[5] = (-0.5*uz_r[5]*dx1)+0.5*uz_l[5]*dx1+0.4330127018922193*uz_r[3]*dx1+0.4330127018922193*uz_l[3]*dx1-0.8660254037844386*uz_c[3]*dx1; 
  grad_u_z[6] = (-0.2886751345948129*uz_r[7]*dx1)-0.2886751345948129*uz_l[7]*dx1+0.5773502691896258*uz_c[7]*dx1+0.25*uz_r[6]*dx1-0.25*uz_l[6]*dx1; 
  grad_u_z[7] = (-0.5*uz_r[7]*dx1)+0.5*uz_l[7]*dx1+0.4330127018922193*uz_r[6]*dx1+0.4330127018922193*uz_l[6]*dx1-0.8660254037844386*uz_c[6]*dx1; 
  ...
  div_ppar_b[2] = (-0.2886751345948129*ppar_b_r[4]*dx1)-0.2886751345948129*ppar_b_l[4]*dx1+0.5773502691896258*ppar_b_c[4]*dx1+0.25*ppar_b_r[2]*dx1-0.25*ppar_b_l[2]*dx1; 
  div_ppar_b[3] = (-0.2886751345948129*ppar_b_r[5]*dx1)-0.2886751345948129*ppar_b_l[5]*dx1+0.5773502691896258*ppar_b_c[5]*dx1+0.25*ppar_b_r[3]*dx1-0.25*ppar_b_l[3]*dx1; 
  div_ppar_b[4] = (-0.5*ppar_b_r[4]*dx1)+0.5*ppar_b_l[4]*dx1+0.4330127018922193*ppar_b_r[2]*dx1+0.4330127018922193*ppar_b_l[2]*dx1-0.8660254037844386*ppar_b_c[2]*dx1; 
  div_ppar_b[5] = (-0.5*ppar_b_r[5]*dx1)+0.5*ppar_b_l[5]*dx1+0.4330127018922193*ppar_b_r[3]*dx1+0.4330127018922193*ppar_b_l[3]*dx1-0.8660254037844386*ppar_b_c[3]*dx1; 
  div_ppar_b[6] = (-0.2886751345948129*ppar_b_r[7]*dx1)-0.2886751345948129*ppar_b_l[7]*dx1+0.5773502691896258*ppar_b_c[7]*dx1+0.25*ppar_b_r[6]*dx1-0.25*ppar_b_l[6]*dx1; 
  div_ppar_b[7] = (-0.5*ppar_b_r[7]*dx1)+0.5*ppar_b_l[7]*dx1+0.4330127018922193*ppar_b_r[6]*dx1+0.4330127018922193*ppar_b_l[6]*dx1-0.8660254037844386*ppar_b_c[6]*dx1; 

  p_force_F_0[0] += 0.3535533905932737*div_ppar_b[7]*rho_inv[7]-0.3535533905932737*T_perp_over_m[7]*div_b_comp[7]+0.3535533905932737*div_ppar_b[6]*rho_inv[6]-0.3535533905932737*T_perp_over_m[6]*div_b_comp[6]+0.3535533905932737*div_ppar_b[5]*rho_inv[5]-0.3535533905932737*T_perp_over_m[5]*div_b_comp[5]+0.3535533905932737*div_ppar_b[4]*rho_inv[4]-0.3535533905932737*T_perp_over_m[4]*div_b_comp[4]+0.3535533905932737*div_ppar_b[3]*rho_inv[3]-0.3535533905932737*T_perp_over_m[3]*div_b_comp[3]+0.3535533905932737*div_ppar_b[2]*rho_inv[2]-0.3535533905932737*T_perp_over_m[2]*div_b_comp[2]+0.3535533905932737*div_ppar_b[1]*rho_inv[1]-0.3535533905932737*T_perp_over_m[1]*div_b_comp[1]+0.3535533905932737*div_ppar_b[0]*rho_inv[0]-0.3535533905932737*T_perp_over_m[0]*div_b_comp[0]; 
  p_force_F_0[1] += 0.3535533905932737*(div_ppar_b[6]*rho_inv[7]+rho_inv[6]*div_ppar_b[7])-0.3535533905932737*(T_perp_over_m[6]*div_b_comp[7]+div_b_comp[6]*T_perp_over_m[7])+0.3535533905932737*(div_ppar_b[3]*rho_inv[5]+rho_inv[3]*div_ppar_b[5])-0.3535533905932737*(T_perp_over_m[3]*div_b_comp[5]+div_b_comp[3]*T_perp_over_m[5])+0.3535533905932737*(div_ppar_b[2]*rho_inv[4]+rho_inv[2]*div_ppar_b[4])-0.3535533905932737*(T_perp_over_m[2]*div_b_comp[4]+div_b_comp[2]*T_perp_over_m[4])+0.3535533905932737*(div_ppar_b[0]*rho_inv[1]+rho_inv[0]*div_ppar_b[1])-0.3535533905932737*(T_perp_over_m[0]*div_b_comp[1]+div_b_comp[0]*T_perp_over_m[1]); 
  p_force_F_0[2] += 0.3535533905932737*(div_ppar_b[5]*rho_inv[7]+rho_inv[5]*div_ppar_b[7])-0.3535533905932737*(T_perp_over_m[5]*div_b_comp[7]+div_b_comp[5]*T_perp_over_m[7])+0.3535533905932737*(div_ppar_b[3]*rho_inv[6]+rho_inv[3]*div_ppar_b[6])-0.3535533905932737*(T_perp_over_m[3]*div_b_comp[6]+div_b_comp[3]*T_perp_over_m[6])+0.3535533905932737*(div_ppar_b[1]*rho_inv[4]+rho_inv[1]*div_ppar_b[4])-0.3535533905932737*(T_perp_over_m[1]*div_b_comp[4]+div_b_comp[1]*T_perp_over_m[4])+0.3535533905932737*(div_ppar_b[0]*rho_inv[2]+rho_inv[0]*div_ppar_b[2])-0.3535533905932737*(T_perp_over_m[0]*div_b_comp[2]+div_b_comp[0]*T_perp_over_m[2]); 
  p_force_F_0[3] += 0.3535533905932737*(div_ppar_b[4]*rho_inv[7]+rho_inv[4]*div_ppar_b[7])-0.3535533905932737*(T_perp_over_m[4]*div_b_comp[7]+div_b_comp[4]*T_perp_over_m[7])+0.3535533905932737*(div_ppar_b[2]*rho_inv[6]+rho_inv[2]*div_ppar_b[6])-0.3535533905932737*(T_perp_over_m[2]*div_b_comp[6]+div_b_comp[2]*T_perp_over_m[6])+0.3535533905932737*(div_ppar_b[1]*rho_inv[5]+rho_inv[1]*div_ppar_b[5])-0.3535533905932737*(T_perp_over_m[1]*div_b_comp[5]+div_b_comp[1]*T_perp_over_m[5])+0.3535533905932737*(div_ppar_b[0]*rho_inv[3]+rho_inv[0]*div_ppar_b[3])-0.3535533905932737*(T_perp_over_m[0]*div_b_comp[3]+div_b_comp[0]*T_perp_over_m[3]); 
  p_force_F_0[4] += 0.3535533905932737*(div_ppar_b[3]*rho_inv[7]+rho_inv[3]*div_ppar_b[7])-0.3535533905932737*(T_perp_over_m[3]*div_b_comp[7]+div_b_comp[3]*T_perp_over_m[7])+0.3535533905932737*(div_ppar_b[5]*rho_inv[6]+rho_inv[5]*div_ppar_b[6])-0.3535533905932737*(T_perp_over_m[5]*div_b_comp[6]+div_b_comp[5]*T_perp_over_m[6])+0.3535533905932737*(div_ppar_b[0]*rho_inv[4]+rho_inv[0]*div_ppar_b[4])-0.3535533905932737*(T_perp_over_m[0]*div_b_comp[4]+div_b_comp[0]*T_perp_over_m[4])+0.3535533905932737*(div_ppar_b[1]*rho_inv[2]+rho_inv[1]*div_ppar_b[2])-0.3535533905932737*(T_perp_over_m[1]*div_b_comp[2]+div_b_comp[1]*T_perp_over_m[2]); 
  p_force_F_0[5] += 0.3535533905932737*(div_ppar_b[2]*rho_inv[7]+rho_inv[2]*div_ppar_b[7])-0.3535533905932737*(T_perp_over_m[2]*div_b_comp[7]+div_b_comp[2]*T_perp_over_m[7])+0.3535533905932737*(div_ppar_b[4]*rho_inv[6]+rho_inv[4]*div_ppar_b[6])-0.3535533905932737*(T_perp_over_m[4]*div_b_comp[6]+div_b_comp[4]*T_perp_over_m[6])+0.3535533905932737*(div_ppar_b[0]*rho_inv[5]+rho_inv[0]*div_ppar_b[5])-0.3535533905932737*(T_perp_over_m[0]*div_b_comp[5]+div_b_comp[0]*T_perp_over_m[5])+0.3535533905932737*(div_ppar_b[1]*rho_inv[3]+rho_inv[1]*div_ppar_b[3])-0.3535533905932737*(T_perp_over_m[1]*div_b_comp[3]+div_b_comp[1]*T_perp_over_m[3]); 
  p_force_F_0[6] += 0.3535533905932737*(div_ppar_b[1]*rho_inv[7]+rho_inv[1]*div_ppar_b[7])-0.3535533905932737*(T_perp_over_m[1]*div_b_comp[7]+div_b_comp[1]*T_perp_over_m[7])+0.3535533905932737*(div_ppar_b[0]*rho_inv[6]+rho_inv[0]*div_ppar_b[6])-0.3535533905932737*(T_perp_over_m[0]*div_b_comp[6]+div_b_comp[0]*T_perp_over_m[6])+0.3535533905932737*(div_ppar_b[4]*rho_inv[5]+rho_inv[4]*div_ppar_b[5])-0.3535533905932737*(T_perp_over_m[4]*div_b_comp[5]+div_b_comp[4]*T_perp_over_m[5])+0.3535533905932737*(div_ppar_b[2]*rho_inv[3]+rho_inv[2]*div_ppar_b[3])-0.3535533905932737*(T_perp_over_m[2]*div_b_comp[3]+div_b_comp[2]*T_perp_over_m[3]); 
  p_force_F_0[7] += 0.3535533905932737*(div_ppar_b[0]*rho_inv[7]+rho_inv[0]*div_ppar_b[7])-0.3535533905932737*(T_perp_over_m[0]*div_b_comp[7]+div_b_comp[0]*T_perp_over_m[7])+0.3535533905932737*(div_ppar_b[1]*rho_inv[6]+rho_inv[1]*div_ppar_b[6])-0.3535533905932737*(T_perp_over_m[1]*div_b_comp[6]+div_b_comp[1]*T_perp_over_m[6])+0.3535533905932737*(div_ppar_b[2]*rho_inv[5]+rho_inv[2]*div_ppar_b[5])-0.3535533905932737*(T_perp_over_m[2]*div_b_comp[5]+div_b_comp[2]*T_perp_over_m[5])+0.3535533905932737*(div_ppar_b[3]*rho_inv[4]+rho_inv[3]*div_ppar_b[4])-0.3535533905932737*(T_perp_over_m[3]*div_b_comp[4]+div_b_comp[3]*T_perp_over_m[4]); 
  p_force_G_1[0] += 0.3535533905932737*(div_ppar_b[7]*rho_inv[7]+T_perp_over_m[7]*div_b_comp[7]+div_ppar_b[6]*rho_inv[6]+T_perp_over_m[6]*div_b_comp[6]+div_ppar_b[5]*rho_inv[5]+T_perp_over_m[5]*div_b_comp[5]+div_ppar_b[4]*rho_inv[4]+T_perp_over_m[4]*div_b_comp[4]+div_ppar_b[3]*rho_inv[3]+T_perp_over_m[3]*div_b_comp[3]+div_ppar_b[2]*rho_inv[2]+T_perp_over_m[2]*div_b_comp[2]+div_ppar_b[1]*rho_inv[1]+T_perp_over_m[1]*div_b_comp[1]+div_ppar_b[0]*rho_inv[0]+T_perp_over_m[0]*div_b_comp[0]); 
  p_force_G_1[1] += 0.3535533905932737*(div_ppar_b[6]*rho_inv[7]+rho_inv[6]*div_ppar_b[7]+T_perp_over_m[6]*div_b_comp[7]+div_b_comp[6]*T_perp_over_m[7]+div_ppar_b[3]*rho_inv[5]+rho_inv[3]*div_ppar_b[5]+T_perp_over_m[3]*div_b_comp[5]+div_b_comp[3]*T_perp_over_m[5]+div_ppar_b[2]*rho_inv[4]+rho_inv[2]*div_ppar_b[4]+T_perp_over_m[2]*div_b_comp[4]+div_b_comp[2]*T_perp_over_m[4]+div_ppar_b[0]*rho_inv[1]+rho_inv[0]*div_ppar_b[1]+T_perp_over_m[0]*div_b_comp[1]+div_b_comp[0]*T_perp_over_m[1]); 
  p_force_G_1[2] += 0.3535533905932737*(div_ppar_b[5]*rho_inv[7]+rho_inv[5]*div_ppar_b[7]+T_perp_over_m[5]*div_b_comp[7]+div_b_comp[5]*T_perp_over_m[7]+div_ppar_b[3]*rho_inv[6]+rho_inv[3]*div_ppar_b[6]+T_perp_over_m[3]*div_b_comp[6]+div_b_comp[3]*T_perp_over_m[6]+div_ppar_b[1]*rho_inv[4]+rho_inv[1]*div_ppar_b[4]+T_perp_over_m[1]*div_b_comp[4]+div_b_comp[1]*T_perp_over_m[4]+div_ppar_b[0]*rho_inv[2]+rho_inv[0]*div_ppar_b[2]+T_perp_over_m[0]*div_b_comp[2]+div_b_comp[0]*T_perp_over_m[2]); 
  p_force_G_1[3] += 0.3535533905932737*(div_ppar_b[4]*rho_inv[7]+rho_inv[4]*div_ppar_b[7]+T_perp_over_m[4]*div_b_comp[7]+div_b_comp[4]*T_perp_over_m[7]+div_ppar_b[2]*rho_inv[6]+rho_inv[2]*div_ppar_b[6]+T_perp_over_m[2]*div_b_comp[6]+div_b_comp[2]*T_perp_over_m[6]+div_ppar_b[1]*rho_inv[5]+rho_inv[1]*div_ppar_b[5]+T_perp_over_m[1]*div_b_comp[5]+div_b_comp[1]*T_perp_over_m[5]+div_ppar_b[0]*rho_inv[3]+rho_inv[0]*div_ppar_b[3]+T_perp_over_m[0]*div_b_comp[3]+div_b_comp[0]*T_perp_over_m[3]); 
  p_force_G_1[4] += 0.3535533905932737*(div_ppar_b[3]*rho_inv[7]+rho_inv[3]*div_ppar_b[7]+T_perp_over_m[3]*div_b_comp[7]+div_b_comp[3]*T_perp_over_m[7]+div_ppar_b[5]*rho_inv[6]+rho_inv[5]*div_ppar_b[6]+T_perp_over_m[5]*div_b_comp[6]+div_b_comp[5]*T_perp_over_m[6]+div_ppar_b[0]*rho_inv[4]+rho_inv[0]*div_ppar_b[4]+T_perp_over_m[0]*div_b_comp[4]+div_b_comp[0]*T_perp_over_m[4]+div_ppar_b[1]*rho_inv[2]+rho_inv[1]*div_ppar_b[2]+T_perp_over_m[1]*div_b_comp[2]+div_b_comp[1]*T_perp_over_m[2]); 
  p_force_G_1[5] += 0.3535533905932737*(div_ppar_b[2]*rho_inv[7]+rho_inv[2]*div_ppar_b[7]+T_perp_over_m[2]*div_b_comp[7]+div_b_comp[2]*T_perp_over_m[7]+div_ppar_b[4]*rho_inv[6]+rho_inv[4]*div_ppar_b[6]+T_perp_over_m[4]*div_b_comp[6]+div_b_comp[4]*T_perp_over_m[6]+div_ppar_b[0]*rho_inv[5]+rho_inv[0]*div_ppar_b[5]+T_perp_over_m[0]*div_b_comp[5]+div_b_comp[0]*T_perp_over_m[5]+div_ppar_b[1]*rho_inv[3]+rho_inv[1]*div_ppar_b[3]+T_perp_over_m[1]*div_b_comp[3]+div_b_comp[1]*T_perp_over_m[3]); 
  p_force_G_1[6] += 0.3535533905932737*(div_ppar_b[1]*rho_inv[7]+rho_inv[1]*div_ppar_b[7]+T_perp_over_m[1]*div_b_comp[7]+div_b_comp[1]*T_perp_over_m[7]+div_ppar_b[0]*rho_inv[6]+rho_inv[0]*div_ppar_b[6]+T_perp_over_m[0]*div_b_comp[6]+div_b_comp[0]*T_perp_over_m[6]+div_ppar_b[4]*rho_inv[5]+rho_inv[4]*div_ppar_b[5]+T_perp_over_m[4]*div_b_comp[5]+div_b_comp[4]*T_perp_over_m[5]+div_ppar_b[2]*rho_inv[3]+rho_inv[2]*div_ppar_b[3]+T_perp_over_m[2]*div_b_comp[3]+div_b_comp[2]*T_perp_over_m[3]); 
  p_force_G_1[7] += 0.3535533905932737*(div_ppar_b[0]*rho_inv[7]+rho_inv[0]*div_ppar_b[7]+T_perp_over_m[0]*div_b_comp[7]+div_b_comp[0]*T_perp_over_m[7]+div_ppar_b[1]*rho_inv[6]+rho_inv[1]*div_ppar_b[6]+T_perp_over_m[1]*div_b_comp[6]+div_b_comp[1]*T_perp_over_m[6]+div_ppar_b[2]*rho_inv[5]+rho_inv[2]*div_ppar_b[5]+T_perp_over_m[2]*div_b_comp[5]+div_b_comp[2]*T_perp_over_m[5]+div_ppar_b[3]*rho_inv[4]+rho_inv[3]*div_ppar_b[4]+T_perp_over_m[3]*div_b_comp[4]+div_b_comp[3]*T_perp_over_m[4]); 

  p_perp_source[0] += 0.1178511301977579*(T_perp_over_m_inv[7]*nu_vthsq[7]+T_perp_over_m_inv[6]*nu_vthsq[6]+T_perp_over_m_inv[5]*nu_vthsq[5]+T_perp_over_m_inv[4]*nu_vthsq[4]+T_perp_over_m_inv[3]*nu_vthsq[3]+T_perp_over_m_inv[2]*nu_vthsq[2]+T_perp_over_m_inv[1]*nu_vthsq[1]+T_perp_over_m_inv[0]*nu_vthsq[0])-0.3333333333333333*nu[0]-1.0*grad_u_x[0]+bb_grad_u_comp[0]; 
  p_perp_source[1] += 0.1178511301977579*(T_perp_over_m_inv[6]*nu_vthsq[7]+nu_vthsq[6]*T_perp_over_m_inv[7]+T_perp_over_m_inv[3]*nu_vthsq[5]+nu_vthsq[3]*T_perp_over_m_inv[5]+T_perp_over_m_inv[2]*nu_vthsq[4]+nu_vthsq[2]*T_perp_over_m_inv[4]+T_perp_over_m_inv[0]*nu_vthsq[1])-0.3333333333333333*nu[1]-1.0*grad_u_x[1]+bb_grad_u_comp[1]+0.1178511301977579*nu_vthsq[0]*T_perp_over_m_inv[1]; 
  p_perp_source[2] += 0.1178511301977579*(T_perp_over_m_inv[5]*nu_vthsq[7]+nu_vthsq[5]*T_perp_over_m_inv[7]+T_perp_over_m_inv[3]*nu_vthsq[6]+nu_vthsq[3]*T_perp_over_m_inv[6]+T_perp_over_m_inv[1]*nu_vthsq[4]+nu_vthsq[1]*T_perp_over_m_inv[4]+T_perp_over_m_inv[0]*nu_vthsq[2])-0.3333333333333333*nu[2]-1.0*grad_u_x[2]+bb_grad_u_comp[2]+0.1178511301977579*nu_vthsq[0]*T_perp_over_m_inv[2]; 
  p_perp_source[3] += 0.1178511301977579*(T_perp_over_m_inv[4]*nu_vthsq[7]+nu_vthsq[4]*T_perp_over_m_inv[7]+T_perp_over_m_inv[2]*nu_vthsq[6]+nu_vthsq[2]*T_perp_over_m_inv[6]+T_perp_over_m_inv[1]*nu_vthsq[5]+nu_vthsq[1]*T_perp_over_m_inv[5]+T_perp_over_m_inv[0]*nu_vthsq[3])-0.3333333333333333*nu[3]-1.0*grad_u_x[3]+bb_grad_u_comp[3]+0.1178511301977579*nu_vthsq[0]*T_perp_over_m_inv[3]; 
  p_perp_source[4] += 0.1178511301977579*(T_perp_over_m_inv[3]*nu_vthsq[7]+nu_vthsq[3]*T_perp_over_m_inv[7]+T_perp_over_m_inv[5]*nu_vthsq[6]+nu_vthsq[5]*T_perp_over_m_inv[6]+T_perp_over_m_inv[0]*nu_vthsq[4])-0.3333333333333333*nu[4]-1.0*grad_u_x[4]+bb_grad_u_comp[4]+0.1178511301977579*(nu_vthsq[0]*T_perp_over_m_inv[4]+T_perp_over_m_inv[1]*nu_vthsq[2]+nu_vthsq[1]*T_perp_over_m_inv[2]); 
  p_perp_source[5] += 0.1178511301977579*(T_perp_over_m_inv[2]*nu_vthsq[7]+nu_vthsq[2]*T_perp_over_m_inv[7]+T_perp_over_m_inv[4]*nu_vthsq[6]+nu_vthsq[4]*T_perp_over_m_inv[6]+T_perp_over_m_inv[0]*nu_vthsq[5])-0.3333333333333333*nu[5]-1.0*grad_u_x[5]+bb_grad_u_comp[5]+0.1178511301977579*(nu_vthsq[0]*T_perp_over_m_inv[5]+T_perp_over_m_inv[1]*nu_vthsq[3]+nu_vthsq[1]*T_perp_over_m_inv[3]); 
  p_perp_source[6] += 0.1178511301977579*(T_perp_over_m_inv[1]*nu_vthsq[7]+nu_vthsq[1]*T_perp_over_m_inv[7]+T_perp_over_m_inv[0]*nu_vthsq[6])-0.3333333333333333*nu[6]-1.0*grad_u_x[6]+bb_grad_u_comp[6]+0.1178511301977579*(nu_vthsq[0]*T_perp_over_m_inv[6]+T_perp_over_m_inv[4]*nu_vthsq[5]+nu_vthsq[4]*T_perp_over_m_inv[5]+T_perp_over_m_inv[2]*nu_vthsq[3]+nu_vthsq[2]*T_perp_over_m_inv[3]); 
  p_perp_source[7] += 0.1178511301977579*T_perp_over_m_inv[0]*nu_vthsq[7]-0.3333333333333333*nu[7]-1.0*grad_u_x[7]+bb_grad_u_comp[7]+0.1178511301977579*(nu_vthsq[0]*T_perp_over_m_inv[7]+T_perp_over_m_inv[1]*nu_vthsq[6]+nu_vthsq[1]*T_perp_over_m_inv[6]+T_perp_over_m_inv[2]*nu_vthsq[5]+nu_vthsq[2]*T_perp_over_m_inv[5]+T_perp_over_m_inv[3]*nu_vthsq[4]+nu_vthsq[3]*T_perp_over_m_inv[4]); 
