...
{ 
  ...
  div_p_z[0] += (4.871392896287466*rhouy_r[1]-4.871392896287466*rhouy_l[1]-2.8125*(rhouy_r[0]+rhouy_l[0])+5.625*rhouy_c[0])*dx14*nuHyp+((-0.2886751345948129*(Pxz_r[1]+Pxz_l[1]))+0.5773502691896258*Pxz_c[1]+0.25*Pxz_r[0]-0.25*Pxz_l[0])*dx1; 
  div_p_z[1] += (72.1875*(rhouy_r[1]+rhouy_l[1])+249.375*rhouy_c[1]-56.83291712335378*rhouy_r[0]+56.83291712335378*rhouy_l[0])*dx14*nuHyp+((-0.5*Pxz_r[1])+0.5*Pxz_l[1]+0.4330127018922193*(Pxz_r[0]+Pxz_l[0])-0.8660254037844386*Pxz_c[0])*dx1; 
  div_p_z[2] += (4.871392896287466*rhouy_r[4]-4.871392896287466*rhouy_l[4]-2.8125*(rhouy_r[2]+rhouy_l[2])+5.625*rhouy_c[2])*dx14*nuHyp+((-0.2886751345948129*(Pxz_r[4]+Pxz_l[4]))+0.5773502691896258*Pxz_c[4]+0.25*Pxz_r[2]-0.25*Pxz_l[2])*dx1; 
  div_p_z[3] += (4.871392896287466*rhouy_r[5]-4.871392896287466*rhouy_l[5]-2.8125*(rhouy_r[3]+rhouy_l[3])+5.625*rhouy_c[3])*dx14*nuHyp+((-0.2886751345948129*(Pxz_r[5]+Pxz_l[5]))+0.5773502691896258*Pxz_c[5]+0.25*Pxz_r[3]-0.25*Pxz_l[3])*dx1; 
  div_p_z[4] += (72.1875*(rhouy_r[4]+rhouy_l[4])+249.375*rhouy_c[4]-56.83291712335378*rhouy_r[2]+56.83291712335378*rhouy_l[2])*dx14*nuHyp+((-0.5*Pxz_r[4])+0.5*Pxz_l[4]+0.4330127018922193*(Pxz_r[2]+Pxz_l[2])-0.8660254037844386*Pxz_c[2])*dx1; 
  div_p_z[5] += (72.1875*(rhouy_r[5]+rhouy_l[5])+249.375*rhouy_c[5]-56.83291712335378*rhouy_r[3]+56.83291712335378*rhouy_l[3])*dx14*nuHyp+((-0.5*Pxz_r[5])+0.5*Pxz_l[5]+0.4330127018922193*(Pxz_r[3]+Pxz_l[3])-0.8660254037844386*Pxz_c[3])*dx1; 
  div_p_z[6] += (4.871392896287466*rhouy_r[7]-4.871392896287466*rhouy_l[7]-2.8125*(rhouy_r[6]+rhouy_l[6])+5.625*rhouy_c[6])*dx14*nuHyp+((-0.2886751345948129*(Pxz_r[7]+Pxz_l[7]))+0.5773502691896258*Pxz_c[7]+0.25*Pxz_r[6]-0.25*Pxz_l[6])*dx1; 
  div_p_z[7] += (72.1875*(rhouy_r[7]+rhouy_l[7])+249.375*rhouy_c[7]-56.83291712335378*rhouy_r[6]+56.83291712335378*rhouy_l[6])*dx14*nuHyp+((-0.5*Pxz_r[7])+0.5*Pxz_l[7]+0.4330127018922193*(Pxz_r[6]+Pxz_l[6])-0.8660254037844386*Pxz_c[6])*dx1; 
  ...
  p_perp_source[0] += 0.3535533905932737*(bb_grad_u[7]*p_perp[7]+bb_grad_u[6]*p_perp[6]+bb_grad_u[5]*p_perp[5]+bb_grad_u[4]*p_perp[4]+bb_grad_u[3]*p_perp[3]+bb_grad_u[2]*p_perp[2]+bb_grad_u[1]*p_perp[1]+bb_grad_u[0]*p_perp[0])-0.3535533905932737*(grad_u_x[7]*p_perp[7]+grad_u_x[6]*p_perp[6]+grad_u_x[5]*p_perp[5]+grad_u_x[4]*p_perp[4]+grad_u_x[3]*p_perp[3]+grad_u_x[2]*p_perp[2]+grad_u_x[1]*p_perp[1]+grad_u_x[0]*p_perp[0])*dx1; 
  p_perp_source[1] += 0.3535533905932737*(bb_grad_u[6]*p_perp[7]+p_perp[6]*bb_grad_u[7]+bb_grad_u[3]*p_perp[5]+p_perp[3]*bb_grad_u[5]+bb_grad_u[2]*p_perp[4]+p_perp[2]*bb_grad_u[4]+bb_grad_u[0]*p_perp[1]+p_perp[0]*bb_grad_u[1])-0.3535533905932737*(grad_u_x[6]*p_perp[7]+p_perp[6]*grad_u_x[7]+grad_u_x[3]*p_perp[5]+p_perp[3]*grad_u_x[5]+grad_u_x[2]*p_perp[4]+p_perp[2]*grad_u_x[4]+grad_u_x[0]*p_perp[1]+p_perp[0]*grad_u_x[1])*dx1; 
  p_perp_source[2] += 0.3535533905932737*(bb_grad_u[5]*p_perp[7]+p_perp[5]*bb_grad_u[7]+bb_grad_u[3]*p_perp[6]+p_perp[3]*bb_grad_u[6]+bb_grad_u[1]*p_perp[4]+p_perp[1]*bb_grad_u[4]+bb_grad_u[0]*p_perp[2]+p_perp[0]*bb_grad_u[2])-0.3535533905932737*(grad_u_x[5]*p_perp[7]+p_perp[5]*grad_u_x[7]+grad_u_x[3]*p_perp[6]+p_perp[3]*grad_u_x[6]+grad_u_x[1]*p_perp[4]+p_perp[1]*grad_u_x[4]+grad_u_x[0]*p_perp[2]+p_perp[0]*grad_u_x[2])*dx1; 
  p_perp_source[3] += 0.3535533905932737*(bb_grad_u[4]*p_perp[7]+p_perp[4]*bb_grad_u[7]+bb_grad_u[2]*p_perp[6]+p_perp[2]*bb_grad_u[6]+bb_grad_u[1]*p_perp[5]+p_perp[1]*bb_grad_u[5]+bb_grad_u[0]*p_perp[3]+p_perp[0]*bb_grad_u[3])-0.3535533905932737*(grad_u_x[4]*p_perp[7]+p_perp[4]*grad_u_x[7]+grad_u_x[2]*p_perp[6]+p_perp[2]*grad_u_x[6]+grad_u_x[1]*p_perp[5]+p_perp[1]*grad_u_x[5]+grad_u_x[0]*p_perp[3]+p_perp[0]*grad_u_x[3])*dx1; 
  p_perp_source[4] += 0.3535533905932737*(bb_grad_u[3]*p_perp[7]+p_perp[3]*bb_grad_u[7]+bb_grad_u[5]*p_perp[6]+p_perp[5]*bb_grad_u[6]+bb_grad_u[0]*p_perp[4]+p_perp[0]*bb_grad_u[4]+bb_grad_u[1]*p_perp[2]+p_perp[1]*bb_grad_u[2])-0.3535533905932737*(grad_u_x[3]*p_perp[7]+p_perp[3]*grad_u_x[7]+grad_u_x[5]*p_perp[6]+p_perp[5]*grad_u_x[6]+grad_u_x[0]*p_perp[4]+p_perp[0]*grad_u_x[4]+grad_u_x[1]*p_perp[2]+p_perp[1]*grad_u_x[2])*dx1; 
  p_perp_source[5] += 0.3535533905932737*(bb_grad_u[2]*p_perp[7]+p_perp[2]*bb_grad_u[7]+bb_grad_u[4]*p_perp[6]+p_perp[4]*bb_grad_u[6]+bb_grad_u[0]*p_perp[5]+p_perp[0]*bb_grad_u[5]+bb_grad_u[1]*p_perp[3]+p_perp[1]*bb_grad_u[3])-0.3535533905932737*(grad_u_x[2]*p_perp[7]+p_perp[2]*grad_u_x[7]+grad_u_x[4]*p_perp[6]+p_perp[4]*grad_u_x[6]+grad_u_x[0]*p_perp[5]+p_perp[0]*grad_u_x[5]+grad_u_x[1]*p_perp[3]+p_perp[1]*grad_u_x[3])*dx1; 
  p_perp_source[6] += 0.3535533905932737*(bb_grad_u[1]*p_perp[7]+p_perp[1]*bb_grad_u[7]+bb_grad_u[0]*p_perp[6]+p_perp[0]*bb_grad_u[6]+bb_grad_u[4]*p_perp[5]+p_perp[4]*bb_grad_u[5]+bb_grad_u[2]*p_perp[3]+p_perp[2]*bb_grad_u[3])-0.3535533905932737*(grad_u_x[1]*p_perp[7]+p_perp[1]*grad_u_x[7]+grad_u_x[0]*p_perp[6]+p_perp[0]*grad_u_x[6]+grad_u_x[4]*p_perp[5]+p_perp[4]*grad_u_x[5]+grad_u_x[2]*p_perp[3]+p_perp[2]*grad_u_x[3])*dx1; 
  p_perp_source[7] += 0.3535533905932737*(bb_grad_u[0]*p_perp[7]+p_perp[0]*bb_grad_u[7]+bb_grad_u[1]*p_perp[6]+p_perp[1]*bb_grad_u[6]+bb_grad_u[2]*p_perp[5]+p_perp[2]*bb_grad_u[5]+bb_grad_u[3]*p_perp[4]+p_perp[3]*bb_grad_u[4])-0.3535533905932737*(grad_u_x[0]*p_perp[7]+p_perp[0]*grad_u_x[7]+grad_u_x[1]*p_perp[6]+p_perp[1]*grad_u_x[6]+grad_u_x[2]*p_perp[5]+p_perp[2]*grad_u_x[5]+grad_u_x[3]*p_perp[4]+p_perp[3]*grad_u_x[4])*dx1; 
