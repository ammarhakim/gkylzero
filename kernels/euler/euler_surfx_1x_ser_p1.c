...
{ 
  ...
  double prec_l = 0.408248290463863*pl[1]-0.408248290463863*pc[1]+0.3535533905932737*pl[0]+0.3535533905932737*pc[0]; 
  double prec_r = (-0.408248290463863*pr[1])+0.408248290463863*pc[1]+0.3535533905932737*pr[0]+0.3535533905932737*pc[0]; 
