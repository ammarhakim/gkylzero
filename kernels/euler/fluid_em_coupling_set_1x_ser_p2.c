...
GKYL_CU_DH void fluid_em_coupling_set_1x_ser_p2(int count, 
...
{ 
  ...
  double rho[num_species][3]; 
  double rhoux[num_species][3]; 
  double rhouy[num_species][3]; 
  double rhouz[num_species][3]; 

  double app_accel_x[num_species][3]; 
  double app_accel_y[num_species][3]; 
  double app_accel_z[num_species][3]; 
  ...
  for (int i = 0; i < num_species; ++i) { 
    ...
    rho[i][0] = inp_fluid[0]; 
    rhoux[i][0] = inp_fluid[3]; 
    rhouy[i][0] = inp_fluid[6]; 
    rhouz[i][0] = inp_fluid[9]; 
    ...
    rho[i][1] = inp_fluid[1]; 
    rhoux[i][1] = inp_fluid[4]; 
    rhouy[i][1] = inp_fluid[7]; 
    rhouz[i][1] = inp_fluid[10]; 
    ...
    rho[i][2] = inp_fluid[2]; 
    rhoux[i][2] = inp_fluid[5]; 
    rhouy[i][2] = inp_fluid[8]; 
    rhouz[i][2] = inp_fluid[11]; 
