...
{ 
  ...
  alphaDrSurf[0] = 0.16666666666666666*(6.7082039324993685*nI[1]*nuField[9]+6.708203932499369*nI[0]*nuField[8]+5.196152422706631*(nI[1]*nuField[4]+nI[0]*nuField[2])+3.0*(nI[1]*nuField[1]+nI[0]*nuField[0])); 
  alphaDrSurf[1] = 0.16666666666666666*(6.7082039324993685*nI[0]*nuField[9]+6.708203932499369*nI[1]*nuField[8]+5.196152422706631*(nI[0]*nuField[4]+nI[1]*nuField[2])+3.0*(nI[0]*nuField[1]+nuField[0]*nI[1])); 
  alphaDrSurf[2] = 0.16666666666666666*(6.708203932499369*nI[1]*nuField[11]+6.7082039324993685*nI[0]*nuField[10]+5.196152422706631*(nI[1]*nuField[7]+nI[0]*nuField[6])+3.0*(nI[1]*nuField[5]+nI[0]*nuField[3])); 
  alphaDrSurf[3] = 0.16666666666666666*(6.708203932499369*nI[0]*nuField[11]+6.7082039324993685*nI[1]*nuField[10]+5.196152422706631*(nI[0]*nuField[7]+nI[1]*nuField[6])+3.0*(nI[0]*nuField[5]+nI[1]*nuField[3])); 
  ...
  Ghat[2] = 0.08333333333333333*(9.48683298050514*(alphaDrSurf[1]*fEdge[11]+alphaDrSurf[0]*fEdge[10]+alphaDrSurf[3]*fEdge[9]+alphaDrSurf[2]*fEdge[8])-7.348469228349534*(alphaDrSurf[1]*fEdge[7]+alphaDrSurf[0]*fEdge[6])+4.242640687119286*alphaDrSurf[1]*fEdge[5]-7.348469228349534*alphaDrSurf[3]*fEdge[4]+4.242640687119286*(alphaDrSurf[0]*fEdge[3]+fEdge[1]*alphaDrSurf[3])+alphaDrSurf[2]*(4.242640687119286*fEdge[0]-7.348469228349534*fEdge[2])); 
  Ghat[3] = 0.08333333333333333*(9.48683298050514*(alphaDrSurf[0]*fEdge[11]+alphaDrSurf[1]*fEdge[10]+alphaDrSurf[2]*fEdge[9]+alphaDrSurf[3]*fEdge[8])-7.348469228349534*(alphaDrSurf[0]*fEdge[7]+alphaDrSurf[1]*fEdge[6])+4.242640687119286*alphaDrSurf[0]*fEdge[5]-7.348469228349534*alphaDrSurf[2]*fEdge[4]+4.242640687119286*alphaDrSurf[1]*fEdge[3]+(4.242640687119286*fEdge[0]-7.348469228349534*fEdge[2])*alphaDrSurf[3]+4.242640687119286*fEdge[1]*alphaDrSurf[2]); 
