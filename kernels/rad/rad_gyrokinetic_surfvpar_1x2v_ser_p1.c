...
{ 
  ...
  Ghat_l[2] = 0.7905694150420947*nvnu_l[1]*fc[11]+0.7905694150420948*(nvnu_l[0]*fc[10]+nvnu_l[3]*fc[9])+0.7905694150420947*nvnu_l[2]*fc[8]-0.6123724356957944*(nvnu_l[1]*fc[7]+nvnu_l[0]*fc[6])+0.3535533905932737*nvnu_l[1]*fc[5]-0.6123724356957944*nvnu_l[3]*fc[4]+0.3535533905932737*(fc[1]*nvnu_l[3]+nvnu_l[0]*fc[3])+(0.3535533905932737*fc[0]-0.6123724356957944*fc[2])*nvnu_l[2]; 
  Ghat_l[3] = 0.7905694150420947*nvnu_l[0]*fc[11]+0.7905694150420948*(nvnu_l[1]*fc[10]+nvnu_l[2]*fc[9])+0.7905694150420947*nvnu_l[3]*fc[8]-0.6123724356957944*(nvnu_l[0]*fc[7]+nvnu_l[1]*fc[6])+0.3535533905932737*nvnu_l[0]*fc[5]-0.6123724356957944*(nvnu_l[2]*fc[4]+fc[2]*nvnu_l[3])+0.3535533905932737*(fc[0]*nvnu_l[3]+nvnu_l[1]*fc[3]+fc[1]*nvnu_l[2]); 
  ...
  Ghat_l[3] = 0.7905694150420947*nvnu_l[0]*fl[11]+0.7905694150420948*(nvnu_l[1]*fl[10]+nvnu_l[2]*fl[9])+0.7905694150420947*nvnu_l[3]*fl[8]+0.6123724356957944*(nvnu_l[0]*fl[7]+nvnu_l[1]*fl[6])+0.3535533905932737*nvnu_l[0]*fl[5]+0.6123724356957944*(nvnu_l[2]*fl[4]+fl[2]*nvnu_l[3])+0.3535533905932737*(fl[0]*nvnu_l[3]+nvnu_l[1]*fl[3]+fl[1]*nvnu_l[2]); 

  Ghat_r[0] = 0.7905694150420947*nvnu_r[3]*fc[11]+0.7905694150420948*(nvnu_r[2]*fc[10]+nvnu_r[1]*fc[9])+0.7905694150420947*nvnu_r[0]*fc[8]+0.6123724356957944*(nvnu_r[3]*fc[7]+nvnu_r[2]*fc[6])+0.3535533905932737*nvnu_r[3]*fc[5]+0.6123724356957944*nvnu_r[1]*fc[4]+0.3535533905932737*nvnu_r[2]*fc[3]+0.6123724356957944*nvnu_r[0]*fc[2]+0.3535533905932737*(fc[1]*nvnu_r[1]+fc[0]*nvnu_r[0]); 
  Ghat_r[1] = 0.7905694150420947*nvnu_r[2]*fc[11]+0.7905694150420948*(nvnu_r[3]*fc[10]+nvnu_r[0]*fc[9])+0.7905694150420947*nvnu_r[1]*fc[8]+0.6123724356957944*(nvnu_r[2]*fc[7]+nvnu_r[3]*fc[6])+0.3535533905932737*nvnu_r[2]*fc[5]+0.6123724356957944*nvnu_r[0]*fc[4]+0.3535533905932737*fc[3]*nvnu_r[3]+0.6123724356957944*nvnu_r[1]*fc[2]+0.3535533905932737*(fc[0]*nvnu_r[1]+nvnu_r[0]*fc[1]); 
  Ghat_r[2] = 0.7905694150420947*nvnu_r[1]*fc[11]+0.7905694150420948*(nvnu_r[0]*fc[10]+nvnu_r[3]*fc[9])+0.7905694150420947*nvnu_r[2]*fc[8]+0.6123724356957944*(nvnu_r[1]*fc[7]+nvnu_r[0]*fc[6])+0.3535533905932737*nvnu_r[1]*fc[5]+0.6123724356957944*nvnu_r[3]*fc[4]+0.3535533905932737*(fc[1]*nvnu_r[3]+nvnu_r[0]*fc[3])+(0.6123724356957944*fc[2]+0.3535533905932737*fc[0])*nvnu_r[2]; 
  Ghat_r[3] = 0.7905694150420947*nvnu_r[0]*fc[11]+0.7905694150420948*(nvnu_r[1]*fc[10]+nvnu_r[2]*fc[9])+0.7905694150420947*nvnu_r[3]*fc[8]+0.6123724356957944*(nvnu_r[0]*fc[7]+nvnu_r[1]*fc[6])+0.3535533905932737*nvnu_r[0]*fc[5]+0.6123724356957944*(nvnu_r[2]*fc[4]+fc[2]*nvnu_r[3])+0.3535533905932737*(fc[0]*nvnu_r[3]+nvnu_r[1]*fc[3]+fc[1]*nvnu_r[2]); 
  ...
  double cflFreq = fmax(fabs(nvnu_l[0]), fabs(nvnu_r[0])); 
