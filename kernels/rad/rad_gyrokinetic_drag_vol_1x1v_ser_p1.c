...
{ 
  ...
  alphaDrag[2] = 0.7071067811865475*nI[1]*vnu[3]+0.7071067811865475*nI[0]*vnu[2]; 
  alphaDrag[3] = 0.7071067811865475*nI[0]*vnu[3]+0.7071067811865475*nI[1]*vnu[2]; 
  alphaDrag[4] = 0.7071067811865475*nI[1]*vnu[5]+0.7071067811865475*nI[0]*vnu[4]; 
  alphaDrag[5] = 0.7071067811865475*nI[0]*vnu[5]+0.7071067811865475*nI[1]*vnu[4]; 
  ...
  out[4] += 1.7320508075688772*(alphaDrag[3]*f[5]+f[3]*alphaDrag[5]+alphaDrag[2]*f[4]+f[2]*alphaDrag[4])+1.9364916731037085*(alphaDrag[1]*f[3]+f[1]*alphaDrag[3]+alphaDrag[0]*f[2]+f[0]*alphaDrag[2]); 
  out[5] += 1.7320508075688772*(alphaDrag[2]*f[5]+f[2]*alphaDrag[5]+alphaDrag[3]*f[4]+f[3]*alphaDrag[4])+1.9364916731037085*(alphaDrag[0]*f[3]+f[0]*alphaDrag[3]+alphaDrag[1]*f[2]+f[1]*alphaDrag[2]); 
