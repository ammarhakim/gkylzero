...
{ 
  ...
  alphaDrag[0] = 0.7071067811865475*rdv2[0]*nI[2]*vnu[4]+0.7071067811865475*rdv2[0]*nI[1]*vnu[1]+0.7071067811865475*nI[0]*rdv2[0]*vnu[0]; 
  alphaDrag[1] = 0.6324555320336759*rdv2[0]*nI[1]*vnu[4]+0.6324555320336759*rdv2[0]*vnu[1]*nI[2]+0.7071067811865475*nI[0]*rdv2[0]*vnu[1]+0.7071067811865475*rdv2[0]*vnu[0]*nI[1]; 
  alphaDrag[2] = 0.7071067811865475*rdv2[0]*nI[2]*vnu[6]+0.7071067811865475*rdv2[0]*nI[1]*vnu[3]+0.7071067811865475*nI[0]*rdv2[0]*vnu[2]; 
  alphaDrag[3] = 0.632455532033676*rdv2[0]*nI[1]*vnu[6]+0.6324555320336759*rdv2[0]*nI[2]*vnu[3]+0.7071067811865475*nI[0]*rdv2[0]*vnu[3]+0.7071067811865475*rdv2[0]*nI[1]*vnu[2]; 
  alphaDrag[4] = 0.4517539514526256*rdv2[0]*nI[2]*vnu[4]+0.7071067811865475*nI[0]*rdv2[0]*vnu[4]+0.7071067811865475*rdv2[0]*vnu[0]*nI[2]+0.6324555320336759*rdv2[0]*nI[1]*vnu[1]; 
  alphaDrag[5] = 0.7071067811865475*rdv2[0]*nI[1]*vnu[7]+0.7071067811865475*nI[0]*rdv2[0]*vnu[5]; 
  alphaDrag[6] = 0.4517539514526256*rdv2[0]*nI[2]*vnu[6]+0.7071067811865475*nI[0]*rdv2[0]*vnu[6]+0.632455532033676*rdv2[0]*nI[1]*vnu[3]+0.7071067811865475*rdv2[0]*nI[2]*vnu[2]; 
  alphaDrag[7] = 0.6324555320336759*rdv2[0]*nI[2]*vnu[7]+0.7071067811865475*nI[0]*rdv2[0]*vnu[7]+0.7071067811865475*rdv2[0]*nI[1]*vnu[5]; 
  ...
  /* printf("\n Volume: w[0]=%e, w[1]= %e, rdv= %e, f[0]=%e\n",w[0],w[1],rdv2[0],f[0]);
  for (int i=0;i<8;i++){
    printf("\tdrag[%i]=%e, f[i]=%e ,out[%i]=%e \n",i,alphaDrag[i],i,f[i],i,out[i]);
  }
  printf("\n");
  printf("     ");
  for (int i=0;i<8;i++){
