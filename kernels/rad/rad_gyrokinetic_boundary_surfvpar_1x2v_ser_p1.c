...
{ 
  ...
  Ghat_l[1] = 0.7905694150420947*nvnu_skin[2]*fskin[11]+0.7905694150420948*(nvnu_skin[3]*fskin[10]+nvnu_skin[0]*fskin[9])+0.7905694150420947*nvnu_skin[1]*fskin[8]-0.6123724356957944*(nvnu_skin[2]*fskin[7]+nvnu_skin[3]*fskin[6])+0.3535533905932737*nvnu_skin[2]*fskin[5]-0.6123724356957944*nvnu_skin[0]*fskin[4]+0.3535533905932737*fskin[3]*nvnu_skin[3]-0.6123724356957944*nvnu_skin[1]*fskin[2]+0.3535533905932737*(fskin[0]*nvnu_skin[1]+nvnu_skin[0]*fskin[1]); 
  ...
  Ghat_l[0] = 0.7905694150420947*nvnu_skin[3]*fedge[11]+0.7905694150420948*(nvnu_skin[2]*fedge[10]+nvnu_skin[1]*fedge[9])+0.7905694150420947*nvnu_skin[0]*fedge[8]+0.6123724356957944*(nvnu_skin[3]*fedge[7]+nvnu_skin[2]*fedge[6])+0.3535533905932737*nvnu_skin[3]*fedge[5]+0.6123724356957944*nvnu_skin[1]*fedge[4]+0.3535533905932737*nvnu_skin[2]*fedge[3]+0.6123724356957944*nvnu_skin[0]*fedge[2]+0.3535533905932737*(fedge[1]*nvnu_skin[1]+fedge[0]*nvnu_skin[0]); 
  Ghat_l[1] = 0.7905694150420947*nvnu_skin[2]*fedge[11]+0.7905694150420948*(nvnu_skin[3]*fedge[10]+nvnu_skin[0]*fedge[9])+0.7905694150420947*nvnu_skin[1]*fedge[8]+0.6123724356957944*(nvnu_skin[2]*fedge[7]+nvnu_skin[3]*fedge[6])+0.3535533905932737*nvnu_skin[2]*fedge[5]+0.6123724356957944*nvnu_skin[0]*fedge[4]+0.3535533905932737*fedge[3]*nvnu_skin[3]+0.6123724356957944*nvnu_skin[1]*fedge[2]+0.3535533905932737*(fedge[0]*nvnu_skin[1]+nvnu_skin[0]*fedge[1]); 
  Ghat_l[2] = 0.7905694150420947*nvnu_skin[1]*fedge[11]+0.7905694150420948*(nvnu_skin[0]*fedge[10]+nvnu_skin[3]*fedge[9])+0.7905694150420947*nvnu_skin[2]*fedge[8]+0.6123724356957944*(nvnu_skin[1]*fedge[7]+nvnu_skin[0]*fedge[6])+0.3535533905932737*nvnu_skin[1]*fedge[5]+0.6123724356957944*nvnu_skin[3]*fedge[4]+0.3535533905932737*(fedge[1]*nvnu_skin[3]+nvnu_skin[0]*fedge[3])+(0.6123724356957944*fedge[2]+0.3535533905932737*fedge[0])*nvnu_skin[2]; 
  Ghat_l[3] = 0.7905694150420947*nvnu_skin[0]*fedge[11]+0.7905694150420948*(nvnu_skin[1]*fedge[10]+nvnu_skin[2]*fedge[9])+0.7905694150420947*nvnu_skin[3]*fedge[8]+0.6123724356957944*(nvnu_skin[0]*fedge[7]+nvnu_skin[1]*fedge[6])+0.3535533905932737*nvnu_skin[0]*fedge[5]+0.6123724356957944*(nvnu_skin[2]*fedge[4]+fedge[2]*nvnu_skin[3])+0.3535533905932737*(fedge[0]*nvnu_skin[3]+nvnu_skin[1]*fedge[3]+fedge[1]*nvnu_skin[2]); 
