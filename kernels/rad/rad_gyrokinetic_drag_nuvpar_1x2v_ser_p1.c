...
{ 
  ...
  vmag_surf = sqrt((1.581138830084189*vpar_sq_p[2]-1.224744871391589*vpar_sq_p[1]+0.7071067811865475*vpar_sq_p[0])+2.0*((0.7071067811865475*bmag[0]-0.7071067811865475*bmag[1])*(0.7071067811865475*mu_p[0]-0.7071067811865475*mu_p[1]))/mass);
  ...
  vmag_surf = sqrt((1.581138830084189*vpar_sq_p[2]-1.224744871391589*vpar_sq_p[1]+0.7071067811865475*vpar_sq_p[0])+2.0*(0.7071067811865475*(0.7071067811865475*bmag[0]-0.7071067811865475*bmag[1])*(mu_p[1]+mu_p[0]))/mass);
  ...
  vmag_surf = sqrt((1.581138830084189*vpar_sq_p[2]-1.224744871391589*vpar_sq_p[1]+0.7071067811865475*vpar_sq_p[0])+2.0*(0.7071067811865475*(bmag[1]+bmag[0])*(0.7071067811865475*mu_p[0]-0.7071067811865475*mu_p[1]))/mass);
  ...
  vmag_surf = sqrt((1.581138830084189*vpar_sq_p[2]-1.224744871391589*vpar_sq_p[1]+0.7071067811865475*vpar_sq_p[0])+2.0*(0.4999999999999999*(bmag[1]+bmag[0])*(mu_p[1]+mu_p[0]))/mass);
  ...
  vnu_nodal[1] = (0.7071067811865475*vpar_p[0])*((a/c_const*(alpha+beta)*pow(vmag,gamma))/(beta*pow(vmag/scaled_v0,-alpha)+alpha*pow(vmag/scaled_v0,beta)));
  vmag = sqrt((0.6324555320336759*vpar_sq_p[2]+0.9486832980505137*vpar_sq_p[1]+0.7071067811865475*vpar_sq_p[0])+2.0*((0.7071067811865475*bmag[0]-0.7071067811865475*bmag[1])*(0.7071067811865475*mu_p[0]-0.7071067811865475*mu_p[1]))/mass);
  vnu_nodal[2] = (0.9486832980505137*vpar_p[1]+0.7071067811865475*vpar_p[0])*((a/c_const*(alpha+beta)*pow(vmag,gamma))/(beta*pow(vmag/scaled_v0,-alpha)+alpha*pow(vmag/scaled_v0,beta)));
  ...
  vnu_nodal[3] = (0.7071067811865475*vpar_p[0]-0.9486832980505137*vpar_p[1])*((a/c_const*(alpha+beta)*pow(vmag,gamma))/(beta*pow(vmag/scaled_v0,-alpha)+alpha*pow(vmag/scaled_v0,beta)));
  ...
  vmag = sqrt((0.6324555320336759*vpar_sq_p[2]+0.9486832980505137*vpar_sq_p[1]+0.7071067811865475*vpar_sq_p[0])+2.0*(0.7071067811865475*(0.7071067811865475*bmag[0]-0.7071067811865475*bmag[1])*(mu_p[1]+mu_p[0]))/mass);
  vnu_nodal[5] = (0.9486832980505137*vpar_p[1]+0.7071067811865475*vpar_p[0])*((a/c_const*(alpha+beta)*pow(vmag,gamma))/(beta*pow(vmag/scaled_v0,-alpha)+alpha*pow(vmag/scaled_v0,beta)));
  ...
  vnu_nodal[6] = (0.7071067811865475*vpar_p[0]-0.9486832980505137*vpar_p[1])*((a/c_const*(alpha+beta)*pow(vmag,gamma))/(beta*pow(vmag/scaled_v0,-alpha)+alpha*pow(vmag/scaled_v0,beta)));
  ...
  vnu_nodal[7] = (0.7071067811865475*vpar_p[0])*((a/c_const*(alpha+beta)*pow(vmag,gamma))/(beta*pow(vmag/scaled_v0,-alpha)+alpha*pow(vmag/scaled_v0,beta)));
  vmag = sqrt((0.6324555320336759*vpar_sq_p[2]+0.9486832980505137*vpar_sq_p[1]+0.7071067811865475*vpar_sq_p[0])+2.0*(0.7071067811865475*(bmag[1]+bmag[0])*(0.7071067811865475*mu_p[0]-0.7071067811865475*mu_p[1]))/mass);
  ...
  vnu_nodal[10] = (0.7071067811865475*vpar_p[0])*((a/c_const*(alpha+beta)*pow(vmag,gamma))/(beta*pow(vmag/scaled_v0,-alpha)+alpha*pow(vmag/scaled_v0,beta)));
  vmag = sqrt((0.6324555320336759*vpar_sq_p[2]+0.9486832980505137*vpar_sq_p[1]+0.7071067811865475*vpar_sq_p[0])+2.0*(0.4999999999999999*(bmag[1]+bmag[0])*(mu_p[1]+mu_p[0]))/mass);
  vnu_nodal[11] = (0.9486832980505137*vpar_p[1]+0.7071067811865475*vpar_p[0])*((a/c_const*(alpha+beta)*pow(vmag,gamma))/(beta*pow(vmag/scaled_v0,-alpha)+alpha*pow(vmag/scaled_v0,beta)));
  ...
  drag_rad_nu[8] = 0.1756820922315766*vnu_nodal[11]-0.3513641844631532*vnu_nodal[10]+0.1756820922315766*vnu_nodal[9]+0.1756820922315766*vnu_nodal[8]-0.3513641844631532*vnu_nodal[7]+0.1756820922315766*vnu_nodal[6]+0.1756820922315766*vnu_nodal[5]-0.3513641844631532*vnu_nodal[4]+0.1756820922315766*vnu_nodal[3]+0.1756820922315766*vnu_nodal[2]-0.3513641844631532*vnu_nodal[1]+0.1756820922315766*vnu_nodal[0]; 
