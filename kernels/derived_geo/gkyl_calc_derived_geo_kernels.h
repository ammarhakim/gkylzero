...
GKYL_CU_DH void adjust_bmag_3x_Ser_p1(const double *cmag, double *gzz, const double *J, const double *bmag, double *gij); 
...
GKYL_CU_DH void adjust_bmag_3x_Ser_p2(const double *cmag, double *gzz, const double *J, const double *bmag, double *gij); 
EXTERN_C_END 
