...
{ 
  ...
  outrhouy[0] += 0.4330127018922193*uvar1r[1]*dx1*ghat_rho_l+0.4330127018922193*uvar1l[1]*dx1*ghat_rho_l-0.8660254037844386*uvar1c[1]*dx1*ghat_rho_l-0.25*uvar1r[0]*dx1*ghat_rho_l+0.25*uvar1l[0]*dx1*ghat_rho_l; 
  outrhouy[1] += 0.75*uvar1r[1]*dx1*ghat_rho_l-0.75*uvar1l[1]*dx1*ghat_rho_l-0.4330127018922193*uvar1r[0]*dx1*ghat_rho_l-0.4330127018922193*uvar1l[0]*dx1*ghat_rho_l-0.8660254037844386*uvar1c[0]*dx1*ghat_rho_l; 

  outrhouz[0] += 0.4330127018922193*uvar2r[1]*dx1*ghat_rho_l+0.4330127018922193*uvar2l[1]*dx1*ghat_rho_l-0.8660254037844386*uvar2c[1]*dx1*ghat_rho_l-0.25*uvar2r[0]*dx1*ghat_rho_l+0.25*uvar2l[0]*dx1*ghat_rho_l; 
  outrhouz[1] += 0.75*uvar2r[1]*dx1*ghat_rho_l-0.75*uvar2l[1]*dx1*ghat_rho_l-0.4330127018922193*uvar2r[0]*dx1*ghat_rho_l-0.4330127018922193*uvar2l[0]*dx1*ghat_rho_l-0.8660254037844386*uvar2c[0]*dx1*ghat_rho_l; 
