...
{ 
  ...
  outrhoux[0] += (-0.5590169943749475*rhor[2]*dx1*vthsq)+0.5590169943749475*rhol[2]*dx1*vthsq+0.4330127018922193*rhor[1]*dx1*vthsq+0.4330127018922193*rhol[1]*dx1*vthsq-0.8660254037844386*rhoc[1]*dx1*vthsq-0.25*rhor[0]*dx1*vthsq+0.25*rhol[0]*dx1*vthsq+0.5590169943749475*rhou0r[2]*dx1*u_max_r-0.5590169943749475*rhou0c[2]*dx1*u_max_r-0.4330127018922193*rhou0r[1]*dx1*u_max_r-0.4330127018922193*rhou0c[1]*dx1*u_max_r+0.25*rhou0r[0]*dx1*u_max_r-0.25*rhou0c[0]*dx1*u_max_r+0.5590169943749475*rhou0l[2]*dx1*u_max_l-0.5590169943749475*rhou0c[2]*dx1*u_max_l+0.4330127018922193*rhou0l[1]*dx1*u_max_l+0.4330127018922193*rhou0c[1]*dx1*u_max_l+0.25*rhou0l[0]*dx1*u_max_l-0.25*rhou0c[0]*dx1*u_max_l-0.5590169943749475*uvar0r[2]*dx1*ghat_rho_r-0.5590169943749475*uvar0c[2]*dx1*ghat_rho_r+0.4330127018922193*uvar0r[1]*dx1*ghat_rho_r-0.4330127018922193*uvar0c[1]*dx1*ghat_rho_r-0.25*uvar0r[0]*dx1*ghat_rho_r-0.25*uvar0c[0]*dx1*ghat_rho_r+0.5590169943749475*uvar0l[2]*dx1*ghat_rho_l+0.5590169943749475*uvar0c[2]*dx1*ghat_rho_l+0.4330127018922193*uvar0l[1]*dx1*ghat_rho_l-0.4330127018922193*uvar0c[1]*dx1*ghat_rho_l+0.25*uvar0l[0]*dx1*ghat_rho_l+0.25*uvar0c[0]*dx1*ghat_rho_l; 
  outrhoux[1] += (-0.9682458365518543*rhor[2]*dx1*vthsq)-0.9682458365518543*rhol[2]*dx1*vthsq-1.936491673103709*rhoc[2]*dx1*vthsq+0.75*rhor[1]*dx1*vthsq-0.75*rhol[1]*dx1*vthsq-0.4330127018922193*rhor[0]*dx1*vthsq-0.4330127018922193*rhol[0]*dx1*vthsq-0.8660254037844386*rhoc[0]*dx1*vthsq+0.9682458365518543*rhou0r[2]*dx1*u_max_r-0.9682458365518543*rhou0c[2]*dx1*u_max_r-0.75*rhou0r[1]*dx1*u_max_r-0.75*rhou0c[1]*dx1*u_max_r+0.4330127018922193*rhou0r[0]*dx1*u_max_r-0.4330127018922193*rhou0c[0]*dx1*u_max_r-0.9682458365518543*rhou0l[2]*dx1*u_max_l+0.9682458365518543*rhou0c[2]*dx1*u_max_l-0.75*rhou0l[1]*dx1*u_max_l-0.75*rhou0c[1]*dx1*u_max_l-0.4330127018922193*rhou0l[0]*dx1*u_max_l+0.4330127018922193*rhou0c[0]*dx1*u_max_l-0.9682458365518543*uvar0r[2]*dx1*ghat_rho_r-0.9682458365518543*uvar0c[2]*dx1*ghat_rho_r+0.75*uvar0r[1]*dx1*ghat_rho_r-0.75*uvar0c[1]*dx1*ghat_rho_r-0.4330127018922193*uvar0r[0]*dx1*ghat_rho_r-0.4330127018922193*uvar0c[0]*dx1*ghat_rho_r-0.9682458365518543*uvar0l[2]*dx1*ghat_rho_l-0.9682458365518543*uvar0c[2]*dx1*ghat_rho_l-0.75*uvar0l[1]*dx1*ghat_rho_l+0.75*uvar0c[1]*dx1*ghat_rho_l-0.4330127018922193*uvar0l[0]*dx1*ghat_rho_l-0.4330127018922193*uvar0c[0]*dx1*ghat_rho_l; 
  outrhoux[2] += (-1.25*rhor[2]*dx1*vthsq)+1.25*rhol[2]*dx1*vthsq+0.9682458365518543*rhor[1]*dx1*vthsq+0.9682458365518543*rhol[1]*dx1*vthsq-1.936491673103709*rhoc[1]*dx1*vthsq-0.5590169943749475*rhor[0]*dx1*vthsq+0.5590169943749475*rhol[0]*dx1*vthsq+1.25*rhou0r[2]*dx1*u_max_r-1.25*rhou0c[2]*dx1*u_max_r-0.9682458365518543*rhou0r[1]*dx1*u_max_r-0.9682458365518543*rhou0c[1]*dx1*u_max_r+0.5590169943749475*rhou0r[0]*dx1*u_max_r-0.5590169943749475*rhou0c[0]*dx1*u_max_r+1.25*rhou0l[2]*dx1*u_max_l-1.25*rhou0c[2]*dx1*u_max_l+0.9682458365518543*rhou0l[1]*dx1*u_max_l+0.9682458365518543*rhou0c[1]*dx1*u_max_l+0.5590169943749475*rhou0l[0]*dx1*u_max_l-0.5590169943749475*rhou0c[0]*dx1*u_max_l-1.25*uvar0r[2]*dx1*ghat_rho_r-1.25*uvar0c[2]*dx1*ghat_rho_r+0.9682458365518543*uvar0r[1]*dx1*ghat_rho_r-0.9682458365518543*uvar0c[1]*dx1*ghat_rho_r-0.5590169943749475*uvar0r[0]*dx1*ghat_rho_r-0.5590169943749475*uvar0c[0]*dx1*ghat_rho_r+1.25*uvar0l[2]*dx1*ghat_rho_l+1.25*uvar0c[2]*dx1*ghat_rho_l+0.9682458365518543*uvar0l[1]*dx1*ghat_rho_l-0.9682458365518543*uvar0c[1]*dx1*ghat_rho_l+0.5590169943749475*uvar0l[0]*dx1*ghat_rho_l+0.5590169943749475*uvar0c[0]*dx1*ghat_rho_l; 

  outrhouy[0] += 0.5590169943749475*rhou1r[2]*dx1*u_max_r-0.5590169943749475*rhou1c[2]*dx1*u_max_r-0.4330127018922193*rhou1r[1]*dx1*u_max_r-0.4330127018922193*rhou1c[1]*dx1*u_max_r+0.25*rhou1r[0]*dx1*u_max_r-0.25*rhou1c[0]*dx1*u_max_r+0.5590169943749475*rhou1l[2]*dx1*u_max_l-0.5590169943749475*rhou1c[2]*dx1*u_max_l+0.4330127018922193*rhou1l[1]*dx1*u_max_l+0.4330127018922193*rhou1c[1]*dx1*u_max_l+0.25*rhou1l[0]*dx1*u_max_l-0.25*rhou1c[0]*dx1*u_max_l-0.5590169943749475*uvar1r[2]*dx1*ghat_rho_r-0.5590169943749475*uvar1c[2]*dx1*ghat_rho_r+0.4330127018922193*uvar1r[1]*dx1*ghat_rho_r-0.4330127018922193*uvar1c[1]*dx1*ghat_rho_r-0.25*uvar1r[0]*dx1*ghat_rho_r-0.25*uvar1c[0]*dx1*ghat_rho_r+0.5590169943749475*uvar1l[2]*dx1*ghat_rho_l+0.5590169943749475*uvar1c[2]*dx1*ghat_rho_l+0.4330127018922193*uvar1l[1]*dx1*ghat_rho_l-0.4330127018922193*uvar1c[1]*dx1*ghat_rho_l+0.25*uvar1l[0]*dx1*ghat_rho_l+0.25*uvar1c[0]*dx1*ghat_rho_l; 
  outrhouy[1] += 0.9682458365518543*rhou1r[2]*dx1*u_max_r-0.9682458365518543*rhou1c[2]*dx1*u_max_r-0.75*rhou1r[1]*dx1*u_max_r-0.75*rhou1c[1]*dx1*u_max_r+0.4330127018922193*rhou1r[0]*dx1*u_max_r-0.4330127018922193*rhou1c[0]*dx1*u_max_r-0.9682458365518543*rhou1l[2]*dx1*u_max_l+0.9682458365518543*rhou1c[2]*dx1*u_max_l-0.75*rhou1l[1]*dx1*u_max_l-0.75*rhou1c[1]*dx1*u_max_l-0.4330127018922193*rhou1l[0]*dx1*u_max_l+0.4330127018922193*rhou1c[0]*dx1*u_max_l-0.9682458365518543*uvar1r[2]*dx1*ghat_rho_r-0.9682458365518543*uvar1c[2]*dx1*ghat_rho_r+0.75*uvar1r[1]*dx1*ghat_rho_r-0.75*uvar1c[1]*dx1*ghat_rho_r-0.4330127018922193*uvar1r[0]*dx1*ghat_rho_r-0.4330127018922193*uvar1c[0]*dx1*ghat_rho_r-0.9682458365518543*uvar1l[2]*dx1*ghat_rho_l-0.9682458365518543*uvar1c[2]*dx1*ghat_rho_l-0.75*uvar1l[1]*dx1*ghat_rho_l+0.75*uvar1c[1]*dx1*ghat_rho_l-0.4330127018922193*uvar1l[0]*dx1*ghat_rho_l-0.4330127018922193*uvar1c[0]*dx1*ghat_rho_l; 
  outrhouy[2] += 1.25*rhou1r[2]*dx1*u_max_r-1.25*rhou1c[2]*dx1*u_max_r-0.9682458365518543*rhou1r[1]*dx1*u_max_r-0.9682458365518543*rhou1c[1]*dx1*u_max_r+0.5590169943749475*rhou1r[0]*dx1*u_max_r-0.5590169943749475*rhou1c[0]*dx1*u_max_r+1.25*rhou1l[2]*dx1*u_max_l-1.25*rhou1c[2]*dx1*u_max_l+0.9682458365518543*rhou1l[1]*dx1*u_max_l+0.9682458365518543*rhou1c[1]*dx1*u_max_l+0.5590169943749475*rhou1l[0]*dx1*u_max_l-0.5590169943749475*rhou1c[0]*dx1*u_max_l-1.25*uvar1r[2]*dx1*ghat_rho_r-1.25*uvar1c[2]*dx1*ghat_rho_r+0.9682458365518543*uvar1r[1]*dx1*ghat_rho_r-0.9682458365518543*uvar1c[1]*dx1*ghat_rho_r-0.5590169943749475*uvar1r[0]*dx1*ghat_rho_r-0.5590169943749475*uvar1c[0]*dx1*ghat_rho_r+1.25*uvar1l[2]*dx1*ghat_rho_l+1.25*uvar1c[2]*dx1*ghat_rho_l+0.9682458365518543*uvar1l[1]*dx1*ghat_rho_l-0.9682458365518543*uvar1c[1]*dx1*ghat_rho_l+0.5590169943749475*uvar1l[0]*dx1*ghat_rho_l+0.5590169943749475*uvar1c[0]*dx1*ghat_rho_l; 

  outrhouz[0] += 0.5590169943749475*rhou2r[2]*dx1*u_max_r-0.5590169943749475*rhou2c[2]*dx1*u_max_r-0.4330127018922193*rhou2r[1]*dx1*u_max_r-0.4330127018922193*rhou2c[1]*dx1*u_max_r+0.25*rhou2r[0]*dx1*u_max_r-0.25*rhou2c[0]*dx1*u_max_r+0.5590169943749475*rhou2l[2]*dx1*u_max_l-0.5590169943749475*rhou2c[2]*dx1*u_max_l+0.4330127018922193*rhou2l[1]*dx1*u_max_l+0.4330127018922193*rhou2c[1]*dx1*u_max_l+0.25*rhou2l[0]*dx1*u_max_l-0.25*rhou2c[0]*dx1*u_max_l-0.5590169943749475*uvar2r[2]*dx1*ghat_rho_r-0.5590169943749475*uvar2c[2]*dx1*ghat_rho_r+0.4330127018922193*uvar2r[1]*dx1*ghat_rho_r-0.4330127018922193*uvar2c[1]*dx1*ghat_rho_r-0.25*uvar2r[0]*dx1*ghat_rho_r-0.25*uvar2c[0]*dx1*ghat_rho_r+0.5590169943749475*uvar2l[2]*dx1*ghat_rho_l+0.5590169943749475*uvar2c[2]*dx1*ghat_rho_l+0.4330127018922193*uvar2l[1]*dx1*ghat_rho_l-0.4330127018922193*uvar2c[1]*dx1*ghat_rho_l+0.25*uvar2l[0]*dx1*ghat_rho_l+0.25*uvar2c[0]*dx1*ghat_rho_l; 
  outrhouz[1] += 0.9682458365518543*rhou2r[2]*dx1*u_max_r-0.9682458365518543*rhou2c[2]*dx1*u_max_r-0.75*rhou2r[1]*dx1*u_max_r-0.75*rhou2c[1]*dx1*u_max_r+0.4330127018922193*rhou2r[0]*dx1*u_max_r-0.4330127018922193*rhou2c[0]*dx1*u_max_r-0.9682458365518543*rhou2l[2]*dx1*u_max_l+0.9682458365518543*rhou2c[2]*dx1*u_max_l-0.75*rhou2l[1]*dx1*u_max_l-0.75*rhou2c[1]*dx1*u_max_l-0.4330127018922193*rhou2l[0]*dx1*u_max_l+0.4330127018922193*rhou2c[0]*dx1*u_max_l-0.9682458365518543*uvar2r[2]*dx1*ghat_rho_r-0.9682458365518543*uvar2c[2]*dx1*ghat_rho_r+0.75*uvar2r[1]*dx1*ghat_rho_r-0.75*uvar2c[1]*dx1*ghat_rho_r-0.4330127018922193*uvar2r[0]*dx1*ghat_rho_r-0.4330127018922193*uvar2c[0]*dx1*ghat_rho_r-0.9682458365518543*uvar2l[2]*dx1*ghat_rho_l-0.9682458365518543*uvar2c[2]*dx1*ghat_rho_l-0.75*uvar2l[1]*dx1*ghat_rho_l+0.75*uvar2c[1]*dx1*ghat_rho_l-0.4330127018922193*uvar2l[0]*dx1*ghat_rho_l-0.4330127018922193*uvar2c[0]*dx1*ghat_rho_l; 
  outrhouz[2] += 1.25*rhou2r[2]*dx1*u_max_r-1.25*rhou2c[2]*dx1*u_max_r-0.9682458365518543*rhou2r[1]*dx1*u_max_r-0.9682458365518543*rhou2c[1]*dx1*u_max_r+0.5590169943749475*rhou2r[0]*dx1*u_max_r-0.5590169943749475*rhou2c[0]*dx1*u_max_r+1.25*rhou2l[2]*dx1*u_max_l-1.25*rhou2c[2]*dx1*u_max_l+0.9682458365518543*rhou2l[1]*dx1*u_max_l+0.9682458365518543*rhou2c[1]*dx1*u_max_l+0.5590169943749475*rhou2l[0]*dx1*u_max_l-0.5590169943749475*rhou2c[0]*dx1*u_max_l-1.25*uvar2r[2]*dx1*ghat_rho_r-1.25*uvar2c[2]*dx1*ghat_rho_r+0.9682458365518543*uvar2r[1]*dx1*ghat_rho_r-0.9682458365518543*uvar2c[1]*dx1*ghat_rho_r-0.5590169943749475*uvar2r[0]*dx1*ghat_rho_r-0.5590169943749475*uvar2c[0]*dx1*ghat_rho_r+1.25*uvar2l[2]*dx1*ghat_rho_l+1.25*uvar2c[2]*dx1*ghat_rho_l+0.9682458365518543*uvar2l[1]*dx1*ghat_rho_l-0.9682458365518543*uvar2c[1]*dx1*ghat_rho_l+0.5590169943749475*uvar2l[0]*dx1*ghat_rho_l+0.5590169943749475*uvar2c[0]*dx1*ghat_rho_l; 
