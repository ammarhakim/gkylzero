...
{ 
  ...
  if (notCellAvg && (-0.5*(3.0*moms_self[3]-1.732050807568877*moms_self[2]+1.732050807568877*moms_self[1]-1.0*moms_self[0]) < 0)) notCellAvg = false; 
  if (notCellAvg && (0.5*(3.0*moms_self[3]+1.732050807568877*(moms_self[2]+moms_self[1])+moms_self[0]) < 0)) notCellAvg = false; 
  if (notCellAvg && (0.5*(3.0*moms_self[15]-1.732050807568877*(moms_self[14]+moms_self[13])+moms_self[12]) < 0)) notCellAvg = false; 
  if (notCellAvg && (-0.5*(3.0*moms_self[15]+1.732050807568877*moms_self[14]-1.732050807568877*moms_self[13]-1.0*moms_self[12]) < 0)) notCellAvg = false; 
  if (notCellAvg && (-0.5*(3.0*moms_self[15]-1.732050807568877*moms_self[14]+1.732050807568877*moms_self[13]-1.0*moms_self[12]) < 0)) notCellAvg = false; 
  if (notCellAvg && (0.5*(3.0*moms_self[15]+1.732050807568877*(moms_self[14]+moms_self[13])+moms_self[12]) < 0)) notCellAvg = false; 
  ...
  if (notCellAvg && (-0.5*(3.0*moms_other[3]-1.732050807568877*moms_other[2]+1.732050807568877*moms_other[1]-1.0*moms_other[0]) < 0)) notCellAvg = false; 
  if (notCellAvg && (0.5*(3.0*moms_other[3]+1.732050807568877*(moms_other[2]+moms_other[1])+moms_other[0]) < 0)) notCellAvg = false; 
  if (notCellAvg && (0.5*(3.0*moms_other[15]-1.732050807568877*(moms_other[14]+moms_other[13])+moms_other[12]) < 0)) notCellAvg = false; 
  if (notCellAvg && (-0.5*(3.0*moms_other[15]+1.732050807568877*moms_other[14]-1.732050807568877*moms_other[13]-1.0*moms_other[12]) < 0)) notCellAvg = false; 
  if (notCellAvg && (-0.5*(3.0*moms_other[15]-1.732050807568877*moms_other[14]+1.732050807568877*moms_other[13]-1.0*moms_other[12]) < 0)) notCellAvg = false; 
  if (notCellAvg && (0.5*(3.0*moms_other[15]+1.732050807568877*(moms_other[14]+moms_other[13])+moms_other[12]) < 0)) notCellAvg = false; 
