...
GKYL_CU_DH void vlasov_self_prim_moments_1x2v_ser_p1(struct gkyl_mat *A, struct gkyl_mat *rhs, const double *moms, const double *boundary_corrections) 
{ 
  ...
  gkyl_mat_set(A,4,4,1.414213562373095*m0r[0]-0.7071067811865475*cEr[0]); 
  gkyl_mat_set(A,4,5,1.414213562373095*m0r[1]-0.7071067811865475*cEr[1]); 
  gkyl_mat_set(A,5,4,1.414213562373095*m0r[1]-0.7071067811865475*cEr[1]); 
  gkyl_mat_set(A,5,5,1.414213562373095*m0r[0]-0.7071067811865475*cEr[0]); 
