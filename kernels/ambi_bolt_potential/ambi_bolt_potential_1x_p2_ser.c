...
{ 
  ...
  out[9] = 1.414213562373095*phiS_qp[0]; 
...
{ 
  ...
  double phi_qp[3];
  phi_qp[0] = (-(1.0*log((1.788854381999831*m0Ion[2])/(1.788854381999831*sheathvals[2]-2.683281572999747*sheathvals[1]+2.0*sheathvals[0])-(1.341640786499874*m0Ion[1])/(0.8944271909999155*sheathvals[2]-1.341640786499874*sheathvals[1]+sheathvals[0])+m0Ion[0]/(0.8944271909999155*sheathvals[2]-1.341640786499874*sheathvals[1]+sheathvals[0]))*T_e)/q_e)+0.6324555320336754*sheathvals[5]-0.9486832980505134*sheathvals[4]+0.7071067811865475*sheathvals[3]; 
  ...
  phi_qp[2] = (-(1.0*log((1.788854381999831*m0Ion[2])/(1.788854381999831*sheathvals[2]+2.683281572999747*sheathvals[1]+2.0*sheathvals[0])+(1.341640786499874*m0Ion[1])/(0.8944271909999155*sheathvals[2]+1.341640786499874*sheathvals[1]+sheathvals[0])+m0Ion[0]/(0.8944271909999155*sheathvals[2]+1.341640786499874*sheathvals[1]+sheathvals[0]))*T_e)/q_e)+0.6324555320336754*sheathvals[5]+0.9486832980505134*sheathvals[4]+0.7071067811865475*sheathvals[3]; 

  phi[0] = 0.392837100659193*phi_qp[2]+0.6285393610547089*phi_qp[1]+0.392837100659193*phi_qp[0]; 
  phi[1] = 0.5270462766947298*phi_qp[2]-0.5270462766947298*phi_qp[0]; 
  phi[2] = 0.351364184463153*phi_qp[2]-0.7027283689263064*phi_qp[1]+0.351364184463153*phi_qp[0]; 
}
