...
GKYL_CU_DH double dg_diffusion_order2_vlasov_boundary_surfx_1x2v_ser_p1_constcoeff(const double *w, const double *dx, const double *coeff, int edge, const double *fSkin, const double *fEdge, double* GKYL_RESTRICT out) 
{
  ...
  edgeSurf_incr[13] = (-1.4375*coeff[0]*fSkin[13])-0.4375*coeff[0]*fEdge[13]-1.407291281149713*coeff[0]*fSkin[12]+0.5412658773652742*coeff[0]*fEdge[12]; 
  ...
  edgeSurf_incr[15] = (-1.4375*coeff[0]*fSkin[15])-0.4375*coeff[0]*fEdge[15]-1.407291281149713*coeff[0]*fSkin[14]+0.5412658773652742*coeff[0]*fEdge[14]; 
...
GKYL_CU_DH double dg_diffusion_order2_vlasov_boundary_surfx_1x2v_ser_p1_varcoeff(const double *w, const double *dx, const double *coeff, int edge, const double *fSkin, const double *fEdge, double* GKYL_RESTRICT out) 
{
  // w[NDIM]: Cell-center coordinate.
  // dxv[NDIM]: Cell length.
  // coeff: Diffusion coefficient.
  ...
  vol_incr[13] = 2.121320343559642*coeff[1]*fSkin[12]; 
  ...
  edgeSurf_incr[12] = (-0.3827327723098714*coeff[0]*fSkin[13])-0.3827327723098714*coeff[0]*fEdge[13]-0.3977475644174328*coeff[0]*fSkin[12]+0.3977475644174328*coeff[0]*fEdge[12]; 
  edgeSurf_incr[13] = (-0.6123724356957944*coeff[1]*fSkin[13])-1.016465997955662*coeff[0]*fSkin[13]+0.6123724356957944*coeff[1]*fEdge[13]-0.3093592167691142*coeff[0]*fEdge[13]-0.5303300858899104*coeff[1]*fSkin[12]-0.9951052080056656*coeff[0]*fSkin[12]-0.5303300858899104*coeff[1]*fEdge[12]+0.3827327723098713*coeff[0]*fEdge[12]; 
  edgeSurf_incr[14] = (-0.3827327723098714*coeff[0]*fSkin[15])-0.3827327723098714*coeff[0]*fEdge[15]-0.3977475644174328*coeff[0]*fSkin[14]+0.3977475644174328*coeff[0]*fEdge[14]; 
  edgeSurf_incr[15] = (-0.6123724356957944*coeff[1]*fSkin[15])-1.016465997955662*coeff[0]*fSkin[15]+0.6123724356957944*coeff[1]*fEdge[15]-0.3093592167691142*coeff[0]*fEdge[15]-0.5303300858899104*coeff[1]*fSkin[14]-0.9951052080056656*coeff[0]*fSkin[14]-0.5303300858899104*coeff[1]*fEdge[14]+0.3827327723098713*coeff[0]*fEdge[14]; 
