...
GKYL_CU_DH double dg_diffusion4_euler_surfy_2x_ser_p1(const double* w, const double* dx, double D, 
...
{ 
  ...
  out1[1] += J*D*(1.623797632095822*q1r[3]-1.623797632095822*q1l[3]-0.9375*q1r[1]-0.9375*q1l[1]+1.875*q1c[1]); 
  out1[2] += J*D*(2.0625*q1r[2]+2.0625*q1l[2]+7.125*q1c[2]-1.623797632095822*q1r[0]+1.623797632095822*q1l[0]); 
  out1[3] += J*D*(2.0625*q1r[3]+2.0625*q1l[3]+7.125*q1c[3]-1.623797632095822*q1r[1]+1.623797632095822*q1l[1]); 
  ...
  out2[1] += J*D*(1.623797632095822*q2r[3]-1.623797632095822*q2l[3]-0.9375*q2r[1]-0.9375*q2l[1]+1.875*q2c[1]); 
  out2[2] += J*D*(2.0625*q2r[2]+2.0625*q2l[2]+7.125*q2c[2]-1.623797632095822*q2r[0]+1.623797632095822*q2l[0]); 
  out2[3] += J*D*(2.0625*q2r[3]+2.0625*q2l[3]+7.125*q2c[3]-1.623797632095822*q2r[1]+1.623797632095822*q2l[1]); 
  ...
  out3[1] += J*D*(1.623797632095822*q3r[3]-1.623797632095822*q3l[3]-0.9375*q3r[1]-0.9375*q3l[1]+1.875*q3c[1]); 
  out3[2] += J*D*(2.0625*q3r[2]+2.0625*q3l[2]+7.125*q3c[2]-1.623797632095822*q3r[0]+1.623797632095822*q3l[0]); 
  out3[3] += J*D*(2.0625*q3r[3]+2.0625*q3l[3]+7.125*q3c[3]-1.623797632095822*q3r[1]+1.623797632095822*q3l[1]); 
  ...
  out4[0] += J*D*(1.623797632095822*q4r[2]-1.623797632095822*q4l[2]-0.9375*q4r[0]-0.9375*q4l[0]+1.875*q4c[0]); 
  out4[1] += J*D*(1.623797632095822*q4r[3]-1.623797632095822*q4l[3]-0.9375*q4r[1]-0.9375*q4l[1]+1.875*q4c[1]); 
  out4[2] += J*D*(2.0625*q4r[2]+2.0625*q4l[2]+7.125*q4c[2]-1.623797632095822*q4r[0]+1.623797632095822*q4l[0]); 
  out4[3] += J*D*(2.0625*q4r[3]+2.0625*q4l[3]+7.125*q4c[3]-1.623797632095822*q4r[1]+1.623797632095822*q4l[1]); 
