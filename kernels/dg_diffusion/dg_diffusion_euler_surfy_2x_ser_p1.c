...
GKYL_CU_DH double dg_diffusion_euler_surfy_2x_ser_p1(const double* w, const double* dx, double D, 
...
{ 
  ...
  out4[0] += J*D*((-0.5412658773652741*q4r[2])+0.5412658773652741*q4l[2]+0.5625*q4r[0]+0.5625*q4l[0]-1.125*q4c[0]); 
  out4[1] += J*D*((-0.5412658773652741*q4r[3])+0.5412658773652741*q4l[3]+0.5625*q4r[1]+0.5625*q4l[1]-1.125*q4c[1]); 
  out4[2] += J*D*((-0.4375*q4r[2])-0.4375*q4l[2]-2.875*q4c[2]+0.5412658773652741*q4r[0]-0.5412658773652741*q4l[0]); 
  out4[3] += J*D*((-0.4375*q4r[3])-0.4375*q4l[3]-2.875*q4c[3]+0.5412658773652741*q4r[1]-0.5412658773652741*q4l[1]); 
