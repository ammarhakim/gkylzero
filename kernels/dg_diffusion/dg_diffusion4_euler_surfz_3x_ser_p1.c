...
{ 
  ...
  out1[2] += J*D*(1.623797632095822*q1r[6]-1.623797632095822*q1l[6]-0.9375*q1r[2]-0.9375*q1l[2]+1.875*q1c[2]); 
  out1[3] += J*D*(2.0625*q1r[3]+2.0625*q1l[3]+7.125*q1c[3]-1.623797632095822*q1r[0]+1.623797632095822*q1l[0]); 
  out1[4] += J*D*(1.623797632095822*q1r[7]-1.623797632095822*q1l[7]-0.9375*q1r[4]-0.9375*q1l[4]+1.875*q1c[4]); 
  out1[5] += J*D*(2.0625*q1r[5]+2.0625*q1l[5]+7.125*q1c[5]-1.623797632095822*q1r[1]+1.623797632095822*q1l[1]); 
  out1[6] += J*D*(2.0625*q1r[6]+2.0625*q1l[6]+7.125*q1c[6]-1.623797632095822*q1r[2]+1.623797632095822*q1l[2]); 
  out1[7] += J*D*(2.0625*q1r[7]+2.0625*q1l[7]+7.125*q1c[7]-1.623797632095822*q1r[4]+1.623797632095822*q1l[4]); 
  ...
  out2[2] += J*D*(1.623797632095822*q2r[6]-1.623797632095822*q2l[6]-0.9375*q2r[2]-0.9375*q2l[2]+1.875*q2c[2]); 
  out2[3] += J*D*(2.0625*q2r[3]+2.0625*q2l[3]+7.125*q2c[3]-1.623797632095822*q2r[0]+1.623797632095822*q2l[0]); 
  out2[4] += J*D*(1.623797632095822*q2r[7]-1.623797632095822*q2l[7]-0.9375*q2r[4]-0.9375*q2l[4]+1.875*q2c[4]); 
  out2[5] += J*D*(2.0625*q2r[5]+2.0625*q2l[5]+7.125*q2c[5]-1.623797632095822*q2r[1]+1.623797632095822*q2l[1]); 
  out2[6] += J*D*(2.0625*q2r[6]+2.0625*q2l[6]+7.125*q2c[6]-1.623797632095822*q2r[2]+1.623797632095822*q2l[2]); 
  out2[7] += J*D*(2.0625*q2r[7]+2.0625*q2l[7]+7.125*q2c[7]-1.623797632095822*q2r[4]+1.623797632095822*q2l[4]); 
  ...
  out3[2] += J*D*(1.623797632095822*q3r[6]-1.623797632095822*q3l[6]-0.9375*q3r[2]-0.9375*q3l[2]+1.875*q3c[2]); 
  out3[3] += J*D*(2.0625*q3r[3]+2.0625*q3l[3]+7.125*q3c[3]-1.623797632095822*q3r[0]+1.623797632095822*q3l[0]); 
  out3[4] += J*D*(1.623797632095822*q3r[7]-1.623797632095822*q3l[7]-0.9375*q3r[4]-0.9375*q3l[4]+1.875*q3c[4]); 
  out3[5] += J*D*(2.0625*q3r[5]+2.0625*q3l[5]+7.125*q3c[5]-1.623797632095822*q3r[1]+1.623797632095822*q3l[1]); 
  out3[6] += J*D*(2.0625*q3r[6]+2.0625*q3l[6]+7.125*q3c[6]-1.623797632095822*q3r[2]+1.623797632095822*q3l[2]); 
  out3[7] += J*D*(2.0625*q3r[7]+2.0625*q3l[7]+7.125*q3c[7]-1.623797632095822*q3r[4]+1.623797632095822*q3l[4]); 
  ...
  out4[2] += J*D*(1.623797632095822*q4r[6]-1.623797632095822*q4l[6]-0.9375*q4r[2]-0.9375*q4l[2]+1.875*q4c[2]); 
  out4[3] += J*D*(2.0625*q4r[3]+2.0625*q4l[3]+7.125*q4c[3]-1.623797632095822*q4r[0]+1.623797632095822*q4l[0]); 
  out4[4] += J*D*(1.623797632095822*q4r[7]-1.623797632095822*q4l[7]-0.9375*q4r[4]-0.9375*q4l[4]+1.875*q4c[4]); 
