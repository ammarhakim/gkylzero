...
GKYL_CU_DH double dg_diffusion_order2_gyrokinetic_boundary_surfx_1x1v_ser_p1_constcoeff(const double *w, const double *dx, const double *coeff, int edge, const double *fSkin, const double *fEdge, double* GKYL_RESTRICT out) 
{
  ...
  edgeSurf_incr[3] = (-1.4375*coeff[0]*fSkin[3])-0.4375*coeff[0]*fEdge[3]-1.407291281149712*coeff[0]*fSkin[2]+0.5412658773652739*coeff[0]*fEdge[2]; 
  ...
  edgeSurf_incr[5] = (-1.4375*coeff[0]*fSkin[5])-0.4375*coeff[0]*fEdge[5]-1.407291281149713*coeff[0]*fSkin[4]+0.5412658773652742*coeff[0]*fEdge[4]; 
...
GKYL_CU_DH double dg_diffusion_order2_gyrokinetic_boundary_surfx_1x1v_ser_p1_varcoeff(const double *w, const double *dx, const double *coeff, int edge, const double *fSkin, const double *fEdge, double* GKYL_RESTRICT out) 
{
  // w[NDIM]: Cell-center coordinate.
  // dxv[NDIM]: Cell length.
  // coeff: Diffusion coefficient.
  ...
  vol_incr[3] = 2.121320343559642*coeff[1]*fSkin[2]; 
  vol_incr[5] = 2.121320343559642*coeff[1]*fSkin[4]; 
  ...
  edgeSurf_incr[2] = (-0.3827327723098713*coeff[0]*fSkin[3])-0.3827327723098713*coeff[0]*fEdge[3]-0.3977475644174328*coeff[0]*fSkin[2]+0.3977475644174328*coeff[0]*fEdge[2]; 
  edgeSurf_incr[3] = (-0.6123724356957944*coeff[1]*fSkin[3])-1.016465997955662*coeff[0]*fSkin[3]+0.6123724356957944*coeff[1]*fEdge[3]-0.3093592167691142*coeff[0]*fEdge[3]-0.5303300858899105*coeff[1]*fSkin[2]-0.9951052080056654*coeff[0]*fSkin[2]-0.5303300858899105*coeff[1]*fEdge[2]+0.3827327723098711*coeff[0]*fEdge[2]; 
  edgeSurf_incr[4] = (-0.3827327723098714*coeff[0]*fSkin[5])-0.3827327723098714*coeff[0]*fEdge[5]-0.3977475644174328*coeff[0]*fSkin[4]+0.3977475644174328*coeff[0]*fEdge[4]; 
  edgeSurf_incr[5] = (-0.6123724356957944*coeff[1]*fSkin[5])-1.016465997955662*coeff[0]*fSkin[5]+0.6123724356957944*coeff[1]*fEdge[5]-0.3093592167691142*coeff[0]*fEdge[5]-0.5303300858899104*coeff[1]*fSkin[4]-0.9951052080056656*coeff[0]*fSkin[4]-0.5303300858899104*coeff[1]*fEdge[4]+0.3827327723098713*coeff[0]*fEdge[4]; 
