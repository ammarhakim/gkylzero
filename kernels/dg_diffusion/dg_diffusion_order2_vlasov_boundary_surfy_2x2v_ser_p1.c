...
GKYL_CU_DH double dg_diffusion_order2_vlasov_boundary_surfy_2x2v_ser_p1_constcoeff(const double *w, const double *dx, const double *coeff, int edge, const double *fSkin, const double *fEdge, double* GKYL_RESTRICT out) 
{
  ...
  edgeSurf_incr[26] = (-1.4375*coeff[1]*fSkin[26])-0.4375*coeff[1]*fEdge[26]-1.407291281149713*coeff[1]*fSkin[24]+0.5412658773652742*coeff[1]*fEdge[24]; 
  ...
  edgeSurf_incr[28] = (-1.4375*coeff[1]*fSkin[28])-0.4375*coeff[1]*fEdge[28]-1.407291281149713*coeff[1]*fSkin[25]+0.5412658773652742*coeff[1]*fEdge[25]; 
  ...
  edgeSurf_incr[30] = (-1.4375*coeff[1]*fSkin[30])-0.4375*coeff[1]*fEdge[30]-1.407291281149713*coeff[1]*fSkin[27]+0.5412658773652742*coeff[1]*fEdge[27]; 
  edgeSurf_incr[31] = (-1.4375*coeff[1]*fSkin[31])-0.4375*coeff[1]*fEdge[31]-1.407291281149713*coeff[1]*fSkin[29]+0.5412658773652742*coeff[1]*fEdge[29]; 
...
GKYL_CU_DH double dg_diffusion_order2_vlasov_boundary_surfy_2x2v_ser_p1_varcoeff(const double *w, const double *dx, const double *coeff, int edge, const double *fSkin, const double *fEdge, double* GKYL_RESTRICT out) 
{
  // w[NDIM]: Cell-center coordinate.
  // dxv[NDIM]: Cell length.
  // coeff: Diffusion coefficient.
  ...
  edgeSurf_incr[24] = (-0.270632938682637*coeff[5]*fSkin[28])-0.270632938682637*coeff[5]*fEdge[28]-0.2706329386826371*coeff[4]*fSkin[26]-0.2706329386826371*coeff[4]*fEdge[26]-0.2812499999999999*coeff[5]*fSkin[25]+0.2812499999999999*coeff[5]*fEdge[25]-0.28125*coeff[4]*fSkin[24]+0.28125*coeff[4]*fEdge[24]; 
  edgeSurf_incr[25] = (-0.2706329386826371*coeff[4]*fSkin[28])-0.2706329386826371*coeff[4]*fEdge[28]-0.270632938682637*coeff[5]*fSkin[26]-0.270632938682637*coeff[5]*fEdge[26]-0.28125*coeff[4]*fSkin[25]+0.28125*coeff[4]*fEdge[25]-0.2812499999999999*coeff[5]*fSkin[24]+0.2812499999999999*coeff[5]*fEdge[24]; 
  edgeSurf_incr[26] = (-0.4330127018922194*coeff[7]*fSkin[28])-0.7187500000000001*coeff[5]*fSkin[28]+0.4330127018922194*coeff[7]*fEdge[28]-0.21875*coeff[5]*fEdge[28]-0.4330127018922193*coeff[6]*fSkin[26]-0.71875*coeff[4]*fSkin[26]+0.4330127018922193*coeff[6]*fEdge[26]-0.21875*coeff[4]*fEdge[26]-0.375*coeff[7]*fSkin[25]-0.7036456405748562*coeff[5]*fSkin[25]-0.375*coeff[7]*fEdge[25]+0.2706329386826369*coeff[5]*fEdge[25]-0.375*coeff[6]*fSkin[24]-0.7036456405748563*coeff[4]*fSkin[24]-0.375*coeff[6]*fEdge[24]+0.2706329386826371*coeff[4]*fEdge[24]; 
  edgeSurf_incr[27] = (-0.270632938682637*coeff[5]*fSkin[31])-0.270632938682637*coeff[5]*fEdge[31]-0.2706329386826371*coeff[4]*fSkin[30]-0.2706329386826371*coeff[4]*fEdge[30]-0.2812499999999999*coeff[5]*fSkin[29]+0.2812499999999999*coeff[5]*fEdge[29]-0.28125*coeff[4]*fSkin[27]+0.28125*coeff[4]*fEdge[27]; 
  edgeSurf_incr[28] = (-0.4330127018922193*coeff[6]*fSkin[28])-0.71875*coeff[4]*fSkin[28]+0.4330127018922193*coeff[6]*fEdge[28]-0.21875*coeff[4]*fEdge[28]-0.4330127018922194*coeff[7]*fSkin[26]-0.7187500000000001*coeff[5]*fSkin[26]+0.4330127018922194*coeff[7]*fEdge[26]-0.21875*coeff[5]*fEdge[26]-0.375*coeff[6]*fSkin[25]-0.7036456405748563*coeff[4]*fSkin[25]-0.375*coeff[6]*fEdge[25]+0.2706329386826371*coeff[4]*fEdge[25]-0.375*coeff[7]*fSkin[24]-0.7036456405748562*coeff[5]*fSkin[24]-0.375*coeff[7]*fEdge[24]+0.2706329386826369*coeff[5]*fEdge[24]; 
  edgeSurf_incr[29] = (-0.2706329386826371*coeff[4]*fSkin[31])-0.2706329386826371*coeff[4]*fEdge[31]-0.270632938682637*coeff[5]*fSkin[30]-0.270632938682637*coeff[5]*fEdge[30]-0.28125*coeff[4]*fSkin[29]+0.28125*coeff[4]*fEdge[29]-0.2812499999999999*coeff[5]*fSkin[27]+0.2812499999999999*coeff[5]*fEdge[27]; 
  edgeSurf_incr[30] = (-0.4330127018922194*coeff[7]*fSkin[31])-0.7187500000000001*coeff[5]*fSkin[31]+0.4330127018922194*coeff[7]*fEdge[31]-0.21875*coeff[5]*fEdge[31]-0.4330127018922193*coeff[6]*fSkin[30]-0.71875*coeff[4]*fSkin[30]+0.4330127018922193*coeff[6]*fEdge[30]-0.21875*coeff[4]*fEdge[30]-0.375*coeff[7]*fSkin[29]-0.7036456405748562*coeff[5]*fSkin[29]-0.375*coeff[7]*fEdge[29]+0.2706329386826369*coeff[5]*fEdge[29]-0.375*coeff[6]*fSkin[27]-0.7036456405748563*coeff[4]*fSkin[27]-0.375*coeff[6]*fEdge[27]+0.2706329386826371*coeff[4]*fEdge[27]; 
  edgeSurf_incr[31] = (-0.4330127018922193*coeff[6]*fSkin[31])-0.71875*coeff[4]*fSkin[31]+0.4330127018922193*coeff[6]*fEdge[31]-0.21875*coeff[4]*fEdge[31]-0.4330127018922194*coeff[7]*fSkin[30]-0.7187500000000001*coeff[5]*fSkin[30]+0.4330127018922194*coeff[7]*fEdge[30]-0.21875*coeff[5]*fEdge[30]-0.375*coeff[6]*fSkin[29]-0.7036456405748563*coeff[4]*fSkin[29]-0.375*coeff[6]*fEdge[29]+0.2706329386826371*coeff[4]*fEdge[29]-0.375*coeff[7]*fSkin[27]-0.7036456405748562*coeff[5]*fSkin[27]-0.375*coeff[7]*fEdge[27]+0.2706329386826369*coeff[5]*fEdge[27]; 
  ...
  boundSurf_incr[26] = 0.8660254037844387*coeff[7]*fSkin[28]-0.5000000000000001*coeff[5]*fSkin[28]+0.8660254037844386*coeff[6]*fSkin[26]-0.5*coeff[4]*fSkin[26]-0.75*coeff[7]*fSkin[25]+0.4330127018922193*coeff[5]*fSkin[25]-0.75*coeff[6]*fSkin[24]+0.4330127018922194*coeff[4]*fSkin[24]; 
  boundSurf_incr[28] = 0.8660254037844386*coeff[6]*fSkin[28]-0.5*coeff[4]*fSkin[28]+0.8660254037844387*coeff[7]*fSkin[26]-0.5000000000000001*coeff[5]*fSkin[26]-0.75*coeff[6]*fSkin[25]+0.4330127018922194*coeff[4]*fSkin[25]-0.75*coeff[7]*fSkin[24]+0.4330127018922193*coeff[5]*fSkin[24]; 
  boundSurf_incr[30] = 0.8660254037844387*coeff[7]*fSkin[31]-0.5000000000000001*coeff[5]*fSkin[31]+0.8660254037844386*coeff[6]*fSkin[30]-0.5*coeff[4]*fSkin[30]-0.75*coeff[7]*fSkin[29]+0.4330127018922193*coeff[5]*fSkin[29]-0.75*coeff[6]*fSkin[27]+0.4330127018922194*coeff[4]*fSkin[27]; 
  boundSurf_incr[31] = 0.8660254037844386*coeff[6]*fSkin[31]-0.5*coeff[4]*fSkin[31]+0.8660254037844387*coeff[7]*fSkin[30]-0.5000000000000001*coeff[5]*fSkin[30]-0.75*coeff[6]*fSkin[29]+0.4330127018922194*coeff[4]*fSkin[29]-0.75*coeff[7]*fSkin[27]+0.4330127018922193*coeff[5]*fSkin[27]; 
