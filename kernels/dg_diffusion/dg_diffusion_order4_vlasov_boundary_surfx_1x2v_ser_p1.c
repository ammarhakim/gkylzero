...
GKYL_CU_DH double dg_diffusion_order4_vlasov_boundary_surfx_1x2v_ser_p1_constcoeff(const double *w, const double *dx, const double *coeff, int edge, const double *fSkin, const double *fEdge, double* GKYL_RESTRICT out) 
{
  ...
  edgeSurf_incr[12] = 1.623797632095823*coeff[0]*fSkin[13]+1.623797632095823*coeff[0]*fEdge[13]+0.9375*coeff[0]*fSkin[12]-0.9375*coeff[0]*fEdge[12]; 
  edgeSurf_incr[13] = 3.5625*coeff[0]*fSkin[13]+2.0625*coeff[0]*fEdge[13]+1.623797632095823*coeff[0]*fSkin[12]-1.623797632095823*coeff[0]*fEdge[12]; 
  edgeSurf_incr[14] = 1.623797632095823*coeff[0]*fSkin[15]+1.623797632095823*coeff[0]*fEdge[15]+0.9375*coeff[0]*fSkin[14]-0.9375*coeff[0]*fEdge[14]; 
  edgeSurf_incr[15] = 3.5625*coeff[0]*fSkin[15]+2.0625*coeff[0]*fEdge[15]+1.623797632095823*coeff[0]*fSkin[14]-1.623797632095823*coeff[0]*fEdge[14]; 
...
GKYL_CU_DH double dg_diffusion_order4_vlasov_boundary_surfx_1x2v_ser_p1_varcoeff(const double *w, const double *dx, const double *coeff, int edge, const double *fSkin, const double *fEdge, double* GKYL_RESTRICT out) 
{
  // w[NDIM]: Cell-center coordinate.
  // dxv[NDIM]: Cell length.
  // coeff: Diffusion coefficient.
  ...
  edgeSurf_incr[12] = (-0.5303300858899104*coeff[1]*fSkin[13])+1.148198316929614*coeff[0]*fSkin[13]+0.5303300858899104*coeff[1]*fEdge[13]+1.148198316929614*coeff[0]*fEdge[13]+0.6629126073623879*coeff[0]*fSkin[12]-0.6629126073623879*coeff[0]*fEdge[12]; 
  edgeSurf_incr[13] = (-0.9185586535436913*coeff[1]*fSkin[13])+2.519067907977075*coeff[0]*fSkin[13]+0.9185586535436913*coeff[1]*fEdge[13]+1.458407736197253*coeff[0]*fEdge[13]+1.148198316929614*coeff[0]*fSkin[12]-1.148198316929614*coeff[0]*fEdge[12]; 
  edgeSurf_incr[14] = (-0.5303300858899104*coeff[1]*fSkin[15])+1.148198316929614*coeff[0]*fSkin[15]+0.5303300858899104*coeff[1]*fEdge[15]+1.148198316929614*coeff[0]*fEdge[15]+0.6629126073623879*coeff[0]*fSkin[14]-0.6629126073623879*coeff[0]*fEdge[14]; 
  ...
  boundSurf_incr[12] = -1.060660171779821*coeff[1]*fSkin[13]; 
