...
GKYL_CU_DH double dg_diffusion_order2_vlasov_boundary_surfx_1x3v_ser_p1_constcoeff(const double *w, const double *dx, const double *coeff, int edge, const double *fSkin, const double *fEdge, double* GKYL_RESTRICT out) 
{
  ...
  edgeSurf_incr[25] = (-1.4375*coeff[0]*fSkin[25])-0.4375*coeff[0]*fEdge[25]-1.407291281149713*coeff[0]*fSkin[24]+0.5412658773652742*coeff[0]*fEdge[24]; 
  ...
  edgeSurf_incr[28] = (-1.4375*coeff[0]*fSkin[28])-0.4375*coeff[0]*fEdge[28]-1.407291281149713*coeff[0]*fSkin[26]+0.5412658773652742*coeff[0]*fEdge[26]; 
  edgeSurf_incr[29] = (-1.4375*coeff[0]*fSkin[29])-0.4375*coeff[0]*fEdge[29]-1.407291281149713*coeff[0]*fSkin[27]+0.5412658773652742*coeff[0]*fEdge[27]; 
  ...
  edgeSurf_incr[31] = (-1.4375*coeff[0]*fSkin[31])-0.4375*coeff[0]*fEdge[31]-1.407291281149713*coeff[0]*fSkin[30]+0.5412658773652742*coeff[0]*fEdge[30]; 
  ...
  edgeSurf_incr[33] = (-1.4375*coeff[0]*fSkin[33])-0.4375*coeff[0]*fEdge[33]-1.407291281149713*coeff[0]*fSkin[32]+0.5412658773652742*coeff[0]*fEdge[32]; 
  ...
  edgeSurf_incr[36] = (-1.4375*coeff[0]*fSkin[36])-0.4375*coeff[0]*fEdge[36]-1.407291281149713*coeff[0]*fSkin[34]+0.5412658773652742*coeff[0]*fEdge[34]; 
  edgeSurf_incr[37] = (-1.4375*coeff[0]*fSkin[37])-0.4375*coeff[0]*fEdge[37]-1.407291281149713*coeff[0]*fSkin[35]+0.5412658773652742*coeff[0]*fEdge[35]; 
  ...
  edgeSurf_incr[39] = (-1.4375*coeff[0]*fSkin[39])-0.4375*coeff[0]*fEdge[39]-1.407291281149713*coeff[0]*fSkin[38]+0.5412658773652742*coeff[0]*fEdge[38]; 
...
GKYL_CU_DH double dg_diffusion_order2_vlasov_boundary_surfx_1x3v_ser_p1_varcoeff(const double *w, const double *dx, const double *coeff, int edge, const double *fSkin, const double *fEdge, double* GKYL_RESTRICT out) 
{
  // w[NDIM]: Cell-center coordinate.
  // dxv[NDIM]: Cell length.
  // coeff: Diffusion coefficient.
  ...
  vol_incr[5] = 2.121320343559642*coeff[1]*fSkin[2]; 
  vol_incr[6] = 2.121320343559642*coeff[1]*fSkin[3]; 
  vol_incr[8] = 2.121320343559642*coeff[1]*fSkin[4]; 
  vol_incr[11] = 2.121320343559642*coeff[1]*fSkin[7]; 
  vol_incr[12] = 2.121320343559642*coeff[1]*fSkin[9]; 
  vol_incr[13] = 2.121320343559642*coeff[1]*fSkin[10]; 
  vol_incr[15] = 2.121320343559642*coeff[1]*fSkin[14]; 
  vol_incr[17] = 2.121320343559642*coeff[1]*fSkin[16]; 
  vol_incr[20] = 2.121320343559642*coeff[1]*fSkin[18]; 
  vol_incr[21] = 2.121320343559642*coeff[1]*fSkin[19]; 
  vol_incr[23] = 2.121320343559642*coeff[1]*fSkin[22]; 
  vol_incr[25] = 2.121320343559642*coeff[1]*fSkin[24]; 
  vol_incr[28] = 2.121320343559642*coeff[1]*fSkin[26]; 
  vol_incr[29] = 2.121320343559642*coeff[1]*fSkin[27]; 
  vol_incr[31] = 2.121320343559642*coeff[1]*fSkin[30]; 
  vol_incr[33] = 2.121320343559642*coeff[1]*fSkin[32]; 
  vol_incr[36] = 2.121320343559642*coeff[1]*fSkin[34]; 
  vol_incr[37] = 2.121320343559642*coeff[1]*fSkin[35]; 
  vol_incr[39] = 2.121320343559642*coeff[1]*fSkin[38]; 
  ...
  edgeSurf_incr[2] = (-0.3827327723098713*coeff[0]*fSkin[5])-0.3827327723098713*coeff[0]*fEdge[5]-0.3977475644174328*coeff[0]*fSkin[2]+0.3977475644174328*coeff[0]*fEdge[2]; 
  edgeSurf_incr[3] = (-0.3827327723098713*coeff[0]*fSkin[6])-0.3827327723098713*coeff[0]*fEdge[6]-0.3977475644174328*coeff[0]*fSkin[3]+0.3977475644174328*coeff[0]*fEdge[3]; 
  edgeSurf_incr[4] = (-0.3827327723098713*coeff[0]*fSkin[8])-0.3827327723098713*coeff[0]*fEdge[8]-0.3977475644174328*coeff[0]*fSkin[4]+0.3977475644174328*coeff[0]*fEdge[4]; 
  edgeSurf_incr[5] = (-0.6123724356957944*coeff[1]*fSkin[5])-1.016465997955662*coeff[0]*fSkin[5]+0.6123724356957944*coeff[1]*fEdge[5]-0.3093592167691142*coeff[0]*fEdge[5]-0.5303300858899105*coeff[1]*fSkin[2]-0.9951052080056654*coeff[0]*fSkin[2]-0.5303300858899105*coeff[1]*fEdge[2]+0.3827327723098711*coeff[0]*fEdge[2]; 
  edgeSurf_incr[6] = (-0.6123724356957944*coeff[1]*fSkin[6])-1.016465997955662*coeff[0]*fSkin[6]+0.6123724356957944*coeff[1]*fEdge[6]-0.3093592167691142*coeff[0]*fEdge[6]-0.5303300858899105*coeff[1]*fSkin[3]-0.9951052080056654*coeff[0]*fSkin[3]-0.5303300858899105*coeff[1]*fEdge[3]+0.3827327723098711*coeff[0]*fEdge[3]; 
  edgeSurf_incr[7] = (-0.3827327723098713*coeff[0]*fSkin[11])-0.3827327723098713*coeff[0]*fEdge[11]-0.3977475644174328*coeff[0]*fSkin[7]+0.3977475644174328*coeff[0]*fEdge[7]; 
  edgeSurf_incr[8] = (-0.6123724356957944*coeff[1]*fSkin[8])-1.016465997955662*coeff[0]*fSkin[8]+0.6123724356957944*coeff[1]*fEdge[8]-0.3093592167691142*coeff[0]*fEdge[8]-0.5303300858899105*coeff[1]*fSkin[4]-0.9951052080056654*coeff[0]*fSkin[4]-0.5303300858899105*coeff[1]*fEdge[4]+0.3827327723098711*coeff[0]*fEdge[4]; 
  edgeSurf_incr[9] = (-0.3827327723098713*coeff[0]*fSkin[12])-0.3827327723098713*coeff[0]*fEdge[12]-0.3977475644174328*coeff[0]*fSkin[9]+0.3977475644174328*coeff[0]*fEdge[9]; 
  edgeSurf_incr[10] = (-0.3827327723098713*coeff[0]*fSkin[13])-0.3827327723098713*coeff[0]*fEdge[13]-0.3977475644174328*coeff[0]*fSkin[10]+0.3977475644174328*coeff[0]*fEdge[10]; 
  edgeSurf_incr[11] = (-0.6123724356957944*coeff[1]*fSkin[11])-1.016465997955662*coeff[0]*fSkin[11]+0.6123724356957944*coeff[1]*fEdge[11]-0.3093592167691142*coeff[0]*fEdge[11]-0.5303300858899105*coeff[1]*fSkin[7]-0.9951052080056654*coeff[0]*fSkin[7]-0.5303300858899105*coeff[1]*fEdge[7]+0.3827327723098711*coeff[0]*fEdge[7]; 
  edgeSurf_incr[12] = (-0.6123724356957944*coeff[1]*fSkin[12])-1.016465997955662*coeff[0]*fSkin[12]+0.6123724356957944*coeff[1]*fEdge[12]-0.3093592167691142*coeff[0]*fEdge[12]-0.5303300858899105*coeff[1]*fSkin[9]-0.9951052080056654*coeff[0]*fSkin[9]-0.5303300858899105*coeff[1]*fEdge[9]+0.3827327723098711*coeff[0]*fEdge[9]; 
  edgeSurf_incr[13] = (-0.6123724356957944*coeff[1]*fSkin[13])-1.016465997955662*coeff[0]*fSkin[13]+0.6123724356957944*coeff[1]*fEdge[13]-0.3093592167691142*coeff[0]*fEdge[13]-0.5303300858899105*coeff[1]*fSkin[10]-0.9951052080056654*coeff[0]*fSkin[10]-0.5303300858899105*coeff[1]*fEdge[10]+0.3827327723098711*coeff[0]*fEdge[10]; 
  edgeSurf_incr[14] = (-0.3827327723098713*coeff[0]*fSkin[15])-0.3827327723098713*coeff[0]*fEdge[15]-0.3977475644174328*coeff[0]*fSkin[14]+0.3977475644174328*coeff[0]*fEdge[14]; 
  edgeSurf_incr[15] = (-0.6123724356957944*coeff[1]*fSkin[15])-1.016465997955662*coeff[0]*fSkin[15]+0.6123724356957944*coeff[1]*fEdge[15]-0.3093592167691142*coeff[0]*fEdge[15]-0.5303300858899105*coeff[1]*fSkin[14]-0.9951052080056654*coeff[0]*fSkin[14]-0.5303300858899105*coeff[1]*fEdge[14]+0.3827327723098711*coeff[0]*fEdge[14]; 
  edgeSurf_incr[16] = (-0.3827327723098714*coeff[0]*fSkin[17])-0.3827327723098714*coeff[0]*fEdge[17]-0.3977475644174328*coeff[0]*fSkin[16]+0.3977475644174328*coeff[0]*fEdge[16]; 
  edgeSurf_incr[17] = (-0.6123724356957944*coeff[1]*fSkin[17])-1.016465997955662*coeff[0]*fSkin[17]+0.6123724356957944*coeff[1]*fEdge[17]-0.3093592167691142*coeff[0]*fEdge[17]-0.5303300858899104*coeff[1]*fSkin[16]-0.9951052080056656*coeff[0]*fSkin[16]-0.5303300858899104*coeff[1]*fEdge[16]+0.3827327723098713*coeff[0]*fEdge[16]; 
  edgeSurf_incr[18] = (-0.3827327723098714*coeff[0]*fSkin[20])-0.3827327723098714*coeff[0]*fEdge[20]-0.3977475644174328*coeff[0]*fSkin[18]+0.3977475644174328*coeff[0]*fEdge[18]; 
  edgeSurf_incr[19] = (-0.3827327723098714*coeff[0]*fSkin[21])-0.3827327723098714*coeff[0]*fEdge[21]-0.3977475644174328*coeff[0]*fSkin[19]+0.3977475644174328*coeff[0]*fEdge[19]; 
  edgeSurf_incr[20] = (-0.6123724356957944*coeff[1]*fSkin[20])-1.016465997955662*coeff[0]*fSkin[20]+0.6123724356957944*coeff[1]*fEdge[20]-0.3093592167691142*coeff[0]*fEdge[20]-0.5303300858899104*coeff[1]*fSkin[18]-0.9951052080056656*coeff[0]*fSkin[18]-0.5303300858899104*coeff[1]*fEdge[18]+0.3827327723098713*coeff[0]*fEdge[18]; 
  edgeSurf_incr[21] = (-0.6123724356957944*coeff[1]*fSkin[21])-1.016465997955662*coeff[0]*fSkin[21]+0.6123724356957944*coeff[1]*fEdge[21]-0.3093592167691142*coeff[0]*fEdge[21]-0.5303300858899104*coeff[1]*fSkin[19]-0.9951052080056656*coeff[0]*fSkin[19]-0.5303300858899104*coeff[1]*fEdge[19]+0.3827327723098713*coeff[0]*fEdge[19]; 
  edgeSurf_incr[22] = (-0.3827327723098714*coeff[0]*fSkin[23])-0.3827327723098714*coeff[0]*fEdge[23]-0.3977475644174328*coeff[0]*fSkin[22]+0.3977475644174328*coeff[0]*fEdge[22]; 
  edgeSurf_incr[23] = (-0.6123724356957944*coeff[1]*fSkin[23])-1.016465997955662*coeff[0]*fSkin[23]+0.6123724356957944*coeff[1]*fEdge[23]-0.3093592167691142*coeff[0]*fEdge[23]-0.5303300858899104*coeff[1]*fSkin[22]-0.9951052080056656*coeff[0]*fSkin[22]-0.5303300858899104*coeff[1]*fEdge[22]+0.3827327723098713*coeff[0]*fEdge[22]; 
  edgeSurf_incr[24] = (-0.3827327723098714*coeff[0]*fSkin[25])-0.3827327723098714*coeff[0]*fEdge[25]-0.3977475644174328*coeff[0]*fSkin[24]+0.3977475644174328*coeff[0]*fEdge[24]; 
  edgeSurf_incr[25] = (-0.6123724356957944*coeff[1]*fSkin[25])-1.016465997955662*coeff[0]*fSkin[25]+0.6123724356957944*coeff[1]*fEdge[25]-0.3093592167691142*coeff[0]*fEdge[25]-0.5303300858899104*coeff[1]*fSkin[24]-0.9951052080056656*coeff[0]*fSkin[24]-0.5303300858899104*coeff[1]*fEdge[24]+0.3827327723098713*coeff[0]*fEdge[24]; 
  edgeSurf_incr[26] = (-0.3827327723098714*coeff[0]*fSkin[28])-0.3827327723098714*coeff[0]*fEdge[28]-0.3977475644174328*coeff[0]*fSkin[26]+0.3977475644174328*coeff[0]*fEdge[26]; 
  edgeSurf_incr[27] = (-0.3827327723098714*coeff[0]*fSkin[29])-0.3827327723098714*coeff[0]*fEdge[29]-0.3977475644174328*coeff[0]*fSkin[27]+0.3977475644174328*coeff[0]*fEdge[27]; 
  edgeSurf_incr[28] = (-0.6123724356957944*coeff[1]*fSkin[28])-1.016465997955662*coeff[0]*fSkin[28]+0.6123724356957944*coeff[1]*fEdge[28]-0.3093592167691142*coeff[0]*fEdge[28]-0.5303300858899104*coeff[1]*fSkin[26]-0.9951052080056656*coeff[0]*fSkin[26]-0.5303300858899104*coeff[1]*fEdge[26]+0.3827327723098713*coeff[0]*fEdge[26]; 
  edgeSurf_incr[29] = (-0.6123724356957944*coeff[1]*fSkin[29])-1.016465997955662*coeff[0]*fSkin[29]+0.6123724356957944*coeff[1]*fEdge[29]-0.3093592167691142*coeff[0]*fEdge[29]-0.5303300858899104*coeff[1]*fSkin[27]-0.9951052080056656*coeff[0]*fSkin[27]-0.5303300858899104*coeff[1]*fEdge[27]+0.3827327723098713*coeff[0]*fEdge[27]; 
  edgeSurf_incr[30] = (-0.3827327723098714*coeff[0]*fSkin[31])-0.3827327723098714*coeff[0]*fEdge[31]-0.3977475644174328*coeff[0]*fSkin[30]+0.3977475644174328*coeff[0]*fEdge[30]; 
  edgeSurf_incr[31] = (-0.6123724356957944*coeff[1]*fSkin[31])-1.016465997955662*coeff[0]*fSkin[31]+0.6123724356957944*coeff[1]*fEdge[31]-0.3093592167691142*coeff[0]*fEdge[31]-0.5303300858899104*coeff[1]*fSkin[30]-0.9951052080056656*coeff[0]*fSkin[30]-0.5303300858899104*coeff[1]*fEdge[30]+0.3827327723098713*coeff[0]*fEdge[30]; 
  edgeSurf_incr[32] = (-0.3827327723098714*coeff[0]*fSkin[33])-0.3827327723098714*coeff[0]*fEdge[33]-0.3977475644174328*coeff[0]*fSkin[32]+0.3977475644174328*coeff[0]*fEdge[32]; 
  edgeSurf_incr[33] = (-0.6123724356957944*coeff[1]*fSkin[33])-1.016465997955662*coeff[0]*fSkin[33]+0.6123724356957944*coeff[1]*fEdge[33]-0.3093592167691142*coeff[0]*fEdge[33]-0.5303300858899104*coeff[1]*fSkin[32]-0.9951052080056656*coeff[0]*fSkin[32]-0.5303300858899104*coeff[1]*fEdge[32]+0.3827327723098713*coeff[0]*fEdge[32]; 
  edgeSurf_incr[34] = (-0.3827327723098714*coeff[0]*fSkin[36])-0.3827327723098714*coeff[0]*fEdge[36]-0.3977475644174328*coeff[0]*fSkin[34]+0.3977475644174328*coeff[0]*fEdge[34]; 
  edgeSurf_incr[35] = (-0.3827327723098714*coeff[0]*fSkin[37])-0.3827327723098714*coeff[0]*fEdge[37]-0.3977475644174328*coeff[0]*fSkin[35]+0.3977475644174328*coeff[0]*fEdge[35]; 
  edgeSurf_incr[36] = (-0.6123724356957944*coeff[1]*fSkin[36])-1.016465997955662*coeff[0]*fSkin[36]+0.6123724356957944*coeff[1]*fEdge[36]-0.3093592167691142*coeff[0]*fEdge[36]-0.5303300858899104*coeff[1]*fSkin[34]-0.9951052080056656*coeff[0]*fSkin[34]-0.5303300858899104*coeff[1]*fEdge[34]+0.3827327723098713*coeff[0]*fEdge[34]; 
  edgeSurf_incr[37] = (-0.6123724356957944*coeff[1]*fSkin[37])-1.016465997955662*coeff[0]*fSkin[37]+0.6123724356957944*coeff[1]*fEdge[37]-0.3093592167691142*coeff[0]*fEdge[37]-0.5303300858899104*coeff[1]*fSkin[35]-0.9951052080056656*coeff[0]*fSkin[35]-0.5303300858899104*coeff[1]*fEdge[35]+0.3827327723098713*coeff[0]*fEdge[35]; 
  edgeSurf_incr[38] = (-0.3827327723098714*coeff[0]*fSkin[39])-0.3827327723098714*coeff[0]*fEdge[39]-0.3977475644174328*coeff[0]*fSkin[38]+0.3977475644174328*coeff[0]*fEdge[38]; 
  edgeSurf_incr[39] = (-0.6123724356957944*coeff[1]*fSkin[39])-1.016465997955662*coeff[0]*fSkin[39]+0.6123724356957944*coeff[1]*fEdge[39]-0.3093592167691142*coeff[0]*fEdge[39]-0.5303300858899104*coeff[1]*fSkin[38]-0.9951052080056656*coeff[0]*fSkin[38]-0.5303300858899104*coeff[1]*fEdge[38]+0.3827327723098713*coeff[0]*fEdge[38]; 
