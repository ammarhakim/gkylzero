...
GKYL_CU_DH double dg_diffusion_order2_boundary_surfy_2x_ser_p1_constcoeff(const double *w, const double *dx, const double *coeff, int edge, const double *fSkin, const double *fEdge, double* GKYL_RESTRICT out) 
{
  ...
  edgeSurf_incr[3] = (-1.4375*coeff[1]*fSkin[3])-0.4375*coeff[1]*fEdge[3]-1.407291281149712*coeff[1]*fSkin[1]+0.5412658773652739*coeff[1]*fEdge[1]; 
...
GKYL_CU_DH double dg_diffusion_order2_boundary_surfy_2x_ser_p1_varcoeff(const double *w, const double *dx, const double *coeff, int edge, const double *fSkin, const double *fEdge, double* GKYL_RESTRICT out) 
{
  // w[NDIM]: Cell-center coordinate.
  // dxv[NDIM]: Cell length.
  // coeff: Diffusion coefficient.
  ...
  edgeSurf_incr[0] = (-0.270632938682637*fSkin[3]*coeff[5])-0.270632938682637*fEdge[3]*coeff[5]-0.28125*fSkin[1]*coeff[5]+0.28125*fEdge[1]*coeff[5]-0.270632938682637*fSkin[2]*coeff[4]-0.270632938682637*fEdge[2]*coeff[4]-0.28125*fSkin[0]*coeff[4]+0.28125*fEdge[0]*coeff[4]; 
  edgeSurf_incr[1] = (-0.270632938682637*fSkin[2]*coeff[5])-0.270632938682637*fEdge[2]*coeff[5]-0.28125*fSkin[0]*coeff[5]+0.28125*fEdge[0]*coeff[5]-0.270632938682637*fSkin[3]*coeff[4]-0.270632938682637*fEdge[3]*coeff[4]-0.28125*fSkin[1]*coeff[4]+0.28125*fEdge[1]*coeff[4]; 
  edgeSurf_incr[2] = (-0.4330127018922193*fSkin[3]*coeff[7])+0.4330127018922193*fEdge[3]*coeff[7]-0.375*fSkin[1]*coeff[7]-0.375*fEdge[1]*coeff[7]-0.4330127018922193*fSkin[2]*coeff[6]+0.4330127018922193*fEdge[2]*coeff[6]-0.375*fSkin[0]*coeff[6]-0.375*fEdge[0]*coeff[6]-0.71875*fSkin[3]*coeff[5]-0.21875*fEdge[3]*coeff[5]-0.7036456405748562*fSkin[1]*coeff[5]+0.2706329386826369*fEdge[1]*coeff[5]-0.71875*fSkin[2]*coeff[4]-0.21875*fEdge[2]*coeff[4]-0.7036456405748562*fSkin[0]*coeff[4]+0.2706329386826369*fEdge[0]*coeff[4]; 
  edgeSurf_incr[3] = (-0.4330127018922193*fSkin[2]*coeff[7])+0.4330127018922193*fEdge[2]*coeff[7]-0.375*fSkin[0]*coeff[7]-0.375*fEdge[0]*coeff[7]-0.4330127018922193*fSkin[3]*coeff[6]+0.4330127018922193*fEdge[3]*coeff[6]-0.375*fSkin[1]*coeff[6]-0.375*fEdge[1]*coeff[6]-0.71875*fSkin[2]*coeff[5]-0.21875*fEdge[2]*coeff[5]-0.7036456405748562*fSkin[0]*coeff[5]+0.2706329386826369*fEdge[0]*coeff[5]-0.71875*fSkin[3]*coeff[4]-0.21875*fEdge[3]*coeff[4]-0.7036456405748562*fSkin[1]*coeff[4]+0.2706329386826369*fEdge[1]*coeff[4]; 
