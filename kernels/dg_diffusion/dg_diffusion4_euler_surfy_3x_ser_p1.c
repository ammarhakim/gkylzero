...
GKYL_CU_DH double dg_diffusion4_euler_surfy_3x_ser_p1(const double* w, const double* dx, double D, 
...
{ 
  ...
  out4[1] += J*D*(1.623797632095822*q4r[4]-1.623797632095822*q4l[4]-0.9375*q4r[1]-0.9375*q4l[1]+1.875*q4c[1]); 
  out4[2] += J*D*(2.0625*q4r[2]+2.0625*q4l[2]+7.125*q4c[2]-1.623797632095822*q4r[0]+1.623797632095822*q4l[0]); 
  out4[3] += J*D*(1.623797632095822*q4r[6]-1.623797632095822*q4l[6]-0.9375*q4r[3]-0.9375*q4l[3]+1.875*q4c[3]); 
  out4[4] += J*D*(2.0625*q4r[4]+2.0625*q4l[4]+7.125*q4c[4]-1.623797632095822*q4r[1]+1.623797632095822*q4l[1]); 
  out4[5] += J*D*(1.623797632095822*q4r[7]-1.623797632095822*q4l[7]-0.9375*q4r[5]-0.9375*q4l[5]+1.875*q4c[5]); 
  out4[6] += J*D*(2.0625*q4r[6]+2.0625*q4l[6]+7.125*q4c[6]-1.623797632095822*q4r[3]+1.623797632095822*q4l[3]); 
  out4[7] += J*D*(2.0625*q4r[7]+2.0625*q4l[7]+7.125*q4c[7]-1.623797632095822*q4r[5]+1.623797632095822*q4l[5]); 
