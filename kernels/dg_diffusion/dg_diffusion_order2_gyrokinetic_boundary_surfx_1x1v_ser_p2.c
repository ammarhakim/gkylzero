...
GKYL_CU_DH double dg_diffusion_order2_gyrokinetic_boundary_surfx_1x1v_ser_p2_constcoeff(const double *w, const double *dx, const double *coeff, int edge, const double *fSkin, const double *fEdge, double* GKYL_RESTRICT out) 
{
  ...
  vol_incr[6] = 6.708203932499369*coeff[0]*fSkin[2]; 
  ...
  edgeSurf_incr[1] = (-1.585502557353661*coeff[0]*fSkin[4])+0.7382874503707886*coeff[0]*fEdge[4]-2.671875*coeff[0]*fSkin[1]-1.453125*coeff[0]*fEdge[1]-2.056810333988042*coeff[0]*fSkin[0]+1.190784930203603*coeff[0]*fEdge[0]; 
  ...
  edgeSurf_incr[3] = (-1.585502557353661*coeff[0]*fSkin[6])+0.7382874503707888*coeff[0]*fEdge[6]-2.671875*coeff[0]*fSkin[3]-1.453125*coeff[0]*fEdge[3]-2.056810333988042*coeff[0]*fSkin[2]+1.190784930203603*coeff[0]*fEdge[2]; 
  edgeSurf_incr[4] = (-3.140625*coeff[0]*fSkin[4])-0.140625*coeff[0]*fEdge[4]-5.022775277112744*coeff[0]*fSkin[1]-0.3025768239224549*coeff[0]*fEdge[1]-3.773364712030896*coeff[0]*fSkin[0]+0.4192627457812108*coeff[0]*fEdge[0]; 
  ...
  edgeSurf_incr[6] = (-3.140625*coeff[0]*fSkin[6])-0.140625*coeff[0]*fEdge[6]-5.022775277112744*coeff[0]*fSkin[3]-0.3025768239224544*coeff[0]*fEdge[3]-3.773364712030894*coeff[0]*fSkin[2]+0.4192627457812105*coeff[0]*fEdge[2]; 
  edgeSurf_incr[7] = (-2.671875*coeff[0]*fSkin[7])-1.453125*coeff[0]*fEdge[7]-2.056810333988042*coeff[0]*fSkin[5]+1.190784930203603*coeff[0]*fEdge[5]; 
  ...
  boundSurf_incr[4] = (-3.75*coeff[0]*fSkin[4])+4.841229182759272*coeff[0]*fSkin[1]-3.354101966249685*coeff[0]*fSkin[0]; 
  boundSurf_incr[6] = (-3.75*coeff[0]*fSkin[6])+4.841229182759271*coeff[0]*fSkin[3]-3.354101966249684*coeff[0]*fSkin[2]; 
...
GKYL_CU_DH double dg_diffusion_order2_gyrokinetic_boundary_surfx_1x1v_ser_p2_varcoeff(const double *w, const double *dx, const double *coeff, int edge, const double *fSkin, const double *fEdge, double* GKYL_RESTRICT out) 
{
  // w[NDIM]: Cell-center coordinate.
  // dxv[NDIM]: Cell length.
  // coeff: Diffusion coefficient.
