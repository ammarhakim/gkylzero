...
GKYL_CU_DH double dg_diffusion4_euler_surfx_2x_ser_p1(const double* w, const double* dx, double D, 
...
{ 
  ...
  out3[2] += J*D*(1.623797632095822*q3r[3]-1.623797632095822*q3l[3]-0.9375*q3r[2]-0.9375*q3l[2]+1.875*q3c[2]); 
  out3[3] += J*D*(2.0625*q3r[3]+2.0625*q3l[3]+7.125*q3c[3]-1.623797632095822*q3r[2]+1.623797632095822*q3l[2]); 
  ...
  out4[2] += J*D*(1.623797632095822*q4r[3]-1.623797632095822*q4l[3]-0.9375*q4r[2]-0.9375*q4l[2]+1.875*q4c[2]); 
  out4[3] += J*D*(2.0625*q4r[3]+2.0625*q4l[3]+7.125*q4c[3]-1.623797632095822*q4r[2]+1.623797632095822*q4l[2]); 
