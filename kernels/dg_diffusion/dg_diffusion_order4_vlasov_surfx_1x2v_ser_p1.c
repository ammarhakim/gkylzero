...
GKYL_CU_DH double dg_diffusion_order4_vlasov_surfx_1x2v_ser_p1_constcoeff(const double *w, const double *dx, const double *coeff, const double *ql, const double *qc, const double *qr, double* GKYL_RESTRICT out) 
{
...
GKYL_CU_DH double dg_diffusion_order4_vlasov_surfx_1x2v_ser_p1_varcoeff(const double *w, const double *dx, const double *coeff, const double *ql, const double *qc, const double *qr, double* GKYL_RESTRICT out) 
{
  // w[NDIM]: Cell-center coordinate.
  // dxv[NDIM]: Cell length.
  // coeff: Diffusion coefficient.
  ...
  out[12] += -0.008838834764831839*((285.0*coeff[1]+129.9038105676658*coeff[0])*qr[13]+(285.0*coeff[1]-129.9038105676658*coeff[0])*ql[13]+330.0000000000001*coeff[1]*qc[13]+((-129.9038105676658*coeff[1])-75.0*coeff[0])*qr[12]+(129.9038105676658*coeff[1]-75.0*coeff[0])*ql[12]+150.0*coeff[0]*qc[12])*Jfac; 
  out[13] += -0.0441941738241592*((77.94228634059945*coeff[1]+33.0*coeff[0])*qr[13]+(33.0*coeff[0]-77.94228634059945*coeff[1])*ql[13]+114.0*coeff[0]*qc[13]+((-45.0*coeff[1])-25.98076211353316*coeff[0])*qr[12]+(25.98076211353316*coeff[0]-45.0*coeff[1])*ql[12]+90.0*coeff[1]*qc[12])*Jfac; 
  out[14] += -0.008838834764831839*((285.0*coeff[1]+129.9038105676658*coeff[0])*qr[15]+(285.0*coeff[1]-129.9038105676658*coeff[0])*ql[15]+330.0000000000001*coeff[1]*qc[15]+((-129.9038105676658*coeff[1])-75.0*coeff[0])*qr[14]+(129.9038105676658*coeff[1]-75.0*coeff[0])*ql[14]+150.0*coeff[0]*qc[14])*Jfac; 
  out[15] += -0.0441941738241592*((77.94228634059945*coeff[1]+33.0*coeff[0])*qr[15]+(33.0*coeff[0]-77.94228634059945*coeff[1])*ql[15]+114.0*coeff[0]*qc[15]+((-45.0*coeff[1])-25.98076211353316*coeff[0])*qr[14]+(25.98076211353316*coeff[0]-45.0*coeff[1])*ql[14]+90.0*coeff[1]*qc[14])*Jfac; 
