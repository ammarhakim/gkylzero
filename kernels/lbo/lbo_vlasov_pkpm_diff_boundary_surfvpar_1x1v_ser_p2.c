...
GKYL_CU_DH void lbo_vlasov_pkpm_diff_boundary_surfvpar_1x1v_ser_p2(const double *w, const double *dxv, const double *nuVtSq, const int edge, const double *fSkin, const double *fEdge, double* GKYL_RESTRICT out) 
{ 
  ...
  vol_incr[5] = 4.743416490252569*nuVtSq[2]*fSkin[4]*rdvSq4+4.743416490252569*fSkin[1]*nuVtSq[1]*rdvSq4+4.743416490252569*fSkin[0]*nuVtSq[0]*rdvSq4; 
  vol_incr[7] = 4.242640687119286*nuVtSq[1]*fSkin[4]*rdvSq4+4.242640687119286*fSkin[1]*nuVtSq[2]*rdvSq4+4.743416490252569*fSkin[0]*nuVtSq[1]*rdvSq4+4.743416490252569*nuVtSq[0]*fSkin[1]*rdvSq4; 
  ...
  diff_incr[0] = 0.7071067811865475*nuVtSq[2]*temp_diff[4]+0.7071067811865475*nuVtSq[1]*temp_diff[1]+0.7071067811865475*nuVtSq[0]*temp_diff[0]; 
  diff_incr[1] = 0.6324555320336759*nuVtSq[1]*temp_diff[4]+0.6324555320336759*temp_diff[1]*nuVtSq[2]+0.7071067811865475*nuVtSq[0]*temp_diff[1]+0.7071067811865475*temp_diff[0]*nuVtSq[1]; 
  diff_incr[2] = 0.7071067811865475*nuVtSq[2]*temp_diff[6]+0.7071067811865475*nuVtSq[1]*temp_diff[3]+0.7071067811865475*nuVtSq[0]*temp_diff[2]; 
  diff_incr[3] = 0.632455532033676*nuVtSq[1]*temp_diff[6]+0.6324555320336759*nuVtSq[2]*temp_diff[3]+0.7071067811865475*nuVtSq[0]*temp_diff[3]+0.7071067811865475*nuVtSq[1]*temp_diff[2]; 
  diff_incr[4] = 0.4517539514526256*nuVtSq[2]*temp_diff[4]+0.7071067811865475*nuVtSq[0]*temp_diff[4]+0.7071067811865475*temp_diff[0]*nuVtSq[2]+0.6324555320336759*nuVtSq[1]*temp_diff[1]; 
  diff_incr[5] = 0.7071067811865475*nuVtSq[1]*temp_diff[7]+0.7071067811865475*nuVtSq[0]*temp_diff[5]; 
  diff_incr[6] = 0.4517539514526256*nuVtSq[2]*temp_diff[6]+0.7071067811865475*nuVtSq[0]*temp_diff[6]+0.632455532033676*nuVtSq[1]*temp_diff[3]+0.7071067811865475*nuVtSq[2]*temp_diff[2]; 
  ...
  edge_incr[0] = 0.7071067811865475*nuVtSq[2]*temp_edge[4]+0.7071067811865475*nuVtSq[1]*temp_edge[1]+0.7071067811865475*nuVtSq[0]*temp_edge[0]; 
  edge_incr[1] = 0.6324555320336759*nuVtSq[1]*temp_edge[4]+0.6324555320336759*temp_edge[1]*nuVtSq[2]+0.7071067811865475*nuVtSq[0]*temp_edge[1]+0.7071067811865475*temp_edge[0]*nuVtSq[1]; 
  edge_incr[2] = 0.7071067811865475*nuVtSq[2]*temp_edge[6]+0.7071067811865475*nuVtSq[1]*temp_edge[3]+0.7071067811865475*nuVtSq[0]*temp_edge[2]; 
  edge_incr[3] = 0.632455532033676*nuVtSq[1]*temp_edge[6]+0.6324555320336759*nuVtSq[2]*temp_edge[3]+0.7071067811865475*nuVtSq[0]*temp_edge[3]+0.7071067811865475*nuVtSq[1]*temp_edge[2]; 
  edge_incr[4] = 0.4517539514526256*nuVtSq[2]*temp_edge[4]+0.7071067811865475*nuVtSq[0]*temp_edge[4]+0.7071067811865475*temp_edge[0]*nuVtSq[2]+0.6324555320336759*nuVtSq[1]*temp_edge[1]; 
  edge_incr[5] = 0.7071067811865475*nuVtSq[1]*temp_edge[7]+0.7071067811865475*nuVtSq[0]*temp_edge[5]; 
  edge_incr[6] = 0.4517539514526256*nuVtSq[2]*temp_edge[6]+0.7071067811865475*nuVtSq[0]*temp_edge[6]+0.632455532033676*nuVtSq[1]*temp_edge[3]+0.7071067811865475*nuVtSq[2]*temp_edge[2]; 
