...
{ 
  ...
  alphaDrag[27] = (2.0*nuUSum[3]-2.828427124746191*nuSum[0]*w[2])*rdvy2; 
  alphaDrag[28] = 2.0*nuUSum[4]*rdvy2; 
  alphaDrag[30] = -0.8164965809277261*nuSum[0]*dxv[2]*rdvy2; 
  ...
  return fabs(0.1767766952966368*alphaDrag[0]-0.1976423537605236*alphaDrag[7])+fabs(0.1767766952966368*alphaDrag[27]-0.1976423537605236*alphaDrag[34])+fabs((1.272792206135785*facDiff[0]-1.42302494707577*facDiff[2])*rdvxSq4)+fabs((1.272792206135785*facDiff[0]-1.42302494707577*facDiff[2])*rdvySq4); 
