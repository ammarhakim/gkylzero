...
GKYL_CU_DH double vlasov_lbo_vol_1x1v_tensor_p1(const double *w, const double *dxv, const double nuSum, const double *nuUSum, const double *nuVtSqSum, const double *f, double GKYL_RESTRICT *out) 
{ 
  ...
  return fabs(0.25*alphaDrag[0])+fabs(0.9428090415820636*nuVtSqSum[0]*rdvxSq4); 
