...
GKYL_CU_DH void lbo_gyrokinetic_drag_surfvpar_1x2v_tensor_p2(const double *w, const double *dxv, const double m_, const double *bmag_inv, const double *nuSum, const double *nuUSum, const double *nuVtSqSum, const double *fl, const double *fc, const double *fr, double* GKYL_RESTRICT out) 
{ 
  ...
  alphaDrSurf_l[4] = (-1.414213562373095*nuUSum[2])+1.414213562373095*w[1]*nuSum[2]-0.7071067811865475*dxv[1]*nuSum[2]; 
  ...
  alphaDrSurf_r[4] = (-1.414213562373095*nuUSum[2])+1.414213562373095*w[1]*nuSum[2]+0.7071067811865475*dxv[1]*nuSum[2]; 
