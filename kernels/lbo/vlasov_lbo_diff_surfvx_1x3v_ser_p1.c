...
{ 
  ...
  diff_incr[2] = (-0.3093592167691144*nuVtSqSum[1]*fr[5])-0.3093592167691144*nuVtSqSum[1]*fl[5]-2.032931995911323*nuVtSqSum[1]*fc[5]-0.3093592167691144*nuVtSqSum[0]*fr[2]-0.3093592167691144*nuVtSqSum[0]*fl[2]-2.032931995911323*nuVtSqSum[0]*fc[2]+0.3827327723098713*fr[1]*nuVtSqSum[1]-0.3827327723098713*fl[1]*nuVtSqSum[1]+0.3827327723098713*fr[0]*nuVtSqSum[0]-0.3827327723098713*fl[0]*nuVtSqSum[0]; 
