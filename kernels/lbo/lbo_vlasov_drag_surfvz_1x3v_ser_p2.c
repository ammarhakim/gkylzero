...
{ 
  ...
  if (0.3162277660168378*alphaDrSurf_l[7]-0.4743416490252567*alphaDrSurf_l[1]+0.3535533905932737*alphaDrSurf_l[0] < 0) { 
  ...
  if (0.3162277660168378*alphaDrSurf_r[7]-0.4743416490252567*alphaDrSurf_r[1]+0.3535533905932737*alphaDrSurf_r[0] < 0) { 
