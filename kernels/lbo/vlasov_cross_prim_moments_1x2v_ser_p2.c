...
GKYL_CU_DH void vlasov_cross_prim_moments_1x2v_ser_p2(struct gkyl_mat *A, struct gkyl_mat *rhs, const double betaGreenep1, const double m_self, const double *u_self, const double *vtsq_self, const double m_other, const double *u_other, const double *vtsq_other, const double *moms, const double *boundary_corrections) 
{ 
  ...
  double enRHS[3] = {0.0}; 
  enRHS[0] = (-(4.0*m0r[2]*vtsq_self[2]*betaGreenep1*m_self)/(2.82842712474619*m_self+2.82842712474619*m_other))-(1.0*m0r[2]*uSumSq[2]*betaGreenep1*m_self)/(2.82842712474619*m_self+2.82842712474619*m_other)-(4.0*m0r[1]*vtsq_self[1]*betaGreenep1*m_self)/(2.82842712474619*m_self+2.82842712474619*m_other)-(1.0*m0r[1]*uSumSq[1]*betaGreenep1*m_self)/(2.82842712474619*m_self+2.82842712474619*m_other)-(4.0*m0r[0]*vtsq_self[0]*betaGreenep1*m_self)/(2.82842712474619*m_self+2.82842712474619*m_other)-(1.0*m0r[0]*uSumSq[0]*betaGreenep1*m_self)/(2.82842712474619*m_self+2.82842712474619*m_other)+(4.0*m0r[2]*vtsq_other[2]*betaGreenep1*m_other)/(2.82842712474619*m_self+2.82842712474619*m_other)+(m0r[2]*uSumSq[2]*betaGreenep1*m_other)/(2.82842712474619*m_self+2.82842712474619*m_other)+(4.0*m0r[1]*vtsq_other[1]*betaGreenep1*m_other)/(2.82842712474619*m_self+2.82842712474619*m_other)+(m0r[1]*uSumSq[1]*betaGreenep1*m_other)/(2.82842712474619*m_self+2.82842712474619*m_other)+(4.0*m0r[0]*vtsq_other[0]*betaGreenep1*m_other)/(2.82842712474619*m_self+2.82842712474619*m_other)+(m0r[0]*uSumSq[0]*betaGreenep1*m_other)/(2.82842712474619*m_self+2.82842712474619*m_other)-1.0*uM1Self[0]-1.0*uM1Other[0]+2.0*m2r[0]; 
  enRHS[1] = (-(17.88854381999832*m0r[1]*vtsq_self[2]*betaGreenep1*m_self)/(14.14213562373095*m_self+14.14213562373095*m_other))-(4.47213595499958*m0r[1]*uSumSq[2]*betaGreenep1*m_self)/(14.14213562373095*m_self+14.14213562373095*m_other)-(17.88854381999832*vtsq_self[1]*m0r[2]*betaGreenep1*m_self)/(14.14213562373095*m_self+14.14213562373095*m_other)-(4.47213595499958*uSumSq[1]*m0r[2]*betaGreenep1*m_self)/(14.14213562373095*m_self+14.14213562373095*m_other)-(20.0*m0r[0]*vtsq_self[1]*betaGreenep1*m_self)/(14.14213562373095*m_self+14.14213562373095*m_other)-(5.0*m0r[0]*uSumSq[1]*betaGreenep1*m_self)/(14.14213562373095*m_self+14.14213562373095*m_other)-(20.0*vtsq_self[0]*m0r[1]*betaGreenep1*m_self)/(14.14213562373095*m_self+14.14213562373095*m_other)-(5.0*uSumSq[0]*m0r[1]*betaGreenep1*m_self)/(14.14213562373095*m_self+14.14213562373095*m_other)+(17.88854381999832*m0r[1]*vtsq_other[2]*betaGreenep1*m_other)/(14.14213562373095*m_self+14.14213562373095*m_other)+(4.47213595499958*m0r[1]*uSumSq[2]*betaGreenep1*m_other)/(14.14213562373095*m_self+14.14213562373095*m_other)+(17.88854381999832*vtsq_other[1]*m0r[2]*betaGreenep1*m_other)/(14.14213562373095*m_self+14.14213562373095*m_other)+(4.47213595499958*uSumSq[1]*m0r[2]*betaGreenep1*m_other)/(14.14213562373095*m_self+14.14213562373095*m_other)+(20.0*m0r[0]*vtsq_other[1]*betaGreenep1*m_other)/(14.14213562373095*m_self+14.14213562373095*m_other)+(5.0*m0r[0]*uSumSq[1]*betaGreenep1*m_other)/(14.14213562373095*m_self+14.14213562373095*m_other)+(20.0*vtsq_other[0]*m0r[1]*betaGreenep1*m_other)/(14.14213562373095*m_self+14.14213562373095*m_other)+(5.0*uSumSq[0]*m0r[1]*betaGreenep1*m_other)/(14.14213562373095*m_self+14.14213562373095*m_other)-1.0*uM1Self[1]-1.0*uM1Other[1]+2.0*m2r[1]; 
  enRHS[2] = (-(89.4427190999916*m0r[2]*vtsq_self[2]*betaGreenep1*m_self)/(98.99494936611667*m_self+98.99494936611667*m_other))-(140.0*m0r[0]*vtsq_self[2]*betaGreenep1*m_self)/(98.99494936611667*m_self+98.99494936611667*m_other)-(22.3606797749979*m0r[2]*uSumSq[2]*betaGreenep1*m_self)/(98.99494936611667*m_self+98.99494936611667*m_other)-(35.0*m0r[0]*uSumSq[2]*betaGreenep1*m_self)/(98.99494936611667*m_self+98.99494936611667*m_other)-(140.0*vtsq_self[0]*m0r[2]*betaGreenep1*m_self)/(98.99494936611667*m_self+98.99494936611667*m_other)-(35.0*uSumSq[0]*m0r[2]*betaGreenep1*m_self)/(98.99494936611667*m_self+98.99494936611667*m_other)-(125.2198067399882*m0r[1]*vtsq_self[1]*betaGreenep1*m_self)/(98.99494936611667*m_self+98.99494936611667*m_other)-(31.30495168499705*m0r[1]*uSumSq[1]*betaGreenep1*m_self)/(98.99494936611667*m_self+98.99494936611667*m_other)+(89.4427190999916*m0r[2]*vtsq_other[2]*betaGreenep1*m_other)/(98.99494936611667*m_self+98.99494936611667*m_other)+(140.0*m0r[0]*vtsq_other[2]*betaGreenep1*m_other)/(98.99494936611667*m_self+98.99494936611667*m_other)+(22.3606797749979*m0r[2]*uSumSq[2]*betaGreenep1*m_other)/(98.99494936611667*m_self+98.99494936611667*m_other)+(35.0*m0r[0]*uSumSq[2]*betaGreenep1*m_other)/(98.99494936611667*m_self+98.99494936611667*m_other)+(140.0*vtsq_other[0]*m0r[2]*betaGreenep1*m_other)/(98.99494936611667*m_self+98.99494936611667*m_other)+(35.0*uSumSq[0]*m0r[2]*betaGreenep1*m_other)/(98.99494936611667*m_self+98.99494936611667*m_other)+(125.2198067399882*m0r[1]*vtsq_other[1]*betaGreenep1*m_other)/(98.99494936611667*m_self+98.99494936611667*m_other)+(31.30495168499705*m0r[1]*uSumSq[1]*betaGreenep1*m_other)/(98.99494936611667*m_self+98.99494936611667*m_other)-1.0*uM1Self[2]-1.0*uM1Other[2]+2.0*m2r[2]; 
