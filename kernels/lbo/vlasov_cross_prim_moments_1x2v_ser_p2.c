...
GKYL_CU_DH void vlasov_cross_prim_moments_1x2v_ser_p2(struct gkyl_mat *A, struct gkyl_mat *rhs, const double betaGreenep1, const double *greene, const double m_self, const double *u_self, const double *vtsq_self, const double m_other, const double *u_other, const double *vtsq_other, const double *moms, const double *boundary_corrections) 
{ 
  ...
  gkyl_mat_set(A,6,2,(-0.3194382824999699*m0r[2]*u_self[2])-0.5*m0r[0]*u_self[2]-0.3194382824999699*m0r[2]*u_other[2]-0.5*m0r[0]*u_other[2]+1.414213562373095*m1r[2]-0.5*u_self[0]*m0r[2]-0.5*u_other[0]*m0r[2]-0.4472135954999579*m0r[1]*u_self[1]-0.4472135954999579*m0r[1]*u_other[1]); 
  ...
  gkyl_mat_set(A,8,0,(-0.3194382824999699*m0r[2]*u_self[2])-0.5*m0r[0]*u_self[2]-0.3194382824999699*m0r[2]*u_other[2]-0.5*m0r[0]*u_other[2]+1.414213562373095*m1r[2]-0.5*u_self[0]*m0r[2]-0.5*u_other[0]*m0r[2]-0.4472135954999579*m0r[1]*u_self[1]-0.4472135954999579*m0r[1]*u_other[1]); 
  ...
  gkyl_mat_set(A,6,5,(-0.3194382824999699*m0r[2]*u_self[5])-0.5*m0r[0]*u_self[5]-0.3194382824999699*m0r[2]*u_other[5]-0.5*m0r[0]*u_other[5]+1.414213562373095*m1r[5]-0.4472135954999579*m0r[1]*u_self[4]-0.4472135954999579*m0r[1]*u_other[4]-0.5*m0r[2]*u_self[3]-0.5*m0r[2]*u_other[3]); 
  ...
  gkyl_mat_set(A,8,3,(-0.3194382824999699*m0r[2]*u_self[5])-0.5*m0r[0]*u_self[5]-0.3194382824999699*m0r[2]*u_other[5]-0.5*m0r[0]*u_other[5]+1.414213562373095*m1r[5]-0.4472135954999579*m0r[1]*u_self[4]-0.4472135954999579*m0r[1]*u_other[4]-0.5*m0r[2]*u_self[3]-0.5*m0r[2]*u_other[3]); 
  ...
  gkyl_mat_set(A,6,6,0.7071067811865475*ucMSelf[0]+0.7071067811865475*ucMOther[0]+2.82842712474619*m0r[0]-1.414213562373095*cEr[0]); 
  gkyl_mat_set(A,6,7,0.7071067811865475*ucMSelf[1]+0.7071067811865475*ucMOther[1]+2.82842712474619*m0r[1]-1.414213562373095*cEr[1]); 
  gkyl_mat_set(A,6,8,0.7071067811865475*ucMSelf[2]+0.7071067811865475*ucMOther[2]+2.82842712474619*m0r[2]-1.414213562373095*cEr[2]); 
  gkyl_mat_set(A,7,6,0.7071067811865475*ucMSelf[1]+0.7071067811865475*ucMOther[1]+2.82842712474619*m0r[1]-1.414213562373095*cEr[1]); 
  gkyl_mat_set(A,7,7,0.6324555320336759*ucMSelf[2]+0.6324555320336759*ucMOther[2]+2.529822128134705*m0r[2]-1.264911064067352*cEr[2]+0.7071067811865475*ucMSelf[0]+0.7071067811865475*ucMOther[0]+2.82842712474619*m0r[0]-1.414213562373095*cEr[0]); 
  gkyl_mat_set(A,7,8,0.6324555320336759*ucMSelf[1]+0.6324555320336759*ucMOther[1]+2.529822128134705*m0r[1]-1.264911064067352*cEr[1]); 
  gkyl_mat_set(A,8,6,0.7071067811865475*ucMSelf[2]+0.7071067811865475*ucMOther[2]+2.82842712474619*m0r[2]-1.414213562373095*cEr[2]); 
  gkyl_mat_set(A,8,7,0.6324555320336759*ucMSelf[1]+0.6324555320336759*ucMOther[1]+2.529822128134705*m0r[1]-1.264911064067352*cEr[1]); 
  gkyl_mat_set(A,8,8,0.4517539514526256*ucMSelf[2]+0.4517539514526256*ucMOther[2]+1.807015805810503*m0r[2]-0.9035079029052515*cEr[2]+0.7071067811865475*ucMSelf[0]+0.7071067811865475*ucMOther[0]+2.82842712474619*m0r[0]-1.414213562373095*cEr[0]); 
  ...
  enRHS[0] = (-(4.0*greene[2]*vtsq_self[2]*betaGreenep1*m_self)/(2.82842712474619*m_self+2.82842712474619*m_other))-(1.0*greene[2]*uSumSq[2]*betaGreenep1*m_self)/(2.82842712474619*m_self+2.82842712474619*m_other)-(4.0*greene[1]*vtsq_self[1]*betaGreenep1*m_self)/(2.82842712474619*m_self+2.82842712474619*m_other)-(1.0*greene[1]*uSumSq[1]*betaGreenep1*m_self)/(2.82842712474619*m_self+2.82842712474619*m_other)-(4.0*greene[0]*vtsq_self[0]*betaGreenep1*m_self)/(2.82842712474619*m_self+2.82842712474619*m_other)-(1.0*greene[0]*uSumSq[0]*betaGreenep1*m_self)/(2.82842712474619*m_self+2.82842712474619*m_other)+(4.0*greene[2]*vtsq_other[2]*betaGreenep1*m_other)/(2.82842712474619*m_self+2.82842712474619*m_other)+(greene[2]*uSumSq[2]*betaGreenep1*m_other)/(2.82842712474619*m_self+2.82842712474619*m_other)+(4.0*greene[1]*vtsq_other[1]*betaGreenep1*m_other)/(2.82842712474619*m_self+2.82842712474619*m_other)+(greene[1]*uSumSq[1]*betaGreenep1*m_other)/(2.82842712474619*m_self+2.82842712474619*m_other)+(4.0*greene[0]*vtsq_other[0]*betaGreenep1*m_other)/(2.82842712474619*m_self+2.82842712474619*m_other)+(greene[0]*uSumSq[0]*betaGreenep1*m_other)/(2.82842712474619*m_self+2.82842712474619*m_other)-1.0*uM1Self[0]-1.0*uM1Other[0]+2.0*m2r[0]; 
  enRHS[1] = (-(17.88854381999832*greene[1]*vtsq_self[2]*betaGreenep1*m_self)/(14.14213562373095*m_self+14.14213562373095*m_other))-(4.47213595499958*greene[1]*uSumSq[2]*betaGreenep1*m_self)/(14.14213562373095*m_self+14.14213562373095*m_other)-(17.88854381999832*vtsq_self[1]*greene[2]*betaGreenep1*m_self)/(14.14213562373095*m_self+14.14213562373095*m_other)-(4.47213595499958*uSumSq[1]*greene[2]*betaGreenep1*m_self)/(14.14213562373095*m_self+14.14213562373095*m_other)-(20.0*greene[0]*vtsq_self[1]*betaGreenep1*m_self)/(14.14213562373095*m_self+14.14213562373095*m_other)-(5.0*greene[0]*uSumSq[1]*betaGreenep1*m_self)/(14.14213562373095*m_self+14.14213562373095*m_other)-(20.0*vtsq_self[0]*greene[1]*betaGreenep1*m_self)/(14.14213562373095*m_self+14.14213562373095*m_other)-(5.0*uSumSq[0]*greene[1]*betaGreenep1*m_self)/(14.14213562373095*m_self+14.14213562373095*m_other)+(17.88854381999832*greene[1]*vtsq_other[2]*betaGreenep1*m_other)/(14.14213562373095*m_self+14.14213562373095*m_other)+(4.47213595499958*greene[1]*uSumSq[2]*betaGreenep1*m_other)/(14.14213562373095*m_self+14.14213562373095*m_other)+(17.88854381999832*vtsq_other[1]*greene[2]*betaGreenep1*m_other)/(14.14213562373095*m_self+14.14213562373095*m_other)+(4.47213595499958*uSumSq[1]*greene[2]*betaGreenep1*m_other)/(14.14213562373095*m_self+14.14213562373095*m_other)+(20.0*greene[0]*vtsq_other[1]*betaGreenep1*m_other)/(14.14213562373095*m_self+14.14213562373095*m_other)+(5.0*greene[0]*uSumSq[1]*betaGreenep1*m_other)/(14.14213562373095*m_self+14.14213562373095*m_other)+(20.0*vtsq_other[0]*greene[1]*betaGreenep1*m_other)/(14.14213562373095*m_self+14.14213562373095*m_other)+(5.0*uSumSq[0]*greene[1]*betaGreenep1*m_other)/(14.14213562373095*m_self+14.14213562373095*m_other)-1.0*uM1Self[1]-1.0*uM1Other[1]+2.0*m2r[1]; 
  enRHS[2] = (-(89.4427190999916*greene[2]*vtsq_self[2]*betaGreenep1*m_self)/(98.99494936611667*m_self+98.99494936611667*m_other))-(140.0*greene[0]*vtsq_self[2]*betaGreenep1*m_self)/(98.99494936611667*m_self+98.99494936611667*m_other)-(22.3606797749979*greene[2]*uSumSq[2]*betaGreenep1*m_self)/(98.99494936611667*m_self+98.99494936611667*m_other)-(35.0*greene[0]*uSumSq[2]*betaGreenep1*m_self)/(98.99494936611667*m_self+98.99494936611667*m_other)-(140.0*vtsq_self[0]*greene[2]*betaGreenep1*m_self)/(98.99494936611667*m_self+98.99494936611667*m_other)-(35.0*uSumSq[0]*greene[2]*betaGreenep1*m_self)/(98.99494936611667*m_self+98.99494936611667*m_other)-(125.2198067399882*greene[1]*vtsq_self[1]*betaGreenep1*m_self)/(98.99494936611667*m_self+98.99494936611667*m_other)-(31.30495168499705*greene[1]*uSumSq[1]*betaGreenep1*m_self)/(98.99494936611667*m_self+98.99494936611667*m_other)+(89.4427190999916*greene[2]*vtsq_other[2]*betaGreenep1*m_other)/(98.99494936611667*m_self+98.99494936611667*m_other)+(140.0*greene[0]*vtsq_other[2]*betaGreenep1*m_other)/(98.99494936611667*m_self+98.99494936611667*m_other)+(22.3606797749979*greene[2]*uSumSq[2]*betaGreenep1*m_other)/(98.99494936611667*m_self+98.99494936611667*m_other)+(35.0*greene[0]*uSumSq[2]*betaGreenep1*m_other)/(98.99494936611667*m_self+98.99494936611667*m_other)+(140.0*vtsq_other[0]*greene[2]*betaGreenep1*m_other)/(98.99494936611667*m_self+98.99494936611667*m_other)+(35.0*uSumSq[0]*greene[2]*betaGreenep1*m_other)/(98.99494936611667*m_self+98.99494936611667*m_other)+(125.2198067399882*greene[1]*vtsq_other[1]*betaGreenep1*m_other)/(98.99494936611667*m_self+98.99494936611667*m_other)+(31.30495168499705*greene[1]*uSumSq[1]*betaGreenep1*m_other)/(98.99494936611667*m_self+98.99494936611667*m_other)-1.0*uM1Self[2]-1.0*uM1Other[2]+2.0*m2r[2]; 
