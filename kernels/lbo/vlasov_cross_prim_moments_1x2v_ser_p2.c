...
{ 
  ...
  gkyl_mat_set(A,15,6,0.7071067811865475*ucMSelf[0]*mnu+0.7071067811865475*ucMOther[0]*mnu+2.82842712474619*m0r[0]*mnu-1.414213562373095*cEr[0]*mnu); 
  gkyl_mat_set(A,15,7,0.7071067811865475*ucMSelf[1]*mnu+0.7071067811865475*ucMOther[1]*mnu+2.82842712474619*m0r[1]*mnu-1.414213562373095*cEr[1]*mnu); 
  gkyl_mat_set(A,15,8,0.7071067811865475*ucMSelf[2]*mnu+0.7071067811865475*ucMOther[2]*mnu+2.82842712474619*m0r[2]*mnu-1.414213562373095*cEr[2]*mnu); 
  gkyl_mat_set(A,16,6,0.7071067811865475*ucMSelf[1]*mnu+0.7071067811865475*ucMOther[1]*mnu+2.82842712474619*m0r[1]*mnu-1.414213562373095*cEr[1]*mnu); 
  gkyl_mat_set(A,16,7,0.6324555320336759*ucMSelf[2]*mnu+0.6324555320336759*ucMOther[2]*mnu+2.529822128134705*m0r[2]*mnu-1.264911064067352*cEr[2]*mnu+0.7071067811865475*ucMSelf[0]*mnu+0.7071067811865475*ucMOther[0]*mnu+2.82842712474619*m0r[0]*mnu-1.414213562373095*cEr[0]*mnu); 
  gkyl_mat_set(A,16,8,0.6324555320336759*ucMSelf[1]*mnu+0.6324555320336759*ucMOther[1]*mnu+2.529822128134705*m0r[1]*mnu-1.264911064067352*cEr[1]*mnu); 
  gkyl_mat_set(A,17,6,0.7071067811865475*ucMSelf[2]*mnu+0.7071067811865475*ucMOther[2]*mnu+2.82842712474619*m0r[2]*mnu-1.414213562373095*cEr[2]*mnu); 
  gkyl_mat_set(A,17,7,0.6324555320336759*ucMSelf[1]*mnu+0.6324555320336759*ucMOther[1]*mnu+2.529822128134705*m0r[1]*mnu-1.264911064067352*cEr[1]*mnu); 
  gkyl_mat_set(A,17,8,0.4517539514526256*ucMSelf[2]*mnu+0.4517539514526256*ucMOther[2]*mnu+1.807015805810503*m0r[2]*mnu-0.9035079029052515*cEr[2]*mnu+0.7071067811865475*ucMSelf[0]*mnu+0.7071067811865475*ucMOther[0]*mnu+2.82842712474619*m0r[0]*mnu-1.414213562373095*cEr[0]*mnu); 
