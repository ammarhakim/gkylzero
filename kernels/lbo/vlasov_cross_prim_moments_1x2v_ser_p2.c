...
{ 
  ...
  enRHS[0] = (-(4.0*greene[2]*vtsq_self[2]*m_self)/(2.82842712474619*m_self+2.82842712474619*m_other))-(1.0*greene[2]*uSumSq[2]*m_self)/(2.82842712474619*m_self+2.82842712474619*m_other)-(4.0*greene[1]*vtsq_self[1]*m_self)/(2.82842712474619*m_self+2.82842712474619*m_other)-(1.0*greene[1]*uSumSq[1]*m_self)/(2.82842712474619*m_self+2.82842712474619*m_other)-(4.0*greene[0]*vtsq_self[0]*m_self)/(2.82842712474619*m_self+2.82842712474619*m_other)-(1.0*greene[0]*uSumSq[0]*m_self)/(2.82842712474619*m_self+2.82842712474619*m_other)+(4.0*greene[2]*vtsq_other[2]*m_other)/(2.82842712474619*m_self+2.82842712474619*m_other)+(greene[2]*uSumSq[2]*m_other)/(2.82842712474619*m_self+2.82842712474619*m_other)+(4.0*greene[1]*vtsq_other[1]*m_other)/(2.82842712474619*m_self+2.82842712474619*m_other)+(greene[1]*uSumSq[1]*m_other)/(2.82842712474619*m_self+2.82842712474619*m_other)+(4.0*greene[0]*vtsq_other[0]*m_other)/(2.82842712474619*m_self+2.82842712474619*m_other)+(greene[0]*uSumSq[0]*m_other)/(2.82842712474619*m_self+2.82842712474619*m_other)-1.0*uM1Self[0]-1.0*uM1Other[0]+2.0*m2r[0]; 
