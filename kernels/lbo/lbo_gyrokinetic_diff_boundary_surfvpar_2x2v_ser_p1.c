...
{ 
  ...
  edgeSurf_incr[0] = 0.5*vmap_prime[2]*(nuVtSqSum[3]*edgeSurf[5]+edgeSurf[2]*nuVtSqSum[2]+edgeSurf[1]*nuVtSqSum[1]+edgeSurf[0]*nuVtSqSum[0]); 
  edgeSurf_incr[1] = 0.5*vmap_prime[2]*(nuVtSqSum[2]*edgeSurf[5]+edgeSurf[2]*nuVtSqSum[3]+edgeSurf[0]*nuVtSqSum[1]+nuVtSqSum[0]*edgeSurf[1]); 
  edgeSurf_incr[2] = 0.5*vmap_prime[2]*(nuVtSqSum[1]*edgeSurf[5]+edgeSurf[1]*nuVtSqSum[3]+edgeSurf[0]*nuVtSqSum[2]+nuVtSqSum[0]*edgeSurf[2]); 
  edgeSurf_incr[3] = 0.5*vmap_prime[2]*(nuVtSqSum[3]*edgeSurf[11]+nuVtSqSum[2]*edgeSurf[7]+nuVtSqSum[1]*edgeSurf[6]+nuVtSqSum[0]*edgeSurf[3]); 
  edgeSurf_incr[4] = 0.5*vmap_prime[2]*(nuVtSqSum[3]*edgeSurf[12]+nuVtSqSum[2]*edgeSurf[9]+nuVtSqSum[1]*edgeSurf[8]+nuVtSqSum[0]*edgeSurf[4]); 
  edgeSurf_incr[5] = 0.5*vmap_prime[2]*(nuVtSqSum[0]*edgeSurf[5]+edgeSurf[0]*nuVtSqSum[3]+edgeSurf[1]*nuVtSqSum[2]+nuVtSqSum[1]*edgeSurf[2]); 
  edgeSurf_incr[6] = 0.5*vmap_prime[2]*(nuVtSqSum[2]*edgeSurf[11]+nuVtSqSum[3]*edgeSurf[7]+nuVtSqSum[0]*edgeSurf[6]+nuVtSqSum[1]*edgeSurf[3]); 
  edgeSurf_incr[7] = 0.5*vmap_prime[2]*(nuVtSqSum[1]*edgeSurf[11]+nuVtSqSum[0]*edgeSurf[7]+nuVtSqSum[3]*edgeSurf[6]+nuVtSqSum[2]*edgeSurf[3]); 
  edgeSurf_incr[8] = 0.5*vmap_prime[2]*(nuVtSqSum[2]*edgeSurf[12]+nuVtSqSum[3]*edgeSurf[9]+nuVtSqSum[0]*edgeSurf[8]+nuVtSqSum[1]*edgeSurf[4]); 
  edgeSurf_incr[9] = 0.5*vmap_prime[2]*(nuVtSqSum[1]*edgeSurf[12]+nuVtSqSum[0]*edgeSurf[9]+nuVtSqSum[3]*edgeSurf[8]+nuVtSqSum[2]*edgeSurf[4]); 
  edgeSurf_incr[10] = 0.5*vmap_prime[2]*(nuVtSqSum[3]*edgeSurf[15]+nuVtSqSum[2]*edgeSurf[14]+nuVtSqSum[1]*edgeSurf[13]+nuVtSqSum[0]*edgeSurf[10]); 
  edgeSurf_incr[11] = 0.5*vmap_prime[2]*(nuVtSqSum[0]*edgeSurf[11]+nuVtSqSum[1]*edgeSurf[7]+nuVtSqSum[2]*edgeSurf[6]+edgeSurf[3]*nuVtSqSum[3]); 
  edgeSurf_incr[12] = 0.5*vmap_prime[2]*(nuVtSqSum[0]*edgeSurf[12]+nuVtSqSum[1]*edgeSurf[9]+nuVtSqSum[2]*edgeSurf[8]+nuVtSqSum[3]*edgeSurf[4]); 
  edgeSurf_incr[13] = 0.5*vmap_prime[2]*(nuVtSqSum[2]*edgeSurf[15]+nuVtSqSum[3]*edgeSurf[14]+nuVtSqSum[0]*edgeSurf[13]+nuVtSqSum[1]*edgeSurf[10]); 
  edgeSurf_incr[14] = 0.5*vmap_prime[2]*(nuVtSqSum[1]*edgeSurf[15]+nuVtSqSum[0]*edgeSurf[14]+nuVtSqSum[3]*edgeSurf[13]+nuVtSqSum[2]*edgeSurf[10]); 
  edgeSurf_incr[15] = 0.5*vmap_prime[2]*(nuVtSqSum[0]*edgeSurf[15]+nuVtSqSum[1]*edgeSurf[14]+nuVtSqSum[2]*edgeSurf[13]+nuVtSqSum[3]*edgeSurf[10]); 
  edgeSurf_incr[16] = 0.03333333333333333*vmap_prime[2]*(15.0*nuVtSqSum[3]*edgeSurf[20]+15.0*(nuVtSqSum[2]*edgeSurf[18]+nuVtSqSum[1]*edgeSurf[17])+15.0*nuVtSqSum[0]*edgeSurf[16]); 
  edgeSurf_incr[17] = 0.03333333333333333*vmap_prime[2]*(15.0*nuVtSqSum[2]*edgeSurf[20]+15.0*(nuVtSqSum[3]*edgeSurf[18]+nuVtSqSum[0]*edgeSurf[17])+15.0*nuVtSqSum[1]*edgeSurf[16]); 
  edgeSurf_incr[18] = 0.03333333333333333*vmap_prime[2]*(15.0*nuVtSqSum[1]*edgeSurf[20]+15.0*(nuVtSqSum[0]*edgeSurf[18]+nuVtSqSum[3]*edgeSurf[17])+15.0*nuVtSqSum[2]*edgeSurf[16]); 
  edgeSurf_incr[19] = 0.03333333333333333*vmap_prime[2]*(15.0*nuVtSqSum[3]*edgeSurf[23]+15.0*(nuVtSqSum[2]*edgeSurf[22]+nuVtSqSum[1]*edgeSurf[21])+15.0*nuVtSqSum[0]*edgeSurf[19]); 
  edgeSurf_incr[20] = 0.03333333333333333*vmap_prime[2]*(15.0*nuVtSqSum[0]*edgeSurf[20]+15.0*(nuVtSqSum[1]*edgeSurf[18]+nuVtSqSum[2]*edgeSurf[17])+15.0*nuVtSqSum[3]*edgeSurf[16]); 
  edgeSurf_incr[21] = 0.03333333333333333*vmap_prime[2]*(15.0*nuVtSqSum[2]*edgeSurf[23]+15.0*(nuVtSqSum[3]*edgeSurf[22]+nuVtSqSum[0]*edgeSurf[21])+15.0*nuVtSqSum[1]*edgeSurf[19]); 
  edgeSurf_incr[22] = 0.03333333333333333*vmap_prime[2]*(15.0*nuVtSqSum[1]*edgeSurf[23]+15.0*(nuVtSqSum[0]*edgeSurf[22]+nuVtSqSum[3]*edgeSurf[21])+15.0*nuVtSqSum[2]*edgeSurf[19]); 
  edgeSurf_incr[23] = 0.03333333333333333*vmap_prime[2]*(15.0*nuVtSqSum[0]*edgeSurf[23]+15.0*(nuVtSqSum[1]*edgeSurf[22]+nuVtSqSum[2]*edgeSurf[21])+15.0*nuVtSqSum[3]*edgeSurf[19]); 
