...
GKYL_CU_DH double lbo_vlasov_vmap_drag_boundary_surfvz_1x3v_tensor_p2(const double *w, const double *dxv, const double *vmap, const double *jacob_vel_inv, const double *nuSum, const double *nuPrimMomsSum, const int edge, const double *fSkin, const double *fEdge, double* GKYL_RESTRICT out) 
{ 
  ...
  alphaDrSurf[0] = nuSum[0]*((5.916079783099617*jacob_vel_inv2[2]+4.58257569495584*jacob_vel_inv2[1]+2.645751311064591*jacob_vel_inv2[0])*v2[3]+(5.0*jacob_vel_inv2[2]+3.872983346207417*jacob_vel_inv2[1]+2.23606797749979*jacob_vel_inv2[0])*v2[2])+(nuSum[0]*(3.872983346207417*v2[1]+2.23606797749979*v2[0])-3.16227766016838*sumNuUz[0])*jacob_vel_inv2[2]+nuSum[0]*(3.0*jacob_vel_inv2[1]+1.732050807568877*jacob_vel_inv2[0])*v2[1]+(1.732050807568877*nuSum[0]*v2[0]-2.449489742783178*sumNuUz[0])*jacob_vel_inv2[1]+jacob_vel_inv2[0]*(nuSum[0]*v2[0]-1.414213562373095*sumNuUz[0]); 
  alphaDrSurf[1] = nuSum[1]*((5.916079783099617*jacob_vel_inv2[2]+4.58257569495584*jacob_vel_inv2[1]+2.645751311064591*jacob_vel_inv2[0])*v2[3]+(5.0*jacob_vel_inv2[2]+3.872983346207417*jacob_vel_inv2[1]+2.23606797749979*jacob_vel_inv2[0])*v2[2])+(3.872983346207417*nuSum[1]*v2[1]-3.16227766016838*sumNuUz[1]+2.23606797749979*v2[0]*nuSum[1])*jacob_vel_inv2[2]+(3.0*jacob_vel_inv2[1]+1.732050807568877*jacob_vel_inv2[0])*nuSum[1]*v2[1]+((-2.449489742783178*jacob_vel_inv2[1])-1.414213562373095*jacob_vel_inv2[0])*sumNuUz[1]+v2[0]*(1.732050807568877*jacob_vel_inv2[1]+jacob_vel_inv2[0])*nuSum[1]; 
  alphaDrSurf[7] = nuSum[2]*((5.916079783099617*jacob_vel_inv2[2]+4.58257569495584*jacob_vel_inv2[1]+2.645751311064591*jacob_vel_inv2[0])*v2[3]+(5.0*jacob_vel_inv2[2]+3.872983346207417*jacob_vel_inv2[1]+2.23606797749979*jacob_vel_inv2[0])*v2[2])+((-3.16227766016838*jacob_vel_inv2[2])-2.449489742783178*jacob_vel_inv2[1]-1.414213562373095*jacob_vel_inv2[0])*sumNuUz[2]+((3.872983346207417*v2[1]+2.23606797749979*v2[0])*jacob_vel_inv2[2]+(3.0*jacob_vel_inv2[1]+1.732050807568877*jacob_vel_inv2[0])*v2[1]+v2[0]*(1.732050807568877*jacob_vel_inv2[1]+jacob_vel_inv2[0]))*nuSum[2]; 
  ...
  out[47] += 1.58113883008419*Ghat[7]*rdv2; 
  out[48] += 1.58113883008419*Ghat[8]*rdv2; 
  ...
  out[53] += 1.58113883008419*Ghat[10]*rdv2; 
  ...
  out[60] += 1.58113883008419*Ghat[11]*rdv2; 
  out[61] += 1.58113883008419*Ghat[12]*rdv2; 
  out[62] += 1.58113883008419*Ghat[13]*rdv2; 
  out[63] += 1.58113883008419*Ghat[14]*rdv2; 
  ...
  alphaDrSurf[0] = nuSum[0]*(((-5.916079783099617*jacob_vel_inv2[2])+4.58257569495584*jacob_vel_inv2[1]-2.645751311064591*jacob_vel_inv2[0])*v2[3]+(5.0*jacob_vel_inv2[2]-3.872983346207417*jacob_vel_inv2[1]+2.23606797749979*jacob_vel_inv2[0])*v2[2])+(nuSum[0]*(2.23606797749979*v2[0]-3.872983346207417*v2[1])-3.16227766016838*sumNuUz[0])*jacob_vel_inv2[2]+nuSum[0]*(3.0*jacob_vel_inv2[1]-1.732050807568877*jacob_vel_inv2[0])*v2[1]+(2.449489742783178*sumNuUz[0]-1.732050807568877*nuSum[0]*v2[0])*jacob_vel_inv2[1]+jacob_vel_inv2[0]*(nuSum[0]*v2[0]-1.414213562373095*sumNuUz[0]); 
  alphaDrSurf[1] = nuSum[1]*(((-5.916079783099617*jacob_vel_inv2[2])+4.58257569495584*jacob_vel_inv2[1]-2.645751311064591*jacob_vel_inv2[0])*v2[3]+(5.0*jacob_vel_inv2[2]-3.872983346207417*jacob_vel_inv2[1]+2.23606797749979*jacob_vel_inv2[0])*v2[2])+((-3.872983346207417*nuSum[1]*v2[1])-3.16227766016838*sumNuUz[1]+2.23606797749979*v2[0]*nuSum[1])*jacob_vel_inv2[2]+(3.0*jacob_vel_inv2[1]-1.732050807568877*jacob_vel_inv2[0])*nuSum[1]*v2[1]+(2.449489742783178*jacob_vel_inv2[1]-1.414213562373095*jacob_vel_inv2[0])*sumNuUz[1]+v2[0]*(jacob_vel_inv2[0]-1.732050807568877*jacob_vel_inv2[1])*nuSum[1]; 
  alphaDrSurf[7] = nuSum[2]*(((-5.916079783099617*jacob_vel_inv2[2])+4.58257569495584*jacob_vel_inv2[1]-2.645751311064591*jacob_vel_inv2[0])*v2[3]+(5.0*jacob_vel_inv2[2]-3.872983346207417*jacob_vel_inv2[1]+2.23606797749979*jacob_vel_inv2[0])*v2[2])+((-3.16227766016838*jacob_vel_inv2[2])+2.449489742783178*jacob_vel_inv2[1]-1.414213562373095*jacob_vel_inv2[0])*sumNuUz[2]+((2.23606797749979*v2[0]-3.872983346207417*v2[1])*jacob_vel_inv2[2]+(3.0*jacob_vel_inv2[1]-1.732050807568877*jacob_vel_inv2[0])*v2[1]+v2[0]*(jacob_vel_inv2[0]-1.732050807568877*jacob_vel_inv2[1]))*nuSum[2]; 
