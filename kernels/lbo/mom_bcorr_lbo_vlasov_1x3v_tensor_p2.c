...
{ 
  ...
  if (edge == GKYL_VX_LOWER) {
    ...
    out[11] += vBoundary[0]*((-3.16227766016838*fIn[44])+2.449489742783178*fIn[19]-1.414213562373095*fIn[11])*dS; 
    ...
    out[11] += vBoundary[3]*(3.16227766016838*fIn[44]+2.449489742783178*fIn[19]+1.414213562373095*fIn[11])*dS; 
  }
  ...
  if (edge == GKYL_VY_LOWER) {
    ...
    out[11] += vBoundary[1]*((-3.16227766016838*fIn[45])+2.449489742783178*fIn[21]-1.414213562373095*fIn[11])*dS; 
    ...
    out[11] += vBoundary[4]*(3.16227766016838*fIn[45]+2.449489742783178*fIn[21]+1.414213562373095*fIn[11])*dS; 
  }
  ...
  if (edge == GKYL_VZ_LOWER) {
    ...
    out[11] += vBoundary[2]*((-3.16227766016838*fIn[47])+2.449489742783178*fIn[25]-1.414213562373095*fIn[11])*dS; 
    ...
    out[11] += vBoundary[5]*(3.16227766016838*fIn[47]+2.449489742783178*fIn[25]+1.414213562373095*fIn[11])*dS; 
  }
