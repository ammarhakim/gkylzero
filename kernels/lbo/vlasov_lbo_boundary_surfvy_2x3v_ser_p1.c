...
GKYL_CU_DH void vlasov_lbo_boundary_surfvy_2x3v_ser_p1(const double *w, const double *dxv, const double *nuSum, const double *nuUSum, const double *nuVtSqSum, const int edge, const double *fSkin, const double *fEdge, double* GKYL_RESTRICT out) 
{ 
  ...
  alphaDrSurf[0] = nuSum[0]*(4.0*w[3]+2.0*dxv[3])-2.0*sumNuUy[0]; 
  alphaDrSurf[1] = -2.0*sumNuUy[1]; 
  alphaDrSurf[2] = -2.0*sumNuUy[2]; 
  alphaDrSurf[5] = -2.0*sumNuUy[3]; 
  ...
  Gdiff2[0] = 0.2041241452319315*nuVtSqSum[3]*fSkin[17]-0.2041241452319315*nuVtSqSum[3]*fEdge[17]+0.2041241452319315*nuVtSqSum[2]*fSkin[10]-0.2041241452319315*nuVtSqSum[2]*fEdge[10]+0.2041241452319315*nuVtSqSum[1]*fSkin[9]-0.2041241452319315*nuVtSqSum[1]*fEdge[9]+0.1767766952966368*nuVtSqSum[3]*fSkin[6]+0.1767766952966368*nuVtSqSum[3]*fEdge[6]+0.2041241452319315*nuVtSqSum[0]*fSkin[4]-0.2041241452319315*nuVtSqSum[0]*fEdge[4]+0.1767766952966368*fSkin[2]*nuVtSqSum[2]+0.1767766952966368*fEdge[2]*nuVtSqSum[2]+0.1767766952966368*fSkin[1]*nuVtSqSum[1]+0.1767766952966368*fEdge[1]*nuVtSqSum[1]+0.1767766952966368*fSkin[0]*nuVtSqSum[0]+0.1767766952966368*fEdge[0]*nuVtSqSum[0]; 
  Gdiff2[1] = 0.2041241452319315*nuVtSqSum[2]*fSkin[17]-0.2041241452319315*nuVtSqSum[2]*fEdge[17]+0.2041241452319315*nuVtSqSum[3]*fSkin[10]-0.2041241452319315*nuVtSqSum[3]*fEdge[10]+0.2041241452319315*nuVtSqSum[0]*fSkin[9]-0.2041241452319315*nuVtSqSum[0]*fEdge[9]+0.1767766952966368*nuVtSqSum[2]*fSkin[6]+0.1767766952966368*nuVtSqSum[2]*fEdge[6]+0.2041241452319315*nuVtSqSum[1]*fSkin[4]-0.2041241452319315*nuVtSqSum[1]*fEdge[4]+0.1767766952966368*fSkin[2]*nuVtSqSum[3]+0.1767766952966368*fEdge[2]*nuVtSqSum[3]+0.1767766952966368*fSkin[0]*nuVtSqSum[1]+0.1767766952966368*fEdge[0]*nuVtSqSum[1]+0.1767766952966368*nuVtSqSum[0]*fSkin[1]+0.1767766952966368*nuVtSqSum[0]*fEdge[1]; 
  Gdiff2[2] = 0.2041241452319315*nuVtSqSum[1]*fSkin[17]-0.2041241452319315*nuVtSqSum[1]*fEdge[17]+0.2041241452319315*nuVtSqSum[0]*fSkin[10]-0.2041241452319315*nuVtSqSum[0]*fEdge[10]+0.2041241452319315*nuVtSqSum[3]*fSkin[9]-0.2041241452319315*nuVtSqSum[3]*fEdge[9]+0.1767766952966368*nuVtSqSum[1]*fSkin[6]+0.1767766952966368*nuVtSqSum[1]*fEdge[6]+0.2041241452319315*nuVtSqSum[2]*fSkin[4]-0.2041241452319315*nuVtSqSum[2]*fEdge[4]+0.1767766952966368*fSkin[1]*nuVtSqSum[3]+0.1767766952966368*fEdge[1]*nuVtSqSum[3]+0.1767766952966368*fSkin[0]*nuVtSqSum[2]+0.1767766952966368*fEdge[0]*nuVtSqSum[2]+0.1767766952966368*nuVtSqSum[0]*fSkin[2]+0.1767766952966368*nuVtSqSum[0]*fEdge[2]; 
  Gdiff2[3] = 0.2041241452319315*nuVtSqSum[3]*fSkin[26]-0.2041241452319315*nuVtSqSum[3]*fEdge[26]+0.2041241452319315*nuVtSqSum[2]*fSkin[19]-0.2041241452319315*nuVtSqSum[2]*fEdge[19]+0.2041241452319315*nuVtSqSum[1]*fSkin[18]-0.2041241452319315*nuVtSqSum[1]*fEdge[18]+0.1767766952966368*nuVtSqSum[3]*fSkin[16]+0.1767766952966368*nuVtSqSum[3]*fEdge[16]+0.2041241452319315*nuVtSqSum[0]*fSkin[11]-0.2041241452319315*nuVtSqSum[0]*fEdge[11]+0.1767766952966368*nuVtSqSum[2]*fSkin[8]+0.1767766952966368*nuVtSqSum[2]*fEdge[8]+0.1767766952966368*nuVtSqSum[1]*fSkin[7]+0.1767766952966368*nuVtSqSum[1]*fEdge[7]+0.1767766952966368*nuVtSqSum[0]*fSkin[3]+0.1767766952966368*nuVtSqSum[0]*fEdge[3]; 
  Gdiff2[4] = 0.2041241452319315*nuVtSqSum[3]*fSkin[28]-0.2041241452319315*nuVtSqSum[3]*fEdge[28]+0.2041241452319315*nuVtSqSum[2]*fSkin[24]-0.2041241452319315*nuVtSqSum[2]*fEdge[24]+0.2041241452319315*nuVtSqSum[1]*fSkin[23]-0.2041241452319315*nuVtSqSum[1]*fEdge[23]+0.1767766952966368*nuVtSqSum[3]*fSkin[20]+0.1767766952966368*nuVtSqSum[3]*fEdge[20]+0.2041241452319315*nuVtSqSum[0]*fSkin[15]-0.2041241452319315*nuVtSqSum[0]*fEdge[15]+0.1767766952966368*nuVtSqSum[2]*fSkin[13]+0.1767766952966368*nuVtSqSum[2]*fEdge[13]+0.1767766952966368*nuVtSqSum[1]*fSkin[12]+0.1767766952966368*nuVtSqSum[1]*fEdge[12]+0.1767766952966368*nuVtSqSum[0]*fSkin[5]+0.1767766952966368*nuVtSqSum[0]*fEdge[5]; 
  Gdiff2[5] = 0.2041241452319315*nuVtSqSum[0]*fSkin[17]-0.2041241452319315*nuVtSqSum[0]*fEdge[17]+0.2041241452319315*nuVtSqSum[1]*fSkin[10]-0.2041241452319315*nuVtSqSum[1]*fEdge[10]+0.2041241452319315*nuVtSqSum[2]*fSkin[9]-0.2041241452319315*nuVtSqSum[2]*fEdge[9]+0.1767766952966368*nuVtSqSum[0]*fSkin[6]+0.1767766952966368*nuVtSqSum[0]*fEdge[6]+0.2041241452319315*nuVtSqSum[3]*fSkin[4]-0.2041241452319315*nuVtSqSum[3]*fEdge[4]+0.1767766952966368*fSkin[0]*nuVtSqSum[3]+0.1767766952966368*fEdge[0]*nuVtSqSum[3]+0.1767766952966368*fSkin[1]*nuVtSqSum[2]+0.1767766952966368*fEdge[1]*nuVtSqSum[2]+0.1767766952966368*nuVtSqSum[1]*fSkin[2]+0.1767766952966368*nuVtSqSum[1]*fEdge[2]; 
  Gdiff2[6] = 0.2041241452319315*nuVtSqSum[2]*fSkin[26]-0.2041241452319315*nuVtSqSum[2]*fEdge[26]+0.2041241452319315*nuVtSqSum[3]*fSkin[19]-0.2041241452319315*nuVtSqSum[3]*fEdge[19]+0.2041241452319315*nuVtSqSum[0]*fSkin[18]-0.2041241452319315*nuVtSqSum[0]*fEdge[18]+0.1767766952966368*nuVtSqSum[2]*fSkin[16]+0.1767766952966368*nuVtSqSum[2]*fEdge[16]+0.2041241452319315*nuVtSqSum[1]*fSkin[11]-0.2041241452319315*nuVtSqSum[1]*fEdge[11]+0.1767766952966368*nuVtSqSum[3]*fSkin[8]+0.1767766952966368*nuVtSqSum[3]*fEdge[8]+0.1767766952966368*nuVtSqSum[0]*fSkin[7]+0.1767766952966368*nuVtSqSum[0]*fEdge[7]+0.1767766952966368*nuVtSqSum[1]*fSkin[3]+0.1767766952966368*nuVtSqSum[1]*fEdge[3]; 
  Gdiff2[7] = 0.2041241452319315*nuVtSqSum[1]*fSkin[26]-0.2041241452319315*nuVtSqSum[1]*fEdge[26]+0.2041241452319315*nuVtSqSum[0]*fSkin[19]-0.2041241452319315*nuVtSqSum[0]*fEdge[19]+0.2041241452319315*nuVtSqSum[3]*fSkin[18]-0.2041241452319315*nuVtSqSum[3]*fEdge[18]+0.1767766952966368*nuVtSqSum[1]*fSkin[16]+0.1767766952966368*nuVtSqSum[1]*fEdge[16]+0.2041241452319315*nuVtSqSum[2]*fSkin[11]-0.2041241452319315*nuVtSqSum[2]*fEdge[11]+0.1767766952966368*nuVtSqSum[0]*fSkin[8]+0.1767766952966368*nuVtSqSum[0]*fEdge[8]+0.1767766952966368*nuVtSqSum[3]*fSkin[7]+0.1767766952966368*nuVtSqSum[3]*fEdge[7]+0.1767766952966368*nuVtSqSum[2]*fSkin[3]+0.1767766952966368*nuVtSqSum[2]*fEdge[3]; 
  Gdiff2[8] = 0.2041241452319315*nuVtSqSum[2]*fSkin[28]-0.2041241452319315*nuVtSqSum[2]*fEdge[28]+0.2041241452319315*nuVtSqSum[3]*fSkin[24]-0.2041241452319315*nuVtSqSum[3]*fEdge[24]+0.2041241452319315*nuVtSqSum[0]*fSkin[23]-0.2041241452319315*nuVtSqSum[0]*fEdge[23]+0.1767766952966368*nuVtSqSum[2]*fSkin[20]+0.1767766952966368*nuVtSqSum[2]*fEdge[20]+0.2041241452319315*nuVtSqSum[1]*fSkin[15]-0.2041241452319315*nuVtSqSum[1]*fEdge[15]+0.1767766952966368*nuVtSqSum[3]*fSkin[13]+0.1767766952966368*nuVtSqSum[3]*fEdge[13]+0.1767766952966368*nuVtSqSum[0]*fSkin[12]+0.1767766952966368*nuVtSqSum[0]*fEdge[12]+0.1767766952966368*nuVtSqSum[1]*fSkin[5]+0.1767766952966368*nuVtSqSum[1]*fEdge[5]; 
  Gdiff2[9] = 0.2041241452319315*nuVtSqSum[1]*fSkin[28]-0.2041241452319315*nuVtSqSum[1]*fEdge[28]+0.2041241452319315*nuVtSqSum[0]*fSkin[24]-0.2041241452319315*nuVtSqSum[0]*fEdge[24]+0.2041241452319315*nuVtSqSum[3]*fSkin[23]-0.2041241452319315*nuVtSqSum[3]*fEdge[23]+0.1767766952966368*nuVtSqSum[1]*fSkin[20]+0.1767766952966368*nuVtSqSum[1]*fEdge[20]+0.2041241452319315*nuVtSqSum[2]*fSkin[15]-0.2041241452319315*nuVtSqSum[2]*fEdge[15]+0.1767766952966368*nuVtSqSum[0]*fSkin[13]+0.1767766952966368*nuVtSqSum[0]*fEdge[13]+0.1767766952966368*nuVtSqSum[3]*fSkin[12]+0.1767766952966368*nuVtSqSum[3]*fEdge[12]+0.1767766952966368*nuVtSqSum[2]*fSkin[5]+0.1767766952966368*nuVtSqSum[2]*fEdge[5]; 
  Gdiff2[10] = 0.2041241452319315*nuVtSqSum[3]*fSkin[31]-0.2041241452319315*nuVtSqSum[3]*fEdge[31]+0.2041241452319315*nuVtSqSum[2]*fSkin[30]-0.2041241452319315*nuVtSqSum[2]*fEdge[30]+0.2041241452319315*nuVtSqSum[1]*fSkin[29]-0.2041241452319315*nuVtSqSum[1]*fEdge[29]+0.1767766952966368*nuVtSqSum[3]*fSkin[27]+0.1767766952966368*nuVtSqSum[3]*fEdge[27]+0.2041241452319315*nuVtSqSum[0]*fSkin[25]-0.2041241452319315*nuVtSqSum[0]*fEdge[25]+0.1767766952966368*nuVtSqSum[2]*fSkin[22]+0.1767766952966368*nuVtSqSum[2]*fEdge[22]+0.1767766952966368*nuVtSqSum[1]*fSkin[21]+0.1767766952966368*nuVtSqSum[1]*fEdge[21]+0.1767766952966368*nuVtSqSum[0]*fSkin[14]+0.1767766952966368*nuVtSqSum[0]*fEdge[14]; 
  Gdiff2[11] = 0.2041241452319315*nuVtSqSum[0]*fSkin[26]-0.2041241452319315*nuVtSqSum[0]*fEdge[26]+0.2041241452319315*nuVtSqSum[1]*fSkin[19]-0.2041241452319315*nuVtSqSum[1]*fEdge[19]+0.2041241452319315*nuVtSqSum[2]*fSkin[18]-0.2041241452319315*nuVtSqSum[2]*fEdge[18]+0.1767766952966368*nuVtSqSum[0]*fSkin[16]+0.1767766952966368*nuVtSqSum[0]*fEdge[16]+0.2041241452319315*nuVtSqSum[3]*fSkin[11]-0.2041241452319315*nuVtSqSum[3]*fEdge[11]+0.1767766952966368*nuVtSqSum[1]*fSkin[8]+0.1767766952966368*nuVtSqSum[1]*fEdge[8]+0.1767766952966368*nuVtSqSum[2]*fSkin[7]+0.1767766952966368*nuVtSqSum[2]*fEdge[7]+0.1767766952966368*fSkin[3]*nuVtSqSum[3]+0.1767766952966368*fEdge[3]*nuVtSqSum[3]; 
  Gdiff2[12] = 0.2041241452319315*nuVtSqSum[0]*fSkin[28]-0.2041241452319315*nuVtSqSum[0]*fEdge[28]+0.2041241452319315*nuVtSqSum[1]*fSkin[24]-0.2041241452319315*nuVtSqSum[1]*fEdge[24]+0.2041241452319315*nuVtSqSum[2]*fSkin[23]-0.2041241452319315*nuVtSqSum[2]*fEdge[23]+0.1767766952966368*nuVtSqSum[0]*fSkin[20]+0.1767766952966368*nuVtSqSum[0]*fEdge[20]+0.2041241452319315*nuVtSqSum[3]*fSkin[15]-0.2041241452319315*nuVtSqSum[3]*fEdge[15]+0.1767766952966368*nuVtSqSum[1]*fSkin[13]+0.1767766952966368*nuVtSqSum[1]*fEdge[13]+0.1767766952966368*nuVtSqSum[2]*fSkin[12]+0.1767766952966368*nuVtSqSum[2]*fEdge[12]+0.1767766952966368*nuVtSqSum[3]*fSkin[5]+0.1767766952966368*nuVtSqSum[3]*fEdge[5]; 
  Gdiff2[13] = 0.2041241452319315*nuVtSqSum[2]*fSkin[31]-0.2041241452319315*nuVtSqSum[2]*fEdge[31]+0.2041241452319315*nuVtSqSum[3]*fSkin[30]-0.2041241452319315*nuVtSqSum[3]*fEdge[30]+0.2041241452319315*nuVtSqSum[0]*fSkin[29]-0.2041241452319315*nuVtSqSum[0]*fEdge[29]+0.1767766952966368*nuVtSqSum[2]*fSkin[27]+0.1767766952966368*nuVtSqSum[2]*fEdge[27]+0.2041241452319315*nuVtSqSum[1]*fSkin[25]-0.2041241452319315*nuVtSqSum[1]*fEdge[25]+0.1767766952966368*nuVtSqSum[3]*fSkin[22]+0.1767766952966368*nuVtSqSum[3]*fEdge[22]+0.1767766952966368*nuVtSqSum[0]*fSkin[21]+0.1767766952966368*nuVtSqSum[0]*fEdge[21]+0.1767766952966368*nuVtSqSum[1]*fSkin[14]+0.1767766952966368*nuVtSqSum[1]*fEdge[14]; 
  Gdiff2[14] = 0.2041241452319315*nuVtSqSum[1]*fSkin[31]-0.2041241452319315*nuVtSqSum[1]*fEdge[31]+0.2041241452319315*nuVtSqSum[0]*fSkin[30]-0.2041241452319315*nuVtSqSum[0]*fEdge[30]+0.2041241452319315*nuVtSqSum[3]*fSkin[29]-0.2041241452319315*nuVtSqSum[3]*fEdge[29]+0.1767766952966368*nuVtSqSum[1]*fSkin[27]+0.1767766952966368*nuVtSqSum[1]*fEdge[27]+0.2041241452319315*nuVtSqSum[2]*fSkin[25]-0.2041241452319315*nuVtSqSum[2]*fEdge[25]+0.1767766952966368*nuVtSqSum[0]*fSkin[22]+0.1767766952966368*nuVtSqSum[0]*fEdge[22]+0.1767766952966368*nuVtSqSum[3]*fSkin[21]+0.1767766952966368*nuVtSqSum[3]*fEdge[21]+0.1767766952966368*nuVtSqSum[2]*fSkin[14]+0.1767766952966368*nuVtSqSum[2]*fEdge[14]; 
  Gdiff2[15] = 0.2041241452319315*nuVtSqSum[0]*fSkin[31]-0.2041241452319315*nuVtSqSum[0]*fEdge[31]+0.2041241452319315*nuVtSqSum[1]*fSkin[30]-0.2041241452319315*nuVtSqSum[1]*fEdge[30]+0.2041241452319315*nuVtSqSum[2]*fSkin[29]-0.2041241452319315*nuVtSqSum[2]*fEdge[29]+0.1767766952966368*nuVtSqSum[0]*fSkin[27]+0.1767766952966368*nuVtSqSum[0]*fEdge[27]+0.2041241452319315*nuVtSqSum[3]*fSkin[25]-0.2041241452319315*nuVtSqSum[3]*fEdge[25]+0.1767766952966368*nuVtSqSum[1]*fSkin[22]+0.1767766952966368*nuVtSqSum[1]*fEdge[22]+0.1767766952966368*nuVtSqSum[2]*fSkin[21]+0.1767766952966368*nuVtSqSum[2]*fEdge[21]+0.1767766952966368*nuVtSqSum[3]*fSkin[14]+0.1767766952966368*nuVtSqSum[3]*fEdge[14]; 

  Gdiff[0] = (-0.3827327723098713*nuVtSqSum[3]*fSkin[17])-0.3827327723098713*nuVtSqSum[3]*fEdge[17]-0.3827327723098713*nuVtSqSum[2]*fSkin[10]-0.3827327723098713*nuVtSqSum[2]*fEdge[10]-0.3827327723098713*nuVtSqSum[1]*fSkin[9]-0.3827327723098713*nuVtSqSum[1]*fEdge[9]-0.3977475644174328*nuVtSqSum[3]*fSkin[6]+0.3977475644174328*nuVtSqSum[3]*fEdge[6]-0.3827327723098713*nuVtSqSum[0]*fSkin[4]-0.3827327723098713*nuVtSqSum[0]*fEdge[4]-0.3977475644174328*fSkin[2]*nuVtSqSum[2]+0.3977475644174328*fEdge[2]*nuVtSqSum[2]-0.3977475644174328*fSkin[1]*nuVtSqSum[1]+0.3977475644174328*fEdge[1]*nuVtSqSum[1]-0.3977475644174328*fSkin[0]*nuVtSqSum[0]+0.3977475644174328*fEdge[0]*nuVtSqSum[0]; 
  Gdiff[1] = (-0.3827327723098713*nuVtSqSum[2]*fSkin[17])-0.3827327723098713*nuVtSqSum[2]*fEdge[17]-0.3827327723098713*nuVtSqSum[3]*fSkin[10]-0.3827327723098713*nuVtSqSum[3]*fEdge[10]-0.3827327723098713*nuVtSqSum[0]*fSkin[9]-0.3827327723098713*nuVtSqSum[0]*fEdge[9]-0.3977475644174328*nuVtSqSum[2]*fSkin[6]+0.3977475644174328*nuVtSqSum[2]*fEdge[6]-0.3827327723098713*nuVtSqSum[1]*fSkin[4]-0.3827327723098713*nuVtSqSum[1]*fEdge[4]-0.3977475644174328*fSkin[2]*nuVtSqSum[3]+0.3977475644174328*fEdge[2]*nuVtSqSum[3]-0.3977475644174328*fSkin[0]*nuVtSqSum[1]+0.3977475644174328*fEdge[0]*nuVtSqSum[1]-0.3977475644174328*nuVtSqSum[0]*fSkin[1]+0.3977475644174328*nuVtSqSum[0]*fEdge[1]; 
  Gdiff[2] = (-0.3827327723098713*nuVtSqSum[1]*fSkin[17])-0.3827327723098713*nuVtSqSum[1]*fEdge[17]-0.3827327723098713*nuVtSqSum[0]*fSkin[10]-0.3827327723098713*nuVtSqSum[0]*fEdge[10]-0.3827327723098713*nuVtSqSum[3]*fSkin[9]-0.3827327723098713*nuVtSqSum[3]*fEdge[9]-0.3977475644174328*nuVtSqSum[1]*fSkin[6]+0.3977475644174328*nuVtSqSum[1]*fEdge[6]-0.3827327723098713*nuVtSqSum[2]*fSkin[4]-0.3827327723098713*nuVtSqSum[2]*fEdge[4]-0.3977475644174328*fSkin[1]*nuVtSqSum[3]+0.3977475644174328*fEdge[1]*nuVtSqSum[3]-0.3977475644174328*fSkin[0]*nuVtSqSum[2]+0.3977475644174328*fEdge[0]*nuVtSqSum[2]-0.3977475644174328*nuVtSqSum[0]*fSkin[2]+0.3977475644174328*nuVtSqSum[0]*fEdge[2]; 
