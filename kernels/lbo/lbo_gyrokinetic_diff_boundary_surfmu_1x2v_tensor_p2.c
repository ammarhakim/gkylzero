...
GKYL_CU_DH void lbo_gyrokinetic_diff_boundary_surfmu_1x2v_tensor_p2(const double *w, const double *dxv, const double m_, const double *bmag_inv, const double *nuSum, const double *nuUSum, const double *nuVtSqSum, const int edge, const double *fedge, const double *fskin, double* GKYL_RESTRICT out) 
{ 
  ...
  vol_incr[14] = 0.6123724356957944*dxv[2]*facDiff[2]*fskin[20]*rdvSq4+0.6123724356957944*facDiff[1]*dxv[2]*fskin[12]*rdvSq4+0.6123724356957944*facDiff[0]*dxv[2]*fskin[8]*rdvSq4; 
  ...
  vol_incr[18] = 0.5477225575051661*facDiff[1]*dxv[2]*fskin[20]*rdvSq4+0.5477225575051661*dxv[2]*facDiff[2]*fskin[12]*rdvSq4+0.6123724356957944*facDiff[0]*dxv[2]*fskin[12]*rdvSq4+0.6123724356957944*facDiff[1]*dxv[2]*fskin[8]*rdvSq4; 
  ...
  vol_incr[21] = 1.749635530559413*dxv[2]*facDiff[2]*fskin[13]*rdvSq4+2.738612787525831*facDiff[0]*dxv[2]*fskin[13]*rdvSq4+3.030457633656632*facDiff[2]*w[2]*fskin[7]*rdvSq4+4.743416490252569*facDiff[0]*w[2]*fskin[7]*rdvSq4+2.449489742783178*facDiff[1]*dxv[2]*fskin[5]*rdvSq4+2.738612787525831*dxv[2]*facDiff[2]*fskin[3]*rdvSq4+4.743416490252569*fskin[0]*facDiff[2]*w[2]*rdvSq4+4.242640687119286*facDiff[1]*fskin[1]*w[2]*rdvSq4; 
  vol_incr[22] = 2.738612787525831*dxv[2]*facDiff[2]*fskin[23]*rdvSq4+4.743416490252569*facDiff[2]*w[2]*fskin[20]*rdvSq4+2.738612787525831*facDiff[1]*dxv[2]*fskin[18]*rdvSq4+2.738612787525831*facDiff[0]*dxv[2]*fskin[14]*rdvSq4+4.743416490252569*facDiff[1]*w[2]*fskin[12]*rdvSq4+4.743416490252569*facDiff[0]*w[2]*fskin[8]*rdvSq4; 
  vol_incr[23] = 0.3912303982179757*dxv[2]*facDiff[2]*fskin[20]*rdvSq4+0.6123724356957944*facDiff[0]*dxv[2]*fskin[20]*rdvSq4+0.5477225575051661*facDiff[1]*dxv[2]*fskin[12]*rdvSq4+0.6123724356957944*dxv[2]*facDiff[2]*fskin[8]*rdvSq4; 
  vol_incr[24] = 1.749635530559413*dxv[2]*facDiff[2]*fskin[17]*rdvSq4+2.738612787525831*facDiff[0]*dxv[2]*fskin[17]*rdvSq4+3.030457633656633*facDiff[2]*w[2]*fskin[11]*rdvSq4+4.743416490252569*facDiff[0]*w[2]*fskin[11]*rdvSq4+2.449489742783178*facDiff[1]*dxv[2]*fskin[10]*rdvSq4+2.738612787525831*dxv[2]*facDiff[2]*fskin[6]*rdvSq4+4.242640687119286*facDiff[1]*w[2]*fskin[4]*rdvSq4+4.743416490252569*facDiff[2]*fskin[2]*w[2]*rdvSq4; 
  vol_incr[25] = 2.449489742783178*facDiff[1]*dxv[2]*fskin[23]*rdvSq4+4.242640687119286*facDiff[1]*w[2]*fskin[20]*rdvSq4+2.449489742783178*dxv[2]*facDiff[2]*fskin[18]*rdvSq4+2.738612787525831*facDiff[0]*dxv[2]*fskin[18]*rdvSq4+2.738612787525831*facDiff[1]*dxv[2]*fskin[14]*rdvSq4+4.242640687119286*facDiff[2]*w[2]*fskin[12]*rdvSq4+4.743416490252569*facDiff[0]*w[2]*fskin[12]*rdvSq4+4.743416490252569*facDiff[1]*w[2]*fskin[8]*rdvSq4; 
  vol_incr[26] = 1.749635530559413*dxv[2]*facDiff[2]*fskin[23]*rdvSq4+2.738612787525831*facDiff[0]*dxv[2]*fskin[23]*rdvSq4+3.030457633656632*facDiff[2]*w[2]*fskin[20]*rdvSq4+4.743416490252569*facDiff[0]*w[2]*fskin[20]*rdvSq4+2.449489742783178*facDiff[1]*dxv[2]*fskin[18]*rdvSq4+2.738612787525831*dxv[2]*facDiff[2]*fskin[14]*rdvSq4+4.242640687119286*facDiff[1]*w[2]*fskin[12]*rdvSq4+4.743416490252569*facDiff[2]*w[2]*fskin[8]*rdvSq4; 

  double temp_diff[27] = {0.0}; 
  double temp_edge[27] = {0.0}; 
  double diff_incr[27] = {0.0}; 
  double edge_incr[27] = {0.0}; 
  ...
  temp_diff[7] = (-0.6708203932499369*w[2]*fskin[21])-0.3354101966249685*dxv[2]*fskin[21]+0.6708203932499369*w[2]*fedge[21]+0.3354101966249685*dxv[2]*fedge[21]-1.190784930203603*w[2]*fskin[13]-0.5953924651018015*dxv[2]*fskin[13]-1.190784930203603*w[2]*fedge[13]-0.5953924651018015*dxv[2]*fedge[13]-0.9375*w[2]*fskin[7]-0.46875*dxv[2]*fskin[7]+0.9375*w[2]*fedge[7]+0.46875*dxv[2]*fedge[7]; 
  temp_diff[8] = (-0.6708203932499369*w[2]*fskin[22])-0.3354101966249685*dxv[2]*fskin[22]+0.6708203932499369*w[2]*fedge[22]+0.3354101966249685*dxv[2]*fedge[22]-1.190784930203603*w[2]*fskin[14]-0.5953924651018015*dxv[2]*fskin[14]-1.190784930203603*w[2]*fedge[14]-0.5953924651018015*dxv[2]*fedge[14]-0.9375*w[2]*fskin[8]-0.46875*dxv[2]*fskin[8]+0.9375*w[2]*fedge[8]+0.46875*dxv[2]*fedge[8]; 
  ...
  temp_diff[12] = (-0.6708203932499369*w[2]*fskin[25])-0.3354101966249685*dxv[2]*fskin[25]+0.6708203932499369*w[2]*fedge[25]+0.3354101966249685*dxv[2]*fedge[25]-1.190784930203603*w[2]*fskin[18]-0.5953924651018015*dxv[2]*fskin[18]-1.190784930203603*w[2]*fedge[18]-0.5953924651018015*dxv[2]*fedge[18]-0.9375*w[2]*fskin[12]-0.46875*dxv[2]*fskin[12]+0.9375*w[2]*fedge[12]+0.46875*dxv[2]*fedge[12]; 
  temp_diff[13] = (-1.585502557353661*w[2]*fskin[21])-0.7927512786768306*dxv[2]*fskin[21]+0.7382874503707888*w[2]*fedge[21]+0.3691437251853944*dxv[2]*fedge[21]-2.671875*w[2]*fskin[13]-1.3359375*dxv[2]*fskin[13]-1.453125*w[2]*fedge[13]-0.7265625*dxv[2]*fedge[13]-2.056810333988042*w[2]*fskin[7]-1.028405166994021*dxv[2]*fskin[7]+1.190784930203603*w[2]*fedge[7]+0.5953924651018015*dxv[2]*fedge[7]; 
  temp_diff[14] = (-1.585502557353661*w[2]*fskin[22])-0.7927512786768306*dxv[2]*fskin[22]+0.7382874503707888*w[2]*fedge[22]+0.3691437251853944*dxv[2]*fedge[22]-2.671875*w[2]*fskin[14]-1.3359375*dxv[2]*fskin[14]-1.453125*w[2]*fedge[14]-0.7265625*dxv[2]*fedge[14]-2.056810333988042*w[2]*fskin[8]-1.028405166994021*dxv[2]*fskin[8]+1.190784930203603*w[2]*fedge[8]+0.5953924651018015*dxv[2]*fedge[8]; 
  ...
  temp_edge[13] = 1.936491673103709*w[2]*fskin[21]-0.9682458365518543*dxv[2]*fskin[21]-1.5*w[2]*fskin[13]+0.75*dxv[2]*fskin[13]+0.8660254037844387*w[2]*fskin[7]-0.4330127018922194*dxv[2]*fskin[7]; 
  temp_edge[14] = 1.936491673103709*w[2]*fskin[22]-0.9682458365518543*dxv[2]*fskin[22]-1.5*w[2]*fskin[14]+0.75*dxv[2]*fskin[14]+0.8660254037844387*w[2]*fskin[8]-0.4330127018922194*dxv[2]*fskin[8]; 
  ...
  temp_edge[17] = 1.936491673103709*w[2]*fskin[24]-0.9682458365518543*dxv[2]*fskin[24]-1.5*w[2]*fskin[17]+0.75*dxv[2]*fskin[17]+0.8660254037844387*w[2]*fskin[11]-0.4330127018922194*dxv[2]*fskin[11]; 
  temp_edge[18] = 1.936491673103709*w[2]*fskin[25]-0.9682458365518543*dxv[2]*fskin[25]-1.5*w[2]*fskin[18]+0.75*dxv[2]*fskin[18]+0.8660254037844387*w[2]*fskin[12]-0.4330127018922194*dxv[2]*fskin[12]; 
  ...
  temp_edge[21] = (-7.5*w[2]*fskin[21])+3.75*dxv[2]*fskin[21]+5.809475019311126*w[2]*fskin[13]-2.904737509655563*dxv[2]*fskin[13]-3.354101966249685*w[2]*fskin[7]+1.677050983124842*dxv[2]*fskin[7]; 
  temp_edge[22] = (-7.5*w[2]*fskin[22])+3.75*dxv[2]*fskin[22]+5.809475019311126*w[2]*fskin[14]-2.904737509655563*dxv[2]*fskin[14]-3.354101966249685*w[2]*fskin[8]+1.677050983124842*dxv[2]*fskin[8]; 
  temp_edge[23] = 1.936491673103709*w[2]*fskin[26]-0.9682458365518543*dxv[2]*fskin[26]-1.5*w[2]*fskin[23]+0.75*dxv[2]*fskin[23]+0.8660254037844386*w[2]*fskin[20]-0.4330127018922193*dxv[2]*fskin[20]; 
  temp_edge[24] = (-7.5*w[2]*fskin[24])+3.75*dxv[2]*fskin[24]+5.809475019311125*w[2]*fskin[17]-2.904737509655563*dxv[2]*fskin[17]-3.354101966249684*w[2]*fskin[11]+1.677050983124842*dxv[2]*fskin[11]; 
  temp_edge[25] = (-7.5*w[2]*fskin[25])+3.75*dxv[2]*fskin[25]+5.809475019311125*w[2]*fskin[18]-2.904737509655563*dxv[2]*fskin[18]-3.354101966249684*w[2]*fskin[12]+1.677050983124842*dxv[2]*fskin[12]; 
  temp_edge[26] = (-7.5*w[2]*fskin[26])+3.75*dxv[2]*fskin[26]+5.809475019311125*w[2]*fskin[23]-2.904737509655563*dxv[2]*fskin[23]-3.354101966249685*w[2]*fskin[20]+1.677050983124842*dxv[2]*fskin[20]; 
  ...
  diff_incr[8] = 0.7071067811865475*facDiff[2]*temp_diff[20]+0.7071067811865475*facDiff[1]*temp_diff[12]+0.7071067811865475*facDiff[0]*temp_diff[8]; 
  diff_incr[9] = 0.7071067811865475*facDiff[2]*temp_diff[21]+0.7071067811865475*facDiff[1]*temp_diff[15]+0.7071067811865475*facDiff[0]*temp_diff[9]; 
  ...
  diff_incr[12] = 0.632455532033676*facDiff[1]*temp_diff[20]+0.6324555320336759*facDiff[2]*temp_diff[12]+0.7071067811865475*facDiff[0]*temp_diff[12]+0.7071067811865475*facDiff[1]*temp_diff[8]; 
  ...
  diff_incr[14] = 0.7071067811865475*facDiff[2]*temp_diff[23]+0.7071067811865475*facDiff[1]*temp_diff[18]+0.7071067811865475*facDiff[0]*temp_diff[14]; 
  diff_incr[15] = 0.632455532033676*facDiff[1]*temp_diff[21]+0.6324555320336759*facDiff[2]*temp_diff[15]+0.7071067811865475*facDiff[0]*temp_diff[15]+0.7071067811865475*facDiff[1]*temp_diff[9]; 
  diff_incr[16] = 0.7071067811865475*facDiff[2]*temp_diff[24]+0.7071067811865475*facDiff[1]*temp_diff[19]+0.7071067811865475*facDiff[0]*temp_diff[16]; 
  ...
  diff_incr[18] = 0.6324555320336759*facDiff[1]*temp_diff[23]+0.6324555320336759*facDiff[2]*temp_diff[18]+0.7071067811865475*facDiff[0]*temp_diff[18]+0.7071067811865475*facDiff[1]*temp_diff[14]; 
  diff_incr[19] = 0.6324555320336759*facDiff[1]*temp_diff[24]+0.6324555320336759*facDiff[2]*temp_diff[19]+0.7071067811865475*facDiff[0]*temp_diff[19]+0.7071067811865475*facDiff[1]*temp_diff[16]; 
  diff_incr[20] = 0.4517539514526256*facDiff[2]*temp_diff[20]+0.7071067811865475*facDiff[0]*temp_diff[20]+0.632455532033676*facDiff[1]*temp_diff[12]+0.7071067811865475*facDiff[2]*temp_diff[8]; 
  diff_incr[21] = 0.4517539514526256*facDiff[2]*temp_diff[21]+0.7071067811865475*facDiff[0]*temp_diff[21]+0.632455532033676*facDiff[1]*temp_diff[15]+0.7071067811865475*facDiff[2]*temp_diff[9]; 
  diff_incr[22] = 0.7071067811865475*facDiff[2]*temp_diff[26]+0.7071067811865475*facDiff[1]*temp_diff[25]+0.7071067811865475*facDiff[0]*temp_diff[22]; 
  diff_incr[23] = 0.4517539514526256*facDiff[2]*temp_diff[23]+0.7071067811865475*facDiff[0]*temp_diff[23]+0.6324555320336759*facDiff[1]*temp_diff[18]+0.7071067811865475*facDiff[2]*temp_diff[14]; 
  diff_incr[24] = 0.4517539514526256*facDiff[2]*temp_diff[24]+0.7071067811865475*facDiff[0]*temp_diff[24]+0.6324555320336759*facDiff[1]*temp_diff[19]+0.7071067811865475*facDiff[2]*temp_diff[16]; 
  diff_incr[25] = 0.6324555320336759*facDiff[1]*temp_diff[26]+0.6324555320336759*facDiff[2]*temp_diff[25]+0.7071067811865475*facDiff[0]*temp_diff[25]+0.7071067811865475*facDiff[1]*temp_diff[22]; 
  diff_incr[26] = 0.4517539514526256*facDiff[2]*temp_diff[26]+0.7071067811865475*facDiff[0]*temp_diff[26]+0.6324555320336759*facDiff[1]*temp_diff[25]+0.7071067811865475*facDiff[2]*temp_diff[22]; 
  ...
  edge_incr[8] = 0.7071067811865475*facDiff[2]*temp_edge[20]+0.7071067811865475*facDiff[1]*temp_edge[12]+0.7071067811865475*facDiff[0]*temp_edge[8]; 
  edge_incr[9] = 0.7071067811865475*facDiff[2]*temp_edge[21]+0.7071067811865475*facDiff[1]*temp_edge[15]+0.7071067811865475*facDiff[0]*temp_edge[9]; 
  ...
  edge_incr[12] = 0.632455532033676*facDiff[1]*temp_edge[20]+0.6324555320336759*facDiff[2]*temp_edge[12]+0.7071067811865475*facDiff[0]*temp_edge[12]+0.7071067811865475*facDiff[1]*temp_edge[8]; 
  ...
  edge_incr[14] = 0.7071067811865475*facDiff[2]*temp_edge[23]+0.7071067811865475*facDiff[1]*temp_edge[18]+0.7071067811865475*facDiff[0]*temp_edge[14]; 
  edge_incr[15] = 0.632455532033676*facDiff[1]*temp_edge[21]+0.6324555320336759*facDiff[2]*temp_edge[15]+0.7071067811865475*facDiff[0]*temp_edge[15]+0.7071067811865475*facDiff[1]*temp_edge[9]; 
  edge_incr[16] = 0.7071067811865475*facDiff[2]*temp_edge[24]+0.7071067811865475*facDiff[1]*temp_edge[19]+0.7071067811865475*facDiff[0]*temp_edge[16]; 
  ...
  edge_incr[18] = 0.6324555320336759*facDiff[1]*temp_edge[23]+0.6324555320336759*facDiff[2]*temp_edge[18]+0.7071067811865475*facDiff[0]*temp_edge[18]+0.7071067811865475*facDiff[1]*temp_edge[14]; 
  edge_incr[19] = 0.6324555320336759*facDiff[1]*temp_edge[24]+0.6324555320336759*facDiff[2]*temp_edge[19]+0.7071067811865475*facDiff[0]*temp_edge[19]+0.7071067811865475*facDiff[1]*temp_edge[16]; 
  edge_incr[20] = 0.4517539514526256*facDiff[2]*temp_edge[20]+0.7071067811865475*facDiff[0]*temp_edge[20]+0.632455532033676*facDiff[1]*temp_edge[12]+0.7071067811865475*facDiff[2]*temp_edge[8]; 
  edge_incr[21] = 0.4517539514526256*facDiff[2]*temp_edge[21]+0.7071067811865475*facDiff[0]*temp_edge[21]+0.632455532033676*facDiff[1]*temp_edge[15]+0.7071067811865475*facDiff[2]*temp_edge[9]; 
  edge_incr[22] = 0.7071067811865475*facDiff[2]*temp_edge[26]+0.7071067811865475*facDiff[1]*temp_edge[25]+0.7071067811865475*facDiff[0]*temp_edge[22]; 
  edge_incr[23] = 0.4517539514526256*facDiff[2]*temp_edge[23]+0.7071067811865475*facDiff[0]*temp_edge[23]+0.6324555320336759*facDiff[1]*temp_edge[18]+0.7071067811865475*facDiff[2]*temp_edge[14]; 
  edge_incr[24] = 0.4517539514526256*facDiff[2]*temp_edge[24]+0.7071067811865475*facDiff[0]*temp_edge[24]+0.6324555320336759*facDiff[1]*temp_edge[19]+0.7071067811865475*facDiff[2]*temp_edge[16]; 
  edge_incr[25] = 0.6324555320336759*facDiff[1]*temp_edge[26]+0.6324555320336759*facDiff[2]*temp_edge[25]+0.7071067811865475*facDiff[0]*temp_edge[25]+0.7071067811865475*facDiff[1]*temp_edge[22]; 
  edge_incr[26] = 0.4517539514526256*facDiff[2]*temp_edge[26]+0.7071067811865475*facDiff[0]*temp_edge[26]+0.6324555320336759*facDiff[1]*temp_edge[25]+0.7071067811865475*facDiff[2]*temp_edge[22]; 
