...
#include <gkyl_basis_tensor_1x2v_p2_surfvx_quad.h> 
...
{ 
  ...
  alphaDrSurf_l[0] = 2.0*w[1]*nuSum-1.0*dxv[1]*nuSum-1.414213562373095*sumNuUx[0]; 
  alphaDrSurf_l[1] = -1.414213562373095*sumNuUx[1]; 
  alphaDrSurf_l[4] = -1.414213562373095*sumNuUx[2]; 

  double alphaDrSurf_r[9] = {0.0}; 
  alphaDrSurf_r[0] = 2.0*w[1]*nuSum+dxv[1]*nuSum-1.414213562373095*sumNuUx[0]; 
  alphaDrSurf_r[1] = -1.414213562373095*sumNuUx[1]; 
  alphaDrSurf_r[4] = -1.414213562373095*sumNuUx[2]; 
  ...
  if (0.4472135954999579*alphaDrSurf_l[4]-0.6708203932499369*alphaDrSurf_l[1]+0.5*alphaDrSurf_l[0] > 0) { 
    fUpwindQuad_l[0] = tensor_1x2v_p2_surfvx_quad_0(1, fl); 
  } else { 
    fUpwindQuad_l[0] = tensor_1x2v_p2_surfvx_quad_0(-1, fc); 
  } 
  if (0.5*alphaDrSurf_l[0]-0.5590169943749475*alphaDrSurf_l[4] > 0) { 
    fUpwindQuad_l[1] = tensor_1x2v_p2_surfvx_quad_1(1, fl); 
  } else { 
    fUpwindQuad_l[1] = tensor_1x2v_p2_surfvx_quad_1(-1, fc); 
  } 
  if (0.4472135954999579*alphaDrSurf_l[4]+0.6708203932499369*alphaDrSurf_l[1]+0.5*alphaDrSurf_l[0] > 0) { 
    fUpwindQuad_l[2] = tensor_1x2v_p2_surfvx_quad_2(1, fl); 
  } else { 
    fUpwindQuad_l[2] = tensor_1x2v_p2_surfvx_quad_2(-1, fc); 
  } 
  if (0.4472135954999579*alphaDrSurf_l[4]-0.6708203932499369*alphaDrSurf_l[1]+0.5*alphaDrSurf_l[0] > 0) { 
    fUpwindQuad_l[3] = tensor_1x2v_p2_surfvx_quad_3(1, fl); 
  } else { 
    fUpwindQuad_l[3] = tensor_1x2v_p2_surfvx_quad_3(-1, fc); 
  } 
  if (0.5*alphaDrSurf_l[0]-0.5590169943749475*alphaDrSurf_l[4] > 0) { 
    fUpwindQuad_l[4] = tensor_1x2v_p2_surfvx_quad_4(1, fl); 
  } else { 
    fUpwindQuad_l[4] = tensor_1x2v_p2_surfvx_quad_4(-1, fc); 
  } 
  if (0.4472135954999579*alphaDrSurf_l[4]+0.6708203932499369*alphaDrSurf_l[1]+0.5*alphaDrSurf_l[0] > 0) { 
    fUpwindQuad_l[5] = tensor_1x2v_p2_surfvx_quad_5(1, fl); 
  } else { 
    fUpwindQuad_l[5] = tensor_1x2v_p2_surfvx_quad_5(-1, fc); 
  } 
  if (0.4472135954999579*alphaDrSurf_l[4]-0.6708203932499369*alphaDrSurf_l[1]+0.5*alphaDrSurf_l[0] > 0) { 
    fUpwindQuad_l[6] = tensor_1x2v_p2_surfvx_quad_6(1, fl); 
  } else { 
    fUpwindQuad_l[6] = tensor_1x2v_p2_surfvx_quad_6(-1, fc); 
  } 
  if (0.5*alphaDrSurf_l[0]-0.5590169943749475*alphaDrSurf_l[4] > 0) { 
    fUpwindQuad_l[7] = tensor_1x2v_p2_surfvx_quad_7(1, fl); 
  } else { 
    fUpwindQuad_l[7] = tensor_1x2v_p2_surfvx_quad_7(-1, fc); 
  } 
  if (0.4472135954999579*alphaDrSurf_l[4]+0.6708203932499369*alphaDrSurf_l[1]+0.5*alphaDrSurf_l[0] > 0) { 
    fUpwindQuad_l[8] = tensor_1x2v_p2_surfvx_quad_8(1, fl); 
  } else { 
    fUpwindQuad_l[8] = tensor_1x2v_p2_surfvx_quad_8(-1, fc); 
  } 
  if (0.4472135954999579*alphaDrSurf_r[4]-0.6708203932499369*alphaDrSurf_r[1]+0.5*alphaDrSurf_r[0] > 0) { 
    fUpwindQuad_r[0] = tensor_1x2v_p2_surfvx_quad_0(1, fc); 
  } else { 
    fUpwindQuad_r[0] = tensor_1x2v_p2_surfvx_quad_0(-1, fr); 
  } 
  if (0.5*alphaDrSurf_r[0]-0.5590169943749475*alphaDrSurf_r[4] > 0) { 
    fUpwindQuad_r[1] = tensor_1x2v_p2_surfvx_quad_1(1, fc); 
  } else { 
    fUpwindQuad_r[1] = tensor_1x2v_p2_surfvx_quad_1(-1, fr); 
  } 
  if (0.4472135954999579*alphaDrSurf_r[4]+0.6708203932499369*alphaDrSurf_r[1]+0.5*alphaDrSurf_r[0] > 0) { 
    fUpwindQuad_r[2] = tensor_1x2v_p2_surfvx_quad_2(1, fc); 
  } else { 
    fUpwindQuad_r[2] = tensor_1x2v_p2_surfvx_quad_2(-1, fr); 
  } 
  if (0.4472135954999579*alphaDrSurf_r[4]-0.6708203932499369*alphaDrSurf_r[1]+0.5*alphaDrSurf_r[0] > 0) { 
    fUpwindQuad_r[3] = tensor_1x2v_p2_surfvx_quad_3(1, fc); 
  } else { 
    fUpwindQuad_r[3] = tensor_1x2v_p2_surfvx_quad_3(-1, fr); 
  } 
  if (0.5*alphaDrSurf_r[0]-0.5590169943749475*alphaDrSurf_r[4] > 0) { 
    fUpwindQuad_r[4] = tensor_1x2v_p2_surfvx_quad_4(1, fc); 
  } else { 
    fUpwindQuad_r[4] = tensor_1x2v_p2_surfvx_quad_4(-1, fr); 
  } 
  if (0.4472135954999579*alphaDrSurf_r[4]+0.6708203932499369*alphaDrSurf_r[1]+0.5*alphaDrSurf_r[0] > 0) { 
    fUpwindQuad_r[5] = tensor_1x2v_p2_surfvx_quad_5(1, fc); 
  } else { 
    fUpwindQuad_r[5] = tensor_1x2v_p2_surfvx_quad_5(-1, fr); 
  } 
  if (0.4472135954999579*alphaDrSurf_r[4]-0.6708203932499369*alphaDrSurf_r[1]+0.5*alphaDrSurf_r[0] > 0) { 
    fUpwindQuad_r[6] = tensor_1x2v_p2_surfvx_quad_6(1, fc); 
  } else { 
    fUpwindQuad_r[6] = tensor_1x2v_p2_surfvx_quad_6(-1, fr); 
  } 
  if (0.5*alphaDrSurf_r[0]-0.5590169943749475*alphaDrSurf_r[4] > 0) { 
    fUpwindQuad_r[7] = tensor_1x2v_p2_surfvx_quad_7(1, fc); 
  } else { 
    fUpwindQuad_r[7] = tensor_1x2v_p2_surfvx_quad_7(-1, fr); 
  } 
  if (0.4472135954999579*alphaDrSurf_r[4]+0.6708203932499369*alphaDrSurf_r[1]+0.5*alphaDrSurf_r[0] > 0) { 
    fUpwindQuad_r[8] = tensor_1x2v_p2_surfvx_quad_8(1, fc); 
  } else { 
    fUpwindQuad_r[8] = tensor_1x2v_p2_surfvx_quad_8(-1, fr); 
  } 
  ...
  Ghat_r[0] = (-1.0*Gdiff_r[0]*rdv2)+0.5*alphaDrSurf_r[4]*fUpwind_r[4]+0.5*alphaDrSurf_r[1]*fUpwind_r[1]+0.5*alphaDrSurf_r[0]*fUpwind_r[0]; 
  Ghat_r[1] = (-1.0*Gdiff_r[1]*rdv2)+0.4472135954999579*alphaDrSurf_r[1]*fUpwind_r[4]+0.4472135954999579*fUpwind_r[1]*alphaDrSurf_r[4]+0.5*alphaDrSurf_r[0]*fUpwind_r[1]+0.5*fUpwind_r[0]*alphaDrSurf_r[1]; 
  Ghat_r[2] = (-1.0*Gdiff_r[2]*rdv2)+0.5000000000000001*alphaDrSurf_r[4]*fUpwind_r[6]+0.5*alphaDrSurf_r[1]*fUpwind_r[3]+0.5*alphaDrSurf_r[0]*fUpwind_r[2]; 
  Ghat_r[3] = (-1.0*Gdiff_r[3]*rdv2)+0.447213595499958*alphaDrSurf_r[1]*fUpwind_r[6]+0.4472135954999579*fUpwind_r[3]*alphaDrSurf_r[4]+0.5*alphaDrSurf_r[0]*fUpwind_r[3]+0.5*alphaDrSurf_r[1]*fUpwind_r[2]; 
  Ghat_r[4] = (-1.0*Gdiff_r[4]*rdv2)+0.31943828249997*alphaDrSurf_r[4]*fUpwind_r[4]+0.5*alphaDrSurf_r[0]*fUpwind_r[4]+0.5*fUpwind_r[0]*alphaDrSurf_r[4]+0.4472135954999579*alphaDrSurf_r[1]*fUpwind_r[1]; 
  Ghat_r[5] = (-1.0*Gdiff_r[5]*rdv2)+0.5*alphaDrSurf_r[4]*fUpwind_r[8]+0.5000000000000001*alphaDrSurf_r[1]*fUpwind_r[7]+0.5*alphaDrSurf_r[0]*fUpwind_r[5]; 
  Ghat_r[6] = (-1.0*Gdiff_r[6]*rdv2)+0.31943828249997*alphaDrSurf_r[4]*fUpwind_r[6]+0.5*alphaDrSurf_r[0]*fUpwind_r[6]+0.5000000000000001*fUpwind_r[2]*alphaDrSurf_r[4]+0.447213595499958*alphaDrSurf_r[1]*fUpwind_r[3]; 
  Ghat_r[7] = (-1.0*Gdiff_r[7]*rdv2)+0.447213595499958*alphaDrSurf_r[1]*fUpwind_r[8]+0.4472135954999579*alphaDrSurf_r[4]*fUpwind_r[7]+0.5*alphaDrSurf_r[0]*fUpwind_r[7]+0.5000000000000001*alphaDrSurf_r[1]*fUpwind_r[5]; 
  Ghat_r[8] = (-1.0*Gdiff_r[8]*rdv2)+0.31943828249997*alphaDrSurf_r[4]*fUpwind_r[8]+0.5*alphaDrSurf_r[0]*fUpwind_r[8]+0.447213595499958*alphaDrSurf_r[1]*fUpwind_r[7]+0.5*alphaDrSurf_r[4]*fUpwind_r[5]; 
  ...
  out[20] += 4.743416490252569*Gdiff2_r[4]*rdvSq4+4.743416490252569*Gdiff2_l[4]*rdvSq4-1.58113883008419*Ghat_r[4]*rdv2+1.58113883008419*Ghat_l[4]*rdv2; 
  out[21] += 0.7071067811865475*Ghat_l[8]*rdv2-0.7071067811865475*Ghat_r[8]*rdv2; 
  ...
  out[23] += 4.743416490252569*Gdiff2_r[6]*rdvSq4+4.743416490252569*Gdiff2_l[6]*rdvSq4-1.58113883008419*Ghat_r[6]*rdv2+1.58113883008419*Ghat_l[6]*rdv2; 
