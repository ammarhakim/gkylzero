...
{ 
  ...
  out[5] += 4.743416490252569*(facDiff[2]*f[4]+f[1]*facDiff[1]+f[0]*facDiff[0])*rdvxSq4+1.732050807568877*(alphaDrag[6]*f[8]+alphaDrag[3]*f[7])+1.936491673103709*(alphaDrag[4]*f[6]+f[4]*alphaDrag[6])+1.732050807568877*alphaDrag[2]*f[5]+1.936491673103709*(alphaDrag[1]*f[3]+f[1]*alphaDrag[3]+alphaDrag[0]*f[2]+f[0]*alphaDrag[2]); 
