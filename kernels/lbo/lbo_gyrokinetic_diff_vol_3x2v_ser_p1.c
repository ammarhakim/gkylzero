...
{ 
  ...
  return fabs(rdvSq4[1]*w[4]*(bmag_inv[5]*nuVtSqSum[5]+bmag_inv[3]*nuVtSqSum[3]+bmag_inv[1]*nuVtSqSum[1])*m_+nuVtSqSum[0]*(bmag_inv[0]*rdvSq4[1]*w[4]*m_+3.181980515339463*rdvSq4[0])); 
