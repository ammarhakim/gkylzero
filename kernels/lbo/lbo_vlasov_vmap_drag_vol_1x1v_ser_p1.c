...
GKYL_CU_DH double lbo_vlasov_vmap_drag_vol_1x1v_ser_p1(const double *w, const double *dxv, const double *vmap, const double *jacob_vel_inv, const double *nuSum, const double *nuPrimMomsSum, const double *f, double* GKYL_RESTRICT out) 
{ 
  ...
  alphaDrag[4] = (nuSum[0]*(((-0.4517539514526256*jacob_vel_inv0[2])-0.7071067811865475*jacob_vel_inv0[0])*v0[2]-0.6210590034081186*jacob_vel_inv0[1]*v0[3])+((-0.7071067811865475*nuSum[0]*v0[0])-1.0*nuUSum[0])*jacob_vel_inv0[2]-0.6324555320336759*nuSum[0]*jacob_vel_inv0[1]*v0[1])*rdvx2; 
  alphaDrag[5] = (nuSum[1]*(((-0.4517539514526256*jacob_vel_inv0[2])-0.7071067811865475*jacob_vel_inv0[0])*v0[2]-0.6210590034081186*jacob_vel_inv0[1]*v0[3])-1.0*nuUSum[1]*jacob_vel_inv0[2]+nuSum[1]*((-0.7071067811865475*v0[0]*jacob_vel_inv0[2])-0.6324555320336759*jacob_vel_inv0[1]*v0[1]))*rdvx2; 
