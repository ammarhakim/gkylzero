...
{ 
  ...
  if (edge == GKYL_VX_LOWER) {
    ...
    out[5] += vBoundary[0]*((-1.58113883008419*fIn[8])+1.224744871391589*fIn[6]-0.7071067811865475*fIn[4])*dS; 
    ...
    out[5] += vBoundary[1]*(1.58113883008419*fIn[8]+1.224744871391589*fIn[6]+0.7071067811865475*fIn[4])*dS; 
  }
