...
GKYL_CU_DH double lbo_vlasov_vmap_drag_surfvy_2x3v_ser_p2(const double *w, const double *dxv, const double *vmap, const double *jacob_vel_inv, const double *nuSum, const double *nuPrimMomsSum, const double *fl, const double *fc, const double *fr, double* GKYL_RESTRICT out) 
{ 
  ...
  alphaDrSurf_l[2] = (-5.916079783099617*jacob_vel_inv1[2]*nuSum[2]*v1[3])+4.58257569495584*jacob_vel_inv1[1]*nuSum[2]*v1[3]-2.645751311064591*jacob_vel_inv1[0]*nuSum[2]*v1[3]+5.0*jacob_vel_inv1[2]*nuSum[2]*v1[2]-3.872983346207417*jacob_vel_inv1[1]*nuSum[2]*v1[2]+2.23606797749979*jacob_vel_inv1[0]*nuSum[2]*v1[2]-3.16227766016838*jacob_vel_inv1[2]*sumNuUy[2]+2.449489742783178*jacob_vel_inv1[1]*sumNuUy[2]-1.414213562373095*jacob_vel_inv1[0]*sumNuUy[2]-3.872983346207417*v1[1]*jacob_vel_inv1[2]*nuSum[2]+2.23606797749979*v1[0]*jacob_vel_inv1[2]*nuSum[2]+3.0*jacob_vel_inv1[1]*v1[1]*nuSum[2]-1.732050807568877*jacob_vel_inv1[0]*v1[1]*nuSum[2]-1.732050807568877*v1[0]*jacob_vel_inv1[1]*nuSum[2]+jacob_vel_inv1[0]*v1[0]*nuSum[2]; 
  alphaDrSurf_l[5] = (-5.916079783099617*jacob_vel_inv1[2]*nuSum[3]*v1[3])+4.58257569495584*jacob_vel_inv1[1]*nuSum[3]*v1[3]-2.645751311064591*jacob_vel_inv1[0]*nuSum[3]*v1[3]-3.16227766016838*jacob_vel_inv1[2]*sumNuUy[3]+2.449489742783178*jacob_vel_inv1[1]*sumNuUy[3]-1.414213562373095*jacob_vel_inv1[0]*sumNuUy[3]+5.0*jacob_vel_inv1[2]*v1[2]*nuSum[3]-3.872983346207417*jacob_vel_inv1[1]*v1[2]*nuSum[3]+2.23606797749979*jacob_vel_inv1[0]*v1[2]*nuSum[3]-3.872983346207417*v1[1]*jacob_vel_inv1[2]*nuSum[3]+2.23606797749979*v1[0]*jacob_vel_inv1[2]*nuSum[3]+3.0*jacob_vel_inv1[1]*v1[1]*nuSum[3]-1.732050807568877*jacob_vel_inv1[0]*v1[1]*nuSum[3]-1.732050807568877*v1[0]*jacob_vel_inv1[1]*nuSum[3]+jacob_vel_inv1[0]*v1[0]*nuSum[3]; 
  alphaDrSurf_l[11] = (-3.16227766016838*jacob_vel_inv1[2]*sumNuUy[4])+2.449489742783178*jacob_vel_inv1[1]*sumNuUy[4]-1.414213562373095*jacob_vel_inv1[0]*sumNuUy[4]-5.916079783099617*jacob_vel_inv1[2]*v1[3]*nuSum[4]+4.58257569495584*jacob_vel_inv1[1]*v1[3]*nuSum[4]-2.645751311064591*jacob_vel_inv1[0]*v1[3]*nuSum[4]+5.0*jacob_vel_inv1[2]*v1[2]*nuSum[4]-3.872983346207417*jacob_vel_inv1[1]*v1[2]*nuSum[4]+2.23606797749979*jacob_vel_inv1[0]*v1[2]*nuSum[4]-3.872983346207417*v1[1]*jacob_vel_inv1[2]*nuSum[4]+2.23606797749979*v1[0]*jacob_vel_inv1[2]*nuSum[4]+3.0*jacob_vel_inv1[1]*v1[1]*nuSum[4]-1.732050807568877*jacob_vel_inv1[0]*v1[1]*nuSum[4]-1.732050807568877*v1[0]*jacob_vel_inv1[1]*nuSum[4]+jacob_vel_inv1[0]*v1[0]*nuSum[4]; 
  alphaDrSurf_l[12] = (-3.16227766016838*jacob_vel_inv1[2]*sumNuUy[5])+2.449489742783178*jacob_vel_inv1[1]*sumNuUy[5]-1.414213562373095*jacob_vel_inv1[0]*sumNuUy[5]-5.916079783099617*jacob_vel_inv1[2]*v1[3]*nuSum[5]+4.58257569495584*jacob_vel_inv1[1]*v1[3]*nuSum[5]-2.645751311064591*jacob_vel_inv1[0]*v1[3]*nuSum[5]+5.0*jacob_vel_inv1[2]*v1[2]*nuSum[5]-3.872983346207417*jacob_vel_inv1[1]*v1[2]*nuSum[5]+2.23606797749979*jacob_vel_inv1[0]*v1[2]*nuSum[5]-3.872983346207417*v1[1]*jacob_vel_inv1[2]*nuSum[5]+2.23606797749979*v1[0]*jacob_vel_inv1[2]*nuSum[5]+3.0*jacob_vel_inv1[1]*v1[1]*nuSum[5]-1.732050807568877*jacob_vel_inv1[0]*v1[1]*nuSum[5]-1.732050807568877*v1[0]*jacob_vel_inv1[1]*nuSum[5]+jacob_vel_inv1[0]*v1[0]*nuSum[5]; 
  alphaDrSurf_l[19] = (-3.16227766016838*jacob_vel_inv1[2]*sumNuUy[6])+2.449489742783178*jacob_vel_inv1[1]*sumNuUy[6]-1.414213562373095*jacob_vel_inv1[0]*sumNuUy[6]-5.916079783099617*jacob_vel_inv1[2]*v1[3]*nuSum[6]+4.58257569495584*jacob_vel_inv1[1]*v1[3]*nuSum[6]-2.645751311064591*jacob_vel_inv1[0]*v1[3]*nuSum[6]+5.0*jacob_vel_inv1[2]*v1[2]*nuSum[6]-3.872983346207417*jacob_vel_inv1[1]*v1[2]*nuSum[6]+2.23606797749979*jacob_vel_inv1[0]*v1[2]*nuSum[6]-3.872983346207417*v1[1]*jacob_vel_inv1[2]*nuSum[6]+2.23606797749979*v1[0]*jacob_vel_inv1[2]*nuSum[6]+3.0*jacob_vel_inv1[1]*v1[1]*nuSum[6]-1.732050807568877*jacob_vel_inv1[0]*v1[1]*nuSum[6]-1.732050807568877*v1[0]*jacob_vel_inv1[1]*nuSum[6]+jacob_vel_inv1[0]*v1[0]*nuSum[6]; 
  alphaDrSurf_l[20] = (-3.16227766016838*jacob_vel_inv1[2]*sumNuUy[7])+2.449489742783178*jacob_vel_inv1[1]*sumNuUy[7]-1.414213562373095*jacob_vel_inv1[0]*sumNuUy[7]-5.916079783099617*jacob_vel_inv1[2]*v1[3]*nuSum[7]+4.58257569495584*jacob_vel_inv1[1]*v1[3]*nuSum[7]-2.645751311064591*jacob_vel_inv1[0]*v1[3]*nuSum[7]+5.0*jacob_vel_inv1[2]*v1[2]*nuSum[7]-3.872983346207417*jacob_vel_inv1[1]*v1[2]*nuSum[7]+2.23606797749979*jacob_vel_inv1[0]*v1[2]*nuSum[7]-3.872983346207417*v1[1]*jacob_vel_inv1[2]*nuSum[7]+2.23606797749979*v1[0]*jacob_vel_inv1[2]*nuSum[7]+3.0*jacob_vel_inv1[1]*v1[1]*nuSum[7]-1.732050807568877*jacob_vel_inv1[0]*v1[1]*nuSum[7]-1.732050807568877*v1[0]*jacob_vel_inv1[1]*nuSum[7]+jacob_vel_inv1[0]*v1[0]*nuSum[7]; 
  ...
  alphaDrSurf_r[2] = 5.916079783099617*jacob_vel_inv1[2]*nuSum[2]*v1[3]+4.58257569495584*jacob_vel_inv1[1]*nuSum[2]*v1[3]+2.645751311064591*jacob_vel_inv1[0]*nuSum[2]*v1[3]+5.0*jacob_vel_inv1[2]*nuSum[2]*v1[2]+3.872983346207417*jacob_vel_inv1[1]*nuSum[2]*v1[2]+2.23606797749979*jacob_vel_inv1[0]*nuSum[2]*v1[2]-3.16227766016838*jacob_vel_inv1[2]*sumNuUy[2]-2.449489742783178*jacob_vel_inv1[1]*sumNuUy[2]-1.414213562373095*jacob_vel_inv1[0]*sumNuUy[2]+3.872983346207417*v1[1]*jacob_vel_inv1[2]*nuSum[2]+2.23606797749979*v1[0]*jacob_vel_inv1[2]*nuSum[2]+3.0*jacob_vel_inv1[1]*v1[1]*nuSum[2]+1.732050807568877*jacob_vel_inv1[0]*v1[1]*nuSum[2]+1.732050807568877*v1[0]*jacob_vel_inv1[1]*nuSum[2]+jacob_vel_inv1[0]*v1[0]*nuSum[2]; 
  alphaDrSurf_r[5] = 5.916079783099617*jacob_vel_inv1[2]*nuSum[3]*v1[3]+4.58257569495584*jacob_vel_inv1[1]*nuSum[3]*v1[3]+2.645751311064591*jacob_vel_inv1[0]*nuSum[3]*v1[3]-3.16227766016838*jacob_vel_inv1[2]*sumNuUy[3]-2.449489742783178*jacob_vel_inv1[1]*sumNuUy[3]-1.414213562373095*jacob_vel_inv1[0]*sumNuUy[3]+5.0*jacob_vel_inv1[2]*v1[2]*nuSum[3]+3.872983346207417*jacob_vel_inv1[1]*v1[2]*nuSum[3]+2.23606797749979*jacob_vel_inv1[0]*v1[2]*nuSum[3]+3.872983346207417*v1[1]*jacob_vel_inv1[2]*nuSum[3]+2.23606797749979*v1[0]*jacob_vel_inv1[2]*nuSum[3]+3.0*jacob_vel_inv1[1]*v1[1]*nuSum[3]+1.732050807568877*jacob_vel_inv1[0]*v1[1]*nuSum[3]+1.732050807568877*v1[0]*jacob_vel_inv1[1]*nuSum[3]+jacob_vel_inv1[0]*v1[0]*nuSum[3]; 
  alphaDrSurf_r[11] = (-3.16227766016838*jacob_vel_inv1[2]*sumNuUy[4])-2.449489742783178*jacob_vel_inv1[1]*sumNuUy[4]-1.414213562373095*jacob_vel_inv1[0]*sumNuUy[4]+5.916079783099617*jacob_vel_inv1[2]*v1[3]*nuSum[4]+4.58257569495584*jacob_vel_inv1[1]*v1[3]*nuSum[4]+2.645751311064591*jacob_vel_inv1[0]*v1[3]*nuSum[4]+5.0*jacob_vel_inv1[2]*v1[2]*nuSum[4]+3.872983346207417*jacob_vel_inv1[1]*v1[2]*nuSum[4]+2.23606797749979*jacob_vel_inv1[0]*v1[2]*nuSum[4]+3.872983346207417*v1[1]*jacob_vel_inv1[2]*nuSum[4]+2.23606797749979*v1[0]*jacob_vel_inv1[2]*nuSum[4]+3.0*jacob_vel_inv1[1]*v1[1]*nuSum[4]+1.732050807568877*jacob_vel_inv1[0]*v1[1]*nuSum[4]+1.732050807568877*v1[0]*jacob_vel_inv1[1]*nuSum[4]+jacob_vel_inv1[0]*v1[0]*nuSum[4]; 
  alphaDrSurf_r[12] = (-3.16227766016838*jacob_vel_inv1[2]*sumNuUy[5])-2.449489742783178*jacob_vel_inv1[1]*sumNuUy[5]-1.414213562373095*jacob_vel_inv1[0]*sumNuUy[5]+5.916079783099617*jacob_vel_inv1[2]*v1[3]*nuSum[5]+4.58257569495584*jacob_vel_inv1[1]*v1[3]*nuSum[5]+2.645751311064591*jacob_vel_inv1[0]*v1[3]*nuSum[5]+5.0*jacob_vel_inv1[2]*v1[2]*nuSum[5]+3.872983346207417*jacob_vel_inv1[1]*v1[2]*nuSum[5]+2.23606797749979*jacob_vel_inv1[0]*v1[2]*nuSum[5]+3.872983346207417*v1[1]*jacob_vel_inv1[2]*nuSum[5]+2.23606797749979*v1[0]*jacob_vel_inv1[2]*nuSum[5]+3.0*jacob_vel_inv1[1]*v1[1]*nuSum[5]+1.732050807568877*jacob_vel_inv1[0]*v1[1]*nuSum[5]+1.732050807568877*v1[0]*jacob_vel_inv1[1]*nuSum[5]+jacob_vel_inv1[0]*v1[0]*nuSum[5]; 
  alphaDrSurf_r[19] = (-3.16227766016838*jacob_vel_inv1[2]*sumNuUy[6])-2.449489742783178*jacob_vel_inv1[1]*sumNuUy[6]-1.414213562373095*jacob_vel_inv1[0]*sumNuUy[6]+5.916079783099617*jacob_vel_inv1[2]*v1[3]*nuSum[6]+4.58257569495584*jacob_vel_inv1[1]*v1[3]*nuSum[6]+2.645751311064591*jacob_vel_inv1[0]*v1[3]*nuSum[6]+5.0*jacob_vel_inv1[2]*v1[2]*nuSum[6]+3.872983346207417*jacob_vel_inv1[1]*v1[2]*nuSum[6]+2.23606797749979*jacob_vel_inv1[0]*v1[2]*nuSum[6]+3.872983346207417*v1[1]*jacob_vel_inv1[2]*nuSum[6]+2.23606797749979*v1[0]*jacob_vel_inv1[2]*nuSum[6]+3.0*jacob_vel_inv1[1]*v1[1]*nuSum[6]+1.732050807568877*jacob_vel_inv1[0]*v1[1]*nuSum[6]+1.732050807568877*v1[0]*jacob_vel_inv1[1]*nuSum[6]+jacob_vel_inv1[0]*v1[0]*nuSum[6]; 
  alphaDrSurf_r[20] = (-3.16227766016838*jacob_vel_inv1[2]*sumNuUy[7])-2.449489742783178*jacob_vel_inv1[1]*sumNuUy[7]-1.414213562373095*jacob_vel_inv1[0]*sumNuUy[7]+5.916079783099617*jacob_vel_inv1[2]*v1[3]*nuSum[7]+4.58257569495584*jacob_vel_inv1[1]*v1[3]*nuSum[7]+2.645751311064591*jacob_vel_inv1[0]*v1[3]*nuSum[7]+5.0*jacob_vel_inv1[2]*v1[2]*nuSum[7]+3.872983346207417*jacob_vel_inv1[1]*v1[2]*nuSum[7]+2.23606797749979*jacob_vel_inv1[0]*v1[2]*nuSum[7]+3.872983346207417*v1[1]*jacob_vel_inv1[2]*nuSum[7]+2.23606797749979*v1[0]*jacob_vel_inv1[2]*nuSum[7]+3.0*jacob_vel_inv1[1]*v1[1]*nuSum[7]+1.732050807568877*jacob_vel_inv1[0]*v1[1]*nuSum[7]+1.732050807568877*v1[0]*jacob_vel_inv1[1]*nuSum[7]+jacob_vel_inv1[0]*v1[0]*nuSum[7]; 
  ...
  out[19] += 1.58113883008419*Ghat_r[0]*rdv2-1.58113883008419*Ghat_l[0]*rdv2; 
  ...
  out[40] += 1.58113883008419*Ghat_r[1]*rdv2-1.58113883008419*Ghat_l[1]*rdv2; 
  out[41] += 1.58113883008419*Ghat_r[2]*rdv2-1.58113883008419*Ghat_l[2]*rdv2; 
  out[42] += 1.58113883008419*Ghat_r[3]*rdv2-1.58113883008419*Ghat_l[3]*rdv2; 
  ...
  out[46] += 1.58113883008419*Ghat_r[4]*rdv2-1.58113883008419*Ghat_l[4]*rdv2; 
  ...
  out[65] += 1.58113883008419*Ghat_r[5]*rdv2-1.58113883008419*Ghat_l[5]*rdv2; 
  out[66] += 1.58113883008419*Ghat_r[6]*rdv2-1.58113883008419*Ghat_l[6]*rdv2; 
  out[67] += 1.58113883008419*Ghat_r[7]*rdv2-1.58113883008419*Ghat_l[7]*rdv2; 
  ...
  out[77] += 1.58113883008419*Ghat_r[8]*rdv2-1.58113883008419*Ghat_l[8]*rdv2; 
  out[78] += 1.58113883008419*Ghat_r[9]*rdv2-1.58113883008419*Ghat_l[9]*rdv2; 
  out[79] += 1.58113883008419*Ghat_r[10]*rdv2-1.58113883008419*Ghat_l[10]*rdv2; 
  ...
  out[90] += 1.58113883008419*Ghat_r[15]*rdv2-1.58113883008419*Ghat_l[15]*rdv2; 
  ...
  out[100] += 1.58113883008419*Ghat_r[16]*rdv2-1.58113883008419*Ghat_l[16]*rdv2; 
  out[101] += 1.58113883008419*Ghat_r[17]*rdv2-1.58113883008419*Ghat_l[17]*rdv2; 
  out[102] += 1.58113883008419*Ghat_r[18]*rdv2-1.58113883008419*Ghat_l[18]*rdv2; 
  ...
  out[110] += 1.58113883008419*Ghat_r[31]*rdv2-1.58113883008419*Ghat_l[31]*rdv2; 
