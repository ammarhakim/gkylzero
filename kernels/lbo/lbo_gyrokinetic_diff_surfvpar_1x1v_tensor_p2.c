...
GKYL_CU_DH void lbo_gyrokinetic_diff_surfvpar_1x1v_tensor_p2(const double *w, const double *dxv, const double m_, const double *bmag_inv, const double *nuSum, const double *nuUSum, const double *nuVtSqSum, const double *fl, const double *fc, const double *fr, double* GKYL_RESTRICT out) 
{ 
  // m_:            species mass.
  ...
  temp_diff[4] = 0.6708203932499369*fr[8]+0.6708203932499369*fl[8]-1.341640786499874*fc[8]-1.190784930203603*fr[6]+1.190784930203603*fl[6]+0.9375*fr[4]+0.9375*fl[4]-1.875*fc[4]; 
  ...
  temp_diff[6] = 0.7382874503707888*fr[8]-0.7382874503707888*fl[8]-1.453125*fr[6]-1.453125*fl[6]-5.34375*fc[6]+1.190784930203603*fr[4]-1.190784930203603*fl[4]; 
  ...
  temp_diff[8] = (-0.140625*fr[8])-0.140625*fl[8]-6.28125*fc[8]-0.3025768239224544*fr[6]+0.3025768239224544*fl[6]+0.4192627457812106*fr[4]+0.4192627457812106*fl[4]-0.8385254915624212*fc[4]; 
