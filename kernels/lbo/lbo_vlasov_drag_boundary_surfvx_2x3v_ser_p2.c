...
GKYL_CU_DH void lbo_vlasov_drag_boundary_surfvx_2x3v_ser_p2(const double *w, const double *dxv, const double *nuSum, const double *nuUSum, const double *nuVtSqSum, const int edge, const double *fSkin, const double *fEdge, double* GKYL_RESTRICT out) 
{ 
  ...
  out[18] += 1.58113883008419*drag_incr[0]*rdv2; 
  out[19] += 0.7071067811865475*drag_incr[13]*rdv2; 
  out[20] += 0.7071067811865475*drag_incr[14]*rdv2; 
  out[21] += 1.224744871391589*drag_incr[5]*rdv2; 
  out[22] += 0.7071067811865475*drag_incr[15]*rdv2; 
  ...
  out[28] += 0.7071067811865475*drag_incr[17]*rdv2; 
  out[29] += 0.7071067811865475*drag_incr[18]*rdv2; 
  ...
  out[33] += 1.224744871391589*drag_incr[11]*rdv2; 
  out[34] += 1.224744871391589*drag_incr[12]*rdv2; 
  out[35] += 1.58113883008419*drag_incr[1]*rdv2; 
  out[36] += 1.58113883008419*drag_incr[2]*rdv2; 
  out[37] += 0.7071067811865475*drag_incr[21]*rdv2; 
  out[38] += 0.7071067811865475*drag_incr[22]*rdv2; 
  out[39] += 1.58113883008419*drag_incr[3]*rdv2; 
  out[40] += 0.7071067811865475*drag_incr[23]*rdv2; 
  out[41] += 0.7071067811865475*drag_incr[24]*rdv2; 
  out[42] += 1.224744871391589*drag_incr[13]*rdv2; 
  out[43] += 0.7071067811865475*drag_incr[25]*rdv2; 
  out[44] += 0.7071067811865475*drag_incr[26]*rdv2; 
  out[45] += 1.58113883008419*drag_incr[4]*rdv2; 
  out[46] += 0.7071067811865475*drag_incr[27]*rdv2; 
  out[47] += 0.7071067811865475*drag_incr[28]*rdv2; 
  out[48] += 0.7071067811865475*drag_incr[29]*rdv2; 
  out[49] += 1.224744871391589*drag_incr[14]*rdv2; 
  out[50] += 0.7071067811865475*drag_incr[30]*rdv2; 
  out[51] += 1.224744871391589*drag_incr[15]*rdv2; 
  out[52] += 1.224744871391589*drag_incr[16]*rdv2; 
  out[53] += 0.7071067811865475*drag_incr[31]*rdv2; 
  out[54] += 1.224744871391589*drag_incr[17]*rdv2; 
  out[55] += 1.224744871391589*drag_incr[18]*rdv2; 
  out[56] += 1.224744871391589*drag_incr[19]*rdv2; 
  out[57] += 1.224744871391589*drag_incr[20]*rdv2; 
  out[58] += 1.58113883008419*drag_incr[5]*rdv2; 
  out[59] += 0.7071067811865475*drag_incr[32]*rdv2; 
  out[60] += 0.7071067811865475*drag_incr[33]*rdv2; 
  out[61] += 1.224744871391589*drag_incr[21]*rdv2; 
  out[62] += 1.224744871391589*drag_incr[22]*rdv2; 
  out[63] += 1.58113883008419*drag_incr[6]*rdv2; 
  out[64] += 1.58113883008419*drag_incr[7]*rdv2; 
  out[65] += 0.7071067811865475*drag_incr[34]*rdv2; 
  out[66] += 1.224744871391589*drag_incr[23]*rdv2; 
  out[67] += 1.224744871391589*drag_incr[24]*rdv2; 
  out[68] += 0.7071067811865475*drag_incr[35]*rdv2; 
  out[69] += 0.7071067811865475*drag_incr[36]*rdv2; 
  out[70] += 1.224744871391589*drag_incr[25]*rdv2; 
  out[71] += 1.224744871391589*drag_incr[26]*rdv2; 
  out[72] += 1.58113883008419*drag_incr[8]*rdv2; 
  out[73] += 1.58113883008419*drag_incr[9]*rdv2; 
  out[74] += 0.7071067811865475*drag_incr[37]*rdv2; 
  out[75] += 0.7071067811865475*drag_incr[38]*rdv2; 
  out[76] += 1.58113883008419*drag_incr[10]*rdv2; 
  out[77] += 0.7071067811865475*drag_incr[39]*rdv2; 
  out[78] += 0.7071067811865475*drag_incr[40]*rdv2; 
  out[79] += 1.224744871391589*drag_incr[27]*rdv2; 
  out[80] += 0.7071067811865475*drag_incr[41]*rdv2; 
  out[81] += 1.224744871391589*drag_incr[28]*rdv2; 
  out[82] += 1.224744871391589*drag_incr[29]*rdv2; 
  out[83] += 0.7071067811865475*drag_incr[42]*rdv2; 
  out[84] += 0.7071067811865475*drag_incr[43]*rdv2; 
  ...
  out[89] += 1.58113883008419*drag_incr[15]*rdv2; 
  out[90] += 1.224744871391589*drag_incr[34]*rdv2; 
  out[91] += 1.224744871391589*drag_incr[35]*rdv2; 
  out[92] += 1.224744871391589*drag_incr[36]*rdv2; 
  out[93] += 1.58113883008419*drag_incr[16]*rdv2; 
  out[94] += 0.7071067811865475*drag_incr[44]*rdv2; 
  out[95] += 0.7071067811865475*drag_incr[45]*rdv2; 
  out[96] += 1.224744871391589*drag_incr[37]*rdv2; 
  out[97] += 1.224744871391589*drag_incr[38]*rdv2; 
  out[98] += 1.58113883008419*drag_incr[17]*rdv2; 
  out[99] += 1.58113883008419*drag_incr[18]*rdv2; 
  out[100] += 0.7071067811865475*drag_incr[46]*rdv2; 
  out[101] += 1.224744871391589*drag_incr[39]*rdv2; 
  out[102] += 1.224744871391589*drag_incr[40]*rdv2; 
  out[103] += 1.224744871391589*drag_incr[41]*rdv2; 
  out[104] += 0.7071067811865475*drag_incr[47]*rdv2; 
  ...
  out[109] += 1.58113883008419*drag_incr[31]*rdv2; 
  out[110] += 1.224744871391589*drag_incr[46]*rdv2; 
