...
{ 
  ...
  if ((-0.3*(alphaDrSurf[20]+alphaDrSurf[19]))+0.223606797749979*(alphaDrSurf[12]+alphaDrSurf[11])+0.45*alphaDrSurf[5]-0.3354101966249685*(alphaDrSurf[2]+alphaDrSurf[1])+0.25*alphaDrSurf[0] < 0) { 
