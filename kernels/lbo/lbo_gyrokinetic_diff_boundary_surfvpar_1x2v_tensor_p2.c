...
GKYL_CU_DH void lbo_gyrokinetic_diff_boundary_surfvpar_1x2v_tensor_p2(const double *w, const double *dxv, const double m_, const double *bmag_inv, const double *nuSum, const double *nuUSum, const double *nuVtSqSum, const int edge, const double *fedge, const double *fskin, double* GKYL_RESTRICT out) 
{ 
  ...
  vol_incr[20] = 3.030457633656632*nuVtSqSum[2]*fskin[7]*rdvSq4+4.743416490252569*nuVtSqSum[0]*fskin[7]*rdvSq4+4.743416490252569*fskin[0]*nuVtSqSum[2]*rdvSq4+4.242640687119286*fskin[1]*nuVtSqSum[1]*rdvSq4; 
  vol_incr[22] = 4.743416490252569*nuVtSqSum[2]*fskin[21]*rdvSq4+4.743416490252569*nuVtSqSum[1]*fskin[15]*rdvSq4+4.743416490252569*nuVtSqSum[0]*fskin[9]*rdvSq4; 
  vol_incr[23] = 3.030457633656633*nuVtSqSum[2]*fskin[13]*rdvSq4+4.743416490252569*nuVtSqSum[0]*fskin[13]*rdvSq4+4.242640687119286*nuVtSqSum[1]*fskin[5]*rdvSq4+4.743416490252569*nuVtSqSum[2]*fskin[3]*rdvSq4; 
  vol_incr[25] = 4.242640687119286*nuVtSqSum[1]*fskin[21]*rdvSq4+4.242640687119286*nuVtSqSum[2]*fskin[15]*rdvSq4+4.743416490252569*nuVtSqSum[0]*fskin[15]*rdvSq4+4.743416490252569*nuVtSqSum[1]*fskin[9]*rdvSq4; 
  vol_incr[26] = 3.030457633656632*nuVtSqSum[2]*fskin[21]*rdvSq4+4.743416490252569*nuVtSqSum[0]*fskin[21]*rdvSq4+4.242640687119286*nuVtSqSum[1]*fskin[15]*rdvSq4+4.743416490252569*nuVtSqSum[2]*fskin[9]*rdvSq4; 
  ...
  temp_diff[7] = (-0.6708203932499369*fskin[20])+0.6708203932499369*fedge[20]-1.190784930203603*fskin[11]-1.190784930203603*fedge[11]-0.9375*fskin[7]+0.9375*fedge[7]; 
  ...
  temp_diff[9] = (-0.6708203932499369*fskin[22])+0.6708203932499369*fedge[22]-1.190784930203603*fskin[16]-1.190784930203603*fedge[16]-0.9375*fskin[9]+0.9375*fedge[9]; 
  ...
  temp_diff[11] = (-1.585502557353661*fskin[20])+0.7382874503707888*fedge[20]-2.671875*fskin[11]-1.453125*fedge[11]-2.056810333988042*fskin[7]+1.190784930203603*fedge[7]; 
  ...
  temp_diff[13] = (-0.6708203932499369*fskin[23])+0.6708203932499369*fedge[23]-1.190784930203603*fskin[17]-1.190784930203603*fedge[17]-0.9375*fskin[13]+0.9375*fedge[13]; 
  ...
  temp_diff[15] = (-0.6708203932499369*fskin[25])+0.6708203932499369*fedge[25]-1.190784930203603*fskin[19]-1.190784930203603*fedge[19]-0.9375*fskin[15]+0.9375*fedge[15]; 
  temp_diff[16] = (-1.585502557353661*fskin[22])+0.7382874503707888*fedge[22]-2.671875*fskin[16]-1.453125*fedge[16]-2.056810333988042*fskin[9]+1.190784930203603*fedge[9]; 
  temp_diff[17] = (-1.585502557353661*fskin[23])+0.7382874503707888*fedge[23]-2.671875*fskin[17]-1.453125*fedge[17]-2.056810333988042*fskin[13]+1.190784930203603*fedge[13]; 
  ...
  temp_diff[19] = (-1.585502557353661*fskin[25])+0.7382874503707888*fedge[25]-2.671875*fskin[19]-1.453125*fedge[19]-2.056810333988042*fskin[15]+1.190784930203603*fedge[15]; 
  temp_diff[20] = (-3.140625*fskin[20])-0.140625*fedge[20]-5.022775277112744*fskin[11]-0.3025768239224544*fedge[11]-3.773364712030896*fskin[7]+0.4192627457812106*fedge[7]; 
  temp_diff[21] = (-0.6708203932499369*fskin[26])+0.6708203932499369*fedge[26]-1.190784930203603*fskin[24]-1.190784930203603*fedge[24]-0.9375*fskin[21]+0.9375*fedge[21]; 
  temp_diff[22] = (-3.140625*fskin[22])-0.140625*fedge[22]-5.022775277112744*fskin[16]-0.3025768239224544*fedge[16]-3.773364712030896*fskin[9]+0.4192627457812106*fedge[9]; 
  temp_diff[23] = (-3.140625*fskin[23])-0.140625*fedge[23]-5.022775277112744*fskin[17]-0.3025768239224545*fedge[17]-3.773364712030894*fskin[13]+0.4192627457812105*fedge[13]; 
  temp_diff[24] = (-1.585502557353661*fskin[26])+0.7382874503707888*fedge[26]-2.671875*fskin[24]-1.453125*fedge[24]-2.056810333988042*fskin[21]+1.190784930203603*fedge[21]; 
  temp_diff[25] = (-3.140625*fskin[25])-0.140625*fedge[25]-5.022775277112744*fskin[19]-0.3025768239224545*fedge[19]-3.773364712030894*fskin[15]+0.4192627457812105*fedge[15]; 
  temp_diff[26] = (-3.140625*fskin[26])-0.140625*fedge[26]-5.022775277112744*fskin[24]-0.3025768239224545*fedge[24]-3.773364712030896*fskin[21]+0.4192627457812106*fedge[21]; 
  ...
  temp_edge[11] = 1.936491673103709*fskin[20]-1.5*fskin[11]+0.8660254037844387*fskin[7]; 
  ...
  temp_edge[16] = 1.936491673103709*fskin[22]-1.5*fskin[16]+0.8660254037844387*fskin[9]; 
  temp_edge[17] = 1.936491673103709*fskin[23]-1.5*fskin[17]+0.8660254037844387*fskin[13]; 
  temp_edge[18] = (-7.5*fskin[18])+5.809475019311125*fskin[10]-3.354101966249685*fskin[5]; 
  temp_edge[19] = 1.936491673103709*fskin[25]-1.5*fskin[19]+0.8660254037844387*fskin[15]; 
  temp_edge[20] = (-7.5*fskin[20])+5.809475019311126*fskin[11]-3.354101966249685*fskin[7]; 
  temp_edge[22] = (-7.5*fskin[22])+5.809475019311126*fskin[16]-3.354101966249685*fskin[9]; 
  temp_edge[23] = (-7.5*fskin[23])+5.809475019311125*fskin[17]-3.354101966249684*fskin[13]; 
  temp_edge[24] = 1.936491673103709*fskin[26]-1.5*fskin[24]+0.8660254037844386*fskin[21]; 
  temp_edge[25] = (-7.5*fskin[25])+5.809475019311125*fskin[19]-3.354101966249684*fskin[15]; 
  temp_edge[26] = (-7.5*fskin[26])+5.809475019311125*fskin[24]-3.354101966249685*fskin[21]; 
  ...
  edge_incr[8] = 0.7071067811865475*nuVtSqSum[2]*temp_edge[20]+0.7071067811865475*nuVtSqSum[1]*temp_edge[12]+0.7071067811865475*nuVtSqSum[0]*temp_edge[8]; 
  edge_incr[9] = 0.7071067811865475*nuVtSqSum[2]*temp_edge[21]+0.7071067811865475*nuVtSqSum[1]*temp_edge[15]+0.7071067811865475*nuVtSqSum[0]*temp_edge[9]; 
  ...
  edge_incr[12] = 0.632455532033676*nuVtSqSum[1]*temp_edge[20]+0.6324555320336759*nuVtSqSum[2]*temp_edge[12]+0.7071067811865475*nuVtSqSum[0]*temp_edge[12]+0.7071067811865475*nuVtSqSum[1]*temp_edge[8]; 
  ...
  edge_incr[14] = 0.7071067811865475*nuVtSqSum[2]*temp_edge[23]+0.7071067811865475*nuVtSqSum[1]*temp_edge[18]+0.7071067811865475*nuVtSqSum[0]*temp_edge[14]; 
  edge_incr[15] = 0.632455532033676*nuVtSqSum[1]*temp_edge[21]+0.6324555320336759*nuVtSqSum[2]*temp_edge[15]+0.7071067811865475*nuVtSqSum[0]*temp_edge[15]+0.7071067811865475*nuVtSqSum[1]*temp_edge[9]; 
  edge_incr[16] = 0.7071067811865475*nuVtSqSum[2]*temp_edge[24]+0.7071067811865475*nuVtSqSum[1]*temp_edge[19]+0.7071067811865475*nuVtSqSum[0]*temp_edge[16]; 
  ...
  edge_incr[18] = 0.6324555320336759*nuVtSqSum[1]*temp_edge[23]+0.6324555320336759*nuVtSqSum[2]*temp_edge[18]+0.7071067811865475*nuVtSqSum[0]*temp_edge[18]+0.7071067811865475*nuVtSqSum[1]*temp_edge[14]; 
  edge_incr[19] = 0.6324555320336759*nuVtSqSum[1]*temp_edge[24]+0.6324555320336759*nuVtSqSum[2]*temp_edge[19]+0.7071067811865475*nuVtSqSum[0]*temp_edge[19]+0.7071067811865475*nuVtSqSum[1]*temp_edge[16]; 
  edge_incr[20] = 0.4517539514526256*nuVtSqSum[2]*temp_edge[20]+0.7071067811865475*nuVtSqSum[0]*temp_edge[20]+0.632455532033676*nuVtSqSum[1]*temp_edge[12]+0.7071067811865475*nuVtSqSum[2]*temp_edge[8]; 
  edge_incr[21] = 0.4517539514526256*nuVtSqSum[2]*temp_edge[21]+0.7071067811865475*nuVtSqSum[0]*temp_edge[21]+0.632455532033676*nuVtSqSum[1]*temp_edge[15]+0.7071067811865475*nuVtSqSum[2]*temp_edge[9]; 
  edge_incr[22] = 0.7071067811865475*nuVtSqSum[2]*temp_edge[26]+0.7071067811865475*nuVtSqSum[1]*temp_edge[25]+0.7071067811865475*nuVtSqSum[0]*temp_edge[22]; 
  edge_incr[23] = 0.4517539514526256*nuVtSqSum[2]*temp_edge[23]+0.7071067811865475*nuVtSqSum[0]*temp_edge[23]+0.6324555320336759*nuVtSqSum[1]*temp_edge[18]+0.7071067811865475*nuVtSqSum[2]*temp_edge[14]; 
  edge_incr[24] = 0.4517539514526256*nuVtSqSum[2]*temp_edge[24]+0.7071067811865475*nuVtSqSum[0]*temp_edge[24]+0.6324555320336759*nuVtSqSum[1]*temp_edge[19]+0.7071067811865475*nuVtSqSum[2]*temp_edge[16]; 
  edge_incr[25] = 0.6324555320336759*nuVtSqSum[1]*temp_edge[26]+0.6324555320336759*nuVtSqSum[2]*temp_edge[25]+0.7071067811865475*nuVtSqSum[0]*temp_edge[25]+0.7071067811865475*nuVtSqSum[1]*temp_edge[22]; 
  edge_incr[26] = 0.4517539514526256*nuVtSqSum[2]*temp_edge[26]+0.7071067811865475*nuVtSqSum[0]*temp_edge[26]+0.6324555320336759*nuVtSqSum[1]*temp_edge[25]+0.7071067811865475*nuVtSqSum[2]*temp_edge[22]; 
