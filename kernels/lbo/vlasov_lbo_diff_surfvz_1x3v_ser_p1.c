...
{ 
  ...
  diff_incr[0] = (-0.3827327723098713*nuVtSqSum[1]*fr[8])+0.3827327723098713*nuVtSqSum[1]*fl[8]-0.3827327723098713*nuVtSqSum[0]*fr[4]+0.3827327723098713*nuVtSqSum[0]*fl[4]+0.3977475644174328*fr[1]*nuVtSqSum[1]+0.3977475644174328*fl[1]*nuVtSqSum[1]-0.7954951288348656*fc[1]*nuVtSqSum[1]+0.3977475644174328*fr[0]*nuVtSqSum[0]+0.3977475644174328*fl[0]*nuVtSqSum[0]-0.7954951288348656*fc[0]*nuVtSqSum[0]; 
  diff_incr[1] = (-0.3827327723098713*nuVtSqSum[0]*fr[8])+0.3827327723098713*nuVtSqSum[0]*fl[8]-0.3827327723098713*nuVtSqSum[1]*fr[4]+0.3827327723098713*nuVtSqSum[1]*fl[4]+0.3977475644174328*fr[0]*nuVtSqSum[1]+0.3977475644174328*fl[0]*nuVtSqSum[1]-0.7954951288348656*fc[0]*nuVtSqSum[1]+0.3977475644174328*nuVtSqSum[0]*fr[1]+0.3977475644174328*nuVtSqSum[0]*fl[1]-0.7954951288348656*nuVtSqSum[0]*fc[1]; 
  ...
  diff_incr[3] = (-0.3827327723098713*nuVtSqSum[1]*fr[13])+0.3827327723098713*nuVtSqSum[1]*fl[13]-0.3827327723098713*nuVtSqSum[0]*fr[10]+0.3827327723098713*nuVtSqSum[0]*fl[10]+0.3977475644174328*nuVtSqSum[1]*fr[6]+0.3977475644174328*nuVtSqSum[1]*fl[6]-0.7954951288348656*nuVtSqSum[1]*fc[6]+0.3977475644174328*nuVtSqSum[0]*fr[3]+0.3977475644174328*nuVtSqSum[0]*fl[3]-0.7954951288348656*nuVtSqSum[0]*fc[3]; 
  diff_incr[4] = (-0.3093592167691144*nuVtSqSum[1]*fr[8])-0.3093592167691144*nuVtSqSum[1]*fl[8]-2.032931995911323*nuVtSqSum[1]*fc[8]-0.3093592167691144*nuVtSqSum[0]*fr[4]-0.3093592167691144*nuVtSqSum[0]*fl[4]-2.032931995911323*nuVtSqSum[0]*fc[4]+0.3827327723098713*fr[1]*nuVtSqSum[1]-0.3827327723098713*fl[1]*nuVtSqSum[1]+0.3827327723098713*fr[0]*nuVtSqSum[0]-0.3827327723098713*fl[0]*nuVtSqSum[0]; 
  ...
  diff_incr[6] = (-0.3827327723098713*nuVtSqSum[0]*fr[13])+0.3827327723098713*nuVtSqSum[0]*fl[13]-0.3827327723098713*nuVtSqSum[1]*fr[10]+0.3827327723098713*nuVtSqSum[1]*fl[10]+0.3977475644174328*nuVtSqSum[0]*fr[6]+0.3977475644174328*nuVtSqSum[0]*fl[6]-0.7954951288348656*nuVtSqSum[0]*fc[6]+0.3977475644174328*nuVtSqSum[1]*fr[3]+0.3977475644174328*nuVtSqSum[1]*fl[3]-0.7954951288348656*nuVtSqSum[1]*fc[3]; 
  diff_incr[7] = (-0.3827327723098713*nuVtSqSum[1]*fr[15])+0.3827327723098713*nuVtSqSum[1]*fl[15]-0.3827327723098713*nuVtSqSum[0]*fr[14]+0.3827327723098713*nuVtSqSum[0]*fl[14]+0.3977475644174328*nuVtSqSum[1]*fr[11]+0.3977475644174328*nuVtSqSum[1]*fl[11]-0.7954951288348656*nuVtSqSum[1]*fc[11]+0.3977475644174328*nuVtSqSum[0]*fr[7]+0.3977475644174328*nuVtSqSum[0]*fl[7]-0.7954951288348656*nuVtSqSum[0]*fc[7]; 
  diff_incr[8] = (-0.3093592167691144*nuVtSqSum[0]*fr[8])-0.3093592167691144*nuVtSqSum[0]*fl[8]-2.032931995911323*nuVtSqSum[0]*fc[8]-0.3093592167691144*nuVtSqSum[1]*fr[4]-0.3093592167691144*nuVtSqSum[1]*fl[4]-2.032931995911323*nuVtSqSum[1]*fc[4]+0.3827327723098713*fr[0]*nuVtSqSum[1]-0.3827327723098713*fl[0]*nuVtSqSum[1]+0.3827327723098713*nuVtSqSum[0]*fr[1]-0.3827327723098713*nuVtSqSum[0]*fl[1]; 
  diff_incr[9] = (-0.3093592167691144*nuVtSqSum[1]*fr[12])-0.3093592167691144*nuVtSqSum[1]*fl[12]-2.032931995911323*nuVtSqSum[1]*fc[12]-0.3093592167691144*nuVtSqSum[0]*fr[9]-0.3093592167691144*nuVtSqSum[0]*fl[9]-2.032931995911323*nuVtSqSum[0]*fc[9]+0.3827327723098713*nuVtSqSum[1]*fr[5]-0.3827327723098713*nuVtSqSum[1]*fl[5]+0.3827327723098713*nuVtSqSum[0]*fr[2]-0.3827327723098713*nuVtSqSum[0]*fl[2]; 
  ...
  diff_incr[11] = (-0.3827327723098713*nuVtSqSum[0]*fr[15])+0.3827327723098713*nuVtSqSum[0]*fl[15]-0.3827327723098713*nuVtSqSum[1]*fr[14]+0.3827327723098713*nuVtSqSum[1]*fl[14]+0.3977475644174328*nuVtSqSum[0]*fr[11]+0.3977475644174328*nuVtSqSum[0]*fl[11]-0.7954951288348656*nuVtSqSum[0]*fc[11]+0.3977475644174328*nuVtSqSum[1]*fr[7]+0.3977475644174328*nuVtSqSum[1]*fl[7]-0.7954951288348656*nuVtSqSum[1]*fc[7]; 
  diff_incr[12] = (-0.3093592167691144*nuVtSqSum[0]*fr[12])-0.3093592167691144*nuVtSqSum[0]*fl[12]-2.032931995911323*nuVtSqSum[0]*fc[12]-0.3093592167691144*nuVtSqSum[1]*fr[9]-0.3093592167691144*nuVtSqSum[1]*fl[9]-2.032931995911323*nuVtSqSum[1]*fc[9]+0.3827327723098713*nuVtSqSum[0]*fr[5]-0.3827327723098713*nuVtSqSum[0]*fl[5]+0.3827327723098713*nuVtSqSum[1]*fr[2]-0.3827327723098713*nuVtSqSum[1]*fl[2]; 
