...
{ 
  ...
  gkyl_mat_set(A,22,10,0.6324555320336759*ucMSelf[2]*mnu+0.6324555320336759*ucMOther[2]*mnu+3.794733192202055*m0r[2]*mnu-1.264911064067352*cEr[2]*mnu+0.7071067811865475*ucMSelf[0]*mnu+0.7071067811865475*ucMOther[0]*mnu+4.242640687119286*m0r[0]*mnu-1.414213562373095*cEr[0]*mnu); 
  gkyl_mat_set(A,22,11,0.6324555320336759*ucMSelf[1]*mnu+0.6324555320336759*ucMOther[1]*mnu+3.794733192202055*m0r[1]*mnu-1.264911064067352*cEr[1]*mnu); 
  ...
  gkyl_mat_set(A,23,10,0.6324555320336759*ucMSelf[1]*mnu+0.6324555320336759*ucMOther[1]*mnu+3.794733192202055*m0r[1]*mnu-1.264911064067352*cEr[1]*mnu); 
