...
GKYL_CU_DH void vlasov_cross_prim_moments_1x3v_ser_p2(struct gkyl_mat *A, struct gkyl_mat *rhs, const double betaGreenep1, const double *greene, const double m_self, const double *u_self, const double *vtsq_self, const double m_other, const double *u_other, const double *vtsq_other, const double *moms, const double *boundary_corrections) 
{ 
  ...
  gkyl_mat_set(A,9,2,(-0.3194382824999699*m0r[2]*u_self[2])-0.5*m0r[0]*u_self[2]-0.3194382824999699*m0r[2]*u_other[2]-0.5*m0r[0]*u_other[2]+1.414213562373095*m1r[2]-0.5*u_self[0]*m0r[2]-0.5*u_other[0]*m0r[2]-0.4472135954999579*m0r[1]*u_self[1]-0.4472135954999579*m0r[1]*u_other[1]); 
  ...
  gkyl_mat_set(A,11,0,(-0.3194382824999699*m0r[2]*u_self[2])-0.5*m0r[0]*u_self[2]-0.3194382824999699*m0r[2]*u_other[2]-0.5*m0r[0]*u_other[2]+1.414213562373095*m1r[2]-0.5*u_self[0]*m0r[2]-0.5*u_other[0]*m0r[2]-0.4472135954999579*m0r[1]*u_self[1]-0.4472135954999579*m0r[1]*u_other[1]); 
  ...
  gkyl_mat_set(A,11,2,(-1.071428571428571*m0r[2]*u_self[2])-0.3194382824999699*m0r[0]*u_self[2]-1.071428571428571*m0r[2]*u_other[2]-0.3194382824999699*m0r[0]*u_other[2]+0.9035079029052515*m1r[2]-0.3194382824999699*u_self[0]*m0r[2]-0.3194382824999699*u_other[0]*m0r[2]-0.7857142857142857*m0r[1]*u_self[1]-0.7857142857142857*m0r[1]*u_other[1]-0.5*m0r[0]*u_self[0]-0.5*m0r[0]*u_other[0]+1.414213562373095*m1r[0]); 
 
  momRHS[0] += -0.7071067811865475*((greene[2]*u_self[2]-1.0*greene[2]*u_other[2]+greene[1]*u_self[1]-1.0*greene[1]*u_other[1]+greene[0]*u_self[0]-1.0*greene[0]*u_other[0])*betaGreenep1-2.82842712474619*m1r[0]); 
  momRHS[1] += -0.1414213562373095*((4.47213595499958*greene[1]*u_self[2]-4.47213595499958*greene[1]*u_other[2]+(4.47213595499958*u_self[1]-4.47213595499958*u_other[1])*greene[2]+5.0*greene[0]*u_self[1]-5.0*greene[0]*u_other[1]+(5.0*u_self[0]-5.0*u_other[0])*greene[1])*betaGreenep1-14.14213562373095*m1r[1]); 
  momRHS[2] += -0.02020305089104421*(((22.3606797749979*greene[2]+35.0*greene[0])*u_self[2]+((-22.3606797749979*greene[2])-35.0*greene[0])*u_other[2]+(35.0*u_self[0]-35.0*u_other[0])*greene[2]+31.30495168499705*greene[1]*u_self[1]-31.30495168499705*greene[1]*u_other[1])*betaGreenep1-98.99494936611667*m1r[2]); 
  ...
  gkyl_mat_set(A,9,5,(-0.3194382824999699*m0r[2]*u_self[5])-0.5*m0r[0]*u_self[5]-0.3194382824999699*m0r[2]*u_other[5]-0.5*m0r[0]*u_other[5]+1.414213562373095*m1r[5]-0.4472135954999579*m0r[1]*u_self[4]-0.4472135954999579*m0r[1]*u_other[4]-0.5*m0r[2]*u_self[3]-0.5*m0r[2]*u_other[3]); 
  ...
  gkyl_mat_set(A,11,3,(-0.3194382824999699*m0r[2]*u_self[5])-0.5*m0r[0]*u_self[5]-0.3194382824999699*m0r[2]*u_other[5]-0.5*m0r[0]*u_other[5]+1.414213562373095*m1r[5]-0.4472135954999579*m0r[1]*u_self[4]-0.4472135954999579*m0r[1]*u_other[4]-0.5*m0r[2]*u_self[3]-0.5*m0r[2]*u_other[3]); 
  ...
  gkyl_mat_set(A,11,5,(-1.071428571428571*m0r[2]*u_self[5])-0.3194382824999699*m0r[0]*u_self[5]-1.071428571428571*m0r[2]*u_other[5]-0.3194382824999699*m0r[0]*u_other[5]+0.9035079029052515*m1r[5]-0.7857142857142857*m0r[1]*u_self[4]-0.7857142857142857*m0r[1]*u_other[4]-0.3194382824999699*m0r[2]*u_self[3]-0.5*m0r[0]*u_self[3]-0.3194382824999699*m0r[2]*u_other[3]-0.5*m0r[0]*u_other[3]+1.414213562373095*m1r[3]); 
 
  momRHS[3] += -0.7071067811865475*((greene[2]*u_self[5]-1.0*greene[2]*u_other[5]+greene[1]*u_self[4]-1.0*greene[1]*u_other[4]+greene[0]*u_self[3]-1.0*greene[0]*u_other[3])*betaGreenep1-2.82842712474619*m1r[3]); 
  momRHS[4] += -0.1414213562373095*((4.47213595499958*greene[1]*u_self[5]-4.47213595499958*greene[1]*u_other[5]+(4.47213595499958*greene[2]+5.0*greene[0])*u_self[4]+((-4.47213595499958*greene[2])-5.0*greene[0])*u_other[4]+5.0*greene[1]*u_self[3]-5.0*greene[1]*u_other[3])*betaGreenep1-14.14213562373095*m1r[4]); 
  momRHS[5] += -0.02020305089104421*(((22.3606797749979*greene[2]+35.0*greene[0])*u_self[5]+((-22.3606797749979*greene[2])-35.0*greene[0])*u_other[5]+31.30495168499705*greene[1]*u_self[4]-31.30495168499705*greene[1]*u_other[4]+35.0*greene[2]*u_self[3]-35.0*greene[2]*u_other[3])*betaGreenep1-98.99494936611667*m1r[5]); 
  ...
  gkyl_mat_set(A,9,8,(-0.3194382824999699*m0r[2]*u_self[8])-0.5*m0r[0]*u_self[8]-0.3194382824999699*m0r[2]*u_other[8]-0.5*m0r[0]*u_other[8]+1.414213562373095*m1r[8]-0.4472135954999579*m0r[1]*u_self[7]-0.4472135954999579*m0r[1]*u_other[7]-0.5*m0r[2]*u_self[6]-0.5*m0r[2]*u_other[6]); 
  ...
  gkyl_mat_set(A,11,6,(-0.3194382824999699*m0r[2]*u_self[8])-0.5*m0r[0]*u_self[8]-0.3194382824999699*m0r[2]*u_other[8]-0.5*m0r[0]*u_other[8]+1.414213562373095*m1r[8]-0.4472135954999579*m0r[1]*u_self[7]-0.4472135954999579*m0r[1]*u_other[7]-0.5*m0r[2]*u_self[6]-0.5*m0r[2]*u_other[6]); 
  ...
  gkyl_mat_set(A,11,8,(-1.071428571428571*m0r[2]*u_self[8])-0.3194382824999699*m0r[0]*u_self[8]-1.071428571428571*m0r[2]*u_other[8]-0.3194382824999699*m0r[0]*u_other[8]+0.9035079029052515*m1r[8]-0.7857142857142857*m0r[1]*u_self[7]-0.7857142857142857*m0r[1]*u_other[7]-0.3194382824999699*m0r[2]*u_self[6]-0.5*m0r[0]*u_self[6]-0.3194382824999699*m0r[2]*u_other[6]-0.5*m0r[0]*u_other[6]+1.414213562373095*m1r[6]); 
 
  momRHS[6] += -0.7071067811865475*((greene[2]*u_self[8]-1.0*greene[2]*u_other[8]+greene[1]*u_self[7]-1.0*greene[1]*u_other[7]+greene[0]*u_self[6]-1.0*greene[0]*u_other[6])*betaGreenep1-2.82842712474619*m1r[6]); 
  momRHS[7] += -0.1414213562373095*((4.47213595499958*greene[1]*u_self[8]-4.47213595499958*greene[1]*u_other[8]+(4.47213595499958*greene[2]+5.0*greene[0])*u_self[7]+((-4.47213595499958*greene[2])-5.0*greene[0])*u_other[7]+5.0*greene[1]*u_self[6]-5.0*greene[1]*u_other[6])*betaGreenep1-14.14213562373095*m1r[7]); 
  momRHS[8] += -0.02020305089104421*(((22.3606797749979*greene[2]+35.0*greene[0])*u_self[8]+((-22.3606797749979*greene[2])-35.0*greene[0])*u_other[8]+31.30495168499705*greene[1]*u_self[7]-31.30495168499705*greene[1]*u_other[7]+35.0*greene[2]*u_self[6]-35.0*greene[2]*u_other[6])*betaGreenep1-98.99494936611667*m1r[8]); 
  ...
  gkyl_mat_set(A,10,10,0.6324555320336759*ucMSelf[2]+0.6324555320336759*ucMOther[2]+3.794733192202055*m0r[2]-1.264911064067352*cEr[2]+0.7071067811865475*ucMSelf[0]+0.7071067811865475*ucMOther[0]+4.242640687119286*m0r[0]-1.414213562373095*cEr[0]); 
  gkyl_mat_set(A,10,11,0.6324555320336759*ucMSelf[1]+0.6324555320336759*ucMOther[1]+3.794733192202055*m0r[1]-1.264911064067352*cEr[1]); 
  ...
  gkyl_mat_set(A,11,10,0.6324555320336759*ucMSelf[1]+0.6324555320336759*ucMOther[1]+3.794733192202055*m0r[1]-1.264911064067352*cEr[1]); 
  ...
  enRHS[0] = (-(6.0*greene[2]*vtsq_self[2]*betaGreenep1*m_self)/(2.82842712474619*m_self+2.82842712474619*m_other))-(1.0*greene[2]*uSumSq[2]*betaGreenep1*m_self)/(2.82842712474619*m_self+2.82842712474619*m_other)-(6.0*greene[1]*vtsq_self[1]*betaGreenep1*m_self)/(2.82842712474619*m_self+2.82842712474619*m_other)-(1.0*greene[1]*uSumSq[1]*betaGreenep1*m_self)/(2.82842712474619*m_self+2.82842712474619*m_other)-(6.0*greene[0]*vtsq_self[0]*betaGreenep1*m_self)/(2.82842712474619*m_self+2.82842712474619*m_other)-(1.0*greene[0]*uSumSq[0]*betaGreenep1*m_self)/(2.82842712474619*m_self+2.82842712474619*m_other)+(6.0*greene[2]*vtsq_other[2]*betaGreenep1*m_other)/(2.82842712474619*m_self+2.82842712474619*m_other)+(greene[2]*uSumSq[2]*betaGreenep1*m_other)/(2.82842712474619*m_self+2.82842712474619*m_other)+(6.0*greene[1]*vtsq_other[1]*betaGreenep1*m_other)/(2.82842712474619*m_self+2.82842712474619*m_other)+(greene[1]*uSumSq[1]*betaGreenep1*m_other)/(2.82842712474619*m_self+2.82842712474619*m_other)+(6.0*greene[0]*vtsq_other[0]*betaGreenep1*m_other)/(2.82842712474619*m_self+2.82842712474619*m_other)+(greene[0]*uSumSq[0]*betaGreenep1*m_other)/(2.82842712474619*m_self+2.82842712474619*m_other)-1.0*uM1Self[0]-1.0*uM1Other[0]+2.0*m2r[0]; 
  enRHS[1] = (-(26.83281572999747*greene[1]*vtsq_self[2]*betaGreenep1*m_self)/(14.14213562373095*m_self+14.14213562373095*m_other))-(4.47213595499958*greene[1]*uSumSq[2]*betaGreenep1*m_self)/(14.14213562373095*m_self+14.14213562373095*m_other)-(26.83281572999747*vtsq_self[1]*greene[2]*betaGreenep1*m_self)/(14.14213562373095*m_self+14.14213562373095*m_other)-(4.47213595499958*uSumSq[1]*greene[2]*betaGreenep1*m_self)/(14.14213562373095*m_self+14.14213562373095*m_other)-(30.0*greene[0]*vtsq_self[1]*betaGreenep1*m_self)/(14.14213562373095*m_self+14.14213562373095*m_other)-(5.0*greene[0]*uSumSq[1]*betaGreenep1*m_self)/(14.14213562373095*m_self+14.14213562373095*m_other)-(30.0*vtsq_self[0]*greene[1]*betaGreenep1*m_self)/(14.14213562373095*m_self+14.14213562373095*m_other)-(5.0*uSumSq[0]*greene[1]*betaGreenep1*m_self)/(14.14213562373095*m_self+14.14213562373095*m_other)+(26.83281572999747*greene[1]*vtsq_other[2]*betaGreenep1*m_other)/(14.14213562373095*m_self+14.14213562373095*m_other)+(4.47213595499958*greene[1]*uSumSq[2]*betaGreenep1*m_other)/(14.14213562373095*m_self+14.14213562373095*m_other)+(26.83281572999747*vtsq_other[1]*greene[2]*betaGreenep1*m_other)/(14.14213562373095*m_self+14.14213562373095*m_other)+(4.47213595499958*uSumSq[1]*greene[2]*betaGreenep1*m_other)/(14.14213562373095*m_self+14.14213562373095*m_other)+(30.0*greene[0]*vtsq_other[1]*betaGreenep1*m_other)/(14.14213562373095*m_self+14.14213562373095*m_other)+(5.0*greene[0]*uSumSq[1]*betaGreenep1*m_other)/(14.14213562373095*m_self+14.14213562373095*m_other)+(30.0*vtsq_other[0]*greene[1]*betaGreenep1*m_other)/(14.14213562373095*m_self+14.14213562373095*m_other)+(5.0*uSumSq[0]*greene[1]*betaGreenep1*m_other)/(14.14213562373095*m_self+14.14213562373095*m_other)-1.0*uM1Self[1]-1.0*uM1Other[1]+2.0*m2r[1]; 
  enRHS[2] = (-(134.1640786499874*greene[2]*vtsq_self[2]*betaGreenep1*m_self)/(98.99494936611667*m_self+98.99494936611667*m_other))-(210.0*greene[0]*vtsq_self[2]*betaGreenep1*m_self)/(98.99494936611667*m_self+98.99494936611667*m_other)-(22.3606797749979*greene[2]*uSumSq[2]*betaGreenep1*m_self)/(98.99494936611667*m_self+98.99494936611667*m_other)-(35.0*greene[0]*uSumSq[2]*betaGreenep1*m_self)/(98.99494936611667*m_self+98.99494936611667*m_other)-(210.0*vtsq_self[0]*greene[2]*betaGreenep1*m_self)/(98.99494936611667*m_self+98.99494936611667*m_other)-(35.0*uSumSq[0]*greene[2]*betaGreenep1*m_self)/(98.99494936611667*m_self+98.99494936611667*m_other)-(187.8297101099823*greene[1]*vtsq_self[1]*betaGreenep1*m_self)/(98.99494936611667*m_self+98.99494936611667*m_other)-(31.30495168499705*greene[1]*uSumSq[1]*betaGreenep1*m_self)/(98.99494936611667*m_self+98.99494936611667*m_other)+(134.1640786499874*greene[2]*vtsq_other[2]*betaGreenep1*m_other)/(98.99494936611667*m_self+98.99494936611667*m_other)+(210.0*greene[0]*vtsq_other[2]*betaGreenep1*m_other)/(98.99494936611667*m_self+98.99494936611667*m_other)+(22.3606797749979*greene[2]*uSumSq[2]*betaGreenep1*m_other)/(98.99494936611667*m_self+98.99494936611667*m_other)+(35.0*greene[0]*uSumSq[2]*betaGreenep1*m_other)/(98.99494936611667*m_self+98.99494936611667*m_other)+(210.0*vtsq_other[0]*greene[2]*betaGreenep1*m_other)/(98.99494936611667*m_self+98.99494936611667*m_other)+(35.0*uSumSq[0]*greene[2]*betaGreenep1*m_other)/(98.99494936611667*m_self+98.99494936611667*m_other)+(187.8297101099823*greene[1]*vtsq_other[1]*betaGreenep1*m_other)/(98.99494936611667*m_self+98.99494936611667*m_other)+(31.30495168499705*greene[1]*uSumSq[1]*betaGreenep1*m_other)/(98.99494936611667*m_self+98.99494936611667*m_other)-1.0*uM1Self[2]-1.0*uM1Other[2]+2.0*m2r[2]; 
