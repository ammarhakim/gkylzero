...
GKYL_CU_DH void vlasov_cross_prim_moments_1x3v_ser_p2(struct gkyl_mat *A, struct gkyl_mat *rhs, const double *greene, const double m_self, const double *u_self, const double *vtsq_self, const double m_other, const double *u_other, const double *vtsq_other, const double *moms, const double *boundary_corrections) 
{ 
  ...
  momRHS[0] += -0.7071067811865475*(greene[2]*u_self[2]-1.0*greene[2]*u_other[2]+greene[1]*u_self[1]-1.0*greene[1]*u_other[1]+greene[0]*u_self[0]-1.0*greene[0]*u_other[0]-2.82842712474619*m1r[0]); 
  ...
  momRHS[2] += -0.02020305089104421*((22.3606797749979*greene[2]+35.0*greene[0])*u_self[2]+((-22.3606797749979*greene[2])-35.0*greene[0])*u_other[2]-98.99494936611667*m1r[2]+(35.0*u_self[0]-35.0*u_other[0])*greene[2]+31.30495168499705*greene[1]*u_self[1]-31.30495168499705*greene[1]*u_other[1]); 
  ...
  momRHS[3] += -0.7071067811865475*(greene[2]*u_self[5]-1.0*greene[2]*u_other[5]+greene[1]*u_self[4]-1.0*greene[1]*u_other[4]+greene[0]*u_self[3]-1.0*greene[0]*u_other[3]-2.82842712474619*m1r[3]); 
  ...
  momRHS[5] += -0.02020305089104421*((22.3606797749979*greene[2]+35.0*greene[0])*u_self[5]+((-22.3606797749979*greene[2])-35.0*greene[0])*u_other[5]-98.99494936611667*m1r[5]+31.30495168499705*greene[1]*u_self[4]-31.30495168499705*greene[1]*u_other[4]+35.0*greene[2]*u_self[3]-35.0*greene[2]*u_other[3]); 
  ...
  momRHS[6] += -0.7071067811865475*(greene[2]*u_self[8]-1.0*greene[2]*u_other[8]+greene[1]*u_self[7]-1.0*greene[1]*u_other[7]+greene[0]*u_self[6]-1.0*greene[0]*u_other[6]-2.82842712474619*m1r[6]); 
  ...
  momRHS[8] += -0.02020305089104421*((22.3606797749979*greene[2]+35.0*greene[0])*u_self[8]+((-22.3606797749979*greene[2])-35.0*greene[0])*u_other[8]-98.99494936611667*m1r[8]+31.30495168499705*greene[1]*u_self[7]-31.30495168499705*greene[1]*u_other[7]+35.0*greene[2]*u_self[6]-35.0*greene[2]*u_other[6]); 
  ...
  enRHS[0] = (-(6.0*greene[2]*vtsq_self[2]*m_self)/(2.82842712474619*m_self+2.82842712474619*m_other))-(1.0*greene[2]*uSumSq[2]*m_self)/(2.82842712474619*m_self+2.82842712474619*m_other)-(6.0*greene[1]*vtsq_self[1]*m_self)/(2.82842712474619*m_self+2.82842712474619*m_other)-(1.0*greene[1]*uSumSq[1]*m_self)/(2.82842712474619*m_self+2.82842712474619*m_other)-(6.0*greene[0]*vtsq_self[0]*m_self)/(2.82842712474619*m_self+2.82842712474619*m_other)-(1.0*greene[0]*uSumSq[0]*m_self)/(2.82842712474619*m_self+2.82842712474619*m_other)+(6.0*greene[2]*vtsq_other[2]*m_other)/(2.82842712474619*m_self+2.82842712474619*m_other)+(greene[2]*uSumSq[2]*m_other)/(2.82842712474619*m_self+2.82842712474619*m_other)+(6.0*greene[1]*vtsq_other[1]*m_other)/(2.82842712474619*m_self+2.82842712474619*m_other)+(greene[1]*uSumSq[1]*m_other)/(2.82842712474619*m_self+2.82842712474619*m_other)+(6.0*greene[0]*vtsq_other[0]*m_other)/(2.82842712474619*m_self+2.82842712474619*m_other)+(greene[0]*uSumSq[0]*m_other)/(2.82842712474619*m_self+2.82842712474619*m_other)-1.0*uM1Self[0]-1.0*uM1Other[0]+2.0*m2r[0]; 
  enRHS[1] = (-(26.83281572999747*greene[1]*vtsq_self[2]*m_self)/(14.14213562373095*m_self+14.14213562373095*m_other))-(4.47213595499958*greene[1]*uSumSq[2]*m_self)/(14.14213562373095*m_self+14.14213562373095*m_other)-(26.83281572999747*vtsq_self[1]*greene[2]*m_self)/(14.14213562373095*m_self+14.14213562373095*m_other)-(4.47213595499958*uSumSq[1]*greene[2]*m_self)/(14.14213562373095*m_self+14.14213562373095*m_other)-(30.0*greene[0]*vtsq_self[1]*m_self)/(14.14213562373095*m_self+14.14213562373095*m_other)-(5.0*greene[0]*uSumSq[1]*m_self)/(14.14213562373095*m_self+14.14213562373095*m_other)-(30.0*vtsq_self[0]*greene[1]*m_self)/(14.14213562373095*m_self+14.14213562373095*m_other)-(5.0*uSumSq[0]*greene[1]*m_self)/(14.14213562373095*m_self+14.14213562373095*m_other)+(26.83281572999747*greene[1]*vtsq_other[2]*m_other)/(14.14213562373095*m_self+14.14213562373095*m_other)+(4.47213595499958*greene[1]*uSumSq[2]*m_other)/(14.14213562373095*m_self+14.14213562373095*m_other)+(26.83281572999747*vtsq_other[1]*greene[2]*m_other)/(14.14213562373095*m_self+14.14213562373095*m_other)+(4.47213595499958*uSumSq[1]*greene[2]*m_other)/(14.14213562373095*m_self+14.14213562373095*m_other)+(30.0*greene[0]*vtsq_other[1]*m_other)/(14.14213562373095*m_self+14.14213562373095*m_other)+(5.0*greene[0]*uSumSq[1]*m_other)/(14.14213562373095*m_self+14.14213562373095*m_other)+(30.0*vtsq_other[0]*greene[1]*m_other)/(14.14213562373095*m_self+14.14213562373095*m_other)+(5.0*uSumSq[0]*greene[1]*m_other)/(14.14213562373095*m_self+14.14213562373095*m_other)-1.0*uM1Self[1]-1.0*uM1Other[1]+2.0*m2r[1]; 
  enRHS[2] = (-(134.1640786499874*greene[2]*vtsq_self[2]*m_self)/(98.99494936611667*m_self+98.99494936611667*m_other))-(210.0*greene[0]*vtsq_self[2]*m_self)/(98.99494936611667*m_self+98.99494936611667*m_other)-(22.3606797749979*greene[2]*uSumSq[2]*m_self)/(98.99494936611667*m_self+98.99494936611667*m_other)-(35.0*greene[0]*uSumSq[2]*m_self)/(98.99494936611667*m_self+98.99494936611667*m_other)-(210.0*vtsq_self[0]*greene[2]*m_self)/(98.99494936611667*m_self+98.99494936611667*m_other)-(35.0*uSumSq[0]*greene[2]*m_self)/(98.99494936611667*m_self+98.99494936611667*m_other)-(187.8297101099823*greene[1]*vtsq_self[1]*m_self)/(98.99494936611667*m_self+98.99494936611667*m_other)-(31.30495168499705*greene[1]*uSumSq[1]*m_self)/(98.99494936611667*m_self+98.99494936611667*m_other)+(134.1640786499874*greene[2]*vtsq_other[2]*m_other)/(98.99494936611667*m_self+98.99494936611667*m_other)+(210.0*greene[0]*vtsq_other[2]*m_other)/(98.99494936611667*m_self+98.99494936611667*m_other)+(22.3606797749979*greene[2]*uSumSq[2]*m_other)/(98.99494936611667*m_self+98.99494936611667*m_other)+(35.0*greene[0]*uSumSq[2]*m_other)/(98.99494936611667*m_self+98.99494936611667*m_other)+(210.0*vtsq_other[0]*greene[2]*m_other)/(98.99494936611667*m_self+98.99494936611667*m_other)+(35.0*uSumSq[0]*greene[2]*m_other)/(98.99494936611667*m_self+98.99494936611667*m_other)+(187.8297101099823*greene[1]*vtsq_other[1]*m_other)/(98.99494936611667*m_self+98.99494936611667*m_other)+(31.30495168499705*greene[1]*uSumSq[1]*m_other)/(98.99494936611667*m_self+98.99494936611667*m_other)-1.0*uM1Self[2]-1.0*uM1Other[2]+2.0*m2r[2]; 
