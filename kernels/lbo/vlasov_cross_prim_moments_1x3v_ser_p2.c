...
GKYL_CU_DH void vlasov_cross_prim_moments_1x3v_ser_p2(struct gkyl_mat *A, struct gkyl_mat *rhs, const double betaGreenep1, const double m_self, const double *u_self, const double *vtsq_self, const double m_other, const double *u_other, const double *vtsq_other, const double *moms, const double *boundary_corrections) 
{ 
  ...
  momRHS[0] += -0.7071067811865475*((m0r[2]*u_self[2]-1.0*m0r[2]*u_other[2]+m0r[1]*u_self[1]-1.0*m0r[1]*u_other[1]+m0r[0]*u_self[0]-1.0*m0r[0]*u_other[0])*betaGreenep1-2.82842712474619*m1r[0]); 
  momRHS[1] += -0.1414213562373095*((4.47213595499958*m0r[1]*u_self[2]-4.47213595499958*m0r[1]*u_other[2]+(4.47213595499958*u_self[1]-4.47213595499958*u_other[1])*m0r[2]+5.0*m0r[0]*u_self[1]-5.0*m0r[0]*u_other[1]+(5.0*u_self[0]-5.0*u_other[0])*m0r[1])*betaGreenep1-14.14213562373095*m1r[1]); 
  momRHS[2] += -0.02020305089104421*(((22.3606797749979*m0r[2]+35.0*m0r[0])*u_self[2]+((-22.3606797749979*m0r[2])-35.0*m0r[0])*u_other[2]+(35.0*u_self[0]-35.0*u_other[0])*m0r[2]+31.30495168499705*m0r[1]*u_self[1]-31.30495168499705*m0r[1]*u_other[1])*betaGreenep1-98.99494936611667*m1r[2]); 
  ...
  momRHS[3] += -0.7071067811865475*((m0r[2]*u_self[5]-1.0*m0r[2]*u_other[5]+m0r[1]*u_self[4]-1.0*m0r[1]*u_other[4]+m0r[0]*u_self[3]-1.0*m0r[0]*u_other[3])*betaGreenep1-2.82842712474619*m1r[3]); 
  momRHS[4] += -0.1414213562373095*((4.47213595499958*m0r[1]*u_self[5]-4.47213595499958*m0r[1]*u_other[5]+(4.47213595499958*m0r[2]+5.0*m0r[0])*u_self[4]+((-4.47213595499958*m0r[2])-5.0*m0r[0])*u_other[4]+5.0*m0r[1]*u_self[3]-5.0*m0r[1]*u_other[3])*betaGreenep1-14.14213562373095*m1r[4]); 
  momRHS[5] += -0.02020305089104421*(((22.3606797749979*m0r[2]+35.0*m0r[0])*u_self[5]+((-22.3606797749979*m0r[2])-35.0*m0r[0])*u_other[5]+31.30495168499705*m0r[1]*u_self[4]-31.30495168499705*m0r[1]*u_other[4]+35.0*m0r[2]*u_self[3]-35.0*m0r[2]*u_other[3])*betaGreenep1-98.99494936611667*m1r[5]); 
  ...
  momRHS[6] += -0.7071067811865475*((m0r[2]*u_self[8]-1.0*m0r[2]*u_other[8]+m0r[1]*u_self[7]-1.0*m0r[1]*u_other[7]+m0r[0]*u_self[6]-1.0*m0r[0]*u_other[6])*betaGreenep1-2.82842712474619*m1r[6]); 
  momRHS[7] += -0.1414213562373095*((4.47213595499958*m0r[1]*u_self[8]-4.47213595499958*m0r[1]*u_other[8]+(4.47213595499958*m0r[2]+5.0*m0r[0])*u_self[7]+((-4.47213595499958*m0r[2])-5.0*m0r[0])*u_other[7]+5.0*m0r[1]*u_self[6]-5.0*m0r[1]*u_other[6])*betaGreenep1-14.14213562373095*m1r[7]); 
  momRHS[8] += -0.02020305089104421*(((22.3606797749979*m0r[2]+35.0*m0r[0])*u_self[8]+((-22.3606797749979*m0r[2])-35.0*m0r[0])*u_other[8]+31.30495168499705*m0r[1]*u_self[7]-31.30495168499705*m0r[1]*u_other[7]+35.0*m0r[2]*u_self[6]-35.0*m0r[2]*u_other[6])*betaGreenep1-98.99494936611667*m1r[8]); 
  ...
  double enRHS[3] = {0.0}; 
  enRHS[0] = (-(6.0*m0r[2]*vtsq_self[2]*betaGreenep1*m_self)/(2.82842712474619*m_self+2.82842712474619*m_other))-(1.0*m0r[2]*uSumSq[2]*betaGreenep1*m_self)/(2.82842712474619*m_self+2.82842712474619*m_other)-(6.0*m0r[1]*vtsq_self[1]*betaGreenep1*m_self)/(2.82842712474619*m_self+2.82842712474619*m_other)-(1.0*m0r[1]*uSumSq[1]*betaGreenep1*m_self)/(2.82842712474619*m_self+2.82842712474619*m_other)-(6.0*m0r[0]*vtsq_self[0]*betaGreenep1*m_self)/(2.82842712474619*m_self+2.82842712474619*m_other)-(1.0*m0r[0]*uSumSq[0]*betaGreenep1*m_self)/(2.82842712474619*m_self+2.82842712474619*m_other)+(6.0*m0r[2]*vtsq_other[2]*betaGreenep1*m_other)/(2.82842712474619*m_self+2.82842712474619*m_other)+(m0r[2]*uSumSq[2]*betaGreenep1*m_other)/(2.82842712474619*m_self+2.82842712474619*m_other)+(6.0*m0r[1]*vtsq_other[1]*betaGreenep1*m_other)/(2.82842712474619*m_self+2.82842712474619*m_other)+(m0r[1]*uSumSq[1]*betaGreenep1*m_other)/(2.82842712474619*m_self+2.82842712474619*m_other)+(6.0*m0r[0]*vtsq_other[0]*betaGreenep1*m_other)/(2.82842712474619*m_self+2.82842712474619*m_other)+(m0r[0]*uSumSq[0]*betaGreenep1*m_other)/(2.82842712474619*m_self+2.82842712474619*m_other)-1.0*uM1Self[0]-1.0*uM1Other[0]+2.0*m2r[0]; 
  enRHS[1] = (-(26.83281572999747*m0r[1]*vtsq_self[2]*betaGreenep1*m_self)/(14.14213562373095*m_self+14.14213562373095*m_other))-(4.47213595499958*m0r[1]*uSumSq[2]*betaGreenep1*m_self)/(14.14213562373095*m_self+14.14213562373095*m_other)-(26.83281572999747*vtsq_self[1]*m0r[2]*betaGreenep1*m_self)/(14.14213562373095*m_self+14.14213562373095*m_other)-(4.47213595499958*uSumSq[1]*m0r[2]*betaGreenep1*m_self)/(14.14213562373095*m_self+14.14213562373095*m_other)-(30.0*m0r[0]*vtsq_self[1]*betaGreenep1*m_self)/(14.14213562373095*m_self+14.14213562373095*m_other)-(5.0*m0r[0]*uSumSq[1]*betaGreenep1*m_self)/(14.14213562373095*m_self+14.14213562373095*m_other)-(30.0*vtsq_self[0]*m0r[1]*betaGreenep1*m_self)/(14.14213562373095*m_self+14.14213562373095*m_other)-(5.0*uSumSq[0]*m0r[1]*betaGreenep1*m_self)/(14.14213562373095*m_self+14.14213562373095*m_other)+(26.83281572999747*m0r[1]*vtsq_other[2]*betaGreenep1*m_other)/(14.14213562373095*m_self+14.14213562373095*m_other)+(4.47213595499958*m0r[1]*uSumSq[2]*betaGreenep1*m_other)/(14.14213562373095*m_self+14.14213562373095*m_other)+(26.83281572999747*vtsq_other[1]*m0r[2]*betaGreenep1*m_other)/(14.14213562373095*m_self+14.14213562373095*m_other)+(4.47213595499958*uSumSq[1]*m0r[2]*betaGreenep1*m_other)/(14.14213562373095*m_self+14.14213562373095*m_other)+(30.0*m0r[0]*vtsq_other[1]*betaGreenep1*m_other)/(14.14213562373095*m_self+14.14213562373095*m_other)+(5.0*m0r[0]*uSumSq[1]*betaGreenep1*m_other)/(14.14213562373095*m_self+14.14213562373095*m_other)+(30.0*vtsq_other[0]*m0r[1]*betaGreenep1*m_other)/(14.14213562373095*m_self+14.14213562373095*m_other)+(5.0*uSumSq[0]*m0r[1]*betaGreenep1*m_other)/(14.14213562373095*m_self+14.14213562373095*m_other)-1.0*uM1Self[1]-1.0*uM1Other[1]+2.0*m2r[1]; 
  enRHS[2] = (-(134.1640786499874*m0r[2]*vtsq_self[2]*betaGreenep1*m_self)/(98.99494936611667*m_self+98.99494936611667*m_other))-(210.0*m0r[0]*vtsq_self[2]*betaGreenep1*m_self)/(98.99494936611667*m_self+98.99494936611667*m_other)-(22.3606797749979*m0r[2]*uSumSq[2]*betaGreenep1*m_self)/(98.99494936611667*m_self+98.99494936611667*m_other)-(35.0*m0r[0]*uSumSq[2]*betaGreenep1*m_self)/(98.99494936611667*m_self+98.99494936611667*m_other)-(210.0*vtsq_self[0]*m0r[2]*betaGreenep1*m_self)/(98.99494936611667*m_self+98.99494936611667*m_other)-(35.0*uSumSq[0]*m0r[2]*betaGreenep1*m_self)/(98.99494936611667*m_self+98.99494936611667*m_other)-(187.8297101099823*m0r[1]*vtsq_self[1]*betaGreenep1*m_self)/(98.99494936611667*m_self+98.99494936611667*m_other)-(31.30495168499705*m0r[1]*uSumSq[1]*betaGreenep1*m_self)/(98.99494936611667*m_self+98.99494936611667*m_other)+(134.1640786499874*m0r[2]*vtsq_other[2]*betaGreenep1*m_other)/(98.99494936611667*m_self+98.99494936611667*m_other)+(210.0*m0r[0]*vtsq_other[2]*betaGreenep1*m_other)/(98.99494936611667*m_self+98.99494936611667*m_other)+(22.3606797749979*m0r[2]*uSumSq[2]*betaGreenep1*m_other)/(98.99494936611667*m_self+98.99494936611667*m_other)+(35.0*m0r[0]*uSumSq[2]*betaGreenep1*m_other)/(98.99494936611667*m_self+98.99494936611667*m_other)+(210.0*vtsq_other[0]*m0r[2]*betaGreenep1*m_other)/(98.99494936611667*m_self+98.99494936611667*m_other)+(35.0*uSumSq[0]*m0r[2]*betaGreenep1*m_other)/(98.99494936611667*m_self+98.99494936611667*m_other)+(187.8297101099823*m0r[1]*vtsq_other[1]*betaGreenep1*m_other)/(98.99494936611667*m_self+98.99494936611667*m_other)+(31.30495168499705*m0r[1]*uSumSq[1]*betaGreenep1*m_other)/(98.99494936611667*m_self+98.99494936611667*m_other)-1.0*uM1Self[2]-1.0*uM1Other[2]+2.0*m2r[2]; 
