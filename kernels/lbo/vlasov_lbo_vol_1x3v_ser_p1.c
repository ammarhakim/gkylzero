...
{ 
  ...
  alphaDrag[16] = (2.828427124746191*nuUSum[2]-4.0*nuSum[0]*w[2])*rdvy2; 
  alphaDrag[17] = 2.828427124746191*nuUSum[3]*rdvy2; 
  alphaDrag[19] = -1.154700538379252*nuSum[0]*dxv[2]*rdvy2; 

  // Expand rdv2*(nu*vz-nuUSumz) in phase basis.
  alphaDrag[32] = (2.828427124746191*nuUSum[4]-4.0*nuSum[0]*w[3])*rdvz2; 
  alphaDrag[33] = 2.828427124746191*nuUSum[5]*rdvz2; 
  alphaDrag[36] = -1.154700538379252*nuSum[0]*dxv[3]*rdvz2; 
