...
GKYL_CU_DH void lbo_vlasov_diff_boundary_surfvx_2x3v_ser_p1(const double *w, const double *dxv, const double *nuSum, const double *nuUSum, const double *nuVtSqSum, const int edge, const double *fSkin, const double *fEdge, double* GKYL_RESTRICT out) 
{ 
  ...
  temp_diff[1] = (-0.5412658773652741*fSkin[7])-0.5412658773652741*fEdge[7]-0.5625*fSkin[1]+0.5625*fEdge[1]; 
  temp_diff[2] = (-0.5412658773652741*fSkin[8])-0.5412658773652741*fEdge[8]-0.5625*fSkin[2]+0.5625*fEdge[2]; 
  temp_diff[3] = (-1.4375*fSkin[3])-0.4375*fEdge[3]-1.407291281149713*fSkin[0]+0.5412658773652741*fEdge[0]; 
  temp_diff[4] = (-0.5412658773652741*fSkin[11])-0.5412658773652741*fEdge[11]-0.5625*fSkin[4]+0.5625*fEdge[4]; 
  temp_diff[5] = (-0.5412658773652741*fSkin[14])-0.5412658773652741*fEdge[14]-0.5625*fSkin[5]+0.5625*fEdge[5]; 
  temp_diff[6] = (-0.5412658773652741*fSkin[16])-0.5412658773652741*fEdge[16]-0.5625*fSkin[6]+0.5625*fEdge[6]; 
  temp_diff[7] = (-1.4375*fSkin[7])-0.4375*fEdge[7]-1.407291281149713*fSkin[1]+0.5412658773652741*fEdge[1]; 
  temp_diff[8] = (-1.4375*fSkin[8])-0.4375*fEdge[8]-1.407291281149713*fSkin[2]+0.5412658773652741*fEdge[2]; 
  temp_diff[9] = (-0.5412658773652741*fSkin[18])-0.5412658773652741*fEdge[18]-0.5625*fSkin[9]+0.5625*fEdge[9]; 
  temp_diff[10] = (-0.5412658773652741*fSkin[19])-0.5412658773652741*fEdge[19]-0.5625*fSkin[10]+0.5625*fEdge[10]; 
  temp_diff[11] = (-1.4375*fSkin[11])-0.4375*fEdge[11]-1.407291281149713*fSkin[4]+0.5412658773652741*fEdge[4]; 
  temp_diff[12] = (-0.5412658773652741*fSkin[21])-0.5412658773652741*fEdge[21]-0.5625*fSkin[12]+0.5625*fEdge[12]; 
  temp_diff[13] = (-0.5412658773652741*fSkin[22])-0.5412658773652741*fEdge[22]-0.5625*fSkin[13]+0.5625*fEdge[13]; 
  temp_diff[14] = (-1.4375*fSkin[14])-0.4375*fEdge[14]-1.407291281149713*fSkin[5]+0.5412658773652741*fEdge[5]; 
  temp_diff[15] = (-0.5412658773652741*fSkin[25])-0.5412658773652741*fEdge[25]-0.5625*fSkin[15]+0.5625*fEdge[15]; 
  temp_diff[16] = (-1.4375*fSkin[16])-0.4375*fEdge[16]-1.407291281149713*fSkin[6]+0.5412658773652741*fEdge[6]; 
  temp_diff[17] = (-0.5412658773652741*fSkin[26])-0.5412658773652741*fEdge[26]-0.5625*fSkin[17]+0.5625*fEdge[17]; 
  temp_diff[18] = (-1.4375*fSkin[18])-0.4375*fEdge[18]-1.407291281149713*fSkin[9]+0.5412658773652741*fEdge[9]; 
  temp_diff[19] = (-1.4375*fSkin[19])-0.4375*fEdge[19]-1.407291281149713*fSkin[10]+0.5412658773652741*fEdge[10]; 
  temp_diff[20] = (-0.5412658773652741*fSkin[27])-0.5412658773652741*fEdge[27]-0.5625*fSkin[20]+0.5625*fEdge[20]; 
  temp_diff[21] = (-1.4375*fSkin[21])-0.4375*fEdge[21]-1.407291281149713*fSkin[12]+0.5412658773652741*fEdge[12]; 
  temp_diff[22] = (-1.4375*fSkin[22])-0.4375*fEdge[22]-1.407291281149713*fSkin[13]+0.5412658773652741*fEdge[13]; 
  temp_diff[23] = (-0.5412658773652741*fSkin[29])-0.5412658773652741*fEdge[29]-0.5625*fSkin[23]+0.5625*fEdge[23]; 
  temp_diff[24] = (-0.5412658773652741*fSkin[30])-0.5412658773652741*fEdge[30]-0.5625*fSkin[24]+0.5625*fEdge[24]; 
  temp_diff[25] = (-1.4375*fSkin[25])-0.4375*fEdge[25]-1.407291281149713*fSkin[15]+0.5412658773652741*fEdge[15]; 
  temp_diff[26] = (-1.4375*fSkin[26])-0.4375*fEdge[26]-1.407291281149713*fSkin[17]+0.5412658773652741*fEdge[17]; 
  temp_diff[27] = (-1.4375*fSkin[27])-0.4375*fEdge[27]-1.407291281149713*fSkin[20]+0.5412658773652741*fEdge[20]; 
  temp_diff[28] = (-0.5412658773652741*fSkin[31])-0.5412658773652741*fEdge[31]-0.5625*fSkin[28]+0.5625*fEdge[28]; 
  temp_diff[29] = (-1.4375*fSkin[29])-0.4375*fEdge[29]-1.407291281149713*fSkin[23]+0.5412658773652741*fEdge[23]; 
  temp_diff[30] = (-1.4375*fSkin[30])-0.4375*fEdge[30]-1.407291281149713*fSkin[24]+0.5412658773652741*fEdge[24]; 
  temp_diff[31] = (-1.4375*fSkin[31])-0.4375*fEdge[31]-1.407291281149713*fSkin[28]+0.5412658773652741*fEdge[28]; 

  temp_edge[3] = 0.8660254037844386*fSkin[0]-1.5*fSkin[3]; 
  temp_edge[7] = 0.8660254037844386*fSkin[1]-1.5*fSkin[7]; 
  temp_edge[8] = 0.8660254037844386*fSkin[2]-1.5*fSkin[8]; 
  temp_edge[11] = 0.8660254037844386*fSkin[4]-1.5*fSkin[11]; 
  temp_edge[14] = 0.8660254037844386*fSkin[5]-1.5*fSkin[14]; 
  temp_edge[16] = 0.8660254037844386*fSkin[6]-1.5*fSkin[16]; 
  temp_edge[18] = 0.8660254037844386*fSkin[9]-1.5*fSkin[18]; 
  temp_edge[19] = 0.8660254037844386*fSkin[10]-1.5*fSkin[19]; 
  temp_edge[21] = 0.8660254037844386*fSkin[12]-1.5*fSkin[21]; 
  temp_edge[22] = 0.8660254037844386*fSkin[13]-1.5*fSkin[22]; 
  temp_edge[25] = 0.8660254037844386*fSkin[15]-1.5*fSkin[25]; 
  temp_edge[26] = 0.8660254037844386*fSkin[17]-1.5*fSkin[26]; 
  temp_edge[27] = 0.8660254037844386*fSkin[20]-1.5*fSkin[27]; 
  temp_edge[29] = 0.8660254037844386*fSkin[23]-1.5*fSkin[29]; 
  temp_edge[30] = 0.8660254037844386*fSkin[24]-1.5*fSkin[30]; 
  temp_edge[31] = 0.8660254037844386*fSkin[28]-1.5*fSkin[31]; 
  ...
  temp_edge[7] = (-1.5*fSkin[7])-0.8660254037844386*fSkin[1]; 
  temp_edge[8] = (-1.5*fSkin[8])-0.8660254037844386*fSkin[2]; 
  temp_edge[11] = (-1.5*fSkin[11])-0.8660254037844386*fSkin[4]; 
  temp_edge[14] = (-1.5*fSkin[14])-0.8660254037844386*fSkin[5]; 
  temp_edge[16] = (-1.5*fSkin[16])-0.8660254037844386*fSkin[6]; 
  temp_edge[18] = (-1.5*fSkin[18])-0.8660254037844386*fSkin[9]; 
  temp_edge[19] = (-1.5*fSkin[19])-0.8660254037844386*fSkin[10]; 
  temp_edge[21] = (-1.5*fSkin[21])-0.8660254037844386*fSkin[12]; 
  temp_edge[22] = (-1.5*fSkin[22])-0.8660254037844386*fSkin[13]; 
  temp_edge[25] = (-1.5*fSkin[25])-0.8660254037844386*fSkin[15]; 
  temp_edge[26] = (-1.5*fSkin[26])-0.8660254037844386*fSkin[17]; 
  temp_edge[27] = (-1.5*fSkin[27])-0.8660254037844386*fSkin[20]; 
  temp_edge[29] = (-1.5*fSkin[29])-0.8660254037844386*fSkin[23]; 
  temp_edge[30] = (-1.5*fSkin[30])-0.8660254037844386*fSkin[24]; 
  temp_edge[31] = (-1.5*fSkin[31])-0.8660254037844386*fSkin[28]; 
