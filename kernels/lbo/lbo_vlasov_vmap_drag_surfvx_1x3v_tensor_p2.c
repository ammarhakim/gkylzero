...
GKYL_CU_DH double lbo_vlasov_vmap_drag_surfvx_1x3v_tensor_p2(const double *w, const double *dxv, const double *vmap, const double *jacob_vel_inv, const double *nuSum, const double *nuPrimMomsSum, const double *fl, const double *fc, const double *fr, double* GKYL_RESTRICT out) 
{ 
  ...
  alphaDrSurf_r[7] = 5.916079783099617*jacob_vel_inv0[2]*nuSum[2]*v0[3]+4.58257569495584*jacob_vel_inv0[1]*nuSum[2]*v0[3]+2.645751311064591*jacob_vel_inv0[0]*nuSum[2]*v0[3]+5.0*jacob_vel_inv0[2]*nuSum[2]*v0[2]+3.872983346207417*jacob_vel_inv0[1]*nuSum[2]*v0[2]+2.23606797749979*jacob_vel_inv0[0]*nuSum[2]*v0[2]-3.16227766016838*jacob_vel_inv0[2]*sumNuUx[2]-2.449489742783178*jacob_vel_inv0[1]*sumNuUx[2]-1.414213562373095*jacob_vel_inv0[0]*sumNuUx[2]+3.872983346207417*v0[1]*jacob_vel_inv0[2]*nuSum[2]+2.23606797749979*v0[0]*jacob_vel_inv0[2]*nuSum[2]+3.0*jacob_vel_inv0[1]*v0[1]*nuSum[2]+1.732050807568877*jacob_vel_inv0[0]*v0[1]*nuSum[2]+1.732050807568877*v0[0]*jacob_vel_inv0[1]*nuSum[2]+jacob_vel_inv0[0]*v0[0]*nuSum[2]; 
  ...
  out[44] += 1.58113883008419*Ghat_r[7]*rdv2-1.58113883008419*Ghat_l[7]*rdv2; 
  ...
  out[48] += 1.58113883008419*Ghat_r[9]*rdv2-1.58113883008419*Ghat_l[9]*rdv2; 
  ...
  out[51] += 1.58113883008419*Ghat_r[10]*rdv2-1.58113883008419*Ghat_l[10]*rdv2; 
  ...
  out[54] += 1.58113883008419*Ghat_r[11]*rdv2-1.58113883008419*Ghat_l[11]*rdv2; 
  ...
  out[57] += 1.58113883008419*Ghat_r[13]*rdv2-1.58113883008419*Ghat_l[13]*rdv2; 
  ...
  out[61] += 1.58113883008419*Ghat_r[15]*rdv2-1.58113883008419*Ghat_l[15]*rdv2; 
  out[62] += 0.7071067811865475*Ghat_r[24]*rdv2-0.7071067811865475*Ghat_l[24]*rdv2; 
  out[63] += 1.58113883008419*Ghat_r[16]*rdv2-1.58113883008419*Ghat_l[16]*rdv2; 
  ...
  out[66] += 1.58113883008419*Ghat_r[17]*rdv2-1.58113883008419*Ghat_l[17]*rdv2; 
  ...
  out[70] += 1.58113883008419*Ghat_r[19]*rdv2-1.58113883008419*Ghat_l[19]*rdv2; 
  ...
  out[73] += 1.58113883008419*Ghat_r[21]*rdv2-1.58113883008419*Ghat_l[21]*rdv2; 
  ...
  out[77] += 1.58113883008419*Ghat_r[24]*rdv2-1.58113883008419*Ghat_l[24]*rdv2; 
