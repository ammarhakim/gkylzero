...
{ 
  ...
  Gdiff2_l[0] = 0.2041241452319315*nuVtSqSum[3]*fl[12]-0.2041241452319315*nuVtSqSum[3]*fc[12]+0.2041241452319315*nuVtSqSum[2]*fl[9]-0.2041241452319315*nuVtSqSum[2]*fc[9]+0.2041241452319315*nuVtSqSum[1]*fl[8]-0.2041241452319315*nuVtSqSum[1]*fc[8]+0.1767766952966368*nuVtSqSum[3]*fl[5]+0.1767766952966368*nuVtSqSum[3]*fc[5]+0.2041241452319315*nuVtSqSum[0]*fl[4]-0.2041241452319315*nuVtSqSum[0]*fc[4]+0.1767766952966368*fl[2]*nuVtSqSum[2]+0.1767766952966368*fc[2]*nuVtSqSum[2]+0.1767766952966368*fl[1]*nuVtSqSum[1]+0.1767766952966368*fc[1]*nuVtSqSum[1]+0.1767766952966368*fl[0]*nuVtSqSum[0]+0.1767766952966368*fc[0]*nuVtSqSum[0]; 
  Gdiff2_l[1] = 0.2041241452319315*nuVtSqSum[2]*fl[12]-0.2041241452319315*nuVtSqSum[2]*fc[12]+0.2041241452319315*nuVtSqSum[3]*fl[9]-0.2041241452319315*nuVtSqSum[3]*fc[9]+0.2041241452319315*nuVtSqSum[0]*fl[8]-0.2041241452319315*nuVtSqSum[0]*fc[8]+0.1767766952966368*nuVtSqSum[2]*fl[5]+0.1767766952966368*nuVtSqSum[2]*fc[5]+0.2041241452319315*nuVtSqSum[1]*fl[4]-0.2041241452319315*nuVtSqSum[1]*fc[4]+0.1767766952966368*fl[2]*nuVtSqSum[3]+0.1767766952966368*fc[2]*nuVtSqSum[3]+0.1767766952966368*fl[0]*nuVtSqSum[1]+0.1767766952966368*fc[0]*nuVtSqSum[1]+0.1767766952966368*nuVtSqSum[0]*fl[1]+0.1767766952966368*nuVtSqSum[0]*fc[1]; 
  Gdiff2_l[2] = 0.2041241452319315*nuVtSqSum[1]*fl[12]-0.2041241452319315*nuVtSqSum[1]*fc[12]+0.2041241452319315*nuVtSqSum[0]*fl[9]-0.2041241452319315*nuVtSqSum[0]*fc[9]+0.2041241452319315*nuVtSqSum[3]*fl[8]-0.2041241452319315*nuVtSqSum[3]*fc[8]+0.1767766952966368*nuVtSqSum[1]*fl[5]+0.1767766952966368*nuVtSqSum[1]*fc[5]+0.2041241452319315*nuVtSqSum[2]*fl[4]-0.2041241452319315*nuVtSqSum[2]*fc[4]+0.1767766952966368*fl[1]*nuVtSqSum[3]+0.1767766952966368*fc[1]*nuVtSqSum[3]+0.1767766952966368*fl[0]*nuVtSqSum[2]+0.1767766952966368*fc[0]*nuVtSqSum[2]+0.1767766952966368*nuVtSqSum[0]*fl[2]+0.1767766952966368*nuVtSqSum[0]*fc[2]; 
  Gdiff2_l[3] = 0.2041241452319315*nuVtSqSum[3]*fl[15]-0.2041241452319315*nuVtSqSum[3]*fc[15]+0.2041241452319315*nuVtSqSum[2]*fl[14]-0.2041241452319315*nuVtSqSum[2]*fc[14]+0.2041241452319315*nuVtSqSum[1]*fl[13]-0.2041241452319315*nuVtSqSum[1]*fc[13]+0.1767766952966368*nuVtSqSum[3]*fl[11]+0.1767766952966368*nuVtSqSum[3]*fc[11]+0.2041241452319315*nuVtSqSum[0]*fl[10]-0.2041241452319315*nuVtSqSum[0]*fc[10]+0.1767766952966368*nuVtSqSum[2]*fl[7]+0.1767766952966368*nuVtSqSum[2]*fc[7]+0.1767766952966368*nuVtSqSum[1]*fl[6]+0.1767766952966368*nuVtSqSum[1]*fc[6]+0.1767766952966368*nuVtSqSum[0]*fl[3]+0.1767766952966368*nuVtSqSum[0]*fc[3]; 
  Gdiff2_l[4] = 0.2041241452319315*nuVtSqSum[0]*fl[12]-0.2041241452319315*nuVtSqSum[0]*fc[12]+0.2041241452319315*nuVtSqSum[1]*fl[9]-0.2041241452319315*nuVtSqSum[1]*fc[9]+0.2041241452319315*nuVtSqSum[2]*fl[8]-0.2041241452319315*nuVtSqSum[2]*fc[8]+0.1767766952966368*nuVtSqSum[0]*fl[5]+0.1767766952966368*nuVtSqSum[0]*fc[5]+0.2041241452319315*nuVtSqSum[3]*fl[4]-0.2041241452319315*nuVtSqSum[3]*fc[4]+0.1767766952966368*fl[0]*nuVtSqSum[3]+0.1767766952966368*fc[0]*nuVtSqSum[3]+0.1767766952966368*fl[1]*nuVtSqSum[2]+0.1767766952966368*fc[1]*nuVtSqSum[2]+0.1767766952966368*nuVtSqSum[1]*fl[2]+0.1767766952966368*nuVtSqSum[1]*fc[2]; 
  Gdiff2_l[5] = 0.2041241452319315*nuVtSqSum[2]*fl[15]-0.2041241452319315*nuVtSqSum[2]*fc[15]+0.2041241452319315*nuVtSqSum[3]*fl[14]-0.2041241452319315*nuVtSqSum[3]*fc[14]+0.2041241452319315*nuVtSqSum[0]*fl[13]-0.2041241452319315*nuVtSqSum[0]*fc[13]+0.1767766952966368*nuVtSqSum[2]*fl[11]+0.1767766952966368*nuVtSqSum[2]*fc[11]+0.2041241452319315*nuVtSqSum[1]*fl[10]-0.2041241452319315*nuVtSqSum[1]*fc[10]+0.1767766952966368*nuVtSqSum[3]*fl[7]+0.1767766952966368*nuVtSqSum[3]*fc[7]+0.1767766952966368*nuVtSqSum[0]*fl[6]+0.1767766952966368*nuVtSqSum[0]*fc[6]+0.1767766952966368*nuVtSqSum[1]*fl[3]+0.1767766952966368*nuVtSqSum[1]*fc[3]; 
  Gdiff2_l[6] = 0.2041241452319315*nuVtSqSum[1]*fl[15]-0.2041241452319315*nuVtSqSum[1]*fc[15]+0.2041241452319315*nuVtSqSum[0]*fl[14]-0.2041241452319315*nuVtSqSum[0]*fc[14]+0.2041241452319315*nuVtSqSum[3]*fl[13]-0.2041241452319315*nuVtSqSum[3]*fc[13]+0.1767766952966368*nuVtSqSum[1]*fl[11]+0.1767766952966368*nuVtSqSum[1]*fc[11]+0.2041241452319315*nuVtSqSum[2]*fl[10]-0.2041241452319315*nuVtSqSum[2]*fc[10]+0.1767766952966368*nuVtSqSum[0]*fl[7]+0.1767766952966368*nuVtSqSum[0]*fc[7]+0.1767766952966368*nuVtSqSum[3]*fl[6]+0.1767766952966368*nuVtSqSum[3]*fc[6]+0.1767766952966368*nuVtSqSum[2]*fl[3]+0.1767766952966368*nuVtSqSum[2]*fc[3]; 
  Gdiff2_l[7] = 0.2041241452319315*nuVtSqSum[0]*fl[15]-0.2041241452319315*nuVtSqSum[0]*fc[15]+0.2041241452319315*nuVtSqSum[1]*fl[14]-0.2041241452319315*nuVtSqSum[1]*fc[14]+0.2041241452319315*nuVtSqSum[2]*fl[13]-0.2041241452319315*nuVtSqSum[2]*fc[13]+0.1767766952966368*nuVtSqSum[0]*fl[11]+0.1767766952966368*nuVtSqSum[0]*fc[11]+0.2041241452319315*nuVtSqSum[3]*fl[10]-0.2041241452319315*nuVtSqSum[3]*fc[10]+0.1767766952966368*nuVtSqSum[1]*fl[7]+0.1767766952966368*nuVtSqSum[1]*fc[7]+0.1767766952966368*nuVtSqSum[2]*fl[6]+0.1767766952966368*nuVtSqSum[2]*fc[6]+0.1767766952966368*fl[3]*nuVtSqSum[3]+0.1767766952966368*fc[3]*nuVtSqSum[3]; 

  Gdiff2_r[0] = (-0.2041241452319315*nuVtSqSum[3]*fr[12])+0.2041241452319315*nuVtSqSum[3]*fc[12]-0.2041241452319315*nuVtSqSum[2]*fr[9]+0.2041241452319315*nuVtSqSum[2]*fc[9]-0.2041241452319315*nuVtSqSum[1]*fr[8]+0.2041241452319315*nuVtSqSum[1]*fc[8]+0.1767766952966368*nuVtSqSum[3]*fr[5]+0.1767766952966368*nuVtSqSum[3]*fc[5]-0.2041241452319315*nuVtSqSum[0]*fr[4]+0.2041241452319315*nuVtSqSum[0]*fc[4]+0.1767766952966368*fr[2]*nuVtSqSum[2]+0.1767766952966368*fc[2]*nuVtSqSum[2]+0.1767766952966368*fr[1]*nuVtSqSum[1]+0.1767766952966368*fc[1]*nuVtSqSum[1]+0.1767766952966368*fr[0]*nuVtSqSum[0]+0.1767766952966368*fc[0]*nuVtSqSum[0]; 
  Gdiff2_r[1] = (-0.2041241452319315*nuVtSqSum[2]*fr[12])+0.2041241452319315*nuVtSqSum[2]*fc[12]-0.2041241452319315*nuVtSqSum[3]*fr[9]+0.2041241452319315*nuVtSqSum[3]*fc[9]-0.2041241452319315*nuVtSqSum[0]*fr[8]+0.2041241452319315*nuVtSqSum[0]*fc[8]+0.1767766952966368*nuVtSqSum[2]*fr[5]+0.1767766952966368*nuVtSqSum[2]*fc[5]-0.2041241452319315*nuVtSqSum[1]*fr[4]+0.2041241452319315*nuVtSqSum[1]*fc[4]+0.1767766952966368*fr[2]*nuVtSqSum[3]+0.1767766952966368*fc[2]*nuVtSqSum[3]+0.1767766952966368*fr[0]*nuVtSqSum[1]+0.1767766952966368*fc[0]*nuVtSqSum[1]+0.1767766952966368*nuVtSqSum[0]*fr[1]+0.1767766952966368*nuVtSqSum[0]*fc[1]; 
  Gdiff2_r[2] = (-0.2041241452319315*nuVtSqSum[1]*fr[12])+0.2041241452319315*nuVtSqSum[1]*fc[12]-0.2041241452319315*nuVtSqSum[0]*fr[9]+0.2041241452319315*nuVtSqSum[0]*fc[9]-0.2041241452319315*nuVtSqSum[3]*fr[8]+0.2041241452319315*nuVtSqSum[3]*fc[8]+0.1767766952966368*nuVtSqSum[1]*fr[5]+0.1767766952966368*nuVtSqSum[1]*fc[5]-0.2041241452319315*nuVtSqSum[2]*fr[4]+0.2041241452319315*nuVtSqSum[2]*fc[4]+0.1767766952966368*fr[1]*nuVtSqSum[3]+0.1767766952966368*fc[1]*nuVtSqSum[3]+0.1767766952966368*fr[0]*nuVtSqSum[2]+0.1767766952966368*fc[0]*nuVtSqSum[2]+0.1767766952966368*nuVtSqSum[0]*fr[2]+0.1767766952966368*nuVtSqSum[0]*fc[2]; 
  Gdiff2_r[3] = (-0.2041241452319315*nuVtSqSum[3]*fr[15])+0.2041241452319315*nuVtSqSum[3]*fc[15]-0.2041241452319315*nuVtSqSum[2]*fr[14]+0.2041241452319315*nuVtSqSum[2]*fc[14]-0.2041241452319315*nuVtSqSum[1]*fr[13]+0.2041241452319315*nuVtSqSum[1]*fc[13]+0.1767766952966368*nuVtSqSum[3]*fr[11]+0.1767766952966368*nuVtSqSum[3]*fc[11]-0.2041241452319315*nuVtSqSum[0]*fr[10]+0.2041241452319315*nuVtSqSum[0]*fc[10]+0.1767766952966368*nuVtSqSum[2]*fr[7]+0.1767766952966368*nuVtSqSum[2]*fc[7]+0.1767766952966368*nuVtSqSum[1]*fr[6]+0.1767766952966368*nuVtSqSum[1]*fc[6]+0.1767766952966368*nuVtSqSum[0]*fr[3]+0.1767766952966368*nuVtSqSum[0]*fc[3]; 
  Gdiff2_r[4] = (-0.2041241452319315*nuVtSqSum[0]*fr[12])+0.2041241452319315*nuVtSqSum[0]*fc[12]-0.2041241452319315*nuVtSqSum[1]*fr[9]+0.2041241452319315*nuVtSqSum[1]*fc[9]-0.2041241452319315*nuVtSqSum[2]*fr[8]+0.2041241452319315*nuVtSqSum[2]*fc[8]+0.1767766952966368*nuVtSqSum[0]*fr[5]+0.1767766952966368*nuVtSqSum[0]*fc[5]-0.2041241452319315*nuVtSqSum[3]*fr[4]+0.2041241452319315*nuVtSqSum[3]*fc[4]+0.1767766952966368*fr[0]*nuVtSqSum[3]+0.1767766952966368*fc[0]*nuVtSqSum[3]+0.1767766952966368*fr[1]*nuVtSqSum[2]+0.1767766952966368*fc[1]*nuVtSqSum[2]+0.1767766952966368*nuVtSqSum[1]*fr[2]+0.1767766952966368*nuVtSqSum[1]*fc[2]; 
  Gdiff2_r[5] = (-0.2041241452319315*nuVtSqSum[2]*fr[15])+0.2041241452319315*nuVtSqSum[2]*fc[15]-0.2041241452319315*nuVtSqSum[3]*fr[14]+0.2041241452319315*nuVtSqSum[3]*fc[14]-0.2041241452319315*nuVtSqSum[0]*fr[13]+0.2041241452319315*nuVtSqSum[0]*fc[13]+0.1767766952966368*nuVtSqSum[2]*fr[11]+0.1767766952966368*nuVtSqSum[2]*fc[11]-0.2041241452319315*nuVtSqSum[1]*fr[10]+0.2041241452319315*nuVtSqSum[1]*fc[10]+0.1767766952966368*nuVtSqSum[3]*fr[7]+0.1767766952966368*nuVtSqSum[3]*fc[7]+0.1767766952966368*nuVtSqSum[0]*fr[6]+0.1767766952966368*nuVtSqSum[0]*fc[6]+0.1767766952966368*nuVtSqSum[1]*fr[3]+0.1767766952966368*nuVtSqSum[1]*fc[3]; 
  Gdiff2_r[6] = (-0.2041241452319315*nuVtSqSum[1]*fr[15])+0.2041241452319315*nuVtSqSum[1]*fc[15]-0.2041241452319315*nuVtSqSum[0]*fr[14]+0.2041241452319315*nuVtSqSum[0]*fc[14]-0.2041241452319315*nuVtSqSum[3]*fr[13]+0.2041241452319315*nuVtSqSum[3]*fc[13]+0.1767766952966368*nuVtSqSum[1]*fr[11]+0.1767766952966368*nuVtSqSum[1]*fc[11]-0.2041241452319315*nuVtSqSum[2]*fr[10]+0.2041241452319315*nuVtSqSum[2]*fc[10]+0.1767766952966368*nuVtSqSum[0]*fr[7]+0.1767766952966368*nuVtSqSum[0]*fc[7]+0.1767766952966368*nuVtSqSum[3]*fr[6]+0.1767766952966368*nuVtSqSum[3]*fc[6]+0.1767766952966368*nuVtSqSum[2]*fr[3]+0.1767766952966368*nuVtSqSum[2]*fc[3]; 
  Gdiff2_r[7] = (-0.2041241452319315*nuVtSqSum[0]*fr[15])+0.2041241452319315*nuVtSqSum[0]*fc[15]-0.2041241452319315*nuVtSqSum[1]*fr[14]+0.2041241452319315*nuVtSqSum[1]*fc[14]-0.2041241452319315*nuVtSqSum[2]*fr[13]+0.2041241452319315*nuVtSqSum[2]*fc[13]+0.1767766952966368*nuVtSqSum[0]*fr[11]+0.1767766952966368*nuVtSqSum[0]*fc[11]-0.2041241452319315*nuVtSqSum[3]*fr[10]+0.2041241452319315*nuVtSqSum[3]*fc[10]+0.1767766952966368*nuVtSqSum[1]*fr[7]+0.1767766952966368*nuVtSqSum[1]*fc[7]+0.1767766952966368*nuVtSqSum[2]*fr[6]+0.1767766952966368*nuVtSqSum[2]*fc[6]+0.1767766952966368*fr[3]*nuVtSqSum[3]+0.1767766952966368*fc[3]*nuVtSqSum[3]; 

  Gdiff_l[0] = (-0.3827327723098713*nuVtSqSum[3]*fl[12])-0.3827327723098713*nuVtSqSum[3]*fc[12]-0.3827327723098713*nuVtSqSum[2]*fl[9]-0.3827327723098713*nuVtSqSum[2]*fc[9]-0.3827327723098713*nuVtSqSum[1]*fl[8]-0.3827327723098713*nuVtSqSum[1]*fc[8]-0.3977475644174328*nuVtSqSum[3]*fl[5]+0.3977475644174328*nuVtSqSum[3]*fc[5]-0.3827327723098713*nuVtSqSum[0]*fl[4]-0.3827327723098713*nuVtSqSum[0]*fc[4]-0.3977475644174328*fl[2]*nuVtSqSum[2]+0.3977475644174328*fc[2]*nuVtSqSum[2]-0.3977475644174328*fl[1]*nuVtSqSum[1]+0.3977475644174328*fc[1]*nuVtSqSum[1]-0.3977475644174328*fl[0]*nuVtSqSum[0]+0.3977475644174328*fc[0]*nuVtSqSum[0]; 
  Gdiff_l[1] = (-0.3827327723098713*nuVtSqSum[2]*fl[12])-0.3827327723098713*nuVtSqSum[2]*fc[12]-0.3827327723098713*nuVtSqSum[3]*fl[9]-0.3827327723098713*nuVtSqSum[3]*fc[9]-0.3827327723098713*nuVtSqSum[0]*fl[8]-0.3827327723098713*nuVtSqSum[0]*fc[8]-0.3977475644174328*nuVtSqSum[2]*fl[5]+0.3977475644174328*nuVtSqSum[2]*fc[5]-0.3827327723098713*nuVtSqSum[1]*fl[4]-0.3827327723098713*nuVtSqSum[1]*fc[4]-0.3977475644174328*fl[2]*nuVtSqSum[3]+0.3977475644174328*fc[2]*nuVtSqSum[3]-0.3977475644174328*fl[0]*nuVtSqSum[1]+0.3977475644174328*fc[0]*nuVtSqSum[1]-0.3977475644174328*nuVtSqSum[0]*fl[1]+0.3977475644174328*nuVtSqSum[0]*fc[1]; 
  Gdiff_l[2] = (-0.3827327723098713*nuVtSqSum[1]*fl[12])-0.3827327723098713*nuVtSqSum[1]*fc[12]-0.3827327723098713*nuVtSqSum[0]*fl[9]-0.3827327723098713*nuVtSqSum[0]*fc[9]-0.3827327723098713*nuVtSqSum[3]*fl[8]-0.3827327723098713*nuVtSqSum[3]*fc[8]-0.3977475644174328*nuVtSqSum[1]*fl[5]+0.3977475644174328*nuVtSqSum[1]*fc[5]-0.3827327723098713*nuVtSqSum[2]*fl[4]-0.3827327723098713*nuVtSqSum[2]*fc[4]-0.3977475644174328*fl[1]*nuVtSqSum[3]+0.3977475644174328*fc[1]*nuVtSqSum[3]-0.3977475644174328*fl[0]*nuVtSqSum[2]+0.3977475644174328*fc[0]*nuVtSqSum[2]-0.3977475644174328*nuVtSqSum[0]*fl[2]+0.3977475644174328*nuVtSqSum[0]*fc[2]; 
  ...
  Ghat_r[0] = Gdiff_r[0]*rdv2+0.3535533905932737*alphaDrSurf_r[4]*fUpwind_r[4]+0.3535533905932737*alphaDrSurf_r[2]*fUpwind_r[2]+0.3535533905932737*alphaDrSurf_r[1]*fUpwind_r[1]+0.3535533905932737*alphaDrSurf_r[0]*fUpwind_r[0]; 
  Ghat_r[1] = Gdiff_r[1]*rdv2+0.3535533905932737*alphaDrSurf_r[2]*fUpwind_r[4]+0.3535533905932737*fUpwind_r[2]*alphaDrSurf_r[4]+0.3535533905932737*alphaDrSurf_r[0]*fUpwind_r[1]+0.3535533905932737*fUpwind_r[0]*alphaDrSurf_r[1]; 
  Ghat_r[2] = Gdiff_r[2]*rdv2+0.3535533905932737*alphaDrSurf_r[1]*fUpwind_r[4]+0.3535533905932737*fUpwind_r[1]*alphaDrSurf_r[4]+0.3535533905932737*alphaDrSurf_r[0]*fUpwind_r[2]+0.3535533905932737*fUpwind_r[0]*alphaDrSurf_r[2]; 
  Ghat_r[3] = Gdiff_r[3]*rdv2+0.3535533905932737*alphaDrSurf_r[4]*fUpwind_r[7]+0.3535533905932737*alphaDrSurf_r[2]*fUpwind_r[6]+0.3535533905932737*alphaDrSurf_r[1]*fUpwind_r[5]+0.3535533905932737*alphaDrSurf_r[0]*fUpwind_r[3]; 
  Ghat_r[4] = Gdiff_r[4]*rdv2+0.3535533905932737*alphaDrSurf_r[0]*fUpwind_r[4]+0.3535533905932737*fUpwind_r[0]*alphaDrSurf_r[4]+0.3535533905932737*alphaDrSurf_r[1]*fUpwind_r[2]+0.3535533905932737*fUpwind_r[1]*alphaDrSurf_r[2]; 
  Ghat_r[5] = Gdiff_r[5]*rdv2+0.3535533905932737*alphaDrSurf_r[2]*fUpwind_r[7]+0.3535533905932737*alphaDrSurf_r[4]*fUpwind_r[6]+0.3535533905932737*alphaDrSurf_r[0]*fUpwind_r[5]+0.3535533905932737*alphaDrSurf_r[1]*fUpwind_r[3]; 
  Ghat_r[6] = Gdiff_r[6]*rdv2+0.3535533905932737*alphaDrSurf_r[1]*fUpwind_r[7]+0.3535533905932737*alphaDrSurf_r[0]*fUpwind_r[6]+0.3535533905932737*alphaDrSurf_r[4]*fUpwind_r[5]+0.3535533905932737*alphaDrSurf_r[2]*fUpwind_r[3]; 
  Ghat_r[7] = Gdiff_r[7]*rdv2+0.3535533905932737*alphaDrSurf_r[0]*fUpwind_r[7]+0.3535533905932737*alphaDrSurf_r[1]*fUpwind_r[6]+0.3535533905932737*alphaDrSurf_r[2]*fUpwind_r[5]+0.3535533905932737*fUpwind_r[3]*alphaDrSurf_r[4]; 
