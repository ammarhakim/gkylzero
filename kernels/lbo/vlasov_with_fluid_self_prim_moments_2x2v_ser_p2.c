...
{ 
  ...
  if (cellAvg) { 
    ...
    cEr[6] = 0.0; 
    cEr[7] = 0.0; 
    gkyl_mat_set(rhs,16,0,moms[24]+fluid[0]); 
    ...
    gkyl_mat_set(rhs,16,0,moms[24]+fluid[0]); 
    gkyl_mat_set(rhs,17,0,moms[25]+fluid[1]); 
    gkyl_mat_set(rhs,18,0,moms[26]+fluid[2]); 
    gkyl_mat_set(rhs,19,0,moms[27]+fluid[3]); 
    gkyl_mat_set(rhs,20,0,moms[28]+fluid[4]); 
    gkyl_mat_set(rhs,21,0,moms[29]+fluid[5]); 
    gkyl_mat_set(rhs,22,0,moms[30]+fluid[6]); 
    gkyl_mat_set(rhs,23,0,moms[31]+fluid[7]); 
  } 
