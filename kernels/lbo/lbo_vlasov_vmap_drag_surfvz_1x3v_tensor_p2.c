...
GKYL_CU_DH double lbo_vlasov_vmap_drag_surfvz_1x3v_tensor_p2(const double *w, const double *dxv, const double *vmap, const double *jacob_vel_inv, const double *nuSum, const double *nuPrimMomsSum, const double *fl, const double *fc, const double *fr, double* GKYL_RESTRICT out) 
{ 
  ...
  alphaDrSurf_r[7] = 5.916079783099617*jacob_vel_inv2[2]*nuSum[2]*v2[3]+4.58257569495584*jacob_vel_inv2[1]*nuSum[2]*v2[3]+2.645751311064591*jacob_vel_inv2[0]*nuSum[2]*v2[3]+5.0*jacob_vel_inv2[2]*nuSum[2]*v2[2]+3.872983346207417*jacob_vel_inv2[1]*nuSum[2]*v2[2]+2.23606797749979*jacob_vel_inv2[0]*nuSum[2]*v2[2]-3.16227766016838*jacob_vel_inv2[2]*sumNuUz[2]-2.449489742783178*jacob_vel_inv2[1]*sumNuUz[2]-1.414213562373095*jacob_vel_inv2[0]*sumNuUz[2]+3.872983346207417*v2[1]*jacob_vel_inv2[2]*nuSum[2]+2.23606797749979*v2[0]*jacob_vel_inv2[2]*nuSum[2]+3.0*jacob_vel_inv2[1]*v2[1]*nuSum[2]+1.732050807568877*jacob_vel_inv2[0]*v2[1]*nuSum[2]+1.732050807568877*v2[0]*jacob_vel_inv2[1]*nuSum[2]+jacob_vel_inv2[0]*v2[0]*nuSum[2]; 
  ...
  out[14] += 1.58113883008419*Ghat_r[0]*rdv2-1.58113883008419*Ghat_l[0]*rdv2; 
  ...
  out[28] += 1.58113883008419*Ghat_r[1]*rdv2-1.58113883008419*Ghat_l[1]*rdv2; 
  out[29] += 1.58113883008419*Ghat_r[2]*rdv2-1.58113883008419*Ghat_l[2]*rdv2; 
  out[30] += 1.58113883008419*Ghat_r[3]*rdv2-1.58113883008419*Ghat_l[3]*rdv2; 
  ...
  out[41] += 1.58113883008419*Ghat_r[4]*rdv2-1.58113883008419*Ghat_l[4]*rdv2; 
  out[42] += 1.58113883008419*Ghat_r[5]*rdv2-1.58113883008419*Ghat_l[5]*rdv2; 
  out[43] += 1.58113883008419*Ghat_r[6]*rdv2-1.58113883008419*Ghat_l[6]*rdv2; 
  ...
  out[47] += 1.58113883008419*Ghat_r[7]*rdv2-1.58113883008419*Ghat_l[7]*rdv2; 
  out[48] += 1.58113883008419*Ghat_r[8]*rdv2-1.58113883008419*Ghat_l[8]*rdv2; 
  ...
  out[53] += 1.58113883008419*Ghat_r[10]*rdv2-1.58113883008419*Ghat_l[10]*rdv2; 
  ...
  out[60] += 1.58113883008419*Ghat_r[11]*rdv2-1.58113883008419*Ghat_l[11]*rdv2; 
  out[61] += 1.58113883008419*Ghat_r[12]*rdv2-1.58113883008419*Ghat_l[12]*rdv2; 
  out[62] += 1.58113883008419*Ghat_r[13]*rdv2-1.58113883008419*Ghat_l[13]*rdv2; 
  out[63] += 1.58113883008419*Ghat_r[14]*rdv2-1.58113883008419*Ghat_l[14]*rdv2; 
  ...
  out[69] += 1.58113883008419*Ghat_r[17]*rdv2-1.58113883008419*Ghat_l[17]*rdv2; 
  out[70] += 1.58113883008419*Ghat_r[18]*rdv2-1.58113883008419*Ghat_l[18]*rdv2; 
  ...
  out[73] += 1.58113883008419*Ghat_r[20]*rdv2-1.58113883008419*Ghat_l[20]*rdv2; 
  ...
  out[77] += 1.58113883008419*Ghat_r[23]*rdv2-1.58113883008419*Ghat_l[23]*rdv2; 
