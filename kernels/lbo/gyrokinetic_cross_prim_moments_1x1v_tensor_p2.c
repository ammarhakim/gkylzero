...
GKYL_CU_DH void gyrokinetic_cross_prim_moments_1x1v_tensor_p2(struct gkyl_mat *A, struct gkyl_mat *rhs, const double *greene, const double m_self, const double *u_self, const double *vtsq_self, const double m_other, const double *u_other, const double *vtsq_other, const double *moms, const double *boundary_corrections) 
{ 
  ...
  double enRHS[3] = {0.0}; 
  enRHS[0] = (-(2.0*greene[2]*vtsq_self[2]*m_self)/(2.828427124746191*m_self+2.828427124746191*m_other))-(1.0*greene[2]*uSumSq[2]*m_self)/(2.828427124746191*m_self+2.828427124746191*m_other)-(2.0*greene[1]*vtsq_self[1]*m_self)/(2.828427124746191*m_self+2.828427124746191*m_other)-(1.0*greene[1]*uSumSq[1]*m_self)/(2.828427124746191*m_self+2.828427124746191*m_other)-(2.0*greene[0]*vtsq_self[0]*m_self)/(2.828427124746191*m_self+2.828427124746191*m_other)-(1.0*greene[0]*uSumSq[0]*m_self)/(2.828427124746191*m_self+2.828427124746191*m_other)+(2.0*greene[2]*vtsq_other[2]*m_other)/(2.828427124746191*m_self+2.828427124746191*m_other)+(greene[2]*uSumSq[2]*m_other)/(2.828427124746191*m_self+2.828427124746191*m_other)+(2.0*greene[1]*vtsq_other[1]*m_other)/(2.828427124746191*m_self+2.828427124746191*m_other)+(greene[1]*uSumSq[1]*m_other)/(2.828427124746191*m_self+2.828427124746191*m_other)+(2.0*greene[0]*vtsq_other[0]*m_other)/(2.828427124746191*m_self+2.828427124746191*m_other)+(greene[0]*uSumSq[0]*m_other)/(2.828427124746191*m_self+2.828427124746191*m_other)-1.0*uM1Self[0]-1.0*uM1Other[0]+2.0*m2r[0]; 
