...
{ 
  ...
  out[5] += 0.7071067811865475*drag_incr[5]*rdv2; 
  out[6] += 1.224744871391589*drag_incr[0]*rdv2; 
  ...
  out[13] += 0.7071067811865475*drag_incr[12]*rdv2; 
  out[14] += 0.7071067811865475*drag_incr[13]*rdv2; 
  out[15] += 0.7071067811865475*drag_incr[14]*rdv2; 
  out[16] += 0.7071067811865475*drag_incr[15]*rdv2; 
  out[17] += 1.224744871391589*drag_incr[1]*rdv2; 
  out[18] += 1.224744871391589*drag_incr[2]*rdv2; 
  out[19] += 1.224744871391589*drag_incr[3]*rdv2; 
  out[20] += 1.224744871391589*drag_incr[4]*rdv2; 
  ...
  out[26] += 0.7071067811865475*drag_incr[20]*rdv2; 
  out[27] += 0.7071067811865475*drag_incr[21]*rdv2; 
  out[28] += 0.7071067811865475*drag_incr[22]*rdv2; 
  out[29] += 0.7071067811865475*drag_incr[23]*rdv2; 
  out[30] += 0.7071067811865475*drag_incr[24]*rdv2; 
  out[31] += 0.7071067811865475*drag_incr[25]*rdv2; 
  out[32] += 1.224744871391589*drag_incr[6]*rdv2; 
  out[33] += 1.224744871391589*drag_incr[7]*rdv2; 
  out[34] += 1.224744871391589*drag_incr[8]*rdv2; 
  out[35] += 1.224744871391589*drag_incr[9]*rdv2; 
  out[36] += 1.224744871391589*drag_incr[10]*rdv2; 
  ...
  out[43] += 0.7071067811865475*drag_incr[27]*rdv2; 
  out[44] += 0.7071067811865475*drag_incr[28]*rdv2; 
  out[45] += 0.7071067811865475*drag_incr[29]*rdv2; 
  out[46] += 0.7071067811865475*drag_incr[30]*rdv2; 
  out[47] += 1.224744871391589*drag_incr[16]*rdv2; 
  out[48] += 1.224744871391589*drag_incr[17]*rdv2; 
  out[49] += 1.224744871391589*drag_incr[18]*rdv2; 
  out[50] += 1.224744871391589*drag_incr[19]*rdv2; 
  ...
  out[57] += 0.7071067811865475*drag_incr[31]*rdv2; 
  out[58] += 1.224744871391589*drag_incr[26]*rdv2; 
