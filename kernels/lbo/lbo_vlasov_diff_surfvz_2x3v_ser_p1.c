...
{ 
  ...
  temp_diff[1] = (-0.5412658773652741*fr[12])+0.5412658773652741*fl[12]+0.5625*fr[1]+0.5625*fl[1]-1.125*fc[1]; 
  temp_diff[2] = (-0.5412658773652741*fr[13])+0.5412658773652741*fl[13]+0.5625*fr[2]+0.5625*fl[2]-1.125*fc[2]; 
  temp_diff[3] = (-0.5412658773652741*fr[14])+0.5412658773652741*fl[14]+0.5625*fr[3]+0.5625*fl[3]-1.125*fc[3]; 
  temp_diff[4] = (-0.5412658773652741*fr[15])+0.5412658773652741*fl[15]+0.5625*fr[4]+0.5625*fl[4]-1.125*fc[4]; 
  temp_diff[5] = (-0.4375*fr[5])-0.4375*fl[5]-2.875*fc[5]+0.5412658773652741*fr[0]-0.5412658773652741*fl[0]; 
  temp_diff[6] = (-0.5412658773652741*fr[20])+0.5412658773652741*fl[20]+0.5625*fr[6]+0.5625*fl[6]-1.125*fc[6]; 
  temp_diff[7] = (-0.5412658773652741*fr[21])+0.5412658773652741*fl[21]+0.5625*fr[7]+0.5625*fl[7]-1.125*fc[7]; 
  temp_diff[8] = (-0.5412658773652741*fr[22])+0.5412658773652741*fl[22]+0.5625*fr[8]+0.5625*fl[8]-1.125*fc[8]; 
  temp_diff[9] = (-0.5412658773652741*fr[23])+0.5412658773652741*fl[23]+0.5625*fr[9]+0.5625*fl[9]-1.125*fc[9]; 
  temp_diff[10] = (-0.5412658773652741*fr[24])+0.5412658773652741*fl[24]+0.5625*fr[10]+0.5625*fl[10]-1.125*fc[10]; 
  temp_diff[11] = (-0.5412658773652741*fr[25])+0.5412658773652741*fl[25]+0.5625*fr[11]+0.5625*fl[11]-1.125*fc[11]; 
  temp_diff[12] = (-0.4375*fr[12])-0.4375*fl[12]-2.875*fc[12]+0.5412658773652741*fr[1]-0.5412658773652741*fl[1]; 
  temp_diff[13] = (-0.4375*fr[13])-0.4375*fl[13]-2.875*fc[13]+0.5412658773652741*fr[2]-0.5412658773652741*fl[2]; 
  temp_diff[14] = (-0.4375*fr[14])-0.4375*fl[14]-2.875*fc[14]+0.5412658773652741*fr[3]-0.5412658773652741*fl[3]; 
  temp_diff[15] = (-0.4375*fr[15])-0.4375*fl[15]-2.875*fc[15]+0.5412658773652741*fr[4]-0.5412658773652741*fl[4]; 
  temp_diff[16] = (-0.5412658773652741*fr[27])+0.5412658773652741*fl[27]+0.5625*fr[16]+0.5625*fl[16]-1.125*fc[16]; 
  temp_diff[17] = (-0.5412658773652741*fr[28])+0.5412658773652741*fl[28]+0.5625*fr[17]+0.5625*fl[17]-1.125*fc[17]; 
  temp_diff[18] = (-0.5412658773652741*fr[29])+0.5412658773652741*fl[29]+0.5625*fr[18]+0.5625*fl[18]-1.125*fc[18]; 
  temp_diff[19] = (-0.5412658773652741*fr[30])+0.5412658773652741*fl[30]+0.5625*fr[19]+0.5625*fl[19]-1.125*fc[19]; 
  temp_diff[20] = (-0.4375*fr[20])-0.4375*fl[20]-2.875*fc[20]+0.5412658773652741*fr[6]-0.5412658773652741*fl[6]; 
  temp_diff[21] = (-0.4375*fr[21])-0.4375*fl[21]-2.875*fc[21]+0.5412658773652741*fr[7]-0.5412658773652741*fl[7]; 
  temp_diff[22] = (-0.4375*fr[22])-0.4375*fl[22]-2.875*fc[22]+0.5412658773652741*fr[8]-0.5412658773652741*fl[8]; 
  temp_diff[23] = (-0.4375*fr[23])-0.4375*fl[23]-2.875*fc[23]+0.5412658773652741*fr[9]-0.5412658773652741*fl[9]; 
  temp_diff[24] = (-0.4375*fr[24])-0.4375*fl[24]-2.875*fc[24]+0.5412658773652741*fr[10]-0.5412658773652741*fl[10]; 
  temp_diff[25] = (-0.4375*fr[25])-0.4375*fl[25]-2.875*fc[25]+0.5412658773652741*fr[11]-0.5412658773652741*fl[11]; 
  temp_diff[26] = (-0.5412658773652741*fr[31])+0.5412658773652741*fl[31]+0.5625*fr[26]+0.5625*fl[26]-1.125*fc[26]; 
  temp_diff[27] = (-0.4375*fr[27])-0.4375*fl[27]-2.875*fc[27]+0.5412658773652741*fr[16]-0.5412658773652741*fl[16]; 
  temp_diff[28] = (-0.4375*fr[28])-0.4375*fl[28]-2.875*fc[28]+0.5412658773652741*fr[17]-0.5412658773652741*fl[17]; 
  temp_diff[29] = (-0.4375*fr[29])-0.4375*fl[29]-2.875*fc[29]+0.5412658773652741*fr[18]-0.5412658773652741*fl[18]; 
  temp_diff[30] = (-0.4375*fr[30])-0.4375*fl[30]-2.875*fc[30]+0.5412658773652741*fr[19]-0.5412658773652741*fl[19]; 
  temp_diff[31] = (-0.4375*fr[31])-0.4375*fl[31]-2.875*fc[31]+0.5412658773652741*fr[26]-0.5412658773652741*fl[26]; 
