...
GKYL_CU_DH void vlasov_lbo_boundary_surfvx_2x2v_ser_p1(const double *w, const double *dxv, const double nuSum, const double *nuUSum, const double *nuVtSqSum, const int edge, const double *fSkin, const double *fEdge, double* GKYL_RESTRICT out) 
{ 
  ...
  Gdiff[4] = (-0.3827327723098713*nuVtSqSum[0]*fSkin[11])-0.3827327723098713*nuVtSqSum[0]*fEdge[11]-0.3827327723098713*nuVtSqSum[1]*fSkin[7]-0.3827327723098713*nuVtSqSum[1]*fEdge[7]-0.3827327723098713*nuVtSqSum[2]*fSkin[6]-0.3827327723098713*nuVtSqSum[2]*fEdge[6]-0.3977475644174328*nuVtSqSum[0]*fSkin[5]+0.3977475644174328*nuVtSqSum[0]*fEdge[5]-0.3827327723098713*fSkin[3]*nuVtSqSum[3]-0.3827327723098713*fEdge[3]*nuVtSqSum[3]-0.3977475644174328*fSkin[0]*nuVtSqSum[3]+0.3977475644174328*fEdge[0]*nuVtSqSum[3]-0.3977475644174328*fSkin[1]*nuVtSqSum[2]+0.3977475644174328*fEdge[1]*nuVtSqSum[2]-0.3977475644174328*nuVtSqSum[1]*fSkin[2]+0.3977475644174328*nuVtSqSum[1]*fEdge[2]; 
