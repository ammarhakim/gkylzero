...
GKYL_CU_DH void lbo_gyrokinetic_diff_surfmu_1x2v_ser_p2(const double *w, const double *dxv, const double m_, const double *bmag_inv, const double *nuSum, const double *nuPrimMomsSum, const double *fl, const double *fc, const double *fr, double* GKYL_RESTRICT out) 
{ 
  // m_: species mass.
  ...
  diff_incr[0] = 0.7071067811865475*diffFac[2]*temp_diff[7]+0.7071067811865475*diffFac[1]*temp_diff[1]+0.7071067811865475*diffFac[0]*temp_diff[0]; 
  diff_incr[1] = 0.6324555320336759*diffFac[1]*temp_diff[7]+0.6324555320336759*temp_diff[1]*diffFac[2]+0.7071067811865475*diffFac[0]*temp_diff[1]+0.7071067811865475*temp_diff[0]*diffFac[1]; 
  diff_incr[2] = 0.7071067811865475*diffFac[2]*temp_diff[11]+0.7071067811865475*diffFac[1]*temp_diff[4]+0.7071067811865475*diffFac[0]*temp_diff[2]; 
  diff_incr[3] = 0.7071067811865475*diffFac[2]*temp_diff[13]+0.7071067811865475*diffFac[1]*temp_diff[5]+0.7071067811865475*diffFac[0]*temp_diff[3]; 
  diff_incr[4] = 0.632455532033676*diffFac[1]*temp_diff[11]+0.6324555320336759*diffFac[2]*temp_diff[4]+0.7071067811865475*diffFac[0]*temp_diff[4]+0.7071067811865475*diffFac[1]*temp_diff[2]; 
  diff_incr[5] = 0.632455532033676*diffFac[1]*temp_diff[13]+0.6324555320336759*diffFac[2]*temp_diff[5]+0.7071067811865475*diffFac[0]*temp_diff[5]+0.7071067811865475*diffFac[1]*temp_diff[3]; 
  diff_incr[6] = 0.7071067811865475*diffFac[2]*temp_diff[17]+0.7071067811865475*diffFac[1]*temp_diff[10]+0.7071067811865475*diffFac[0]*temp_diff[6]; 
  diff_incr[7] = 0.4517539514526256*diffFac[2]*temp_diff[7]+0.7071067811865475*diffFac[0]*temp_diff[7]+0.7071067811865475*temp_diff[0]*diffFac[2]+0.6324555320336759*diffFac[1]*temp_diff[1]; 
  diff_incr[8] = 0.7071067811865475*diffFac[1]*temp_diff[12]+0.7071067811865475*diffFac[0]*temp_diff[8]; 
  diff_incr[9] = 0.7071067811865475*diffFac[1]*temp_diff[15]+0.7071067811865475*diffFac[0]*temp_diff[9]; 
  diff_incr[10] = 0.6324555320336759*diffFac[1]*temp_diff[17]+0.6324555320336759*diffFac[2]*temp_diff[10]+0.7071067811865475*diffFac[0]*temp_diff[10]+0.7071067811865475*diffFac[1]*temp_diff[6]; 
  diff_incr[11] = 0.4517539514526256*diffFac[2]*temp_diff[11]+0.7071067811865475*diffFac[0]*temp_diff[11]+0.632455532033676*diffFac[1]*temp_diff[4]+0.7071067811865475*diffFac[2]*temp_diff[2]; 
  diff_incr[12] = 0.6324555320336759*diffFac[2]*temp_diff[12]+0.7071067811865475*diffFac[0]*temp_diff[12]+0.7071067811865475*diffFac[1]*temp_diff[8]; 
  diff_incr[13] = 0.4517539514526256*diffFac[2]*temp_diff[13]+0.7071067811865475*diffFac[0]*temp_diff[13]+0.632455532033676*diffFac[1]*temp_diff[5]+0.7071067811865475*diffFac[2]*temp_diff[3]; 
  diff_incr[14] = 0.7071067811865475*diffFac[1]*temp_diff[18]+0.7071067811865475*diffFac[0]*temp_diff[14]; 
  diff_incr[15] = 0.6324555320336759*diffFac[2]*temp_diff[15]+0.7071067811865475*diffFac[0]*temp_diff[15]+0.7071067811865475*diffFac[1]*temp_diff[9]; 
  diff_incr[16] = 0.7071067811865475*diffFac[1]*temp_diff[19]+0.7071067811865475*diffFac[0]*temp_diff[16]; 
  diff_incr[17] = 0.4517539514526256*diffFac[2]*temp_diff[17]+0.7071067811865475*diffFac[0]*temp_diff[17]+0.6324555320336759*diffFac[1]*temp_diff[10]+0.7071067811865475*diffFac[2]*temp_diff[6]; 
  diff_incr[18] = 0.6324555320336759*diffFac[2]*temp_diff[18]+0.7071067811865475*diffFac[0]*temp_diff[18]+0.7071067811865475*diffFac[1]*temp_diff[14]; 
  diff_incr[19] = 0.6324555320336759*diffFac[2]*temp_diff[19]+0.7071067811865475*diffFac[0]*temp_diff[19]+0.7071067811865475*diffFac[1]*temp_diff[16]; 
