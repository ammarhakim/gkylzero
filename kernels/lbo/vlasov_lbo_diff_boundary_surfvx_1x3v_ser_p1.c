...
{ 
  ...
  temp_diff[3] = (-0.5412658773652741*fSkin[7])-0.5412658773652741*fEdge[7]-0.5625*fSkin[3]+0.5625*fEdge[3]; 
  temp_diff[4] = (-0.5412658773652741*fSkin[9])-0.5412658773652741*fEdge[9]-0.5625*fSkin[4]+0.5625*fEdge[4]; 
  temp_diff[5] = (-1.4375*fSkin[5])-0.4375*fEdge[5]-1.407291281149713*fSkin[1]+0.5412658773652741*fEdge[1]; 
  temp_diff[6] = (-0.5412658773652741*fSkin[11])-0.5412658773652741*fEdge[11]-0.5625*fSkin[6]+0.5625*fEdge[6]; 
  temp_diff[7] = (-1.4375*fSkin[7])-0.4375*fEdge[7]-1.407291281149713*fSkin[3]+0.5412658773652741*fEdge[3]; 
  temp_diff[8] = (-0.5412658773652741*fSkin[12])-0.5412658773652741*fEdge[12]-0.5625*fSkin[8]+0.5625*fEdge[8]; 
  temp_diff[9] = (-1.4375*fSkin[9])-0.4375*fEdge[9]-1.407291281149713*fSkin[4]+0.5412658773652741*fEdge[4]; 
  temp_diff[10] = (-0.5412658773652741*fSkin[14])-0.5412658773652741*fEdge[14]-0.5625*fSkin[10]+0.5625*fEdge[10]; 
  temp_diff[11] = (-1.4375*fSkin[11])-0.4375*fEdge[11]-1.407291281149713*fSkin[6]+0.5412658773652741*fEdge[6]; 
  temp_diff[12] = (-1.4375*fSkin[12])-0.4375*fEdge[12]-1.407291281149713*fSkin[8]+0.5412658773652741*fEdge[8]; 
  temp_diff[13] = (-0.5412658773652741*fSkin[15])-0.5412658773652741*fEdge[15]-0.5625*fSkin[13]+0.5625*fEdge[13]; 
  temp_diff[14] = (-1.4375*fSkin[14])-0.4375*fEdge[14]-1.407291281149713*fSkin[10]+0.5412658773652741*fEdge[10]; 
  temp_diff[15] = (-1.4375*fSkin[15])-0.4375*fEdge[15]-1.407291281149713*fSkin[13]+0.5412658773652741*fEdge[13]; 

  temp_edge[2] = 0.8660254037844386*fSkin[0]-1.5*fSkin[2]; 
  temp_edge[5] = 0.8660254037844386*fSkin[1]-1.5*fSkin[5]; 
  temp_edge[7] = 0.8660254037844386*fSkin[3]-1.5*fSkin[7]; 
  temp_edge[9] = 0.8660254037844386*fSkin[4]-1.5*fSkin[9]; 
  temp_edge[11] = 0.8660254037844386*fSkin[6]-1.5*fSkin[11]; 
  temp_edge[12] = 0.8660254037844386*fSkin[8]-1.5*fSkin[12]; 
  temp_edge[14] = 0.8660254037844386*fSkin[10]-1.5*fSkin[14]; 
  temp_edge[15] = 0.8660254037844386*fSkin[13]-1.5*fSkin[15]; 
  ...
  temp_edge[7] = (-1.5*fSkin[7])-0.8660254037844386*fSkin[3]; 
  temp_edge[9] = (-1.5*fSkin[9])-0.8660254037844386*fSkin[4]; 
  temp_edge[11] = (-1.5*fSkin[11])-0.8660254037844386*fSkin[6]; 
  temp_edge[12] = (-1.5*fSkin[12])-0.8660254037844386*fSkin[8]; 
  temp_edge[14] = (-1.5*fSkin[14])-0.8660254037844386*fSkin[10]; 
  temp_edge[15] = (-1.5*fSkin[15])-0.8660254037844386*fSkin[13]; 
