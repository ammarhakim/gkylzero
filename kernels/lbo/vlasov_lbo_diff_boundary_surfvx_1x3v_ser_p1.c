...
GKYL_CU_DH void vlasov_lbo_diff_boundary_surfvx_1x3v_ser_p1(const double *w, const double *dxv, const double *nuSum, const double *nuUSum, const double *nuVtSqSum, const int edge, const double *fSkin, const double *fEdge, double* GKYL_RESTRICT out) 
{ 
  ...
  diff_incr[10] = 0.2296396633859228*nuVtSqSum[1]*fSkin[15]-0.3827327723098713*nuVtSqSum[1]*fEdge[15]+0.2296396633859228*nuVtSqSum[0]*fSkin[14]-0.3827327723098713*nuVtSqSum[0]*fEdge[14]-0.7513009550107064*nuVtSqSum[1]*fSkin[13]+0.3977475644174328*nuVtSqSum[1]*fEdge[13]-0.7513009550107064*nuVtSqSum[0]*fSkin[10]+0.3977475644174328*nuVtSqSum[0]*fEdge[10]; 
  ...
  diff_incr[13] = 0.2296396633859228*nuVtSqSum[0]*fSkin[15]-0.3827327723098713*nuVtSqSum[0]*fEdge[15]+0.2296396633859228*nuVtSqSum[1]*fSkin[14]-0.3827327723098713*nuVtSqSum[1]*fEdge[14]-0.7513009550107064*nuVtSqSum[0]*fSkin[13]+0.3977475644174328*nuVtSqSum[0]*fEdge[13]-0.7513009550107064*nuVtSqSum[1]*fSkin[10]+0.3977475644174328*nuVtSqSum[1]*fEdge[10]; 
