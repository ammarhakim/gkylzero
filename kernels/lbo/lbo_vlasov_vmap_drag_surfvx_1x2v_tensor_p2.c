...
GKYL_CU_DH double lbo_vlasov_vmap_drag_surfvx_1x2v_tensor_p2(const double *w, const double *dxv, const double *vmap, const double *jacob_vel_inv, const double *nuSum, const double *nuPrimMomsSum, const double *fl, const double *fc, const double *fr, double* GKYL_RESTRICT out) 
{ 
  ...
  alphaDrSurf_r[4] = 4.183300132670378*jacob_vel_inv0[2]*nuSum[2]*v0[3]+3.24037034920393*jacob_vel_inv0[1]*nuSum[2]*v0[3]+1.870828693386971*jacob_vel_inv0[0]*nuSum[2]*v0[3]+3.535533905932737*jacob_vel_inv0[2]*nuSum[2]*v0[2]+2.738612787525831*jacob_vel_inv0[1]*nuSum[2]*v0[2]+1.58113883008419*jacob_vel_inv0[0]*nuSum[2]*v0[2]-2.23606797749979*jacob_vel_inv0[2]*sumNuUx[2]-1.732050807568877*jacob_vel_inv0[1]*sumNuUx[2]-1.0*jacob_vel_inv0[0]*sumNuUx[2]+2.738612787525831*v0[1]*jacob_vel_inv0[2]*nuSum[2]+1.58113883008419*v0[0]*jacob_vel_inv0[2]*nuSum[2]+2.121320343559642*jacob_vel_inv0[1]*v0[1]*nuSum[2]+1.224744871391589*jacob_vel_inv0[0]*v0[1]*nuSum[2]+1.224744871391589*v0[0]*jacob_vel_inv0[1]*nuSum[2]+0.7071067811865475*jacob_vel_inv0[0]*v0[0]*nuSum[2]; 
  ...
  Ghat_l[7] = 0.447213595499958*alphaDrSurf_l[1]*fUpwind_l[8]+0.4472135954999579*alphaDrSurf_l[4]*fUpwind_l[7]+0.5*alphaDrSurf_l[0]*fUpwind_l[7]+0.5000000000000001*alphaDrSurf_l[1]*fUpwind_l[5]; 
  Ghat_l[8] = 0.31943828249997*alphaDrSurf_l[4]*fUpwind_l[8]+0.5*alphaDrSurf_l[0]*fUpwind_l[8]+0.447213595499958*alphaDrSurf_l[1]*fUpwind_l[7]+0.5*alphaDrSurf_l[4]*fUpwind_l[5]; 
  ...
  Ghat_r[7] = 0.447213595499958*alphaDrSurf_r[1]*fUpwind_r[8]+0.4472135954999579*alphaDrSurf_r[4]*fUpwind_r[7]+0.5*alphaDrSurf_r[0]*fUpwind_r[7]+0.5000000000000001*alphaDrSurf_r[1]*fUpwind_r[5]; 
  Ghat_r[8] = 0.31943828249997*alphaDrSurf_r[4]*fUpwind_r[8]+0.5*alphaDrSurf_r[0]*fUpwind_r[8]+0.447213595499958*alphaDrSurf_r[1]*fUpwind_r[7]+0.5*alphaDrSurf_r[4]*fUpwind_r[5]; 
  ...
  out[12] += 1.58113883008419*Ghat_r[1]*rdv2-1.58113883008419*Ghat_l[1]*rdv2; 
  ...
  out[18] += 1.58113883008419*Ghat_r[3]*rdv2-1.58113883008419*Ghat_l[3]*rdv2; 
  ...
  out[22] += 1.58113883008419*Ghat_r[5]*rdv2-1.58113883008419*Ghat_l[5]*rdv2; 
  out[23] += 1.58113883008419*Ghat_r[6]*rdv2-1.58113883008419*Ghat_l[6]*rdv2; 
  out[24] += 1.224744871391589*Ghat_r[8]*rdv2+1.224744871391589*Ghat_l[8]*rdv2; 
  out[25] += 1.58113883008419*Ghat_r[7]*rdv2-1.58113883008419*Ghat_l[7]*rdv2; 
  out[26] += 1.58113883008419*Ghat_r[8]*rdv2-1.58113883008419*Ghat_l[8]*rdv2; 
