...
{ 
  ...
  temp_diff[2] = (-0.5412658773652741*fr[6])+0.5412658773652741*fl[6]+0.5625*fr[2]+0.5625*fl[2]-1.125*fc[2]; 
  temp_diff[3] = (-0.4375*fr[3])-0.4375*fl[3]-2.875*fc[3]+0.5412658773652741*fr[0]-0.5412658773652741*fl[0]; 
  temp_diff[4] = (-0.5412658773652741*fr[7])+0.5412658773652741*fl[7]+0.5625*fr[4]+0.5625*fl[4]-1.125*fc[4]; 
  temp_diff[5] = (-0.4375*fr[5])-0.4375*fl[5]-2.875*fc[5]+0.5412658773652741*fr[1]-0.5412658773652741*fl[1]; 
  temp_diff[6] = (-0.4375*fr[6])-0.4375*fl[6]-2.875*fc[6]+0.5412658773652741*fr[2]-0.5412658773652741*fl[2]; 
  temp_diff[7] = (-0.4375*fr[7])-0.4375*fl[7]-2.875*fc[7]+0.5412658773652741*fr[4]-0.5412658773652741*fl[4]; 
