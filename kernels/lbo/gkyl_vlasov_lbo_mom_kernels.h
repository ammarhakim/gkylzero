...
GKYL_CU_DH void vlasov_boundary_integral_2x3v_ser_f_p1(const int *idx, const int *atLower, const double *vBoundary, const double *dxv, const double *fIn, double* GKYL_RESTRICT out);
GKYL_CU_DH void vlasov_boundary_integral_2x3v_ser_vf_p1(const int *idx, const int *atLower, const double *vBoundary, const double *dxv, const double *fIn, double* GKYL_RESTRICT out);

GKYL_CU_DH void vlasov_boundary_integral_3x3v_ser_f_p1(const int *idx, const int *atLower, const double *vBoundary, const double *dxv, const double *fIn, double* GKYL_RESTRICT out);
GKYL_CU_DH void vlasov_boundary_integral_3x3v_ser_vf_p1(const int *idx, const int *atLower, const double *vBoundary, const double *dxv, const double *fIn, double* GKYL_RESTRICT out);
