...
{ 
  ...
  Ghat[16] = -(0.008333333333333333*(36.74234614174767*alphaDrSurf[11]*fEdge[47]+36.74234614174768*(alphaDrSurf[7]*fEdge[46]+alphaDrSurf[6]*fEdge[45]+alphaDrSurf[5]*fEdge[44])-21.21320343559643*alphaDrSurf[11]*fEdge[43]+36.74234614174767*(alphaDrSurf[3]*fEdge[42]+alphaDrSurf[2]*fEdge[41]+alphaDrSurf[1]*fEdge[40])-21.21320343559643*(alphaDrSurf[7]*fEdge[39]+alphaDrSurf[6]*fEdge[38]+alphaDrSurf[5]*fEdge[37])+36.74234614174768*alphaDrSurf[0]*fEdge[36]-21.21320343559643*(alphaDrSurf[3]*fEdge[35]+alphaDrSurf[2]*fEdge[34]+alphaDrSurf[1]*fEdge[33])-21.21320343559643*alphaDrSurf[0]*fEdge[32]))/vmap_prime_edge[1]; 
  Ghat[17] = -(0.008333333333333333*(36.74234614174768*alphaDrSurf[7]*fEdge[47]+36.74234614174767*(alphaDrSurf[11]*fEdge[46]+alphaDrSurf[3]*fEdge[45]+alphaDrSurf[2]*fEdge[44])-21.21320343559643*alphaDrSurf[7]*fEdge[43]+36.74234614174768*(alphaDrSurf[6]*fEdge[42]+alphaDrSurf[5]*fEdge[41]+alphaDrSurf[0]*fEdge[40])-21.21320343559643*(alphaDrSurf[11]*fEdge[39]+alphaDrSurf[3]*fEdge[38]+alphaDrSurf[2]*fEdge[37])+36.74234614174767*alphaDrSurf[1]*fEdge[36]-21.21320343559643*(alphaDrSurf[6]*fEdge[35]+alphaDrSurf[5]*fEdge[34]+alphaDrSurf[0]*fEdge[33])-21.21320343559643*alphaDrSurf[1]*fEdge[32]))/vmap_prime_edge[1]; 
  Ghat[18] = -(0.008333333333333333*(36.74234614174768*alphaDrSurf[6]*fEdge[47]+36.74234614174767*(alphaDrSurf[3]*fEdge[46]+alphaDrSurf[11]*fEdge[45]+alphaDrSurf[1]*fEdge[44])-21.21320343559643*alphaDrSurf[6]*fEdge[43]+36.74234614174768*(alphaDrSurf[7]*fEdge[42]+alphaDrSurf[0]*fEdge[41]+alphaDrSurf[5]*fEdge[40])-21.21320343559643*(alphaDrSurf[3]*fEdge[39]+alphaDrSurf[11]*fEdge[38]+alphaDrSurf[1]*fEdge[37])+36.74234614174767*alphaDrSurf[2]*fEdge[36]-21.21320343559643*(alphaDrSurf[7]*fEdge[35]+alphaDrSurf[0]*fEdge[34]+alphaDrSurf[5]*fEdge[33])-21.21320343559643*alphaDrSurf[2]*fEdge[32]))/vmap_prime_edge[1]; 
  Ghat[19] = -(0.008333333333333333*(36.74234614174768*alphaDrSurf[5]*fEdge[47]+36.74234614174767*(alphaDrSurf[2]*fEdge[46]+alphaDrSurf[1]*fEdge[45]+alphaDrSurf[11]*fEdge[44])-21.21320343559643*alphaDrSurf[5]*fEdge[43]+36.74234614174768*(alphaDrSurf[0]*fEdge[42]+alphaDrSurf[7]*fEdge[41]+alphaDrSurf[6]*fEdge[40])-21.21320343559643*(alphaDrSurf[2]*fEdge[39]+alphaDrSurf[1]*fEdge[38]+alphaDrSurf[11]*fEdge[37])+36.74234614174767*alphaDrSurf[3]*fEdge[36]-21.21320343559643*(alphaDrSurf[0]*fEdge[35]+alphaDrSurf[7]*fEdge[34]+alphaDrSurf[6]*fEdge[33])-21.21320343559643*alphaDrSurf[3]*fEdge[32]))/vmap_prime_edge[1]; 
  Ghat[20] = -(0.008333333333333333*(36.74234614174767*alphaDrSurf[3]*fEdge[47]+36.74234614174768*(alphaDrSurf[6]*fEdge[46]+alphaDrSurf[7]*fEdge[45]+alphaDrSurf[0]*fEdge[44])-21.21320343559643*alphaDrSurf[3]*fEdge[43]+36.74234614174767*(alphaDrSurf[11]*fEdge[42]+alphaDrSurf[1]*fEdge[41]+alphaDrSurf[2]*fEdge[40])-21.21320343559643*(alphaDrSurf[6]*fEdge[39]+alphaDrSurf[7]*fEdge[38]+alphaDrSurf[0]*fEdge[37])+36.74234614174768*alphaDrSurf[5]*fEdge[36]-21.21320343559643*(alphaDrSurf[11]*fEdge[35]+alphaDrSurf[1]*fEdge[34]+alphaDrSurf[2]*fEdge[33])-21.21320343559643*alphaDrSurf[5]*fEdge[32]))/vmap_prime_edge[1]; 
  Ghat[21] = -(0.008333333333333333*(36.74234614174767*alphaDrSurf[2]*fEdge[47]+36.74234614174768*(alphaDrSurf[5]*fEdge[46]+alphaDrSurf[0]*fEdge[45]+alphaDrSurf[7]*fEdge[44])-21.21320343559643*alphaDrSurf[2]*fEdge[43]+36.74234614174767*(alphaDrSurf[1]*fEdge[42]+alphaDrSurf[11]*fEdge[41]+alphaDrSurf[3]*fEdge[40])-21.21320343559643*(alphaDrSurf[5]*fEdge[39]+alphaDrSurf[0]*fEdge[38]+alphaDrSurf[7]*fEdge[37])+36.74234614174768*alphaDrSurf[6]*fEdge[36]-21.21320343559643*(alphaDrSurf[1]*fEdge[35]+alphaDrSurf[11]*fEdge[34]+alphaDrSurf[3]*fEdge[33])-21.21320343559643*alphaDrSurf[6]*fEdge[32]))/vmap_prime_edge[1]; 
  Ghat[22] = -(0.008333333333333333*(36.74234614174767*alphaDrSurf[1]*fEdge[47]+36.74234614174768*(alphaDrSurf[0]*fEdge[46]+alphaDrSurf[5]*fEdge[45]+alphaDrSurf[6]*fEdge[44])-21.21320343559643*alphaDrSurf[1]*fEdge[43]+36.74234614174767*(alphaDrSurf[2]*fEdge[42]+alphaDrSurf[3]*fEdge[41]+alphaDrSurf[11]*fEdge[40])-21.21320343559643*(alphaDrSurf[0]*fEdge[39]+alphaDrSurf[5]*fEdge[38]+alphaDrSurf[6]*fEdge[37])+36.74234614174768*alphaDrSurf[7]*fEdge[36]-21.21320343559643*(alphaDrSurf[2]*fEdge[35]+alphaDrSurf[3]*fEdge[34]+alphaDrSurf[11]*fEdge[33])-21.21320343559643*alphaDrSurf[7]*fEdge[32]))/vmap_prime_edge[1]; 
  Ghat[23] = -(0.008333333333333333*(36.74234614174768*alphaDrSurf[0]*fEdge[47]+36.74234614174767*(alphaDrSurf[1]*fEdge[46]+alphaDrSurf[2]*fEdge[45]+alphaDrSurf[3]*fEdge[44])-21.21320343559643*alphaDrSurf[0]*fEdge[43]+36.74234614174768*(alphaDrSurf[5]*fEdge[42]+alphaDrSurf[6]*fEdge[41]+alphaDrSurf[7]*fEdge[40])-21.21320343559643*(alphaDrSurf[1]*fEdge[39]+alphaDrSurf[2]*fEdge[38]+alphaDrSurf[3]*fEdge[37])+36.74234614174767*alphaDrSurf[11]*fEdge[36]-21.21320343559643*(alphaDrSurf[5]*fEdge[35]+alphaDrSurf[6]*fEdge[34]+alphaDrSurf[7]*fEdge[33])-21.21320343559643*alphaDrSurf[11]*fEdge[32]))/vmap_prime_edge[1]; 
  ...
  alphaDrSurf[0] = nuSum[0]*(2.0*vmap[2]-3.464101615137754*vmap[3]); 
  alphaDrSurf[1] = nuSum[1]*(2.0*vmap[2]-3.464101615137754*vmap[3]); 
  alphaDrSurf[2] = nuSum[2]*(2.0*vmap[2]-3.464101615137754*vmap[3]); 
  alphaDrSurf[3] = nuSum[3]*(2.0*vmap[2]-3.464101615137754*vmap[3]); 
  alphaDrSurf[5] = (2.0*vmap[2]-3.464101615137754*vmap[3])*nuSum[4]; 
  alphaDrSurf[6] = (2.0*vmap[2]-3.464101615137754*vmap[3])*nuSum[5]; 
  alphaDrSurf[7] = (2.0*vmap[2]-3.464101615137754*vmap[3])*nuSum[6]; 
  alphaDrSurf[11] = (2.0*vmap[2]-3.464101615137754*vmap[3])*nuSum[7]; 
