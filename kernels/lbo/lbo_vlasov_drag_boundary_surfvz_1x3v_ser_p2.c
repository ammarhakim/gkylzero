...
GKYL_CU_DH void lbo_vlasov_drag_boundary_surfvz_1x3v_ser_p2(const double *w, const double *dxv, const double *nuSum, const double *nuUSum, const double *nuVtSqSum, const int edge, const double *fSkin, const double *fEdge, double* GKYL_RESTRICT out) 
{ 
  ...
  if (0.3162277660168379*alphaDrSurf[7]-0.4743416490252568*alphaDrSurf[1]+0.3535533905932737*alphaDrSurf[0] < 0) { 
    fUpwindQuad[0] = ser_1x3v_p2_surfvz_quad_0(1, fSkin); 
    fUpwindQuad[3] = ser_1x3v_p2_surfvz_quad_3(1, fSkin); 
    fUpwindQuad[6] = ser_1x3v_p2_surfvz_quad_6(1, fSkin); 
    fUpwindQuad[9] = ser_1x3v_p2_surfvz_quad_9(1, fSkin); 
    fUpwindQuad[12] = ser_1x3v_p2_surfvz_quad_12(1, fSkin); 
    fUpwindQuad[15] = ser_1x3v_p2_surfvz_quad_15(1, fSkin); 
    fUpwindQuad[18] = ser_1x3v_p2_surfvz_quad_18(1, fSkin); 
    fUpwindQuad[21] = ser_1x3v_p2_surfvz_quad_21(1, fSkin); 
    fUpwindQuad[24] = ser_1x3v_p2_surfvz_quad_24(1, fSkin); 
  } else { 
    fUpwindQuad[0] = ser_1x3v_p2_surfvz_quad_0(-1, fEdge); 
    fUpwindQuad[3] = ser_1x3v_p2_surfvz_quad_3(-1, fEdge); 
    fUpwindQuad[6] = ser_1x3v_p2_surfvz_quad_6(-1, fEdge); 
    fUpwindQuad[9] = ser_1x3v_p2_surfvz_quad_9(-1, fEdge); 
    fUpwindQuad[12] = ser_1x3v_p2_surfvz_quad_12(-1, fEdge); 
    fUpwindQuad[15] = ser_1x3v_p2_surfvz_quad_15(-1, fEdge); 
    fUpwindQuad[18] = ser_1x3v_p2_surfvz_quad_18(-1, fEdge); 
    fUpwindQuad[21] = ser_1x3v_p2_surfvz_quad_21(-1, fEdge); 
    fUpwindQuad[24] = ser_1x3v_p2_surfvz_quad_24(-1, fEdge); 
  } 
  if (0.3535533905932737*alphaDrSurf[0]-0.3952847075210473*alphaDrSurf[7] < 0) { 
    fUpwindQuad[1] = ser_1x3v_p2_surfvz_quad_1(1, fSkin); 
    fUpwindQuad[4] = ser_1x3v_p2_surfvz_quad_4(1, fSkin); 
    fUpwindQuad[7] = ser_1x3v_p2_surfvz_quad_7(1, fSkin); 
    fUpwindQuad[10] = ser_1x3v_p2_surfvz_quad_10(1, fSkin); 
    fUpwindQuad[13] = ser_1x3v_p2_surfvz_quad_13(1, fSkin); 
    fUpwindQuad[16] = ser_1x3v_p2_surfvz_quad_16(1, fSkin); 
    fUpwindQuad[19] = ser_1x3v_p2_surfvz_quad_19(1, fSkin); 
    fUpwindQuad[22] = ser_1x3v_p2_surfvz_quad_22(1, fSkin); 
    fUpwindQuad[25] = ser_1x3v_p2_surfvz_quad_25(1, fSkin); 
  } else { 
    fUpwindQuad[1] = ser_1x3v_p2_surfvz_quad_1(-1, fEdge); 
    fUpwindQuad[4] = ser_1x3v_p2_surfvz_quad_4(-1, fEdge); 
    fUpwindQuad[7] = ser_1x3v_p2_surfvz_quad_7(-1, fEdge); 
    fUpwindQuad[10] = ser_1x3v_p2_surfvz_quad_10(-1, fEdge); 
    fUpwindQuad[13] = ser_1x3v_p2_surfvz_quad_13(-1, fEdge); 
    fUpwindQuad[16] = ser_1x3v_p2_surfvz_quad_16(-1, fEdge); 
    fUpwindQuad[19] = ser_1x3v_p2_surfvz_quad_19(-1, fEdge); 
    fUpwindQuad[22] = ser_1x3v_p2_surfvz_quad_22(-1, fEdge); 
    fUpwindQuad[25] = ser_1x3v_p2_surfvz_quad_25(-1, fEdge); 
  } 
  if (0.3162277660168379*alphaDrSurf[7]+0.4743416490252568*alphaDrSurf[1]+0.3535533905932737*alphaDrSurf[0] < 0) { 
    fUpwindQuad[2] = ser_1x3v_p2_surfvz_quad_2(1, fSkin); 
    fUpwindQuad[5] = ser_1x3v_p2_surfvz_quad_5(1, fSkin); 
    fUpwindQuad[8] = ser_1x3v_p2_surfvz_quad_8(1, fSkin); 
    fUpwindQuad[11] = ser_1x3v_p2_surfvz_quad_11(1, fSkin); 
    fUpwindQuad[14] = ser_1x3v_p2_surfvz_quad_14(1, fSkin); 
    fUpwindQuad[17] = ser_1x3v_p2_surfvz_quad_17(1, fSkin); 
    fUpwindQuad[20] = ser_1x3v_p2_surfvz_quad_20(1, fSkin); 
    fUpwindQuad[23] = ser_1x3v_p2_surfvz_quad_23(1, fSkin); 
    fUpwindQuad[26] = ser_1x3v_p2_surfvz_quad_26(1, fSkin); 
  } else { 
    fUpwindQuad[2] = ser_1x3v_p2_surfvz_quad_2(-1, fEdge); 
    fUpwindQuad[5] = ser_1x3v_p2_surfvz_quad_5(-1, fEdge); 
    fUpwindQuad[8] = ser_1x3v_p2_surfvz_quad_8(-1, fEdge); 
    fUpwindQuad[11] = ser_1x3v_p2_surfvz_quad_11(-1, fEdge); 
    fUpwindQuad[14] = ser_1x3v_p2_surfvz_quad_14(-1, fEdge); 
    fUpwindQuad[17] = ser_1x3v_p2_surfvz_quad_17(-1, fEdge); 
    fUpwindQuad[20] = ser_1x3v_p2_surfvz_quad_20(-1, fEdge); 
    fUpwindQuad[23] = ser_1x3v_p2_surfvz_quad_23(-1, fEdge); 
    fUpwindQuad[26] = ser_1x3v_p2_surfvz_quad_26(-1, fEdge); 
  } 
