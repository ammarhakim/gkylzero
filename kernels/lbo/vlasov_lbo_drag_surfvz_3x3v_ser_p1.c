...
{ 
  ...
  out[5] += 0.7071067811865475*Gdrag_r[5]*rdv2-0.7071067811865475*Gdrag_l[5]*rdv2; 
  out[6] += 1.224744871391589*Gdrag_r[0]*rdv2+1.224744871391589*Gdrag_l[0]*rdv2; 
  ...
  out[13] += 0.7071067811865475*Gdrag_r[12]*rdv2-0.7071067811865475*Gdrag_l[12]*rdv2; 
  out[14] += 0.7071067811865475*Gdrag_r[13]*rdv2-0.7071067811865475*Gdrag_l[13]*rdv2; 
  out[15] += 0.7071067811865475*Gdrag_r[14]*rdv2-0.7071067811865475*Gdrag_l[14]*rdv2; 
  out[16] += 0.7071067811865475*Gdrag_r[15]*rdv2-0.7071067811865475*Gdrag_l[15]*rdv2; 
  out[17] += 1.224744871391589*Gdrag_r[1]*rdv2+1.224744871391589*Gdrag_l[1]*rdv2; 
  out[18] += 1.224744871391589*Gdrag_r[2]*rdv2+1.224744871391589*Gdrag_l[2]*rdv2; 
  out[19] += 1.224744871391589*Gdrag_r[3]*rdv2+1.224744871391589*Gdrag_l[3]*rdv2; 
  out[20] += 1.224744871391589*Gdrag_r[4]*rdv2+1.224744871391589*Gdrag_l[4]*rdv2; 
  ...
  out[26] += 0.7071067811865475*Gdrag_r[20]*rdv2-0.7071067811865475*Gdrag_l[20]*rdv2; 
  out[27] += 0.7071067811865475*Gdrag_r[21]*rdv2-0.7071067811865475*Gdrag_l[21]*rdv2; 
  out[28] += 0.7071067811865475*Gdrag_r[22]*rdv2-0.7071067811865475*Gdrag_l[22]*rdv2; 
  out[29] += 0.7071067811865475*Gdrag_r[23]*rdv2-0.7071067811865475*Gdrag_l[23]*rdv2; 
  out[30] += 0.7071067811865475*Gdrag_r[24]*rdv2-0.7071067811865475*Gdrag_l[24]*rdv2; 
  out[31] += 0.7071067811865475*Gdrag_r[25]*rdv2-0.7071067811865475*Gdrag_l[25]*rdv2; 
  out[32] += 1.224744871391589*Gdrag_r[6]*rdv2+1.224744871391589*Gdrag_l[6]*rdv2; 
  out[33] += 1.224744871391589*Gdrag_r[7]*rdv2+1.224744871391589*Gdrag_l[7]*rdv2; 
  out[34] += 1.224744871391589*Gdrag_r[8]*rdv2+1.224744871391589*Gdrag_l[8]*rdv2; 
  out[35] += 1.224744871391589*Gdrag_r[9]*rdv2+1.224744871391589*Gdrag_l[9]*rdv2; 
  out[36] += 1.224744871391589*Gdrag_r[10]*rdv2+1.224744871391589*Gdrag_l[10]*rdv2; 
  ...
  out[43] += 0.7071067811865475*Gdrag_r[27]*rdv2-0.7071067811865475*Gdrag_l[27]*rdv2; 
  out[44] += 0.7071067811865475*Gdrag_r[28]*rdv2-0.7071067811865475*Gdrag_l[28]*rdv2; 
  out[45] += 0.7071067811865475*Gdrag_r[29]*rdv2-0.7071067811865475*Gdrag_l[29]*rdv2; 
  out[46] += 0.7071067811865475*Gdrag_r[30]*rdv2-0.7071067811865475*Gdrag_l[30]*rdv2; 
  out[47] += 1.224744871391589*Gdrag_r[16]*rdv2+1.224744871391589*Gdrag_l[16]*rdv2; 
  out[48] += 1.224744871391589*Gdrag_r[17]*rdv2+1.224744871391589*Gdrag_l[17]*rdv2; 
  out[49] += 1.224744871391589*Gdrag_r[18]*rdv2+1.224744871391589*Gdrag_l[18]*rdv2; 
  out[50] += 1.224744871391589*Gdrag_r[19]*rdv2+1.224744871391589*Gdrag_l[19]*rdv2; 
  ...
  out[57] += 0.7071067811865475*Gdrag_r[31]*rdv2-0.7071067811865475*Gdrag_l[31]*rdv2; 
  out[58] += 1.224744871391589*Gdrag_r[26]*rdv2+1.224744871391589*Gdrag_l[26]*rdv2; 
