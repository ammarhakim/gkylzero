...
GKYL_CU_DH double vlasov_lbo_vol_1x3v_tensor_p1(const double *w, const double *dxv, const double nuSum, const double *nuUSum, const double *nuVtSqSum, const double *f, double GKYL_RESTRICT *out) 
{ 
