...
GKYL_CU_DH double lbo_vlasov_vmap_drag_surfvy_2x2v_ser_p2(const double *w, const double *dxv, const double *vmap, const double *jacob_vel_inv, const double *nuSum, const double *nuPrimMomsSum, const double *fl, const double *fc, const double *fr, double* GKYL_RESTRICT out) 
{ 
  ...
  alphaDrSurf_l[7] = (-2.23606797749979*jacob_vel_inv1[2]*sumNuUy[4])+1.732050807568877*jacob_vel_inv1[1]*sumNuUy[4]-1.0*jacob_vel_inv1[0]*sumNuUy[4]-4.183300132670378*jacob_vel_inv1[2]*v1[3]*nuSum[4]+3.24037034920393*jacob_vel_inv1[1]*v1[3]*nuSum[4]-1.870828693386971*jacob_vel_inv1[0]*v1[3]*nuSum[4]+3.535533905932737*jacob_vel_inv1[2]*v1[2]*nuSum[4]-2.738612787525831*jacob_vel_inv1[1]*v1[2]*nuSum[4]+1.58113883008419*jacob_vel_inv1[0]*v1[2]*nuSum[4]-2.738612787525831*v1[1]*jacob_vel_inv1[2]*nuSum[4]+1.58113883008419*v1[0]*jacob_vel_inv1[2]*nuSum[4]+2.121320343559642*jacob_vel_inv1[1]*v1[1]*nuSum[4]-1.224744871391589*jacob_vel_inv1[0]*v1[1]*nuSum[4]-1.224744871391589*v1[0]*jacob_vel_inv1[1]*nuSum[4]+0.7071067811865475*jacob_vel_inv1[0]*v1[0]*nuSum[4]; 
  alphaDrSurf_l[8] = (-2.23606797749979*jacob_vel_inv1[2]*sumNuUy[5])+1.732050807568877*jacob_vel_inv1[1]*sumNuUy[5]-1.0*jacob_vel_inv1[0]*sumNuUy[5]-4.183300132670378*jacob_vel_inv1[2]*v1[3]*nuSum[5]+3.24037034920393*jacob_vel_inv1[1]*v1[3]*nuSum[5]-1.870828693386971*jacob_vel_inv1[0]*v1[3]*nuSum[5]+3.535533905932737*jacob_vel_inv1[2]*v1[2]*nuSum[5]-2.738612787525831*jacob_vel_inv1[1]*v1[2]*nuSum[5]+1.58113883008419*jacob_vel_inv1[0]*v1[2]*nuSum[5]-2.738612787525831*v1[1]*jacob_vel_inv1[2]*nuSum[5]+1.58113883008419*v1[0]*jacob_vel_inv1[2]*nuSum[5]+2.121320343559642*jacob_vel_inv1[1]*v1[1]*nuSum[5]-1.224744871391589*jacob_vel_inv1[0]*v1[1]*nuSum[5]-1.224744871391589*v1[0]*jacob_vel_inv1[1]*nuSum[5]+0.7071067811865475*jacob_vel_inv1[0]*v1[0]*nuSum[5]; 
  alphaDrSurf_l[11] = (-2.23606797749979*jacob_vel_inv1[2]*sumNuUy[6])+1.732050807568877*jacob_vel_inv1[1]*sumNuUy[6]-1.0*jacob_vel_inv1[0]*sumNuUy[6]-4.183300132670378*jacob_vel_inv1[2]*v1[3]*nuSum[6]+3.24037034920393*jacob_vel_inv1[1]*v1[3]*nuSum[6]-1.870828693386971*jacob_vel_inv1[0]*v1[3]*nuSum[6]+3.535533905932737*jacob_vel_inv1[2]*v1[2]*nuSum[6]-2.738612787525831*jacob_vel_inv1[1]*v1[2]*nuSum[6]+1.58113883008419*jacob_vel_inv1[0]*v1[2]*nuSum[6]-2.738612787525831*v1[1]*jacob_vel_inv1[2]*nuSum[6]+1.58113883008419*v1[0]*jacob_vel_inv1[2]*nuSum[6]+2.121320343559642*jacob_vel_inv1[1]*v1[1]*nuSum[6]-1.224744871391589*jacob_vel_inv1[0]*v1[1]*nuSum[6]-1.224744871391589*v1[0]*jacob_vel_inv1[1]*nuSum[6]+0.7071067811865475*jacob_vel_inv1[0]*v1[0]*nuSum[6]; 
  alphaDrSurf_l[12] = (-2.23606797749979*jacob_vel_inv1[2]*sumNuUy[7])+1.732050807568877*jacob_vel_inv1[1]*sumNuUy[7]-1.0*jacob_vel_inv1[0]*sumNuUy[7]-4.183300132670378*jacob_vel_inv1[2]*v1[3]*nuSum[7]+3.24037034920393*jacob_vel_inv1[1]*v1[3]*nuSum[7]-1.870828693386971*jacob_vel_inv1[0]*v1[3]*nuSum[7]+3.535533905932737*jacob_vel_inv1[2]*v1[2]*nuSum[7]-2.738612787525831*jacob_vel_inv1[1]*v1[2]*nuSum[7]+1.58113883008419*jacob_vel_inv1[0]*v1[2]*nuSum[7]-2.738612787525831*v1[1]*jacob_vel_inv1[2]*nuSum[7]+1.58113883008419*v1[0]*jacob_vel_inv1[2]*nuSum[7]+2.121320343559642*jacob_vel_inv1[1]*v1[1]*nuSum[7]-1.224744871391589*jacob_vel_inv1[0]*v1[1]*nuSum[7]-1.224744871391589*v1[0]*jacob_vel_inv1[1]*nuSum[7]+0.7071067811865475*jacob_vel_inv1[0]*v1[0]*nuSum[7]; 
  ...
  out[47] += 1.58113883008419*Ghat_r[10]*rdv2-1.58113883008419*Ghat_l[10]*rdv2; 
