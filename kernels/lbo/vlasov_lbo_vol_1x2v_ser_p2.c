...
{ 
  ...
  out[8] += 4.743416490252569*(facDiff[2]*f[7]+f[1]*facDiff[1]+f[0]*facDiff[0])*rdvxSq4+1.224744871391589*alphaDrag[4]*f[12]+1.369306393762915*(alphaDrag[7]*f[11]+f[7]*alphaDrag[11])+1.224744871391589*alphaDrag[2]*f[8]+1.369306393762915*(alphaDrag[1]*f[4]+f[1]*alphaDrag[4]+alphaDrag[0]*f[2]+f[0]*alphaDrag[2]); 
  out[9] += 4.743416490252569*(facDiff[2]*f[7]+f[1]*facDiff[1]+f[0]*facDiff[0])*rdvySq4+1.369306393762915*(f[7]*alphaDrag[33]+f[13]*alphaDrag[27])+(1.224744871391589*f[15]+1.369306393762915*f[1])*alphaDrag[25]+1.224744871391589*f[9]*alphaDrag[23]+1.369306393762915*(f[0]*alphaDrag[23]+f[5]*alphaDrag[21]+f[3]*alphaDrag[20]); 
  ...
  out[12] += (4.242640687119286*(facDiff[1]*f[7]+f[1]*facDiff[2])+4.743416490252569*(f[0]*facDiff[1]+facDiff[0]*f[1]))*rdvxSq4+1.095445115010332*alphaDrag[11]*f[12]+1.224744871391589*(alphaDrag[2]*f[12]+alphaDrag[1]*f[11]+f[1]*alphaDrag[11]+alphaDrag[4]*(f[8]+f[7])+f[4]*alphaDrag[7])+1.369306393762915*(alphaDrag[0]*f[4]+f[0]*alphaDrag[4]+alphaDrag[1]*f[2]+f[1]*alphaDrag[2]); 
  ...
  out[14] += 4.743416490252569*(facDiff[2]*f[13]+facDiff[1]*f[5]+facDiff[0]*f[3])*rdvxSq4+0.6123724356957944*(f[18]*alphaDrag[25]+f[14]*alphaDrag[23]+f[12]*alphaDrag[21]+f[8]*alphaDrag[20])+1.224744871391589*alphaDrag[4]*f[18]+1.369306393762915*alphaDrag[7]*f[17]+1.224744871391589*alphaDrag[2]*f[14]+1.369306393762915*(alphaDrag[11]*f[13]+alphaDrag[1]*f[10]+alphaDrag[0]*f[6]+alphaDrag[4]*f[5]+alphaDrag[2]*f[3]); 
  out[15] += (4.242640687119286*(facDiff[1]*f[7]+f[1]*facDiff[2])+4.743416490252569*(f[0]*facDiff[1]+facDiff[0]*f[1]))*rdvySq4+1.095445115010332*f[15]*alphaDrag[33]+1.224744871391589*(f[1]*alphaDrag[33]+f[5]*alphaDrag[27])+(1.224744871391589*(f[9]+f[7])+1.369306393762915*f[0])*alphaDrag[25]+(1.224744871391589*f[15]+1.369306393762915*f[1])*alphaDrag[23]+1.224744871391589*f[13]*alphaDrag[21]+1.369306393762915*(f[3]*alphaDrag[21]+f[5]*alphaDrag[20]); 
  out[16] += 4.743416490252569*(facDiff[2]*f[11]+facDiff[1]*f[4]+facDiff[0]*f[2])*rdvySq4+1.369306393762915*(f[11]*alphaDrag[33]+f[17]*alphaDrag[27])+(1.224744871391589*f[19]+1.369306393762915*f[4])*alphaDrag[25]+1.224744871391589*f[16]*alphaDrag[23]+1.369306393762915*(f[2]*alphaDrag[23]+f[10]*alphaDrag[21]+f[6]*alphaDrag[20])+0.6123724356957944*(alphaDrag[4]*f[19]+alphaDrag[2]*f[16]+alphaDrag[1]*f[15]+alphaDrag[0]*f[9]); 
  ...
  out[19] += (4.242640687119286*facDiff[1]*f[11]+4.743416490252569*(facDiff[0]*f[4]+facDiff[1]*f[2])+4.242640687119286*facDiff[2]*f[4])*rdvySq4+1.095445115010332*f[19]*alphaDrag[33]+1.224744871391589*(f[4]*alphaDrag[33]+f[10]*alphaDrag[27])+(1.224744871391589*(f[16]+f[11])+1.369306393762915*f[2])*alphaDrag[25]+(1.224744871391589*f[19]+1.369306393762915*f[4])*alphaDrag[23]+1.224744871391589*f[17]*alphaDrag[21]+1.369306393762915*(f[6]*alphaDrag[21]+f[10]*alphaDrag[20])+0.5477225575051661*alphaDrag[11]*f[19]+0.6123724356957944*(alphaDrag[2]*f[19]+alphaDrag[4]*f[16])+0.5477225575051661*alphaDrag[7]*f[15]+0.6123724356957944*(alphaDrag[0]*f[15]+alphaDrag[1]*f[9]); 

  return fabs(0.1767766952966368*alphaDrag[0]-0.1976423537605236*alphaDrag[7])+fabs(0.1767766952966368*alphaDrag[20]-0.1976423537605236*alphaDrag[27])+fabs((1.272792206135785*facDiff[0]-1.42302494707577*facDiff[2])*rdvxSq4)+fabs((1.272792206135785*facDiff[0]-1.42302494707577*facDiff[2])*rdvySq4); 
