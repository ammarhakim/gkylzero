...
GKYL_CU_DH double lbo_vlasov_vmap_drag_boundary_surfvx_1x3v_tensor_p2(const double *w, const double *dxv, const double *vmap, const double *jacob_vel_inv, const double *nuSum, const double *nuPrimMomsSum, const int edge, const double *fSkin, const double *fEdge, double* GKYL_RESTRICT out) 
{ 
  ...
  alphaDrSurf[0] = nuSum[0]*(((-5.916079783099617*jacob_vel_inv0[2])+4.58257569495584*jacob_vel_inv0[1]-2.645751311064591*jacob_vel_inv0[0])*v0[3]+(5.0*jacob_vel_inv0[2]-3.872983346207417*jacob_vel_inv0[1]+2.23606797749979*jacob_vel_inv0[0])*v0[2])+(nuSum[0]*(2.23606797749979*v0[0]-3.872983346207417*v0[1])-3.16227766016838*sumNuUx[0])*jacob_vel_inv0[2]+nuSum[0]*(3.0*jacob_vel_inv0[1]-1.732050807568877*jacob_vel_inv0[0])*v0[1]+(2.449489742783178*sumNuUx[0]-1.732050807568877*nuSum[0]*v0[0])*jacob_vel_inv0[1]+jacob_vel_inv0[0]*(nuSum[0]*v0[0]-1.414213562373095*sumNuUx[0]); 
  alphaDrSurf[1] = nuSum[1]*(((-5.916079783099617*jacob_vel_inv0[2])+4.58257569495584*jacob_vel_inv0[1]-2.645751311064591*jacob_vel_inv0[0])*v0[3]+(5.0*jacob_vel_inv0[2]-3.872983346207417*jacob_vel_inv0[1]+2.23606797749979*jacob_vel_inv0[0])*v0[2])+((-3.872983346207417*nuSum[1]*v0[1])-3.16227766016838*sumNuUx[1]+2.23606797749979*v0[0]*nuSum[1])*jacob_vel_inv0[2]+(3.0*jacob_vel_inv0[1]-1.732050807568877*jacob_vel_inv0[0])*nuSum[1]*v0[1]+(2.449489742783178*jacob_vel_inv0[1]-1.414213562373095*jacob_vel_inv0[0])*sumNuUx[1]+v0[0]*(jacob_vel_inv0[0]-1.732050807568877*jacob_vel_inv0[1])*nuSum[1]; 
  alphaDrSurf[7] = nuSum[2]*(((-5.916079783099617*jacob_vel_inv0[2])+4.58257569495584*jacob_vel_inv0[1]-2.645751311064591*jacob_vel_inv0[0])*v0[3]+(5.0*jacob_vel_inv0[2]-3.872983346207417*jacob_vel_inv0[1]+2.23606797749979*jacob_vel_inv0[0])*v0[2])+((-3.16227766016838*jacob_vel_inv0[2])+2.449489742783178*jacob_vel_inv0[1]-1.414213562373095*jacob_vel_inv0[0])*sumNuUx[2]+((2.23606797749979*v0[0]-3.872983346207417*v0[1])*jacob_vel_inv0[2]+(3.0*jacob_vel_inv0[1]-1.732050807568877*jacob_vel_inv0[0])*v0[1]+v0[0]*(jacob_vel_inv0[0]-1.732050807568877*jacob_vel_inv0[1]))*nuSum[2]; 
