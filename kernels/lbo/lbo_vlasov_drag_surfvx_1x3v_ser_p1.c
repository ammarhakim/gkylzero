...
{ 
  ...
  if (alphaDrSurf_l[0]-alphaDrSurf_l[1] < 0) { 
    fUpwindQuad_l[0] = ser_4x_p1_surfx2_quad_0_r(fl); 
    fUpwindQuad_l[2] = ser_4x_p1_surfx2_quad_2_r(fl); 
    fUpwindQuad_l[4] = ser_4x_p1_surfx2_quad_4_r(fl); 
    fUpwindQuad_l[6] = ser_4x_p1_surfx2_quad_6_r(fl); 
  } else { 
    fUpwindQuad_l[0] = ser_4x_p1_surfx2_quad_0_l(fc); 
    fUpwindQuad_l[2] = ser_4x_p1_surfx2_quad_2_l(fc); 
    fUpwindQuad_l[4] = ser_4x_p1_surfx2_quad_4_l(fc); 
    fUpwindQuad_l[6] = ser_4x_p1_surfx2_quad_6_l(fc); 
  } 
  if (alphaDrSurf_r[0]-alphaDrSurf_r[1] < 0) { 
    fUpwindQuad_r[0] = ser_4x_p1_surfx2_quad_0_r(fc); 
    fUpwindQuad_r[2] = ser_4x_p1_surfx2_quad_2_r(fc); 
    fUpwindQuad_r[4] = ser_4x_p1_surfx2_quad_4_r(fc); 
    fUpwindQuad_r[6] = ser_4x_p1_surfx2_quad_6_r(fc); 
  } else { 
    fUpwindQuad_r[0] = ser_4x_p1_surfx2_quad_0_l(fr); 
    fUpwindQuad_r[2] = ser_4x_p1_surfx2_quad_2_l(fr); 
    fUpwindQuad_r[4] = ser_4x_p1_surfx2_quad_4_l(fr); 
    fUpwindQuad_r[6] = ser_4x_p1_surfx2_quad_6_l(fr); 
  } 
  if (alphaDrSurf_l[1]+alphaDrSurf_l[0] < 0) { 
    fUpwindQuad_l[1] = ser_4x_p1_surfx2_quad_1_r(fl); 
    fUpwindQuad_l[3] = ser_4x_p1_surfx2_quad_3_r(fl); 
    fUpwindQuad_l[5] = ser_4x_p1_surfx2_quad_5_r(fl); 
    fUpwindQuad_l[7] = ser_4x_p1_surfx2_quad_7_r(fl); 
  } else { 
    fUpwindQuad_l[1] = ser_4x_p1_surfx2_quad_1_l(fc); 
    fUpwindQuad_l[3] = ser_4x_p1_surfx2_quad_3_l(fc); 
    fUpwindQuad_l[5] = ser_4x_p1_surfx2_quad_5_l(fc); 
    fUpwindQuad_l[7] = ser_4x_p1_surfx2_quad_7_l(fc); 
  } 
  if (alphaDrSurf_r[1]+alphaDrSurf_r[0] < 0) { 
    fUpwindQuad_r[1] = ser_4x_p1_surfx2_quad_1_r(fc); 
    fUpwindQuad_r[3] = ser_4x_p1_surfx2_quad_3_r(fc); 
    fUpwindQuad_r[5] = ser_4x_p1_surfx2_quad_5_r(fc); 
    fUpwindQuad_r[7] = ser_4x_p1_surfx2_quad_7_r(fc); 
  } else { 
    fUpwindQuad_r[1] = ser_4x_p1_surfx2_quad_1_l(fr); 
    fUpwindQuad_r[3] = ser_4x_p1_surfx2_quad_3_l(fr); 
    fUpwindQuad_r[5] = ser_4x_p1_surfx2_quad_5_l(fr); 
    fUpwindQuad_r[7] = ser_4x_p1_surfx2_quad_7_l(fr); 
  } 
  ...
  out[12] += 1.224744871391589*Gdrag_r[5]*rdv2+1.224744871391589*Gdrag_l[5]*rdv2; 
  out[13] += 0.7071067811865475*Gdrag_r[7]*rdv2-0.7071067811865475*Gdrag_l[7]*rdv2; 
