...
{ 
  ...
  if ((-0.3*(alphaDrSurf_l[20]+alphaDrSurf_l[19]))+0.223606797749979*(alphaDrSurf_l[12]+alphaDrSurf_l[11])+0.45*alphaDrSurf_l[5]-0.3354101966249685*(alphaDrSurf_l[2]+alphaDrSurf_l[1])+0.25*alphaDrSurf_l[0] < 0) { 
  ...
  if ((-0.3*(alphaDrSurf_r[20]+alphaDrSurf_r[19]))+0.223606797749979*(alphaDrSurf_r[12]+alphaDrSurf_r[11])+0.45*alphaDrSurf_r[5]-0.3354101966249685*(alphaDrSurf_r[2]+alphaDrSurf_r[1])+0.25*alphaDrSurf_r[0] < 0) { 
