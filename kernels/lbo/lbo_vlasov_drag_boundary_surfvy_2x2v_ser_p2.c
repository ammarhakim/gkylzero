...
{ 
  ...
  if ((-0.4242640687119284*(alphaDrSurf[12]+alphaDrSurf[11]))+0.3162277660168378*(alphaDrSurf[8]+alphaDrSurf[7])+0.6363961030678926*alphaDrSurf[4]-0.4743416490252567*(alphaDrSurf[2]+alphaDrSurf[1])+0.3535533905932737*alphaDrSurf[0] < 0) { 
  ...
  if (0.5303300858899105*alphaDrSurf[12]-0.3952847075210473*alphaDrSurf[8]+0.3162277660168378*alphaDrSurf[7]-0.4743416490252567*alphaDrSurf[1]+0.3535533905932737*alphaDrSurf[0] < 0) { 
  ...
  if ((-0.4242640687119284*alphaDrSurf[12])+0.4242640687119284*alphaDrSurf[11]+0.3162277660168378*(alphaDrSurf[8]+alphaDrSurf[7])-0.6363961030678926*alphaDrSurf[4]+0.4743416490252567*alphaDrSurf[2]-0.4743416490252567*alphaDrSurf[1]+0.3535533905932737*alphaDrSurf[0] < 0) { 
