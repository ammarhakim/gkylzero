...
GKYL_CU_DH double lbo_vlasov_vmap_drag_surfvz_2x3v_ser_p2(const double *w, const double *dxv, const double *vmap, const double *jacob_vel_inv, const double *nuSum, const double *nuPrimMomsSum, const double *fl, const double *fc, const double *fr, double* GKYL_RESTRICT out) 
{ 
  ...
  alphaDrSurf_l[11] = (-3.16227766016838*jacob_vel_inv2[2]*sumNuUz[4])+2.449489742783178*jacob_vel_inv2[1]*sumNuUz[4]-1.414213562373095*jacob_vel_inv2[0]*sumNuUz[4]-5.916079783099617*jacob_vel_inv2[2]*v2[3]*nuSum[4]+4.58257569495584*jacob_vel_inv2[1]*v2[3]*nuSum[4]-2.645751311064591*jacob_vel_inv2[0]*v2[3]*nuSum[4]+5.0*jacob_vel_inv2[2]*v2[2]*nuSum[4]-3.872983346207417*jacob_vel_inv2[1]*v2[2]*nuSum[4]+2.23606797749979*jacob_vel_inv2[0]*v2[2]*nuSum[4]-3.872983346207417*v2[1]*jacob_vel_inv2[2]*nuSum[4]+2.23606797749979*v2[0]*jacob_vel_inv2[2]*nuSum[4]+3.0*jacob_vel_inv2[1]*v2[1]*nuSum[4]-1.732050807568877*jacob_vel_inv2[0]*v2[1]*nuSum[4]-1.732050807568877*v2[0]*jacob_vel_inv2[1]*nuSum[4]+jacob_vel_inv2[0]*v2[0]*nuSum[4]; 
  alphaDrSurf_l[12] = (-3.16227766016838*jacob_vel_inv2[2]*sumNuUz[5])+2.449489742783178*jacob_vel_inv2[1]*sumNuUz[5]-1.414213562373095*jacob_vel_inv2[0]*sumNuUz[5]-5.916079783099617*jacob_vel_inv2[2]*v2[3]*nuSum[5]+4.58257569495584*jacob_vel_inv2[1]*v2[3]*nuSum[5]-2.645751311064591*jacob_vel_inv2[0]*v2[3]*nuSum[5]+5.0*jacob_vel_inv2[2]*v2[2]*nuSum[5]-3.872983346207417*jacob_vel_inv2[1]*v2[2]*nuSum[5]+2.23606797749979*jacob_vel_inv2[0]*v2[2]*nuSum[5]-3.872983346207417*v2[1]*jacob_vel_inv2[2]*nuSum[5]+2.23606797749979*v2[0]*jacob_vel_inv2[2]*nuSum[5]+3.0*jacob_vel_inv2[1]*v2[1]*nuSum[5]-1.732050807568877*jacob_vel_inv2[0]*v2[1]*nuSum[5]-1.732050807568877*v2[0]*jacob_vel_inv2[1]*nuSum[5]+jacob_vel_inv2[0]*v2[0]*nuSum[5]; 
  alphaDrSurf_l[19] = (-3.16227766016838*jacob_vel_inv2[2]*sumNuUz[6])+2.449489742783178*jacob_vel_inv2[1]*sumNuUz[6]-1.414213562373095*jacob_vel_inv2[0]*sumNuUz[6]-5.916079783099617*jacob_vel_inv2[2]*v2[3]*nuSum[6]+4.58257569495584*jacob_vel_inv2[1]*v2[3]*nuSum[6]-2.645751311064591*jacob_vel_inv2[0]*v2[3]*nuSum[6]+5.0*jacob_vel_inv2[2]*v2[2]*nuSum[6]-3.872983346207417*jacob_vel_inv2[1]*v2[2]*nuSum[6]+2.23606797749979*jacob_vel_inv2[0]*v2[2]*nuSum[6]-3.872983346207417*v2[1]*jacob_vel_inv2[2]*nuSum[6]+2.23606797749979*v2[0]*jacob_vel_inv2[2]*nuSum[6]+3.0*jacob_vel_inv2[1]*v2[1]*nuSum[6]-1.732050807568877*jacob_vel_inv2[0]*v2[1]*nuSum[6]-1.732050807568877*v2[0]*jacob_vel_inv2[1]*nuSum[6]+jacob_vel_inv2[0]*v2[0]*nuSum[6]; 
  alphaDrSurf_l[20] = (-3.16227766016838*jacob_vel_inv2[2]*sumNuUz[7])+2.449489742783178*jacob_vel_inv2[1]*sumNuUz[7]-1.414213562373095*jacob_vel_inv2[0]*sumNuUz[7]-5.916079783099617*jacob_vel_inv2[2]*v2[3]*nuSum[7]+4.58257569495584*jacob_vel_inv2[1]*v2[3]*nuSum[7]-2.645751311064591*jacob_vel_inv2[0]*v2[3]*nuSum[7]+5.0*jacob_vel_inv2[2]*v2[2]*nuSum[7]-3.872983346207417*jacob_vel_inv2[1]*v2[2]*nuSum[7]+2.23606797749979*jacob_vel_inv2[0]*v2[2]*nuSum[7]-3.872983346207417*v2[1]*jacob_vel_inv2[2]*nuSum[7]+2.23606797749979*v2[0]*jacob_vel_inv2[2]*nuSum[7]+3.0*jacob_vel_inv2[1]*v2[1]*nuSum[7]-1.732050807568877*jacob_vel_inv2[0]*v2[1]*nuSum[7]-1.732050807568877*v2[0]*jacob_vel_inv2[1]*nuSum[7]+jacob_vel_inv2[0]*v2[0]*nuSum[7]; 
  ...
  alphaDrSurf_r[11] = (-3.16227766016838*jacob_vel_inv2[2]*sumNuUz[4])-2.449489742783178*jacob_vel_inv2[1]*sumNuUz[4]-1.414213562373095*jacob_vel_inv2[0]*sumNuUz[4]+5.916079783099617*jacob_vel_inv2[2]*v2[3]*nuSum[4]+4.58257569495584*jacob_vel_inv2[1]*v2[3]*nuSum[4]+2.645751311064591*jacob_vel_inv2[0]*v2[3]*nuSum[4]+5.0*jacob_vel_inv2[2]*v2[2]*nuSum[4]+3.872983346207417*jacob_vel_inv2[1]*v2[2]*nuSum[4]+2.23606797749979*jacob_vel_inv2[0]*v2[2]*nuSum[4]+3.872983346207417*v2[1]*jacob_vel_inv2[2]*nuSum[4]+2.23606797749979*v2[0]*jacob_vel_inv2[2]*nuSum[4]+3.0*jacob_vel_inv2[1]*v2[1]*nuSum[4]+1.732050807568877*jacob_vel_inv2[0]*v2[1]*nuSum[4]+1.732050807568877*v2[0]*jacob_vel_inv2[1]*nuSum[4]+jacob_vel_inv2[0]*v2[0]*nuSum[4]; 
  alphaDrSurf_r[12] = (-3.16227766016838*jacob_vel_inv2[2]*sumNuUz[5])-2.449489742783178*jacob_vel_inv2[1]*sumNuUz[5]-1.414213562373095*jacob_vel_inv2[0]*sumNuUz[5]+5.916079783099617*jacob_vel_inv2[2]*v2[3]*nuSum[5]+4.58257569495584*jacob_vel_inv2[1]*v2[3]*nuSum[5]+2.645751311064591*jacob_vel_inv2[0]*v2[3]*nuSum[5]+5.0*jacob_vel_inv2[2]*v2[2]*nuSum[5]+3.872983346207417*jacob_vel_inv2[1]*v2[2]*nuSum[5]+2.23606797749979*jacob_vel_inv2[0]*v2[2]*nuSum[5]+3.872983346207417*v2[1]*jacob_vel_inv2[2]*nuSum[5]+2.23606797749979*v2[0]*jacob_vel_inv2[2]*nuSum[5]+3.0*jacob_vel_inv2[1]*v2[1]*nuSum[5]+1.732050807568877*jacob_vel_inv2[0]*v2[1]*nuSum[5]+1.732050807568877*v2[0]*jacob_vel_inv2[1]*nuSum[5]+jacob_vel_inv2[0]*v2[0]*nuSum[5]; 
  alphaDrSurf_r[19] = (-3.16227766016838*jacob_vel_inv2[2]*sumNuUz[6])-2.449489742783178*jacob_vel_inv2[1]*sumNuUz[6]-1.414213562373095*jacob_vel_inv2[0]*sumNuUz[6]+5.916079783099617*jacob_vel_inv2[2]*v2[3]*nuSum[6]+4.58257569495584*jacob_vel_inv2[1]*v2[3]*nuSum[6]+2.645751311064591*jacob_vel_inv2[0]*v2[3]*nuSum[6]+5.0*jacob_vel_inv2[2]*v2[2]*nuSum[6]+3.872983346207417*jacob_vel_inv2[1]*v2[2]*nuSum[6]+2.23606797749979*jacob_vel_inv2[0]*v2[2]*nuSum[6]+3.872983346207417*v2[1]*jacob_vel_inv2[2]*nuSum[6]+2.23606797749979*v2[0]*jacob_vel_inv2[2]*nuSum[6]+3.0*jacob_vel_inv2[1]*v2[1]*nuSum[6]+1.732050807568877*jacob_vel_inv2[0]*v2[1]*nuSum[6]+1.732050807568877*v2[0]*jacob_vel_inv2[1]*nuSum[6]+jacob_vel_inv2[0]*v2[0]*nuSum[6]; 
  alphaDrSurf_r[20] = (-3.16227766016838*jacob_vel_inv2[2]*sumNuUz[7])-2.449489742783178*jacob_vel_inv2[1]*sumNuUz[7]-1.414213562373095*jacob_vel_inv2[0]*sumNuUz[7]+5.916079783099617*jacob_vel_inv2[2]*v2[3]*nuSum[7]+4.58257569495584*jacob_vel_inv2[1]*v2[3]*nuSum[7]+2.645751311064591*jacob_vel_inv2[0]*v2[3]*nuSum[7]+5.0*jacob_vel_inv2[2]*v2[2]*nuSum[7]+3.872983346207417*jacob_vel_inv2[1]*v2[2]*nuSum[7]+2.23606797749979*jacob_vel_inv2[0]*v2[2]*nuSum[7]+3.872983346207417*v2[1]*jacob_vel_inv2[2]*nuSum[7]+2.23606797749979*v2[0]*jacob_vel_inv2[2]*nuSum[7]+3.0*jacob_vel_inv2[1]*v2[1]*nuSum[7]+1.732050807568877*jacob_vel_inv2[0]*v2[1]*nuSum[7]+1.732050807568877*v2[0]*jacob_vel_inv2[1]*nuSum[7]+jacob_vel_inv2[0]*v2[0]*nuSum[7]; 
