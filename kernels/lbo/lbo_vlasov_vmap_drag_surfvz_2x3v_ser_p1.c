...
GKYL_CU_DH double lbo_vlasov_vmap_drag_surfvz_2x3v_ser_p1(const double *w, const double *dxv, const double *vmap, const double *jacob_vel_inv, const double *nuSum, const double *nuPrimMomsSum, const double *fl, const double *fc, const double *fr, double* GKYL_RESTRICT out) 
{ 
  ...
  const double *sumNuUz = &nuPrimMomsSum[8]; 

  double alphaDrSurf_l[32] = {0.0}; 
  alphaDrSurf_l[0] = (-5.916079783099617*nuSum[0]*jacob_vel_inv2[2]*v2[3])+4.58257569495584*nuSum[0]*jacob_vel_inv2[1]*v2[3]-2.645751311064591*jacob_vel_inv2[0]*nuSum[0]*v2[3]+5.0*nuSum[0]*jacob_vel_inv2[2]*v2[2]-3.872983346207417*nuSum[0]*jacob_vel_inv2[1]*v2[2]+2.23606797749979*jacob_vel_inv2[0]*nuSum[0]*v2[2]-3.872983346207417*nuSum[0]*v2[1]*jacob_vel_inv2[2]+2.23606797749979*nuSum[0]*v2[0]*jacob_vel_inv2[2]-3.16227766016838*sumNuUz[0]*jacob_vel_inv2[2]+3.0*nuSum[0]*jacob_vel_inv2[1]*v2[1]-1.732050807568877*jacob_vel_inv2[0]*nuSum[0]*v2[1]-1.732050807568877*nuSum[0]*v2[0]*jacob_vel_inv2[1]+2.449489742783178*sumNuUz[0]*jacob_vel_inv2[1]+jacob_vel_inv2[0]*nuSum[0]*v2[0]-1.414213562373095*jacob_vel_inv2[0]*sumNuUz[0]; 
  alphaDrSurf_l[1] = (-5.916079783099617*nuSum[1]*jacob_vel_inv2[2]*v2[3])+4.58257569495584*jacob_vel_inv2[1]*nuSum[1]*v2[3]-2.645751311064591*jacob_vel_inv2[0]*nuSum[1]*v2[3]+5.0*nuSum[1]*jacob_vel_inv2[2]*v2[2]-3.872983346207417*jacob_vel_inv2[1]*nuSum[1]*v2[2]+2.23606797749979*jacob_vel_inv2[0]*nuSum[1]*v2[2]-3.872983346207417*nuSum[1]*v2[1]*jacob_vel_inv2[2]-3.16227766016838*sumNuUz[1]*jacob_vel_inv2[2]+2.23606797749979*v2[0]*nuSum[1]*jacob_vel_inv2[2]+3.0*jacob_vel_inv2[1]*nuSum[1]*v2[1]-1.732050807568877*jacob_vel_inv2[0]*nuSum[1]*v2[1]+2.449489742783178*jacob_vel_inv2[1]*sumNuUz[1]-1.414213562373095*jacob_vel_inv2[0]*sumNuUz[1]-1.732050807568877*v2[0]*jacob_vel_inv2[1]*nuSum[1]+jacob_vel_inv2[0]*v2[0]*nuSum[1]; 
  alphaDrSurf_l[2] = (-5.916079783099617*jacob_vel_inv2[2]*nuSum[2]*v2[3])+4.58257569495584*jacob_vel_inv2[1]*nuSum[2]*v2[3]-2.645751311064591*jacob_vel_inv2[0]*nuSum[2]*v2[3]+5.0*jacob_vel_inv2[2]*nuSum[2]*v2[2]-3.872983346207417*jacob_vel_inv2[1]*nuSum[2]*v2[2]+2.23606797749979*jacob_vel_inv2[0]*nuSum[2]*v2[2]-3.16227766016838*jacob_vel_inv2[2]*sumNuUz[2]+2.449489742783178*jacob_vel_inv2[1]*sumNuUz[2]-1.414213562373095*jacob_vel_inv2[0]*sumNuUz[2]-3.872983346207417*v2[1]*jacob_vel_inv2[2]*nuSum[2]+2.23606797749979*v2[0]*jacob_vel_inv2[2]*nuSum[2]+3.0*jacob_vel_inv2[1]*v2[1]*nuSum[2]-1.732050807568877*jacob_vel_inv2[0]*v2[1]*nuSum[2]-1.732050807568877*v2[0]*jacob_vel_inv2[1]*nuSum[2]+jacob_vel_inv2[0]*v2[0]*nuSum[2]; 
  alphaDrSurf_l[5] = (-5.916079783099617*jacob_vel_inv2[2]*nuSum[3]*v2[3])+4.58257569495584*jacob_vel_inv2[1]*nuSum[3]*v2[3]-2.645751311064591*jacob_vel_inv2[0]*nuSum[3]*v2[3]-3.16227766016838*jacob_vel_inv2[2]*sumNuUz[3]+2.449489742783178*jacob_vel_inv2[1]*sumNuUz[3]-1.414213562373095*jacob_vel_inv2[0]*sumNuUz[3]+5.0*jacob_vel_inv2[2]*v2[2]*nuSum[3]-3.872983346207417*jacob_vel_inv2[1]*v2[2]*nuSum[3]+2.23606797749979*jacob_vel_inv2[0]*v2[2]*nuSum[3]-3.872983346207417*v2[1]*jacob_vel_inv2[2]*nuSum[3]+2.23606797749979*v2[0]*jacob_vel_inv2[2]*nuSum[3]+3.0*jacob_vel_inv2[1]*v2[1]*nuSum[3]-1.732050807568877*jacob_vel_inv2[0]*v2[1]*nuSum[3]-1.732050807568877*v2[0]*jacob_vel_inv2[1]*nuSum[3]+jacob_vel_inv2[0]*v2[0]*nuSum[3]; 

  double alphaDrSurf_r[32] = {0.0}; 
  alphaDrSurf_r[0] = 5.916079783099617*nuSum[0]*jacob_vel_inv2[2]*v2[3]+4.58257569495584*nuSum[0]*jacob_vel_inv2[1]*v2[3]+2.645751311064591*jacob_vel_inv2[0]*nuSum[0]*v2[3]+5.0*nuSum[0]*jacob_vel_inv2[2]*v2[2]+3.872983346207417*nuSum[0]*jacob_vel_inv2[1]*v2[2]+2.23606797749979*jacob_vel_inv2[0]*nuSum[0]*v2[2]+3.872983346207417*nuSum[0]*v2[1]*jacob_vel_inv2[2]+2.23606797749979*nuSum[0]*v2[0]*jacob_vel_inv2[2]-3.16227766016838*sumNuUz[0]*jacob_vel_inv2[2]+3.0*nuSum[0]*jacob_vel_inv2[1]*v2[1]+1.732050807568877*jacob_vel_inv2[0]*nuSum[0]*v2[1]+1.732050807568877*nuSum[0]*v2[0]*jacob_vel_inv2[1]-2.449489742783178*sumNuUz[0]*jacob_vel_inv2[1]+jacob_vel_inv2[0]*nuSum[0]*v2[0]-1.414213562373095*jacob_vel_inv2[0]*sumNuUz[0]; 
  alphaDrSurf_r[1] = 5.916079783099617*nuSum[1]*jacob_vel_inv2[2]*v2[3]+4.58257569495584*jacob_vel_inv2[1]*nuSum[1]*v2[3]+2.645751311064591*jacob_vel_inv2[0]*nuSum[1]*v2[3]+5.0*nuSum[1]*jacob_vel_inv2[2]*v2[2]+3.872983346207417*jacob_vel_inv2[1]*nuSum[1]*v2[2]+2.23606797749979*jacob_vel_inv2[0]*nuSum[1]*v2[2]+3.872983346207417*nuSum[1]*v2[1]*jacob_vel_inv2[2]-3.16227766016838*sumNuUz[1]*jacob_vel_inv2[2]+2.23606797749979*v2[0]*nuSum[1]*jacob_vel_inv2[2]+3.0*jacob_vel_inv2[1]*nuSum[1]*v2[1]+1.732050807568877*jacob_vel_inv2[0]*nuSum[1]*v2[1]-2.449489742783178*jacob_vel_inv2[1]*sumNuUz[1]-1.414213562373095*jacob_vel_inv2[0]*sumNuUz[1]+1.732050807568877*v2[0]*jacob_vel_inv2[1]*nuSum[1]+jacob_vel_inv2[0]*v2[0]*nuSum[1]; 
  alphaDrSurf_r[2] = 5.916079783099617*jacob_vel_inv2[2]*nuSum[2]*v2[3]+4.58257569495584*jacob_vel_inv2[1]*nuSum[2]*v2[3]+2.645751311064591*jacob_vel_inv2[0]*nuSum[2]*v2[3]+5.0*jacob_vel_inv2[2]*nuSum[2]*v2[2]+3.872983346207417*jacob_vel_inv2[1]*nuSum[2]*v2[2]+2.23606797749979*jacob_vel_inv2[0]*nuSum[2]*v2[2]-3.16227766016838*jacob_vel_inv2[2]*sumNuUz[2]-2.449489742783178*jacob_vel_inv2[1]*sumNuUz[2]-1.414213562373095*jacob_vel_inv2[0]*sumNuUz[2]+3.872983346207417*v2[1]*jacob_vel_inv2[2]*nuSum[2]+2.23606797749979*v2[0]*jacob_vel_inv2[2]*nuSum[2]+3.0*jacob_vel_inv2[1]*v2[1]*nuSum[2]+1.732050807568877*jacob_vel_inv2[0]*v2[1]*nuSum[2]+1.732050807568877*v2[0]*jacob_vel_inv2[1]*nuSum[2]+jacob_vel_inv2[0]*v2[0]*nuSum[2]; 
  alphaDrSurf_r[5] = 5.916079783099617*jacob_vel_inv2[2]*nuSum[3]*v2[3]+4.58257569495584*jacob_vel_inv2[1]*nuSum[3]*v2[3]+2.645751311064591*jacob_vel_inv2[0]*nuSum[3]*v2[3]-3.16227766016838*jacob_vel_inv2[2]*sumNuUz[3]-2.449489742783178*jacob_vel_inv2[1]*sumNuUz[3]-1.414213562373095*jacob_vel_inv2[0]*sumNuUz[3]+5.0*jacob_vel_inv2[2]*v2[2]*nuSum[3]+3.872983346207417*jacob_vel_inv2[1]*v2[2]*nuSum[3]+2.23606797749979*jacob_vel_inv2[0]*v2[2]*nuSum[3]+3.872983346207417*v2[1]*jacob_vel_inv2[2]*nuSum[3]+2.23606797749979*v2[0]*jacob_vel_inv2[2]*nuSum[3]+3.0*jacob_vel_inv2[1]*v2[1]*nuSum[3]+1.732050807568877*jacob_vel_inv2[0]*v2[1]*nuSum[3]+1.732050807568877*v2[0]*jacob_vel_inv2[1]*nuSum[3]+jacob_vel_inv2[0]*v2[0]*nuSum[3]; 
  ...
  out[32] += 0.7071067811865475*Ghat_r[16]*rdv2-0.7071067811865475*Ghat_l[16]*rdv2; 
  out[33] += 0.7071067811865475*Ghat_r[17]*rdv2-0.7071067811865475*Ghat_l[17]*rdv2; 
  out[34] += 0.7071067811865475*Ghat_r[18]*rdv2-0.7071067811865475*Ghat_l[18]*rdv2; 
  out[35] += 0.7071067811865475*Ghat_r[19]*rdv2-0.7071067811865475*Ghat_l[19]*rdv2; 
  out[36] += 1.224744871391589*Ghat_r[16]*rdv2+1.224744871391589*Ghat_l[16]*rdv2; 
  out[37] += 0.7071067811865475*Ghat_r[20]*rdv2-0.7071067811865475*Ghat_l[20]*rdv2; 
  out[38] += 0.7071067811865475*Ghat_r[21]*rdv2-0.7071067811865475*Ghat_l[21]*rdv2; 
  out[39] += 0.7071067811865475*Ghat_r[22]*rdv2-0.7071067811865475*Ghat_l[22]*rdv2; 
  out[40] += 1.224744871391589*Ghat_r[17]*rdv2+1.224744871391589*Ghat_l[17]*rdv2; 
  out[41] += 1.224744871391589*Ghat_r[18]*rdv2+1.224744871391589*Ghat_l[18]*rdv2; 
  out[42] += 1.224744871391589*Ghat_r[19]*rdv2+1.224744871391589*Ghat_l[19]*rdv2; 
  out[43] += 0.7071067811865475*Ghat_r[23]*rdv2-0.7071067811865475*Ghat_l[23]*rdv2; 
  out[44] += 1.224744871391589*Ghat_r[20]*rdv2+1.224744871391589*Ghat_l[20]*rdv2; 
  out[45] += 1.224744871391589*Ghat_r[21]*rdv2+1.224744871391589*Ghat_l[21]*rdv2; 
  out[46] += 1.224744871391589*Ghat_r[22]*rdv2+1.224744871391589*Ghat_l[22]*rdv2; 
  out[47] += 1.224744871391589*Ghat_r[23]*rdv2+1.224744871391589*Ghat_l[23]*rdv2; 
  out[48] += 0.7071067811865475*Ghat_r[24]*rdv2-0.7071067811865475*Ghat_l[24]*rdv2; 
  out[49] += 0.7071067811865475*Ghat_r[25]*rdv2-0.7071067811865475*Ghat_l[25]*rdv2; 
  out[50] += 0.7071067811865475*Ghat_r[26]*rdv2-0.7071067811865475*Ghat_l[26]*rdv2; 
  out[51] += 0.7071067811865475*Ghat_r[27]*rdv2-0.7071067811865475*Ghat_l[27]*rdv2; 
  out[52] += 1.224744871391589*Ghat_r[24]*rdv2+1.224744871391589*Ghat_l[24]*rdv2; 
  out[53] += 0.7071067811865475*Ghat_r[28]*rdv2-0.7071067811865475*Ghat_l[28]*rdv2; 
  out[54] += 0.7071067811865475*Ghat_r[29]*rdv2-0.7071067811865475*Ghat_l[29]*rdv2; 
  out[55] += 0.7071067811865475*Ghat_r[30]*rdv2-0.7071067811865475*Ghat_l[30]*rdv2; 
