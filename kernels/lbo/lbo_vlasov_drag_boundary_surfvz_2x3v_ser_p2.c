...
GKYL_CU_DH void lbo_vlasov_drag_boundary_surfvz_2x3v_ser_p2(const double *w, const double *dxv, const double *nuSum, const double *nuUSum, const double *nuVtSqSum, const int edge, const double *fSkin, const double *fEdge, double* GKYL_RESTRICT out) 
{ 
  ...
  out[20] += 1.58113883008419*drag_incr[0]*rdv2; 
  ...
  out[25] += 1.224744871391589*drag_incr[5]*rdv2; 
  ...
  out[38] += 0.7071067811865475*drag_incr[26]*rdv2; 
  out[39] += 0.7071067811865475*drag_incr[27]*rdv2; 
  out[40] += 0.7071067811865475*drag_incr[28]*rdv2; 
  out[41] += 0.7071067811865475*drag_incr[29]*rdv2; 
  out[42] += 0.7071067811865475*drag_incr[30]*rdv2; 
  out[43] += 1.224744871391589*drag_incr[11]*rdv2; 
  out[44] += 1.224744871391589*drag_incr[12]*rdv2; 
  out[45] += 1.224744871391589*drag_incr[13]*rdv2; 
  out[46] += 1.224744871391589*drag_incr[14]*rdv2; 
  out[47] += 1.58113883008419*drag_incr[1]*rdv2; 
  out[48] += 1.58113883008419*drag_incr[2]*rdv2; 
  out[49] += 1.58113883008419*drag_incr[3]*rdv2; 
  out[50] += 1.58113883008419*drag_incr[4]*rdv2; 
  out[51] += 0.7071067811865475*drag_incr[31]*rdv2; 
  out[52] += 1.224744871391589*drag_incr[15]*rdv2; 
  ...
  out[59] += 0.7071067811865475*drag_incr[35]*rdv2; 
  out[60] += 0.7071067811865475*drag_incr[36]*rdv2; 
  out[61] += 0.7071067811865475*drag_incr[37]*rdv2; 
  out[62] += 0.7071067811865475*drag_incr[38]*rdv2; 
  out[63] += 0.7071067811865475*drag_incr[39]*rdv2; 
  out[64] += 0.7071067811865475*drag_incr[40]*rdv2; 
  out[65] += 0.7071067811865475*drag_incr[41]*rdv2; 
  out[66] += 0.7071067811865475*drag_incr[42]*rdv2; 
  out[67] += 0.7071067811865475*drag_incr[43]*rdv2; 
  out[68] += 1.224744871391589*drag_incr[19]*rdv2; 
  out[69] += 1.224744871391589*drag_incr[20]*rdv2; 
  out[70] += 1.224744871391589*drag_incr[21]*rdv2; 
  out[71] += 1.224744871391589*drag_incr[22]*rdv2; 
  out[72] += 1.224744871391589*drag_incr[23]*rdv2; 
  out[73] += 1.224744871391589*drag_incr[24]*rdv2; 
  ...
  out[77] += 1.224744871391589*drag_incr[28]*rdv2; 
  out[78] += 1.224744871391589*drag_incr[29]*rdv2; 
  out[79] += 1.224744871391589*drag_incr[30]*rdv2; 
  out[80] += 1.58113883008419*drag_incr[5]*rdv2; 
  out[81] += 1.58113883008419*drag_incr[6]*rdv2; 
  out[82] += 1.58113883008419*drag_incr[7]*rdv2; 
  out[83] += 1.58113883008419*drag_incr[8]*rdv2; 
  out[84] += 1.58113883008419*drag_incr[9]*rdv2; 
  out[85] += 1.58113883008419*drag_incr[10]*rdv2; 
  out[86] += 1.224744871391589*drag_incr[31]*rdv2; 
  out[87] += 0.7071067811865475*drag_incr[44]*rdv2; 
  out[88] += 0.7071067811865475*drag_incr[45]*rdv2; 
  out[89] += 0.7071067811865475*drag_incr[46]*rdv2; 
  out[90] += 0.7071067811865475*drag_incr[47]*rdv2; 
  out[91] += 1.224744871391589*drag_incr[32]*rdv2; 
  out[92] += 1.224744871391589*drag_incr[33]*rdv2; 
  out[93] += 1.224744871391589*drag_incr[34]*rdv2; 
  ...
  out[100] += 1.224744871391589*drag_incr[41]*rdv2; 
  out[101] += 1.224744871391589*drag_incr[42]*rdv2; 
  out[102] += 1.224744871391589*drag_incr[43]*rdv2; 
  out[103] += 1.58113883008419*drag_incr[15]*rdv2; 
  out[104] += 1.58113883008419*drag_incr[16]*rdv2; 
  out[105] += 1.58113883008419*drag_incr[17]*rdv2; 
  out[106] += 1.58113883008419*drag_incr[18]*rdv2; 
  ...
  out[110] += 1.224744871391589*drag_incr[47]*rdv2; 
  out[111] += 1.58113883008419*drag_incr[31]*rdv2; 
