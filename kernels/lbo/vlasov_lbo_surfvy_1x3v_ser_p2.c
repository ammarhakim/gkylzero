...
{ 
  ...
  Gdiff2_l[0] = 0.2445699350390395*nuVtSqSum[1]*fl[23]+0.2445699350390395*nuVtSqSum[1]*fc[23]+0.3518228202874282*nuVtSqSum[2]*fl[21]-0.3518228202874282*nuVtSqSum[2]*fc[21]+0.2445699350390395*nuVtSqSum[0]*fl[13]+0.2445699350390395*nuVtSqSum[0]*fc[13]+0.25*nuVtSqSum[2]*fl[11]+0.25*nuVtSqSum[2]*fc[11]+0.3518228202874282*nuVtSqSum[1]*fl[6]-0.3518228202874282*nuVtSqSum[1]*fc[6]+0.3518228202874282*nuVtSqSum[0]*fl[3]-0.3518228202874282*nuVtSqSum[0]*fc[3]+0.25*fl[1]*nuVtSqSum[1]+0.25*fc[1]*nuVtSqSum[1]+0.25*fl[0]*nuVtSqSum[0]+0.25*fc[0]*nuVtSqSum[0]; 
  Gdiff2_l[1] = 0.21875*nuVtSqSum[2]*fl[23]+0.2445699350390395*nuVtSqSum[0]*fl[23]+0.21875*nuVtSqSum[2]*fc[23]+0.2445699350390395*nuVtSqSum[0]*fc[23]+0.3146798968793526*nuVtSqSum[1]*fl[21]-0.3146798968793526*nuVtSqSum[1]*fc[21]+0.2445699350390395*nuVtSqSum[1]*fl[13]+0.2445699350390395*nuVtSqSum[1]*fc[13]+0.223606797749979*nuVtSqSum[1]*fl[11]+0.223606797749979*nuVtSqSum[1]*fc[11]+0.3146798968793526*nuVtSqSum[2]*fl[6]+0.3518228202874282*nuVtSqSum[0]*fl[6]-0.3146798968793526*nuVtSqSum[2]*fc[6]-0.3518228202874282*nuVtSqSum[0]*fc[6]+0.3518228202874282*nuVtSqSum[1]*fl[3]-0.3518228202874282*nuVtSqSum[1]*fc[3]+0.223606797749979*fl[1]*nuVtSqSum[2]+0.223606797749979*fc[1]*nuVtSqSum[2]+0.25*fl[0]*nuVtSqSum[1]+0.25*fc[0]*nuVtSqSum[1]+0.25*nuVtSqSum[0]*fl[1]+0.25*nuVtSqSum[0]*fc[1]; 
  Gdiff2_l[2] = 0.2445699350390395*nuVtSqSum[1]*fl[34]+0.2445699350390395*nuVtSqSum[1]*fc[34]+0.3518228202874282*nuVtSqSum[2]*fl[32]-0.3518228202874282*nuVtSqSum[2]*fc[32]+0.2445699350390395*nuVtSqSum[0]*fl[24]+0.2445699350390395*nuVtSqSum[0]*fc[24]+0.25*nuVtSqSum[2]*fl[19]+0.25*nuVtSqSum[2]*fc[19]+0.3518228202874282*nuVtSqSum[1]*fl[15]-0.3518228202874282*nuVtSqSum[1]*fc[15]+0.3518228202874282*nuVtSqSum[0]*fl[7]-0.3518228202874282*nuVtSqSum[0]*fc[7]+0.25*nuVtSqSum[1]*fl[5]+0.25*nuVtSqSum[1]*fc[5]+0.25*nuVtSqSum[0]*fl[2]+0.25*nuVtSqSum[0]*fc[2]; 
  Gdiff2_l[3] = 0.2445699350390395*nuVtSqSum[1]*fl[39]+0.2445699350390395*nuVtSqSum[1]*fc[39]+0.3518228202874282*nuVtSqSum[2]*fl[37]-0.3518228202874282*nuVtSqSum[2]*fc[37]+0.2445699350390395*nuVtSqSum[0]*fl[27]+0.2445699350390395*nuVtSqSum[0]*fc[27]+0.25*nuVtSqSum[2]*fl[25]+0.25*nuVtSqSum[2]*fc[25]+0.3518228202874282*nuVtSqSum[1]*fl[17]-0.3518228202874282*nuVtSqSum[1]*fc[17]+0.3518228202874282*nuVtSqSum[0]*fl[10]-0.3518228202874282*nuVtSqSum[0]*fc[10]+0.25*nuVtSqSum[1]*fl[8]+0.25*nuVtSqSum[1]*fc[8]+0.25*nuVtSqSum[0]*fl[4]+0.25*nuVtSqSum[0]*fc[4]; 
  Gdiff2_l[4] = 0.21875*nuVtSqSum[2]*fl[34]+0.2445699350390395*nuVtSqSum[0]*fl[34]+0.21875*nuVtSqSum[2]*fc[34]+0.2445699350390395*nuVtSqSum[0]*fc[34]+0.3146798968793526*nuVtSqSum[1]*fl[32]-0.3146798968793526*nuVtSqSum[1]*fc[32]+0.2445699350390395*nuVtSqSum[1]*fl[24]+0.2445699350390395*nuVtSqSum[1]*fc[24]+0.223606797749979*nuVtSqSum[1]*fl[19]+0.223606797749979*nuVtSqSum[1]*fc[19]+0.3146798968793526*nuVtSqSum[2]*fl[15]+0.3518228202874282*nuVtSqSum[0]*fl[15]-0.3146798968793526*nuVtSqSum[2]*fc[15]-0.3518228202874282*nuVtSqSum[0]*fc[15]+0.3518228202874282*nuVtSqSum[1]*fl[7]-0.3518228202874282*nuVtSqSum[1]*fc[7]+0.223606797749979*nuVtSqSum[2]*fl[5]+0.25*nuVtSqSum[0]*fl[5]+0.223606797749979*nuVtSqSum[2]*fc[5]+0.25*nuVtSqSum[0]*fc[5]+0.25*nuVtSqSum[1]*fl[2]+0.25*nuVtSqSum[1]*fc[2]; 
  Gdiff2_l[5] = 0.21875*nuVtSqSum[2]*fl[39]+0.2445699350390395*nuVtSqSum[0]*fl[39]+0.21875*nuVtSqSum[2]*fc[39]+0.2445699350390395*nuVtSqSum[0]*fc[39]+0.3146798968793526*nuVtSqSum[1]*fl[37]-0.3146798968793526*nuVtSqSum[1]*fc[37]+0.2445699350390395*nuVtSqSum[1]*fl[27]+0.2445699350390395*nuVtSqSum[1]*fc[27]+0.223606797749979*nuVtSqSum[1]*fl[25]+0.223606797749979*nuVtSqSum[1]*fc[25]+0.3146798968793526*nuVtSqSum[2]*fl[17]+0.3518228202874282*nuVtSqSum[0]*fl[17]-0.3146798968793526*nuVtSqSum[2]*fc[17]-0.3518228202874282*nuVtSqSum[0]*fc[17]+0.3518228202874282*nuVtSqSum[1]*fl[10]-0.3518228202874282*nuVtSqSum[1]*fc[10]+0.223606797749979*nuVtSqSum[2]*fl[8]+0.25*nuVtSqSum[0]*fl[8]+0.223606797749979*nuVtSqSum[2]*fc[8]+0.25*nuVtSqSum[0]*fc[8]+0.25*nuVtSqSum[1]*fl[4]+0.25*nuVtSqSum[1]*fc[4]; 
  Gdiff2_l[6] = 0.2445699350390395*nuVtSqSum[1]*fl[46]+0.2445699350390395*nuVtSqSum[1]*fc[46]+0.3518228202874282*nuVtSqSum[2]*fl[44]-0.3518228202874282*nuVtSqSum[2]*fc[44]+0.2445699350390395*nuVtSqSum[0]*fl[40]+0.2445699350390395*nuVtSqSum[0]*fc[40]+0.25*nuVtSqSum[2]*fl[35]+0.25*nuVtSqSum[2]*fc[35]+0.3518228202874282*nuVtSqSum[1]*fl[31]-0.3518228202874282*nuVtSqSum[1]*fc[31]+0.3518228202874282*nuVtSqSum[0]*fl[18]-0.3518228202874282*nuVtSqSum[0]*fc[18]+0.25*nuVtSqSum[1]*fl[16]+0.25*nuVtSqSum[1]*fc[16]+0.25*nuVtSqSum[0]*fl[9]+0.25*nuVtSqSum[0]*fc[9]; 
  Gdiff2_l[7] = 0.21875*nuVtSqSum[1]*fl[23]+0.21875*nuVtSqSum[1]*fc[23]+0.2247713549138233*nuVtSqSum[2]*fl[21]+0.3518228202874282*nuVtSqSum[0]*fl[21]-0.2247713549138233*nuVtSqSum[2]*fc[21]-0.3518228202874282*nuVtSqSum[0]*fc[21]+0.2445699350390395*nuVtSqSum[2]*fl[13]+0.2445699350390395*nuVtSqSum[2]*fc[13]+0.159719141249985*nuVtSqSum[2]*fl[11]+0.25*nuVtSqSum[0]*fl[11]+0.159719141249985*nuVtSqSum[2]*fc[11]+0.25*nuVtSqSum[0]*fc[11]+0.3146798968793526*nuVtSqSum[1]*fl[6]-0.3146798968793526*nuVtSqSum[1]*fc[6]+0.3518228202874282*nuVtSqSum[2]*fl[3]-0.3518228202874282*nuVtSqSum[2]*fc[3]+0.25*fl[0]*nuVtSqSum[2]+0.25*fc[0]*nuVtSqSum[2]+0.223606797749979*fl[1]*nuVtSqSum[1]+0.223606797749979*fc[1]*nuVtSqSum[1]; 
  Gdiff2_l[8] = 0.3518228202874282*nuVtSqSum[1]*fl[33]-0.3518228202874282*nuVtSqSum[1]*fc[33]+0.3518228202874282*nuVtSqSum[0]*fl[22]-0.3518228202874282*nuVtSqSum[0]*fc[22]+0.25*nuVtSqSum[1]*fl[20]+0.25*nuVtSqSum[1]*fc[20]+0.25*nuVtSqSum[0]*fl[12]+0.25*nuVtSqSum[0]*fc[12]; 
  Gdiff2_l[9] = 0.3518228202874282*nuVtSqSum[1]*fl[42]-0.3518228202874282*nuVtSqSum[1]*fc[42]+0.3518228202874282*nuVtSqSum[0]*fl[30]-0.3518228202874282*nuVtSqSum[0]*fc[30]+0.25*nuVtSqSum[1]*fl[28]+0.25*nuVtSqSum[1]*fc[28]+0.25*nuVtSqSum[0]*fl[14]+0.25*nuVtSqSum[0]*fc[14]; 
  Gdiff2_l[10] = 0.21875*nuVtSqSum[2]*fl[46]+0.2445699350390395*nuVtSqSum[0]*fl[46]+0.21875*nuVtSqSum[2]*fc[46]+0.2445699350390395*nuVtSqSum[0]*fc[46]+0.3146798968793526*nuVtSqSum[1]*fl[44]-0.3146798968793526*nuVtSqSum[1]*fc[44]+0.2445699350390395*nuVtSqSum[1]*fl[40]+0.2445699350390395*nuVtSqSum[1]*fc[40]+0.223606797749979*nuVtSqSum[1]*fl[35]+0.223606797749979*nuVtSqSum[1]*fc[35]+0.3146798968793526*nuVtSqSum[2]*fl[31]+0.3518228202874282*nuVtSqSum[0]*fl[31]-0.3146798968793526*nuVtSqSum[2]*fc[31]-0.3518228202874282*nuVtSqSum[0]*fc[31]+0.3518228202874282*nuVtSqSum[1]*fl[18]-0.3518228202874282*nuVtSqSum[1]*fc[18]+0.223606797749979*nuVtSqSum[2]*fl[16]+0.25*nuVtSqSum[0]*fl[16]+0.223606797749979*nuVtSqSum[2]*fc[16]+0.25*nuVtSqSum[0]*fc[16]+0.25*nuVtSqSum[1]*fl[9]+0.25*nuVtSqSum[1]*fc[9]; 
  Gdiff2_l[11] = 0.21875*nuVtSqSum[1]*fl[34]+0.21875*nuVtSqSum[1]*fc[34]+0.2247713549138233*nuVtSqSum[2]*fl[32]+0.3518228202874282*nuVtSqSum[0]*fl[32]-0.2247713549138233*nuVtSqSum[2]*fc[32]-0.3518228202874282*nuVtSqSum[0]*fc[32]+0.2445699350390395*nuVtSqSum[2]*fl[24]+0.2445699350390395*nuVtSqSum[2]*fc[24]+0.159719141249985*nuVtSqSum[2]*fl[19]+0.25*nuVtSqSum[0]*fl[19]+0.159719141249985*nuVtSqSum[2]*fc[19]+0.25*nuVtSqSum[0]*fc[19]+0.3146798968793526*nuVtSqSum[1]*fl[15]-0.3146798968793526*nuVtSqSum[1]*fc[15]+0.3518228202874282*nuVtSqSum[2]*fl[7]-0.3518228202874282*nuVtSqSum[2]*fc[7]+0.223606797749979*nuVtSqSum[1]*fl[5]+0.223606797749979*nuVtSqSum[1]*fc[5]+0.25*fl[2]*nuVtSqSum[2]+0.25*fc[2]*nuVtSqSum[2]; 
  Gdiff2_l[12] = 0.3146798968793526*nuVtSqSum[2]*fl[33]+0.3518228202874282*nuVtSqSum[0]*fl[33]-0.3146798968793526*nuVtSqSum[2]*fc[33]-0.3518228202874282*nuVtSqSum[0]*fc[33]+0.3518228202874282*nuVtSqSum[1]*fl[22]-0.3518228202874282*nuVtSqSum[1]*fc[22]+0.223606797749979*nuVtSqSum[2]*fl[20]+0.25*nuVtSqSum[0]*fl[20]+0.223606797749979*nuVtSqSum[2]*fc[20]+0.25*nuVtSqSum[0]*fc[20]+0.25*nuVtSqSum[1]*fl[12]+0.25*nuVtSqSum[1]*fc[12]; 
  Gdiff2_l[13] = 0.21875*nuVtSqSum[1]*fl[39]+0.21875*nuVtSqSum[1]*fc[39]+0.2247713549138233*nuVtSqSum[2]*fl[37]+0.3518228202874282*nuVtSqSum[0]*fl[37]-0.2247713549138233*nuVtSqSum[2]*fc[37]-0.3518228202874282*nuVtSqSum[0]*fc[37]+0.2445699350390395*nuVtSqSum[2]*fl[27]+0.2445699350390395*nuVtSqSum[2]*fc[27]+0.159719141249985*nuVtSqSum[2]*fl[25]+0.25*nuVtSqSum[0]*fl[25]+0.159719141249985*nuVtSqSum[2]*fc[25]+0.25*nuVtSqSum[0]*fc[25]+0.3146798968793526*nuVtSqSum[1]*fl[17]-0.3146798968793526*nuVtSqSum[1]*fc[17]+0.3518228202874282*nuVtSqSum[2]*fl[10]-0.3518228202874282*nuVtSqSum[2]*fc[10]+0.223606797749979*nuVtSqSum[1]*fl[8]+0.223606797749979*nuVtSqSum[1]*fc[8]+0.25*nuVtSqSum[2]*fl[4]+0.25*nuVtSqSum[2]*fc[4]; 
  Gdiff2_l[14] = 0.3518228202874282*nuVtSqSum[1]*fl[45]-0.3518228202874282*nuVtSqSum[1]*fc[45]+0.3518228202874282*nuVtSqSum[0]*fl[38]-0.3518228202874282*nuVtSqSum[0]*fc[38]+0.25*nuVtSqSum[1]*fl[36]+0.25*nuVtSqSum[1]*fc[36]+0.25*nuVtSqSum[0]*fl[26]+0.25*nuVtSqSum[0]*fc[26]; 
  Gdiff2_l[15] = 0.3146798968793526*nuVtSqSum[2]*fl[42]+0.3518228202874282*nuVtSqSum[0]*fl[42]-0.3146798968793526*nuVtSqSum[2]*fc[42]-0.3518228202874282*nuVtSqSum[0]*fc[42]+0.3518228202874282*nuVtSqSum[1]*fl[30]-0.3518228202874282*nuVtSqSum[1]*fc[30]+0.223606797749979*nuVtSqSum[2]*fl[28]+0.25*nuVtSqSum[0]*fl[28]+0.223606797749979*nuVtSqSum[2]*fc[28]+0.25*nuVtSqSum[0]*fc[28]+0.25*nuVtSqSum[1]*fl[14]+0.25*nuVtSqSum[1]*fc[14]; 
  Gdiff2_l[16] = 0.3518228202874282*nuVtSqSum[1]*fl[47]-0.3518228202874282*nuVtSqSum[1]*fc[47]+0.3518228202874282*nuVtSqSum[0]*fl[43]-0.3518228202874282*nuVtSqSum[0]*fc[43]+0.25*nuVtSqSum[1]*fl[41]+0.25*nuVtSqSum[1]*fc[41]+0.25*nuVtSqSum[0]*fl[29]+0.25*nuVtSqSum[0]*fc[29]; 
  Gdiff2_l[17] = 0.21875*nuVtSqSum[1]*fl[46]+0.21875*nuVtSqSum[1]*fc[46]+0.2247713549138233*nuVtSqSum[2]*fl[44]+0.3518228202874282*nuVtSqSum[0]*fl[44]-0.2247713549138233*nuVtSqSum[2]*fc[44]-0.3518228202874282*nuVtSqSum[0]*fc[44]+0.2445699350390395*nuVtSqSum[2]*fl[40]+0.2445699350390395*nuVtSqSum[2]*fc[40]+0.159719141249985*nuVtSqSum[2]*fl[35]+0.25*nuVtSqSum[0]*fl[35]+0.159719141249985*nuVtSqSum[2]*fc[35]+0.25*nuVtSqSum[0]*fc[35]+0.3146798968793526*nuVtSqSum[1]*fl[31]-0.3146798968793526*nuVtSqSum[1]*fc[31]+0.3518228202874282*nuVtSqSum[2]*fl[18]-0.3518228202874282*nuVtSqSum[2]*fc[18]+0.223606797749979*nuVtSqSum[1]*fl[16]+0.223606797749979*nuVtSqSum[1]*fc[16]+0.25*nuVtSqSum[2]*fl[9]+0.25*nuVtSqSum[2]*fc[9]; 
  Gdiff2_l[18] = 0.3146798968793526*nuVtSqSum[2]*fl[45]+0.3518228202874282*nuVtSqSum[0]*fl[45]-0.3146798968793526*nuVtSqSum[2]*fc[45]-0.3518228202874282*nuVtSqSum[0]*fc[45]+0.3518228202874282*nuVtSqSum[1]*fl[38]-0.3518228202874282*nuVtSqSum[1]*fc[38]+0.223606797749979*nuVtSqSum[2]*fl[36]+0.25*nuVtSqSum[0]*fl[36]+0.223606797749979*nuVtSqSum[2]*fc[36]+0.25*nuVtSqSum[0]*fc[36]+0.25*nuVtSqSum[1]*fl[26]+0.25*nuVtSqSum[1]*fc[26]; 
  Gdiff2_l[19] = 0.3146798968793526*nuVtSqSum[2]*fl[47]+0.3518228202874282*nuVtSqSum[0]*fl[47]-0.3146798968793526*nuVtSqSum[2]*fc[47]-0.3518228202874282*nuVtSqSum[0]*fc[47]+0.3518228202874282*nuVtSqSum[1]*fl[43]-0.3518228202874282*nuVtSqSum[1]*fc[43]+0.223606797749979*nuVtSqSum[2]*fl[41]+0.25*nuVtSqSum[0]*fl[41]+0.223606797749979*nuVtSqSum[2]*fc[41]+0.25*nuVtSqSum[0]*fc[41]+0.25*nuVtSqSum[1]*fl[29]+0.25*nuVtSqSum[1]*fc[29]; 

  Gdiff2_r[0] = 0.2445699350390395*nuVtSqSum[1]*fr[23]+0.2445699350390395*nuVtSqSum[1]*fc[23]-0.3518228202874282*nuVtSqSum[2]*fr[21]+0.3518228202874282*nuVtSqSum[2]*fc[21]+0.2445699350390395*nuVtSqSum[0]*fr[13]+0.2445699350390395*nuVtSqSum[0]*fc[13]+0.25*nuVtSqSum[2]*fr[11]+0.25*nuVtSqSum[2]*fc[11]-0.3518228202874282*nuVtSqSum[1]*fr[6]+0.3518228202874282*nuVtSqSum[1]*fc[6]-0.3518228202874282*nuVtSqSum[0]*fr[3]+0.3518228202874282*nuVtSqSum[0]*fc[3]+0.25*fr[1]*nuVtSqSum[1]+0.25*fc[1]*nuVtSqSum[1]+0.25*fr[0]*nuVtSqSum[0]+0.25*fc[0]*nuVtSqSum[0]; 
  Gdiff2_r[1] = 0.21875*nuVtSqSum[2]*fr[23]+0.2445699350390395*nuVtSqSum[0]*fr[23]+0.21875*nuVtSqSum[2]*fc[23]+0.2445699350390395*nuVtSqSum[0]*fc[23]-0.3146798968793526*nuVtSqSum[1]*fr[21]+0.3146798968793526*nuVtSqSum[1]*fc[21]+0.2445699350390395*nuVtSqSum[1]*fr[13]+0.2445699350390395*nuVtSqSum[1]*fc[13]+0.223606797749979*nuVtSqSum[1]*fr[11]+0.223606797749979*nuVtSqSum[1]*fc[11]-0.3146798968793526*nuVtSqSum[2]*fr[6]-0.3518228202874282*nuVtSqSum[0]*fr[6]+0.3146798968793526*nuVtSqSum[2]*fc[6]+0.3518228202874282*nuVtSqSum[0]*fc[6]-0.3518228202874282*nuVtSqSum[1]*fr[3]+0.3518228202874282*nuVtSqSum[1]*fc[3]+0.223606797749979*fr[1]*nuVtSqSum[2]+0.223606797749979*fc[1]*nuVtSqSum[2]+0.25*fr[0]*nuVtSqSum[1]+0.25*fc[0]*nuVtSqSum[1]+0.25*nuVtSqSum[0]*fr[1]+0.25*nuVtSqSum[0]*fc[1]; 
  Gdiff2_r[2] = 0.2445699350390395*nuVtSqSum[1]*fr[34]+0.2445699350390395*nuVtSqSum[1]*fc[34]-0.3518228202874282*nuVtSqSum[2]*fr[32]+0.3518228202874282*nuVtSqSum[2]*fc[32]+0.2445699350390395*nuVtSqSum[0]*fr[24]+0.2445699350390395*nuVtSqSum[0]*fc[24]+0.25*nuVtSqSum[2]*fr[19]+0.25*nuVtSqSum[2]*fc[19]-0.3518228202874282*nuVtSqSum[1]*fr[15]+0.3518228202874282*nuVtSqSum[1]*fc[15]-0.3518228202874282*nuVtSqSum[0]*fr[7]+0.3518228202874282*nuVtSqSum[0]*fc[7]+0.25*nuVtSqSum[1]*fr[5]+0.25*nuVtSqSum[1]*fc[5]+0.25*nuVtSqSum[0]*fr[2]+0.25*nuVtSqSum[0]*fc[2]; 
  Gdiff2_r[3] = 0.2445699350390395*nuVtSqSum[1]*fr[39]+0.2445699350390395*nuVtSqSum[1]*fc[39]-0.3518228202874282*nuVtSqSum[2]*fr[37]+0.3518228202874282*nuVtSqSum[2]*fc[37]+0.2445699350390395*nuVtSqSum[0]*fr[27]+0.2445699350390395*nuVtSqSum[0]*fc[27]+0.25*nuVtSqSum[2]*fr[25]+0.25*nuVtSqSum[2]*fc[25]-0.3518228202874282*nuVtSqSum[1]*fr[17]+0.3518228202874282*nuVtSqSum[1]*fc[17]-0.3518228202874282*nuVtSqSum[0]*fr[10]+0.3518228202874282*nuVtSqSum[0]*fc[10]+0.25*nuVtSqSum[1]*fr[8]+0.25*nuVtSqSum[1]*fc[8]+0.25*nuVtSqSum[0]*fr[4]+0.25*nuVtSqSum[0]*fc[4]; 
  Gdiff2_r[4] = 0.21875*nuVtSqSum[2]*fr[34]+0.2445699350390395*nuVtSqSum[0]*fr[34]+0.21875*nuVtSqSum[2]*fc[34]+0.2445699350390395*nuVtSqSum[0]*fc[34]-0.3146798968793526*nuVtSqSum[1]*fr[32]+0.3146798968793526*nuVtSqSum[1]*fc[32]+0.2445699350390395*nuVtSqSum[1]*fr[24]+0.2445699350390395*nuVtSqSum[1]*fc[24]+0.223606797749979*nuVtSqSum[1]*fr[19]+0.223606797749979*nuVtSqSum[1]*fc[19]-0.3146798968793526*nuVtSqSum[2]*fr[15]-0.3518228202874282*nuVtSqSum[0]*fr[15]+0.3146798968793526*nuVtSqSum[2]*fc[15]+0.3518228202874282*nuVtSqSum[0]*fc[15]-0.3518228202874282*nuVtSqSum[1]*fr[7]+0.3518228202874282*nuVtSqSum[1]*fc[7]+0.223606797749979*nuVtSqSum[2]*fr[5]+0.25*nuVtSqSum[0]*fr[5]+0.223606797749979*nuVtSqSum[2]*fc[5]+0.25*nuVtSqSum[0]*fc[5]+0.25*nuVtSqSum[1]*fr[2]+0.25*nuVtSqSum[1]*fc[2]; 
  Gdiff2_r[5] = 0.21875*nuVtSqSum[2]*fr[39]+0.2445699350390395*nuVtSqSum[0]*fr[39]+0.21875*nuVtSqSum[2]*fc[39]+0.2445699350390395*nuVtSqSum[0]*fc[39]-0.3146798968793526*nuVtSqSum[1]*fr[37]+0.3146798968793526*nuVtSqSum[1]*fc[37]+0.2445699350390395*nuVtSqSum[1]*fr[27]+0.2445699350390395*nuVtSqSum[1]*fc[27]+0.223606797749979*nuVtSqSum[1]*fr[25]+0.223606797749979*nuVtSqSum[1]*fc[25]-0.3146798968793526*nuVtSqSum[2]*fr[17]-0.3518228202874282*nuVtSqSum[0]*fr[17]+0.3146798968793526*nuVtSqSum[2]*fc[17]+0.3518228202874282*nuVtSqSum[0]*fc[17]-0.3518228202874282*nuVtSqSum[1]*fr[10]+0.3518228202874282*nuVtSqSum[1]*fc[10]+0.223606797749979*nuVtSqSum[2]*fr[8]+0.25*nuVtSqSum[0]*fr[8]+0.223606797749979*nuVtSqSum[2]*fc[8]+0.25*nuVtSqSum[0]*fc[8]+0.25*nuVtSqSum[1]*fr[4]+0.25*nuVtSqSum[1]*fc[4]; 
  Gdiff2_r[6] = 0.2445699350390395*nuVtSqSum[1]*fr[46]+0.2445699350390395*nuVtSqSum[1]*fc[46]-0.3518228202874282*nuVtSqSum[2]*fr[44]+0.3518228202874282*nuVtSqSum[2]*fc[44]+0.2445699350390395*nuVtSqSum[0]*fr[40]+0.2445699350390395*nuVtSqSum[0]*fc[40]+0.25*nuVtSqSum[2]*fr[35]+0.25*nuVtSqSum[2]*fc[35]-0.3518228202874282*nuVtSqSum[1]*fr[31]+0.3518228202874282*nuVtSqSum[1]*fc[31]-0.3518228202874282*nuVtSqSum[0]*fr[18]+0.3518228202874282*nuVtSqSum[0]*fc[18]+0.25*nuVtSqSum[1]*fr[16]+0.25*nuVtSqSum[1]*fc[16]+0.25*nuVtSqSum[0]*fr[9]+0.25*nuVtSqSum[0]*fc[9]; 
  Gdiff2_r[7] = 0.21875*nuVtSqSum[1]*fr[23]+0.21875*nuVtSqSum[1]*fc[23]-0.2247713549138233*nuVtSqSum[2]*fr[21]-0.3518228202874282*nuVtSqSum[0]*fr[21]+0.2247713549138233*nuVtSqSum[2]*fc[21]+0.3518228202874282*nuVtSqSum[0]*fc[21]+0.2445699350390395*nuVtSqSum[2]*fr[13]+0.2445699350390395*nuVtSqSum[2]*fc[13]+0.159719141249985*nuVtSqSum[2]*fr[11]+0.25*nuVtSqSum[0]*fr[11]+0.159719141249985*nuVtSqSum[2]*fc[11]+0.25*nuVtSqSum[0]*fc[11]-0.3146798968793526*nuVtSqSum[1]*fr[6]+0.3146798968793526*nuVtSqSum[1]*fc[6]-0.3518228202874282*nuVtSqSum[2]*fr[3]+0.3518228202874282*nuVtSqSum[2]*fc[3]+0.25*fr[0]*nuVtSqSum[2]+0.25*fc[0]*nuVtSqSum[2]+0.223606797749979*fr[1]*nuVtSqSum[1]+0.223606797749979*fc[1]*nuVtSqSum[1]; 
  Gdiff2_r[8] = (-0.3518228202874282*nuVtSqSum[1]*fr[33])+0.3518228202874282*nuVtSqSum[1]*fc[33]-0.3518228202874282*nuVtSqSum[0]*fr[22]+0.3518228202874282*nuVtSqSum[0]*fc[22]+0.25*nuVtSqSum[1]*fr[20]+0.25*nuVtSqSum[1]*fc[20]+0.25*nuVtSqSum[0]*fr[12]+0.25*nuVtSqSum[0]*fc[12]; 
  Gdiff2_r[9] = (-0.3518228202874282*nuVtSqSum[1]*fr[42])+0.3518228202874282*nuVtSqSum[1]*fc[42]-0.3518228202874282*nuVtSqSum[0]*fr[30]+0.3518228202874282*nuVtSqSum[0]*fc[30]+0.25*nuVtSqSum[1]*fr[28]+0.25*nuVtSqSum[1]*fc[28]+0.25*nuVtSqSum[0]*fr[14]+0.25*nuVtSqSum[0]*fc[14]; 
  Gdiff2_r[10] = 0.21875*nuVtSqSum[2]*fr[46]+0.2445699350390395*nuVtSqSum[0]*fr[46]+0.21875*nuVtSqSum[2]*fc[46]+0.2445699350390395*nuVtSqSum[0]*fc[46]-0.3146798968793526*nuVtSqSum[1]*fr[44]+0.3146798968793526*nuVtSqSum[1]*fc[44]+0.2445699350390395*nuVtSqSum[1]*fr[40]+0.2445699350390395*nuVtSqSum[1]*fc[40]+0.223606797749979*nuVtSqSum[1]*fr[35]+0.223606797749979*nuVtSqSum[1]*fc[35]-0.3146798968793526*nuVtSqSum[2]*fr[31]-0.3518228202874282*nuVtSqSum[0]*fr[31]+0.3146798968793526*nuVtSqSum[2]*fc[31]+0.3518228202874282*nuVtSqSum[0]*fc[31]-0.3518228202874282*nuVtSqSum[1]*fr[18]+0.3518228202874282*nuVtSqSum[1]*fc[18]+0.223606797749979*nuVtSqSum[2]*fr[16]+0.25*nuVtSqSum[0]*fr[16]+0.223606797749979*nuVtSqSum[2]*fc[16]+0.25*nuVtSqSum[0]*fc[16]+0.25*nuVtSqSum[1]*fr[9]+0.25*nuVtSqSum[1]*fc[9]; 
  Gdiff2_r[11] = 0.21875*nuVtSqSum[1]*fr[34]+0.21875*nuVtSqSum[1]*fc[34]-0.2247713549138233*nuVtSqSum[2]*fr[32]-0.3518228202874282*nuVtSqSum[0]*fr[32]+0.2247713549138233*nuVtSqSum[2]*fc[32]+0.3518228202874282*nuVtSqSum[0]*fc[32]+0.2445699350390395*nuVtSqSum[2]*fr[24]+0.2445699350390395*nuVtSqSum[2]*fc[24]+0.159719141249985*nuVtSqSum[2]*fr[19]+0.25*nuVtSqSum[0]*fr[19]+0.159719141249985*nuVtSqSum[2]*fc[19]+0.25*nuVtSqSum[0]*fc[19]-0.3146798968793526*nuVtSqSum[1]*fr[15]+0.3146798968793526*nuVtSqSum[1]*fc[15]-0.3518228202874282*nuVtSqSum[2]*fr[7]+0.3518228202874282*nuVtSqSum[2]*fc[7]+0.223606797749979*nuVtSqSum[1]*fr[5]+0.223606797749979*nuVtSqSum[1]*fc[5]+0.25*fr[2]*nuVtSqSum[2]+0.25*fc[2]*nuVtSqSum[2]; 
  Gdiff2_r[12] = (-0.3146798968793526*nuVtSqSum[2]*fr[33])-0.3518228202874282*nuVtSqSum[0]*fr[33]+0.3146798968793526*nuVtSqSum[2]*fc[33]+0.3518228202874282*nuVtSqSum[0]*fc[33]-0.3518228202874282*nuVtSqSum[1]*fr[22]+0.3518228202874282*nuVtSqSum[1]*fc[22]+0.223606797749979*nuVtSqSum[2]*fr[20]+0.25*nuVtSqSum[0]*fr[20]+0.223606797749979*nuVtSqSum[2]*fc[20]+0.25*nuVtSqSum[0]*fc[20]+0.25*nuVtSqSum[1]*fr[12]+0.25*nuVtSqSum[1]*fc[12]; 
  Gdiff2_r[13] = 0.21875*nuVtSqSum[1]*fr[39]+0.21875*nuVtSqSum[1]*fc[39]-0.2247713549138233*nuVtSqSum[2]*fr[37]-0.3518228202874282*nuVtSqSum[0]*fr[37]+0.2247713549138233*nuVtSqSum[2]*fc[37]+0.3518228202874282*nuVtSqSum[0]*fc[37]+0.2445699350390395*nuVtSqSum[2]*fr[27]+0.2445699350390395*nuVtSqSum[2]*fc[27]+0.159719141249985*nuVtSqSum[2]*fr[25]+0.25*nuVtSqSum[0]*fr[25]+0.159719141249985*nuVtSqSum[2]*fc[25]+0.25*nuVtSqSum[0]*fc[25]-0.3146798968793526*nuVtSqSum[1]*fr[17]+0.3146798968793526*nuVtSqSum[1]*fc[17]-0.3518228202874282*nuVtSqSum[2]*fr[10]+0.3518228202874282*nuVtSqSum[2]*fc[10]+0.223606797749979*nuVtSqSum[1]*fr[8]+0.223606797749979*nuVtSqSum[1]*fc[8]+0.25*nuVtSqSum[2]*fr[4]+0.25*nuVtSqSum[2]*fc[4]; 
  Gdiff2_r[14] = (-0.3518228202874282*nuVtSqSum[1]*fr[45])+0.3518228202874282*nuVtSqSum[1]*fc[45]-0.3518228202874282*nuVtSqSum[0]*fr[38]+0.3518228202874282*nuVtSqSum[0]*fc[38]+0.25*nuVtSqSum[1]*fr[36]+0.25*nuVtSqSum[1]*fc[36]+0.25*nuVtSqSum[0]*fr[26]+0.25*nuVtSqSum[0]*fc[26]; 
  Gdiff2_r[15] = (-0.3146798968793526*nuVtSqSum[2]*fr[42])-0.3518228202874282*nuVtSqSum[0]*fr[42]+0.3146798968793526*nuVtSqSum[2]*fc[42]+0.3518228202874282*nuVtSqSum[0]*fc[42]-0.3518228202874282*nuVtSqSum[1]*fr[30]+0.3518228202874282*nuVtSqSum[1]*fc[30]+0.223606797749979*nuVtSqSum[2]*fr[28]+0.25*nuVtSqSum[0]*fr[28]+0.223606797749979*nuVtSqSum[2]*fc[28]+0.25*nuVtSqSum[0]*fc[28]+0.25*nuVtSqSum[1]*fr[14]+0.25*nuVtSqSum[1]*fc[14]; 
  Gdiff2_r[16] = (-0.3518228202874282*nuVtSqSum[1]*fr[47])+0.3518228202874282*nuVtSqSum[1]*fc[47]-0.3518228202874282*nuVtSqSum[0]*fr[43]+0.3518228202874282*nuVtSqSum[0]*fc[43]+0.25*nuVtSqSum[1]*fr[41]+0.25*nuVtSqSum[1]*fc[41]+0.25*nuVtSqSum[0]*fr[29]+0.25*nuVtSqSum[0]*fc[29]; 
  Gdiff2_r[17] = 0.21875*nuVtSqSum[1]*fr[46]+0.21875*nuVtSqSum[1]*fc[46]-0.2247713549138233*nuVtSqSum[2]*fr[44]-0.3518228202874282*nuVtSqSum[0]*fr[44]+0.2247713549138233*nuVtSqSum[2]*fc[44]+0.3518228202874282*nuVtSqSum[0]*fc[44]+0.2445699350390395*nuVtSqSum[2]*fr[40]+0.2445699350390395*nuVtSqSum[2]*fc[40]+0.159719141249985*nuVtSqSum[2]*fr[35]+0.25*nuVtSqSum[0]*fr[35]+0.159719141249985*nuVtSqSum[2]*fc[35]+0.25*nuVtSqSum[0]*fc[35]-0.3146798968793526*nuVtSqSum[1]*fr[31]+0.3146798968793526*nuVtSqSum[1]*fc[31]-0.3518228202874282*nuVtSqSum[2]*fr[18]+0.3518228202874282*nuVtSqSum[2]*fc[18]+0.223606797749979*nuVtSqSum[1]*fr[16]+0.223606797749979*nuVtSqSum[1]*fc[16]+0.25*nuVtSqSum[2]*fr[9]+0.25*nuVtSqSum[2]*fc[9]; 
  Gdiff2_r[18] = (-0.3146798968793526*nuVtSqSum[2]*fr[45])-0.3518228202874282*nuVtSqSum[0]*fr[45]+0.3146798968793526*nuVtSqSum[2]*fc[45]+0.3518228202874282*nuVtSqSum[0]*fc[45]-0.3518228202874282*nuVtSqSum[1]*fr[38]+0.3518228202874282*nuVtSqSum[1]*fc[38]+0.223606797749979*nuVtSqSum[2]*fr[36]+0.25*nuVtSqSum[0]*fr[36]+0.223606797749979*nuVtSqSum[2]*fc[36]+0.25*nuVtSqSum[0]*fc[36]+0.25*nuVtSqSum[1]*fr[26]+0.25*nuVtSqSum[1]*fc[26]; 
  Gdiff2_r[19] = (-0.3146798968793526*nuVtSqSum[2]*fr[47])-0.3518228202874282*nuVtSqSum[0]*fr[47]+0.3146798968793526*nuVtSqSum[2]*fc[47]+0.3518228202874282*nuVtSqSum[0]*fc[47]-0.3518228202874282*nuVtSqSum[1]*fr[43]+0.3518228202874282*nuVtSqSum[1]*fc[43]+0.223606797749979*nuVtSqSum[2]*fr[41]+0.25*nuVtSqSum[0]*fr[41]+0.223606797749979*nuVtSqSum[2]*fc[41]+0.25*nuVtSqSum[0]*fc[41]+0.25*nuVtSqSum[1]*fr[29]+0.25*nuVtSqSum[1]*fc[29]; 

  Gdiff_l[0] = (-0.6708203932499369*nuVtSqSum[1]*fl[23])+0.6708203932499369*nuVtSqSum[1]*fc[23]-1.190784930203603*nuVtSqSum[2]*fl[21]-1.190784930203603*nuVtSqSum[2]*fc[21]-0.6708203932499369*nuVtSqSum[0]*fl[13]+0.6708203932499369*nuVtSqSum[0]*fc[13]-0.9375*nuVtSqSum[2]*fl[11]+0.9375*nuVtSqSum[2]*fc[11]-1.190784930203603*nuVtSqSum[1]*fl[6]-1.190784930203603*nuVtSqSum[1]*fc[6]-1.190784930203603*nuVtSqSum[0]*fl[3]-1.190784930203603*nuVtSqSum[0]*fc[3]-0.9375*fl[1]*nuVtSqSum[1]+0.9375*fc[1]*nuVtSqSum[1]-0.9375*fl[0]*nuVtSqSum[0]+0.9375*fc[0]*nuVtSqSum[0]; 
  Gdiff_l[1] = (-0.5999999999999999*nuVtSqSum[2]*fl[23])-0.6708203932499369*nuVtSqSum[0]*fl[23]+0.5999999999999999*nuVtSqSum[2]*fc[23]+0.6708203932499369*nuVtSqSum[0]*fc[23]-1.06507042020704*nuVtSqSum[1]*fl[21]-1.06507042020704*nuVtSqSum[1]*fc[21]-0.6708203932499369*nuVtSqSum[1]*fl[13]+0.6708203932499369*nuVtSqSum[1]*fc[13]-0.8385254915624212*nuVtSqSum[1]*fl[11]+0.8385254915624212*nuVtSqSum[1]*fc[11]-1.06507042020704*nuVtSqSum[2]*fl[6]-1.190784930203603*nuVtSqSum[0]*fl[6]-1.06507042020704*nuVtSqSum[2]*fc[6]-1.190784930203603*nuVtSqSum[0]*fc[6]-1.190784930203603*nuVtSqSum[1]*fl[3]-1.190784930203603*nuVtSqSum[1]*fc[3]-0.8385254915624212*fl[1]*nuVtSqSum[2]+0.8385254915624212*fc[1]*nuVtSqSum[2]-0.9375*fl[0]*nuVtSqSum[1]+0.9375*fc[0]*nuVtSqSum[1]-0.9375*nuVtSqSum[0]*fl[1]+0.9375*nuVtSqSum[0]*fc[1]; 
  Gdiff_l[2] = (-0.6708203932499369*nuVtSqSum[1]*fl[34])+0.6708203932499369*nuVtSqSum[1]*fc[34]-1.190784930203603*nuVtSqSum[2]*fl[32]-1.190784930203603*nuVtSqSum[2]*fc[32]-0.6708203932499369*nuVtSqSum[0]*fl[24]+0.6708203932499369*nuVtSqSum[0]*fc[24]-0.9375000000000001*nuVtSqSum[2]*fl[19]+0.9375000000000001*nuVtSqSum[2]*fc[19]-1.190784930203603*nuVtSqSum[1]*fl[15]-1.190784930203603*nuVtSqSum[1]*fc[15]-1.190784930203603*nuVtSqSum[0]*fl[7]-1.190784930203603*nuVtSqSum[0]*fc[7]-0.9375*nuVtSqSum[1]*fl[5]+0.9375*nuVtSqSum[1]*fc[5]-0.9375*nuVtSqSum[0]*fl[2]+0.9375*nuVtSqSum[0]*fc[2]; 
  Gdiff_l[3] = (-0.6708203932499369*nuVtSqSum[1]*fl[39])+0.6708203932499369*nuVtSqSum[1]*fc[39]-1.190784930203603*nuVtSqSum[2]*fl[37]-1.190784930203603*nuVtSqSum[2]*fc[37]-0.6708203932499369*nuVtSqSum[0]*fl[27]+0.6708203932499369*nuVtSqSum[0]*fc[27]-0.9375000000000001*nuVtSqSum[2]*fl[25]+0.9375000000000001*nuVtSqSum[2]*fc[25]-1.190784930203603*nuVtSqSum[1]*fl[17]-1.190784930203603*nuVtSqSum[1]*fc[17]-1.190784930203603*nuVtSqSum[0]*fl[10]-1.190784930203603*nuVtSqSum[0]*fc[10]-0.9375*nuVtSqSum[1]*fl[8]+0.9375*nuVtSqSum[1]*fc[8]-0.9375*nuVtSqSum[0]*fl[4]+0.9375*nuVtSqSum[0]*fc[4]; 
  Gdiff_l[4] = (-0.6*nuVtSqSum[2]*fl[34])-0.6708203932499369*nuVtSqSum[0]*fl[34]+0.6*nuVtSqSum[2]*fc[34]+0.6708203932499369*nuVtSqSum[0]*fc[34]-1.06507042020704*nuVtSqSum[1]*fl[32]-1.06507042020704*nuVtSqSum[1]*fc[32]-0.6708203932499369*nuVtSqSum[1]*fl[24]+0.6708203932499369*nuVtSqSum[1]*fc[24]-0.8385254915624211*nuVtSqSum[1]*fl[19]+0.8385254915624211*nuVtSqSum[1]*fc[19]-1.06507042020704*nuVtSqSum[2]*fl[15]-1.190784930203603*nuVtSqSum[0]*fl[15]-1.06507042020704*nuVtSqSum[2]*fc[15]-1.190784930203603*nuVtSqSum[0]*fc[15]-1.190784930203603*nuVtSqSum[1]*fl[7]-1.190784930203603*nuVtSqSum[1]*fc[7]-0.8385254915624212*nuVtSqSum[2]*fl[5]-0.9375*nuVtSqSum[0]*fl[5]+0.8385254915624212*nuVtSqSum[2]*fc[5]+0.9375*nuVtSqSum[0]*fc[5]-0.9375*nuVtSqSum[1]*fl[2]+0.9375*nuVtSqSum[1]*fc[2]; 
  Gdiff_l[5] = (-0.6*nuVtSqSum[2]*fl[39])-0.6708203932499369*nuVtSqSum[0]*fl[39]+0.6*nuVtSqSum[2]*fc[39]+0.6708203932499369*nuVtSqSum[0]*fc[39]-1.06507042020704*nuVtSqSum[1]*fl[37]-1.06507042020704*nuVtSqSum[1]*fc[37]-0.6708203932499369*nuVtSqSum[1]*fl[27]+0.6708203932499369*nuVtSqSum[1]*fc[27]-0.8385254915624211*nuVtSqSum[1]*fl[25]+0.8385254915624211*nuVtSqSum[1]*fc[25]-1.06507042020704*nuVtSqSum[2]*fl[17]-1.190784930203603*nuVtSqSum[0]*fl[17]-1.06507042020704*nuVtSqSum[2]*fc[17]-1.190784930203603*nuVtSqSum[0]*fc[17]-1.190784930203603*nuVtSqSum[1]*fl[10]-1.190784930203603*nuVtSqSum[1]*fc[10]-0.8385254915624212*nuVtSqSum[2]*fl[8]-0.9375*nuVtSqSum[0]*fl[8]+0.8385254915624212*nuVtSqSum[2]*fc[8]+0.9375*nuVtSqSum[0]*fc[8]-0.9375*nuVtSqSum[1]*fl[4]+0.9375*nuVtSqSum[1]*fc[4]; 
  Gdiff_l[6] = (-0.6708203932499369*nuVtSqSum[1]*fl[46])+0.6708203932499369*nuVtSqSum[1]*fc[46]-1.190784930203603*nuVtSqSum[2]*fl[44]-1.190784930203603*nuVtSqSum[2]*fc[44]-0.6708203932499369*nuVtSqSum[0]*fl[40]+0.6708203932499369*nuVtSqSum[0]*fc[40]-0.9375*nuVtSqSum[2]*fl[35]+0.9375*nuVtSqSum[2]*fc[35]-1.190784930203603*nuVtSqSum[1]*fl[31]-1.190784930203603*nuVtSqSum[1]*fc[31]-1.190784930203603*nuVtSqSum[0]*fl[18]-1.190784930203603*nuVtSqSum[0]*fc[18]-0.9375*nuVtSqSum[1]*fl[16]+0.9375*nuVtSqSum[1]*fc[16]-0.9375*nuVtSqSum[0]*fl[9]+0.9375*nuVtSqSum[0]*fc[9]; 
  Gdiff_l[7] = (-0.5999999999999999*nuVtSqSum[1]*fl[23])+0.5999999999999999*nuVtSqSum[1]*fc[23]-0.7607645858621712*nuVtSqSum[2]*fl[21]-1.190784930203603*nuVtSqSum[0]*fl[21]-0.7607645858621712*nuVtSqSum[2]*fc[21]-1.190784930203603*nuVtSqSum[0]*fc[21]-0.6708203932499369*nuVtSqSum[2]*fl[13]+0.6708203932499369*nuVtSqSum[2]*fc[13]-0.5989467796874438*nuVtSqSum[2]*fl[11]-0.9375*nuVtSqSum[0]*fl[11]+0.5989467796874438*nuVtSqSum[2]*fc[11]+0.9375*nuVtSqSum[0]*fc[11]-1.06507042020704*nuVtSqSum[1]*fl[6]-1.06507042020704*nuVtSqSum[1]*fc[6]-1.190784930203603*nuVtSqSum[2]*fl[3]-1.190784930203603*nuVtSqSum[2]*fc[3]-0.9375*fl[0]*nuVtSqSum[2]+0.9375*fc[0]*nuVtSqSum[2]-0.8385254915624212*fl[1]*nuVtSqSum[1]+0.8385254915624212*fc[1]*nuVtSqSum[1]; 
  Gdiff_l[8] = (-1.190784930203603*nuVtSqSum[1]*fl[33])-1.190784930203603*nuVtSqSum[1]*fc[33]-1.190784930203603*nuVtSqSum[0]*fl[22]-1.190784930203603*nuVtSqSum[0]*fc[22]-0.9375000000000001*nuVtSqSum[1]*fl[20]+0.9375000000000001*nuVtSqSum[1]*fc[20]-0.9375*nuVtSqSum[0]*fl[12]+0.9375*nuVtSqSum[0]*fc[12]; 
  Gdiff_l[9] = (-1.190784930203603*nuVtSqSum[1]*fl[42])-1.190784930203603*nuVtSqSum[1]*fc[42]-1.190784930203603*nuVtSqSum[0]*fl[30]-1.190784930203603*nuVtSqSum[0]*fc[30]-0.9375000000000001*nuVtSqSum[1]*fl[28]+0.9375000000000001*nuVtSqSum[1]*fc[28]-0.9375*nuVtSqSum[0]*fl[14]+0.9375*nuVtSqSum[0]*fc[14]; 
  Gdiff_l[10] = (-0.5999999999999999*nuVtSqSum[2]*fl[46])-0.6708203932499369*nuVtSqSum[0]*fl[46]+0.5999999999999999*nuVtSqSum[2]*fc[46]+0.6708203932499369*nuVtSqSum[0]*fc[46]-1.06507042020704*nuVtSqSum[1]*fl[44]-1.06507042020704*nuVtSqSum[1]*fc[44]-0.6708203932499369*nuVtSqSum[1]*fl[40]+0.6708203932499369*nuVtSqSum[1]*fc[40]-0.8385254915624212*nuVtSqSum[1]*fl[35]+0.8385254915624212*nuVtSqSum[1]*fc[35]-1.06507042020704*nuVtSqSum[2]*fl[31]-1.190784930203603*nuVtSqSum[0]*fl[31]-1.06507042020704*nuVtSqSum[2]*fc[31]-1.190784930203603*nuVtSqSum[0]*fc[31]-1.190784930203603*nuVtSqSum[1]*fl[18]-1.190784930203603*nuVtSqSum[1]*fc[18]-0.8385254915624212*nuVtSqSum[2]*fl[16]-0.9375*nuVtSqSum[0]*fl[16]+0.8385254915624212*nuVtSqSum[2]*fc[16]+0.9375*nuVtSqSum[0]*fc[16]-0.9375*nuVtSqSum[1]*fl[9]+0.9375*nuVtSqSum[1]*fc[9]; 
  Gdiff_l[11] = (-0.5999999999999999*nuVtSqSum[1]*fl[34])+0.5999999999999999*nuVtSqSum[1]*fc[34]-0.7607645858621712*nuVtSqSum[2]*fl[32]-1.190784930203603*nuVtSqSum[0]*fl[32]-0.7607645858621712*nuVtSqSum[2]*fc[32]-1.190784930203603*nuVtSqSum[0]*fc[32]-0.6708203932499369*nuVtSqSum[2]*fl[24]+0.6708203932499369*nuVtSqSum[2]*fc[24]-0.5989467796874438*nuVtSqSum[2]*fl[19]-0.9375*nuVtSqSum[0]*fl[19]+0.5989467796874438*nuVtSqSum[2]*fc[19]+0.9375*nuVtSqSum[0]*fc[19]-1.06507042020704*nuVtSqSum[1]*fl[15]-1.06507042020704*nuVtSqSum[1]*fc[15]-1.190784930203603*nuVtSqSum[2]*fl[7]-1.190784930203603*nuVtSqSum[2]*fc[7]-0.8385254915624211*nuVtSqSum[1]*fl[5]+0.8385254915624211*nuVtSqSum[1]*fc[5]-0.9375000000000001*fl[2]*nuVtSqSum[2]+0.9375000000000001*fc[2]*nuVtSqSum[2]; 
  Gdiff_l[12] = (-1.06507042020704*nuVtSqSum[2]*fl[33])-1.190784930203603*nuVtSqSum[0]*fl[33]-1.06507042020704*nuVtSqSum[2]*fc[33]-1.190784930203603*nuVtSqSum[0]*fc[33]-1.190784930203603*nuVtSqSum[1]*fl[22]-1.190784930203603*nuVtSqSum[1]*fc[22]-0.8385254915624212*nuVtSqSum[2]*fl[20]-0.9375*nuVtSqSum[0]*fl[20]+0.8385254915624212*nuVtSqSum[2]*fc[20]+0.9375*nuVtSqSum[0]*fc[20]-0.9375000000000001*nuVtSqSum[1]*fl[12]+0.9375000000000001*nuVtSqSum[1]*fc[12]; 
  Gdiff_l[13] = (-0.5999999999999999*nuVtSqSum[1]*fl[39])+0.5999999999999999*nuVtSqSum[1]*fc[39]-0.7607645858621712*nuVtSqSum[2]*fl[37]-1.190784930203603*nuVtSqSum[0]*fl[37]-0.7607645858621712*nuVtSqSum[2]*fc[37]-1.190784930203603*nuVtSqSum[0]*fc[37]-0.6708203932499369*nuVtSqSum[2]*fl[27]+0.6708203932499369*nuVtSqSum[2]*fc[27]-0.5989467796874438*nuVtSqSum[2]*fl[25]-0.9375*nuVtSqSum[0]*fl[25]+0.5989467796874438*nuVtSqSum[2]*fc[25]+0.9375*nuVtSqSum[0]*fc[25]-1.06507042020704*nuVtSqSum[1]*fl[17]-1.06507042020704*nuVtSqSum[1]*fc[17]-1.190784930203603*nuVtSqSum[2]*fl[10]-1.190784930203603*nuVtSqSum[2]*fc[10]-0.8385254915624211*nuVtSqSum[1]*fl[8]+0.8385254915624211*nuVtSqSum[1]*fc[8]-0.9375000000000001*nuVtSqSum[2]*fl[4]+0.9375000000000001*nuVtSqSum[2]*fc[4]; 
  Gdiff_l[14] = (-1.190784930203603*nuVtSqSum[1]*fl[45])-1.190784930203603*nuVtSqSum[1]*fc[45]-1.190784930203603*nuVtSqSum[0]*fl[38]-1.190784930203603*nuVtSqSum[0]*fc[38]-0.9375000000000001*nuVtSqSum[1]*fl[36]+0.9375000000000001*nuVtSqSum[1]*fc[36]-0.9375*nuVtSqSum[0]*fl[26]+0.9375*nuVtSqSum[0]*fc[26]; 
  Gdiff_l[15] = (-1.06507042020704*nuVtSqSum[2]*fl[42])-1.190784930203603*nuVtSqSum[0]*fl[42]-1.06507042020704*nuVtSqSum[2]*fc[42]-1.190784930203603*nuVtSqSum[0]*fc[42]-1.190784930203603*nuVtSqSum[1]*fl[30]-1.190784930203603*nuVtSqSum[1]*fc[30]-0.8385254915624212*nuVtSqSum[2]*fl[28]-0.9375*nuVtSqSum[0]*fl[28]+0.8385254915624212*nuVtSqSum[2]*fc[28]+0.9375*nuVtSqSum[0]*fc[28]-0.9375000000000001*nuVtSqSum[1]*fl[14]+0.9375000000000001*nuVtSqSum[1]*fc[14]; 
  Gdiff_l[16] = (-1.190784930203603*nuVtSqSum[1]*fl[47])-1.190784930203603*nuVtSqSum[1]*fc[47]-1.190784930203603*nuVtSqSum[0]*fl[43]-1.190784930203603*nuVtSqSum[0]*fc[43]-0.9375000000000001*nuVtSqSum[1]*fl[41]+0.9375000000000001*nuVtSqSum[1]*fc[41]-0.9375*nuVtSqSum[0]*fl[29]+0.9375*nuVtSqSum[0]*fc[29]; 
  Gdiff_l[17] = (-0.5999999999999999*nuVtSqSum[1]*fl[46])+0.5999999999999999*nuVtSqSum[1]*fc[46]-0.7607645858621712*nuVtSqSum[2]*fl[44]-1.190784930203603*nuVtSqSum[0]*fl[44]-0.7607645858621712*nuVtSqSum[2]*fc[44]-1.190784930203603*nuVtSqSum[0]*fc[44]-0.6708203932499369*nuVtSqSum[2]*fl[40]+0.6708203932499369*nuVtSqSum[2]*fc[40]-0.5989467796874438*nuVtSqSum[2]*fl[35]-0.9375*nuVtSqSum[0]*fl[35]+0.5989467796874438*nuVtSqSum[2]*fc[35]+0.9375*nuVtSqSum[0]*fc[35]-1.06507042020704*nuVtSqSum[1]*fl[31]-1.06507042020704*nuVtSqSum[1]*fc[31]-1.190784930203603*nuVtSqSum[2]*fl[18]-1.190784930203603*nuVtSqSum[2]*fc[18]-0.8385254915624212*nuVtSqSum[1]*fl[16]+0.8385254915624212*nuVtSqSum[1]*fc[16]-0.9375*nuVtSqSum[2]*fl[9]+0.9375*nuVtSqSum[2]*fc[9]; 
  Gdiff_l[18] = (-1.06507042020704*nuVtSqSum[2]*fl[45])-1.190784930203603*nuVtSqSum[0]*fl[45]-1.06507042020704*nuVtSqSum[2]*fc[45]-1.190784930203603*nuVtSqSum[0]*fc[45]-1.190784930203603*nuVtSqSum[1]*fl[38]-1.190784930203603*nuVtSqSum[1]*fc[38]-0.8385254915624212*nuVtSqSum[2]*fl[36]-0.9375*nuVtSqSum[0]*fl[36]+0.8385254915624212*nuVtSqSum[2]*fc[36]+0.9375*nuVtSqSum[0]*fc[36]-0.9375000000000001*nuVtSqSum[1]*fl[26]+0.9375000000000001*nuVtSqSum[1]*fc[26]; 
  Gdiff_l[19] = (-1.06507042020704*nuVtSqSum[2]*fl[47])-1.190784930203603*nuVtSqSum[0]*fl[47]-1.06507042020704*nuVtSqSum[2]*fc[47]-1.190784930203603*nuVtSqSum[0]*fc[47]-1.190784930203603*nuVtSqSum[1]*fl[43]-1.190784930203603*nuVtSqSum[1]*fc[43]-0.8385254915624212*nuVtSqSum[2]*fl[41]-0.9375*nuVtSqSum[0]*fl[41]+0.8385254915624212*nuVtSqSum[2]*fc[41]+0.9375*nuVtSqSum[0]*fc[41]-0.9375000000000001*nuVtSqSum[1]*fl[29]+0.9375000000000001*nuVtSqSum[1]*fc[29]; 

  Gdiff_r[0] = 0.6708203932499369*nuVtSqSum[1]*fr[23]-0.6708203932499369*nuVtSqSum[1]*fc[23]-1.190784930203603*nuVtSqSum[2]*fr[21]-1.190784930203603*nuVtSqSum[2]*fc[21]+0.6708203932499369*nuVtSqSum[0]*fr[13]-0.6708203932499369*nuVtSqSum[0]*fc[13]+0.9375*nuVtSqSum[2]*fr[11]-0.9375*nuVtSqSum[2]*fc[11]-1.190784930203603*nuVtSqSum[1]*fr[6]-1.190784930203603*nuVtSqSum[1]*fc[6]-1.190784930203603*nuVtSqSum[0]*fr[3]-1.190784930203603*nuVtSqSum[0]*fc[3]+0.9375*fr[1]*nuVtSqSum[1]-0.9375*fc[1]*nuVtSqSum[1]+0.9375*fr[0]*nuVtSqSum[0]-0.9375*fc[0]*nuVtSqSum[0]; 
  Gdiff_r[1] = 0.5999999999999999*nuVtSqSum[2]*fr[23]+0.6708203932499369*nuVtSqSum[0]*fr[23]-0.5999999999999999*nuVtSqSum[2]*fc[23]-0.6708203932499369*nuVtSqSum[0]*fc[23]-1.06507042020704*nuVtSqSum[1]*fr[21]-1.06507042020704*nuVtSqSum[1]*fc[21]+0.6708203932499369*nuVtSqSum[1]*fr[13]-0.6708203932499369*nuVtSqSum[1]*fc[13]+0.8385254915624212*nuVtSqSum[1]*fr[11]-0.8385254915624212*nuVtSqSum[1]*fc[11]-1.06507042020704*nuVtSqSum[2]*fr[6]-1.190784930203603*nuVtSqSum[0]*fr[6]-1.06507042020704*nuVtSqSum[2]*fc[6]-1.190784930203603*nuVtSqSum[0]*fc[6]-1.190784930203603*nuVtSqSum[1]*fr[3]-1.190784930203603*nuVtSqSum[1]*fc[3]+0.8385254915624212*fr[1]*nuVtSqSum[2]-0.8385254915624212*fc[1]*nuVtSqSum[2]+0.9375*fr[0]*nuVtSqSum[1]-0.9375*fc[0]*nuVtSqSum[1]+0.9375*nuVtSqSum[0]*fr[1]-0.9375*nuVtSqSum[0]*fc[1]; 
  Gdiff_r[2] = 0.6708203932499369*nuVtSqSum[1]*fr[34]-0.6708203932499369*nuVtSqSum[1]*fc[34]-1.190784930203603*nuVtSqSum[2]*fr[32]-1.190784930203603*nuVtSqSum[2]*fc[32]+0.6708203932499369*nuVtSqSum[0]*fr[24]-0.6708203932499369*nuVtSqSum[0]*fc[24]+0.9375000000000001*nuVtSqSum[2]*fr[19]-0.9375000000000001*nuVtSqSum[2]*fc[19]-1.190784930203603*nuVtSqSum[1]*fr[15]-1.190784930203603*nuVtSqSum[1]*fc[15]-1.190784930203603*nuVtSqSum[0]*fr[7]-1.190784930203603*nuVtSqSum[0]*fc[7]+0.9375*nuVtSqSum[1]*fr[5]-0.9375*nuVtSqSum[1]*fc[5]+0.9375*nuVtSqSum[0]*fr[2]-0.9375*nuVtSqSum[0]*fc[2]; 
  Gdiff_r[3] = 0.6708203932499369*nuVtSqSum[1]*fr[39]-0.6708203932499369*nuVtSqSum[1]*fc[39]-1.190784930203603*nuVtSqSum[2]*fr[37]-1.190784930203603*nuVtSqSum[2]*fc[37]+0.6708203932499369*nuVtSqSum[0]*fr[27]-0.6708203932499369*nuVtSqSum[0]*fc[27]+0.9375000000000001*nuVtSqSum[2]*fr[25]-0.9375000000000001*nuVtSqSum[2]*fc[25]-1.190784930203603*nuVtSqSum[1]*fr[17]-1.190784930203603*nuVtSqSum[1]*fc[17]-1.190784930203603*nuVtSqSum[0]*fr[10]-1.190784930203603*nuVtSqSum[0]*fc[10]+0.9375*nuVtSqSum[1]*fr[8]-0.9375*nuVtSqSum[1]*fc[8]+0.9375*nuVtSqSum[0]*fr[4]-0.9375*nuVtSqSum[0]*fc[4]; 
  Gdiff_r[4] = 0.6*nuVtSqSum[2]*fr[34]+0.6708203932499369*nuVtSqSum[0]*fr[34]-0.6*nuVtSqSum[2]*fc[34]-0.6708203932499369*nuVtSqSum[0]*fc[34]-1.06507042020704*nuVtSqSum[1]*fr[32]-1.06507042020704*nuVtSqSum[1]*fc[32]+0.6708203932499369*nuVtSqSum[1]*fr[24]-0.6708203932499369*nuVtSqSum[1]*fc[24]+0.8385254915624211*nuVtSqSum[1]*fr[19]-0.8385254915624211*nuVtSqSum[1]*fc[19]-1.06507042020704*nuVtSqSum[2]*fr[15]-1.190784930203603*nuVtSqSum[0]*fr[15]-1.06507042020704*nuVtSqSum[2]*fc[15]-1.190784930203603*nuVtSqSum[0]*fc[15]-1.190784930203603*nuVtSqSum[1]*fr[7]-1.190784930203603*nuVtSqSum[1]*fc[7]+0.8385254915624212*nuVtSqSum[2]*fr[5]+0.9375*nuVtSqSum[0]*fr[5]-0.8385254915624212*nuVtSqSum[2]*fc[5]-0.9375*nuVtSqSum[0]*fc[5]+0.9375*nuVtSqSum[1]*fr[2]-0.9375*nuVtSqSum[1]*fc[2]; 
  Gdiff_r[5] = 0.6*nuVtSqSum[2]*fr[39]+0.6708203932499369*nuVtSqSum[0]*fr[39]-0.6*nuVtSqSum[2]*fc[39]-0.6708203932499369*nuVtSqSum[0]*fc[39]-1.06507042020704*nuVtSqSum[1]*fr[37]-1.06507042020704*nuVtSqSum[1]*fc[37]+0.6708203932499369*nuVtSqSum[1]*fr[27]-0.6708203932499369*nuVtSqSum[1]*fc[27]+0.8385254915624211*nuVtSqSum[1]*fr[25]-0.8385254915624211*nuVtSqSum[1]*fc[25]-1.06507042020704*nuVtSqSum[2]*fr[17]-1.190784930203603*nuVtSqSum[0]*fr[17]-1.06507042020704*nuVtSqSum[2]*fc[17]-1.190784930203603*nuVtSqSum[0]*fc[17]-1.190784930203603*nuVtSqSum[1]*fr[10]-1.190784930203603*nuVtSqSum[1]*fc[10]+0.8385254915624212*nuVtSqSum[2]*fr[8]+0.9375*nuVtSqSum[0]*fr[8]-0.8385254915624212*nuVtSqSum[2]*fc[8]-0.9375*nuVtSqSum[0]*fc[8]+0.9375*nuVtSqSum[1]*fr[4]-0.9375*nuVtSqSum[1]*fc[4]; 
  Gdiff_r[6] = 0.6708203932499369*nuVtSqSum[1]*fr[46]-0.6708203932499369*nuVtSqSum[1]*fc[46]-1.190784930203603*nuVtSqSum[2]*fr[44]-1.190784930203603*nuVtSqSum[2]*fc[44]+0.6708203932499369*nuVtSqSum[0]*fr[40]-0.6708203932499369*nuVtSqSum[0]*fc[40]+0.9375*nuVtSqSum[2]*fr[35]-0.9375*nuVtSqSum[2]*fc[35]-1.190784930203603*nuVtSqSum[1]*fr[31]-1.190784930203603*nuVtSqSum[1]*fc[31]-1.190784930203603*nuVtSqSum[0]*fr[18]-1.190784930203603*nuVtSqSum[0]*fc[18]+0.9375*nuVtSqSum[1]*fr[16]-0.9375*nuVtSqSum[1]*fc[16]+0.9375*nuVtSqSum[0]*fr[9]-0.9375*nuVtSqSum[0]*fc[9]; 
  Gdiff_r[7] = 0.5999999999999999*nuVtSqSum[1]*fr[23]-0.5999999999999999*nuVtSqSum[1]*fc[23]-0.7607645858621712*nuVtSqSum[2]*fr[21]-1.190784930203603*nuVtSqSum[0]*fr[21]-0.7607645858621712*nuVtSqSum[2]*fc[21]-1.190784930203603*nuVtSqSum[0]*fc[21]+0.6708203932499369*nuVtSqSum[2]*fr[13]-0.6708203932499369*nuVtSqSum[2]*fc[13]+0.5989467796874438*nuVtSqSum[2]*fr[11]+0.9375*nuVtSqSum[0]*fr[11]-0.5989467796874438*nuVtSqSum[2]*fc[11]-0.9375*nuVtSqSum[0]*fc[11]-1.06507042020704*nuVtSqSum[1]*fr[6]-1.06507042020704*nuVtSqSum[1]*fc[6]-1.190784930203603*nuVtSqSum[2]*fr[3]-1.190784930203603*nuVtSqSum[2]*fc[3]+0.9375*fr[0]*nuVtSqSum[2]-0.9375*fc[0]*nuVtSqSum[2]+0.8385254915624212*fr[1]*nuVtSqSum[1]-0.8385254915624212*fc[1]*nuVtSqSum[1]; 
  Gdiff_r[8] = (-1.190784930203603*nuVtSqSum[1]*fr[33])-1.190784930203603*nuVtSqSum[1]*fc[33]-1.190784930203603*nuVtSqSum[0]*fr[22]-1.190784930203603*nuVtSqSum[0]*fc[22]+0.9375000000000001*nuVtSqSum[1]*fr[20]-0.9375000000000001*nuVtSqSum[1]*fc[20]+0.9375*nuVtSqSum[0]*fr[12]-0.9375*nuVtSqSum[0]*fc[12]; 
  Gdiff_r[9] = (-1.190784930203603*nuVtSqSum[1]*fr[42])-1.190784930203603*nuVtSqSum[1]*fc[42]-1.190784930203603*nuVtSqSum[0]*fr[30]-1.190784930203603*nuVtSqSum[0]*fc[30]+0.9375000000000001*nuVtSqSum[1]*fr[28]-0.9375000000000001*nuVtSqSum[1]*fc[28]+0.9375*nuVtSqSum[0]*fr[14]-0.9375*nuVtSqSum[0]*fc[14]; 
  Gdiff_r[10] = 0.5999999999999999*nuVtSqSum[2]*fr[46]+0.6708203932499369*nuVtSqSum[0]*fr[46]-0.5999999999999999*nuVtSqSum[2]*fc[46]-0.6708203932499369*nuVtSqSum[0]*fc[46]-1.06507042020704*nuVtSqSum[1]*fr[44]-1.06507042020704*nuVtSqSum[1]*fc[44]+0.6708203932499369*nuVtSqSum[1]*fr[40]-0.6708203932499369*nuVtSqSum[1]*fc[40]+0.8385254915624212*nuVtSqSum[1]*fr[35]-0.8385254915624212*nuVtSqSum[1]*fc[35]-1.06507042020704*nuVtSqSum[2]*fr[31]-1.190784930203603*nuVtSqSum[0]*fr[31]-1.06507042020704*nuVtSqSum[2]*fc[31]-1.190784930203603*nuVtSqSum[0]*fc[31]-1.190784930203603*nuVtSqSum[1]*fr[18]-1.190784930203603*nuVtSqSum[1]*fc[18]+0.8385254915624212*nuVtSqSum[2]*fr[16]+0.9375*nuVtSqSum[0]*fr[16]-0.8385254915624212*nuVtSqSum[2]*fc[16]-0.9375*nuVtSqSum[0]*fc[16]+0.9375*nuVtSqSum[1]*fr[9]-0.9375*nuVtSqSum[1]*fc[9]; 
  Gdiff_r[11] = 0.5999999999999999*nuVtSqSum[1]*fr[34]-0.5999999999999999*nuVtSqSum[1]*fc[34]-0.7607645858621712*nuVtSqSum[2]*fr[32]-1.190784930203603*nuVtSqSum[0]*fr[32]-0.7607645858621712*nuVtSqSum[2]*fc[32]-1.190784930203603*nuVtSqSum[0]*fc[32]+0.6708203932499369*nuVtSqSum[2]*fr[24]-0.6708203932499369*nuVtSqSum[2]*fc[24]+0.5989467796874438*nuVtSqSum[2]*fr[19]+0.9375*nuVtSqSum[0]*fr[19]-0.5989467796874438*nuVtSqSum[2]*fc[19]-0.9375*nuVtSqSum[0]*fc[19]-1.06507042020704*nuVtSqSum[1]*fr[15]-1.06507042020704*nuVtSqSum[1]*fc[15]-1.190784930203603*nuVtSqSum[2]*fr[7]-1.190784930203603*nuVtSqSum[2]*fc[7]+0.8385254915624211*nuVtSqSum[1]*fr[5]-0.8385254915624211*nuVtSqSum[1]*fc[5]+0.9375000000000001*fr[2]*nuVtSqSum[2]-0.9375000000000001*fc[2]*nuVtSqSum[2]; 
  Gdiff_r[12] = (-1.06507042020704*nuVtSqSum[2]*fr[33])-1.190784930203603*nuVtSqSum[0]*fr[33]-1.06507042020704*nuVtSqSum[2]*fc[33]-1.190784930203603*nuVtSqSum[0]*fc[33]-1.190784930203603*nuVtSqSum[1]*fr[22]-1.190784930203603*nuVtSqSum[1]*fc[22]+0.8385254915624212*nuVtSqSum[2]*fr[20]+0.9375*nuVtSqSum[0]*fr[20]-0.8385254915624212*nuVtSqSum[2]*fc[20]-0.9375*nuVtSqSum[0]*fc[20]+0.9375000000000001*nuVtSqSum[1]*fr[12]-0.9375000000000001*nuVtSqSum[1]*fc[12]; 
  Gdiff_r[13] = 0.5999999999999999*nuVtSqSum[1]*fr[39]-0.5999999999999999*nuVtSqSum[1]*fc[39]-0.7607645858621712*nuVtSqSum[2]*fr[37]-1.190784930203603*nuVtSqSum[0]*fr[37]-0.7607645858621712*nuVtSqSum[2]*fc[37]-1.190784930203603*nuVtSqSum[0]*fc[37]+0.6708203932499369*nuVtSqSum[2]*fr[27]-0.6708203932499369*nuVtSqSum[2]*fc[27]+0.5989467796874438*nuVtSqSum[2]*fr[25]+0.9375*nuVtSqSum[0]*fr[25]-0.5989467796874438*nuVtSqSum[2]*fc[25]-0.9375*nuVtSqSum[0]*fc[25]-1.06507042020704*nuVtSqSum[1]*fr[17]-1.06507042020704*nuVtSqSum[1]*fc[17]-1.190784930203603*nuVtSqSum[2]*fr[10]-1.190784930203603*nuVtSqSum[2]*fc[10]+0.8385254915624211*nuVtSqSum[1]*fr[8]-0.8385254915624211*nuVtSqSum[1]*fc[8]+0.9375000000000001*nuVtSqSum[2]*fr[4]-0.9375000000000001*nuVtSqSum[2]*fc[4]; 
  Gdiff_r[14] = (-1.190784930203603*nuVtSqSum[1]*fr[45])-1.190784930203603*nuVtSqSum[1]*fc[45]-1.190784930203603*nuVtSqSum[0]*fr[38]-1.190784930203603*nuVtSqSum[0]*fc[38]+0.9375000000000001*nuVtSqSum[1]*fr[36]-0.9375000000000001*nuVtSqSum[1]*fc[36]+0.9375*nuVtSqSum[0]*fr[26]-0.9375*nuVtSqSum[0]*fc[26]; 
  Gdiff_r[15] = (-1.06507042020704*nuVtSqSum[2]*fr[42])-1.190784930203603*nuVtSqSum[0]*fr[42]-1.06507042020704*nuVtSqSum[2]*fc[42]-1.190784930203603*nuVtSqSum[0]*fc[42]-1.190784930203603*nuVtSqSum[1]*fr[30]-1.190784930203603*nuVtSqSum[1]*fc[30]+0.8385254915624212*nuVtSqSum[2]*fr[28]+0.9375*nuVtSqSum[0]*fr[28]-0.8385254915624212*nuVtSqSum[2]*fc[28]-0.9375*nuVtSqSum[0]*fc[28]+0.9375000000000001*nuVtSqSum[1]*fr[14]-0.9375000000000001*nuVtSqSum[1]*fc[14]; 
  Gdiff_r[16] = (-1.190784930203603*nuVtSqSum[1]*fr[47])-1.190784930203603*nuVtSqSum[1]*fc[47]-1.190784930203603*nuVtSqSum[0]*fr[43]-1.190784930203603*nuVtSqSum[0]*fc[43]+0.9375000000000001*nuVtSqSum[1]*fr[41]-0.9375000000000001*nuVtSqSum[1]*fc[41]+0.9375*nuVtSqSum[0]*fr[29]-0.9375*nuVtSqSum[0]*fc[29]; 
  Gdiff_r[17] = 0.5999999999999999*nuVtSqSum[1]*fr[46]-0.5999999999999999*nuVtSqSum[1]*fc[46]-0.7607645858621712*nuVtSqSum[2]*fr[44]-1.190784930203603*nuVtSqSum[0]*fr[44]-0.7607645858621712*nuVtSqSum[2]*fc[44]-1.190784930203603*nuVtSqSum[0]*fc[44]+0.6708203932499369*nuVtSqSum[2]*fr[40]-0.6708203932499369*nuVtSqSum[2]*fc[40]+0.5989467796874438*nuVtSqSum[2]*fr[35]+0.9375*nuVtSqSum[0]*fr[35]-0.5989467796874438*nuVtSqSum[2]*fc[35]-0.9375*nuVtSqSum[0]*fc[35]-1.06507042020704*nuVtSqSum[1]*fr[31]-1.06507042020704*nuVtSqSum[1]*fc[31]-1.190784930203603*nuVtSqSum[2]*fr[18]-1.190784930203603*nuVtSqSum[2]*fc[18]+0.8385254915624212*nuVtSqSum[1]*fr[16]-0.8385254915624212*nuVtSqSum[1]*fc[16]+0.9375*nuVtSqSum[2]*fr[9]-0.9375*nuVtSqSum[2]*fc[9]; 
  Gdiff_r[18] = (-1.06507042020704*nuVtSqSum[2]*fr[45])-1.190784930203603*nuVtSqSum[0]*fr[45]-1.06507042020704*nuVtSqSum[2]*fc[45]-1.190784930203603*nuVtSqSum[0]*fc[45]-1.190784930203603*nuVtSqSum[1]*fr[38]-1.190784930203603*nuVtSqSum[1]*fc[38]+0.8385254915624212*nuVtSqSum[2]*fr[36]+0.9375*nuVtSqSum[0]*fr[36]-0.8385254915624212*nuVtSqSum[2]*fc[36]-0.9375*nuVtSqSum[0]*fc[36]+0.9375000000000001*nuVtSqSum[1]*fr[26]-0.9375000000000001*nuVtSqSum[1]*fc[26]; 
  Gdiff_r[19] = (-1.06507042020704*nuVtSqSum[2]*fr[47])-1.190784930203603*nuVtSqSum[0]*fr[47]-1.06507042020704*nuVtSqSum[2]*fc[47]-1.190784930203603*nuVtSqSum[0]*fc[47]-1.190784930203603*nuVtSqSum[1]*fr[43]-1.190784930203603*nuVtSqSum[1]*fc[43]+0.8385254915624212*nuVtSqSum[2]*fr[41]+0.9375*nuVtSqSum[0]*fr[41]-0.8385254915624212*nuVtSqSum[2]*fc[41]-0.9375*nuVtSqSum[0]*fc[41]+0.9375000000000001*nuVtSqSum[1]*fr[29]-0.9375000000000001*nuVtSqSum[1]*fc[29]; 
  ...
  out[13] += 4.743416490252569*Gdiff2_r[0]*rdvSq4+4.743416490252569*Gdiff2_l[0]*rdvSq4-1.58113883008419*Ghat_r[0]*rdv2+1.58113883008419*Ghat_l[0]*rdv2; 
  ...
  out[16] += 0.7071067811865475*Ghat_l[10]*rdv2-0.7071067811865475*Ghat_r[10]*rdv2; 
  ...
  out[21] += 1.224744871391589*Gdiff2_r[7]*rdvSq4-1.224744871391589*Gdiff2_l[7]*rdvSq4-1.224744871391589*Ghat_r[7]*rdv2-1.224744871391589*Ghat_l[7]*rdv2; 
  out[22] += 1.224744871391589*Gdiff2_r[8]*rdvSq4-1.224744871391589*Gdiff2_l[8]*rdvSq4-1.224744871391589*Ghat_r[8]*rdv2-1.224744871391589*Ghat_l[8]*rdv2; 
  out[23] += 4.743416490252569*Gdiff2_r[1]*rdvSq4+4.743416490252569*Gdiff2_l[1]*rdvSq4-1.58113883008419*Ghat_r[1]*rdv2+1.58113883008419*Ghat_l[1]*rdv2; 
  out[24] += 4.743416490252569*Gdiff2_r[2]*rdvSq4+4.743416490252569*Gdiff2_l[2]*rdvSq4-1.58113883008419*Ghat_r[2]*rdv2+1.58113883008419*Ghat_l[2]*rdv2; 
  out[25] += 0.7071067811865475*Ghat_l[13]*rdv2-0.7071067811865475*Ghat_r[13]*rdv2; 
  out[26] += 0.7071067811865475*Ghat_l[14]*rdv2-0.7071067811865475*Ghat_r[14]*rdv2; 
  out[27] += 4.743416490252569*Gdiff2_r[3]*rdvSq4+4.743416490252569*Gdiff2_l[3]*rdvSq4-1.58113883008419*Ghat_r[3]*rdv2+1.58113883008419*Ghat_l[3]*rdv2; 
  out[28] += 0.7071067811865475*Ghat_l[15]*rdv2-0.7071067811865475*Ghat_r[15]*rdv2; 
  out[29] += 0.7071067811865475*Ghat_l[16]*rdv2-0.7071067811865475*Ghat_r[16]*rdv2; 
  out[30] += 1.224744871391589*Gdiff2_r[9]*rdvSq4-1.224744871391589*Gdiff2_l[9]*rdvSq4-1.224744871391589*Ghat_r[9]*rdv2-1.224744871391589*Ghat_l[9]*rdv2; 
  ...
  out[33] += 1.224744871391589*Gdiff2_r[12]*rdvSq4-1.224744871391589*Gdiff2_l[12]*rdvSq4-1.224744871391589*Ghat_r[12]*rdv2-1.224744871391589*Ghat_l[12]*rdv2; 
  out[34] += 4.743416490252569*Gdiff2_r[4]*rdvSq4+4.743416490252569*Gdiff2_l[4]*rdvSq4-1.58113883008419*Ghat_r[4]*rdv2+1.58113883008419*Ghat_l[4]*rdv2; 
  out[35] += 0.7071067811865475*Ghat_l[17]*rdv2-0.7071067811865475*Ghat_r[17]*rdv2; 
  out[36] += 0.7071067811865475*Ghat_l[18]*rdv2-0.7071067811865475*Ghat_r[18]*rdv2; 
  ...
  out[39] += 4.743416490252569*Gdiff2_r[5]*rdvSq4+4.743416490252569*Gdiff2_l[5]*rdvSq4-1.58113883008419*Ghat_r[5]*rdv2+1.58113883008419*Ghat_l[5]*rdv2; 
  out[40] += 4.743416490252569*Gdiff2_r[6]*rdvSq4+4.743416490252569*Gdiff2_l[6]*rdvSq4-1.58113883008419*Ghat_r[6]*rdv2+1.58113883008419*Ghat_l[6]*rdv2; 
  out[41] += 0.7071067811865475*Ghat_l[19]*rdv2-0.7071067811865475*Ghat_r[19]*rdv2; 
  out[42] += 1.224744871391589*Gdiff2_r[15]*rdvSq4-1.224744871391589*Gdiff2_l[15]*rdvSq4-1.224744871391589*Ghat_r[15]*rdv2-1.224744871391589*Ghat_l[15]*rdv2; 
  ...
  out[46] += 4.743416490252569*Gdiff2_r[10]*rdvSq4+4.743416490252569*Gdiff2_l[10]*rdvSq4-1.58113883008419*Ghat_r[10]*rdv2+1.58113883008419*Ghat_l[10]*rdv2; 
