...
{ 
  ...
  if (edge == GKYL_VX_LOWER) {
    ...
    out[18] += vBoundary[0]*((-2.23606797749979*fIn[13])+1.732050807568877*fIn[3]-1.0*fIn[0])*dS; 
    out[19] += vBoundary[0]*((-2.23606797749979*fIn[23])+1.732050807568877*fIn[6]-1.0*fIn[1])*dS; 
    out[20] += vBoundary[0]*((-2.23606797749979*fIn[24])+1.732050807568877*fIn[7]-1.0*fIn[2])*dS; 
    out[21] += vBoundary[0]*((-2.23606797749979*fIn[34])+1.732050807568877*fIn[15]-1.0*fIn[5])*dS; 
    out[22] += vBoundary[0]*((-2.23606797749979*fIn[45])+1.732050807568877*fIn[21]-1.0*fIn[11])*dS; 
    out[23] += vBoundary[0]*((-2.23606797749979*fIn[46])+1.732050807568877*fIn[22]-1.0*fIn[12])*dS; 
    out[24] += vBoundary[0]*((-2.23606797749979*fIn[55])+1.732050807568877*fIn[32]-1.0*fIn[19])*dS; 
    out[25] += vBoundary[0]*((-2.23606797749979*fIn[56])+1.732050807568877*fIn[33]-1.0*fIn[20])*dS; 
    out[26] += vBoundary[0]*((-2.23606797749979*fIn[72])+1.732050807568877*fIn[54]-1.0*fIn[44])*dS; 
    ...
    out[18] += vBoundary[2]*(2.23606797749979*fIn[13]+1.732050807568877*fIn[3]+fIn[0])*dS; 
    out[19] += vBoundary[2]*(2.23606797749979*fIn[23]+1.732050807568877*fIn[6]+fIn[1])*dS; 
    out[20] += vBoundary[2]*(2.23606797749979*fIn[24]+1.732050807568877*fIn[7]+fIn[2])*dS; 
    out[21] += vBoundary[2]*(2.23606797749979*fIn[34]+1.732050807568877*fIn[15]+fIn[5])*dS; 
    out[22] += vBoundary[2]*(2.23606797749979*fIn[45]+1.732050807568877*fIn[21]+fIn[11])*dS; 
    out[23] += vBoundary[2]*(2.23606797749979*fIn[46]+1.732050807568877*fIn[22]+fIn[12])*dS; 
    out[24] += vBoundary[2]*(2.23606797749979*fIn[55]+1.732050807568877*fIn[32]+fIn[19])*dS; 
    out[25] += vBoundary[2]*(2.23606797749979*fIn[56]+1.732050807568877*fIn[33]+fIn[20])*dS; 
    out[26] += vBoundary[2]*(2.23606797749979*fIn[72]+1.732050807568877*fIn[54]+fIn[44])*dS; 
  }
  ...
  if (edge == GKYL_VY_LOWER) {
    ...
    out[18] += vBoundary[1]*((-2.23606797749979*fIn[14])+1.732050807568877*fIn[4]-1.0*fIn[0])*dS; 
    out[19] += vBoundary[1]*((-2.23606797749979*fIn[28])+1.732050807568877*fIn[8]-1.0*fIn[1])*dS; 
    out[20] += vBoundary[1]*((-2.23606797749979*fIn[29])+1.732050807568877*fIn[9]-1.0*fIn[2])*dS; 
    out[21] += vBoundary[1]*((-2.23606797749979*fIn[41])+1.732050807568877*fIn[16]-1.0*fIn[5])*dS; 
    out[22] += vBoundary[1]*((-2.23606797749979*fIn[47])+1.732050807568877*fIn[25]-1.0*fIn[11])*dS; 
    out[23] += vBoundary[1]*((-2.23606797749979*fIn[48])+1.732050807568877*fIn[26]-1.0*fIn[12])*dS; 
    out[24] += vBoundary[1]*((-2.23606797749979*fIn[60])+1.732050807568877*fIn[35]-1.0*fIn[19])*dS; 
    out[25] += vBoundary[1]*((-2.23606797749979*fIn[61])+1.732050807568877*fIn[36]-1.0*fIn[20])*dS; 
    out[26] += vBoundary[1]*((-2.23606797749979*fIn[73])+1.732050807568877*fIn[57]-1.0*fIn[44])*dS; 
    ...
    out[18] += vBoundary[3]*(2.23606797749979*fIn[14]+1.732050807568877*fIn[4]+fIn[0])*dS; 
    out[19] += vBoundary[3]*(2.23606797749979*fIn[28]+1.732050807568877*fIn[8]+fIn[1])*dS; 
    out[20] += vBoundary[3]*(2.23606797749979*fIn[29]+1.732050807568877*fIn[9]+fIn[2])*dS; 
    out[21] += vBoundary[3]*(2.23606797749979*fIn[41]+1.732050807568877*fIn[16]+fIn[5])*dS; 
    out[22] += vBoundary[3]*(2.23606797749979*fIn[47]+1.732050807568877*fIn[25]+fIn[11])*dS; 
    out[23] += vBoundary[3]*(2.23606797749979*fIn[48]+1.732050807568877*fIn[26]+fIn[12])*dS; 
    out[24] += vBoundary[3]*(2.23606797749979*fIn[60]+1.732050807568877*fIn[35]+fIn[19])*dS; 
    out[25] += vBoundary[3]*(2.23606797749979*fIn[61]+1.732050807568877*fIn[36]+fIn[20])*dS; 
    out[26] += vBoundary[3]*(2.23606797749979*fIn[73]+1.732050807568877*fIn[57]+fIn[44])*dS; 
  }
