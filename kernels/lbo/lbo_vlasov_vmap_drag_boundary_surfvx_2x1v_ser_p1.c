...
GKYL_CU_DH double lbo_vlasov_vmap_drag_boundary_surfvx_2x1v_ser_p1(const double *w, const double *dxv, const double *vmap, const double *jacob_vel_inv, const double *nuSum, const double *nuPrimMomsSum, const int edge, const double *fSkin, const double *fEdge, double* GKYL_RESTRICT out) 
{ 
  ...
  out[7] += 1.58113883008419*Ghat[0]*rdv2; 
  out[8] += 1.224744871391589*Ghat[3]*rdv2; 
