...
{ 
  ...
  alphaDrSurf_l[4] = -1.414213562373095*sumNuUy[2]; 
  ...
  alphaDrSurf_r[4] = -1.414213562373095*sumNuUy[2]; 
  ...
  if (0.4472135954999579*alphaDrSurf_l[4]-0.6708203932499369*alphaDrSurf_l[1]+0.5*alphaDrSurf_l[0] > 0) { 
    fUpwindQuad_l[0] = ser_1x2v_p2_surfvy_quad_0(1, fl); 
  } else { 
    fUpwindQuad_l[0] = ser_1x2v_p2_surfvy_quad_0(-1, fc); 
  } 
  if (0.5*alphaDrSurf_l[0]-0.5590169943749475*alphaDrSurf_l[4] > 0) { 
    fUpwindQuad_l[1] = ser_1x2v_p2_surfvy_quad_1(1, fl); 
  } else { 
    fUpwindQuad_l[1] = ser_1x2v_p2_surfvy_quad_1(-1, fc); 
  } 
  if (0.4472135954999579*alphaDrSurf_l[4]+0.6708203932499369*alphaDrSurf_l[1]+0.5*alphaDrSurf_l[0] > 0) { 
    fUpwindQuad_l[2] = ser_1x2v_p2_surfvy_quad_2(1, fl); 
  } else { 
    fUpwindQuad_l[2] = ser_1x2v_p2_surfvy_quad_2(-1, fc); 
  } 
  if (0.4472135954999579*alphaDrSurf_l[4]-0.6708203932499369*alphaDrSurf_l[1]+0.5*alphaDrSurf_l[0] > 0) { 
    fUpwindQuad_l[3] = ser_1x2v_p2_surfvy_quad_3(1, fl); 
  } else { 
    fUpwindQuad_l[3] = ser_1x2v_p2_surfvy_quad_3(-1, fc); 
  } 
  if (0.5*alphaDrSurf_l[0]-0.5590169943749475*alphaDrSurf_l[4] > 0) { 
    fUpwindQuad_l[4] = ser_1x2v_p2_surfvy_quad_4(1, fl); 
  } else { 
    fUpwindQuad_l[4] = ser_1x2v_p2_surfvy_quad_4(-1, fc); 
  } 
  if (0.4472135954999579*alphaDrSurf_l[4]+0.6708203932499369*alphaDrSurf_l[1]+0.5*alphaDrSurf_l[0] > 0) { 
    fUpwindQuad_l[5] = ser_1x2v_p2_surfvy_quad_5(1, fl); 
  } else { 
    fUpwindQuad_l[5] = ser_1x2v_p2_surfvy_quad_5(-1, fc); 
  } 
  if (0.4472135954999579*alphaDrSurf_l[4]-0.6708203932499369*alphaDrSurf_l[1]+0.5*alphaDrSurf_l[0] > 0) { 
    fUpwindQuad_l[6] = ser_1x2v_p2_surfvy_quad_6(1, fl); 
  } else { 
    fUpwindQuad_l[6] = ser_1x2v_p2_surfvy_quad_6(-1, fc); 
  } 
  if (0.5*alphaDrSurf_l[0]-0.5590169943749475*alphaDrSurf_l[4] > 0) { 
    fUpwindQuad_l[7] = ser_1x2v_p2_surfvy_quad_7(1, fl); 
  } else { 
    fUpwindQuad_l[7] = ser_1x2v_p2_surfvy_quad_7(-1, fc); 
  } 
  if (0.4472135954999579*alphaDrSurf_l[4]+0.6708203932499369*alphaDrSurf_l[1]+0.5*alphaDrSurf_l[0] > 0) { 
    fUpwindQuad_l[8] = ser_1x2v_p2_surfvy_quad_8(1, fl); 
  } else { 
    fUpwindQuad_l[8] = ser_1x2v_p2_surfvy_quad_8(-1, fc); 
  } 
  if (0.4472135954999579*alphaDrSurf_r[4]-0.6708203932499369*alphaDrSurf_r[1]+0.5*alphaDrSurf_r[0] > 0) { 
    fUpwindQuad_r[0] = ser_1x2v_p2_surfvy_quad_0(1, fc); 
  } else { 
    fUpwindQuad_r[0] = ser_1x2v_p2_surfvy_quad_0(-1, fr); 
  } 
  if (0.5*alphaDrSurf_r[0]-0.5590169943749475*alphaDrSurf_r[4] > 0) { 
    fUpwindQuad_r[1] = ser_1x2v_p2_surfvy_quad_1(1, fc); 
  } else { 
    fUpwindQuad_r[1] = ser_1x2v_p2_surfvy_quad_1(-1, fr); 
  } 
  if (0.4472135954999579*alphaDrSurf_r[4]+0.6708203932499369*alphaDrSurf_r[1]+0.5*alphaDrSurf_r[0] > 0) { 
    fUpwindQuad_r[2] = ser_1x2v_p2_surfvy_quad_2(1, fc); 
  } else { 
    fUpwindQuad_r[2] = ser_1x2v_p2_surfvy_quad_2(-1, fr); 
  } 
  if (0.4472135954999579*alphaDrSurf_r[4]-0.6708203932499369*alphaDrSurf_r[1]+0.5*alphaDrSurf_r[0] > 0) { 
    fUpwindQuad_r[3] = ser_1x2v_p2_surfvy_quad_3(1, fc); 
  } else { 
    fUpwindQuad_r[3] = ser_1x2v_p2_surfvy_quad_3(-1, fr); 
  } 
  if (0.5*alphaDrSurf_r[0]-0.5590169943749475*alphaDrSurf_r[4] > 0) { 
    fUpwindQuad_r[4] = ser_1x2v_p2_surfvy_quad_4(1, fc); 
  } else { 
    fUpwindQuad_r[4] = ser_1x2v_p2_surfvy_quad_4(-1, fr); 
  } 
  if (0.4472135954999579*alphaDrSurf_r[4]+0.6708203932499369*alphaDrSurf_r[1]+0.5*alphaDrSurf_r[0] > 0) { 
    fUpwindQuad_r[5] = ser_1x2v_p2_surfvy_quad_5(1, fc); 
  } else { 
    fUpwindQuad_r[5] = ser_1x2v_p2_surfvy_quad_5(-1, fr); 
  } 
  if (0.4472135954999579*alphaDrSurf_r[4]-0.6708203932499369*alphaDrSurf_r[1]+0.5*alphaDrSurf_r[0] > 0) { 
    fUpwindQuad_r[6] = ser_1x2v_p2_surfvy_quad_6(1, fc); 
  } else { 
    fUpwindQuad_r[6] = ser_1x2v_p2_surfvy_quad_6(-1, fr); 
  } 
  if (0.5*alphaDrSurf_r[0]-0.5590169943749475*alphaDrSurf_r[4] > 0) { 
    fUpwindQuad_r[7] = ser_1x2v_p2_surfvy_quad_7(1, fc); 
  } else { 
    fUpwindQuad_r[7] = ser_1x2v_p2_surfvy_quad_7(-1, fr); 
  } 
  if (0.4472135954999579*alphaDrSurf_r[4]+0.6708203932499369*alphaDrSurf_r[1]+0.5*alphaDrSurf_r[0] > 0) { 
    fUpwindQuad_r[8] = ser_1x2v_p2_surfvy_quad_8(1, fc); 
  } else { 
    fUpwindQuad_r[8] = ser_1x2v_p2_surfvy_quad_8(-1, fr); 
  } 
  ...
  Gdiff2_r[5] = (-0.3518228202874282*nuVtSqSum[1]*fr[18])+0.3518228202874282*nuVtSqSum[1]*fc[18]-0.3518228202874282*nuVtSqSum[0]*fr[14]+0.3518228202874282*nuVtSqSum[0]*fc[14]+0.25*nuVtSqSum[1]*fr[12]+0.25*nuVtSqSum[1]*fc[12]+0.25*nuVtSqSum[0]*fr[8]+0.25*nuVtSqSum[0]*fc[8]; 
  ...
  Gdiff2_r[7] = (-0.3146798968793526*nuVtSqSum[2]*fr[18])-0.3518228202874282*nuVtSqSum[0]*fr[18]+0.3146798968793526*nuVtSqSum[2]*fc[18]+0.3518228202874282*nuVtSqSum[0]*fc[18]-0.3518228202874282*nuVtSqSum[1]*fr[14]+0.3518228202874282*nuVtSqSum[1]*fc[14]+0.223606797749979*nuVtSqSum[2]*fr[12]+0.25*nuVtSqSum[0]*fr[12]+0.223606797749979*nuVtSqSum[2]*fc[12]+0.25*nuVtSqSum[0]*fc[12]+0.25*nuVtSqSum[1]*fr[8]+0.25*nuVtSqSum[1]*fc[8]; 

  Gdiff_l[0] = (-0.6708203932499369*nuVtSqSum[1]*fl[15])+0.6708203932499369*nuVtSqSum[1]*fc[15]-1.190784930203603*nuVtSqSum[2]*fl[13]-1.190784930203603*nuVtSqSum[2]*fc[13]-0.6708203932499369*nuVtSqSum[0]*fl[9]+0.6708203932499369*nuVtSqSum[0]*fc[9]-0.9375*nuVtSqSum[2]*fl[7]+0.9375*nuVtSqSum[2]*fc[7]-1.190784930203603*nuVtSqSum[1]*fl[5]-1.190784930203603*nuVtSqSum[1]*fc[5]-1.190784930203603*nuVtSqSum[0]*fl[3]-1.190784930203603*nuVtSqSum[0]*fc[3]-0.9375*fl[1]*nuVtSqSum[1]+0.9375*fc[1]*nuVtSqSum[1]-0.9375*fl[0]*nuVtSqSum[0]+0.9375*fc[0]*nuVtSqSum[0]; 
  Gdiff_l[1] = (-0.5999999999999999*nuVtSqSum[2]*fl[15])-0.6708203932499369*nuVtSqSum[0]*fl[15]+0.5999999999999999*nuVtSqSum[2]*fc[15]+0.6708203932499369*nuVtSqSum[0]*fc[15]-1.06507042020704*nuVtSqSum[1]*fl[13]-1.06507042020704*nuVtSqSum[1]*fc[13]-0.6708203932499369*nuVtSqSum[1]*fl[9]+0.6708203932499369*nuVtSqSum[1]*fc[9]-0.8385254915624212*nuVtSqSum[1]*fl[7]+0.8385254915624212*nuVtSqSum[1]*fc[7]-1.06507042020704*nuVtSqSum[2]*fl[5]-1.190784930203603*nuVtSqSum[0]*fl[5]-1.06507042020704*nuVtSqSum[2]*fc[5]-1.190784930203603*nuVtSqSum[0]*fc[5]-1.190784930203603*nuVtSqSum[1]*fl[3]-1.190784930203603*nuVtSqSum[1]*fc[3]-0.8385254915624212*fl[1]*nuVtSqSum[2]+0.8385254915624212*fc[1]*nuVtSqSum[2]-0.9375*fl[0]*nuVtSqSum[1]+0.9375*fc[0]*nuVtSqSum[1]-0.9375*nuVtSqSum[0]*fl[1]+0.9375*nuVtSqSum[0]*fc[1]; 
  Gdiff_l[2] = (-0.6708203932499369*nuVtSqSum[1]*fl[19])+0.6708203932499369*nuVtSqSum[1]*fc[19]-1.190784930203603*nuVtSqSum[2]*fl[17]-1.190784930203603*nuVtSqSum[2]*fc[17]-0.6708203932499369*nuVtSqSum[0]*fl[16]+0.6708203932499369*nuVtSqSum[0]*fc[16]-0.9375000000000001*nuVtSqSum[2]*fl[11]+0.9375000000000001*nuVtSqSum[2]*fc[11]-1.190784930203603*nuVtSqSum[1]*fl[10]-1.190784930203603*nuVtSqSum[1]*fc[10]-1.190784930203603*nuVtSqSum[0]*fl[6]-1.190784930203603*nuVtSqSum[0]*fc[6]-0.9375*nuVtSqSum[1]*fl[4]+0.9375*nuVtSqSum[1]*fc[4]-0.9375*nuVtSqSum[0]*fl[2]+0.9375*nuVtSqSum[0]*fc[2]; 
  Gdiff_l[3] = (-0.6*nuVtSqSum[2]*fl[19])-0.6708203932499369*nuVtSqSum[0]*fl[19]+0.6*nuVtSqSum[2]*fc[19]+0.6708203932499369*nuVtSqSum[0]*fc[19]-1.06507042020704*nuVtSqSum[1]*fl[17]-1.06507042020704*nuVtSqSum[1]*fc[17]-0.6708203932499369*nuVtSqSum[1]*fl[16]+0.6708203932499369*nuVtSqSum[1]*fc[16]-0.8385254915624211*nuVtSqSum[1]*fl[11]+0.8385254915624211*nuVtSqSum[1]*fc[11]-1.06507042020704*nuVtSqSum[2]*fl[10]-1.190784930203603*nuVtSqSum[0]*fl[10]-1.06507042020704*nuVtSqSum[2]*fc[10]-1.190784930203603*nuVtSqSum[0]*fc[10]-1.190784930203603*nuVtSqSum[1]*fl[6]-1.190784930203603*nuVtSqSum[1]*fc[6]-0.8385254915624212*nuVtSqSum[2]*fl[4]-0.9375*nuVtSqSum[0]*fl[4]+0.8385254915624212*nuVtSqSum[2]*fc[4]+0.9375*nuVtSqSum[0]*fc[4]-0.9375*nuVtSqSum[1]*fl[2]+0.9375*nuVtSqSum[1]*fc[2]; 
  Gdiff_l[4] = (-0.5999999999999999*nuVtSqSum[1]*fl[15])+0.5999999999999999*nuVtSqSum[1]*fc[15]-0.7607645858621712*nuVtSqSum[2]*fl[13]-1.190784930203603*nuVtSqSum[0]*fl[13]-0.7607645858621712*nuVtSqSum[2]*fc[13]-1.190784930203603*nuVtSqSum[0]*fc[13]-0.6708203932499369*nuVtSqSum[2]*fl[9]+0.6708203932499369*nuVtSqSum[2]*fc[9]-0.5989467796874438*nuVtSqSum[2]*fl[7]-0.9375*nuVtSqSum[0]*fl[7]+0.5989467796874438*nuVtSqSum[2]*fc[7]+0.9375*nuVtSqSum[0]*fc[7]-1.06507042020704*nuVtSqSum[1]*fl[5]-1.06507042020704*nuVtSqSum[1]*fc[5]-1.190784930203603*nuVtSqSum[2]*fl[3]-1.190784930203603*nuVtSqSum[2]*fc[3]-0.9375*fl[0]*nuVtSqSum[2]+0.9375*fc[0]*nuVtSqSum[2]-0.8385254915624212*fl[1]*nuVtSqSum[1]+0.8385254915624212*fc[1]*nuVtSqSum[1]; 
  Gdiff_l[5] = (-1.190784930203603*nuVtSqSum[1]*fl[18])-1.190784930203603*nuVtSqSum[1]*fc[18]-1.190784930203603*nuVtSqSum[0]*fl[14]-1.190784930203603*nuVtSqSum[0]*fc[14]-0.9375000000000001*nuVtSqSum[1]*fl[12]+0.9375000000000001*nuVtSqSum[1]*fc[12]-0.9375*nuVtSqSum[0]*fl[8]+0.9375*nuVtSqSum[0]*fc[8]; 
  Gdiff_l[6] = (-0.5999999999999999*nuVtSqSum[1]*fl[19])+0.5999999999999999*nuVtSqSum[1]*fc[19]-0.7607645858621712*nuVtSqSum[2]*fl[17]-1.190784930203603*nuVtSqSum[0]*fl[17]-0.7607645858621712*nuVtSqSum[2]*fc[17]-1.190784930203603*nuVtSqSum[0]*fc[17]-0.6708203932499369*nuVtSqSum[2]*fl[16]+0.6708203932499369*nuVtSqSum[2]*fc[16]-0.5989467796874438*nuVtSqSum[2]*fl[11]-0.9375*nuVtSqSum[0]*fl[11]+0.5989467796874438*nuVtSqSum[2]*fc[11]+0.9375*nuVtSqSum[0]*fc[11]-1.06507042020704*nuVtSqSum[1]*fl[10]-1.06507042020704*nuVtSqSum[1]*fc[10]-1.190784930203603*nuVtSqSum[2]*fl[6]-1.190784930203603*nuVtSqSum[2]*fc[6]-0.8385254915624211*nuVtSqSum[1]*fl[4]+0.8385254915624211*nuVtSqSum[1]*fc[4]-0.9375000000000001*fl[2]*nuVtSqSum[2]+0.9375000000000001*fc[2]*nuVtSqSum[2]; 
  Gdiff_l[7] = (-1.06507042020704*nuVtSqSum[2]*fl[18])-1.190784930203603*nuVtSqSum[0]*fl[18]-1.06507042020704*nuVtSqSum[2]*fc[18]-1.190784930203603*nuVtSqSum[0]*fc[18]-1.190784930203603*nuVtSqSum[1]*fl[14]-1.190784930203603*nuVtSqSum[1]*fc[14]-0.8385254915624212*nuVtSqSum[2]*fl[12]-0.9375*nuVtSqSum[0]*fl[12]+0.8385254915624212*nuVtSqSum[2]*fc[12]+0.9375*nuVtSqSum[0]*fc[12]-0.9375000000000001*nuVtSqSum[1]*fl[8]+0.9375000000000001*nuVtSqSum[1]*fc[8]; 
  ...
  Gdiff_r[5] = (-1.190784930203603*nuVtSqSum[1]*fr[18])-1.190784930203603*nuVtSqSum[1]*fc[18]-1.190784930203603*nuVtSqSum[0]*fr[14]-1.190784930203603*nuVtSqSum[0]*fc[14]+0.9375000000000001*nuVtSqSum[1]*fr[12]-0.9375000000000001*nuVtSqSum[1]*fc[12]+0.9375*nuVtSqSum[0]*fr[8]-0.9375*nuVtSqSum[0]*fc[8]; 
  ...
  Ghat_r[5] = (-1.0*Gdiff_r[5]*rdv2)+0.5000000000000001*alphaDrSurf_r[1]*fUpwind_r[7]+0.5*alphaDrSurf_r[0]*fUpwind_r[5]; 
  ...
  Ghat_r[7] = (-1.0*Gdiff_r[7]*rdv2)+0.4472135954999579*alphaDrSurf_r[4]*fUpwind_r[7]+0.5*alphaDrSurf_r[0]*fUpwind_r[7]+0.5000000000000001*alphaDrSurf_r[1]*fUpwind_r[5]; 
