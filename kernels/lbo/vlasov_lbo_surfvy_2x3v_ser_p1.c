...
{ 
  ...
  alphaDrSurf_l[0] = 4.0*w[3]*nuSum-2.0*dxv[3]*nuSum-2.0*sumNuUy[0]; 
  alphaDrSurf_l[1] = -2.0*sumNuUy[1]; 
  alphaDrSurf_l[2] = -2.0*sumNuUy[2]; 
  alphaDrSurf_l[5] = -2.0*sumNuUy[3]; 

  double alphaDrSurf_r[16] = {0.0}; 
  alphaDrSurf_r[0] = 4.0*w[3]*nuSum+2.0*dxv[3]*nuSum-2.0*sumNuUy[0]; 
  alphaDrSurf_r[1] = -2.0*sumNuUy[1]; 
  alphaDrSurf_r[2] = -2.0*sumNuUy[2]; 
  alphaDrSurf_r[5] = -2.0*sumNuUy[3]; 
  ...
  Gdiff2_l[0] = 0.2041241452319315*nuVtSqSum[3]*fl[17]-0.2041241452319315*nuVtSqSum[3]*fc[17]+0.2041241452319315*nuVtSqSum[2]*fl[10]-0.2041241452319315*nuVtSqSum[2]*fc[10]+0.2041241452319315*nuVtSqSum[1]*fl[9]-0.2041241452319315*nuVtSqSum[1]*fc[9]+0.1767766952966368*nuVtSqSum[3]*fl[6]+0.1767766952966368*nuVtSqSum[3]*fc[6]+0.2041241452319315*nuVtSqSum[0]*fl[4]-0.2041241452319315*nuVtSqSum[0]*fc[4]+0.1767766952966368*fl[2]*nuVtSqSum[2]+0.1767766952966368*fc[2]*nuVtSqSum[2]+0.1767766952966368*fl[1]*nuVtSqSum[1]+0.1767766952966368*fc[1]*nuVtSqSum[1]+0.1767766952966368*fl[0]*nuVtSqSum[0]+0.1767766952966368*fc[0]*nuVtSqSum[0]; 
  Gdiff2_l[1] = 0.2041241452319315*nuVtSqSum[2]*fl[17]-0.2041241452319315*nuVtSqSum[2]*fc[17]+0.2041241452319315*nuVtSqSum[3]*fl[10]-0.2041241452319315*nuVtSqSum[3]*fc[10]+0.2041241452319315*nuVtSqSum[0]*fl[9]-0.2041241452319315*nuVtSqSum[0]*fc[9]+0.1767766952966368*nuVtSqSum[2]*fl[6]+0.1767766952966368*nuVtSqSum[2]*fc[6]+0.2041241452319315*nuVtSqSum[1]*fl[4]-0.2041241452319315*nuVtSqSum[1]*fc[4]+0.1767766952966368*fl[2]*nuVtSqSum[3]+0.1767766952966368*fc[2]*nuVtSqSum[3]+0.1767766952966368*fl[0]*nuVtSqSum[1]+0.1767766952966368*fc[0]*nuVtSqSum[1]+0.1767766952966368*nuVtSqSum[0]*fl[1]+0.1767766952966368*nuVtSqSum[0]*fc[1]; 
  Gdiff2_l[2] = 0.2041241452319315*nuVtSqSum[1]*fl[17]-0.2041241452319315*nuVtSqSum[1]*fc[17]+0.2041241452319315*nuVtSqSum[0]*fl[10]-0.2041241452319315*nuVtSqSum[0]*fc[10]+0.2041241452319315*nuVtSqSum[3]*fl[9]-0.2041241452319315*nuVtSqSum[3]*fc[9]+0.1767766952966368*nuVtSqSum[1]*fl[6]+0.1767766952966368*nuVtSqSum[1]*fc[6]+0.2041241452319315*nuVtSqSum[2]*fl[4]-0.2041241452319315*nuVtSqSum[2]*fc[4]+0.1767766952966368*fl[1]*nuVtSqSum[3]+0.1767766952966368*fc[1]*nuVtSqSum[3]+0.1767766952966368*fl[0]*nuVtSqSum[2]+0.1767766952966368*fc[0]*nuVtSqSum[2]+0.1767766952966368*nuVtSqSum[0]*fl[2]+0.1767766952966368*nuVtSqSum[0]*fc[2]; 
  Gdiff2_l[3] = 0.2041241452319315*nuVtSqSum[3]*fl[26]-0.2041241452319315*nuVtSqSum[3]*fc[26]+0.2041241452319315*nuVtSqSum[2]*fl[19]-0.2041241452319315*nuVtSqSum[2]*fc[19]+0.2041241452319315*nuVtSqSum[1]*fl[18]-0.2041241452319315*nuVtSqSum[1]*fc[18]+0.1767766952966368*nuVtSqSum[3]*fl[16]+0.1767766952966368*nuVtSqSum[3]*fc[16]+0.2041241452319315*nuVtSqSum[0]*fl[11]-0.2041241452319315*nuVtSqSum[0]*fc[11]+0.1767766952966368*nuVtSqSum[2]*fl[8]+0.1767766952966368*nuVtSqSum[2]*fc[8]+0.1767766952966368*nuVtSqSum[1]*fl[7]+0.1767766952966368*nuVtSqSum[1]*fc[7]+0.1767766952966368*nuVtSqSum[0]*fl[3]+0.1767766952966368*nuVtSqSum[0]*fc[3]; 
  Gdiff2_l[4] = 0.2041241452319315*nuVtSqSum[3]*fl[28]-0.2041241452319315*nuVtSqSum[3]*fc[28]+0.2041241452319315*nuVtSqSum[2]*fl[24]-0.2041241452319315*nuVtSqSum[2]*fc[24]+0.2041241452319315*nuVtSqSum[1]*fl[23]-0.2041241452319315*nuVtSqSum[1]*fc[23]+0.1767766952966368*nuVtSqSum[3]*fl[20]+0.1767766952966368*nuVtSqSum[3]*fc[20]+0.2041241452319315*nuVtSqSum[0]*fl[15]-0.2041241452319315*nuVtSqSum[0]*fc[15]+0.1767766952966368*nuVtSqSum[2]*fl[13]+0.1767766952966368*nuVtSqSum[2]*fc[13]+0.1767766952966368*nuVtSqSum[1]*fl[12]+0.1767766952966368*nuVtSqSum[1]*fc[12]+0.1767766952966368*nuVtSqSum[0]*fl[5]+0.1767766952966368*nuVtSqSum[0]*fc[5]; 
  Gdiff2_l[5] = 0.2041241452319315*nuVtSqSum[0]*fl[17]-0.2041241452319315*nuVtSqSum[0]*fc[17]+0.2041241452319315*nuVtSqSum[1]*fl[10]-0.2041241452319315*nuVtSqSum[1]*fc[10]+0.2041241452319315*nuVtSqSum[2]*fl[9]-0.2041241452319315*nuVtSqSum[2]*fc[9]+0.1767766952966368*nuVtSqSum[0]*fl[6]+0.1767766952966368*nuVtSqSum[0]*fc[6]+0.2041241452319315*nuVtSqSum[3]*fl[4]-0.2041241452319315*nuVtSqSum[3]*fc[4]+0.1767766952966368*fl[0]*nuVtSqSum[3]+0.1767766952966368*fc[0]*nuVtSqSum[3]+0.1767766952966368*fl[1]*nuVtSqSum[2]+0.1767766952966368*fc[1]*nuVtSqSum[2]+0.1767766952966368*nuVtSqSum[1]*fl[2]+0.1767766952966368*nuVtSqSum[1]*fc[2]; 
  Gdiff2_l[6] = 0.2041241452319315*nuVtSqSum[2]*fl[26]-0.2041241452319315*nuVtSqSum[2]*fc[26]+0.2041241452319315*nuVtSqSum[3]*fl[19]-0.2041241452319315*nuVtSqSum[3]*fc[19]+0.2041241452319315*nuVtSqSum[0]*fl[18]-0.2041241452319315*nuVtSqSum[0]*fc[18]+0.1767766952966368*nuVtSqSum[2]*fl[16]+0.1767766952966368*nuVtSqSum[2]*fc[16]+0.2041241452319315*nuVtSqSum[1]*fl[11]-0.2041241452319315*nuVtSqSum[1]*fc[11]+0.1767766952966368*nuVtSqSum[3]*fl[8]+0.1767766952966368*nuVtSqSum[3]*fc[8]+0.1767766952966368*nuVtSqSum[0]*fl[7]+0.1767766952966368*nuVtSqSum[0]*fc[7]+0.1767766952966368*nuVtSqSum[1]*fl[3]+0.1767766952966368*nuVtSqSum[1]*fc[3]; 
  Gdiff2_l[7] = 0.2041241452319315*nuVtSqSum[1]*fl[26]-0.2041241452319315*nuVtSqSum[1]*fc[26]+0.2041241452319315*nuVtSqSum[0]*fl[19]-0.2041241452319315*nuVtSqSum[0]*fc[19]+0.2041241452319315*nuVtSqSum[3]*fl[18]-0.2041241452319315*nuVtSqSum[3]*fc[18]+0.1767766952966368*nuVtSqSum[1]*fl[16]+0.1767766952966368*nuVtSqSum[1]*fc[16]+0.2041241452319315*nuVtSqSum[2]*fl[11]-0.2041241452319315*nuVtSqSum[2]*fc[11]+0.1767766952966368*nuVtSqSum[0]*fl[8]+0.1767766952966368*nuVtSqSum[0]*fc[8]+0.1767766952966368*nuVtSqSum[3]*fl[7]+0.1767766952966368*nuVtSqSum[3]*fc[7]+0.1767766952966368*nuVtSqSum[2]*fl[3]+0.1767766952966368*nuVtSqSum[2]*fc[3]; 
  Gdiff2_l[8] = 0.2041241452319315*nuVtSqSum[2]*fl[28]-0.2041241452319315*nuVtSqSum[2]*fc[28]+0.2041241452319315*nuVtSqSum[3]*fl[24]-0.2041241452319315*nuVtSqSum[3]*fc[24]+0.2041241452319315*nuVtSqSum[0]*fl[23]-0.2041241452319315*nuVtSqSum[0]*fc[23]+0.1767766952966368*nuVtSqSum[2]*fl[20]+0.1767766952966368*nuVtSqSum[2]*fc[20]+0.2041241452319315*nuVtSqSum[1]*fl[15]-0.2041241452319315*nuVtSqSum[1]*fc[15]+0.1767766952966368*nuVtSqSum[3]*fl[13]+0.1767766952966368*nuVtSqSum[3]*fc[13]+0.1767766952966368*nuVtSqSum[0]*fl[12]+0.1767766952966368*nuVtSqSum[0]*fc[12]+0.1767766952966368*nuVtSqSum[1]*fl[5]+0.1767766952966368*nuVtSqSum[1]*fc[5]; 
  Gdiff2_l[9] = 0.2041241452319315*nuVtSqSum[1]*fl[28]-0.2041241452319315*nuVtSqSum[1]*fc[28]+0.2041241452319315*nuVtSqSum[0]*fl[24]-0.2041241452319315*nuVtSqSum[0]*fc[24]+0.2041241452319315*nuVtSqSum[3]*fl[23]-0.2041241452319315*nuVtSqSum[3]*fc[23]+0.1767766952966368*nuVtSqSum[1]*fl[20]+0.1767766952966368*nuVtSqSum[1]*fc[20]+0.2041241452319315*nuVtSqSum[2]*fl[15]-0.2041241452319315*nuVtSqSum[2]*fc[15]+0.1767766952966368*nuVtSqSum[0]*fl[13]+0.1767766952966368*nuVtSqSum[0]*fc[13]+0.1767766952966368*nuVtSqSum[3]*fl[12]+0.1767766952966368*nuVtSqSum[3]*fc[12]+0.1767766952966368*nuVtSqSum[2]*fl[5]+0.1767766952966368*nuVtSqSum[2]*fc[5]; 
  Gdiff2_l[10] = 0.2041241452319315*nuVtSqSum[3]*fl[31]-0.2041241452319315*nuVtSqSum[3]*fc[31]+0.2041241452319315*nuVtSqSum[2]*fl[30]-0.2041241452319315*nuVtSqSum[2]*fc[30]+0.2041241452319315*nuVtSqSum[1]*fl[29]-0.2041241452319315*nuVtSqSum[1]*fc[29]+0.1767766952966368*nuVtSqSum[3]*fl[27]+0.1767766952966368*nuVtSqSum[3]*fc[27]+0.2041241452319315*nuVtSqSum[0]*fl[25]-0.2041241452319315*nuVtSqSum[0]*fc[25]+0.1767766952966368*nuVtSqSum[2]*fl[22]+0.1767766952966368*nuVtSqSum[2]*fc[22]+0.1767766952966368*nuVtSqSum[1]*fl[21]+0.1767766952966368*nuVtSqSum[1]*fc[21]+0.1767766952966368*nuVtSqSum[0]*fl[14]+0.1767766952966368*nuVtSqSum[0]*fc[14]; 
  Gdiff2_l[11] = 0.2041241452319315*nuVtSqSum[0]*fl[26]-0.2041241452319315*nuVtSqSum[0]*fc[26]+0.2041241452319315*nuVtSqSum[1]*fl[19]-0.2041241452319315*nuVtSqSum[1]*fc[19]+0.2041241452319315*nuVtSqSum[2]*fl[18]-0.2041241452319315*nuVtSqSum[2]*fc[18]+0.1767766952966368*nuVtSqSum[0]*fl[16]+0.1767766952966368*nuVtSqSum[0]*fc[16]+0.2041241452319315*nuVtSqSum[3]*fl[11]-0.2041241452319315*nuVtSqSum[3]*fc[11]+0.1767766952966368*nuVtSqSum[1]*fl[8]+0.1767766952966368*nuVtSqSum[1]*fc[8]+0.1767766952966368*nuVtSqSum[2]*fl[7]+0.1767766952966368*nuVtSqSum[2]*fc[7]+0.1767766952966368*fl[3]*nuVtSqSum[3]+0.1767766952966368*fc[3]*nuVtSqSum[3]; 
  Gdiff2_l[12] = 0.2041241452319315*nuVtSqSum[0]*fl[28]-0.2041241452319315*nuVtSqSum[0]*fc[28]+0.2041241452319315*nuVtSqSum[1]*fl[24]-0.2041241452319315*nuVtSqSum[1]*fc[24]+0.2041241452319315*nuVtSqSum[2]*fl[23]-0.2041241452319315*nuVtSqSum[2]*fc[23]+0.1767766952966368*nuVtSqSum[0]*fl[20]+0.1767766952966368*nuVtSqSum[0]*fc[20]+0.2041241452319315*nuVtSqSum[3]*fl[15]-0.2041241452319315*nuVtSqSum[3]*fc[15]+0.1767766952966368*nuVtSqSum[1]*fl[13]+0.1767766952966368*nuVtSqSum[1]*fc[13]+0.1767766952966368*nuVtSqSum[2]*fl[12]+0.1767766952966368*nuVtSqSum[2]*fc[12]+0.1767766952966368*nuVtSqSum[3]*fl[5]+0.1767766952966368*nuVtSqSum[3]*fc[5]; 
  Gdiff2_l[13] = 0.2041241452319315*nuVtSqSum[2]*fl[31]-0.2041241452319315*nuVtSqSum[2]*fc[31]+0.2041241452319315*nuVtSqSum[3]*fl[30]-0.2041241452319315*nuVtSqSum[3]*fc[30]+0.2041241452319315*nuVtSqSum[0]*fl[29]-0.2041241452319315*nuVtSqSum[0]*fc[29]+0.1767766952966368*nuVtSqSum[2]*fl[27]+0.1767766952966368*nuVtSqSum[2]*fc[27]+0.2041241452319315*nuVtSqSum[1]*fl[25]-0.2041241452319315*nuVtSqSum[1]*fc[25]+0.1767766952966368*nuVtSqSum[3]*fl[22]+0.1767766952966368*nuVtSqSum[3]*fc[22]+0.1767766952966368*nuVtSqSum[0]*fl[21]+0.1767766952966368*nuVtSqSum[0]*fc[21]+0.1767766952966368*nuVtSqSum[1]*fl[14]+0.1767766952966368*nuVtSqSum[1]*fc[14]; 
  Gdiff2_l[14] = 0.2041241452319315*nuVtSqSum[1]*fl[31]-0.2041241452319315*nuVtSqSum[1]*fc[31]+0.2041241452319315*nuVtSqSum[0]*fl[30]-0.2041241452319315*nuVtSqSum[0]*fc[30]+0.2041241452319315*nuVtSqSum[3]*fl[29]-0.2041241452319315*nuVtSqSum[3]*fc[29]+0.1767766952966368*nuVtSqSum[1]*fl[27]+0.1767766952966368*nuVtSqSum[1]*fc[27]+0.2041241452319315*nuVtSqSum[2]*fl[25]-0.2041241452319315*nuVtSqSum[2]*fc[25]+0.1767766952966368*nuVtSqSum[0]*fl[22]+0.1767766952966368*nuVtSqSum[0]*fc[22]+0.1767766952966368*nuVtSqSum[3]*fl[21]+0.1767766952966368*nuVtSqSum[3]*fc[21]+0.1767766952966368*nuVtSqSum[2]*fl[14]+0.1767766952966368*nuVtSqSum[2]*fc[14]; 
  Gdiff2_l[15] = 0.2041241452319315*nuVtSqSum[0]*fl[31]-0.2041241452319315*nuVtSqSum[0]*fc[31]+0.2041241452319315*nuVtSqSum[1]*fl[30]-0.2041241452319315*nuVtSqSum[1]*fc[30]+0.2041241452319315*nuVtSqSum[2]*fl[29]-0.2041241452319315*nuVtSqSum[2]*fc[29]+0.1767766952966368*nuVtSqSum[0]*fl[27]+0.1767766952966368*nuVtSqSum[0]*fc[27]+0.2041241452319315*nuVtSqSum[3]*fl[25]-0.2041241452319315*nuVtSqSum[3]*fc[25]+0.1767766952966368*nuVtSqSum[1]*fl[22]+0.1767766952966368*nuVtSqSum[1]*fc[22]+0.1767766952966368*nuVtSqSum[2]*fl[21]+0.1767766952966368*nuVtSqSum[2]*fc[21]+0.1767766952966368*nuVtSqSum[3]*fl[14]+0.1767766952966368*nuVtSqSum[3]*fc[14]; 

  Gdiff2_r[0] = (-0.2041241452319315*nuVtSqSum[3]*fr[17])+0.2041241452319315*nuVtSqSum[3]*fc[17]-0.2041241452319315*nuVtSqSum[2]*fr[10]+0.2041241452319315*nuVtSqSum[2]*fc[10]-0.2041241452319315*nuVtSqSum[1]*fr[9]+0.2041241452319315*nuVtSqSum[1]*fc[9]+0.1767766952966368*nuVtSqSum[3]*fr[6]+0.1767766952966368*nuVtSqSum[3]*fc[6]-0.2041241452319315*nuVtSqSum[0]*fr[4]+0.2041241452319315*nuVtSqSum[0]*fc[4]+0.1767766952966368*fr[2]*nuVtSqSum[2]+0.1767766952966368*fc[2]*nuVtSqSum[2]+0.1767766952966368*fr[1]*nuVtSqSum[1]+0.1767766952966368*fc[1]*nuVtSqSum[1]+0.1767766952966368*fr[0]*nuVtSqSum[0]+0.1767766952966368*fc[0]*nuVtSqSum[0]; 
  Gdiff2_r[1] = (-0.2041241452319315*nuVtSqSum[2]*fr[17])+0.2041241452319315*nuVtSqSum[2]*fc[17]-0.2041241452319315*nuVtSqSum[3]*fr[10]+0.2041241452319315*nuVtSqSum[3]*fc[10]-0.2041241452319315*nuVtSqSum[0]*fr[9]+0.2041241452319315*nuVtSqSum[0]*fc[9]+0.1767766952966368*nuVtSqSum[2]*fr[6]+0.1767766952966368*nuVtSqSum[2]*fc[6]-0.2041241452319315*nuVtSqSum[1]*fr[4]+0.2041241452319315*nuVtSqSum[1]*fc[4]+0.1767766952966368*fr[2]*nuVtSqSum[3]+0.1767766952966368*fc[2]*nuVtSqSum[3]+0.1767766952966368*fr[0]*nuVtSqSum[1]+0.1767766952966368*fc[0]*nuVtSqSum[1]+0.1767766952966368*nuVtSqSum[0]*fr[1]+0.1767766952966368*nuVtSqSum[0]*fc[1]; 
  Gdiff2_r[2] = (-0.2041241452319315*nuVtSqSum[1]*fr[17])+0.2041241452319315*nuVtSqSum[1]*fc[17]-0.2041241452319315*nuVtSqSum[0]*fr[10]+0.2041241452319315*nuVtSqSum[0]*fc[10]-0.2041241452319315*nuVtSqSum[3]*fr[9]+0.2041241452319315*nuVtSqSum[3]*fc[9]+0.1767766952966368*nuVtSqSum[1]*fr[6]+0.1767766952966368*nuVtSqSum[1]*fc[6]-0.2041241452319315*nuVtSqSum[2]*fr[4]+0.2041241452319315*nuVtSqSum[2]*fc[4]+0.1767766952966368*fr[1]*nuVtSqSum[3]+0.1767766952966368*fc[1]*nuVtSqSum[3]+0.1767766952966368*fr[0]*nuVtSqSum[2]+0.1767766952966368*fc[0]*nuVtSqSum[2]+0.1767766952966368*nuVtSqSum[0]*fr[2]+0.1767766952966368*nuVtSqSum[0]*fc[2]; 
  Gdiff2_r[3] = (-0.2041241452319315*nuVtSqSum[3]*fr[26])+0.2041241452319315*nuVtSqSum[3]*fc[26]-0.2041241452319315*nuVtSqSum[2]*fr[19]+0.2041241452319315*nuVtSqSum[2]*fc[19]-0.2041241452319315*nuVtSqSum[1]*fr[18]+0.2041241452319315*nuVtSqSum[1]*fc[18]+0.1767766952966368*nuVtSqSum[3]*fr[16]+0.1767766952966368*nuVtSqSum[3]*fc[16]-0.2041241452319315*nuVtSqSum[0]*fr[11]+0.2041241452319315*nuVtSqSum[0]*fc[11]+0.1767766952966368*nuVtSqSum[2]*fr[8]+0.1767766952966368*nuVtSqSum[2]*fc[8]+0.1767766952966368*nuVtSqSum[1]*fr[7]+0.1767766952966368*nuVtSqSum[1]*fc[7]+0.1767766952966368*nuVtSqSum[0]*fr[3]+0.1767766952966368*nuVtSqSum[0]*fc[3]; 
  Gdiff2_r[4] = (-0.2041241452319315*nuVtSqSum[3]*fr[28])+0.2041241452319315*nuVtSqSum[3]*fc[28]-0.2041241452319315*nuVtSqSum[2]*fr[24]+0.2041241452319315*nuVtSqSum[2]*fc[24]-0.2041241452319315*nuVtSqSum[1]*fr[23]+0.2041241452319315*nuVtSqSum[1]*fc[23]+0.1767766952966368*nuVtSqSum[3]*fr[20]+0.1767766952966368*nuVtSqSum[3]*fc[20]-0.2041241452319315*nuVtSqSum[0]*fr[15]+0.2041241452319315*nuVtSqSum[0]*fc[15]+0.1767766952966368*nuVtSqSum[2]*fr[13]+0.1767766952966368*nuVtSqSum[2]*fc[13]+0.1767766952966368*nuVtSqSum[1]*fr[12]+0.1767766952966368*nuVtSqSum[1]*fc[12]+0.1767766952966368*nuVtSqSum[0]*fr[5]+0.1767766952966368*nuVtSqSum[0]*fc[5]; 
  Gdiff2_r[5] = (-0.2041241452319315*nuVtSqSum[0]*fr[17])+0.2041241452319315*nuVtSqSum[0]*fc[17]-0.2041241452319315*nuVtSqSum[1]*fr[10]+0.2041241452319315*nuVtSqSum[1]*fc[10]-0.2041241452319315*nuVtSqSum[2]*fr[9]+0.2041241452319315*nuVtSqSum[2]*fc[9]+0.1767766952966368*nuVtSqSum[0]*fr[6]+0.1767766952966368*nuVtSqSum[0]*fc[6]-0.2041241452319315*nuVtSqSum[3]*fr[4]+0.2041241452319315*nuVtSqSum[3]*fc[4]+0.1767766952966368*fr[0]*nuVtSqSum[3]+0.1767766952966368*fc[0]*nuVtSqSum[3]+0.1767766952966368*fr[1]*nuVtSqSum[2]+0.1767766952966368*fc[1]*nuVtSqSum[2]+0.1767766952966368*nuVtSqSum[1]*fr[2]+0.1767766952966368*nuVtSqSum[1]*fc[2]; 
  Gdiff2_r[6] = (-0.2041241452319315*nuVtSqSum[2]*fr[26])+0.2041241452319315*nuVtSqSum[2]*fc[26]-0.2041241452319315*nuVtSqSum[3]*fr[19]+0.2041241452319315*nuVtSqSum[3]*fc[19]-0.2041241452319315*nuVtSqSum[0]*fr[18]+0.2041241452319315*nuVtSqSum[0]*fc[18]+0.1767766952966368*nuVtSqSum[2]*fr[16]+0.1767766952966368*nuVtSqSum[2]*fc[16]-0.2041241452319315*nuVtSqSum[1]*fr[11]+0.2041241452319315*nuVtSqSum[1]*fc[11]+0.1767766952966368*nuVtSqSum[3]*fr[8]+0.1767766952966368*nuVtSqSum[3]*fc[8]+0.1767766952966368*nuVtSqSum[0]*fr[7]+0.1767766952966368*nuVtSqSum[0]*fc[7]+0.1767766952966368*nuVtSqSum[1]*fr[3]+0.1767766952966368*nuVtSqSum[1]*fc[3]; 
  Gdiff2_r[7] = (-0.2041241452319315*nuVtSqSum[1]*fr[26])+0.2041241452319315*nuVtSqSum[1]*fc[26]-0.2041241452319315*nuVtSqSum[0]*fr[19]+0.2041241452319315*nuVtSqSum[0]*fc[19]-0.2041241452319315*nuVtSqSum[3]*fr[18]+0.2041241452319315*nuVtSqSum[3]*fc[18]+0.1767766952966368*nuVtSqSum[1]*fr[16]+0.1767766952966368*nuVtSqSum[1]*fc[16]-0.2041241452319315*nuVtSqSum[2]*fr[11]+0.2041241452319315*nuVtSqSum[2]*fc[11]+0.1767766952966368*nuVtSqSum[0]*fr[8]+0.1767766952966368*nuVtSqSum[0]*fc[8]+0.1767766952966368*nuVtSqSum[3]*fr[7]+0.1767766952966368*nuVtSqSum[3]*fc[7]+0.1767766952966368*nuVtSqSum[2]*fr[3]+0.1767766952966368*nuVtSqSum[2]*fc[3]; 
  Gdiff2_r[8] = (-0.2041241452319315*nuVtSqSum[2]*fr[28])+0.2041241452319315*nuVtSqSum[2]*fc[28]-0.2041241452319315*nuVtSqSum[3]*fr[24]+0.2041241452319315*nuVtSqSum[3]*fc[24]-0.2041241452319315*nuVtSqSum[0]*fr[23]+0.2041241452319315*nuVtSqSum[0]*fc[23]+0.1767766952966368*nuVtSqSum[2]*fr[20]+0.1767766952966368*nuVtSqSum[2]*fc[20]-0.2041241452319315*nuVtSqSum[1]*fr[15]+0.2041241452319315*nuVtSqSum[1]*fc[15]+0.1767766952966368*nuVtSqSum[3]*fr[13]+0.1767766952966368*nuVtSqSum[3]*fc[13]+0.1767766952966368*nuVtSqSum[0]*fr[12]+0.1767766952966368*nuVtSqSum[0]*fc[12]+0.1767766952966368*nuVtSqSum[1]*fr[5]+0.1767766952966368*nuVtSqSum[1]*fc[5]; 
  Gdiff2_r[9] = (-0.2041241452319315*nuVtSqSum[1]*fr[28])+0.2041241452319315*nuVtSqSum[1]*fc[28]-0.2041241452319315*nuVtSqSum[0]*fr[24]+0.2041241452319315*nuVtSqSum[0]*fc[24]-0.2041241452319315*nuVtSqSum[3]*fr[23]+0.2041241452319315*nuVtSqSum[3]*fc[23]+0.1767766952966368*nuVtSqSum[1]*fr[20]+0.1767766952966368*nuVtSqSum[1]*fc[20]-0.2041241452319315*nuVtSqSum[2]*fr[15]+0.2041241452319315*nuVtSqSum[2]*fc[15]+0.1767766952966368*nuVtSqSum[0]*fr[13]+0.1767766952966368*nuVtSqSum[0]*fc[13]+0.1767766952966368*nuVtSqSum[3]*fr[12]+0.1767766952966368*nuVtSqSum[3]*fc[12]+0.1767766952966368*nuVtSqSum[2]*fr[5]+0.1767766952966368*nuVtSqSum[2]*fc[5]; 
  Gdiff2_r[10] = (-0.2041241452319315*nuVtSqSum[3]*fr[31])+0.2041241452319315*nuVtSqSum[3]*fc[31]-0.2041241452319315*nuVtSqSum[2]*fr[30]+0.2041241452319315*nuVtSqSum[2]*fc[30]-0.2041241452319315*nuVtSqSum[1]*fr[29]+0.2041241452319315*nuVtSqSum[1]*fc[29]+0.1767766952966368*nuVtSqSum[3]*fr[27]+0.1767766952966368*nuVtSqSum[3]*fc[27]-0.2041241452319315*nuVtSqSum[0]*fr[25]+0.2041241452319315*nuVtSqSum[0]*fc[25]+0.1767766952966368*nuVtSqSum[2]*fr[22]+0.1767766952966368*nuVtSqSum[2]*fc[22]+0.1767766952966368*nuVtSqSum[1]*fr[21]+0.1767766952966368*nuVtSqSum[1]*fc[21]+0.1767766952966368*nuVtSqSum[0]*fr[14]+0.1767766952966368*nuVtSqSum[0]*fc[14]; 
  Gdiff2_r[11] = (-0.2041241452319315*nuVtSqSum[0]*fr[26])+0.2041241452319315*nuVtSqSum[0]*fc[26]-0.2041241452319315*nuVtSqSum[1]*fr[19]+0.2041241452319315*nuVtSqSum[1]*fc[19]-0.2041241452319315*nuVtSqSum[2]*fr[18]+0.2041241452319315*nuVtSqSum[2]*fc[18]+0.1767766952966368*nuVtSqSum[0]*fr[16]+0.1767766952966368*nuVtSqSum[0]*fc[16]-0.2041241452319315*nuVtSqSum[3]*fr[11]+0.2041241452319315*nuVtSqSum[3]*fc[11]+0.1767766952966368*nuVtSqSum[1]*fr[8]+0.1767766952966368*nuVtSqSum[1]*fc[8]+0.1767766952966368*nuVtSqSum[2]*fr[7]+0.1767766952966368*nuVtSqSum[2]*fc[7]+0.1767766952966368*fr[3]*nuVtSqSum[3]+0.1767766952966368*fc[3]*nuVtSqSum[3]; 
  Gdiff2_r[12] = (-0.2041241452319315*nuVtSqSum[0]*fr[28])+0.2041241452319315*nuVtSqSum[0]*fc[28]-0.2041241452319315*nuVtSqSum[1]*fr[24]+0.2041241452319315*nuVtSqSum[1]*fc[24]-0.2041241452319315*nuVtSqSum[2]*fr[23]+0.2041241452319315*nuVtSqSum[2]*fc[23]+0.1767766952966368*nuVtSqSum[0]*fr[20]+0.1767766952966368*nuVtSqSum[0]*fc[20]-0.2041241452319315*nuVtSqSum[3]*fr[15]+0.2041241452319315*nuVtSqSum[3]*fc[15]+0.1767766952966368*nuVtSqSum[1]*fr[13]+0.1767766952966368*nuVtSqSum[1]*fc[13]+0.1767766952966368*nuVtSqSum[2]*fr[12]+0.1767766952966368*nuVtSqSum[2]*fc[12]+0.1767766952966368*nuVtSqSum[3]*fr[5]+0.1767766952966368*nuVtSqSum[3]*fc[5]; 
  Gdiff2_r[13] = (-0.2041241452319315*nuVtSqSum[2]*fr[31])+0.2041241452319315*nuVtSqSum[2]*fc[31]-0.2041241452319315*nuVtSqSum[3]*fr[30]+0.2041241452319315*nuVtSqSum[3]*fc[30]-0.2041241452319315*nuVtSqSum[0]*fr[29]+0.2041241452319315*nuVtSqSum[0]*fc[29]+0.1767766952966368*nuVtSqSum[2]*fr[27]+0.1767766952966368*nuVtSqSum[2]*fc[27]-0.2041241452319315*nuVtSqSum[1]*fr[25]+0.2041241452319315*nuVtSqSum[1]*fc[25]+0.1767766952966368*nuVtSqSum[3]*fr[22]+0.1767766952966368*nuVtSqSum[3]*fc[22]+0.1767766952966368*nuVtSqSum[0]*fr[21]+0.1767766952966368*nuVtSqSum[0]*fc[21]+0.1767766952966368*nuVtSqSum[1]*fr[14]+0.1767766952966368*nuVtSqSum[1]*fc[14]; 
  Gdiff2_r[14] = (-0.2041241452319315*nuVtSqSum[1]*fr[31])+0.2041241452319315*nuVtSqSum[1]*fc[31]-0.2041241452319315*nuVtSqSum[0]*fr[30]+0.2041241452319315*nuVtSqSum[0]*fc[30]-0.2041241452319315*nuVtSqSum[3]*fr[29]+0.2041241452319315*nuVtSqSum[3]*fc[29]+0.1767766952966368*nuVtSqSum[1]*fr[27]+0.1767766952966368*nuVtSqSum[1]*fc[27]-0.2041241452319315*nuVtSqSum[2]*fr[25]+0.2041241452319315*nuVtSqSum[2]*fc[25]+0.1767766952966368*nuVtSqSum[0]*fr[22]+0.1767766952966368*nuVtSqSum[0]*fc[22]+0.1767766952966368*nuVtSqSum[3]*fr[21]+0.1767766952966368*nuVtSqSum[3]*fc[21]+0.1767766952966368*nuVtSqSum[2]*fr[14]+0.1767766952966368*nuVtSqSum[2]*fc[14]; 
  Gdiff2_r[15] = (-0.2041241452319315*nuVtSqSum[0]*fr[31])+0.2041241452319315*nuVtSqSum[0]*fc[31]-0.2041241452319315*nuVtSqSum[1]*fr[30]+0.2041241452319315*nuVtSqSum[1]*fc[30]-0.2041241452319315*nuVtSqSum[2]*fr[29]+0.2041241452319315*nuVtSqSum[2]*fc[29]+0.1767766952966368*nuVtSqSum[0]*fr[27]+0.1767766952966368*nuVtSqSum[0]*fc[27]-0.2041241452319315*nuVtSqSum[3]*fr[25]+0.2041241452319315*nuVtSqSum[3]*fc[25]+0.1767766952966368*nuVtSqSum[1]*fr[22]+0.1767766952966368*nuVtSqSum[1]*fc[22]+0.1767766952966368*nuVtSqSum[2]*fr[21]+0.1767766952966368*nuVtSqSum[2]*fc[21]+0.1767766952966368*nuVtSqSum[3]*fr[14]+0.1767766952966368*nuVtSqSum[3]*fc[14]; 

  Gdiff_l[0] = (-0.3827327723098713*nuVtSqSum[3]*fl[17])-0.3827327723098713*nuVtSqSum[3]*fc[17]-0.3827327723098713*nuVtSqSum[2]*fl[10]-0.3827327723098713*nuVtSqSum[2]*fc[10]-0.3827327723098713*nuVtSqSum[1]*fl[9]-0.3827327723098713*nuVtSqSum[1]*fc[9]-0.3977475644174328*nuVtSqSum[3]*fl[6]+0.3977475644174328*nuVtSqSum[3]*fc[6]-0.3827327723098713*nuVtSqSum[0]*fl[4]-0.3827327723098713*nuVtSqSum[0]*fc[4]-0.3977475644174328*fl[2]*nuVtSqSum[2]+0.3977475644174328*fc[2]*nuVtSqSum[2]-0.3977475644174328*fl[1]*nuVtSqSum[1]+0.3977475644174328*fc[1]*nuVtSqSum[1]-0.3977475644174328*fl[0]*nuVtSqSum[0]+0.3977475644174328*fc[0]*nuVtSqSum[0]; 
  Gdiff_l[1] = (-0.3827327723098713*nuVtSqSum[2]*fl[17])-0.3827327723098713*nuVtSqSum[2]*fc[17]-0.3827327723098713*nuVtSqSum[3]*fl[10]-0.3827327723098713*nuVtSqSum[3]*fc[10]-0.3827327723098713*nuVtSqSum[0]*fl[9]-0.3827327723098713*nuVtSqSum[0]*fc[9]-0.3977475644174328*nuVtSqSum[2]*fl[6]+0.3977475644174328*nuVtSqSum[2]*fc[6]-0.3827327723098713*nuVtSqSum[1]*fl[4]-0.3827327723098713*nuVtSqSum[1]*fc[4]-0.3977475644174328*fl[2]*nuVtSqSum[3]+0.3977475644174328*fc[2]*nuVtSqSum[3]-0.3977475644174328*fl[0]*nuVtSqSum[1]+0.3977475644174328*fc[0]*nuVtSqSum[1]-0.3977475644174328*nuVtSqSum[0]*fl[1]+0.3977475644174328*nuVtSqSum[0]*fc[1]; 
  Gdiff_l[2] = (-0.3827327723098713*nuVtSqSum[1]*fl[17])-0.3827327723098713*nuVtSqSum[1]*fc[17]-0.3827327723098713*nuVtSqSum[0]*fl[10]-0.3827327723098713*nuVtSqSum[0]*fc[10]-0.3827327723098713*nuVtSqSum[3]*fl[9]-0.3827327723098713*nuVtSqSum[3]*fc[9]-0.3977475644174328*nuVtSqSum[1]*fl[6]+0.3977475644174328*nuVtSqSum[1]*fc[6]-0.3827327723098713*nuVtSqSum[2]*fl[4]-0.3827327723098713*nuVtSqSum[2]*fc[4]-0.3977475644174328*fl[1]*nuVtSqSum[3]+0.3977475644174328*fc[1]*nuVtSqSum[3]-0.3977475644174328*fl[0]*nuVtSqSum[2]+0.3977475644174328*fc[0]*nuVtSqSum[2]-0.3977475644174328*nuVtSqSum[0]*fl[2]+0.3977475644174328*nuVtSqSum[0]*fc[2]; 
  Gdiff_l[3] = (-0.3827327723098713*nuVtSqSum[3]*fl[26])-0.3827327723098713*nuVtSqSum[3]*fc[26]-0.3827327723098713*nuVtSqSum[2]*fl[19]-0.3827327723098713*nuVtSqSum[2]*fc[19]-0.3827327723098713*nuVtSqSum[1]*fl[18]-0.3827327723098713*nuVtSqSum[1]*fc[18]-0.3977475644174328*nuVtSqSum[3]*fl[16]+0.3977475644174328*nuVtSqSum[3]*fc[16]-0.3827327723098713*nuVtSqSum[0]*fl[11]-0.3827327723098713*nuVtSqSum[0]*fc[11]-0.3977475644174328*nuVtSqSum[2]*fl[8]+0.3977475644174328*nuVtSqSum[2]*fc[8]-0.3977475644174328*nuVtSqSum[1]*fl[7]+0.3977475644174328*nuVtSqSum[1]*fc[7]-0.3977475644174328*nuVtSqSum[0]*fl[3]+0.3977475644174328*nuVtSqSum[0]*fc[3]; 
  Gdiff_l[4] = (-0.3827327723098713*nuVtSqSum[3]*fl[28])-0.3827327723098713*nuVtSqSum[3]*fc[28]-0.3827327723098713*nuVtSqSum[2]*fl[24]-0.3827327723098713*nuVtSqSum[2]*fc[24]-0.3827327723098713*nuVtSqSum[1]*fl[23]-0.3827327723098713*nuVtSqSum[1]*fc[23]-0.3977475644174328*nuVtSqSum[3]*fl[20]+0.3977475644174328*nuVtSqSum[3]*fc[20]-0.3827327723098713*nuVtSqSum[0]*fl[15]-0.3827327723098713*nuVtSqSum[0]*fc[15]-0.3977475644174328*nuVtSqSum[2]*fl[13]+0.3977475644174328*nuVtSqSum[2]*fc[13]-0.3977475644174328*nuVtSqSum[1]*fl[12]+0.3977475644174328*nuVtSqSum[1]*fc[12]-0.3977475644174328*nuVtSqSum[0]*fl[5]+0.3977475644174328*nuVtSqSum[0]*fc[5]; 
  Gdiff_l[5] = (-0.3827327723098713*nuVtSqSum[0]*fl[17])-0.3827327723098713*nuVtSqSum[0]*fc[17]-0.3827327723098713*nuVtSqSum[1]*fl[10]-0.3827327723098713*nuVtSqSum[1]*fc[10]-0.3827327723098713*nuVtSqSum[2]*fl[9]-0.3827327723098713*nuVtSqSum[2]*fc[9]-0.3977475644174328*nuVtSqSum[0]*fl[6]+0.3977475644174328*nuVtSqSum[0]*fc[6]-0.3827327723098713*nuVtSqSum[3]*fl[4]-0.3827327723098713*nuVtSqSum[3]*fc[4]-0.3977475644174328*fl[0]*nuVtSqSum[3]+0.3977475644174328*fc[0]*nuVtSqSum[3]-0.3977475644174328*fl[1]*nuVtSqSum[2]+0.3977475644174328*fc[1]*nuVtSqSum[2]-0.3977475644174328*nuVtSqSum[1]*fl[2]+0.3977475644174328*nuVtSqSum[1]*fc[2]; 
  Gdiff_l[6] = (-0.3827327723098713*nuVtSqSum[2]*fl[26])-0.3827327723098713*nuVtSqSum[2]*fc[26]-0.3827327723098713*nuVtSqSum[3]*fl[19]-0.3827327723098713*nuVtSqSum[3]*fc[19]-0.3827327723098713*nuVtSqSum[0]*fl[18]-0.3827327723098713*nuVtSqSum[0]*fc[18]-0.3977475644174328*nuVtSqSum[2]*fl[16]+0.3977475644174328*nuVtSqSum[2]*fc[16]-0.3827327723098713*nuVtSqSum[1]*fl[11]-0.3827327723098713*nuVtSqSum[1]*fc[11]-0.3977475644174328*nuVtSqSum[3]*fl[8]+0.3977475644174328*nuVtSqSum[3]*fc[8]-0.3977475644174328*nuVtSqSum[0]*fl[7]+0.3977475644174328*nuVtSqSum[0]*fc[7]-0.3977475644174328*nuVtSqSum[1]*fl[3]+0.3977475644174328*nuVtSqSum[1]*fc[3]; 
  Gdiff_l[7] = (-0.3827327723098713*nuVtSqSum[1]*fl[26])-0.3827327723098713*nuVtSqSum[1]*fc[26]-0.3827327723098713*nuVtSqSum[0]*fl[19]-0.3827327723098713*nuVtSqSum[0]*fc[19]-0.3827327723098713*nuVtSqSum[3]*fl[18]-0.3827327723098713*nuVtSqSum[3]*fc[18]-0.3977475644174328*nuVtSqSum[1]*fl[16]+0.3977475644174328*nuVtSqSum[1]*fc[16]-0.3827327723098713*nuVtSqSum[2]*fl[11]-0.3827327723098713*nuVtSqSum[2]*fc[11]-0.3977475644174328*nuVtSqSum[0]*fl[8]+0.3977475644174328*nuVtSqSum[0]*fc[8]-0.3977475644174328*nuVtSqSum[3]*fl[7]+0.3977475644174328*nuVtSqSum[3]*fc[7]-0.3977475644174328*nuVtSqSum[2]*fl[3]+0.3977475644174328*nuVtSqSum[2]*fc[3]; 
  Gdiff_l[8] = (-0.3827327723098713*nuVtSqSum[2]*fl[28])-0.3827327723098713*nuVtSqSum[2]*fc[28]-0.3827327723098713*nuVtSqSum[3]*fl[24]-0.3827327723098713*nuVtSqSum[3]*fc[24]-0.3827327723098713*nuVtSqSum[0]*fl[23]-0.3827327723098713*nuVtSqSum[0]*fc[23]-0.3977475644174328*nuVtSqSum[2]*fl[20]+0.3977475644174328*nuVtSqSum[2]*fc[20]-0.3827327723098713*nuVtSqSum[1]*fl[15]-0.3827327723098713*nuVtSqSum[1]*fc[15]-0.3977475644174328*nuVtSqSum[3]*fl[13]+0.3977475644174328*nuVtSqSum[3]*fc[13]-0.3977475644174328*nuVtSqSum[0]*fl[12]+0.3977475644174328*nuVtSqSum[0]*fc[12]-0.3977475644174328*nuVtSqSum[1]*fl[5]+0.3977475644174328*nuVtSqSum[1]*fc[5]; 
  Gdiff_l[9] = (-0.3827327723098713*nuVtSqSum[1]*fl[28])-0.3827327723098713*nuVtSqSum[1]*fc[28]-0.3827327723098713*nuVtSqSum[0]*fl[24]-0.3827327723098713*nuVtSqSum[0]*fc[24]-0.3827327723098713*nuVtSqSum[3]*fl[23]-0.3827327723098713*nuVtSqSum[3]*fc[23]-0.3977475644174328*nuVtSqSum[1]*fl[20]+0.3977475644174328*nuVtSqSum[1]*fc[20]-0.3827327723098713*nuVtSqSum[2]*fl[15]-0.3827327723098713*nuVtSqSum[2]*fc[15]-0.3977475644174328*nuVtSqSum[0]*fl[13]+0.3977475644174328*nuVtSqSum[0]*fc[13]-0.3977475644174328*nuVtSqSum[3]*fl[12]+0.3977475644174328*nuVtSqSum[3]*fc[12]-0.3977475644174328*nuVtSqSum[2]*fl[5]+0.3977475644174328*nuVtSqSum[2]*fc[5]; 
  Gdiff_l[10] = (-0.3827327723098713*nuVtSqSum[3]*fl[31])-0.3827327723098713*nuVtSqSum[3]*fc[31]-0.3827327723098713*nuVtSqSum[2]*fl[30]-0.3827327723098713*nuVtSqSum[2]*fc[30]-0.3827327723098713*nuVtSqSum[1]*fl[29]-0.3827327723098713*nuVtSqSum[1]*fc[29]-0.3977475644174328*nuVtSqSum[3]*fl[27]+0.3977475644174328*nuVtSqSum[3]*fc[27]-0.3827327723098713*nuVtSqSum[0]*fl[25]-0.3827327723098713*nuVtSqSum[0]*fc[25]-0.3977475644174328*nuVtSqSum[2]*fl[22]+0.3977475644174328*nuVtSqSum[2]*fc[22]-0.3977475644174328*nuVtSqSum[1]*fl[21]+0.3977475644174328*nuVtSqSum[1]*fc[21]-0.3977475644174328*nuVtSqSum[0]*fl[14]+0.3977475644174328*nuVtSqSum[0]*fc[14]; 
  Gdiff_l[11] = (-0.3827327723098713*nuVtSqSum[0]*fl[26])-0.3827327723098713*nuVtSqSum[0]*fc[26]-0.3827327723098713*nuVtSqSum[1]*fl[19]-0.3827327723098713*nuVtSqSum[1]*fc[19]-0.3827327723098713*nuVtSqSum[2]*fl[18]-0.3827327723098713*nuVtSqSum[2]*fc[18]-0.3977475644174328*nuVtSqSum[0]*fl[16]+0.3977475644174328*nuVtSqSum[0]*fc[16]-0.3827327723098713*nuVtSqSum[3]*fl[11]-0.3827327723098713*nuVtSqSum[3]*fc[11]-0.3977475644174328*nuVtSqSum[1]*fl[8]+0.3977475644174328*nuVtSqSum[1]*fc[8]-0.3977475644174328*nuVtSqSum[2]*fl[7]+0.3977475644174328*nuVtSqSum[2]*fc[7]-0.3977475644174328*fl[3]*nuVtSqSum[3]+0.3977475644174328*fc[3]*nuVtSqSum[3]; 
  Gdiff_l[12] = (-0.3827327723098713*nuVtSqSum[0]*fl[28])-0.3827327723098713*nuVtSqSum[0]*fc[28]-0.3827327723098713*nuVtSqSum[1]*fl[24]-0.3827327723098713*nuVtSqSum[1]*fc[24]-0.3827327723098713*nuVtSqSum[2]*fl[23]-0.3827327723098713*nuVtSqSum[2]*fc[23]-0.3977475644174328*nuVtSqSum[0]*fl[20]+0.3977475644174328*nuVtSqSum[0]*fc[20]-0.3827327723098713*nuVtSqSum[3]*fl[15]-0.3827327723098713*nuVtSqSum[3]*fc[15]-0.3977475644174328*nuVtSqSum[1]*fl[13]+0.3977475644174328*nuVtSqSum[1]*fc[13]-0.3977475644174328*nuVtSqSum[2]*fl[12]+0.3977475644174328*nuVtSqSum[2]*fc[12]-0.3977475644174328*nuVtSqSum[3]*fl[5]+0.3977475644174328*nuVtSqSum[3]*fc[5]; 
  Gdiff_l[13] = (-0.3827327723098713*nuVtSqSum[2]*fl[31])-0.3827327723098713*nuVtSqSum[2]*fc[31]-0.3827327723098713*nuVtSqSum[3]*fl[30]-0.3827327723098713*nuVtSqSum[3]*fc[30]-0.3827327723098713*nuVtSqSum[0]*fl[29]-0.3827327723098713*nuVtSqSum[0]*fc[29]-0.3977475644174328*nuVtSqSum[2]*fl[27]+0.3977475644174328*nuVtSqSum[2]*fc[27]-0.3827327723098713*nuVtSqSum[1]*fl[25]-0.3827327723098713*nuVtSqSum[1]*fc[25]-0.3977475644174328*nuVtSqSum[3]*fl[22]+0.3977475644174328*nuVtSqSum[3]*fc[22]-0.3977475644174328*nuVtSqSum[0]*fl[21]+0.3977475644174328*nuVtSqSum[0]*fc[21]-0.3977475644174328*nuVtSqSum[1]*fl[14]+0.3977475644174328*nuVtSqSum[1]*fc[14]; 
  Gdiff_l[14] = (-0.3827327723098713*nuVtSqSum[1]*fl[31])-0.3827327723098713*nuVtSqSum[1]*fc[31]-0.3827327723098713*nuVtSqSum[0]*fl[30]-0.3827327723098713*nuVtSqSum[0]*fc[30]-0.3827327723098713*nuVtSqSum[3]*fl[29]-0.3827327723098713*nuVtSqSum[3]*fc[29]-0.3977475644174328*nuVtSqSum[1]*fl[27]+0.3977475644174328*nuVtSqSum[1]*fc[27]-0.3827327723098713*nuVtSqSum[2]*fl[25]-0.3827327723098713*nuVtSqSum[2]*fc[25]-0.3977475644174328*nuVtSqSum[0]*fl[22]+0.3977475644174328*nuVtSqSum[0]*fc[22]-0.3977475644174328*nuVtSqSum[3]*fl[21]+0.3977475644174328*nuVtSqSum[3]*fc[21]-0.3977475644174328*nuVtSqSum[2]*fl[14]+0.3977475644174328*nuVtSqSum[2]*fc[14]; 
  Gdiff_l[15] = (-0.3827327723098713*nuVtSqSum[0]*fl[31])-0.3827327723098713*nuVtSqSum[0]*fc[31]-0.3827327723098713*nuVtSqSum[1]*fl[30]-0.3827327723098713*nuVtSqSum[1]*fc[30]-0.3827327723098713*nuVtSqSum[2]*fl[29]-0.3827327723098713*nuVtSqSum[2]*fc[29]-0.3977475644174328*nuVtSqSum[0]*fl[27]+0.3977475644174328*nuVtSqSum[0]*fc[27]-0.3827327723098713*nuVtSqSum[3]*fl[25]-0.3827327723098713*nuVtSqSum[3]*fc[25]-0.3977475644174328*nuVtSqSum[1]*fl[22]+0.3977475644174328*nuVtSqSum[1]*fc[22]-0.3977475644174328*nuVtSqSum[2]*fl[21]+0.3977475644174328*nuVtSqSum[2]*fc[21]-0.3977475644174328*nuVtSqSum[3]*fl[14]+0.3977475644174328*nuVtSqSum[3]*fc[14]; 

  Gdiff_r[0] = (-0.3827327723098713*nuVtSqSum[3]*fr[17])-0.3827327723098713*nuVtSqSum[3]*fc[17]-0.3827327723098713*nuVtSqSum[2]*fr[10]-0.3827327723098713*nuVtSqSum[2]*fc[10]-0.3827327723098713*nuVtSqSum[1]*fr[9]-0.3827327723098713*nuVtSqSum[1]*fc[9]+0.3977475644174328*nuVtSqSum[3]*fr[6]-0.3977475644174328*nuVtSqSum[3]*fc[6]-0.3827327723098713*nuVtSqSum[0]*fr[4]-0.3827327723098713*nuVtSqSum[0]*fc[4]+0.3977475644174328*fr[2]*nuVtSqSum[2]-0.3977475644174328*fc[2]*nuVtSqSum[2]+0.3977475644174328*fr[1]*nuVtSqSum[1]-0.3977475644174328*fc[1]*nuVtSqSum[1]+0.3977475644174328*fr[0]*nuVtSqSum[0]-0.3977475644174328*fc[0]*nuVtSqSum[0]; 
  Gdiff_r[1] = (-0.3827327723098713*nuVtSqSum[2]*fr[17])-0.3827327723098713*nuVtSqSum[2]*fc[17]-0.3827327723098713*nuVtSqSum[3]*fr[10]-0.3827327723098713*nuVtSqSum[3]*fc[10]-0.3827327723098713*nuVtSqSum[0]*fr[9]-0.3827327723098713*nuVtSqSum[0]*fc[9]+0.3977475644174328*nuVtSqSum[2]*fr[6]-0.3977475644174328*nuVtSqSum[2]*fc[6]-0.3827327723098713*nuVtSqSum[1]*fr[4]-0.3827327723098713*nuVtSqSum[1]*fc[4]+0.3977475644174328*fr[2]*nuVtSqSum[3]-0.3977475644174328*fc[2]*nuVtSqSum[3]+0.3977475644174328*fr[0]*nuVtSqSum[1]-0.3977475644174328*fc[0]*nuVtSqSum[1]+0.3977475644174328*nuVtSqSum[0]*fr[1]-0.3977475644174328*nuVtSqSum[0]*fc[1]; 
  Gdiff_r[2] = (-0.3827327723098713*nuVtSqSum[1]*fr[17])-0.3827327723098713*nuVtSqSum[1]*fc[17]-0.3827327723098713*nuVtSqSum[0]*fr[10]-0.3827327723098713*nuVtSqSum[0]*fc[10]-0.3827327723098713*nuVtSqSum[3]*fr[9]-0.3827327723098713*nuVtSqSum[3]*fc[9]+0.3977475644174328*nuVtSqSum[1]*fr[6]-0.3977475644174328*nuVtSqSum[1]*fc[6]-0.3827327723098713*nuVtSqSum[2]*fr[4]-0.3827327723098713*nuVtSqSum[2]*fc[4]+0.3977475644174328*fr[1]*nuVtSqSum[3]-0.3977475644174328*fc[1]*nuVtSqSum[3]+0.3977475644174328*fr[0]*nuVtSqSum[2]-0.3977475644174328*fc[0]*nuVtSqSum[2]+0.3977475644174328*nuVtSqSum[0]*fr[2]-0.3977475644174328*nuVtSqSum[0]*fc[2]; 
  Gdiff_r[3] = (-0.3827327723098713*nuVtSqSum[3]*fr[26])-0.3827327723098713*nuVtSqSum[3]*fc[26]-0.3827327723098713*nuVtSqSum[2]*fr[19]-0.3827327723098713*nuVtSqSum[2]*fc[19]-0.3827327723098713*nuVtSqSum[1]*fr[18]-0.3827327723098713*nuVtSqSum[1]*fc[18]+0.3977475644174328*nuVtSqSum[3]*fr[16]-0.3977475644174328*nuVtSqSum[3]*fc[16]-0.3827327723098713*nuVtSqSum[0]*fr[11]-0.3827327723098713*nuVtSqSum[0]*fc[11]+0.3977475644174328*nuVtSqSum[2]*fr[8]-0.3977475644174328*nuVtSqSum[2]*fc[8]+0.3977475644174328*nuVtSqSum[1]*fr[7]-0.3977475644174328*nuVtSqSum[1]*fc[7]+0.3977475644174328*nuVtSqSum[0]*fr[3]-0.3977475644174328*nuVtSqSum[0]*fc[3]; 
  Gdiff_r[4] = (-0.3827327723098713*nuVtSqSum[3]*fr[28])-0.3827327723098713*nuVtSqSum[3]*fc[28]-0.3827327723098713*nuVtSqSum[2]*fr[24]-0.3827327723098713*nuVtSqSum[2]*fc[24]-0.3827327723098713*nuVtSqSum[1]*fr[23]-0.3827327723098713*nuVtSqSum[1]*fc[23]+0.3977475644174328*nuVtSqSum[3]*fr[20]-0.3977475644174328*nuVtSqSum[3]*fc[20]-0.3827327723098713*nuVtSqSum[0]*fr[15]-0.3827327723098713*nuVtSqSum[0]*fc[15]+0.3977475644174328*nuVtSqSum[2]*fr[13]-0.3977475644174328*nuVtSqSum[2]*fc[13]+0.3977475644174328*nuVtSqSum[1]*fr[12]-0.3977475644174328*nuVtSqSum[1]*fc[12]+0.3977475644174328*nuVtSqSum[0]*fr[5]-0.3977475644174328*nuVtSqSum[0]*fc[5]; 
  Gdiff_r[5] = (-0.3827327723098713*nuVtSqSum[0]*fr[17])-0.3827327723098713*nuVtSqSum[0]*fc[17]-0.3827327723098713*nuVtSqSum[1]*fr[10]-0.3827327723098713*nuVtSqSum[1]*fc[10]-0.3827327723098713*nuVtSqSum[2]*fr[9]-0.3827327723098713*nuVtSqSum[2]*fc[9]+0.3977475644174328*nuVtSqSum[0]*fr[6]-0.3977475644174328*nuVtSqSum[0]*fc[6]-0.3827327723098713*nuVtSqSum[3]*fr[4]-0.3827327723098713*nuVtSqSum[3]*fc[4]+0.3977475644174328*fr[0]*nuVtSqSum[3]-0.3977475644174328*fc[0]*nuVtSqSum[3]+0.3977475644174328*fr[1]*nuVtSqSum[2]-0.3977475644174328*fc[1]*nuVtSqSum[2]+0.3977475644174328*nuVtSqSum[1]*fr[2]-0.3977475644174328*nuVtSqSum[1]*fc[2]; 
  Gdiff_r[6] = (-0.3827327723098713*nuVtSqSum[2]*fr[26])-0.3827327723098713*nuVtSqSum[2]*fc[26]-0.3827327723098713*nuVtSqSum[3]*fr[19]-0.3827327723098713*nuVtSqSum[3]*fc[19]-0.3827327723098713*nuVtSqSum[0]*fr[18]-0.3827327723098713*nuVtSqSum[0]*fc[18]+0.3977475644174328*nuVtSqSum[2]*fr[16]-0.3977475644174328*nuVtSqSum[2]*fc[16]-0.3827327723098713*nuVtSqSum[1]*fr[11]-0.3827327723098713*nuVtSqSum[1]*fc[11]+0.3977475644174328*nuVtSqSum[3]*fr[8]-0.3977475644174328*nuVtSqSum[3]*fc[8]+0.3977475644174328*nuVtSqSum[0]*fr[7]-0.3977475644174328*nuVtSqSum[0]*fc[7]+0.3977475644174328*nuVtSqSum[1]*fr[3]-0.3977475644174328*nuVtSqSum[1]*fc[3]; 
  Gdiff_r[7] = (-0.3827327723098713*nuVtSqSum[1]*fr[26])-0.3827327723098713*nuVtSqSum[1]*fc[26]-0.3827327723098713*nuVtSqSum[0]*fr[19]-0.3827327723098713*nuVtSqSum[0]*fc[19]-0.3827327723098713*nuVtSqSum[3]*fr[18]-0.3827327723098713*nuVtSqSum[3]*fc[18]+0.3977475644174328*nuVtSqSum[1]*fr[16]-0.3977475644174328*nuVtSqSum[1]*fc[16]-0.3827327723098713*nuVtSqSum[2]*fr[11]-0.3827327723098713*nuVtSqSum[2]*fc[11]+0.3977475644174328*nuVtSqSum[0]*fr[8]-0.3977475644174328*nuVtSqSum[0]*fc[8]+0.3977475644174328*nuVtSqSum[3]*fr[7]-0.3977475644174328*nuVtSqSum[3]*fc[7]+0.3977475644174328*nuVtSqSum[2]*fr[3]-0.3977475644174328*nuVtSqSum[2]*fc[3]; 
  Gdiff_r[8] = (-0.3827327723098713*nuVtSqSum[2]*fr[28])-0.3827327723098713*nuVtSqSum[2]*fc[28]-0.3827327723098713*nuVtSqSum[3]*fr[24]-0.3827327723098713*nuVtSqSum[3]*fc[24]-0.3827327723098713*nuVtSqSum[0]*fr[23]-0.3827327723098713*nuVtSqSum[0]*fc[23]+0.3977475644174328*nuVtSqSum[2]*fr[20]-0.3977475644174328*nuVtSqSum[2]*fc[20]-0.3827327723098713*nuVtSqSum[1]*fr[15]-0.3827327723098713*nuVtSqSum[1]*fc[15]+0.3977475644174328*nuVtSqSum[3]*fr[13]-0.3977475644174328*nuVtSqSum[3]*fc[13]+0.3977475644174328*nuVtSqSum[0]*fr[12]-0.3977475644174328*nuVtSqSum[0]*fc[12]+0.3977475644174328*nuVtSqSum[1]*fr[5]-0.3977475644174328*nuVtSqSum[1]*fc[5]; 
  Gdiff_r[9] = (-0.3827327723098713*nuVtSqSum[1]*fr[28])-0.3827327723098713*nuVtSqSum[1]*fc[28]-0.3827327723098713*nuVtSqSum[0]*fr[24]-0.3827327723098713*nuVtSqSum[0]*fc[24]-0.3827327723098713*nuVtSqSum[3]*fr[23]-0.3827327723098713*nuVtSqSum[3]*fc[23]+0.3977475644174328*nuVtSqSum[1]*fr[20]-0.3977475644174328*nuVtSqSum[1]*fc[20]-0.3827327723098713*nuVtSqSum[2]*fr[15]-0.3827327723098713*nuVtSqSum[2]*fc[15]+0.3977475644174328*nuVtSqSum[0]*fr[13]-0.3977475644174328*nuVtSqSum[0]*fc[13]+0.3977475644174328*nuVtSqSum[3]*fr[12]-0.3977475644174328*nuVtSqSum[3]*fc[12]+0.3977475644174328*nuVtSqSum[2]*fr[5]-0.3977475644174328*nuVtSqSum[2]*fc[5]; 
  Gdiff_r[10] = (-0.3827327723098713*nuVtSqSum[3]*fr[31])-0.3827327723098713*nuVtSqSum[3]*fc[31]-0.3827327723098713*nuVtSqSum[2]*fr[30]-0.3827327723098713*nuVtSqSum[2]*fc[30]-0.3827327723098713*nuVtSqSum[1]*fr[29]-0.3827327723098713*nuVtSqSum[1]*fc[29]+0.3977475644174328*nuVtSqSum[3]*fr[27]-0.3977475644174328*nuVtSqSum[3]*fc[27]-0.3827327723098713*nuVtSqSum[0]*fr[25]-0.3827327723098713*nuVtSqSum[0]*fc[25]+0.3977475644174328*nuVtSqSum[2]*fr[22]-0.3977475644174328*nuVtSqSum[2]*fc[22]+0.3977475644174328*nuVtSqSum[1]*fr[21]-0.3977475644174328*nuVtSqSum[1]*fc[21]+0.3977475644174328*nuVtSqSum[0]*fr[14]-0.3977475644174328*nuVtSqSum[0]*fc[14]; 
  Gdiff_r[11] = (-0.3827327723098713*nuVtSqSum[0]*fr[26])-0.3827327723098713*nuVtSqSum[0]*fc[26]-0.3827327723098713*nuVtSqSum[1]*fr[19]-0.3827327723098713*nuVtSqSum[1]*fc[19]-0.3827327723098713*nuVtSqSum[2]*fr[18]-0.3827327723098713*nuVtSqSum[2]*fc[18]+0.3977475644174328*nuVtSqSum[0]*fr[16]-0.3977475644174328*nuVtSqSum[0]*fc[16]-0.3827327723098713*nuVtSqSum[3]*fr[11]-0.3827327723098713*nuVtSqSum[3]*fc[11]+0.3977475644174328*nuVtSqSum[1]*fr[8]-0.3977475644174328*nuVtSqSum[1]*fc[8]+0.3977475644174328*nuVtSqSum[2]*fr[7]-0.3977475644174328*nuVtSqSum[2]*fc[7]+0.3977475644174328*fr[3]*nuVtSqSum[3]-0.3977475644174328*fc[3]*nuVtSqSum[3]; 
  ...
  Ghat_r[0] = (-1.0*Gdiff_r[0]*rdv2)+0.25*alphaDrSurf_r[5]*fUpwind_r[5]+0.25*alphaDrSurf_r[2]*fUpwind_r[2]+0.25*alphaDrSurf_r[1]*fUpwind_r[1]+0.25*alphaDrSurf_r[0]*fUpwind_r[0]; 
  Ghat_r[1] = (-1.0*Gdiff_r[1]*rdv2)+0.25*alphaDrSurf_r[2]*fUpwind_r[5]+0.25*fUpwind_r[2]*alphaDrSurf_r[5]+0.25*alphaDrSurf_r[0]*fUpwind_r[1]+0.25*fUpwind_r[0]*alphaDrSurf_r[1]; 
  Ghat_r[2] = (-1.0*Gdiff_r[2]*rdv2)+0.25*alphaDrSurf_r[1]*fUpwind_r[5]+0.25*fUpwind_r[1]*alphaDrSurf_r[5]+0.25*alphaDrSurf_r[0]*fUpwind_r[2]+0.25*fUpwind_r[0]*alphaDrSurf_r[2]; 
  Ghat_r[3] = (-1.0*Gdiff_r[3]*rdv2)+0.25*alphaDrSurf_r[5]*fUpwind_r[11]+0.25*alphaDrSurf_r[2]*fUpwind_r[7]+0.25*alphaDrSurf_r[1]*fUpwind_r[6]+0.25*alphaDrSurf_r[0]*fUpwind_r[3]; 
  Ghat_r[4] = (-1.0*Gdiff_r[4]*rdv2)+0.25*alphaDrSurf_r[5]*fUpwind_r[12]+0.25*alphaDrSurf_r[2]*fUpwind_r[9]+0.25*alphaDrSurf_r[1]*fUpwind_r[8]+0.25*alphaDrSurf_r[0]*fUpwind_r[4]; 
  Ghat_r[5] = (-1.0*Gdiff_r[5]*rdv2)+0.25*alphaDrSurf_r[0]*fUpwind_r[5]+0.25*fUpwind_r[0]*alphaDrSurf_r[5]+0.25*alphaDrSurf_r[1]*fUpwind_r[2]+0.25*fUpwind_r[1]*alphaDrSurf_r[2]; 
  Ghat_r[6] = (-1.0*Gdiff_r[6]*rdv2)+0.25*alphaDrSurf_r[2]*fUpwind_r[11]+0.25*alphaDrSurf_r[5]*fUpwind_r[7]+0.25*alphaDrSurf_r[0]*fUpwind_r[6]+0.25*alphaDrSurf_r[1]*fUpwind_r[3]; 
  Ghat_r[7] = (-1.0*Gdiff_r[7]*rdv2)+0.25*alphaDrSurf_r[1]*fUpwind_r[11]+0.25*alphaDrSurf_r[0]*fUpwind_r[7]+0.25*alphaDrSurf_r[5]*fUpwind_r[6]+0.25*alphaDrSurf_r[2]*fUpwind_r[3]; 
  Ghat_r[8] = (-1.0*Gdiff_r[8]*rdv2)+0.25*alphaDrSurf_r[2]*fUpwind_r[12]+0.25*alphaDrSurf_r[5]*fUpwind_r[9]+0.25*alphaDrSurf_r[0]*fUpwind_r[8]+0.25*alphaDrSurf_r[1]*fUpwind_r[4]; 
  Ghat_r[9] = (-1.0*Gdiff_r[9]*rdv2)+0.25*alphaDrSurf_r[1]*fUpwind_r[12]+0.25*alphaDrSurf_r[0]*fUpwind_r[9]+0.25*alphaDrSurf_r[5]*fUpwind_r[8]+0.25*alphaDrSurf_r[2]*fUpwind_r[4]; 
  Ghat_r[10] = (-1.0*Gdiff_r[10]*rdv2)+0.25*alphaDrSurf_r[5]*fUpwind_r[15]+0.25*alphaDrSurf_r[2]*fUpwind_r[14]+0.25*alphaDrSurf_r[1]*fUpwind_r[13]+0.25*alphaDrSurf_r[0]*fUpwind_r[10]; 
  Ghat_r[11] = (-1.0*Gdiff_r[11]*rdv2)+0.25*alphaDrSurf_r[0]*fUpwind_r[11]+0.25*alphaDrSurf_r[1]*fUpwind_r[7]+0.25*alphaDrSurf_r[2]*fUpwind_r[6]+0.25*fUpwind_r[3]*alphaDrSurf_r[5]; 
  Ghat_r[12] = (-1.0*Gdiff_r[12]*rdv2)+0.25*alphaDrSurf_r[0]*fUpwind_r[12]+0.25*alphaDrSurf_r[1]*fUpwind_r[9]+0.25*alphaDrSurf_r[2]*fUpwind_r[8]+0.25*fUpwind_r[4]*alphaDrSurf_r[5]; 
  Ghat_r[13] = (-1.0*Gdiff_r[13]*rdv2)+0.25*alphaDrSurf_r[2]*fUpwind_r[15]+0.25*alphaDrSurf_r[5]*fUpwind_r[14]+0.25*alphaDrSurf_r[0]*fUpwind_r[13]+0.25*alphaDrSurf_r[1]*fUpwind_r[10]; 
  Ghat_r[14] = (-1.0*Gdiff_r[14]*rdv2)+0.25*alphaDrSurf_r[1]*fUpwind_r[15]+0.25*alphaDrSurf_r[0]*fUpwind_r[14]+0.25*alphaDrSurf_r[5]*fUpwind_r[13]+0.25*alphaDrSurf_r[2]*fUpwind_r[10]; 
  Ghat_r[15] = (-1.0*Gdiff_r[15]*rdv2)+0.25*alphaDrSurf_r[0]*fUpwind_r[15]+0.25*alphaDrSurf_r[1]*fUpwind_r[14]+0.25*alphaDrSurf_r[2]*fUpwind_r[13]+0.25*alphaDrSurf_r[5]*fUpwind_r[10]; 
  ...
  out[9] += 1.224744871391589*Gdiff2_r[1]*rdvSq4-1.224744871391589*Gdiff2_l[1]*rdvSq4-1.224744871391589*Ghat_r[1]*rdv2-1.224744871391589*Ghat_l[1]*rdv2; 
  out[10] += 1.224744871391589*Gdiff2_r[2]*rdvSq4-1.224744871391589*Gdiff2_l[2]*rdvSq4-1.224744871391589*Ghat_r[2]*rdv2-1.224744871391589*Ghat_l[2]*rdv2; 
  out[11] += 1.224744871391589*Gdiff2_r[3]*rdvSq4-1.224744871391589*Gdiff2_l[3]*rdvSq4-1.224744871391589*Ghat_r[3]*rdv2-1.224744871391589*Ghat_l[3]*rdv2; 
  ...
  out[14] += 0.7071067811865475*Ghat_l[10]*rdv2-0.7071067811865475*Ghat_r[10]*rdv2; 
  ...
  out[26] += 1.224744871391589*Gdiff2_r[11]*rdvSq4-1.224744871391589*Gdiff2_l[11]*rdvSq4-1.224744871391589*Ghat_r[11]*rdv2-1.224744871391589*Ghat_l[11]*rdv2; 
  out[27] += 0.7071067811865475*Ghat_l[15]*rdv2-0.7071067811865475*Ghat_r[15]*rdv2; 
