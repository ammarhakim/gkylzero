...
GKYL_CU_DH void vlasov_with_fluid_cross_prim_moments_1x1v_ser_p2(struct gkyl_mat *A, struct gkyl_mat *rhs, const double *greene, const double m_self,
...
GKYL_CU_DH void vlasov_with_fluid_self_prim_moments_1x2v_ser_p2(struct gkyl_mat *A, struct gkyl_mat *rhs,
  const double *moms, const double *fluid, const double *boundary_corrections); 
GKYL_CU_DH void vlasov_with_fluid_cross_prim_moments_1x2v_ser_p2(struct gkyl_mat *A, struct gkyl_mat *rhs, const double *greene, const double m_self,
  const double *u_self, const double *vtsq_self, const double m_other, const double *u_other,
  const double *vtsq_other, const double *moms, const double *fluid, const double *boundary_corrections); 

GKYL_CU_DH void vlasov_with_fluid_self_prim_moments_2x2v_ser_p2(struct gkyl_mat *A, struct gkyl_mat *rhs,
  const double *moms, const double *fluid, const double *boundary_corrections); 
GKYL_CU_DH void vlasov_with_fluid_cross_prim_moments_2x2v_ser_p2(struct gkyl_mat *A, struct gkyl_mat *rhs, const double *greene, const double m_self,
  const double *u_self, const double *vtsq_self, const double m_other, const double *u_other,
  const double *vtsq_other, const double *moms, const double *fluid, const double *boundary_corrections); 
