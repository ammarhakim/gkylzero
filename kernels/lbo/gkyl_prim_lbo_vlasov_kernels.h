...
GKYL_CU_DH void vlasov_self_prim_moments_1x1v_tensor_p2(struct gkyl_mat *A, struct gkyl_mat *rhs, const double *moms, const double *boundary_corrections);
...
GKYL_CU_DH void vlasov_self_prim_moments_1x3v_tensor_p2(struct gkyl_mat *A, struct gkyl_mat *rhs, const double *moms, const double *boundary_corrections);
