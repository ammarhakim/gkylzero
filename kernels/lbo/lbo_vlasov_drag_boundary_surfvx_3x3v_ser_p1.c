...
GKYL_CU_DH void lbo_vlasov_drag_boundary_surfvx_3x3v_ser_p1(const double *w, const double *dxv, const double *nuSum, const double *nuUSum, const double *nuVtSqSum, const int edge, const double *fSkin, const double *fEdge, double* GKYL_RESTRICT out) 
{ 
  ...
  alphaDrSurf[0] = nuSum[0]*(2.0*w[3]+dxv[3])-2.0*sumNuUx[0]; 
  alphaDrSurf[1] = nuSum[1]*(2.0*w[3]+dxv[3])-2.0*sumNuUx[1]; 
  alphaDrSurf[2] = nuSum[2]*(2.0*w[3]+dxv[3])-2.0*sumNuUx[2]; 
  alphaDrSurf[3] = 2.0*nuSum[3]*w[3]-2.0*sumNuUx[3]+dxv[3]*nuSum[3]; 
  alphaDrSurf[6] = (2.0*w[3]+dxv[3])*nuSum[4]-2.0*sumNuUx[4]; 
  alphaDrSurf[7] = (2.0*w[3]+dxv[3])*nuSum[5]-2.0*sumNuUx[5]; 
  alphaDrSurf[8] = (2.0*w[3]+dxv[3])*nuSum[6]-2.0*sumNuUx[6]; 
  alphaDrSurf[16] = (2.0*w[3]+dxv[3])*nuSum[7]-2.0*sumNuUx[7]; 
  ...
  out[10] += 1.224744871391589*drag_incr[1]*rdv2; 
  out[11] += 1.224744871391589*drag_incr[2]*rdv2; 
  out[12] += 1.224744871391589*drag_incr[3]*rdv2; 
  out[13] += 0.7071067811865475*drag_incr[9]*rdv2; 
  out[14] += 0.7071067811865475*drag_incr[10]*rdv2; 
  out[15] += 0.7071067811865475*drag_incr[11]*rdv2; 
  ...
  out[35] += 1.224744871391589*drag_incr[12]*rdv2; 
  out[36] += 1.224744871391589*drag_incr[13]*rdv2; 
  out[37] += 1.224744871391589*drag_incr[14]*rdv2; 
  out[38] += 0.7071067811865475*drag_incr[23]*rdv2; 
  out[39] += 0.7071067811865475*drag_incr[24]*rdv2; 
  out[40] += 0.7071067811865475*drag_incr[25]*rdv2; 
  out[41] += 1.224744871391589*drag_incr[15]*rdv2; 
  out[42] += 1.224744871391589*drag_incr[16]*rdv2; 
  out[43] += 0.7071067811865475*drag_incr[26]*rdv2; 
  ...
  out[48] += 1.224744871391589*drag_incr[20]*rdv2; 
  out[49] += 1.224744871391589*drag_incr[21]*rdv2; 
  out[50] += 1.224744871391589*drag_incr[22]*rdv2; 
  out[51] += 0.7071067811865475*drag_incr[28]*rdv2; 
  out[52] += 0.7071067811865475*drag_incr[29]*rdv2; 
  out[53] += 0.7071067811865475*drag_incr[30]*rdv2; 
  ...
  out[58] += 1.224744871391589*drag_incr[27]*rdv2; 
  out[59] += 0.7071067811865475*drag_incr[31]*rdv2; 
  ...
  alphaDrSurf[0] = nuSum[0]*(2.0*w[3]-1.0*dxv[3])-2.0*sumNuUx[0]; 
  alphaDrSurf[1] = nuSum[1]*(2.0*w[3]-1.0*dxv[3])-2.0*sumNuUx[1]; 
  alphaDrSurf[2] = nuSum[2]*(2.0*w[3]-1.0*dxv[3])-2.0*sumNuUx[2]; 
  alphaDrSurf[3] = 2.0*nuSum[3]*w[3]-2.0*sumNuUx[3]-1.0*dxv[3]*nuSum[3]; 
  alphaDrSurf[6] = (2.0*w[3]-1.0*dxv[3])*nuSum[4]-2.0*sumNuUx[4]; 
  alphaDrSurf[7] = (2.0*w[3]-1.0*dxv[3])*nuSum[5]-2.0*sumNuUx[5]; 
  alphaDrSurf[8] = (2.0*w[3]-1.0*dxv[3])*nuSum[6]-2.0*sumNuUx[6]; 
  alphaDrSurf[16] = (2.0*w[3]-1.0*dxv[3])*nuSum[7]-2.0*sumNuUx[7]; 
