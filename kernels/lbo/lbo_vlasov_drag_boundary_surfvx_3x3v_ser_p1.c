...
{ 
  ...
  out[10] += 1.224744871391589*Ghat[1]*rdv2; 
  out[11] += 1.224744871391589*Ghat[2]*rdv2; 
  out[12] += 1.224744871391589*Ghat[3]*rdv2; 
  out[13] += 0.7071067811865475*Ghat[9]*rdv2; 
  out[14] += 0.7071067811865475*Ghat[10]*rdv2; 
  out[15] += 0.7071067811865475*Ghat[11]*rdv2; 
  ...
  out[37] += 1.224744871391589*Ghat[14]*rdv2; 
  out[38] += 0.7071067811865475*Ghat[23]*rdv2; 
  out[39] += 0.7071067811865475*Ghat[24]*rdv2; 
  out[40] += 0.7071067811865475*Ghat[25]*rdv2; 
  out[41] += 1.224744871391589*Ghat[15]*rdv2; 
  out[42] += 1.224744871391589*Ghat[16]*rdv2; 
  out[43] += 0.7071067811865475*Ghat[26]*rdv2; 
  ...
  out[48] += 1.224744871391589*Ghat[20]*rdv2; 
  out[49] += 1.224744871391589*Ghat[21]*rdv2; 
  out[50] += 1.224744871391589*Ghat[22]*rdv2; 
  out[51] += 0.7071067811865475*Ghat[28]*rdv2; 
  out[52] += 0.7071067811865475*Ghat[29]*rdv2; 
  out[53] += 0.7071067811865475*Ghat[30]*rdv2; 
