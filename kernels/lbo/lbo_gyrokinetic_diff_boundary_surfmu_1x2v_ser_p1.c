...
{ 
  ...
  double fVfac_l = (jacobvel[0]*(0.7071067811865475*vmap_skin[2]-1.224744871391589*vmap_skin[3]))/vmap_primeSq[1]; 
  double fVfac_r = (jacobvel[0]*(1.224744871391589*vmap_skin[3]+0.7071067811865475*vmap_skin[2]))/vmap_primeSq[1]; 
