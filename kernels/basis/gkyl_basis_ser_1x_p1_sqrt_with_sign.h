...
{ 
  ...
  temp = 0.7071067811865475*A[0]-1.109839118871799*A[1]; 
  temp_sign = 0.7071067811865475*ASign[0]-1.109839118871799*ASign[1]; 
  if (temp < 0.0) { 
  AOrd[0] = 0.0; 
  ...
  temp = 0.7071067811865475*A[0]-0.6594875259537025*A[1]; 
  temp_sign = 0.7071067811865475*ASign[0]-0.6594875259537025*ASign[1]; 
  if (temp < 0.0) { 
  AOrd[1] = 0.0; 
  } else if (temp > 0.0 && temp_sign < 0.0) { 
  AOrd[1] = -sqrt(temp); 
  ...
  temp = 0.6594875259537025*A[1]+0.7071067811865475*A[0]; 
  temp_sign = 0.6594875259537025*ASign[1]+0.7071067811865475*ASign[0]; 
  if (temp < 0.0) { 
  AOrd[3] = 0.0; 
  } else if (temp > 0.0 && temp_sign < 0.0) { 
  AOrd[3] = -sqrt(temp); 
  ...
  temp = 1.109839118871799*A[1]+0.7071067811865475*A[0]; 
  temp_sign = 1.109839118871799*ASign[1]+0.7071067811865475*ASign[0]; 
  if (temp < 0.0) { 
  AOrd[4] = 0.0; 
  } else if (temp > 0.0 && temp_sign < 0.0) { 
  AOrd[4] = -sqrt(temp); 
