...
GKYL_CU_DH void nodal_to_modal_2d_tensor_p2(double *node_coords);
...
GKYL_CU_DH void nodal_to_modal_3d_tensor_p2(double *node_coords);
...
GKYL_CU_DH void nodal_to_modal_4d_tensor_p2(double *node_coords);
...
GKYL_CU_DH void nodal_to_modal_5d_tensor_p2(double *node_coords);
EXTERN_C_END
