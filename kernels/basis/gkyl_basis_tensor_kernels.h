...
GKYL_CU_DH double eval_laplacian_expand_2d_tensor_p2(int dir, const double *z, const double *f);
GKYL_CU_DH double eval_mixedpartial_expand_2d_tensor_p2(const double *z, const double *f);
