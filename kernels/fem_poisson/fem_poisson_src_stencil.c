...
{ 
  ...
  ACCUMULATE(bsrc[globalIdxs[0]],0.7071067811865476*rho[0]-0.408248290463863*rho[1]);
  ACCUMULATE(bsrc[globalIdxs[1]],0.408248290463863*rho[1]+0.7071067811865476*rho[0]);
...
{ 
  ...
  ACCUMULATE(bsrc[globalIdxs[0]],0.210818510677892*rho[2]-0.408248290463863*rho[1]+0.2357022603955158*rho[0]);
  ACCUMULATE(bsrc[globalIdxs[1]],0.9428090415820636*rho[0]-0.4216370213557841*rho[2]);
  ACCUMULATE(bsrc[globalIdxs[2]],0.210818510677892*rho[2]+0.408248290463863*rho[1]+0.2357022603955158*rho[0]);
...
{ 
  ...
  ASSIGN(bsrc[globalIdxs[0]],bcVals[2]);
  ACCUMULATE(bsrc[globalIdxs[1]],0.408248290463863*rho[1]+0.7071067811865476*rho[0]);
...
{ 
  ...
  ACCUMULATE(bsrc[globalIdxs[0]],0.7071067811865476*rho[0]-0.408248290463863*rho[1]);
  ASSIGN(bsrc[globalIdxs[1]],bcVals[5]);
...
{ 
  ...
  ACCUMULATE(bsrc[globalIdxs[0]],0.210818510677892*rho[2]-0.408248290463863*rho[1]+0.2357022603955158*rho[0]);
  ACCUMULATE(bsrc[globalIdxs[1]],0.9428090415820636*rho[0]-0.4216370213557841*rho[2]);
  ASSIGN(bsrc[globalIdxs[2]],bcVals[5]);
...
{ 
  ...
  ACCUMULATE(bsrc[globalIdxs[0]],0.1666666666666667*rho[3]-0.2886751345948129*rho[2]-0.2886751345948129*rho[1]+0.5*rho[0]);
  ACCUMULATE(bsrc[globalIdxs[1]],(-0.1666666666666667*rho[3])-0.2886751345948129*rho[2]+0.2886751345948129*rho[1]+0.5*rho[0]);
  ACCUMULATE(bsrc[globalIdxs[2]],(-0.1666666666666667*rho[3])+0.2886751345948129*rho[2]-0.2886751345948129*rho[1]+0.5*rho[0]);
  ACCUMULATE(bsrc[globalIdxs[3]],0.1666666666666667*rho[3]+0.2886751345948129*rho[2]+0.2886751345948129*rho[1]+0.5*rho[0]);
...
{ 
  ...
  ACCUMULATE(bsrc[globalIdxs[0]],(-0.08606629658238704*rho[7])-0.08606629658238704*rho[6]+0.149071198499986*rho[5]+0.149071198499986*rho[4]+0.1666666666666667*rho[3]-0.09622504486493762*rho[2]-0.09622504486493762*rho[1]-0.1666666666666667*rho[0]);
  ACCUMULATE(bsrc[globalIdxs[1]],0.1721325931647741*rho[6]-0.298142396999972*rho[4]-0.3849001794597506*rho[2]+0.6666666666666667*rho[0]);
  ACCUMULATE(bsrc[globalIdxs[2]],0.08606629658238704*rho[7]-0.08606629658238704*rho[6]+0.149071198499986*rho[5]+0.149071198499986*rho[4]-0.1666666666666667*rho[3]-0.09622504486493762*rho[2]+0.09622504486493762*rho[1]-0.1666666666666667*rho[0]);
  ACCUMULATE(bsrc[globalIdxs[3]],0.1721325931647741*rho[7]-0.2981423969999719*rho[5]-0.3849001794597505*rho[1]+0.6666666666666665*rho[0]);
  ACCUMULATE(bsrc[globalIdxs[4]],(-0.1721325931647741*rho[7])-0.2981423969999719*rho[5]+0.3849001794597505*rho[1]+0.6666666666666665*rho[0]);
  ACCUMULATE(bsrc[globalIdxs[5]],(-0.08606629658238707*rho[7])+0.08606629658238707*rho[6]+0.149071198499986*rho[5]+0.149071198499986*rho[4]-0.1666666666666667*rho[3]+0.09622504486493766*rho[2]-0.09622504486493766*rho[1]-0.1666666666666667*rho[0]);
  ACCUMULATE(bsrc[globalIdxs[6]],(-0.1721325931647741*rho[6])-0.2981423969999719*rho[4]+0.3849001794597505*rho[2]+0.6666666666666665*rho[0]);
  ACCUMULATE(bsrc[globalIdxs[7]],0.08606629658238704*rho[7]+0.08606629658238704*rho[6]+0.149071198499986*rho[5]+0.149071198499986*rho[4]+0.1666666666666667*rho[3]+0.09622504486493762*rho[2]+0.09622504486493762*rho[1]-0.1666666666666667*rho[0]);
...
{ 
  ...
  ASSIGN(bsrc[globalIdxs[0]],bcVals[2]);
  ACCUMULATE(bsrc[globalIdxs[1]],(-0.1666666666666667*rho[3])-0.2886751345948129*rho[2]+0.2886751345948129*rho[1]+0.5*rho[0]);
  ASSIGN(bsrc[globalIdxs[2]],bcVals[2]);
  ACCUMULATE(bsrc[globalIdxs[3]],0.1666666666666667*rho[3]+0.2886751345948129*rho[2]+0.2886751345948129*rho[1]+0.5*rho[0]);
...
{ 
  ...
  ACCUMULATE(bsrc[globalIdxs[1]],0.1721325931647741*rho[6]-0.298142396999972*rho[4]-0.3849001794597506*rho[2]+0.6666666666666667*rho[0]);
  ACCUMULATE(bsrc[globalIdxs[2]],0.08606629658238704*rho[7]-0.08606629658238704*rho[6]+0.149071198499986*rho[5]+0.149071198499986*rho[4]-0.1666666666666667*rho[3]-0.09622504486493762*rho[2]+0.09622504486493762*rho[1]-0.1666666666666667*rho[0]);
  ASSIGN(bsrc[globalIdxs[3]],bcVals[2]);
  ACCUMULATE(bsrc[globalIdxs[4]],(-0.1721325931647741*rho[7])-0.2981423969999719*rho[5]+0.3849001794597505*rho[1]+0.6666666666666665*rho[0]);
  ASSIGN(bsrc[globalIdxs[5]],bcVals[2]);
  ACCUMULATE(bsrc[globalIdxs[6]],(-0.1721325931647741*rho[6])-0.2981423969999719*rho[4]+0.3849001794597505*rho[2]+0.6666666666666665*rho[0]);
  ACCUMULATE(bsrc[globalIdxs[7]],0.08606629658238704*rho[7]+0.08606629658238704*rho[6]+0.149071198499986*rho[5]+0.149071198499986*rho[4]+0.1666666666666667*rho[3]+0.09622504486493762*rho[2]+0.09622504486493762*rho[1]-0.1666666666666667*rho[0]);
...
{ 
  ...
  ASSIGN(bsrc[globalIdxs[1]],bcVals[5]);
  ACCUMULATE(bsrc[globalIdxs[2]],(-0.1666666666666667*rho[3])+0.2886751345948129*rho[2]-0.2886751345948129*rho[1]+0.5*rho[0]);
  ASSIGN(bsrc[globalIdxs[3]],bcVals[5]);
...
{ 
  ...
  ASSIGN(bsrc[globalIdxs[2]],bcVals[5]);
  ACCUMULATE(bsrc[globalIdxs[3]],0.1721325931647741*rho[7]-0.2981423969999719*rho[5]-0.3849001794597505*rho[1]+0.6666666666666665*rho[0]);
  ASSIGN(bsrc[globalIdxs[4]],bcVals[5]);
  ACCUMULATE(bsrc[globalIdxs[5]],(-0.08606629658238707*rho[7])+0.08606629658238707*rho[6]+0.149071198499986*rho[5]+0.149071198499986*rho[4]-0.1666666666666667*rho[3]+0.09622504486493766*rho[2]-0.09622504486493766*rho[1]-0.1666666666666667*rho[0]);
  ACCUMULATE(bsrc[globalIdxs[6]],(-0.1721325931647741*rho[6])-0.2981423969999719*rho[4]+0.3849001794597505*rho[2]+0.6666666666666665*rho[0]);
  ASSIGN(bsrc[globalIdxs[7]],bcVals[5]);
...
{ 
  ...
  ASSIGN(bsrc[globalIdxs[0]],bcVals[8]);
  ASSIGN(bsrc[globalIdxs[1]],bcVals[8]);
  ACCUMULATE(bsrc[globalIdxs[2]],(-0.1666666666666667*rho[3])+0.2886751345948129*rho[2]-0.2886751345948129*rho[1]+0.5*rho[0]);
  ACCUMULATE(bsrc[globalIdxs[3]],0.1666666666666667*rho[3]+0.2886751345948129*rho[2]+0.2886751345948129*rho[1]+0.5*rho[0]);
...
{ 
  ...
  ASSIGN(bsrc[globalIdxs[0]],bcVals[8]);
  ASSIGN(bsrc[globalIdxs[1]],bcVals[8]);
  ASSIGN(bsrc[globalIdxs[2]],bcVals[8]);
  ACCUMULATE(bsrc[globalIdxs[3]],0.1721325931647741*rho[7]-0.2981423969999719*rho[5]-0.3849001794597505*rho[1]+0.6666666666666665*rho[0]);
  ACCUMULATE(bsrc[globalIdxs[4]],(-0.1721325931647741*rho[7])-0.2981423969999719*rho[5]+0.3849001794597505*rho[1]+0.6666666666666665*rho[0]);
  ACCUMULATE(bsrc[globalIdxs[5]],(-0.08606629658238707*rho[7])+0.08606629658238707*rho[6]+0.149071198499986*rho[5]+0.149071198499986*rho[4]-0.1666666666666667*rho[3]+0.09622504486493766*rho[2]-0.09622504486493766*rho[1]-0.1666666666666667*rho[0]);
  ACCUMULATE(bsrc[globalIdxs[6]],(-0.1721325931647741*rho[6])-0.2981423969999719*rho[4]+0.3849001794597505*rho[2]+0.6666666666666665*rho[0]);
...
{ 
  ...
  ACCUMULATE(bsrc[globalIdxs[0]],0.1666666666666667*rho[3]-0.2886751345948129*rho[2]-0.2886751345948129*rho[1]+0.5*rho[0]);
  ACCUMULATE(bsrc[globalIdxs[1]],(-0.1666666666666667*rho[3])-0.2886751345948129*rho[2]+0.2886751345948129*rho[1]+0.5*rho[0]);
  ASSIGN(bsrc[globalIdxs[2]],bcVals[11]);
  ASSIGN(bsrc[globalIdxs[3]],bcVals[11]);
...
{ 
  ...
  ACCUMULATE(bsrc[globalIdxs[3]],0.1721325931647741*rho[7]-0.2981423969999719*rho[5]-0.3849001794597505*rho[1]+0.6666666666666665*rho[0]);
  ACCUMULATE(bsrc[globalIdxs[4]],(-0.1721325931647741*rho[7])-0.2981423969999719*rho[5]+0.3849001794597505*rho[1]+0.6666666666666665*rho[0]);
  ASSIGN(bsrc[globalIdxs[5]],bcVals[11]);
  ASSIGN(bsrc[globalIdxs[6]],bcVals[11]);
  ASSIGN(bsrc[globalIdxs[7]],bcVals[11]);
