...
GKYL_CU_DH int fpo_drag_coeff_1x3v_vz_ser_p1_invz(const double *dxv, const double *gamma, 
  ...
  out[0] = (-(0.5773502691896257*H_R[4])-0.5773502691896257*H_L[4]+1.1547005383792515*H_C[4]+0.5*H_R[0]-0.5*H_L[0])*dv1*gamma_avg; 
  out[1] = (-(0.5773502691896257*H_R[8])-0.5773502691896257*H_L[8]+1.1547005383792515*H_C[8]+0.5*H_R[1]-0.5*H_L[1])*dv1*gamma_avg; 
  out[2] = (-(0.5773502691896257*H_R[9])-0.5773502691896257*H_L[9]+1.1547005383792515*H_C[9]+0.5*H_R[2]-0.5*H_L[2])*dv1*gamma_avg; 
  out[3] = (-(0.5773502691896257*H_R[10])-0.5773502691896257*H_L[10]+1.1547005383792515*H_C[10]+0.5*H_R[3]-0.5*H_L[3])*dv1*gamma_avg; 
  out[4] = (-(1.0*H_R[4])+1.0*H_L[4]+0.8660254037844386*H_R[0]+0.8660254037844386*H_L[0]-1.7320508075688772*H_C[0])*dv1*gamma_avg; 
  out[5] = (-(0.5773502691896257*H_R[12])-0.5773502691896257*H_L[12]+1.1547005383792515*H_C[12]+0.5*H_R[5]-0.5*H_L[5])*dv1*gamma_avg; 
  out[6] = (-(0.5773502691896257*H_R[13])-0.5773502691896257*H_L[13]+1.1547005383792515*H_C[13]+0.5*H_R[6]-0.5*H_L[6])*dv1*gamma_avg; 
  out[7] = (-(0.5773502691896257*H_R[14])-0.5773502691896257*H_L[14]+1.1547005383792515*H_C[14]+0.5*H_R[7]-0.5*H_L[7])*dv1*gamma_avg; 
  out[8] = (-(1.0*H_R[8])+1.0*H_L[8]+0.8660254037844386*H_R[1]+0.8660254037844386*H_L[1]-1.7320508075688772*H_C[1])*dv1*gamma_avg; 
  out[9] = (-(1.0*H_R[9])+1.0*H_L[9]+0.8660254037844386*H_R[2]+0.8660254037844386*H_L[2]-1.7320508075688772*H_C[2])*dv1*gamma_avg; 
  out[10] = (-(1.0*H_R[10])+1.0*H_L[10]+0.8660254037844386*H_R[3]+0.8660254037844386*H_L[3]-1.7320508075688772*H_C[3])*dv1*gamma_avg; 
  out[11] = (-(0.5773502691896257*H_R[15])-0.5773502691896257*H_L[15]+1.1547005383792515*H_C[15]+0.5*H_R[11]-0.5*H_L[11])*dv1*gamma_avg; 
  out[12] = (-(1.0*H_R[12])+1.0*H_L[12]+0.8660254037844386*H_R[5]+0.8660254037844386*H_L[5]-1.7320508075688772*H_C[5])*dv1*gamma_avg; 
  out[13] = (-(1.0*H_R[13])+1.0*H_L[13]+0.8660254037844386*H_R[6]+0.8660254037844386*H_L[6]-1.7320508075688772*H_C[6])*dv1*gamma_avg; 
  out[14] = (-(1.0*H_R[14])+1.0*H_L[14]+0.8660254037844386*H_R[7]+0.8660254037844386*H_L[7]-1.7320508075688772*H_C[7])*dv1*gamma_avg; 
  out[15] = (-(1.0*H_R[15])+1.0*H_L[15]+0.8660254037844386*H_R[11]+0.8660254037844386*H_L[11]-1.7320508075688772*H_C[11])*dv1*gamma_avg; 
  out[32] = (-(1.2909944487358056*H_R[4])-1.2909944487358056*H_L[4]-5.163977794943222*H_C[4]+1.118033988749895*H_R[0]-1.118033988749895*H_L[0])*dv1*gamma_avg; 
  out[33] = (-(1.2909944487358056*H_R[8])-1.2909944487358056*H_L[8]-5.163977794943222*H_C[8]+1.118033988749895*H_R[1]-1.118033988749895*H_L[1])*dv1*gamma_avg; 
  out[34] = (-(1.2909944487358056*H_R[9])-1.2909944487358056*H_L[9]-5.163977794943222*H_C[9]+1.118033988749895*H_R[2]-1.118033988749895*H_L[2])*dv1*gamma_avg; 
  out[35] = (-(1.2909944487358056*H_R[10])-1.2909944487358056*H_L[10]-5.163977794943222*H_C[10]+1.118033988749895*H_R[3]-1.118033988749895*H_L[3])*dv1*gamma_avg; 
  out[36] = (-(1.2909944487358056*H_R[12])-1.2909944487358056*H_L[12]-5.163977794943222*H_C[12]+1.118033988749895*H_R[5]-1.118033988749895*H_L[5])*dv1*gamma_avg; 
  out[37] = (-(1.2909944487358056*H_R[13])-1.2909944487358056*H_L[13]-5.163977794943222*H_C[13]+1.118033988749895*H_R[6]-1.118033988749895*H_L[6])*dv1*gamma_avg; 
  out[38] = (-(1.2909944487358056*H_R[14])-1.2909944487358056*H_L[14]-5.163977794943222*H_C[14]+1.118033988749895*H_R[7]-1.118033988749895*H_L[7])*dv1*gamma_avg; 
  out[39] = (-(1.2909944487358056*H_R[15])-1.2909944487358056*H_L[15]-5.163977794943222*H_C[15]+1.118033988749895*H_R[11]-1.118033988749895*H_L[11])*dv1*gamma_avg; 
