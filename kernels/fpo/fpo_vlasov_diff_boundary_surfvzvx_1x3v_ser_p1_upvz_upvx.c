...
GKYL_CU_DH void fpo_vlasov_diff_boundary_surfvzvx_1x3v_ser_p1_upvz_upvx(const double *dxv, const double* diff_coeff_stencil[9], const double* f_stencil[9], double* out) { 
  ...
  const double* DBL = &diff_coeff_stencil[0][240]; 
  const double* fBL = f_stencil[0]; 
  const double* DBC = &diff_coeff_stencil[1][240]; 
  const double* fBC = f_stencil[1]; 
  const double* DCL = &diff_coeff_stencil[2][240]; 
  const double* fCL = f_stencil[2]; 
  const double* DCC = &diff_coeff_stencil[3][240]; 
  const double* fCC = f_stencil[3]; 

  D_rec_lo[0] = 0.408248290463863*DCL[4]-0.408248290463863*DCC[4]+0.3535533905932737*DCL[0]+0.3535533905932737*DCC[0]; 
  D_rec_lo[1] = 0.408248290463863*DCL[8]-0.408248290463863*DCC[8]+0.3535533905932737*DCL[1]+0.3535533905932737*DCC[1]; 
  D_rec_lo[2] = 0.408248290463863*DCL[9]-0.408248290463863*DCC[9]+0.3535533905932737*DCL[2]+0.3535533905932737*DCC[2]; 
  D_rec_lo[3] = 0.408248290463863*DCL[10]-0.408248290463863*DCC[10]+0.3535533905932737*DCL[3]+0.3535533905932737*DCC[3]; 
  D_rec_lo[4] = 0.408248290463863*DCL[12]-0.408248290463863*DCC[12]+0.3535533905932737*DCL[5]+0.3535533905932737*DCC[5]; 
  D_rec_lo[5] = 0.408248290463863*DCL[13]-0.408248290463863*DCC[13]+0.3535533905932737*DCL[6]+0.3535533905932737*DCC[6]; 
  D_rec_lo[6] = 0.408248290463863*DCL[14]-0.408248290463863*DCC[14]+0.3535533905932737*DCL[7]+0.3535533905932737*DCC[7]; 
  D_rec_lo[7] = 0.408248290463863*DCL[15]-0.408248290463863*DCC[15]+0.3535533905932737*DCL[11]+0.3535533905932737*DCC[11]; 
  D_rec_up[0] = 1.5811388300841895*DCC[32]+1.224744871391589*DCC[4]+0.7071067811865475*DCC[0]; 
  D_rec_up[1] = 1.5811388300841898*DCC[33]+1.224744871391589*DCC[8]+0.7071067811865475*DCC[1]; 
  D_rec_up[2] = 1.5811388300841898*DCC[34]+1.224744871391589*DCC[9]+0.7071067811865475*DCC[2]; 
  D_rec_up[3] = 1.5811388300841898*DCC[35]+1.224744871391589*DCC[10]+0.7071067811865475*DCC[3]; 
  D_rec_up[4] = 1.5811388300841895*DCC[36]+1.224744871391589*DCC[12]+0.7071067811865475*DCC[5]; 
  D_rec_up[5] = 1.5811388300841895*DCC[37]+1.224744871391589*DCC[13]+0.7071067811865475*DCC[6]; 
  D_rec_up[6] = 1.5811388300841895*DCC[38]+1.224744871391589*DCC[14]+0.7071067811865475*DCC[7]; 
  D_rec_up[7] = 1.5811388300841898*DCC[39]+1.224744871391589*DCC[15]+0.7071067811865475*DCC[11]; 

  f_rec_lo[0] = 0.408248290463863*fCL[4]-0.408248290463863*fCC[4]+0.3535533905932737*fCL[0]+0.3535533905932737*fCC[0]; 
  f_rec_lo[1] = 0.408248290463863*fCL[8]-0.408248290463863*fCC[8]+0.3535533905932737*fCL[1]+0.3535533905932737*fCC[1]; 
  f_rec_lo[2] = 0.408248290463863*fCL[9]-0.408248290463863*fCC[9]+0.3535533905932737*fCL[2]+0.3535533905932737*fCC[2]; 
  f_rec_lo[3] = 0.408248290463863*fCL[10]-0.408248290463863*fCC[10]+0.3535533905932737*fCL[3]+0.3535533905932737*fCC[3]; 
  f_rec_lo[4] = 0.408248290463863*fCL[12]-0.408248290463863*fCC[12]+0.3535533905932737*fCL[5]+0.3535533905932737*fCC[5]; 
  f_rec_lo[5] = 0.408248290463863*fCL[13]-0.408248290463863*fCC[13]+0.3535533905932737*fCL[6]+0.3535533905932737*fCC[6]; 
  f_rec_lo[6] = 0.408248290463863*fCL[14]-0.408248290463863*fCC[14]+0.3535533905932737*fCL[7]+0.3535533905932737*fCC[7]; 
  f_rec_lo[7] = 0.408248290463863*fCL[15]-0.408248290463863*fCC[15]+0.3535533905932737*fCL[11]+0.3535533905932737*fCC[11]; 
  f_rec_up[0] = 1.5811388300841895*fCC[32]+1.224744871391589*fCC[4]+0.7071067811865475*fCC[0]; 
  f_rec_up[1] = 1.5811388300841898*fCC[33]+1.224744871391589*fCC[8]+0.7071067811865475*fCC[1]; 
  f_rec_up[2] = 1.5811388300841898*fCC[34]+1.224744871391589*fCC[9]+0.7071067811865475*fCC[2]; 
  f_rec_up[3] = 1.5811388300841898*fCC[35]+1.224744871391589*fCC[10]+0.7071067811865475*fCC[3]; 
  f_rec_up[4] = 1.5811388300841895*fCC[36]+1.224744871391589*fCC[12]+0.7071067811865475*fCC[5]; 
  f_rec_up[5] = 1.5811388300841895*fCC[37]+1.224744871391589*fCC[13]+0.7071067811865475*fCC[6]; 
  f_rec_up[6] = 1.5811388300841895*fCC[38]+1.224744871391589*fCC[14]+0.7071067811865475*fCC[7]; 
  f_rec_up[7] = 1.5811388300841898*fCC[39]+1.224744871391589*fCC[15]+0.7071067811865475*fCC[11]; 
  ...
  out[3] += 0.35355339059327373*surft1_up[3]*dv1_sq-0.35355339059327373*surft1_lo[3]*dv1_sq; 
  ...
  out[6] += 0.35355339059327373*surft1_up[5]*dv1_sq-0.35355339059327373*surft1_lo[5]*dv1_sq; 
  out[7] += 0.35355339059327373*surft1_up[6]*dv1_sq-0.35355339059327373*surft1_lo[6]*dv1_sq-0.6123724356957945*surft2_up[3]*dv1_sq+0.6123724356957945*surft2_lo[3]*dv1_sq; 
  out[8] += 0.6123724356957945*surft1_up[1]*dv1_sq+0.6123724356957945*surft1_lo[1]*dv1_sq; 
  out[9] += 0.6123724356957945*surft1_up[2]*dv1_sq+0.6123724356957945*surft1_lo[2]*dv1_sq-1.0606601717798212*surft2_up[0]*dv1_sq-1.0606601717798212*surft2_lo[0]*dv1_sq; 
  out[10] += 0.6123724356957945*surft1_up[3]*dv1_sq+0.6123724356957945*surft1_lo[3]*dv1_sq; 
  out[11] += 0.35355339059327373*surft1_up[7]*dv1_sq-0.35355339059327373*surft1_lo[7]*dv1_sq-0.6123724356957945*surft2_up[5]*dv1_sq+0.6123724356957945*surft2_lo[5]*dv1_sq; 
  out[12] += 0.6123724356957945*surft1_up[4]*dv1_sq+0.6123724356957945*surft1_lo[4]*dv1_sq-1.0606601717798212*surft2_up[1]*dv1_sq-1.0606601717798212*surft2_lo[1]*dv1_sq; 
  ...
  out[18] += 1.3693063937629153*surft2_lo[6]*dv1_sq-1.3693063937629153*surft2_up[6]*dv1_sq; 
  out[19] += -(2.3717082451262845*surft2_up[2]*dv1_sq)-2.3717082451262845*surft2_lo[2]*dv1_sq; 
  out[20] += 1.3693063937629153*surft2_lo[7]*dv1_sq-1.3693063937629153*surft2_up[7]*dv1_sq; 
  out[21] += -(2.3717082451262845*surft2_up[4]*dv1_sq)-2.3717082451262845*surft2_lo[4]*dv1_sq; 
  ...
  out[34] += 0.7905694150420949*surft1_up[2]*dv1_sq-0.7905694150420949*surft1_lo[2]*dv1_sq-1.3693063937629153*surft2_up[0]*dv1_sq+1.3693063937629153*surft2_lo[0]*dv1_sq; 
  out[35] += 0.7905694150420949*surft1_up[3]*dv1_sq-0.7905694150420949*surft1_lo[3]*dv1_sq; 
  out[36] += 0.7905694150420948*surft1_up[4]*dv1_sq-0.7905694150420948*surft1_lo[4]*dv1_sq-1.3693063937629153*surft2_up[1]*dv1_sq+1.3693063937629153*surft2_lo[1]*dv1_sq; 
  out[37] += 0.7905694150420948*surft1_up[5]*dv1_sq-0.7905694150420948*surft1_lo[5]*dv1_sq; 
  out[38] += 0.7905694150420948*surft1_up[6]*dv1_sq-0.7905694150420948*surft1_lo[6]*dv1_sq-1.3693063937629153*surft2_up[3]*dv1_sq+1.3693063937629153*surft2_lo[3]*dv1_sq; 
  out[39] += 0.7905694150420949*surft1_up[7]*dv1_sq-0.7905694150420949*surft1_lo[7]*dv1_sq-1.3693063937629153*surft2_up[5]*dv1_sq+1.3693063937629153*surft2_lo[5]*dv1_sq; 
} 
