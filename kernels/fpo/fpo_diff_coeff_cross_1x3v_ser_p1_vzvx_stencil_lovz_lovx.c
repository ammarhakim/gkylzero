...
GKYL_CU_DH void fpo_diff_coeff_cross_1x3v_vzvx_ser_p1_lovz_lovx(const double *dxv, const double *gamma, const double* fpo_g_stencil[9], const double* fpo_g_surf_stencil[9], const double* fpo_dgdv_surf, double *diff_coeff) { 
  ...
  const double* G_surf_CC_vz = &fpo_g_surf_stencil[0][16]; 
  ...
  surft1_up[0] = -(0.7071067811865475*GCR[9])+0.7071067811865475*GCC[9]+0.6123724356957944*GCR[4]+0.6123724356957944*GCC[4]; 
  surft1_up[1] = -(0.7071067811865475*GCR[12])+0.7071067811865475*GCC[12]+0.6123724356957944*GCR[8]+0.6123724356957944*GCC[8]; 
  surft1_up[2] = -(0.7071067811865475*GCR[14])+0.7071067811865475*GCC[14]+0.6123724356957944*GCR[10]+0.6123724356957944*GCC[10]; 
  surft1_up[4] = -(0.7071067811865475*GCR[15])+0.7071067811865475*GCC[15]+0.6123724356957944*GCR[13]+0.6123724356957944*GCC[13]; 
