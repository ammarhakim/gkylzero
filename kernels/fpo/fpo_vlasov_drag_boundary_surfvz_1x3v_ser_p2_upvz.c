...
GKYL_CU_DH void fpo_vlasov_drag_boundary_surfvz_1x3v_ser_p2_upvz(const double *dxv, const double* drag_coeff_stencil[9], const double* f_stencil[9], double* out) { 
  ...
  const double* aL = &drag_coeff_stencil[0][96]; 
  const double* aC = &drag_coeff_stencil[1][96]; 
  ...
  alphaDragSurf[0] = 0.34587411908091625*aL[14]+0.34587411908091625*aC[14]+0.49755260400283263*aL[4]-0.49755260400283263*aC[4]+0.3535533905932737*aL[0]+0.3535533905932737*aC[0]; 
  alphaDragSurf[1] = 0.34587411908091625*aL[28]+0.34587411908091625*aC[28]+0.49755260400283263*aL[8]-0.49755260400283263*aC[8]+0.3535533905932737*aL[1]+0.3535533905932737*aC[1]; 
  alphaDragSurf[2] = 0.34587411908091625*aL[29]+0.34587411908091625*aC[29]+0.49755260400283263*aL[9]-0.49755260400283263*aC[9]+0.3535533905932737*aL[2]+0.3535533905932737*aC[2]; 
  alphaDragSurf[3] = 0.34587411908091625*aL[30]+0.34587411908091625*aC[30]+0.49755260400283263*aL[10]-0.49755260400283263*aC[10]+0.3535533905932737*aL[3]+0.3535533905932737*aC[3]; 
  alphaDragSurf[4] = 0.34587411908091625*aL[41]+0.34587411908091625*aC[41]+0.49755260400283263*aL[16]-0.49755260400283263*aC[16]+0.3535533905932737*aL[5]+0.3535533905932737*aC[5]; 
  alphaDragSurf[5] = 0.34587411908091625*aL[42]+0.34587411908091625*aC[42]+0.49755260400283263*aL[17]-0.49755260400283263*aC[17]+0.3535533905932737*aL[6]+0.3535533905932737*aC[6]; 
  alphaDragSurf[6] = 0.34587411908091625*aL[43]+0.34587411908091625*aC[43]+0.49755260400283263*aL[18]-0.49755260400283263*aC[18]+0.3535533905932737*aL[7]+0.3535533905932737*aC[7]; 
  alphaDragSurf[7] = 0.49755260400283263*aL[25]-0.49755260400283263*aC[25]+0.3535533905932737*aL[11]+0.3535533905932737*aC[11]; 
  alphaDragSurf[8] = 0.49755260400283263*aL[26]-0.49755260400283263*aC[26]+0.3535533905932737*aL[12]+0.3535533905932737*aC[12]; 
  alphaDragSurf[9] = 0.49755260400283263*aL[27]-0.49755260400283263*aC[27]+0.3535533905932737*aL[13]+0.3535533905932737*aC[13]; 
  alphaDragSurf[10] = 0.34587411908091625*aL[47]+0.34587411908091625*aC[47]+0.49755260400283263*aL[31]-0.49755260400283263*aC[31]+0.3535533905932737*aL[15]+0.3535533905932737*aC[15]; 
  alphaDragSurf[11] = 0.49755260400283263*aL[35]-0.49755260400283263*aC[35]+0.3535533905932737*aL[19]+0.3535533905932737*aC[19]; 
  alphaDragSurf[12] = 0.49755260400283263*aL[36]-0.49755260400283263*aC[36]+0.3535533905932737*aL[20]+0.3535533905932737*aC[20]; 
  alphaDragSurf[13] = 0.49755260400283263*aL[37]-0.49755260400283263*aC[37]+0.3535533905932737*aL[21]+0.3535533905932737*aC[21]; 
  alphaDragSurf[14] = 0.49755260400283263*aL[38]-0.49755260400283263*aC[38]+0.3535533905932737*aL[22]+0.3535533905932737*aC[22]; 
  alphaDragSurf[15] = 0.49755260400283263*aL[39]-0.49755260400283263*aC[39]+0.3535533905932737*aL[23]+0.3535533905932737*aC[23]; 
  alphaDragSurf[16] = 0.49755260400283263*aL[40]-0.49755260400283263*aC[40]+0.3535533905932737*aL[24]+0.3535533905932737*aC[24]; 
  alphaDragSurf[17] = 0.49755260400283263*aL[44]-0.49755260400283263*aC[44]+0.3535533905932737*aL[32]+0.3535533905932737*aC[32]; 
  alphaDragSurf[18] = 0.49755260400283263*aL[45]-0.49755260400283263*aC[45]+0.3535533905932737*aL[33]+0.3535533905932737*aC[33]; 
  alphaDragSurf[19] = 0.49755260400283263*aL[46]-0.49755260400283263*aC[46]+0.3535533905932737*aL[34]+0.3535533905932737*aC[34]; 
  ...
  if (0.5692099788303082*(alphaDragSurf[19]+alphaDragSurf[18]+alphaDragSurf[17])-0.42426406871192807*(alphaDragSurf[16]+alphaDragSurf[15])-0.42426406871192845*(alphaDragSurf[14]+alphaDragSurf[13])-0.42426406871192807*alphaDragSurf[12]-0.42426406871192845*alphaDragSurf[11]-0.853814968245462*alphaDragSurf[10]+0.3162277660168379*(alphaDragSurf[9]+alphaDragSurf[8]+alphaDragSurf[7])+0.6363961030678926*(alphaDragSurf[6]+alphaDragSurf[5]+alphaDragSurf[4])-0.4743416490252568*(alphaDragSurf[3]+alphaDragSurf[2]+alphaDragSurf[1])+0.3535533905932737*alphaDragSurf[0] > 0) { 
    fUpwindQuad[0] = ser_4x_p2_surfx4_eval_quad_node_0_r(fL); 
  } else { 
    fUpwindQuad[0] = ser_4x_p2_surfx4_eval_quad_node_0_l(fC); 
  } 
  if (-(0.711512473537885*alphaDragSurf[19])+0.5303300858899104*(alphaDragSurf[16]+alphaDragSurf[15])-0.42426406871192807*alphaDragSurf[12]-0.42426406871192845*alphaDragSurf[11]-0.3952847075210473*alphaDragSurf[9]+0.3162277660168379*(alphaDragSurf[8]+alphaDragSurf[7])+0.6363961030678926*alphaDragSurf[4]-0.4743416490252568*(alphaDragSurf[2]+alphaDragSurf[1])+0.3535533905932737*alphaDragSurf[0] > 0) { 
    fUpwindQuad[1] = ser_4x_p2_surfx4_eval_quad_node_1_r(fL); 
  } else { 
    fUpwindQuad[1] = ser_4x_p2_surfx4_eval_quad_node_1_l(fC); 
  } 
  if (0.5692099788303082*alphaDragSurf[19]-0.5692099788303082*(alphaDragSurf[18]+alphaDragSurf[17])-0.42426406871192807*(alphaDragSurf[16]+alphaDragSurf[15])+0.42426406871192845*(alphaDragSurf[14]+alphaDragSurf[13])-0.42426406871192807*alphaDragSurf[12]-0.42426406871192845*alphaDragSurf[11]+0.853814968245462*alphaDragSurf[10]+0.3162277660168379*(alphaDragSurf[9]+alphaDragSurf[8]+alphaDragSurf[7])-0.6363961030678926*(alphaDragSurf[6]+alphaDragSurf[5])+0.6363961030678926*alphaDragSurf[4]+0.4743416490252568*alphaDragSurf[3]-0.4743416490252568*(alphaDragSurf[2]+alphaDragSurf[1])+0.3535533905932737*alphaDragSurf[0] > 0) { 
    fUpwindQuad[2] = ser_4x_p2_surfx4_eval_quad_node_2_r(fL); 
  } else { 
    fUpwindQuad[2] = ser_4x_p2_surfx4_eval_quad_node_2_l(fC); 
  } 
  if (-(0.711512473537885*alphaDragSurf[18])-0.42426406871192807*alphaDragSurf[15]+0.5303300858899104*alphaDragSurf[14]-0.42426406871192845*alphaDragSurf[13]+0.5303300858899104*alphaDragSurf[12]+0.3162277660168379*alphaDragSurf[9]-0.3952847075210473*alphaDragSurf[8]+0.3162277660168379*alphaDragSurf[7]+0.6363961030678926*alphaDragSurf[5]-0.4743416490252568*(alphaDragSurf[3]+alphaDragSurf[1])+0.3535533905932737*alphaDragSurf[0] > 0) { 
    fUpwindQuad[3] = ser_4x_p2_surfx4_eval_quad_node_3_r(fL); 
  } else { 
    fUpwindQuad[3] = ser_4x_p2_surfx4_eval_quad_node_3_l(fC); 
  } 
  if (0.5303300858899104*(alphaDragSurf[15]+alphaDragSurf[12])-0.3952847075210473*(alphaDragSurf[9]+alphaDragSurf[8])+0.3162277660168379*alphaDragSurf[7]-0.4743416490252568*alphaDragSurf[1]+0.3535533905932737*alphaDragSurf[0] > 0) { 
    fUpwindQuad[4] = ser_4x_p2_surfx4_eval_quad_node_4_r(fL); 
  } else { 
    fUpwindQuad[4] = ser_4x_p2_surfx4_eval_quad_node_4_l(fC); 
  } 
  if (0.711512473537885*alphaDragSurf[18]-0.42426406871192807*alphaDragSurf[15]-0.5303300858899104*alphaDragSurf[14]+0.42426406871192845*alphaDragSurf[13]+0.5303300858899104*alphaDragSurf[12]+0.3162277660168379*alphaDragSurf[9]-0.3952847075210473*alphaDragSurf[8]+0.3162277660168379*alphaDragSurf[7]-0.6363961030678926*alphaDragSurf[5]+0.4743416490252568*alphaDragSurf[3]-0.4743416490252568*alphaDragSurf[1]+0.3535533905932737*alphaDragSurf[0] > 0) { 
    fUpwindQuad[5] = ser_4x_p2_surfx4_eval_quad_node_5_r(fL); 
  } else { 
    fUpwindQuad[5] = ser_4x_p2_surfx4_eval_quad_node_5_l(fC); 
  } 
  if (-(0.5692099788303082*alphaDragSurf[19])+0.5692099788303082*alphaDragSurf[18]-0.5692099788303082*alphaDragSurf[17]+0.42426406871192807*alphaDragSurf[16]-0.42426406871192807*alphaDragSurf[15]-0.42426406871192845*(alphaDragSurf[14]+alphaDragSurf[13])-0.42426406871192807*alphaDragSurf[12]+0.42426406871192845*alphaDragSurf[11]+0.853814968245462*alphaDragSurf[10]+0.3162277660168379*(alphaDragSurf[9]+alphaDragSurf[8]+alphaDragSurf[7])-0.6363961030678926*alphaDragSurf[6]+0.6363961030678926*alphaDragSurf[5]-0.6363961030678926*alphaDragSurf[4]-0.4743416490252568*alphaDragSurf[3]+0.4743416490252568*alphaDragSurf[2]-0.4743416490252568*alphaDragSurf[1]+0.3535533905932737*alphaDragSurf[0] > 0) { 
    fUpwindQuad[6] = ser_4x_p2_surfx4_eval_quad_node_6_r(fL); 
  } else { 
    fUpwindQuad[6] = ser_4x_p2_surfx4_eval_quad_node_6_l(fC); 
  } 
  if (0.711512473537885*alphaDragSurf[19]-0.5303300858899104*alphaDragSurf[16]+0.5303300858899104*alphaDragSurf[15]-0.42426406871192807*alphaDragSurf[12]+0.42426406871192845*alphaDragSurf[11]-0.3952847075210473*alphaDragSurf[9]+0.3162277660168379*(alphaDragSurf[8]+alphaDragSurf[7])-0.6363961030678926*alphaDragSurf[4]+0.4743416490252568*alphaDragSurf[2]-0.4743416490252568*alphaDragSurf[1]+0.3535533905932737*alphaDragSurf[0] > 0) { 
    fUpwindQuad[7] = ser_4x_p2_surfx4_eval_quad_node_7_r(fL); 
  } else { 
    fUpwindQuad[7] = ser_4x_p2_surfx4_eval_quad_node_7_l(fC); 
  } 
  if (-(0.5692099788303082*(alphaDragSurf[19]+alphaDragSurf[18]))+0.5692099788303082*alphaDragSurf[17]+0.42426406871192807*alphaDragSurf[16]-0.42426406871192807*alphaDragSurf[15]+0.42426406871192845*(alphaDragSurf[14]+alphaDragSurf[13])-0.42426406871192807*alphaDragSurf[12]+0.42426406871192845*alphaDragSurf[11]-0.853814968245462*alphaDragSurf[10]+0.3162277660168379*(alphaDragSurf[9]+alphaDragSurf[8]+alphaDragSurf[7])+0.6363961030678926*alphaDragSurf[6]-0.6363961030678926*(alphaDragSurf[5]+alphaDragSurf[4])+0.4743416490252568*(alphaDragSurf[3]+alphaDragSurf[2])-0.4743416490252568*alphaDragSurf[1]+0.3535533905932737*alphaDragSurf[0] > 0) { 
    fUpwindQuad[8] = ser_4x_p2_surfx4_eval_quad_node_8_r(fL); 
  } else { 
    fUpwindQuad[8] = ser_4x_p2_surfx4_eval_quad_node_8_l(fC); 
  } 
  if (-(0.711512473537885*alphaDragSurf[17])-0.42426406871192807*alphaDragSurf[16]-0.42426406871192845*alphaDragSurf[14]+0.5303300858899104*(alphaDragSurf[13]+alphaDragSurf[11])+0.3162277660168379*(alphaDragSurf[9]+alphaDragSurf[8])-0.3952847075210473*alphaDragSurf[7]+0.6363961030678926*alphaDragSurf[6]-0.4743416490252568*(alphaDragSurf[3]+alphaDragSurf[2])+0.3535533905932737*alphaDragSurf[0] > 0) { 
    fUpwindQuad[9] = ser_4x_p2_surfx4_eval_quad_node_9_r(fL); 
  } else { 
    fUpwindQuad[9] = ser_4x_p2_surfx4_eval_quad_node_9_l(fC); 
  } 
  if (0.5303300858899104*(alphaDragSurf[16]+alphaDragSurf[11])-0.3952847075210473*alphaDragSurf[9]+0.3162277660168379*alphaDragSurf[8]-0.3952847075210473*alphaDragSurf[7]-0.4743416490252568*alphaDragSurf[2]+0.3535533905932737*alphaDragSurf[0] > 0) { 
    fUpwindQuad[10] = ser_4x_p2_surfx4_eval_quad_node_10_r(fL); 
  } else { 
    fUpwindQuad[10] = ser_4x_p2_surfx4_eval_quad_node_10_l(fC); 
  } 
  if (0.711512473537885*alphaDragSurf[17]-0.42426406871192807*alphaDragSurf[16]+0.42426406871192845*alphaDragSurf[14]-0.5303300858899104*alphaDragSurf[13]+0.5303300858899104*alphaDragSurf[11]+0.3162277660168379*(alphaDragSurf[9]+alphaDragSurf[8])-0.3952847075210473*alphaDragSurf[7]-0.6363961030678926*alphaDragSurf[6]+0.4743416490252568*alphaDragSurf[3]-0.4743416490252568*alphaDragSurf[2]+0.3535533905932737*alphaDragSurf[0] > 0) { 
    fUpwindQuad[11] = ser_4x_p2_surfx4_eval_quad_node_11_r(fL); 
  } else { 
    fUpwindQuad[11] = ser_4x_p2_surfx4_eval_quad_node_11_l(fC); 
  } 
  if (0.5303300858899104*(alphaDragSurf[14]+alphaDragSurf[13])+0.3162277660168379*alphaDragSurf[9]-0.3952847075210473*(alphaDragSurf[8]+alphaDragSurf[7])-0.4743416490252568*alphaDragSurf[3]+0.3535533905932737*alphaDragSurf[0] > 0) { 
    fUpwindQuad[12] = ser_4x_p2_surfx4_eval_quad_node_12_r(fL); 
  } else { 
    fUpwindQuad[12] = ser_4x_p2_surfx4_eval_quad_node_12_l(fC); 
  } 
  if (0.3535533905932737*alphaDragSurf[0]-0.3952847075210473*(alphaDragSurf[9]+alphaDragSurf[8]+alphaDragSurf[7]) > 0) { 
    fUpwindQuad[13] = ser_4x_p2_surfx4_eval_quad_node_13_r(fL); 
  } else { 
    fUpwindQuad[13] = ser_4x_p2_surfx4_eval_quad_node_13_l(fC); 
  } 
  if (-(0.5303300858899104*(alphaDragSurf[14]+alphaDragSurf[13]))+0.3162277660168379*alphaDragSurf[9]-0.3952847075210473*(alphaDragSurf[8]+alphaDragSurf[7])+0.4743416490252568*alphaDragSurf[3]+0.3535533905932737*alphaDragSurf[0] > 0) { 
    fUpwindQuad[14] = ser_4x_p2_surfx4_eval_quad_node_14_r(fL); 
  } else { 
    fUpwindQuad[14] = ser_4x_p2_surfx4_eval_quad_node_14_l(fC); 
  } 
  if (0.711512473537885*alphaDragSurf[17]+0.42426406871192807*alphaDragSurf[16]-0.42426406871192845*alphaDragSurf[14]+0.5303300858899104*alphaDragSurf[13]-0.5303300858899104*alphaDragSurf[11]+0.3162277660168379*(alphaDragSurf[9]+alphaDragSurf[8])-0.3952847075210473*alphaDragSurf[7]-0.6363961030678926*alphaDragSurf[6]-0.4743416490252568*alphaDragSurf[3]+0.4743416490252568*alphaDragSurf[2]+0.3535533905932737*alphaDragSurf[0] > 0) { 
    fUpwindQuad[15] = ser_4x_p2_surfx4_eval_quad_node_15_r(fL); 
  } else { 
    fUpwindQuad[15] = ser_4x_p2_surfx4_eval_quad_node_15_l(fC); 
  } 
  if (-(0.5303300858899104*(alphaDragSurf[16]+alphaDragSurf[11]))-0.3952847075210473*alphaDragSurf[9]+0.3162277660168379*alphaDragSurf[8]-0.3952847075210473*alphaDragSurf[7]+0.4743416490252568*alphaDragSurf[2]+0.3535533905932737*alphaDragSurf[0] > 0) { 
    fUpwindQuad[16] = ser_4x_p2_surfx4_eval_quad_node_16_r(fL); 
  } else { 
    fUpwindQuad[16] = ser_4x_p2_surfx4_eval_quad_node_16_l(fC); 
  } 
  if (-(0.711512473537885*alphaDragSurf[17])+0.42426406871192807*alphaDragSurf[16]+0.42426406871192845*alphaDragSurf[14]-0.5303300858899104*(alphaDragSurf[13]+alphaDragSurf[11])+0.3162277660168379*(alphaDragSurf[9]+alphaDragSurf[8])-0.3952847075210473*alphaDragSurf[7]+0.6363961030678926*alphaDragSurf[6]+0.4743416490252568*(alphaDragSurf[3]+alphaDragSurf[2])+0.3535533905932737*alphaDragSurf[0] > 0) { 
    fUpwindQuad[17] = ser_4x_p2_surfx4_eval_quad_node_17_r(fL); 
  } else { 
    fUpwindQuad[17] = ser_4x_p2_surfx4_eval_quad_node_17_l(fC); 
  } 
  if (-(0.5692099788303082*(alphaDragSurf[19]+alphaDragSurf[18]))+0.5692099788303082*alphaDragSurf[17]-0.42426406871192807*alphaDragSurf[16]+0.42426406871192807*alphaDragSurf[15]-0.42426406871192845*(alphaDragSurf[14]+alphaDragSurf[13])+0.42426406871192807*alphaDragSurf[12]-0.42426406871192845*alphaDragSurf[11]+0.853814968245462*alphaDragSurf[10]+0.3162277660168379*(alphaDragSurf[9]+alphaDragSurf[8]+alphaDragSurf[7])+0.6363961030678926*alphaDragSurf[6]-0.6363961030678926*(alphaDragSurf[5]+alphaDragSurf[4])-0.4743416490252568*(alphaDragSurf[3]+alphaDragSurf[2])+0.4743416490252568*alphaDragSurf[1]+0.3535533905932737*alphaDragSurf[0] > 0) { 
    fUpwindQuad[18] = ser_4x_p2_surfx4_eval_quad_node_18_r(fL); 
  } else { 
    fUpwindQuad[18] = ser_4x_p2_surfx4_eval_quad_node_18_l(fC); 
  } 
  if (0.711512473537885*alphaDragSurf[19]+0.5303300858899104*alphaDragSurf[16]-0.5303300858899104*alphaDragSurf[15]+0.42426406871192807*alphaDragSurf[12]-0.42426406871192845*alphaDragSurf[11]-0.3952847075210473*alphaDragSurf[9]+0.3162277660168379*(alphaDragSurf[8]+alphaDragSurf[7])-0.6363961030678926*alphaDragSurf[4]-0.4743416490252568*alphaDragSurf[2]+0.4743416490252568*alphaDragSurf[1]+0.3535533905932737*alphaDragSurf[0] > 0) { 
    fUpwindQuad[19] = ser_4x_p2_surfx4_eval_quad_node_19_r(fL); 
  } else { 
    fUpwindQuad[19] = ser_4x_p2_surfx4_eval_quad_node_19_l(fC); 
  } 
  if (-(0.5692099788303082*alphaDragSurf[19])+0.5692099788303082*alphaDragSurf[18]-0.5692099788303082*alphaDragSurf[17]-0.42426406871192807*alphaDragSurf[16]+0.42426406871192807*alphaDragSurf[15]+0.42426406871192845*(alphaDragSurf[14]+alphaDragSurf[13])+0.42426406871192807*alphaDragSurf[12]-0.42426406871192845*alphaDragSurf[11]-0.853814968245462*alphaDragSurf[10]+0.3162277660168379*(alphaDragSurf[9]+alphaDragSurf[8]+alphaDragSurf[7])-0.6363961030678926*alphaDragSurf[6]+0.6363961030678926*alphaDragSurf[5]-0.6363961030678926*alphaDragSurf[4]+0.4743416490252568*alphaDragSurf[3]-0.4743416490252568*alphaDragSurf[2]+0.4743416490252568*alphaDragSurf[1]+0.3535533905932737*alphaDragSurf[0] > 0) { 
    fUpwindQuad[20] = ser_4x_p2_surfx4_eval_quad_node_20_r(fL); 
  } else { 
    fUpwindQuad[20] = ser_4x_p2_surfx4_eval_quad_node_20_l(fC); 
  } 
  if (0.711512473537885*alphaDragSurf[18]+0.42426406871192807*alphaDragSurf[15]+0.5303300858899104*alphaDragSurf[14]-0.42426406871192845*alphaDragSurf[13]-0.5303300858899104*alphaDragSurf[12]+0.3162277660168379*alphaDragSurf[9]-0.3952847075210473*alphaDragSurf[8]+0.3162277660168379*alphaDragSurf[7]-0.6363961030678926*alphaDragSurf[5]-0.4743416490252568*alphaDragSurf[3]+0.4743416490252568*alphaDragSurf[1]+0.3535533905932737*alphaDragSurf[0] > 0) { 
    fUpwindQuad[21] = ser_4x_p2_surfx4_eval_quad_node_21_r(fL); 
  } else { 
    fUpwindQuad[21] = ser_4x_p2_surfx4_eval_quad_node_21_l(fC); 
  } 
  if (-(0.5303300858899104*(alphaDragSurf[15]+alphaDragSurf[12]))-0.3952847075210473*(alphaDragSurf[9]+alphaDragSurf[8])+0.3162277660168379*alphaDragSurf[7]+0.4743416490252568*alphaDragSurf[1]+0.3535533905932737*alphaDragSurf[0] > 0) { 
    fUpwindQuad[22] = ser_4x_p2_surfx4_eval_quad_node_22_r(fL); 
  } else { 
    fUpwindQuad[22] = ser_4x_p2_surfx4_eval_quad_node_22_l(fC); 
  } 
  if (-(0.711512473537885*alphaDragSurf[18])+0.42426406871192807*alphaDragSurf[15]-0.5303300858899104*alphaDragSurf[14]+0.42426406871192845*alphaDragSurf[13]-0.5303300858899104*alphaDragSurf[12]+0.3162277660168379*alphaDragSurf[9]-0.3952847075210473*alphaDragSurf[8]+0.3162277660168379*alphaDragSurf[7]+0.6363961030678926*alphaDragSurf[5]+0.4743416490252568*(alphaDragSurf[3]+alphaDragSurf[1])+0.3535533905932737*alphaDragSurf[0] > 0) { 
    fUpwindQuad[23] = ser_4x_p2_surfx4_eval_quad_node_23_r(fL); 
  } else { 
    fUpwindQuad[23] = ser_4x_p2_surfx4_eval_quad_node_23_l(fC); 
  } 
  if (0.5692099788303082*alphaDragSurf[19]-0.5692099788303082*(alphaDragSurf[18]+alphaDragSurf[17])+0.42426406871192807*(alphaDragSurf[16]+alphaDragSurf[15])-0.42426406871192845*(alphaDragSurf[14]+alphaDragSurf[13])+0.42426406871192807*alphaDragSurf[12]+0.42426406871192845*alphaDragSurf[11]-0.853814968245462*alphaDragSurf[10]+0.3162277660168379*(alphaDragSurf[9]+alphaDragSurf[8]+alphaDragSurf[7])-0.6363961030678926*(alphaDragSurf[6]+alphaDragSurf[5])+0.6363961030678926*alphaDragSurf[4]-0.4743416490252568*alphaDragSurf[3]+0.4743416490252568*(alphaDragSurf[2]+alphaDragSurf[1])+0.3535533905932737*alphaDragSurf[0] > 0) { 
    fUpwindQuad[24] = ser_4x_p2_surfx4_eval_quad_node_24_r(fL); 
  } else { 
    fUpwindQuad[24] = ser_4x_p2_surfx4_eval_quad_node_24_l(fC); 
  } 
  if (-(0.711512473537885*alphaDragSurf[19])-0.5303300858899104*(alphaDragSurf[16]+alphaDragSurf[15])+0.42426406871192807*alphaDragSurf[12]+0.42426406871192845*alphaDragSurf[11]-0.3952847075210473*alphaDragSurf[9]+0.3162277660168379*(alphaDragSurf[8]+alphaDragSurf[7])+0.6363961030678926*alphaDragSurf[4]+0.4743416490252568*(alphaDragSurf[2]+alphaDragSurf[1])+0.3535533905932737*alphaDragSurf[0] > 0) { 
    fUpwindQuad[25] = ser_4x_p2_surfx4_eval_quad_node_25_r(fL); 
  } else { 
    fUpwindQuad[25] = ser_4x_p2_surfx4_eval_quad_node_25_l(fC); 
  } 
  if (0.5692099788303082*(alphaDragSurf[19]+alphaDragSurf[18]+alphaDragSurf[17])+0.42426406871192807*(alphaDragSurf[16]+alphaDragSurf[15])+0.42426406871192845*(alphaDragSurf[14]+alphaDragSurf[13])+0.42426406871192807*alphaDragSurf[12]+0.42426406871192845*alphaDragSurf[11]+0.853814968245462*alphaDragSurf[10]+0.3162277660168379*(alphaDragSurf[9]+alphaDragSurf[8]+alphaDragSurf[7])+0.6363961030678926*(alphaDragSurf[6]+alphaDragSurf[5]+alphaDragSurf[4])+0.4743416490252568*(alphaDragSurf[3]+alphaDragSurf[2]+alphaDragSurf[1])+0.3535533905932737*alphaDragSurf[0] > 0) { 
    fUpwindQuad[26] = ser_4x_p2_surfx4_eval_quad_node_26_r(fL); 
  } else { 
    fUpwindQuad[26] = ser_4x_p2_surfx4_eval_quad_node_26_l(fC); 
  } 
