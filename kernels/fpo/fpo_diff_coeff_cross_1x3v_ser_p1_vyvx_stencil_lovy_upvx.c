...
GKYL_CU_DH void fpo_diff_coeff_cross_1x3v_vyvx_ser_p1_lovy_upvx(const double *dxv, const double *gamma, const double* fpo_g_stencil[9], const double* fpo_g_surf_stencil[9], const double* fpo_dgdv_surf, double *diff_coeff) { 
  ...
  surft2_up[0] = 0.34587411908091625*GTC[24]+0.34587411908091625*GCC[24]-0.49755260400283263*GTC[3]+0.49755260400283263*GCC[3]+0.3535533905932737*GTC[0]+0.3535533905932737*GCC[0]; 
  surft2_up[1] = 0.34587411908091625*GTC[25]+0.34587411908091625*GCC[25]-0.49755260400283263*GTC[6]+0.49755260400283263*GCC[6]+0.3535533905932737*GTC[1]+0.3535533905932737*GCC[1]; 
  surft2_up[2] = 0.34587411908091625*GTC[26]+0.34587411908091625*GCC[26]-0.49755260400283263*GTC[7]+0.49755260400283263*GCC[7]+0.3535533905932737*GTC[2]+0.3535533905932737*GCC[2]; 
  ...
  surft2_up[4] = 0.34587411908091625*GTC[28]+0.34587411908091625*GCC[28]-0.49755260400283263*GTC[11]+0.49755260400283263*GCC[11]+0.3535533905932737*GTC[5]+0.3535533905932737*GCC[5]; 
  surft2_up[5] = 0.34587411908091625*GTC[29]+0.34587411908091625*GCC[29]-0.49755260400283263*GTC[13]+0.49755260400283263*GCC[13]+0.3535533905932737*GTC[8]+0.3535533905932737*GCC[8]; 
  surft2_up[6] = 0.34587411908091625*GTC[30]+0.34587411908091625*GCC[30]-0.49755260400283263*GTC[14]+0.49755260400283263*GCC[14]+0.3535533905932737*GTC[9]+0.3535533905932737*GCC[9]; 
  surft2_up[7] = 0.34587411908091625*GTC[31]+0.34587411908091625*GCC[31]-0.49755260400283263*GTC[15]+0.49755260400283263*GCC[15]+0.3535533905932737*GTC[12]+0.3535533905932737*GCC[12]; 
  surft2_up[8] = -(0.49755260400283263*GTC[18])+0.49755260400283263*GCC[18]+0.3535533905932737*GTC[16]+0.3535533905932737*GCC[16]; 
  surft2_up[9] = -(0.49755260400283263*GTC[20])+0.49755260400283263*GCC[20]+0.3535533905932737*GTC[17]+0.3535533905932737*GCC[17]; 
  surft2_up[10] = -(0.49755260400283263*GTC[22])+0.49755260400283263*GCC[22]+0.3535533905932737*GTC[19]+0.3535533905932737*GCC[19]; 
  surft2_up[11] = -(0.49755260400283263*GTC[23])+0.49755260400283263*GCC[23]+0.3535533905932737*GTC[21]+0.3535533905932737*GCC[21]; 
  surft2_up[12] = -(0.49755260400283263*GTC[35])+0.49755260400283263*GCC[35]+0.3535533905932737*GTC[32]+0.3535533905932737*GCC[32]; 
  surft2_up[13] = -(0.49755260400283263*GTC[37])+0.49755260400283263*GCC[37]+0.3535533905932737*GTC[33]+0.3535533905932737*GCC[33]; 
  surft2_up[14] = -(0.49755260400283263*GTC[38])+0.49755260400283263*GCC[38]+0.3535533905932737*GTC[34]+0.3535533905932737*GCC[34]; 
  surft2_up[15] = -(0.49755260400283263*GTC[39])+0.49755260400283263*GCC[39]+0.3535533905932737*GTC[36]+0.3535533905932737*GCC[36]; 
