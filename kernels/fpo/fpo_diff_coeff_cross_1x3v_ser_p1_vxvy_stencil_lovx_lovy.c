...
GKYL_CU_DH void fpo_diff_coeff_cross_1x3v_vxvy_ser_p1_lovx_lovy(const double *dxv, const double *gamma, const double* fpo_g_stencil[9], const double* fpo_g_surf_stencil[9], const double* fpo_dgdv_surf, double *diff_coeff) { 
  ...
  surft1_up[0] = 0.599071547271275*GTC[26]+0.599071547271275*GCC[26]-0.8617863895711042*GTC[7]+0.8617863895711042*GCC[7]+0.6123724356957944*GTC[2]+0.6123724356957944*GCC[2]; 
  surft1_up[1] = 0.599071547271275*GTC[28]+0.599071547271275*GCC[28]-0.8617863895711042*GTC[11]+0.8617863895711042*GCC[11]+0.6123724356957944*GTC[5]+0.6123724356957944*GCC[5]; 
  surft1_up[2] = -(1.9270129491651047*GTC[18])+1.9270129491651047*GCC[18]+1.369306393762915*GTC[16]+1.369306393762915*GCC[16]; 
  surft1_up[3] = 0.599071547271275*GTC[30]+0.599071547271275*GCC[30]-0.8617863895711042*GTC[14]+0.8617863895711042*GCC[14]+0.6123724356957944*GTC[9]+0.6123724356957944*GCC[9]; 
  surft1_up[4] = -(1.927012949165105*GTC[20])+1.927012949165105*GCC[20]+1.369306393762915*GTC[17]+1.369306393762915*GCC[17]; 
  surft1_up[5] = 0.599071547271275*GTC[31]+0.599071547271275*GCC[31]-0.8617863895711042*GTC[15]+0.8617863895711042*GCC[15]+0.6123724356957944*GTC[12]+0.6123724356957944*GCC[12]; 
  surft1_up[6] = -(1.927012949165105*GTC[22])+1.927012949165105*GCC[22]+1.369306393762915*GTC[19]+1.369306393762915*GCC[19]; 
  surft1_up[7] = -(1.9270129491651047*GTC[23])+1.9270129491651047*GCC[23]+1.369306393762915*GTC[21]+1.369306393762915*GCC[21]; 
  surft1_up[12] = -(0.8617863895711042*GTC[38])+0.8617863895711042*GCC[38]+0.6123724356957944*GTC[34]+0.6123724356957944*GCC[34]; 
  surft1_up[13] = -(0.8617863895711042*GTC[39])+0.8617863895711042*GCC[39]+0.6123724356957944*GTC[36]+0.6123724356957944*GCC[36]; 
