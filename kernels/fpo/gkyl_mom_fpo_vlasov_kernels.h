...
GKYL_CU_DH void mom_bcorr_fpo_vlasov_1x3v_ser_p1(const double *w, const int *idx, enum gkyl_vel_edge edge, const double *vBoundary, const double *dxv, const double *D_ij, const double *fIn, double* GKYL_RESTRICT out); 
...
GKYL_CU_DH void mom_bcorr_fpo_vlasov_1x3v_ser_p2(const double *w, const int *idx, enum gkyl_vel_edge edge, const double *vBoundary, const double *dxv, const double *D_ij, const double *fIn, double* GKYL_RESTRICT out); 
...
GKYL_CU_DH void mom_bcorr_fpo_vlasov_2x3v_ser_p1(const double *w, const int *idx, enum gkyl_vel_edge edge, const double *vBoundary, const double *dxv, const double *D_ij, const double *fIn, double* GKYL_RESTRICT out);

GKYL_CU_DH void mom_fpo_vlasov_2x3v_ser_p2(const double *w, const double *dxv, const int *idx, const double *a_i, const double *D_ij,  const double *f, double* GKYL_RESTRICT out); 
GKYL_CU_DH void mom_bcorr_fpo_vlasov_2x3v_ser_p2(const double *w, const int *idx, enum gkyl_vel_edge edge, const double *vBoundary, const double *dxv, const double *D_ij, const double *fIn, double* GKYL_RESTRICT out);

GKYL_CU_DH void mom_fpo_vlasov_3x3v_ser_p1(const double *w, const double *dxv, const int *idx, const double *a_i, const double *D_ij,  const double *f, double* GKYL_RESTRICT out); 
GKYL_CU_DH void mom_bcorr_fpo_vlasov_3x3v_ser_p1(const double *w, const int *idx, enum gkyl_vel_edge edge, const double *vBoundary, const double *dxv, const double *D_ij, const double *fIn, double* GKYL_RESTRICT out);
...
GKYL_CU_DH void mom_fpo_vlasov_coeff_correct_mat_3x3v_ser_p1(struct gkyl_mat *lhs, struct gkyl_mat *rhs, const double *fpo_moms, const double *boundary_corrections, const double *moms); 
