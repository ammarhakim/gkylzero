...
GKYL_CU_DH void fpo_vlasov_drag_surfvx_1x3v_ser_p2(const double* dxv, const double* drag_coeff_stencil[9], const double* f_stencil[9], double* GKYL_RESTRICT out); 
...
GKYL_CU_DH void fpo_vlasov_drag_surfvy_1x3v_ser_p2(const double* dxv, const double* drag_coeff_stencil[9], const double* f_stencil[9], double* GKYL_RESTRICT out); 
...
GKYL_CU_DH void fpo_vlasov_drag_surfvz_1x3v_ser_p2(const double* dxv, const double* drag_coeff_stencil[9], const double* f_stencil[9], double* GKYL_RESTRICT out); 
