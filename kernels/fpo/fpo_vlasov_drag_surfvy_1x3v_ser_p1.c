...
{ 
  ...
  out[3] += 2.449489742783178*Ghat_u[0]*rdv2; 
  out[6] += 2.449489742783178*Ghat_u[1]*rdv2; 
  out[7] += 2.449489742783178*Ghat_u[2]*rdv2; 
  out[10] += 2.449489742783178*Ghat_u[3]*rdv2; 
  out[11] += 2.449489742783178*Ghat_u[4]*rdv2; 
  out[13] += 2.449489742783178*Ghat_u[5]*rdv2; 
