...
GKYL_CU_DH void fpo_vlasov_drag_surfvy_1x3v_ser_p1(const double* dxv, const double* drag_coeff_stencil[9], const double* f_stencil[9], double* GKYL_RESTRICT out) { 
  ...
  const double* aL = &drag_coeff_stencil[0][40]; 
  const double* aC = &drag_coeff_stencil[1][40]; 
  const double* aR = &drag_coeff_stencil[2][40]; 
  double dv1 = 2.0/dxv[2]; 

  double alphaDragSurf_lo[8] = {0.0}; 
  alphaDragSurf_lo[0] = 0.408248290463863*aL[3]-0.408248290463863*aC[3]+0.3535533905932737*aL[0]+0.3535533905932737*aC[0]; 
  alphaDragSurf_lo[1] = 0.408248290463863*aL[6]-0.408248290463863*aC[6]+0.3535533905932737*aL[1]+0.3535533905932737*aC[1]; 
  alphaDragSurf_lo[2] = 0.408248290463863*aL[7]-0.408248290463863*aC[7]+0.3535533905932737*aL[2]+0.3535533905932737*aC[2]; 
  alphaDragSurf_lo[3] = 0.408248290463863*aL[10]-0.408248290463863*aC[10]+0.3535533905932737*aL[4]+0.3535533905932737*aC[4]; 
  alphaDragSurf_lo[4] = 0.408248290463863*aL[11]-0.408248290463863*aC[11]+0.3535533905932737*aL[5]+0.3535533905932737*aC[5]; 
  alphaDragSurf_lo[5] = 0.408248290463863*aL[13]-0.408248290463863*aC[13]+0.3535533905932737*aL[8]+0.3535533905932737*aC[8]; 
  alphaDragSurf_lo[6] = 0.408248290463863*aL[14]-0.408248290463863*aC[14]+0.3535533905932737*aL[9]+0.3535533905932737*aC[9]; 
  alphaDragSurf_lo[7] = 0.408248290463863*aL[15]-0.408248290463863*aC[15]+0.3535533905932737*aL[12]+0.3535533905932737*aC[12]; 

  double alphaDragSurf_up[8] = {0.0}; 
  alphaDragSurf_up[0] = -(0.408248290463863*aR[3])+0.408248290463863*aC[3]+0.3535533905932737*aR[0]+0.3535533905932737*aC[0]; 
  alphaDragSurf_up[1] = -(0.408248290463863*aR[6])+0.408248290463863*aC[6]+0.3535533905932737*aR[1]+0.3535533905932737*aC[1]; 
  alphaDragSurf_up[2] = -(0.408248290463863*aR[7])+0.408248290463863*aC[7]+0.3535533905932737*aR[2]+0.3535533905932737*aC[2]; 
  alphaDragSurf_up[3] = -(0.408248290463863*aR[10])+0.408248290463863*aC[10]+0.3535533905932737*aR[4]+0.3535533905932737*aC[4]; 
  alphaDragSurf_up[4] = -(0.408248290463863*aR[11])+0.408248290463863*aC[11]+0.3535533905932737*aR[5]+0.3535533905932737*aC[5]; 
  alphaDragSurf_up[5] = -(0.408248290463863*aR[13])+0.408248290463863*aC[13]+0.3535533905932737*aR[8]+0.3535533905932737*aC[8]; 
  alphaDragSurf_up[6] = -(0.408248290463863*aR[14])+0.408248290463863*aC[14]+0.3535533905932737*aR[9]+0.3535533905932737*aC[9]; 
  alphaDragSurf_up[7] = -(0.408248290463863*aR[15])+0.408248290463863*aC[15]+0.3535533905932737*aR[12]+0.3535533905932737*aC[12]; 
  ...
  if (-(0.3535533905932737*alphaDragSurf_lo[7])+0.3535533905932737*(alphaDragSurf_lo[6]+alphaDragSurf_lo[5]+alphaDragSurf_lo[4])-0.3535533905932737*(alphaDragSurf_lo[3]+alphaDragSurf_lo[2]+alphaDragSurf_lo[1])+0.3535533905932737*alphaDragSurf_lo[0] > 0) { 
    fUpwindQuad_lo[0] = ser_4x_p1_surfx3_eval_quad_node_0_r(fL); 
  } else { 
    fUpwindQuad_lo[0] = ser_4x_p1_surfx3_eval_quad_node_0_l(fC); 
  } 
  if (-(0.3535533905932737*alphaDragSurf_up[7])+0.3535533905932737*(alphaDragSurf_up[6]+alphaDragSurf_up[5]+alphaDragSurf_up[4])-0.3535533905932737*(alphaDragSurf_up[3]+alphaDragSurf_up[2]+alphaDragSurf_up[1])+0.3535533905932737*alphaDragSurf_up[0] > 0) { 
    fUpwindQuad_up[0] = ser_4x_p1_surfx3_eval_quad_node_0_r(fC); 
  } else { 
    fUpwindQuad_up[0] = ser_4x_p1_surfx3_eval_quad_node_0_l(fR); 
  } 
  if (0.3535533905932737*alphaDragSurf_lo[7]-0.3535533905932737*(alphaDragSurf_lo[6]+alphaDragSurf_lo[5])+0.3535533905932737*(alphaDragSurf_lo[4]+alphaDragSurf_lo[3])-0.3535533905932737*(alphaDragSurf_lo[2]+alphaDragSurf_lo[1])+0.3535533905932737*alphaDragSurf_lo[0] > 0) { 
    fUpwindQuad_lo[1] = ser_4x_p1_surfx3_eval_quad_node_1_r(fL); 
  } else { 
    fUpwindQuad_lo[1] = ser_4x_p1_surfx3_eval_quad_node_1_l(fC); 
  } 
  if (0.3535533905932737*alphaDragSurf_up[7]-0.3535533905932737*(alphaDragSurf_up[6]+alphaDragSurf_up[5])+0.3535533905932737*(alphaDragSurf_up[4]+alphaDragSurf_up[3])-0.3535533905932737*(alphaDragSurf_up[2]+alphaDragSurf_up[1])+0.3535533905932737*alphaDragSurf_up[0] > 0) { 
    fUpwindQuad_up[1] = ser_4x_p1_surfx3_eval_quad_node_1_r(fC); 
  } else { 
    fUpwindQuad_up[1] = ser_4x_p1_surfx3_eval_quad_node_1_l(fR); 
  } 
  if (0.3535533905932737*alphaDragSurf_lo[7]-0.3535533905932737*alphaDragSurf_lo[6]+0.3535533905932737*alphaDragSurf_lo[5]-0.3535533905932737*(alphaDragSurf_lo[4]+alphaDragSurf_lo[3])+0.3535533905932737*alphaDragSurf_lo[2]-0.3535533905932737*alphaDragSurf_lo[1]+0.3535533905932737*alphaDragSurf_lo[0] > 0) { 
    fUpwindQuad_lo[2] = ser_4x_p1_surfx3_eval_quad_node_2_r(fL); 
  } else { 
    fUpwindQuad_lo[2] = ser_4x_p1_surfx3_eval_quad_node_2_l(fC); 
  } 
  if (0.3535533905932737*alphaDragSurf_up[7]-0.3535533905932737*alphaDragSurf_up[6]+0.3535533905932737*alphaDragSurf_up[5]-0.3535533905932737*(alphaDragSurf_up[4]+alphaDragSurf_up[3])+0.3535533905932737*alphaDragSurf_up[2]-0.3535533905932737*alphaDragSurf_up[1]+0.3535533905932737*alphaDragSurf_up[0] > 0) { 
    fUpwindQuad_up[2] = ser_4x_p1_surfx3_eval_quad_node_2_r(fC); 
  } else { 
    fUpwindQuad_up[2] = ser_4x_p1_surfx3_eval_quad_node_2_l(fR); 
  } 
  if (-(0.3535533905932737*alphaDragSurf_lo[7])+0.3535533905932737*alphaDragSurf_lo[6]-0.3535533905932737*(alphaDragSurf_lo[5]+alphaDragSurf_lo[4])+0.3535533905932737*(alphaDragSurf_lo[3]+alphaDragSurf_lo[2])-0.3535533905932737*alphaDragSurf_lo[1]+0.3535533905932737*alphaDragSurf_lo[0] > 0) { 
    fUpwindQuad_lo[3] = ser_4x_p1_surfx3_eval_quad_node_3_r(fL); 
  } else { 
    fUpwindQuad_lo[3] = ser_4x_p1_surfx3_eval_quad_node_3_l(fC); 
  } 
  if (-(0.3535533905932737*alphaDragSurf_up[7])+0.3535533905932737*alphaDragSurf_up[6]-0.3535533905932737*(alphaDragSurf_up[5]+alphaDragSurf_up[4])+0.3535533905932737*(alphaDragSurf_up[3]+alphaDragSurf_up[2])-0.3535533905932737*alphaDragSurf_up[1]+0.3535533905932737*alphaDragSurf_up[0] > 0) { 
    fUpwindQuad_up[3] = ser_4x_p1_surfx3_eval_quad_node_3_r(fC); 
  } else { 
    fUpwindQuad_up[3] = ser_4x_p1_surfx3_eval_quad_node_3_l(fR); 
  } 
  if (0.3535533905932737*(alphaDragSurf_lo[7]+alphaDragSurf_lo[6])-0.3535533905932737*(alphaDragSurf_lo[5]+alphaDragSurf_lo[4]+alphaDragSurf_lo[3]+alphaDragSurf_lo[2])+0.3535533905932737*(alphaDragSurf_lo[1]+alphaDragSurf_lo[0]) > 0) { 
    fUpwindQuad_lo[4] = ser_4x_p1_surfx3_eval_quad_node_4_r(fL); 
  } else { 
    fUpwindQuad_lo[4] = ser_4x_p1_surfx3_eval_quad_node_4_l(fC); 
  } 
  if (0.3535533905932737*(alphaDragSurf_up[7]+alphaDragSurf_up[6])-0.3535533905932737*(alphaDragSurf_up[5]+alphaDragSurf_up[4]+alphaDragSurf_up[3]+alphaDragSurf_up[2])+0.3535533905932737*(alphaDragSurf_up[1]+alphaDragSurf_up[0]) > 0) { 
    fUpwindQuad_up[4] = ser_4x_p1_surfx3_eval_quad_node_4_r(fC); 
  } else { 
    fUpwindQuad_up[4] = ser_4x_p1_surfx3_eval_quad_node_4_l(fR); 
  } 
  if (-(0.3535533905932737*(alphaDragSurf_lo[7]+alphaDragSurf_lo[6]))+0.3535533905932737*alphaDragSurf_lo[5]-0.3535533905932737*alphaDragSurf_lo[4]+0.3535533905932737*alphaDragSurf_lo[3]-0.3535533905932737*alphaDragSurf_lo[2]+0.3535533905932737*(alphaDragSurf_lo[1]+alphaDragSurf_lo[0]) > 0) { 
    fUpwindQuad_lo[5] = ser_4x_p1_surfx3_eval_quad_node_5_r(fL); 
  } else { 
    fUpwindQuad_lo[5] = ser_4x_p1_surfx3_eval_quad_node_5_l(fC); 
  } 
  if (-(0.3535533905932737*(alphaDragSurf_up[7]+alphaDragSurf_up[6]))+0.3535533905932737*alphaDragSurf_up[5]-0.3535533905932737*alphaDragSurf_up[4]+0.3535533905932737*alphaDragSurf_up[3]-0.3535533905932737*alphaDragSurf_up[2]+0.3535533905932737*(alphaDragSurf_up[1]+alphaDragSurf_up[0]) > 0) { 
    fUpwindQuad_up[5] = ser_4x_p1_surfx3_eval_quad_node_5_r(fC); 
  } else { 
    fUpwindQuad_up[5] = ser_4x_p1_surfx3_eval_quad_node_5_l(fR); 
  } 
  if (-(0.3535533905932737*(alphaDragSurf_lo[7]+alphaDragSurf_lo[6]+alphaDragSurf_lo[5]))+0.3535533905932737*alphaDragSurf_lo[4]-0.3535533905932737*alphaDragSurf_lo[3]+0.3535533905932737*(alphaDragSurf_lo[2]+alphaDragSurf_lo[1]+alphaDragSurf_lo[0]) > 0) { 
    fUpwindQuad_lo[6] = ser_4x_p1_surfx3_eval_quad_node_6_r(fL); 
  } else { 
    fUpwindQuad_lo[6] = ser_4x_p1_surfx3_eval_quad_node_6_l(fC); 
  } 
  if (-(0.3535533905932737*(alphaDragSurf_up[7]+alphaDragSurf_up[6]+alphaDragSurf_up[5]))+0.3535533905932737*alphaDragSurf_up[4]-0.3535533905932737*alphaDragSurf_up[3]+0.3535533905932737*(alphaDragSurf_up[2]+alphaDragSurf_up[1]+alphaDragSurf_up[0]) > 0) { 
    fUpwindQuad_up[6] = ser_4x_p1_surfx3_eval_quad_node_6_r(fC); 
  } else { 
    fUpwindQuad_up[6] = ser_4x_p1_surfx3_eval_quad_node_6_l(fR); 
  } 
  if (0.3535533905932737*(alphaDragSurf_lo[7]+alphaDragSurf_lo[6]+alphaDragSurf_lo[5]+alphaDragSurf_lo[4]+alphaDragSurf_lo[3]+alphaDragSurf_lo[2]+alphaDragSurf_lo[1]+alphaDragSurf_lo[0]) > 0) { 
    fUpwindQuad_lo[7] = ser_4x_p1_surfx3_eval_quad_node_7_r(fL); 
  } else { 
    fUpwindQuad_lo[7] = ser_4x_p1_surfx3_eval_quad_node_7_l(fC); 
  } 
  if (0.3535533905932737*(alphaDragSurf_up[7]+alphaDragSurf_up[6]+alphaDragSurf_up[5]+alphaDragSurf_up[4]+alphaDragSurf_up[3]+alphaDragSurf_up[2]+alphaDragSurf_up[1]+alphaDragSurf_up[0]) > 0) { 
    fUpwindQuad_up[7] = ser_4x_p1_surfx3_eval_quad_node_7_r(fC); 
  } else { 
    fUpwindQuad_up[7] = ser_4x_p1_surfx3_eval_quad_node_7_l(fR); 
  } 
  ...
  out[3] += 0.6123724356957945*Ghat_up[0]*dv1+0.6123724356957945*Ghat_lo[0]*dv1; 
  ...
  out[6] += 0.6123724356957945*Ghat_up[1]*dv1+0.6123724356957945*Ghat_lo[1]*dv1; 
  ...
  out[9] += 0.35355339059327373*Ghat_up[6]*dv1-0.35355339059327373*Ghat_lo[6]*dv1; 
  ...
  out[12] += 0.35355339059327373*Ghat_up[7]*dv1-0.35355339059327373*Ghat_lo[7]*dv1; 
  ...
  out[24] += 0.7905694150420948*Ghat_up[0]*dv1-0.7905694150420948*Ghat_lo[0]*dv1; 
  out[25] += 0.7905694150420949*Ghat_up[1]*dv1-0.7905694150420949*Ghat_lo[1]*dv1; 
  out[26] += 0.7905694150420949*Ghat_up[2]*dv1-0.7905694150420949*Ghat_lo[2]*dv1; 
  out[27] += 0.7905694150420949*Ghat_up[3]*dv1-0.7905694150420949*Ghat_lo[3]*dv1; 
  out[28] += 0.7905694150420948*Ghat_up[4]*dv1-0.7905694150420948*Ghat_lo[4]*dv1; 
  out[29] += 0.7905694150420948*Ghat_up[5]*dv1-0.7905694150420948*Ghat_lo[5]*dv1; 
  out[30] += 0.7905694150420948*Ghat_up[6]*dv1-0.7905694150420948*Ghat_lo[6]*dv1; 
  out[31] += 0.7905694150420949*Ghat_up[7]*dv1-0.7905694150420949*Ghat_lo[7]*dv1; 
