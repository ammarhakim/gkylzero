...
GKYL_CU_DH void
fpo_vlasov_drag_surfvy_1x3v_ser_p1(const double* w, const double* dxv, const double* hl, const double *hc, const double* hu,const double* fl, const double* fc, const double* fu, double* GKYL_RESTRICT out) 
{ 
  ...
  alphaDrSurf_l[0] = (-0.7654655446197428*hl[3])-0.7654655446197428*hc[3]-0.7954951288348656*hl[0]+0.7954951288348656*hc[0]; 
  alphaDrSurf_l[1] = (-0.7654655446197428*hl[6])-0.7654655446197428*hc[6]-0.7954951288348656*hl[1]+0.7954951288348656*hc[1]; 
  alphaDrSurf_l[2] = (-0.7654655446197428*hl[7])-0.7654655446197428*hc[7]-0.7954951288348656*hl[2]+0.7954951288348656*hc[2]; 
  alphaDrSurf_l[3] = (-0.7654655446197428*hl[10])-0.7654655446197428*hc[10]-0.7954951288348656*hl[4]+0.7954951288348656*hc[4]; 
  alphaDrSurf_l[4] = (-0.7654655446197428*hl[11])-0.7654655446197428*hc[11]-0.7954951288348656*hl[5]+0.7954951288348656*hc[5]; 
  alphaDrSurf_l[5] = (-0.7654655446197428*hl[13])-0.7654655446197428*hc[13]-0.7954951288348656*hl[8]+0.7954951288348656*hc[8]; 
  alphaDrSurf_l[6] = (-0.7654655446197428*hl[14])-0.7654655446197428*hc[14]-0.7954951288348656*hl[9]+0.7954951288348656*hc[9]; 
  alphaDrSurf_l[7] = (-0.7654655446197428*hl[15])-0.7654655446197428*hc[15]-0.7954951288348656*hl[12]+0.7954951288348656*hc[12]; 

  double alphaDrSurf_u[8] = {0.0}; 
  alphaDrSurf_u[0] = (-0.7654655446197428*hu[3])-0.7654655446197428*hc[3]+0.7954951288348656*hu[0]-0.7954951288348656*hc[0]; 
  alphaDrSurf_u[1] = (-0.7654655446197428*hu[6])-0.7654655446197428*hc[6]+0.7954951288348656*hu[1]-0.7954951288348656*hc[1]; 
  alphaDrSurf_u[2] = (-0.7654655446197428*hu[7])-0.7654655446197428*hc[7]+0.7954951288348656*hu[2]-0.7954951288348656*hc[2]; 
  alphaDrSurf_u[3] = (-0.7654655446197428*hu[10])-0.7654655446197428*hc[10]+0.7954951288348656*hu[4]-0.7954951288348656*hc[4]; 
  alphaDrSurf_u[4] = (-0.7654655446197428*hu[11])-0.7654655446197428*hc[11]+0.7954951288348656*hu[5]-0.7954951288348656*hc[5]; 
  alphaDrSurf_u[5] = (-0.7654655446197428*hu[13])-0.7654655446197428*hc[13]+0.7954951288348656*hu[8]-0.7954951288348656*hc[8]; 
  alphaDrSurf_u[6] = (-0.7654655446197428*hu[14])-0.7654655446197428*hc[14]+0.7954951288348656*hu[9]-0.7954951288348656*hc[9]; 
  alphaDrSurf_u[7] = (-0.7654655446197428*hu[15])-0.7654655446197428*hc[15]+0.7954951288348656*hu[12]-0.7954951288348656*hc[12]; 
  ...
  if ((-0.3535533905932737*alphaDrSurf_u[7])+0.3535533905932737*(alphaDrSurf_u[6]+alphaDrSurf_u[5]+alphaDrSurf_u[4])-0.3535533905932737*(alphaDrSurf_u[3]+alphaDrSurf_u[2]+alphaDrSurf_u[1])+0.3535533905932737*alphaDrSurf_u[0] > 0) { 
    fUpwindQuad_u[0] = ser_4x_p1_surfx3_eval_quad_node_0_r(fc); 
  } else { 
    fUpwindQuad_u[0] = ser_4x_p1_surfx3_eval_quad_node_0_l(fu); 
  } 
  ...
  if (0.3535533905932737*alphaDrSurf_u[7]-0.3535533905932737*(alphaDrSurf_u[6]+alphaDrSurf_u[5])+0.3535533905932737*(alphaDrSurf_u[4]+alphaDrSurf_u[3])-0.3535533905932737*(alphaDrSurf_u[2]+alphaDrSurf_u[1])+0.3535533905932737*alphaDrSurf_u[0] > 0) { 
    fUpwindQuad_u[1] = ser_4x_p1_surfx3_eval_quad_node_1_r(fc); 
  } else { 
    fUpwindQuad_u[1] = ser_4x_p1_surfx3_eval_quad_node_1_l(fu); 
  } 
  ...
  if (0.3535533905932737*alphaDrSurf_u[7]-0.3535533905932737*alphaDrSurf_u[6]+0.3535533905932737*alphaDrSurf_u[5]-0.3535533905932737*(alphaDrSurf_u[4]+alphaDrSurf_u[3])+0.3535533905932737*alphaDrSurf_u[2]-0.3535533905932737*alphaDrSurf_u[1]+0.3535533905932737*alphaDrSurf_u[0] > 0) { 
    fUpwindQuad_u[2] = ser_4x_p1_surfx3_eval_quad_node_2_r(fc); 
  } else { 
    fUpwindQuad_u[2] = ser_4x_p1_surfx3_eval_quad_node_2_l(fu); 
  } 
  ...
  if ((-0.3535533905932737*alphaDrSurf_u[7])+0.3535533905932737*alphaDrSurf_u[6]-0.3535533905932737*(alphaDrSurf_u[5]+alphaDrSurf_u[4])+0.3535533905932737*(alphaDrSurf_u[3]+alphaDrSurf_u[2])-0.3535533905932737*alphaDrSurf_u[1]+0.3535533905932737*alphaDrSurf_u[0] > 0) { 
    fUpwindQuad_u[3] = ser_4x_p1_surfx3_eval_quad_node_3_r(fc); 
  } else { 
    fUpwindQuad_u[3] = ser_4x_p1_surfx3_eval_quad_node_3_l(fu); 
  } 
  ...
  if (0.3535533905932737*(alphaDrSurf_u[7]+alphaDrSurf_u[6])-0.3535533905932737*(alphaDrSurf_u[5]+alphaDrSurf_u[4]+alphaDrSurf_u[3]+alphaDrSurf_u[2])+0.3535533905932737*(alphaDrSurf_u[1]+alphaDrSurf_u[0]) > 0) { 
    fUpwindQuad_u[4] = ser_4x_p1_surfx3_eval_quad_node_4_r(fc); 
  } else { 
    fUpwindQuad_u[4] = ser_4x_p1_surfx3_eval_quad_node_4_l(fu); 
  } 
  ...
  if ((-0.3535533905932737*(alphaDrSurf_u[7]+alphaDrSurf_u[6]))+0.3535533905932737*alphaDrSurf_u[5]-0.3535533905932737*alphaDrSurf_u[4]+0.3535533905932737*alphaDrSurf_u[3]-0.3535533905932737*alphaDrSurf_u[2]+0.3535533905932737*(alphaDrSurf_u[1]+alphaDrSurf_u[0]) > 0) { 
    fUpwindQuad_u[5] = ser_4x_p1_surfx3_eval_quad_node_5_r(fc); 
  } else { 
    fUpwindQuad_u[5] = ser_4x_p1_surfx3_eval_quad_node_5_l(fu); 
  } 
  ...
  if ((-0.3535533905932737*(alphaDrSurf_u[7]+alphaDrSurf_u[6]+alphaDrSurf_u[5]))+0.3535533905932737*alphaDrSurf_u[4]-0.3535533905932737*alphaDrSurf_u[3]+0.3535533905932737*(alphaDrSurf_u[2]+alphaDrSurf_u[1]+alphaDrSurf_u[0]) > 0) { 
    fUpwindQuad_u[6] = ser_4x_p1_surfx3_eval_quad_node_6_r(fc); 
  } else { 
    fUpwindQuad_u[6] = ser_4x_p1_surfx3_eval_quad_node_6_l(fu); 
  } 
  ...
  if (0.3535533905932737*(alphaDrSurf_u[7]+alphaDrSurf_u[6]+alphaDrSurf_u[5]+alphaDrSurf_u[4]+alphaDrSurf_u[3]+alphaDrSurf_u[2]+alphaDrSurf_u[1]+alphaDrSurf_u[0]) > 0) { 
    fUpwindQuad_u[7] = ser_4x_p1_surfx3_eval_quad_node_7_r(fc); 
  } else { 
    fUpwindQuad_u[7] = ser_4x_p1_surfx3_eval_quad_node_7_l(fu); 
  } 
  ...
  out[3] += 1.224744871391589*Ghat_u[0]*rdv2+1.224744871391589*Ghat_l[0]*rdv2; 
  ...
  out[6] += 1.224744871391589*Ghat_u[1]*rdv2+1.224744871391589*Ghat_l[1]*rdv2; 
  ...
  out[9] += 0.7071067811865475*Ghat_u[6]*rdv2-0.7071067811865475*Ghat_l[6]*rdv2; 
  ...
  out[12] += 0.7071067811865475*Ghat_u[7]*rdv2-0.7071067811865475*Ghat_l[7]*rdv2; 
