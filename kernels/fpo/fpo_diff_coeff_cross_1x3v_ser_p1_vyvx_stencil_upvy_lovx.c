...
GKYL_CU_DH void fpo_diff_coeff_cross_1x3v_vyvx_ser_p1_upvy_lovx(const double *dxv, const double *gamma, const double* fpo_g_stencil[9], const double* fpo_g_surf_stencil[9], const double* fpo_dgdv_surf, double *diff_coeff) { 
  ...
  surft1_up[0] = 0.599071547271275*GCR[18]+0.599071547271275*GCC[18]-0.8617863895711042*GCR[7]+0.8617863895711042*GCC[7]+0.6123724356957944*GCR[3]+0.6123724356957944*GCC[3]; 
  surft1_up[1] = 0.599071547271275*GCR[20]+0.599071547271275*GCC[20]-0.8617863895711042*GCR[11]+0.8617863895711042*GCC[11]+0.6123724356957944*GCR[6]+0.6123724356957944*GCC[6]; 
  surft1_up[2] = -(1.9270129491651047*GCR[26])+1.9270129491651047*GCC[26]+1.369306393762915*GCR[24]+1.369306393762915*GCC[24]; 
  surft1_up[3] = 0.599071547271275*GCR[22]+0.599071547271275*GCC[22]-0.8617863895711042*GCR[14]+0.8617863895711042*GCC[14]+0.6123724356957944*GCR[10]+0.6123724356957944*GCC[10]; 
  surft1_up[4] = -(1.927012949165105*GCR[28])+1.927012949165105*GCC[28]+1.369306393762915*GCR[25]+1.369306393762915*GCC[25]; 
  surft1_up[5] = 0.599071547271275*GCR[23]+0.599071547271275*GCC[23]-0.8617863895711042*GCR[15]+0.8617863895711042*GCC[15]+0.6123724356957944*GCR[13]+0.6123724356957944*GCC[13]; 
  surft1_up[6] = -(1.927012949165105*GCR[30])+1.927012949165105*GCC[30]+1.369306393762915*GCR[27]+1.369306393762915*GCC[27]; 
  surft1_up[7] = -(1.9270129491651047*GCR[31])+1.9270129491651047*GCC[31]+1.369306393762915*GCR[29]+1.369306393762915*GCC[29]; 
  surft1_up[12] = -(0.8617863895711042*GCR[38])+0.8617863895711042*GCC[38]+0.6123724356957944*GCR[35]+0.6123724356957944*GCC[35]; 
  surft1_up[13] = -(0.8617863895711042*GCR[39])+0.8617863895711042*GCC[39]+0.6123724356957944*GCR[37]+0.6123724356957944*GCC[37]; 
