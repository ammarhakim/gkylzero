...
GKYL_CU_DH void fpo_diff_coeff_cross_1x3v_vzvx_ser_p1_upvz_upvx(const double *dxv, const double *gamma, const double* fpo_g_stencil[9], const double* fpo_g_surf_stencil[9], const double* fpo_dgdv_surf, double *diff_coeff) { 
  ...
  surft1_lo[0] = 0.599071547271275*GCL[19]+0.599071547271275*GCC[19]+0.8617863895711042*GCL[9]-0.8617863895711042*GCC[9]+0.6123724356957944*GCL[4]+0.6123724356957944*GCC[4]; 
  surft1_lo[1] = 0.599071547271275*GCL[21]+0.599071547271275*GCC[21]+0.8617863895711042*GCL[12]-0.8617863895711042*GCC[12]+0.6123724356957944*GCL[8]+0.6123724356957944*GCC[8]; 
  surft1_lo[2] = 0.599071547271275*GCL[22]+0.599071547271275*GCC[22]+0.8617863895711042*GCL[14]-0.8617863895711042*GCC[14]+0.6123724356957944*GCL[10]+0.6123724356957944*GCC[10]; 
  surft1_lo[3] = 1.9270129491651047*GCL[34]-1.9270129491651047*GCC[34]+1.369306393762915*GCL[32]+1.369306393762915*GCC[32]; 
  surft1_lo[4] = 0.599071547271275*GCL[23]+0.599071547271275*GCC[23]+0.8617863895711042*GCL[15]-0.8617863895711042*GCC[15]+0.6123724356957944*GCL[13]+0.6123724356957944*GCC[13]; 
  surft1_lo[5] = 1.927012949165105*GCL[36]-1.927012949165105*GCC[36]+1.369306393762915*GCL[33]+1.369306393762915*GCC[33]; 
  surft1_lo[6] = 1.927012949165105*GCL[38]-1.927012949165105*GCC[38]+1.369306393762915*GCL[35]+1.369306393762915*GCC[35]; 
  surft1_lo[7] = 1.9270129491651047*GCL[39]-1.9270129491651047*GCC[39]+1.369306393762915*GCL[37]+1.369306393762915*GCC[37]; 
  surft1_lo[8] = 0.8617863895711042*GCL[30]-0.8617863895711042*GCC[30]+0.6123724356957944*GCL[27]+0.6123724356957944*GCC[27]; 
  surft1_lo[9] = 0.8617863895711042*GCL[31]-0.8617863895711042*GCC[31]+0.6123724356957944*GCL[29]+0.6123724356957944*GCC[29]; 
