...
GKYL_CU_DH void fpo_diff_coeff_cross_1x3v_vzvy_ser_p1_lovz_upvy(const double *dxv, const double *gamma, const double* fpo_g_stencil[9], const double* fpo_g_surf_stencil[9], const double* fpo_dgdv_surf, double *diff_coeff) { 
  ...
  const double* G_surf_CC_vy = &fpo_g_surf_stencil[2][8]; 
  const double* GTC = fpo_g_stencil[3]; 
  const double* dGdvy_surf_CC_vz = &fpo_dgdv_surf[56]; 

  surft1_lo[0] = dGdvy_surf_CC_vz[0]/dv2; 
  surft1_lo[1] = dGdvy_surf_CC_vz[1]/dv2; 
  surft1_lo[2] = dGdvy_surf_CC_vz[2]/dv2; 
  surft1_lo[3] = dGdvy_surf_CC_vz[3]/dv2; 
  surft1_lo[4] = dGdvy_surf_CC_vz[4]/dv2; 
  surft1_lo[5] = dGdvy_surf_CC_vz[5]/dv2; 
  surft1_lo[6] = dGdvy_surf_CC_vz[6]/dv2; 
  surft1_lo[7] = dGdvy_surf_CC_vz[7]/dv2; 
  surft1_up[0] = -(0.7071067811865475*GTC[10])+0.7071067811865475*GCC[10]+0.6123724356957944*GTC[3]+0.6123724356957944*GCC[3]; 
  surft1_up[1] = -(0.7071067811865475*GTC[13])+0.7071067811865475*GCC[13]+0.6123724356957944*GTC[6]+0.6123724356957944*GCC[6]; 
  surft1_up[2] = -(0.7071067811865475*GTC[14])+0.7071067811865475*GCC[14]+0.6123724356957944*GTC[7]+0.6123724356957944*GCC[7]; 
  surft1_up[4] = -(0.7071067811865475*GTC[15])+0.7071067811865475*GCC[15]+0.6123724356957944*GTC[11]+0.6123724356957944*GCC[11]; 

  surft2_lo[0] = 0.408248290463863*GCL[3]-0.408248290463863*GCC[3]+0.3535533905932737*GCL[0]+0.3535533905932737*GCC[0]; 
  surft2_lo[1] = 0.408248290463863*GCL[6]-0.408248290463863*GCC[6]+0.3535533905932737*GCL[1]+0.3535533905932737*GCC[1]; 
  surft2_lo[2] = 0.408248290463863*GCL[7]-0.408248290463863*GCC[7]+0.3535533905932737*GCL[2]+0.3535533905932737*GCC[2]; 
  surft2_lo[3] = 0.408248290463863*GCL[10]-0.408248290463863*GCC[10]+0.3535533905932737*GCL[4]+0.3535533905932737*GCC[4]; 
  surft2_lo[4] = 0.408248290463863*GCL[11]-0.408248290463863*GCC[11]+0.3535533905932737*GCL[5]+0.3535533905932737*GCC[5]; 
  surft2_lo[5] = 0.408248290463863*GCL[13]-0.408248290463863*GCC[13]+0.3535533905932737*GCL[8]+0.3535533905932737*GCC[8]; 
  surft2_lo[6] = 0.408248290463863*GCL[14]-0.408248290463863*GCC[14]+0.3535533905932737*GCL[9]+0.3535533905932737*GCC[9]; 
  surft2_lo[7] = 0.408248290463863*GCL[15]-0.408248290463863*GCC[15]+0.3535533905932737*GCL[12]+0.3535533905932737*GCC[12]; 
  surft2_up[0] = 1.5811388300841895*GCC[24]+1.224744871391589*GCC[3]+0.7071067811865475*GCC[0]; 
  surft2_up[1] = 1.5811388300841898*GCC[25]+1.224744871391589*GCC[6]+0.7071067811865475*GCC[1]; 
  surft2_up[2] = 1.5811388300841898*GCC[26]+1.224744871391589*GCC[7]+0.7071067811865475*GCC[2]; 
  surft2_up[3] = 1.5811388300841898*GCC[27]+1.224744871391589*GCC[10]+0.7071067811865475*GCC[4]; 
  surft2_up[4] = 1.5811388300841895*GCC[28]+1.224744871391589*GCC[11]+0.7071067811865475*GCC[5]; 
  surft2_up[5] = 1.5811388300841895*GCC[29]+1.224744871391589*GCC[13]+0.7071067811865475*GCC[8]; 
  surft2_up[6] = 1.5811388300841895*GCC[30]+1.224744871391589*GCC[14]+0.7071067811865475*GCC[9]; 
  surft2_up[7] = 1.5811388300841898*GCC[31]+1.224744871391589*GCC[15]+0.7071067811865475*GCC[12]; 
