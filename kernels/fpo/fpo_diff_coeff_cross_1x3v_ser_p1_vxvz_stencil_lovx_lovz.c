...
GKYL_CU_DH void fpo_diff_coeff_cross_1x3v_vxvz_ser_p1_lovx_lovz(const double *dxv, const double *gamma, const double* fpo_g_stencil[9], const double* fpo_g_surf_stencil[9], const double* fpo_dgdv_surf, double *diff_coeff) { 
  ...
  surft1_up[0] = 0.599071547271275*GTC[34]+0.599071547271275*GCC[34]-0.8617863895711042*GTC[9]+0.8617863895711042*GCC[9]+0.6123724356957944*GTC[2]+0.6123724356957944*GCC[2]; 
  surft1_up[1] = 0.599071547271275*GTC[36]+0.599071547271275*GCC[36]-0.8617863895711042*GTC[12]+0.8617863895711042*GCC[12]+0.6123724356957944*GTC[5]+0.6123724356957944*GCC[5]; 
  surft1_up[2] = -(1.9270129491651047*GTC[19])+1.9270129491651047*GCC[19]+1.369306393762915*GTC[16]+1.369306393762915*GCC[16]; 
  surft1_up[3] = 0.599071547271275*GTC[38]+0.599071547271275*GCC[38]-0.8617863895711042*GTC[14]+0.8617863895711042*GCC[14]+0.6123724356957944*GTC[7]+0.6123724356957944*GCC[7]; 
  surft1_up[4] = -(1.927012949165105*GTC[21])+1.927012949165105*GCC[21]+1.369306393762915*GTC[17]+1.369306393762915*GCC[17]; 
  surft1_up[5] = 0.599071547271275*GTC[39]+0.599071547271275*GCC[39]-0.8617863895711042*GTC[15]+0.8617863895711042*GCC[15]+0.6123724356957944*GTC[11]+0.6123724356957944*GCC[11]; 
  surft1_up[6] = -(1.927012949165105*GTC[22])+1.927012949165105*GCC[22]+1.369306393762915*GTC[18]+1.369306393762915*GCC[18]; 
  surft1_up[7] = -(1.9270129491651047*GTC[23])+1.9270129491651047*GCC[23]+1.369306393762915*GTC[20]+1.369306393762915*GCC[20]; 
  surft1_up[12] = -(0.8617863895711042*GTC[30])+0.8617863895711042*GCC[30]+0.6123724356957944*GTC[26]+0.6123724356957944*GCC[26]; 
  surft1_up[13] = -(0.8617863895711042*GTC[31])+0.8617863895711042*GCC[31]+0.6123724356957944*GTC[28]+0.6123724356957944*GCC[28]; 
  ...
  surft2_up[0] = 0.34587411908091625*GCR[16]+0.34587411908091625*GCC[16]-0.49755260400283263*GCR[2]+0.49755260400283263*GCC[2]+0.3535533905932737*GCR[0]+0.3535533905932737*GCC[0]; 
  surft2_up[1] = 0.34587411908091625*GCR[17]+0.34587411908091625*GCC[17]-0.49755260400283263*GCR[5]+0.49755260400283263*GCC[5]+0.3535533905932737*GCR[1]+0.3535533905932737*GCC[1]; 
  surft2_up[2] = 0.34587411908091625*GCR[18]+0.34587411908091625*GCC[18]-0.49755260400283263*GCR[7]+0.49755260400283263*GCC[7]+0.3535533905932737*GCR[3]+0.3535533905932737*GCC[3]; 
  surft2_up[3] = 0.34587411908091625*GCR[19]+0.34587411908091625*GCC[19]-0.49755260400283263*GCR[9]+0.49755260400283263*GCC[9]+0.3535533905932737*GCR[4]+0.3535533905932737*GCC[4]; 
  surft2_up[4] = 0.34587411908091625*GCR[20]+0.34587411908091625*GCC[20]-0.49755260400283263*GCR[11]+0.49755260400283263*GCC[11]+0.3535533905932737*GCR[6]+0.3535533905932737*GCC[6]; 
  surft2_up[5] = 0.34587411908091625*GCR[21]+0.34587411908091625*GCC[21]-0.49755260400283263*GCR[12]+0.49755260400283263*GCC[12]+0.3535533905932737*GCR[8]+0.3535533905932737*GCC[8]; 
  surft2_up[6] = 0.34587411908091625*GCR[22]+0.34587411908091625*GCC[22]-0.49755260400283263*GCR[14]+0.49755260400283263*GCC[14]+0.3535533905932737*GCR[10]+0.3535533905932737*GCC[10]; 
  surft2_up[7] = 0.34587411908091625*GCR[23]+0.34587411908091625*GCC[23]-0.49755260400283263*GCR[15]+0.49755260400283263*GCC[15]+0.3535533905932737*GCR[13]+0.3535533905932737*GCC[13]; 
  surft2_up[8] = -(0.49755260400283263*GCR[26])+0.49755260400283263*GCC[26]+0.3535533905932737*GCR[24]+0.3535533905932737*GCC[24]; 
  surft2_up[9] = -(0.49755260400283263*GCR[28])+0.49755260400283263*GCC[28]+0.3535533905932737*GCR[25]+0.3535533905932737*GCC[25]; 
  surft2_up[10] = -(0.49755260400283263*GCR[30])+0.49755260400283263*GCC[30]+0.3535533905932737*GCR[27]+0.3535533905932737*GCC[27]; 
  surft2_up[11] = -(0.49755260400283263*GCR[31])+0.49755260400283263*GCC[31]+0.3535533905932737*GCR[29]+0.3535533905932737*GCC[29]; 
  surft2_up[12] = -(0.49755260400283263*GCR[34])+0.49755260400283263*GCC[34]+0.3535533905932737*GCR[32]+0.3535533905932737*GCC[32]; 
  surft2_up[13] = -(0.49755260400283263*GCR[36])+0.49755260400283263*GCC[36]+0.3535533905932737*GCR[33]+0.3535533905932737*GCC[33]; 
  surft2_up[14] = -(0.49755260400283263*GCR[38])+0.49755260400283263*GCC[38]+0.3535533905932737*GCR[35]+0.3535533905932737*GCC[35]; 
  surft2_up[15] = -(0.49755260400283263*GCR[39])+0.49755260400283263*GCC[39]+0.3535533905932737*GCR[37]+0.3535533905932737*GCC[37]; 
  ...
  out[19] = (vol[19]+1.224744871391589*surft1_up[8]+1.224744871391589*surft1_lo[8]-2.7386127875258306*surft2_up[0]+2.7386127875258306*surft2_lo[0])*dv1_sq*gamma_avg; 
  out[20] = (vol[20]+0.7071067811865475*surft1_up[11]-0.7071067811865475*surft1_lo[11])*dv1_sq*gamma_avg; 
  out[21] = (vol[21]+1.224744871391589*surft1_up[9]+1.224744871391589*surft1_lo[9]-2.7386127875258306*surft2_up[1]+2.7386127875258306*surft2_lo[1])*dv1_sq*gamma_avg; 
  out[22] = (vol[22]+1.224744871391589*surft1_up[10]+1.224744871391589*surft1_lo[10]-2.7386127875258306*surft2_up[2]+2.7386127875258306*surft2_lo[2])*dv1_sq*gamma_avg; 
  out[23] = (vol[23]+1.224744871391589*surft1_up[11]+1.224744871391589*surft1_lo[11]-2.7386127875258306*surft2_up[4]+2.7386127875258306*surft2_lo[4])*dv1_sq*gamma_avg; 
  ...
  out[27] = (vol[27]+1.224744871391589*surft1_up[12]+1.224744871391589*surft1_lo[12]-1.224744871391589*surft2_up[8]+1.224744871391589*surft2_lo[8])*dv1_sq*gamma_avg; 
  out[28] = (vol[28]+0.7071067811865475*surft1_up[15]-0.7071067811865475*surft1_lo[15])*dv1_sq*gamma_avg; 
  out[29] = (vol[29]+1.224744871391589*surft1_up[13]+1.224744871391589*surft1_lo[13]-1.224744871391589*surft2_up[9]+1.224744871391589*surft2_lo[9])*dv1_sq*gamma_avg; 
  out[30] = (vol[30]+1.224744871391589*surft1_up[14]+1.224744871391589*surft1_lo[14]-2.1213203435596424*surft2_up[8]-2.1213203435596424*surft2_lo[8])*dv1_sq*gamma_avg; 
  out[31] = (vol[31]+1.224744871391589*surft1_up[15]+1.224744871391589*surft1_lo[15]-2.1213203435596424*surft2_up[9]-2.1213203435596424*surft2_lo[9])*dv1_sq*gamma_avg; 
