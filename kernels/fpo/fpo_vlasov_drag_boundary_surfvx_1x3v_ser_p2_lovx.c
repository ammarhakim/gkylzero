...
GKYL_CU_DH void fpo_vlasov_drag_boundary_surfvx_1x3v_ser_p2_lovx(const double *dxv, const double* drag_coeff_stencil[9], const double* f_stencil[9], double* out) { 
  ...
  const double* aC = &drag_coeff_stencil[0][0]; 
  const double* aR = &drag_coeff_stencil[1][0]; 
  ...
  alphaDragSurf[0] = 0.34587411908091625*aR[12]+0.34587411908091625*aC[12]-0.49755260400283263*aR[2]+0.49755260400283263*aC[2]+0.3535533905932737*aR[0]+0.3535533905932737*aC[0]; 
  alphaDragSurf[1] = 0.34587411908091625*aR[20]+0.34587411908091625*aC[20]-0.49755260400283263*aR[5]+0.49755260400283263*aC[5]+0.3535533905932737*aR[1]+0.3535533905932737*aC[1]; 
  alphaDragSurf[2] = 0.34587411908091625*aR[22]+0.34587411908091625*aC[22]-0.49755260400283263*aR[7]+0.49755260400283263*aC[7]+0.3535533905932737*aR[3]+0.3535533905932737*aC[3]; 
  alphaDragSurf[3] = 0.34587411908091625*aR[26]+0.34587411908091625*aC[26]-0.49755260400283263*aR[9]+0.49755260400283263*aC[9]+0.3535533905932737*aR[4]+0.3535533905932737*aC[4]; 
  alphaDragSurf[4] = 0.34587411908091625*aR[33]+0.34587411908091625*aC[33]-0.49755260400283263*aR[15]+0.49755260400283263*aC[15]+0.3535533905932737*aR[6]+0.3535533905932737*aC[6]; 
  alphaDragSurf[5] = 0.34587411908091625*aR[36]+0.34587411908091625*aC[36]-0.49755260400283263*aR[16]+0.49755260400283263*aC[16]+0.3535533905932737*aR[8]+0.3535533905932737*aC[8]; 
  alphaDragSurf[6] = 0.34587411908091625*aR[38]+0.34587411908091625*aC[38]-0.49755260400283263*aR[18]+0.49755260400283263*aC[18]+0.3535533905932737*aR[10]+0.3535533905932737*aC[10]; 
  alphaDragSurf[7] = -(0.49755260400283263*aR[19])+0.49755260400283263*aC[19]+0.3535533905932737*aR[11]+0.3535533905932737*aC[11]; 
  alphaDragSurf[8] = -(0.49755260400283263*aR[24])+0.49755260400283263*aC[24]+0.3535533905932737*aR[13]+0.3535533905932737*aC[13]; 
  alphaDragSurf[9] = -(0.49755260400283263*aR[29])+0.49755260400283263*aC[29]+0.3535533905932737*aR[14]+0.3535533905932737*aC[14]; 
  alphaDragSurf[10] = 0.34587411908091625*aR[45]+0.34587411908091625*aC[45]-0.49755260400283263*aR[31]+0.49755260400283263*aC[31]+0.3535533905932737*aR[17]+0.3535533905932737*aC[17]; 
  alphaDragSurf[11] = -(0.49755260400283263*aR[32])+0.49755260400283263*aC[32]+0.3535533905932737*aR[21]+0.3535533905932737*aC[21]; 
  alphaDragSurf[12] = -(0.49755260400283263*aR[34])+0.49755260400283263*aC[34]+0.3535533905932737*aR[23]+0.3535533905932737*aC[23]; 
  alphaDragSurf[13] = -(0.49755260400283263*aR[35])+0.49755260400283263*aC[35]+0.3535533905932737*aR[25]+0.3535533905932737*aC[25]; 
  alphaDragSurf[14] = -(0.49755260400283263*aR[40])+0.49755260400283263*aC[40]+0.3535533905932737*aR[27]+0.3535533905932737*aC[27]; 
  alphaDragSurf[15] = -(0.49755260400283263*aR[41])+0.49755260400283263*aC[41]+0.3535533905932737*aR[28]+0.3535533905932737*aC[28]; 
  alphaDragSurf[16] = -(0.49755260400283263*aR[43])+0.49755260400283263*aC[43]+0.3535533905932737*aR[30]+0.3535533905932737*aC[30]; 
  alphaDragSurf[17] = -(0.49755260400283263*aR[44])+0.49755260400283263*aC[44]+0.3535533905932737*aR[37]+0.3535533905932737*aC[37]; 
  alphaDragSurf[18] = -(0.49755260400283263*aR[46])+0.49755260400283263*aC[46]+0.3535533905932737*aR[39]+0.3535533905932737*aC[39]; 
  alphaDragSurf[19] = -(0.49755260400283263*aR[47])+0.49755260400283263*aC[47]+0.3535533905932737*aR[42]+0.3535533905932737*aC[42]; 
  ...
  if (0.5692099788303082*(alphaDragSurf[19]+alphaDragSurf[18]+alphaDragSurf[17])-0.42426406871192807*(alphaDragSurf[16]+alphaDragSurf[15])-0.42426406871192845*(alphaDragSurf[14]+alphaDragSurf[13])-0.42426406871192807*alphaDragSurf[12]-0.42426406871192845*alphaDragSurf[11]-0.853814968245462*alphaDragSurf[10]+0.3162277660168379*(alphaDragSurf[9]+alphaDragSurf[8]+alphaDragSurf[7])+0.6363961030678926*(alphaDragSurf[6]+alphaDragSurf[5]+alphaDragSurf[4])-0.4743416490252568*(alphaDragSurf[3]+alphaDragSurf[2]+alphaDragSurf[1])+0.3535533905932737*alphaDragSurf[0] > 0) { 
    fUpwindQuad[0] = ser_4x_p2_surfx2_eval_quad_node_0_r(fC); 
  } else { 
    fUpwindQuad[0] = ser_4x_p2_surfx2_eval_quad_node_0_l(fR); 
  } 
  if (-(0.711512473537885*alphaDragSurf[19])+0.5303300858899104*(alphaDragSurf[16]+alphaDragSurf[15])-0.42426406871192807*alphaDragSurf[12]-0.42426406871192845*alphaDragSurf[11]-0.3952847075210473*alphaDragSurf[9]+0.3162277660168379*(alphaDragSurf[8]+alphaDragSurf[7])+0.6363961030678926*alphaDragSurf[4]-0.4743416490252568*(alphaDragSurf[2]+alphaDragSurf[1])+0.3535533905932737*alphaDragSurf[0] > 0) { 
    fUpwindQuad[1] = ser_4x_p2_surfx2_eval_quad_node_1_r(fC); 
  } else { 
    fUpwindQuad[1] = ser_4x_p2_surfx2_eval_quad_node_1_l(fR); 
  } 
  if (0.5692099788303082*alphaDragSurf[19]-0.5692099788303082*(alphaDragSurf[18]+alphaDragSurf[17])-0.42426406871192807*(alphaDragSurf[16]+alphaDragSurf[15])+0.42426406871192845*(alphaDragSurf[14]+alphaDragSurf[13])-0.42426406871192807*alphaDragSurf[12]-0.42426406871192845*alphaDragSurf[11]+0.853814968245462*alphaDragSurf[10]+0.3162277660168379*(alphaDragSurf[9]+alphaDragSurf[8]+alphaDragSurf[7])-0.6363961030678926*(alphaDragSurf[6]+alphaDragSurf[5])+0.6363961030678926*alphaDragSurf[4]+0.4743416490252568*alphaDragSurf[3]-0.4743416490252568*(alphaDragSurf[2]+alphaDragSurf[1])+0.3535533905932737*alphaDragSurf[0] > 0) { 
    fUpwindQuad[2] = ser_4x_p2_surfx2_eval_quad_node_2_r(fC); 
  } else { 
    fUpwindQuad[2] = ser_4x_p2_surfx2_eval_quad_node_2_l(fR); 
  } 
  if (-(0.711512473537885*alphaDragSurf[18])-0.42426406871192807*alphaDragSurf[15]+0.5303300858899104*alphaDragSurf[14]-0.42426406871192845*alphaDragSurf[13]+0.5303300858899104*alphaDragSurf[12]+0.3162277660168379*alphaDragSurf[9]-0.3952847075210473*alphaDragSurf[8]+0.3162277660168379*alphaDragSurf[7]+0.6363961030678926*alphaDragSurf[5]-0.4743416490252568*(alphaDragSurf[3]+alphaDragSurf[1])+0.3535533905932737*alphaDragSurf[0] > 0) { 
    fUpwindQuad[3] = ser_4x_p2_surfx2_eval_quad_node_3_r(fC); 
  } else { 
    fUpwindQuad[3] = ser_4x_p2_surfx2_eval_quad_node_3_l(fR); 
  } 
  if (0.5303300858899104*(alphaDragSurf[15]+alphaDragSurf[12])-0.3952847075210473*(alphaDragSurf[9]+alphaDragSurf[8])+0.3162277660168379*alphaDragSurf[7]-0.4743416490252568*alphaDragSurf[1]+0.3535533905932737*alphaDragSurf[0] > 0) { 
    fUpwindQuad[4] = ser_4x_p2_surfx2_eval_quad_node_4_r(fC); 
  } else { 
    fUpwindQuad[4] = ser_4x_p2_surfx2_eval_quad_node_4_l(fR); 
  } 
  if (0.711512473537885*alphaDragSurf[18]-0.42426406871192807*alphaDragSurf[15]-0.5303300858899104*alphaDragSurf[14]+0.42426406871192845*alphaDragSurf[13]+0.5303300858899104*alphaDragSurf[12]+0.3162277660168379*alphaDragSurf[9]-0.3952847075210473*alphaDragSurf[8]+0.3162277660168379*alphaDragSurf[7]-0.6363961030678926*alphaDragSurf[5]+0.4743416490252568*alphaDragSurf[3]-0.4743416490252568*alphaDragSurf[1]+0.3535533905932737*alphaDragSurf[0] > 0) { 
    fUpwindQuad[5] = ser_4x_p2_surfx2_eval_quad_node_5_r(fC); 
  } else { 
    fUpwindQuad[5] = ser_4x_p2_surfx2_eval_quad_node_5_l(fR); 
  } 
  if (-(0.5692099788303082*alphaDragSurf[19])+0.5692099788303082*alphaDragSurf[18]-0.5692099788303082*alphaDragSurf[17]+0.42426406871192807*alphaDragSurf[16]-0.42426406871192807*alphaDragSurf[15]-0.42426406871192845*(alphaDragSurf[14]+alphaDragSurf[13])-0.42426406871192807*alphaDragSurf[12]+0.42426406871192845*alphaDragSurf[11]+0.853814968245462*alphaDragSurf[10]+0.3162277660168379*(alphaDragSurf[9]+alphaDragSurf[8]+alphaDragSurf[7])-0.6363961030678926*alphaDragSurf[6]+0.6363961030678926*alphaDragSurf[5]-0.6363961030678926*alphaDragSurf[4]-0.4743416490252568*alphaDragSurf[3]+0.4743416490252568*alphaDragSurf[2]-0.4743416490252568*alphaDragSurf[1]+0.3535533905932737*alphaDragSurf[0] > 0) { 
    fUpwindQuad[6] = ser_4x_p2_surfx2_eval_quad_node_6_r(fC); 
  } else { 
    fUpwindQuad[6] = ser_4x_p2_surfx2_eval_quad_node_6_l(fR); 
  } 
  if (0.711512473537885*alphaDragSurf[19]-0.5303300858899104*alphaDragSurf[16]+0.5303300858899104*alphaDragSurf[15]-0.42426406871192807*alphaDragSurf[12]+0.42426406871192845*alphaDragSurf[11]-0.3952847075210473*alphaDragSurf[9]+0.3162277660168379*(alphaDragSurf[8]+alphaDragSurf[7])-0.6363961030678926*alphaDragSurf[4]+0.4743416490252568*alphaDragSurf[2]-0.4743416490252568*alphaDragSurf[1]+0.3535533905932737*alphaDragSurf[0] > 0) { 
    fUpwindQuad[7] = ser_4x_p2_surfx2_eval_quad_node_7_r(fC); 
  } else { 
    fUpwindQuad[7] = ser_4x_p2_surfx2_eval_quad_node_7_l(fR); 
  } 
  if (-(0.5692099788303082*(alphaDragSurf[19]+alphaDragSurf[18]))+0.5692099788303082*alphaDragSurf[17]+0.42426406871192807*alphaDragSurf[16]-0.42426406871192807*alphaDragSurf[15]+0.42426406871192845*(alphaDragSurf[14]+alphaDragSurf[13])-0.42426406871192807*alphaDragSurf[12]+0.42426406871192845*alphaDragSurf[11]-0.853814968245462*alphaDragSurf[10]+0.3162277660168379*(alphaDragSurf[9]+alphaDragSurf[8]+alphaDragSurf[7])+0.6363961030678926*alphaDragSurf[6]-0.6363961030678926*(alphaDragSurf[5]+alphaDragSurf[4])+0.4743416490252568*(alphaDragSurf[3]+alphaDragSurf[2])-0.4743416490252568*alphaDragSurf[1]+0.3535533905932737*alphaDragSurf[0] > 0) { 
    fUpwindQuad[8] = ser_4x_p2_surfx2_eval_quad_node_8_r(fC); 
  } else { 
    fUpwindQuad[8] = ser_4x_p2_surfx2_eval_quad_node_8_l(fR); 
  } 
  if (-(0.711512473537885*alphaDragSurf[17])-0.42426406871192807*alphaDragSurf[16]-0.42426406871192845*alphaDragSurf[14]+0.5303300858899104*(alphaDragSurf[13]+alphaDragSurf[11])+0.3162277660168379*(alphaDragSurf[9]+alphaDragSurf[8])-0.3952847075210473*alphaDragSurf[7]+0.6363961030678926*alphaDragSurf[6]-0.4743416490252568*(alphaDragSurf[3]+alphaDragSurf[2])+0.3535533905932737*alphaDragSurf[0] > 0) { 
    fUpwindQuad[9] = ser_4x_p2_surfx2_eval_quad_node_9_r(fC); 
  } else { 
    fUpwindQuad[9] = ser_4x_p2_surfx2_eval_quad_node_9_l(fR); 
  } 
  if (0.5303300858899104*(alphaDragSurf[16]+alphaDragSurf[11])-0.3952847075210473*alphaDragSurf[9]+0.3162277660168379*alphaDragSurf[8]-0.3952847075210473*alphaDragSurf[7]-0.4743416490252568*alphaDragSurf[2]+0.3535533905932737*alphaDragSurf[0] > 0) { 
    fUpwindQuad[10] = ser_4x_p2_surfx2_eval_quad_node_10_r(fC); 
  } else { 
    fUpwindQuad[10] = ser_4x_p2_surfx2_eval_quad_node_10_l(fR); 
  } 
  if (0.711512473537885*alphaDragSurf[17]-0.42426406871192807*alphaDragSurf[16]+0.42426406871192845*alphaDragSurf[14]-0.5303300858899104*alphaDragSurf[13]+0.5303300858899104*alphaDragSurf[11]+0.3162277660168379*(alphaDragSurf[9]+alphaDragSurf[8])-0.3952847075210473*alphaDragSurf[7]-0.6363961030678926*alphaDragSurf[6]+0.4743416490252568*alphaDragSurf[3]-0.4743416490252568*alphaDragSurf[2]+0.3535533905932737*alphaDragSurf[0] > 0) { 
    fUpwindQuad[11] = ser_4x_p2_surfx2_eval_quad_node_11_r(fC); 
  } else { 
    fUpwindQuad[11] = ser_4x_p2_surfx2_eval_quad_node_11_l(fR); 
  } 
  if (0.5303300858899104*(alphaDragSurf[14]+alphaDragSurf[13])+0.3162277660168379*alphaDragSurf[9]-0.3952847075210473*(alphaDragSurf[8]+alphaDragSurf[7])-0.4743416490252568*alphaDragSurf[3]+0.3535533905932737*alphaDragSurf[0] > 0) { 
    fUpwindQuad[12] = ser_4x_p2_surfx2_eval_quad_node_12_r(fC); 
  } else { 
    fUpwindQuad[12] = ser_4x_p2_surfx2_eval_quad_node_12_l(fR); 
  } 
  if (0.3535533905932737*alphaDragSurf[0]-0.3952847075210473*(alphaDragSurf[9]+alphaDragSurf[8]+alphaDragSurf[7]) > 0) { 
    fUpwindQuad[13] = ser_4x_p2_surfx2_eval_quad_node_13_r(fC); 
  } else { 
    fUpwindQuad[13] = ser_4x_p2_surfx2_eval_quad_node_13_l(fR); 
  } 
  if (-(0.5303300858899104*(alphaDragSurf[14]+alphaDragSurf[13]))+0.3162277660168379*alphaDragSurf[9]-0.3952847075210473*(alphaDragSurf[8]+alphaDragSurf[7])+0.4743416490252568*alphaDragSurf[3]+0.3535533905932737*alphaDragSurf[0] > 0) { 
    fUpwindQuad[14] = ser_4x_p2_surfx2_eval_quad_node_14_r(fC); 
  } else { 
    fUpwindQuad[14] = ser_4x_p2_surfx2_eval_quad_node_14_l(fR); 
  } 
  if (0.711512473537885*alphaDragSurf[17]+0.42426406871192807*alphaDragSurf[16]-0.42426406871192845*alphaDragSurf[14]+0.5303300858899104*alphaDragSurf[13]-0.5303300858899104*alphaDragSurf[11]+0.3162277660168379*(alphaDragSurf[9]+alphaDragSurf[8])-0.3952847075210473*alphaDragSurf[7]-0.6363961030678926*alphaDragSurf[6]-0.4743416490252568*alphaDragSurf[3]+0.4743416490252568*alphaDragSurf[2]+0.3535533905932737*alphaDragSurf[0] > 0) { 
    fUpwindQuad[15] = ser_4x_p2_surfx2_eval_quad_node_15_r(fC); 
  } else { 
    fUpwindQuad[15] = ser_4x_p2_surfx2_eval_quad_node_15_l(fR); 
  } 
  if (-(0.5303300858899104*(alphaDragSurf[16]+alphaDragSurf[11]))-0.3952847075210473*alphaDragSurf[9]+0.3162277660168379*alphaDragSurf[8]-0.3952847075210473*alphaDragSurf[7]+0.4743416490252568*alphaDragSurf[2]+0.3535533905932737*alphaDragSurf[0] > 0) { 
    fUpwindQuad[16] = ser_4x_p2_surfx2_eval_quad_node_16_r(fC); 
  } else { 
    fUpwindQuad[16] = ser_4x_p2_surfx2_eval_quad_node_16_l(fR); 
  } 
  if (-(0.711512473537885*alphaDragSurf[17])+0.42426406871192807*alphaDragSurf[16]+0.42426406871192845*alphaDragSurf[14]-0.5303300858899104*(alphaDragSurf[13]+alphaDragSurf[11])+0.3162277660168379*(alphaDragSurf[9]+alphaDragSurf[8])-0.3952847075210473*alphaDragSurf[7]+0.6363961030678926*alphaDragSurf[6]+0.4743416490252568*(alphaDragSurf[3]+alphaDragSurf[2])+0.3535533905932737*alphaDragSurf[0] > 0) { 
    fUpwindQuad[17] = ser_4x_p2_surfx2_eval_quad_node_17_r(fC); 
  } else { 
    fUpwindQuad[17] = ser_4x_p2_surfx2_eval_quad_node_17_l(fR); 
  } 
  if (-(0.5692099788303082*(alphaDragSurf[19]+alphaDragSurf[18]))+0.5692099788303082*alphaDragSurf[17]-0.42426406871192807*alphaDragSurf[16]+0.42426406871192807*alphaDragSurf[15]-0.42426406871192845*(alphaDragSurf[14]+alphaDragSurf[13])+0.42426406871192807*alphaDragSurf[12]-0.42426406871192845*alphaDragSurf[11]+0.853814968245462*alphaDragSurf[10]+0.3162277660168379*(alphaDragSurf[9]+alphaDragSurf[8]+alphaDragSurf[7])+0.6363961030678926*alphaDragSurf[6]-0.6363961030678926*(alphaDragSurf[5]+alphaDragSurf[4])-0.4743416490252568*(alphaDragSurf[3]+alphaDragSurf[2])+0.4743416490252568*alphaDragSurf[1]+0.3535533905932737*alphaDragSurf[0] > 0) { 
    fUpwindQuad[18] = ser_4x_p2_surfx2_eval_quad_node_18_r(fC); 
  } else { 
    fUpwindQuad[18] = ser_4x_p2_surfx2_eval_quad_node_18_l(fR); 
  } 
  if (0.711512473537885*alphaDragSurf[19]+0.5303300858899104*alphaDragSurf[16]-0.5303300858899104*alphaDragSurf[15]+0.42426406871192807*alphaDragSurf[12]-0.42426406871192845*alphaDragSurf[11]-0.3952847075210473*alphaDragSurf[9]+0.3162277660168379*(alphaDragSurf[8]+alphaDragSurf[7])-0.6363961030678926*alphaDragSurf[4]-0.4743416490252568*alphaDragSurf[2]+0.4743416490252568*alphaDragSurf[1]+0.3535533905932737*alphaDragSurf[0] > 0) { 
    fUpwindQuad[19] = ser_4x_p2_surfx2_eval_quad_node_19_r(fC); 
  } else { 
    fUpwindQuad[19] = ser_4x_p2_surfx2_eval_quad_node_19_l(fR); 
  } 
  if (-(0.5692099788303082*alphaDragSurf[19])+0.5692099788303082*alphaDragSurf[18]-0.5692099788303082*alphaDragSurf[17]-0.42426406871192807*alphaDragSurf[16]+0.42426406871192807*alphaDragSurf[15]+0.42426406871192845*(alphaDragSurf[14]+alphaDragSurf[13])+0.42426406871192807*alphaDragSurf[12]-0.42426406871192845*alphaDragSurf[11]-0.853814968245462*alphaDragSurf[10]+0.3162277660168379*(alphaDragSurf[9]+alphaDragSurf[8]+alphaDragSurf[7])-0.6363961030678926*alphaDragSurf[6]+0.6363961030678926*alphaDragSurf[5]-0.6363961030678926*alphaDragSurf[4]+0.4743416490252568*alphaDragSurf[3]-0.4743416490252568*alphaDragSurf[2]+0.4743416490252568*alphaDragSurf[1]+0.3535533905932737*alphaDragSurf[0] > 0) { 
    fUpwindQuad[20] = ser_4x_p2_surfx2_eval_quad_node_20_r(fC); 
  } else { 
    fUpwindQuad[20] = ser_4x_p2_surfx2_eval_quad_node_20_l(fR); 
  } 
  if (0.711512473537885*alphaDragSurf[18]+0.42426406871192807*alphaDragSurf[15]+0.5303300858899104*alphaDragSurf[14]-0.42426406871192845*alphaDragSurf[13]-0.5303300858899104*alphaDragSurf[12]+0.3162277660168379*alphaDragSurf[9]-0.3952847075210473*alphaDragSurf[8]+0.3162277660168379*alphaDragSurf[7]-0.6363961030678926*alphaDragSurf[5]-0.4743416490252568*alphaDragSurf[3]+0.4743416490252568*alphaDragSurf[1]+0.3535533905932737*alphaDragSurf[0] > 0) { 
    fUpwindQuad[21] = ser_4x_p2_surfx2_eval_quad_node_21_r(fC); 
  } else { 
    fUpwindQuad[21] = ser_4x_p2_surfx2_eval_quad_node_21_l(fR); 
  } 
  if (-(0.5303300858899104*(alphaDragSurf[15]+alphaDragSurf[12]))-0.3952847075210473*(alphaDragSurf[9]+alphaDragSurf[8])+0.3162277660168379*alphaDragSurf[7]+0.4743416490252568*alphaDragSurf[1]+0.3535533905932737*alphaDragSurf[0] > 0) { 
    fUpwindQuad[22] = ser_4x_p2_surfx2_eval_quad_node_22_r(fC); 
  } else { 
    fUpwindQuad[22] = ser_4x_p2_surfx2_eval_quad_node_22_l(fR); 
  } 
  if (-(0.711512473537885*alphaDragSurf[18])+0.42426406871192807*alphaDragSurf[15]-0.5303300858899104*alphaDragSurf[14]+0.42426406871192845*alphaDragSurf[13]-0.5303300858899104*alphaDragSurf[12]+0.3162277660168379*alphaDragSurf[9]-0.3952847075210473*alphaDragSurf[8]+0.3162277660168379*alphaDragSurf[7]+0.6363961030678926*alphaDragSurf[5]+0.4743416490252568*(alphaDragSurf[3]+alphaDragSurf[1])+0.3535533905932737*alphaDragSurf[0] > 0) { 
    fUpwindQuad[23] = ser_4x_p2_surfx2_eval_quad_node_23_r(fC); 
  } else { 
    fUpwindQuad[23] = ser_4x_p2_surfx2_eval_quad_node_23_l(fR); 
  } 
  if (0.5692099788303082*alphaDragSurf[19]-0.5692099788303082*(alphaDragSurf[18]+alphaDragSurf[17])+0.42426406871192807*(alphaDragSurf[16]+alphaDragSurf[15])-0.42426406871192845*(alphaDragSurf[14]+alphaDragSurf[13])+0.42426406871192807*alphaDragSurf[12]+0.42426406871192845*alphaDragSurf[11]-0.853814968245462*alphaDragSurf[10]+0.3162277660168379*(alphaDragSurf[9]+alphaDragSurf[8]+alphaDragSurf[7])-0.6363961030678926*(alphaDragSurf[6]+alphaDragSurf[5])+0.6363961030678926*alphaDragSurf[4]-0.4743416490252568*alphaDragSurf[3]+0.4743416490252568*(alphaDragSurf[2]+alphaDragSurf[1])+0.3535533905932737*alphaDragSurf[0] > 0) { 
    fUpwindQuad[24] = ser_4x_p2_surfx2_eval_quad_node_24_r(fC); 
  } else { 
    fUpwindQuad[24] = ser_4x_p2_surfx2_eval_quad_node_24_l(fR); 
  } 
  if (-(0.711512473537885*alphaDragSurf[19])-0.5303300858899104*(alphaDragSurf[16]+alphaDragSurf[15])+0.42426406871192807*alphaDragSurf[12]+0.42426406871192845*alphaDragSurf[11]-0.3952847075210473*alphaDragSurf[9]+0.3162277660168379*(alphaDragSurf[8]+alphaDragSurf[7])+0.6363961030678926*alphaDragSurf[4]+0.4743416490252568*(alphaDragSurf[2]+alphaDragSurf[1])+0.3535533905932737*alphaDragSurf[0] > 0) { 
    fUpwindQuad[25] = ser_4x_p2_surfx2_eval_quad_node_25_r(fC); 
  } else { 
    fUpwindQuad[25] = ser_4x_p2_surfx2_eval_quad_node_25_l(fR); 
  } 
  if (0.5692099788303082*(alphaDragSurf[19]+alphaDragSurf[18]+alphaDragSurf[17])+0.42426406871192807*(alphaDragSurf[16]+alphaDragSurf[15])+0.42426406871192845*(alphaDragSurf[14]+alphaDragSurf[13])+0.42426406871192807*alphaDragSurf[12]+0.42426406871192845*alphaDragSurf[11]+0.853814968245462*alphaDragSurf[10]+0.3162277660168379*(alphaDragSurf[9]+alphaDragSurf[8]+alphaDragSurf[7])+0.6363961030678926*(alphaDragSurf[6]+alphaDragSurf[5]+alphaDragSurf[4])+0.4743416490252568*(alphaDragSurf[3]+alphaDragSurf[2]+alphaDragSurf[1])+0.3535533905932737*alphaDragSurf[0] > 0) { 
    fUpwindQuad[26] = ser_4x_p2_surfx2_eval_quad_node_26_r(fC); 
  } else { 
    fUpwindQuad[26] = ser_4x_p2_surfx2_eval_quad_node_26_l(fR); 
  } 
