...
GKYL_CU_DH void fpo_vlasov_diff_boundary_surfvxvz_1x3v_ser_p1_upvx_upvz(const double *dxv, const double* diff_coeff_stencil[9], const double* f_stencil[9], double* out) { 
  ...
  const double* DCL = &diff_coeff_stencil[1][80]; 
  const double* fCL = f_stencil[1]; 
  const double* DBC = &diff_coeff_stencil[2][80]; 
  ...
  out[9] += 0.6123724356957945*surft1_up[3]*dv1_sq+0.6123724356957945*surft1_lo[3]*dv1_sq-1.0606601717798212*surft2_up[0]*dv1_sq-1.0606601717798212*surft2_lo[0]*dv1_sq; 
  out[10] += 0.35355339059327373*surft1_up[6]*dv1_sq-0.35355339059327373*surft1_lo[6]*dv1_sq-0.6123724356957945*surft2_up[2]*dv1_sq+0.6123724356957945*surft2_lo[2]*dv1_sq; 
  out[11] += 0.6123724356957945*surft1_up[4]*dv1_sq+0.6123724356957945*surft1_lo[4]*dv1_sq; 
  out[12] += 0.6123724356957945*surft1_up[5]*dv1_sq+0.6123724356957945*surft1_lo[5]*dv1_sq-1.0606601717798212*surft2_up[1]*dv1_sq-1.0606601717798212*surft2_lo[1]*dv1_sq; 
  out[13] += 0.35355339059327373*surft1_up[7]*dv1_sq-0.35355339059327373*surft1_lo[7]*dv1_sq-0.6123724356957945*surft2_up[4]*dv1_sq+0.6123724356957945*surft2_lo[4]*dv1_sq; 
  ...
  out[18] += 0.7905694150420949*surft1_up[2]*dv1_sq-0.7905694150420949*surft1_lo[2]*dv1_sq; 
  out[19] += 0.7905694150420949*surft1_up[3]*dv1_sq-0.7905694150420949*surft1_lo[3]*dv1_sq-1.3693063937629153*surft2_up[0]*dv1_sq+1.3693063937629153*surft2_lo[0]*dv1_sq; 
  out[20] += 0.7905694150420948*surft1_up[4]*dv1_sq-0.7905694150420948*surft1_lo[4]*dv1_sq; 
  out[21] += 0.7905694150420948*surft1_up[5]*dv1_sq-0.7905694150420948*surft1_lo[5]*dv1_sq-1.3693063937629153*surft2_up[1]*dv1_sq+1.3693063937629153*surft2_lo[1]*dv1_sq; 
  out[22] += 0.7905694150420948*surft1_up[6]*dv1_sq-0.7905694150420948*surft1_lo[6]*dv1_sq-1.3693063937629153*surft2_up[2]*dv1_sq+1.3693063937629153*surft2_lo[2]*dv1_sq; 
  out[23] += 0.7905694150420949*surft1_up[7]*dv1_sq-0.7905694150420949*surft1_lo[7]*dv1_sq-1.3693063937629153*surft2_up[4]*dv1_sq+1.3693063937629153*surft2_lo[4]*dv1_sq; 
  ...
  out[34] += -(2.3717082451262845*surft2_up[3]*dv1_sq)-2.3717082451262845*surft2_lo[3]*dv1_sq; 
  out[35] += 1.3693063937629153*surft2_lo[6]*dv1_sq-1.3693063937629153*surft2_up[6]*dv1_sq; 
  out[36] += -(2.3717082451262845*surft2_up[5]*dv1_sq)-2.3717082451262845*surft2_lo[5]*dv1_sq; 
  out[37] += 1.3693063937629153*surft2_lo[7]*dv1_sq-1.3693063937629153*surft2_up[7]*dv1_sq; 
