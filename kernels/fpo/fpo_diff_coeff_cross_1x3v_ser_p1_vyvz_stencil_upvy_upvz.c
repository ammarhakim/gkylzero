...
GKYL_CU_DH void fpo_diff_coeff_cross_1x3v_vyvz_ser_p1_upvy_upvz(const double *dxv, const double *gamma, const double* fpo_g_stencil[9], const double* fpo_g_surf_stencil[9], const double* fpo_dgdv_surf, double *diff_coeff) { 
  ...
  surft1_up[0] = dGdvz_surf_CC_vy[0]/dv2; 
  surft1_up[1] = dGdvz_surf_CC_vy[1]/dv2; 
  surft1_up[2] = dGdvz_surf_CC_vy[2]/dv2; 
  surft1_up[3] = dGdvz_surf_CC_vy[3]/dv2; 
  surft1_up[4] = dGdvz_surf_CC_vy[4]/dv2; 
  surft1_up[5] = dGdvz_surf_CC_vy[5]/dv2; 
  surft1_up[6] = dGdvz_surf_CC_vy[6]/dv2; 
  surft1_up[7] = dGdvz_surf_CC_vy[7]/dv2; 
