...
GKYL_CU_DH void fpo_diff_coeff_cross_1x3v_vyvx_ser_p1_upvy_upvx(const double *dxv, const double *gamma, const double* fpo_g_stencil[9], const double* fpo_g_surf_stencil[9], const double* fpo_dgdv_surf, double *diff_coeff) { 
  ...
  surft1_lo[0] = 0.599071547271275*GCL[18]+0.599071547271275*GCC[18]+0.8617863895711042*GCL[7]-0.8617863895711042*GCC[7]+0.6123724356957944*GCL[3]+0.6123724356957944*GCC[3]; 
  surft1_lo[1] = 0.599071547271275*GCL[20]+0.599071547271275*GCC[20]+0.8617863895711042*GCL[11]-0.8617863895711042*GCC[11]+0.6123724356957944*GCL[6]+0.6123724356957944*GCC[6]; 
  surft1_lo[2] = 1.9270129491651047*GCL[26]-1.9270129491651047*GCC[26]+1.369306393762915*GCL[24]+1.369306393762915*GCC[24]; 
  surft1_lo[3] = 0.599071547271275*GCL[22]+0.599071547271275*GCC[22]+0.8617863895711042*GCL[14]-0.8617863895711042*GCC[14]+0.6123724356957944*GCL[10]+0.6123724356957944*GCC[10]; 
  surft1_lo[4] = 1.927012949165105*GCL[28]-1.927012949165105*GCC[28]+1.369306393762915*GCL[25]+1.369306393762915*GCC[25]; 
  surft1_lo[5] = 0.599071547271275*GCL[23]+0.599071547271275*GCC[23]+0.8617863895711042*GCL[15]-0.8617863895711042*GCC[15]+0.6123724356957944*GCL[13]+0.6123724356957944*GCC[13]; 
  surft1_lo[6] = 1.927012949165105*GCL[30]-1.927012949165105*GCC[30]+1.369306393762915*GCL[27]+1.369306393762915*GCC[27]; 
  surft1_lo[7] = 1.9270129491651047*GCL[31]-1.9270129491651047*GCC[31]+1.369306393762915*GCL[29]+1.369306393762915*GCC[29]; 
  surft1_lo[12] = 0.8617863895711042*GCL[38]-0.8617863895711042*GCC[38]+0.6123724356957944*GCL[35]+0.6123724356957944*GCC[35]; 
  surft1_lo[13] = 0.8617863895711042*GCL[39]-0.8617863895711042*GCC[39]+0.6123724356957944*GCL[37]+0.6123724356957944*GCC[37]; 
  ...
  surft2_lo[0] = 0.34587411908091625*GCC[24]+0.34587411908091625*GBC[24]-0.49755260400283263*GCC[3]+0.49755260400283263*GBC[3]+0.3535533905932737*GCC[0]+0.3535533905932737*GBC[0]; 
  surft2_lo[1] = 0.34587411908091625*GCC[25]+0.34587411908091625*GBC[25]-0.49755260400283263*GCC[6]+0.49755260400283263*GBC[6]+0.3535533905932737*GCC[1]+0.3535533905932737*GBC[1]; 
  surft2_lo[2] = 0.34587411908091625*GCC[26]+0.34587411908091625*GBC[26]-0.49755260400283263*GCC[7]+0.49755260400283263*GBC[7]+0.3535533905932737*GCC[2]+0.3535533905932737*GBC[2]; 
  ...
  surft2_lo[4] = 0.34587411908091625*GCC[28]+0.34587411908091625*GBC[28]-0.49755260400283263*GCC[11]+0.49755260400283263*GBC[11]+0.3535533905932737*GCC[5]+0.3535533905932737*GBC[5]; 
  surft2_lo[5] = 0.34587411908091625*GCC[29]+0.34587411908091625*GBC[29]-0.49755260400283263*GCC[13]+0.49755260400283263*GBC[13]+0.3535533905932737*GCC[8]+0.3535533905932737*GBC[8]; 
  surft2_lo[6] = 0.34587411908091625*GCC[30]+0.34587411908091625*GBC[30]-0.49755260400283263*GCC[14]+0.49755260400283263*GBC[14]+0.3535533905932737*GCC[9]+0.3535533905932737*GBC[9]; 
  surft2_lo[7] = 0.34587411908091625*GCC[31]+0.34587411908091625*GBC[31]-0.49755260400283263*GCC[15]+0.49755260400283263*GBC[15]+0.3535533905932737*GCC[12]+0.3535533905932737*GBC[12]; 
  surft2_lo[8] = -(0.49755260400283263*GCC[18])+0.49755260400283263*GBC[18]+0.3535533905932737*GCC[16]+0.3535533905932737*GBC[16]; 
  surft2_lo[9] = -(0.49755260400283263*GCC[20])+0.49755260400283263*GBC[20]+0.3535533905932737*GCC[17]+0.3535533905932737*GBC[17]; 
  surft2_lo[10] = -(0.49755260400283263*GCC[22])+0.49755260400283263*GBC[22]+0.3535533905932737*GCC[19]+0.3535533905932737*GBC[19]; 
  surft2_lo[11] = -(0.49755260400283263*GCC[23])+0.49755260400283263*GBC[23]+0.3535533905932737*GCC[21]+0.3535533905932737*GBC[21]; 
  surft2_lo[12] = -(0.49755260400283263*GCC[35])+0.49755260400283263*GBC[35]+0.3535533905932737*GCC[32]+0.3535533905932737*GBC[32]; 
  surft2_lo[13] = -(0.49755260400283263*GCC[37])+0.49755260400283263*GBC[37]+0.3535533905932737*GCC[33]+0.3535533905932737*GBC[33]; 
  surft2_lo[14] = -(0.49755260400283263*GCC[38])+0.49755260400283263*GBC[38]+0.3535533905932737*GCC[34]+0.3535533905932737*GBC[34]; 
  surft2_lo[15] = -(0.49755260400283263*GCC[39])+0.49755260400283263*GBC[39]+0.3535533905932737*GCC[36]+0.3535533905932737*GBC[36]; 
  ...
  out[28] = (vol[28]+1.224744871391589*surft1_up[9]+1.224744871391589*surft1_lo[9]-2.7386127875258306*surft2_up[1]+2.7386127875258306*surft2_lo[1])*dv1_sq*gamma_avg; 
  out[29] = (vol[29]+0.7071067811865475*surft1_up[11]-0.7071067811865475*surft1_lo[11])*dv1_sq*gamma_avg; 
  out[30] = (vol[30]+1.224744871391589*surft1_up[10]+1.224744871391589*surft1_lo[10]-2.7386127875258306*surft2_up[3]+2.7386127875258306*surft2_lo[3])*dv1_sq*gamma_avg; 
  out[31] = (vol[31]+1.224744871391589*surft1_up[11]+1.224744871391589*surft1_lo[11]-2.7386127875258306*surft2_up[5]+2.7386127875258306*surft2_lo[5])*dv1_sq*gamma_avg; 
  ...
  out[34] = (vol[34]-1.224744871391589*surft2_up[12]+1.224744871391589*surft2_lo[12]+1.224744871391589*surft1_up[12]+1.224744871391589*surft1_lo[12])*dv1_sq*gamma_avg; 
  out[35] = (vol[35]+0.7071067811865475*surft1_up[14]-0.7071067811865475*surft1_lo[14])*dv1_sq*gamma_avg; 
  out[36] = (vol[36]-1.224744871391589*surft2_up[13]+1.224744871391589*surft2_lo[13]+1.224744871391589*surft1_up[13]+1.224744871391589*surft1_lo[13])*dv1_sq*gamma_avg; 
