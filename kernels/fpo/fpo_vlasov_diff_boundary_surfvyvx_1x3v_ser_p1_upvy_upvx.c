...
GKYL_CU_DH void fpo_vlasov_diff_boundary_surfvyvx_1x3v_ser_p1_upvy_upvx(const double *dxv, const double* diff_coeff_stencil[9], const double* f_stencil[9], double* out) { 
  ...
  const double* DBL = &diff_coeff_stencil[0][120]; 
  const double* fBL = f_stencil[0]; 
  const double* DBC = &diff_coeff_stencil[1][120]; 
  const double* fBC = f_stencil[1]; 
  const double* DCL = &diff_coeff_stencil[2][120]; 
  const double* fCL = f_stencil[2]; 
  const double* DCC = &diff_coeff_stencil[3][120]; 
  const double* fCC = f_stencil[3]; 
  ...
  out[2] += 0.35355339059327373*surft1_up[2]*dv1_sq-0.35355339059327373*surft1_lo[2]*dv1_sq-0.6123724356957945*surft2_up[0]*dv1_sq+0.6123724356957945*surft2_lo[0]*dv1_sq; 
  out[3] += 0.6123724356957945*surft1_up[0]*dv1_sq+0.6123724356957945*surft1_lo[0]*dv1_sq; 
  out[4] += 0.35355339059327373*surft1_up[3]*dv1_sq-0.35355339059327373*surft1_lo[3]*dv1_sq; 
  out[5] += 0.35355339059327373*surft1_up[4]*dv1_sq-0.35355339059327373*surft1_lo[4]*dv1_sq-0.6123724356957945*surft2_up[1]*dv1_sq+0.6123724356957945*surft2_lo[1]*dv1_sq; 
  out[6] += 0.6123724356957945*surft1_up[1]*dv1_sq+0.6123724356957945*surft1_lo[1]*dv1_sq; 
  ...
  out[9] += 0.35355339059327373*surft1_up[6]*dv1_sq-0.35355339059327373*surft1_lo[6]*dv1_sq-0.6123724356957945*surft2_up[3]*dv1_sq+0.6123724356957945*surft2_lo[3]*dv1_sq; 
  out[10] += 0.6123724356957945*surft1_up[3]*dv1_sq+0.6123724356957945*surft1_lo[3]*dv1_sq; 
  ...
  out[12] += 0.35355339059327373*surft1_up[7]*dv1_sq-0.35355339059327373*surft1_lo[7]*dv1_sq-0.6123724356957945*surft2_up[5]*dv1_sq+0.6123724356957945*surft2_lo[5]*dv1_sq; 
  out[13] += 0.6123724356957945*surft1_up[5]*dv1_sq+0.6123724356957945*surft1_lo[5]*dv1_sq; 
  ...
  out[16] += 1.3693063937629153*surft2_lo[2]*dv1_sq-1.3693063937629153*surft2_up[2]*dv1_sq; 
  out[17] += 1.3693063937629153*surft2_lo[4]*dv1_sq-1.3693063937629153*surft2_up[4]*dv1_sq; 
  out[18] += -(2.3717082451262845*surft2_up[2]*dv1_sq)-2.3717082451262845*surft2_lo[2]*dv1_sq; 
  out[19] += 1.3693063937629153*surft2_lo[6]*dv1_sq-1.3693063937629153*surft2_up[6]*dv1_sq; 
  out[20] += -(2.3717082451262845*surft2_up[4]*dv1_sq)-2.3717082451262845*surft2_lo[4]*dv1_sq; 
  out[21] += 1.3693063937629153*surft2_lo[7]*dv1_sq-1.3693063937629153*surft2_up[7]*dv1_sq; 
  out[22] += -(2.3717082451262845*surft2_up[6]*dv1_sq)-2.3717082451262845*surft2_lo[6]*dv1_sq; 
  out[23] += -(2.3717082451262845*surft2_up[7]*dv1_sq)-2.3717082451262845*surft2_lo[7]*dv1_sq; 
  out[24] += 0.7905694150420948*surft1_up[0]*dv1_sq-0.7905694150420948*surft1_lo[0]*dv1_sq; 
  out[25] += 0.7905694150420949*surft1_up[1]*dv1_sq-0.7905694150420949*surft1_lo[1]*dv1_sq; 
  out[26] += 0.7905694150420949*surft1_up[2]*dv1_sq-0.7905694150420949*surft1_lo[2]*dv1_sq-1.3693063937629153*surft2_up[0]*dv1_sq+1.3693063937629153*surft2_lo[0]*dv1_sq; 
  out[27] += 0.7905694150420949*surft1_up[3]*dv1_sq-0.7905694150420949*surft1_lo[3]*dv1_sq; 
  out[28] += 0.7905694150420948*surft1_up[4]*dv1_sq-0.7905694150420948*surft1_lo[4]*dv1_sq-1.3693063937629153*surft2_up[1]*dv1_sq+1.3693063937629153*surft2_lo[1]*dv1_sq; 
  out[29] += 0.7905694150420948*surft1_up[5]*dv1_sq-0.7905694150420948*surft1_lo[5]*dv1_sq; 
  out[30] += 0.7905694150420948*surft1_up[6]*dv1_sq-0.7905694150420948*surft1_lo[6]*dv1_sq-1.3693063937629153*surft2_up[3]*dv1_sq+1.3693063937629153*surft2_lo[3]*dv1_sq; 
  out[31] += 0.7905694150420949*surft1_up[7]*dv1_sq-0.7905694150420949*surft1_lo[7]*dv1_sq-1.3693063937629153*surft2_up[5]*dv1_sq+1.3693063937629153*surft2_lo[5]*dv1_sq; 
} 
