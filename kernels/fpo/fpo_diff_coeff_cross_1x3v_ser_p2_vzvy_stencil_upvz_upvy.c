...
GKYL_CU_DH void fpo_diff_coeff_cross_1x3v_vzvy_ser_p2_upvz_upvy(const double *dxv, const double *gamma, const double* fpo_g_stencil[9], const double* fpo_g_surf_stencil[9], const double* fpo_dgdv_surf, double *diff_coeff) { 
  ...
  const double* dGdvz_surf_CC_vy = &fpo_dgdv_surf[100]; 

  surft1_lo[0] = 0.599071547271275*GCL[27]+0.599071547271275*GCC[27]+0.8617863895711042*GCL[10]-0.8617863895711042*GCC[10]+0.6123724356957944*GCL[4]+0.6123724356957944*GCC[4]; 
  surft1_lo[1] = 0.599071547271275*GCL[39]+0.599071547271275*GCC[39]+0.8617863895711042*GCL[17]-0.8617863895711042*GCC[17]+0.6123724356957944*GCL[8]+0.6123724356957944*GCC[8]; 
  surft1_lo[2] = 0.599071547271275*GCL[40]+0.599071547271275*GCC[40]+0.8617863895711042*GCL[18]-0.8617863895711042*GCC[18]+0.6123724356957944*GCL[9]+0.6123724356957944*GCC[9]; 
  surft1_lo[3] = 1.9270129491651047*GCL[30]-1.9270129491651047*GCC[30]+1.369306393762915*GCL[14]+1.369306393762915*GCC[14]; 
  surft1_lo[4] = 0.599071547271275*GCL[46]+0.599071547271275*GCC[46]+0.8617863895711042*GCL[31]-0.8617863895711042*GCC[31]+0.6123724356957944*GCL[16]+0.6123724356957944*GCC[16]; 
  surft1_lo[5] = 1.927012949165105*GCL[42]-1.927012949165105*GCC[42]+1.369306393762915*GCL[28]+1.369306393762915*GCC[28]; 
  surft1_lo[6] = 1.927012949165105*GCL[43]-1.927012949165105*GCC[43]+1.369306393762915*GCL[29]+1.369306393762915*GCC[29]; 
  surft1_lo[7] = 0.8617863895711042*GCL[37]-0.8617863895711042*GCC[37]+0.6123724356957944*GCL[25]+0.6123724356957944*GCC[25]; 
  surft1_lo[8] = 0.8617863895711042*GCL[38]-0.8617863895711042*GCC[38]+0.6123724356957944*GCL[26]+0.6123724356957944*GCC[26]; 
  surft1_lo[10] = 1.9270129491651047*GCL[47]-1.9270129491651047*GCC[47]+1.369306393762915*GCL[41]+1.369306393762915*GCC[41]; 
  surft1_lo[11] = 0.8617863895711042*GCL[44]-0.8617863895711042*GCC[44]+0.6123724356957944*GCL[35]+0.6123724356957944*GCC[35]; 
  surft1_lo[12] = 0.8617863895711042*GCL[45]-0.8617863895711042*GCC[45]+0.6123724356957944*GCL[36]+0.6123724356957944*GCC[36]; 
  surft1_up[0] = dGdvz_surf_CC_vy[0]/dv1_pvy; 
  surft1_up[1] = dGdvz_surf_CC_vy[1]/dv1_pvy; 
  surft1_up[2] = dGdvz_surf_CC_vy[2]/dv1_pvy; 
  surft1_up[3] = dGdvz_surf_CC_vy[3]/dv1_pvy; 
  surft1_up[4] = dGdvz_surf_CC_vy[4]/dv1_pvy; 
  surft1_up[5] = dGdvz_surf_CC_vy[5]/dv1_pvy; 
  surft1_up[6] = dGdvz_surf_CC_vy[6]/dv1_pvy; 
  surft1_up[7] = dGdvz_surf_CC_vy[7]/dv1_pvy; 
  surft1_up[8] = dGdvz_surf_CC_vy[8]/dv1_pvy; 
  surft1_up[9] = dGdvz_surf_CC_vy[9]/dv1_pvy; 
  surft1_up[10] = dGdvz_surf_CC_vy[10]/dv1_pvy; 
  surft1_up[11] = dGdvz_surf_CC_vy[11]/dv1_pvy; 
  surft1_up[12] = dGdvz_surf_CC_vy[12]/dv1_pvy; 
  surft1_up[13] = dGdvz_surf_CC_vy[13]/dv1_pvy; 
  surft1_up[14] = dGdvz_surf_CC_vy[14]/dv1_pvy; 
  surft1_up[15] = dGdvz_surf_CC_vy[15]/dv1_pvy; 
  surft1_up[16] = dGdvz_surf_CC_vy[16]/dv1_pvy; 
  surft1_up[17] = dGdvz_surf_CC_vy[17]/dv1_pvy; 
  surft1_up[18] = dGdvz_surf_CC_vy[18]/dv1_pvy; 
  surft1_up[19] = dGdvz_surf_CC_vy[19]/dv1_pvy; 
