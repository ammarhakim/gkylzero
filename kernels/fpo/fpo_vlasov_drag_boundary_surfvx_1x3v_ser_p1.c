...
GKYL_CU_DH double fpo_vlasov_drag_boundary_surfvx_1x3v_ser_p1(const double* dxv,
  ...
  out[2] += -(0.6123724356957945*GhatR[0]*dv1); 
  out[3] += -(0.35355339059327373*GhatR[2]*dv1); 
  out[4] += -(0.35355339059327373*GhatR[3]*dv1); 
  out[5] += -(0.6123724356957945*GhatR[1]*dv1); 
  out[6] += -(0.35355339059327373*GhatR[4]*dv1); 
  out[7] += -(0.6123724356957945*GhatR[2]*dv1); 
  out[8] += -(0.35355339059327373*GhatR[5]*dv1); 
  out[9] += -(0.6123724356957945*GhatR[3]*dv1); 
  out[10] += -(0.35355339059327373*GhatR[6]*dv1); 
  out[11] += -(0.6123724356957945*GhatR[4]*dv1); 
  out[12] += -(0.6123724356957945*GhatR[5]*dv1); 
  out[13] += -(0.35355339059327373*GhatR[7]*dv1); 
  out[14] += -(0.6123724356957945*GhatR[6]*dv1); 
  out[15] += -(0.6123724356957945*GhatR[7]*dv1); 
  out[16] += -(0.7905694150420948*GhatR[0]*dv1); 
  out[17] += -(0.7905694150420949*GhatR[1]*dv1); 
  out[18] += -(0.7905694150420949*GhatR[2]*dv1); 
  out[19] += -(0.7905694150420949*GhatR[3]*dv1); 
  out[20] += -(0.7905694150420948*GhatR[4]*dv1); 
  out[21] += -(0.7905694150420948*GhatR[5]*dv1); 
  out[22] += -(0.7905694150420948*GhatR[6]*dv1); 
  out[23] += -(0.7905694150420949*GhatR[7]*dv1); 
  ...
  out[2] += -(0.6123724356957945*GhatL[0]*dv1); 
  out[3] += 0.35355339059327373*GhatL[2]*dv1; 
  out[4] += 0.35355339059327373*GhatL[3]*dv1; 
  out[5] += -(0.6123724356957945*GhatL[1]*dv1); 
  out[6] += 0.35355339059327373*GhatL[4]*dv1; 
  out[7] += -(0.6123724356957945*GhatL[2]*dv1); 
  out[8] += 0.35355339059327373*GhatL[5]*dv1; 
  out[9] += -(0.6123724356957945*GhatL[3]*dv1); 
  out[10] += 0.35355339059327373*GhatL[6]*dv1; 
  out[11] += -(0.6123724356957945*GhatL[4]*dv1); 
  out[12] += -(0.6123724356957945*GhatL[5]*dv1); 
  out[13] += 0.35355339059327373*GhatL[7]*dv1; 
  out[14] += -(0.6123724356957945*GhatL[6]*dv1); 
  out[15] += -(0.6123724356957945*GhatL[7]*dv1); 
  out[16] += 0.7905694150420948*GhatL[0]*dv1; 
  out[17] += 0.7905694150420949*GhatL[1]*dv1; 
  out[18] += 0.7905694150420949*GhatL[2]*dv1; 
  out[19] += 0.7905694150420949*GhatL[3]*dv1; 
  out[20] += 0.7905694150420948*GhatL[4]*dv1; 
  out[21] += 0.7905694150420948*GhatL[5]*dv1; 
  out[22] += 0.7905694150420948*GhatL[6]*dv1; 
  out[23] += 0.7905694150420949*GhatL[7]*dv1; 
