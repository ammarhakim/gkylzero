...
GKYL_CU_DH void fpo_diff_coeff_cross_1x3v_vzvx_ser_p1_upvz_invx(const double *dxv, const double *gamma, const double* fpo_g_stencil[9], const double* fpo_g_surf_stencil[9], const double* fpo_dgdv_surf, double *diff_coeff) { 
 ...
 double gamma_avg = gamma[0]/sqrt(pow(2, 1)); 
  ...
  surft1_lower[0] = -(0.11785113019775789*GTL[9])+0.11785113019775789*GTC[9]+0.2357022603955158*GCL[9]-0.2357022603955158*GCC[9]-0.11785113019775789*GBL[9]+0.11785113019775789*GBC[9]+0.10206207261596573*GTL[4]-0.10206207261596573*GTC[4]-0.10206207261596573*GBL[4]+0.10206207261596573*GBC[4]-0.10206207261596573*GTL[2]-0.10206207261596573*GTC[2]+0.20412414523193148*GCL[2]+0.20412414523193148*GCC[2]-0.10206207261596573*GBL[2]-0.10206207261596573*GBC[2]+0.0883883476483184*GTL[0]+0.0883883476483184*GTC[0]-0.0883883476483184*GBL[0]-0.0883883476483184*GBC[0]; 
  surft1_lower[1] = -(0.11785113019775789*GTL[12])+0.11785113019775789*GTC[12]+0.2357022603955158*GCL[12]-0.2357022603955158*GCC[12]-0.11785113019775789*GBL[12]+0.11785113019775789*GBC[12]+0.10206207261596573*GTL[8]-0.10206207261596573*GTC[8]-0.10206207261596573*GBL[8]+0.10206207261596573*GBC[8]-0.10206207261596573*GTL[5]-0.10206207261596573*GTC[5]+0.20412414523193148*GCL[5]+0.20412414523193148*GCC[5]-0.10206207261596573*GBL[5]-0.10206207261596573*GBC[5]+0.0883883476483184*GTL[1]+0.0883883476483184*GTC[1]-0.0883883476483184*GBL[1]-0.0883883476483184*GBC[1]; 
  surft1_lower[2] = -(0.20412414523193148*GTL[9])+0.20412414523193148*GTC[9]+0.20412414523193148*GBL[9]-0.20412414523193148*GBC[9]+0.1767766952966368*GTL[4]-0.1767766952966368*GTC[4]-0.3535533905932737*GCL[4]+0.3535533905932737*GCC[4]+0.1767766952966368*GBL[4]-0.1767766952966368*GBC[4]-0.1767766952966368*GTL[2]-0.1767766952966368*GTC[2]+0.1767766952966368*GBL[2]+0.1767766952966368*GBC[2]+0.15309310892394856*GTL[0]+0.15309310892394856*GTC[0]-0.3061862178478971*GCL[0]-0.3061862178478971*GCC[0]+0.15309310892394856*GBL[0]+0.15309310892394856*GBC[0]; 
  surft1_lower[3] = -(0.11785113019775789*GTL[14])+0.11785113019775789*GTC[14]+0.2357022603955158*GCL[14]-0.2357022603955158*GCC[14]-0.11785113019775789*GBL[14]+0.11785113019775789*GBC[14]+0.10206207261596573*GTL[10]-0.10206207261596573*GTC[10]-0.10206207261596573*GBL[10]+0.10206207261596573*GBC[10]-0.10206207261596573*GTL[7]-0.10206207261596573*GTC[7]+0.20412414523193148*GCL[7]+0.20412414523193148*GCC[7]-0.10206207261596573*GBL[7]-0.10206207261596573*GBC[7]+0.0883883476483184*GTL[3]+0.0883883476483184*GTC[3]-0.0883883476483184*GBL[3]-0.0883883476483184*GBC[3]; 
  surft1_lower[4] = -(0.20412414523193148*GTL[12])+0.20412414523193148*GTC[12]+0.20412414523193148*GBL[12]-0.20412414523193148*GBC[12]+0.1767766952966368*GTL[8]-0.1767766952966368*GTC[8]-0.3535533905932737*GCL[8]+0.3535533905932737*GCC[8]+0.1767766952966368*GBL[8]-0.1767766952966368*GBC[8]-0.1767766952966368*GTL[5]-0.1767766952966368*GTC[5]+0.1767766952966368*GBL[5]+0.1767766952966368*GBC[5]+0.15309310892394856*GTL[1]+0.15309310892394856*GTC[1]-0.3061862178478971*GCL[1]-0.3061862178478971*GCC[1]+0.15309310892394856*GBL[1]+0.15309310892394856*GBC[1]; 
  surft1_lower[5] = -(0.11785113019775789*GTL[15])+0.11785113019775789*GTC[15]+0.2357022603955158*GCL[15]-0.2357022603955158*GCC[15]-0.11785113019775789*GBL[15]+0.11785113019775789*GBC[15]+0.10206207261596573*GTL[13]-0.10206207261596573*GTC[13]-0.10206207261596573*GBL[13]+0.10206207261596573*GBC[13]-0.10206207261596573*GTL[11]-0.10206207261596573*GTC[11]+0.20412414523193148*GCL[11]+0.20412414523193148*GCC[11]-0.10206207261596573*GBL[11]-0.10206207261596573*GBC[11]+0.0883883476483184*GTL[6]+0.0883883476483184*GTC[6]-0.0883883476483184*GBL[6]-0.0883883476483184*GBC[6]; 
  surft1_lower[6] = -(0.20412414523193148*GTL[14])+0.20412414523193148*GTC[14]+0.20412414523193148*GBL[14]-0.20412414523193148*GBC[14]+0.1767766952966368*GTL[10]-0.1767766952966368*GTC[10]-0.3535533905932737*GCL[10]+0.3535533905932737*GCC[10]+0.1767766952966368*GBL[10]-0.1767766952966368*GBC[10]-0.1767766952966368*GTL[7]-0.1767766952966368*GTC[7]+0.1767766952966368*GBL[7]+0.1767766952966368*GBC[7]+0.15309310892394856*GTL[3]+0.15309310892394856*GTC[3]-0.3061862178478971*GCL[3]-0.3061862178478971*GCC[3]+0.15309310892394856*GBL[3]+0.15309310892394856*GBC[3]; 
  surft1_lower[7] = -(0.20412414523193148*GTL[15])+0.20412414523193148*GTC[15]+0.20412414523193148*GBL[15]-0.20412414523193148*GBC[15]+0.1767766952966368*GTL[13]-0.1767766952966368*GTC[13]-0.3535533905932737*GCL[13]+0.3535533905932737*GCC[13]+0.1767766952966368*GBL[13]-0.1767766952966368*GBC[13]-0.1767766952966368*GTL[11]-0.1767766952966368*GTC[11]+0.1767766952966368*GBL[11]+0.1767766952966368*GBC[11]+0.15309310892394856*GTL[6]+0.15309310892394856*GTC[6]-0.3061862178478971*GCL[6]-0.3061862178478971*GCC[6]+0.15309310892394856*GBL[6]+0.15309310892394856*GBC[6]; 
