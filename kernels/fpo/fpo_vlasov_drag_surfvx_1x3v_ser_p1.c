...
GKYL_CU_DH void fpo_vlasov_drag_surfvx_1x3v_ser_p1(const double* dxv, const double* drag_coeff_stencil[9], const double* f_stencil[9], double* GKYL_RESTRICT out) { 
  ...
  const double* aR = &drag_coeff_stencil[2][0]; 
  double dv1 = 2.0/dxv[1]; 

  double alphaDragSurf_lo[8] = {0.0}; 
  alphaDragSurf_lo[0] = 0.408248290463863*aL[2]-0.408248290463863*aC[2]+0.3535533905932737*aL[0]+0.3535533905932737*aC[0]; 
  alphaDragSurf_lo[1] = 0.408248290463863*aL[5]-0.408248290463863*aC[5]+0.3535533905932737*aL[1]+0.3535533905932737*aC[1]; 
  alphaDragSurf_lo[2] = 0.408248290463863*aL[7]-0.408248290463863*aC[7]+0.3535533905932737*aL[3]+0.3535533905932737*aC[3]; 
  alphaDragSurf_lo[3] = 0.408248290463863*aL[9]-0.408248290463863*aC[9]+0.3535533905932737*aL[4]+0.3535533905932737*aC[4]; 
  alphaDragSurf_lo[4] = 0.408248290463863*aL[11]-0.408248290463863*aC[11]+0.3535533905932737*aL[6]+0.3535533905932737*aC[6]; 
  alphaDragSurf_lo[5] = 0.408248290463863*aL[12]-0.408248290463863*aC[12]+0.3535533905932737*aL[8]+0.3535533905932737*aC[8]; 
  alphaDragSurf_lo[6] = 0.408248290463863*aL[14]-0.408248290463863*aC[14]+0.3535533905932737*aL[10]+0.3535533905932737*aC[10]; 
  alphaDragSurf_lo[7] = 0.408248290463863*aL[15]-0.408248290463863*aC[15]+0.3535533905932737*aL[13]+0.3535533905932737*aC[13]; 

  double alphaDragSurf_up[8] = {0.0}; 
  alphaDragSurf_up[0] = -(0.408248290463863*aR[2])+0.408248290463863*aC[2]+0.3535533905932737*aR[0]+0.3535533905932737*aC[0]; 
  alphaDragSurf_up[1] = -(0.408248290463863*aR[5])+0.408248290463863*aC[5]+0.3535533905932737*aR[1]+0.3535533905932737*aC[1]; 
  alphaDragSurf_up[2] = -(0.408248290463863*aR[7])+0.408248290463863*aC[7]+0.3535533905932737*aR[3]+0.3535533905932737*aC[3]; 
  alphaDragSurf_up[3] = -(0.408248290463863*aR[9])+0.408248290463863*aC[9]+0.3535533905932737*aR[4]+0.3535533905932737*aC[4]; 
  alphaDragSurf_up[4] = -(0.408248290463863*aR[11])+0.408248290463863*aC[11]+0.3535533905932737*aR[6]+0.3535533905932737*aC[6]; 
  alphaDragSurf_up[5] = -(0.408248290463863*aR[12])+0.408248290463863*aC[12]+0.3535533905932737*aR[8]+0.3535533905932737*aC[8]; 
  alphaDragSurf_up[6] = -(0.408248290463863*aR[14])+0.408248290463863*aC[14]+0.3535533905932737*aR[10]+0.3535533905932737*aC[10]; 
  alphaDragSurf_up[7] = -(0.408248290463863*aR[15])+0.408248290463863*aC[15]+0.3535533905932737*aR[13]+0.3535533905932737*aC[13]; 
  ...
  if (-(0.3535533905932737*alphaDragSurf_lo[7])+0.3535533905932737*(alphaDragSurf_lo[6]+alphaDragSurf_lo[5]+alphaDragSurf_lo[4])-0.3535533905932737*(alphaDragSurf_lo[3]+alphaDragSurf_lo[2]+alphaDragSurf_lo[1])+0.3535533905932737*alphaDragSurf_lo[0] > 0) { 
    fUpwindQuad_lo[0] = ser_4x_p1_surfx2_eval_quad_node_0_r(fL); 
  } else { 
    fUpwindQuad_lo[0] = ser_4x_p1_surfx2_eval_quad_node_0_l(fC); 
  } 
  if (-(0.3535533905932737*alphaDragSurf_up[7])+0.3535533905932737*(alphaDragSurf_up[6]+alphaDragSurf_up[5]+alphaDragSurf_up[4])-0.3535533905932737*(alphaDragSurf_up[3]+alphaDragSurf_up[2]+alphaDragSurf_up[1])+0.3535533905932737*alphaDragSurf_up[0] > 0) { 
    fUpwindQuad_up[0] = ser_4x_p1_surfx2_eval_quad_node_0_r(fC); 
  } else { 
    fUpwindQuad_up[0] = ser_4x_p1_surfx2_eval_quad_node_0_l(fR); 
  } 
  if (0.3535533905932737*alphaDragSurf_lo[7]-0.3535533905932737*(alphaDragSurf_lo[6]+alphaDragSurf_lo[5])+0.3535533905932737*(alphaDragSurf_lo[4]+alphaDragSurf_lo[3])-0.3535533905932737*(alphaDragSurf_lo[2]+alphaDragSurf_lo[1])+0.3535533905932737*alphaDragSurf_lo[0] > 0) { 
    fUpwindQuad_lo[1] = ser_4x_p1_surfx2_eval_quad_node_1_r(fL); 
  } else { 
    fUpwindQuad_lo[1] = ser_4x_p1_surfx2_eval_quad_node_1_l(fC); 
  } 
  if (0.3535533905932737*alphaDragSurf_up[7]-0.3535533905932737*(alphaDragSurf_up[6]+alphaDragSurf_up[5])+0.3535533905932737*(alphaDragSurf_up[4]+alphaDragSurf_up[3])-0.3535533905932737*(alphaDragSurf_up[2]+alphaDragSurf_up[1])+0.3535533905932737*alphaDragSurf_up[0] > 0) { 
    fUpwindQuad_up[1] = ser_4x_p1_surfx2_eval_quad_node_1_r(fC); 
  } else { 
    fUpwindQuad_up[1] = ser_4x_p1_surfx2_eval_quad_node_1_l(fR); 
  } 
  if (0.3535533905932737*alphaDragSurf_lo[7]-0.3535533905932737*alphaDragSurf_lo[6]+0.3535533905932737*alphaDragSurf_lo[5]-0.3535533905932737*(alphaDragSurf_lo[4]+alphaDragSurf_lo[3])+0.3535533905932737*alphaDragSurf_lo[2]-0.3535533905932737*alphaDragSurf_lo[1]+0.3535533905932737*alphaDragSurf_lo[0] > 0) { 
    fUpwindQuad_lo[2] = ser_4x_p1_surfx2_eval_quad_node_2_r(fL); 
  } else { 
    fUpwindQuad_lo[2] = ser_4x_p1_surfx2_eval_quad_node_2_l(fC); 
  } 
  if (0.3535533905932737*alphaDragSurf_up[7]-0.3535533905932737*alphaDragSurf_up[6]+0.3535533905932737*alphaDragSurf_up[5]-0.3535533905932737*(alphaDragSurf_up[4]+alphaDragSurf_up[3])+0.3535533905932737*alphaDragSurf_up[2]-0.3535533905932737*alphaDragSurf_up[1]+0.3535533905932737*alphaDragSurf_up[0] > 0) { 
    fUpwindQuad_up[2] = ser_4x_p1_surfx2_eval_quad_node_2_r(fC); 
  } else { 
    fUpwindQuad_up[2] = ser_4x_p1_surfx2_eval_quad_node_2_l(fR); 
  } 
  if (-(0.3535533905932737*alphaDragSurf_lo[7])+0.3535533905932737*alphaDragSurf_lo[6]-0.3535533905932737*(alphaDragSurf_lo[5]+alphaDragSurf_lo[4])+0.3535533905932737*(alphaDragSurf_lo[3]+alphaDragSurf_lo[2])-0.3535533905932737*alphaDragSurf_lo[1]+0.3535533905932737*alphaDragSurf_lo[0] > 0) { 
    fUpwindQuad_lo[3] = ser_4x_p1_surfx2_eval_quad_node_3_r(fL); 
  } else { 
    fUpwindQuad_lo[3] = ser_4x_p1_surfx2_eval_quad_node_3_l(fC); 
  } 
  if (-(0.3535533905932737*alphaDragSurf_up[7])+0.3535533905932737*alphaDragSurf_up[6]-0.3535533905932737*(alphaDragSurf_up[5]+alphaDragSurf_up[4])+0.3535533905932737*(alphaDragSurf_up[3]+alphaDragSurf_up[2])-0.3535533905932737*alphaDragSurf_up[1]+0.3535533905932737*alphaDragSurf_up[0] > 0) { 
    fUpwindQuad_up[3] = ser_4x_p1_surfx2_eval_quad_node_3_r(fC); 
  } else { 
    fUpwindQuad_up[3] = ser_4x_p1_surfx2_eval_quad_node_3_l(fR); 
  } 
  if (0.3535533905932737*(alphaDragSurf_lo[7]+alphaDragSurf_lo[6])-0.3535533905932737*(alphaDragSurf_lo[5]+alphaDragSurf_lo[4]+alphaDragSurf_lo[3]+alphaDragSurf_lo[2])+0.3535533905932737*(alphaDragSurf_lo[1]+alphaDragSurf_lo[0]) > 0) { 
    fUpwindQuad_lo[4] = ser_4x_p1_surfx2_eval_quad_node_4_r(fL); 
  } else { 
    fUpwindQuad_lo[4] = ser_4x_p1_surfx2_eval_quad_node_4_l(fC); 
  } 
  if (0.3535533905932737*(alphaDragSurf_up[7]+alphaDragSurf_up[6])-0.3535533905932737*(alphaDragSurf_up[5]+alphaDragSurf_up[4]+alphaDragSurf_up[3]+alphaDragSurf_up[2])+0.3535533905932737*(alphaDragSurf_up[1]+alphaDragSurf_up[0]) > 0) { 
    fUpwindQuad_up[4] = ser_4x_p1_surfx2_eval_quad_node_4_r(fC); 
  } else { 
    fUpwindQuad_up[4] = ser_4x_p1_surfx2_eval_quad_node_4_l(fR); 
  } 
  if (-(0.3535533905932737*(alphaDragSurf_lo[7]+alphaDragSurf_lo[6]))+0.3535533905932737*alphaDragSurf_lo[5]-0.3535533905932737*alphaDragSurf_lo[4]+0.3535533905932737*alphaDragSurf_lo[3]-0.3535533905932737*alphaDragSurf_lo[2]+0.3535533905932737*(alphaDragSurf_lo[1]+alphaDragSurf_lo[0]) > 0) { 
    fUpwindQuad_lo[5] = ser_4x_p1_surfx2_eval_quad_node_5_r(fL); 
  } else { 
    fUpwindQuad_lo[5] = ser_4x_p1_surfx2_eval_quad_node_5_l(fC); 
  } 
  if (-(0.3535533905932737*(alphaDragSurf_up[7]+alphaDragSurf_up[6]))+0.3535533905932737*alphaDragSurf_up[5]-0.3535533905932737*alphaDragSurf_up[4]+0.3535533905932737*alphaDragSurf_up[3]-0.3535533905932737*alphaDragSurf_up[2]+0.3535533905932737*(alphaDragSurf_up[1]+alphaDragSurf_up[0]) > 0) { 
    fUpwindQuad_up[5] = ser_4x_p1_surfx2_eval_quad_node_5_r(fC); 
  } else { 
    fUpwindQuad_up[5] = ser_4x_p1_surfx2_eval_quad_node_5_l(fR); 
  } 
  if (-(0.3535533905932737*(alphaDragSurf_lo[7]+alphaDragSurf_lo[6]+alphaDragSurf_lo[5]))+0.3535533905932737*alphaDragSurf_lo[4]-0.3535533905932737*alphaDragSurf_lo[3]+0.3535533905932737*(alphaDragSurf_lo[2]+alphaDragSurf_lo[1]+alphaDragSurf_lo[0]) > 0) { 
    fUpwindQuad_lo[6] = ser_4x_p1_surfx2_eval_quad_node_6_r(fL); 
  } else { 
    fUpwindQuad_lo[6] = ser_4x_p1_surfx2_eval_quad_node_6_l(fC); 
  } 
  if (-(0.3535533905932737*(alphaDragSurf_up[7]+alphaDragSurf_up[6]+alphaDragSurf_up[5]))+0.3535533905932737*alphaDragSurf_up[4]-0.3535533905932737*alphaDragSurf_up[3]+0.3535533905932737*(alphaDragSurf_up[2]+alphaDragSurf_up[1]+alphaDragSurf_up[0]) > 0) { 
    fUpwindQuad_up[6] = ser_4x_p1_surfx2_eval_quad_node_6_r(fC); 
  } else { 
    fUpwindQuad_up[6] = ser_4x_p1_surfx2_eval_quad_node_6_l(fR); 
  } 
  if (0.3535533905932737*(alphaDragSurf_lo[7]+alphaDragSurf_lo[6]+alphaDragSurf_lo[5]+alphaDragSurf_lo[4]+alphaDragSurf_lo[3]+alphaDragSurf_lo[2]+alphaDragSurf_lo[1]+alphaDragSurf_lo[0]) > 0) { 
    fUpwindQuad_lo[7] = ser_4x_p1_surfx2_eval_quad_node_7_r(fL); 
  } else { 
    fUpwindQuad_lo[7] = ser_4x_p1_surfx2_eval_quad_node_7_l(fC); 
  } 
  if (0.3535533905932737*(alphaDragSurf_up[7]+alphaDragSurf_up[6]+alphaDragSurf_up[5]+alphaDragSurf_up[4]+alphaDragSurf_up[3]+alphaDragSurf_up[2]+alphaDragSurf_up[1]+alphaDragSurf_up[0]) > 0) { 
    fUpwindQuad_up[7] = ser_4x_p1_surfx2_eval_quad_node_7_r(fC); 
  } else { 
    fUpwindQuad_up[7] = ser_4x_p1_surfx2_eval_quad_node_7_l(fR); 
  } 
  ...
  out[2] += 0.6123724356957945*Ghat_up[0]*dv1+0.6123724356957945*Ghat_lo[0]*dv1; 
  out[3] += 0.35355339059327373*Ghat_up[2]*dv1-0.35355339059327373*Ghat_lo[2]*dv1; 
  out[4] += 0.35355339059327373*Ghat_up[3]*dv1-0.35355339059327373*Ghat_lo[3]*dv1; 
  out[5] += 0.6123724356957945*Ghat_up[1]*dv1+0.6123724356957945*Ghat_lo[1]*dv1; 
  out[6] += 0.35355339059327373*Ghat_up[4]*dv1-0.35355339059327373*Ghat_lo[4]*dv1; 
  out[7] += 0.6123724356957945*Ghat_up[2]*dv1+0.6123724356957945*Ghat_lo[2]*dv1; 
  out[8] += 0.35355339059327373*Ghat_up[5]*dv1-0.35355339059327373*Ghat_lo[5]*dv1; 
  out[9] += 0.6123724356957945*Ghat_up[3]*dv1+0.6123724356957945*Ghat_lo[3]*dv1; 
  out[10] += 0.35355339059327373*Ghat_up[6]*dv1-0.35355339059327373*Ghat_lo[6]*dv1; 
  out[11] += 0.6123724356957945*Ghat_up[4]*dv1+0.6123724356957945*Ghat_lo[4]*dv1; 
  out[12] += 0.6123724356957945*Ghat_up[5]*dv1+0.6123724356957945*Ghat_lo[5]*dv1; 
  out[13] += 0.35355339059327373*Ghat_up[7]*dv1-0.35355339059327373*Ghat_lo[7]*dv1; 
  ...
  out[16] += 0.7905694150420948*Ghat_up[0]*dv1-0.7905694150420948*Ghat_lo[0]*dv1; 
  out[17] += 0.7905694150420949*Ghat_up[1]*dv1-0.7905694150420949*Ghat_lo[1]*dv1; 
  out[18] += 0.7905694150420949*Ghat_up[2]*dv1-0.7905694150420949*Ghat_lo[2]*dv1; 
  out[19] += 0.7905694150420949*Ghat_up[3]*dv1-0.7905694150420949*Ghat_lo[3]*dv1; 
  out[20] += 0.7905694150420948*Ghat_up[4]*dv1-0.7905694150420948*Ghat_lo[4]*dv1; 
  out[21] += 0.7905694150420948*Ghat_up[5]*dv1-0.7905694150420948*Ghat_lo[5]*dv1; 
  out[22] += 0.7905694150420948*Ghat_up[6]*dv1-0.7905694150420948*Ghat_lo[6]*dv1; 
  out[23] += 0.7905694150420949*Ghat_up[7]*dv1-0.7905694150420949*Ghat_lo[7]*dv1; 
