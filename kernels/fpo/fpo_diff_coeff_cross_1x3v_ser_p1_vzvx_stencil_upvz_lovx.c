...
GKYL_CU_DH void fpo_diff_coeff_cross_1x3v_vzvx_ser_p1_upvz_lovx(const double *dxv, const double *gamma, const double* fpo_g_stencil[9], const double* fpo_g_surf_stencil[9], const double* fpo_dgdv_surf, double *diff_coeff) { 
  ...
  surft1_lo[0] = -(0.7071067811865475*GCC[9])+0.7071067811865475*GBC[9]+0.6123724356957944*GCC[2]+0.6123724356957944*GBC[2]; 
  surft1_lo[1] = -(0.7071067811865475*GCC[12])+0.7071067811865475*GBC[12]+0.6123724356957944*GCC[5]+0.6123724356957944*GBC[5]; 
  surft1_lo[3] = -(0.7071067811865475*GCC[14])+0.7071067811865475*GBC[14]+0.6123724356957944*GCC[7]+0.6123724356957944*GBC[7]; 
  surft1_lo[5] = -(0.7071067811865475*GCC[15])+0.7071067811865475*GBC[15]+0.6123724356957944*GCC[11]+0.6123724356957944*GBC[11]; 
  surft1_up[0] = dGdvx_surf_CC_vz[0]/dv2; 
  surft1_up[1] = dGdvx_surf_CC_vz[1]/dv2; 
  surft1_up[2] = dGdvx_surf_CC_vz[2]/dv2; 
  surft1_up[3] = dGdvx_surf_CC_vz[3]/dv2; 
  surft1_up[4] = dGdvx_surf_CC_vz[4]/dv2; 
  surft1_up[5] = dGdvx_surf_CC_vz[5]/dv2; 
  surft1_up[6] = dGdvx_surf_CC_vz[6]/dv2; 
  surft1_up[7] = dGdvx_surf_CC_vz[7]/dv2; 

  surft2_lo[0] = 1.5811388300841895*GCC[16]-1.224744871391589*GCC[2]+0.7071067811865475*GCC[0]; 
  surft2_lo[1] = 1.5811388300841898*GCC[17]-1.224744871391589*GCC[5]+0.7071067811865475*GCC[1]; 
  surft2_lo[2] = 1.5811388300841898*GCC[18]-1.224744871391589*GCC[7]+0.7071067811865475*GCC[3]; 
  surft2_lo[3] = 1.5811388300841898*GCC[19]-1.224744871391589*GCC[9]+0.7071067811865475*GCC[4]; 
  surft2_lo[4] = 1.5811388300841895*GCC[20]-1.224744871391589*GCC[11]+0.7071067811865475*GCC[6]; 
  surft2_lo[5] = 1.5811388300841895*GCC[21]-1.224744871391589*GCC[12]+0.7071067811865475*GCC[8]; 
  surft2_lo[6] = 1.5811388300841895*GCC[22]-1.224744871391589*GCC[14]+0.7071067811865475*GCC[10]; 
  surft2_lo[7] = 1.5811388300841898*GCC[23]-1.224744871391589*GCC[15]+0.7071067811865475*GCC[13]; 
  surft2_up[0] = -(0.408248290463863*GCR[2])+0.408248290463863*GCC[2]+0.3535533905932737*GCR[0]+0.3535533905932737*GCC[0]; 
  surft2_up[1] = -(0.408248290463863*GCR[5])+0.408248290463863*GCC[5]+0.3535533905932737*GCR[1]+0.3535533905932737*GCC[1]; 
  surft2_up[2] = -(0.408248290463863*GCR[7])+0.408248290463863*GCC[7]+0.3535533905932737*GCR[3]+0.3535533905932737*GCC[3]; 
  surft2_up[3] = -(0.408248290463863*GCR[9])+0.408248290463863*GCC[9]+0.3535533905932737*GCR[4]+0.3535533905932737*GCC[4]; 
  surft2_up[4] = -(0.408248290463863*GCR[11])+0.408248290463863*GCC[11]+0.3535533905932737*GCR[6]+0.3535533905932737*GCC[6]; 
  surft2_up[5] = -(0.408248290463863*GCR[12])+0.408248290463863*GCC[12]+0.3535533905932737*GCR[8]+0.3535533905932737*GCC[8]; 
  surft2_up[6] = -(0.408248290463863*GCR[14])+0.408248290463863*GCC[14]+0.3535533905932737*GCR[10]+0.3535533905932737*GCC[10]; 
  surft2_up[7] = -(0.408248290463863*GCR[15])+0.408248290463863*GCC[15]+0.3535533905932737*GCR[13]+0.3535533905932737*GCC[13]; 
