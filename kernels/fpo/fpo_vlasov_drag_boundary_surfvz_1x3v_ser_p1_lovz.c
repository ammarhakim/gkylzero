...
GKYL_CU_DH void fpo_vlasov_drag_boundary_surfvz_1x3v_ser_p1_lovz(const double *dxv, const double* drag_coeff_stencil[9], const double* f_stencil[9], double* out) { 
  ...
  const double* aC = &drag_coeff_stencil[0][80]; 
  const double* aR = &drag_coeff_stencil[1][80]; 
  ...
  alphaDragSurf[0] = -(0.408248290463863*aR[4])+0.408248290463863*aC[4]+0.3535533905932737*aR[0]+0.3535533905932737*aC[0]; 
  alphaDragSurf[1] = -(0.408248290463863*aR[8])+0.408248290463863*aC[8]+0.3535533905932737*aR[1]+0.3535533905932737*aC[1]; 
  alphaDragSurf[2] = -(0.408248290463863*aR[9])+0.408248290463863*aC[9]+0.3535533905932737*aR[2]+0.3535533905932737*aC[2]; 
  alphaDragSurf[3] = -(0.408248290463863*aR[10])+0.408248290463863*aC[10]+0.3535533905932737*aR[3]+0.3535533905932737*aC[3]; 
  alphaDragSurf[4] = -(0.408248290463863*aR[12])+0.408248290463863*aC[12]+0.3535533905932737*aR[5]+0.3535533905932737*aC[5]; 
  alphaDragSurf[5] = -(0.408248290463863*aR[13])+0.408248290463863*aC[13]+0.3535533905932737*aR[6]+0.3535533905932737*aC[6]; 
  alphaDragSurf[6] = -(0.408248290463863*aR[14])+0.408248290463863*aC[14]+0.3535533905932737*aR[7]+0.3535533905932737*aC[7]; 
  alphaDragSurf[7] = -(0.408248290463863*aR[15])+0.408248290463863*aC[15]+0.3535533905932737*aR[11]+0.3535533905932737*aC[11]; 
  ...
  if (-(0.3535533905932737*alphaDragSurf[7])+0.3535533905932737*(alphaDragSurf[6]+alphaDragSurf[5]+alphaDragSurf[4])-0.3535533905932737*(alphaDragSurf[3]+alphaDragSurf[2]+alphaDragSurf[1])+0.3535533905932737*alphaDragSurf[0] > 0) { 
    fUpwindQuad[0] = ser_4x_p1_surfx4_eval_quad_node_0_r(fC); 
  } else { 
    fUpwindQuad[0] = ser_4x_p1_surfx4_eval_quad_node_0_l(fR); 
  } 
  if (0.3535533905932737*alphaDragSurf[7]-0.3535533905932737*(alphaDragSurf[6]+alphaDragSurf[5])+0.3535533905932737*(alphaDragSurf[4]+alphaDragSurf[3])-0.3535533905932737*(alphaDragSurf[2]+alphaDragSurf[1])+0.3535533905932737*alphaDragSurf[0] > 0) { 
    fUpwindQuad[1] = ser_4x_p1_surfx4_eval_quad_node_1_r(fC); 
  } else { 
    fUpwindQuad[1] = ser_4x_p1_surfx4_eval_quad_node_1_l(fR); 
  } 
  if (0.3535533905932737*alphaDragSurf[7]-0.3535533905932737*alphaDragSurf[6]+0.3535533905932737*alphaDragSurf[5]-0.3535533905932737*(alphaDragSurf[4]+alphaDragSurf[3])+0.3535533905932737*alphaDragSurf[2]-0.3535533905932737*alphaDragSurf[1]+0.3535533905932737*alphaDragSurf[0] > 0) { 
    fUpwindQuad[2] = ser_4x_p1_surfx4_eval_quad_node_2_r(fC); 
  } else { 
    fUpwindQuad[2] = ser_4x_p1_surfx4_eval_quad_node_2_l(fR); 
  } 
  if (-(0.3535533905932737*alphaDragSurf[7])+0.3535533905932737*alphaDragSurf[6]-0.3535533905932737*(alphaDragSurf[5]+alphaDragSurf[4])+0.3535533905932737*(alphaDragSurf[3]+alphaDragSurf[2])-0.3535533905932737*alphaDragSurf[1]+0.3535533905932737*alphaDragSurf[0] > 0) { 
    fUpwindQuad[3] = ser_4x_p1_surfx4_eval_quad_node_3_r(fC); 
  } else { 
    fUpwindQuad[3] = ser_4x_p1_surfx4_eval_quad_node_3_l(fR); 
  } 
  if (0.3535533905932737*(alphaDragSurf[7]+alphaDragSurf[6])-0.3535533905932737*(alphaDragSurf[5]+alphaDragSurf[4]+alphaDragSurf[3]+alphaDragSurf[2])+0.3535533905932737*(alphaDragSurf[1]+alphaDragSurf[0]) > 0) { 
    fUpwindQuad[4] = ser_4x_p1_surfx4_eval_quad_node_4_r(fC); 
  } else { 
    fUpwindQuad[4] = ser_4x_p1_surfx4_eval_quad_node_4_l(fR); 
  } 
  if (-(0.3535533905932737*(alphaDragSurf[7]+alphaDragSurf[6]))+0.3535533905932737*alphaDragSurf[5]-0.3535533905932737*alphaDragSurf[4]+0.3535533905932737*alphaDragSurf[3]-0.3535533905932737*alphaDragSurf[2]+0.3535533905932737*(alphaDragSurf[1]+alphaDragSurf[0]) > 0) { 
    fUpwindQuad[5] = ser_4x_p1_surfx4_eval_quad_node_5_r(fC); 
  } else { 
    fUpwindQuad[5] = ser_4x_p1_surfx4_eval_quad_node_5_l(fR); 
  } 
  if (-(0.3535533905932737*(alphaDragSurf[7]+alphaDragSurf[6]+alphaDragSurf[5]))+0.3535533905932737*alphaDragSurf[4]-0.3535533905932737*alphaDragSurf[3]+0.3535533905932737*(alphaDragSurf[2]+alphaDragSurf[1]+alphaDragSurf[0]) > 0) { 
    fUpwindQuad[6] = ser_4x_p1_surfx4_eval_quad_node_6_r(fC); 
  } else { 
    fUpwindQuad[6] = ser_4x_p1_surfx4_eval_quad_node_6_l(fR); 
  } 
  if (0.3535533905932737*(alphaDragSurf[7]+alphaDragSurf[6]+alphaDragSurf[5]+alphaDragSurf[4]+alphaDragSurf[3]+alphaDragSurf[2]+alphaDragSurf[1]+alphaDragSurf[0]) > 0) { 
    fUpwindQuad[7] = ser_4x_p1_surfx4_eval_quad_node_7_r(fC); 
  } else { 
    fUpwindQuad[7] = ser_4x_p1_surfx4_eval_quad_node_7_l(fR); 
  } 
  ...
  out[12] += 0.6123724356957945*Ghat[4]*dv1; 
  out[13] += 0.6123724356957945*Ghat[5]*dv1; 
  out[14] += 0.6123724356957945*Ghat[6]*dv1; 
  out[15] += 0.6123724356957945*Ghat[7]*dv1; 
  out[32] += 0.7905694150420948*Ghat[0]*dv1; 
  out[33] += 0.7905694150420949*Ghat[1]*dv1; 
  out[34] += 0.7905694150420949*Ghat[2]*dv1; 
  out[35] += 0.7905694150420949*Ghat[3]*dv1; 
  out[36] += 0.7905694150420948*Ghat[4]*dv1; 
  out[37] += 0.7905694150420948*Ghat[5]*dv1; 
  out[38] += 0.7905694150420948*Ghat[6]*dv1; 
  out[39] += 0.7905694150420949*Ghat[7]*dv1; 
} 
