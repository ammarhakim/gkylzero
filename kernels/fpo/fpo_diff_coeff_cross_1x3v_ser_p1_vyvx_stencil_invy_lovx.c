...
GKYL_CU_DH void fpo_diff_coeff_cross_1x3v_vyvx_ser_p1_invy_lovx(const double *dxv, const double *gamma, const double* fpo_g_stencil[9], const double* fpo_g_surf_stencil[9], const double* fpo_dgdv_surf, double *diff_coeff) { 
  ...
  surft1_lo[0] = -(0.7071067811865475*GCC[7])+0.7071067811865475*GBC[7]+0.6123724356957944*GCC[2]+0.6123724356957944*GBC[2]; 
  surft1_lo[1] = -(0.7071067811865475*GCC[11])+0.7071067811865475*GBC[11]+0.6123724356957944*GCC[5]+0.6123724356957944*GBC[5]; 
  surft1_lo[3] = -(0.7071067811865475*GCC[14])+0.7071067811865475*GBC[14]+0.6123724356957944*GCC[9]+0.6123724356957944*GBC[9]; 
  surft1_lo[5] = -(0.7071067811865475*GCC[15])+0.7071067811865475*GBC[15]+0.6123724356957944*GCC[12]+0.6123724356957944*GBC[12]; 
