...
GKYL_CU_DH void fpo_diff_coeff_cross_1x3v_vxvy_ser_p2_lovx_upvy(const double *dxv, const double *gamma, const double* fpo_g_stencil[9], const double* fpo_g_surf_stencil[9], const double* fpo_dgdv_surf, double *diff_coeff) { 
  ...
  surft1_lo[0] = 0.599071547271275*GCC[24]+0.599071547271275*GBC[24]-0.8617863895711042*GCC[7]+0.8617863895711042*GBC[7]+0.6123724356957944*GCC[2]+0.6123724356957944*GBC[2]; 
  surft1_lo[1] = 0.599071547271275*GCC[34]+0.599071547271275*GBC[34]-0.8617863895711042*GCC[15]+0.8617863895711042*GBC[15]+0.6123724356957944*GCC[5]+0.6123724356957944*GBC[5]; 
  surft1_lo[2] = -(1.9270129491651047*GCC[22])+1.9270129491651047*GBC[22]+1.369306393762915*GCC[12]+1.369306393762915*GBC[12]; 
  surft1_lo[3] = 0.599071547271275*GCC[40]+0.599071547271275*GBC[40]-0.8617863895711042*GCC[18]+0.8617863895711042*GBC[18]+0.6123724356957944*GCC[9]+0.6123724356957944*GBC[9]; 
  surft1_lo[4] = -(1.927012949165105*GCC[33])+1.927012949165105*GBC[33]+1.369306393762915*GCC[20]+1.369306393762915*GBC[20]; 
  surft1_lo[5] = 0.599071547271275*GCC[46]+0.599071547271275*GBC[46]-0.8617863895711042*GCC[31]+0.8617863895711042*GBC[31]+0.6123724356957944*GCC[16]+0.6123724356957944*GBC[16]; 
  surft1_lo[6] = -(1.927012949165105*GCC[38])+1.927012949165105*GBC[38]+1.369306393762915*GCC[26]+1.369306393762915*GBC[26]; 
  surft1_lo[7] = -(0.8617863895711042*GCC[32])+0.8617863895711042*GBC[32]+0.6123724356957944*GCC[19]+0.6123724356957944*GBC[19]; 
  surft1_lo[9] = -(0.8617863895711042*GCC[43])+0.8617863895711042*GBC[43]+0.6123724356957944*GCC[29]+0.6123724356957944*GBC[29]; 
  surft1_lo[10] = -(1.9270129491651047*GCC[45])+1.9270129491651047*GBC[45]+1.369306393762915*GCC[36]+1.369306393762915*GBC[36]; 
  surft1_lo[13] = -(0.8617863895711042*GCC[44])+0.8617863895711042*GBC[44]+0.6123724356957944*GCC[35]+0.6123724356957944*GBC[35]; 
  surft1_lo[15] = -(0.8617863895711042*GCC[47])+0.8617863895711042*GBC[47]+0.6123724356957944*GCC[41]+0.6123724356957944*GBC[41]; 
  surft1_up[0] = dGdvx_surf_CC_vy[0]/dv1_pvx; 
  surft1_up[1] = dGdvx_surf_CC_vy[1]/dv1_pvx; 
  surft1_up[2] = dGdvx_surf_CC_vy[2]/dv1_pvx; 
  surft1_up[3] = dGdvx_surf_CC_vy[3]/dv1_pvx; 
  surft1_up[4] = dGdvx_surf_CC_vy[4]/dv1_pvx; 
  surft1_up[5] = dGdvx_surf_CC_vy[5]/dv1_pvx; 
  surft1_up[6] = dGdvx_surf_CC_vy[6]/dv1_pvx; 
  surft1_up[7] = dGdvx_surf_CC_vy[7]/dv1_pvx; 
  surft1_up[8] = dGdvx_surf_CC_vy[8]/dv1_pvx; 
  surft1_up[9] = dGdvx_surf_CC_vy[9]/dv1_pvx; 
  surft1_up[10] = dGdvx_surf_CC_vy[10]/dv1_pvx; 
  surft1_up[11] = dGdvx_surf_CC_vy[11]/dv1_pvx; 
  surft1_up[12] = dGdvx_surf_CC_vy[12]/dv1_pvx; 
  surft1_up[13] = dGdvx_surf_CC_vy[13]/dv1_pvx; 
  surft1_up[14] = dGdvx_surf_CC_vy[14]/dv1_pvx; 
  surft1_up[15] = dGdvx_surf_CC_vy[15]/dv1_pvx; 
  surft1_up[16] = dGdvx_surf_CC_vy[16]/dv1_pvx; 
  surft1_up[17] = dGdvx_surf_CC_vy[17]/dv1_pvx; 
  surft1_up[18] = dGdvx_surf_CC_vy[18]/dv1_pvx; 
  surft1_up[19] = dGdvx_surf_CC_vy[19]/dv1_pvx; 
