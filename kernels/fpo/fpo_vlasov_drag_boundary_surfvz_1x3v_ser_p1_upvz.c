...
GKYL_CU_DH void fpo_vlasov_drag_boundary_surfvz_1x3v_ser_p1_upvz(const double *dxv, const double* drag_coeff_stencil[9], const double* f_stencil[9], double* out) { 
  ...
  alphaDragSurf[0] = 0.408248290463863*aL[4]-0.408248290463863*aC[4]+0.3535533905932737*aL[0]+0.3535533905932737*aC[0]; 
  alphaDragSurf[1] = 0.408248290463863*aL[8]-0.408248290463863*aC[8]+0.3535533905932737*aL[1]+0.3535533905932737*aC[1]; 
  alphaDragSurf[2] = 0.408248290463863*aL[9]-0.408248290463863*aC[9]+0.3535533905932737*aL[2]+0.3535533905932737*aC[2]; 
  alphaDragSurf[3] = 0.408248290463863*aL[10]-0.408248290463863*aC[10]+0.3535533905932737*aL[3]+0.3535533905932737*aC[3]; 
  alphaDragSurf[4] = 0.408248290463863*aL[12]-0.408248290463863*aC[12]+0.3535533905932737*aL[5]+0.3535533905932737*aC[5]; 
  alphaDragSurf[5] = 0.408248290463863*aL[13]-0.408248290463863*aC[13]+0.3535533905932737*aL[6]+0.3535533905932737*aC[6]; 
  alphaDragSurf[6] = 0.408248290463863*aL[14]-0.408248290463863*aC[14]+0.3535533905932737*aL[7]+0.3535533905932737*aC[7]; 
  alphaDragSurf[7] = 0.408248290463863*aL[15]-0.408248290463863*aC[15]+0.3535533905932737*aL[11]+0.3535533905932737*aC[11]; 
  ...
  if (-(0.3535533905932737*alphaDragSurf[7])+0.3535533905932737*(alphaDragSurf[6]+alphaDragSurf[5]+alphaDragSurf[4])-0.3535533905932737*(alphaDragSurf[3]+alphaDragSurf[2]+alphaDragSurf[1])+0.3535533905932737*alphaDragSurf[0] > 0) { 
    fUpwindQuad[0] = ser_4x_p1_surfx4_eval_quad_node_0_r(fL); 
  } else { 
    fUpwindQuad[0] = ser_4x_p1_surfx4_eval_quad_node_0_l(fC); 
  } 
  if (0.3535533905932737*alphaDragSurf[7]-0.3535533905932737*(alphaDragSurf[6]+alphaDragSurf[5])+0.3535533905932737*(alphaDragSurf[4]+alphaDragSurf[3])-0.3535533905932737*(alphaDragSurf[2]+alphaDragSurf[1])+0.3535533905932737*alphaDragSurf[0] > 0) { 
    fUpwindQuad[1] = ser_4x_p1_surfx4_eval_quad_node_1_r(fL); 
  } else { 
    fUpwindQuad[1] = ser_4x_p1_surfx4_eval_quad_node_1_l(fC); 
  } 
  if (0.3535533905932737*alphaDragSurf[7]-0.3535533905932737*alphaDragSurf[6]+0.3535533905932737*alphaDragSurf[5]-0.3535533905932737*(alphaDragSurf[4]+alphaDragSurf[3])+0.3535533905932737*alphaDragSurf[2]-0.3535533905932737*alphaDragSurf[1]+0.3535533905932737*alphaDragSurf[0] > 0) { 
    fUpwindQuad[2] = ser_4x_p1_surfx4_eval_quad_node_2_r(fL); 
  } else { 
    fUpwindQuad[2] = ser_4x_p1_surfx4_eval_quad_node_2_l(fC); 
  } 
  if (-(0.3535533905932737*alphaDragSurf[7])+0.3535533905932737*alphaDragSurf[6]-0.3535533905932737*(alphaDragSurf[5]+alphaDragSurf[4])+0.3535533905932737*(alphaDragSurf[3]+alphaDragSurf[2])-0.3535533905932737*alphaDragSurf[1]+0.3535533905932737*alphaDragSurf[0] > 0) { 
    fUpwindQuad[3] = ser_4x_p1_surfx4_eval_quad_node_3_r(fL); 
  } else { 
    fUpwindQuad[3] = ser_4x_p1_surfx4_eval_quad_node_3_l(fC); 
  } 
  if (0.3535533905932737*(alphaDragSurf[7]+alphaDragSurf[6])-0.3535533905932737*(alphaDragSurf[5]+alphaDragSurf[4]+alphaDragSurf[3]+alphaDragSurf[2])+0.3535533905932737*(alphaDragSurf[1]+alphaDragSurf[0]) > 0) { 
    fUpwindQuad[4] = ser_4x_p1_surfx4_eval_quad_node_4_r(fL); 
  } else { 
    fUpwindQuad[4] = ser_4x_p1_surfx4_eval_quad_node_4_l(fC); 
  } 
  if (-(0.3535533905932737*(alphaDragSurf[7]+alphaDragSurf[6]))+0.3535533905932737*alphaDragSurf[5]-0.3535533905932737*alphaDragSurf[4]+0.3535533905932737*alphaDragSurf[3]-0.3535533905932737*alphaDragSurf[2]+0.3535533905932737*(alphaDragSurf[1]+alphaDragSurf[0]) > 0) { 
    fUpwindQuad[5] = ser_4x_p1_surfx4_eval_quad_node_5_r(fL); 
  } else { 
    fUpwindQuad[5] = ser_4x_p1_surfx4_eval_quad_node_5_l(fC); 
  } 
  if (-(0.3535533905932737*(alphaDragSurf[7]+alphaDragSurf[6]+alphaDragSurf[5]))+0.3535533905932737*alphaDragSurf[4]-0.3535533905932737*alphaDragSurf[3]+0.3535533905932737*(alphaDragSurf[2]+alphaDragSurf[1]+alphaDragSurf[0]) > 0) { 
    fUpwindQuad[6] = ser_4x_p1_surfx4_eval_quad_node_6_r(fL); 
  } else { 
    fUpwindQuad[6] = ser_4x_p1_surfx4_eval_quad_node_6_l(fC); 
  } 
  if (0.3535533905932737*(alphaDragSurf[7]+alphaDragSurf[6]+alphaDragSurf[5]+alphaDragSurf[4]+alphaDragSurf[3]+alphaDragSurf[2]+alphaDragSurf[1]+alphaDragSurf[0]) > 0) { 
    fUpwindQuad[7] = ser_4x_p1_surfx4_eval_quad_node_7_r(fL); 
  } else { 
    fUpwindQuad[7] = ser_4x_p1_surfx4_eval_quad_node_7_l(fC); 
  } 
