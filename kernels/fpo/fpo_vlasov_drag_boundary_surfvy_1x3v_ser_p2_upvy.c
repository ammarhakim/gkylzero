...
GKYL_CU_DH void fpo_vlasov_drag_boundary_surfvy_1x3v_ser_p2_upvy(const double *dxv, const double* drag_coeff_stencil[9], const double* f_stencil[9], double* out) { 
  ...
  const double* aL = &drag_coeff_stencil[0][48]; 
  const double* aC = &drag_coeff_stencil[1][48]; 
  ...
  alphaDragSurf[0] = 0.34587411908091625*aL[13]+0.34587411908091625*aC[13]+0.49755260400283263*aL[3]-0.49755260400283263*aC[3]+0.3535533905932737*aL[0]+0.3535533905932737*aC[0]; 
  alphaDragSurf[1] = 0.34587411908091625*aL[23]+0.34587411908091625*aC[23]+0.49755260400283263*aL[6]-0.49755260400283263*aC[6]+0.3535533905932737*aL[1]+0.3535533905932737*aC[1]; 
  alphaDragSurf[2] = 0.34587411908091625*aL[24]+0.34587411908091625*aC[24]+0.49755260400283263*aL[7]-0.49755260400283263*aC[7]+0.3535533905932737*aL[2]+0.3535533905932737*aC[2]; 
  alphaDragSurf[3] = 0.34587411908091625*aL[27]+0.34587411908091625*aC[27]+0.49755260400283263*aL[10]-0.49755260400283263*aC[10]+0.3535533905932737*aL[4]+0.3535533905932737*aC[4]; 
  alphaDragSurf[4] = 0.34587411908091625*aL[34]+0.34587411908091625*aC[34]+0.49755260400283263*aL[15]-0.49755260400283263*aC[15]+0.3535533905932737*aL[5]+0.3535533905932737*aC[5]; 
  alphaDragSurf[5] = 0.34587411908091625*aL[39]+0.34587411908091625*aC[39]+0.49755260400283263*aL[17]-0.49755260400283263*aC[17]+0.3535533905932737*aL[8]+0.3535533905932737*aC[8]; 
  alphaDragSurf[6] = 0.34587411908091625*aL[40]+0.34587411908091625*aC[40]+0.49755260400283263*aL[18]-0.49755260400283263*aC[18]+0.3535533905932737*aL[9]+0.3535533905932737*aC[9]; 
  alphaDragSurf[7] = 0.49755260400283263*aL[21]-0.49755260400283263*aC[21]+0.3535533905932737*aL[11]+0.3535533905932737*aC[11]; 
  alphaDragSurf[8] = 0.49755260400283263*aL[22]-0.49755260400283263*aC[22]+0.3535533905932737*aL[12]+0.3535533905932737*aC[12]; 
  alphaDragSurf[9] = 0.49755260400283263*aL[30]-0.49755260400283263*aC[30]+0.3535533905932737*aL[14]+0.3535533905932737*aC[14]; 
  alphaDragSurf[10] = 0.34587411908091625*aL[46]+0.34587411908091625*aC[46]+0.49755260400283263*aL[31]-0.49755260400283263*aC[31]+0.3535533905932737*aL[16]+0.3535533905932737*aC[16]; 
  alphaDragSurf[11] = 0.49755260400283263*aL[32]-0.49755260400283263*aC[32]+0.3535533905932737*aL[19]+0.3535533905932737*aC[19]; 
  alphaDragSurf[12] = 0.49755260400283263*aL[33]-0.49755260400283263*aC[33]+0.3535533905932737*aL[20]+0.3535533905932737*aC[20]; 
  alphaDragSurf[13] = 0.49755260400283263*aL[37]-0.49755260400283263*aC[37]+0.3535533905932737*aL[25]+0.3535533905932737*aC[25]; 
  alphaDragSurf[14] = 0.49755260400283263*aL[38]-0.49755260400283263*aC[38]+0.3535533905932737*aL[26]+0.3535533905932737*aC[26]; 
  alphaDragSurf[15] = 0.49755260400283263*aL[42]-0.49755260400283263*aC[42]+0.3535533905932737*aL[28]+0.3535533905932737*aC[28]; 
  alphaDragSurf[16] = 0.49755260400283263*aL[43]-0.49755260400283263*aC[43]+0.3535533905932737*aL[29]+0.3535533905932737*aC[29]; 
  alphaDragSurf[17] = 0.49755260400283263*aL[44]-0.49755260400283263*aC[44]+0.3535533905932737*aL[35]+0.3535533905932737*aC[35]; 
  alphaDragSurf[18] = 0.49755260400283263*aL[45]-0.49755260400283263*aC[45]+0.3535533905932737*aL[36]+0.3535533905932737*aC[36]; 
  alphaDragSurf[19] = 0.49755260400283263*aL[47]-0.49755260400283263*aC[47]+0.3535533905932737*aL[41]+0.3535533905932737*aC[41]; 
  ...
  if (0.5692099788303082*(alphaDragSurf[19]+alphaDragSurf[18]+alphaDragSurf[17])-0.42426406871192807*(alphaDragSurf[16]+alphaDragSurf[15])-0.42426406871192845*(alphaDragSurf[14]+alphaDragSurf[13])-0.42426406871192807*alphaDragSurf[12]-0.42426406871192845*alphaDragSurf[11]-0.853814968245462*alphaDragSurf[10]+0.3162277660168379*(alphaDragSurf[9]+alphaDragSurf[8]+alphaDragSurf[7])+0.6363961030678926*(alphaDragSurf[6]+alphaDragSurf[5]+alphaDragSurf[4])-0.4743416490252568*(alphaDragSurf[3]+alphaDragSurf[2]+alphaDragSurf[1])+0.3535533905932737*alphaDragSurf[0] > 0) { 
    fUpwindQuad[0] = ser_4x_p2_surfx3_eval_quad_node_0_r(fL); 
  } else { 
    fUpwindQuad[0] = ser_4x_p2_surfx3_eval_quad_node_0_l(fC); 
  } 
  if (-(0.711512473537885*alphaDragSurf[19])+0.5303300858899104*(alphaDragSurf[16]+alphaDragSurf[15])-0.42426406871192807*alphaDragSurf[12]-0.42426406871192845*alphaDragSurf[11]-0.3952847075210473*alphaDragSurf[9]+0.3162277660168379*(alphaDragSurf[8]+alphaDragSurf[7])+0.6363961030678926*alphaDragSurf[4]-0.4743416490252568*(alphaDragSurf[2]+alphaDragSurf[1])+0.3535533905932737*alphaDragSurf[0] > 0) { 
    fUpwindQuad[1] = ser_4x_p2_surfx3_eval_quad_node_1_r(fL); 
  } else { 
    fUpwindQuad[1] = ser_4x_p2_surfx3_eval_quad_node_1_l(fC); 
  } 
  if (0.5692099788303082*alphaDragSurf[19]-0.5692099788303082*(alphaDragSurf[18]+alphaDragSurf[17])-0.42426406871192807*(alphaDragSurf[16]+alphaDragSurf[15])+0.42426406871192845*(alphaDragSurf[14]+alphaDragSurf[13])-0.42426406871192807*alphaDragSurf[12]-0.42426406871192845*alphaDragSurf[11]+0.853814968245462*alphaDragSurf[10]+0.3162277660168379*(alphaDragSurf[9]+alphaDragSurf[8]+alphaDragSurf[7])-0.6363961030678926*(alphaDragSurf[6]+alphaDragSurf[5])+0.6363961030678926*alphaDragSurf[4]+0.4743416490252568*alphaDragSurf[3]-0.4743416490252568*(alphaDragSurf[2]+alphaDragSurf[1])+0.3535533905932737*alphaDragSurf[0] > 0) { 
    fUpwindQuad[2] = ser_4x_p2_surfx3_eval_quad_node_2_r(fL); 
  } else { 
    fUpwindQuad[2] = ser_4x_p2_surfx3_eval_quad_node_2_l(fC); 
  } 
  if (-(0.711512473537885*alphaDragSurf[18])-0.42426406871192807*alphaDragSurf[15]+0.5303300858899104*alphaDragSurf[14]-0.42426406871192845*alphaDragSurf[13]+0.5303300858899104*alphaDragSurf[12]+0.3162277660168379*alphaDragSurf[9]-0.3952847075210473*alphaDragSurf[8]+0.3162277660168379*alphaDragSurf[7]+0.6363961030678926*alphaDragSurf[5]-0.4743416490252568*(alphaDragSurf[3]+alphaDragSurf[1])+0.3535533905932737*alphaDragSurf[0] > 0) { 
    fUpwindQuad[3] = ser_4x_p2_surfx3_eval_quad_node_3_r(fL); 
  } else { 
    fUpwindQuad[3] = ser_4x_p2_surfx3_eval_quad_node_3_l(fC); 
  } 
  if (0.5303300858899104*(alphaDragSurf[15]+alphaDragSurf[12])-0.3952847075210473*(alphaDragSurf[9]+alphaDragSurf[8])+0.3162277660168379*alphaDragSurf[7]-0.4743416490252568*alphaDragSurf[1]+0.3535533905932737*alphaDragSurf[0] > 0) { 
    fUpwindQuad[4] = ser_4x_p2_surfx3_eval_quad_node_4_r(fL); 
  } else { 
    fUpwindQuad[4] = ser_4x_p2_surfx3_eval_quad_node_4_l(fC); 
  } 
  if (0.711512473537885*alphaDragSurf[18]-0.42426406871192807*alphaDragSurf[15]-0.5303300858899104*alphaDragSurf[14]+0.42426406871192845*alphaDragSurf[13]+0.5303300858899104*alphaDragSurf[12]+0.3162277660168379*alphaDragSurf[9]-0.3952847075210473*alphaDragSurf[8]+0.3162277660168379*alphaDragSurf[7]-0.6363961030678926*alphaDragSurf[5]+0.4743416490252568*alphaDragSurf[3]-0.4743416490252568*alphaDragSurf[1]+0.3535533905932737*alphaDragSurf[0] > 0) { 
    fUpwindQuad[5] = ser_4x_p2_surfx3_eval_quad_node_5_r(fL); 
  } else { 
    fUpwindQuad[5] = ser_4x_p2_surfx3_eval_quad_node_5_l(fC); 
  } 
  if (-(0.5692099788303082*alphaDragSurf[19])+0.5692099788303082*alphaDragSurf[18]-0.5692099788303082*alphaDragSurf[17]+0.42426406871192807*alphaDragSurf[16]-0.42426406871192807*alphaDragSurf[15]-0.42426406871192845*(alphaDragSurf[14]+alphaDragSurf[13])-0.42426406871192807*alphaDragSurf[12]+0.42426406871192845*alphaDragSurf[11]+0.853814968245462*alphaDragSurf[10]+0.3162277660168379*(alphaDragSurf[9]+alphaDragSurf[8]+alphaDragSurf[7])-0.6363961030678926*alphaDragSurf[6]+0.6363961030678926*alphaDragSurf[5]-0.6363961030678926*alphaDragSurf[4]-0.4743416490252568*alphaDragSurf[3]+0.4743416490252568*alphaDragSurf[2]-0.4743416490252568*alphaDragSurf[1]+0.3535533905932737*alphaDragSurf[0] > 0) { 
    fUpwindQuad[6] = ser_4x_p2_surfx3_eval_quad_node_6_r(fL); 
  } else { 
    fUpwindQuad[6] = ser_4x_p2_surfx3_eval_quad_node_6_l(fC); 
  } 
  if (0.711512473537885*alphaDragSurf[19]-0.5303300858899104*alphaDragSurf[16]+0.5303300858899104*alphaDragSurf[15]-0.42426406871192807*alphaDragSurf[12]+0.42426406871192845*alphaDragSurf[11]-0.3952847075210473*alphaDragSurf[9]+0.3162277660168379*(alphaDragSurf[8]+alphaDragSurf[7])-0.6363961030678926*alphaDragSurf[4]+0.4743416490252568*alphaDragSurf[2]-0.4743416490252568*alphaDragSurf[1]+0.3535533905932737*alphaDragSurf[0] > 0) { 
    fUpwindQuad[7] = ser_4x_p2_surfx3_eval_quad_node_7_r(fL); 
  } else { 
    fUpwindQuad[7] = ser_4x_p2_surfx3_eval_quad_node_7_l(fC); 
  } 
  if (-(0.5692099788303082*(alphaDragSurf[19]+alphaDragSurf[18]))+0.5692099788303082*alphaDragSurf[17]+0.42426406871192807*alphaDragSurf[16]-0.42426406871192807*alphaDragSurf[15]+0.42426406871192845*(alphaDragSurf[14]+alphaDragSurf[13])-0.42426406871192807*alphaDragSurf[12]+0.42426406871192845*alphaDragSurf[11]-0.853814968245462*alphaDragSurf[10]+0.3162277660168379*(alphaDragSurf[9]+alphaDragSurf[8]+alphaDragSurf[7])+0.6363961030678926*alphaDragSurf[6]-0.6363961030678926*(alphaDragSurf[5]+alphaDragSurf[4])+0.4743416490252568*(alphaDragSurf[3]+alphaDragSurf[2])-0.4743416490252568*alphaDragSurf[1]+0.3535533905932737*alphaDragSurf[0] > 0) { 
    fUpwindQuad[8] = ser_4x_p2_surfx3_eval_quad_node_8_r(fL); 
  } else { 
    fUpwindQuad[8] = ser_4x_p2_surfx3_eval_quad_node_8_l(fC); 
  } 
  if (-(0.711512473537885*alphaDragSurf[17])-0.42426406871192807*alphaDragSurf[16]-0.42426406871192845*alphaDragSurf[14]+0.5303300858899104*(alphaDragSurf[13]+alphaDragSurf[11])+0.3162277660168379*(alphaDragSurf[9]+alphaDragSurf[8])-0.3952847075210473*alphaDragSurf[7]+0.6363961030678926*alphaDragSurf[6]-0.4743416490252568*(alphaDragSurf[3]+alphaDragSurf[2])+0.3535533905932737*alphaDragSurf[0] > 0) { 
    fUpwindQuad[9] = ser_4x_p2_surfx3_eval_quad_node_9_r(fL); 
  } else { 
    fUpwindQuad[9] = ser_4x_p2_surfx3_eval_quad_node_9_l(fC); 
  } 
  if (0.5303300858899104*(alphaDragSurf[16]+alphaDragSurf[11])-0.3952847075210473*alphaDragSurf[9]+0.3162277660168379*alphaDragSurf[8]-0.3952847075210473*alphaDragSurf[7]-0.4743416490252568*alphaDragSurf[2]+0.3535533905932737*alphaDragSurf[0] > 0) { 
    fUpwindQuad[10] = ser_4x_p2_surfx3_eval_quad_node_10_r(fL); 
  } else { 
    fUpwindQuad[10] = ser_4x_p2_surfx3_eval_quad_node_10_l(fC); 
  } 
  if (0.711512473537885*alphaDragSurf[17]-0.42426406871192807*alphaDragSurf[16]+0.42426406871192845*alphaDragSurf[14]-0.5303300858899104*alphaDragSurf[13]+0.5303300858899104*alphaDragSurf[11]+0.3162277660168379*(alphaDragSurf[9]+alphaDragSurf[8])-0.3952847075210473*alphaDragSurf[7]-0.6363961030678926*alphaDragSurf[6]+0.4743416490252568*alphaDragSurf[3]-0.4743416490252568*alphaDragSurf[2]+0.3535533905932737*alphaDragSurf[0] > 0) { 
    fUpwindQuad[11] = ser_4x_p2_surfx3_eval_quad_node_11_r(fL); 
  } else { 
    fUpwindQuad[11] = ser_4x_p2_surfx3_eval_quad_node_11_l(fC); 
  } 
  if (0.5303300858899104*(alphaDragSurf[14]+alphaDragSurf[13])+0.3162277660168379*alphaDragSurf[9]-0.3952847075210473*(alphaDragSurf[8]+alphaDragSurf[7])-0.4743416490252568*alphaDragSurf[3]+0.3535533905932737*alphaDragSurf[0] > 0) { 
    fUpwindQuad[12] = ser_4x_p2_surfx3_eval_quad_node_12_r(fL); 
  } else { 
    fUpwindQuad[12] = ser_4x_p2_surfx3_eval_quad_node_12_l(fC); 
  } 
  if (0.3535533905932737*alphaDragSurf[0]-0.3952847075210473*(alphaDragSurf[9]+alphaDragSurf[8]+alphaDragSurf[7]) > 0) { 
    fUpwindQuad[13] = ser_4x_p2_surfx3_eval_quad_node_13_r(fL); 
  } else { 
    fUpwindQuad[13] = ser_4x_p2_surfx3_eval_quad_node_13_l(fC); 
  } 
  if (-(0.5303300858899104*(alphaDragSurf[14]+alphaDragSurf[13]))+0.3162277660168379*alphaDragSurf[9]-0.3952847075210473*(alphaDragSurf[8]+alphaDragSurf[7])+0.4743416490252568*alphaDragSurf[3]+0.3535533905932737*alphaDragSurf[0] > 0) { 
    fUpwindQuad[14] = ser_4x_p2_surfx3_eval_quad_node_14_r(fL); 
  } else { 
    fUpwindQuad[14] = ser_4x_p2_surfx3_eval_quad_node_14_l(fC); 
  } 
  if (0.711512473537885*alphaDragSurf[17]+0.42426406871192807*alphaDragSurf[16]-0.42426406871192845*alphaDragSurf[14]+0.5303300858899104*alphaDragSurf[13]-0.5303300858899104*alphaDragSurf[11]+0.3162277660168379*(alphaDragSurf[9]+alphaDragSurf[8])-0.3952847075210473*alphaDragSurf[7]-0.6363961030678926*alphaDragSurf[6]-0.4743416490252568*alphaDragSurf[3]+0.4743416490252568*alphaDragSurf[2]+0.3535533905932737*alphaDragSurf[0] > 0) { 
    fUpwindQuad[15] = ser_4x_p2_surfx3_eval_quad_node_15_r(fL); 
  } else { 
    fUpwindQuad[15] = ser_4x_p2_surfx3_eval_quad_node_15_l(fC); 
  } 
  if (-(0.5303300858899104*(alphaDragSurf[16]+alphaDragSurf[11]))-0.3952847075210473*alphaDragSurf[9]+0.3162277660168379*alphaDragSurf[8]-0.3952847075210473*alphaDragSurf[7]+0.4743416490252568*alphaDragSurf[2]+0.3535533905932737*alphaDragSurf[0] > 0) { 
    fUpwindQuad[16] = ser_4x_p2_surfx3_eval_quad_node_16_r(fL); 
  } else { 
    fUpwindQuad[16] = ser_4x_p2_surfx3_eval_quad_node_16_l(fC); 
  } 
  if (-(0.711512473537885*alphaDragSurf[17])+0.42426406871192807*alphaDragSurf[16]+0.42426406871192845*alphaDragSurf[14]-0.5303300858899104*(alphaDragSurf[13]+alphaDragSurf[11])+0.3162277660168379*(alphaDragSurf[9]+alphaDragSurf[8])-0.3952847075210473*alphaDragSurf[7]+0.6363961030678926*alphaDragSurf[6]+0.4743416490252568*(alphaDragSurf[3]+alphaDragSurf[2])+0.3535533905932737*alphaDragSurf[0] > 0) { 
    fUpwindQuad[17] = ser_4x_p2_surfx3_eval_quad_node_17_r(fL); 
  } else { 
    fUpwindQuad[17] = ser_4x_p2_surfx3_eval_quad_node_17_l(fC); 
  } 
  if (-(0.5692099788303082*(alphaDragSurf[19]+alphaDragSurf[18]))+0.5692099788303082*alphaDragSurf[17]-0.42426406871192807*alphaDragSurf[16]+0.42426406871192807*alphaDragSurf[15]-0.42426406871192845*(alphaDragSurf[14]+alphaDragSurf[13])+0.42426406871192807*alphaDragSurf[12]-0.42426406871192845*alphaDragSurf[11]+0.853814968245462*alphaDragSurf[10]+0.3162277660168379*(alphaDragSurf[9]+alphaDragSurf[8]+alphaDragSurf[7])+0.6363961030678926*alphaDragSurf[6]-0.6363961030678926*(alphaDragSurf[5]+alphaDragSurf[4])-0.4743416490252568*(alphaDragSurf[3]+alphaDragSurf[2])+0.4743416490252568*alphaDragSurf[1]+0.3535533905932737*alphaDragSurf[0] > 0) { 
    fUpwindQuad[18] = ser_4x_p2_surfx3_eval_quad_node_18_r(fL); 
  } else { 
    fUpwindQuad[18] = ser_4x_p2_surfx3_eval_quad_node_18_l(fC); 
  } 
  if (0.711512473537885*alphaDragSurf[19]+0.5303300858899104*alphaDragSurf[16]-0.5303300858899104*alphaDragSurf[15]+0.42426406871192807*alphaDragSurf[12]-0.42426406871192845*alphaDragSurf[11]-0.3952847075210473*alphaDragSurf[9]+0.3162277660168379*(alphaDragSurf[8]+alphaDragSurf[7])-0.6363961030678926*alphaDragSurf[4]-0.4743416490252568*alphaDragSurf[2]+0.4743416490252568*alphaDragSurf[1]+0.3535533905932737*alphaDragSurf[0] > 0) { 
    fUpwindQuad[19] = ser_4x_p2_surfx3_eval_quad_node_19_r(fL); 
  } else { 
    fUpwindQuad[19] = ser_4x_p2_surfx3_eval_quad_node_19_l(fC); 
  } 
  if (-(0.5692099788303082*alphaDragSurf[19])+0.5692099788303082*alphaDragSurf[18]-0.5692099788303082*alphaDragSurf[17]-0.42426406871192807*alphaDragSurf[16]+0.42426406871192807*alphaDragSurf[15]+0.42426406871192845*(alphaDragSurf[14]+alphaDragSurf[13])+0.42426406871192807*alphaDragSurf[12]-0.42426406871192845*alphaDragSurf[11]-0.853814968245462*alphaDragSurf[10]+0.3162277660168379*(alphaDragSurf[9]+alphaDragSurf[8]+alphaDragSurf[7])-0.6363961030678926*alphaDragSurf[6]+0.6363961030678926*alphaDragSurf[5]-0.6363961030678926*alphaDragSurf[4]+0.4743416490252568*alphaDragSurf[3]-0.4743416490252568*alphaDragSurf[2]+0.4743416490252568*alphaDragSurf[1]+0.3535533905932737*alphaDragSurf[0] > 0) { 
    fUpwindQuad[20] = ser_4x_p2_surfx3_eval_quad_node_20_r(fL); 
  } else { 
    fUpwindQuad[20] = ser_4x_p2_surfx3_eval_quad_node_20_l(fC); 
  } 
  if (0.711512473537885*alphaDragSurf[18]+0.42426406871192807*alphaDragSurf[15]+0.5303300858899104*alphaDragSurf[14]-0.42426406871192845*alphaDragSurf[13]-0.5303300858899104*alphaDragSurf[12]+0.3162277660168379*alphaDragSurf[9]-0.3952847075210473*alphaDragSurf[8]+0.3162277660168379*alphaDragSurf[7]-0.6363961030678926*alphaDragSurf[5]-0.4743416490252568*alphaDragSurf[3]+0.4743416490252568*alphaDragSurf[1]+0.3535533905932737*alphaDragSurf[0] > 0) { 
    fUpwindQuad[21] = ser_4x_p2_surfx3_eval_quad_node_21_r(fL); 
  } else { 
    fUpwindQuad[21] = ser_4x_p2_surfx3_eval_quad_node_21_l(fC); 
  } 
  if (-(0.5303300858899104*(alphaDragSurf[15]+alphaDragSurf[12]))-0.3952847075210473*(alphaDragSurf[9]+alphaDragSurf[8])+0.3162277660168379*alphaDragSurf[7]+0.4743416490252568*alphaDragSurf[1]+0.3535533905932737*alphaDragSurf[0] > 0) { 
    fUpwindQuad[22] = ser_4x_p2_surfx3_eval_quad_node_22_r(fL); 
  } else { 
    fUpwindQuad[22] = ser_4x_p2_surfx3_eval_quad_node_22_l(fC); 
  } 
  if (-(0.711512473537885*alphaDragSurf[18])+0.42426406871192807*alphaDragSurf[15]-0.5303300858899104*alphaDragSurf[14]+0.42426406871192845*alphaDragSurf[13]-0.5303300858899104*alphaDragSurf[12]+0.3162277660168379*alphaDragSurf[9]-0.3952847075210473*alphaDragSurf[8]+0.3162277660168379*alphaDragSurf[7]+0.6363961030678926*alphaDragSurf[5]+0.4743416490252568*(alphaDragSurf[3]+alphaDragSurf[1])+0.3535533905932737*alphaDragSurf[0] > 0) { 
    fUpwindQuad[23] = ser_4x_p2_surfx3_eval_quad_node_23_r(fL); 
  } else { 
    fUpwindQuad[23] = ser_4x_p2_surfx3_eval_quad_node_23_l(fC); 
  } 
  if (0.5692099788303082*alphaDragSurf[19]-0.5692099788303082*(alphaDragSurf[18]+alphaDragSurf[17])+0.42426406871192807*(alphaDragSurf[16]+alphaDragSurf[15])-0.42426406871192845*(alphaDragSurf[14]+alphaDragSurf[13])+0.42426406871192807*alphaDragSurf[12]+0.42426406871192845*alphaDragSurf[11]-0.853814968245462*alphaDragSurf[10]+0.3162277660168379*(alphaDragSurf[9]+alphaDragSurf[8]+alphaDragSurf[7])-0.6363961030678926*(alphaDragSurf[6]+alphaDragSurf[5])+0.6363961030678926*alphaDragSurf[4]-0.4743416490252568*alphaDragSurf[3]+0.4743416490252568*(alphaDragSurf[2]+alphaDragSurf[1])+0.3535533905932737*alphaDragSurf[0] > 0) { 
    fUpwindQuad[24] = ser_4x_p2_surfx3_eval_quad_node_24_r(fL); 
  } else { 
    fUpwindQuad[24] = ser_4x_p2_surfx3_eval_quad_node_24_l(fC); 
  } 
  if (-(0.711512473537885*alphaDragSurf[19])-0.5303300858899104*(alphaDragSurf[16]+alphaDragSurf[15])+0.42426406871192807*alphaDragSurf[12]+0.42426406871192845*alphaDragSurf[11]-0.3952847075210473*alphaDragSurf[9]+0.3162277660168379*(alphaDragSurf[8]+alphaDragSurf[7])+0.6363961030678926*alphaDragSurf[4]+0.4743416490252568*(alphaDragSurf[2]+alphaDragSurf[1])+0.3535533905932737*alphaDragSurf[0] > 0) { 
    fUpwindQuad[25] = ser_4x_p2_surfx3_eval_quad_node_25_r(fL); 
  } else { 
    fUpwindQuad[25] = ser_4x_p2_surfx3_eval_quad_node_25_l(fC); 
  } 
  if (0.5692099788303082*(alphaDragSurf[19]+alphaDragSurf[18]+alphaDragSurf[17])+0.42426406871192807*(alphaDragSurf[16]+alphaDragSurf[15])+0.42426406871192845*(alphaDragSurf[14]+alphaDragSurf[13])+0.42426406871192807*alphaDragSurf[12]+0.42426406871192845*alphaDragSurf[11]+0.853814968245462*alphaDragSurf[10]+0.3162277660168379*(alphaDragSurf[9]+alphaDragSurf[8]+alphaDragSurf[7])+0.6363961030678926*(alphaDragSurf[6]+alphaDragSurf[5]+alphaDragSurf[4])+0.4743416490252568*(alphaDragSurf[3]+alphaDragSurf[2]+alphaDragSurf[1])+0.3535533905932737*alphaDragSurf[0] > 0) { 
    fUpwindQuad[26] = ser_4x_p2_surfx3_eval_quad_node_26_r(fL); 
  } else { 
    fUpwindQuad[26] = ser_4x_p2_surfx3_eval_quad_node_26_l(fC); 
  } 
  ...
  out[13] += -(0.7905694150420948*Ghat[0]*dv1); 
  out[14] += -(0.35355339059327373*Ghat[9]*dv1); 
  out[15] += 0.6123724356957945*Ghat[4]*dv1; 
  out[16] += -(0.35355339059327373*Ghat[10]*dv1); 
  ...
  out[21] += 0.6123724356957945*Ghat[7]*dv1; 
  out[22] += 0.6123724356957945*Ghat[8]*dv1; 
  out[23] += -(0.7905694150420949*Ghat[1]*dv1); 
  out[24] += -(0.7905694150420949*Ghat[2]*dv1); 
  out[25] += -(0.35355339059327373*Ghat[13]*dv1); 
  out[26] += -(0.35355339059327373*Ghat[14]*dv1); 
  out[27] += -(0.7905694150420949*Ghat[3]*dv1); 
  out[28] += -(0.35355339059327373*Ghat[15]*dv1); 
  out[29] += -(0.35355339059327373*Ghat[16]*dv1); 
  out[30] += 0.6123724356957945*Ghat[9]*dv1; 
  out[31] += 0.6123724356957945*Ghat[10]*dv1; 
  out[32] += 0.6123724356957945*Ghat[11]*dv1; 
  out[33] += 0.6123724356957945*Ghat[12]*dv1; 
  out[34] += -(0.7905694150420948*Ghat[4]*dv1); 
  out[35] += -(0.35355339059327373*Ghat[17]*dv1); 
  out[36] += -(0.35355339059327373*Ghat[18]*dv1); 
  out[37] += 0.6123724356957945*Ghat[13]*dv1; 
  out[38] += 0.6123724356957945*Ghat[14]*dv1; 
  out[39] += -(0.7905694150420948*Ghat[5]*dv1); 
  out[40] += -(0.7905694150420948*Ghat[6]*dv1); 
  out[41] += -(0.35355339059327373*Ghat[19]*dv1); 
  out[42] += 0.6123724356957945*Ghat[15]*dv1; 
  out[43] += 0.6123724356957945*Ghat[16]*dv1; 
  out[44] += 0.6123724356957945*Ghat[17]*dv1; 
  out[45] += 0.6123724356957945*Ghat[18]*dv1; 
  out[46] += -(0.7905694150420949*Ghat[10]*dv1); 
