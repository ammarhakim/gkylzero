...
GKYL_CU_DH void fpo_diff_coeff_cross_1x3v_vzvy_ser_p1_upvz_upvy(const double *dxv, const double *gamma, const double* fpo_g_stencil[9], const double* fpo_g_surf_stencil[9], const double* fpo_dgdv_surf, double *diff_coeff) { 
  ...
  const double* G_surf_CC_vz = &fpo_g_surf_stencil[3][16]; 
  const double* dGdvz_surf_CC_vy = &fpo_dgdv_surf[40]; 

  surft1_lo[0] = 0.7071067811865475*GCL[10]-0.7071067811865475*GCC[10]+0.6123724356957944*GCL[4]+0.6123724356957944*GCC[4]; 
  surft1_lo[1] = 0.7071067811865475*GCL[13]-0.7071067811865475*GCC[13]+0.6123724356957944*GCL[8]+0.6123724356957944*GCC[8]; 
  surft1_lo[2] = 0.7071067811865475*GCL[14]-0.7071067811865475*GCC[14]+0.6123724356957944*GCL[9]+0.6123724356957944*GCC[9]; 
  surft1_lo[4] = 0.7071067811865475*GCL[15]-0.7071067811865475*GCC[15]+0.6123724356957944*GCL[12]+0.6123724356957944*GCC[12]; 
