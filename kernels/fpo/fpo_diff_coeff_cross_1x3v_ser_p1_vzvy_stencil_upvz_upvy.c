...
GKYL_CU_DH void fpo_diff_coeff_cross_1x3v_vzvy_ser_p1_upvz_upvy(const double *dxv, const double *gamma, const double* fpo_g_stencil[9], const double* fpo_g_surf_stencil[9], const double* fpo_dgdv_surf, double *diff_coeff) { 
  ...
  surft1_lo[1] = 0.599071547271275*GCL[29]+0.599071547271275*GCC[29]+0.8617863895711042*GCL[13]-0.8617863895711042*GCC[13]+0.6123724356957944*GCL[8]+0.6123724356957944*GCC[8]; 
  surft1_lo[2] = 0.599071547271275*GCL[30]+0.599071547271275*GCC[30]+0.8617863895711042*GCL[14]-0.8617863895711042*GCC[14]+0.6123724356957944*GCL[9]+0.6123724356957944*GCC[9]; 
  surft1_lo[3] = 1.9270129491651047*GCL[35]-1.9270129491651047*GCC[35]+1.369306393762915*GCL[32]+1.369306393762915*GCC[32]; 
  surft1_lo[4] = 0.599071547271275*GCL[31]+0.599071547271275*GCC[31]+0.8617863895711042*GCL[15]-0.8617863895711042*GCC[15]+0.6123724356957944*GCL[12]+0.6123724356957944*GCC[12]; 
  surft1_lo[5] = 1.927012949165105*GCL[37]-1.927012949165105*GCC[37]+1.369306393762915*GCL[33]+1.369306393762915*GCC[33]; 
  surft1_lo[6] = 1.927012949165105*GCL[38]-1.927012949165105*GCC[38]+1.369306393762915*GCL[34]+1.369306393762915*GCC[34]; 
  surft1_lo[7] = 1.9270129491651047*GCL[39]-1.9270129491651047*GCC[39]+1.369306393762915*GCL[36]+1.369306393762915*GCC[36]; 
  surft1_lo[8] = 0.8617863895711042*GCL[22]-0.8617863895711042*GCC[22]+0.6123724356957944*GCL[19]+0.6123724356957944*GCC[19]; 
  surft1_lo[9] = 0.8617863895711042*GCL[23]-0.8617863895711042*GCC[23]+0.6123724356957944*GCL[21]+0.6123724356957944*GCC[21]; 
  ...
  surft2_lo[0] = 0.34587411908091625*GCC[32]+0.34587411908091625*GBC[32]-0.49755260400283263*GCC[4]+0.49755260400283263*GBC[4]+0.3535533905932737*GCC[0]+0.3535533905932737*GBC[0]; 
  surft2_lo[1] = 0.34587411908091625*GCC[33]+0.34587411908091625*GBC[33]-0.49755260400283263*GCC[8]+0.49755260400283263*GBC[8]+0.3535533905932737*GCC[1]+0.3535533905932737*GBC[1]; 
  surft2_lo[2] = 0.34587411908091625*GCC[34]+0.34587411908091625*GBC[34]-0.49755260400283263*GCC[9]+0.49755260400283263*GBC[9]+0.3535533905932737*GCC[2]+0.3535533905932737*GBC[2]; 
  surft2_lo[3] = 0.34587411908091625*GCC[35]+0.34587411908091625*GBC[35]-0.49755260400283263*GCC[10]+0.49755260400283263*GBC[10]+0.3535533905932737*GCC[3]+0.3535533905932737*GBC[3]; 
  surft2_lo[4] = 0.34587411908091625*GCC[36]+0.34587411908091625*GBC[36]-0.49755260400283263*GCC[12]+0.49755260400283263*GBC[12]+0.3535533905932737*GCC[5]+0.3535533905932737*GBC[5]; 
  surft2_lo[5] = 0.34587411908091625*GCC[37]+0.34587411908091625*GBC[37]-0.49755260400283263*GCC[13]+0.49755260400283263*GBC[13]+0.3535533905932737*GCC[6]+0.3535533905932737*GBC[6]; 
  surft2_lo[6] = 0.34587411908091625*GCC[38]+0.34587411908091625*GBC[38]-0.49755260400283263*GCC[14]+0.49755260400283263*GBC[14]+0.3535533905932737*GCC[7]+0.3535533905932737*GBC[7]; 
  surft2_lo[7] = 0.34587411908091625*GCC[39]+0.34587411908091625*GBC[39]-0.49755260400283263*GCC[15]+0.49755260400283263*GBC[15]+0.3535533905932737*GCC[11]+0.3535533905932737*GBC[11]; 
  surft2_lo[8] = -(0.49755260400283263*GCC[19])+0.49755260400283263*GBC[19]+0.3535533905932737*GCC[16]+0.3535533905932737*GBC[16]; 
  surft2_lo[9] = -(0.49755260400283263*GCC[21])+0.49755260400283263*GBC[21]+0.3535533905932737*GCC[17]+0.3535533905932737*GBC[17]; 
  surft2_lo[10] = -(0.49755260400283263*GCC[22])+0.49755260400283263*GBC[22]+0.3535533905932737*GCC[18]+0.3535533905932737*GBC[18]; 
  surft2_lo[11] = -(0.49755260400283263*GCC[23])+0.49755260400283263*GBC[23]+0.3535533905932737*GCC[20]+0.3535533905932737*GBC[20]; 
  surft2_lo[12] = -(0.49755260400283263*GCC[27])+0.49755260400283263*GBC[27]+0.3535533905932737*GCC[24]+0.3535533905932737*GBC[24]; 
  surft2_lo[13] = -(0.49755260400283263*GCC[29])+0.49755260400283263*GBC[29]+0.3535533905932737*GCC[25]+0.3535533905932737*GBC[25]; 
  surft2_lo[14] = -(0.49755260400283263*GCC[30])+0.49755260400283263*GBC[30]+0.3535533905932737*GCC[26]+0.3535533905932737*GBC[26]; 
  surft2_lo[15] = -(0.49755260400283263*GCC[31])+0.49755260400283263*GBC[31]+0.3535533905932737*GCC[28]+0.3535533905932737*GBC[28]; 
  ...
  out[18] = (vol[18]-1.224744871391589*surft2_up[8]+1.224744871391589*surft2_lo[8]+1.224744871391589*surft1_up[8]+1.224744871391589*surft1_lo[8])*dv1_sq*gamma_avg; 
  out[19] = (vol[19]+0.7071067811865475*surft1_up[10]-0.7071067811865475*surft1_lo[10])*dv1_sq*gamma_avg; 
  out[20] = (vol[20]-1.224744871391589*surft2_up[9]+1.224744871391589*surft2_lo[9]+1.224744871391589*surft1_up[9]+1.224744871391589*surft1_lo[9])*dv1_sq*gamma_avg; 
  ...
  out[35] = (vol[35]+1.224744871391589*surft1_up[12]+1.224744871391589*surft1_lo[12]-2.7386127875258306*surft2_up[0]+2.7386127875258306*surft2_lo[0])*dv1_sq*gamma_avg; 
  out[36] = (vol[36]+0.7071067811865475*surft1_up[15]-0.7071067811865475*surft1_lo[15])*dv1_sq*gamma_avg; 
  out[37] = (vol[37]+1.224744871391589*surft1_up[13]+1.224744871391589*surft1_lo[13]-2.7386127875258306*surft2_up[1]+2.7386127875258306*surft2_lo[1])*dv1_sq*gamma_avg; 
  ...
  out[39] = (vol[39]+1.224744871391589*surft1_up[15]+1.224744871391589*surft1_lo[15]-2.7386127875258306*surft2_up[4]+2.7386127875258306*surft2_lo[4])*dv1_sq*gamma_avg; 
} 
