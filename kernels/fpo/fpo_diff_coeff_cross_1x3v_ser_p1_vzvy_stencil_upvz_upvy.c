...
GKYL_CU_DH void fpo_diff_coeff_cross_1x3v_vzvy_ser_p1_upvz_upvy(const double *dxv, const double *gamma, const double* fpo_g_stencil[9], const double* fpo_g_surf_stencil[9], const double* fpo_dgdv_surf, double *diff_coeff) { 
  ...
  surft1_up[0] = dGdvy_surf_CC_vz[0]/dv2; 
  surft1_up[1] = dGdvy_surf_CC_vz[1]/dv2; 
  surft1_up[2] = dGdvy_surf_CC_vz[2]/dv2; 
  surft1_up[3] = dGdvy_surf_CC_vz[3]/dv2; 
  surft1_up[4] = dGdvy_surf_CC_vz[4]/dv2; 
  surft1_up[5] = dGdvy_surf_CC_vz[5]/dv2; 
  surft1_up[6] = dGdvy_surf_CC_vz[6]/dv2; 
  surft1_up[7] = dGdvy_surf_CC_vz[7]/dv2; 
