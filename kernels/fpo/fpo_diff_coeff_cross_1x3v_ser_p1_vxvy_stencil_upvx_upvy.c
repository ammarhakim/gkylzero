...
GKYL_CU_DH void fpo_diff_coeff_cross_1x3v_vxvy_ser_p1_upvx_upvy(const double *dxv, const double *gamma, const double* fpo_g_stencil[9], const double* fpo_g_surf_stencil[9], const double* fpo_dgdv_surf, double *diff_coeff) { 
  ...
  const double* G_surf_CC_vy = &fpo_g_surf_stencil[3][8]; 
  const double* dGdvy_surf_CC_vx = &fpo_dgdv_surf[8]; 

  surft1_lo[0] = 0.7071067811865475*GCL[7]-0.7071067811865475*GCC[7]+0.6123724356957944*GCL[3]+0.6123724356957944*GCC[3]; 
  surft1_lo[1] = 0.7071067811865475*GCL[11]-0.7071067811865475*GCC[11]+0.6123724356957944*GCL[6]+0.6123724356957944*GCC[6]; 
  surft1_lo[3] = 0.7071067811865475*GCL[14]-0.7071067811865475*GCC[14]+0.6123724356957944*GCL[10]+0.6123724356957944*GCC[10]; 
  surft1_lo[5] = 0.7071067811865475*GCL[15]-0.7071067811865475*GCC[15]+0.6123724356957944*GCL[13]+0.6123724356957944*GCC[13]; 
  surft1_up[0] = dGdvy_surf_CC_vx[0]/dv2; 
  surft1_up[1] = dGdvy_surf_CC_vx[1]/dv2; 
  surft1_up[2] = dGdvy_surf_CC_vx[2]/dv2; 
  surft1_up[3] = dGdvy_surf_CC_vx[3]/dv2; 
  surft1_up[4] = dGdvy_surf_CC_vx[4]/dv2; 
  surft1_up[5] = dGdvy_surf_CC_vx[5]/dv2; 
  surft1_up[6] = dGdvy_surf_CC_vx[6]/dv2; 
  surft1_up[7] = dGdvy_surf_CC_vx[7]/dv2; 

  surft2_lo[0] = -(0.408248290463863*GCC[3])+0.408248290463863*GBC[3]+0.3535533905932737*GCC[0]+0.3535533905932737*GBC[0]; 
  surft2_lo[1] = -(0.408248290463863*GCC[6])+0.408248290463863*GBC[6]+0.3535533905932737*GCC[1]+0.3535533905932737*GBC[1]; 
  surft2_lo[2] = -(0.408248290463863*GCC[7])+0.408248290463863*GBC[7]+0.3535533905932737*GCC[2]+0.3535533905932737*GBC[2]; 
  surft2_lo[3] = -(0.408248290463863*GCC[10])+0.408248290463863*GBC[10]+0.3535533905932737*GCC[4]+0.3535533905932737*GBC[4]; 
  surft2_lo[4] = -(0.408248290463863*GCC[11])+0.408248290463863*GBC[11]+0.3535533905932737*GCC[5]+0.3535533905932737*GBC[5]; 
  surft2_lo[5] = -(0.408248290463863*GCC[13])+0.408248290463863*GBC[13]+0.3535533905932737*GCC[8]+0.3535533905932737*GBC[8]; 
  surft2_lo[6] = -(0.408248290463863*GCC[14])+0.408248290463863*GBC[14]+0.3535533905932737*GCC[9]+0.3535533905932737*GBC[9]; 
  surft2_lo[7] = -(0.408248290463863*GCC[15])+0.408248290463863*GBC[15]+0.3535533905932737*GCC[12]+0.3535533905932737*GBC[12]; 
