...
GKYL_CU_DH void fpo_diff_coeff_cross_1x3v_vzvx_ser_p1_invz_lovx(const double *dxv, const double *gamma, const double* fpo_g_stencil[9], const double* fpo_g_surf_stencil[9], const double* fpo_dgdv_surf, double *diff_coeff) { 
 ...
 double gamma_avg = gamma[0]/sqrt(pow(2, 1)); 
  ...
  surft1_upper[0] = 0.11785113019775789*GTR[9]+0.11785113019775789*GTL[9]-0.2357022603955158*GTC[9]-0.11785113019775789*GCR[9]-0.11785113019775789*GCL[9]+0.2357022603955158*GCC[9]-0.10206207261596573*GTR[4]-0.10206207261596573*GTL[4]+0.20412414523193148*GTC[4]-0.10206207261596573*GCR[4]-0.10206207261596573*GCL[4]+0.20412414523193148*GCC[4]-0.10206207261596573*GTR[2]+0.10206207261596573*GTL[2]+0.10206207261596573*GCR[2]-0.10206207261596573*GCL[2]+0.0883883476483184*GTR[0]-0.0883883476483184*GTL[0]+0.0883883476483184*GCR[0]-0.0883883476483184*GCL[0]; 
  surft1_upper[1] = 0.11785113019775789*GTR[12]+0.11785113019775789*GTL[12]-0.2357022603955158*GTC[12]-0.11785113019775789*GCR[12]-0.11785113019775789*GCL[12]+0.2357022603955158*GCC[12]-0.10206207261596573*GTR[8]-0.10206207261596573*GTL[8]+0.20412414523193148*GTC[8]-0.10206207261596573*GCR[8]-0.10206207261596573*GCL[8]+0.20412414523193148*GCC[8]-0.10206207261596573*GTR[5]+0.10206207261596573*GTL[5]+0.10206207261596573*GCR[5]-0.10206207261596573*GCL[5]+0.0883883476483184*GTR[1]-0.0883883476483184*GTL[1]+0.0883883476483184*GCR[1]-0.0883883476483184*GCL[1]; 
  surft1_upper[2] = 0.11785113019775789*GTR[14]+0.11785113019775789*GTL[14]-0.2357022603955158*GTC[14]-0.11785113019775789*GCR[14]-0.11785113019775789*GCL[14]+0.2357022603955158*GCC[14]-0.10206207261596573*GTR[10]-0.10206207261596573*GTL[10]+0.20412414523193148*GTC[10]-0.10206207261596573*GCR[10]-0.10206207261596573*GCL[10]+0.20412414523193148*GCC[10]-0.10206207261596573*GTR[7]+0.10206207261596573*GTL[7]+0.10206207261596573*GCR[7]-0.10206207261596573*GCL[7]+0.0883883476483184*GTR[3]-0.0883883476483184*GTL[3]+0.0883883476483184*GCR[3]-0.0883883476483184*GCL[3]; 
  surft1_upper[3] = 0.20412414523193148*GTR[9]-0.20412414523193148*GTL[9]-0.20412414523193148*GCR[9]+0.20412414523193148*GCL[9]-0.1767766952966368*GTR[4]+0.1767766952966368*GTL[4]-0.1767766952966368*GCR[4]+0.1767766952966368*GCL[4]-0.1767766952966368*GTR[2]-0.1767766952966368*GTL[2]+0.3535533905932737*GTC[2]+0.1767766952966368*GCR[2]+0.1767766952966368*GCL[2]-0.3535533905932737*GCC[2]+0.15309310892394856*GTR[0]+0.15309310892394856*GTL[0]-0.3061862178478971*GTC[0]+0.15309310892394856*GCR[0]+0.15309310892394856*GCL[0]-0.3061862178478971*GCC[0]; 
  surft1_upper[4] = 0.11785113019775789*GTR[15]+0.11785113019775789*GTL[15]-0.2357022603955158*GTC[15]-0.11785113019775789*GCR[15]-0.11785113019775789*GCL[15]+0.2357022603955158*GCC[15]-0.10206207261596573*GTR[13]-0.10206207261596573*GTL[13]+0.20412414523193148*GTC[13]-0.10206207261596573*GCR[13]-0.10206207261596573*GCL[13]+0.20412414523193148*GCC[13]-0.10206207261596573*GTR[11]+0.10206207261596573*GTL[11]+0.10206207261596573*GCR[11]-0.10206207261596573*GCL[11]+0.0883883476483184*GTR[6]-0.0883883476483184*GTL[6]+0.0883883476483184*GCR[6]-0.0883883476483184*GCL[6]; 
  surft1_upper[5] = 0.20412414523193148*GTR[12]-0.20412414523193148*GTL[12]-0.20412414523193148*GCR[12]+0.20412414523193148*GCL[12]-0.1767766952966368*GTR[8]+0.1767766952966368*GTL[8]-0.1767766952966368*GCR[8]+0.1767766952966368*GCL[8]-0.1767766952966368*GTR[5]-0.1767766952966368*GTL[5]+0.3535533905932737*GTC[5]+0.1767766952966368*GCR[5]+0.1767766952966368*GCL[5]-0.3535533905932737*GCC[5]+0.15309310892394856*GTR[1]+0.15309310892394856*GTL[1]-0.3061862178478971*GTC[1]+0.15309310892394856*GCR[1]+0.15309310892394856*GCL[1]-0.3061862178478971*GCC[1]; 
  surft1_upper[6] = 0.20412414523193148*GTR[14]-0.20412414523193148*GTL[14]-0.20412414523193148*GCR[14]+0.20412414523193148*GCL[14]-0.1767766952966368*GTR[10]+0.1767766952966368*GTL[10]-0.1767766952966368*GCR[10]+0.1767766952966368*GCL[10]-0.1767766952966368*GTR[7]-0.1767766952966368*GTL[7]+0.3535533905932737*GTC[7]+0.1767766952966368*GCR[7]+0.1767766952966368*GCL[7]-0.3535533905932737*GCC[7]+0.15309310892394856*GTR[3]+0.15309310892394856*GTL[3]-0.3061862178478971*GTC[3]+0.15309310892394856*GCR[3]+0.15309310892394856*GCL[3]-0.3061862178478971*GCC[3]; 
  surft1_upper[7] = 0.20412414523193148*GTR[15]-0.20412414523193148*GTL[15]-0.20412414523193148*GCR[15]+0.20412414523193148*GCL[15]-0.1767766952966368*GTR[13]+0.1767766952966368*GTL[13]-0.1767766952966368*GCR[13]+0.1767766952966368*GCL[13]-0.1767766952966368*GTR[11]-0.1767766952966368*GTL[11]+0.3535533905932737*GTC[11]+0.1767766952966368*GCR[11]+0.1767766952966368*GCL[11]-0.3535533905932737*GCC[11]+0.15309310892394856*GTR[6]+0.15309310892394856*GTL[6]-0.3061862178478971*GTC[6]+0.15309310892394856*GCR[6]+0.15309310892394856*GCL[6]-0.3061862178478971*GCC[6]; 
