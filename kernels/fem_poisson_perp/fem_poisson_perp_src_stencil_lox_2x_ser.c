...
{ 
  ...
  #ifdef __CUDA_ARCH__
  atomicAdd(&bsrc[perpOff+globalIdxs[0]],0.16666666666666666*rho[3]-0.28867513459481287*rho[2]-1.0*rdx2[0]*bcVals[2]-0.28867513459481287*rho[1]+0.5*rho[0]);
  #else
  bsrc[perpOff+globalIdxs[0]] += 0.16666666666666666*rho[3]-0.28867513459481287*rho[2]-1.0*rdx2[0]*bcVals[2]-0.28867513459481287*rho[1]+0.5*rho[0];
  #endif
  #ifdef __CUDA_ARCH__
  atomicAdd(&bsrc[perpOff+globalIdxs[1]],-(0.16666666666666666*rho[3])-0.28867513459481287*rho[2]+0.28867513459481287*rho[1]+0.5*rho[0]);
  #else
  ...
  #endif
  #ifdef __CUDA_ARCH__
  atomicAdd(&bsrc[perpOff+globalIdxs[2]],-(0.16666666666666669*rho[3])+0.2886751345948129*rho[2]-1.0*rdx2[0]*bcVals[2]-0.2886751345948129*rho[1]+0.5*rho[0]);
  #else
  bsrc[perpOff+globalIdxs[2]] += -(0.16666666666666669*rho[3])+0.2886751345948129*rho[2]-1.0*rdx2[0]*bcVals[2]-0.2886751345948129*rho[1]+0.5*rho[0];
  #endif
  #ifdef __CUDA_ARCH__
  atomicAdd(&bsrc[perpOff+globalIdxs[3]],0.16666666666666669*rho[3]+0.2886751345948129*rho[2]+0.2886751345948129*rho[1]+0.5*rho[0]);
  #else
