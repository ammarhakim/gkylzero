...
{ 
  ...
  #endif
  #ifdef __CUDA_ARCH__
  atomicAdd(&bsrc[perpOff+globalIdxs[1]],(-1.0*rdx2[1]*bcVals[8])+0.06804138174397718*rho[7]+0.1178511301977579*rho[6]-0.1178511301977579*rho[5]+rdx2[0]*bcVals[5]-0.1178511301977579*rho[4]-0.2041241452319316*rho[3]-0.2041241452319316*rho[2]+0.2041241452319316*rho[1]+0.3535533905932738*rho[0]);
  #else
  bsrc[perpOff+globalIdxs[1]] += (-1.0*rdx2[1]*bcVals[8])+0.06804138174397718*rho[7]+0.1178511301977579*rho[6]-0.1178511301977579*rho[5]+rdx2[0]*bcVals[5]-0.1178511301977579*rho[4]-0.2041241452319316*rho[3]-0.2041241452319316*rho[2]+0.2041241452319316*rho[1]+0.3535533905932738*rho[0];
  #endif
  #ifdef __CUDA_ARCH__
  atomicAdd(&bsrc[perpOff+globalIdxs[2]],0.06804138174397718*rho[7]-0.1178511301977579*rho[6]+0.1178511301977579*rho[5]-0.1178511301977579*rho[4]-0.2041241452319316*rho[3]+0.2041241452319316*rho[2]-0.2041241452319316*rho[1]+0.3535533905932738*rho[0]);
  #else
  ...
  #endif
  #ifdef __CUDA_ARCH__
  atomicAdd(&bsrc[perpOff+globalIdxs[5]],(-1.0*rdx2[1]*bcVals[8])-0.06804138174397718*rho[7]-0.1178511301977579*rho[6]+0.1178511301977579*rho[5]+rdx2[0]*bcVals[5]-0.1178511301977579*rho[4]+0.2041241452319316*rho[3]-0.2041241452319316*rho[2]+0.2041241452319316*rho[1]+0.3535533905932738*rho[0]);
  #else
  bsrc[perpOff+globalIdxs[5]] += (-1.0*rdx2[1]*bcVals[8])-0.06804138174397718*rho[7]-0.1178511301977579*rho[6]+0.1178511301977579*rho[5]+rdx2[0]*bcVals[5]-0.1178511301977579*rho[4]+0.2041241452319316*rho[3]-0.2041241452319316*rho[2]+0.2041241452319316*rho[1]+0.3535533905932738*rho[0];
  #endif
  #ifdef __CUDA_ARCH__
  atomicAdd(&bsrc[perpOff+globalIdxs[6]],(-0.06804138174397718*rho[7])+0.1178511301977579*rho[6]-0.1178511301977579*rho[5]-0.1178511301977579*rho[4]+0.2041241452319316*rho[3]+0.2041241452319316*rho[2]-0.2041241452319316*rho[1]+0.3535533905932738*rho[0]);
  #else
