...
GKYL_CU_DH void fem_poisson_perp_src_stencil_3x_ser_p2_inx_periodicx_iny_periodicy(const double *epsilon, const double *dx, const double *rho, const double *bcVals, long perpOff, const long *globalIdxs, double *bsrc);
GKYL_CU_DH void fem_poisson_perp_src_stencil_3x_ser_p2_lox_periodicx_iny_periodicy(const double *epsilon, const double *dx, const double *rho, const double *bcVals, long perpOff, const long *globalIdxs, double *bsrc);
GKYL_CU_DH void fem_poisson_perp_src_stencil_3x_ser_p2_lox_dirichletx_iny_periodicy(const double *epsilon, const double *dx, const double *rho, const double *bcVals, long perpOff, const long *globalIdxs, double *bsrc);
GKYL_CU_DH void fem_poisson_perp_src_stencil_3x_ser_p2_lox_neumannx_iny_periodicy(const double *epsilon, const double *dx, const double *rho, const double *bcVals, long perpOff, const long *globalIdxs, double *bsrc);
GKYL_CU_DH void fem_poisson_perp_src_stencil_3x_ser_p2_upx_periodicx_iny_periodicy(const double *epsilon, const double *dx, const double *rho, const double *bcVals, long perpOff, const long *globalIdxs, double *bsrc);
GKYL_CU_DH void fem_poisson_perp_src_stencil_3x_ser_p2_upx_dirichletx_iny_periodicy(const double *epsilon, const double *dx, const double *rho, const double *bcVals, long perpOff, const long *globalIdxs, double *bsrc);
GKYL_CU_DH void fem_poisson_perp_src_stencil_3x_ser_p2_upx_neumannx_iny_periodicy(const double *epsilon, const double *dx, const double *rho, const double *bcVals, long perpOff, const long *globalIdxs, double *bsrc);
GKYL_CU_DH void fem_poisson_perp_src_stencil_3x_ser_p2_inx_periodicx_loy_periodicy(const double *epsilon, const double *dx, const double *rho, const double *bcVals, long perpOff, const long *globalIdxs, double *bsrc);
GKYL_CU_DH void fem_poisson_perp_src_stencil_3x_ser_p2_inx_periodicx_loy_dirichlety(const double *epsilon, const double *dx, const double *rho, const double *bcVals, long perpOff, const long *globalIdxs, double *bsrc);
GKYL_CU_DH void fem_poisson_perp_src_stencil_3x_ser_p2_inx_periodicx_loy_neumanny(const double *epsilon, const double *dx, const double *rho, const double *bcVals, long perpOff, const long *globalIdxs, double *bsrc);
GKYL_CU_DH void fem_poisson_perp_src_stencil_3x_ser_p2_inx_periodicx_upy_periodicy(const double *epsilon, const double *dx, const double *rho, const double *bcVals, long perpOff, const long *globalIdxs, double *bsrc);
GKYL_CU_DH void fem_poisson_perp_src_stencil_3x_ser_p2_inx_periodicx_upy_dirichlety(const double *epsilon, const double *dx, const double *rho, const double *bcVals, long perpOff, const long *globalIdxs, double *bsrc);
GKYL_CU_DH void fem_poisson_perp_src_stencil_3x_ser_p2_inx_periodicx_upy_neumanny(const double *epsilon, const double *dx, const double *rho, const double *bcVals, long perpOff, const long *globalIdxs, double *bsrc);
GKYL_CU_DH void fem_poisson_perp_src_stencil_3x_ser_p2_lox_periodicx_loy_periodicy(const double *epsilon, const double *dx, const double *rho, const double *bcVals, long perpOff, const long *globalIdxs, double *bsrc);
GKYL_CU_DH void fem_poisson_perp_src_stencil_3x_ser_p2_lox_periodicx_loy_dirichlety(const double *epsilon, const double *dx, const double *rho, const double *bcVals, long perpOff, const long *globalIdxs, double *bsrc);
GKYL_CU_DH void fem_poisson_perp_src_stencil_3x_ser_p2_lox_periodicx_loy_neumanny(const double *epsilon, const double *dx, const double *rho, const double *bcVals, long perpOff, const long *globalIdxs, double *bsrc);
GKYL_CU_DH void fem_poisson_perp_src_stencil_3x_ser_p2_lox_dirichletx_loy_periodicy(const double *epsilon, const double *dx, const double *rho, const double *bcVals, long perpOff, const long *globalIdxs, double *bsrc);
GKYL_CU_DH void fem_poisson_perp_src_stencil_3x_ser_p2_lox_dirichletx_loy_dirichlety(const double *epsilon, const double *dx, const double *rho, const double *bcVals, long perpOff, const long *globalIdxs, double *bsrc);
GKYL_CU_DH void fem_poisson_perp_src_stencil_3x_ser_p2_lox_dirichletx_loy_neumanny(const double *epsilon, const double *dx, const double *rho, const double *bcVals, long perpOff, const long *globalIdxs, double *bsrc);
GKYL_CU_DH void fem_poisson_perp_src_stencil_3x_ser_p2_lox_neumannx_loy_periodicy(const double *epsilon, const double *dx, const double *rho, const double *bcVals, long perpOff, const long *globalIdxs, double *bsrc);
GKYL_CU_DH void fem_poisson_perp_src_stencil_3x_ser_p2_lox_neumannx_loy_dirichlety(const double *epsilon, const double *dx, const double *rho, const double *bcVals, long perpOff, const long *globalIdxs, double *bsrc);
GKYL_CU_DH void fem_poisson_perp_src_stencil_3x_ser_p2_lox_neumannx_loy_neumanny(const double *epsilon, const double *dx, const double *rho, const double *bcVals, long perpOff, const long *globalIdxs, double *bsrc);
GKYL_CU_DH void fem_poisson_perp_src_stencil_3x_ser_p2_lox_periodicx_upy_periodicy(const double *epsilon, const double *dx, const double *rho, const double *bcVals, long perpOff, const long *globalIdxs, double *bsrc);
GKYL_CU_DH void fem_poisson_perp_src_stencil_3x_ser_p2_lox_periodicx_upy_dirichlety(const double *epsilon, const double *dx, const double *rho, const double *bcVals, long perpOff, const long *globalIdxs, double *bsrc);
GKYL_CU_DH void fem_poisson_perp_src_stencil_3x_ser_p2_lox_periodicx_upy_neumanny(const double *epsilon, const double *dx, const double *rho, const double *bcVals, long perpOff, const long *globalIdxs, double *bsrc);
GKYL_CU_DH void fem_poisson_perp_src_stencil_3x_ser_p2_lox_dirichletx_upy_periodicy(const double *epsilon, const double *dx, const double *rho, const double *bcVals, long perpOff, const long *globalIdxs, double *bsrc);
GKYL_CU_DH void fem_poisson_perp_src_stencil_3x_ser_p2_lox_dirichletx_upy_dirichlety(const double *epsilon, const double *dx, const double *rho, const double *bcVals, long perpOff, const long *globalIdxs, double *bsrc);
GKYL_CU_DH void fem_poisson_perp_src_stencil_3x_ser_p2_lox_dirichletx_upy_neumanny(const double *epsilon, const double *dx, const double *rho, const double *bcVals, long perpOff, const long *globalIdxs, double *bsrc);
GKYL_CU_DH void fem_poisson_perp_src_stencil_3x_ser_p2_lox_neumannx_upy_periodicy(const double *epsilon, const double *dx, const double *rho, const double *bcVals, long perpOff, const long *globalIdxs, double *bsrc);
GKYL_CU_DH void fem_poisson_perp_src_stencil_3x_ser_p2_lox_neumannx_upy_dirichlety(const double *epsilon, const double *dx, const double *rho, const double *bcVals, long perpOff, const long *globalIdxs, double *bsrc);
GKYL_CU_DH void fem_poisson_perp_src_stencil_3x_ser_p2_lox_neumannx_upy_neumanny(const double *epsilon, const double *dx, const double *rho, const double *bcVals, long perpOff, const long *globalIdxs, double *bsrc);
GKYL_CU_DH void fem_poisson_perp_src_stencil_3x_ser_p2_upx_periodicx_loy_periodicy(const double *epsilon, const double *dx, const double *rho, const double *bcVals, long perpOff, const long *globalIdxs, double *bsrc);
GKYL_CU_DH void fem_poisson_perp_src_stencil_3x_ser_p2_upx_periodicx_loy_dirichlety(const double *epsilon, const double *dx, const double *rho, const double *bcVals, long perpOff, const long *globalIdxs, double *bsrc);
GKYL_CU_DH void fem_poisson_perp_src_stencil_3x_ser_p2_upx_periodicx_loy_neumanny(const double *epsilon, const double *dx, const double *rho, const double *bcVals, long perpOff, const long *globalIdxs, double *bsrc);
GKYL_CU_DH void fem_poisson_perp_src_stencil_3x_ser_p2_upx_dirichletx_loy_periodicy(const double *epsilon, const double *dx, const double *rho, const double *bcVals, long perpOff, const long *globalIdxs, double *bsrc);
GKYL_CU_DH void fem_poisson_perp_src_stencil_3x_ser_p2_upx_dirichletx_loy_dirichlety(const double *epsilon, const double *dx, const double *rho, const double *bcVals, long perpOff, const long *globalIdxs, double *bsrc);
GKYL_CU_DH void fem_poisson_perp_src_stencil_3x_ser_p2_upx_dirichletx_loy_neumanny(const double *epsilon, const double *dx, const double *rho, const double *bcVals, long perpOff, const long *globalIdxs, double *bsrc);
GKYL_CU_DH void fem_poisson_perp_src_stencil_3x_ser_p2_upx_neumannx_loy_periodicy(const double *epsilon, const double *dx, const double *rho, const double *bcVals, long perpOff, const long *globalIdxs, double *bsrc);
GKYL_CU_DH void fem_poisson_perp_src_stencil_3x_ser_p2_upx_neumannx_loy_dirichlety(const double *epsilon, const double *dx, const double *rho, const double *bcVals, long perpOff, const long *globalIdxs, double *bsrc);
GKYL_CU_DH void fem_poisson_perp_src_stencil_3x_ser_p2_upx_neumannx_loy_neumanny(const double *epsilon, const double *dx, const double *rho, const double *bcVals, long perpOff, const long *globalIdxs, double *bsrc);
GKYL_CU_DH void fem_poisson_perp_src_stencil_3x_ser_p2_upx_periodicx_upy_periodicy(const double *epsilon, const double *dx, const double *rho, const double *bcVals, long perpOff, const long *globalIdxs, double *bsrc);
GKYL_CU_DH void fem_poisson_perp_src_stencil_3x_ser_p2_upx_periodicx_upy_dirichlety(const double *epsilon, const double *dx, const double *rho, const double *bcVals, long perpOff, const long *globalIdxs, double *bsrc);
GKYL_CU_DH void fem_poisson_perp_src_stencil_3x_ser_p2_upx_periodicx_upy_neumanny(const double *epsilon, const double *dx, const double *rho, const double *bcVals, long perpOff, const long *globalIdxs, double *bsrc);
GKYL_CU_DH void fem_poisson_perp_src_stencil_3x_ser_p2_upx_dirichletx_upy_periodicy(const double *epsilon, const double *dx, const double *rho, const double *bcVals, long perpOff, const long *globalIdxs, double *bsrc);
GKYL_CU_DH void fem_poisson_perp_src_stencil_3x_ser_p2_upx_dirichletx_upy_dirichlety(const double *epsilon, const double *dx, const double *rho, const double *bcVals, long perpOff, const long *globalIdxs, double *bsrc);
GKYL_CU_DH void fem_poisson_perp_src_stencil_3x_ser_p2_upx_dirichletx_upy_neumanny(const double *epsilon, const double *dx, const double *rho, const double *bcVals, long perpOff, const long *globalIdxs, double *bsrc);
GKYL_CU_DH void fem_poisson_perp_src_stencil_3x_ser_p2_upx_neumannx_upy_periodicy(const double *epsilon, const double *dx, const double *rho, const double *bcVals, long perpOff, const long *globalIdxs, double *bsrc);
GKYL_CU_DH void fem_poisson_perp_src_stencil_3x_ser_p2_upx_neumannx_upy_dirichlety(const double *epsilon, const double *dx, const double *rho, const double *bcVals, long perpOff, const long *globalIdxs, double *bsrc);
GKYL_CU_DH void fem_poisson_perp_src_stencil_3x_ser_p2_upx_neumannx_upy_neumanny(const double *epsilon, const double *dx, const double *rho, const double *bcVals, long perpOff, const long *globalIdxs, double *bsrc);

GKYL_CU_DH void fem_poisson_perp_sol_stencil_3x_ser_p2(const double *sol_nodal_global, long perpOff, const long *globalIdxs, double *sol_modal_local);
