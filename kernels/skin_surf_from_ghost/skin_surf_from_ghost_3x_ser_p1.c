...
{ 
  ...
  fskin[2] = 0.8660254037844386*fskin[4]+0.5*fskin[2]+0.7071067811865475*fghostSurf[1]; 
  fskin[3] = 0.8660254037844386*fskin[5]+0.5*fskin[3]+0.7071067811865475*fghostSurf[2]; 
  fskin[4] = 0.5*fskin[4]+0.2886751345948129*fskin[2]-0.408248290463863*fghostSurf[1]; 
  fskin[5] = 0.5*fskin[5]+0.2886751345948129*fskin[3]-0.408248290463863*fghostSurf[2]; 
  fskin[6] = 0.8660254037844386*fskin[7]+0.5*fskin[6]+0.7071067811865475*fghostSurf[3]; 
  fskin[7] = 0.5*fskin[7]+0.2886751345948129*fskin[6]-0.408248290463863*fghostSurf[3]; 
...
{ 
  ...
  fskin[1] = 0.8660254037844386*fskin[4]+0.5*fskin[1]+0.7071067811865475*fghostSurf[1]; 
  fskin[2] = 0.5*fskin[2]+0.2886751345948129*fskin[0]-0.408248290463863*fghostSurf[0]; 
  fskin[3] = 0.8660254037844386*fskin[6]+0.5*fskin[3]+0.7071067811865475*fghostSurf[2]; 
  fskin[4] = 0.5*fskin[4]+0.2886751345948129*fskin[1]-0.408248290463863*fghostSurf[1]; 
  fskin[5] = 0.8660254037844386*fskin[7]+0.5*fskin[5]+0.7071067811865475*fghostSurf[3]; 
  fskin[6] = 0.5*fskin[6]+0.2886751345948129*fskin[3]-0.408248290463863*fghostSurf[2]; 
  fskin[7] = 0.5*fskin[7]+0.2886751345948129*fskin[5]-0.408248290463863*fghostSurf[3]; 
