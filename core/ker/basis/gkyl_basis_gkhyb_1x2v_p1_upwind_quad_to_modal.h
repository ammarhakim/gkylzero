...
gkhyb_1x2v_p1_xdir_upwind_quad_to_modal(const double* fUpwindQuad, double* GKYL_RESTRICT fUpwind) { 
  ...
  fUpwind[1] = 0.3726779962499649*fUpwindQuad[5]-0.3726779962499649*fUpwindQuad[3]+0.3726779962499649*fUpwindQuad[2]-0.3726779962499649*fUpwindQuad[0]; 
  fUpwind[2] = 0.2777777777777778*fUpwindQuad[5]+0.4444444444444444*fUpwindQuad[4]+0.2777777777777778*fUpwindQuad[3]-0.2777777777777778*fUpwindQuad[2]-0.4444444444444444*fUpwindQuad[1]-0.2777777777777778*fUpwindQuad[0]; 
...
GKYL_CU_DH static inline void 
gkhyb_1x2v_p1_vpardir_upwind_quad_to_modal(const double* fUpwindQuad, double* GKYL_RESTRICT fUpwind) { 
...
GKYL_CU_DH static inline void 
gkhyb_1x2v_p1_mudir_upwind_quad_to_modal(const double* fUpwindQuad, double* GKYL_RESTRICT fUpwind) { 
  fUpwind[0] = 0.2777777777777778*fUpwindQuad[5]+0.4444444444444444*fUpwindQuad[4]+0.2777777777777778*fUpwindQuad[3]+0.2777777777777778*fUpwindQuad[2]+0.4444444444444444*fUpwindQuad[1]+0.2777777777777778*fUpwindQuad[0]; 
