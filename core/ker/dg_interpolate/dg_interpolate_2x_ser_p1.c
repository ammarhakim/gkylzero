...
{ 
  ...
  atomicAdd(&fldTar[2], (dxTar[0]*(0.4330127018922193*fldDo[3]*eUpR2-0.4330127018922193*fldDo[3]*eLoR2))/dxDo[0]+(1.7320508075688772*wTar[0]*fldDo[3]*eUp-1.7320508075688772*wDo[0]*fldDo[3]*eUp-1.7320508075688772*wTar[0]*fldDo[3]*eLo+1.7320508075688772*wDo[0]*fldDo[3]*eLo)/dxDo[0]+0.5*fldDo[2]*eUp-0.5*fldDo[2]*eLo); 
  atomicAdd(&fldTar[3], (dxTar[0]*(0.5*fldDo[3]*eUpR3-0.5*fldDo[3]*eLoR3))/dxDo[0]+(1.5*wTar[0]*fldDo[3]*eUpR2-1.5*wDo[0]*fldDo[3]*eUpR2-1.5*wTar[0]*fldDo[3]*eLoR2+1.5*wDo[0]*fldDo[3]*eLoR2)/dxDo[0]+0.4330127018922193*fldDo[2]*eUpR2-0.4330127018922193*fldDo[2]*eLoR2); 
#else
  const double eLoR2 = pow(eLo,2);
  const double eLoR3 = pow(eLo,3);
  const double eUpR2 = pow(eUp,2);
...
{ 
  ...
  atomicAdd(&fldTar[1], (dxTar[1]*(0.4330127018922193*fldDo[3]*eUpR2-0.4330127018922193*fldDo[3]*eLoR2))/dxDo[1]+(1.7320508075688772*wTar[1]*fldDo[3]*eUp-1.7320508075688772*wDo[1]*fldDo[3]*eUp-1.7320508075688772*wTar[1]*fldDo[3]*eLo+1.7320508075688772*wDo[1]*fldDo[3]*eLo)/dxDo[1]+0.5*fldDo[1]*eUp-0.5*fldDo[1]*eLo); 
  ...
  atomicAdd(&fldTar[3], (dxTar[1]*(0.5*fldDo[3]*eUpR3-0.5*fldDo[3]*eLoR3))/dxDo[1]+(1.5*wTar[1]*fldDo[3]*eUpR2-1.5*wDo[1]*fldDo[3]*eUpR2-1.5*wTar[1]*fldDo[3]*eLoR2+1.5*wDo[1]*fldDo[3]*eLoR2)/dxDo[1]+0.4330127018922193*fldDo[1]*eUpR2-0.4330127018922193*fldDo[1]*eLoR2); 
#else
  const double eLoR2 = pow(eLo,2);
  const double eLoR3 = pow(eLo,3);
  const double eUpR2 = pow(eUp,2);
  ...
  fldTar[1] += (dxTar[1]*(0.4330127018922193*fldDo[3]*eUpR2-0.4330127018922193*fldDo[3]*eLoR2))/dxDo[1]+(1.7320508075688772*wTar[1]*fldDo[3]*eUp-1.7320508075688772*wDo[1]*fldDo[3]*eUp-1.7320508075688772*wTar[1]*fldDo[3]*eLo+1.7320508075688772*wDo[1]*fldDo[3]*eLo)/dxDo[1]+0.5*fldDo[1]*eUp-0.5*fldDo[1]*eLo; 
  ...
  fldTar[3] += (dxTar[1]*(0.5*fldDo[3]*eUpR3-0.5*fldDo[3]*eLoR3))/dxDo[1]+(1.5*wTar[1]*fldDo[3]*eUpR2-1.5*wDo[1]*fldDo[3]*eUpR2-1.5*wTar[1]*fldDo[3]*eLoR2+1.5*wDo[1]*fldDo[3]*eLoR2)/dxDo[1]+0.4330127018922193*fldDo[1]*eUpR2-0.4330127018922193*fldDo[1]*eLoR2; 
#endif
