...
test_1()
{
  ...
  struct gkyl_geo_gyrokinetic_geo_inp ginp = {
    ...
    .node_file_nm = "cerfoninner_nodes.gkyl"
  }; 
  ...
  gkyl_grid_sub_array_write(&cgrid, &clocal, mapc2p_arr, "cerfoninner_mapc2pfile.gkyl");
  ...
  gkyl_grid_sub_array_write(&rzgrid, &rzlocal, psidg, "cerfoninner_psi.gkyl");
  ...
  do{
    ...
    snprintf(fileNm, sizeof fileNm, fmt, "cerfoninner");
  ...
  //gkyl_grid_sub_array_write(&cgrid, &clocal, XYZ, "cerfoninner_xyzfile.gkyl");
