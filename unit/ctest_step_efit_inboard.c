...
test_1()
{
  ...
  gkyl_grid_sub_array_write(&rzgrid, &rzlocal, psizr, "stepinboard_psi.gkyl");
  gkyl_grid_sub_array_write(&rzgrid, &rzlocal, psibyrzr, "stepinboard_psibyr.gkyl");
  gkyl_grid_sub_array_write(&rzgrid, &rzlocal, psibyr2zr, "stepinboard_psibyr2.gkyl");
  gkyl_grid_sub_array_write(&fluxgrid, &fluxlocal, fpolflux, "stepinboard_fpol.gkyl");
  gkyl_grid_sub_array_write(&fluxgrid, &fluxlocal, qflux, "stepinboard_q.gkyl");
  ...
  double clower[] = { 1.4501, -0.01, -3.14 };
  ...
  struct gkyl_geo_gyrokinetic_geo_inp ginp = {
    ...
    .node_file_nm = "stepinboard_nodes.gkyl"
  }; 
  ...
  gkyl_grid_sub_array_write(&cgrid, &clocal, mapc2p_arr, "stepinboard_mapc2pfile.gkyl");
  ...
  do{
    ...
    snprintf(fileNm, sizeof fileNm, fmt, "stepinboard");
