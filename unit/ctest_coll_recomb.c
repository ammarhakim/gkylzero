...
test_coll_recomb_all_gk_li(bool use_gpu)
{
  ...
  // cuda stuff
  if (use_gpu) {
    struct gkyl_array *moms_ion_cu = gkyl_array_cu_dev_new(GKYL_DOUBLE, 5*basis.num_basis, confRange.volume);
    struct gkyl_array *moms_elc_cu = gkyl_array_cu_dev_new(GKYL_DOUBLE, 3*basis.num_basis, confRange.volume);
    ...
    gkyl_array_release(cflRate_elc_cu); gkyl_array_release(distf_elc_cu);
    gkyl_array_release(bmag_cu); gkyl_array_release(jacob_tot_cu);
    gkyl_array_release(coll_recomb_elc_cu); gkyl_array_release(b_i_cu);
  }
  else {
    gkyl_proj_gkmaxwellian_on_basis_lab_mom(proj_max_elc, &phaseRange_elc, &confRange, moms_elc,
      bmag, jacob_tot, emass, distf_elc);
  ...
  double p1_vals_ion[] = {-7.6846242945232746e-04, -7.8389955672629841e-21,  4.6163486443475535e-20,
			  -6.1988540948317719e-21, -1.0310005382460250e-03,  4.3905801712689564e-04,
			  -3.4020165836416649e-20, -7.0189248310473814e-21, -7.0189248310473814e-21,
			  -1.8145675374875721e-20,  9.3224172047938328e-21,  9.3224172047938328e-21,
			  2.6168620978263331e-20,  1.0273022834532277e-20,  3.7277302672438601e-21,
			  5.8905814341720319e-04, -6.1988540948317711e-21, -2.8003789361644293e-20,
			  -9.3406860784252285e-21, -2.5663742360810318e-20, -1.2549290890324760e-23,
			  -1.4150557954674409e-21, -1.4150557954674407e-21,  4.0570915168827172e-20,
			  -3.7039667479594881e-21, -3.7039667479594889e-21,  1.9180531191562402e-20,
			  3.7277302672438594e-21,  1.7622216047481774e-20,  6.9591246497611424e-21,
			  3.7266535019528817e-21, -3.7039667479594889e-21, -6.8733369216401646e-04,
			  -4.3672002711301218e-21, -4.1743692221083202e-20,  1.0618648317224109e-20,
			  3.9270542894480212e-04, -1.7417610269871002e-20, -4.9755414143916293e-21,
			  -1.4873830536996144e-20, -1.0029322723470919e-20, -1.1156192785854929e-20,
			  -4.6109002185665178e-21, -5.6642328293250314e-21,  6.4544341022579586e-21,
			  -7.1995860635108792e-21, -7.1995860635108777e-21, -1.2177285274144708e-21};

  double p1_vals_recvr[] = {7.6846242945232746e-04,  7.8389955672629841e-21, -4.6163486443475535e-20,
			    6.1988540948317719e-21,  1.0310005382460250e-03, -4.3905801712689564e-04,
			    3.4020165836416649e-20,  7.0189248310473814e-21,  7.0189248310473814e-21,
			    1.8145675374875721e-20, -9.3224172047938328e-21, -9.3224172047938328e-21,
			    -2.6168620978263331e-20, -1.0273022834532277e-20, -3.7277302672438601e-21,
  ...
  for (int i=0; i<basis.num_basis; ++i) {
    TEST_CHECK( gkyl_compare_double(p1_vals_recvr[i], pv_recvr[i], 1e-30) );
  }
...
void coll_recomb_all_gk_li_gpu() { test_coll_recomb_all_gk_li(true); }
