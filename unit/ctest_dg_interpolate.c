...
void test_1x1v_ho()
{
  int cells_do0[] = {3, 3};
  int cells_tar0[] = {3, 4};
  test_1x1v(cells_do0, cells_tar0, 1, false);

  int cells_do1[] = {6, 12};
  int cells_tar1[] = {12, 12};
  test_1x1v(cells_do1, cells_tar1, 1, false);
}
...
void test_1x1v_dev()
{
  int cells_do0[] = {3, 3};
  int cells_tar0[] = {3, 4};
  test_1x1v(cells_do0, cells_tar0, 1, true);

  int cells_do1[] = {6, 12};
  int cells_tar1[] = {12, 12};
  test_1x1v(cells_do1, cells_tar1, 1, true);
}
