...
test_1()
{
  ...
  struct gkyl_geo_gyrokinetic_geo_inp ginp = {
    ...
    .node_file_nm = "steppfup_nodes.gkyl"
  }; 
  ...
  gkyl_grid_sub_array_write(&cgrid, &clocal, mapc2p_arr, "steppfup_mapc2pfile.gkyl");
  ...
  //gkyl_grid_sub_array_write(&rzgrid, &rzlocal, psidg, "steppfup_psi.gkyl");
  ...
  do{
    ...
    snprintf(fileNm, sizeof fileNm, fmt, "steppfup");
  ...
  //gkyl_grid_sub_array_write(&cgrid, &clocal, XYZ, "steppfup_xyzfile.gkyl");
