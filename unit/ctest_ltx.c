...
test_ltx()
{
  ...
  double psisep = -5.4760172700000003e-03;
  // For LTX, flux increases towards magnetic axis

  double clower[] = { psisep - 0.0004, -0.01, -M_PI+1e-14 };
  double cupper[] = {psisep + 0.0012, 0.01, M_PI-1e-14 };
  int ccells[] = { 8,1,16 };
  ...
  //write_geometry(up, cgrid, cbasis, clocal, "ltx");
