...
test_dg_gyrokinetic()
{
  ...
  struct gkyl_dg_eqn* eqn = gkyl_dg_gyrokinetic_new(&cbasis, &pbasis, &crange);
...
test_cu_dg_gyrokinetic()
{
  ...
  struct gkyl_dg_eqn* eqn = gkyl_dg_gyrokinetic_cu_dev_new(&cbasis, &pbasis, &crange, GKYL_FIELD_E_B);
