...
void test_vlasov_2x3v_p1_cu()
{
  ...
  for(int n=0; n<nrep; n++) {
    ...
    cudaMemset(rhs_cu->data, 0.0, sizeof(double)*basis.numBasis*phaseRange_ext.volume);
    cudaMemset(cflrate_cu->data, 0.0, sizeof(double)*basis.numBasis*phaseRange_ext.volume);
