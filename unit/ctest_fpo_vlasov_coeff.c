...
void test_1x3v(int poly_order, int NV)
{
  ...
  if ((poly_order == 1) && (NV == 8)) {
    ...
    TEST_CHECK( gkyl_compare_double(diff_corner[3], 0.000561896233837, 1e-12) );
    ...
    TEST_CHECK( gkyl_compare_double(diff_corner[49], -0.000651059231579, 1e-12) );
    TEST_CHECK( gkyl_compare_double(diff_corner[50], -0.000818114814429, 1e-12) );
    ...
    TEST_CHECK( gkyl_compare_double(diff_corner[146], -0.006818263469524, 1e-12) );
    ...
    TEST_CHECK( gkyl_compare_double(diff_int[146], -0.000009080754942, 1e-10) );
  ...
  if ((poly_order == 2) && (NV == 8)) {
    ...
    TEST_CHECK( gkyl_compare_double(diff_corner[3], 0.000561896233836, 1e-12) );
    TEST_CHECK( gkyl_compare_double(diff_corner[4], 0.000561896233841, 1e-12) );
    ...
    TEST_CHECK( gkyl_compare_double(diff_corner[50], 0.000514210743318, 1e-12) );
    TEST_CHECK( gkyl_compare_double(diff_corner[51], -0.002534916638363, 1e-12) );
    ...
    TEST_CHECK( gkyl_compare_double(diff_corner[146], -0.002534916638374, 1e-12) );
    ...
    TEST_CHECK( gkyl_compare_double(diff_int[49], -0.000000000000000, 1e-12) );
    TEST_CHECK( gkyl_compare_double(diff_int[50], 0.001994932779555, 1e-12) );
    TEST_CHECK( gkyl_compare_double(diff_int[51], 0.001994932779561, 1e-12) );
