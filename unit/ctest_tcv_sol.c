...
test_1()
{
  ...
  gkyl_grid_sub_array_write(&rzgrid, &rzlocal, psizr, "tcvsol_psi.gkyl");
  gkyl_grid_sub_array_write(&rzgrid, &rzlocal, psibyrzr, "tcvsol_psibyr.gkyl");
  gkyl_grid_sub_array_write(&rzgrid, &rzlocal, psibyr2zr, "tcvsol_psibyr2.gkyl");
  gkyl_grid_sub_array_write(&fluxgrid, &fluxlocal, fpolflux, "tcvsol_fpol.gkyl");
  gkyl_grid_sub_array_write(&fluxgrid, &fluxlocal, qflux, "tcvsol_q.gkyl");
  ...
  double clower[] = { -0.02, -0.01, -3.14 };
  double cupper[] = {-0.01, 0.01, 3.14 };
