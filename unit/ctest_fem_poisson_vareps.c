...
//  gkyl_grid_sub_array_write(&grid, &localRange, phisol, "ctest_fem_poisson_vareps_2x_phisol_8x8_p1.gkyl");
//  gkyl_grid_sub_array_write(&grid, &localRange, phi,       "ctest_fem_poisson_vareps_2x_phi_8x8_p1.gkyl");
