...
typedef void (*dg_vlasov_alpha_gen_geof_t)(const double *w, const double *dxv, const double *tvComp, const double *gxx, const double *gxy, const double *gxz, const double *gyy, const double *gyz, const double *gzz, double* GKYL_RESTRICT alpha_geo);
