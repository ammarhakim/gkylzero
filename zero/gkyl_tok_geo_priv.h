...
*/
void set_ridders(struct gkyl_tok_geo_geo_inp* inp, struct arc_length_ctx* arc_ctx, double psi_curr, double arcL, double arcL_curr, double zmin, double zmax, double rright, double rleft, double* rclose, double *ridders_min, double* ridders_max);
