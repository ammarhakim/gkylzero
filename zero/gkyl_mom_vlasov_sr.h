 ...
 */
void gkyl_mom_vlasov_sr_set_auxfields(const struct gkyl_mom_type *eqn, struct gkyl_mom_vlasov_sr_auxfields auxin);
 ...
 * @param auxfields Pointer to struct of aux fields.
 */
void gkyl_mom_vlasov_sr_set_auxfields_cu(const struct gkyl_mom_type *eqn, struct gkyl_mom_vlasov_sr_auxfields auxin);
