  ...
  const int* idx, const double* qIn, double* GKYL_RESTRICT qRhsOut)
{
  ...
  return vlasov_pkpm_vol_1x1v_tensor_p2(xc, dx, 
    ...
    (const double*) gkyl_array_cfetch(vlasov_pkpm->auxfields.pkpm_u, cidx),
...
static const gkyl_dg_vlasov_pkpm_vol_kern_list ten_vol_kernels[] = {
  // 1x kernels
  { NULL, NULL, kernel_vlasov_pkpm_vol_1x1v_tensor_p2 }, // 0
  // 2x kernels
  { NULL, NULL, kernel_vlasov_pkpm_vol_2x1v_tensor_p2 }, // 1
  // 3x kernels
  { NULL, NULL, NULL }, // 2
};
...
static const gkyl_dg_vlasov_pkpm_stream_surf_kern_list ten_stream_surf_x_kernels[] = {
  // 1x kernels
  { NULL, NULL, vlasov_pkpm_surfx_1x1v_tensor_p2 }, // 0
  // 2x kernels
  { NULL, NULL, vlasov_pkpm_surfx_2x1v_tensor_p2 }, // 1
  // 3x kernels
  { NULL, NULL, NULL }, // 2
};
...
static const gkyl_dg_vlasov_pkpm_stream_surf_kern_list ten_stream_surf_y_kernels[] = {
  ...
  { NULL, NULL, NULL }, // 0
  // 2x kernels
  { NULL, NULL, vlasov_pkpm_surfy_2x1v_tensor_p2 }, // 1
  // 3x kernels
  { NULL, NULL, NULL }, // 2
};
...
static const gkyl_dg_vlasov_pkpm_accel_surf_kern_list ten_accel_surf_vpar_kernels[] = {
  // 1x kernels
  { NULL, NULL, vlasov_pkpm_surfvpar_1x1v_tensor_p2 }, // 0
  // 2x kernels
  { NULL, NULL, vlasov_pkpm_surfvpar_2x1v_tensor_p2 }, // 1
  // 3x kernels
  { NULL, NULL, NULL }, // 2
};
...
static const gkyl_dg_vlasov_pkpm_accel_boundary_surf_kern_list ten_accel_boundary_surf_vpar_kernels[] = {
  // 1x kernels
  { NULL, NULL, vlasov_pkpm_boundary_surfvpar_1x1v_tensor_p2 }, // 0
  // 2x kernels
  { NULL, NULL, vlasov_pkpm_boundary_surfvpar_2x1v_tensor_p2 }, // 1
  // 3x kernels
  { NULL, NULL, NULL }, // 2
};
  ...
  const double* qInL, const double*  qInC, const double*  qInR, double* GKYL_RESTRICT qRhsOut)
{
  ...
  if (dir < vlasov_pkpm->cdim) {
    ...
    return vlasov_pkpm->stream_surf[dir]
      ...
      (const double*) gkyl_array_cfetch(vlasov_pkpm->auxfields.pkpm_u_surf, cidx_l), 
      (const double*) gkyl_array_cfetch(vlasov_pkpm->auxfields.pkpm_u_surf, cidx), 
      (const double*) gkyl_array_cfetch(vlasov_pkpm->auxfields.pkpm_u_surf, cidx_r), 
      qInL, qInC, qInR, 
