  ...
  double cfl, double dt, double *rhs_d[])
{
  ...
  double qx = chi*bx*bx*(3.0*dTdx[T11] + dTdx[T22] + dTdx[T33])/6.0;
  double qy = chi*by*bx*(dTdx[T12])/3.0;
  double qz = chi*bz*bx*(dTdx[T13])/3.0;
  ...
  double cfl, double dt, double *rhs_d[])
{
  ...
  qx[LL_2D] = chi*bx*(3.0*bx*dTdx[compx[LL_2D]][T11] + bx*dTdx[compx[LL_2D]][T22]
    + bx*dTdx[compx[LL_2D]][T33] + 2.0*by*dTdy[compy[LL_2D]][T12])/6.0;
  qy[LL_2D] = chi*by*(3.0*by*dTdy[compy[LL_2D]][T22] + by*dTdy[compx[LL_2D]][T11]
    + by*dTdy[compx[LL_2D]][T33] + 2.0*bx*dTdx[compy[LL_2D]][T12])/6.0;
  qz[LL_2D] = chi*bz*(2.0*bx*dTdx[compx[LL_2D]][T13] + 2.0*by*dTdy[compy[LL_2D]][T23])/2.0;

  qx[LU_2D] = chi*bx*(3.0*bx*dTdx[compx[LU_2D]][T11] + bx*dTdx[compx[LU_2D]][T22]
    + bx*dTdx[compx[LU_2D]][T33] + 2.0*by*dTdy[compy[LU_2D]][T12])/6.0;
  qy[LU_2D] = chi*by*(3.0*by*dTdy[compy[LU_2D]][T22] + by*dTdy[compx[LU_2D]][T11]
    + by*dTdy[compx[LU_2D]][T33] + 2.0*bx*dTdx[compy[LU_2D]][T12])/6.0;
  qz[LU_2D] = chi*bz*(2.0*bx*dTdx[compx[LU_2D]][T13] + 2.0*by*dTdy[compy[LU_2D]][T23])/6.0;

  qx[UL_2D] = chi*bx*(3.0*bx*dTdx[compx[UL_2D]][T11] + bx*dTdx[compx[UL_2D]][T22]
    + bx*dTdx[compx[UL_2D]][T33] + 2.0*by*dTdy[compy[UL_2D]][T12])/6.0;
  qy[UL_2D] = chi*by*(3.0*by*dTdy[compy[UL_2D]][T22] + by*dTdy[compx[UL_2D]][T11]
    + by*dTdy[compx[UL_2D]][T33] + 2.0*bx*dTdx[compy[UL_2D]][T12])/6.0;
  qz[UL_2D] = chi*bz*(2.0*bx*dTdx[compx[UL_2D]][T13] + 2.0*by*dTdy[compy[UL_2D]][T23])/6.0;

  qx[UU_2D] = chi*bx*(3.0*bx*dTdx[compx[UU_2D]][T11] + bx*dTdx[compx[UU_2D]][T22]
    + bx*dTdx[compx[UU_2D]][T33] + 2.0*by*dTdy[compy[UU_2D]][T12])/6.0;
  qy[UU_2D] = chi*by*(3.0*by*dTdy[compy[UU_2D]][T22] + by*dTdy[compx[UU_2D]][T11]
    + by*dTdy[compx[UU_2D]][T33] + 2.0*bx*dTdx[compy[UU_2D]][T12])/6.0;
  qz[UU_2D] = chi*bz*(2.0*bx*dTdx[compx[UU_2D]][T13] + 2.0*by*dTdy[compy[UU_2D]][T23])/6.0;
  ...
  double cfl, double dt, double *rhs_d[])
{
  ...
  qx[LLL_3D] = chi*bx*(3.0*bx*dTdx[compx[LLL_3D]][T11] + bx*dTdx[compx[LLL_3D]][T22]
    + bx*dTdx[compx[LLL_3D]][T33] + 2.0*by*dTdy[compy[LLL_3D]][T12]
    + 2.0*bz*dTdz[compz[LLL_3D]][T13])/6.0;
  qy[LLL_3D] = chi*by*(by*dTdy[compy[LLL_3D]][T11] + 3.0*by*dTdy[compy[LLL_3D]][T22]
    + by*dTdy[compy[LLL_3D]][T33] + 2.0*bx*dTdx[compx[LLL_3D]][T12]
    + 2.0*bz*dTdz[compz[LLL_3D]][T23])/6.0;
  qz[LLL_3D] = chi*bz*(bz*dTdz[compz[LLL_3D]][T11] + bz*dTdz[compz[LLL_3D]][T22]
    + 3.0*bz*dTdz[compz[LLL_3D]][T33] + 2.0*bx*dTdx[compx[LLL_3D]][T13]
    + 2.0*by*dTdy[compy[LLL_3D]][T23])/6.0;

  qx[LLU_3D] = chi*bx*(3.0*bx*dTdx[compx[LLU_3D]][T11] + bx*dTdx[compx[LLU_3D]][T22]
    + bx*dTdx[compx[LLU_3D]][T33] + 2.0*by*dTdy[compy[LLU_3D]][T12]
    + 2.0*bz*dTdz[compz[LLU_3D]][T13])/6.0;
  qy[LLU_3D] = chi*by*(by*dTdy[compy[LLU_3D]][T11] + 3.0*by*dTdy[compy[LLU_3D]][T22]
    + by*dTdy[compy[LLU_3D]][T33] + 2.0*bx*dTdx[compx[LLU_3D]][T12]
    + 2.0*bz*dTdz[compz[LLU_3D]][T23])/6.0;
  qz[LLU_3D] = chi*bz*(bz*dTdz[compz[LLU_3D]][T11] + bz*dTdz[compz[LLU_3D]][T22]
    + 3.0*bz*dTdz[compz[LLU_3D]][T33] + 2.0*bx*dTdx[compx[LLU_3D]][T13]
    + 2.0*by*dTdy[compy[LLU_3D]][T23])/6.0;

  qx[LUL_3D] = chi*bx*(3.0*bx*dTdx[compx[LUL_3D]][T11] + bx*dTdx[compx[LUL_3D]][T22]
    + bx*dTdx[compx[LUL_3D]][T33] + 2.0*by*dTdy[compy[LUL_3D]][T12]
    + 2.0*bz*dTdz[compz[LUL_3D]][T13])/6.0;
  qy[LUL_3D] = chi*by*(by*dTdy[compy[LUL_3D]][T11] + 3.0*by*dTdy[compy[LUL_3D]][T22]
    + by*dTdy[compy[LUL_3D]][T33] + 2.0*bx*dTdx[compx[LUL_3D]][T12]
    + 2.0*bz*dTdz[compz[LUL_3D]][T23])/6.0;
  qz[LUL_3D] = chi*bz*(bz*dTdz[compz[LUL_3D]][T11] + bz*dTdz[compz[LUL_3D]][T22]
    + 3.0*bz*dTdz[compz[LUL_3D]][T33] + 2.0*bx*dTdx[compx[LUL_3D]][T13]
    + 2.0*by*dTdy[compy[LUL_3D]][T23])/6.0;

  qx[LUU_3D] = chi*bx*(3.0*bx*dTdx[compx[LUU_3D]][T11] + bx*dTdx[compx[LUU_3D]][T22]
    + bx*dTdx[compx[LUU_3D]][T33] + 2.0*by*dTdy[compy[LUU_3D]][T12]
    + 2.0*bz*dTdz[compz[LUU_3D]][T13])/6.0;
  qy[LUU_3D] = chi*by*(by*dTdy[compy[LUU_3D]][T11] + 3.0*by*dTdy[compy[LUU_3D]][T22]
    + by*dTdy[compy[LUU_3D]][T33] + 2.0*bx*dTdx[compx[LUU_3D]][T12]
    + 2.0*bz*dTdz[compz[LUU_3D]][T23])/6.0;
  qz[LUU_3D] = chi*bz*(bz*dTdz[compz[LUU_3D]][T11] + bz*dTdz[compz[LUU_3D]][T22]
    + 3.0*bz*dTdz[compz[LUU_3D]][T33] + 2.0*bx*dTdx[compx[LUU_3D]][T13]
    + 2.0*by*dTdy[compy[LUU_3D]][T23])/6.0;

  qx[ULL_3D] = chi*bx*(3.0*bx*dTdx[compx[ULL_3D]][T11] + bx*dTdx[compx[ULL_3D]][T22]
    + bx*dTdx[compx[ULL_3D]][T33] + 2.0*by*dTdy[compy[ULL_3D]][T12]
    + 2.0*bz*dTdz[compz[ULL_3D]][T13])/6.0;
  qy[ULL_3D] = chi*by*(by*dTdy[compy[ULL_3D]][T11] + 3.0*by*dTdy[compy[ULL_3D]][T22]
    + by*dTdy[compy[ULL_3D]][T33] + 2.0*bx*dTdx[compx[ULL_3D]][T12]
    + 2.0*bz*dTdz[compz[ULL_3D]][T23])/6.0;
  qz[ULL_3D] = chi*bz*(bz*dTdz[compz[ULL_3D]][T11] + bz*dTdz[compz[ULL_3D]][T22]
    + 3.0*bz*dTdz[compz[ULL_3D]][T33] + 2.0*bx*dTdx[compx[ULL_3D]][T13]
    + 2.0*by*dTdy[compy[ULL_3D]][T23])/6.0;

  qx[ULU_3D] = chi*bx*(3.0*bx*dTdx[compx[ULU_3D]][T11] + bx*dTdx[compx[ULU_3D]][T22]
    + bx*dTdx[compx[ULU_3D]][T33] + 2.0*by*dTdy[compy[ULU_3D]][T12]
    + 2.0*bz*dTdz[compz[ULU_3D]][T13])/6.0;
  qy[ULU_3D] = chi*by*(by*dTdy[compy[ULU_3D]][T11] + 3.0*by*dTdy[compy[ULU_3D]][T22]
    + by*dTdy[compy[ULU_3D]][T33] + 2.0*bx*dTdx[compx[ULU_3D]][T12]
    + 2.0*bz*dTdz[compz[ULU_3D]][T23])/6.0;
  qz[ULU_3D] = chi*bz*(bz*dTdz[compz[ULU_3D]][T11] + bz*dTdz[compz[ULU_3D]][T22]
    + 3.0*bz*dTdz[compz[ULU_3D]][T33] + 2.0*bx*dTdx[compx[ULU_3D]][T13]
    + 2.0*by*dTdy[compy[ULU_3D]][T23])/6.0;

  qx[UUL_3D] = chi*bx*(3.0*bx*dTdx[compx[UUL_3D]][T11] + bx*dTdx[compx[UUL_3D]][T22]
    + bx*dTdx[compx[UUL_3D]][T33] + 2.0*by*dTdy[compy[UUL_3D]][T12]
    + 2.0*bz*dTdz[compz[UUL_3D]][T13])/6.0;
  qy[UUL_3D] = chi*by*(by*dTdy[compy[UUL_3D]][T11] + 3.0*by*dTdy[compy[UUL_3D]][T22]
    + by*dTdy[compy[UUL_3D]][T33] + 2.0*bx*dTdx[compx[UUL_3D]][T12]
    + 2.0*bz*dTdz[compz[UUL_3D]][T23])/6.0;
  qz[UUL_3D] = chi*bz*(bz*dTdz[compz[UUL_3D]][T11] + bz*dTdz[compz[UUL_3D]][T22]
    + 3.0*bz*dTdz[compz[UUL_3D]][T33] + 2.0*bx*dTdx[compx[UUL_3D]][T13]
    + 2.0*by*dTdy[compy[UUL_3D]][T23])/6.0;

  qx[UUU_3D] = chi*bx*(3.0*bx*dTdx[compx[UUU_3D]][T11] + bx*dTdx[compx[UUU_3D]][T22]
    + bx*dTdx[compx[UUU_3D]][T33] + 2.0*by*dTdy[compy[UUU_3D]][T12]
    + 2.0*bz*dTdz[compz[UUU_3D]][T13])/6.0;
  qy[UUU_3D] = chi*by*(by*dTdy[compy[UUU_3D]][T11] + 3.0*by*dTdy[compy[UUU_3D]][T22]
    + by*dTdy[compy[UUU_3D]][T33] + 2.0*bx*dTdx[compx[UUU_3D]][T12]
    + 2.0*bz*dTdz[compz[UUU_3D]][T23])/6.0;
  qz[UUU_3D] = chi*bz*(bz*dTdz[compz[UUU_3D]][T11] + bz*dTdz[compz[UUU_3D]][T22]
    + 3.0*bz*dTdz[compz[UUU_3D]][T33] + 2.0*bx*dTdx[compx[UUU_3D]][T13]
    + 2.0*by*dTdy[compy[UUU_3D]][T23])/6.0;
