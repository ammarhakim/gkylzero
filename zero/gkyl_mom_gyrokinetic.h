...
gkyl_mom_gyrokinetic_new(const struct gkyl_basis* cbasis, 
  ...
  double mass, const struct gk_geometry *gk_geom, const char *mom, bool use_gpu);
...
gkyl_mom_gyrokinetic_cu_dev_new(const struct gkyl_basis* cbasis, 
  const struct gkyl_basis* pbasis, const struct gkyl_range* conf_range, 
  double mass, const struct gk_geometry *gk_geom, const char *mom);
...
gkyl_int_mom_gyrokinetic_cu_dev_new(const struct gkyl_basis* cbasis, 
  const struct gkyl_basis* pbasis, const struct gkyl_range* conf_range, 
  double mass, const struct gk_geometry *gk_geom);
