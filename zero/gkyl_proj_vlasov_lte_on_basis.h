...
// Object type
typedef struct gkyl_proj_vlasov_lte_on_basis gkyl_proj_vlasov_lte_on_basis;

// input packaged as a struct
struct gkyl_proj_vlasov_lte_inp {
 ...
 * Free using gkyl_proj_vlasov_lte_on_basis_release method.
 *
 * @param inp Input parameters defined in gkyl_proj_vlasov_lte_inp struct.
 ...
 */
void gkyl_proj_vlasov_lte_on_basis_advance(gkyl_proj_vlasov_lte_on_basis *proj_on_basis,
 ...
 */
void gkyl_proj_vlasov_lte_on_basis_advance_cu(gkyl_proj_vlasov_lte_on_basis *proj_on_basis,
  const struct gkyl_range *phase_range, const struct gkyl_range *conf_range,
  const struct gkyl_array *moms_lte, struct gkyl_array *f_lte);
 ...
 */
void gkyl_proj_vlasov_lte_on_basis_release(gkyl_proj_vlasov_lte_on_basis* pob);
