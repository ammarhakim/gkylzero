 ...
 */
static double
compute_sr_roe_avereged_velocity_via_ridders(const double ql[4], const double qr[4]) 
{
  ...
  } elseif ((uRx != 0.0 ) || (uLx != 0.0 )) && ((uRy != 0.0 ) || (uLy != 0.0 )) && ((uRz != 0.0 ) || (uLz != 0.0 )) {
