...
static void
proj_on_basis(const gkyl_proj_bimaxwellian_on_basis *up, const struct gkyl_array *fun_at_ords, double* f)
{
...
void
gkyl_proj_bimaxwellian_on_basis_gyrokinetic_lab_mom(const gkyl_proj_bimaxwellian_on_basis *up,
...
void
gkyl_proj_bimaxwellian_on_basis_gyrokinetic_prim_mom(const gkyl_proj_bimaxwellian_on_basis *up,
  const struct gkyl_range *phase_rng, const struct gkyl_range *conf_rng,
...
void
gkyl_proj_bimaxwellian_on_basis_release(gkyl_proj_bimaxwellian_on_basis* up)
{
#ifdef GKYL_HAVE_CUDA
  if (up->use_gpu)
