...
static void
iso_euler_wall(double t, double xc[3], int nc, const double *skin, double * GKYL_RESTRICT ghost, void *ctx)
{
  // copy density
  ghost[0] = skin[0];
...
static void
iso_euler_no_slip(double t, double xc[3], int nc, const double *skin, double * GKYL_RESTRICT ghost, void *ctx)
{
