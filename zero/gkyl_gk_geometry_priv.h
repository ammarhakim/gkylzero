...
gk_geometry_surf_alloc_nodal(struct gk_geometry* gk_geom, int dir)
{
  ...
  gk_geom->geo_surf[dir].normcurlbhat_nodal = gkyl_array_new(GKYL_DOUBLE, 3, gk_geom->nrange_surf[dir].volume);
  ...
  gk_geom->geo_surf[dir].lenr_nodal = gkyl_array_new(GKYL_DOUBLE, 3, gk_geom->nrange_surf[dir].volume);
}
