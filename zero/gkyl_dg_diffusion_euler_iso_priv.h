...
typedef double (*diffusion_euler_iso_vol_t)(const double* w, const double* dx,
...
typedef struct { diffusion_euler_iso_vol_t kernels[3]; } gkyl_dg_diffusion_euler_iso_vol_kern_list;
