...
/**
* Integrate the electromagnetic source terms in the multi-fluid equation system in each cell, using an implicit forcing solver (specifically
...
* @param nT_source_s Array of number density and temperature source terms.
*/
