 ...
 */
void gkyl_lbo_vlasov_diff_set_nuSum_cu(const struct gkyl_dg_eqn *eqn, const struct gkyl_array *nuSum);
 ...
 */
void gkyl_lbo_vlasov_diff_set_nuUSum_cu(const struct gkyl_dg_eqn *eqn, const struct gkyl_array *nuUSum);
 ...
 */
void gkyl_lbo_vlasov_diff_set_nuVtSqSum_cu(const struct gkyl_dg_eqn *eqn, const struct gkyl_array *nuVtSqSum);
