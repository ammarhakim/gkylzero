...
struct gk_geometry*
gkyl_gk_geometry_mirror_cu_dev_new(const struct gkyl_rect_grid* grid, const struct gkyl_range *local, const struct gkyl_range* local_ext,
      ...
      void* mirror_comp_ctx)
{
  ...
  struct gk_geometry *hgeo  = gkyl_gk_geometry_mirror_new(grid, local, local_ext, global, global_ext, basis, mirror_rz_ctx, mirror_comp_ctx, false);
