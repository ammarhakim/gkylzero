...
/**
* Raise or lower the indices of a rank-2 (spatial) tensor field using the value of the spatial metric tensor field at a given point in spacetime.
*
* @param spacetime Base spacetime object.
* @param t Time coordinate.
* @param x Spatial coordinate (x-direction).
...
* @param old_indices Array of current tensor indices (true for covariant, false for contravariant).
* @param new_indices Array of new tensor indices (true for covariant, false for contravariant).
* @param tensor Rank-2 (spatial) tensor field.
*/
GKYL_CU_D
double**
...
/**
* Raise or lower the indices of a rank-2 (spacetime) tensor field using the value of the spacetime metric tensor field at a given point in spacetime.
*
* @param spacetime Base spacetime object.
* @param t Time coordinate.
* @param x Spatial coordinate (x-direction).
...
* @param old_indices Array of current tensor indices (true for covariant, false for contravariant).
* @param new_indices Array of new tensor indices (true for covariant, false for contravariant).
* @param tensor Rank-2 (spacetime) tensor field.
*/
GKYL_CU_D
double**
...
/**
* Raise or lower the indices of a rank-3 (spatial) tensor field using the value of the spatial metric tensor field at a given point in spacetime.
*
* @param spacetime Base spacetime object.
* @param t Time coordinate.
* @param x Spatial coordinate (x-direction).
...
* @param old_indices Array of current tensor indices (true for covariant, false for contravariant).
* @param new_indices Array of new tensor indices (true for covariant, false for contravariant).
* @param tensor Rank-3 (spatial) tensor field.
*/
GKYL_CU_D
double***
...
/**
* Raise or lower the indices of a rank-3 (spacetime) tensor field using the value of the spacetime metric tensor field at a given point in spacetime.
*
* @param spacetime Base spacetime object.
* @param t Time coordinate.
* @param x Spatial coordinate (x-direction).
...
* @param old_indices Array of current tensor indices (true for covariant, false for contravariant).
* @param new_indices Array of new tensor indices (true for covariant, false for contravariant).
* @param tensor Rank-3 (spacetime) tensor field.
*/
GKYL_CU_D
double***
...
/**
* Compute the rank-3 covariant derivative of a rank-2 (spatial) tensor field using the values of the spatial Christoffel symbols at a given point in spacetime.
*
* @param spacetime Base spacetime object.
* @param t Time coordinate.
* @param x Spatial coordinate (x-direction).
...
* @param new_indices Array of tensor indices (true for covariant, false for contravariant).
* @param tensor Rank-2 (spatial) tensor field.
* @param tensor_der Rank-3 (spatial) partal derivative of the tensor field.
*/
GKYL_CU_D
double***
...
/**
* Compute the rank-3 covariant derivative of a rank-2 (spacetime) tensor field using the values of the spacetime Christoffel symbols at a given point in spacetime.
*
* @param spacetime Base spacetime object.
* @param t Time coordinate.
* @param x Spatial coordinate (x-direction).
