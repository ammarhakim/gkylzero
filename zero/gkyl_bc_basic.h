...
enum gkyl_bc_basic_type { 
  ...
  GKYL_BC_MAXWELL_RESERVOIR = 5, 
  GKYL_BC_FIXED_FUNC = 6,
  GKYL_BC_PKPM_SPECIES_REFLECT = 7,  
  GKYL_BC_PKPM_MOM_REFLECT = 8, 
  GKYL_BC_PKPM_MOM_LINE_TIED = 9, 
  GKYL_BC_PKPM_MOM_NO_SLIP = 10,
  GKYL_BC_EULER_REFLECT = 11, 
  GKYL_BC_EULER_LINE_TIED = 12, 
  GKYL_BC_EULER_NO_SLIP = 13,
};
