...
// Object type
typedef struct gkyl_fem_poisson_vareps gkyl_fem_poisson_vareps;
 ...
 * assuming epsilon is a spatially varying symmetric tensor,
 ...
 * Free using gkyl_fem_poisson_vareps_release method.
 *
 * @param grid Grid object
 * @param basis Basis functions of the DG field.
 * @param bcs Boundary conditions.
 * @param epsilon Entries in permittivity tensor (spatially varying). Assummed
                  symmetric and only unique entries are provided (e.g. eps^xx, eps^xy, eps^yy).
 * @param use_gpu boolean indicating whether to use the GPU.
 * @return New updater pointer.
 */
gkyl_fem_poisson_vareps* gkyl_fem_poisson_vareps_new(
 ...
 */
void gkyl_fem_poisson_vareps_set_rhs(gkyl_fem_poisson_vareps* up, struct gkyl_array *rhsin);

void gkyl_fem_poisson_vareps_set_rhs_cu(gkyl_fem_poisson_vareps *up, struct gkyl_array *rhsin);
 ...
 */
void gkyl_fem_poisson_vareps_solve(gkyl_fem_poisson_vareps* up, struct gkyl_array *phiout);

void gkyl_fem_poisson_vareps_solve_cu(gkyl_fem_poisson_vareps* up, struct gkyl_array *phiout);
