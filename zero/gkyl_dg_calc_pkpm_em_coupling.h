 ...
 * Solves the linear system for num_species number of current density equations and Ampere's Law:
 * 
 * J_s^{n+1} - 0.5*dt*(q_s/m_s*rho_s^n*E^{n+1} + q_s/m_s*J_s^{n+1} x B^n) = J_s^n + ext_forces
