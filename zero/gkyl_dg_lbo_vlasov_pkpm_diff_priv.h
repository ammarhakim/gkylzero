...
static const gkyl_dg_lbo_vlasov_pkpm_diff_vol_kern_list ser_vol_kernels[] = {
  // 1x kernels
  { NULL, NULL, lbo_vlasov_pkpm_diff_vol_1x1v_ser_p2, lbo_vlasov_pkpm_diff_vol_1x1v_ser_p3 }, // 0
  // 2x kernels
  { NULL, NULL, lbo_vlasov_pkpm_diff_vol_2x1v_ser_p2, NULL }, // 1
  // 3x kernels
  { NULL, NULL, lbo_vlasov_pkpm_diff_vol_3x1v_ser_p2, NULL }, // 2
};
...
static const gkyl_dg_lbo_vlasov_pkpm_diff_surf_kern_list ser_surf_vpar_kernels[] = {
  // 1x kernels
  { NULL, NULL, lbo_vlasov_pkpm_diff_surfvpar_1x1v_ser_p2, lbo_vlasov_pkpm_diff_surfvpar_1x1v_ser_p3 }, // 0
  // 2x kernels
  { NULL, NULL, lbo_vlasov_pkpm_diff_surfvpar_2x1v_ser_p2, NULL }, // 1
  // 3x kernels
  { NULL, NULL, lbo_vlasov_pkpm_diff_surfvpar_3x1v_ser_p2, NULL }, // 2
};
...
static const gkyl_dg_lbo_vlasov_pkpm_diff_boundary_surf_kern_list ser_boundary_surf_vpar_kernels[] = {
  // 1x kernels
  { NULL, NULL, lbo_vlasov_pkpm_diff_boundary_surfvpar_1x1v_ser_p2, lbo_vlasov_pkpm_diff_boundary_surfvpar_1x1v_ser_p3 }, // 0
  // 2x kernels
  { NULL, NULL, lbo_vlasov_pkpm_diff_boundary_surfvpar_2x1v_ser_p2, NULL }, // 1
  // 3x kernels
  { NULL, NULL, lbo_vlasov_pkpm_diff_boundary_surfvpar_3x1v_ser_p2, NULL }, // 2
};
