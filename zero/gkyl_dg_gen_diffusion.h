...
struct gkyl_dg_gen_diffusion_auxfields { 
 ...
 */
struct gkyl_dg_eqn* gkyl_dg_gen_diffusion_new(const struct gkyl_basis* cbasis, const struct gkyl_range* conf_range, bool use_gpu);
 ...
 * @return Pointer to generic diffusion equation object
 */
struct gkyl_dg_eqn* gkyl_dg_gen_diffusion_cu_dev_new(const struct gkyl_basis* cbasis, const struct gkyl_range* conf_range);
 ...
 */
void gkyl_gen_diffusion_set_auxfields(const struct gkyl_dg_eqn* eqn, struct gkyl_dg_gen_diffusion_auxfields auxin);
 ...
 * @param auxfields Pointer to struct of aux fields.
 */
void gkyl_gen_diffusion_set_auxfields_cu(const struct gkyl_dg_eqn *eqn, struct gkyl_dg_gen_diffusion_auxfields auxin);
