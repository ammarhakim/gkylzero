...
furman_pivi_set_cu_dev_ptrs(struct gkyl_yield_furman_pivi *model)
{
  model->yield.function = furman_pivi_yield;
}

__global__ static void
schou_set_cu_dev_ptrs(struct gkyl_yield_schou *model)
{
  model->yield.function = schou_yield;
}

__global__ static void
constant_set_cu_dev_ptrs(struct gkyl_yield_constant *model)
{
  ...
  double t3, double t4, double s)
{
  ...
  struct gkyl_yield_furman_pivi *model_cu = (struct gkyl_yield_furman_pivi*)
    gkyl_cu_malloc(sizeof(struct gkyl_yield_furman_pivi));
  gkyl_cu_memcpy(model_cu, model, sizeof(struct gkyl_yield_furman_pivi), GKYL_CU_MEMCPY_H2D);
...
gkyl_yield_schou_cu_dev_new(double charge, double int_wall, double a2, double a3, double a4, double a5, double nw)
{
  ...
  struct gkyl_yield_schou *model_cu = (struct gkyl_yield_schou*)
    gkyl_cu_malloc(sizeof(struct gkyl_yield_schou));
  gkyl_cu_memcpy(model_cu, model, sizeof(struct gkyl_yield_schou), GKYL_CU_MEMCPY_H2D);
...
gkyl_yield_constant_cu_dev_new(double charge, double delta)
{
  ...
  struct gkyl_yield_constant *model_cu = (struct gkyl_yield_constant*)
    gkyl_cu_malloc(sizeof(struct gkyl_yield_constant));
  gkyl_cu_memcpy(model_cu, model, sizeof(struct gkyl_yield_constant), GKYL_CU_MEMCPY_H2D);
