...
{                                                           
  ...
  for (size_t i=0; i<NELM(out,double); ++i)                   
    out_d[i] = val;                                         
  return out;                                               
}
...
struct gkyl_array*                                                  
gkyl_array_clear_range(struct gkyl_array *out,               
  double val, const struct gkyl_range *range)                         
{                                                                   
  long n = NCOM(out, double);                                         
...
{                                                                   
  ...
  long outnc = NCOM(out, double), inpnc = NCOM(inp, double);            
