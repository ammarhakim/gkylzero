...
#include <gkyl_bc_average_flux_priv.h>
#include <gkyl_alloc.h>
#include <assert.h>

struct gkyl_bc_average_flux*
gkyl_bc_average_flux_new(int dir, enum gkyl_edge_loc edge, const struct gkyl_basis *basis,
  ...
  int cdim, bool use_gpu)
{
  ...
  struct gkyl_bc_average_flux *up = gkyl_malloc(sizeof(*up));
  ...
  // reflection.
  up->kernels = gkyl_malloc(sizeof(struct gkyl_bc_average_flux_kernels));
// #ifdef GKYL_HAVE_CUDA
//   if (use_gpu) {
//     up->kernels_cu = gkyl_cu_malloc(sizeof(struct gkyl_bc_average_flux_kernels));
...
void
gkyl_bc_average_flux_advance(const struct gkyl_bc_average_flux *up, const struct gkyl_array *buff,
  struct gkyl_array *distf)
{
// #ifdef GKYL_HAVE_CUDA
//   if (up->use_gpu) {
//     gkyl_bc_average_flux_advance_cu(up, phi, phi_wall, distf, conf_r);
//     return;
//   }
// #endif
