...
#include <gkyl_mom_bcorr_lbo_vlasov_pkpm_priv.h>
}
  ...
  const double *vBoundary, double mass)
{
  ...
  struct mom_type_bcorr_lbo_vlasov_pkpm *mom_bcorr = (struct mom_type_bcorr_lbo_vlasov_pkpm*) gkyl_malloc(sizeof(struct mom_type_bcorr_lbo_vlasov_pkpm));
  ...
  struct mom_type_bcorr_lbo_vlasov_pkpm *mom_bcorr_cu = (struct mom_type_bcorr_lbo_vlasov_pkpm*)
    gkyl_cu_malloc(sizeof(struct mom_type_bcorr_lbo_vlasov_pkpm));
  gkyl_cu_memcpy(mom_bcorr_cu, mom_bcorr, sizeof(struct mom_type_bcorr_lbo_vlasov_pkpm), GKYL_CU_MEMCPY_H2D);


  gkyl_mom_bcorr_lbo_vlasov_pkpm_set_cu_dev_ptrs<<<1,1>>>(mom_bcorr_cu, cbasis->b_type, cdim, poly_order);
