 ...
 */
struct gk_geometry* gkyl_gk_geometry_mirror_new(const struct gkyl_rect_grid* grid, const struct gkyl_range *range,
...
struct gk_geometry* gkyl_gk_geometry_mirror_cu_dev_new(const struct gkyl_rect_grid* grid, const struct gkyl_range *range,
    const struct gkyl_range* range_ext, const struct gkyl_range *global, const struct gkyl_range* global_ext,
