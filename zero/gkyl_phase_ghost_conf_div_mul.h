...
// Object type.
typedef struct gkyl_phase_ghost_conf_div_mul gkyl_phase_ghost_conf_div_mul;
 ...
 * @return New phase_ghost_conf_div_mul updater. 
 */
struct gkyl_phase_ghost_conf_div_mul* gkyl_phase_ghost_conf_div_mul_new(const struct gkyl_basis *conf_basis,
  const struct gkyl_basis *phase_basis, bool use_gpu);

/**
 * Run the phase_ghost_conf_div_mul updater.
 *
 * @param up Updater of type phase_ghost_conf_div_mul. 
 ...
 */
void gkyl_phase_ghost_conf_div_mul_advance(const struct gkyl_phase_ghost_conf_div_mul *up,
...
/**
 * Release the memory associated with phase_ghost_conf_div_mul updater.
 *
 * @param up Updater of type phase_ghost_conf_div_mul. 
 */
void gkyl_phase_ghost_conf_div_mul_release(struct gkyl_phase_ghost_conf_div_mul *up);
