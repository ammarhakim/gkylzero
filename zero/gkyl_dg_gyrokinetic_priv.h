...
typedef double (*gyrokinetic_vol_t)(const double *w, const double *dxv, const double q_, const double m_,
  ...
  const double *phi, const double *apar, const double* apardot, const double *f, double* GKYL_RESTRICT out);
...
typedef struct { gyrokinetic_vol_t kernels[3]; } gkyl_dg_gyrokinetic_vol_kern_list;
...
// Volume kernel list.
GKYL_CU_D
static const gkyl_dg_gyrokinetic_vol_kern_list ten_vol_kernels[] = {
  // 1x kernels
  { NULL, gyrokinetic_vol_1x1v_tensor_p1, gyrokinetic_vol_1x1v_tensor_p2 }, // 0
  { NULL, gyrokinetic_vol_1x2v_tensor_p1, gyrokinetic_vol_1x2v_tensor_p2 }, // 1
  // 2x kernels
  { NULL, NULL, NULL }, // 2
  // 3x kernels
  { NULL, NULL, NULL }, // 3
...
// Step 2 (for electromagnetics) volume kernel list.
GKYL_CU_D
static const gkyl_dg_gyrokinetic_step2_vol_kern_list ten_step2_vol_kernels[] = {
  // 1x kernels
  { NULL, gyrokinetic_step2_vol_1x1v_tensor_p1, gyrokinetic_step2_vol_1x1v_tensor_p2 }, // 0
  { NULL, gyrokinetic_step2_vol_1x2v_tensor_p1, gyrokinetic_step2_vol_1x2v_tensor_p2 }, // 1
  // 2x kernels
  { NULL, NULL, NULL }, // 2
  // 3x kernels
  { NULL, NULL, NULL }, // 3
...
// Surface kernel list: x-direction
GKYL_CU_D
static const gkyl_dg_gyrokinetic_surf_kern_list ten_surf_x_kernels[] = {
  // 1x kernels
  { NULL, gyrokinetic_surfx_1x1v_tensor_p1, gyrokinetic_surfx_1x1v_tensor_p2 }, // 0
  { NULL, gyrokinetic_surfx_1x2v_tensor_p1, gyrokinetic_surfx_1x2v_tensor_p2 }, // 1
  // 2x kernels
  { NULL, NULL, NULL }, // 2
  // 3x kernels
  { NULL, NULL, NULL }, // 3
...
// Surface kernel list: y-direction
GKYL_CU_D
static const gkyl_dg_gyrokinetic_surf_kern_list ten_surf_y_kernels[] = {
  // 1x kernels
  { NULL, NULL, NULL }, // 0
  { NULL, NULL, NULL }, // 1
  // 2x kernels
...
// Surface kernel list: z-direction
GKYL_CU_D
static const gkyl_dg_gyrokinetic_surf_kern_list ten_surf_z_kernels[] = {
  // 1x kernels
  { NULL, NULL, NULL }, // 0
  { NULL, NULL, NULL }, // 1
  // 2x kernels
...
// Acceleration surface kernel list: vpar-direction
GKYL_CU_D
static const gkyl_dg_gyrokinetic_surf_kern_list ten_surf_vpar_kernels[] = {
  // 1x kernels
  { NULL, gyrokinetic_surfvpar_1x1v_tensor_p1, gyrokinetic_surfvpar_1x1v_tensor_p2 }, // 0
  { NULL, gyrokinetic_surfvpar_1x2v_tensor_p1, gyrokinetic_surfvpar_1x2v_tensor_p2 }, // 1
  // 2x kernels
  { NULL, NULL, NULL }, // 2
  // 3x kernels
  { NULL, NULL, NULL }, // 3
...
// Acceleration boundary surface kernel (zero-flux BCs) list: vpar-direction
GKYL_CU_D
static const gkyl_dg_gyrokinetic_boundary_surf_kern_list ten_boundary_surf_vpar_kernels[] = {
  // 1x kernels
  { NULL, gyrokinetic_boundary_surfvpar_1x1v_tensor_p1, gyrokinetic_boundary_surfvpar_1x1v_tensor_p2 }, // 0
  { NULL, gyrokinetic_boundary_surfvpar_1x2v_tensor_p1, gyrokinetic_boundary_surfvpar_1x2v_tensor_p2 }, // 1
  // 2x kernels
  { NULL, NULL, NULL }, // 2
  // 3x kernels
  { NULL, NULL, NULL }, // 3
...
struct dg_gyrokinetic {
  ...
  gyrokinetic_vol_t vol; // Volume kernel.
