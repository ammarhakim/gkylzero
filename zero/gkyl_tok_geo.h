...
void gkyl_tok_geo_calc(struct gk_geometry* up, struct gkyl_range *nrange, double dzc[3], 
  ...
  struct gkyl_array *mc2p_nodal, struct gkyl_array *mc2p, struct gkyl_array *ddalpha_nodal,
  struct gkyl_array *ddtheta_nodal, struct gkyl_array *mc2nu_nodal, struct gkyl_array *mc2nu_pos,
