...
GKYL_CU_DH
static void
kernel_gyrokinetic_hamiltonian_moment_1x1v_ser_p1(const struct gkyl_mom_type *momt, const double *xc, const double *dx,
  const int *idx, const double *f, double* out, void *param)
{
  struct mom_type_gyrokinetic *mom_gk = container_of(momt, struct mom_type_gyrokinetic, momt);
  ...
  long cidx = gkyl_range_idx(&mom_gk->conf_range, idx);
  long vidx = gkyl_range_idx(&mom_gk->vel_map->local_vel, idx_vel);
  return gyrokinetic_hamiltonian_moment_1x1v_ser_p1(dx,
...
GKYL_CU_DH
static void
kernel_gyrokinetic_hamiltonian_moment_1x2v_ser_p1(const struct gkyl_mom_type *momt, const double *xc, const double *dx,
  const int *idx, const double *f, double* out, void *param)
{
  struct mom_type_gyrokinetic *mom_gk = container_of(momt, struct mom_type_gyrokinetic, momt);
  ...
  long cidx = gkyl_range_idx(&mom_gk->conf_range, idx);
  long vidx = gkyl_range_idx(&mom_gk->vel_map->local_vel, idx_vel);
  return gyrokinetic_hamiltonian_moment_1x2v_ser_p1(dx,
    (const double*) gkyl_array_cfetch(mom_gk->vel_map->vmap, vidx), mom_gk->mass, mom_gk->charge,
    (const double*) gkyl_array_cfetch(mom_gk->gk_geom->bmag, cidx), 
    (const double*) gkyl_array_cfetch(mom_gk->phi, cidx), f, out);  
}
...
GKYL_CU_DH
static void
kernel_gyrokinetic_hamiltonian_moment_2x2v_ser_p1(const struct gkyl_mom_type *momt, const double *xc, const double *dx,
  const int *idx, const double *f, double* out, void *param)
{
  struct mom_type_gyrokinetic *mom_gk = container_of(momt, struct mom_type_gyrokinetic, momt);
  ...
  long cidx = gkyl_range_idx(&mom_gk->conf_range, idx);
  long vidx = gkyl_range_idx(&mom_gk->vel_map->local_vel, idx_vel);
  return gyrokinetic_hamiltonian_moment_2x2v_ser_p1(dx,
    (const double*) gkyl_array_cfetch(mom_gk->vel_map->vmap, vidx), mom_gk->mass, mom_gk->charge,
    (const double*) gkyl_array_cfetch(mom_gk->gk_geom->bmag, cidx), 
    (const double*) gkyl_array_cfetch(mom_gk->phi, cidx), f, out);  
}
...
GKYL_CU_DH
static void
kernel_gyrokinetic_hamiltonian_moment_3x2v_ser_p1(const struct gkyl_mom_type *momt, const double *xc, const double *dx,
  const int *idx, const double *f, double* out, void *param)
{
  struct mom_type_gyrokinetic *mom_gk = container_of(momt, struct mom_type_gyrokinetic, momt);
  ...
  long cidx = gkyl_range_idx(&mom_gk->conf_range, idx);
  long vidx = gkyl_range_idx(&mom_gk->vel_map->local_vel, idx_vel);
  return gyrokinetic_hamiltonian_moment_3x2v_ser_p1(dx,
    (const double*) gkyl_array_cfetch(mom_gk->vel_map->vmap, vidx), mom_gk->mass, mom_gk->charge,
    (const double*) gkyl_array_cfetch(mom_gk->gk_geom->bmag, cidx), 
    (const double*) gkyl_array_cfetch(mom_gk->phi, cidx), f, out);  
}
...
GKYL_CU_DH
static void
kernel_gyrokinetic_hamiltonian_moment_1x1v_ser_p2(const struct gkyl_mom_type *momt, const double *xc, const double *dx,
  const int *idx, const double *f, double* out, void *param)
{
  struct mom_type_gyrokinetic *mom_gk = container_of(momt, struct mom_type_gyrokinetic, momt);
  ...
  long cidx = gkyl_range_idx(&mom_gk->conf_range, idx);
  long vidx = gkyl_range_idx(&mom_gk->vel_map->local_vel, idx_vel);
  return gyrokinetic_hamiltonian_moment_1x1v_ser_p2(dx,
    (const double*) gkyl_array_cfetch(mom_gk->vel_map->vmap, vidx), mom_gk->mass, mom_gk->charge,
    (const double*) gkyl_array_cfetch(mom_gk->gk_geom->bmag, cidx), 
    (const double*) gkyl_array_cfetch(mom_gk->phi, cidx), f, out);  
}
...
GKYL_CU_DH
static void
kernel_gyrokinetic_hamiltonian_moment_1x2v_ser_p2(const struct gkyl_mom_type *momt, const double *xc, const double *dx,
  const int *idx, const double *f, double* out, void *param)
{
  struct mom_type_gyrokinetic *mom_gk = container_of(momt, struct mom_type_gyrokinetic, momt);
  ...
  long cidx = gkyl_range_idx(&mom_gk->conf_range, idx);
  long vidx = gkyl_range_idx(&mom_gk->vel_map->local_vel, idx_vel);
  return gyrokinetic_hamiltonian_moment_1x2v_ser_p2(dx,
    (const double*) gkyl_array_cfetch(mom_gk->vel_map->vmap, vidx), mom_gk->mass, mom_gk->charge,
    (const double*) gkyl_array_cfetch(mom_gk->gk_geom->bmag, cidx), 
    (const double*) gkyl_array_cfetch(mom_gk->phi, cidx), f, out);  
}
...
GKYL_CU_DH
static void
kernel_gyrokinetic_hamiltonian_moment_2x2v_ser_p2(const struct gkyl_mom_type *momt, const double *xc, const double *dx,
  const int *idx, const double *f, double* out, void *param)
{
  struct mom_type_gyrokinetic *mom_gk = container_of(momt, struct mom_type_gyrokinetic, momt);
  ...
  long cidx = gkyl_range_idx(&mom_gk->conf_range, idx);
  long vidx = gkyl_range_idx(&mom_gk->vel_map->local_vel, idx_vel);
  return gyrokinetic_hamiltonian_moment_2x2v_ser_p2(dx,
    (const double*) gkyl_array_cfetch(mom_gk->vel_map->vmap, vidx), mom_gk->mass, mom_gk->charge,
    (const double*) gkyl_array_cfetch(mom_gk->gk_geom->bmag, cidx), 
    (const double*) gkyl_array_cfetch(mom_gk->phi, cidx), f, out);  
}
...
GKYL_CU_D
static const gkyl_gyrokinetic_mom_kern_list ser_hamiltonian_moment_kernels[] = {
  // 1x kernels
  { NULL, kernel_gyrokinetic_hamiltonian_moment_1x1v_ser_p1, kernel_gyrokinetic_hamiltonian_moment_1x1v_ser_p2 }, // 0
  { NULL, kernel_gyrokinetic_hamiltonian_moment_1x2v_ser_p1, kernel_gyrokinetic_hamiltonian_moment_1x2v_ser_p2 }, // 1
  // 2x kernels
  { NULL, kernel_gyrokinetic_hamiltonian_moment_2x2v_ser_p1, kernel_gyrokinetic_hamiltonian_moment_2x2v_ser_p2 }, // 2
  // 3x kernels
  { NULL, kernel_gyrokinetic_hamiltonian_moment_3x2v_ser_p1, NULL }, // 3
};
