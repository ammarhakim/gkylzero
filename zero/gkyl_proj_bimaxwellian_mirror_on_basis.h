...
// Object type
typedef struct gkyl_proj_bimaxwellian_mirror_on_basis gkyl_proj_bimaxwellian_mirror_on_basis;

/**
 * Create new updater to project a bimaxwellian_mirror on basis functions.
 * Free using gkyl_proj_bimaxwellian_mirror_on_basis_release method.
 *
 ...
 */
gkyl_proj_bimaxwellian_mirror_on_basis* gkyl_proj_bimaxwellian_mirror_on_basis_new(
 ...
 */
void gkyl_proj_bimaxwellian_mirror_on_basis_gyrokinetic_lab_mom(const gkyl_proj_bimaxwellian_mirror_on_basis *up,
 ...
 * @param fmax Output Maxwellian
 */
void gkyl_proj_bimaxwellian_mirror_on_basis_gyrokinetic_prim_mom(const gkyl_proj_bimaxwellian_mirror_on_basis *up,
  const struct gkyl_range *phase_rng, const struct gkyl_range *conf_rng,
 ...
 */
void gkyl_proj_bimaxwellian_mirror_on_basis_release(gkyl_proj_bimaxwellian_mirror_on_basis *up);
