 ...
 * @param range A gkyl_range over which to perform the reduction.
 */
void gkyl_array_reduce_range_min_cu(double *out_d, const struct gkyl_array* inp, struct gkyl_range range);
 ...
 * @param range A gkyl_range over which to perform the reduction.
 */
void gkyl_array_reduce_range_sum_cu(double *out_d, const struct gkyl_array* inp, struct gkyl_range range);
