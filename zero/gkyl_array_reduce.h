 ...
 * @param basis Baisis DG coefficients expand in (device pointer).
 */
void gkyl_array_reducec_dg_range_max_cu(double *out_d, const struct gkyl_array* inp,
 ...
 * @param basis Baisis DG coefficients expand in (device pointer).
 */
void gkyl_array_reducec_dg_range_min_cu(double *out_d, const struct gkyl_array* inp,
  int comp, const struct gkyl_basis *basis, const struct gkyl_range *range);
 ...
 * @param basis Baisis DG coefficients expand in (device pointer).
 */
void gkyl_array_reducec_dg_range_sum_cu(double *out_d, const struct gkyl_array* inp,
  int comp, const struct gkyl_basis *basis, const struct gkyl_range *range);
