...
(require "../prover_core.rkt")
 ...
 (prove-lax-friedrichs-scalar-1d-hyperbolicity '#hash((cons-expr . u) (flux-expr . (* a u)) (max-speed-expr . (abs a)) (name . "advect") (parameters . ((define a 1.0)))) #:cfl 0.95 #:init-func '(cond ((< x 1.0) 1.0) (else 0.0)) #:nx 200 #:t-final 0.5 #:x0 0.0 #:x1 2.0)
