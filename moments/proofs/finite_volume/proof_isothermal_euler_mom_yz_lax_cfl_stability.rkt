...
(require "../prover_vector.rkt")
 ...
 (prove-lax-friedrichs-vector2-1d-cfl-stability '#hash((cons-exprs . (mom_y mom_z)) (flux-exprs . ((* mom_y u) (* mom_z u))) (max-speed-exprs . ((abs u) (abs u))) (name . "isothermal-euler-mom-yz") (parameters . ((define u 0.0)))) #:cfl 0.95 #:init-funcs '(0.0 0.0) #:nx 200 #:t-final 0.1 #:x0 0.0 #:x1 1.0)
  ...
  (symbolic-simp '(abs u))
   ...
   '(abs u)
  '(abs u)
  (symbolic-simp '(abs (* 0.5 (+ (- u (sqrt (+ (* 4.0 0.0 0.0) (* (- u u) (- u u))))) u))))
   (symbolic-simp-rule '(abs (* 0.5 (+ (- u (sqrt (+ (* 4.0 0.0 0.0) (* (- u u) (- u u))))) u))))
    (symbolic-simp-rule '(* 0.5 (+ (- u (sqrt (+ (* 4.0 0.0 0.0) (* (- u u) (- u u))))) u)))
    '(+ (* 0.5 (- u (sqrt (+ (* 4.0 0.0 0.0) (* (- u u) (- u u)))))) (* 0.5 u))
   '(abs (+ (* 0.5 (- u (sqrt (+ (* 4.0 0.0 0.0) (* (- u u) (- u u)))))) (* 0.5 u)))
  (symbolic-simp '(abs (+ (* 0.5 (- u (sqrt (+ (* 4.0 0.0 0.0) (* (- u u) (- u u)))))) (* 0.5 u))))
   (symbolic-simp-rule '(abs (+ (* 0.5 (- u (sqrt (+ (* 4.0 0.0 0.0) (* (- u u) (- u u)))))) (* 0.5 u))))
   ...
   '(abs (+ (* 0.5 (- u (sqrt (+ (* (* 4.0 0.0) 0.0) (- (+ (* u u) (* u u)) (* 2.0 (* u u))))))) (* 0.5 u)))
  (symbolic-simp '(abs (+ (* 0.5 (- u (sqrt (+ (* (* 4.0 0.0) 0.0) (- (+ (* u u) (* u u)) (* 2.0 (* u u))))))) (* 0.5 u))))
   (symbolic-simp-rule '(abs (+ (* 0.5 (- u (sqrt (+ (* (* 4.0 0.0) 0.0) (- (+ (* u u) (* u u)) (* 2.0 (* u u))))))) (* 0.5 u))))
   ...
   '(abs (+ (* 0.5 (- u (sqrt (+ (* 4.0 (* 0.0 0.0)) (- (* (+ u u) u) (* 2.0 (* u u))))))) (* 0.5 u)))
  (symbolic-simp '(abs (+ (* 0.5 (- u (sqrt (+ (* 4.0 (* 0.0 0.0)) (- (* (+ u u) u) (* 2.0 (* u u))))))) (* 0.5 u))))
   (symbolic-simp-rule '(abs (+ (* 0.5 (- u (sqrt (+ (* 4.0 (* 0.0 0.0)) (- (* (+ u u) u) (* 2.0 (* u u))))))) (* 0.5 u))))
   ...
   '(abs (+ (* 0.5 (- u (sqrt (+ (* 0.0 0.0) (- (* (* 2.0 u) u) (* 2.0 (* u u))))))) (* 0.5 u)))
  (symbolic-simp '(abs (+ (* 0.5 (- u (sqrt (+ (* 0.0 0.0) (- (* (* 2.0 u) u) (* 2.0 (* u u))))))) (* 0.5 u))))
   (symbolic-simp-rule '(abs (+ (* 0.5 (- u (sqrt (+ (* 0.0 0.0) (- (* (* 2.0 u) u) (* 2.0 (* u u))))))) (* 0.5 u))))
   ...
   '(abs (+ (* 0.5 (- u (sqrt (+ 0.0 (- (* 2.0 (* u u)) (* 2.0 (* u u))))))) (* 0.5 u)))
  (symbolic-simp '(abs (+ (* 0.5 (- u (sqrt (+ 0.0 (- (* 2.0 (* u u)) (* 2.0 (* u u))))))) (* 0.5 u))))
   (symbolic-simp-rule '(abs (+ (* 0.5 (- u (sqrt (+ 0.0 (- (* 2.0 (* u u)) (* 2.0 (* u u))))))) (* 0.5 u))))
   ...
   '(abs (+ (* 0.5 (- u (sqrt (- (* 2.0 (* u u)) (* 2.0 (* u u)))))) (* 0.5 u)))
  (symbolic-simp '(abs (+ (* 0.5 (- u (sqrt (- (* 2.0 (* u u)) (* 2.0 (* u u)))))) (* 0.5 u))))
   (symbolic-simp-rule '(abs (+ (* 0.5 (- u (sqrt (- (* 2.0 (* u u)) (* 2.0 (* u u)))))) (* 0.5 u))))
   ...
   '(abs (+ (* 0.5 (- u (sqrt (* (- 2.0 2.0) (* u u))))) (* 0.5 u)))
  (symbolic-simp '(abs (+ (* 0.5 (- u (sqrt (* (- 2.0 2.0) (* u u))))) (* 0.5 u))))
   (symbolic-simp-rule '(abs (+ (* 0.5 (- u (sqrt (* (- 2.0 2.0) (* u u))))) (* 0.5 u))))
   ...
   '(abs (+ (* 0.5 (- u (* (sqrt (- 2.0 2.0)) (sqrt (* u u))))) (* 0.5 u)))
  (symbolic-simp '(abs (+ (* 0.5 (- u (* (sqrt (- 2.0 2.0)) (sqrt (* u u))))) (* 0.5 u))))
   (symbolic-simp-rule '(abs (+ (* 0.5 (- u (* (sqrt (- 2.0 2.0)) (sqrt (* u u))))) (* 0.5 u))))
   ...
   '(abs (+ (* 0.5 (- u (* (sqrt 0.0) u))) (* 0.5 u)))
  (symbolic-simp '(abs (+ (* 0.5 (- u (* (sqrt 0.0) u))) (* 0.5 u))))
   (symbolic-simp-rule '(abs (+ (* 0.5 (- u (* (sqrt 0.0) u))) (* 0.5 u))))
    (symbolic-simp-rule '(+ (* 0.5 (- u (* (sqrt 0.0) u))) (* 0.5 u)))
     ...
     '(* 0.5 u)
    '(+ (* 0.5 (- u (* 0.0 u))) (* 0.5 u))
   '(abs (+ (* 0.5 (- u (* 0.0 u))) (* 0.5 u)))
  (symbolic-simp '(abs (+ (* 0.5 (- u (* 0.0 u))) (* 0.5 u))))
   (symbolic-simp-rule '(abs (+ (* 0.5 (- u (* 0.0 u))) (* 0.5 u))))
    ...
    '(+ (* 0.5 (- u 0.0)) (* 0.5 u))
   '(abs (+ (* 0.5 (- u 0.0)) (* 0.5 u)))
  (symbolic-simp '(abs (+ (* 0.5 (- u 0.0)) (* 0.5 u))))
   (symbolic-simp-rule '(abs (+ (* 0.5 (- u 0.0)) (* 0.5 u))))
  ...
  (symbolic-simp '(abs (+ (* 0.5 (+ u (sqrt (+ (* 4.0 0.0 0.0) (* (- u u) (- u u)))))) (* 0.5 u))))
   ...
   '(abs (+ (+ (* 0.5 u) (* 0.5 (sqrt (+ (* 4.0 0.0 0.0) (* (- u u) (- u u)))))) (* 0.5 u)))
  (symbolic-simp '(abs (+ (+ (* 0.5 u) (* 0.5 (sqrt (+ (* 4.0 0.0 0.0) (* (- u u) (- u u)))))) (* 0.5 u))))
   (symbolic-simp-rule '(abs (+ (+ (* 0.5 u) (* 0.5 (sqrt (+ (* 4.0 0.0 0.0) (* (- u u) (- u u)))))) (* 0.5 u))))
  ...
  (symbolic-simp '(abs (+ (* 0.5 u) (+ (* 0.5 (sqrt (+ (* 4.0 0.0 0.0) (* (- u u) (- u u))))) (* 0.5 u)))))
   ...
   '(abs (+ (* (+ 0.5 0.5) u) (* 0.5 (sqrt (+ (* 4.0 0.0 0.0) (* (- u u) (- u u)))))))
  (symbolic-simp '(abs (+ (* (+ 0.5 0.5) u) (* 0.5 (sqrt (+ (* 4.0 0.0 0.0) (* (- u u) (- u u))))))))
   (symbolic-simp-rule '(abs (+ (* (+ 0.5 0.5) u) (* 0.5 (sqrt (+ (* 4.0 0.0 0.0) (* (- u u) (- u u))))))))
   ...
   '(abs (+ (* 1.0 u) (* 0.5 (sqrt (+ (* (* 4.0 0.0) 0.0) (- (+ (* u u) (* u u)) (* 2.0 (* u u))))))))
  (symbolic-simp '(abs (+ (* 1.0 u) (* 0.5 (sqrt (+ (* (* 4.0 0.0) 0.0) (- (+ (* u u) (* u u)) (* 2.0 (* u u)))))))))
   (symbolic-simp-rule '(abs (+ (* 1.0 u) (* 0.5 (sqrt (+ (* (* 4.0 0.0) 0.0) (- (+ (* u u) (* u u)) (* 2.0 (* u u)))))))))
   ...
   '(abs (+ u (* 0.5 (sqrt (+ (* 4.0 (* 0.0 0.0)) (- (* (+ u u) u) (* 2.0 (* u u))))))))
  (symbolic-simp '(abs (+ u (* 0.5 (sqrt (+ (* 4.0 (* 0.0 0.0)) (- (* (+ u u) u) (* 2.0 (* u u)))))))))
   (symbolic-simp-rule '(abs (+ u (* 0.5 (sqrt (+ (* 4.0 (* 0.0 0.0)) (- (* (+ u u) u) (* 2.0 (* u u)))))))))
   ...
   '(abs (+ u (* 0.5 (sqrt (+ (* 0.0 0.0) (- (* (* 2.0 u) u) (* 2.0 (* u u))))))))
  (symbolic-simp '(abs (+ u (* 0.5 (sqrt (+ (* 0.0 0.0) (- (* (* 2.0 u) u) (* 2.0 (* u u)))))))))
   (symbolic-simp-rule '(abs (+ u (* 0.5 (sqrt (+ (* 0.0 0.0) (- (* (* 2.0 u) u) (* 2.0 (* u u)))))))))
   ...
   '(abs (+ u (* 0.5 (sqrt (+ 0.0 (- (* 2.0 (* u u)) (* 2.0 (* u u))))))))
  (symbolic-simp '(abs (+ u (* 0.5 (sqrt (+ 0.0 (- (* 2.0 (* u u)) (* 2.0 (* u u)))))))))
   (symbolic-simp-rule '(abs (+ u (* 0.5 (sqrt (+ 0.0 (- (* 2.0 (* u u)) (* 2.0 (* u u)))))))))
   ...
   '(abs (+ u (* 0.5 (sqrt (- (* 2.0 (* u u)) (* 2.0 (* u u)))))))
  (symbolic-simp '(abs (+ u (* 0.5 (sqrt (- (* 2.0 (* u u)) (* 2.0 (* u u))))))))
   (symbolic-simp-rule '(abs (+ u (* 0.5 (sqrt (- (* 2.0 (* u u)) (* 2.0 (* u u))))))))
   ...
   '(abs (+ u (* 0.5 (sqrt (* (- 2.0 2.0) (* u u))))))
  (symbolic-simp '(abs (+ u (* 0.5 (sqrt (* (- 2.0 2.0) (* u u)))))))
   (symbolic-simp-rule '(abs (+ u (* 0.5 (sqrt (* (- 2.0 2.0) (* u u)))))))
   ...
   '(abs (+ u (* 0.5 (* (sqrt (- 2.0 2.0)) (sqrt (* u u))))))
  (symbolic-simp '(abs (+ u (* 0.5 (* (sqrt (- 2.0 2.0)) (sqrt (* u u)))))))
   (symbolic-simp-rule '(abs (+ u (* 0.5 (* (sqrt (- 2.0 2.0)) (sqrt (* u u)))))))
    (symbolic-simp-rule '(+ u (* 0.5 (* (sqrt (- 2.0 2.0)) (sqrt (* u u))))))
     ...
     '(* 0.5 (* (sqrt 0.0) u))
    '(+ u (* 0.5 (* (sqrt 0.0) u)))
   '(abs (+ u (* 0.5 (* (sqrt 0.0) u))))
  (symbolic-simp '(abs (+ u (* 0.5 (* (sqrt 0.0) u)))))
   (symbolic-simp-rule '(abs (+ u (* 0.5 (* (sqrt 0.0) u)))))
    ...
    '(+ u (* 0.5 (* 0.0 u)))
   '(abs (+ u (* 0.5 (* 0.0 u))))
  (symbolic-simp '(abs (+ u (* 0.5 (* 0.0 u)))))
   (symbolic-simp-rule '(abs (+ u (* 0.5 (* 0.0 u)))))
    ...
    '(+ u (* 0.0 u))
   '(abs (+ u (* 0.0 u)))
  (symbolic-simp '(abs (+ u (* 0.0 u))))
   (symbolic-simp-rule '(abs (+ u (* 0.0 u))))
    (symbolic-simp-rule '(+ u (* 0.0 u)))
     (symbolic-simp-rule 'u)
     'u
     (symbolic-simp-rule '(* 0.0 u))
    ...
    '(+ u 0.0)
   '(abs (+ u 0.0))
  (symbolic-simp '(abs (+ u 0.0)))
   (symbolic-simp-rule '(abs (+ u 0.0)))
    (symbolic-simp-rule '(+ u 0.0))
    '(+ 0.0 u)
   '(abs (+ 0.0 u))
  (symbolic-simp '(abs (+ 0.0 u)))
   (symbolic-simp-rule '(abs (+ 0.0 u)))
    (symbolic-simp-rule '(+ 0.0 u))
    'u
   '(abs u)
  (symbolic-simp '(abs u))
