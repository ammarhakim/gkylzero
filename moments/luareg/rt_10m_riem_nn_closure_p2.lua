...
poly_order = 2 -- Polynomial order of learned DG coefficients.
nn_closure_file = "moments/data/neural_nets/pkpm_periodic_es_shock_p2_moms_nn_1" -- File path of neural network to use.
