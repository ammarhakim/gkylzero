...
struct gkyl_gk_multib {
  ...
  bool skip_field; // Whether to skip the electromagnetic field solve.
  struct gkyl_gyrokinetic_field field; // field object

  int num_blocks; // Number of blocks.
  struct gkyl_gk *blocks[GKYL_MAX_BLOCKS]; // Single block apps.

  struct gkyl_block_connections *block_connections; // Block connectivities.
};
