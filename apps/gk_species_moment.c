...
void
gk_species_moment_init(struct gkyl_gyrokinetic_oneb *app, struct gk_species *s,
...
void
gk_species_moment_release(const struct gkyl_gyrokinetic_oneb *app, const struct gk_species_moment *sm)
{
  if (app->use_gpu)
