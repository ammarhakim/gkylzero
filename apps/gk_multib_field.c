  ...
  struct gkyl_gyrokinetic_multib_app *mbapp, struct gk_multib_field *mbf)
{
  ...
  int stat_jac = gkyl_multib_comm_conn_array_transfer(mbapp->comm, mbf->num_local_blocks, mbapp->local_blocks,
...
//      fem_parbc, mbf->lhs_weight_multibz[bI], mbf->rhs_weight_multibz[bI], mbapp->use_gpu);
    mbf->fem_parproj[bI] = gkyl_fem_parproj_multib_new(nconnected[bid], mbf->multibz_ranges[bI],
      mbf->multibz_ranges_indi[bI], &sbapp->basis, fem_parbc,
