...
void
gk_species_bflux_rhs_calc(gkyl_gyrokinetic_app *app, struct gk_boundary_fluxes *bflux, const struct gkyl_array *fin, struct gkyl_array *rhs)
{
  for (int b=0; b<bflux->num_boundaries; ++b) {
...
static void
gk_species_bflux_rhs_none(gkyl_gyrokinetic_app *app, struct gk_boundary_fluxes *bflux, const struct gkyl_array *fin, struct gkyl_array *rhs)
{
}

void
gk_species_bflux_rhs(gkyl_gyrokinetic_app *app, struct gk_boundary_fluxes *bflux, const struct gkyl_array *fin, struct gkyl_array *rhs)
{
...
void
gk_species_bflux_release(const struct gkyl_gyrokinetic_app *app, const void *species, const struct gk_boundary_fluxes *bflux)
{
