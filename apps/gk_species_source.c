...
// Function prototypes (defined at the end of this file) and empty functions.
void gk_species_source_write_disabled(gkyl_gyrokinetic_app* app, struct gk_species *gks, double tm, int frame){}
void gk_species_source_write_enabled(gkyl_gyrokinetic_app* app, struct gk_species *gks, double tm, int frame);
void gk_species_source_write_init_only(gkyl_gyrokinetic_app* app, struct gk_species *gks, double tm, int frame);
void gk_species_source_write_mom_disabled(gkyl_gyrokinetic_app* app, struct gk_species *gks, double tm, int frame){}
void gk_species_source_write_mom_enabled(gkyl_gyrokinetic_app* app, struct gk_species *gks, double tm, int frame);
void gk_species_source_write_mom_init_only(gkyl_gyrokinetic_app* app, struct gk_species *gks, double tm, int frame);
void gk_species_source_calc_integrated_mom_disabled(gkyl_gyrokinetic_app* app, struct gk_species *gks, double tm){}
void gk_species_source_calc_integrated_mom_enabled(gkyl_gyrokinetic_app* app, struct gk_species *gks, double tm);
void gk_species_source_write_integrated_mom_disabled(gkyl_gyrokinetic_app* app, struct gk_species *gks){}
void gk_species_source_write_integrated_mom_enabled(gkyl_gyrokinetic_app* app, struct gk_species *gks);
      ...
      for (int k = 0; k < src->num_adapt_sources; ++k) {
        ...
        for (int j=0; j < adapt_src->num_boundaries; ++j) {
          ...
          if (edge == GKYL_LOWER_EDGE? 
            ...
            { 
            adapt_src->range_bflux[j] = edge == GKYL_LOWER_EDGE ? s->lower_ghost_par_sol   : s->upper_ghost_par_sol;
